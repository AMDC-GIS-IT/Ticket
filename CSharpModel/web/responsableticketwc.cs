...
namespace GeneXus.Programs {
   public class responsableticketwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV80Pgmname = "ResponsableTicketWC";
               context.Gx_err = 0;
               WS2P2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188124267", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RF2P2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               ...
               n57TicketOtros = H002P2_n57TicketOtros[0];
               A52TicketInstalarDataShow = H002P2_A52TicketInstalarDataShow[0];
               n52TicketInstalarDataShow = H002P2_n52TicketInstalarDataShow[0];
               A41TicketApoyoUsuario = H002P2_A41TicketApoyoUsuario[0];
               n41TicketApoyoUsuario = H002P2_n41TicketApoyoUsuario[0];
               A87TicketUps = H002P2_A87TicketUps[0];
               n87TicketUps = H002P2_n87TicketUps[0];
               A58TicketPerifericos = H002P2_A58TicketPerifericos[0];
               n58TicketPerifericos = H002P2_n58TicketPerifericos[0];
               A43TicketDiscoDuroExterno = H002P2_A43TicketDiscoDuroExterno[0];
               n43TicketDiscoDuroExterno = H002P2_n43TicketDiscoDuroExterno[0];
               A51TicketIngenieria = H002P2_A51TicketIngenieria[0];
               n51TicketIngenieria = H002P2_n51TicketIngenieria[0];
               A44TicketDisenio = H002P2_A44TicketDisenio[0];
               n44TicketDisenio = H002P2_n44TicketDisenio[0];
               A40TicketAplicacion = H002P2_A40TicketAplicacion[0];
               n40TicketAplicacion = H002P2_n40TicketAplicacion[0];
               A39TicketAntivirus = H002P2_A39TicketAntivirus[0];
               n39TicketAntivirus = H002P2_n39TicketAntivirus[0];
               A56TicketOffice = H002P2_A56TicketOffice[0];
               n56TicketOffice = H002P2_n56TicketOffice[0];
               A60TicketSistemaOperativo = H002P2_A60TicketSistemaOperativo[0];
               n60TicketSistemaOperativo = H002P2_n60TicketSistemaOperativo[0];
               A59TicketRouter = H002P2_A59TicketRouter[0];
               n59TicketRouter = H002P2_n59TicketRouter[0];
               A45TicketEscaner = H002P2_A45TicketEscaner[0];
               n45TicketEscaner = H002P2_n45TicketEscaner[0];
               A50TicketImpresora = H002P2_A50TicketImpresora[0];
               n50TicketImpresora = H002P2_n50TicketImpresora[0];
               A55TicketMonitor = H002P2_A55TicketMonitor[0];
               n55TicketMonitor = H002P2_n55TicketMonitor[0];
               A42TicketDesktop = H002P2_A42TicketDesktop[0];
               n42TicketDesktop = H002P2_n42TicketDesktop[0];
               A53TicketLaptop = H002P2_A53TicketLaptop[0];
               n53TicketLaptop = H002P2_n53TicketLaptop[0];
      ...
      protected void E192P2( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "Ticket",  "Ticket",  "List",  "",  "ExportResponsableTicketWC") )
         {
            new exportresponsableticketwc(context ).execute(  AV6ResponsableId,  AV50TicketFecha_From,  AV51TicketFecha_To,  AV53TicketHora_From,  AV54TicketHora_To,  AV55UsuarioNombre,  AV60K2BToolsGenericSearchField,  AV61OrderedBy, out  AV75OutFile) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202418813116", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("responsableticketwc.js", "?202418813116", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E252P2',iparms:[{av:'AV70AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZZZZZZZ9'},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV72TicketFecha_IsAuthorized',fld:'vTICKETFECHA_ISAUTHORIZED',pic:''},{av:'A14TicketId',fld:'TICKETID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV15Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV16Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_EstadoTicketId_Visible',fld:'vATT_ESTADOTICKETID_VISIBLE',pic:''},{av:'AV22Att_EstadoTicketNombre_Visible',fld:'vATT_ESTADOTICKETNOMBRE_VISIBLE',pic:''},{av:'AV23Att_TicketLastId_Visible',fld:'vATT_TICKETLASTID_VISIBLE',pic:''},{av:'AV24Att_TicketLaptop_Visible',fld:'vATT_TICKETLAPTOP_VISIBLE',pic:''},{av:'AV25Att_TicketDesktop_Visible',fld:'vATT_TICKETDESKTOP_VISIBLE',pic:''},{av:'AV26Att_TicketMonitor_Visible',fld:'vATT_TICKETMONITOR_VISIBLE',pic:''},{av:'AV27Att_TicketImpresora_Visible',fld:'vATT_TICKETIMPRESORA_VISIBLE',pic:''},{av:'AV28Att_TicketEscaner_Visible',fld:'vATT_TICKETESCANER_VISIBLE',pic:''},{av:'AV29Att_TicketRouter_Visible',fld:'vATT_TICKETROUTER_VISIBLE',pic:''},{av:'AV30Att_TicketSistemaOperativo_Visible',fld:'vATT_TICKETSISTEMAOPERATIVO_VISIBLE',pic:''},{av:'AV31Att_TicketOffice_Visible',fld:'vATT_TICKETOFFICE_VISIBLE',pic:''},{av:'AV32Att_TicketAntivirus_Visible',fld:'vATT_TICKETANTIVIRUS_VISIBLE',pic:''},{av:'AV33Att_TicketAplicacion_Visible',fld:'vATT_TICKETAPLICACION_VISIBLE',pic:''},{av:'AV34Att_TicketDisenio_Visible',fld:'vATT_TICKETDISENIO_VISIBLE',pic:''},{av:'AV35Att_TicketIngenieria_Visible',fld:'vATT_TICKETINGENIERIA_VISIBLE',pic:''},{av:'AV36Att_TicketDiscoDuroExterno_Visible',fld:'vATT_TICKETDISCODUROEXTERNO_VISIBLE',pic:''},{av:'AV37Att_TicketPerifericos_Visible',fld:'vATT_TICKETPERIFERICOS_VISIBLE',pic:''},{av:'AV38Att_TicketUps_Visible',fld:'vATT_TICKETUPS_VISIBLE',pic:''},{av:'AV39Att_TicketApoyoUsuario_Visible',fld:'vATT_TICKETAPOYOUSUARIO_VISIBLE',pic:''},{av:'AV40Att_TicketInstalarDataShow_Visible',fld:'vATT_TICKETINSTALARDATASHOW_VISIBLE',pic:''},{av:'AV41Att_TicketOtros_Visible',fld:'vATT_TICKETOTROS_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E162P2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV60K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV50TicketFecha_From',fld:'vTICKETFECHA_FROM',pic:''},{av:'AV53TicketHora_From',fld:'vTICKETHORA_FROM',pic:'99:99'},{av:'AV54TicketHora_To',fld:'vTICKETHORA_TO',pic:'99:99'},{av:'AV55UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'A6ResponsableId',fld:'RESPONSABLEID',pic:'ZZZ9'},{av:'AV6ResponsableId',fld:'vRESPONSABLEID',pic:'ZZZ9'},{av:'AV48ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV61OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV51TicketFecha_To',fld:'vTICKETFECHA_TO',pic:''},{av:'AV80Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV70AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV72TicketFecha_IsAuthorized',fld:'vTICKETFECHA_ISAUTHORIZED',pic:''},{av:'AV77Uri',fld:'vURI',pic:'',hsh:true},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV16Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_EstadoTicketId_Visible',fld:'vATT_ESTADOTICKETID_VISIBLE',pic:''},{av:'AV22Att_EstadoTicketNombre_Visible',fld:'vATT_ESTADOTICKETNOMBRE_VISIBLE',pic:''},{av:'AV23Att_TicketLastId_Visible',fld:'vATT_TICKETLASTID_VISIBLE',pic:''},{av:'AV24Att_TicketLaptop_Visible',fld:'vATT_TICKETLAPTOP_VISIBLE',pic:''},{av:'AV25Att_TicketDesktop_Visible',fld:'vATT_TICKETDESKTOP_VISIBLE',pic:''},{av:'AV26Att_TicketMonitor_Visible',fld:'vATT_TICKETMONITOR_VISIBLE',pic:''},{av:'AV27Att_TicketImpresora_Visible',fld:'vATT_TICKETIMPRESORA_VISIBLE',pic:''},{av:'AV28Att_TicketEscaner_Visible',fld:'vATT_TICKETESCANER_VISIBLE',pic:''},{av:'AV29Att_TicketRouter_Visible',fld:'vATT_TICKETROUTER_VISIBLE',pic:''},{av:'AV30Att_TicketSistemaOperativo_Visible',fld:'vATT_TICKETSISTEMAOPERATIVO_VISIBLE',pic:''},{av:'AV31Att_TicketOffice_Visible',fld:'vATT_TICKETOFFICE_VISIBLE',pic:''},{av:'AV32Att_TicketAntivirus_Visible',fld:'vATT_TICKETANTIVIRUS_VISIBLE',pic:''},{av:'AV33Att_TicketAplicacion_Visible',fld:'vATT_TICKETAPLICACION_VISIBLE',pic:''},{av:'AV34Att_TicketDisenio_Visible',fld:'vATT_TICKETDISENIO_VISIBLE',pic:''},{av:'AV35Att_TicketIngenieria_Visible',fld:'vATT_TICKETINGENIERIA_VISIBLE',pic:''},{av:'AV36Att_TicketDiscoDuroExterno_Visible',fld:'vATT_TICKETDISCODUROEXTERNO_VISIBLE',pic:''},{av:'AV37Att_TicketPerifericos_Visible',fld:'vATT_TICKETPERIFERICOS_VISIBLE',pic:''},{av:'AV38Att_TicketUps_Visible',fld:'vATT_TICKETUPS_VISIBLE',pic:''},{av:'AV39Att_TicketApoyoUsuario_Visible',fld:'vATT_TICKETAPOYOUSUARIO_VISIBLE',pic:''},{av:'AV40Att_TicketInstalarDataShow_Visible',fld:'vATT_TICKETINSTALARDATASHOW_VISIBLE',pic:''},{av:'AV41Att_TicketOtros_Visible',fld:'vATT_TICKETOTROS_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E172P2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV60K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV50TicketFecha_From',fld:'vTICKETFECHA_FROM',pic:''},{av:'AV53TicketHora_From',fld:'vTICKETHORA_FROM',pic:'99:99'},{av:'AV54TicketHora_To',fld:'vTICKETHORA_TO',pic:'99:99'},{av:'AV55UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'A6ResponsableId',fld:'RESPONSABLEID',pic:'ZZZ9'},{av:'AV6ResponsableId',fld:'vRESPONSABLEID',pic:'ZZZ9'},{av:'AV48ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV61OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV51TicketFecha_To',fld:'vTICKETFECHA_TO',pic:''},{av:'AV80Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV70AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV72TicketFecha_IsAuthorized',fld:'vTICKETFECHA_ISAUTHORIZED',pic:''},{av:'AV77Uri',fld:'vURI',pic:'',hsh:true},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV16Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_EstadoTicketId_Visible',fld:'vATT_ESTADOTICKETID_VISIBLE',pic:''},{av:'AV22Att_EstadoTicketNombre_Visible',fld:'vATT_ESTADOTICKETNOMBRE_VISIBLE',pic:''},{av:'AV23Att_TicketLastId_Visible',fld:'vATT_TICKETLASTID_VISIBLE',pic:''},{av:'AV24Att_TicketLaptop_Visible',fld:'vATT_TICKETLAPTOP_VISIBLE',pic:''},{av:'AV25Att_TicketDesktop_Visible',fld:'vATT_TICKETDESKTOP_VISIBLE',pic:''},{av:'AV26Att_TicketMonitor_Visible',fld:'vATT_TICKETMONITOR_VISIBLE',pic:''},{av:'AV27Att_TicketImpresora_Visible',fld:'vATT_TICKETIMPRESORA_VISIBLE',pic:''},{av:'AV28Att_TicketEscaner_Visible',fld:'vATT_TICKETESCANER_VISIBLE',pic:''},{av:'AV29Att_TicketRouter_Visible',fld:'vATT_TICKETROUTER_VISIBLE',pic:''},{av:'AV30Att_TicketSistemaOperativo_Visible',fld:'vATT_TICKETSISTEMAOPERATIVO_VISIBLE',pic:''},{av:'AV31Att_TicketOffice_Visible',fld:'vATT_TICKETOFFICE_VISIBLE',pic:''},{av:'AV32Att_TicketAntivirus_Visible',fld:'vATT_TICKETANTIVIRUS_VISIBLE',pic:''},{av:'AV33Att_TicketAplicacion_Visible',fld:'vATT_TICKETAPLICACION_VISIBLE',pic:''},{av:'AV34Att_TicketDisenio_Visible',fld:'vATT_TICKETDISENIO_VISIBLE',pic:''},{av:'AV35Att_TicketIngenieria_Visible',fld:'vATT_TICKETINGENIERIA_VISIBLE',pic:''},{av:'AV36Att_TicketDiscoDuroExterno_Visible',fld:'vATT_TICKETDISCODUROEXTERNO_VISIBLE',pic:''},{av:'AV37Att_TicketPerifericos_Visible',fld:'vATT_TICKETPERIFERICOS_VISIBLE',pic:''},{av:'AV38Att_TicketUps_Visible',fld:'vATT_TICKETUPS_VISIBLE',pic:''},{av:'AV39Att_TicketApoyoUsuario_Visible',fld:'vATT_TICKETAPOYOUSUARIO_VISIBLE',pic:''},{av:'AV40Att_TicketInstalarDataShow_Visible',fld:'vATT_TICKETINSTALARDATASHOW_VISIBLE',pic:''},{av:'AV41Att_TicketOtros_Visible',fld:'vATT_TICKETOTROS_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E182P2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV60K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV50TicketFecha_From',fld:'vTICKETFECHA_FROM',pic:''},{av:'AV53TicketHora_From',fld:'vTICKETHORA_FROM',pic:'99:99'},{av:'AV54TicketHora_To',fld:'vTICKETHORA_TO',pic:'99:99'},{av:'AV55UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'A6ResponsableId',fld:'RESPONSABLEID',pic:'ZZZ9'},{av:'AV6ResponsableId',fld:'vRESPONSABLEID',pic:'ZZZ9'},{av:'AV48ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV61OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV51TicketFecha_To',fld:'vTICKETFECHA_TO',pic:''},{av:'AV80Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV70AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV72TicketFecha_IsAuthorized',fld:'vTICKETFECHA_ISAUTHORIZED',pic:''},{av:'AV77Uri',fld:'vURI',pic:'',hsh:true},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV16Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_EstadoTicketId_Visible',fld:'vATT_ESTADOTICKETID_VISIBLE',pic:''},{av:'AV22Att_EstadoTicketNombre_Visible',fld:'vATT_ESTADOTICKETNOMBRE_VISIBLE',pic:''},{av:'AV23Att_TicketLastId_Visible',fld:'vATT_TICKETLASTID_VISIBLE',pic:''},{av:'AV24Att_TicketLaptop_Visible',fld:'vATT_TICKETLAPTOP_VISIBLE',pic:''},{av:'AV25Att_TicketDesktop_Visible',fld:'vATT_TICKETDESKTOP_VISIBLE',pic:''},{av:'AV26Att_TicketMonitor_Visible',fld:'vATT_TICKETMONITOR_VISIBLE',pic:''},{av:'AV27Att_TicketImpresora_Visible',fld:'vATT_TICKETIMPRESORA_VISIBLE',pic:''},{av:'AV28Att_TicketEscaner_Visible',fld:'vATT_TICKETESCANER_VISIBLE',pic:''},{av:'AV29Att_TicketRouter_Visible',fld:'vATT_TICKETROUTER_VISIBLE',pic:''},{av:'AV30Att_TicketSistemaOperativo_Visible',fld:'vATT_TICKETSISTEMAOPERATIVO_VISIBLE',pic:''},{av:'AV31Att_TicketOffice_Visible',fld:'vATT_TICKETOFFICE_VISIBLE',pic:''},{av:'AV32Att_TicketAntivirus_Visible',fld:'vATT_TICKETANTIVIRUS_VISIBLE',pic:''},{av:'AV33Att_TicketAplicacion_Visible',fld:'vATT_TICKETAPLICACION_VISIBLE',pic:''},{av:'AV34Att_TicketDisenio_Visible',fld:'vATT_TICKETDISENIO_VISIBLE',pic:''},{av:'AV35Att_TicketIngenieria_Visible',fld:'vATT_TICKETINGENIERIA_VISIBLE',pic:''},{av:'AV36Att_TicketDiscoDuroExterno_Visible',fld:'vATT_TICKETDISCODUROEXTERNO_VISIBLE',pic:''},{av:'AV37Att_TicketPerifericos_Visible',fld:'vATT_TICKETPERIFERICOS_VISIBLE',pic:''},{av:'AV38Att_TicketUps_Visible',fld:'vATT_TICKETUPS_VISIBLE',pic:''},{av:'AV39Att_TicketApoyoUsuario_Visible',fld:'vATT_TICKETAPOYOUSUARIO_VISIBLE',pic:''},{av:'AV40Att_TicketInstalarDataShow_Visible',fld:'vATT_TICKETINSTALARDATASHOW_VISIBLE',pic:''},{av:'AV41Att_TicketOtros_Visible',fld:'vATT_TICKETOTROS_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.responsableticketwc__default(),
            new Object[][] {
                new Object[] {
               H002P2_A57TicketOtros, H002P2_n57TicketOtros, H002P2_A52TicketInstalarDataShow, H002P2_n52TicketInstalarDataShow, H002P2_A41TicketApoyoUsuario, H002P2_n41TicketApoyoUsuario, H002P2_A87TicketUps, H002P2_n87TicketUps, H002P2_A58TicketPerifericos, H002P2_n58TicketPerifericos,
               H002P2_A43TicketDiscoDuroExterno, H002P2_n43TicketDiscoDuroExterno, H002P2_A51TicketIngenieria, H002P2_n51TicketIngenieria, H002P2_A44TicketDisenio, H002P2_n44TicketDisenio, H002P2_A40TicketAplicacion, H002P2_n40TicketAplicacion, H002P2_A39TicketAntivirus, H002P2_n39TicketAntivirus,
               H002P2_A56TicketOffice, H002P2_n56TicketOffice, H002P2_A60TicketSistemaOperativo, H002P2_n60TicketSistemaOperativo, H002P2_A59TicketRouter, H002P2_n59TicketRouter, H002P2_A45TicketEscaner, H002P2_n45TicketEscaner, H002P2_A50TicketImpresora, H002P2_n50TicketImpresora,
               H002P2_A55TicketMonitor, H002P2_n55TicketMonitor, H002P2_A42TicketDesktop, H002P2_n42TicketDesktop, H002P2_A53TicketLaptop, H002P2_n53TicketLaptop, H002P2_A54TicketLastId, H002P2_A94UsuarioRequerimiento, H002P2_A93UsuarioNombre, H002P2_A15UsuarioId,
               H002P2_A48TicketHora, H002P2_A46TicketFecha, H002P2_A14TicketId
               }
               , new Object[] {
   ...
   public class responsableticketwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002P2(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (string)dynConstraints[8] , (long)dynConstraints[9] , (long)dynConstraints[10] , (string)dynConstraints[11] , (short)dynConstraints[12] , (string)dynConstraints[13] , (long)dynConstraints[14] , (short)dynConstraints[15] , (short)dynConstraints[16] , (short)dynConstraints[17] );
               case 1 :
                     return conditional_H002P3(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (string)dynConstraints[8] , (long)dynConstraints[9] , (long)dynConstraints[10] , (string)dynConstraints[11] , (short)dynConstraints[12] , (string)dynConstraints[13] , (long)dynConstraints[14] , (short)dynConstraints[15] , (short)dynConstraints[16] , (short)dynConstraints[17] );
         }
