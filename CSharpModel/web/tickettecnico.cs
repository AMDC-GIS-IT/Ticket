   ...
   public class tickettecnico : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITTRN( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel15"+"_"+"") == 0 )
            {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_30") == 0 )
            {
               ...
               gxLoad_30( A14TicketId, A16TicketResponsableId) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_33") == 0 )
            {
               ...
               gxLoad_33( A294CategoriaDetalleTareaId) ;
               return  ;
            }
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_31") == 0 )
            {
               ...
               gxLoad_31( A173SgActividadIdCategoria) ;
               return  ;
            }
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtTicketTecnicoId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A18TicketTecnicoId), 10, 0, ".", "")), StringUtil.LTrim( ((edtTicketTecnicoId_Enabled!=0) ? context.localUtil.Format( (decimal)(A18TicketTecnicoId), "ZZZZZZZZZ9") : context.localUtil.Format( (decimal)(A18TicketTecnicoId), "ZZZZZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTicketTecnicoId_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtTicketTecnicoId_Enabled, 0, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "NumMax", "right", false, "", "HLP_TicketTecnico.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtTicketResponsableId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A16TicketResponsableId), 10, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A16TicketResponsableId), "ZZZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,34);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTicketResponsableId_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtTicketResponsableId_Enabled, 1, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_TicketTecnico.htm");
         ...
         GxWebStd.gx_single_line_edit( context, edtTicketId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A14TicketId), 10, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A14TicketId), "ZZZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,42);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTicketId_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtTicketId_Enabled, 1, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "NumMax", "right", false, "", "HLP_TicketTecnico.htm");
         /* Static images/pictures */
         ClassString = "gx-prompt Image";
         StyleString = "";
         sImgUrl = (string)(context.GetImagePath( "f5b04895-0024-488b-8e3b-b687ca4598ee", "", context.GetTheme( )));
         ...
         GxWebStd.gx_single_line_edit( context, edtResponsableId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A6ResponsableId), 4, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A6ResponsableId), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,86);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtResponsableId_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtResponsableId_Enabled, 1, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "NumMin", "right", false, "", "HLP_TicketTecnico.htm");
         /* Static images/pictures */
         ClassString = "gx-prompt Image";
         StyleString = "";
         sImgUrl = (string)(context.GetImagePath( "f5b04895-0024-488b-8e3b-b687ca4598ee", "", context.GetTheme( )));
      ...
      protected void drawControls1( )
      {
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSgActividadIdCategoria_Internalname, "Id Categoria", "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         AssignAttri(sPrefix, false, "A173SgActividadIdCategoria", StringUtil.LTrimStr( (decimal)(A173SgActividadIdCategoria), 9, 0));
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 314,'" + sPrefix + "',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtSgActividadIdCategoria_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A173SgActividadIdCategoria), 9, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A173SgActividadIdCategoria), "ZZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,314);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSgActividadIdCategoria_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtSgActividadIdCategoria_Enabled, 1, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_TicketTecnico.htm");
         /* Static images/pictures */
         ClassString = "gx-prompt Image";
         StyleString = "";
         sImgUrl = (string)(context.GetImagePath( "f5b04895-0024-488b-8e3b-b687ca4598ee", "", context.GetTheme( )));
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSgActividadNombreCategoria_Internalname, "Nombre Categoria", "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
         /* Multiple line edit */
         ...
         GxWebStd.gx_single_line_edit( context, edtSgActividadId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A171SgActividadId), 9, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A171SgActividadId), "ZZZZZZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,328);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSgActividadId_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtSgActividadId_Enabled, 1, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_TicketTecnico.htm");
         /* Static images/pictures */
         ClassString = "gx-prompt Image";
         StyleString = "";
         sImgUrl = (string)(context.GetImagePath( "f5b04895-0024-488b-8e3b-b687ca4598ee", "", context.GetTheme( )));
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( ( ( ( StringUtil.Len( sPrefix) == 0 ) ) || ( StringUtil.StringSearch( sXEvt, sPrefix, 1) > 0 ) ) && ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
            {
               ...
               N6ResponsableId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"N6ResponsableId"), ".", ","));
               ...
               AV33Insert_ResponsableId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"vINSERT_RESPONSABLEID"), ".", ","));
               ...
               A102id_actividad_categoria = (int)(context.localUtil.CToN( cgiGet( sPrefix+"ID_ACTIVIDAD_CATEGORIA"), ".", ","));
      ...
      protected void E11082( )
      {
         ...
         new k2bisauthorizedactivityname(context ).execute(  "TicketTecnico",  "TicketTecnico",  AV18StandardActivityType,  AV19UserActivityType,  AV35Pgmname, out  AV20IsAuthorized) ;
         AssignAttri(sPrefix, false, "AV20IsAuthorized", AV20IsAuthorized);
         if ( ! AV20IsAuthorized )
         {
            CallWebObject(formatLink("k2bnotauthorized.aspx", new object[] {UrlEncode(StringUtil.RTrim("TicketTecnico")),UrlEncode(StringUtil.RTrim("TicketTecnico")),UrlEncode(StringUtil.RTrim(AV18StandardActivityType)),UrlEncode(StringUtil.RTrim(AV19UserActivityType)),UrlEncode(StringUtil.RTrim(AV35Pgmname))}, new string[] {"EntityName","TransactionName","StandardActivityType","UserActivityType","ProgramName"}) );
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            ...
            while ( AV36GXV1 <= AV8TrnContext.gxTpr_Attributes.Count )
            {
               ...
               else if ( StringUtil.StrCmp(AV9TrnContextAtt.gxTpr_Attributename, "ResponsableId") == 0 )
               {
                  AV33Insert_ResponsableId = (short)(NumberUtil.Val( AV9TrnContextAtt.gxTpr_Attributevalue, "."));
                  AssignAttri(sPrefix, false, "AV33Insert_ResponsableId", StringUtil.LTrimStr( (decimal)(AV33Insert_ResponsableId), 4, 0));
               }
      ...
      protected void standaloneNotModal( )
      {
         ...
         imgprompt_6_Link = ((StringUtil.StrCmp(Gx_mode, "DSP")==0) ? "" : "javascript:"+"gx.popup.openPrompt('"+"promptresponsable.aspx"+"',["+"{Ctrl:gx.dom.el('"+sPrefix+"RESPONSABLEID"+"'), id:'"+sPrefix+"RESPONSABLEID"+"'"+",IOType:'out'}"+"],"+"null"+","+"'"+sPrefix+"', false"+","+"false"+");");
         ...
         if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ! (0==AV33Insert_ResponsableId) )
         {
      ...
      protected void standaloneModal( )
      {
         ...
         if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ! (0==AV33Insert_ResponsableId) )
         {
            A6ResponsableId = AV33Insert_ResponsableId;
            AssignAttri(sPrefix, false, "A6ResponsableId", StringUtil.LTrimStr( (decimal)(A6ResponsableId), 4, 0));
         }
         if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ! (0==AV13Insert_TicketResponsableId) )
         {
         ...
         if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ( Gx_BScreen == 0 ) )
         {
            ...
            A123nombre_actividad = T00086_A123nombre_actividad[0];
            n123nombre_actividad = T00086_n123nombre_actividad[0];
            A172SgActividadNombre = T00086_A123nombre_actividad[0];
            AssignAttri(sPrefix, false, "A172SgActividadNombre", A172SgActividadNombre);
            ...
            A294CategoriaDetalleTareaId = T00087_A294CategoriaDetalleTareaId[0];
            pr_default.close(4);
         }
      }
      ...
      protected void Load089( )
      {
         ...
         pr_default.execute(7, new Object[] {A18TicketTecnicoId});
         if ( (pr_default.getStatus(7) != 101) )
         {
            RcdFound9 = 1;
            A294CategoriaDetalleTareaId = T000812_A294CategoriaDetalleTareaId[0];
            A69TicketTecnicoFecha = T000812_A69TicketTecnicoFecha[0];
            AssignAttri(sPrefix, false, "A69TicketTecnicoFecha", context.localUtil.Format(A69TicketTecnicoFecha, "99/99/9999"));
            A71TicketTecnicoHora = T000812_A71TicketTecnicoHora[0];
            AssignAttri(sPrefix, false, "A71TicketTecnicoHora", context.localUtil.TToC( A71TicketTecnicoHora, 0, 5, 0, 3, "/", ":", " "));
            A30ResponsableNombre = T000812_A30ResponsableNombre[0];
            AssignAttri(sPrefix, false, "A30ResponsableNombre", A30ResponsableNombre);
            ...
            AssignAttri(sPrefix, false, "A88UsuarioDepartamento", A88UsuarioDepartamento);
            A74TicketTecnicoInventarioSerie = T000812_A74TicketTecnicoInventarioSerie[0];
            AssignAttri(sPrefix, false, "A74TicketTecnicoInventarioSerie", A74TicketTecnicoInventarioSerie);
            A72TicketTecnicoInstalacion = T000812_A72TicketTecnicoInstalacion[0];
            AssignAttri(sPrefix, false, "A72TicketTecnicoInstalacion", A72TicketTecnicoInstalacion);
            A66TicketTecnicoConfiguracion = T000812_A66TicketTecnicoConfiguracion[0];
            AssignAttri(sPrefix, false, "A66TicketTecnicoConfiguracion", A66TicketTecnicoConfiguracion);
            A73TicketTecnicoInternetRouter = T000812_A73TicketTecnicoInternetRouter[0];
            AssignAttri(sPrefix, false, "A73TicketTecnicoInternetRouter", A73TicketTecnicoInternetRouter);
            A70TicketTecnicoFormateo = T000812_A70TicketTecnicoFormateo[0];
            AssignAttri(sPrefix, false, "A70TicketTecnicoFormateo", A70TicketTecnicoFormateo);
            A84TicketTecnicoReparacion = T000812_A84TicketTecnicoReparacion[0];
            AssignAttri(sPrefix, false, "A84TicketTecnicoReparacion", A84TicketTecnicoReparacion);
            A75TicketTecnicoLimpieza = T000812_A75TicketTecnicoLimpieza[0];
            AssignAttri(sPrefix, false, "A75TicketTecnicoLimpieza", A75TicketTecnicoLimpieza);
            A82TicketTecnicoPuntoRed = T000812_A82TicketTecnicoPuntoRed[0];
            AssignAttri(sPrefix, false, "A82TicketTecnicoPuntoRed", A82TicketTecnicoPuntoRed);
            A62TicketTecnicoCambiosHardware = T000812_A62TicketTecnicoCambiosHardware[0];
            AssignAttri(sPrefix, false, "A62TicketTecnicoCambiosHardware", A62TicketTecnicoCambiosHardware);
            A67TicketTecnicoCopiasRespaldo = T000812_A67TicketTecnicoCopiasRespaldo[0];
            AssignAttri(sPrefix, false, "A67TicketTecnicoCopiasRespaldo", A67TicketTecnicoCopiasRespaldo);
            A83TicketTecnicoRam = T000812_A83TicketTecnicoRam[0];
            AssignAttri(sPrefix, false, "A83TicketTecnicoRam", A83TicketTecnicoRam);
            A68TicketTecnicoDiscoDuro = T000812_A68TicketTecnicoDiscoDuro[0];
            AssignAttri(sPrefix, false, "A68TicketTecnicoDiscoDuro", A68TicketTecnicoDiscoDuro);
            A81TicketTecnicoProcesador = T000812_A81TicketTecnicoProcesador[0];
            AssignAttri(sPrefix, false, "A81TicketTecnicoProcesador", A81TicketTecnicoProcesador);
            A76TicketTecnicoMaletin = T000812_A76TicketTecnicoMaletin[0];
            AssignAttri(sPrefix, false, "A76TicketTecnicoMaletin", A76TicketTecnicoMaletin);
            A86TicketTecnicoTonerCinta = T000812_A86TicketTecnicoTonerCinta[0];
            AssignAttri(sPrefix, false, "A86TicketTecnicoTonerCinta", A86TicketTecnicoTonerCinta);
            A85TicketTecnicoTarjetaVideoExtra = T000812_A85TicketTecnicoTarjetaVideoExtra[0];
            AssignAttri(sPrefix, false, "A85TicketTecnicoTarjetaVideoExtra", A85TicketTecnicoTarjetaVideoExtra);
            A63TicketTecnicoCargadorLaptop = T000812_A63TicketTecnicoCargadorLaptop[0];
            AssignAttri(sPrefix, false, "A63TicketTecnicoCargadorLaptop", A63TicketTecnicoCargadorLaptop);
            A64TicketTecnicoCDsDVDs = T000812_A64TicketTecnicoCDsDVDs[0];
            AssignAttri(sPrefix, false, "A64TicketTecnicoCDsDVDs", A64TicketTecnicoCDsDVDs);
            A61TicketTecnicoCableEspecial = T000812_A61TicketTecnicoCableEspecial[0];
            AssignAttri(sPrefix, false, "A61TicketTecnicoCableEspecial", A61TicketTecnicoCableEspecial);
            A78TicketTecnicoOtrosTaller = T000812_A78TicketTecnicoOtrosTaller[0];
            AssignAttri(sPrefix, false, "A78TicketTecnicoOtrosTaller", A78TicketTecnicoOtrosTaller);
            A65TicketTecnicoCerrado = T000812_A65TicketTecnicoCerrado[0];
            AssignAttri(sPrefix, false, "A65TicketTecnicoCerrado", A65TicketTecnicoCerrado);
            A80TicketTecnicoPendiente = T000812_A80TicketTecnicoPendiente[0];
            AssignAttri(sPrefix, false, "A80TicketTecnicoPendiente", A80TicketTecnicoPendiente);
            A79TicketTecnicoPasaTaller = T000812_A79TicketTecnicoPasaTaller[0];
            AssignAttri(sPrefix, false, "A79TicketTecnicoPasaTaller", A79TicketTecnicoPasaTaller);
            A77TicketTecnicoObservacion = T000812_A77TicketTecnicoObservacion[0];
            n77TicketTecnicoObservacion = T000812_n77TicketTecnicoObservacion[0];
            AssignAttri(sPrefix, false, "A77TicketTecnicoObservacion", A77TicketTecnicoObservacion);
            A97TicketTecnicoDetalle = T000812_A97TicketTecnicoDetalle[0];
            AssignAttri(sPrefix, false, "A97TicketTecnicoDetalle", A97TicketTecnicoDetalle);
            A14TicketId = T000812_A14TicketId[0];
            AssignAttri(sPrefix, false, "A14TicketId", StringUtil.LTrimStr( (decimal)(A14TicketId), 10, 0));
            A6ResponsableId = T000812_A6ResponsableId[0];
            AssignAttri(sPrefix, false, "A6ResponsableId", StringUtil.LTrimStr( (decimal)(A6ResponsableId), 4, 0));
            A171SgActividadId = T000812_A171SgActividadId[0];
            AssignAttri(sPrefix, false, "A171SgActividadId", StringUtil.LTrimStr( (decimal)(A171SgActividadId), 9, 0));
            A16TicketResponsableId = T000812_A16TicketResponsableId[0];
            AssignAttri(sPrefix, false, "A16TicketResponsableId", StringUtil.LTrimStr( (decimal)(A16TicketResponsableId), 10, 0));
            A173SgActividadIdCategoria = T000812_A173SgActividadIdCategoria[0];
            AssignAttri(sPrefix, false, "A173SgActividadIdCategoria", StringUtil.LTrimStr( (decimal)(A173SgActividadIdCategoria), 9, 0));
            A15UsuarioId = T000812_A15UsuarioId[0];
            AssignAttri(sPrefix, false, "A15UsuarioId", StringUtil.LTrimStr( (decimal)(A15UsuarioId), 10, 0));
            ZM089( -26) ;
         }
         pr_default.close(7);
      ...
      protected void CheckExtendedTable089( )
      {
         ...
         pr_default.execute(6, new Object[] {A294CategoriaDetalleTareaId});
      ...
      protected void gxLoad_27( long A14TicketId )
      {
         /* Using cursor T000813 */
         pr_default.execute(8, new Object[] {A14TicketId});
         ...
         A15UsuarioId = T000813_A15UsuarioId[0];
         AssignAttri(sPrefix, false, "A15UsuarioId", StringUtil.LTrimStr( (decimal)(A15UsuarioId), 10, 0));
      ...
      protected void gxLoad_32( long A15UsuarioId )
      {
         ...
         pr_default.execute(9, new Object[] {A15UsuarioId});
         if ( (pr_default.getStatus(9) == 101) )
         {
            GX_msglist.addItem("No existe 'Usuario'.", "ForeignKeyNotFound", 1, "USUARIOID");
            AnyError = 1;
         }
         A93UsuarioNombre = T000814_A93UsuarioNombre[0];
         AssignAttri(sPrefix, false, "A93UsuarioNombre", A93UsuarioNombre);
         A94UsuarioRequerimiento = T000814_A94UsuarioRequerimiento[0];
         AssignAttri(sPrefix, false, "A94UsuarioRequerimiento", A94UsuarioRequerimiento);
         A88UsuarioDepartamento = T000814_A88UsuarioDepartamento[0];
         AssignAttri(sPrefix, false, "A88UsuarioDepartamento", A88UsuarioDepartamento);
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void gxLoad_30( long A14TicketId ,
                                long A16TicketResponsableId )
      {
         /* Using cursor T000815 */
         pr_default.execute(10, new Object[] {A14TicketId, A16TicketResponsableId});
         ...
         A294CategoriaDetalleTareaId = T000815_A294CategoriaDetalleTareaId[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
         AddString( "\""+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A294CategoriaDetalleTareaId), 4, 0, ".", "")))+"\"") ;
         AddString( "]") ;
         if ( (pr_default.getStatus(10) == 101) )
         {
            AddString( ",") ;
      ...
      protected void gxLoad_33( short A294CategoriaDetalleTareaId )
      {
         /* Using cursor T000816 */
         pr_default.execute(11, new Object[] {A294CategoriaDetalleTareaId});
      ...
      protected void gxLoad_28( short A6ResponsableId )
      {
         ...
         A30ResponsableNombre = T000817_A30ResponsableNombre[0];
         AssignAttri(sPrefix, false, "A30ResponsableNombre", A30ResponsableNombre);
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void gxLoad_29( int A171SgActividadId )
      {
         /* Using cursor T00086 */
         pr_datastore1.execute(0, new Object[] {A171SgActividadId});
         if ( (pr_datastore1.getStatus(0) == 101) )
      ...
      protected void gxLoad_31( int A173SgActividadIdCategoria )
      {
         ...
         A106nombre_categoria = T000818_A106nombre_categoria[0];
         n106nombre_categoria = T000818_n106nombre_categoria[0];
         A174SgActividadNombreCategoria = T000818_A106nombre_categoria[0];
         AssignAttri(sPrefix, false, "A174SgActividadNombreCategoria", A174SgActividadNombreCategoria);
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void move_next( )
      {
         ...
         pr_default.execute(14, new Object[] {A18TicketTecnicoId});
         if ( (pr_default.getStatus(14) != 101) )
         {
            while ( (pr_default.getStatus(14) != 101) && ( ( T000820_A18TicketTecnicoId[0] < A18TicketTecnicoId ) ) )
            {
               pr_default.readNext(14);
            }
            if ( (pr_default.getStatus(14) != 101) && ( ( T000820_A18TicketTecnicoId[0] > A18TicketTecnicoId ) ) )
            {
      ...
      protected void move_previous( )
      {
         ...
         pr_default.execute(15, new Object[] {A18TicketTecnicoId});
         if ( (pr_default.getStatus(15) != 101) )
         {
            while ( (pr_default.getStatus(15) != 101) && ( ( T000821_A18TicketTecnicoId[0] > A18TicketTecnicoId ) ) )
            {
               pr_default.readNext(15);
            }
            if ( (pr_default.getStatus(15) != 101) && ( ( T000821_A18TicketTecnicoId[0] < A18TicketTecnicoId ) ) )
            {
               A18TicketTecnicoId = T000821_A18TicketTecnicoId[0];
               AssignAttri(sPrefix, false, "A18TicketTecnicoId", StringUtil.LTrimStr( (decimal)(A18TicketTecnicoId), 10, 0));
               RcdFound9 = 1;
            }
         }
      ...
      protected void CheckOptimisticConcurrency089( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( Gx_longc || ( Z77TicketTecnicoObservacion != T00082_A77TicketTecnicoObservacion[0] ) || ( StringUtil.StrCmp(Z97TicketTecnicoDetalle, T00082_A97TicketTecnicoDetalle[0]) != 0 ) || ( Z14TicketId != T00082_A14TicketId[0] ) || ( Z6ResponsableId != T00082_A6ResponsableId[0] ) || ( Z171SgActividadId != T00082_A171SgActividadId[0] ) )
            {
               Gx_longc = true;
            }
            if ( Gx_longc || ( Z16TicketResponsableId != T00082_A16TicketResponsableId[0] ) || ( Z173SgActividadIdCategoria != T00082_A173SgActividadIdCategoria[0] ) )
            {
               if ( DateTimeUtil.ResetTime ( Z69TicketTecnicoFecha ) != DateTimeUtil.ResetTime ( T00082_A69TicketTecnicoFecha[0] ) )
               {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(16, new Object[] {A18TicketTecnicoId, A69TicketTecnicoFecha, A71TicketTecnicoHora, A74TicketTecnicoInventarioSerie, A72TicketTecnicoInstalacion, A66TicketTecnicoConfiguracion, A73TicketTecnicoInternetRouter, A70TicketTecnicoFormateo, A84TicketTecnicoReparacion, A75TicketTecnicoLimpieza, A82TicketTecnicoPuntoRed, A62TicketTecnicoCambiosHardware, A67TicketTecnicoCopiasRespaldo, A83TicketTecnicoRam, A68TicketTecnicoDiscoDuro, A81TicketTecnicoProcesador, A76TicketTecnicoMaletin, A86TicketTecnicoTonerCinta, A85TicketTecnicoTarjetaVideoExtra, A63TicketTecnicoCargadorLaptop, A64TicketTecnicoCDsDVDs, A61TicketTecnicoCableEspecial, A78TicketTecnicoOtrosTaller, A65TicketTecnicoCerrado, A80TicketTecnicoPendiente, A79TicketTecnicoPasaTaller, n77TicketTecnicoObservacion, A77TicketTecnicoObservacion, A97TicketTecnicoDetalle, A14TicketId, A6ResponsableId, A171SgActividadId, A16TicketResponsableId, A173SgActividadIdCategoria});
                     pr_default.close(16);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(17, new Object[] {A69TicketTecnicoFecha, A71TicketTecnicoHora, A74TicketTecnicoInventarioSerie, A72TicketTecnicoInstalacion, A66TicketTecnicoConfiguracion, A73TicketTecnicoInternetRouter, A70TicketTecnicoFormateo, A84TicketTecnicoReparacion, A75TicketTecnicoLimpieza, A82TicketTecnicoPuntoRed, A62TicketTecnicoCambiosHardware, A67TicketTecnicoCopiasRespaldo, A83TicketTecnicoRam, A68TicketTecnicoDiscoDuro, A81TicketTecnicoProcesador, A76TicketTecnicoMaletin, A86TicketTecnicoTonerCinta, A85TicketTecnicoTarjetaVideoExtra, A63TicketTecnicoCargadorLaptop, A64TicketTecnicoCDsDVDs, A61TicketTecnicoCableEspecial, A78TicketTecnicoOtrosTaller, A65TicketTecnicoCerrado, A80TicketTecnicoPendiente, A79TicketTecnicoPasaTaller, n77TicketTecnicoObservacion, A77TicketTecnicoObservacion, A97TicketTecnicoDetalle, A14TicketId, A6ResponsableId, A171SgActividadId, A16TicketResponsableId, A173SgActividadIdCategoria, A18TicketTecnicoId});
                     pr_default.close(17);
                     dsDefault.SmartCacheProvider.SetUpdated("TicketTecnico");
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(18, new Object[] {A18TicketTecnicoId});
                  pr_default.close(18);
                  dsDefault.SmartCacheProvider.SetUpdated("TicketTecnico");
                  if ( AnyError == 0 )
                  {
      ...
      protected void OnDeleteControls089( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            pr_default.execute(19, new Object[] {A14TicketId});
            A15UsuarioId = T000825_A15UsuarioId[0];
            AssignAttri(sPrefix, false, "A15UsuarioId", StringUtil.LTrimStr( (decimal)(A15UsuarioId), 10, 0));
            pr_default.close(19);
            /* Using cursor T000826 */
            pr_default.execute(20, new Object[] {A15UsuarioId});
            A93UsuarioNombre = T000826_A93UsuarioNombre[0];
            AssignAttri(sPrefix, false, "A93UsuarioNombre", A93UsuarioNombre);
            A94UsuarioRequerimiento = T000826_A94UsuarioRequerimiento[0];
            AssignAttri(sPrefix, false, "A94UsuarioRequerimiento", A94UsuarioRequerimiento);
            A88UsuarioDepartamento = T000826_A88UsuarioDepartamento[0];
            AssignAttri(sPrefix, false, "A88UsuarioDepartamento", A88UsuarioDepartamento);
            pr_default.close(20);
            GXt_boolean2 = false;
            new k2bisauthorizedactivityname(context ).execute(  "Usuario",  "Usuario",  "Display",  "",  "EntityManagerUsuario", out  GXt_boolean2) ;
            ...
            A294CategoriaDetalleTareaId = T000827_A294CategoriaDetalleTareaId[0];
            pr_default.close(21);
            /* Using cursor T000828 */
            pr_default.execute(22, new Object[] {A6ResponsableId});
            A30ResponsableNombre = T000828_A30ResponsableNombre[0];
            AssignAttri(sPrefix, false, "A30ResponsableNombre", A30ResponsableNombre);
            pr_default.close(22);
            /* Using cursor T000829 */
            pr_datastore1.execute(4, new Object[] {A171SgActividadId});
            A123nombre_actividad = T000829_A123nombre_actividad[0];
            n123nombre_actividad = T000829_n123nombre_actividad[0];
            A172SgActividadNombre = T000829_A123nombre_actividad[0];
            AssignAttri(sPrefix, false, "A172SgActividadNombre", A172SgActividadNombre);
            pr_datastore1.close(4);
            /* Using cursor T000830 */
            pr_datastore1.execute(5, new Object[] {A173SgActividadIdCategoria});
            A106nombre_categoria = T000830_A106nombre_categoria[0];
            n106nombre_categoria = T000830_n106nombre_categoria[0];
            A174SgActividadNombreCategoria = T000830_A106nombre_categoria[0];
            AssignAttri(sPrefix, false, "A174SgActividadNombreCategoria", A174SgActividadNombreCategoria);
      ...
      public void ScanStart089( )
      {
         ...
         {
            RcdFound9 = 1;
            A18TicketTecnicoId = T000831_A18TicketTecnicoId[0];
            AssignAttri(sPrefix, false, "A18TicketTecnicoId", StringUtil.LTrimStr( (decimal)(A18TicketTecnicoId), 10, 0));
         }
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188114460", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"N6ResponsableId", StringUtil.LTrim( StringUtil.NToC( (decimal)(A6ResponsableId), 4, 0, ".", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vINSERT_RESPONSABLEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV33Insert_ResponsableId), 4, 0, ".", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"ID_ACTIVIDAD_CATEGORIA", StringUtil.LTrim( StringUtil.NToC( (decimal)(A102id_actividad_categoria), 9, 0, ".", "")));
      ...
      protected void InitializeNonKey089( )
      {
         ...
         A16TicketResponsableId = 0;
         AssignAttri(sPrefix, false, "A16TicketResponsableId", StringUtil.LTrimStr( (decimal)(A16TicketResponsableId), 10, 0));
         A6ResponsableId = AV29ResponsableId;
         AssignAttri(sPrefix, false, "A6ResponsableId", StringUtil.LTrimStr( (decimal)(A6ResponsableId), 4, 0));
         A171SgActividadId = 0;
         AssignAttri(sPrefix, false, "A171SgActividadId", StringUtil.LTrimStr( (decimal)(A171SgActividadId), 9, 0));
         A173SgActividadIdCategoria = 0;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188114526", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("tickettecnico.js", "?2024188114527", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      protected void GXASA93089( long A15UsuarioId )
      {
         GXt_boolean2 = false;
         new k2bisauthorizedactivityname(context ).execute(  "Usuario",  "Usuario",  "Display",  "",  "EntityManagerUsuario", out  GXt_boolean2) ;
         if ( ( StringUtil.StrCmp(Gx_mode, "DSP") == 0 ) && GXt_boolean2 )
      ...
      public void Valid_Ticketid( )
      {
         ...
         pr_default.execute(24, new Object[] {A294CategoriaDetalleTareaId});
         ...
         AssignAttri(sPrefix, false, "A88UsuarioDepartamento", A88UsuarioDepartamento);
         AssignProp(sPrefix, false, edtUsuarioNombre_Internalname, "Link", edtUsuarioNombre_Link, true);
         AssignAttri(sPrefix, false, "A294CategoriaDetalleTareaId", StringUtil.LTrim( StringUtil.NToC( (decimal)(A294CategoriaDetalleTareaId), 4, 0, ".", "")));
      }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALID_TICKETRESPONSABLEID",",oparms:[{av:'A72TicketTecnicoInstalacion',fld:'TICKETTECNICOINSTALACION',pic:''},{av:'A66TicketTecnicoConfiguracion',fld:'TICKETTECNICOCONFIGURACION',pic:''},{av:'A73TicketTecnicoInternetRouter',fld:'TICKETTECNICOINTERNETROUTER',pic:''},{av:'A70TicketTecnicoFormateo',fld:'TICKETTECNICOFORMATEO',pic:''},{av:'A84TicketTecnicoReparacion',fld:'TICKETTECNICOREPARACION',pic:''},{av:'A75TicketTecnicoLimpieza',fld:'TICKETTECNICOLIMPIEZA',pic:''},{av:'A82TicketTecnicoPuntoRed',fld:'TICKETTECNICOPUNTORED',pic:''},{av:'A62TicketTecnicoCambiosHardware',fld:'TICKETTECNICOCAMBIOSHARDWARE',pic:''},{av:'A67TicketTecnicoCopiasRespaldo',fld:'TICKETTECNICOCOPIASRESPALDO',pic:''},{av:'A65TicketTecnicoCerrado',fld:'TICKETTECNICOCERRADO',pic:''},{av:'A80TicketTecnicoPendiente',fld:'TICKETTECNICOPENDIENTE',pic:''},{av:'A79TicketTecnicoPasaTaller',fld:'TICKETTECNICOPASATALLER',pic:''},{av:'A77TicketTecnicoObservacion',fld:'TICKETTECNICOOBSERVACION',pic:''},{av:'A83TicketTecnicoRam',fld:'TICKETTECNICORAM',pic:''},{av:'A68TicketTecnicoDiscoDuro',fld:'TICKETTECNICODISCODURO',pic:''},{av:'A81TicketTecnicoProcesador',fld:'TICKETTECNICOPROCESADOR',pic:''},{av:'A76TicketTecnicoMaletin',fld:'TICKETTECNICOMALETIN',pic:''},{av:'A86TicketTecnicoTonerCinta',fld:'TICKETTECNICOTONERCINTA',pic:''},{av:'A85TicketTecnicoTarjetaVideoExtra',fld:'TICKETTECNICOTARJETAVIDEOEXTRA',pic:''},{av:'A63TicketTecnicoCargadorLaptop',fld:'TICKETTECNICOCARGADORLAPTOP',pic:''},{av:'A64TicketTecnicoCDsDVDs',fld:'TICKETTECNICOCDSDVDS',pic:''},{av:'A61TicketTecnicoCableEspecial',fld:'TICKETTECNICOCABLEESPECIAL',pic:''},{av:'A78TicketTecnicoOtrosTaller',fld:'TICKETTECNICOOTROSTALLER',pic:''}]}");
         setEventMetadata("VALID_TICKETID","{handler:'Valid_Ticketid',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!'},{av:'A14TicketId',fld:'TICKETID',pic:'ZZZZZZZZZ9'},{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZZZZZZZ9'},{av:'A16TicketResponsableId',fld:'TICKETRESPONSABLEID',pic:'ZZZZZZZZZ9'},{av:'A294CategoriaDetalleTareaId',fld:'CATEGORIADETALLETAREAID',pic:'ZZZ9'},{av:'A93UsuarioNombre',fld:'USUARIONOMBRE',pic:''},{av:'A94UsuarioRequerimiento',fld:'USUARIOREQUERIMIENTO',pic:''},{av:'A88UsuarioDepartamento',fld:'USUARIODEPARTAMENTO',pic:''},{av:'A72TicketTecnicoInstalacion',fld:'TICKETTECNICOINSTALACION',pic:''},{av:'A66TicketTecnicoConfiguracion',fld:'TICKETTECNICOCONFIGURACION',pic:''},{av:'A73TicketTecnicoInternetRouter',fld:'TICKETTECNICOINTERNETROUTER',pic:''},{av:'A70TicketTecnicoFormateo',fld:'TICKETTECNICOFORMATEO',pic:''},{av:'A84TicketTecnicoReparacion',fld:'TICKETTECNICOREPARACION',pic:''},{av:'A75TicketTecnicoLimpieza',fld:'TICKETTECNICOLIMPIEZA',pic:''},{av:'A82TicketTecnicoPuntoRed',fld:'TICKETTECNICOPUNTORED',pic:''},{av:'A62TicketTecnicoCambiosHardware',fld:'TICKETTECNICOCAMBIOSHARDWARE',pic:''},{av:'A67TicketTecnicoCopiasRespaldo',fld:'TICKETTECNICOCOPIASRESPALDO',pic:''},{av:'A65TicketTecnicoCerrado',fld:'TICKETTECNICOCERRADO',pic:''},{av:'A80TicketTecnicoPendiente',fld:'TICKETTECNICOPENDIENTE',pic:''},{av:'A79TicketTecnicoPasaTaller',fld:'TICKETTECNICOPASATALLER',pic:''},{av:'A77TicketTecnicoObservacion',fld:'TICKETTECNICOOBSERVACION',pic:''},{av:'A83TicketTecnicoRam',fld:'TICKETTECNICORAM',pic:''},{av:'A68TicketTecnicoDiscoDuro',fld:'TICKETTECNICODISCODURO',pic:''},{av:'A81TicketTecnicoProcesador',fld:'TICKETTECNICOPROCESADOR',pic:''},{av:'A76TicketTecnicoMaletin',fld:'TICKETTECNICOMALETIN',pic:''},{av:'A86TicketTecnicoTonerCinta',fld:'TICKETTECNICOTONERCINTA',pic:''},{av:'A85TicketTecnicoTarjetaVideoExtra',fld:'TICKETTECNICOTARJETAVIDEOEXTRA',pic:''},{av:'A63TicketTecnicoCargadorLaptop',fld:'TICKETTECNICOCARGADORLAPTOP',pic:''},{av:'A64TicketTecnicoCDsDVDs',fld:'TICKETTECNICOCDSDVDS',pic:''},{av:'A61TicketTecnicoCableEspecial',fld:'TICKETTECNICOCABLEESPECIAL',pic:''},{av:'A78TicketTecnicoOtrosTaller',fld:'TICKETTECNICOOTROSTALLER',pic:''}]");
         setEventMetadata("VALID_TICKETID",",oparms:[{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZZZZZZZ9'},{av:'A93UsuarioNombre',fld:'USUARIONOMBRE',pic:''},{av:'A94UsuarioRequerimiento',fld:'USUARIOREQUERIMIENTO',pic:''},{av:'A88UsuarioDepartamento',fld:'USUARIODEPARTAMENTO',pic:''},{av:'edtUsuarioNombre_Link',ctrl:'USUARIONOMBRE',prop:'Link'},{av:'A294CategoriaDetalleTareaId',fld:'CATEGORIADETALLETAREAID',pic:'ZZZ9'},{av:'A72TicketTecnicoInstalacion',fld:'TICKETTECNICOINSTALACION',pic:''},{av:'A66TicketTecnicoConfiguracion',fld:'TICKETTECNICOCONFIGURACION',pic:''},{av:'A73TicketTecnicoInternetRouter',fld:'TICKETTECNICOINTERNETROUTER',pic:''},{av:'A70TicketTecnicoFormateo',fld:'TICKETTECNICOFORMATEO',pic:''},{av:'A84TicketTecnicoReparacion',fld:'TICKETTECNICOREPARACION',pic:''},{av:'A75TicketTecnicoLimpieza',fld:'TICKETTECNICOLIMPIEZA',pic:''},{av:'A82TicketTecnicoPuntoRed',fld:'TICKETTECNICOPUNTORED',pic:''},{av:'A62TicketTecnicoCambiosHardware',fld:'TICKETTECNICOCAMBIOSHARDWARE',pic:''},{av:'A67TicketTecnicoCopiasRespaldo',fld:'TICKETTECNICOCOPIASRESPALDO',pic:''},{av:'A65TicketTecnicoCerrado',fld:'TICKETTECNICOCERRADO',pic:''},{av:'A80TicketTecnicoPendiente',fld:'TICKETTECNICOPENDIENTE',pic:''},{av:'A79TicketTecnicoPasaTaller',fld:'TICKETTECNICOPASATALLER',pic:''},{av:'A77TicketTecnicoObservacion',fld:'TICKETTECNICOOBSERVACION',pic:''},{av:'A83TicketTecnicoRam',fld:'TICKETTECNICORAM',pic:''},{av:'A68TicketTecnicoDiscoDuro',fld:'TICKETTECNICODISCODURO',pic:''},{av:'A81TicketTecnicoProcesador',fld:'TICKETTECNICOPROCESADOR',pic:''},{av:'A76TicketTecnicoMaletin',fld:'TICKETTECNICOMALETIN',pic:''},{av:'A86TicketTecnicoTonerCinta',fld:'TICKETTECNICOTONERCINTA',pic:''},{av:'A85TicketTecnicoTarjetaVideoExtra',fld:'TICKETTECNICOTARJETAVIDEOEXTRA',pic:''},{av:'A63TicketTecnicoCargadorLaptop',fld:'TICKETTECNICOCARGADORLAPTOP',pic:''},{av:'A64TicketTecnicoCDsDVDs',fld:'TICKETTECNICOCDSDVDS',pic:''},{av:'A61TicketTecnicoCableEspecial',fld:'TICKETTECNICOCABLEESPECIAL',pic:''},{av:'A78TicketTecnicoOtrosTaller',fld:'TICKETTECNICOOTROSTALLER',pic:''}]}");
      ...
      public override void initialize( )
      {
         ...
         T00086_A102id_actividad_categoria = new int[1] ;
         T00086_A123nombre_actividad = new string[] {""} ;
         T00086_n123nombre_actividad = new bool[] {false} ;
         A123nombre_actividad = "";
         T00085_A30ResponsableNombre = new string[] {""} ;
         T00084_A15UsuarioId = new long[1] ;
         T00089_A93UsuarioNombre = new string[] {""} ;
         T00089_A94UsuarioRequerimiento = new string[] {""} ;
         T00089_A88UsuarioDepartamento = new string[] {""} ;
         T00087_A294CategoriaDetalleTareaId = new short[1] ;
         T000812_A294CategoriaDetalleTareaId = new short[1] ;
         T000812_A18TicketTecnicoId = new long[1] ;
         T000812_A69TicketTecnicoFecha = new DateTime[] {DateTime.MinValue} ;
         T000812_A71TicketTecnicoHora = new DateTime[] {DateTime.MinValue} ;
         T000812_A30ResponsableNombre = new string[] {""} ;
         T000812_A93UsuarioNombre = new string[] {""} ;
         T000812_A94UsuarioRequerimiento = new string[] {""} ;
         T000812_A88UsuarioDepartamento = new string[] {""} ;
         T000812_A74TicketTecnicoInventarioSerie = new string[] {""} ;
         T000812_A72TicketTecnicoInstalacion = new bool[] {false} ;
         T000812_A66TicketTecnicoConfiguracion = new bool[] {false} ;
         T000812_A73TicketTecnicoInternetRouter = new bool[] {false} ;
         T000812_A70TicketTecnicoFormateo = new bool[] {false} ;
         T000812_A84TicketTecnicoReparacion = new bool[] {false} ;
         T000812_A75TicketTecnicoLimpieza = new bool[] {false} ;
         T000812_A82TicketTecnicoPuntoRed = new bool[] {false} ;
         T000812_A62TicketTecnicoCambiosHardware = new bool[] {false} ;
         T000812_A67TicketTecnicoCopiasRespaldo = new bool[] {false} ;
         T000812_A83TicketTecnicoRam = new bool[] {false} ;
         T000812_A68TicketTecnicoDiscoDuro = new bool[] {false} ;
         T000812_A81TicketTecnicoProcesador = new bool[] {false} ;
         T000812_A76TicketTecnicoMaletin = new bool[] {false} ;
         T000812_A86TicketTecnicoTonerCinta = new bool[] {false} ;
         T000812_A85TicketTecnicoTarjetaVideoExtra = new bool[] {false} ;
         T000812_A63TicketTecnicoCargadorLaptop = new bool[] {false} ;
         T000812_A64TicketTecnicoCDsDVDs = new bool[] {false} ;
         T000812_A61TicketTecnicoCableEspecial = new bool[] {false} ;
         T000812_A78TicketTecnicoOtrosTaller = new bool[] {false} ;
         T000812_A65TicketTecnicoCerrado = new bool[] {false} ;
         T000812_A80TicketTecnicoPendiente = new bool[] {false} ;
         T000812_A79TicketTecnicoPasaTaller = new bool[] {false} ;
         T000812_A77TicketTecnicoObservacion = new bool[] {false} ;
         T000812_n77TicketTecnicoObservacion = new bool[] {false} ;
         T000812_A97TicketTecnicoDetalle = new string[] {""} ;
         T000812_A14TicketId = new long[1] ;
         T000812_A6ResponsableId = new short[1] ;
         T000812_A171SgActividadId = new int[1] ;
         T000812_A16TicketResponsableId = new long[1] ;
         T000812_A173SgActividadIdCategoria = new int[1] ;
         T000812_A15UsuarioId = new long[1] ;
         T000810_A294CategoriaDetalleTareaId = new short[1] ;
         T000813_A15UsuarioId = new long[1] ;
         T000814_A93UsuarioNombre = new string[] {""} ;
         T000814_A94UsuarioRequerimiento = new string[] {""} ;
         T000814_A88UsuarioDepartamento = new string[] {""} ;
         T000815_A294CategoriaDetalleTareaId = new short[1] ;
         T000816_A294CategoriaDetalleTareaId = new short[1] ;
         T000817_A30ResponsableNombre = new string[] {""} ;
         T000818_A104categoria_tareaid_tipo_categoria = new int[1] ;
         T000818_A106nombre_categoria = new string[] {""} ;
         T000818_n106nombre_categoria = new bool[] {false} ;
         ...
         T000821_A18TicketTecnicoId = new long[1] ;
         ...
         T000825_A15UsuarioId = new long[1] ;
         T000826_A93UsuarioNombre = new string[] {""} ;
         T000826_A94UsuarioRequerimiento = new string[] {""} ;
         T000826_A88UsuarioDepartamento = new string[] {""} ;
         T000827_A294CategoriaDetalleTareaId = new short[1] ;
         T000828_A30ResponsableNombre = new string[] {""} ;
         T000829_A123nombre_actividad = new string[] {""} ;
         T000829_n123nombre_actividad = new bool[] {false} ;
         T000830_A106nombre_categoria = new string[] {""} ;
         T000830_n106nombre_categoria = new bool[] {false} ;
         T000831_A18TicketTecnicoId = new long[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         ...
         T000832_A294CategoriaDetalleTareaId = new short[1] ;
         ...
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.tickettecnico__datastore1(),
            new Object[][] {
                new Object[] {
               T00086_A102id_actividad_categoria, T00086_A123nombre_actividad, T00086_n123nombre_actividad
               }
               , new Object[] {
               T00088_A104categoria_tareaid_tipo_categoria, T00088_A106nombre_categoria, T00088_n106nombre_categoria
               }
               , new Object[] {
               T000811_A102id_actividad_categoria, T000811_A123nombre_actividad, T000811_n123nombre_actividad
               }
               , new Object[] {
               T000818_A104categoria_tareaid_tipo_categoria, T000818_A106nombre_categoria, T000818_n106nombre_categoria
               }
               , new Object[] {
               T000829_A123nombre_actividad, T000829_n123nombre_actividad
               }
               , new Object[] {
               T000830_A106nombre_categoria, T000830_n106nombre_categoria
               }
            }
         );
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tickettecnico__default(),
            new Object[][] {
               ...
               T00082_A6ResponsableId, T00082_A171SgActividadId, T00082_A16TicketResponsableId, T00082_A173SgActividadIdCategoria
               }
               , new Object[] {
               ...
               T00083_A6ResponsableId, T00083_A171SgActividadId, T00083_A16TicketResponsableId, T00083_A173SgActividadIdCategoria
               }
               , new Object[] {
               T00084_A15UsuarioId
               }
               ...
               , new Object[] {
               T00087_A294CategoriaDetalleTareaId
               }
               , new Object[] {
               T00089_A93UsuarioNombre, T00089_A94UsuarioRequerimiento, T00089_A88UsuarioDepartamento
               }
               , new Object[] {
               T000810_A294CategoriaDetalleTareaId
               }
               , new Object[] {
               T000812_A294CategoriaDetalleTareaId, T000812_A18TicketTecnicoId, T000812_A69TicketTecnicoFecha, T000812_A71TicketTecnicoHora, T000812_A30ResponsableNombre, T000812_A93UsuarioNombre, T000812_A94UsuarioRequerimiento, T000812_A88UsuarioDepartamento, T000812_A74TicketTecnicoInventarioSerie, T000812_A72TicketTecnicoInstalacion,
               T000812_A66TicketTecnicoConfiguracion, T000812_A73TicketTecnicoInternetRouter, T000812_A70TicketTecnicoFormateo, T000812_A84TicketTecnicoReparacion, T000812_A75TicketTecnicoLimpieza, T000812_A82TicketTecnicoPuntoRed, T000812_A62TicketTecnicoCambiosHardware, T000812_A67TicketTecnicoCopiasRespaldo, T000812_A83TicketTecnicoRam, T000812_A68TicketTecnicoDiscoDuro,
               T000812_A81TicketTecnicoProcesador, T000812_A76TicketTecnicoMaletin, T000812_A86TicketTecnicoTonerCinta, T000812_A85TicketTecnicoTarjetaVideoExtra, T000812_A63TicketTecnicoCargadorLaptop, T000812_A64TicketTecnicoCDsDVDs, T000812_A61TicketTecnicoCableEspecial, T000812_A78TicketTecnicoOtrosTaller, T000812_A65TicketTecnicoCerrado, T000812_A80TicketTecnicoPendiente,
               T000812_A79TicketTecnicoPasaTaller, T000812_A77TicketTecnicoObservacion, T000812_n77TicketTecnicoObservacion, T000812_A97TicketTecnicoDetalle, T000812_A14TicketId, T000812_A6ResponsableId, T000812_A171SgActividadId, T000812_A16TicketResponsableId, T000812_A173SgActividadIdCategoria, T000812_A15UsuarioId
               }
               , new Object[] {
               T000813_A15UsuarioId
               }
               , new Object[] {
               T000814_A93UsuarioNombre, T000814_A94UsuarioRequerimiento, T000814_A88UsuarioDepartamento
               }
               , new Object[] {
               T000815_A294CategoriaDetalleTareaId
               }
               , new Object[] {
               T000816_A294CategoriaDetalleTareaId
               }
               , new Object[] {
               T000817_A30ResponsableNombre
               }
               , new Object[] {
               ...
               , new Object[] {
               T000825_A15UsuarioId
               }
               , new Object[] {
               T000826_A93UsuarioNombre, T000826_A94UsuarioRequerimiento, T000826_A88UsuarioDepartamento
               }
               , new Object[] {
               T000827_A294CategoriaDetalleTareaId
               }
               , new Object[] {
               T000828_A30ResponsableNombre
               }
               , new Object[] {
               T000831_A18TicketTecnicoId
               }
               , new Object[] {
               T000832_A294CategoriaDetalleTareaId
               }
            }
         );
         AV35Pgmname = "TicketTecnico";
      ...
      private int[] T00086_A102id_actividad_categoria ;
      private string[] T00086_A123nombre_actividad ;
      private bool[] T00086_n123nombre_actividad ;
      private IDataStoreProvider pr_default ;
      private string[] T00085_A30ResponsableNombre ;
      private long[] T00084_A15UsuarioId ;
      ...
      private short[] T00087_A294CategoriaDetalleTareaId ;
      private short[] T000812_A294CategoriaDetalleTareaId ;
      private long[] T000812_A18TicketTecnicoId ;
      private DateTime[] T000812_A69TicketTecnicoFecha ;
      private DateTime[] T000812_A71TicketTecnicoHora ;
      private string[] T000812_A30ResponsableNombre ;
      ...
      private string[] T000812_A74TicketTecnicoInventarioSerie ;
      private bool[] T000812_A72TicketTecnicoInstalacion ;
      private bool[] T000812_A66TicketTecnicoConfiguracion ;
      private bool[] T000812_A73TicketTecnicoInternetRouter ;
      private bool[] T000812_A70TicketTecnicoFormateo ;
      private bool[] T000812_A84TicketTecnicoReparacion ;
      private bool[] T000812_A75TicketTecnicoLimpieza ;
      private bool[] T000812_A82TicketTecnicoPuntoRed ;
      private bool[] T000812_A62TicketTecnicoCambiosHardware ;
      private bool[] T000812_A67TicketTecnicoCopiasRespaldo ;
      private bool[] T000812_A83TicketTecnicoRam ;
      private bool[] T000812_A68TicketTecnicoDiscoDuro ;
      private bool[] T000812_A81TicketTecnicoProcesador ;
      private bool[] T000812_A76TicketTecnicoMaletin ;
      private bool[] T000812_A86TicketTecnicoTonerCinta ;
      private bool[] T000812_A85TicketTecnicoTarjetaVideoExtra ;
      private bool[] T000812_A63TicketTecnicoCargadorLaptop ;
      private bool[] T000812_A64TicketTecnicoCDsDVDs ;
      private bool[] T000812_A61TicketTecnicoCableEspecial ;
      private bool[] T000812_A78TicketTecnicoOtrosTaller ;
      private bool[] T000812_A65TicketTecnicoCerrado ;
      private bool[] T000812_A80TicketTecnicoPendiente ;
      private bool[] T000812_A79TicketTecnicoPasaTaller ;
      private bool[] T000812_A77TicketTecnicoObservacion ;
      private bool[] T000812_n77TicketTecnicoObservacion ;
      private string[] T000812_A97TicketTecnicoDetalle ;
      private long[] T000812_A14TicketId ;
      private short[] T000812_A6ResponsableId ;
      private int[] T000812_A171SgActividadId ;
      private long[] T000812_A16TicketResponsableId ;
      private int[] T000812_A173SgActividadIdCategoria ;
      private long[] T000812_A15UsuarioId ;
      private short[] T000810_A294CategoriaDetalleTareaId ;
      private long[] T000813_A15UsuarioId ;
      private string[] T000814_A93UsuarioNombre ;
      private string[] T000814_A94UsuarioRequerimiento ;
      private string[] T000814_A88UsuarioDepartamento ;
      private short[] T000815_A294CategoriaDetalleTareaId ;
      private short[] T000816_A294CategoriaDetalleTareaId ;
      private string[] T000817_A30ResponsableNombre ;
      private int[] T000818_A104categoria_tareaid_tipo_categoria ;
      private string[] T000818_A106nombre_categoria ;
      private bool[] T000818_n106nombre_categoria ;
      ...
      private long[] T000821_A18TicketTecnicoId ;
      ...
      private long[] T000825_A15UsuarioId ;
      private string[] T000826_A93UsuarioNombre ;
      private string[] T000826_A94UsuarioRequerimiento ;
      private string[] T000826_A88UsuarioDepartamento ;
      private short[] T000827_A294CategoriaDetalleTareaId ;
      private string[] T000828_A30ResponsableNombre ;
      private string[] T000829_A123nombre_actividad ;
      private bool[] T000829_n123nombre_actividad ;
      private string[] T000830_A106nombre_categoria ;
      private bool[] T000830_n106nombre_categoria ;
      private long[] T000831_A18TicketTecnicoId ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private short[] T000832_A294CategoriaDetalleTareaId ;
      private IDataStoreProvider pr_datastore2 ;
      private int[] T000811_A102id_actividad_categoria ;
      private string[] T000811_A123nombre_actividad ;
      private bool[] T000811_n123nombre_actividad ;
 ...
 public class tickettecnico__datastore1 : DataStoreHelperBase, IDataStoreHelper
 {
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        def= new CursorDef[] {
            new CursorDef("T00086", "SELECT [id_actividad_categoria], [nombre_actividad] FROM dbo.[actividades_categoria] WHERE [id_actividad_categoria] = @SgActividadId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00086,1, GxCacheFrequency.OFF ,true,false )
           ...
           ,new CursorDef("T000811", "SELECT [id_actividad_categoria], [nombre_actividad] FROM dbo.[actividades_categoria] WHERE [id_actividad_categoria] = @id_actividad_categoria ",true, GxErrorMask.GX_NOMASK, false, this,prmT000811,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000818", "SELECT [id_tipo_categoria] AS categoria_tareaid_tipo_categoria, [nombre_categoria] FROM dbo.[categoria_tarea] WHERE [id_tipo_categoria] = @SgActividadIdCategoria ",true, GxErrorMask.GX_NOMASK, false, this,prmT000818,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000829", "SELECT [nombre_actividad] FROM dbo.[actividades_categoria] WHERE [id_actividad_categoria] = @SgActividadId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000829,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000830", "SELECT [nombre_categoria] FROM dbo.[categoria_tarea] WHERE [id_tipo_categoria] = @SgActividadIdCategoria ",true, GxErrorMask.GX_NOMASK, false, this,prmT000830,1, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
...
public class tickettecnico__default : DataStoreHelperBase, IDataStoreHelper
{
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
           new CursorDef("T00082", "SELECT [TicketTecnicoId], [TicketTecnicoFecha], [TicketTecnicoHora], [TicketTecnicoInventarioSerie], [TicketTecnicoInstalacion], [TicketTecnicoConfiguracion], [TicketTecnicoInternetRouter], [TicketTecnicoFormateo], [TicketTecnicoReparacion], [TicketTecnicoLimpieza], [TicketTecnicoPuntoRed], [TicketTecnicoCambiosHardware], [TicketTecnicoCopiasRespaldo], [TicketTecnicoRam], [TicketTecnicoDiscoDuro], [TicketTecnicoProcesador], [TicketTecnicoMaletin], [TicketTecnicoTonerCinta], [TicketTecnicoTarjetaVideoExtra], [TicketTecnicoCargadorLaptop], [TicketTecnicoCDsDVDs], [TicketTecnicoCableEspecial], [TicketTecnicoOtrosTaller], [TicketTecnicoCerrado], [TicketTecnicoPendiente], [TicketTecnicoPasaTaller], [TicketTecnicoObservacion], [TicketTecnicoDetalle], [TicketId], [ResponsableId], [SgActividadId], [TicketResponsableId], [SgActividadIdCategoria] FROM [TicketTecnico] WITH (UPDLOCK) WHERE [TicketTecnicoId] = @TicketTecnicoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00082,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T00083", "SELECT [TicketTecnicoId], [TicketTecnicoFecha], [TicketTecnicoHora], [TicketTecnicoInventarioSerie], [TicketTecnicoInstalacion], [TicketTecnicoConfiguracion], [TicketTecnicoInternetRouter], [TicketTecnicoFormateo], [TicketTecnicoReparacion], [TicketTecnicoLimpieza], [TicketTecnicoPuntoRed], [TicketTecnicoCambiosHardware], [TicketTecnicoCopiasRespaldo], [TicketTecnicoRam], [TicketTecnicoDiscoDuro], [TicketTecnicoProcesador], [TicketTecnicoMaletin], [TicketTecnicoTonerCinta], [TicketTecnicoTarjetaVideoExtra], [TicketTecnicoCargadorLaptop], [TicketTecnicoCDsDVDs], [TicketTecnicoCableEspecial], [TicketTecnicoOtrosTaller], [TicketTecnicoCerrado], [TicketTecnicoPendiente], [TicketTecnicoPasaTaller], [TicketTecnicoObservacion], [TicketTecnicoDetalle], [TicketId], [ResponsableId], [SgActividadId], [TicketResponsableId], [SgActividadIdCategoria] FROM [TicketTecnico] WHERE [TicketTecnicoId] = @TicketTecnicoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00083,1, GxCacheFrequency.OFF ,true,false )
          ...
          ,new CursorDef("T00087", "SELECT [CategoriaDetalleTareaId] FROM [TicketResponsable] WHERE [TicketId] = @TicketId AND [TicketResponsableId] = @TicketResponsableId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00087,1, GxCacheFrequency.OFF ,true,false )
          ...
          ,new CursorDef("T000810", "SELECT [CategoriaDetalleTareaId] FROM [CategoriaDetalleTarea] WHERE [CategoriaDetalleTareaId] = @CategoriaDetalleTareaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000810,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T000812", "SELECT T4.[CategoriaDetalleTareaId], TM1.[TicketTecnicoId], TM1.[TicketTecnicoFecha], TM1.[TicketTecnicoHora], T5.[ResponsableNombre], T3.[UsuarioNombre], T3.[UsuarioRequerimiento], T3.[UsuarioDepartamento], TM1.[TicketTecnicoInventarioSerie], TM1.[TicketTecnicoInstalacion], TM1.[TicketTecnicoConfiguracion], TM1.[TicketTecnicoInternetRouter], TM1.[TicketTecnicoFormateo], TM1.[TicketTecnicoReparacion], TM1.[TicketTecnicoLimpieza], TM1.[TicketTecnicoPuntoRed], TM1.[TicketTecnicoCambiosHardware], TM1.[TicketTecnicoCopiasRespaldo], TM1.[TicketTecnicoRam], TM1.[TicketTecnicoDiscoDuro], TM1.[TicketTecnicoProcesador], TM1.[TicketTecnicoMaletin], TM1.[TicketTecnicoTonerCinta], TM1.[TicketTecnicoTarjetaVideoExtra], TM1.[TicketTecnicoCargadorLaptop], TM1.[TicketTecnicoCDsDVDs], TM1.[TicketTecnicoCableEspecial], TM1.[TicketTecnicoOtrosTaller], TM1.[TicketTecnicoCerrado], TM1.[TicketTecnicoPendiente], TM1.[TicketTecnicoPasaTaller], TM1.[TicketTecnicoObservacion], TM1.[TicketTecnicoDetalle], TM1.[TicketId], TM1.[ResponsableId], TM1.[SgActividadId], TM1.[TicketResponsableId], TM1.[SgActividadIdCategoria], T2.[UsuarioId] FROM (((([TicketTecnico] TM1 INNER JOIN [Ticket] T2 ON T2.[TicketId] = TM1.[TicketId]) INNER JOIN [Usuario] T3 ON T3.[UsuarioId] = T2.[UsuarioId]) INNER JOIN [TicketResponsable] T4 ON T4.[TicketId] = TM1.[TicketId] AND T4.[TicketResponsableId] = TM1.[TicketResponsableId]) INNER JOIN [Responsable] T5 ON T5.[ResponsableId] = TM1.[ResponsableId]) WHERE TM1.[TicketTecnicoId] = @TicketTecnicoId ORDER BY TM1.[TicketTecnicoId]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT000812,100, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T000813", "SELECT [UsuarioId] FROM [Ticket] WHERE [TicketId] = @TicketId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000813,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T000814", "SELECT [UsuarioNombre], [UsuarioRequerimiento], [UsuarioDepartamento] FROM [Usuario] WHERE [UsuarioId] = @UsuarioId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000814,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T000815", "SELECT [CategoriaDetalleTareaId] FROM [TicketResponsable] WHERE [TicketId] = @TicketId AND [TicketResponsableId] = @TicketResponsableId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000815,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T000816", "SELECT [CategoriaDetalleTareaId] FROM [CategoriaDetalleTarea] WHERE [CategoriaDetalleTareaId] = @CategoriaDetalleTareaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000816,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T000817", "SELECT [ResponsableNombre] FROM [Responsable] WHERE [ResponsableId] = @ResponsableId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000817,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T000819", "SELECT [TicketTecnicoId] FROM [TicketTecnico] WHERE [TicketTecnicoId] = @TicketTecnicoId  OPTION (FAST 1)",true, GxErrorMask.GX_NOMASK, false, this,prmT000819,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T000820", "SELECT TOP 1 [TicketTecnicoId] FROM [TicketTecnico] WHERE ( [TicketTecnicoId] > @TicketTecnicoId) ORDER BY [TicketTecnicoId]  OPTION (FAST 1)",true, GxErrorMask.GX_NOMASK, false, this,prmT000820,1, GxCacheFrequency.OFF ,true,true )
          ,new CursorDef("T000821", "SELECT TOP 1 [TicketTecnicoId] FROM [TicketTecnico] WHERE ( [TicketTecnicoId] < @TicketTecnicoId) ORDER BY [TicketTecnicoId] DESC  OPTION (FAST 1)",true, GxErrorMask.GX_NOMASK, false, this,prmT000821,1, GxCacheFrequency.OFF ,true,true )
          ,new CursorDef("T000822", "INSERT INTO [TicketTecnico]([TicketTecnicoId], [TicketTecnicoFecha], [TicketTecnicoHora], [TicketTecnicoInventarioSerie], [TicketTecnicoInstalacion], [TicketTecnicoConfiguracion], [TicketTecnicoInternetRouter], [TicketTecnicoFormateo], [TicketTecnicoReparacion], [TicketTecnicoLimpieza], [TicketTecnicoPuntoRed], [TicketTecnicoCambiosHardware], [TicketTecnicoCopiasRespaldo], [TicketTecnicoRam], [TicketTecnicoDiscoDuro], [TicketTecnicoProcesador], [TicketTecnicoMaletin], [TicketTecnicoTonerCinta], [TicketTecnicoTarjetaVideoExtra], [TicketTecnicoCargadorLaptop], [TicketTecnicoCDsDVDs], [TicketTecnicoCableEspecial], [TicketTecnicoOtrosTaller], [TicketTecnicoCerrado], [TicketTecnicoPendiente], [TicketTecnicoPasaTaller], [TicketTecnicoObservacion], [TicketTecnicoDetalle], [TicketId], [ResponsableId], [SgActividadId], [TicketResponsableId], [SgActividadIdCategoria]) VALUES(@TicketTecnicoId, @TicketTecnicoFecha, @TicketTecnicoHora, @TicketTecnicoInventarioSerie, @TicketTecnicoInstalacion, @TicketTecnicoConfiguracion, @TicketTecnicoInternetRouter, @TicketTecnicoFormateo, @TicketTecnicoReparacion, @TicketTecnicoLimpieza, @TicketTecnicoPuntoRed, @TicketTecnicoCambiosHardware, @TicketTecnicoCopiasRespaldo, @TicketTecnicoRam, @TicketTecnicoDiscoDuro, @TicketTecnicoProcesador, @TicketTecnicoMaletin, @TicketTecnicoTonerCinta, @TicketTecnicoTarjetaVideoExtra, @TicketTecnicoCargadorLaptop, @TicketTecnicoCDsDVDs, @TicketTecnicoCableEspecial, @TicketTecnicoOtrosTaller, @TicketTecnicoCerrado, @TicketTecnicoPendiente, @TicketTecnicoPasaTaller, @TicketTecnicoObservacion, @TicketTecnicoDetalle, @TicketId, @ResponsableId, @SgActividadId, @TicketResponsableId, @SgActividadIdCategoria)", GxErrorMask.GX_NOMASK,prmT000822)
          ,new CursorDef("T000823", "UPDATE [TicketTecnico] SET [TicketTecnicoFecha]=@TicketTecnicoFecha, [TicketTecnicoHora]=@TicketTecnicoHora, [TicketTecnicoInventarioSerie]=@TicketTecnicoInventarioSerie, [TicketTecnicoInstalacion]=@TicketTecnicoInstalacion, [TicketTecnicoConfiguracion]=@TicketTecnicoConfiguracion, [TicketTecnicoInternetRouter]=@TicketTecnicoInternetRouter, [TicketTecnicoFormateo]=@TicketTecnicoFormateo, [TicketTecnicoReparacion]=@TicketTecnicoReparacion, [TicketTecnicoLimpieza]=@TicketTecnicoLimpieza, [TicketTecnicoPuntoRed]=@TicketTecnicoPuntoRed, [TicketTecnicoCambiosHardware]=@TicketTecnicoCambiosHardware, [TicketTecnicoCopiasRespaldo]=@TicketTecnicoCopiasRespaldo, [TicketTecnicoRam]=@TicketTecnicoRam, [TicketTecnicoDiscoDuro]=@TicketTecnicoDiscoDuro, [TicketTecnicoProcesador]=@TicketTecnicoProcesador, [TicketTecnicoMaletin]=@TicketTecnicoMaletin, [TicketTecnicoTonerCinta]=@TicketTecnicoTonerCinta, [TicketTecnicoTarjetaVideoExtra]=@TicketTecnicoTarjetaVideoExtra, [TicketTecnicoCargadorLaptop]=@TicketTecnicoCargadorLaptop, [TicketTecnicoCDsDVDs]=@TicketTecnicoCDsDVDs, [TicketTecnicoCableEspecial]=@TicketTecnicoCableEspecial, [TicketTecnicoOtrosTaller]=@TicketTecnicoOtrosTaller, [TicketTecnicoCerrado]=@TicketTecnicoCerrado, [TicketTecnicoPendiente]=@TicketTecnicoPendiente, [TicketTecnicoPasaTaller]=@TicketTecnicoPasaTaller, [TicketTecnicoObservacion]=@TicketTecnicoObservacion, [TicketTecnicoDetalle]=@TicketTecnicoDetalle, [TicketId]=@TicketId, [ResponsableId]=@ResponsableId, [SgActividadId]=@SgActividadId, [TicketResponsableId]=@TicketResponsableId, [SgActividadIdCategoria]=@SgActividadIdCategoria  WHERE [TicketTecnicoId] = @TicketTecnicoId", GxErrorMask.GX_NOMASK,prmT000823)
          ,new CursorDef("T000824", "DELETE FROM [TicketTecnico]  WHERE [TicketTecnicoId] = @TicketTecnicoId", GxErrorMask.GX_NOMASK,prmT000824)
          ,new CursorDef("T000825", "SELECT [UsuarioId] FROM [Ticket] WHERE [TicketId] = @TicketId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000825,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T000826", "SELECT [UsuarioNombre], [UsuarioRequerimiento], [UsuarioDepartamento] FROM [Usuario] WHERE [UsuarioId] = @UsuarioId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000826,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T000827", "SELECT [CategoriaDetalleTareaId] FROM [TicketResponsable] WHERE [TicketId] = @TicketId AND [TicketResponsableId] = @TicketResponsableId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000827,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T000828", "SELECT [ResponsableNombre] FROM [Responsable] WHERE [ResponsableId] = @ResponsableId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000828,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T000831", "SELECT [TicketTecnicoId] FROM [TicketTecnico] ORDER BY [TicketTecnicoId]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT000831,100, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T000832", "SELECT [CategoriaDetalleTareaId] FROM [CategoriaDetalleTarea] WHERE [CategoriaDetalleTareaId] = @CategoriaDetalleTareaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000832,1, GxCacheFrequency.OFF ,true,false )
       };
    }
 }
