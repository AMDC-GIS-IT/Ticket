...
namespace GeneXus.Programs {
   public class wptrabajodesarrollomodificar : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wptrabajodesarrollomodificar( )
      {
      ...
      public wptrabajodesarrollomodificar( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vEMPLEADO") == 0 )
            {
               ...
               GXDLVvEMPLEADO802( AV33UsuarioConectado) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vCARGO") == 0 )
            {
               ...
               GXDLVvCARGO802( AV33UsuarioConectado) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vDETALLE_INFOTECID_UNIDAD") == 0 )
            {
               ...
               GXDLVvDETALLE_INFOTECID_UNIDAD802( AV7categoria_tareaid_tipo_categoria) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vCATEGORIA_TAREAID_TIPO_CATEGORIA") == 0 )
            {
               ...
               GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA802( ) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vID_ACTIVIDAD_CATEGORIA") == 0 )
            {
               ...
               GXDLVvID_ACTIVIDAD_CATEGORIA802( AV7categoria_tareaid_tipo_categoria) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vCATEGORIADETALLETAREAID") == 0 )
            {
               AV17id_actividad_categoria = (int)(NumberUtil.Val( GetPar( "id_actividad_categoria"), "."));
               ...
               GXDLVvCATEGORIADETALLETAREAID802( AV17id_actividad_categoria) ;
               return  ;
            }
      ...
      {
         get {
            return "wptrabajodesarrollomodificar_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188221394", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"WPTrabajoDesarrolloModificar");
         ...
         GXUtil.WriteLogInfo("wptrabajodesarrollomodificar:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("wptrabajodesarrollomodificar.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV34correlativo,9,0)),UrlEncode(StringUtil.RTrim(AV36nombre_emp1)),UrlEncode(StringUtil.RTrim(AV37cargo_emp1)),UrlEncode(StringUtil.RTrim(AV38nombre_usuario1)),UrlEncode(DateTimeUtil.FormatDateParm(AV39fecha_registro1)),UrlEncode(StringUtil.RTrim(AV40depto_usuario1)),UrlEncode(StringUtil.RTrim(AV41correo_usuario1)),UrlEncode(StringUtil.RTrim(AV42observaciones1)),UrlEncode(StringUtil.LTrimStr(AV43detalle_infotecid_unidad1,9,0)),UrlEncode(StringUtil.LTrimStr(AV44id_categoria1,9,0)),UrlEncode(StringUtil.LTrimStr(AV45id_actividad1,9,0)),UrlEncode(StringUtil.RTrim(AV46prioridad1)),UrlEncode(StringUtil.RTrim(AV35fecha_solicitud))}, new string[] {"correlativo","nombre_emp1","cargo_emp1","nombre_usuario1","fecha_registro1","depto_usuario1","correo_usuario1","observaciones1","detalle_infotecid_unidad1","id_categoria1","id_actividad1","prioridad1","fecha_solicitud"})  ;
      }

      public override string GetPgmname( )
      {
         return "WPTrabajoDesarrolloModificar" ;
      }

      public override string GetPgmdesc( )
      {
         return "WPTrabajo Desarrollo Modificar" ;
      }
      ...
      protected void WB800( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock2_Internalname, "Gerencia de Información y Sistemas", "", "", lblTextblock2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_LevelHeaderTitle1", 0, "", 1, 1, 0, 0, "HLP_WPTrabajoDesarrolloModificar.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "Middle", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock3_Internalname, "<<Modificar de Trabajo Diario>>", "", "", lblTextblock3_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_LevelHeaderTitle", 0, "", 1, 1, 0, 0, "HLP_WPTrabajoDesarrolloModificar.htm");
            GxWebStd.gx_div_end( context, "Center", "Middle", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtavCorrelativo_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV34correlativo), 9, 0, ".", "")), StringUtil.LTrim( ((edtavCorrelativo_Enabled!=0) ? context.localUtil.Format( (decimal)(AV34correlativo), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(AV34correlativo), "ZZZZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCorrelativo_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCorrelativo_Enabled, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_WPTrabajoDesarrolloModificar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavCargo, dynavCargo_Internalname, StringUtil.RTrim( AV6Cargo), 1, dynavCargo_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavCargo.Enabled, 0, 0, 0, "em", 0, "", "color:"+context.BuildHTMLColor( dynavCargo.ForeColor)+";", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,46);\"", "", true, 1, "HLP_WPTrabajoDesarrolloModificar.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsuariofecha_Internalname, context.localUtil.Format(AV28UsuarioFecha, "99/99/9999"), context.localUtil.Format( AV28UsuarioFecha, "99/99/9999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsuariofecha_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavUsuariofecha_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_WPTrabajoDesarrolloModificar.htm");
            GxWebStd.gx_bitmap( context, edtavUsuariofecha_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavUsuariofecha_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_WPTrabajoDesarrolloModificar.htm");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavUsuariodepartamento, dynavUsuariodepartamento_Internalname, StringUtil.RTrim( AV26UsuarioDepartamento), 1, dynavUsuariodepartamento_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavUsuariodepartamento.Enabled, 0, 0, 0, "em", 0, "", "color:"+context.BuildHTMLColor( dynavUsuariodepartamento.ForeColor)+";", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,74);\"", "", true, 1, "HLP_WPTrabajoDesarrolloModificar.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsuarioemail_Internalname, AV27UsuarioEmail, StringUtil.RTrim( context.localUtil.Format( AV27UsuarioEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,81);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsuarioemail_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavUsuarioemail_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, 0, true, "", "left", true, "", "HLP_WPTrabajoDesarrolloModificar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavDetalle_infotecid_unidad, dynavDetalle_infotecid_unidad_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV9detalle_infotecid_unidad), 9, 0)), 1, dynavDetalle_infotecid_unidad_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", dynavDetalle_infotecid_unidad.Visible, dynavDetalle_infotecid_unidad.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,89);\"", "", true, 1, "HLP_WPTrabajoDesarrolloModificar.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "Observaciones: ", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "color:"+context.BuildHTMLColor( lblTextblock1_Forecolor)+";", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPTrabajoDesarrolloModificar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavCategoria_tareaid_tipo_categoria, dynavCategoria_tareaid_tipo_categoria_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV7categoria_tareaid_tipo_categoria), 9, 0)), 1, dynavCategoria_tareaid_tipo_categoria_Jsonclick, 5, "'"+""+"'"+",false,"+"'"+"EVCATEGORIA_TAREAID_TIPO_CATEGORIA.CLICK."+"'", "int", "", 1, dynavCategoria_tareaid_tipo_categoria.Enabled, 0, 0, 0, "em", 0, "", "color:"+context.BuildHTMLColor( dynavCategoria_tareaid_tipo_categoria.ForeColor)+";", "Attribute_Color", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,126);\"", "", true, 1, "HLP_WPTrabajoDesarrolloModificar.htm");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavCategoriadetalletareaid, dynavCategoriadetalletareaid_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV8CategoriaDetalleTareaId), 4, 0)), 1, dynavCategoriadetalletareaid_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, dynavCategoriadetalletareaid.Enabled, 0, 0, 0, "em", 0, "", "color:"+context.BuildHTMLColor( dynavCategoriadetalletareaid.ForeColor)+";", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,142);\"", "", true, 1, "HLP_WPTrabajoDesarrolloModificar.htm");
            dynavCategoriadetalletareaid.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV8CategoriaDetalleTareaId), 4, 0));
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavPrioridad, cmbavPrioridad_Internalname, StringUtil.RTrim( AV19prioridad), 1, cmbavPrioridad_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbavPrioridad.Enabled, 0, 0, 0, "em", 0, "", "color:"+context.BuildHTMLColor( cmbavPrioridad.ForeColor)+";", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,150);\"", "", true, 1, "HLP_WPTrabajoDesarrolloModificar.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttGuardar_Internalname, "", "Guardar", bttGuardar_Jsonclick, 5, "Guardar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'GUARDAR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WPTrabajoDesarrolloModificar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttCancelar_Internalname, "", "Cancelar", bttCancelar_Jsonclick, 5, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CANCELAR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WPTrabajoDesarrolloModificar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START802( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "WPTrabajo Desarrollo Modificar", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void GXDLVvUSUARIODEPARTAMENTO801( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvUSUARIODEPARTAMENTO_data801( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXVvUSUARIODEPARTAMENTO_html801( )
      {
      ...
      protected void GXDLVvUSUARIODEPARTAMENTO_data801( )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(H00802_A361nombre_depto[0]);
            gxdynajaxctrldescr.Add(H00802_A361nombre_depto[0]);
            pr_datastore1.readNext(0);
         }
         pr_datastore1.close(0);
      }

      protected void GXDLVvEMPLEADO802( string AV33UsuarioConectado )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvEMPLEADO_data802( AV33UsuarioConectado) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvEMPLEADO_html802( string AV33UsuarioConectado )
      {
         string gxdynajaxvalue;
         GXDLVvEMPLEADO_data802( AV33UsuarioConectado) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvEMPLEADO_data802( string AV33UsuarioConectado )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         /* Using cursor H00803 */
         ...
         {
            gxdynajaxctrlcodr.Add(H00803_A30ResponsableNombre[0]);
            gxdynajaxctrldescr.Add(H00803_A30ResponsableNombre[0]);
            pr_default.readNext(0);
         }
         pr_default.close(0);
      }

      protected void GXDLVvCARGO802( string AV33UsuarioConectado )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvCARGO_data802( AV33UsuarioConectado) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvCARGO_html802( string AV33UsuarioConectado )
      {
         string gxdynajaxvalue;
         GXDLVvCARGO_data802( AV33UsuarioConectado) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvCARGO_data802( string AV33UsuarioConectado )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         /* Using cursor H00804 */
         ...
         {
            gxdynajaxctrlcodr.Add(H00804_A27ResponsableCargo[0]);
            gxdynajaxctrldescr.Add(H00804_A27ResponsableCargo[0]);
            pr_default.readNext(1);
         }
         pr_default.close(1);
      }

      protected void GXDLVvDETALLE_INFOTECID_UNIDAD802( int AV7categoria_tareaid_tipo_categoria )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvDETALLE_INFOTECID_UNIDAD_data802( AV7categoria_tareaid_tipo_categoria) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvDETALLE_INFOTECID_UNIDAD_html802( int AV7categoria_tareaid_tipo_categoria )
      {
         int gxdynajaxvalue;
         GXDLVvDETALLE_INFOTECID_UNIDAD_data802( AV7categoria_tareaid_tipo_categoria) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvDETALLE_INFOTECID_UNIDAD_data802( int AV7categoria_tareaid_tipo_categoria )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H00805_A105id_unidad_gis[0]), 9, 0, ".", "")));
            gxdynajaxctrldescr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H00805_A105id_unidad_gis[0]), 9, 0, ".", "")));
            pr_datastore1.readNext(1);
         }
         pr_datastore1.close(1);
      }

      protected void GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA802( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA_data802( ) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvCATEGORIA_TAREAID_TIPO_CATEGORIA_html802( )
      {
         int gxdynajaxvalue;
         GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA_data802( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA_data802( )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         gxdynajaxctrlcodr.Add(StringUtil.Str( (decimal)(0), 1, 0));
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H00806_A104categoria_tareaid_tipo_categoria[0]), 9, 0, ".", "")));
            gxdynajaxctrldescr.Add(H00806_A106nombre_categoria[0]);
            pr_datastore1.readNext(2);
         }
         pr_datastore1.close(2);
      }

      protected void GXDLVvID_ACTIVIDAD_CATEGORIA802( int AV7categoria_tareaid_tipo_categoria )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvID_ACTIVIDAD_CATEGORIA_data802( AV7categoria_tareaid_tipo_categoria) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvID_ACTIVIDAD_CATEGORIA_html802( int AV7categoria_tareaid_tipo_categoria )
      {
         int gxdynajaxvalue;
         GXDLVvID_ACTIVIDAD_CATEGORIA_data802( AV7categoria_tareaid_tipo_categoria) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvID_ACTIVIDAD_CATEGORIA_data802( int AV7categoria_tareaid_tipo_categoria )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         gxdynajaxctrlcodr.Add(StringUtil.Str( (decimal)(0), 1, 0));
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H00807_A102id_actividad_categoria[0]), 9, 0, ".", "")));
            gxdynajaxctrldescr.Add(H00807_A123nombre_actividad[0]);
            pr_datastore1.readNext(3);
         }
         pr_datastore1.close(3);
      }

      protected void GXDLVvCATEGORIADETALLETAREAID802( int AV17id_actividad_categoria )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvCATEGORIADETALLETAREAID_data802( AV17id_actividad_categoria) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvCATEGORIADETALLETAREAID_html802( int AV17id_actividad_categoria )
      {
      ...
      protected void GXDLVvCATEGORIADETALLETAREAID_data802( int AV17id_actividad_categoria )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         gxdynajaxctrlcodr.Add(StringUtil.Str( (decimal)(0), 1, 0));
         gxdynajaxctrldescr.Add("(Ninguno)");
         /* Using cursor H00808 */
         pr_default.execute(2, new Object[] {AV17id_actividad_categoria});
         while ( (pr_default.getStatus(2) != 101) )
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H00808_A294CategoriaDetalleTareaId[0]), 4, 0, ".", "")));
            gxdynajaxctrldescr.Add(H00808_A295CategoriaDetalleTareaNombre[0]);
      ...
      protected void clear_multi_value_controls( )
      {
         if ( context.isAjaxRequest( ) )
         {
            GXVvCATEGORIA_TAREAID_TIPO_CATEGORIA_html802( ) ;
            ...
            {
               dynavUsuariodepartamento.addItem(H00809_A361nombre_depto[0], H00809_A361nombre_depto[0], 0);
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV8CategoriaDetalleTareaId = (short)(NumberUtil.Val( dynavCategoriadetalletareaid.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV8CategoriaDetalleTareaId), 4, 0))), "."));
            AssignAttri("", false, "AV8CategoriaDetalleTareaId", StringUtil.LTrimStr( (decimal)(AV8CategoriaDetalleTareaId), 4, 0));
         }
         if ( context.isAjaxRequest( ) )
         {
            dynavCategoriadetalletareaid.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV8CategoriaDetalleTareaId), 4, 0));
      ...
      protected void STRUP800( )
      {
         ...
         GXVvEMPLEADO_html802( AV33UsuarioConectado) ;
         GXVvCARGO_html802( AV33UsuarioConectado) ;
         GXVvDETALLE_INFOTECID_UNIDAD_html802( AV7categoria_tareaid_tipo_categoria) ;
         GXVvID_ACTIVIDAD_CATEGORIA_html802( AV7categoria_tareaid_tipo_categoria) ;
         GXVvCATEGORIADETALLETAREAID_html802( AV17id_actividad_categoria) ;
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            ...
            AV8CategoriaDetalleTareaId = (short)(NumberUtil.Val( cgiGet( dynavCategoriadetalletareaid_Internalname), "."));
            AssignAttri("", false, "AV8CategoriaDetalleTareaId", StringUtil.LTrimStr( (decimal)(AV8CategoriaDetalleTareaId), 4, 0));
            ...
            {
               GXUtil.WriteLogError("wptrabajodesarrollomodificar:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
         ...
         else
         {
            ...
            else
            {
               ...
               else
               {
                  ...
                  {
                     AV10detalle_tarea = dynavCategoria_tareaid_tipo_categoria.Description + "/-" + dynavId_actividad_categoria.Description + "/-" + dynavCategoriadetalletareaid.Description;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188221739", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wptrabajodesarrollomodificar.js", "?2024188221741", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         dynavUsuariodepartamento.WebTags = "";
         dynavUsuariodepartamento.removeAllItems();
         /* Using cursor H008010 */
         pr_datastore1.execute(5);
         while ( (pr_datastore1.getStatus(5) != 101) )
         {
            dynavUsuariodepartamento.addItem(H008010_A361nombre_depto[0], H008010_A361nombre_depto[0], 0);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "WPTrabajo Desarrollo Modificar";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public void Validv_Categoria_tareaid_tipo_categoria( )
      {
         ...
         AV8CategoriaDetalleTareaId = (short)(NumberUtil.Val( dynavCategoriadetalletareaid.CurrentValue, "."));
      ...
      public void Validv_Id_actividad_categoria( )
      {
         ...
         /*  Sending validation outputs */
         AssignAttri("", false, "AV8CategoriaDetalleTareaId", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8CategoriaDetalleTareaId), 4, 0, ".", "")));
         dynavCategoriadetalletareaid.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV8CategoriaDetalleTareaId), 4, 0));
         AssignProp("", false, dynavCategoriadetalletareaid_Internalname, "Values", dynavCategoriadetalletareaid.ToJavascriptSource(), true);
      }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'GUARDAR'","{handler:'E11802',iparms:[{av:'dynavId_actividad_categoria'},{av:'cmbavPrioridad'},{av:'AV24TicketResponsableObservacion',fld:'vTICKETRESPONSABLEOBSERVACION',pic:''},{av:'dynavCategoriadetalletareaid'},{av:'AV17id_actividad_categoria',fld:'vID_ACTIVIDAD_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV30UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV27UsuarioEmail',fld:'vUSUARIOEMAIL',pic:''},{av:'dynavDetalle_infotecid_unidad'},{av:'AV9detalle_infotecid_unidad',fld:'vDETALLE_INFOTECID_UNIDAD',pic:'ZZZZZZZZ9'},{av:'AV28UsuarioFecha',fld:'vUSUARIOFECHA',pic:''},{av:'AV15EstadoTicketTicketId',fld:'vESTADOTICKETTICKETID',pic:'ZZZ9',hsh:true},{av:'AV16EtapaDesarrolloId',fld:'vETAPADESARROLLOID',pic:'ZZZ9',hsh:true},{av:'dynavEmpleado'},{av:'dynavCargo'},{av:'AV34correlativo',fld:'vCORRELATIVO',pic:'ZZZZZZZZ9',hsh:true},{av:'dynavCategoria_tareaid_tipo_categoria'},{av:'AV7categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'dynavUsuariodepartamento'},{av:'AV26UsuarioDepartamento',fld:'vUSUARIODEPARTAMENTO',pic:''}]");
         ...
         setEventMetadata("'CANCELAR'","{handler:'E12802',iparms:[{av:'dynavCategoria_tareaid_tipo_categoria'},{av:'AV7categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'dynavUsuariodepartamento'},{av:'AV26UsuarioDepartamento',fld:'vUSUARIODEPARTAMENTO',pic:''}]");
         ...
         setEventMetadata("'PRUEBA'","{handler:'E13802',iparms:[{av:'dynavCategoria_tareaid_tipo_categoria'},{av:'AV7categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'dynavUsuariodepartamento'},{av:'AV26UsuarioDepartamento',fld:'vUSUARIODEPARTAMENTO',pic:''}]");
         ...
         setEventMetadata("VCATEGORIA_TAREAID_TIPO_CATEGORIA.CLICK","{handler:'E14802',iparms:[{av:'dynavCategoria_tareaid_tipo_categoria'},{av:'AV7categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'dynavUsuariodepartamento'},{av:'AV26UsuarioDepartamento',fld:'vUSUARIODEPARTAMENTO',pic:''}]");
         setEventMetadata("VCATEGORIA_TAREAID_TIPO_CATEGORIA.CLICK",",oparms:[{av:'dynavCategoriadetalletareaid'},{av:'AV8CategoriaDetalleTareaId',fld:'vCATEGORIADETALLETAREAID',pic:'ZZZ9'},{av:'dynavCategoria_tareaid_tipo_categoria'},{av:'AV7categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'dynavUsuariodepartamento'},{av:'AV26UsuarioDepartamento',fld:'vUSUARIODEPARTAMENTO',pic:''}]}");
         ...
         setEventMetadata("VALIDV_ID_ACTIVIDAD_CATEGORIA",",oparms:[{av:'dynavCategoriadetalletareaid'},{av:'AV8CategoriaDetalleTareaId',fld:'vCATEGORIADETALLETAREAID',pic:'ZZZ9'},{av:'dynavCategoria_tareaid_tipo_categoria'},{av:'AV7categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'dynavUsuariodepartamento'},{av:'AV26UsuarioDepartamento',fld:'vUSUARIODEPARTAMENTO',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         gxwrpcisep = "";
         scmdbuf = "";
         H00802_A360codigo_depto = new int[1] ;
         H00802_A361nombre_depto = new string[] {""} ;
         H00802_n361nombre_depto = new bool[] {false} ;
         H00803_A6ResponsableId = new short[1] ;
         H00803_A30ResponsableNombre = new string[] {""} ;
         H00803_A96ResponsableUsuario = new string[] {""} ;
         H00804_A6ResponsableId = new short[1] ;
         H00804_A27ResponsableCargo = new string[] {""} ;
         H00804_A96ResponsableUsuario = new string[] {""} ;
         H00805_A105id_unidad_gis = new int[1] ;
         H00805_A104categoria_tareaid_tipo_categoria = new int[1] ;
         H00806_A104categoria_tareaid_tipo_categoria = new int[1] ;
         H00806_A106nombre_categoria = new string[] {""} ;
         H00806_n106nombre_categoria = new bool[] {false} ;
         H00807_A102id_actividad_categoria = new int[1] ;
         H00807_A123nombre_actividad = new string[] {""} ;
         H00807_n123nombre_actividad = new bool[] {false} ;
         H00807_A122actividades_categoriaid_tipo_categoria = new int[1] ;
         H00807_n122actividades_categoriaid_tipo_categoria = new bool[] {false} ;
         H00807_A125actividades_categoriaestado = new int[1] ;
         H00807_n125actividades_categoriaestado = new bool[] {false} ;
         H00808_A294CategoriaDetalleTareaId = new short[1] ;
         H00808_A295CategoriaDetalleTareaNombre = new string[] {""} ;
         H00808_A102id_actividad_categoria = new int[1] ;
         H00809_A360codigo_depto = new int[1] ;
         H00809_A361nombre_depto = new string[] {""} ;
         H00809_n361nombre_depto = new bool[] {false} ;
         hsh = "";
         AV10detalle_tarea = "";
         AV5window = new GXWindow();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         H008010_A360codigo_depto = new int[1] ;
         H008010_A361nombre_depto = new string[] {""} ;
         H008010_n361nombre_depto = new bool[] {false} ;
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.wptrabajodesarrollomodificar__datastore1(),
            new Object[][] {
                new Object[] {
               H00802_A360codigo_depto, H00802_A361nombre_depto, H00802_n361nombre_depto
               }
               , new Object[] {
               H00805_A105id_unidad_gis, H00805_A104categoria_tareaid_tipo_categoria
               }
               , new Object[] {
               H00806_A104categoria_tareaid_tipo_categoria, H00806_A106nombre_categoria, H00806_n106nombre_categoria
               }
               , new Object[] {
               H00807_A102id_actividad_categoria, H00807_A123nombre_actividad, H00807_n123nombre_actividad, H00807_A122actividades_categoriaid_tipo_categoria, H00807_n122actividades_categoriaid_tipo_categoria, H00807_A125actividades_categoriaestado, H00807_n125actividades_categoriaestado
               }
               , new Object[] {
               H00809_A360codigo_depto, H00809_A361nombre_depto, H00809_n361nombre_depto
               }
               , new Object[] {
               H008010_A360codigo_depto, H008010_A361nombre_depto, H008010_n361nombre_depto
               }
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wptrabajodesarrollomodificar__default(),
            new Object[][] {
                new Object[] {
               H00803_A6ResponsableId, H00803_A30ResponsableNombre, H00803_A96ResponsableUsuario
               }
               , new Object[] {
               H00804_A6ResponsableId, H00804_A27ResponsableCargo, H00804_A96ResponsableUsuario
               }
               , new Object[] {
               H00808_A294CategoriaDetalleTareaId, H00808_A295CategoriaDetalleTareaNombre, H00808_A102id_actividad_categoria
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short ZV8CategoriaDetalleTareaId ;
      ...
      private int[] H00802_A360codigo_depto ;
      private string[] H00802_A361nombre_depto ;
      private bool[] H00802_n361nombre_depto ;
      private IDataStoreProvider pr_default ;
      private short[] H00803_A6ResponsableId ;
      private string[] H00803_A30ResponsableNombre ;
      private string[] H00803_A96ResponsableUsuario ;
      private short[] H00804_A6ResponsableId ;
      private string[] H00804_A27ResponsableCargo ;
      private string[] H00804_A96ResponsableUsuario ;
      private int[] H00805_A105id_unidad_gis ;
      private int[] H00805_A104categoria_tareaid_tipo_categoria ;
      private int[] H00806_A104categoria_tareaid_tipo_categoria ;
      private string[] H00806_A106nombre_categoria ;
      private bool[] H00806_n106nombre_categoria ;
      private int[] H00807_A102id_actividad_categoria ;
      private string[] H00807_A123nombre_actividad ;
      private bool[] H00807_n123nombre_actividad ;
      private int[] H00807_A122actividades_categoriaid_tipo_categoria ;
      private bool[] H00807_n122actividades_categoriaid_tipo_categoria ;
      private int[] H00807_A125actividades_categoriaestado ;
      private bool[] H00807_n125actividades_categoriaestado ;
      private short[] H00808_A294CategoriaDetalleTareaId ;
      private string[] H00808_A295CategoriaDetalleTareaNombre ;
      private int[] H00808_A102id_actividad_categoria ;
      private int[] H00809_A360codigo_depto ;
      private string[] H00809_A361nombre_depto ;
      private bool[] H00809_n361nombre_depto ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private int[] H008010_A360codigo_depto ;
      private string[] H008010_A361nombre_depto ;
      private bool[] H008010_n361nombre_depto ;
      private GXWebForm Form ;
      private GXWindow AV5window ;
   }

   public class wptrabajodesarrollomodificar__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH00809;
          prmH00809 = new Object[] {
          };
          Object[] prmH008010;
          prmH008010 = new Object[] {
          };
          def= new CursorDef[] {
              new CursorDef("H00802", "SELECT [codigo_depto], [nombre_depto] FROM dbo.[deptos] ORDER BY [nombre_depto] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00802,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00805", "SELECT [id_unidad_gis], [id_tipo_categoria] AS categoria_tareaid_tipo_categoria FROM dbo.[categoria_tarea] WHERE [id_tipo_categoria] = @AV7categoria_tareaid_tipo_categoria ORDER BY [id_unidad_gis] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00805,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00806", "SELECT [id_tipo_categoria] AS categoria_tareaid_tipo_categoria, [nombre_categoria] FROM dbo.[categoria_tarea] WHERE [id_tipo_categoria] = 14 or [id_tipo_categoria] = 15 ORDER BY [nombre_categoria] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00806,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00807", "SELECT [id_actividad_categoria], [nombre_actividad], [id_tipo_categoria] AS actividades_categoriaid_tipo_categoria, [estado] AS actividades_categoriaestado FROM dbo.[actividades_categoria] WHERE ([id_tipo_categoria] = @AV7categoria_tareaid_tipo_categoria) AND ([estado] = 1) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00807,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00809", "SELECT [codigo_depto], [nombre_depto] FROM dbo.[deptos] ORDER BY [nombre_depto] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00809,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H008010", "SELECT [codigo_depto], [nombre_depto] FROM dbo.[deptos] ORDER BY [nombre_depto] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008010,0, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
 ...
 public class wptrabajodesarrollomodificar__default : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        Object[] prmH00808;
        prmH00808 = new Object[] {
        new ParDef("@AV17id_actividad_categoria",GXType.Int32,9,0)
        };
        def= new CursorDef[] {
            new CursorDef("H00803", "SELECT [ResponsableId], [ResponsableNombre], [ResponsableUsuario] FROM [Responsable] WHERE [ResponsableUsuario] = @AV33UsuarioConectado ORDER BY [ResponsableNombre] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00803,0, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("H00804", "SELECT [ResponsableId], [ResponsableCargo], [ResponsableUsuario] FROM [Responsable] WHERE [ResponsableUsuario] = @AV33UsuarioConectado ORDER BY [ResponsableCargo] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00804,0, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("H00808", "SELECT [CategoriaDetalleTareaId], [CategoriaDetalleTareaNombre], [id_actividad_categoria] FROM [CategoriaDetalleTarea] WHERE [id_actividad_categoria] = @AV17id_actividad_categoria ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00808,0, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
