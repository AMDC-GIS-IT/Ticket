...
namespace GeneXus.Programs {
   public class wptrabajoaplicaciones : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wptrabajoaplicaciones( )
      {
      ...
      public wptrabajoaplicaciones( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vEMPLEADO") == 0 )
            {
               ...
               GXDLVvEMPLEADO7R2( AV33UsuarioConectado) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vCARGO") == 0 )
            {
               ...
               GXDLVvCARGO7R2( AV33UsuarioConectado) ;
               return  ;
            }
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vDETALLE_INFOTECID_UNIDAD") == 0 )
            {
               ...
               GXDLVvDETALLE_INFOTECID_UNIDAD7R2( AV7categoria_tareaid_tipo_categoria) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vCATEGORIA_TAREAID_TIPO_CATEGORIA") == 0 )
            {
               ...
               GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA7R2( ) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vID_ACTIVIDAD_CATEGORIA") == 0 )
            {
               ...
               GXDLVvID_ACTIVIDAD_CATEGORIA7R2( AV7categoria_tareaid_tipo_categoria) ;
               return  ;
            }
      ...
      {
         get {
            return "wptrabajoaplicaciones_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202418822385", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wptrabajoaplicaciones.aspx") +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"WPTrabajoAplicaciones");
         ...
         GXUtil.WriteLogInfo("wptrabajoaplicaciones:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("wptrabajoaplicaciones.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WPTrabajoAplicaciones" ;
      }

      public override string GetPgmdesc( )
      {
         return "WPTrabajo Aplicaciones" ;
      }
      ...
      protected void WB7R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock2_Internalname, "Gerencia de Información y Sistemas", "", "", lblTextblock2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_LevelHeaderTitle1", 0, "", 1, 1, 0, 0, "HLP_WPTrabajoAplicaciones.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "Middle", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock3_Internalname, "<<Registro de Trabajo Diario>>", "", "", lblTextblock3_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_LevelHeaderTitle", 0, "", 1, 1, 0, 0, "HLP_WPTrabajoAplicaciones.htm");
            GxWebStd.gx_div_end( context, "Center", "Middle", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavEmpleado, dynavEmpleado_Internalname, StringUtil.RTrim( AV13Empleado), 1, dynavEmpleado_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavEmpleado.Enabled, 0, 0, 0, "em", 0, "", "color:"+context.BuildHTMLColor( dynavEmpleado.ForeColor)+";", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,31);\"", "", true, 1, "HLP_WPTrabajoAplicaciones.htm");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavCargo, dynavCargo_Internalname, StringUtil.RTrim( AV6Cargo), 1, dynavCargo_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavCargo.Enabled, 0, 0, 0, "em", 0, "", "color:"+context.BuildHTMLColor( dynavCargo.ForeColor)+";", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,38);\"", "", true, 1, "HLP_WPTrabajoAplicaciones.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsuariofecha_Internalname, context.localUtil.Format(AV28UsuarioFecha, "99/99/9999"), context.localUtil.Format( AV28UsuarioFecha, "99/99/9999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,58);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsuariofecha_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavUsuariofecha_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_WPTrabajoAplicaciones.htm");
            GxWebStd.gx_bitmap( context, edtavUsuariofecha_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavUsuariofecha_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_WPTrabajoAplicaciones.htm");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavUsuariodepartamento, dynavUsuariodepartamento_Internalname, StringUtil.RTrim( AV26UsuarioDepartamento), 1, dynavUsuariodepartamento_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavUsuariodepartamento.Enabled, 0, 0, 0, "em", 0, "", "color:"+context.BuildHTMLColor( dynavUsuariodepartamento.ForeColor)+";", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,66);\"", "", true, 1, "HLP_WPTrabajoAplicaciones.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsuarioemail_Internalname, AV27UsuarioEmail, StringUtil.RTrim( context.localUtil.Format( AV27UsuarioEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,73);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsuarioemail_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavUsuarioemail_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, 0, true, "", "left", true, "", "HLP_WPTrabajoAplicaciones.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavDetalle_infotecid_unidad, dynavDetalle_infotecid_unidad_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV9detalle_infotecid_unidad), 9, 0)), 1, dynavDetalle_infotecid_unidad_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", dynavDetalle_infotecid_unidad.Visible, dynavDetalle_infotecid_unidad.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,81);\"", "", true, 1, "HLP_WPTrabajoAplicaciones.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "Observaciones: ", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "color:"+context.BuildHTMLColor( lblTextblock1_Forecolor)+";", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPTrabajoAplicaciones.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavCategoria_tareaid_tipo_categoria, dynavCategoria_tareaid_tipo_categoria_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV7categoria_tareaid_tipo_categoria), 9, 0)), 1, dynavCategoria_tareaid_tipo_categoria_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, dynavCategoria_tareaid_tipo_categoria.Enabled, 0, 0, 0, "em", 0, "", "color:"+context.BuildHTMLColor( dynavCategoria_tareaid_tipo_categoria.ForeColor)+";", "Attribute_Color", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,118);\"", "", true, 1, "HLP_WPTrabajoAplicaciones.htm");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavId_actividad_categoria, dynavId_actividad_categoria_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV17id_actividad_categoria), 9, 0)), 1, dynavId_actividad_categoria_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, dynavId_actividad_categoria.Enabled, 0, 0, 0, "em", 0, "", "color:"+context.BuildHTMLColor( dynavId_actividad_categoria.ForeColor)+";", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,126);\"", "", true, 1, "HLP_WPTrabajoAplicaciones.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttGuardar_Internalname, "", "Guardar", bttGuardar_Jsonclick, 5, "Guardar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'GUARDAR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WPTrabajoAplicaciones.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttCancelar_Internalname, "", "Cancelar", bttCancelar_Jsonclick, 5, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CANCELAR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WPTrabajoAplicaciones.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START7R2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "WPTrabajo Aplicaciones", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         GXVvDETALLE_INFOTECID_UNIDAD_html7R2( AV7categoria_tareaid_tipo_categoria) ;
         GXVvID_ACTIVIDAD_CATEGORIA_html7R2( AV7categoria_tareaid_tipo_categoria) ;
         /* End function dynload_actions */
      }

      protected void GXDLVvEMPLEADO7R2( string AV33UsuarioConectado )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvEMPLEADO_data7R2( AV33UsuarioConectado) ;
         gxdynajaxindex = 1;
      ...
      protected void GXVvEMPLEADO_html7R2( string AV33UsuarioConectado )
      {
      ...
      protected void GXDLVvEMPLEADO_data7R2( string AV33UsuarioConectado )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(H007R2_A30ResponsableNombre[0]);
            gxdynajaxctrldescr.Add(H007R2_A30ResponsableNombre[0]);
            pr_default.readNext(0);
         }
         pr_default.close(0);
      }

      protected void GXDLVvCARGO7R2( string AV33UsuarioConectado )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvCARGO_data7R2( AV33UsuarioConectado) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvCARGO_html7R2( string AV33UsuarioConectado )
      {
         string gxdynajaxvalue;
         GXDLVvCARGO_data7R2( AV33UsuarioConectado) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvCARGO_data7R2( string AV33UsuarioConectado )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         /* Using cursor H007R3 */
         ...
         {
            gxdynajaxctrlcodr.Add(H007R3_A27ResponsableCargo[0]);
            gxdynajaxctrldescr.Add(H007R3_A27ResponsableCargo[0]);
            pr_default.readNext(1);
         }
         pr_default.close(1);
      }

      protected void GXDLVvUSUARIODEPARTAMENTO7R2( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvUSUARIODEPARTAMENTO_data7R2( ) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvUSUARIODEPARTAMENTO_html7R2( )
      {
         string gxdynajaxvalue;
         GXDLVvUSUARIODEPARTAMENTO_data7R2( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvUSUARIODEPARTAMENTO_data7R2( )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         ...
         {
            gxdynajaxctrlcodr.Add(H007R4_A361nombre_depto[0]);
            gxdynajaxctrldescr.Add(H007R4_A361nombre_depto[0]);
            pr_datastore1.readNext(0);
         }
         pr_datastore1.close(0);
      }

      protected void GXDLVvDETALLE_INFOTECID_UNIDAD7R2( int AV7categoria_tareaid_tipo_categoria )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvDETALLE_INFOTECID_UNIDAD_data7R2( AV7categoria_tareaid_tipo_categoria) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvDETALLE_INFOTECID_UNIDAD_html7R2( int AV7categoria_tareaid_tipo_categoria )
      {
         int gxdynajaxvalue;
         GXDLVvDETALLE_INFOTECID_UNIDAD_data7R2( AV7categoria_tareaid_tipo_categoria) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvDETALLE_INFOTECID_UNIDAD_data7R2( int AV7categoria_tareaid_tipo_categoria )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H007R5_A105id_unidad_gis[0]), 9, 0, ".", "")));
            gxdynajaxctrldescr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H007R5_A105id_unidad_gis[0]), 9, 0, ".", "")));
            pr_datastore1.readNext(1);
         }
         pr_datastore1.close(1);
      }

      protected void GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA7R2( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA_data7R2( ) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvCATEGORIA_TAREAID_TIPO_CATEGORIA_html7R2( )
      {
         int gxdynajaxvalue;
         GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA_data7R2( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA_data7R2( )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         gxdynajaxctrlcodr.Add(StringUtil.Str( (decimal)(0), 1, 0));
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H007R6_A104categoria_tareaid_tipo_categoria[0]), 9, 0, ".", "")));
            gxdynajaxctrldescr.Add(H007R6_A106nombre_categoria[0]);
            pr_datastore1.readNext(2);
         }
         pr_datastore1.close(2);
      }

      protected void GXDLVvID_ACTIVIDAD_CATEGORIA7R2( int AV7categoria_tareaid_tipo_categoria )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvID_ACTIVIDAD_CATEGORIA_data7R2( AV7categoria_tareaid_tipo_categoria) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvID_ACTIVIDAD_CATEGORIA_html7R2( int AV7categoria_tareaid_tipo_categoria )
      {
         int gxdynajaxvalue;
         GXDLVvID_ACTIVIDAD_CATEGORIA_data7R2( AV7categoria_tareaid_tipo_categoria) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvID_ACTIVIDAD_CATEGORIA_data7R2( int AV7categoria_tareaid_tipo_categoria )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         gxdynajaxctrlcodr.Add(StringUtil.Str( (decimal)(0), 1, 0));
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H007R7_A102id_actividad_categoria[0]), 9, 0, ".", "")));
            gxdynajaxctrldescr.Add(H007R7_A123nombre_actividad[0]);
      ...
      protected void clear_multi_value_controls( )
      {
         if ( context.isAjaxRequest( ) )
         {
            GXVvUSUARIODEPARTAMENTO_html7R2( ) ;
            GXVvCATEGORIA_TAREAID_TIPO_CATEGORIA_html7R2( ) ;
            GXVvDETALLE_INFOTECID_UNIDAD_html7R2( AV7categoria_tareaid_tipo_categoria) ;
            GXVvID_ACTIVIDAD_CATEGORIA_html7R2( AV7categoria_tareaid_tipo_categoria) ;
            dynload_actions( ) ;
      ...
      protected void STRUP7R0( )
      {
         ...
         GXVvEMPLEADO_html7R2( AV33UsuarioConectado) ;
         GXVvCARGO_html7R2( AV33UsuarioConectado) ;
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            ...
            {
               GXUtil.WriteLogError("wptrabajoaplicaciones:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202418822647", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wptrabajoaplicaciones.js", "?202418822648", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "WPTrabajo Aplicaciones";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'CANCELAR'","{handler:'E127R2',iparms:[{av:'dynavUsuariodepartamento'},{av:'AV26UsuarioDepartamento',fld:'vUSUARIODEPARTAMENTO',pic:''},{av:'dynavCategoria_tareaid_tipo_categoria'},{av:'AV7categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'dynavDetalle_infotecid_unidad'},{av:'AV9detalle_infotecid_unidad',fld:'vDETALLE_INFOTECID_UNIDAD',pic:'ZZZZZZZZ9'},{av:'dynavId_actividad_categoria'},{av:'AV17id_actividad_categoria',fld:'vID_ACTIVIDAD_CATEGORIA',pic:'ZZZZZZZZ9'}]");
         ...
         setEventMetadata("'PRUEBA'","{handler:'E137R2',iparms:[{av:'dynavUsuariodepartamento'},{av:'AV26UsuarioDepartamento',fld:'vUSUARIODEPARTAMENTO',pic:''},{av:'dynavCategoria_tareaid_tipo_categoria'},{av:'AV7categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'dynavDetalle_infotecid_unidad'},{av:'AV9detalle_infotecid_unidad',fld:'vDETALLE_INFOTECID_UNIDAD',pic:'ZZZZZZZZ9'},{av:'dynavId_actividad_categoria'},{av:'AV17id_actividad_categoria',fld:'vID_ACTIVIDAD_CATEGORIA',pic:'ZZZZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         gxwrpcisep = "";
         scmdbuf = "";
         H007R2_A6ResponsableId = new short[1] ;
         H007R2_A30ResponsableNombre = new string[] {""} ;
         H007R2_A96ResponsableUsuario = new string[] {""} ;
         H007R3_A6ResponsableId = new short[1] ;
         H007R3_A27ResponsableCargo = new string[] {""} ;
         H007R3_A96ResponsableUsuario = new string[] {""} ;
         H007R4_A360codigo_depto = new int[1] ;
         H007R4_A361nombre_depto = new string[] {""} ;
         H007R4_n361nombre_depto = new bool[] {false} ;
         H007R5_A105id_unidad_gis = new int[1] ;
         H007R5_A104categoria_tareaid_tipo_categoria = new int[1] ;
         H007R6_A104categoria_tareaid_tipo_categoria = new int[1] ;
         H007R6_A106nombre_categoria = new string[] {""} ;
         H007R6_n106nombre_categoria = new bool[] {false} ;
         H007R7_A102id_actividad_categoria = new int[1] ;
         H007R7_A123nombre_actividad = new string[] {""} ;
         H007R7_n123nombre_actividad = new bool[] {false} ;
         H007R7_A122actividades_categoriaid_tipo_categoria = new int[1] ;
         H007R7_n122actividades_categoriaid_tipo_categoria = new bool[] {false} ;
         H007R7_A125actividades_categoriaestado = new int[1] ;
         H007R7_n125actividades_categoriaestado = new bool[] {false} ;
         hsh = "";
         AV10detalle_tarea = "";
         AV5window = new GXWindow();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.wptrabajoaplicaciones__datastore1(),
            new Object[][] {
                new Object[] {
               H007R4_A360codigo_depto, H007R4_A361nombre_depto, H007R4_n361nombre_depto
               }
               , new Object[] {
               H007R5_A105id_unidad_gis, H007R5_A104categoria_tareaid_tipo_categoria
               }
               , new Object[] {
               H007R6_A104categoria_tareaid_tipo_categoria, H007R6_A106nombre_categoria, H007R6_n106nombre_categoria
               }
               , new Object[] {
               H007R7_A102id_actividad_categoria, H007R7_A123nombre_actividad, H007R7_n123nombre_actividad, H007R7_A122actividades_categoriaid_tipo_categoria, H007R7_n122actividades_categoriaid_tipo_categoria, H007R7_A125actividades_categoriaestado, H007R7_n125actividades_categoriaestado
               }
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wptrabajoaplicaciones__default(),
            new Object[][] {
                new Object[] {
               H007R2_A6ResponsableId, H007R2_A30ResponsableNombre, H007R2_A96ResponsableUsuario
               }
               , new Object[] {
               H007R3_A6ResponsableId, H007R3_A27ResponsableCargo, H007R3_A96ResponsableUsuario
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] H007R2_A6ResponsableId ;
      private string[] H007R2_A30ResponsableNombre ;
      private string[] H007R2_A96ResponsableUsuario ;
      private short[] H007R3_A6ResponsableId ;
      private string[] H007R3_A27ResponsableCargo ;
      private string[] H007R3_A96ResponsableUsuario ;
      private IDataStoreProvider pr_datastore1 ;
      private int[] H007R4_A360codigo_depto ;
      private string[] H007R4_A361nombre_depto ;
      private bool[] H007R4_n361nombre_depto ;
      private int[] H007R5_A105id_unidad_gis ;
      private int[] H007R5_A104categoria_tareaid_tipo_categoria ;
      private int[] H007R6_A104categoria_tareaid_tipo_categoria ;
      private string[] H007R6_A106nombre_categoria ;
      private bool[] H007R6_n106nombre_categoria ;
      private int[] H007R7_A102id_actividad_categoria ;
      private string[] H007R7_A123nombre_actividad ;
      private bool[] H007R7_n123nombre_actividad ;
      private int[] H007R7_A122actividades_categoriaid_tipo_categoria ;
      private bool[] H007R7_n122actividades_categoriaid_tipo_categoria ;
      private int[] H007R7_A125actividades_categoriaestado ;
      private bool[] H007R7_n125actividades_categoriaestado ;
   ...
   public class wptrabajoaplicaciones__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmH007R4;
          prmH007R4 = new Object[] {
          };
          Object[] prmH007R5;
          prmH007R5 = new Object[] {
          new ParDef("@AV7categoria_tareaid_tipo_categoria",GXType.Int32,9,0)
          };
          Object[] prmH007R6;
          prmH007R6 = new Object[] {
          };
          Object[] prmH007R7;
          prmH007R7 = new Object[] {
          new ParDef("@AV7categoria_tareaid_tipo_categoria",GXType.Int32,9,0)
          };
          def= new CursorDef[] {
              new CursorDef("H007R4", "SELECT [codigo_depto], [nombre_depto] FROM dbo.[deptos] ORDER BY [nombre_depto] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007R4,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007R5", "SELECT [id_unidad_gis], [id_tipo_categoria] AS categoria_tareaid_tipo_categoria FROM dbo.[categoria_tarea] WHERE [id_tipo_categoria] = @AV7categoria_tareaid_tipo_categoria ORDER BY [id_unidad_gis] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007R5,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007R6", "SELECT [id_tipo_categoria] AS categoria_tareaid_tipo_categoria, [nombre_categoria] FROM dbo.[categoria_tarea] WHERE [id_tipo_categoria] = 2 or [id_tipo_categoria] = 11 ORDER BY [nombre_categoria] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007R6,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007R7", "SELECT [id_actividad_categoria], [nombre_actividad], [id_tipo_categoria] AS actividades_categoriaid_tipo_categoria, [estado] AS actividades_categoriaestado FROM dbo.[actividades_categoria] WHERE ([id_tipo_categoria] = @AV7categoria_tareaid_tipo_categoria) AND ([estado] = 1) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007R7,0, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
 ...
 public class wptrabajoaplicaciones__default : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        def= new CursorDef[] {
            new CursorDef("H007R2", "SELECT [ResponsableId], [ResponsableNombre], [ResponsableUsuario] FROM [Responsable] WHERE [ResponsableUsuario] = @AV33UsuarioConectado ORDER BY [ResponsableNombre] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007R2,0, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("H007R3", "SELECT [ResponsableId], [ResponsableCargo], [ResponsableUsuario] FROM [Responsable] WHERE [ResponsableUsuario] = @AV33UsuarioConectado ORDER BY [ResponsableCargo] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007R3,0, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
