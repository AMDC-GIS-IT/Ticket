   ...
   public class soportetecnico : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITTRN( )
      {
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_5") == 0 )
         {
            ...
            AssignAttri("", false, "A15UsuarioId", StringUtil.LTrimStr( (decimal)(A15UsuarioId), 10, 0));
            setAjaxCallMode();
            if ( ! IsValidAjaxCall( true) )
            {
               GxWebError = 1;
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtSoporteTecnicoId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A202SoporteTecnicoId), 10, 0, ".", "")), StringUtil.LTrim( ((edtSoporteTecnicoId_Enabled!=0) ? context.localUtil.Format( (decimal)(A202SoporteTecnicoId), "ZZZZZZZZZ9") : context.localUtil.Format( (decimal)(A202SoporteTecnicoId), "ZZZZZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,28);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSoporteTecnicoId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSoporteTecnicoId_Enabled, 0, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "NumMax", "right", false, "", "HLP_SoporteTecnico.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtTicketId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A14TicketId), 10, 0, ".", "")), StringUtil.LTrim( ((edtTicketId_Enabled!=0) ? context.localUtil.Format( (decimal)(A14TicketId), "ZZZZZZZZZ9") : context.localUtil.Format( (decimal)(A14TicketId), "ZZZZZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,53);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTicketId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtTicketId_Enabled, 0, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "NumMax", "right", false, "", "HLP_SoporteTecnico.htm");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtUsuarioId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A15UsuarioId), 10, 0, ".", "")), StringUtil.LTrim( ((edtUsuarioId_Enabled!=0) ? context.localUtil.Format( (decimal)(A15UsuarioId), "ZZZZZZZZZ9") : context.localUtil.Format( (decimal)(A15UsuarioId), "ZZZZZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtUsuarioId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtUsuarioId_Enabled, 0, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "NumMax", "right", false, "", "HLP_SoporteTecnico.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void CheckExtendedTable0F16( )
      {
         ...
         Gx_BScreen = 1;
         standaloneModal( ) ;
         if ( ! ( (DateTime.MinValue==A203SoporteTecnicoFecha) || ( DateTimeUtil.ResetTime ( A203SoporteTecnicoFecha ) >= DateTimeUtil.ResetTime ( context.localUtil.YMDToD( 1753, 1, 1) ) ) ) )
         {
         ...
         if ( ! ( (DateTime.MinValue==A211SoporteTecnicoFechaResuelve) || ( DateTimeUtil.ResetTime ( A211SoporteTecnicoFechaResuelve ) >= DateTimeUtil.ResetTime ( context.localUtil.YMDToD( 1753, 1, 1) ) ) ) )
         {
      ...
      protected void gxLoad_5( long A15UsuarioId )
      {
         /* Using cursor T000F8 */
      ...
      protected void CheckOptimisticConcurrency0F16( )
      {
         if ( ! IsIns( ) )
         {
            ...
            Gx_longc = false;
            if ( (pr_default.getStatus(0) == 101) || ( DateTimeUtil.ResetTime ( Z203SoporteTecnicoFecha ) != DateTimeUtil.ResetTime ( T000F2_A203SoporteTecnicoFecha[0] ) ) || ( Z204SoporteTecnicoHora != T000F2_A204SoporteTecnicoHora[0] ) || ( DateTimeUtil.ResetTime ( Z211SoporteTecnicoFechaResuelve ) != DateTimeUtil.ResetTime ( T000F2_A211SoporteTecnicoFechaResuelve[0] ) ) || ( Z212SoporteTecnicoHoraResuelve != T000F2_A212SoporteTecnicoHoraResuelve[0] ) || ( StringUtil.StrCmp(Z205SoporteTecnicoInventarioSerie, T000F2_A205SoporteTecnicoInventarioSerie[0]) != 0 ) )
            {
               Gx_longc = true;
            }
            ...
            {
               if ( DateTimeUtil.ResetTime ( Z203SoporteTecnicoFecha ) != DateTimeUtil.ResetTime ( T000F2_A203SoporteTecnicoFecha[0] ) )
               {
               ...
               if ( DateTimeUtil.ResetTime ( Z211SoporteTecnicoFechaResuelve ) != DateTimeUtil.ResetTime ( T000F2_A211SoporteTecnicoFechaResuelve[0] ) )
               {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202418815990", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188151010", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("soportetecnico.js", "?2024188151010", false, true);
      ...
      public void Valid_Soportetecnicoid( )
      {
         ...
         AssignAttri("", false, "A237SoporteTecnicoPasaTaller", A237SoporteTecnicoPasaTaller);
         AssignAttri("", false, "A227SoporteTecnicoObservacion", A227SoporteTecnicoObservacion);
         AssignAttri("", false, "A15UsuarioId", StringUtil.LTrim( StringUtil.NToC( (decimal)(A15UsuarioId), 10, 0, ".", "")));
         AssignAttri("", false, "A93UsuarioNombre", A93UsuarioNombre);
         AssignAttri("", false, "A94UsuarioRequerimiento", A94UsuarioRequerimiento);
         AssignAttri("", false, "A91UsuarioGerencia", A91UsuarioGerencia);
         AssignAttri("", false, "A88UsuarioDepartamento", A88UsuarioDepartamento);
         ...
         GxWebStd.gx_hidden_field( context, "Z227SoporteTecnicoObservacion", Z227SoporteTecnicoObservacion);
         GxWebStd.gx_hidden_field( context, "Z15UsuarioId", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z15UsuarioId), 10, 0, ".", "")));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALID_TICKETID","{handler:'Valid_Ticketid',iparms:[{av:'A14TicketId',fld:'TICKETID',pic:'ZZZZZZZZZ9'},{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZZZZZZZ9'},{av:'A93UsuarioNombre',fld:'USUARIONOMBRE',pic:''},{av:'A94UsuarioRequerimiento',fld:'USUARIOREQUERIMIENTO',pic:''},{av:'A91UsuarioGerencia',fld:'USUARIOGERENCIA',pic:''},{av:'A88UsuarioDepartamento',fld:'USUARIODEPARTAMENTO',pic:''},{av:'A206SoporteTecnicoInstalacion',fld:'SOPORTETECNICOINSTALACION',pic:''},{av:'A207SoporteTecnicoConfiguracion',fld:'SOPORTETECNICOCONFIGURACION',pic:''},{av:'A208SoporteTecnicoInternetRouter',fld:'SOPORTETECNICOINTERNETROUTER',pic:''},{av:'A209SoporteTecnicoFormateo',fld:'SOPORTETECNICOFORMATEO',pic:''},{av:'A210SoporteTecnicoReparacion',fld:'SOPORTETECNICOREPARACION',pic:''},{av:'A213SoporteTecnicoLimpieza',fld:'SOPORTETECNICOLIMPIEZA',pic:''},{av:'A214SoporteTecnicoPuntoRed',fld:'SOPORTETECNICOPUNTORED',pic:''},{av:'A215SoporteTecnicoCambiosHardware',fld:'SOPORTETECNICOCAMBIOSHARDWARE',pic:''},{av:'A216SoporteTecnicoCopiasRespaldo',fld:'SOPORTETECNICOCOPIASRESPALDO',pic:''},{av:'A235SoporteTecnicoCerrado',fld:'SOPORTETECNICOCERRADO',pic:''},{av:'A236SoporteTecnicoPendiente',fld:'SOPORTETECNICOPENDIENTE',pic:''},{av:'A237SoporteTecnicoPasaTaller',fld:'SOPORTETECNICOPASATALLER',pic:''}]");
         setEventMetadata("VALID_TICKETID",",oparms:[{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZZZZZZZ9'},{av:'A93UsuarioNombre',fld:'USUARIONOMBRE',pic:''},{av:'A94UsuarioRequerimiento',fld:'USUARIOREQUERIMIENTO',pic:''},{av:'A91UsuarioGerencia',fld:'USUARIOGERENCIA',pic:''},{av:'A88UsuarioDepartamento',fld:'USUARIODEPARTAMENTO',pic:''},{av:'A206SoporteTecnicoInstalacion',fld:'SOPORTETECNICOINSTALACION',pic:''},{av:'A207SoporteTecnicoConfiguracion',fld:'SOPORTETECNICOCONFIGURACION',pic:''},{av:'A208SoporteTecnicoInternetRouter',fld:'SOPORTETECNICOINTERNETROUTER',pic:''},{av:'A209SoporteTecnicoFormateo',fld:'SOPORTETECNICOFORMATEO',pic:''},{av:'A210SoporteTecnicoReparacion',fld:'SOPORTETECNICOREPARACION',pic:''},{av:'A213SoporteTecnicoLimpieza',fld:'SOPORTETECNICOLIMPIEZA',pic:''},{av:'A214SoporteTecnicoPuntoRed',fld:'SOPORTETECNICOPUNTORED',pic:''},{av:'A215SoporteTecnicoCambiosHardware',fld:'SOPORTETECNICOCAMBIOSHARDWARE',pic:''},{av:'A216SoporteTecnicoCopiasRespaldo',fld:'SOPORTETECNICOCOPIASRESPALDO',pic:''},{av:'A235SoporteTecnicoCerrado',fld:'SOPORTETECNICOCERRADO',pic:''},{av:'A236SoporteTecnicoPendiente',fld:'SOPORTETECNICOPENDIENTE',pic:''},{av:'A237SoporteTecnicoPasaTaller',fld:'SOPORTETECNICOPASATALLER',pic:''}]}");
      ...
      public override void initialize( )
      {
         ...
         T000F6_A15UsuarioId = new long[1] ;
         T000F4_A15UsuarioId = new long[1] ;
         ...
         T000F7_A15UsuarioId = new long[1] ;
         ...
         T000F15_A15UsuarioId = new long[1] ;
      ...
      private long[] T000F6_A15UsuarioId ;
      private long[] T000F4_A15UsuarioId ;
      ...
      private long[] T000F7_A15UsuarioId ;
      ...
      private long[] T000F15_A15UsuarioId ;
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
          ...
          ,new CursorDef("T000F12", "INSERT INTO [AtencionSoporteTecnico]([SoporteTecnicoId], [SoporteTecnicoFecha], [SoporteTecnicoHora], [SoporteTecnicoFechaResuelve], [SoporteTecnicoHoraResuelve], [SoporteTecnicoInventarioSerie], [SoporteTecnicoInstalacion], [SoporteTecnicoConfiguracion], [SoporteTecnicoInternetRouter], [SoporteTecnicoFormateo], [SoporteTecnicoReparacion], [SoporteTecnicoLimpieza], [SoporteTecnicoPuntoRed], [SoporteTecnicoCambiosHardware], [SoporteTecnicoCopiasRespaldo], [SoporteTecnicoRam], [SoporteTecnicoDiscoDuro], [SoporteTecnicoProcesador], [SoporteTecnicoMaletin], [SoporteTecnicoTonerCinta], [SoporteTecnicoTarjetaVideoExtra], [SoporteTecnicoCargadorLaptop], [SoporteTecnicoCDsDVDs], [SoporteTecnicoCableEspecial], [SoporteTecnicoOtrosTaller], [SoporteTecnicoCerrado], [SoporteTecnicoPendiente], [SoporteTecnicoPasaTaller], [SoporteTecnicoObservacion], [TicketId]) VALUES(@SoporteTecnicoId, @SoporteTecnicoFecha, @SoporteTecnicoHora, @SoporteTecnicoFechaResuelve, @SoporteTecnicoHoraResuelve, @SoporteTecnicoInventarioSerie, @SoporteTecnicoInstalacion, @SoporteTecnicoConfiguracion, @SoporteTecnicoInternetRouter, @SoporteTecnicoFormateo, @SoporteTecnicoReparacion, @SoporteTecnicoLimpieza, @SoporteTecnicoPuntoRed, @SoporteTecnicoCambiosHardware, @SoporteTecnicoCopiasRespaldo, @SoporteTecnicoRam, @SoporteTecnicoDiscoDuro, @SoporteTecnicoProcesador, @SoporteTecnicoMaletin, @SoporteTecnicoTonerCinta, @SoporteTecnicoTarjetaVideoExtra, @SoporteTecnicoCargadorLaptop, @SoporteTecnicoCDsDVDs, @SoporteTecnicoCableEspecial, @SoporteTecnicoOtrosTaller, @SoporteTecnicoCerrado, @SoporteTecnicoPendiente, @SoporteTecnicoPasaTaller, @SoporteTecnicoObservacion, @TicketId)", GxErrorMask.GX_NOMASK,prmT000F12)
