...
namespace GeneXus.Programs {
   public class reportestadosatisfaccionsatisfaccionwc2 : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
         ...
         try
         {
            ...
            else
            {
               ...
               while ( (pr_default.getStatus(0) != 101) )
               {
                  ...
                  n34SatisfaccionSugerencia = P00382_n34SatisfaccionSugerencia[0];
      ...
      public override void initialize( )
      {
         ...
         P00382_n34SatisfaccionSugerencia = new bool[] {false} ;
         P00382_A94UsuarioRequerimiento = new string[] {""} ;
         P00382_A93UsuarioNombre = new string[] {""} ;
         P00382_A15UsuarioId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportestadosatisfaccionsatisfaccionwc2__default(),
            new Object[][] {
                new Object[] {
               P00382_A8SatisfaccionResueltoId, P00382_A9SatisfaccionTecnicoProblemaId, P00382_A11SatisfaccionTecnicoProfesionalismoId, P00382_A12SatisfaccionTiempoId, P00382_A13SatisfaccionAtencionId, P00382_A10SatisfaccionTecnicoCompetenteId, P00382_A34SatisfaccionSugerencia, P00382_n34SatisfaccionSugerencia, P00382_A94UsuarioRequerimiento, P00382_A93UsuarioNombre,
               P00382_A15UsuarioId, P00382_A14TicketId, P00382_A7SatisfaccionId, P00382_A31SatisfaccionAtencionNombre, P00382_A38SatisfaccionTiempoNombre, P00382_A37SatisfaccionTecnicoProfesionalismoNombre, P00382_A36SatisfaccionTecnicoProblemaNombre, P00382_A33SatisfaccionResueltoNombre, P00382_A90UsuarioFecha, P00382_A32SatisfaccionFecha
               }
            }
         );
   ...
   public class reportestadosatisfaccionsatisfaccionwc2__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00382(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (long)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] );
         }
