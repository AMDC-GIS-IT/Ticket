...
namespace GeneXus.Programs {
   public class wpbuscartddesarrollo : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wpbuscartddesarrollo( )
      {
      ...
      public wpbuscartddesarrollo( IGxContext context )
      {
      ...
      {
         get {
            return "wpbuscartddesarrollo_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188221989", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpbuscartddesarrollo.aspx") +"\">") ;
      ...
      {
         return formatLink("wpbuscartddesarrollo.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WpBuscarTdDesarrollo" ;
      }

      public override string GetPgmdesc( )
      {
         return "Wp Buscar Td Desarrollo" ;
      }
      ...
      protected void WB7Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock_var_filter_fecha_Internalname, "fecha_registro", "", "", lblTextblock_var_filter_fecha_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BT_LabelTop", 0, "", 1, 1, 0, 0, "HLP_WpBuscarTdDesarrollo.htm");
            /* User Defined Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;", "div");
            wb_table1_46_7Z2( true) ;
         }
         else
         {
            wb_table1_46_7Z2( false) ;
         }
         return  ;
      }

      protected void wb_table1_46_7Z2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            wb_table2_90_7Z2( true) ;
         }
         else
         {
            wb_table2_90_7Z2( false) ;
         }
         return  ;
      }

      protected void wb_table2_90_7Z2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         if ( wbEnd == 99 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table3_116_7Z2( true) ;
         }
         else
         {
            wb_table3_116_7Z2( false) ;
         }
         return  ;
      }

      protected void wb_table3_116_7Z2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_previouspagebuttontextblockgrid_Internalname, "", "", "", lblPaginationbar_previouspagebuttontextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGPREVIOUS(GRID)\\'."+"'", "", lblPaginationbar_previouspagebuttontextblockgrid_Class, 5, "", 1, 1, 0, 0, "HLP_WpBuscarTdDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_firstpagetextblockgrid_Internalname, lblPaginationbar_firstpagetextblockgrid_Caption, "", "", lblPaginationbar_firstpagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGFIRST(GRID)\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPaginationbar_firstpagetextblockgrid_Visible, 1, 0, 0, "HLP_WpBuscarTdDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_spacinglefttextblockgrid_Internalname, "...", "", "", lblPaginationbar_spacinglefttextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblPaginationbar_spacinglefttextblockgrid_Visible, 1, 0, 0, "HLP_WpBuscarTdDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_previouspagetextblockgrid_Internalname, lblPaginationbar_previouspagetextblockgrid_Caption, "", "", lblPaginationbar_previouspagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGPREVIOUS(GRID)\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPaginationbar_previouspagetextblockgrid_Visible, 1, 0, 0, "HLP_WpBuscarTdDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_currentpagetextblockgrid_Internalname, lblPaginationbar_currentpagetextblockgrid_Caption, "", "", lblPaginationbar_currentpagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_WpBuscarTdDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_nextpagetextblockgrid_Internalname, lblPaginationbar_nextpagetextblockgrid_Caption, "", "", lblPaginationbar_nextpagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGNEXT(GRID)\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPaginationbar_nextpagetextblockgrid_Visible, 1, 0, 0, "HLP_WpBuscarTdDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_spacingrighttextblockgrid_Internalname, "...", "", "", lblPaginationbar_spacingrighttextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblPaginationbar_spacingrighttextblockgrid_Visible, 1, 0, 0, "HLP_WpBuscarTdDesarrollo.htm");
            /* Text block */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_nextpagebuttontextblockgrid_Internalname, "", "", "", lblPaginationbar_nextpagebuttontextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGNEXT(GRID)\\'."+"'", "", lblPaginationbar_nextpagebuttontextblockgrid_Class, 5, "", 1, 1, 0, 0, "HLP_WpBuscarTdDesarrollo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START7Z2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Wp Buscar Td Desarrollo", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         /* GeneXus formulas. */
         AV35Pgmname = "WpBuscarTdDesarrollo";
         context.Gx_err = 0;
      }
      ...
      protected int subGridclient_rec_count_fnc( )
      {
         ...
         {
            A254fecha_solicitud = H007Z2_A254fecha_solicitud[0];
            n254fecha_solicitud = H007Z2_n254fecha_solicitud[0];
            A252prioridad = H007Z2_A252prioridad[0];
            n252prioridad = H007Z2_n252prioridad[0];
            A250id_actividad = H007Z2_A250id_actividad[0];
            n250id_actividad = H007Z2_n250id_actividad[0];
            A249id_categoria = H007Z2_A249id_categoria[0];
            n249id_categoria = H007Z2_n249id_categoria[0];
            A248detalle_infotecid_unidad = H007Z2_A248detalle_infotecid_unidad[0];
            n248detalle_infotecid_unidad = H007Z2_n248detalle_infotecid_unidad[0];
            A253observaciones = H007Z2_A253observaciones[0];
            n253observaciones = H007Z2_n253observaciones[0];
            A247correo_usuario = H007Z2_A247correo_usuario[0];
            n247correo_usuario = H007Z2_n247correo_usuario[0];
            A246depto_usuario = H007Z2_A246depto_usuario[0];
            n246depto_usuario = H007Z2_n246depto_usuario[0];
            A241fecha_registro = H007Z2_A241fecha_registro[0];
            n241fecha_registro = H007Z2_n241fecha_registro[0];
            A245nombre_usuario = H007Z2_A245nombre_usuario[0];
            n245nombre_usuario = H007Z2_n245nombre_usuario[0];
            A240cargo_emp = H007Z2_A240cargo_emp[0];
            n240cargo_emp = H007Z2_n240cargo_emp[0];
            A239nombre_emp = H007Z2_A239nombre_emp[0];
            n239nombre_emp = H007Z2_n239nombre_emp[0];
            A238correlativo = H007Z2_A238correlativo[0];
      ...
      protected void RF7Z2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A254fecha_solicitud = H007Z3_A254fecha_solicitud[0];
               n254fecha_solicitud = H007Z3_n254fecha_solicitud[0];
               A252prioridad = H007Z3_A252prioridad[0];
               n252prioridad = H007Z3_n252prioridad[0];
               A250id_actividad = H007Z3_A250id_actividad[0];
               n250id_actividad = H007Z3_n250id_actividad[0];
               A249id_categoria = H007Z3_A249id_categoria[0];
               n249id_categoria = H007Z3_n249id_categoria[0];
               A248detalle_infotecid_unidad = H007Z3_A248detalle_infotecid_unidad[0];
               n248detalle_infotecid_unidad = H007Z3_n248detalle_infotecid_unidad[0];
               A253observaciones = H007Z3_A253observaciones[0];
               n253observaciones = H007Z3_n253observaciones[0];
               A247correo_usuario = H007Z3_A247correo_usuario[0];
               n247correo_usuario = H007Z3_n247correo_usuario[0];
               A246depto_usuario = H007Z3_A246depto_usuario[0];
               n246depto_usuario = H007Z3_n246depto_usuario[0];
               A241fecha_registro = H007Z3_A241fecha_registro[0];
               n241fecha_registro = H007Z3_n241fecha_registro[0];
               A245nombre_usuario = H007Z3_A245nombre_usuario[0];
               n245nombre_usuario = H007Z3_n245nombre_usuario[0];
               A240cargo_emp = H007Z3_A240cargo_emp[0];
               n240cargo_emp = H007Z3_n240cargo_emp[0];
               A239nombre_emp = H007Z3_A239nombre_emp[0];
               n239nombre_emp = H007Z3_n239nombre_emp[0];
               A238correlativo = H007Z3_A238correlativo[0];
               if ( StringUtil.StrCmp(A239nombre_emp, AV25WebSession.Get("NombreResponsable")) == 0 )
               {
                  E227Z2 ();
               }
      ...
      protected void S232( )
      {
         ...
         returnInSub = false;
         context.PopUp(formatLink("wptrabajodesarrollo.aspx") , new Object[] {});
         context.DoAjaxRefresh();
      }

      protected void wb_table3_116_7Z2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_grid_Internalname, "No hay resultados", "", "", lblI_noresultsfoundtextblock_grid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_WpBuscarTdDesarrollo.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_116_7Z2e( true) ;
         }
         else
         {
            wb_table3_116_7Z2e( false) ;
         }
      }

      protected void wb_table2_90_7Z2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttActionnuevatarea_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(99), 2, 0)+","+"null"+");", "Registrar Trabajo", bttActionnuevatarea_Jsonclick, 5, "", "", StyleString, ClassString, bttActionnuevatarea_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'E_ACTIONNUEVATAREA\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WpBuscarTdDesarrollo.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_90_7Z2e( true) ;
         }
         else
         {
            wb_table2_90_7Z2e( false) ;
         }
      }

      protected void wb_table1_46_7Z2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGslayoutdefined_gridruntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblGslayoutdefined_gridruntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_WpBuscarTdDesarrollo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavGridsettingsrowsperpage_grid, cmbavGridsettingsrowsperpage_grid_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV12GridSettingsRowsPerPage_Grid), 4, 0)), 1, cmbavGridsettingsrowsperpage_grid_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavGridsettingsrowsperpage_grid.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,72);\"", "", true, 1, "HLP_WpBuscarTdDesarrollo.htm");
            cmbavGridsettingsrowsperpage_grid.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV12GridSettingsRowsPerPage_Grid), 4, 0));
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_46_7Z2e( true) ;
         }
         else
         {
            wb_table1_46_7Z2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188222323", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wpbuscartddesarrollo.js", "?2024188222325", false, true);
            context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
            context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
            context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
            context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Wp Buscar Td Desarrollo";
         subGrid_Rows = 20;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E227Z2',iparms:[{av:'AV10FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         ...
         setEventMetadata("'PAGINGPREVIOUS(GRID)'","{handler:'E137Z2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV30GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV31Filter_Fecha_From',fld:'vFILTER_FECHA_FROM',pic:''},{av:'AV8ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV32Filter_Fecha_To',fld:'vFILTER_FECHA_TO',pic:''},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV9CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV10FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         ...
         setEventMetadata("'PAGINGNEXT(GRID)'","{handler:'E147Z2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV30GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV31Filter_Fecha_From',fld:'vFILTER_FECHA_FROM',pic:''},{av:'AV8ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV32Filter_Fecha_To',fld:'vFILTER_FECHA_TO',pic:''},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV9CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV10FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         ...
         setEventMetadata("'PAGINGLAST(GRID)'","{handler:'E157Z2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV30GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV31Filter_Fecha_From',fld:'vFILTER_FECHA_FROM',pic:''},{av:'AV8ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV32Filter_Fecha_To',fld:'vFILTER_FECHA_TO',pic:''},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV9CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV10FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         ...
         setEventMetadata("'TOGGLEGRIDSETTINGS(GRID)'","{handler:'E257Z1',iparms:[{av:'divGridsettings_contentoutertablegrid_Visible',ctrl:'GRIDSETTINGS_CONTENTOUTERTABLEGRID',prop:'Visible'},{av:'AV10FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         ...
         setEventMetadata("LAYOUTDEFINED_FILTERTOGGLE_COMBINED_GRID.CLICK","{handler:'E177Z2',iparms:[{av:'divLayoutdefined_filtercollapsiblesection_combined_grid_Visible',ctrl:'LAYOUTDEFINED_FILTERCOLLAPSIBLESECTION_COMBINED_GRID',prop:'Visible'},{av:'AV10FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         ...
         setEventMetadata("LAYOUTDEFINED_FILTERCLOSE_COMBINED_GRID.CLICK","{handler:'E187Z2',iparms:[{av:'AV10FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         ...
         setEventMetadata("'E_ACTIONNUEVATAREA'","{handler:'E197Z2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV30GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV31Filter_Fecha_From',fld:'vFILTER_FECHA_FROM',pic:''},{av:'AV8ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV32Filter_Fecha_To',fld:'vFILTER_FECHA_TO',pic:''},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV9CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV10FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         H007Z2_A254fecha_solicitud = new string[] {""} ;
         H007Z2_n254fecha_solicitud = new bool[] {false} ;
         H007Z2_A252prioridad = new string[] {""} ;
         H007Z2_n252prioridad = new bool[] {false} ;
         H007Z2_A250id_actividad = new int[1] ;
         H007Z2_n250id_actividad = new bool[] {false} ;
         H007Z2_A249id_categoria = new int[1] ;
         H007Z2_n249id_categoria = new bool[] {false} ;
         H007Z2_A248detalle_infotecid_unidad = new int[1] ;
         H007Z2_n248detalle_infotecid_unidad = new bool[] {false} ;
         H007Z2_A253observaciones = new string[] {""} ;
         H007Z2_n253observaciones = new bool[] {false} ;
         H007Z2_A247correo_usuario = new string[] {""} ;
         H007Z2_n247correo_usuario = new bool[] {false} ;
         H007Z2_A246depto_usuario = new string[] {""} ;
         H007Z2_n246depto_usuario = new bool[] {false} ;
         H007Z2_A241fecha_registro = new DateTime[] {DateTime.MinValue} ;
         H007Z2_n241fecha_registro = new bool[] {false} ;
         H007Z2_A245nombre_usuario = new string[] {""} ;
         H007Z2_n245nombre_usuario = new bool[] {false} ;
         H007Z2_A240cargo_emp = new string[] {""} ;
         H007Z2_n240cargo_emp = new bool[] {false} ;
         H007Z2_A239nombre_emp = new string[] {""} ;
         H007Z2_n239nombre_emp = new bool[] {false} ;
         H007Z2_A238correlativo = new int[1] ;
         AV25WebSession = context.GetSession();
         H007Z3_A254fecha_solicitud = new string[] {""} ;
         H007Z3_n254fecha_solicitud = new bool[] {false} ;
         H007Z3_A252prioridad = new string[] {""} ;
         H007Z3_n252prioridad = new bool[] {false} ;
         H007Z3_A250id_actividad = new int[1] ;
         H007Z3_n250id_actividad = new bool[] {false} ;
         H007Z3_A249id_categoria = new int[1] ;
         H007Z3_n249id_categoria = new bool[] {false} ;
         H007Z3_A248detalle_infotecid_unidad = new int[1] ;
         H007Z3_n248detalle_infotecid_unidad = new bool[] {false} ;
         H007Z3_A253observaciones = new string[] {""} ;
         H007Z3_n253observaciones = new bool[] {false} ;
         H007Z3_A247correo_usuario = new string[] {""} ;
         H007Z3_n247correo_usuario = new bool[] {false} ;
         H007Z3_A246depto_usuario = new string[] {""} ;
         H007Z3_n246depto_usuario = new bool[] {false} ;
         H007Z3_A241fecha_registro = new DateTime[] {DateTime.MinValue} ;
         H007Z3_n241fecha_registro = new bool[] {false} ;
         H007Z3_A245nombre_usuario = new string[] {""} ;
         H007Z3_n245nombre_usuario = new bool[] {false} ;
         H007Z3_A240cargo_emp = new string[] {""} ;
         H007Z3_n240cargo_emp = new bool[] {false} ;
         H007Z3_A239nombre_emp = new string[] {""} ;
         H007Z3_n239nombre_emp = new bool[] {false} ;
         H007Z3_A238correlativo = new int[1] ;
         ...
         ROClassString = "";
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.wpbuscartddesarrollo__datastore1(),
            new Object[][] {
                new Object[] {
               H007Z2_A254fecha_solicitud, H007Z2_n254fecha_solicitud, H007Z2_A252prioridad, H007Z2_n252prioridad, H007Z2_A250id_actividad, H007Z2_n250id_actividad, H007Z2_A249id_categoria, H007Z2_n249id_categoria, H007Z2_A248detalle_infotecid_unidad, H007Z2_n248detalle_infotecid_unidad,
               H007Z2_A253observaciones, H007Z2_n253observaciones, H007Z2_A247correo_usuario, H007Z2_n247correo_usuario, H007Z2_A246depto_usuario, H007Z2_n246depto_usuario, H007Z2_A241fecha_registro, H007Z2_n241fecha_registro, H007Z2_A245nombre_usuario, H007Z2_n245nombre_usuario,
               H007Z2_A240cargo_emp, H007Z2_n240cargo_emp, H007Z2_A239nombre_emp, H007Z2_n239nombre_emp, H007Z2_A238correlativo
               }
               , new Object[] {
               H007Z3_A254fecha_solicitud, H007Z3_n254fecha_solicitud, H007Z3_A252prioridad, H007Z3_n252prioridad, H007Z3_A250id_actividad, H007Z3_n250id_actividad, H007Z3_A249id_categoria, H007Z3_n249id_categoria, H007Z3_A248detalle_infotecid_unidad, H007Z3_n248detalle_infotecid_unidad,
               H007Z3_A253observaciones, H007Z3_n253observaciones, H007Z3_A247correo_usuario, H007Z3_n247correo_usuario, H007Z3_A246depto_usuario, H007Z3_n246depto_usuario, H007Z3_A241fecha_registro, H007Z3_n241fecha_registro, H007Z3_A245nombre_usuario, H007Z3_n245nombre_usuario,
               H007Z3_A240cargo_emp, H007Z3_n240cargo_emp, H007Z3_A239nombre_emp, H007Z3_n239nombre_emp, H007Z3_A238correlativo
               }
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpbuscartddesarrollo__default(),
            new Object[][] {
            }
         );
         AV35Pgmname = "WpBuscarTdDesarrollo";
      ...
      private string[] H007Z2_A254fecha_solicitud ;
      private bool[] H007Z2_n254fecha_solicitud ;
      private string[] H007Z2_A252prioridad ;
      private bool[] H007Z2_n252prioridad ;
      private int[] H007Z2_A250id_actividad ;
      private bool[] H007Z2_n250id_actividad ;
      private int[] H007Z2_A249id_categoria ;
      private bool[] H007Z2_n249id_categoria ;
      private int[] H007Z2_A248detalle_infotecid_unidad ;
      private bool[] H007Z2_n248detalle_infotecid_unidad ;
      private string[] H007Z2_A253observaciones ;
      private bool[] H007Z2_n253observaciones ;
      private string[] H007Z2_A247correo_usuario ;
      private bool[] H007Z2_n247correo_usuario ;
      private string[] H007Z2_A246depto_usuario ;
      private bool[] H007Z2_n246depto_usuario ;
      private DateTime[] H007Z2_A241fecha_registro ;
      private bool[] H007Z2_n241fecha_registro ;
      private string[] H007Z2_A245nombre_usuario ;
      private bool[] H007Z2_n245nombre_usuario ;
      private string[] H007Z2_A240cargo_emp ;
      private bool[] H007Z2_n240cargo_emp ;
      private string[] H007Z2_A239nombre_emp ;
      private bool[] H007Z2_n239nombre_emp ;
      private int[] H007Z2_A238correlativo ;
      private string[] H007Z3_A254fecha_solicitud ;
      private bool[] H007Z3_n254fecha_solicitud ;
      private string[] H007Z3_A252prioridad ;
      private bool[] H007Z3_n252prioridad ;
      private int[] H007Z3_A250id_actividad ;
      private bool[] H007Z3_n250id_actividad ;
      private int[] H007Z3_A249id_categoria ;
      private bool[] H007Z3_n249id_categoria ;
      private int[] H007Z3_A248detalle_infotecid_unidad ;
      private bool[] H007Z3_n248detalle_infotecid_unidad ;
      private string[] H007Z3_A253observaciones ;
      private bool[] H007Z3_n253observaciones ;
      private string[] H007Z3_A247correo_usuario ;
      private bool[] H007Z3_n247correo_usuario ;
      private string[] H007Z3_A246depto_usuario ;
      private bool[] H007Z3_n246depto_usuario ;
      private DateTime[] H007Z3_A241fecha_registro ;
      private bool[] H007Z3_n241fecha_registro ;
      private string[] H007Z3_A245nombre_usuario ;
      private bool[] H007Z3_n245nombre_usuario ;
      private string[] H007Z3_A240cargo_emp ;
      private bool[] H007Z3_n240cargo_emp ;
      private string[] H007Z3_A239nombre_emp ;
      private bool[] H007Z3_n239nombre_emp ;
      private int[] H007Z3_A238correlativo ;
   ...
   public class wpbuscartddesarrollo__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int A249id_categoria )
      {
         ...
         AddWhere(sWhereString, "([id_categoria] = 14 or [id_categoria] = 15)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H007Z2(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (string)dynConstraints[2] , (DateTime)dynConstraints[3] , (int)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (int)dynConstraints[12] );
               case 1 :
                     return conditional_H007Z3(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (string)dynConstraints[2] , (DateTime)dynConstraints[3] , (int)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (int)dynConstraints[12] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H007Z2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007Z2,21, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007Z3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007Z3,21, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
 ...
 public class wpbuscartddesarrollo__default : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
