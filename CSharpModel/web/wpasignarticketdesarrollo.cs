...
namespace GeneXus.Programs {
   public class wpasignarticketdesarrollo : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wpasignarticketdesarrollo( )
      {
      ...
      public wpasignarticketdesarrollo( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Gridusuario") == 0 )
            {
               ...
               gxgrGridusuario_refresh( subGridusuario_Rows, AV28GenericFilter_GridUsuario, AV33UsuarioNombre_Filter, AV34EstadoTicketUsuarioNombre_Filter, AV22ClassCollection_GridUsuario, AV21OrderedBy_GridUsuario, AV38Pgmname, AV17GridConfiguration, AV18CurrentPage_GridUsuario, AV32FreezeColumnTitles_GridUsuario) ;
      ...
      {
         get {
            return "wpasignarticketdesarrollo_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188215165", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpasignarticketdesarrollo.aspx") +"\">") ;
      ...
      {
         return formatLink("wpasignarticketdesarrollo.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WPAsignarTicketDesarrollo" ;
      }

      public override string GetPgmdesc( )
      {
         return "Asignar Ticket Desarrollo" ;
      }
      ...
      protected void WB7B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;", "div");
            wb_table1_53_7B2( true) ;
         }
         else
         {
            wb_table1_53_7B2( false) ;
         }
         return  ;
      }

      protected void wb_table1_53_7B2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_97_7B2( true) ;
         }
         else
         {
            wb_table2_97_7B2( false) ;
         }
         return  ;
      }

      protected void wb_table2_97_7B2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table3_117_7B2( true) ;
         }
         else
         {
            wb_table3_117_7B2( false) ;
         }
         return  ;
      }

      protected void wb_table3_117_7B2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_previouspagebuttontextblockgridusuario_Internalname, "", "", "", lblPaginationbar_previouspagebuttontextblockgridusuario_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGPREVIOUS(GRIDUSUARIO)\\'."+"'", "", lblPaginationbar_previouspagebuttontextblockgridusuario_Class, 5, "", 1, 1, 0, 0, "HLP_WPAsignarTicketDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_firstpagetextblockgridusuario_Internalname, lblPaginationbar_firstpagetextblockgridusuario_Caption, "", "", lblPaginationbar_firstpagetextblockgridusuario_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGFIRST(GRIDUSUARIO)\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPaginationbar_firstpagetextblockgridusuario_Visible, 1, 0, 0, "HLP_WPAsignarTicketDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_spacinglefttextblockgridusuario_Internalname, "...", "", "", lblPaginationbar_spacinglefttextblockgridusuario_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblPaginationbar_spacinglefttextblockgridusuario_Visible, 1, 0, 0, "HLP_WPAsignarTicketDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_previouspagetextblockgridusuario_Internalname, lblPaginationbar_previouspagetextblockgridusuario_Caption, "", "", lblPaginationbar_previouspagetextblockgridusuario_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGPREVIOUS(GRIDUSUARIO)\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPaginationbar_previouspagetextblockgridusuario_Visible, 1, 0, 0, "HLP_WPAsignarTicketDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_currentpagetextblockgridusuario_Internalname, lblPaginationbar_currentpagetextblockgridusuario_Caption, "", "", lblPaginationbar_currentpagetextblockgridusuario_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_WPAsignarTicketDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_nextpagetextblockgridusuario_Internalname, lblPaginationbar_nextpagetextblockgridusuario_Caption, "", "", lblPaginationbar_nextpagetextblockgridusuario_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGNEXT(GRIDUSUARIO)\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPaginationbar_nextpagetextblockgridusuario_Visible, 1, 0, 0, "HLP_WPAsignarTicketDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_spacingrighttextblockgridusuario_Internalname, "...", "", "", lblPaginationbar_spacingrighttextblockgridusuario_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblPaginationbar_spacingrighttextblockgridusuario_Visible, 1, 0, 0, "HLP_WPAsignarTicketDesarrollo.htm");
            /* Text block */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_nextpagebuttontextblockgridusuario_Internalname, "", "", "", lblPaginationbar_nextpagebuttontextblockgridusuario_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGNEXT(GRIDUSUARIO)\\'."+"'", "", lblPaginationbar_nextpagebuttontextblockgridusuario_Class, 5, "", 1, 1, 0, 0, "HLP_WPAsignarTicketDesarrollo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START7B2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Asignar Ticket Desarrollo", 0) ;
         }
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 16), "GRIDUSUARIO.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 19), "GRIDUSUARIO.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 17), "'E_ASIGNARTICKET'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 17), "'E_ASIGNARTICKET'") == 0 ) )
                           {
                              ...
                              AV35AsignarTicket_Action = cgiGet( edtavAsignarticket_action_Internalname);
                              AssignProp("", false, edtavAsignarticket_action_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV35AsignarTicket_Action)) ? AV39Asignarticket_action_GXI : context.convertURL( context.PathToRelativeUrl( AV35AsignarTicket_Action))), !bGXsfl_100_Refreshing);
                              AssignProp("", false, edtavAsignarticket_action_Internalname, "SrcSet", context.GetImageSrcSet( AV35AsignarTicket_Action), true);
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
      ...
      {
         /* GeneXus formulas. */
         AV38Pgmname = "WPAsignarTicketDesarrollo";
         context.Gx_err = 0;
      }
      ...
      protected void RF7B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV28GenericFilter_GridUsuario = StringUtil.PadR( StringUtil.RTrim( AV28GenericFilter_GridUsuario), 100, "%");
            /* Using cursor H007B2 */
            pr_default.execute(0, new Object[] {lV33UsuarioNombre_Filter, lV34EstadoTicketUsuarioNombre_Filter, lV28GenericFilter_GridUsuario, lV28GenericFilter_GridUsuario, lV28GenericFilter_GridUsuario, lV28GenericFilter_GridUsuario, lV28GenericFilter_GridUsuario, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_100_idx = 1;
            sGXsfl_100_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_100_idx), 4, 0), 4, "0");
            SubsflControlProps_1002( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGridusuario_Rows == 0 ) || ( GRIDUSUARIO_nCurrentRecord < subGridusuario_fnc_Recordsperpage( ) ) ) ) )
            {
               A190EstadoTicketUsuarioNombre = H007B2_A190EstadoTicketUsuarioNombre[0];
               A189EstadoTicketUsuarioId = H007B2_A189EstadoTicketUsuarioId[0];
               A95UsuarioTelefono = H007B2_A95UsuarioTelefono[0];
               A89UsuarioEmail = H007B2_A89UsuarioEmail[0];
               A94UsuarioRequerimiento = H007B2_A94UsuarioRequerimiento[0];
               A88UsuarioDepartamento = H007B2_A88UsuarioDepartamento[0];
               A91UsuarioGerencia = H007B2_A91UsuarioGerencia[0];
               A92UsuarioHora = H007B2_A92UsuarioHora[0];
               A90UsuarioFecha = H007B2_A90UsuarioFecha[0];
               A15UsuarioId = H007B2_A15UsuarioId[0];
               A93UsuarioNombre = H007B2_A93UsuarioNombre[0];
               A190EstadoTicketUsuarioNombre = H007B2_A190EstadoTicketUsuarioNombre[0];
               E227B2 ();
      ...
      protected int subGridusuario_fnc_Recordcount( )
      {
         ...
         lV28GenericFilter_GridUsuario = StringUtil.PadR( StringUtil.RTrim( AV28GenericFilter_GridUsuario), 100, "%");
         /* Using cursor H007B3 */
         pr_default.execute(1, new Object[] {lV33UsuarioNombre_Filter, lV34EstadoTicketUsuarioNombre_Filter, lV28GenericFilter_GridUsuario, lV28GenericFilter_GridUsuario, lV28GenericFilter_GridUsuario, lV28GenericFilter_GridUsuario, lV28GenericFilter_GridUsuario});
         GRIDUSUARIO_nRecordCount = H007B3_AGRIDUSUARIO_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void E217B2( )
      {
         ...
         new k2bloadrowsperpage(context ).execute(  AV38Pgmname,  "GridUsuario", out  AV24RowsPerPage_GridUsuario, out  AV25RowsPerPageLoaded_GridUsuario) ;
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         new k2bloadgridconfiguration(context ).execute(  AV38Pgmname,  "GridUsuario", ref  AV17GridConfiguration) ;
      ...
      private void E227B2( )
      {
         ...
         AV35AsignarTicket_Action = context.GetImagePath( "5649fbb8-8ce0-4810-a5ce-bd649ea83c3a", "", context.GetTheme( ));
         AssignAttri("", false, edtavAsignarticket_action_Internalname, AV35AsignarTicket_Action);
         AV39Asignarticket_action_GXI = GXDbFile.PathToUrl( context.GetImagePath( "5649fbb8-8ce0-4810-a5ce-bd649ea83c3a", "", context.GetTheme( )));
      ...
      protected void S172( )
      {
         ...
         AssignProp("", false, edtUsuarioId_Internalname, "Forecolor", StringUtil.LTrimStr( (decimal)(edtUsuarioId_Forecolor), 9, 0), !bGXsfl_100_Refreshing);
      ...
      protected void E177B2( )
      {
         ...
         new k2bsavegridconfiguration(context ).execute(  AV38Pgmname,  "GridUsuario",  AV17GridConfiguration,  true) ;
         ...
         if ( AV24RowsPerPage_GridUsuario != AV26GridSettingsRowsPerPage_GridUsuario )
         {
            ...
            AssignAttri("", false, "AV24RowsPerPage_GridUsuario", StringUtil.LTrimStr( (decimal)(AV24RowsPerPage_GridUsuario), 4, 0));
            new k2bsaverowsperpage(context ).execute(  AV38Pgmname,  "GridUsuario",  AV24RowsPerPage_GridUsuario) ;
            AV18CurrentPage_GridUsuario = 1;
            AssignAttri("", false, "AV18CurrentPage_GridUsuario", StringUtil.LTrimStr( (decimal)(AV18CurrentPage_GridUsuario), 4, 0));
            subgridusuario_firstpage( ) ;
         }
      ...
      protected void S162( )
      {
         ...
         if ( AV15K2BFilterValuesSDT_WebForm.Count > 0 )
         {
            ...
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV38Pgmname,  "GridUsuario",  AV15K2BFilterValuesSDT_WebForm, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item2) ;
      ...
      protected void S212( )
      {
         ...
         returnInSub = false;
         context.PopUp(formatLink("wpregistrarticketdesarrollo.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A15UsuarioId,10,0)),UrlEncode(StringUtil.RTrim(A93UsuarioNombre)),UrlEncode(StringUtil.RTrim(A91UsuarioGerencia)),UrlEncode(StringUtil.RTrim(A88UsuarioDepartamento)),UrlEncode(StringUtil.RTrim(A94UsuarioRequerimiento))}, new string[] {"UsuarioId","UsuarioNombre","UsuarioGerencia","UsuarioDepartamento","UsuarioRequerimiento"}) , new Object[] {});
         context.DoAjaxRefresh();
      }

      protected void wb_table3_117_7B2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_gridusuario_Internalname, "No hay resultados", "", "", lblI_noresultsfoundtextblock_gridusuario_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_WPAsignarTicketDesarrollo.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_117_7B2e( true) ;
         }
         else
         {
            wb_table3_117_7B2e( false) ;
         }
      }

      protected void wb_table2_97_7B2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            else
            {
               ...
               GridusuarioContainer.AddColumnProperties(GridusuarioColumn);
               GridusuarioColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridusuarioColumn.AddObjectProperty("Value", context.convertURL( AV35AsignarTicket_Action));
         ...
         if ( wbEnd == 100 )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_97_7B2e( true) ;
         }
         else
         {
            wb_table2_97_7B2e( false) ;
         }
      }

      protected void wb_table1_53_7B2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGslayoutdefined_gridusuarioruntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblGslayoutdefined_gridusuarioruntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_WPAsignarTicketDesarrollo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_53_7B2e( true) ;
         }
         else
         {
            wb_table1_53_7B2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188215538", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpasignarticketdesarrollo.js", "?2024188215538", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Asignar Ticket Desarrollo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ORDERBYUC_GRIDUSUARIO.ORDERBYCHANGED","{handler:'E127B2',iparms:[{av:'GRIDUSUARIO_nFirstRecordOnPage'},{av:'GRIDUSUARIO_nEOF'},{av:'subGridusuario_Rows',ctrl:'GRIDUSUARIO',prop:'Rows'},{av:'AV28GenericFilter_GridUsuario',fld:'vGENERICFILTER_GRIDUSUARIO',pic:''},{av:'AV33UsuarioNombre_Filter',fld:'vUSUARIONOMBRE_FILTER',pic:''},{av:'AV34EstadoTicketUsuarioNombre_Filter',fld:'vESTADOTICKETUSUARIONOMBRE_FILTER',pic:''},{av:'AV22ClassCollection_GridUsuario',fld:'vCLASSCOLLECTION_GRIDUSUARIO',pic:''},{av:'AV21OrderedBy_GridUsuario',fld:'vORDEREDBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV29SelectedOrderBy_GridUsuario',fld:'vSELECTEDORDERBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         setEventMetadata("ORDERBYUC_GRIDUSUARIO.ORDERBYCHANGED",",oparms:[{av:'AV21OrderedBy_GridUsuario',fld:'vORDEREDBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'divMaingrid_responsivetable_gridusuario_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRIDUSUARIO',prop:'Class'},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV22ClassCollection_GridUsuario',fld:'vCLASSCOLLECTION_GRIDUSUARIO',pic:''},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]}");
         setEventMetadata("GRIDUSUARIO.LOAD","{handler:'E227B2',iparms:[{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         setEventMetadata("GRIDUSUARIO.LOAD",",oparms:[{av:'tblI_noresultsfoundtablename_gridusuario_Visible',ctrl:'I_NORESULTSFOUNDTABLENAME_GRIDUSUARIO',prop:'Visible'},{av:'AV35AsignarTicket_Action',fld:'vASIGNARTICKET_ACTION',pic:''},{av:'edtavAsignarticket_action_Tooltiptext',ctrl:'vASIGNARTICKET_ACTION',prop:'Tooltiptext'},{av:'edtUsuarioNombre_Forecolor',ctrl:'USUARIONOMBRE',prop:'Forecolor'},{av:'edtUsuarioId_Forecolor',ctrl:'USUARIOID',prop:'Forecolor'},{av:'edtUsuarioFecha_Forecolor',ctrl:'USUARIOFECHA',prop:'Forecolor'},{av:'edtUsuarioHora_Forecolor',ctrl:'USUARIOHORA',prop:'Forecolor'},{av:'edtUsuarioGerencia_Forecolor',ctrl:'USUARIOGERENCIA',prop:'Forecolor'},{av:'edtUsuarioDepartamento_Forecolor',ctrl:'USUARIODEPARTAMENTO',prop:'Forecolor'},{av:'edtUsuarioRequerimiento_Forecolor',ctrl:'USUARIOREQUERIMIENTO',prop:'Forecolor'},{av:'edtEstadoTicketUsuarioNombre_Forecolor',ctrl:'ESTADOTICKETUSUARIONOMBRE',prop:'Forecolor'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]}");
         setEventMetadata("GRIDUSUARIO.REFRESH","{handler:'E237B2',iparms:[{av:'AV22ClassCollection_GridUsuario',fld:'vCLASSCOLLECTION_GRIDUSUARIO',pic:''},{av:'AV21OrderedBy_GridUsuario',fld:'vORDEREDBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV33UsuarioNombre_Filter',fld:'vUSUARIONOMBRE_FILTER',pic:''},{av:'AV34EstadoTicketUsuarioNombre_Filter',fld:'vESTADOTICKETUSUARIONOMBRE_FILTER',pic:''},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'GRIDUSUARIO_nFirstRecordOnPage'},{av:'GRIDUSUARIO_nEOF'},{av:'subGridusuario_Rows',ctrl:'GRIDUSUARIO',prop:'Rows'},{av:'AV28GenericFilter_GridUsuario',fld:'vGENERICFILTER_GRIDUSUARIO',pic:''},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         ...
         setEventMetadata("'PAGINGFIRST(GRIDUSUARIO)'","{handler:'E137B2',iparms:[{av:'GRIDUSUARIO_nFirstRecordOnPage'},{av:'GRIDUSUARIO_nEOF'},{av:'subGridusuario_Rows',ctrl:'GRIDUSUARIO',prop:'Rows'},{av:'AV28GenericFilter_GridUsuario',fld:'vGENERICFILTER_GRIDUSUARIO',pic:''},{av:'AV33UsuarioNombre_Filter',fld:'vUSUARIONOMBRE_FILTER',pic:''},{av:'AV34EstadoTicketUsuarioNombre_Filter',fld:'vESTADOTICKETUSUARIONOMBRE_FILTER',pic:''},{av:'AV22ClassCollection_GridUsuario',fld:'vCLASSCOLLECTION_GRIDUSUARIO',pic:''},{av:'AV21OrderedBy_GridUsuario',fld:'vORDEREDBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         setEventMetadata("'PAGINGFIRST(GRIDUSUARIO)'",",oparms:[{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'lblPaginationbar_firstpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_previouspagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_currentpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_CURRENTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_nextpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_lastpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_previouspagebuttontextblockgridusuario_Class',ctrl:'PAGINATIONBAR_PREVIOUSPAGEBUTTONTEXTBLOCKGRIDUSUARIO',prop:'Class'},{av:'lblPaginationbar_nextpagebuttontextblockgridusuario_Class',ctrl:'PAGINATIONBAR_NEXTPAGEBUTTONTEXTBLOCKGRIDUSUARIO',prop:'Class'},{av:'lblPaginationbar_firstpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_spacinglefttextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_SPACINGLEFTTEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_previouspagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_lastpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_spacingrighttextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_SPACINGRIGHTTEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_nextpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'divPaginationbar_pagingcontainertable_gridusuario_Visible',ctrl:'PAGINATIONBAR_PAGINGCONTAINERTABLE_GRIDUSUARIO',prop:'Visible'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]}");
         setEventMetadata("'PAGINGPREVIOUS(GRIDUSUARIO)'","{handler:'E147B2',iparms:[{av:'GRIDUSUARIO_nFirstRecordOnPage'},{av:'GRIDUSUARIO_nEOF'},{av:'subGridusuario_Rows',ctrl:'GRIDUSUARIO',prop:'Rows'},{av:'AV28GenericFilter_GridUsuario',fld:'vGENERICFILTER_GRIDUSUARIO',pic:''},{av:'AV33UsuarioNombre_Filter',fld:'vUSUARIONOMBRE_FILTER',pic:''},{av:'AV34EstadoTicketUsuarioNombre_Filter',fld:'vESTADOTICKETUSUARIONOMBRE_FILTER',pic:''},{av:'AV22ClassCollection_GridUsuario',fld:'vCLASSCOLLECTION_GRIDUSUARIO',pic:''},{av:'AV21OrderedBy_GridUsuario',fld:'vORDEREDBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         setEventMetadata("'PAGINGPREVIOUS(GRIDUSUARIO)'",",oparms:[{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'lblPaginationbar_firstpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_previouspagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_currentpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_CURRENTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_nextpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_lastpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_previouspagebuttontextblockgridusuario_Class',ctrl:'PAGINATIONBAR_PREVIOUSPAGEBUTTONTEXTBLOCKGRIDUSUARIO',prop:'Class'},{av:'lblPaginationbar_nextpagebuttontextblockgridusuario_Class',ctrl:'PAGINATIONBAR_NEXTPAGEBUTTONTEXTBLOCKGRIDUSUARIO',prop:'Class'},{av:'lblPaginationbar_firstpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_spacinglefttextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_SPACINGLEFTTEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_previouspagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_lastpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_spacingrighttextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_SPACINGRIGHTTEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_nextpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'divPaginationbar_pagingcontainertable_gridusuario_Visible',ctrl:'PAGINATIONBAR_PAGINGCONTAINERTABLE_GRIDUSUARIO',prop:'Visible'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]}");
         setEventMetadata("'PAGINGNEXT(GRIDUSUARIO)'","{handler:'E157B2',iparms:[{av:'GRIDUSUARIO_nFirstRecordOnPage'},{av:'GRIDUSUARIO_nEOF'},{av:'subGridusuario_Rows',ctrl:'GRIDUSUARIO',prop:'Rows'},{av:'AV28GenericFilter_GridUsuario',fld:'vGENERICFILTER_GRIDUSUARIO',pic:''},{av:'AV33UsuarioNombre_Filter',fld:'vUSUARIONOMBRE_FILTER',pic:''},{av:'AV34EstadoTicketUsuarioNombre_Filter',fld:'vESTADOTICKETUSUARIONOMBRE_FILTER',pic:''},{av:'AV22ClassCollection_GridUsuario',fld:'vCLASSCOLLECTION_GRIDUSUARIO',pic:''},{av:'AV21OrderedBy_GridUsuario',fld:'vORDEREDBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         setEventMetadata("'PAGINGNEXT(GRIDUSUARIO)'",",oparms:[{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'lblPaginationbar_firstpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_previouspagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_currentpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_CURRENTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_nextpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_lastpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_previouspagebuttontextblockgridusuario_Class',ctrl:'PAGINATIONBAR_PREVIOUSPAGEBUTTONTEXTBLOCKGRIDUSUARIO',prop:'Class'},{av:'lblPaginationbar_nextpagebuttontextblockgridusuario_Class',ctrl:'PAGINATIONBAR_NEXTPAGEBUTTONTEXTBLOCKGRIDUSUARIO',prop:'Class'},{av:'lblPaginationbar_firstpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_spacinglefttextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_SPACINGLEFTTEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_previouspagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_lastpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_spacingrighttextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_SPACINGRIGHTTEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_nextpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'divPaginationbar_pagingcontainertable_gridusuario_Visible',ctrl:'PAGINATIONBAR_PAGINGCONTAINERTABLE_GRIDUSUARIO',prop:'Visible'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]}");
         setEventMetadata("'PAGINGLAST(GRIDUSUARIO)'","{handler:'E167B2',iparms:[{av:'GRIDUSUARIO_nFirstRecordOnPage'},{av:'GRIDUSUARIO_nEOF'},{av:'subGridusuario_Rows',ctrl:'GRIDUSUARIO',prop:'Rows'},{av:'AV28GenericFilter_GridUsuario',fld:'vGENERICFILTER_GRIDUSUARIO',pic:''},{av:'AV33UsuarioNombre_Filter',fld:'vUSUARIONOMBRE_FILTER',pic:''},{av:'AV34EstadoTicketUsuarioNombre_Filter',fld:'vESTADOTICKETUSUARIONOMBRE_FILTER',pic:''},{av:'AV22ClassCollection_GridUsuario',fld:'vCLASSCOLLECTION_GRIDUSUARIO',pic:''},{av:'AV21OrderedBy_GridUsuario',fld:'vORDEREDBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         setEventMetadata("'PAGINGLAST(GRIDUSUARIO)'",",oparms:[{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'lblPaginationbar_firstpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_previouspagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_currentpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_CURRENTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_nextpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_lastpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_previouspagebuttontextblockgridusuario_Class',ctrl:'PAGINATIONBAR_PREVIOUSPAGEBUTTONTEXTBLOCKGRIDUSUARIO',prop:'Class'},{av:'lblPaginationbar_nextpagebuttontextblockgridusuario_Class',ctrl:'PAGINATIONBAR_NEXTPAGEBUTTONTEXTBLOCKGRIDUSUARIO',prop:'Class'},{av:'lblPaginationbar_firstpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_spacinglefttextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_SPACINGLEFTTEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_previouspagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_lastpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_spacingrighttextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_SPACINGRIGHTTEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_nextpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'divPaginationbar_pagingcontainertable_gridusuario_Visible',ctrl:'PAGINATIONBAR_PAGINGCONTAINERTABLE_GRIDUSUARIO',prop:'Visible'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]}");
         setEventMetadata("'TOGGLEGRIDSETTINGS(GRIDUSUARIO)'","{handler:'E257B1',iparms:[{av:'divGridsettings_contentoutertablegridusuario_Visible',ctrl:'GRIDSETTINGS_CONTENTOUTERTABLEGRIDUSUARIO',prop:'Visible'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         ...
         setEventMetadata("FILTERTAGSUSERCONTROL_GRIDUSUARIO.TAGDELETED","{handler:'E117B2',iparms:[{av:'GRIDUSUARIO_nFirstRecordOnPage'},{av:'GRIDUSUARIO_nEOF'},{av:'subGridusuario_Rows',ctrl:'GRIDUSUARIO',prop:'Rows'},{av:'AV28GenericFilter_GridUsuario',fld:'vGENERICFILTER_GRIDUSUARIO',pic:''},{av:'AV33UsuarioNombre_Filter',fld:'vUSUARIONOMBRE_FILTER',pic:''},{av:'AV34EstadoTicketUsuarioNombre_Filter',fld:'vESTADOTICKETUSUARIONOMBRE_FILTER',pic:''},{av:'AV22ClassCollection_GridUsuario',fld:'vCLASSCOLLECTION_GRIDUSUARIO',pic:''},{av:'AV21OrderedBy_GridUsuario',fld:'vORDEREDBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV38Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV20DeletedTag_GridUsuario',fld:'vDELETEDTAG_GRIDUSUARIO',pic:''},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         ...
         setEventMetadata("LAYOUTDEFINED_FILTERTOGGLE_COMBINED_GRIDUSUARIO.CLICK","{handler:'E187B2',iparms:[{av:'divLayoutdefined_filtercollapsiblesection_combined_gridusuario_Visible',ctrl:'LAYOUTDEFINED_FILTERCOLLAPSIBLESECTION_COMBINED_GRIDUSUARIO',prop:'Visible'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         ...
         setEventMetadata("LAYOUTDEFINED_FILTERCLOSE_COMBINED_GRIDUSUARIO.CLICK","{handler:'E197B2',iparms:[{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         A89UsuarioEmail = "";
         A190EstadoTicketUsuarioNombre = "";
         AV35AsignarTicket_Action = "";
         AV39Asignarticket_action_GXI = "";
         scmdbuf = "";
         lV33UsuarioNombre_Filter = "";
         lV34EstadoTicketUsuarioNombre_Filter = "";
         lV28GenericFilter_GridUsuario = "";
         H007B2_A190EstadoTicketUsuarioNombre = new string[] {""} ;
         H007B2_A189EstadoTicketUsuarioId = new short[1] ;
         H007B2_A95UsuarioTelefono = new int[1] ;
         H007B2_A89UsuarioEmail = new string[] {""} ;
         H007B2_A94UsuarioRequerimiento = new string[] {""} ;
         H007B2_A88UsuarioDepartamento = new string[] {""} ;
         H007B2_A91UsuarioGerencia = new string[] {""} ;
         H007B2_A92UsuarioHora = new DateTime[] {DateTime.MinValue} ;
         H007B2_A90UsuarioFecha = new DateTime[] {DateTime.MinValue} ;
         H007B2_A15UsuarioId = new long[1] ;
         H007B2_A93UsuarioNombre = new string[] {""} ;
         H007B3_AGRIDUSUARIO_nRecordCount = new long[1] ;
         ...
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpasignarticketdesarrollo__default(),
            new Object[][] {
                new Object[] {
               H007B2_A190EstadoTicketUsuarioNombre, H007B2_A189EstadoTicketUsuarioId, H007B2_A95UsuarioTelefono, H007B2_A89UsuarioEmail, H007B2_A94UsuarioRequerimiento, H007B2_A88UsuarioDepartamento, H007B2_A91UsuarioGerencia, H007B2_A92UsuarioHora, H007B2_A90UsuarioFecha, H007B2_A15UsuarioId,
               H007B2_A93UsuarioNombre
               }
               , new Object[] {
               H007B3_AGRIDUSUARIO_nRecordCount
               }
            }
         );
         AV38Pgmname = "WPAsignarTicketDesarrollo";
      ...
      private bool AV35AsignarTicket_Action_IsBlob ;
      ...
      private string AV39Asignarticket_action_GXI ;
      ...
      private string AV35AsignarTicket_Action ;
      ...
      private string[] H007B2_A190EstadoTicketUsuarioNombre ;
      private short[] H007B2_A189EstadoTicketUsuarioId ;
      private int[] H007B2_A95UsuarioTelefono ;
      private string[] H007B2_A89UsuarioEmail ;
      private string[] H007B2_A94UsuarioRequerimiento ;
      private string[] H007B2_A88UsuarioDepartamento ;
      private string[] H007B2_A91UsuarioGerencia ;
      private DateTime[] H007B2_A92UsuarioHora ;
      private DateTime[] H007B2_A90UsuarioFecha ;
      private long[] H007B2_A15UsuarioId ;
      private string[] H007B2_A93UsuarioNombre ;
      private long[] H007B3_AGRIDUSUARIO_nRecordCount ;
   ...
   public class wpasignarticketdesarrollo__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H007B2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] );
               case 1 :
                     return conditional_H007B3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H007B2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007B2,21, GxCacheFrequency.OFF ,true,false )
