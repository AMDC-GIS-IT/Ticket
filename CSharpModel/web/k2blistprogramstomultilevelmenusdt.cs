...
namespace GeneXus.Programs {
   public class k2blistprogramstomultilevelmenusdt : GXProcedure
   {
                           ...
                           out GXBaseCollection<SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem> aP1_MultiLevelMenu )
      {
         ...
         this.AV9MultiLevelMenu = new GXBaseCollection<SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem>( context, "K2BMultiLevelMenuItem", "kb_ticket") ;
         initialize();
         executePrivate();
                                 ...
                                 out GXBaseCollection<SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem> aP1_MultiLevelMenu )
      {
         ...
         objk2blistprogramstomultilevelmenusdt.AV9MultiLevelMenu = new GXBaseCollection<SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem>( context, "K2BMultiLevelMenuItem", "kb_ticket") ;
      ...
      void executePrivate( )
      {
         ...
         AV9MultiLevelMenu = new GXBaseCollection<SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem>( context, "K2BMultiLevelMenuItem", "kb_ticket");
         AV14GXV1 = 1;
