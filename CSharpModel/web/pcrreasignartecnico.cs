...
namespace GeneXus.Programs {
   public class pcrreasignartecnico : GXProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         AV52TicketResponsableFechaHoraAsigna = DateTimeUtil.Now( context);
         AV53TicketResponsableFechaHoraResuelve = DateTimeUtil.Now( context);
         AV54TicketFechaSistema = DateTimeUtil.Now( context);
         AV55TicketResponsableFechaSistema = DateTimeUtil.Now( context);
         /*
         ...
         */
         ...
         A287TicketResponsableFechaHoraAsigna = DateTimeUtil.TAdd( AV52TicketResponsableFechaHoraAsigna, 3600*(-6));
         ...
         /* Optimized UPDATE. */
         /* Using cursor P00655 */
         pr_default.execute(2, new Object[] {AV49TicketResponsableSig, AV24TicketId});
         pr_default.close(2);
         dsDefault.SmartCacheProvider.SetUpdated("Ticket");
         /* End optimized UPDATE. */
         /* Using cursor P00656 */
         pr_default.execute(3, new Object[] {AV8TicketResponsableId, AV45TicketTecnicoResponsableId});
         while ( (pr_default.getStatus(3) != 101) )
         {
            A17EstadoTicketTecnicoId = P00656_A17EstadoTicketTecnicoId[0];
            A198TicketTecnicoResponsableId = P00656_A198TicketTecnicoResponsableId[0];
            A16TicketResponsableId = P00656_A16TicketResponsableId[0];
            A145TicketResponsableInventarioSerie = P00656_A145TicketResponsableInventarioSerie[0];
            n145TicketResponsableInventarioSerie = P00656_n145TicketResponsableInventarioSerie[0];
            A146TicketResponsableInstalacion = P00656_A146TicketResponsableInstalacion[0];
            n146TicketResponsableInstalacion = P00656_n146TicketResponsableInstalacion[0];
            A147TicketResponsableConfiguracion = P00656_A147TicketResponsableConfiguracion[0];
            n147TicketResponsableConfiguracion = P00656_n147TicketResponsableConfiguracion[0];
            A148TicketResponsableInternetRouter = P00656_A148TicketResponsableInternetRouter[0];
            n148TicketResponsableInternetRouter = P00656_n148TicketResponsableInternetRouter[0];
            A149TicketResponsableFormateo = P00656_A149TicketResponsableFormateo[0];
            n149TicketResponsableFormateo = P00656_n149TicketResponsableFormateo[0];
            A150TicketResponsableReparacion = P00656_A150TicketResponsableReparacion[0];
            n150TicketResponsableReparacion = P00656_n150TicketResponsableReparacion[0];
            A151TicketResponsableLimpieza = P00656_A151TicketResponsableLimpieza[0];
            n151TicketResponsableLimpieza = P00656_n151TicketResponsableLimpieza[0];
            A152TicketResponsablePuntoRed = P00656_A152TicketResponsablePuntoRed[0];
            n152TicketResponsablePuntoRed = P00656_n152TicketResponsablePuntoRed[0];
            A153TicketResponsableCambiosHardware = P00656_A153TicketResponsableCambiosHardware[0];
            n153TicketResponsableCambiosHardware = P00656_n153TicketResponsableCambiosHardware[0];
            A154TicketResponsableCopiasRespaldo = P00656_A154TicketResponsableCopiasRespaldo[0];
            n154TicketResponsableCopiasRespaldo = P00656_n154TicketResponsableCopiasRespaldo[0];
            A177TicketResponsableRamTxt = P00656_A177TicketResponsableRamTxt[0];
            n177TicketResponsableRamTxt = P00656_n177TicketResponsableRamTxt[0];
            A178TicketResponsableDiscoDuroTxt = P00656_A178TicketResponsableDiscoDuroTxt[0];
            n178TicketResponsableDiscoDuroTxt = P00656_n178TicketResponsableDiscoDuroTxt[0];
            A179TicketResponsableProcesadorTxt = P00656_A179TicketResponsableProcesadorTxt[0];
            n179TicketResponsableProcesadorTxt = P00656_n179TicketResponsableProcesadorTxt[0];
            A180TicketResponsableMaletinTxt = P00656_A180TicketResponsableMaletinTxt[0];
            n180TicketResponsableMaletinTxt = P00656_n180TicketResponsableMaletinTxt[0];
            A181TicketResponsableTonerCintaTxt = P00656_A181TicketResponsableTonerCintaTxt[0];
            n181TicketResponsableTonerCintaTxt = P00656_n181TicketResponsableTonerCintaTxt[0];
            A182TicketResponsableTarjetaVideoExtraTxt = P00656_A182TicketResponsableTarjetaVideoExtraTxt[0];
            n182TicketResponsableTarjetaVideoExtraTxt = P00656_n182TicketResponsableTarjetaVideoExtraTxt[0];
            A183TicketResponsableCargadorLaptopTxt = P00656_A183TicketResponsableCargadorLaptopTxt[0];
            n183TicketResponsableCargadorLaptopTxt = P00656_n183TicketResponsableCargadorLaptopTxt[0];
            A184TicketResponsableCDsDVDsTxt = P00656_A184TicketResponsableCDsDVDsTxt[0];
            n184TicketResponsableCDsDVDsTxt = P00656_n184TicketResponsableCDsDVDsTxt[0];
            A185TicketResponsableCableEspecialTxt = P00656_A185TicketResponsableCableEspecialTxt[0];
            n185TicketResponsableCableEspecialTxt = P00656_n185TicketResponsableCableEspecialTxt[0];
            A186TicketResponsableOtrosTallerTxt = P00656_A186TicketResponsableOtrosTallerTxt[0];
            n186TicketResponsableOtrosTallerTxt = P00656_n186TicketResponsableOtrosTallerTxt[0];
            A165TicketResponsableCerrado = P00656_A165TicketResponsableCerrado[0];
            n165TicketResponsableCerrado = P00656_n165TicketResponsableCerrado[0];
            A166TicketResponsablePendiente = P00656_A166TicketResponsablePendiente[0];
            n166TicketResponsablePendiente = P00656_n166TicketResponsablePendiente[0];
            A167TicketResponsablePasaTaller = P00656_A167TicketResponsablePasaTaller[0];
            n167TicketResponsablePasaTaller = P00656_n167TicketResponsablePasaTaller[0];
            A168TicketResponsableObservacion = P00656_A168TicketResponsableObservacion[0];
            n168TicketResponsableObservacion = P00656_n168TicketResponsableObservacion[0];
            A175TicketResponsableFechaResuelve = P00656_A175TicketResponsableFechaResuelve[0];
            n175TicketResponsableFechaResuelve = P00656_n175TicketResponsableFechaResuelve[0];
            A176TicketResponsableHoraResuelve = P00656_A176TicketResponsableHoraResuelve[0];
            n176TicketResponsableHoraResuelve = P00656_n176TicketResponsableHoraResuelve[0];
            A288TicketResponsableFechaHoraResuelve = P00656_A288TicketResponsableFechaHoraResuelve[0];
            n288TicketResponsableFechaHoraResuelve = P00656_n288TicketResponsableFechaHoraResuelve[0];
            A14TicketId = P00656_A14TicketId[0];
         ...
         /* Optimized UPDATE. */
         /* Using cursor P00658 */
         pr_default.execute(5, new Object[] {AV45TicketTecnicoResponsableId});
         pr_default.close(5);
      ...
      {
         AV52TicketResponsableFechaHoraAsigna = (DateTime)(DateTime.MinValue);
         AV53TicketResponsableFechaHoraResuelve = (DateTime)(DateTime.MinValue);
         AV54TicketFechaSistema = (DateTime)(DateTime.MinValue);
         AV55TicketResponsableFechaSistema = (DateTime)(DateTime.MinValue);
         scmdbuf = "";
         ...
         Gx_emsg = "";
         P00656_A17EstadoTicketTecnicoId = new short[1] ;
         P00656_A198TicketTecnicoResponsableId = new short[1] ;
         P00656_A16TicketResponsableId = new long[1] ;
         P00656_A145TicketResponsableInventarioSerie = new string[] {""} ;
         P00656_n145TicketResponsableInventarioSerie = new bool[] {false} ;
         P00656_A146TicketResponsableInstalacion = new bool[] {false} ;
         P00656_n146TicketResponsableInstalacion = new bool[] {false} ;
         P00656_A147TicketResponsableConfiguracion = new bool[] {false} ;
         P00656_n147TicketResponsableConfiguracion = new bool[] {false} ;
         P00656_A148TicketResponsableInternetRouter = new bool[] {false} ;
         P00656_n148TicketResponsableInternetRouter = new bool[] {false} ;
         P00656_A149TicketResponsableFormateo = new bool[] {false} ;
         P00656_n149TicketResponsableFormateo = new bool[] {false} ;
         P00656_A150TicketResponsableReparacion = new bool[] {false} ;
         P00656_n150TicketResponsableReparacion = new bool[] {false} ;
         P00656_A151TicketResponsableLimpieza = new bool[] {false} ;
         P00656_n151TicketResponsableLimpieza = new bool[] {false} ;
         P00656_A152TicketResponsablePuntoRed = new bool[] {false} ;
         P00656_n152TicketResponsablePuntoRed = new bool[] {false} ;
         P00656_A153TicketResponsableCambiosHardware = new bool[] {false} ;
         P00656_n153TicketResponsableCambiosHardware = new bool[] {false} ;
         P00656_A154TicketResponsableCopiasRespaldo = new bool[] {false} ;
         P00656_n154TicketResponsableCopiasRespaldo = new bool[] {false} ;
         P00656_A177TicketResponsableRamTxt = new string[] {""} ;
         P00656_n177TicketResponsableRamTxt = new bool[] {false} ;
         P00656_A178TicketResponsableDiscoDuroTxt = new string[] {""} ;
         P00656_n178TicketResponsableDiscoDuroTxt = new bool[] {false} ;
         P00656_A179TicketResponsableProcesadorTxt = new string[] {""} ;
         P00656_n179TicketResponsableProcesadorTxt = new bool[] {false} ;
         P00656_A180TicketResponsableMaletinTxt = new string[] {""} ;
         P00656_n180TicketResponsableMaletinTxt = new bool[] {false} ;
         P00656_A181TicketResponsableTonerCintaTxt = new string[] {""} ;
         P00656_n181TicketResponsableTonerCintaTxt = new bool[] {false} ;
         P00656_A182TicketResponsableTarjetaVideoExtraTxt = new string[] {""} ;
         P00656_n182TicketResponsableTarjetaVideoExtraTxt = new bool[] {false} ;
         P00656_A183TicketResponsableCargadorLaptopTxt = new string[] {""} ;
         P00656_n183TicketResponsableCargadorLaptopTxt = new bool[] {false} ;
         P00656_A184TicketResponsableCDsDVDsTxt = new string[] {""} ;
         P00656_n184TicketResponsableCDsDVDsTxt = new bool[] {false} ;
         P00656_A185TicketResponsableCableEspecialTxt = new string[] {""} ;
         P00656_n185TicketResponsableCableEspecialTxt = new bool[] {false} ;
         P00656_A186TicketResponsableOtrosTallerTxt = new string[] {""} ;
         P00656_n186TicketResponsableOtrosTallerTxt = new bool[] {false} ;
         P00656_A165TicketResponsableCerrado = new bool[] {false} ;
         P00656_n165TicketResponsableCerrado = new bool[] {false} ;
         P00656_A166TicketResponsablePendiente = new bool[] {false} ;
         P00656_n166TicketResponsablePendiente = new bool[] {false} ;
         P00656_A167TicketResponsablePasaTaller = new bool[] {false} ;
         P00656_n167TicketResponsablePasaTaller = new bool[] {false} ;
         P00656_A168TicketResponsableObservacion = new string[] {""} ;
         P00656_n168TicketResponsableObservacion = new bool[] {false} ;
         P00656_A175TicketResponsableFechaResuelve = new DateTime[] {DateTime.MinValue} ;
         P00656_n175TicketResponsableFechaResuelve = new bool[] {false} ;
         P00656_A176TicketResponsableHoraResuelve = new DateTime[] {DateTime.MinValue} ;
         P00656_n176TicketResponsableHoraResuelve = new bool[] {false} ;
         P00656_A288TicketResponsableFechaHoraResuelve = new DateTime[] {DateTime.MinValue} ;
         P00656_n288TicketResponsableFechaHoraResuelve = new bool[] {false} ;
         P00656_A14TicketId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.pcrreasignartecnico__default(),
            new Object[][] {
               ...
               , new Object[] {
               P00656_A17EstadoTicketTecnicoId, P00656_A198TicketTecnicoResponsableId, P00656_A16TicketResponsableId, P00656_A145TicketResponsableInventarioSerie, P00656_n145TicketResponsableInventarioSerie, P00656_A146TicketResponsableInstalacion, P00656_n146TicketResponsableInstalacion, P00656_A147TicketResponsableConfiguracion, P00656_n147TicketResponsableConfiguracion, P00656_A148TicketResponsableInternetRouter,
               P00656_n148TicketResponsableInternetRouter, P00656_A149TicketResponsableFormateo, P00656_n149TicketResponsableFormateo, P00656_A150TicketResponsableReparacion, P00656_n150TicketResponsableReparacion, P00656_A151TicketResponsableLimpieza, P00656_n151TicketResponsableLimpieza, P00656_A152TicketResponsablePuntoRed, P00656_n152TicketResponsablePuntoRed, P00656_A153TicketResponsableCambiosHardware,
               P00656_n153TicketResponsableCambiosHardware, P00656_A154TicketResponsableCopiasRespaldo, P00656_n154TicketResponsableCopiasRespaldo, P00656_A177TicketResponsableRamTxt, P00656_n177TicketResponsableRamTxt, P00656_A178TicketResponsableDiscoDuroTxt, P00656_n178TicketResponsableDiscoDuroTxt, P00656_A179TicketResponsableProcesadorTxt, P00656_n179TicketResponsableProcesadorTxt, P00656_A180TicketResponsableMaletinTxt,
               P00656_n180TicketResponsableMaletinTxt, P00656_A181TicketResponsableTonerCintaTxt, P00656_n181TicketResponsableTonerCintaTxt, P00656_A182TicketResponsableTarjetaVideoExtraTxt, P00656_n182TicketResponsableTarjetaVideoExtraTxt, P00656_A183TicketResponsableCargadorLaptopTxt, P00656_n183TicketResponsableCargadorLaptopTxt, P00656_A184TicketResponsableCDsDVDsTxt, P00656_n184TicketResponsableCDsDVDsTxt, P00656_A185TicketResponsableCableEspecialTxt,
               P00656_n185TicketResponsableCableEspecialTxt, P00656_A186TicketResponsableOtrosTallerTxt, P00656_n186TicketResponsableOtrosTallerTxt, P00656_A165TicketResponsableCerrado, P00656_n165TicketResponsableCerrado, P00656_A166TicketResponsablePendiente, P00656_n166TicketResponsablePendiente, P00656_A167TicketResponsablePasaTaller, P00656_n167TicketResponsablePasaTaller, P00656_A168TicketResponsableObservacion,
               P00656_n168TicketResponsableObservacion, P00656_A175TicketResponsableFechaResuelve, P00656_n175TicketResponsableFechaResuelve, P00656_A176TicketResponsableHoraResuelve, P00656_n176TicketResponsableHoraResuelve, P00656_A288TicketResponsableFechaHoraResuelve, P00656_n288TicketResponsableFechaHoraResuelve, P00656_A14TicketId
               }
               , new Object[] {
               }
               , new Object[] {
      ...
      private DateTime AV52TicketResponsableFechaHoraAsigna ;
      private DateTime AV53TicketResponsableFechaHoraResuelve ;
      private DateTime AV54TicketFechaSistema ;
      private DateTime AV55TicketResponsableFechaSistema ;
      ...
      private short[] P00656_A17EstadoTicketTecnicoId ;
      private short[] P00656_A198TicketTecnicoResponsableId ;
      private long[] P00656_A16TicketResponsableId ;
      private string[] P00656_A145TicketResponsableInventarioSerie ;
      private bool[] P00656_n145TicketResponsableInventarioSerie ;
      private bool[] P00656_A146TicketResponsableInstalacion ;
      private bool[] P00656_n146TicketResponsableInstalacion ;
      private bool[] P00656_A147TicketResponsableConfiguracion ;
      private bool[] P00656_n147TicketResponsableConfiguracion ;
      private bool[] P00656_A148TicketResponsableInternetRouter ;
      private bool[] P00656_n148TicketResponsableInternetRouter ;
      private bool[] P00656_A149TicketResponsableFormateo ;
      private bool[] P00656_n149TicketResponsableFormateo ;
      private bool[] P00656_A150TicketResponsableReparacion ;
      private bool[] P00656_n150TicketResponsableReparacion ;
      private bool[] P00656_A151TicketResponsableLimpieza ;
      private bool[] P00656_n151TicketResponsableLimpieza ;
      private bool[] P00656_A152TicketResponsablePuntoRed ;
      private bool[] P00656_n152TicketResponsablePuntoRed ;
      private bool[] P00656_A153TicketResponsableCambiosHardware ;
      private bool[] P00656_n153TicketResponsableCambiosHardware ;
      private bool[] P00656_A154TicketResponsableCopiasRespaldo ;
      private bool[] P00656_n154TicketResponsableCopiasRespaldo ;
      private string[] P00656_A177TicketResponsableRamTxt ;
      private bool[] P00656_n177TicketResponsableRamTxt ;
      private string[] P00656_A178TicketResponsableDiscoDuroTxt ;
      private bool[] P00656_n178TicketResponsableDiscoDuroTxt ;
      private string[] P00656_A179TicketResponsableProcesadorTxt ;
      private bool[] P00656_n179TicketResponsableProcesadorTxt ;
      private string[] P00656_A180TicketResponsableMaletinTxt ;
      private bool[] P00656_n180TicketResponsableMaletinTxt ;
      private string[] P00656_A181TicketResponsableTonerCintaTxt ;
      private bool[] P00656_n181TicketResponsableTonerCintaTxt ;
      private string[] P00656_A182TicketResponsableTarjetaVideoExtraTxt ;
      private bool[] P00656_n182TicketResponsableTarjetaVideoExtraTxt ;
      private string[] P00656_A183TicketResponsableCargadorLaptopTxt ;
      private bool[] P00656_n183TicketResponsableCargadorLaptopTxt ;
      private string[] P00656_A184TicketResponsableCDsDVDsTxt ;
      private bool[] P00656_n184TicketResponsableCDsDVDsTxt ;
      private string[] P00656_A185TicketResponsableCableEspecialTxt ;
      private bool[] P00656_n185TicketResponsableCableEspecialTxt ;
      private string[] P00656_A186TicketResponsableOtrosTallerTxt ;
      private bool[] P00656_n186TicketResponsableOtrosTallerTxt ;
      private bool[] P00656_A165TicketResponsableCerrado ;
      private bool[] P00656_n165TicketResponsableCerrado ;
      private bool[] P00656_A166TicketResponsablePendiente ;
      private bool[] P00656_n166TicketResponsablePendiente ;
      private bool[] P00656_A167TicketResponsablePasaTaller ;
      private bool[] P00656_n167TicketResponsablePasaTaller ;
      private string[] P00656_A168TicketResponsableObservacion ;
      private bool[] P00656_n168TicketResponsableObservacion ;
      private DateTime[] P00656_A175TicketResponsableFechaResuelve ;
      private bool[] P00656_n175TicketResponsableFechaResuelve ;
      private DateTime[] P00656_A176TicketResponsableHoraResuelve ;
      private bool[] P00656_n176TicketResponsableHoraResuelve ;
      private DateTime[] P00656_A288TicketResponsableFechaHoraResuelve ;
      private bool[] P00656_n288TicketResponsableFechaHoraResuelve ;
      private long[] P00656_A14TicketId ;
   }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P00654", cmdBufferP00654, GxErrorMask.GX_NOMASK,prmP00654)
             ,new CursorDef("P00655", "UPDATE [Ticket] SET [TicketLastId]=@TicketLastId  WHERE [TicketId] = @AV24TicketId", GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00655)
             ,new CursorDef("P00656", "SELECT [EstadoTicketTecnicoId], [TicketTecnicoResponsableId], [TicketResponsableId], [TicketResponsableInventarioSerie], [TicketResponsableInstalacion], [TicketResponsableConfiguracion], [TicketResponsableInternetRouter], [TicketResponsableFormateo], [TicketResponsableReparacion], [TicketResponsableLimpieza], [TicketResponsablePuntoRed], [TicketResponsableCambiosHardware], [TicketResponsableCopiasRespaldo], [TicketResponsableRamTxt], [TicketResponsableDiscoDuroTxt], [TicketResponsableProcesadorTxt], [TicketResponsableMaletinTxt], [TicketResponsableTonerCintaTxt], [TicketResponsableTarjetaVideoExtraTxt], [TicketResponsableCargadorLaptopTxt], [TicketResponsableCDsDVDsTxt], [TicketResponsableCableEspecialTxt], [TicketResponsableOtrosTallerTxt], [TicketResponsableCerrado], [TicketResponsablePendiente], [TicketResponsablePasaTaller], [TicketResponsableObservacion], [TicketResponsableFechaResuelve], [TicketResponsableHoraResuelve], [TicketResponsableFechaHoraResuelve], [TicketId] FROM [TicketResponsable] WITH (UPDLOCK) WHERE ([TicketResponsableId] = @AV8TicketResponsableId) AND ([TicketTecnicoResponsableId] = @AV45TicketTecnicoResponsableId) AND ([EstadoTicketTecnicoId] = 3) ORDER BY [TicketId], [TicketResponsableId] ",true, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00656,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00657", cmdBufferP00657, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00657)
             ,new CursorDef("P00658", "UPDATE [Responsable] SET [EstadoResponsableId]=2  WHERE [ResponsableId] = @AV45TicketTecnicoResponsableId", GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00658)
          };
       }
    }
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             ...
             case 3 :
                ...
                ((DateTime[]) buf[55])[0] = rslt.getGXDateTime(30);
