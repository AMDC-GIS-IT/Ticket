...
namespace GeneXus.Programs {
   public class promptactividades_categoria : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public promptactividades_categoria( )
      {
      ...
      public promptactividades_categoria( IGxContext context )
      {
      ...
      {
         this.AV17pid_actividad_categoria = 0 ;
         executePrivate();
         aP0_pid_actividad_categoria=this.AV17pid_actividad_categoria;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV38flCat = GetPar( "flCat");
               AV39flAct = GetPar( "flAct");
               ...
               AV17pid_actividad_categoria = (int)(NumberUtil.Val( GetPar( "pid_actividad_categoria"), "."));
               ...
               gxgrGrid_refresh( subGrid_Rows, AV29K2BToolsGenericSearchField, AV38flCat, AV39flAct, AV15ClassCollection, AV30OrderedBy, AV42Pgmname, AV5CurrentPage, AV7GridConfiguration, AV17pid_actividad_categoria, AV8FreezeColumnTitles) ;
            ...
            {
               AV17pid_actividad_categoria = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV17pid_actividad_categoria", StringUtil.LTrimStr( (decimal)(AV17pid_actividad_categoria), 9, 0));
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188205464", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("promptactividades_categoria.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV17pid_actividad_categoria,9,0))}, new string[] {"pid_actividad_categoria"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vFLCAT", AV38flCat);
         GxWebStd.gx_hidden_field( context, "GXH_vFLACT", AV39flAct);
         /* Send saved values. */
         ...
         GxWebStd.gx_hidden_field( context, "vPID_ACTIVIDAD_CATEGORIA", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV17pid_actividad_categoria), 9, 0, ".", "")));
      ...
      {
         return formatLink("promptactividades_categoria.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV17pid_actividad_categoria,9,0))}, new string[] {"pid_actividad_categoria"})  ;
      }

      public override string GetPgmname( )
      {
         return "Promptactividades_categoria" ;
      }
      ...
      protected void WB540( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divK2btoolstable_attributecontainerflcat_Internalname, 1, 0, "px", 0, "px", "K2BT_NGA K2BToolsTable_TopAttributeContainer", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group gx-default-form-group gx-label-top", "left", "top", ""+" data-gx-for=\""+edtavFlcat_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavFlcat_Internalname, "nombre_categoria", "gx-form-item Attribute_FilterLabel", 1, true, "width: 100%;");
            /* Div Control */
            ...
            ClassString = "Attribute_Filter";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavFlcat_Internalname, AV38flCat, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,41);\"", 0, 1, edtavFlcat_Enabled, 0, 80, "chr", 3, "row", StyleString, ClassString, "", "", "200", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_Promptactividades_categoria.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divK2btoolstable_attributecontainerflact_Internalname, 1, 0, "px", 0, "px", "K2BT_NGA K2BToolsTable_TopAttributeContainer", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group gx-default-form-group gx-label-top", "left", "top", ""+" data-gx-for=\""+edtavFlact_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavFlact_Internalname, "Actividad Categoría", "gx-form-item Attribute_FilterLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Multiple line edit */
            ...
            ClassString = "Attribute_Filter";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavFlact_Internalname, AV39flAct, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,47);\"", 0, 1, edtavFlact_Enabled, 0, 80, "chr", 3, "row", StyleString, ClassString, "", "", "200", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_Promptactividades_categoria.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;", "div");
            wb_table1_49_542( true) ;
         }
         else
         {
            wb_table1_49_542( false) ;
         }
         return  ;
      }

      protected void wb_table1_49_542e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         if ( wbEnd == 93 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_101_542( true) ;
         }
         else
         {
            wb_table2_101_542( false) ;
         }
         return  ;
      }

      protected void wb_table2_101_542e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagebuttontextblock_Internalname, "", "", "", lblPreviouspagebuttontextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOPREVIOUS\\'."+"'", "", lblPreviouspagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_Promptactividades_categoria.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFirstpagetextblock_Internalname, lblFirstpagetextblock_Caption, "", "", lblFirstpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOFIRST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblFirstpagetextblock_Visible, 1, 0, 0, "HLP_Promptactividades_categoria.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacinglefttextblock_Internalname, "...", "", "", lblSpacinglefttextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacinglefttextblock_Visible, 1, 0, 0, "HLP_Promptactividades_categoria.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagetextblock_Internalname, lblPreviouspagetextblock_Caption, "", "", lblPreviouspagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOPREVIOUS\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPreviouspagetextblock_Visible, 1, 0, 0, "HLP_Promptactividades_categoria.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCurrentpagetextblock_Internalname, lblCurrentpagetextblock_Caption, "", "", lblCurrentpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_Promptactividades_categoria.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagetextblock_Internalname, lblNextpagetextblock_Caption, "", "", lblNextpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DONEXT\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblNextpagetextblock_Visible, 1, 0, 0, "HLP_Promptactividades_categoria.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacingrighttextblock_Internalname, "...", "", "", lblSpacingrighttextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacingrighttextblock_Visible, 1, 0, 0, "HLP_Promptactividades_categoria.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLastpagetextblock_Internalname, lblLastpagetextblock_Caption, "", "", lblLastpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOLAST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblLastpagetextblock_Visible, 1, 0, 0, "HLP_Promptactividades_categoria.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagebuttontextblock_Internalname, "", "", "", lblNextpagebuttontextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DONEXT\\'."+"'", "", lblNextpagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_Promptactividades_categoria.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       /* Set Refresh If Flcat Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vFLCAT"), AV38flCat) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Flact Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vFLACT"), AV39flAct) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       int AV17pid_actividad_categoria ,
      ...
      {
         /* GeneXus formulas. */
         AV42Pgmname = "Promptactividades_categoria";
         context.Gx_err = 0;
      }
      ...
      protected void RF542( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_datastore1.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV30OrderedBy } ,
                                                 new int[]{
                                                 TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.BOOLEAN, TypeConstants.SHORT
                                                 }
            });
            lV39flAct = StringUtil.Concat( StringUtil.RTrim( AV39flAct), "%", "");
            lV29K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV29K2BToolsGenericSearchField), 100, "%");
            lV29K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV29K2BToolsGenericSearchField), 100, "%");
            lV29K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV29K2BToolsGenericSearchField), 100, "%");
            lV29K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV29K2BToolsGenericSearchField), 100, "%");
            /* Using cursor H00542 */
            pr_datastore1.execute(0, new Object[] {lV39flAct, lV29K2BToolsGenericSearchField, lV29K2BToolsGenericSearchField, lV29K2BToolsGenericSearchField, lV29K2BToolsGenericSearchField, GXPagingFrom2, GXPagingTo2, GXPagingFrom2, GXPagingTo2});
            nGXsfl_93_idx = 1;
            sGXsfl_93_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_93_idx), 4, 0), 4, "0");
            SubsflControlProps_932( ) ;
            while ( ( (pr_datastore1.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A125actividades_categoriaestado = H00542_A125actividades_categoriaestado[0];
               n125actividades_categoriaestado = H00542_n125actividades_categoriaestado[0];
               A124unidad_medida = H00542_A124unidad_medida[0];
               n124unidad_medida = H00542_n124unidad_medida[0];
               A123nombre_actividad = H00542_A123nombre_actividad[0];
               n123nombre_actividad = H00542_n123nombre_actividad[0];
               A122actividades_categoriaid_tipo_categoria = H00542_A122actividades_categoriaid_tipo_categoria[0];
               n122actividades_categoriaid_tipo_categoria = H00542_n122actividades_categoriaid_tipo_categoria[0];
               A102id_actividad_categoria = H00542_A102id_actividad_categoria[0];
               E24542 ();
      ...
      protected void send_integrity_lvl_hashes542( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV42Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV42Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_ID_ACTIVIDAD_CATEGORIA"+"_"+sGXsfl_93_idx, GetSecureSignedToken( sGXsfl_93_idx, context.localUtil.Format( (decimal)(A102id_actividad_categoria), "ZZZZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV29K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV29K2BToolsGenericSearchField), 100, "%");
         /* Using cursor H00543 */
         pr_datastore1.execute(1, new Object[] {lV39flAct, lV29K2BToolsGenericSearchField, lV29K2BToolsGenericSearchField, lV29K2BToolsGenericSearchField, lV29K2BToolsGenericSearchField});
      ...
      protected void STRUP540( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV38flCat = cgiGet( edtavFlcat_Internalname);
            AssignAttri("", false, "AV38flCat", AV38flCat);
            AV39flAct = cgiGet( edtavFlact_Internalname);
            AssignAttri("", false, "AV39flAct", AV39flAct);
      ...
      protected void E20542( )
      {
         ...
         AV37ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "actividades_categoria";
         AV37ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "actividades_categoria";
         ...
         GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
         Form.Caption = StringUtil.Format( "Seleccionar %1", "actividades_categoria", "", "", "", "", "", "", "", "");
      ...
      protected void E22542( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV17pid_actividad_categoria = A102id_actividad_categoria;
         AssignAttri("", false, "AV17pid_actividad_categoria", StringUtil.LTrimStr( (decimal)(AV17pid_actividad_categoria), 9, 0));
         context.setWebReturnParms(new Object[] {(int)AV17pid_actividad_categoria});
         context.setWebReturnParmsMetadata(new Object[] {"AV17pid_actividad_categoria"});
         context.wjLocDisableFrm = 1;
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV12GridStateKey = StringUtil.Str( (decimal)(AV17pid_actividad_categoria), 9, 0);
         ...
         while ( AV43GXV1 <= AV13GridState.gxTpr_Filtervalues.Count )
         {
            ...
            if ( StringUtil.StrCmp(AV14GridStateFilterValue.gxTpr_Filtername, "flCat") == 0 )
            {
               AV38flCat = AV14GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV38flCat", AV38flCat);
            }
            else if ( StringUtil.StrCmp(AV14GridStateFilterValue.gxTpr_Filtername, "flAct") == 0 )
            {
               AV39flAct = AV14GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV39flAct", AV39flAct);
            }
      ...
      protected void S122( )
      {
         ...
         AV14GridStateFilterValue.gxTpr_Filtername = "flCat";
         AV14GridStateFilterValue.gxTpr_Value = AV38flCat;
         AV13GridState.gxTpr_Filtervalues.Add(AV14GridStateFilterValue, 0);
         AV14GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         AV14GridStateFilterValue.gxTpr_Filtername = "flAct";
         AV14GridStateFilterValue.gxTpr_Value = AV39flAct;
         AV13GridState.gxTpr_Filtervalues.Add(AV14GridStateFilterValue, 0);
         AV14GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
      ...
      protected void S142( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV38flCat)) )
         {
            AV26K2BFilterValuesSDTItem = new SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem(context);
            AV26K2BFilterValuesSDTItem.gxTpr_Name = "flCat";
            ...
            AV26K2BFilterValuesSDTItem.gxTpr_Value = AV38flCat;
            AV26K2BFilterValuesSDTItem.gxTpr_Valuedescription = AV38flCat;
            AV25K2BFilterValuesSDT.Add(AV26K2BFilterValuesSDTItem, 0);
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV39flAct)) )
         {
            AV26K2BFilterValuesSDTItem = new SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem(context);
            AV26K2BFilterValuesSDTItem.gxTpr_Name = "flAct";
            AV26K2BFilterValuesSDTItem.gxTpr_Description = "Actividad Categoría";
            AV26K2BFilterValuesSDTItem.gxTpr_Canbedeleted = true;
            AV26K2BFilterValuesSDTItem.gxTpr_Type = "Standard";
            AV26K2BFilterValuesSDTItem.gxTpr_Value = AV39flAct;
            AV26K2BFilterValuesSDTItem.gxTpr_Valuedescription = AV39flAct;
            AV25K2BFilterValuesSDT.Add(AV26K2BFilterValuesSDTItem, 0);
         }
      ...
      protected void E11542( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV28DeletedTag, "flCat") == 0 )
         {
            AV38flCat = "";
            AssignAttri("", false, "AV38flCat", AV38flCat);
         }
         else if ( StringUtil.StrCmp(AV28DeletedTag, "flAct") == 0 )
         {
            AV39flAct = "";
            AssignAttri("", false, "AV39flAct", AV39flAct);
         }
      ...
      protected void wb_table2_101_542( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoresultsfoundtextblock_Internalname, "No hay resultados", "", "", lblNoresultsfoundtextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_Promptactividades_categoria.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_101_542e( true) ;
         }
         else
         {
            wb_table2_101_542e( false) ;
         }
      }

      protected void wb_table1_49_542( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRuntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblRuntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_Promptactividades_categoria.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttK2bgridsettingssave_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(93), 2, 0)+","+"null"+");", "Aplicar", bttK2bgridsettingssave_Jsonclick, 5, "Aplicar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'SAVEGRIDSETTINGS\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Promptactividades_categoria.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_49_542e( true) ;
         }
         else
         {
            wb_table1_49_542e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV17pid_actividad_categoria = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV17pid_actividad_categoria", StringUtil.LTrimStr( (decimal)(AV17pid_actividad_categoria), 9, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188205747", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("promptactividades_categoria.js", "?2024188205747", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
      ...
      {
         edtid_actividad_categoria_Internalname = "ID_ACTIVIDAD_CATEGORIA_"+sGXsfl_93_idx;
         edtactividades_categoriaid_tipo_categoria_Internalname = "ACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA_"+sGXsfl_93_idx;
         edtnombre_actividad_Internalname = "NOMBRE_ACTIVIDAD_"+sGXsfl_93_idx;
         edtunidad_medida_Internalname = "UNIDAD_MEDIDA_"+sGXsfl_93_idx;
         edtactividades_categoriaestado_Internalname = "ACTIVIDADES_CATEGORIAESTADO_"+sGXsfl_93_idx;
      }

      protected void SubsflControlProps_fel_932( )
      {
         edtid_actividad_categoria_Internalname = "ID_ACTIVIDAD_CATEGORIA_"+sGXsfl_93_fel_idx;
         edtactividades_categoriaid_tipo_categoria_Internalname = "ACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA_"+sGXsfl_93_fel_idx;
         edtnombre_actividad_Internalname = "NOMBRE_ACTIVIDAD_"+sGXsfl_93_fel_idx;
         edtunidad_medida_Internalname = "UNIDAD_MEDIDA_"+sGXsfl_93_fel_idx;
         edtactividades_categoriaestado_Internalname = "ACTIVIDADES_CATEGORIAESTADO_"+sGXsfl_93_fel_idx;
      }
      ...
      protected void sendrow_932( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_93_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            AssignProp("", false, edtactividades_categoriaid_tipo_categoria_Internalname, "Link", edtactividades_categoriaid_tipo_categoria_Link, !bGXsfl_93_Refreshing);
      ...
      protected void init_default_properties( )
      {
         ...
         edtavFlcat_Internalname = "vFLCAT";
         divK2btoolstable_attributecontainerflcat_Internalname = "K2BTOOLSTABLE_ATTRIBUTECONTAINERFLCAT";
         edtavFlact_Internalname = "vFLACT";
         divK2btoolstable_attributecontainerflact_Internalname = "K2BTOOLSTABLE_ATTRIBUTECONTAINERFLACT";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavFlact_Enabled = 1;
         edtavFlcat_Enabled = 1;
         divFiltercollapsiblesection_combined_Visible = 1;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV17pid_actividad_categoria',fld:'vPID_ACTIVIDAD_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV38flCat',fld:'vFLCAT',pic:''},{av:'AV39flAct',fld:'vFLACT',pic:''},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("ENTER","{handler:'E22542',iparms:[{av:'A102id_actividad_categoria',fld:'ID_ACTIVIDAD_CATEGORIA',pic:'ZZZZZZZZ9',hsh:true},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV17pid_actividad_categoria',fld:'vPID_ACTIVIDAD_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("GRID.REFRESH","{handler:'E23542',iparms:[{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV38flCat',fld:'vFLCAT',pic:''},{av:'AV39flAct',fld:'vFLACT',pic:''},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pid_actividad_categoria',fld:'vPID_ACTIVIDAD_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E24542',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOSEARCH'","{handler:'E25542',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV38flCat',fld:'vFLCAT',pic:''},{av:'AV39flAct',fld:'vFLACT',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pid_actividad_categoria',fld:'vPID_ACTIVIDAD_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E13542',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV38flCat',fld:'vFLCAT',pic:''},{av:'AV39flAct',fld:'vFLACT',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pid_actividad_categoria',fld:'vPID_ACTIVIDAD_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E14542',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV38flCat',fld:'vFLCAT',pic:''},{av:'AV39flAct',fld:'vFLACT',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pid_actividad_categoria',fld:'vPID_ACTIVIDAD_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E15542',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV38flCat',fld:'vFLCAT',pic:''},{av:'AV39flAct',fld:'vFLACT',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pid_actividad_categoria',fld:'vPID_ACTIVIDAD_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E16542',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV38flCat',fld:'vFLCAT',pic:''},{av:'AV39flAct',fld:'vFLACT',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pid_actividad_categoria',fld:'vPID_ACTIVIDAD_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'TOGGLEGRIDSETTINGSTABLE'","{handler:'E26541',iparms:[{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E17542',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV38flCat',fld:'vFLCAT',pic:''},{av:'AV39flAct',fld:'vFLACT',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pid_actividad_categoria',fld:'vPID_ACTIVIDAD_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV10RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV9GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED","{handler:'E11542',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV38flCat',fld:'vFLCAT',pic:''},{av:'AV39flAct',fld:'vFLACT',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pid_actividad_categoria',fld:'vPID_ACTIVIDAD_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV28DeletedTag',fld:'vDELETEDTAG',pic:''},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED",",oparms:[{av:'AV38flCat',fld:'vFLCAT',pic:''},{av:'AV39flAct',fld:'vFLACT',pic:''},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E12542',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV38flCat',fld:'vFLCAT',pic:''},{av:'AV39flAct',fld:'vFLACT',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pid_actividad_categoria',fld:'vPID_ACTIVIDAD_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV34UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERTOGGLE_COMBINED.CLICK","{handler:'E18542',iparms:[{av:'divFiltercollapsiblesection_combined_Visible',ctrl:'FILTERCOLLAPSIBLESECTION_COMBINED',prop:'Visible'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERCLOSE_COMBINED.CLICK","{handler:'E19542',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("NULL","{handler:'Valid_Actividades_categoriaestado',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         A106nombre_categoria = "";
         H00542_A125actividades_categoriaestado = new int[1] ;
         H00542_n125actividades_categoriaestado = new bool[] {false} ;
         H00542_A124unidad_medida = new string[] {""} ;
         H00542_n124unidad_medida = new bool[] {false} ;
         H00542_A123nombre_actividad = new string[] {""} ;
         H00542_n123nombre_actividad = new bool[] {false} ;
         H00542_A122actividades_categoriaid_tipo_categoria = new int[1] ;
         H00542_n122actividades_categoriaid_tipo_categoria = new bool[] {false} ;
         H00542_A102id_actividad_categoria = new int[1] ;
         ...
         ROClassString = "";
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.promptactividades_categoria__datastore1(),
            new Object[][] {
                new Object[] {
               H00542_A125actividades_categoriaestado, H00542_n125actividades_categoriaestado, H00542_A124unidad_medida, H00542_n124unidad_medida, H00542_A123nombre_actividad, H00542_n123nombre_actividad, H00542_A122actividades_categoriaid_tipo_categoria, H00542_n122actividades_categoriaid_tipo_categoria, H00542_A102id_actividad_categoria
               }
               , new Object[] {
      ...
      private int AV17pid_actividad_categoria ;
      ...
      private int edtavFlcat_Enabled ;
      private int edtavFlact_Enabled ;
      ...
      private string divK2btoolstable_attributecontainerflcat_Internalname ;
      private string edtavFlcat_Internalname ;
      private string divK2btoolstable_attributecontainerflact_Internalname ;
      private string edtavFlact_Internalname ;
      ...
      private string AV38flCat ;
      private string AV39flAct ;
      private string A123nombre_actividad ;
      private string A124unidad_medida ;
      private string lV39flAct ;
      ...
      private int[] H00542_A125actividades_categoriaestado ;
      private bool[] H00542_n125actividades_categoriaestado ;
      private string[] H00542_A124unidad_medida ;
      private bool[] H00542_n124unidad_medida ;
      private string[] H00542_A123nombre_actividad ;
      private bool[] H00542_n123nombre_actividad ;
      private int[] H00542_A122actividades_categoriaid_tipo_categoria ;
      private bool[] H00542_n122actividades_categoriaid_tipo_categoria ;
      private int[] H00542_A102id_actividad_categoria ;
   ...
   public class promptactividades_categoria__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV30OrderedBy )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV39flAct)) )
         {
            AddWhere(sWhereString, "([nombre_actividad] like @lV39flAct)");
         }
         else
         {
            GXv_int3[0] = 1;
         ...
         {
            AddWhere(sWhereString, "(CONVERT( char(9), CAST([id_actividad_categoria] AS decimal(9,0))) like '%' + @lV29K2BToolsGenericSearchField + '%' or [nombre_actividad] like '%' + @lV29K2BToolsGenericSearchField + '%' or [unidad_medida] like '%' + @lV29K2BToolsGenericSearchField + '%' or CONVERT( char(9), CAST([estado] AS decimal(9,0))) like '%' + @lV29K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int3[1] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00542(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (int)dynConstraints[5] , (string)dynConstraints[6] , (int)dynConstraints[7] , (short)dynConstraints[8] );
               case 1 :
                     return conditional_H00543(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (int)dynConstraints[5] , (string)dynConstraints[6] , (int)dynConstraints[7] , (short)dynConstraints[8] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV39flAct",GXType.NVarChar,200,0) ,
