...
namespace GeneXus.Programs {
   public class reportestadosatisfaccionsatisfaccionwc4 : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
         ...
         try
         {
            ...
            else
            {
               ...
               while ( (pr_default.getStatus(0) != 101) )
               {
                  ...
                  n34SatisfaccionSugerencia = P003A2_n34SatisfaccionSugerencia[0];
      ...
      public override void initialize( )
      {
         ...
         P003A2_n34SatisfaccionSugerencia = new bool[] {false} ;
         P003A2_A94UsuarioRequerimiento = new string[] {""} ;
         P003A2_A93UsuarioNombre = new string[] {""} ;
         P003A2_A15UsuarioId = new long[1] ;
