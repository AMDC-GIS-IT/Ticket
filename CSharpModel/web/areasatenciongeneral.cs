...
namespace GeneXus.Programs {
   public class areasatenciongeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public areasatenciongeneral( )
      {
      ...
      public areasatenciongeneral( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)Gx_mode,(short)AV6AreasAtencionId,(string)AV8TabCode});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188102593", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"AREASATENCIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A366AreasAtencionId), 4, 0, ".", "")));
      ...
      protected void WB890( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "areasatenciongeneral.aspx");
            }
            /* Div Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_15_892( true) ;
         }
         else
         {
            wb_table1_15_892( false) ;
         }
         return  ;
      }

      protected void wb_table1_15_892e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void E12892( )
      {
         ...
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "AreasAtencion";
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "AreasAtencion";
         ...
         {
            A366AreasAtencionId = H00892_A366AreasAtencionId[0];
            AV16GXLvl26 = 1;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Transactioncomponent_Component), StringUtil.Lower( "AreasAtencion")) != 0 )
         {
            WebComp_Transactioncomponent = getWebComponent(GetType(), "GeneXus.Programs", "areasatencion", new Object[] {context} );
            WebComp_Transactioncomponent.ComponentInit();
            WebComp_Transactioncomponent.Name = "AreasAtencion";
            WebComp_Transactioncomponent_Component = "AreasAtencion";
         }
         if ( StringUtil.Len( WebComp_Transactioncomponent_Component) != 0 )
         {
            WebComp_Transactioncomponent.setjustcreated();
            WebComp_Transactioncomponent.componentprepare(new Object[] {(string)sPrefix+"W0029",(string)"",(string)Gx_mode,(short)AV6AreasAtencionId});
      ...
      protected void E13892( )
      {
         /* 'DoUpdate' Routine */
         returnInSub = false;
         new k2bgettrncontextbyname(context ).execute(  "AreasAtencion", out  AV10TrnContext) ;
         GXt_char1 = "";
         ...
         new k2bsettrncontextbyname(context ).execute(  "AreasAtencion",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerareasatencion.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(AV6AreasAtencionId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","AreasAtencionId","TabCode"}) );
      ...
      protected void E14892( )
      {
         ...
         AV10TrnContext.gxTpr_Returnmode = "Popup";
         new k2bsettrncontextbyname(context ).execute(  "AreasAtencion",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerareasatencion.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(AV6AreasAtencionId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","AreasAtencionId","TabCode"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void wb_table1_15_892( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_18_892( true) ;
         }
         else
         {
            wb_table2_18_892( false) ;
         }
         return  ;
      }

      protected void wb_table2_18_892e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_15_892e( true) ;
         }
         else
         {
            wb_table1_15_892e( false) ;
         }
      }

      protected void wb_table2_18_892( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_18_892e( true) ;
         }
         else
         {
            wb_table2_18_892e( false) ;
         }
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6AreasAtencionId = (string)((string)getParm(obj,1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "areasatenciongeneral", GetJustCreated( ));
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "Gx_mode", Gx_mode);
            AV6AreasAtencionId = Convert.ToInt16(getParm(obj,3));
            AssignAttri(sPrefix, false, "AV6AreasAtencionId", StringUtil.LTrimStr( (decimal)(AV6AreasAtencionId), 4, 0));
         ...
         wcpOAV6AreasAtencionId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6AreasAtencionId"), ".", ","));
         wcpOAV8TabCode = cgiGet( sPrefix+"wcpOAV8TabCode");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(Gx_mode, wcpOGx_mode) != 0 ) || ( AV6AreasAtencionId != wcpOAV6AreasAtencionId ) || ( StringUtil.StrCmp(AV8TabCode, wcpOAV8TabCode) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOGx_mode = Gx_mode;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188102634", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("areasatenciongeneral.js", "?2024188102634", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A366AreasAtencionId',fld:'AREASATENCIONID',pic:'ZZZ9'},{av:'AV6AreasAtencionId',fld:'vAREASATENCIONID',pic:'ZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E13892',iparms:[{av:'AV6AreasAtencionId',fld:'vAREASATENCIONID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E14892',iparms:[{av:'AV6AreasAtencionId',fld:'vAREASATENCIONID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV12ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         scmdbuf = "";
         H00892_A366AreasAtencionId = new short[1] ;
         ...
         sCtrlAV8TabCode = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.areasatenciongeneral__default(),
            new Object[][] {
                new Object[] {
               H00892_A366AreasAtencionId
               }
            }
         );
      ...
      private short[] H00892_A366AreasAtencionId ;
   ...
   public class areasatenciongeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00892", "SELECT [AreasAtencionId] FROM [AreasAtencion] WHERE [AreasAtencionId] = @AV6AreasAtencionId ORDER BY [AreasAtencionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00892,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
