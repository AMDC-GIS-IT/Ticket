...
namespace GeneXus.Programs {
   public class reportwwdepto : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public reportwwdepto( IGxContext context )
      {
      ...
      public void executeSubmit( string aP0_K2BToolsGenericSearchField ,
                                 short aP1_OrderedBy )
      {
         reportwwdepto objreportwwdepto;
         objreportwwdepto = new reportwwdepto();
         objreportwwdepto.AV9K2BToolsGenericSearchField = aP0_K2BToolsGenericSearchField;
         objreportwwdepto.AV10OrderedBy = aP1_OrderedBy;
         objreportwwdepto.context.SetSubmitInitialConfig(context);
         objreportwwdepto.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objreportwwdepto);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((reportwwdepto)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "Depto",  "Depto",  "List",  "",  AV19Pgmname) )
            {
               H5Y0( false, 30) ;
            ...
            else
            {
               ...
               getPrinter().GxDrawText("Deptos", 347, Gx_line+0, 479, Gx_line+42, 0+256, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
               ...
               getPrinter().GxAttris("Courier New", 8, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText("Centrodecosto Id", 18, Gx_line+7, 53, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Departamento Id", 61, Gx_line+7, 171, Gx_line+22, 2, 0, 0, 1) ;
               Gx_OldLine = Gx_line;
               Gx_line = (int)(Gx_line+30);
               GxHdr3 = true;
               ...
               lV9K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV9K2BToolsGenericSearchField), 200, "%");
               /* Using cursor P005Y2 */
               pr_datastore2.execute(0, new Object[] {lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField});
               while ( (pr_datastore2.getStatus(0) != 101) )
               {
                  A261DepartamentoNombre = P005Y2_A261DepartamentoNombre[0];
                  A260DepartamentoId = P005Y2_A260DepartamentoId[0];
                  A259CentrodecostoId = P005Y2_A259CentrodecostoId[0];
                  H5Y0( false, 30) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A259CentrodecostoId, "")), 18, Gx_line+7, 53, Gx_line+23, 0, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(A260DepartamentoId), "ZZZ9")), 61, Gx_line+7, 171, Gx_line+23, 2, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
      ...
      public override void initialize( )
      {
         ...
         A259CentrodecostoId = "";
         A261DepartamentoNombre = "";
         P005Y2_A261DepartamentoNombre = new string[] {""} ;
         P005Y2_A260DepartamentoId = new short[1] ;
         P005Y2_A259CentrodecostoId = new string[] {""} ;
         Gx_date = DateTime.MinValue;
         pr_datastore2 = new DataStoreProvider(context, new GeneXus.Programs.reportwwdepto__datastore2(),
            new Object[][] {
                new Object[] {
               P005Y2_A261DepartamentoNombre, P005Y2_A260DepartamentoId, P005Y2_A259CentrodecostoId
               }
            }
         );
         AV19Pgmname = "ReportWWDepto";
      ...
      private string[] P005Y2_A261DepartamentoNombre ;
      private short[] P005Y2_A260DepartamentoId ;
      private string[] P005Y2_A259CentrodecostoId ;
      private SdtK2BContext AV8Context ;
   }

   public class reportwwdepto__datastore2 : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV10OrderedBy )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "([CentrodecostoId] like '%' + @lV9K2BToolsGenericSearchField + '%' or CONVERT( char(4), CAST([DepartamentoId] AS decimal(4,0))) like '%' + @lV9K2BToolsGenericSearchField + '%' or [DepartamentoNombre] like '%' + @lV9K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int1[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P005Y2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (short)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P005Y2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP005Y2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
