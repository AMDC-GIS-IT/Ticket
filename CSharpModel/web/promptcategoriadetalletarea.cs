...
namespace GeneXus.Programs {
   public class promptcategoriadetalletarea : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public promptcategoriadetalletarea( )
      {
      ...
      public promptcategoriadetalletarea( IGxContext context )
      {
      ...
      {
         this.AV17pCategoriaDetalleTareaId = 0 ;
         executePrivate();
         aP0_pCategoriaDetalleTareaId=this.AV17pCategoriaDetalleTareaId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV17pCategoriaDetalleTareaId = (short)(NumberUtil.Val( GetPar( "pCategoriaDetalleTareaId"), "."));
               ...
               gxgrGrid_refresh( subGrid_Rows, AV18K2BToolsGenericSearchField, AV15ClassCollection, AV19OrderedBy, AV5CurrentPage, AV29Pgmname, AV7GridConfiguration, AV17pCategoriaDetalleTareaId, AV8FreezeColumnTitles) ;
            ...
            {
               AV17pCategoriaDetalleTareaId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV17pCategoriaDetalleTareaId", StringUtil.LTrimStr( (decimal)(AV17pCategoriaDetalleTareaId), 4, 0));
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202418822063", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("promptcategoriadetalletarea.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV17pCategoriaDetalleTareaId,4,0))}, new string[] {"pCategoriaDetalleTareaId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPCATEGORIADETALLETAREAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV17pCategoriaDetalleTareaId), 4, 0, ".", "")));
      ...
      {
         return formatLink("promptcategoriadetalletarea.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV17pCategoriaDetalleTareaId,4,0))}, new string[] {"pCategoriaDetalleTareaId"})  ;
      }

      public override string GetPgmname( )
      {
         return "PromptCategoriaDetalleTarea" ;
      }
      ...
      protected void wb_table1_20_7J2e( bool wbgen )
      {
         ...
         if ( wbEnd == 64 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_72_7J2( true) ;
         }
         else
         {
            wb_table2_72_7J2( false) ;
         }
         return  ;
      }

      protected void wb_table2_72_7J2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagebuttontextblock_Internalname, "", "", "", lblPreviouspagebuttontextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOPREVIOUS\\'."+"'", "", lblPreviouspagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_PromptCategoriaDetalleTarea.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFirstpagetextblock_Internalname, lblFirstpagetextblock_Caption, "", "", lblFirstpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOFIRST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblFirstpagetextblock_Visible, 1, 0, 0, "HLP_PromptCategoriaDetalleTarea.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacinglefttextblock_Internalname, "...", "", "", lblSpacinglefttextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacinglefttextblock_Visible, 1, 0, 0, "HLP_PromptCategoriaDetalleTarea.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagetextblock_Internalname, lblPreviouspagetextblock_Caption, "", "", lblPreviouspagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOPREVIOUS\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPreviouspagetextblock_Visible, 1, 0, 0, "HLP_PromptCategoriaDetalleTarea.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCurrentpagetextblock_Internalname, lblCurrentpagetextblock_Caption, "", "", lblCurrentpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_PromptCategoriaDetalleTarea.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagetextblock_Internalname, lblNextpagetextblock_Caption, "", "", lblNextpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DONEXT\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblNextpagetextblock_Visible, 1, 0, 0, "HLP_PromptCategoriaDetalleTarea.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacingrighttextblock_Internalname, "...", "", "", lblSpacingrighttextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacingrighttextblock_Visible, 1, 0, 0, "HLP_PromptCategoriaDetalleTarea.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLastpagetextblock_Internalname, lblLastpagetextblock_Caption, "", "", lblLastpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOLAST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblLastpagetextblock_Visible, 1, 0, 0, "HLP_PromptCategoriaDetalleTarea.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagebuttontextblock_Internalname, "", "", "", lblNextpagebuttontextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DONEXT\\'."+"'", "", lblNextpagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_PromptCategoriaDetalleTarea.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       short AV17pCategoriaDetalleTareaId ,
      ...
      {
         /* GeneXus formulas. */
         AV29Pgmname = "PromptCategoriaDetalleTarea";
         context.Gx_err = 0;
      }
      ...
      protected int subGridclient_rec_count_fnc( )
      {
         ...
         {
            A296CategoriaDetalleUsuarioRegistro = H007J2_A296CategoriaDetalleUsuarioRegistro[0];
            A102id_actividad_categoria = H007J2_A102id_actividad_categoria[0];
            A295CategoriaDetalleTareaNombre = H007J2_A295CategoriaDetalleTareaNombre[0];
            A294CategoriaDetalleTareaId = H007J2_A294CategoriaDetalleTareaId[0];
            /* Using cursor H007J3 */
            pr_datastore1.execute(0, new Object[] {A102id_actividad_categoria});
            A123nombre_actividad = H007J3_A123nombre_actividad[0];
            n123nombre_actividad = H007J3_n123nombre_actividad[0];
            pr_datastore1.close(0);
            if ( String.IsNullOrEmpty(StringUtil.RTrim( AV18K2BToolsGenericSearchField)) || ( StringUtil.Like( StringUtil.Str( (decimal)(A294CategoriaDetalleTareaId), 4, 0) , StringUtil.PadR( "%" + AV18K2BToolsGenericSearchField + "%" , 254 , "%"),  ' ' ) || StringUtil.Like( A295CategoriaDetalleTareaNombre , StringUtil.PadR( "%" + AV18K2BToolsGenericSearchField + "%" , 300 , "%"),  ' ' ) || StringUtil.Like( StringUtil.Str( (decimal)(A102id_actividad_categoria), 9, 0) , StringUtil.PadR( "%" + AV18K2BToolsGenericSearchField + "%" , 254 , "%"),  ' ' ) || StringUtil.Like( A123nombre_actividad , StringUtil.PadR( "%" + AV18K2BToolsGenericSearchField + "%" , 200 , "%"),  ' ' ) || StringUtil.Like( A296CategoriaDetalleUsuarioRegistro , StringUtil.PadR( "%" + AV18K2BToolsGenericSearchField + "%" , 102 , "%"),  ' ' ) ) )
            {
      ...
      protected void RF7J2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A296CategoriaDetalleUsuarioRegistro = H007J4_A296CategoriaDetalleUsuarioRegistro[0];
               A102id_actividad_categoria = H007J4_A102id_actividad_categoria[0];
               A295CategoriaDetalleTareaNombre = H007J4_A295CategoriaDetalleTareaNombre[0];
               A294CategoriaDetalleTareaId = H007J4_A294CategoriaDetalleTareaId[0];
               /* Using cursor H007J5 */
               pr_datastore1.execute(1, new Object[] {A102id_actividad_categoria});
               A123nombre_actividad = H007J5_A123nombre_actividad[0];
               n123nombre_actividad = H007J5_n123nombre_actividad[0];
      ...
      protected void send_integrity_lvl_hashes7J2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV29Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV29Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_CATEGORIADETALLETAREAID"+"_"+sGXsfl_64_idx, GetSecureSignedToken( sGXsfl_64_idx, context.localUtil.Format( (decimal)(A294CategoriaDetalleTareaId), "ZZZ9"), context));
      }
      ...
      protected void E177J2( )
      {
         ...
         AV26ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "CategoriaDetalleTarea";
         AV26ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "CategoriaDetalleTarea";
         ...
         GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
         Form.Caption = StringUtil.Format( "Seleccionar %1", "Categoria Detalle Tarea", "", "", "", "", "", "", "", "");
      ...
      protected void E197J2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV17pCategoriaDetalleTareaId = A294CategoriaDetalleTareaId;
         AssignAttri("", false, "AV17pCategoriaDetalleTareaId", StringUtil.LTrimStr( (decimal)(AV17pCategoriaDetalleTareaId), 4, 0));
         context.setWebReturnParms(new Object[] {(short)AV17pCategoriaDetalleTareaId});
         context.setWebReturnParmsMetadata(new Object[] {"AV17pCategoriaDetalleTareaId"});
         context.wjLocDisableFrm = 1;
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV12GridStateKey = StringUtil.Str( (decimal)(AV17pCategoriaDetalleTareaId), 4, 0);
      ...
      protected void wb_table2_72_7J2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoresultsfoundtextblock_Internalname, "No hay resultados", "", "", lblNoresultsfoundtextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_PromptCategoriaDetalleTarea.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_72_7J2e( true) ;
         }
         else
         {
            wb_table2_72_7J2e( false) ;
         }
      }

      protected void wb_table1_20_7J2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, imgK2bgridsettingslabel_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "K2BT_GridSettingsLabel", "Config. tabla", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgK2bgridsettingslabel_Jsonclick, "'"+""+"'"+",false,"+"'"+"e237j1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_PromptCategoriaDetalleTarea.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRuntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblRuntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_PromptCategoriaDetalleTarea.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttK2bgridsettingssave_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(64), 2, 0)+","+"null"+");", "Aplicar", bttK2bgridsettingssave_Jsonclick, 5, "Aplicar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'SAVEGRIDSETTINGS\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_PromptCategoriaDetalleTarea.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_20_7J2e( true) ;
         }
         else
         {
            wb_table1_20_7J2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV17pCategoriaDetalleTareaId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV17pCategoriaDetalleTareaId", StringUtil.LTrimStr( (decimal)(AV17pCategoriaDetalleTareaId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202418822233", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("promptcategoriadetalletarea.js", "?202418822233", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      {
         edtCategoriaDetalleTareaId_Internalname = "CATEGORIADETALLETAREAID_"+sGXsfl_64_idx;
         edtCategoriaDetalleTareaNombre_Internalname = "CATEGORIADETALLETAREANOMBRE_"+sGXsfl_64_idx;
         edtid_actividad_categoria_Internalname = "ID_ACTIVIDAD_CATEGORIA_"+sGXsfl_64_idx;
         edtnombre_actividad_Internalname = "NOMBRE_ACTIVIDAD_"+sGXsfl_64_idx;
         edtCategoriaDetalleUsuarioRegistro_Internalname = "CATEGORIADETALLEUSUARIOREGISTRO_"+sGXsfl_64_idx;
      }

      protected void SubsflControlProps_fel_642( )
      {
         edtCategoriaDetalleTareaId_Internalname = "CATEGORIADETALLETAREAID_"+sGXsfl_64_fel_idx;
         edtCategoriaDetalleTareaNombre_Internalname = "CATEGORIADETALLETAREANOMBRE_"+sGXsfl_64_fel_idx;
         edtid_actividad_categoria_Internalname = "ID_ACTIVIDAD_CATEGORIA_"+sGXsfl_64_fel_idx;
         edtnombre_actividad_Internalname = "NOMBRE_ACTIVIDAD_"+sGXsfl_64_fel_idx;
         edtCategoriaDetalleUsuarioRegistro_Internalname = "CATEGORIADETALLEUSUARIOREGISTRO_"+sGXsfl_64_fel_idx;
      }
      ...
      protected void sendrow_642( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_64_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute_Grid";
            edtCategoriaDetalleTareaNombre_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A294CategoriaDetalleTareaId), 4, 0, ".", "")))+"'"+"]);";
            AssignProp("", false, edtCategoriaDetalleTareaNombre_Internalname, "Link", edtCategoriaDetalleTareaNombre_Link, !bGXsfl_64_Refreshing);
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCategoriaDetalleTareaNombre_Internalname,(string)A295CategoriaDetalleTareaNombre,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtCategoriaDetalleTareaNombre_Link,(string)"",(string)"",(string)"",(string)edtCategoriaDetalleTareaNombre_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn K2BToolsSortableColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)300,(short)0,(short)0,(short)64,(short)1,(short)-1,(short)-1,(bool)true,(string)"Texto",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV17pCategoriaDetalleTareaId',fld:'vPCATEGORIADETALLETAREAID',pic:'ZZZ9'},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV19OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV18K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("ENTER","{handler:'E197J2',iparms:[{av:'A294CategoriaDetalleTareaId',fld:'CATEGORIADETALLETAREAID',pic:'ZZZ9',hsh:true},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV17pCategoriaDetalleTareaId',fld:'vPCATEGORIADETALLETAREAID',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("GRID.REFRESH","{handler:'E207J2',iparms:[{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV19OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pCategoriaDetalleTareaId',fld:'vPCATEGORIADETALLETAREAID',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E217J2',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E127J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV19OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pCategoriaDetalleTareaId',fld:'vPCATEGORIADETALLETAREAID',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E137J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV19OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pCategoriaDetalleTareaId',fld:'vPCATEGORIADETALLETAREAID',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E147J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV19OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pCategoriaDetalleTareaId',fld:'vPCATEGORIADETALLETAREAID',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E157J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV19OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pCategoriaDetalleTareaId',fld:'vPCATEGORIADETALLETAREAID',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'TOGGLEGRIDSETTINGSTABLE'","{handler:'E237J1',iparms:[{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E167J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV19OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pCategoriaDetalleTareaId',fld:'vPCATEGORIADETALLETAREAID',pic:'ZZZ9'},{av:'AV10RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV9GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E117J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV19OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pCategoriaDetalleTareaId',fld:'vPCATEGORIADETALLETAREAID',pic:'ZZZ9'},{av:'AV23UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("VALID_CATEGORIADETALLETAREAID","{handler:'Valid_Categoriadetalletareaid',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("VALID_CATEGORIADETALLETAREAID",",oparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("VALID_CATEGORIADETALLETAREANOMBRE","{handler:'Valid_Categoriadetalletareanombre',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("VALID_CATEGORIADETALLETAREANOMBRE",",oparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("VALID_ID_ACTIVIDAD_CATEGORIA","{handler:'Valid_Id_actividad_categoria',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("VALID_ID_ACTIVIDAD_CATEGORIA",",oparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("VALID_NOMBRE_ACTIVIDAD","{handler:'Valid_Nombre_actividad',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("VALID_NOMBRE_ACTIVIDAD",",oparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("VALID_CATEGORIADETALLEUSUARIOREGISTRO","{handler:'Valid_Categoriadetalleusuarioregistro',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("VALID_CATEGORIADETALLEUSUARIOREGISTRO",",oparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         lV18K2BToolsGenericSearchField = "";
         H007J2_A296CategoriaDetalleUsuarioRegistro = new string[] {""} ;
         H007J2_A102id_actividad_categoria = new int[1] ;
         H007J2_A295CategoriaDetalleTareaNombre = new string[] {""} ;
         H007J2_A294CategoriaDetalleTareaId = new short[1] ;
         H007J3_A123nombre_actividad = new string[] {""} ;
         H007J3_n123nombre_actividad = new bool[] {false} ;
         H007J4_A296CategoriaDetalleUsuarioRegistro = new string[] {""} ;
         H007J4_A102id_actividad_categoria = new int[1] ;
         H007J4_A295CategoriaDetalleTareaNombre = new string[] {""} ;
         H007J4_A294CategoriaDetalleTareaId = new short[1] ;
         H007J5_A123nombre_actividad = new string[] {""} ;
         H007J5_n123nombre_actividad = new bool[] {false} ;
         AV25ActivityList = new GXBaseCollection<SdtK2BActivityList_K2BActivityListItem>( context, "K2BActivityListItem", "kb_ticket");
         AV26ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         ...
         ROClassString = "";
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.promptcategoriadetalletarea__datastore1(),
            new Object[][] {
                new Object[] {
               H007J3_A123nombre_actividad, H007J3_n123nombre_actividad
               }
               , new Object[] {
               H007J5_A123nombre_actividad, H007J5_n123nombre_actividad
               }
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.promptcategoriadetalletarea__default(),
            new Object[][] {
                new Object[] {
               H007J2_A296CategoriaDetalleUsuarioRegistro, H007J2_A102id_actividad_categoria, H007J2_A295CategoriaDetalleTareaNombre, H007J2_A294CategoriaDetalleTareaId
               }
               , new Object[] {
               H007J4_A296CategoriaDetalleUsuarioRegistro, H007J4_A102id_actividad_categoria, H007J4_A295CategoriaDetalleTareaNombre, H007J4_A294CategoriaDetalleTareaId
               }
            }
         );
         AV29Pgmname = "PromptCategoriaDetalleTarea";
      ...
      private short AV17pCategoriaDetalleTareaId ;
      ...
      private string lV18K2BToolsGenericSearchField ;
      ...
      private string[] H007J2_A296CategoriaDetalleUsuarioRegistro ;
      private int[] H007J2_A102id_actividad_categoria ;
      private string[] H007J2_A295CategoriaDetalleTareaNombre ;
      private short[] H007J2_A294CategoriaDetalleTareaId ;
      private IDataStoreProvider pr_datastore1 ;
      private string[] H007J3_A123nombre_actividad ;
      private bool[] H007J3_n123nombre_actividad ;
      private string[] H007J4_A296CategoriaDetalleUsuarioRegistro ;
      private int[] H007J4_A102id_actividad_categoria ;
      private string[] H007J4_A295CategoriaDetalleTareaNombre ;
      private short[] H007J4_A294CategoriaDetalleTareaId ;
      private string[] H007J5_A123nombre_actividad ;
      private bool[] H007J5_n123nombre_actividad ;
   ...
   public class promptcategoriadetalletarea__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH007J5;
          prmH007J5 = new Object[] {
          new ParDef("@id_actividad_categoria",GXType.Int32,9,0)
          };
          def= new CursorDef[] {
              new CursorDef("H007J3", "SELECT [nombre_actividad] FROM dbo.[actividades_categoria] WHERE [id_actividad_categoria] = @id_actividad_categoria ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007J3,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007J5", "SELECT [nombre_actividad] FROM dbo.[actividades_categoria] WHERE [id_actividad_categoria] = @id_actividad_categoria ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007J5,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
 ...
 public class promptcategoriadetalletarea__default : DataStoreHelperBase, IDataStoreHelper
 {
    ...
    protected Object[] conditional_H007J4( IGxContext context ,
                                           short AV19OrderedBy ,
                                           string AV18K2BToolsGenericSearchField ,
                                           short A294CategoriaDetalleTareaId ,
                                           string A295CategoriaDetalleTareaNombre ,
                                                   ...
                                                   Object [] dynConstraints )
    {
       ...
       {
             case 0 :
                   return conditional_H007J2(context, (short)dynConstraints[0] , (string)dynConstraints[1] , (short)dynConstraints[2] , (string)dynConstraints[3] , (int)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] );
             case 1 :
                   return conditional_H007J4(context, (short)dynConstraints[0] , (string)dynConstraints[1] , (short)dynConstraints[2] , (string)dynConstraints[3] , (int)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] );
       }
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        def= new CursorDef[] {
           ...
           ,new CursorDef("H007J4", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007J4,11, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
