...
namespace GeneXus.Programs {
   public class etapasdesarrolloticketwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV89Pgmname = "EtapasDesarrolloTicketWC";
               context.Gx_err = 0;
               WS792( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188115476", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV89Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vURI", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV86Uri, "")), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vURI", AV86Uri);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vURI", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV86Uri, "")), context));
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV77Update)) ? AV91Update_GXI : context.convertURL( context.PathToRelativeUrl( AV77Update))), !bGXsfl_334_Refreshing);
                              ...
                              AssignProp(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV78Delete)) ? AV92Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV78Delete))), !bGXsfl_334_Refreshing);
      ...
      protected void RF792( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 TypeConstants.LONG, TypeConstants.LONG, TypeConstants.SHORT, TypeConstants.LONG, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT
                                                 }
            });
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               ...
               n278TicketUsuarioAsigno = H00792_n278TicketUsuarioAsigno[0];
               A57TicketOtros = H00792_A57TicketOtros[0];
               n57TicketOtros = H00792_n57TicketOtros[0];
               A52TicketInstalarDataShow = H00792_A52TicketInstalarDataShow[0];
               n52TicketInstalarDataShow = H00792_n52TicketInstalarDataShow[0];
               A41TicketApoyoUsuario = H00792_A41TicketApoyoUsuario[0];
               n41TicketApoyoUsuario = H00792_n41TicketApoyoUsuario[0];
               A87TicketUps = H00792_A87TicketUps[0];
               n87TicketUps = H00792_n87TicketUps[0];
               A58TicketPerifericos = H00792_A58TicketPerifericos[0];
               n58TicketPerifericos = H00792_n58TicketPerifericos[0];
               A43TicketDiscoDuroExterno = H00792_A43TicketDiscoDuroExterno[0];
               n43TicketDiscoDuroExterno = H00792_n43TicketDiscoDuroExterno[0];
               A51TicketIngenieria = H00792_A51TicketIngenieria[0];
               n51TicketIngenieria = H00792_n51TicketIngenieria[0];
               A44TicketDisenio = H00792_A44TicketDisenio[0];
               n44TicketDisenio = H00792_n44TicketDisenio[0];
               A40TicketAplicacion = H00792_A40TicketAplicacion[0];
               n40TicketAplicacion = H00792_n40TicketAplicacion[0];
               A39TicketAntivirus = H00792_A39TicketAntivirus[0];
               n39TicketAntivirus = H00792_n39TicketAntivirus[0];
               A56TicketOffice = H00792_A56TicketOffice[0];
               n56TicketOffice = H00792_n56TicketOffice[0];
               A60TicketSistemaOperativo = H00792_A60TicketSistemaOperativo[0];
               n60TicketSistemaOperativo = H00792_n60TicketSistemaOperativo[0];
               A59TicketRouter = H00792_A59TicketRouter[0];
               n59TicketRouter = H00792_n59TicketRouter[0];
               A45TicketEscaner = H00792_A45TicketEscaner[0];
               n45TicketEscaner = H00792_n45TicketEscaner[0];
               A50TicketImpresora = H00792_A50TicketImpresora[0];
               n50TicketImpresora = H00792_n50TicketImpresora[0];
               A55TicketMonitor = H00792_A55TicketMonitor[0];
               n55TicketMonitor = H00792_n55TicketMonitor[0];
               A42TicketDesktop = H00792_A42TicketDesktop[0];
               n42TicketDesktop = H00792_n42TicketDesktop[0];
               A53TicketLaptop = H00792_A53TicketLaptop[0];
               n53TicketLaptop = H00792_n53TicketLaptop[0];
      ...
      protected void STRUP790( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            if ( DateTimeUtil.ResetTime ( context.localUtil.CToD( cgiGet( sPrefix+"GXH_vTICKETFECHA_FROM"), 2) ) != DateTimeUtil.ResetTime ( AV55TicketFecha_From ) )
            {
               GRID_nFirstRecordOnPage = 0;
            }
      ...
      protected void E22792( )
      {
         ...
         AV54TicketFecha = DateTime.MinValue;
         ...
         AV57TicketHora = (DateTime)(DateTime.MinValue);
         ...
         AV61EstadoTicketTicketNombre = "";
         AssignAttri(sPrefix, false, "AV61EstadoTicketTicketNombre", AV61EstadoTicketTicketNombre);
         AV62TicketFechaHora = (DateTime)(DateTime.MinValue);
         ...
         AssignAttri(sPrefix, false, "AV64TicketFechaHora_To", context.localUtil.TToC( AV64TicketFechaHora_To, 10, 8, 0, 3, "/", ":", " "));
         new k2bloadrowsperpage(context ).execute(  AV89Pgmname,  "Grid", out  AV48RowsPerPageVariable, out  AV49RowsPerPageLoaded) ;
      ...
      protected void E23792( )
      {
         ...
         AV90GXV1 = 1;
         while ( AV90GXV1 <= AV74Messages.Count )
         {
            AV75Message = ((GeneXus.Utils.SdtMessages_Message)AV74Messages.Item(AV90GXV1));
         ...
         AV83ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV89Pgmname;
         ...
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV77Update)) ? AV91Update_GXI : context.convertURL( context.PathToRelativeUrl( AV77Update))), !bGXsfl_334_Refreshing);
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV77Update), true);
         AV91Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "788f9b72-f982-49f9-99e4-c0374e31a85a", "", context.GetTheme( )));
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV77Update)) ? AV91Update_GXI : context.convertURL( context.PathToRelativeUrl( AV77Update))), !bGXsfl_334_Refreshing);
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV77Update), true);
         ...
         AssignProp(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV78Delete)) ? AV92Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV78Delete))), !bGXsfl_334_Refreshing);
         AssignProp(sPrefix, false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV78Delete), true);
         AV92Delete_GXI = GXDbFile.PathToUrl( context.GetImagePath( "3e4a9f50-2c57-41b6-9da5-ebe49bca33c0", "", context.GetTheme( )));
         AssignProp(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV78Delete)) ? AV92Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV78Delete))), !bGXsfl_334_Refreshing);
         AssignProp(sPrefix, false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV78Delete), true);
      ...
      protected void S112( )
      {
         ...
         new k2bloadgridstate(context ).execute(  AV89Pgmname,  AV50GridStateKey, out  AV51GridState) ;
         ...
         AV93GXV2 = 1;
         while ( AV93GXV2 <= AV51GridState.gxTpr_Filtervalues.Count )
         {
            AV52GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV51GridState.gxTpr_Filtervalues.Item(AV93GXV2));
      ...
      protected void S132( )
      {
         ...
         AV51GridState.gxTpr_Filtervalues.Add(AV52GridStateFilterValue, 0);
         new k2bsavegridstate(context ).execute(  AV89Pgmname,  AV50GridStateKey,  AV51GridState) ;
      }
      ...
      protected void S202( )
      {
         ...
         AssignAttri(sPrefix, false, "AV46Att_TicketFechaHora_Visible", AV46Att_TicketFechaHora_Visible);
         new k2bsavegridconfiguration(context ).execute(  AV89Pgmname,  "Grid",  AV11GridConfiguration,  false) ;
         AV94GXV3 = 1;
         while ( AV94GXV3 <= AV11GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV14GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV11GridConfiguration.gxTpr_Gridcolumns.Item(AV94GXV3));
      ...
      protected void S122( )
      {
         ...
         if ( ! (DateTime.MinValue==AV55TicketFecha_From) || ! (DateTime.MinValue==AV56TicketFecha_To) )
         {
            ...
            AV66K2BFilterValuesSDTItem.gxTpr_Canbedeleted = true;
         ...
         if ( AV65K2BFilterValuesSDT.Count > 0 )
         {
            ...
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV89Pgmname,  "Grid",  AV65K2BFilterValuesSDT, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item4) ;
      ...
      protected void E14792( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  AV89Pgmname,  "Grid", ref  AV11GridConfiguration) ;
         AV95GXV4 = 1;
         while ( AV95GXV4 <= AV11GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV14GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV11GridConfiguration.gxTpr_Gridcolumns.Item(AV95GXV4));
            if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "TicketId") == 0 )
            {
         ...
         new k2bsavegridconfiguration(context ).execute(  AV89Pgmname,  "Grid",  AV11GridConfiguration,  true) ;
         AV73UC_OrderedBy = AV70OrderedBy;
         AssignAttri(sPrefix, false, "AV73UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV73UC_OrderedBy), 4, 0));
         if ( AV48RowsPerPageVariable != AV47GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV48RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, sPrefix+"GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV89Pgmname,  "Grid",  AV48RowsPerPageVariable) ;
            AV9CurrentPage = 1;
            AssignAttri(sPrefix, false, "AV9CurrentPage", StringUtil.LTrimStr( (decimal)(AV9CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void E19792( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "Ticket",  "Ticket",  "List",  "",  "ExportEtapasDesarrolloTicketWC") )
         {
            new exportetapasdesarrolloticketwc(context ).execute(  AV6EtapaDesarrolloId,  AV55TicketFecha_From,  AV56TicketFecha_To,  AV58TicketHora_From,  AV59TicketHora_To,  AV60UsuarioNombre,  AV61EstadoTicketTicketNombre,  AV63TicketFechaHora_From,  AV64TicketFechaHora_To,  AV69K2BToolsGenericSearchField,  AV70OrderedBy, out  AV84OutFile) ;
            if ( new k2bt_isinexternalstorage(context).executeUdp(  AV84OutFile, out  AV86Uri) )
            {
               CallWebObject(formatLink(AV86Uri) );
               context.wjLocDisableFrm = 0;
            }
            else
            {
               AV85Guid = (Guid)(Guid.NewGuid( ));
               new k2bsessionset(context ).execute(  AV85Guid.ToString(),  AV84OutFile) ;
               CallWebObject(formatLink("k2bt_returnfileinhttpresponse.aspx", new object[] {UrlEncode(AV85Guid.ToString())}, new string[] {"Guid"}) );
      ...
      protected void wb_table1_74_792( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavAtt_estadoticketticketid_visible_Internalname, "Id", "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188122080", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("etapasdesarrolloticketwc.js", "?2024188122082", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
      ...
      protected void sendrow_3342( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_334_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV77Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV77Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV91Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV77Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV77Update)) ? AV91Update_GXI : context.PathToRelativeUrl( AV77Update));
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV78Delete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV78Delete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV92Delete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV78Delete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV78Delete)) ? AV92Delete_GXI : context.PathToRelativeUrl( AV78Delete));
      ...
      public override void initialize_properties( )
      {
         ...
         chkavAtt_estadoticketticketid_visible.Caption = "Id";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E25792',iparms:[{av:'AV82AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZZZZZZZ9'},{av:'A187EstadoTicketTicketId',fld:'ESTADOTICKETTICKETID',pic:'ZZZ9'},{av:'AV76TicketFecha_IsAuthorized',fld:'vTICKETFECHA_ISAUTHORIZED',pic:''},{av:'A14TicketId',fld:'TICKETID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV15Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV16Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV22Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV23Att_EstadoTicketTicketId_Visible',fld:'vATT_ESTADOTICKETTICKETID_VISIBLE',pic:''},{av:'AV24Att_EstadoTicketTicketNombre_Visible',fld:'vATT_ESTADOTICKETTICKETNOMBRE_VISIBLE',pic:''},{av:'AV25Att_TicketLastId_Visible',fld:'vATT_TICKETLASTID_VISIBLE',pic:''},{av:'AV26Att_TicketHoraCaracter_Visible',fld:'vATT_TICKETHORACARACTER_VISIBLE',pic:''},{av:'AV27Att_TicketLaptop_Visible',fld:'vATT_TICKETLAPTOP_VISIBLE',pic:''},{av:'AV28Att_TicketDesktop_Visible',fld:'vATT_TICKETDESKTOP_VISIBLE',pic:''},{av:'AV29Att_TicketMonitor_Visible',fld:'vATT_TICKETMONITOR_VISIBLE',pic:''},{av:'AV30Att_TicketImpresora_Visible',fld:'vATT_TICKETIMPRESORA_VISIBLE',pic:''},{av:'AV31Att_TicketEscaner_Visible',fld:'vATT_TICKETESCANER_VISIBLE',pic:''},{av:'AV32Att_TicketRouter_Visible',fld:'vATT_TICKETROUTER_VISIBLE',pic:''},{av:'AV33Att_TicketSistemaOperativo_Visible',fld:'vATT_TICKETSISTEMAOPERATIVO_VISIBLE',pic:''},{av:'AV34Att_TicketOffice_Visible',fld:'vATT_TICKETOFFICE_VISIBLE',pic:''},{av:'AV35Att_TicketAntivirus_Visible',fld:'vATT_TICKETANTIVIRUS_VISIBLE',pic:''},{av:'AV36Att_TicketAplicacion_Visible',fld:'vATT_TICKETAPLICACION_VISIBLE',pic:''},{av:'AV37Att_TicketDisenio_Visible',fld:'vATT_TICKETDISENIO_VISIBLE',pic:''},{av:'AV38Att_TicketIngenieria_Visible',fld:'vATT_TICKETINGENIERIA_VISIBLE',pic:''},{av:'AV39Att_TicketDiscoDuroExterno_Visible',fld:'vATT_TICKETDISCODUROEXTERNO_VISIBLE',pic:''},{av:'AV40Att_TicketPerifericos_Visible',fld:'vATT_TICKETPERIFERICOS_VISIBLE',pic:''},{av:'AV41Att_TicketUps_Visible',fld:'vATT_TICKETUPS_VISIBLE',pic:''},{av:'AV42Att_TicketApoyoUsuario_Visible',fld:'vATT_TICKETAPOYOUSUARIO_VISIBLE',pic:''},{av:'AV43Att_TicketInstalarDataShow_Visible',fld:'vATT_TICKETINSTALARDATASHOW_VISIBLE',pic:''},{av:'AV44Att_TicketOtros_Visible',fld:'vATT_TICKETOTROS_VISIBLE',pic:''},{av:'AV45Att_TicketUsuarioAsigno_Visible',fld:'vATT_TICKETUSUARIOASIGNO_VISIBLE',pic:''},{av:'AV46Att_TicketFechaHora_Visible',fld:'vATT_TICKETFECHAHORA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED","{handler:'E11792',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV69K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV55TicketFecha_From',fld:'vTICKETFECHA_FROM',pic:''},{av:'AV58TicketHora_From',fld:'vTICKETHORA_FROM',pic:'99:99'},{av:'AV59TicketHora_To',fld:'vTICKETHORA_TO',pic:'99:99'},{av:'AV60UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV61EstadoTicketTicketNombre',fld:'vESTADOTICKETTICKETNOMBRE',pic:''},{av:'AV63TicketFechaHora_From',fld:'vTICKETFECHAHORA_FROM',pic:'99/99/9999 99:99:99'},{av:'AV64TicketFechaHora_To',fld:'vTICKETFECHAHORA_TO',pic:'99/99/9999 99:99:99'},{av:'A290EtapaDesarrolloId',fld:'ETAPADESARROLLOID',pic:'ZZZ9'},{av:'AV6EtapaDesarrolloId',fld:'vETAPADESARROLLOID',pic:'ZZZ9'},{av:'AV53ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV70OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV56TicketFecha_To',fld:'vTICKETFECHA_TO',pic:''},{av:'AV89Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV82AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV76TicketFecha_IsAuthorized',fld:'vTICKETFECHA_ISAUTHORIZED',pic:''},{av:'AV86Uri',fld:'vURI',pic:'',hsh:true},{av:'sPrefix'},{av:'AV68DeletedTag',fld:'vDELETEDTAG',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV16Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV22Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV23Att_EstadoTicketTicketId_Visible',fld:'vATT_ESTADOTICKETTICKETID_VISIBLE',pic:''},{av:'AV24Att_EstadoTicketTicketNombre_Visible',fld:'vATT_ESTADOTICKETTICKETNOMBRE_VISIBLE',pic:''},{av:'AV25Att_TicketLastId_Visible',fld:'vATT_TICKETLASTID_VISIBLE',pic:''},{av:'AV26Att_TicketHoraCaracter_Visible',fld:'vATT_TICKETHORACARACTER_VISIBLE',pic:''},{av:'AV27Att_TicketLaptop_Visible',fld:'vATT_TICKETLAPTOP_VISIBLE',pic:''},{av:'AV28Att_TicketDesktop_Visible',fld:'vATT_TICKETDESKTOP_VISIBLE',pic:''},{av:'AV29Att_TicketMonitor_Visible',fld:'vATT_TICKETMONITOR_VISIBLE',pic:''},{av:'AV30Att_TicketImpresora_Visible',fld:'vATT_TICKETIMPRESORA_VISIBLE',pic:''},{av:'AV31Att_TicketEscaner_Visible',fld:'vATT_TICKETESCANER_VISIBLE',pic:''},{av:'AV32Att_TicketRouter_Visible',fld:'vATT_TICKETROUTER_VISIBLE',pic:''},{av:'AV33Att_TicketSistemaOperativo_Visible',fld:'vATT_TICKETSISTEMAOPERATIVO_VISIBLE',pic:''},{av:'AV34Att_TicketOffice_Visible',fld:'vATT_TICKETOFFICE_VISIBLE',pic:''},{av:'AV35Att_TicketAntivirus_Visible',fld:'vATT_TICKETANTIVIRUS_VISIBLE',pic:''},{av:'AV36Att_TicketAplicacion_Visible',fld:'vATT_TICKETAPLICACION_VISIBLE',pic:''},{av:'AV37Att_TicketDisenio_Visible',fld:'vATT_TICKETDISENIO_VISIBLE',pic:''},{av:'AV38Att_TicketIngenieria_Visible',fld:'vATT_TICKETINGENIERIA_VISIBLE',pic:''},{av:'AV39Att_TicketDiscoDuroExterno_Visible',fld:'vATT_TICKETDISCODUROEXTERNO_VISIBLE',pic:''},{av:'AV40Att_TicketPerifericos_Visible',fld:'vATT_TICKETPERIFERICOS_VISIBLE',pic:''},{av:'AV41Att_TicketUps_Visible',fld:'vATT_TICKETUPS_VISIBLE',pic:''},{av:'AV42Att_TicketApoyoUsuario_Visible',fld:'vATT_TICKETAPOYOUSUARIO_VISIBLE',pic:''},{av:'AV43Att_TicketInstalarDataShow_Visible',fld:'vATT_TICKETINSTALARDATASHOW_VISIBLE',pic:''},{av:'AV44Att_TicketOtros_Visible',fld:'vATT_TICKETOTROS_VISIBLE',pic:''},{av:'AV45Att_TicketUsuarioAsigno_Visible',fld:'vATT_TICKETUSUARIOASIGNO_VISIBLE',pic:''},{av:'AV46Att_TicketFechaHora_Visible',fld:'vATT_TICKETFECHAHORA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E12792',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV69K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV55TicketFecha_From',fld:'vTICKETFECHA_FROM',pic:''},{av:'AV58TicketHora_From',fld:'vTICKETHORA_FROM',pic:'99:99'},{av:'AV59TicketHora_To',fld:'vTICKETHORA_TO',pic:'99:99'},{av:'AV60UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV61EstadoTicketTicketNombre',fld:'vESTADOTICKETTICKETNOMBRE',pic:''},{av:'AV63TicketFechaHora_From',fld:'vTICKETFECHAHORA_FROM',pic:'99/99/9999 99:99:99'},{av:'AV64TicketFechaHora_To',fld:'vTICKETFECHAHORA_TO',pic:'99/99/9999 99:99:99'},{av:'A290EtapaDesarrolloId',fld:'ETAPADESARROLLOID',pic:'ZZZ9'},{av:'AV6EtapaDesarrolloId',fld:'vETAPADESARROLLOID',pic:'ZZZ9'},{av:'AV53ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV70OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV56TicketFecha_To',fld:'vTICKETFECHA_TO',pic:''},{av:'AV89Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV82AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV76TicketFecha_IsAuthorized',fld:'vTICKETFECHA_ISAUTHORIZED',pic:''},{av:'AV86Uri',fld:'vURI',pic:'',hsh:true},{av:'sPrefix'},{av:'AV73UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV16Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV22Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV23Att_EstadoTicketTicketId_Visible',fld:'vATT_ESTADOTICKETTICKETID_VISIBLE',pic:''},{av:'AV24Att_EstadoTicketTicketNombre_Visible',fld:'vATT_ESTADOTICKETTICKETNOMBRE_VISIBLE',pic:''},{av:'AV25Att_TicketLastId_Visible',fld:'vATT_TICKETLASTID_VISIBLE',pic:''},{av:'AV26Att_TicketHoraCaracter_Visible',fld:'vATT_TICKETHORACARACTER_VISIBLE',pic:''},{av:'AV27Att_TicketLaptop_Visible',fld:'vATT_TICKETLAPTOP_VISIBLE',pic:''},{av:'AV28Att_TicketDesktop_Visible',fld:'vATT_TICKETDESKTOP_VISIBLE',pic:''},{av:'AV29Att_TicketMonitor_Visible',fld:'vATT_TICKETMONITOR_VISIBLE',pic:''},{av:'AV30Att_TicketImpresora_Visible',fld:'vATT_TICKETIMPRESORA_VISIBLE',pic:''},{av:'AV31Att_TicketEscaner_Visible',fld:'vATT_TICKETESCANER_VISIBLE',pic:''},{av:'AV32Att_TicketRouter_Visible',fld:'vATT_TICKETROUTER_VISIBLE',pic:''},{av:'AV33Att_TicketSistemaOperativo_Visible',fld:'vATT_TICKETSISTEMAOPERATIVO_VISIBLE',pic:''},{av:'AV34Att_TicketOffice_Visible',fld:'vATT_TICKETOFFICE_VISIBLE',pic:''},{av:'AV35Att_TicketAntivirus_Visible',fld:'vATT_TICKETANTIVIRUS_VISIBLE',pic:''},{av:'AV36Att_TicketAplicacion_Visible',fld:'vATT_TICKETAPLICACION_VISIBLE',pic:''},{av:'AV37Att_TicketDisenio_Visible',fld:'vATT_TICKETDISENIO_VISIBLE',pic:''},{av:'AV38Att_TicketIngenieria_Visible',fld:'vATT_TICKETINGENIERIA_VISIBLE',pic:''},{av:'AV39Att_TicketDiscoDuroExterno_Visible',fld:'vATT_TICKETDISCODUROEXTERNO_VISIBLE',pic:''},{av:'AV40Att_TicketPerifericos_Visible',fld:'vATT_TICKETPERIFERICOS_VISIBLE',pic:''},{av:'AV41Att_TicketUps_Visible',fld:'vATT_TICKETUPS_VISIBLE',pic:''},{av:'AV42Att_TicketApoyoUsuario_Visible',fld:'vATT_TICKETAPOYOUSUARIO_VISIBLE',pic:''},{av:'AV43Att_TicketInstalarDataShow_Visible',fld:'vATT_TICKETINSTALARDATASHOW_VISIBLE',pic:''},{av:'AV44Att_TicketOtros_Visible',fld:'vATT_TICKETOTROS_VISIBLE',pic:''},{av:'AV45Att_TicketUsuarioAsigno_Visible',fld:'vATT_TICKETUSUARIOASIGNO_VISIBLE',pic:''},{av:'AV46Att_TicketFechaHora_Visible',fld:'vATT_TICKETFECHAHORA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E16792',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV69K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV55TicketFecha_From',fld:'vTICKETFECHA_FROM',pic:''},{av:'AV58TicketHora_From',fld:'vTICKETHORA_FROM',pic:'99:99'},{av:'AV59TicketHora_To',fld:'vTICKETHORA_TO',pic:'99:99'},{av:'AV60UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV61EstadoTicketTicketNombre',fld:'vESTADOTICKETTICKETNOMBRE',pic:''},{av:'AV63TicketFechaHora_From',fld:'vTICKETFECHAHORA_FROM',pic:'99/99/9999 99:99:99'},{av:'AV64TicketFechaHora_To',fld:'vTICKETFECHAHORA_TO',pic:'99/99/9999 99:99:99'},{av:'A290EtapaDesarrolloId',fld:'ETAPADESARROLLOID',pic:'ZZZ9'},{av:'AV6EtapaDesarrolloId',fld:'vETAPADESARROLLOID',pic:'ZZZ9'},{av:'AV53ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV70OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV56TicketFecha_To',fld:'vTICKETFECHA_TO',pic:''},{av:'AV89Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV82AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV76TicketFecha_IsAuthorized',fld:'vTICKETFECHA_ISAUTHORIZED',pic:''},{av:'AV86Uri',fld:'vURI',pic:'',hsh:true},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV16Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV22Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV23Att_EstadoTicketTicketId_Visible',fld:'vATT_ESTADOTICKETTICKETID_VISIBLE',pic:''},{av:'AV24Att_EstadoTicketTicketNombre_Visible',fld:'vATT_ESTADOTICKETTICKETNOMBRE_VISIBLE',pic:''},{av:'AV25Att_TicketLastId_Visible',fld:'vATT_TICKETLASTID_VISIBLE',pic:''},{av:'AV26Att_TicketHoraCaracter_Visible',fld:'vATT_TICKETHORACARACTER_VISIBLE',pic:''},{av:'AV27Att_TicketLaptop_Visible',fld:'vATT_TICKETLAPTOP_VISIBLE',pic:''},{av:'AV28Att_TicketDesktop_Visible',fld:'vATT_TICKETDESKTOP_VISIBLE',pic:''},{av:'AV29Att_TicketMonitor_Visible',fld:'vATT_TICKETMONITOR_VISIBLE',pic:''},{av:'AV30Att_TicketImpresora_Visible',fld:'vATT_TICKETIMPRESORA_VISIBLE',pic:''},{av:'AV31Att_TicketEscaner_Visible',fld:'vATT_TICKETESCANER_VISIBLE',pic:''},{av:'AV32Att_TicketRouter_Visible',fld:'vATT_TICKETROUTER_VISIBLE',pic:''},{av:'AV33Att_TicketSistemaOperativo_Visible',fld:'vATT_TICKETSISTEMAOPERATIVO_VISIBLE',pic:''},{av:'AV34Att_TicketOffice_Visible',fld:'vATT_TICKETOFFICE_VISIBLE',pic:''},{av:'AV35Att_TicketAntivirus_Visible',fld:'vATT_TICKETANTIVIRUS_VISIBLE',pic:''},{av:'AV36Att_TicketAplicacion_Visible',fld:'vATT_TICKETAPLICACION_VISIBLE',pic:''},{av:'AV37Att_TicketDisenio_Visible',fld:'vATT_TICKETDISENIO_VISIBLE',pic:''},{av:'AV38Att_TicketIngenieria_Visible',fld:'vATT_TICKETINGENIERIA_VISIBLE',pic:''},{av:'AV39Att_TicketDiscoDuroExterno_Visible',fld:'vATT_TICKETDISCODUROEXTERNO_VISIBLE',pic:''},{av:'AV40Att_TicketPerifericos_Visible',fld:'vATT_TICKETPERIFERICOS_VISIBLE',pic:''},{av:'AV41Att_TicketUps_Visible',fld:'vATT_TICKETUPS_VISIBLE',pic:''},{av:'AV42Att_TicketApoyoUsuario_Visible',fld:'vATT_TICKETAPOYOUSUARIO_VISIBLE',pic:''},{av:'AV43Att_TicketInstalarDataShow_Visible',fld:'vATT_TICKETINSTALARDATASHOW_VISIBLE',pic:''},{av:'AV44Att_TicketOtros_Visible',fld:'vATT_TICKETOTROS_VISIBLE',pic:''},{av:'AV45Att_TicketUsuarioAsigno_Visible',fld:'vATT_TICKETUSUARIOASIGNO_VISIBLE',pic:''},{av:'AV46Att_TicketFechaHora_Visible',fld:'vATT_TICKETFECHAHORA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E17792',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV69K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV55TicketFecha_From',fld:'vTICKETFECHA_FROM',pic:''},{av:'AV58TicketHora_From',fld:'vTICKETHORA_FROM',pic:'99:99'},{av:'AV59TicketHora_To',fld:'vTICKETHORA_TO',pic:'99:99'},{av:'AV60UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV61EstadoTicketTicketNombre',fld:'vESTADOTICKETTICKETNOMBRE',pic:''},{av:'AV63TicketFechaHora_From',fld:'vTICKETFECHAHORA_FROM',pic:'99/99/9999 99:99:99'},{av:'AV64TicketFechaHora_To',fld:'vTICKETFECHAHORA_TO',pic:'99/99/9999 99:99:99'},{av:'A290EtapaDesarrolloId',fld:'ETAPADESARROLLOID',pic:'ZZZ9'},{av:'AV6EtapaDesarrolloId',fld:'vETAPADESARROLLOID',pic:'ZZZ9'},{av:'AV53ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV70OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV56TicketFecha_To',fld:'vTICKETFECHA_TO',pic:''},{av:'AV89Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV82AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV76TicketFecha_IsAuthorized',fld:'vTICKETFECHA_ISAUTHORIZED',pic:''},{av:'AV86Uri',fld:'vURI',pic:'',hsh:true},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV16Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV22Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV23Att_EstadoTicketTicketId_Visible',fld:'vATT_ESTADOTICKETTICKETID_VISIBLE',pic:''},{av:'AV24Att_EstadoTicketTicketNombre_Visible',fld:'vATT_ESTADOTICKETTICKETNOMBRE_VISIBLE',pic:''},{av:'AV25Att_TicketLastId_Visible',fld:'vATT_TICKETLASTID_VISIBLE',pic:''},{av:'AV26Att_TicketHoraCaracter_Visible',fld:'vATT_TICKETHORACARACTER_VISIBLE',pic:''},{av:'AV27Att_TicketLaptop_Visible',fld:'vATT_TICKETLAPTOP_VISIBLE',pic:''},{av:'AV28Att_TicketDesktop_Visible',fld:'vATT_TICKETDESKTOP_VISIBLE',pic:''},{av:'AV29Att_TicketMonitor_Visible',fld:'vATT_TICKETMONITOR_VISIBLE',pic:''},{av:'AV30Att_TicketImpresora_Visible',fld:'vATT_TICKETIMPRESORA_VISIBLE',pic:''},{av:'AV31Att_TicketEscaner_Visible',fld:'vATT_TICKETESCANER_VISIBLE',pic:''},{av:'AV32Att_TicketRouter_Visible',fld:'vATT_TICKETROUTER_VISIBLE',pic:''},{av:'AV33Att_TicketSistemaOperativo_Visible',fld:'vATT_TICKETSISTEMAOPERATIVO_VISIBLE',pic:''},{av:'AV34Att_TicketOffice_Visible',fld:'vATT_TICKETOFFICE_VISIBLE',pic:''},{av:'AV35Att_TicketAntivirus_Visible',fld:'vATT_TICKETANTIVIRUS_VISIBLE',pic:''},{av:'AV36Att_TicketAplicacion_Visible',fld:'vATT_TICKETAPLICACION_VISIBLE',pic:''},{av:'AV37Att_TicketDisenio_Visible',fld:'vATT_TICKETDISENIO_VISIBLE',pic:''},{av:'AV38Att_TicketIngenieria_Visible',fld:'vATT_TICKETINGENIERIA_VISIBLE',pic:''},{av:'AV39Att_TicketDiscoDuroExterno_Visible',fld:'vATT_TICKETDISCODUROEXTERNO_VISIBLE',pic:''},{av:'AV40Att_TicketPerifericos_Visible',fld:'vATT_TICKETPERIFERICOS_VISIBLE',pic:''},{av:'AV41Att_TicketUps_Visible',fld:'vATT_TICKETUPS_VISIBLE',pic:''},{av:'AV42Att_TicketApoyoUsuario_Visible',fld:'vATT_TICKETAPOYOUSUARIO_VISIBLE',pic:''},{av:'AV43Att_TicketInstalarDataShow_Visible',fld:'vATT_TICKETINSTALARDATASHOW_VISIBLE',pic:''},{av:'AV44Att_TicketOtros_Visible',fld:'vATT_TICKETOTROS_VISIBLE',pic:''},{av:'AV45Att_TicketUsuarioAsigno_Visible',fld:'vATT_TICKETUSUARIOASIGNO_VISIBLE',pic:''},{av:'AV46Att_TicketFechaHora_Visible',fld:'vATT_TICKETFECHAHORA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E18792',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV69K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV55TicketFecha_From',fld:'vTICKETFECHA_FROM',pic:''},{av:'AV58TicketHora_From',fld:'vTICKETHORA_FROM',pic:'99:99'},{av:'AV59TicketHora_To',fld:'vTICKETHORA_TO',pic:'99:99'},{av:'AV60UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV61EstadoTicketTicketNombre',fld:'vESTADOTICKETTICKETNOMBRE',pic:''},{av:'AV63TicketFechaHora_From',fld:'vTICKETFECHAHORA_FROM',pic:'99/99/9999 99:99:99'},{av:'AV64TicketFechaHora_To',fld:'vTICKETFECHAHORA_TO',pic:'99/99/9999 99:99:99'},{av:'A290EtapaDesarrolloId',fld:'ETAPADESARROLLOID',pic:'ZZZ9'},{av:'AV6EtapaDesarrolloId',fld:'vETAPADESARROLLOID',pic:'ZZZ9'},{av:'AV53ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV70OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV56TicketFecha_To',fld:'vTICKETFECHA_TO',pic:''},{av:'AV89Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV82AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV76TicketFecha_IsAuthorized',fld:'vTICKETFECHA_ISAUTHORIZED',pic:''},{av:'AV86Uri',fld:'vURI',pic:'',hsh:true},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV16Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV22Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV23Att_EstadoTicketTicketId_Visible',fld:'vATT_ESTADOTICKETTICKETID_VISIBLE',pic:''},{av:'AV24Att_EstadoTicketTicketNombre_Visible',fld:'vATT_ESTADOTICKETTICKETNOMBRE_VISIBLE',pic:''},{av:'AV25Att_TicketLastId_Visible',fld:'vATT_TICKETLASTID_VISIBLE',pic:''},{av:'AV26Att_TicketHoraCaracter_Visible',fld:'vATT_TICKETHORACARACTER_VISIBLE',pic:''},{av:'AV27Att_TicketLaptop_Visible',fld:'vATT_TICKETLAPTOP_VISIBLE',pic:''},{av:'AV28Att_TicketDesktop_Visible',fld:'vATT_TICKETDESKTOP_VISIBLE',pic:''},{av:'AV29Att_TicketMonitor_Visible',fld:'vATT_TICKETMONITOR_VISIBLE',pic:''},{av:'AV30Att_TicketImpresora_Visible',fld:'vATT_TICKETIMPRESORA_VISIBLE',pic:''},{av:'AV31Att_TicketEscaner_Visible',fld:'vATT_TICKETESCANER_VISIBLE',pic:''},{av:'AV32Att_TicketRouter_Visible',fld:'vATT_TICKETROUTER_VISIBLE',pic:''},{av:'AV33Att_TicketSistemaOperativo_Visible',fld:'vATT_TICKETSISTEMAOPERATIVO_VISIBLE',pic:''},{av:'AV34Att_TicketOffice_Visible',fld:'vATT_TICKETOFFICE_VISIBLE',pic:''},{av:'AV35Att_TicketAntivirus_Visible',fld:'vATT_TICKETANTIVIRUS_VISIBLE',pic:''},{av:'AV36Att_TicketAplicacion_Visible',fld:'vATT_TICKETAPLICACION_VISIBLE',pic:''},{av:'AV37Att_TicketDisenio_Visible',fld:'vATT_TICKETDISENIO_VISIBLE',pic:''},{av:'AV38Att_TicketIngenieria_Visible',fld:'vATT_TICKETINGENIERIA_VISIBLE',pic:''},{av:'AV39Att_TicketDiscoDuroExterno_Visible',fld:'vATT_TICKETDISCODUROEXTERNO_VISIBLE',pic:''},{av:'AV40Att_TicketPerifericos_Visible',fld:'vATT_TICKETPERIFERICOS_VISIBLE',pic:''},{av:'AV41Att_TicketUps_Visible',fld:'vATT_TICKETUPS_VISIBLE',pic:''},{av:'AV42Att_TicketApoyoUsuario_Visible',fld:'vATT_TICKETAPOYOUSUARIO_VISIBLE',pic:''},{av:'AV43Att_TicketInstalarDataShow_Visible',fld:'vATT_TICKETINSTALARDATASHOW_VISIBLE',pic:''},{av:'AV44Att_TicketOtros_Visible',fld:'vATT_TICKETOTROS_VISIBLE',pic:''},{av:'AV45Att_TicketUsuarioAsigno_Visible',fld:'vATT_TICKETUSUARIOASIGNO_VISIBLE',pic:''},{av:'AV46Att_TicketFechaHora_Visible',fld:'vATT_TICKETFECHAHORA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOEXPORT'","{handler:'E19792',iparms:[{av:'AV6EtapaDesarrolloId',fld:'vETAPADESARROLLOID',pic:'ZZZ9'},{av:'AV55TicketFecha_From',fld:'vTICKETFECHA_FROM',pic:''},{av:'AV56TicketFecha_To',fld:'vTICKETFECHA_TO',pic:''},{av:'AV58TicketHora_From',fld:'vTICKETHORA_FROM',pic:'99:99'},{av:'AV59TicketHora_To',fld:'vTICKETHORA_TO',pic:'99:99'},{av:'AV60UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV61EstadoTicketTicketNombre',fld:'vESTADOTICKETTICKETNOMBRE',pic:''},{av:'AV63TicketFechaHora_From',fld:'vTICKETFECHAHORA_FROM',pic:'99/99/9999 99:99:99'},{av:'AV64TicketFechaHora_To',fld:'vTICKETFECHAHORA_TO',pic:'99/99/9999 99:99:99'},{av:'AV69K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV70OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV86Uri',fld:'vURI',pic:'',hsh:true},{av:'AV15Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV16Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV22Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV23Att_EstadoTicketTicketId_Visible',fld:'vATT_ESTADOTICKETTICKETID_VISIBLE',pic:''},{av:'AV24Att_EstadoTicketTicketNombre_Visible',fld:'vATT_ESTADOTICKETTICKETNOMBRE_VISIBLE',pic:''},{av:'AV25Att_TicketLastId_Visible',fld:'vATT_TICKETLASTID_VISIBLE',pic:''},{av:'AV26Att_TicketHoraCaracter_Visible',fld:'vATT_TICKETHORACARACTER_VISIBLE',pic:''},{av:'AV27Att_TicketLaptop_Visible',fld:'vATT_TICKETLAPTOP_VISIBLE',pic:''},{av:'AV28Att_TicketDesktop_Visible',fld:'vATT_TICKETDESKTOP_VISIBLE',pic:''},{av:'AV29Att_TicketMonitor_Visible',fld:'vATT_TICKETMONITOR_VISIBLE',pic:''},{av:'AV30Att_TicketImpresora_Visible',fld:'vATT_TICKETIMPRESORA_VISIBLE',pic:''},{av:'AV31Att_TicketEscaner_Visible',fld:'vATT_TICKETESCANER_VISIBLE',pic:''},{av:'AV32Att_TicketRouter_Visible',fld:'vATT_TICKETROUTER_VISIBLE',pic:''},{av:'AV33Att_TicketSistemaOperativo_Visible',fld:'vATT_TICKETSISTEMAOPERATIVO_VISIBLE',pic:''},{av:'AV34Att_TicketOffice_Visible',fld:'vATT_TICKETOFFICE_VISIBLE',pic:''},{av:'AV35Att_TicketAntivirus_Visible',fld:'vATT_TICKETANTIVIRUS_VISIBLE',pic:''},{av:'AV36Att_TicketAplicacion_Visible',fld:'vATT_TICKETAPLICACION_VISIBLE',pic:''},{av:'AV37Att_TicketDisenio_Visible',fld:'vATT_TICKETDISENIO_VISIBLE',pic:''},{av:'AV38Att_TicketIngenieria_Visible',fld:'vATT_TICKETINGENIERIA_VISIBLE',pic:''},{av:'AV39Att_TicketDiscoDuroExterno_Visible',fld:'vATT_TICKETDISCODUROEXTERNO_VISIBLE',pic:''},{av:'AV40Att_TicketPerifericos_Visible',fld:'vATT_TICKETPERIFERICOS_VISIBLE',pic:''},{av:'AV41Att_TicketUps_Visible',fld:'vATT_TICKETUPS_VISIBLE',pic:''},{av:'AV42Att_TicketApoyoUsuario_Visible',fld:'vATT_TICKETAPOYOUSUARIO_VISIBLE',pic:''},{av:'AV43Att_TicketInstalarDataShow_Visible',fld:'vATT_TICKETINSTALARDATASHOW_VISIBLE',pic:''},{av:'AV44Att_TicketOtros_Visible',fld:'vATT_TICKETOTROS_VISIBLE',pic:''},{av:'AV45Att_TicketUsuarioAsigno_Visible',fld:'vATT_TICKETUSUARIOASIGNO_VISIBLE',pic:''},{av:'AV46Att_TicketFechaHora_Visible',fld:'vATT_TICKETFECHAHORA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         H00792_n278TicketUsuarioAsigno = new bool[] {false} ;
         H00792_A57TicketOtros = new bool[] {false} ;
         H00792_n57TicketOtros = new bool[] {false} ;
         H00792_A52TicketInstalarDataShow = new bool[] {false} ;
         H00792_n52TicketInstalarDataShow = new bool[] {false} ;
         H00792_A41TicketApoyoUsuario = new bool[] {false} ;
         H00792_n41TicketApoyoUsuario = new bool[] {false} ;
         H00792_A87TicketUps = new bool[] {false} ;
         H00792_n87TicketUps = new bool[] {false} ;
         H00792_A58TicketPerifericos = new bool[] {false} ;
         H00792_n58TicketPerifericos = new bool[] {false} ;
         H00792_A43TicketDiscoDuroExterno = new bool[] {false} ;
         H00792_n43TicketDiscoDuroExterno = new bool[] {false} ;
         H00792_A51TicketIngenieria = new bool[] {false} ;
         H00792_n51TicketIngenieria = new bool[] {false} ;
         H00792_A44TicketDisenio = new bool[] {false} ;
         H00792_n44TicketDisenio = new bool[] {false} ;
         H00792_A40TicketAplicacion = new bool[] {false} ;
         H00792_n40TicketAplicacion = new bool[] {false} ;
         H00792_A39TicketAntivirus = new bool[] {false} ;
         H00792_n39TicketAntivirus = new bool[] {false} ;
         H00792_A56TicketOffice = new bool[] {false} ;
         H00792_n56TicketOffice = new bool[] {false} ;
         H00792_A60TicketSistemaOperativo = new bool[] {false} ;
         H00792_n60TicketSistemaOperativo = new bool[] {false} ;
         H00792_A59TicketRouter = new bool[] {false} ;
         H00792_n59TicketRouter = new bool[] {false} ;
         H00792_A45TicketEscaner = new bool[] {false} ;
         H00792_n45TicketEscaner = new bool[] {false} ;
         H00792_A50TicketImpresora = new bool[] {false} ;
         H00792_n50TicketImpresora = new bool[] {false} ;
         H00792_A55TicketMonitor = new bool[] {false} ;
         H00792_n55TicketMonitor = new bool[] {false} ;
         H00792_A42TicketDesktop = new bool[] {false} ;
         H00792_n42TicketDesktop = new bool[] {false} ;
         H00792_A53TicketLaptop = new bool[] {false} ;
         H00792_n53TicketLaptop = new bool[] {false} ;
         ...
         H00792_A15UsuarioId = new long[1] ;
         ...
         AV62TicketFechaHora = (DateTime)(DateTime.MinValue);
         AV72GridOrder = new SdtK2BGridOrders_K2BGridOrdersItem(context);
         AV74Messages = new GXBaseCollection<GeneXus.Utils.SdtMessages_Message>( context, "Message", "GeneXus");
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.etapasdesarrolloticketwc__default(),
            new Object[][] {
                new Object[] {
               H00792_A289TicketFechaHora, H00792_n289TicketFechaHora, H00792_A278TicketUsuarioAsigno, H00792_n278TicketUsuarioAsigno, H00792_A57TicketOtros, H00792_n57TicketOtros, H00792_A52TicketInstalarDataShow, H00792_n52TicketInstalarDataShow, H00792_A41TicketApoyoUsuario, H00792_n41TicketApoyoUsuario,
               H00792_A87TicketUps, H00792_n87TicketUps, H00792_A58TicketPerifericos, H00792_n58TicketPerifericos, H00792_A43TicketDiscoDuroExterno, H00792_n43TicketDiscoDuroExterno, H00792_A51TicketIngenieria, H00792_n51TicketIngenieria, H00792_A44TicketDisenio, H00792_n44TicketDisenio,
               H00792_A40TicketAplicacion, H00792_n40TicketAplicacion, H00792_A39TicketAntivirus, H00792_n39TicketAntivirus, H00792_A56TicketOffice, H00792_n56TicketOffice, H00792_A60TicketSistemaOperativo, H00792_n60TicketSistemaOperativo, H00792_A59TicketRouter, H00792_n59TicketRouter,
               H00792_A45TicketEscaner, H00792_n45TicketEscaner, H00792_A50TicketImpresora, H00792_n50TicketImpresora, H00792_A55TicketMonitor, H00792_n55TicketMonitor, H00792_A42TicketDesktop, H00792_n42TicketDesktop, H00792_A53TicketLaptop, H00792_n53TicketLaptop,
               H00792_A285TicketHoraCaracter, H00792_A54TicketLastId, H00792_A188EstadoTicketTicketNombre, H00792_A187EstadoTicketTicketId, H00792_A88UsuarioDepartamento, H00792_A91UsuarioGerencia, H00792_A94UsuarioRequerimiento, H00792_A93UsuarioNombre, H00792_A15UsuarioId, H00792_A48TicketHora,
               H00792_A46TicketFecha, H00792_A14TicketId
               }
               , new Object[] {
      ...
      private bool[] H00792_n278TicketUsuarioAsigno ;
      private bool[] H00792_A57TicketOtros ;
      private bool[] H00792_n57TicketOtros ;
      private bool[] H00792_A52TicketInstalarDataShow ;
      private bool[] H00792_n52TicketInstalarDataShow ;
      private bool[] H00792_A41TicketApoyoUsuario ;
      private bool[] H00792_n41TicketApoyoUsuario ;
      private bool[] H00792_A87TicketUps ;
      private bool[] H00792_n87TicketUps ;
      private bool[] H00792_A58TicketPerifericos ;
      private bool[] H00792_n58TicketPerifericos ;
      private bool[] H00792_A43TicketDiscoDuroExterno ;
      private bool[] H00792_n43TicketDiscoDuroExterno ;
      private bool[] H00792_A51TicketIngenieria ;
      private bool[] H00792_n51TicketIngenieria ;
      private bool[] H00792_A44TicketDisenio ;
      private bool[] H00792_n44TicketDisenio ;
      private bool[] H00792_A40TicketAplicacion ;
      private bool[] H00792_n40TicketAplicacion ;
      private bool[] H00792_A39TicketAntivirus ;
      private bool[] H00792_n39TicketAntivirus ;
      private bool[] H00792_A56TicketOffice ;
      private bool[] H00792_n56TicketOffice ;
      private bool[] H00792_A60TicketSistemaOperativo ;
      private bool[] H00792_n60TicketSistemaOperativo ;
      private bool[] H00792_A59TicketRouter ;
      private bool[] H00792_n59TicketRouter ;
      private bool[] H00792_A45TicketEscaner ;
      private bool[] H00792_n45TicketEscaner ;
      private bool[] H00792_A50TicketImpresora ;
      private bool[] H00792_n50TicketImpresora ;
      private bool[] H00792_A55TicketMonitor ;
      private bool[] H00792_n55TicketMonitor ;
      private bool[] H00792_A42TicketDesktop ;
      private bool[] H00792_n42TicketDesktop ;
      private bool[] H00792_A53TicketLaptop ;
      private bool[] H00792_n53TicketLaptop ;
      ...
      private long[] H00792_A15UsuarioId ;
      ...
      private GXBaseCollection<GeneXus.Utils.SdtMessages_Message> AV74Messages ;
   ...
   public class etapasdesarrolloticketwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV6EtapaDesarrolloId )
      {
         ...
         {
            AddWhere(sWhereString, "(CONVERT( char(10), CAST(T1.[TicketId] AS decimal(10,0))) like '%' + @lV69K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T1.[UsuarioId] AS decimal(10,0))) like '%' + @lV69K2BToolsGenericSearchField + '%' or T3.[UsuarioNombre] like '%' + @lV69K2BToolsGenericSearchField + '%' or T3.[UsuarioRequerimiento] like '%' + @lV69K2BToolsGenericSearchField + '%' or T3.[UsuarioGerencia] like '%' + @lV69K2BToolsGenericSearchField + '%' or T3.[UsuarioDepartamento] like '%' + @lV69K2BToolsGenericSearchField + '%' or CONVERT( char(4), CAST(T1.[EstadoTicketTicketId] AS decimal(4,0))) like '%' + @lV69K2BToolsGenericSearchField + '%' or T2.[EstadoTicketNombre] like '%' + @lV69K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T1.[TicketLastId] AS decimal(10,0))) like '%' + @lV69K2BToolsGenericSearchField + '%' or T1.[TicketHoraCaracter] like '%' + @lV69K2BToolsGenericSearchField + '%' or T1.[TicketUsuarioAsigno] like '%' + @lV69K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int5[10] = 1;
                                             ...
                                             short AV6EtapaDesarrolloId )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV69K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(10), CAST(T1.[TicketId] AS decimal(10,0))) like '%' + @lV69K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T1.[UsuarioId] AS decimal(10,0))) like '%' + @lV69K2BToolsGenericSearchField + '%' or T2.[UsuarioNombre] like '%' + @lV69K2BToolsGenericSearchField + '%' or T2.[UsuarioRequerimiento] like '%' + @lV69K2BToolsGenericSearchField + '%' or T2.[UsuarioGerencia] like '%' + @lV69K2BToolsGenericSearchField + '%' or T2.[UsuarioDepartamento] like '%' + @lV69K2BToolsGenericSearchField + '%' or CONVERT( char(4), CAST(T1.[EstadoTicketTicketId] AS decimal(4,0))) like '%' + @lV69K2BToolsGenericSearchField + '%' or T3.[EstadoTicketNombre] like '%' + @lV69K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T1.[TicketLastId] AS decimal(10,0))) like '%' + @lV69K2BToolsGenericSearchField + '%' or T1.[TicketHoraCaracter] like '%' + @lV69K2BToolsGenericSearchField + '%' or T1.[TicketUsuarioAsigno] like '%' + @lV69K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int7[10] = 1;
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((string[]) buf[40])[0] = rslt.getString(21, 8);
                ...
                ((long[]) buf[48])[0] = rslt.getLong(29);
                ((DateTime[]) buf[49])[0] = rslt.getGXDateTime(30);
                ((DateTime[]) buf[50])[0] = rslt.getGXDate(31);
                ((long[]) buf[51])[0] = rslt.getLong(32);
                return;
             case 1 :
