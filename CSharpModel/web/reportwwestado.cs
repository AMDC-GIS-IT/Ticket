...
namespace GeneXus.Programs {
   public class reportwwestado : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV15EstadoNombre = gxfirstwebparm;
      ...
      public reportwwestado( IGxContext context )
      {
      ...
      public void execute( string aP0_EstadoNombre ,
                           ...
                           short aP2_OrderedBy )
      {
         this.AV15EstadoNombre = aP0_EstadoNombre;
      ...
      public void executeSubmit( string aP0_EstadoNombre ,
                                 ...
                                 short aP2_OrderedBy )
      {
         reportwwestado objreportwwestado;
         objreportwwestado = new reportwwestado();
         objreportwwestado.AV15EstadoNombre = aP0_EstadoNombre;
         objreportwwestado.AV9K2BToolsGenericSearchField = aP1_K2BToolsGenericSearchField;
         objreportwwestado.AV10OrderedBy = aP2_OrderedBy;
         objreportwwestado.context.SetSubmitInitialConfig(context);
         objreportwwestado.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objreportwwestado);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((reportwwestado)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "Estado",  "Estado",  "List",  "",  AV25Pgmname) )
            {
               H2X0( false, 30) ;
            ...
            else
            {
               ...
               getPrinter().GxDrawText("Estados", 336, Gx_line+0, 490, Gx_line+42, 0+256, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
               ...
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV15EstadoNombre)) )
               {
                  H2X0( false, 30) ;
                  getPrinter().GxAttris("Courier New", 8, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText("Estado", 10, Gx_line+7, 55, Gx_line+22, 0+256, 0, 0, 0) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV15EstadoNombre, "")), 63, Gx_line+7, 283, Gx_line+23, 0+256, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
               }
               H2X0( false, 30) ;
               ...
               getPrinter().GxDrawText("Estado", 56, Gx_line+7, 276, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Status", 284, Gx_line+7, 329, Gx_line+22, 0, 0, 0, 1) ;
               Gx_OldLine = Gx_line;
               Gx_line = (int)(Gx_line+30);
               GxHdr3 = true;
               ...
               lV15EstadoNombre = StringUtil.Concat( StringUtil.RTrim( AV15EstadoNombre), "%", "");
               lV9K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV9K2BToolsGenericSearchField), 200, "%");
               lV9K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV9K2BToolsGenericSearchField), 200, "%");
               /* Using cursor P002X2 */
               pr_default.execute(0, new Object[] {lV15EstadoNombre, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField});
               while ( (pr_default.getStatus(0) != 101) )
               {
                  A3EstadoId = P002X2_A3EstadoId[0];
                  A20EstadoNombre = P002X2_A20EstadoNombre[0];
                  A19EstadoActivo = P002X2_A19EstadoActivo[0];
                  AV20Grid_EstadoActivo = (A19EstadoActivo ? "Si" : "No");
                  H2X0( false, 30) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(A3EstadoId), "ZZZ9")), 18, Gx_line+7, 48, Gx_line+23, 2, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A20EstadoNombre, "")), 56, Gx_line+7, 276, Gx_line+23, 0, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV20Grid_EstadoActivo, "")), 284, Gx_line+7, 329, Gx_line+23, 0, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
      ...
      protected void H2X0( bool bFoot ,
                           int Inc )
      {
      ...
      public override void initialize( )
      {
         ...
         A20EstadoNombre = "";
         P002X2_A3EstadoId = new short[1] ;
         P002X2_A20EstadoNombre = new string[] {""} ;
         P002X2_A19EstadoActivo = new bool[] {false} ;
         AV20Grid_EstadoActivo = "";
         Gx_date = DateTime.MinValue;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportwwestado__default(),
            new Object[][] {
                new Object[] {
               P002X2_A3EstadoId, P002X2_A20EstadoNombre, P002X2_A19EstadoActivo
               }
            }
         );
         AV25Pgmname = "ReportWWEstado";
      ...
      private string AV20Grid_EstadoActivo ;
      private DateTime Gx_date ;
      private bool entryPointCalled ;
      private bool toggleJsOutput ;
      private bool GxHdr3 ;
      private bool A19EstadoActivo ;
      private string AV15EstadoNombre ;
      private string lV15EstadoNombre ;
      ...
      private short[] P002X2_A3EstadoId ;
      private string[] P002X2_A20EstadoNombre ;
      private bool[] P002X2_A19EstadoActivo ;
      private SdtK2BContext AV8Context ;
   }

   public class reportwwestado__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P002X2( IGxContext context ,
                                             string AV15EstadoNombre ,
                                             ...
                                             short AV10OrderedBy )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV15EstadoNombre)) )
         {
            AddWhere(sWhereString, "([EstadoNombre] like @lV15EstadoNombre)");
         }
         else
         {
            GXv_int1[0] = 1;
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(4), CAST([EstadoId] AS decimal(4,0))) like '%' + @lV9K2BToolsGenericSearchField + '%' or [EstadoNombre] like '%' + @lV9K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int1[1] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P002X2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV15EstadoNombre",GXType.NVarChar,30,0) ,
