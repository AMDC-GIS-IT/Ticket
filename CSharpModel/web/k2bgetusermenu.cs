...
namespace GeneXus.Programs {
   public class k2bgetusermenu : GXProcedure
   {
      ...
      {
         this.AV8MenuItems = new GXBaseCollection<SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem>( context, "K2BMultiLevelMenuItem", "kb_ticket") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBaseCollection<SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem> aP0_MenuItems )
      {
         ...
         objk2bgetusermenu.AV8MenuItems = new GXBaseCollection<SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem>( context, "K2BMultiLevelMenuItem", "kb_ticket") ;
      ...
      {
         AV8MenuItems = new GXBaseCollection<SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem>( context, "K2BMultiLevelMenuItem", "kb_ticket");
         ...
         AV15AllStaticMenu = new GXBaseCollection<SdtK2BMultiLevelMenuCollection_K2BMultiLevelMenuCollectionItem>( context, "K2BMultiLevelMenuCollectionItem", "kb_ticket");
         GXt_objcol_SdtK2BMultiLevelMenuCollection_K2BMultiLevelMenuCollectionItem2 = new GXBaseCollection<SdtK2BMultiLevelMenuCollection_K2BMultiLevelMenuCollectionItem>( context, "K2BMultiLevelMenuCollectionItem", "kb_ticket");
         AV24ProgramNames = new GXBaseCollection<SdtK2BProgramNames_ProgramName>( context, "ProgramName", "kb_ticket");
         GXt_objcol_SdtK2BProgramNames_ProgramName3 = new GXBaseCollection<SdtK2BProgramNames_ProgramName>( context, "ProgramName", "kb_ticket");
         AV23MenuItem = new SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem(context);
