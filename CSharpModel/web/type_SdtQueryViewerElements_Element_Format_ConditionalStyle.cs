...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerElements.Element.Format.ConditionalStyle" , Namespace="kb_ticket" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerElements.Element.Format.ConditionalStyle", Namespace="kb_ticket")]
