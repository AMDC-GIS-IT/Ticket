...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="DashboardViewerValuesHighlightedData.Filter" , Namespace="kb_ticket" )]
	[Serializable]
	public class SdtDashboardViewerValuesHighlightedData_Filter : GxUserType
	{
		...
		public GxSimpleCollection<string> gxTpr_Values_GxSimpleCollection
		{
			...
			set {
				gxTv_SdtDashboardViewerValuesHighlightedData_Filter_Values_N = false;
		...
		{
			gxTv_SdtDashboardViewerValuesHighlightedData_Filter_Values_N = true;
		...
		{
			return gxTv_SdtDashboardViewerValuesHighlightedData_Filter_Values == null;
		}
		...
		protected bool gxTv_SdtDashboardViewerValuesHighlightedData_Filter_Values_N;
	...
	[DataContract(Name=@"DashboardViewerValuesHighlightedData.Filter", Namespace="kb_ticket")]
