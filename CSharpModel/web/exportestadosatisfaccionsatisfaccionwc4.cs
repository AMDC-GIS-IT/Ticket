...
namespace GeneXus.Programs {
   public class exportestadosatisfaccionsatisfaccionwc4 : GXProcedure
   {
      ...
      public string executeUdp( short aP0_SatisfaccionTiempoId ,
                                DateTime aP1_SatisfaccionFecha_From ,
                                DateTime aP2_SatisfaccionFecha_To ,
                                DateTime aP3_UsuarioFecha_From ,
                                DateTime aP4_UsuarioFecha_To ,
                                 ...
                                 out string aP12_OutFile )
      {
         ...
         objexportestadosatisfaccionsatisfaccionwc4.AV50OutFile = "" ;
      ...
      void executePrivate( )
      {
         ...
         AV50OutFile = GxDirectory.TemporaryFilesPath + AV30File.Separator + "ExportEstadoSatisfaccionSatisfaccionWC4-" + Guid.NewGuid( ).ToString() + ".xlsx";
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            n34SatisfaccionSugerencia = P00333_n34SatisfaccionSugerencia[0];
      ...
      public override void initialize( )
      {
         ...
         P00333_n34SatisfaccionSugerencia = new bool[] {false} ;
         P00333_A94UsuarioRequerimiento = new string[] {""} ;
         P00333_A93UsuarioNombre = new string[] {""} ;
         P00333_A15UsuarioId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.exportestadosatisfaccionsatisfaccionwc4__default(),
            new Object[][] {
               ...
               , new Object[] {
               P00333_A8SatisfaccionResueltoId, P00333_A9SatisfaccionTecnicoProblemaId, P00333_A10SatisfaccionTecnicoCompetenteId, P00333_A11SatisfaccionTecnicoProfesionalismoId, P00333_A13SatisfaccionAtencionId, P00333_A34SatisfaccionSugerencia, P00333_n34SatisfaccionSugerencia, P00333_A94UsuarioRequerimiento, P00333_A93UsuarioNombre, P00333_A15UsuarioId,
               P00333_A14TicketId, P00333_A7SatisfaccionId, P00333_A31SatisfaccionAtencionNombre, P00333_A37SatisfaccionTecnicoProfesionalismoNombre, P00333_A35SatisfaccionTecnicoCompetenteNombre, P00333_A36SatisfaccionTecnicoProblemaNombre, P00333_A33SatisfaccionResueltoNombre, P00333_A90UsuarioFecha, P00333_A32SatisfaccionFecha, P00333_A12SatisfaccionTiempoId
               }
            }
         );
         /* GeneXus formulas. */
   ...
   public class exportestadosatisfaccionsatisfaccionwc4__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_P00333(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (long)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] , (short)dynConstraints[25] );
         }
