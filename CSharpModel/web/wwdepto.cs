...
namespace GeneXus.Programs {
   public class wwdepto : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwdepto( )
      {
      ...
      public wwdepto( IGxContext context )
      {
      ...
      {
         chkavAtt_centrodecostoid_visible = new GXCheckbox();
         chkavAtt_departamentoid_visible = new GXCheckbox();
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV32DepartamentoNombre_IsAuthorized = StringUtil.StrToBool( GetPar( "DepartamentoNombre_IsAuthorized"));
               AV14Att_CentrodecostoId_Visible = StringUtil.StrToBool( GetPar( "Att_CentrodecostoId_Visible"));
               AV15Att_DepartamentoId_Visible = StringUtil.StrToBool( GetPar( "Att_DepartamentoId_Visible"));
               AV16Att_DepartamentoNombre_Visible = StringUtil.StrToBool( GetPar( "Att_DepartamentoNombre_Visible"));
               ...
               gxgrGrid_refresh( subGrid_Rows, AV24K2BToolsGenericSearchField, AV23ClassCollection, AV25OrderedBy, AV8CurrentPage, AV44Pgmname, AV10GridConfiguration, AV32DepartamentoNombre_IsAuthorized, AV14Att_CentrodecostoId_Visible, AV15Att_DepartamentoId_Visible, AV16Att_DepartamentoNombre_Visible, AV11FreezeColumnTitles, AV41Uri) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188213356", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwdepto.aspx") +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vURI", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV41Uri, "")), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vGRIDORDERS", AV27GridOrders);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vGRIDORDERS", AV27GridOrders);
         }
         GxWebStd.gx_hidden_field( context, "vUC_ORDEREDBY", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV29UC_OrderedBy), 4, 0, ".", "")));
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vDEPARTAMENTONOMBRE_ISAUTHORIZED", AV32DepartamentoNombre_IsAuthorized);
         ...
         GxWebStd.gx_hidden_field( context, "vURI", AV41Uri);
         GxWebStd.gx_hidden_field( context, "gxhash_vURI", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV41Uri, "")), context));
      ...
      {
         return formatLink("wwdepto.aspx")  ;
      }
      ...
      protected void WB610( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPgmdescriptortextblock_Internalname, "Deptos", "", "", lblPgmdescriptortextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_WWDepto.htm");
      ...
      protected void wb_table1_24_612e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" width="+StringUtil.LTrimStr( (decimal)(97), 4, 0)+"px"+" class=\""+"Attribute_Grid"+"\" "+" style=\""+((edtCentrodecostoId_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
               context.SendWebValue( "Centrodecosto Id") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute_Grid"+"\" "+" style=\""+((edtDepartamentoId_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtCentrodecostoId_Visible), 5, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A260DepartamentoId), 4, 0, ".", "")));
               GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtDepartamentoId_Visible), 5, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         if ( wbEnd == 111 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_117_612( true) ;
         }
         else
         {
            wb_table2_117_612( false) ;
         }
         return  ;
      }

      protected void wb_table2_117_612e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagebuttontextblock_Internalname, "", "", "", lblPreviouspagebuttontextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOPREVIOUS\\'."+"'", "", lblPreviouspagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_WWDepto.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFirstpagetextblock_Internalname, lblFirstpagetextblock_Caption, "", "", lblFirstpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOFIRST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblFirstpagetextblock_Visible, 1, 0, 0, "HLP_WWDepto.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacinglefttextblock_Internalname, "...", "", "", lblSpacinglefttextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacinglefttextblock_Visible, 1, 0, 0, "HLP_WWDepto.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagetextblock_Internalname, lblPreviouspagetextblock_Caption, "", "", lblPreviouspagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOPREVIOUS\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPreviouspagetextblock_Visible, 1, 0, 0, "HLP_WWDepto.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCurrentpagetextblock_Internalname, lblCurrentpagetextblock_Caption, "", "", lblCurrentpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_WWDepto.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagetextblock_Internalname, lblNextpagetextblock_Caption, "", "", lblNextpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DONEXT\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblNextpagetextblock_Visible, 1, 0, 0, "HLP_WWDepto.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacingrighttextblock_Internalname, "...", "", "", lblSpacingrighttextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacingrighttextblock_Visible, 1, 0, 0, "HLP_WWDepto.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLastpagetextblock_Internalname, lblLastpagetextblock_Caption, "", "", lblLastpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOLAST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblLastpagetextblock_Visible, 1, 0, 0, "HLP_WWDepto.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagebuttontextblock_Internalname, "", "", "", lblNextpagebuttontextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DONEXT\\'."+"'", "", lblNextpagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_WWDepto.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV32DepartamentoNombre_IsAuthorized ,
                                       bool AV14Att_CentrodecostoId_Visible ,
                                       bool AV15Att_DepartamentoId_Visible ,
                                       bool AV16Att_DepartamentoNombre_Visible ,
      ...
      {
         AV14Att_CentrodecostoId_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV14Att_CentrodecostoId_Visible));
         AssignAttri("", false, "AV14Att_CentrodecostoId_Visible", AV14Att_CentrodecostoId_Visible);
         AV15Att_DepartamentoId_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV15Att_DepartamentoId_Visible));
         AssignAttri("", false, "AV15Att_DepartamentoId_Visible", AV15Att_DepartamentoId_Visible);
         AV16Att_DepartamentoNombre_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV16Att_DepartamentoNombre_Visible));
         AssignAttri("", false, "AV16Att_DepartamentoNombre_Visible", AV16Att_DepartamentoNombre_Visible);
         if ( cmbavGridsettingsorderedby.ItemCount > 0 )
         {
            AV26GridSettingsOrderedBy = (short)(NumberUtil.Val( cmbavGridsettingsorderedby.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV26GridSettingsOrderedBy), 4, 0))), "."));
            AssignAttri("", false, "AV26GridSettingsOrderedBy", StringUtil.LTrimStr( (decimal)(AV26GridSettingsOrderedBy), 4, 0));
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavGridsettingsorderedby.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV26GridSettingsOrderedBy), 4, 0));
      ...
      protected void RF612( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV24K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV24K2BToolsGenericSearchField), 100, "%");
            /* Using cursor H00612 */
            pr_datastore2.execute(0, new Object[] {lV24K2BToolsGenericSearchField, lV24K2BToolsGenericSearchField, lV24K2BToolsGenericSearchField, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_111_idx = 1;
            sGXsfl_111_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_111_idx), 4, 0), 4, "0");
            SubsflControlProps_1112( ) ;
            while ( ( (pr_datastore2.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A261DepartamentoNombre = H00612_A261DepartamentoNombre[0];
               A260DepartamentoId = H00612_A260DepartamentoId[0];
               A259CentrodecostoId = H00612_A259CentrodecostoId[0];
               E21612 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV24K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV24K2BToolsGenericSearchField), 100, "%");
         /* Using cursor H00613 */
         pr_datastore2.execute(1, new Object[] {lV24K2BToolsGenericSearchField, lV24K2BToolsGenericSearchField, lV24K2BToolsGenericSearchField});
      ...
      protected void STRUP610( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( "vGRIDORDERS"), AV27GridOrders);
            /* Read saved values. */
            nRC_GXsfl_111 = (int)(context.localUtil.CToN( cgiGet( "nRC_GXsfl_111"), ".", ","));
            AV29UC_OrderedBy = (short)(context.localUtil.CToN( cgiGet( "vUC_ORDEREDBY"), ".", ","));
            ...
            AV14Att_CentrodecostoId_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_centrodecostoid_visible_Internalname));
            AssignAttri("", false, "AV14Att_CentrodecostoId_Visible", AV14Att_CentrodecostoId_Visible);
            AV15Att_DepartamentoId_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_departamentoid_visible_Internalname));
            AssignAttri("", false, "AV15Att_DepartamentoId_Visible", AV15Att_DepartamentoId_Visible);
            AV16Att_DepartamentoNombre_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_departamentonombre_visible_Internalname));
            AssignAttri("", false, "AV16Att_DepartamentoNombre_Visible", AV16Att_DepartamentoNombre_Visible);
            ...
            AV26GridSettingsOrderedBy = (short)(NumberUtil.Val( cgiGet( cmbavGridsettingsorderedby_Internalname), "."));
            AssignAttri("", false, "AV26GridSettingsOrderedBy", StringUtil.LTrimStr( (decimal)(AV26GridSettingsOrderedBy), 4, 0));
      ...
      protected void E18612( )
      {
         ...
         new k2bloadrowsperpage(context ).execute(  AV44Pgmname,  "Grid", out  AV18RowsPerPageVariable, out  AV19RowsPerPageLoaded) ;
         ...
         AV28GridOrder.gxTpr_Ascendingorder = 1;
         AV28GridOrder.gxTpr_Descendingorder = 2;
      ...
      protected void E19612( )
      {
         ...
         /* Refresh Routine */
         returnInSub = false;
         GXt_objcol_SdtMessages_Message1 = AV30Messages;
         new k2btoolsmessagequeuegetallmessages(context ).execute( out  GXt_objcol_SdtMessages_Message1) ;
         AV30Messages = GXt_objcol_SdtMessages_Message1;
         AV45GXV1 = 1;
         while ( AV45GXV1 <= AV30Messages.Count )
         {
            AV31Message = ((GeneXus.Utils.SdtMessages_Message)AV30Messages.Item(AV45GXV1));
         ...
         AV38ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Depto";
         AV38ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Depto";
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV20GridStateKey = "";
         new k2bloadgridstate(context ).execute(  AV44Pgmname,  AV20GridStateKey, out  AV21GridState) ;
         AV25OrderedBy = AV21GridState.gxTpr_Orderedby;
         AssignAttri("", false, "AV25OrderedBy", StringUtil.LTrimStr( (decimal)(AV25OrderedBy), 4, 0));
         AV26GridSettingsOrderedBy = AV21GridState.gxTpr_Orderedby;
         AssignAttri("", false, "AV26GridSettingsOrderedBy", StringUtil.LTrimStr( (decimal)(AV26GridSettingsOrderedBy), 4, 0));
         AV29UC_OrderedBy = AV21GridState.gxTpr_Orderedby;
         AssignAttri("", false, "AV29UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV29UC_OrderedBy), 4, 0));
         AV46GXV2 = 1;
         while ( AV46GXV2 <= AV21GridState.gxTpr_Filtervalues.Count )
         {
            AV22GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV21GridState.gxTpr_Filtervalues.Item(AV46GXV2));
      ...
      protected void S122( )
      {
         ...
         new k2bsavegridstate(context ).execute(  AV44Pgmname,  AV20GridStateKey,  AV21GridState) ;
      }
      ...
      protected void S182( )
      {
         ...
         AV35TrnContext.gxTpr_Callerurl = AV7HTTPRequest.ScriptName+"?"+AV7HTTPRequest.QueryString;
         ...
         new k2bsettrncontextbyname(context ).execute(  "Depto",  AV35TrnContext) ;
      }
      ...
      protected void S192( )
      {
         ...
         returnInSub = false;
         edtCentrodecostoId_Visible = 1;
         AssignProp("", false, edtCentrodecostoId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtCentrodecostoId_Visible), 5, 0), !bGXsfl_111_Refreshing);
         AV14Att_CentrodecostoId_Visible = true;
         AssignAttri("", false, "AV14Att_CentrodecostoId_Visible", AV14Att_CentrodecostoId_Visible);
         edtDepartamentoId_Visible = 1;
         AssignProp("", false, edtDepartamentoId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtDepartamentoId_Visible), 5, 0), !bGXsfl_111_Refreshing);
         AV15Att_DepartamentoId_Visible = true;
         AssignAttri("", false, "AV15Att_DepartamentoId_Visible", AV15Att_DepartamentoId_Visible);
         edtDepartamentoNombre_Visible = 1;
         AssignProp("", false, edtDepartamentoNombre_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtDepartamentoNombre_Visible), 5, 0), !bGXsfl_111_Refreshing);
         AV16Att_DepartamentoNombre_Visible = true;
         AssignAttri("", false, "AV16Att_DepartamentoNombre_Visible", AV16Att_DepartamentoNombre_Visible);
         new k2bsavegridconfiguration(context ).execute(  AV44Pgmname,  "Grid",  AV10GridConfiguration,  false) ;
         AV47GXV3 = 1;
         while ( AV47GXV3 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            ...
            {
               if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "CentrodecostoId") == 0 )
               {
                  edtCentrodecostoId_Visible = 0;
                  AssignProp("", false, edtCentrodecostoId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtCentrodecostoId_Visible), 5, 0), !bGXsfl_111_Refreshing);
                  AV14Att_CentrodecostoId_Visible = false;
                  AssignAttri("", false, "AV14Att_CentrodecostoId_Visible", AV14Att_CentrodecostoId_Visible);
               }
               else if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "DepartamentoId") == 0 )
               {
                  edtDepartamentoId_Visible = 0;
                  AssignProp("", false, edtDepartamentoId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtDepartamentoId_Visible), 5, 0), !bGXsfl_111_Refreshing);
                  AV15Att_DepartamentoId_Visible = false;
                  AssignAttri("", false, "AV15Att_DepartamentoId_Visible", AV15Att_DepartamentoId_Visible);
               }
               else if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "DepartamentoNombre") == 0 )
               {
                  edtDepartamentoNombre_Visible = 0;
                  AssignProp("", false, edtDepartamentoNombre_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtDepartamentoNombre_Visible), 5, 0), !bGXsfl_111_Refreshing);
                  AV16Att_DepartamentoNombre_Visible = false;
                  AssignAttri("", false, "AV16Att_DepartamentoNombre_Visible", AV16Att_DepartamentoNombre_Visible);
               }
            }
      ...
      protected void S172( )
      {
         ...
         AV13GridColumn.gxTpr_Attributename = "CentrodecostoId";
         AV13GridColumn.gxTpr_Columntitle = "Centrodecosto Id";
         AV13GridColumn.gxTpr_Showattribute = true;
         AV12GridColumns.Add(AV13GridColumn, 0);
         AV13GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV13GridColumn.gxTpr_Attributename = "DepartamentoId";
         AV13GridColumn.gxTpr_Columntitle = "Departamento Id";
         AV13GridColumn.gxTpr_Showattribute = true;
         AV12GridColumns.Add(AV13GridColumn, 0);
         AV13GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV13GridColumn.gxTpr_Attributename = "DepartamentoNombre";
         AV13GridColumn.gxTpr_Columntitle = "Departamento Nombre";
         AV13GridColumn.gxTpr_Showattribute = true;
         AV12GridColumns.Add(AV13GridColumn, 0);
      ...
      protected void S202( )
      {
         ...
         AV38ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Depto";
         AV38ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Depto";
         AV38ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = "ReportWWDepto";
         AV37ActivityList.Add(AV38ActivityListItem, 0);
         AV38ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         AV38ActivityListItem.gxTpr_Activity.gxTpr_Standardactivitytype = "List";
         AV38ActivityListItem.gxTpr_Activity.gxTpr_Useractivitytype = "";
         AV38ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Depto";
         AV38ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Depto";
         AV38ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = "ExportWWDepto";
         AV37ActivityList.Add(AV38ActivityListItem, 0);
         new k2bisauthorizedactivitylist(context ).execute( ref  AV37ActivityList) ;
         if ( ((SdtK2BActivityList_K2BActivityListItem)AV37ActivityList.Item(1)).gxTpr_Isauthorized )
         {
      ...
      protected void S212( )
      {
         ...
         AV38ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Depto";
         AV38ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Depto";
         AV38ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = "EntityManagerDepto";
         AV37ActivityList.Add(AV38ActivityListItem, 0);
         new k2bisauthorizedactivitylist(context ).execute( ref  AV37ActivityList) ;
         AV32DepartamentoNombre_IsAuthorized = ((SdtK2BActivityList_K2BActivityListItem)AV37ActivityList.Item(1)).gxTpr_Isauthorized;
         AssignAttri("", false, "AV32DepartamentoNombre_IsAuthorized", AV32DepartamentoNombre_IsAuthorized);
      }
      ...
      protected void E20612( )
      {
         ...
         AV29UC_OrderedBy = AV25OrderedBy;
         AssignAttri("", false, "AV29UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV29UC_OrderedBy), 4, 0));
         /* Execute user subroutine: 'APPLYGRIDCONFIGURATION' */
         S152 ();
         if ( returnInSub )
      ...
      private void E21612( )
      {
         ...
         AssignProp("", false, tblNoresultsfoundtable_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(tblNoresultsfoundtable_Visible), 5, 0), true);
         if ( AV32DepartamentoNombre_IsAuthorized )
         {
      ...
      protected void E11612( )
      {
         ...
         returnInSub = false;
         AV25OrderedBy = AV29UC_OrderedBy;
         AssignAttri("", false, "AV25OrderedBy", StringUtil.LTrimStr( (decimal)(AV25OrderedBy), 4, 0));
         AV26GridSettingsOrderedBy = AV25OrderedBy;
         AssignAttri("", false, "AV26GridSettingsOrderedBy", StringUtil.LTrimStr( (decimal)(AV26GridSettingsOrderedBy), 4, 0));
         gxgrGrid_refresh( subGrid_Rows, AV24K2BToolsGenericSearchField, AV23ClassCollection, AV25OrderedBy, AV8CurrentPage, AV44Pgmname, AV10GridConfiguration, AV32DepartamentoNombre_IsAuthorized, AV14Att_CentrodecostoId_Visible, AV15Att_DepartamentoId_Visible, AV16Att_DepartamentoNombre_Visible, AV11FreezeColumnTitles, AV41Uri) ;
         /*  Sending Event outputs  */
         cmbavGridsettingsorderedby.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV26GridSettingsOrderedBy), 4, 0));
      ...
      protected void E12612( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  AV44Pgmname,  "Grid", ref  AV10GridConfiguration) ;
         AV48GXV4 = 1;
         while ( AV48GXV4 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            ...
            if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "CentrodecostoId") == 0 )
            {
               AV13GridColumn.gxTpr_Showattribute = AV14Att_CentrodecostoId_Visible;
            }
            else if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "DepartamentoId") == 0 )
            {
               AV13GridColumn.gxTpr_Showattribute = AV15Att_DepartamentoId_Visible;
            }
            else if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "DepartamentoNombre") == 0 )
            {
               AV13GridColumn.gxTpr_Showattribute = AV16Att_DepartamentoNombre_Visible;
            }
            AV48GXV4 = (int)(AV48GXV4+1);
         }
         AV10GridConfiguration.gxTpr_Freezecolumntitles = AV11FreezeColumnTitles;
         new k2bsavegridconfiguration(context ).execute(  AV44Pgmname,  "Grid",  AV10GridConfiguration,  true) ;
         AV25OrderedBy = AV26GridSettingsOrderedBy;
         AssignAttri("", false, "AV25OrderedBy", StringUtil.LTrimStr( (decimal)(AV25OrderedBy), 4, 0));
         AV29UC_OrderedBy = AV25OrderedBy;
         AssignAttri("", false, "AV29UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV29UC_OrderedBy), 4, 0));
         if ( AV18RowsPerPageVariable != AV17GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV18RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV44Pgmname,  "Grid",  AV18RowsPerPageVariable) ;
            AV8CurrentPage = 1;
            AssignAttri("", false, "AV8CurrentPage", StringUtil.LTrimStr( (decimal)(AV8CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void E17612( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "Depto",  "Depto",  "List",  "",  "ExportWWDepto") )
         {
            new exportwwdepto(context ).execute(  AV24K2BToolsGenericSearchField,  AV25OrderedBy, out  AV39OutFile) ;
            if ( new k2bt_isinexternalstorage(context).executeUdp(  AV39OutFile, out  AV41Uri) )
            {
               CallWebObject(formatLink(AV41Uri) );
               context.wjLocDisableFrm = 0;
            }
            else
            {
               AV40Guid = (Guid)(Guid.NewGuid( ));
               new k2bsessionset(context ).execute(  AV40Guid.ToString(),  AV39OutFile) ;
               CallWebObject(formatLink("k2bt_returnfileinhttpresponse.aspx", new object[] {UrlEncode(AV40Guid.ToString())}, new string[] {"Guid"}) );
               context.wjLocDisableFrm = 2;
            }
         }
      }

      protected void wb_table2_117_612( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoresultsfoundtextblock_Internalname, "No hay resultados", "", "", lblNoresultsfoundtextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_WWDepto.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_117_612e( true) ;
         }
         else
         {
            wb_table2_117_612e( false) ;
         }
      }

      protected void wb_table1_24_612( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRuntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblRuntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_WWDepto.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divCentrodecostoid_gridsettingscontainer_Internalname, 1, 0, "px", 0, "px", "K2BT_GridSettingsAttributeContainer", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group gx-default-form-group", "left", "top", ""+" data-gx-for=\""+chkavAtt_centrodecostoid_visible_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavAtt_centrodecostoid_visible_Internalname, "Centrodecosto Id", "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_centrodecostoid_visible_Internalname, StringUtil.BoolToStr( AV14Att_CentrodecostoId_Visible), "", "Centrodecosto Id", 1, chkavAtt_centrodecostoid_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(53, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,53);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divDepartamentoid_gridsettingscontainer_Internalname, 1, 0, "px", 0, "px", "K2BT_GridSettingsAttributeContainer", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group gx-default-form-group", "left", "top", ""+" data-gx-for=\""+chkavAtt_departamentoid_visible_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavAtt_departamentoid_visible_Internalname, "Departamento Id", "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_departamentoid_visible_Internalname, StringUtil.BoolToStr( AV15Att_DepartamentoId_Visible), "", "Departamento Id", 1, chkavAtt_departamentoid_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(59, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,59);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_departamentonombre_visible_Internalname, StringUtil.BoolToStr( AV16Att_DepartamentoNombre_Visible), "", "Departamento Nombre", 1, chkavAtt_departamentonombre_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(65, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,65);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavGridsettingsorderedby, cmbavGridsettingsorderedby_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV26GridSettingsOrderedBy), 4, 0)), 1, cmbavGridsettingsorderedby_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavGridsettingsorderedby.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,71);\"", "", true, 1, "HLP_WWDepto.htm");
            cmbavGridsettingsorderedby.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV26GridSettingsOrderedBy), 4, 0));
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 77,'',false,'" + sGXsfl_111_idx + "',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavGridsettingsrowsperpagevariable, cmbavGridsettingsrowsperpagevariable_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV17GridSettingsRowsPerPageVariable), 4, 0)), 1, cmbavGridsettingsrowsperpagevariable_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavGridsettingsrowsperpagevariable.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,77);\"", "", true, 1, "HLP_WWDepto.htm");
            cmbavGridsettingsrowsperpagevariable.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV17GridSettingsRowsPerPageVariable), 4, 0));
            ...
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 83,'',false,'" + sGXsfl_111_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttK2bgridsettingssave_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(111), 3, 0)+","+"null"+");", "Aplicar", bttK2bgridsettingssave_Jsonclick, 5, "Aplicar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'SAVEGRIDSETTINGS\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWDepto.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgImage1_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgImage1_Jsonclick, "'"+""+"'"+",false,"+"'"+"e23611_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_WWDepto.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table3_97_612( true) ;
         }
         else
         {
            wb_table3_97_612( false) ;
         }
         return  ;
      }

      protected void wb_table3_97_612e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_24_612e( true) ;
         }
         else
         {
            wb_table1_24_612e( false) ;
         }
      }

      protected void wb_table3_97_612( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttReport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(111), 3, 0)+","+"null"+");", "Reporte", bttReport_Jsonclick, 7, bttReport_Tooltiptext, "", StyleString, ClassString, bttReport_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"e24611_client"+"'", TempTags, "", 2, "HLP_WWDepto.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='K2BToolsTableCell_ActionContainer'>") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 102,'',false,'',0)\"";
            ClassString = "Button_Standard";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttExport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(111), 3, 0)+","+"null"+");", "Exportar", bttExport_Jsonclick, 5, bttExport_Tooltiptext, "", StyleString, ClassString, bttExport_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOEXPORT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWDepto.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_97_612e( true) ;
         }
         else
         {
            wb_table3_97_612e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188213673", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwdepto.js", "?2024188213673", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      {
         edtCentrodecostoId_Internalname = "CENTRODECOSTOID_"+sGXsfl_111_idx;
         edtDepartamentoId_Internalname = "DEPARTAMENTOID_"+sGXsfl_111_idx;
         edtDepartamentoNombre_Internalname = "DEPARTAMENTONOMBRE_"+sGXsfl_111_idx;
      }

      protected void SubsflControlProps_fel_1112( )
      {
         edtCentrodecostoId_Internalname = "CENTRODECOSTOID_"+sGXsfl_111_fel_idx;
         edtDepartamentoId_Internalname = "DEPARTAMENTOID_"+sGXsfl_111_fel_idx;
         edtDepartamentoNombre_Internalname = "DEPARTAMENTONOMBRE_"+sGXsfl_111_fel_idx;
      }
      ...
      protected void sendrow_1112( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_111_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+((edtCentrodecostoId_Visible==0) ? "display:none;" : "")+"\">") ;
            }
            /* Single line edit */
            ROClassString = "Attribute_Grid";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCentrodecostoId_Internalname,(string)A259CentrodecostoId,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCentrodecostoId_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn InvisibleInExtraSmallColumn",(string)"",(int)edtCentrodecostoId_Visible,(short)0,(short)0,(string)"text",(string)"",(short)97,(string)"px",(short)17,(string)"px",(short)5,(short)0,(short)0,(short)111,(short)1,(short)-1,(short)-1,(bool)true,(string)"",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+((edtDepartamentoId_Visible==0) ? "display:none;" : "")+"\">") ;
            }
            /* Single line edit */
            ROClassString = "Attribute_Grid";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtDepartamentoId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A260DepartamentoId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A260DepartamentoId), "ZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtDepartamentoId_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn InvisibleInExtraSmallColumn",(string)"",(int)edtDepartamentoId_Visible,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)111,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      {
         chkavAtt_centrodecostoid_visible.Name = "vATT_CENTRODECOSTOID_VISIBLE";
         chkavAtt_centrodecostoid_visible.WebTags = "";
         chkavAtt_centrodecostoid_visible.Caption = "";
         AssignProp("", false, chkavAtt_centrodecostoid_visible_Internalname, "TitleCaption", chkavAtt_centrodecostoid_visible.Caption, true);
         chkavAtt_centrodecostoid_visible.CheckedValue = "false";
         AV14Att_CentrodecostoId_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV14Att_CentrodecostoId_Visible));
         AssignAttri("", false, "AV14Att_CentrodecostoId_Visible", AV14Att_CentrodecostoId_Visible);
         chkavAtt_departamentoid_visible.Name = "vATT_DEPARTAMENTOID_VISIBLE";
         chkavAtt_departamentoid_visible.WebTags = "";
         chkavAtt_departamentoid_visible.Caption = "";
         AssignProp("", false, chkavAtt_departamentoid_visible_Internalname, "TitleCaption", chkavAtt_departamentoid_visible.Caption, true);
         chkavAtt_departamentoid_visible.CheckedValue = "false";
         AV15Att_DepartamentoId_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV15Att_DepartamentoId_Visible));
         AssignAttri("", false, "AV15Att_DepartamentoId_Visible", AV15Att_DepartamentoId_Visible);
         ...
         AssignProp("", false, chkavAtt_departamentonombre_visible_Internalname, "TitleCaption", chkavAtt_departamentonombre_visible.Caption, true);
      ...
      protected void init_default_properties( )
      {
         ...
         chkavAtt_centrodecostoid_visible_Internalname = "vATT_CENTRODECOSTOID_VISIBLE";
         divCentrodecostoid_gridsettingscontainer_Internalname = "CENTRODECOSTOID_GRIDSETTINGSCONTAINER";
         chkavAtt_departamentoid_visible_Internalname = "vATT_DEPARTAMENTOID_VISIBLE";
         divDepartamentoid_gridsettingscontainer_Internalname = "DEPARTAMENTOID_GRIDSETTINGSCONTAINER";
         chkavAtt_departamentonombre_visible_Internalname = "vATT_DEPARTAMENTONOMBRE_VISIBLE";
         divDepartamentonombre_gridsettingscontainer_Internalname = "DEPARTAMENTONOMBRE_GRIDSETTINGSCONTAINER";
      ...
      public override void initialize_properties( )
      {
         ...
         chkavAtt_departamentoid_visible.Caption = "Departamento Id";
         chkavAtt_centrodecostoid_visible.Caption = "Centrodecosto Id";
         ...
         chkavAtt_departamentoid_visible.Enabled = 1;
         chkavAtt_centrodecostoid_visible.Enabled = 1;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV32DepartamentoNombre_IsAuthorized',fld:'vDEPARTAMENTONOMBRE_ISAUTHORIZED',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV44Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV41Uri',fld:'vURI',pic:'',hsh:true},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[{ctrl:'REPORT',prop:'Tooltiptext'},{ctrl:'EXPORT',prop:'Tooltiptext'},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'divDownloadsactionssectioncontainer_Visible',ctrl:'DOWNLOADSACTIONSSECTIONCONTAINER',prop:'Visible'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV32DepartamentoNombre_IsAuthorized',fld:'vDEPARTAMENTONOMBRE_ISAUTHORIZED',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'edtCentrodecostoId_Visible',ctrl:'CENTRODECOSTOID',prop:'Visible'},{av:'edtDepartamentoId_Visible',ctrl:'DEPARTAMENTOID',prop:'Visible'},{av:'edtDepartamentoNombre_Visible',ctrl:'DEPARTAMENTONOMBRE',prop:'Visible'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("'DOREPORT'","{handler:'E24611',iparms:[{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOREPORT'",",oparms:[{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("GRID.REFRESH","{handler:'E20612',iparms:[{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV44Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV32DepartamentoNombre_IsAuthorized',fld:'vDEPARTAMENTONOMBRE_ISAUTHORIZED',pic:''},{av:'AV41Uri',fld:'vURI',pic:'',hsh:true},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("GRID.REFRESH",",oparms:[{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{ctrl:'REPORT',prop:'Tooltiptext'},{ctrl:'EXPORT',prop:'Tooltiptext'},{av:'tblNoresultsfoundtable_Visible',ctrl:'NORESULTSFOUNDTABLE',prop:'Visible'},{av:'AV29UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'divDownloadsactionssectioncontainer_Visible',ctrl:'DOWNLOADSACTIONSSECTIONCONTAINER',prop:'Visible'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'lblFirstpagetextblock_Caption',ctrl:'FIRSTPAGETEXTBLOCK',prop:'Caption'},{av:'lblPreviouspagetextblock_Caption',ctrl:'PREVIOUSPAGETEXTBLOCK',prop:'Caption'},{av:'lblCurrentpagetextblock_Caption',ctrl:'CURRENTPAGETEXTBLOCK',prop:'Caption'},{av:'lblNextpagetextblock_Caption',ctrl:'NEXTPAGETEXTBLOCK',prop:'Caption'},{av:'lblLastpagetextblock_Caption',ctrl:'LASTPAGETEXTBLOCK',prop:'Caption'},{av:'lblPreviouspagebuttontextblock_Class',ctrl:'PREVIOUSPAGEBUTTONTEXTBLOCK',prop:'Class'},{av:'lblNextpagebuttontextblock_Class',ctrl:'NEXTPAGEBUTTONTEXTBLOCK',prop:'Class'},{av:'lblFirstpagetextblock_Visible',ctrl:'FIRSTPAGETEXTBLOCK',prop:'Visible'},{av:'lblSpacinglefttextblock_Visible',ctrl:'SPACINGLEFTTEXTBLOCK',prop:'Visible'},{av:'lblPreviouspagetextblock_Visible',ctrl:'PREVIOUSPAGETEXTBLOCK',prop:'Visible'},{av:'lblLastpagetextblock_Visible',ctrl:'LASTPAGETEXTBLOCK',prop:'Visible'},{av:'lblSpacingrighttextblock_Visible',ctrl:'SPACINGRIGHTTEXTBLOCK',prop:'Visible'},{av:'lblNextpagetextblock_Visible',ctrl:'NEXTPAGETEXTBLOCK',prop:'Visible'},{av:'divK2btoolspagingcontainertable_Visible',ctrl:'K2BTOOLSPAGINGCONTAINERTABLE',prop:'Visible'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV32DepartamentoNombre_IsAuthorized',fld:'vDEPARTAMENTONOMBRE_ISAUTHORIZED',pic:''},{av:'edtCentrodecostoId_Visible',ctrl:'CENTRODECOSTOID',prop:'Visible'},{av:'edtDepartamentoId_Visible',ctrl:'DEPARTAMENTOID',prop:'Visible'},{av:'edtDepartamentoNombre_Visible',ctrl:'DEPARTAMENTONOMBRE',prop:'Visible'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("GRID.LOAD","{handler:'E21612',iparms:[{av:'AV32DepartamentoNombre_IsAuthorized',fld:'vDEPARTAMENTONOMBRE_ISAUTHORIZED',pic:''},{av:'A259CentrodecostoId',fld:'CENTRODECOSTOID',pic:''},{av:'A260DepartamentoId',fld:'DEPARTAMENTOID',pic:'ZZZ9'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'tblNoresultsfoundtable_Visible',ctrl:'NORESULTSFOUNDTABLE',prop:'Visible'},{av:'edtDepartamentoNombre_Link',ctrl:'DEPARTAMENTONOMBRE',prop:'Link'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E11612',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV44Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV32DepartamentoNombre_IsAuthorized',fld:'vDEPARTAMENTONOMBRE_ISAUTHORIZED',pic:''},{av:'AV41Uri',fld:'vURI',pic:'',hsh:true},{av:'AV29UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED",",oparms:[{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'cmbavGridsettingsorderedby'},{av:'AV26GridSettingsOrderedBy',fld:'vGRIDSETTINGSORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Tooltiptext'},{ctrl:'EXPORT',prop:'Tooltiptext'},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'divDownloadsactionssectioncontainer_Visible',ctrl:'DOWNLOADSACTIONSSECTIONCONTAINER',prop:'Visible'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV32DepartamentoNombre_IsAuthorized',fld:'vDEPARTAMENTONOMBRE_ISAUTHORIZED',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'edtCentrodecostoId_Visible',ctrl:'CENTRODECOSTOID',prop:'Visible'},{av:'edtDepartamentoId_Visible',ctrl:'DEPARTAMENTOID',prop:'Visible'},{av:'edtDepartamentoNombre_Visible',ctrl:'DEPARTAMENTONOMBRE',prop:'Visible'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("'TOGGLEGRIDSETTINGSTABLE'","{handler:'E22611',iparms:[{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'TOGGLEGRIDSETTINGSTABLE'",",oparms:[{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E12612',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV44Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV32DepartamentoNombre_IsAuthorized',fld:'vDEPARTAMENTONOMBRE_ISAUTHORIZED',pic:''},{av:'AV41Uri',fld:'vURI',pic:'',hsh:true},{av:'cmbavGridsettingsorderedby'},{av:'AV26GridSettingsOrderedBy',fld:'vGRIDSETTINGSORDEREDBY',pic:'ZZZ9'},{av:'AV18RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV17GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'SAVEGRIDSETTINGS'",",oparms:[{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV29UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{av:'AV18RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{ctrl:'REPORT',prop:'Tooltiptext'},{ctrl:'EXPORT',prop:'Tooltiptext'},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'divDownloadsactionssectioncontainer_Visible',ctrl:'DOWNLOADSACTIONSSECTIONCONTAINER',prop:'Visible'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV32DepartamentoNombre_IsAuthorized',fld:'vDEPARTAMENTONOMBRE_ISAUTHORIZED',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'edtCentrodecostoId_Visible',ctrl:'CENTRODECOSTOID',prop:'Visible'},{av:'edtDepartamentoId_Visible',ctrl:'DEPARTAMENTOID',prop:'Visible'},{av:'edtDepartamentoNombre_Visible',ctrl:'DEPARTAMENTONOMBRE',prop:'Visible'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("'DOFIRST'","{handler:'E13612',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV44Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV32DepartamentoNombre_IsAuthorized',fld:'vDEPARTAMENTONOMBRE_ISAUTHORIZED',pic:''},{av:'AV41Uri',fld:'vURI',pic:'',hsh:true},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E15612',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV44Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV32DepartamentoNombre_IsAuthorized',fld:'vDEPARTAMENTONOMBRE_ISAUTHORIZED',pic:''},{av:'AV41Uri',fld:'vURI',pic:'',hsh:true},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E16612',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV44Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV32DepartamentoNombre_IsAuthorized',fld:'vDEPARTAMENTONOMBRE_ISAUTHORIZED',pic:''},{av:'AV41Uri',fld:'vURI',pic:'',hsh:true},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOEXPORT'","{handler:'E17612',iparms:[{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV41Uri',fld:'vURI',pic:'',hsh:true},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOEXPORT'",",oparms:[{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("'TOGGLEDOWNLOADACTIONS'","{handler:'E23611',iparms:[{av:'divDownloadactionstable_Visible',ctrl:'DOWNLOADACTIONSTABLE',prop:'Visible'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'TOGGLEDOWNLOADACTIONS'",",oparms:[{av:'divDownloadactionstable_Visible',ctrl:'DOWNLOADACTIONSTABLE',prop:'Visible'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("NULL","{handler:'Valid_Departamentonombre',iparms:[{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("NULL",",oparms:[{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         H00612_A261DepartamentoNombre = new string[] {""} ;
         H00612_A260DepartamentoId = new short[1] ;
         H00612_A259CentrodecostoId = new string[] {""} ;
         H00613_AGRID_nRecordCount = new long[1] ;
         AV5Context = new SdtK2BContext(context);
         AV28GridOrder = new SdtK2BGridOrders_K2BGridOrdersItem(context);
         AV30Messages = new GXBaseCollection<GeneXus.Utils.SdtMessages_Message>( context, "Message", "GeneXus");
         ...
         ROClassString = "";
         pr_datastore2 = new DataStoreProvider(context, new GeneXus.Programs.wwdepto__datastore2(),
            new Object[][] {
                new Object[] {
               H00612_A261DepartamentoNombre, H00612_A260DepartamentoId, H00612_A259CentrodecostoId
               }
               , new Object[] {
      ...
      private short AV26GridSettingsOrderedBy ;
      ...
      private int edtCentrodecostoId_Visible ;
      private int edtDepartamentoId_Visible ;
      ...
      private string chkavAtt_centrodecostoid_visible_Internalname ;
      private string chkavAtt_departamentoid_visible_Internalname ;
      ...
      private string divCentrodecostoid_gridsettingscontainer_Internalname ;
      private string divDepartamentoid_gridsettingscontainer_Internalname ;
      ...
      private bool AV32DepartamentoNombre_IsAuthorized ;
      private bool AV14Att_CentrodecostoId_Visible ;
      private bool AV15Att_DepartamentoId_Visible ;
      private bool AV16Att_DepartamentoNombre_Visible ;
      ...
      private GXCheckbox chkavAtt_centrodecostoid_visible ;
      private GXCheckbox chkavAtt_departamentoid_visible ;
      ...
      private string[] H00612_A261DepartamentoNombre ;
      private short[] H00612_A260DepartamentoId ;
      private string[] H00612_A259CentrodecostoId ;
      ...
      private GXBaseCollection<GeneXus.Utils.SdtMessages_Message> AV30Messages ;
   ...
   public class wwdepto__datastore2 : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV25OrderedBy )
      {
         ...
         {
            AddWhere(sWhereString, "([CentrodecostoId] like '%' + @lV24K2BToolsGenericSearchField + '%' or CONVERT( char(4), CAST([DepartamentoId] AS decimal(4,0))) like '%' + @lV24K2BToolsGenericSearchField + '%' or [DepartamentoNombre] like '%' + @lV24K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int3[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00612(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (short)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] );
               case 1 :
                     return conditional_H00613(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (short)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] );
         }
