...
namespace GeneXus.Programs.k2bfsg {
   public class faststartgammenuloader : GXProcedure
   {
      ...
      public void executeSubmit( out GXBaseCollection<SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem> aP0_MenuLevel0 )
      {
         ...
         objfaststartgammenuloader.AV10MenuLevel0 = new GXBaseCollection<SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem>( context, "K2BMultiLevelMenuItem", "kb_ticket") ;
         objfaststartgammenuloader.context.SetSubmitInitialConfig(context);
         objfaststartgammenuloader.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objfaststartgammenuloader);
         aP0_MenuLevel0=this.AV10MenuLevel0;
      }
      ...
      void executePrivate( )
      {
         ...
         GXt_boolean2 = true;
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.WWUser",  "Usuarios",  "",  "fa fa-user",  formatLink("k2bfsg.wwuser.aspx") ,  2,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean2, ref  AV10MenuLevel0) ;
         GXt_boolean3 = true;
         ...
         GXt_boolean4 = true;
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.WWMenu",  "Menús",  "",  "fa fa-bars",  formatLink("k2bfsg.wwmenu.aspx") ,  4,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean4, ref  AV10MenuLevel0) ;
         GXt_boolean5 = true;
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.WWApplication",  "Aplicaciones",  "",  "fa fa-archive",  formatLink("k2bfsg.wwapplication.aspx") ,  5,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean5, ref  AV10MenuLevel0) ;
      ...
      protected void S111( )
      {
         ...
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.RepositoryConfiguration",  "Configuración de repositorio",  "",  "fa fa-cog",  formatLink("k2bfsg.repositoryconfiguration.aspx", new object[] {GXUtil.UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"pId"}) ,  6,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean5, ref  GXt_objcol_SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem6) ;
         ...
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.WWAuthType",  "Tipos de autenticación",  "",  "fa fa-key",  formatLink("k2bfsg.wwauthtype.aspx") ,  7,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean4, ref  GXt_objcol_SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem7) ;
         ...
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.WWConnections",  "Conexiones a repositorio",  "",  "fa fa-plug",  formatLink("k2bfsg.wwconnections.aspx") ,  8,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean3, ref  GXt_objcol_SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem8) ;
         ...
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.WWSecurityPolicy",  "Políticas de seguridad",  "",  "fa fa-file-text-o",  formatLink("k2bfsg.wwsecuritypolicy.aspx") ,  9,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean2, ref  GXt_objcol_SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem9) ;
         ...
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.WWRepositories",  "Repositorios",  "",  "",  formatLink("k2bfsg.wwrepositories.aspx") ,  11,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean11, ref  GXt_objcol_SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem12) ;
         ...
         new k2bmenuaddprogram(context ).execute(  "K2BFSG.WWEventSubscription",  "Subscripciones a eventos",  "",  "",  formatLink("k2bfsg.wweventsubscription.aspx") ,  12,  AV8ActivityList,  true,  true,  true, ref  GXt_boolean13, ref  GXt_objcol_SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem14) ;
      ...
      public override void initialize( )
      {
         ...
         AV12MenuLevel1 = new SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem(context);
         GXt_objcol_SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem6 = new GXBaseCollection<SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem>( context, "K2BMultiLevelMenuItem", "kb_ticket");
         GXt_objcol_SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem7 = new GXBaseCollection<SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem>( context, "K2BMultiLevelMenuItem", "kb_ticket");
