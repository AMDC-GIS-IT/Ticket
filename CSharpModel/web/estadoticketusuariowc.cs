...
namespace GeneXus.Programs {
   public class estadoticketusuariowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public estadoticketusuariowc( )
      {
      ...
      public estadoticketusuariowc( IGxContext context )
      {
      ...
      {
         this.AV6EstadoTicketId = aP0_EstadoTicketId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6EstadoTicketId = (short)(NumberUtil.Val( GetPar( "EstadoTicketId"), "."));
                  AssignAttri(sPrefix, false, "AV6EstadoTicketId", StringUtil.LTrimStr( (decimal)(AV6EstadoTicketId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV6EstadoTicketId});
                  componentstart();
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  AV33UsuarioFecha_From = context.localUtil.ParseDateParm( GetPar( "UsuarioFecha_From"));
                  AV36UsuarioHora_From = DateTimeUtil.ResetDate(context.localUtil.ParseDTimeParm( GetPar( "UsuarioHora_From")));
                  AV37UsuarioHora_To = DateTimeUtil.ResetDate(context.localUtil.ParseDTimeParm( GetPar( "UsuarioHora_To")));
                  ...
                  AV34UsuarioFecha_To = context.localUtil.ParseDateParm( GetPar( "UsuarioFecha_To"));
                  ...
                  AV53UsuarioNombre_IsAuthorized = StringUtil.StrToBool( GetPar( "UsuarioNombre_IsAuthorized"));
                  AV15Att_UsuarioId_Visible = StringUtil.StrToBool( GetPar( "Att_UsuarioId_Visible"));
                  AV16Att_UsuarioNombre_Visible = StringUtil.StrToBool( GetPar( "Att_UsuarioNombre_Visible"));
                  AV17Att_UsuarioFecha_Visible = StringUtil.StrToBool( GetPar( "Att_UsuarioFecha_Visible"));
                  AV18Att_UsuarioHora_Visible = StringUtil.StrToBool( GetPar( "Att_UsuarioHora_Visible"));
                  AV19Att_UsuarioGerencia_Visible = StringUtil.StrToBool( GetPar( "Att_UsuarioGerencia_Visible"));
                  AV20Att_UsuarioDepartamento_Visible = StringUtil.StrToBool( GetPar( "Att_UsuarioDepartamento_Visible"));
                  AV21Att_UsuarioRequerimiento_Visible = StringUtil.StrToBool( GetPar( "Att_UsuarioRequerimiento_Visible"));
                  AV22Att_UsuarioEmail_Visible = StringUtil.StrToBool( GetPar( "Att_UsuarioEmail_Visible"));
                  AV23Att_UsuarioTelefono_Visible = StringUtil.StrToBool( GetPar( "Att_UsuarioTelefono_Visible"));
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV42K2BToolsGenericSearchField, AV31UsuarioNombre, AV33UsuarioFecha_From, AV36UsuarioHora_From, AV37UsuarioHora_To, A5EstadoTicketId, AV6EstadoTicketId, AV30ClassCollection, AV43OrderedBy, AV34UsuarioFecha_To, AV61Pgmname, AV9CurrentPage, AV11GridConfiguration, AV53UsuarioNombre_IsAuthorized, AV15Att_UsuarioId_Visible, AV16Att_UsuarioNombre_Visible, AV17Att_UsuarioFecha_Visible, AV18Att_UsuarioHora_Visible, AV19Att_UsuarioGerencia_Visible, AV20Att_UsuarioDepartamento_Visible, AV21Att_UsuarioRequerimiento_Visible, AV22Att_UsuarioEmail_Visible, AV23Att_UsuarioTelefono_Visible, AV12FreezeColumnTitles, AV58Uri, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV61Pgmname = "EstadoTicketUsuarioWC";
               context.Gx_err = 0;
               WS2G2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188113914", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("estadoticketusuariowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6EstadoTicketId,4,0))}, new string[] {"EstadoTicketId"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vURI", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV58Uri, "")), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"GXH_vK2BTOOLSGENERICSEARCHFIELD", StringUtil.RTrim( AV42K2BToolsGenericSearchField));
         GxWebStd.gx_hidden_field( context, sPrefix+"GXH_vUSUARIONOMBRE", AV31UsuarioNombre);
         GxWebStd.gx_hidden_field( context, sPrefix+"GXH_vUSUARIOFECHA_FROM", context.localUtil.Format(AV33UsuarioFecha_From, "99/99/9999"));
         GxWebStd.gx_hidden_field( context, sPrefix+"GXH_vUSUARIOHORA_FROM", context.localUtil.TToC( AV36UsuarioHora_From, 10, 8, 0, 3, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, sPrefix+"GXH_vUSUARIOHORA_TO", context.localUtil.TToC( AV37UsuarioHora_To, 10, 8, 0, 3, "/", ":", " "));
         /* Send saved values. */
         send_integrity_footer_hashes( ) ;
         GxWebStd.gx_hidden_field( context, sPrefix+"nRC_GXsfl_180", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_180), 8, 0, ".", "")));
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vFILTERTAGS", AV40FilterTags);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vFILTERTAGS", AV40FilterTags);
         }
         GxWebStd.gx_hidden_field( context, sPrefix+"vDELETEDTAG", StringUtil.RTrim( AV41DeletedTag));
         GxWebStd.gx_hidden_field( context, sPrefix+"vUSUARIOFECHA_TO", context.localUtil.DToC( AV34UsuarioFecha_To, 0, "/"));
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vGRIDORDERS", AV44GridOrders);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vGRIDORDERS", AV44GridOrders);
         }
         GxWebStd.gx_hidden_field( context, sPrefix+"vUC_ORDEREDBY", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV46UC_OrderedBy), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6EstadoTicketId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6EstadoTicketId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV61Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV61Pgmname, "")), context));
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vCLASSCOLLECTION", AV30ClassCollection);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vCLASSCOLLECTION", AV30ClassCollection);
         }
         GxWebStd.gx_hidden_field( context, sPrefix+"vESTADOTICKETID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6EstadoTicketId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vCURRENTPAGE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9CurrentPage), 5, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vORDEREDBY", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV43OrderedBy), 4, 0, ".", "")));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vUSUARIONOMBRE_ISAUTHORIZED", AV53UsuarioNombre_IsAuthorized);
         GxWebStd.gx_hidden_field( context, sPrefix+"vROWSPERPAGEVARIABLE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV25RowsPerPageVariable), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vURI", AV58Uri);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vURI", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV58Uri, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"ESTADOTICKETID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A5EstadoTicketId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"GRID_nFirstRecordOnPage", StringUtil.LTrim( StringUtil.NToC( (decimal)(GRID_nFirstRecordOnPage), 15, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"GRID_nEOF", StringUtil.LTrim( StringUtil.NToC( (decimal)(GRID_nEOF), 1, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vUSUARIOFECHA_FROM", context.localUtil.DToC( AV33UsuarioFecha_From, 0, "/"));
      ...
      protected void WB2G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "estadoticketusuariowc.aspx");
               context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
               context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
               context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
               context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 25,'" + sPrefix + "',false,'" + sGXsfl_180_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavK2btoolsgenericsearchfield_Internalname, StringUtil.RTrim( AV42K2BToolsGenericSearchField), StringUtil.RTrim( context.localUtil.Format( AV42K2BToolsGenericSearchField, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,25);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "Buscar...", edtavK2btoolsgenericsearchfield_Jsonclick, 0, "K2BTools_SearchCriteria", "", "", "", "", 1, edtavK2btoolsgenericsearchfield_Enabled, 0, "text", "", 40, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_EstadoTicketUsuarioWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 41,'" + sPrefix + "',false,'" + sGXsfl_180_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavUsuarionombre_Internalname, AV31UsuarioNombre, StringUtil.RTrim( context.localUtil.Format( AV31UsuarioNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,41);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsuarionombre_Jsonclick, 0, "Attribute_Filter", "", "", "", "", 1, edtavUsuarionombre_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_EstadoTicketUsuarioWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockusuariofecha_Internalname, "Fecha Inicio:", "", "", lblTextblockusuariofecha_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label K2BT_LabelTop", 0, "", 1, 1, 0, 0, "HLP_EstadoTicketUsuarioWC.htm");
            /* User Defined Control */
            ucUsuariofecha_daterangepicker.SetProperty("ValueFrom", AV33UsuarioFecha_From);
            ucUsuariofecha_daterangepicker.SetProperty("ValueTo", AV34UsuarioFecha_To);
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockusuariohora_Internalname, "Hora Inicio:", "", "", lblTextblockusuariohora_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label K2BT_LabelTop", 0, "", 1, 1, 0, 0, "HLP_EstadoTicketUsuarioWC.htm");
            /* Div Control */
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 53,'" + sPrefix + "',false,'" + sGXsfl_180_idx + "',0)\"";
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsuariohora_from_Internalname, context.localUtil.TToC( AV36UsuarioHora_From, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( AV36UsuarioHora_From, "99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 0,'DMY',5,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 0,'DMY',5,24,'spa',false,0);"+";gx.evt.onblur(this,53);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsuariohora_from_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavUsuariohora_from_Enabled, 0, "text", "", 5, "chr", 1, "row", 5, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_EstadoTicketUsuarioWC.htm");
            GxWebStd.gx_bitmap( context, edtavUsuariohora_from_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavUsuariohora_from_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_EstadoTicketUsuarioWC.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDaterangeseparator_usuariohora_Internalname, "-", "", "", lblDaterangeseparator_usuariohora_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "SideLabel", 0, "", 1, 1, 0, 0, "HLP_EstadoTicketUsuarioWC.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavUsuariohora_to_Internalname, "Hasta", "gx-form-item AttributeLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 56,'" + sPrefix + "',false,'" + sGXsfl_180_idx + "',0)\"";
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsuariohora_to_Internalname, context.localUtil.TToC( AV37UsuarioHora_To, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( AV37UsuarioHora_To, "99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 0,'DMY',5,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 0,'DMY',5,24,'spa',false,0);"+";gx.evt.onblur(this,56);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsuariohora_to_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavUsuariohora_to_Enabled, 0, "text", "", 5, "chr", 1, "row", 5, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_EstadoTicketUsuarioWC.htm");
            GxWebStd.gx_bitmap( context, edtavUsuariohora_to_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavUsuariohora_to_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_EstadoTicketUsuarioWC.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;", "div");
            wb_table1_58_2G2( true) ;
         }
         else
         {
            wb_table1_58_2G2( false) ;
         }
         return  ;
      }

      protected void wb_table1_58_2G2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            {
               context.WriteHtmlText( "<div id=\""+sPrefix+"GridContainer"+"DivS\" data-gxgridid=\"180\">") ;
               sStyleString = "";
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", context.convertURL( AV54Update));
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", context.convertURL( AV55Delete));
         ...
         if ( wbEnd == 180 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_194_2G2( true) ;
         }
         else
         {
            wb_table2_194_2G2( false) ;
         }
         return  ;
      }

      protected void wb_table2_194_2G2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagebuttontextblock_Internalname, "", "", "", lblPreviouspagebuttontextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOPREVIOUS\\'."+"'", "", lblPreviouspagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_EstadoTicketUsuarioWC.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFirstpagetextblock_Internalname, lblFirstpagetextblock_Caption, "", "", lblFirstpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOFIRST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblFirstpagetextblock_Visible, 1, 0, 0, "HLP_EstadoTicketUsuarioWC.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacinglefttextblock_Internalname, "...", "", "", lblSpacinglefttextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacinglefttextblock_Visible, 1, 0, 0, "HLP_EstadoTicketUsuarioWC.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagetextblock_Internalname, lblPreviouspagetextblock_Caption, "", "", lblPreviouspagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOPREVIOUS\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPreviouspagetextblock_Visible, 1, 0, 0, "HLP_EstadoTicketUsuarioWC.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCurrentpagetextblock_Internalname, lblCurrentpagetextblock_Caption, "", "", lblCurrentpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_EstadoTicketUsuarioWC.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagetextblock_Internalname, lblNextpagetextblock_Caption, "", "", lblNextpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DONEXT\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblNextpagetextblock_Visible, 1, 0, 0, "HLP_EstadoTicketUsuarioWC.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacingrighttextblock_Internalname, "...", "", "", lblSpacingrighttextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacingrighttextblock_Visible, 1, 0, 0, "HLP_EstadoTicketUsuarioWC.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLastpagetextblock_Internalname, lblLastpagetextblock_Caption, "", "", lblLastpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOLAST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblLastpagetextblock_Visible, 1, 0, 0, "HLP_EstadoTicketUsuarioWC.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagebuttontextblock_Internalname, "", "", "", lblNextpagebuttontextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DONEXT\\'."+"'", "", lblNextpagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_EstadoTicketUsuarioWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV54Update)) ? AV63Update_GXI : context.convertURL( context.PathToRelativeUrl( AV54Update))), !bGXsfl_180_Refreshing);
                              AssignProp(sPrefix, false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV54Update), true);
                              AV55Delete = cgiGet( edtavDelete_Internalname);
                              AssignProp(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV55Delete)) ? AV64Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV55Delete))), !bGXsfl_180_Refreshing);
                              AssignProp(sPrefix, false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV55Delete), true);
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
                                    ...
                                    if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                                    {
                                       ...
                                       if ( ! wbErr )
                                       {
                                          if ( ! wbErr )
                                          {
                                             ...
                                             if ( StringUtil.StrCmp(cgiGet( sPrefix+"GXH_vK2BTOOLSGENERICSEARCHFIELD"), AV42K2BToolsGenericSearchField) != 0 )
                                             {
                                                Rfr0gs = true;
                                             }
                                             /* Set Refresh If Usuarionombre Changed */
                                             if ( StringUtil.StrCmp(cgiGet( sPrefix+"GXH_vUSUARIONOMBRE"), AV31UsuarioNombre) != 0 )
                                             {
                                                Rfr0gs = true;
                                             }
                                             /* Set Refresh If Usuariofecha_from Changed */
                                             if ( context.localUtil.CToT( cgiGet( sPrefix+"GXH_vUSUARIOFECHA_FROM"), 0) != AV33UsuarioFecha_From )
                                             {
                                                Rfr0gs = true;
                                             }
                                             /* Set Refresh If Usuariohora_from Changed */
                                             if ( context.localUtil.CToT( cgiGet( sPrefix+"GXH_vUSUARIOHORA_FROM"), 0) != AV36UsuarioHora_From )
                                             {
                                                Rfr0gs = true;
                                             }
                                             /* Set Refresh If Usuariohora_to Changed */
                                             if ( context.localUtil.CToT( cgiGet( sPrefix+"GXH_vUSUARIOHORA_TO"), 0) != AV37UsuarioHora_To )
                                             {
                                                Rfr0gs = true;
                                             }
                                             if ( ! Rfr0gs )
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       DateTime AV33UsuarioFecha_From ,
                                       DateTime AV36UsuarioHora_From ,
                                       DateTime AV37UsuarioHora_To ,
                                       short A5EstadoTicketId ,
                                       short AV6EstadoTicketId ,
                                       GxSimpleCollection<string> AV30ClassCollection ,
                                       short AV43OrderedBy ,
                                       DateTime AV34UsuarioFecha_To ,
                                       string AV61Pgmname ,
                                       int AV9CurrentPage ,
                                       SdtK2BGridConfiguration AV11GridConfiguration ,
                                       bool AV53UsuarioNombre_IsAuthorized ,
                                       bool AV15Att_UsuarioId_Visible ,
                                       bool AV16Att_UsuarioNombre_Visible ,
                                       bool AV17Att_UsuarioFecha_Visible ,
                                       bool AV18Att_UsuarioHora_Visible ,
                                       bool AV19Att_UsuarioGerencia_Visible ,
                                       bool AV20Att_UsuarioDepartamento_Visible ,
                                       bool AV21Att_UsuarioRequerimiento_Visible ,
                                       bool AV22Att_UsuarioEmail_Visible ,
                                       bool AV23Att_UsuarioTelefono_Visible ,
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_USUARIOID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A15UsuarioId), "ZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"USUARIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A15UsuarioId), 10, 0, ".", "")));
      }
      ...
      {
         AV15Att_UsuarioId_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV15Att_UsuarioId_Visible));
         AssignAttri(sPrefix, false, "AV15Att_UsuarioId_Visible", AV15Att_UsuarioId_Visible);
         AV16Att_UsuarioNombre_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV16Att_UsuarioNombre_Visible));
         AssignAttri(sPrefix, false, "AV16Att_UsuarioNombre_Visible", AV16Att_UsuarioNombre_Visible);
         ...
         AV18Att_UsuarioHora_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV18Att_UsuarioHora_Visible));
         AssignAttri(sPrefix, false, "AV18Att_UsuarioHora_Visible", AV18Att_UsuarioHora_Visible);
         AV19Att_UsuarioGerencia_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV19Att_UsuarioGerencia_Visible));
         AssignAttri(sPrefix, false, "AV19Att_UsuarioGerencia_Visible", AV19Att_UsuarioGerencia_Visible);
         AV20Att_UsuarioDepartamento_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV20Att_UsuarioDepartamento_Visible));
         AssignAttri(sPrefix, false, "AV20Att_UsuarioDepartamento_Visible", AV20Att_UsuarioDepartamento_Visible);
         ...
         AV22Att_UsuarioEmail_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV22Att_UsuarioEmail_Visible));
         AssignAttri(sPrefix, false, "AV22Att_UsuarioEmail_Visible", AV22Att_UsuarioEmail_Visible);
         AV23Att_UsuarioTelefono_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV23Att_UsuarioTelefono_Visible));
         AssignAttri(sPrefix, false, "AV23Att_UsuarioTelefono_Visible", AV23Att_UsuarioTelefono_Visible);
         if ( cmbavGridsettingsrowsperpagevariable.ItemCount > 0 )
         {
            ...
            AssignAttri(sPrefix, false, "AV24GridSettingsRowsPerPageVariable", StringUtil.LTrimStr( (decimal)(AV24GridSettingsRowsPerPageVariable), 4, 0));
         }
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void RF2G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV31UsuarioNombre ,
                                                 AV34UsuarioFecha_To ,
                                                 AV33UsuarioFecha_From ,
                                                 AV37UsuarioHora_To ,
                                                 AV36UsuarioHora_From ,
                                                 ...
                                                 AV6EstadoTicketId } ,
                                                 new int[]{
                                                 TypeConstants.DATE, TypeConstants.DATE, TypeConstants.DATE, TypeConstants.DATE, TypeConstants.DATE, TypeConstants.DATE, TypeConstants.LONG, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.SHORT,
                                                 TypeConstants.SHORT
                                                 }
            });
            ...
            lV42K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV42K2BToolsGenericSearchField), 100, "%");
            /* Using cursor H002G2 */
            pr_default.execute(0, new Object[] {A5EstadoTicketId, AV6EstadoTicketId, lV31UsuarioNombre, AV34UsuarioFecha_To, AV33UsuarioFecha_From, AV37UsuarioHora_To, AV36UsuarioHora_From, lV42K2BToolsGenericSearchField, lV42K2BToolsGenericSearchField, lV42K2BToolsGenericSearchField, lV42K2BToolsGenericSearchField, lV42K2BToolsGenericSearchField, lV42K2BToolsGenericSearchField, lV42K2BToolsGenericSearchField, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_180_idx = 1;
            sGXsfl_180_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_180_idx), 4, 0), 4, "0");
            SubsflControlProps_1802( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A95UsuarioTelefono = H002G2_A95UsuarioTelefono[0];
               A89UsuarioEmail = H002G2_A89UsuarioEmail[0];
               A94UsuarioRequerimiento = H002G2_A94UsuarioRequerimiento[0];
               A88UsuarioDepartamento = H002G2_A88UsuarioDepartamento[0];
               A91UsuarioGerencia = H002G2_A91UsuarioGerencia[0];
               A92UsuarioHora = H002G2_A92UsuarioHora[0];
               A90UsuarioFecha = H002G2_A90UsuarioFecha[0];
               A93UsuarioNombre = H002G2_A93UsuarioNombre[0];
               A15UsuarioId = H002G2_A15UsuarioId[0];
               E252G2 ();
      ...
      protected void send_integrity_lvl_hashes2G2( )
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV61Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV61Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_USUARIOID"+"_"+sGXsfl_180_idx, GetSecureSignedToken( sPrefix+sGXsfl_180_idx, context.localUtil.Format( (decimal)(A15UsuarioId), "ZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vURI", AV58Uri);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vURI", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV58Uri, "")), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV42K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV42K2BToolsGenericSearchField), 100, "%");
         /* Using cursor H002G3 */
         pr_default.execute(1, new Object[] {A5EstadoTicketId, AV6EstadoTicketId, lV31UsuarioNombre, AV34UsuarioFecha_To, AV33UsuarioFecha_From, AV37UsuarioHora_To, AV36UsuarioHora_From, lV42K2BToolsGenericSearchField, lV42K2BToolsGenericSearchField, lV42K2BToolsGenericSearchField, lV42K2BToolsGenericSearchField, lV42K2BToolsGenericSearchField, lV42K2BToolsGenericSearchField, lV42K2BToolsGenericSearchField});
      ...
      protected void STRUP2G0( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( sPrefix+"vFILTERTAGS"), AV40FilterTags);
            ajax_req_read_hidden_sdt(cgiGet( sPrefix+"vGRIDORDERS"), AV44GridOrders);
            /* Read saved values. */
            nRC_GXsfl_180 = (int)(context.localUtil.CToN( cgiGet( sPrefix+"nRC_GXsfl_180"), ".", ","));
            AV41DeletedTag = cgiGet( sPrefix+"vDELETEDTAG");
            AV33UsuarioFecha_From = context.localUtil.CToD( cgiGet( sPrefix+"vUSUARIOFECHA_FROM"), 0);
            AV34UsuarioFecha_To = context.localUtil.CToD( cgiGet( sPrefix+"vUSUARIOFECHA_TO"), 0);
            AV46UC_OrderedBy = (short)(context.localUtil.CToN( cgiGet( sPrefix+"vUC_ORDEREDBY"), ".", ","));
            wcpOAV6EstadoTicketId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6EstadoTicketId"), ".", ","));
            AV43OrderedBy = (short)(context.localUtil.CToN( cgiGet( sPrefix+"vORDEREDBY"), ".", ","));
            AV6EstadoTicketId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"vESTADOTICKETID"), ".", ","));
            ...
            AssignAttri(sPrefix, false, "AV42K2BToolsGenericSearchField", AV42K2BToolsGenericSearchField);
            AV31UsuarioNombre = cgiGet( edtavUsuarionombre_Internalname);
            AssignAttri(sPrefix, false, "AV31UsuarioNombre", AV31UsuarioNombre);
            if ( context.localUtil.VCDate( cgiGet( edtavUsuariohora_from_Internalname), 2) == 0 )
            {
               ...
               AssignAttri(sPrefix, false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV36UsuarioHora_From = (DateTime)(DateTime.MinValue);
               AssignAttri(sPrefix, false, "AV36UsuarioHora_From", context.localUtil.TToC( AV36UsuarioHora_From, 0, 5, 0, 3, "/", ":", " "));
            }
            else
            {
               AV36UsuarioHora_From = DateTimeUtil.ResetDate(context.localUtil.CToT( cgiGet( edtavUsuariohora_from_Internalname)));
               AssignAttri(sPrefix, false, "AV36UsuarioHora_From", context.localUtil.TToC( AV36UsuarioHora_From, 0, 5, 0, 3, "/", ":", " "));
            }
            if ( context.localUtil.VCDate( cgiGet( edtavUsuariohora_to_Internalname), 2) == 0 )
            {
               ...
               AssignAttri(sPrefix, false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV37UsuarioHora_To = (DateTime)(DateTime.MinValue);
               AssignAttri(sPrefix, false, "AV37UsuarioHora_To", context.localUtil.TToC( AV37UsuarioHora_To, 0, 5, 0, 3, "/", ":", " "));
            }
            else
            {
               AV37UsuarioHora_To = DateTimeUtil.ResetDate(context.localUtil.CToT( cgiGet( edtavUsuariohora_to_Internalname)));
               AssignAttri(sPrefix, false, "AV37UsuarioHora_To", context.localUtil.TToC( AV37UsuarioHora_To, 0, 5, 0, 3, "/", ":", " "));
            }
            AV15Att_UsuarioId_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_usuarioid_visible_Internalname));
            AssignAttri(sPrefix, false, "AV15Att_UsuarioId_Visible", AV15Att_UsuarioId_Visible);
            AV16Att_UsuarioNombre_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_usuarionombre_visible_Internalname));
            AssignAttri(sPrefix, false, "AV16Att_UsuarioNombre_Visible", AV16Att_UsuarioNombre_Visible);
            AV17Att_UsuarioFecha_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_usuariofecha_visible_Internalname));
            AssignAttri(sPrefix, false, "AV17Att_UsuarioFecha_Visible", AV17Att_UsuarioFecha_Visible);
            AV18Att_UsuarioHora_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_usuariohora_visible_Internalname));
            AssignAttri(sPrefix, false, "AV18Att_UsuarioHora_Visible", AV18Att_UsuarioHora_Visible);
            AV19Att_UsuarioGerencia_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_usuariogerencia_visible_Internalname));
            AssignAttri(sPrefix, false, "AV19Att_UsuarioGerencia_Visible", AV19Att_UsuarioGerencia_Visible);
            AV20Att_UsuarioDepartamento_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_usuariodepartamento_visible_Internalname));
            AssignAttri(sPrefix, false, "AV20Att_UsuarioDepartamento_Visible", AV20Att_UsuarioDepartamento_Visible);
            AV21Att_UsuarioRequerimiento_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_usuariorequerimiento_visible_Internalname));
            AssignAttri(sPrefix, false, "AV21Att_UsuarioRequerimiento_Visible", AV21Att_UsuarioRequerimiento_Visible);
            AV22Att_UsuarioEmail_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_usuarioemail_visible_Internalname));
            AssignAttri(sPrefix, false, "AV22Att_UsuarioEmail_Visible", AV22Att_UsuarioEmail_Visible);
            AV23Att_UsuarioTelefono_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_usuariotelefono_visible_Internalname));
            AssignAttri(sPrefix, false, "AV23Att_UsuarioTelefono_Visible", AV23Att_UsuarioTelefono_Visible);
            ...
            if ( DateTimeUtil.ResetTime ( context.localUtil.CToD( cgiGet( sPrefix+"GXH_vUSUARIOFECHA_FROM"), 2) ) != DateTimeUtil.ResetTime ( AV33UsuarioFecha_From ) )
            {
               GRID_nFirstRecordOnPage = 0;
            }
            if ( context.localUtil.CToT( cgiGet( sPrefix+"GXH_vUSUARIOHORA_FROM")) != AV36UsuarioHora_From )
            {
               GRID_nFirstRecordOnPage = 0;
            }
            if ( context.localUtil.CToT( cgiGet( sPrefix+"GXH_vUSUARIOHORA_TO")) != AV37UsuarioHora_To )
            {
               GRID_nFirstRecordOnPage = 0;
            }
         }
      ...
      protected void E222G2( )
      {
         ...
         AV31UsuarioNombre = "";
         AssignAttri(sPrefix, false, "AV31UsuarioNombre", AV31UsuarioNombre);
         AV32UsuarioFecha = DateTime.MinValue;
         AV33UsuarioFecha_From = DateTimeUtil.DAdd(DateTimeUtil.ServerDate( context, pr_default),-((int)(30)));
         AssignAttri(sPrefix, false, "AV33UsuarioFecha_From", context.localUtil.Format(AV33UsuarioFecha_From, "99/99/9999"));
         AV34UsuarioFecha_To = DateTimeUtil.ResetTime(DateTimeUtil.ServerNow( context, pr_default));
         AssignAttri(sPrefix, false, "AV34UsuarioFecha_To", context.localUtil.Format(AV34UsuarioFecha_To, "99/99/9999"));
         AV35UsuarioHora = (DateTime)(DateTime.MinValue);
         AV36UsuarioHora_From = DateTimeUtil.ResetTime( DateTimeUtil.DAdd( DateTimeUtil.ServerDate( context, pr_default) , - ( (int)(30) )) ) ;
         AssignAttri(sPrefix, false, "AV36UsuarioHora_From", context.localUtil.TToC( AV36UsuarioHora_From, 0, 5, 0, 3, "/", ":", " "));
         AV37UsuarioHora_To = DateTimeUtil.ResetDate(DateTimeUtil.ServerNow( context, pr_default));
         AssignAttri(sPrefix, false, "AV37UsuarioHora_To", context.localUtil.TToC( AV37UsuarioHora_To, 0, 5, 0, 3, "/", ":", " "));
         new k2bloadrowsperpage(context ).execute(  AV61Pgmname,  "Grid", out  AV25RowsPerPageVariable, out  AV26RowsPerPageLoaded) ;
         AssignAttri(sPrefix, false, "AV25RowsPerPageVariable", StringUtil.LTrimStr( (decimal)(AV25RowsPerPageVariable), 4, 0));
      ...
      protected void E232G2( )
      {
         ...
         AV62GXV1 = 1;
         while ( AV62GXV1 <= AV47Messages.Count )
         {
            AV48Message = ((GeneXus.Utils.SdtMessages_Message)AV47Messages.Item(AV62GXV1));
         ...
         AV51ActivityList = new GXBaseCollection<SdtK2BActivityList_K2BActivityListItem>( context, "K2BActivityListItem", "kb_ticket");
         AV52ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         AV52ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Usuario";
         AV52ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Usuario";
         ...
         AV52ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV61Pgmname;
         ...
         AV54Update = context.GetImagePath( "788f9b72-f982-49f9-99e4-c0374e31a85a", "", context.GetTheme( ));
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV54Update)) ? AV63Update_GXI : context.convertURL( context.PathToRelativeUrl( AV54Update))), !bGXsfl_180_Refreshing);
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV54Update), true);
         AV63Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "788f9b72-f982-49f9-99e4-c0374e31a85a", "", context.GetTheme( )));
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV54Update)) ? AV63Update_GXI : context.convertURL( context.PathToRelativeUrl( AV54Update))), !bGXsfl_180_Refreshing);
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV54Update), true);
         edtavUpdate_Tooltiptext = "Actualizar";
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "Tooltiptext", edtavUpdate_Tooltiptext, !bGXsfl_180_Refreshing);
         AV55Delete = context.GetImagePath( "3e4a9f50-2c57-41b6-9da5-ebe49bca33c0", "", context.GetTheme( ));
         AssignProp(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV55Delete)) ? AV64Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV55Delete))), !bGXsfl_180_Refreshing);
         AssignProp(sPrefix, false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV55Delete), true);
         AV64Delete_GXI = GXDbFile.PathToUrl( context.GetImagePath( "3e4a9f50-2c57-41b6-9da5-ebe49bca33c0", "", context.GetTheme( )));
         AssignProp(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV55Delete)) ? AV64Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV55Delete))), !bGXsfl_180_Refreshing);
         AssignProp(sPrefix, false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV55Delete), true);
         edtavDelete_Tooltiptext = "Eliminar";
         AssignProp(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_180_Refreshing);
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV30ClassCollection", AV30ClassCollection);
      }
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV27GridStateKey = StringUtil.Str( (decimal)(AV6EstadoTicketId), 4, 0);
         new k2bloadgridstate(context ).execute(  AV61Pgmname,  AV27GridStateKey, out  AV28GridState) ;
         AV43OrderedBy = AV28GridState.gxTpr_Orderedby;
         AssignAttri(sPrefix, false, "AV43OrderedBy", StringUtil.LTrimStr( (decimal)(AV43OrderedBy), 4, 0));
         AV46UC_OrderedBy = AV28GridState.gxTpr_Orderedby;
         AssignAttri(sPrefix, false, "AV46UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV46UC_OrderedBy), 4, 0));
         AV65GXV2 = 1;
         while ( AV65GXV2 <= AV28GridState.gxTpr_Filtervalues.Count )
         {
            AV29GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV28GridState.gxTpr_Filtervalues.Item(AV65GXV2));
            ...
            {
               AV33UsuarioFecha_From = context.localUtil.CToD( AV29GridStateFilterValue.gxTpr_Value, 2);
               AssignAttri(sPrefix, false, "AV33UsuarioFecha_From", context.localUtil.Format(AV33UsuarioFecha_From, "99/99/9999"));
            }
            else if ( StringUtil.StrCmp(AV29GridStateFilterValue.gxTpr_Filtername, "UsuarioFecha:To") == 0 )
            {
               AV34UsuarioFecha_To = context.localUtil.CToD( AV29GridStateFilterValue.gxTpr_Value, 2);
               AssignAttri(sPrefix, false, "AV34UsuarioFecha_To", context.localUtil.Format(AV34UsuarioFecha_To, "99/99/9999"));
            }
            else if ( StringUtil.StrCmp(AV29GridStateFilterValue.gxTpr_Filtername, "UsuarioHora:From") == 0 )
            {
               AV36UsuarioHora_From = DateTimeUtil.ResetDate(context.localUtil.CToT( AV29GridStateFilterValue.gxTpr_Value, 2));
               AssignAttri(sPrefix, false, "AV36UsuarioHora_From", context.localUtil.TToC( AV36UsuarioHora_From, 0, 5, 0, 3, "/", ":", " "));
            }
            else if ( StringUtil.StrCmp(AV29GridStateFilterValue.gxTpr_Filtername, "UsuarioHora:To") == 0 )
            {
               AV37UsuarioHora_To = DateTimeUtil.ResetDate(context.localUtil.CToT( AV29GridStateFilterValue.gxTpr_Value, 2));
               AssignAttri(sPrefix, false, "AV37UsuarioHora_To", context.localUtil.TToC( AV37UsuarioHora_To, 0, 5, 0, 3, "/", ":", " "));
            }
         ...
         if ( ( AV28GridState.gxTpr_Currentpage > 0 ) && ( AV28GridState.gxTpr_Currentpage <= AV10K2BMaxPages ) )
         {
            AV9CurrentPage = AV28GridState.gxTpr_Currentpage;
      ...
      protected void S132( )
      {
         ...
         AV27GridStateKey = StringUtil.Str( (decimal)(AV6EstadoTicketId), 4, 0);
         new k2bloadgridstate(context ).execute(  AV61Pgmname,  AV27GridStateKey, out  AV28GridState) ;
         AV28GridState.gxTpr_Currentpage = (short)(AV9CurrentPage);
         ...
         AV29GridStateFilterValue.gxTpr_Value = context.localUtil.Format( AV33UsuarioFecha_From, "99/99/9999");
         AV28GridState.gxTpr_Filtervalues.Add(AV29GridStateFilterValue, 0);
         AV29GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         AV29GridStateFilterValue.gxTpr_Filtername = "UsuarioFecha:To";
         AV29GridStateFilterValue.gxTpr_Value = context.localUtil.Format( AV34UsuarioFecha_To, "99/99/9999");
         AV28GridState.gxTpr_Filtervalues.Add(AV29GridStateFilterValue, 0);
         AV29GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         AV29GridStateFilterValue.gxTpr_Filtername = "UsuarioHora:From";
         AV29GridStateFilterValue.gxTpr_Value = context.localUtil.Format( AV36UsuarioHora_From, "99:99");
         AV28GridState.gxTpr_Filtervalues.Add(AV29GridStateFilterValue, 0);
         AV29GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         AV29GridStateFilterValue.gxTpr_Filtername = "UsuarioHora:To";
         AV29GridStateFilterValue.gxTpr_Value = context.localUtil.Format( AV37UsuarioHora_To, "99:99");
         AV28GridState.gxTpr_Filtervalues.Add(AV29GridStateFilterValue, 0);
         AV29GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         ...
         AV28GridState.gxTpr_Filtervalues.Add(AV29GridStateFilterValue, 0);
         new k2bsavegridstate(context ).execute(  AV61Pgmname,  AV27GridStateKey,  AV28GridState) ;
      }
      ...
      protected void S192( )
      {
         ...
         AV49TrnContext.gxTpr_Callerurl = AV8HTTPRequest.ScriptName+"?"+AV8HTTPRequest.QueryString;
         ...
         AV50TrnContextAtt = new SdtK2BTrnContext_Attribute(context);
         AV50TrnContextAtt.gxTpr_Attributename = "EstadoTicketId";
         AV50TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6EstadoTicketId), 4, 0);
         AV49TrnContext.gxTpr_Attributes.Add(AV50TrnContextAtt, 0);
         new k2bsettrncontextbyname(context ).execute(  "Usuario",  AV49TrnContext) ;
      }
      ...
      protected void S202( )
      {
         ...
         AssignProp(sPrefix, false, edtUsuarioId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtUsuarioId_Visible), 5, 0), !bGXsfl_180_Refreshing);
         AV15Att_UsuarioId_Visible = true;
         AssignAttri(sPrefix, false, "AV15Att_UsuarioId_Visible", AV15Att_UsuarioId_Visible);
         edtUsuarioNombre_Visible = 1;
         AssignProp(sPrefix, false, edtUsuarioNombre_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtUsuarioNombre_Visible), 5, 0), !bGXsfl_180_Refreshing);
         AV16Att_UsuarioNombre_Visible = true;
         AssignAttri(sPrefix, false, "AV16Att_UsuarioNombre_Visible", AV16Att_UsuarioNombre_Visible);
         edtUsuarioFecha_Visible = 1;
         AssignProp(sPrefix, false, edtUsuarioFecha_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtUsuarioFecha_Visible), 5, 0), !bGXsfl_180_Refreshing);
         AV17Att_UsuarioFecha_Visible = true;
         AssignAttri(sPrefix, false, "AV17Att_UsuarioFecha_Visible", AV17Att_UsuarioFecha_Visible);
         edtUsuarioHora_Visible = 1;
         AssignProp(sPrefix, false, edtUsuarioHora_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtUsuarioHora_Visible), 5, 0), !bGXsfl_180_Refreshing);
         AV18Att_UsuarioHora_Visible = true;
         AssignAttri(sPrefix, false, "AV18Att_UsuarioHora_Visible", AV18Att_UsuarioHora_Visible);
         edtUsuarioGerencia_Visible = 1;
         AssignProp(sPrefix, false, edtUsuarioGerencia_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtUsuarioGerencia_Visible), 5, 0), !bGXsfl_180_Refreshing);
         AV19Att_UsuarioGerencia_Visible = true;
         AssignAttri(sPrefix, false, "AV19Att_UsuarioGerencia_Visible", AV19Att_UsuarioGerencia_Visible);
         edtUsuarioDepartamento_Visible = 1;
         AssignProp(sPrefix, false, edtUsuarioDepartamento_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtUsuarioDepartamento_Visible), 5, 0), !bGXsfl_180_Refreshing);
         AV20Att_UsuarioDepartamento_Visible = true;
         AssignAttri(sPrefix, false, "AV20Att_UsuarioDepartamento_Visible", AV20Att_UsuarioDepartamento_Visible);
         edtUsuarioRequerimiento_Visible = 1;
         AssignProp(sPrefix, false, edtUsuarioRequerimiento_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtUsuarioRequerimiento_Visible), 5, 0), !bGXsfl_180_Refreshing);
         AV21Att_UsuarioRequerimiento_Visible = true;
         AssignAttri(sPrefix, false, "AV21Att_UsuarioRequerimiento_Visible", AV21Att_UsuarioRequerimiento_Visible);
         edtUsuarioEmail_Visible = 1;
         AssignProp(sPrefix, false, edtUsuarioEmail_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtUsuarioEmail_Visible), 5, 0), !bGXsfl_180_Refreshing);
         AV22Att_UsuarioEmail_Visible = true;
         AssignAttri(sPrefix, false, "AV22Att_UsuarioEmail_Visible", AV22Att_UsuarioEmail_Visible);
         edtUsuarioTelefono_Visible = 1;
         AssignProp(sPrefix, false, edtUsuarioTelefono_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtUsuarioTelefono_Visible), 5, 0), !bGXsfl_180_Refreshing);
         AV23Att_UsuarioTelefono_Visible = true;
         AssignAttri(sPrefix, false, "AV23Att_UsuarioTelefono_Visible", AV23Att_UsuarioTelefono_Visible);
         new k2bsavegridconfiguration(context ).execute(  AV61Pgmname,  "Grid",  AV11GridConfiguration,  false) ;
         AV66GXV3 = 1;
         while ( AV66GXV3 <= AV11GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV14GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV11GridConfiguration.gxTpr_Gridcolumns.Item(AV66GXV3));
            if ( ! AV14GridColumn.gxTpr_Showattribute )
            {
               if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "UsuarioId") == 0 )
               {
                  edtUsuarioId_Visible = 0;
                  AssignProp(sPrefix, false, edtUsuarioId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtUsuarioId_Visible), 5, 0), !bGXsfl_180_Refreshing);
                  AV15Att_UsuarioId_Visible = false;
                  AssignAttri(sPrefix, false, "AV15Att_UsuarioId_Visible", AV15Att_UsuarioId_Visible);
               }
               else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "UsuarioNombre") == 0 )
               {
                  ...
                  AssignProp(sPrefix, false, edtUsuarioNombre_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtUsuarioNombre_Visible), 5, 0), !bGXsfl_180_Refreshing);
                  AV16Att_UsuarioNombre_Visible = false;
                  AssignAttri(sPrefix, false, "AV16Att_UsuarioNombre_Visible", AV16Att_UsuarioNombre_Visible);
               }
               ...
               else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "UsuarioHora") == 0 )
               {
                  edtUsuarioHora_Visible = 0;
                  AssignProp(sPrefix, false, edtUsuarioHora_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtUsuarioHora_Visible), 5, 0), !bGXsfl_180_Refreshing);
                  AV18Att_UsuarioHora_Visible = false;
                  AssignAttri(sPrefix, false, "AV18Att_UsuarioHora_Visible", AV18Att_UsuarioHora_Visible);
               }
               else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "UsuarioGerencia") == 0 )
               {
                  ...
                  AssignProp(sPrefix, false, edtUsuarioGerencia_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtUsuarioGerencia_Visible), 5, 0), !bGXsfl_180_Refreshing);
                  AV19Att_UsuarioGerencia_Visible = false;
                  AssignAttri(sPrefix, false, "AV19Att_UsuarioGerencia_Visible", AV19Att_UsuarioGerencia_Visible);
               }
               else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "UsuarioDepartamento") == 0 )
               {
                  ...
                  AssignProp(sPrefix, false, edtUsuarioDepartamento_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtUsuarioDepartamento_Visible), 5, 0), !bGXsfl_180_Refreshing);
                  AV20Att_UsuarioDepartamento_Visible = false;
                  AssignAttri(sPrefix, false, "AV20Att_UsuarioDepartamento_Visible", AV20Att_UsuarioDepartamento_Visible);
               }
               ...
               else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "UsuarioEmail") == 0 )
               {
                  edtUsuarioEmail_Visible = 0;
                  AssignProp(sPrefix, false, edtUsuarioEmail_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtUsuarioEmail_Visible), 5, 0), !bGXsfl_180_Refreshing);
                  AV22Att_UsuarioEmail_Visible = false;
                  AssignAttri(sPrefix, false, "AV22Att_UsuarioEmail_Visible", AV22Att_UsuarioEmail_Visible);
               }
               else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "UsuarioTelefono") == 0 )
               {
                  edtUsuarioTelefono_Visible = 0;
                  AssignProp(sPrefix, false, edtUsuarioTelefono_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtUsuarioTelefono_Visible), 5, 0), !bGXsfl_180_Refreshing);
                  AV23Att_UsuarioTelefono_Visible = false;
                  AssignAttri(sPrefix, false, "AV23Att_UsuarioTelefono_Visible", AV23Att_UsuarioTelefono_Visible);
               }
            }
      ...
      protected void S182( )
      {
         ...
         AV13GridColumns.Add(AV14GridColumn, 0);
         AV14GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV14GridColumn.gxTpr_Attributename = "UsuarioHora";
         AV14GridColumn.gxTpr_Columntitle = "Hora Inicio:";
         AV14GridColumn.gxTpr_Showattribute = true;
         AV13GridColumns.Add(AV14GridColumn, 0);
         AV14GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         ...
         AV14GridColumn.gxTpr_Columntitle = "Descripción del Requerimiento:";
         AV14GridColumn.gxTpr_Showattribute = true;
         AV13GridColumns.Add(AV14GridColumn, 0);
         AV14GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV14GridColumn.gxTpr_Attributename = "UsuarioEmail";
         AV14GridColumn.gxTpr_Columntitle = "Email:";
         AV14GridColumn.gxTpr_Showattribute = true;
         AV13GridColumns.Add(AV14GridColumn, 0);
         AV14GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV14GridColumn.gxTpr_Attributename = "UsuarioTelefono";
         AV14GridColumn.gxTpr_Columntitle = "Teléfono:";
         AV14GridColumn.gxTpr_Showattribute = true;
         AV13GridColumns.Add(AV14GridColumn, 0);
      ...
      protected void S212( )
      {
         ...
         AV52ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Usuario";
         AV52ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Usuario";
         AV52ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = "ReportEstadoTicketUsuarioWC";
         AV51ActivityList.Add(AV52ActivityListItem, 0);
         AV52ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         AV52ActivityListItem.gxTpr_Activity.gxTpr_Standardactivitytype = "List";
         AV52ActivityListItem.gxTpr_Activity.gxTpr_Useractivitytype = "";
         AV52ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Usuario";
         AV52ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Usuario";
         AV52ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = "ExportEstadoTicketUsuarioWC";
         AV51ActivityList.Add(AV52ActivityListItem, 0);
         AV52ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         ...
         AV52ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Usuario";
         AV52ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Usuario";
         AV52ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = "EntityManagerUsuario";
         AV51ActivityList.Add(AV52ActivityListItem, 0);
         new k2bisauthorizedactivitylist(context ).execute( ref  AV51ActivityList) ;
         if ( ((SdtK2BActivityList_K2BActivityListItem)AV51ActivityList.Item(1)).gxTpr_Isauthorized )
         {
      ...
      protected void S222( )
      {
         ...
         AV51ActivityList.Add(AV52ActivityListItem, 0);
         new k2bisauthorizedactivitylist(context ).execute( ref  AV51ActivityList) ;
         AV53UsuarioNombre_IsAuthorized = ((SdtK2BActivityList_K2BActivityListItem)AV51ActivityList.Item(1)).gxTpr_Isauthorized;
         AssignAttri(sPrefix, false, "AV53UsuarioNombre_IsAuthorized", AV53UsuarioNombre_IsAuthorized);
         if ( ! ((SdtK2BActivityList_K2BActivityListItem)AV51ActivityList.Item(2)).gxTpr_Isauthorized )
         {
            edtavUpdate_Visible = 0;
            AssignProp(sPrefix, false, edtavUpdate_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavUpdate_Visible), 5, 0), !bGXsfl_180_Refreshing);
         }
         else
         {
         ...
         if ( ! ((SdtK2BActivityList_K2BActivityListItem)AV51ActivityList.Item(3)).gxTpr_Isauthorized )
         {
            ...
            AssignProp(sPrefix, false, edtavDelete_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavDelete_Visible), 5, 0), !bGXsfl_180_Refreshing);
         }
         else
         {
      ...
      protected void E242G2( )
      {
         ...
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV30ClassCollection", AV30ClassCollection);
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV40FilterTags", AV40FilterTags);
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV11GridConfiguration", AV11GridConfiguration);
      }
      ...
      private void E252G2( )
      {
         ...
         AssignProp(sPrefix, false, tblNoresultsfoundtable_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(tblNoresultsfoundtable_Visible), 5, 0), true);
         if ( AV53UsuarioNombre_IsAuthorized )
         {
      ...
      protected void S122( )
      {
         ...
         if ( ! (DateTime.MinValue==AV33UsuarioFecha_From) || ! (DateTime.MinValue==AV34UsuarioFecha_To) )
         {
            AV39K2BFilterValuesSDTItem = new SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem(context);
            ...
            GXt_dtime3 = DateTimeUtil.ResetTime( AV33UsuarioFecha_From ) ;
            AV39K2BFilterValuesSDTItem.gxTpr_Daterangefromvalue = GXt_dtime3;
            GXt_dtime3 = DateTimeUtil.ResetTime( AV34UsuarioFecha_To ) ;
            AV39K2BFilterValuesSDTItem.gxTpr_Daterangetovalue = GXt_dtime3;
            AV38K2BFilterValuesSDT.Add(AV39K2BFilterValuesSDTItem, 0);
         }
         if ( ! (DateTime.MinValue==AV36UsuarioHora_From) || ! (DateTime.MinValue==AV37UsuarioHora_To) )
         {
            AV39K2BFilterValuesSDTItem = new SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem(context);
            AV39K2BFilterValuesSDTItem.gxTpr_Name = "UsuarioHora";
            AV39K2BFilterValuesSDTItem.gxTpr_Description = "Hora Inicio:";
            AV39K2BFilterValuesSDTItem.gxTpr_Canbedeleted = true;
            AV39K2BFilterValuesSDTItem.gxTpr_Type = "DateTimeRange";
            AV39K2BFilterValuesSDTItem.gxTpr_Semanticdaterangevalue = "K2BToolsDateRangeManual";
            AV39K2BFilterValuesSDTItem.gxTpr_Daterangefromvalue = AV36UsuarioHora_From;
            AV39K2BFilterValuesSDTItem.gxTpr_Daterangetovalue = AV37UsuarioHora_To;
            AV38K2BFilterValuesSDT.Add(AV39K2BFilterValuesSDTItem, 0);
         }
         ...
         if ( AV38K2BFilterValuesSDT.Count > 0 )
         {
            ...
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV61Pgmname,  "Grid",  AV38K2BFilterValuesSDT, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item4) ;
      ...
      protected void E112G2( )
      {
         ...
         {
            AV33UsuarioFecha_From = DateTime.MinValue;
            AssignAttri(sPrefix, false, "AV33UsuarioFecha_From", context.localUtil.Format(AV33UsuarioFecha_From, "99/99/9999"));
            AV34UsuarioFecha_To = DateTime.MinValue;
            AssignAttri(sPrefix, false, "AV34UsuarioFecha_To", context.localUtil.Format(AV34UsuarioFecha_To, "99/99/9999"));
         }
         else if ( StringUtil.StrCmp(AV41DeletedTag, "UsuarioHora") == 0 )
         {
            AV36UsuarioHora_From = (DateTime)(DateTime.MinValue);
            AssignAttri(sPrefix, false, "AV36UsuarioHora_From", context.localUtil.TToC( AV36UsuarioHora_From, 0, 5, 0, 3, "/", ":", " "));
            AV37UsuarioHora_To = (DateTime)(DateTime.MinValue);
      ...
      protected void E142G2( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  AV61Pgmname,  "Grid", ref  AV11GridConfiguration) ;
         AV67GXV4 = 1;
         while ( AV67GXV4 <= AV11GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV14GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV11GridConfiguration.gxTpr_Gridcolumns.Item(AV67GXV4));
            if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "UsuarioId") == 0 )
            {
               AV14GridColumn.gxTpr_Showattribute = AV15Att_UsuarioId_Visible;
            }
            else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "UsuarioNombre") == 0 )
            {
               AV14GridColumn.gxTpr_Showattribute = AV16Att_UsuarioNombre_Visible;
            }
            else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "UsuarioFecha") == 0 )
            {
            ...
            {
               AV14GridColumn.gxTpr_Showattribute = AV18Att_UsuarioHora_Visible;
            }
            else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "UsuarioGerencia") == 0 )
            {
               AV14GridColumn.gxTpr_Showattribute = AV19Att_UsuarioGerencia_Visible;
            }
            else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "UsuarioDepartamento") == 0 )
            {
               AV14GridColumn.gxTpr_Showattribute = AV20Att_UsuarioDepartamento_Visible;
            }
            else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "UsuarioRequerimiento") == 0 )
            {
            ...
            {
               AV14GridColumn.gxTpr_Showattribute = AV22Att_UsuarioEmail_Visible;
            }
            else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "UsuarioTelefono") == 0 )
            {
               AV14GridColumn.gxTpr_Showattribute = AV23Att_UsuarioTelefono_Visible;
            }
            AV67GXV4 = (int)(AV67GXV4+1);
         }
         AV11GridConfiguration.gxTpr_Freezecolumntitles = AV12FreezeColumnTitles;
         new k2bsavegridconfiguration(context ).execute(  AV61Pgmname,  "Grid",  AV11GridConfiguration,  true) ;
         AV46UC_OrderedBy = AV43OrderedBy;
         AssignAttri(sPrefix, false, "AV46UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV46UC_OrderedBy), 4, 0));
         if ( AV25RowsPerPageVariable != AV24GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV25RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, sPrefix+"GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV61Pgmname,  "Grid",  AV25RowsPerPageVariable) ;
            AV9CurrentPage = 1;
            AssignAttri(sPrefix, false, "AV9CurrentPage", StringUtil.LTrimStr( (decimal)(AV9CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void E192G2( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "Usuario",  "Usuario",  "List",  "",  "ExportEstadoTicketUsuarioWC") )
         {
            new exportestadoticketusuariowc(context ).execute(  AV6EstadoTicketId,  AV31UsuarioNombre,  AV33UsuarioFecha_From,  AV34UsuarioFecha_To,  AV36UsuarioHora_From,  AV37UsuarioHora_To,  AV42K2BToolsGenericSearchField,  AV43OrderedBy, out  AV56OutFile) ;
            if ( new k2bt_isinexternalstorage(context).executeUdp(  AV56OutFile, out  AV58Uri) )
            {
               CallWebObject(formatLink(AV58Uri) );
               context.wjLocDisableFrm = 0;
            }
            else
            {
               AV57Guid = (Guid)(Guid.NewGuid( ));
               new k2bsessionset(context ).execute(  AV57Guid.ToString(),  AV56OutFile) ;
               CallWebObject(formatLink("k2bt_returnfileinhttpresponse.aspx", new object[] {UrlEncode(AV57Guid.ToString())}, new string[] {"Guid"}) );
      ...
      protected void wb_table2_194_2G2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoresultsfoundtextblock_Internalname, "No hay resultados", "", "", lblNoresultsfoundtextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_EstadoTicketUsuarioWC.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_194_2G2e( true) ;
         }
         else
         {
            wb_table2_194_2G2e( false) ;
         }
      }

      protected void wb_table1_58_2G2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRuntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblRuntimecolumnselectiontb_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_EstadoTicketUsuarioWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 99,'" + sPrefix + "',false,'" + sGXsfl_180_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            ...
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 105,'" + sPrefix + "',false,'" + sGXsfl_180_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_usuariohora_visible_Internalname, StringUtil.BoolToStr( AV18Att_UsuarioHora_Visible), "", "Hora Inicio:", 1, chkavAtt_usuariohora_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(105, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,105);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 111,'" + sPrefix + "',false,'" + sGXsfl_180_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_usuariogerencia_visible_Internalname, StringUtil.BoolToStr( AV19Att_UsuarioGerencia_Visible), "", "Gerencia:", 1, chkavAtt_usuariogerencia_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(111, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,111);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 117,'" + sPrefix + "',false,'" + sGXsfl_180_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_usuariodepartamento_visible_Internalname, StringUtil.BoolToStr( AV20Att_UsuarioDepartamento_Visible), "", "Departamento:", 1, chkavAtt_usuariodepartamento_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(117, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,117);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 123,'" + sPrefix + "',false,'" + sGXsfl_180_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_usuariorequerimiento_visible_Internalname, StringUtil.BoolToStr( AV21Att_UsuarioRequerimiento_Visible), "", "Descripción del Requerimiento:", 1, chkavAtt_usuariorequerimiento_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(123, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,123);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 129,'" + sPrefix + "',false,'" + sGXsfl_180_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_usuarioemail_visible_Internalname, StringUtil.BoolToStr( AV22Att_UsuarioEmail_Visible), "", "Email:", 1, chkavAtt_usuarioemail_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(129, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,129);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 135,'" + sPrefix + "',false,'" + sGXsfl_180_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_usuariotelefono_visible_Internalname, StringUtil.BoolToStr( AV23Att_UsuarioTelefono_Visible), "", "Teléfono:", 1, chkavAtt_usuariotelefono_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(135, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,135);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 141,'" + sPrefix + "',false,'" + sGXsfl_180_idx + "',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavGridsettingsrowsperpagevariable, cmbavGridsettingsrowsperpagevariable_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV24GridSettingsRowsPerPageVariable), 4, 0)), 1, cmbavGridsettingsrowsperpagevariable_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavGridsettingsrowsperpagevariable.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,141);\"", "", true, 1, "HLP_EstadoTicketUsuarioWC.htm");
            cmbavGridsettingsrowsperpagevariable.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV24GridSettingsRowsPerPageVariable), 4, 0));
            ...
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 147,'" + sPrefix + "',false,'" + sGXsfl_180_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttK2bgridsettingssave_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(180), 3, 0)+","+"null"+");", "Aplicar", bttK2bgridsettingssave_Jsonclick, 5, "Aplicar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'SAVEGRIDSETTINGS\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EstadoTicketUsuarioWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgImage1_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgImage1_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e272g1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_EstadoTicketUsuarioWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table3_161_2G2( true) ;
         }
         else
         {
            wb_table3_161_2G2( false) ;
         }
         return  ;
      }

      protected void wb_table3_161_2G2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table4_168_2G2( true) ;
         }
         else
         {
            wb_table4_168_2G2( false) ;
         }
         return  ;
      }

      protected void wb_table4_168_2G2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_58_2G2e( true) ;
         }
         else
         {
            wb_table1_58_2G2e( false) ;
         }
      }

      protected void wb_table4_168_2G2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttInsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(180), 3, 0)+","+"null"+");", "Nuevo", bttInsert_Jsonclick, 5, bttInsert_Tooltiptext, "", StyleString, ClassString, bttInsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EstadoTicketUsuarioWC.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_168_2G2e( true) ;
         }
         else
         {
            wb_table4_168_2G2e( false) ;
         }
      }

      protected void wb_table3_161_2G2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttReport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(180), 3, 0)+","+"null"+");", "Reporte", bttReport_Jsonclick, 7, bttReport_Tooltiptext, "", StyleString, ClassString, bttReport_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e282g1_client"+"'", TempTags, "", 2, "HLP_EstadoTicketUsuarioWC.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='K2BToolsTableCell_ActionContainer'>") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 166,'" + sPrefix + "',false,'',0)\"";
            ClassString = "Button_Standard";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttExport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(180), 3, 0)+","+"null"+");", "Exportar", bttExport_Jsonclick, 5, bttExport_Tooltiptext, "", StyleString, ClassString, bttExport_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOEXPORT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EstadoTicketUsuarioWC.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_161_2G2e( true) ;
         }
         else
         {
            wb_table3_161_2G2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6EstadoTicketId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6EstadoTicketId", StringUtil.LTrimStr( (decimal)(AV6EstadoTicketId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6EstadoTicketId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "estadoticketusuariowc", GetJustCreated( ));
         ...
         {
            AV6EstadoTicketId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6EstadoTicketId", StringUtil.LTrimStr( (decimal)(AV6EstadoTicketId), 4, 0));
         }
         wcpOAV6EstadoTicketId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6EstadoTicketId"), ".", ","));
         if ( ! GetJustCreated( ) && ( ( AV6EstadoTicketId != wcpOAV6EstadoTicketId ) ) )
         {
            setjustcreated();
         }
         wcpOAV6EstadoTicketId = AV6EstadoTicketId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6EstadoTicketId = cgiGet( sPrefix+"AV6EstadoTicketId_CTRL");
         if ( StringUtil.Len( sCtrlAV6EstadoTicketId) > 0 )
         {
            AV6EstadoTicketId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6EstadoTicketId), ".", ","));
            AssignAttri(sPrefix, false, "AV6EstadoTicketId", StringUtil.LTrimStr( (decimal)(AV6EstadoTicketId), 4, 0));
         }
         else
         {
            AV6EstadoTicketId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6EstadoTicketId_PARM"), ".", ","));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6EstadoTicketId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6EstadoTicketId), 4, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6EstadoTicketId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6EstadoTicketId_CTRL", StringUtil.RTrim( sCtrlAV6EstadoTicketId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188114844", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("estadoticketusuariowc.js", "?2024188114844", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
      ...
      {
         edtUsuarioId_Internalname = sPrefix+"USUARIOID_"+sGXsfl_180_idx;
         edtUsuarioNombre_Internalname = sPrefix+"USUARIONOMBRE_"+sGXsfl_180_idx;
         edtUsuarioFecha_Internalname = sPrefix+"USUARIOFECHA_"+sGXsfl_180_idx;
         edtUsuarioHora_Internalname = sPrefix+"USUARIOHORA_"+sGXsfl_180_idx;
         edtUsuarioGerencia_Internalname = sPrefix+"USUARIOGERENCIA_"+sGXsfl_180_idx;
         edtUsuarioDepartamento_Internalname = sPrefix+"USUARIODEPARTAMENTO_"+sGXsfl_180_idx;
         edtUsuarioRequerimiento_Internalname = sPrefix+"USUARIOREQUERIMIENTO_"+sGXsfl_180_idx;
         edtUsuarioEmail_Internalname = sPrefix+"USUARIOEMAIL_"+sGXsfl_180_idx;
         edtUsuarioTelefono_Internalname = sPrefix+"USUARIOTELEFONO_"+sGXsfl_180_idx;
         edtavUpdate_Internalname = sPrefix+"vUPDATE_"+sGXsfl_180_idx;
         edtavDelete_Internalname = sPrefix+"vDELETE_"+sGXsfl_180_idx;
      }

      protected void SubsflControlProps_fel_1802( )
      {
         edtUsuarioId_Internalname = sPrefix+"USUARIOID_"+sGXsfl_180_fel_idx;
         edtUsuarioNombre_Internalname = sPrefix+"USUARIONOMBRE_"+sGXsfl_180_fel_idx;
         edtUsuarioFecha_Internalname = sPrefix+"USUARIOFECHA_"+sGXsfl_180_fel_idx;
         edtUsuarioHora_Internalname = sPrefix+"USUARIOHORA_"+sGXsfl_180_fel_idx;
         edtUsuarioGerencia_Internalname = sPrefix+"USUARIOGERENCIA_"+sGXsfl_180_fel_idx;
         edtUsuarioDepartamento_Internalname = sPrefix+"USUARIODEPARTAMENTO_"+sGXsfl_180_fel_idx;
         edtUsuarioRequerimiento_Internalname = sPrefix+"USUARIOREQUERIMIENTO_"+sGXsfl_180_fel_idx;
         edtUsuarioEmail_Internalname = sPrefix+"USUARIOEMAIL_"+sGXsfl_180_fel_idx;
         edtUsuarioTelefono_Internalname = sPrefix+"USUARIOTELEFONO_"+sGXsfl_180_fel_idx;
         edtavUpdate_Internalname = sPrefix+"vUPDATE_"+sGXsfl_180_fel_idx;
         edtavDelete_Internalname = sPrefix+"vDELETE_"+sGXsfl_180_fel_idx;
      }
      ...
      protected void sendrow_1802( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_180_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV54Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV54Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV63Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV54Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV54Update)) ? AV63Update_GXI : context.PathToRelativeUrl( AV54Update));
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtavUpdate_Internalname,(string)sImgUrl,(string)edtavUpdate_Link,(string)"",(string)"",context.GetTheme( ),(int)edtavUpdate_Visible,(int)edtavUpdate_Enabled,(string)"",(string)edtavUpdate_Tooltiptext,(short)0,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"K2BToolsGridColumn ActionColumn ActionVisibleOnRowHover",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)AV54Update_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV55Delete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV55Delete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV64Delete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV55Delete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV55Delete)) ? AV64Delete_GXI : context.PathToRelativeUrl( AV55Delete));
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtavDelete_Internalname,(string)sImgUrl,(string)edtavDelete_Link,(string)"",(string)"",context.GetTheme( ),(int)edtavDelete_Visible,(int)edtavDelete_Enabled,(string)"",(string)edtavDelete_Tooltiptext,(short)0,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"K2BToolsGridColumn ActionColumn ActionVisibleOnRowHover",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)AV55Delete_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
      ...
      protected void init_web_controls( )
      {
         ...
         AssignProp(sPrefix, false, chkavAtt_usuariohora_visible_Internalname, "TitleCaption", chkavAtt_usuariohora_visible.Caption, true);
         ...
         AssignProp(sPrefix, false, chkavAtt_usuarioemail_visible_Internalname, "TitleCaption", chkavAtt_usuarioemail_visible.Caption, true);
         ...
         AssignProp(sPrefix, false, chkavAtt_usuariotelefono_visible_Internalname, "TitleCaption", chkavAtt_usuariotelefono_visible.Caption, true);
      ...
      protected void init_default_properties( )
      {
         ...
         lblTextblockusuariohora_Internalname = sPrefix+"TEXTBLOCKUSUARIOHORA";
         edtavUsuariohora_from_Internalname = sPrefix+"vUSUARIOHORA_FROM";
         lblDaterangeseparator_usuariohora_Internalname = sPrefix+"DATERANGESEPARATOR_USUARIOHORA";
         edtavUsuariohora_to_Internalname = sPrefix+"vUSUARIOHORA_TO";
         divDaterangefiltermaintable_usuariohora_Internalname = sPrefix+"DATERANGEFILTERMAINTABLE_USUARIOHORA";
         ...
         chkavAtt_usuariohora_visible_Internalname = sPrefix+"vATT_USUARIOHORA_VISIBLE";
         divUsuariohora_gridsettingscontainer_Internalname = sPrefix+"USUARIOHORA_GRIDSETTINGSCONTAINER";
         ...
         chkavAtt_usuarioemail_visible_Internalname = sPrefix+"vATT_USUARIOEMAIL_VISIBLE";
         divUsuarioemail_gridsettingscontainer_Internalname = sPrefix+"USUARIOEMAIL_GRIDSETTINGSCONTAINER";
         chkavAtt_usuariotelefono_visible_Internalname = sPrefix+"vATT_USUARIOTELEFONO_VISIBLE";
         divUsuariotelefono_gridsettingscontainer_Internalname = sPrefix+"USUARIOTELEFONO_GRIDSETTINGSCONTAINER";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'sPrefix'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV61Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV58Uri',fld:'vURI',pic:'',hsh:true},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[{ctrl:'REPORT',prop:'Tooltiptext'},{ctrl:'EXPORT',prop:'Tooltiptext'},{ctrl:'INSERT',prop:'Tooltiptext'},{av:'AV54Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV55Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'divDownloadsactionssectioncontainer_Visible',ctrl:'DOWNLOADSACTIONSSECTIONCONTAINER',prop:'Visible'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{ctrl:'INSERT',prop:'Visible'},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'edtUsuarioId_Visible',ctrl:'USUARIOID',prop:'Visible'},{av:'edtUsuarioNombre_Visible',ctrl:'USUARIONOMBRE',prop:'Visible'},{av:'edtUsuarioFecha_Visible',ctrl:'USUARIOFECHA',prop:'Visible'},{av:'edtUsuarioHora_Visible',ctrl:'USUARIOHORA',prop:'Visible'},{av:'edtUsuarioGerencia_Visible',ctrl:'USUARIOGERENCIA',prop:'Visible'},{av:'edtUsuarioDepartamento_Visible',ctrl:'USUARIODEPARTAMENTO',prop:'Visible'},{av:'edtUsuarioRequerimiento_Visible',ctrl:'USUARIOREQUERIMIENTO',prop:'Visible'},{av:'edtUsuarioEmail_Visible',ctrl:'USUARIOEMAIL',prop:'Visible'},{av:'edtUsuarioTelefono_Visible',ctrl:'USUARIOTELEFONO',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("'DOINSERT'","{handler:'E132G2',iparms:[{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOINSERT'",",oparms:[{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("'DOREPORT'","{handler:'E282G1',iparms:[{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOREPORT'",",oparms:[{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("GRID.REFRESH","{handler:'E242G2',iparms:[{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'AV61Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'AV58Uri',fld:'vURI',pic:'',hsh:true},{av:'sPrefix'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("GRID.REFRESH",",oparms:[{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{ctrl:'REPORT',prop:'Tooltiptext'},{ctrl:'EXPORT',prop:'Tooltiptext'},{ctrl:'INSERT',prop:'Tooltiptext'},{av:'AV54Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV55Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'tblNoresultsfoundtable_Visible',ctrl:'NORESULTSFOUNDTABLE',prop:'Visible'},{av:'AV46UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'divDownloadsactionssectioncontainer_Visible',ctrl:'DOWNLOADSACTIONSSECTIONCONTAINER',prop:'Visible'},{av:'Filtersummarytagsuc_Emptystatemessage',ctrl:'FILTERSUMMARYTAGSUC',prop:'EmptyStateMessage'},{av:'AV40FilterTags',fld:'vFILTERTAGS',pic:''},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'lblFirstpagetextblock_Caption',ctrl:'FIRSTPAGETEXTBLOCK',prop:'Caption'},{av:'lblPreviouspagetextblock_Caption',ctrl:'PREVIOUSPAGETEXTBLOCK',prop:'Caption'},{av:'lblCurrentpagetextblock_Caption',ctrl:'CURRENTPAGETEXTBLOCK',prop:'Caption'},{av:'lblNextpagetextblock_Caption',ctrl:'NEXTPAGETEXTBLOCK',prop:'Caption'},{av:'lblLastpagetextblock_Caption',ctrl:'LASTPAGETEXTBLOCK',prop:'Caption'},{av:'lblPreviouspagebuttontextblock_Class',ctrl:'PREVIOUSPAGEBUTTONTEXTBLOCK',prop:'Class'},{av:'lblNextpagebuttontextblock_Class',ctrl:'NEXTPAGEBUTTONTEXTBLOCK',prop:'Class'},{av:'lblFirstpagetextblock_Visible',ctrl:'FIRSTPAGETEXTBLOCK',prop:'Visible'},{av:'lblSpacinglefttextblock_Visible',ctrl:'SPACINGLEFTTEXTBLOCK',prop:'Visible'},{av:'lblPreviouspagetextblock_Visible',ctrl:'PREVIOUSPAGETEXTBLOCK',prop:'Visible'},{av:'lblLastpagetextblock_Visible',ctrl:'LASTPAGETEXTBLOCK',prop:'Visible'},{av:'lblSpacingrighttextblock_Visible',ctrl:'SPACINGRIGHTTEXTBLOCK',prop:'Visible'},{av:'lblNextpagetextblock_Visible',ctrl:'NEXTPAGETEXTBLOCK',prop:'Visible'},{av:'divK2btoolspagingcontainertable_Visible',ctrl:'K2BTOOLSPAGINGCONTAINERTABLE',prop:'Visible'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{ctrl:'INSERT',prop:'Visible'},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'edtUsuarioId_Visible',ctrl:'USUARIOID',prop:'Visible'},{av:'edtUsuarioNombre_Visible',ctrl:'USUARIONOMBRE',prop:'Visible'},{av:'edtUsuarioFecha_Visible',ctrl:'USUARIOFECHA',prop:'Visible'},{av:'edtUsuarioHora_Visible',ctrl:'USUARIOHORA',prop:'Visible'},{av:'edtUsuarioGerencia_Visible',ctrl:'USUARIOGERENCIA',prop:'Visible'},{av:'edtUsuarioDepartamento_Visible',ctrl:'USUARIODEPARTAMENTO',prop:'Visible'},{av:'edtUsuarioRequerimiento_Visible',ctrl:'USUARIOREQUERIMIENTO',prop:'Visible'},{av:'edtUsuarioEmail_Visible',ctrl:'USUARIOEMAIL',prop:'Visible'},{av:'edtUsuarioTelefono_Visible',ctrl:'USUARIOTELEFONO',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("GRID.LOAD","{handler:'E252G2',iparms:[{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED","{handler:'E112G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV61Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'AV58Uri',fld:'vURI',pic:'',hsh:true},{av:'sPrefix'},{av:'AV41DeletedTag',fld:'vDELETEDTAG',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED",",oparms:[{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{ctrl:'REPORT',prop:'Tooltiptext'},{ctrl:'EXPORT',prop:'Tooltiptext'},{ctrl:'INSERT',prop:'Tooltiptext'},{av:'AV54Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV55Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'divDownloadsactionssectioncontainer_Visible',ctrl:'DOWNLOADSACTIONSSECTIONCONTAINER',prop:'Visible'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{ctrl:'INSERT',prop:'Visible'},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'edtUsuarioId_Visible',ctrl:'USUARIOID',prop:'Visible'},{av:'edtUsuarioNombre_Visible',ctrl:'USUARIONOMBRE',prop:'Visible'},{av:'edtUsuarioFecha_Visible',ctrl:'USUARIOFECHA',prop:'Visible'},{av:'edtUsuarioHora_Visible',ctrl:'USUARIOHORA',prop:'Visible'},{av:'edtUsuarioGerencia_Visible',ctrl:'USUARIOGERENCIA',prop:'Visible'},{av:'edtUsuarioDepartamento_Visible',ctrl:'USUARIODEPARTAMENTO',prop:'Visible'},{av:'edtUsuarioRequerimiento_Visible',ctrl:'USUARIOREQUERIMIENTO',prop:'Visible'},{av:'edtUsuarioEmail_Visible',ctrl:'USUARIOEMAIL',prop:'Visible'},{av:'edtUsuarioTelefono_Visible',ctrl:'USUARIOTELEFONO',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E122G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV61Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'AV58Uri',fld:'vURI',pic:'',hsh:true},{av:'sPrefix'},{av:'AV46UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'TOGGLEGRIDSETTINGSTABLE'","{handler:'E262G1',iparms:[{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'TOGGLEGRIDSETTINGSTABLE'",",oparms:[{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E142G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV61Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'AV58Uri',fld:'vURI',pic:'',hsh:true},{av:'sPrefix'},{av:'AV25RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV24GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'SAVEGRIDSETTINGS'",",oparms:[{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV46UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{av:'AV25RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{ctrl:'REPORT',prop:'Tooltiptext'},{ctrl:'EXPORT',prop:'Tooltiptext'},{ctrl:'INSERT',prop:'Tooltiptext'},{av:'AV54Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV55Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'divDownloadsactionssectioncontainer_Visible',ctrl:'DOWNLOADSACTIONSSECTIONCONTAINER',prop:'Visible'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{ctrl:'INSERT',prop:'Visible'},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'edtUsuarioId_Visible',ctrl:'USUARIOID',prop:'Visible'},{av:'edtUsuarioNombre_Visible',ctrl:'USUARIONOMBRE',prop:'Visible'},{av:'edtUsuarioFecha_Visible',ctrl:'USUARIOFECHA',prop:'Visible'},{av:'edtUsuarioHora_Visible',ctrl:'USUARIOHORA',prop:'Visible'},{av:'edtUsuarioGerencia_Visible',ctrl:'USUARIOGERENCIA',prop:'Visible'},{av:'edtUsuarioDepartamento_Visible',ctrl:'USUARIODEPARTAMENTO',prop:'Visible'},{av:'edtUsuarioRequerimiento_Visible',ctrl:'USUARIOREQUERIMIENTO',prop:'Visible'},{av:'edtUsuarioEmail_Visible',ctrl:'USUARIOEMAIL',prop:'Visible'},{av:'edtUsuarioTelefono_Visible',ctrl:'USUARIOTELEFONO',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("'DOFIRST'","{handler:'E152G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV61Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'AV58Uri',fld:'vURI',pic:'',hsh:true},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E162G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV61Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'AV58Uri',fld:'vURI',pic:'',hsh:true},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E172G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV61Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'AV58Uri',fld:'vURI',pic:'',hsh:true},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E182G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV61Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'AV58Uri',fld:'vURI',pic:'',hsh:true},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOEXPORT'","{handler:'E192G2',iparms:[{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV58Uri',fld:'vURI',pic:'',hsh:true},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOEXPORT'",",oparms:[{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("'TOGGLEDOWNLOADACTIONS'","{handler:'E272G1',iparms:[{av:'divDownloadactionstable_Visible',ctrl:'DOWNLOADACTIONSTABLE',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'TOGGLEDOWNLOADACTIONS'",",oparms:[{av:'divDownloadactionstable_Visible',ctrl:'DOWNLOADACTIONSTABLE',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("FILTERTOGGLE_COMBINED.CLICK","{handler:'E202G2',iparms:[{av:'divFiltercollapsiblesection_combined_Visible',ctrl:'FILTERCOLLAPSIBLESECTION_COMBINED',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERCLOSE_COMBINED.CLICK","{handler:'E212G2',iparms:[{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("NULL","{handler:'Validv_Delete',iparms:[{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("NULL",",oparms:[{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         H002G2_A95UsuarioTelefono = new int[1] ;
         H002G2_A89UsuarioEmail = new string[] {""} ;
         H002G2_A94UsuarioRequerimiento = new string[] {""} ;
         H002G2_A88UsuarioDepartamento = new string[] {""} ;
         H002G2_A91UsuarioGerencia = new string[] {""} ;
         H002G2_A92UsuarioHora = new DateTime[] {DateTime.MinValue} ;
         H002G2_A90UsuarioFecha = new DateTime[] {DateTime.MinValue} ;
         H002G2_A93UsuarioNombre = new string[] {""} ;
         H002G2_A15UsuarioId = new long[1] ;
         ...
         sCtrlAV6EstadoTicketId = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.estadoticketusuariowc__default(),
            new Object[][] {
                new Object[] {
               H002G2_A95UsuarioTelefono, H002G2_A89UsuarioEmail, H002G2_A94UsuarioRequerimiento, H002G2_A88UsuarioDepartamento, H002G2_A91UsuarioGerencia, H002G2_A92UsuarioHora, H002G2_A90UsuarioFecha, H002G2_A93UsuarioNombre, H002G2_A15UsuarioId
               }
               , new Object[] {
      ...
      private short AV6EstadoTicketId ;
      private short wcpOAV6EstadoTicketId ;
      ...
      private string sCtrlAV6EstadoTicketId ;
      ...
      private DateTime AV36UsuarioHora_From ;
      private DateTime AV37UsuarioHora_To ;
      private DateTime A92UsuarioHora ;
      private DateTime AV35UsuarioHora ;
      private DateTime GXt_dtime3 ;
      private DateTime AV33UsuarioFecha_From ;
      private DateTime AV34UsuarioFecha_To ;
      private DateTime A90UsuarioFecha ;
      private DateTime AV32UsuarioFecha ;
      private bool entryPointCalled ;
      private bool toggleJsOutput ;
      private bool AV53UsuarioNombre_IsAuthorized ;
      private bool AV15Att_UsuarioId_Visible ;
      private bool AV16Att_UsuarioNombre_Visible ;
      private bool AV17Att_UsuarioFecha_Visible ;
      private bool AV18Att_UsuarioHora_Visible ;
      private bool AV19Att_UsuarioGerencia_Visible ;
      private bool AV20Att_UsuarioDepartamento_Visible ;
      private bool AV21Att_UsuarioRequerimiento_Visible ;
      private bool AV22Att_UsuarioEmail_Visible ;
      private bool AV23Att_UsuarioTelefono_Visible ;
      ...
      private bool AV54Update_IsBlob ;
      private bool AV55Delete_IsBlob ;
      private string AV31UsuarioNombre ;
      private string AV58Uri ;
      ...
      private int[] H002G2_A95UsuarioTelefono ;
      private string[] H002G2_A89UsuarioEmail ;
      private string[] H002G2_A94UsuarioRequerimiento ;
      private string[] H002G2_A88UsuarioDepartamento ;
      private string[] H002G2_A91UsuarioGerencia ;
      private DateTime[] H002G2_A92UsuarioHora ;
      private DateTime[] H002G2_A90UsuarioFecha ;
      private string[] H002G2_A93UsuarioNombre ;
      private long[] H002G2_A15UsuarioId ;
      ...
      private SdtK2BTrnContext_Attribute AV50TrnContextAtt ;
      private SdtK2BActivityList_K2BActivityListItem AV52ActivityListItem ;
   }

   public class estadoticketusuariowc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV6EstadoTicketId )
      {
         ...
         sOrderString = "";
         AddWhere(sWhereString, "(@EstadoTicketId = @AV6EstadoTicketId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV31UsuarioNombre)) )
         {
         ...
         if ( ! (DateTime.MinValue==AV34UsuarioFecha_To) )
         {
            AddWhere(sWhereString, "([UsuarioFecha] <= @AV34UsuarioFecha_To)");
         }
         else
         {
            GXv_int5[3] = 1;
         }
         if ( ! (DateTime.MinValue==AV33UsuarioFecha_From) )
         {
            AddWhere(sWhereString, "([UsuarioFecha] >= @AV33UsuarioFecha_From)");
         }
         else
         {
            GXv_int5[4] = 1;
         }
         if ( ! (DateTime.MinValue==AV37UsuarioHora_To) )
         {
            AddWhere(sWhereString, "([UsuarioHora] <= @AV37UsuarioHora_To)");
         }
         else
         {
            GXv_int5[5] = 1;
         }
         if ( ! (DateTime.MinValue==AV36UsuarioHora_From) )
         {
            AddWhere(sWhereString, "([UsuarioHora] >= @AV36UsuarioHora_From)");
         }
         else
         {
            GXv_int5[6] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002G2(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (DateTime)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (DateTime)dynConstraints[7] , (DateTime)dynConstraints[8] , (long)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (int)dynConstraints[14] , (short)dynConstraints[15] , (short)dynConstraints[16] , (short)dynConstraints[17] );
               case 1 :
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6EstadoTicketId",GXType.Int16,4,0) ,
          new ParDef("@lV31UsuarioNombre",GXType.NVarChar,60,0) ,
          new ParDef("@AV34UsuarioFecha_To",GXType.Date,8,0) ,
          new ParDef("@AV33UsuarioFecha_From",GXType.Date,8,0) ,
          new ParDef("@AV37UsuarioHora_To",GXType.DateTime,0,5) ,
          new ParDef("@AV36UsuarioHora_From",GXType.DateTime,0,5) ,
