...
namespace GeneXus.Programs {
   public class wwestado : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV29K2BToolsGenericSearchField, AV24EstadoNombre, AV23ClassCollection, AV30OrderedBy, AV48Pgmname, AV8CurrentPage, AV10GridConfiguration, AV36EstadoNombre_IsAuthorized, AV14Att_EstadoId_Visible, AV15Att_EstadoNombre_Visible, AV16Att_EstadoActivo_Visible, AV11FreezeColumnTitles, AV45Uri) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188151588", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vURI", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV45Uri, "")), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vURI", AV45Uri);
         GxWebStd.gx_hidden_field( context, "gxhash_vURI", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV45Uri, "")), context));
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV37Update)) ? AV50Update_GXI : context.convertURL( context.PathToRelativeUrl( AV37Update))), !bGXsfl_133_Refreshing);
                              ...
                              AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV38Delete)) ? AV51Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV38Delete))), !bGXsfl_133_Refreshing);
      ...
      protected void E22222( )
      {
         ...
         AV24EstadoNombre = "";
         AssignAttri("", false, "AV24EstadoNombre", AV24EstadoNombre);
         new k2bloadrowsperpage(context ).execute(  AV48Pgmname,  "Grid", out  AV18RowsPerPageVariable, out  AV19RowsPerPageLoaded) ;
      ...
      protected void E23222( )
      {
         ...
         AV49GXV1 = 1;
         while ( AV49GXV1 <= AV34Messages.Count )
         {
            AV35Message = ((GeneXus.Utils.SdtMessages_Message)AV34Messages.Item(AV49GXV1));
         ...
         AV42ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV48Pgmname;
         ...
         AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV37Update)) ? AV50Update_GXI : context.convertURL( context.PathToRelativeUrl( AV37Update))), !bGXsfl_133_Refreshing);
         AssignProp("", false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV37Update), true);
         AV50Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "788f9b72-f982-49f9-99e4-c0374e31a85a", "", context.GetTheme( )));
         AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV37Update)) ? AV50Update_GXI : context.convertURL( context.PathToRelativeUrl( AV37Update))), !bGXsfl_133_Refreshing);
         AssignProp("", false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV37Update), true);
         ...
         AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV38Delete)) ? AV51Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV38Delete))), !bGXsfl_133_Refreshing);
         AssignProp("", false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV38Delete), true);
         AV51Delete_GXI = GXDbFile.PathToUrl( context.GetImagePath( "3e4a9f50-2c57-41b6-9da5-ebe49bca33c0", "", context.GetTheme( )));
         AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV38Delete)) ? AV51Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV38Delete))), !bGXsfl_133_Refreshing);
         AssignProp("", false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV38Delete), true);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV20GridStateKey = "";
         new k2bloadgridstate(context ).execute(  AV48Pgmname,  AV20GridStateKey, out  AV21GridState) ;
         ...
         AV52GXV2 = 1;
         while ( AV52GXV2 <= AV21GridState.gxTpr_Filtervalues.Count )
         {
            AV22GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV21GridState.gxTpr_Filtervalues.Item(AV52GXV2));
      ...
      protected void S132( )
      {
         ...
         AV21GridState.gxTpr_Filtervalues.Add(AV22GridStateFilterValue, 0);
         new k2bsavegridstate(context ).execute(  AV48Pgmname,  AV20GridStateKey,  AV21GridState) ;
      }
      ...
      protected void S202( )
      {
         ...
         AssignAttri("", false, "AV16Att_EstadoActivo_Visible", AV16Att_EstadoActivo_Visible);
         new k2bsavegridconfiguration(context ).execute(  AV48Pgmname,  "Grid",  AV10GridConfiguration,  false) ;
         AV53GXV3 = 1;
         while ( AV53GXV3 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV13GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV10GridConfiguration.gxTpr_Gridcolumns.Item(AV53GXV3));
      ...
      protected void S122( )
      {
         ...
         if ( AV25K2BFilterValuesSDT.Count > 0 )
         {
            ...
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV48Pgmname,  "Grid",  AV25K2BFilterValuesSDT, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item3) ;
      ...
      protected void E14222( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  AV48Pgmname,  "Grid", ref  AV10GridConfiguration) ;
         AV54GXV4 = 1;
         while ( AV54GXV4 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV13GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV10GridConfiguration.gxTpr_Gridcolumns.Item(AV54GXV4));
            if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "EstadoId") == 0 )
            {
         ...
         new k2bsavegridconfiguration(context ).execute(  AV48Pgmname,  "Grid",  AV10GridConfiguration,  true) ;
         AV33UC_OrderedBy = AV30OrderedBy;
         AssignAttri("", false, "AV33UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV33UC_OrderedBy), 4, 0));
         if ( AV18RowsPerPageVariable != AV17GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV18RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV48Pgmname,  "Grid",  AV18RowsPerPageVariable) ;
            AV8CurrentPage = 1;
            AssignAttri("", false, "AV8CurrentPage", StringUtil.LTrimStr( (decimal)(AV8CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void E19222( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "Estado",  "Estado",  "List",  "",  "ExportWWEstado") )
         {
            new exportwwestado(context ).execute(  AV24EstadoNombre,  AV29K2BToolsGenericSearchField,  AV30OrderedBy, out  AV43OutFile) ;
            if ( new k2bt_isinexternalstorage(context).executeUdp(  AV43OutFile, out  AV45Uri) )
            {
               CallWebObject(formatLink(AV45Uri) );
               context.wjLocDisableFrm = 0;
            }
            else
            {
               AV44Guid = (Guid)(Guid.NewGuid( ));
               new k2bsessionset(context ).execute(  AV44Guid.ToString(),  AV43OutFile) ;
               CallWebObject(formatLink("k2bt_returnfileinhttpresponse.aspx", new object[] {UrlEncode(AV44Guid.ToString())}, new string[] {"Guid"}) );
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188152197", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwestado.js", "?2024188152199", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
      ...
      protected void sendrow_1332( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_133_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV37Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV37Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV50Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV37Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV37Update)) ? AV50Update_GXI : context.PathToRelativeUrl( AV37Update));
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV38Delete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV38Delete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV51Delete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV38Delete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV38Delete)) ? AV51Delete_GXI : context.PathToRelativeUrl( AV38Delete));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.REFRESH","{handler:'E24222',iparms:[{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV24EstadoNombre',fld:'vESTADONOMBRE',pic:''},{av:'AV48Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV36EstadoNombre_IsAuthorized',fld:'vESTADONOMBRE_ISAUTHORIZED',pic:''},{av:'AV45Uri',fld:'vURI',pic:'',hsh:true},{av:'AV14Att_EstadoId_Visible',fld:'vATT_ESTADOID_VISIBLE',pic:''},{av:'AV15Att_EstadoNombre_Visible',fld:'vATT_ESTADONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EstadoActivo_Visible',fld:'vATT_ESTADOACTIVO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED","{handler:'E11222',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV24EstadoNombre',fld:'vESTADONOMBRE',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV48Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV36EstadoNombre_IsAuthorized',fld:'vESTADONOMBRE_ISAUTHORIZED',pic:''},{av:'AV45Uri',fld:'vURI',pic:'',hsh:true},{av:'AV28DeletedTag',fld:'vDELETEDTAG',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EstadoId_Visible',fld:'vATT_ESTADOID_VISIBLE',pic:''},{av:'AV15Att_EstadoNombre_Visible',fld:'vATT_ESTADONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EstadoActivo_Visible',fld:'vATT_ESTADOACTIVO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E12222',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV24EstadoNombre',fld:'vESTADONOMBRE',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV48Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV36EstadoNombre_IsAuthorized',fld:'vESTADONOMBRE_ISAUTHORIZED',pic:''},{av:'AV45Uri',fld:'vURI',pic:'',hsh:true},{av:'AV33UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EstadoId_Visible',fld:'vATT_ESTADOID_VISIBLE',pic:''},{av:'AV15Att_EstadoNombre_Visible',fld:'vATT_ESTADONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EstadoActivo_Visible',fld:'vATT_ESTADOACTIVO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E15222',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV24EstadoNombre',fld:'vESTADONOMBRE',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV48Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV36EstadoNombre_IsAuthorized',fld:'vESTADONOMBRE_ISAUTHORIZED',pic:''},{av:'AV45Uri',fld:'vURI',pic:'',hsh:true},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EstadoId_Visible',fld:'vATT_ESTADOID_VISIBLE',pic:''},{av:'AV15Att_EstadoNombre_Visible',fld:'vATT_ESTADONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EstadoActivo_Visible',fld:'vATT_ESTADOACTIVO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E16222',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV24EstadoNombre',fld:'vESTADONOMBRE',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV48Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV36EstadoNombre_IsAuthorized',fld:'vESTADONOMBRE_ISAUTHORIZED',pic:''},{av:'AV45Uri',fld:'vURI',pic:'',hsh:true},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EstadoId_Visible',fld:'vATT_ESTADOID_VISIBLE',pic:''},{av:'AV15Att_EstadoNombre_Visible',fld:'vATT_ESTADONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EstadoActivo_Visible',fld:'vATT_ESTADOACTIVO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E17222',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV24EstadoNombre',fld:'vESTADONOMBRE',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV48Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV36EstadoNombre_IsAuthorized',fld:'vESTADONOMBRE_ISAUTHORIZED',pic:''},{av:'AV45Uri',fld:'vURI',pic:'',hsh:true},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EstadoId_Visible',fld:'vATT_ESTADOID_VISIBLE',pic:''},{av:'AV15Att_EstadoNombre_Visible',fld:'vATT_ESTADONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EstadoActivo_Visible',fld:'vATT_ESTADOACTIVO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E18222',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV24EstadoNombre',fld:'vESTADONOMBRE',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV48Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV36EstadoNombre_IsAuthorized',fld:'vESTADONOMBRE_ISAUTHORIZED',pic:''},{av:'AV45Uri',fld:'vURI',pic:'',hsh:true},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EstadoId_Visible',fld:'vATT_ESTADOID_VISIBLE',pic:''},{av:'AV15Att_EstadoNombre_Visible',fld:'vATT_ESTADONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EstadoActivo_Visible',fld:'vATT_ESTADOACTIVO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOEXPORT'","{handler:'E19222',iparms:[{av:'AV24EstadoNombre',fld:'vESTADONOMBRE',pic:''},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV45Uri',fld:'vURI',pic:'',hsh:true},{av:'AV14Att_EstadoId_Visible',fld:'vATT_ESTADOID_VISIBLE',pic:''},{av:'AV15Att_EstadoNombre_Visible',fld:'vATT_ESTADONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EstadoActivo_Visible',fld:'vATT_ESTADOACTIVO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOEXPORT'",",oparms:[{av:'AV14Att_EstadoId_Visible',fld:'vATT_ESTADOID_VISIBLE',pic:''},{av:'AV15Att_EstadoNombre_Visible',fld:'vATT_ESTADONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EstadoActivo_Visible',fld:'vATT_ESTADOACTIVO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
