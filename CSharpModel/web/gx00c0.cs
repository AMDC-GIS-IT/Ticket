...
namespace GeneXus.Programs {
   public class gx00c0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188224528", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB5H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavCid_unidad_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cid_unidad), 9, 0, ".", "")), StringUtil.LTrim( ((edtavCid_unidad_Enabled!=0) ? context.localUtil.Format( (decimal)(AV6cid_unidad), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(AV6cid_unidad), "ZZZZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCid_unidad_Jsonclick, 0, "Attribute", "", "", "", "", edtavCid_unidad_Visible, edtavCid_unidad_Enabled, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx00C0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCunidades_gisestado_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7cunidades_gisestado), 9, 0, ".", "")), StringUtil.LTrim( ((edtavCunidades_gisestado_Enabled!=0) ? context.localUtil.Format( (decimal)(AV7cunidades_gisestado), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(AV7cunidades_gisestado), "ZZZZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCunidades_gisestado_Jsonclick, 0, "Attribute", "", "", "", "", edtavCunidades_gisestado_Visible, edtavCunidades_gisestado_Enabled, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx00C0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCunidades_gishora_creacion_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9cunidades_gishora_creacion), 5, 0, ".", "")), StringUtil.LTrim( ((edtavCunidades_gishora_creacion_Enabled!=0) ? context.localUtil.Format( (decimal)(AV9cunidades_gishora_creacion), "ZZZZ9") : context.localUtil.Format( (decimal)(AV9cunidades_gishora_creacion), "ZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCunidades_gishora_creacion_Jsonclick, 0, "Attribute", "", "", "", "", edtavCunidades_gishora_creacion_Visible, edtavCunidades_gishora_creacion_Enabled, 0, "text", "1", 5, "chr", 1, "row", 5, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx00C0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCunidades_gishora_modificacion_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12cunidades_gishora_modificacion), 5, 0, ".", "")), StringUtil.LTrim( ((edtavCunidades_gishora_modificacion_Enabled!=0) ? context.localUtil.Format( (decimal)(AV12cunidades_gishora_modificacion), "ZZZZ9") : context.localUtil.Format( (decimal)(AV12cunidades_gishora_modificacion), "ZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,76);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCunidades_gishora_modificacion_Jsonclick, 0, "Attribute", "", "", "", "", edtavCunidades_gishora_modificacion_Visible, edtavCunidades_gishora_modificacion_Enabled, 0, "text", "1", 5, "chr", 1, "row", 5, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx00C0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF5H2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H005H2 */
            pr_datastore1.execute(0, new Object[] {AV6cid_unidad, AV7cunidades_gisestado, AV8cunidades_gisfecha_creacion, AV9cunidades_gishora_creacion, lV10cunidades_giscreado_por, AV11cunidades_gisfecha_modificacion, AV12cunidades_gishora_modificacion, GXPagingFrom2, GXPagingTo2, GXPagingFrom2, GXPagingTo2});
            nGXsfl_84_idx = 1;
            sGXsfl_84_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_84_idx), 4, 0), 4, "0");
            SubsflControlProps_842( ) ;
      ...
      protected void STRUP5H0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( DateTimeUtil.ResetTime ( context.localUtil.CToD( cgiGet( "GXH_vCUNIDADES_GISFECHA_CREACION"), 2) ) != DateTimeUtil.ResetTime ( AV8cunidades_gisfecha_creacion ) )
            {
               GRID1_nFirstRecordOnPage = 0;
            }
            if ( ( context.localUtil.CToN( cgiGet( "GXH_vCUNIDADES_GISHORA_CREACION"), ".", ",") != Convert.ToDecimal( AV9cunidades_gishora_creacion )) )
            ...
            if ( DateTimeUtil.ResetTime ( context.localUtil.CToD( cgiGet( "GXH_vCUNIDADES_GISFECHA_MODIFICACION"), 2) ) != DateTimeUtil.ResetTime ( AV11cunidades_gisfecha_modificacion ) )
            {
               GRID1_nFirstRecordOnPage = 0;
            }
            if ( ( context.localUtil.CToN( cgiGet( "GXH_vCUNIDADES_GISHORA_MODIFICACION"), ".", ",") != Convert.ToDecimal( AV12cunidades_gishora_modificacion )) )
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188224616", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00c0.js", "?2024188224617", false, true);
      ...
      protected void sendrow_842( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_84_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtid_unidad_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A103id_unidad), 9, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A103id_unidad), "ZZZZZZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtid_unidad_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)9,(short)0,(short)0,(short)84,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtunidades_gisestado_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A115unidades_gisestado), 9, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A115unidades_gisestado), "ZZZZZZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtunidades_gisestado_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn OptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)9,(short)0,(short)0,(short)84,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
