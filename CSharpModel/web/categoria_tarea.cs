...
namespace GeneXus.Programs {
   public class categoria_tarea : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtcategoria_tareaid_tipo_categoria_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A104categoria_tareaid_tipo_categoria), 9, 0, ".", "")), StringUtil.LTrim( ((edtcategoria_tareaid_tipo_categoria_Enabled!=0) ? context.localUtil.Format( (decimal)(A104categoria_tareaid_tipo_categoria), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(A104categoria_tareaid_tipo_categoria), "ZZZZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtcategoria_tareaid_tipo_categoria_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtcategoria_tareaid_tipo_categoria_Enabled, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_categoria_tarea.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtid_unidad_gis_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A105id_unidad_gis), 9, 0, ".", "")), StringUtil.LTrim( ((edtid_unidad_gis_Enabled!=0) ? context.localUtil.Format( (decimal)(A105id_unidad_gis), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(A105id_unidad_gis), "ZZZZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,24);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtid_unidad_gis_Jsonclick, 0, edtid_unidad_gis_Class, "", "", "", "", 1, edtid_unidad_gis_Enabled, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_categoria_tarea.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtcategoria_tareaestado_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A107categoria_tareaestado), 9, 0, ".", "")), StringUtil.LTrim( ((edtcategoria_tareaestado_Enabled!=0) ? context.localUtil.Format( (decimal)(A107categoria_tareaestado), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(A107categoria_tareaestado), "ZZZZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,36);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtcategoria_tareaestado_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtcategoria_tareaestado_Enabled, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_categoria_tarea.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtcategoria_tareahora_creacion_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A109categoria_tareahora_creacion), 5, 0, ".", "")), StringUtil.LTrim( ((edtcategoria_tareahora_creacion_Enabled!=0) ? context.localUtil.Format( (decimal)(A109categoria_tareahora_creacion), "ZZZZ9") : context.localUtil.Format( (decimal)(A109categoria_tareahora_creacion), "ZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,48);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtcategoria_tareahora_creacion_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtcategoria_tareahora_creacion_Enabled, 0, "text", "1", 5, "chr", 1, "row", 5, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_categoria_tarea.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtcategoria_tareahora_modificacion_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A112categoria_tareahora_modificacion), 5, 0, ".", "")), StringUtil.LTrim( ((edtcategoria_tareahora_modificacion_Enabled!=0) ? context.localUtil.Format( (decimal)(A112categoria_tareahora_modificacion), "ZZZZ9") : context.localUtil.Format( (decimal)(A112categoria_tareahora_modificacion), "ZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,66);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtcategoria_tareahora_modificacion_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtcategoria_tareahora_modificacion_Enabled, 0, "text", "1", 5, "chr", 1, "row", 5, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_categoria_tarea.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void CheckExtendedTable0D14( )
      {
         ...
         if ( ! ( (DateTime.MinValue==A108categoria_tareafecha_creacion) || ( DateTimeUtil.ResetTime ( A108categoria_tareafecha_creacion ) >= DateTimeUtil.ResetTime ( context.localUtil.YMDToD( 1753, 1, 1) ) ) ) )
         {
         ...
         if ( ! ( (DateTime.MinValue==A111categoria_tareafecha_modificacion) || ( DateTimeUtil.ResetTime ( A111categoria_tareafecha_modificacion ) >= DateTimeUtil.ResetTime ( context.localUtil.YMDToD( 1753, 1, 1) ) ) ) )
         {
      ...
      protected void CheckOptimisticConcurrency0D14( )
      {
         if ( ! IsIns( ) )
         {
            ...
            Gx_longc = false;
            if ( (pr_datastore1.getStatus(0) == 101) || ( Z105id_unidad_gis != T000D2_A105id_unidad_gis[0] ) || ( StringUtil.StrCmp(Z106nombre_categoria, T000D2_A106nombre_categoria[0]) != 0 ) || ( Z107categoria_tareaestado != T000D2_A107categoria_tareaestado[0] ) || ( DateTimeUtil.ResetTime ( Z108categoria_tareafecha_creacion ) != DateTimeUtil.ResetTime ( T000D2_A108categoria_tareafecha_creacion[0] ) ) || ( Z109categoria_tareahora_creacion != T000D2_A109categoria_tareahora_creacion[0] ) )
            {
               Gx_longc = true;
            }
            if ( Gx_longc || ( StringUtil.StrCmp(Z110categoria_tareacreado_por, T000D2_A110categoria_tareacreado_por[0]) != 0 ) || ( DateTimeUtil.ResetTime ( Z111categoria_tareafecha_modificacion ) != DateTimeUtil.ResetTime ( T000D2_A111categoria_tareafecha_modificacion[0] ) ) || ( Z112categoria_tareahora_modificacion != T000D2_A112categoria_tareahora_modificacion[0] ) || ( StringUtil.StrCmp(Z113categoria_tareamodificado_por, T000D2_A113categoria_tareamodificado_por[0]) != 0 ) )
            {
               ...
               if ( DateTimeUtil.ResetTime ( Z108categoria_tareafecha_creacion ) != DateTimeUtil.ResetTime ( T000D2_A108categoria_tareafecha_creacion[0] ) )
               {
               ...
               if ( DateTimeUtil.ResetTime ( Z111categoria_tareafecha_modificacion ) != DateTimeUtil.ResetTime ( T000D2_A111categoria_tareafecha_modificacion[0] ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188104816", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188104838", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("categoria_tarea.js", "?2024188104838", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
