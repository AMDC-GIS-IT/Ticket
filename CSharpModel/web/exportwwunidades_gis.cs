...
namespace GeneXus.Programs {
   public class exportwwunidades_gis : GXProcedure
   {
                           ...
                           out string aP7_OutFile )
      {
         ...
         initialize();
         executePrivate();
         aP7_OutFile=this.AV40OutFile;
      }

      public string executeUdp( string aP0_nombre_unidad ,
                                DateTime aP1_unidades_gisfecha_creacion_From ,
                                DateTime aP2_unidades_gisfecha_creacion_To ,
                                DateTime aP3_unidades_gisfecha_modificacion_From ,
                                DateTime aP4_unidades_gisfecha_modificacion_To ,
                                ...
                                short aP6_OrderedBy )
      {
         execute(aP0_nombre_unidad, aP1_unidades_gisfecha_creacion_From, aP2_unidades_gisfecha_creacion_To, aP3_unidades_gisfecha_modificacion_From, aP4_unidades_gisfecha_modificacion_To, aP5_K2BToolsGenericSearchField, aP6_OrderedBy, out aP7_OutFile);
         return AV40OutFile ;
      }
                                 ...
                                 out string aP7_OutFile )
      {
         ...
         objexportwwunidades_gis.AV40OutFile = "" ;
      ...
      void executePrivate( )
      {
         ...
         AV40OutFile = GxDirectory.TemporaryFilesPath + AV29File.Separator + "ExportWWunidades_gis-" + Guid.NewGuid( ).ToString() + ".xlsx";
         AV21ExcelDocument.Open(AV40OutFile);
