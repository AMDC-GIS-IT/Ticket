...
namespace GeneXus.Programs {
   public class entitymanagerareasatencion : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public entitymanagerareasatencion( )
      {
      ...
      public entitymanagerareasatencion( IGxContext context )
      {
                           ...
                           string aP2_TabCode )
      {
         ...
         this.AV6AreasAtencionId = aP1_AreasAtencionId;
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  ...
                  AssignAttri("", false, "AV6AreasAtencionId", StringUtil.LTrimStr( (decimal)(AV6AreasAtencionId), 4, 0));
                  GxWebStd.gx_hidden_field( context, "gxhash_vAREASATENCIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6AreasAtencionId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188223262", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("entitymanagerareasatencion.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6AreasAtencionId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Gx_mode","AreasAtencionId","TabCode"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vMODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( Gx_mode, "@!")), context));
         GxWebStd.gx_hidden_field( context, "vAREASATENCIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6AreasAtencionId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vAREASATENCIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6AreasAtencionId), "ZZZ9"), context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Componentwc_listarequerimientos == null ) )
         {
            WebComp_Componentwc_listarequerimientos.componentjscripts();
         }
      ...
      {
         return formatLink("entitymanagerareasatencion.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6AreasAtencionId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Gx_mode","AreasAtencionId","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "EntityManagerAreasAtencion" ;
      }

      public override string GetPgmdesc( )
      {
         return "Áreas de atención" ;
      }
      ...
      protected void WB870( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblK2bpgmdesc_Internalname, lblK2bpgmdesc_Caption, "", "", lblK2bpgmdesc_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_EntityManagerAreasAtencion.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblBacktoworkwith_Internalname, lblBacktoworkwith_Caption, lblBacktoworkwith_Link, "", lblBacktoworkwith_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_BackToWorkWith", 0, "", 1, 1, 0, 0, "HLP_EntityManagerAreasAtencion.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divComponentcontainer_listarequerimientos_Internalname, divComponentcontainer_listarequerimientos_Visible, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0049"+"", StringUtil.RTrim( WebComp_Componentwc_listarequerimientos_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0049"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Componentwc_listarequerimientos_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldComponentwc_listarequerimientos), StringUtil.Lower( WebComp_Componentwc_listarequerimientos_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0049"+"");
                  }
                  WebComp_Componentwc_listarequerimientos.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldComponentwc_listarequerimientos), StringUtil.Lower( WebComp_Componentwc_listarequerimientos_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START872( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Áreas de atención", 0) ;
         }
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldComponentwc_listarequerimientos = cgiGet( "W0049");
                           if ( ( StringUtil.Len( OldComponentwc_listarequerimientos) == 0 ) || ( StringUtil.StrCmp(OldComponentwc_listarequerimientos, WebComp_Componentwc_listarequerimientos_Component) != 0 ) )
                           {
                              WebComp_Componentwc_listarequerimientos = getWebComponent(GetType(), "GeneXus.Programs", OldComponentwc_listarequerimientos, new Object[] {context} );
                              WebComp_Componentwc_listarequerimientos.ComponentInit();
                              WebComp_Componentwc_listarequerimientos.Name = "OldComponentwc_listarequerimientos";
                              WebComp_Componentwc_listarequerimientos_Component = OldComponentwc_listarequerimientos;
                           }
                           if ( StringUtil.Len( WebComp_Componentwc_listarequerimientos_Component) != 0 )
                           {
                              WebComp_Componentwc_listarequerimientos.componentprocess("W0049", "", sEvt);
                           }
                           WebComp_Componentwc_listarequerimientos_Component = OldComponentwc_listarequerimientos;
                        }
                        else if ( nCmpId == 60 )
      ...
      {
         /* GeneXus formulas. */
         AV27Pgmname = "EntityManagerAreasAtencion";
         context.Gx_err = 0;
      }
      ...
      protected void RF872( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Componentwc_listarequerimientos_Component) != 0 )
               {
                  WebComp_Componentwc_listarequerimientos.componentstart();
               }
            }
         }
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
      ...
      protected void E12872( )
      {
         /* Start Routine */
         returnInSub = false;
         lblBacktoworkwith_Caption = StringUtil.Format( "%1", "Áreas de atenciones", "", "", "", "", "", "", "", "");
         AssignProp("", false, lblBacktoworkwith_Internalname, "Caption", lblBacktoworkwith_Caption, true);
         lblBacktoworkwith_Link = formatLink("wwareasatencion.aspx") ;
         AssignProp("", false, lblBacktoworkwith_Internalname, "Link", lblBacktoworkwith_Link, true);
         AV26GXLvl7 = 0;
         /* Using cursor H00872 */
         pr_default.execute(0, new Object[] {AV6AreasAtencionId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A366AreasAtencionId = H00872_A366AreasAtencionId[0];
            A367AreasAtencionDescripcion = H00872_A367AreasAtencionDescripcion[0];
            AV26GXLvl7 = 1;
            Form.Caption = A367AreasAtencionDescripcion;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblK2bpgmdesc_Caption = StringUtil.Format( "%1 - %2", "Áreas de atención", A367AreasAtencionDescripcion, "", "", "", "", "", "", "");
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            lblK2bpgmdesc_Caption = "Áreas de atención";
            AssignProp("", false, lblK2bpgmdesc_Internalname, "Caption", lblK2bpgmdesc_Caption, true);
         }
      ...
      protected void E13872( )
      {
         ...
         {
            AV20RelatedTransactionName = "AreasAtencion";
            AssignAttri("", false, "AV20RelatedTransactionName", AV20RelatedTransactionName);
            GxWebStd.gx_hidden_field( context, "gxhash_vRELATEDTRANSACTIONNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV20RelatedTransactionName, "")), context));
         }
         else if ( StringUtil.StrCmp(AV8TabCode, "ListaRequerimientos") == 0 )
         {
            AV20RelatedTransactionName = "ListaRequerimientos";
            AssignAttri("", false, "AV20RelatedTransactionName", AV20RelatedTransactionName);
            GxWebStd.gx_hidden_field( context, "gxhash_vRELATEDTRANSACTIONNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV20RelatedTransactionName, "")), context));
         }
         ...
         if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               Tablemodal_Modaltitle = StringUtil.Format( "Actualizar %1", "Áreas de atención", "", "", "", "", "", "", "", "");
               ...
               if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Popupcomponent_Component), StringUtil.Lower( "AreasAtencion")) != 0 )
               {
                  WebComp_Popupcomponent = getWebComponent(GetType(), "GeneXus.Programs", "areasatencion", new Object[] {context} );
                  WebComp_Popupcomponent.ComponentInit();
                  WebComp_Popupcomponent.Name = "AreasAtencion";
                  WebComp_Popupcomponent_Component = "AreasAtencion";
               }
               if ( StringUtil.Len( WebComp_Popupcomponent_Component) != 0 )
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0060",(string)"",(string)"UPD",(short)AV6AreasAtencionId});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
         {
            if ( ( StringUtil.StrCmp(AV8TabCode, "General") == 0 ) || String.IsNullOrEmpty(StringUtil.RTrim( AV8TabCode)) )
            {
               Tablemodal_Modaltitle = StringUtil.Format( "Eliminar %1", "Áreas de atención", "", "", "", "", "", "", "", "");
               ucTablemodal.SendProperty(context, "", false, Tablemodal_Internalname, "ModalTitle", Tablemodal_Modaltitle);
               Tablemodal_Visible = true;
               ucTablemodal.SendProperty(context, "", false, Tablemodal_Internalname, "Visible", StringUtil.BoolToStr( Tablemodal_Visible));
               /* Object Property */
               ...
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0060",(string)"",(string)"DLT",(short)AV6AreasAtencionId});
                  WebComp_Popupcomponent.componentbind(new Object[] {(string)"",(string)""});
               }
               if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Popupcomponent )
               {
      ...
      protected void S112( )
      {
         ...
         AV11Tab.gxTpr_Link = formatLink("entitymanagerareasatencion.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6AreasAtencionId,4,0)),UrlEncode(StringUtil.RTrim(AV11Tab.gxTpr_Code))}, new string[] {"Mode","AreasAtencionId","TabCode"}) ;
         AV11Tab.gxTpr_Componenttype = 3;
         AV11Tab.gxTpr_Relatedtransaction = "AreasAtencion";
         AV10Tabs.Add(AV11Tab, 0);
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "ListaRequerimientos",  "ListaRequerimientos",  "List",  "",  "AreasAtencionListaRequerimientosWC") )
         {
            AV18AvailableComponents.Add("ListaRequerimientos", 0);
            AV11Tab = new SdtK2BTabOptions_K2BTabOptionsItem(context);
            AV11Tab.gxTpr_Code = "ListaRequerimientos";
            AV11Tab.gxTpr_Description = "Lista requerimientoses";
            AV11Tab.gxTpr_Link = formatLink("entitymanagerareasatencion.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6AreasAtencionId,4,0)),UrlEncode(StringUtil.RTrim(AV11Tab.gxTpr_Code))}, new string[] {"Mode","AreasAtencionId","TabCode"}) ;
            AV11Tab.gxTpr_Componenttype = 1;
            AV11Tab.gxTpr_Relatedtransaction = "ListaRequerimientos";
            AV10Tabs.Add(AV11Tab, 0);
         }
         if ( AV10Tabs.Count > 0 )
         {
            ...
            divComponentcontainer_listarequerimientos_Visible = 0;
            AssignProp("", false, divComponentcontainer_listarequerimientos_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(divComponentcontainer_listarequerimientos_Visible), 5, 0), true);
            ...
            else if ( ( StringUtil.StrCmp(AV8TabCode, "ListaRequerimientos") == 0 ) || ( String.IsNullOrEmpty(StringUtil.RTrim( AV8TabCode)) && ( StringUtil.StrCmp(((SdtK2BTabOptions_K2BTabOptionsItem)AV10Tabs.Item(1)).gxTpr_Code, "ListaRequerimientos") == 0 ) ) )
            {
               /* Execute user subroutine: 'LOADCOMPONENT_LISTAREQUERIMIENTOS' */
               S132 ();
               if (returnInSub) return;
            }
            else
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Componentwc_general_Component), StringUtil.Lower( "AreasAtencionGeneral")) != 0 )
            {
               WebComp_Componentwc_general = getWebComponent(GetType(), "GeneXus.Programs", "areasatenciongeneral", new Object[] {context} );
               WebComp_Componentwc_general.ComponentInit();
               WebComp_Componentwc_general.Name = "AreasAtencionGeneral";
               WebComp_Componentwc_general_Component = "AreasAtencionGeneral";
            }
            if ( StringUtil.Len( WebComp_Componentwc_general_Component) != 0 )
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0043",(string)"",(string)Gx_mode,(short)AV6AreasAtencionId,(string)AV8TabCode});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0043",(string)"",(string)"DSP",(short)AV6AreasAtencionId,(string)AV8TabCode});
               WebComp_Componentwc_general.componentbind(new Object[] {(string)"",(string)"",(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Componentwc_general )
            {
      ...
      protected void S132( )
      {
         /* 'LOADCOMPONENT_LISTAREQUERIMIENTOS' Routine */
         returnInSub = false;
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "ListaRequerimientos",  "ListaRequerimientos",  "List",  "",  "AreasAtencionListaRequerimientosWC") )
         {
            if ( StringUtil.StrCmp(Gx_mode, "INS") != 0 )
            {
               divComponentcontainer_listarequerimientos_Visible = 1;
               AssignProp("", false, divComponentcontainer_listarequerimientos_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(divComponentcontainer_listarequerimientos_Visible), 5, 0), true);
               /* Object Property */
               if ( true )
               {
                  bDynCreated_Componentwc_listarequerimientos = true;
               }
               if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Componentwc_listarequerimientos_Component), StringUtil.Lower( "AreasAtencionListaRequerimientosWC")) != 0 )
               {
                  WebComp_Componentwc_listarequerimientos = getWebComponent(GetType(), "GeneXus.Programs", "areasatencionlistarequerimientoswc", new Object[] {context} );
                  WebComp_Componentwc_listarequerimientos.ComponentInit();
                  WebComp_Componentwc_listarequerimientos.Name = "AreasAtencionListaRequerimientosWC";
                  WebComp_Componentwc_listarequerimientos_Component = "AreasAtencionListaRequerimientosWC";
               }
               if ( StringUtil.Len( WebComp_Componentwc_listarequerimientos_Component) != 0 )
               {
                  WebComp_Componentwc_listarequerimientos.setjustcreated();
                  WebComp_Componentwc_listarequerimientos.componentprepare(new Object[] {(string)"W0049",(string)"",(short)AV6AreasAtencionId});
                  WebComp_Componentwc_listarequerimientos.componentbind(new Object[] {(string)""});
               }
               if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Componentwc_listarequerimientos )
               {
                  context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0049"+"");
                  WebComp_Componentwc_listarequerimientos.componentdraw();
                  context.httpAjaxContext.ajax_rspEndCmp();
      ...
      protected void E14872( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV21GE_EntityManagerName)) || ( StringUtil.StrCmp(StringUtil.Lower( StringUtil.Trim( AV21GE_EntityManagerName)), StringUtil.Lower( StringUtil.Trim( AV27Pgmname))) == 0 ) )
         {
            ...
            else if ( StringUtil.StrCmp(AV22GE_ComponentName, "ListaRequerimientos") == 0 )
            {
               /* Execute user subroutine: 'LOADCOMPONENT_LISTAREQUERIMIENTOS' */
               S132 ();
               if (returnInSub) return;
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "Gx_mode", Gx_mode);
         AV6AreasAtencionId = Convert.ToInt16(getParm(obj,1));
         AssignAttri("", false, "AV6AreasAtencionId", StringUtil.LTrimStr( (decimal)(AV6AreasAtencionId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vAREASATENCIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6AreasAtencionId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Componentwc_listarequerimientos == null ) )
         {
            if ( StringUtil.Len( WebComp_Componentwc_listarequerimientos_Component) != 0 )
            {
               WebComp_Componentwc_listarequerimientos.componentthemes();
            }
         }
         if ( ! ( WebComp_Popupcomponent == null ) )
         {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188223345", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("entitymanagerareasatencion.js", "?2024188223347", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("UserControls/K2BT_ComponentRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divComponentcontainer_listarequerimientos_Internalname = "COMPONENTCONTAINER_LISTAREQUERIMIENTOS";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Áreas de atención";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV18AvailableComponents',fld:'vAVAILABLECOMPONENTS',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'AV20RelatedTransactionName',fld:'vRELATEDTRANSACTIONNAME',pic:'',hsh:true},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV6AreasAtencionId',fld:'vAREASATENCIONID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV20RelatedTransactionName',fld:'vRELATEDTRANSACTIONNAME',pic:'',hsh:true},{av:'Tablemodal_Visible',ctrl:'TABLEMODAL',prop:'Visible'},{av:'Tablemodal_Modaltitle',ctrl:'TABLEMODAL',prop:'ModalTitle'},{ctrl:'POPUPCOMPONENT'},{av:'AV18AvailableComponents',fld:'vAVAILABLECOMPONENTS',pic:'',hsh:true},{ctrl:'TABSTRIP'},{av:'divComponentcontainer_general_Visible',ctrl:'COMPONENTCONTAINER_GENERAL',prop:'Visible'},{av:'divComponentcontainer_listarequerimientos_Visible',ctrl:'COMPONENTCONTAINER_LISTAREQUERIMIENTOS',prop:'Visible'},{av:'Componentscontainer_components_Visible',ctrl:'COMPONENTSCONTAINER_COMPONENTS',prop:'Visible'},{ctrl:'COMPONENTWC_GENERAL'},{ctrl:'COMPONENTWC_LISTAREQUERIMIENTOS'}]}");
         setEventMetadata("GLOBALEVENTS.K2BT_REFRESHENTITYMANAGER","{handler:'E14872',iparms:[{av:'AV22GE_ComponentName',fld:'vGE_COMPONENTNAME',pic:''},{av:'AV21GE_EntityManagerName',fld:'vGE_ENTITYMANAGERNAME',pic:''},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV6AreasAtencionId',fld:'vAREASATENCIONID',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("GLOBALEVENTS.K2BT_REFRESHENTITYMANAGER",",oparms:[{av:'divComponentcontainer_general_Visible',ctrl:'COMPONENTCONTAINER_GENERAL',prop:'Visible'},{ctrl:'COMPONENTWC_GENERAL'},{ctrl:'COMPONENTWC_LISTAREQUERIMIENTOS'},{av:'divComponentcontainer_listarequerimientos_Visible',ctrl:'COMPONENTCONTAINER_LISTAREQUERIMIENTOS',prop:'Visible'}]}");
         setEventMetadata("TABLEMODAL.ONCLOSE","{handler:'E11872',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         WebComp_Componentwc_listarequerimientos_Component = "";
         OldComponentwc_listarequerimientos = "";
         ...
         sEvtType = "";
         scmdbuf = "";
         H00872_A366AreasAtencionId = new short[1] ;
         H00872_A367AreasAtencionDescripcion = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.entitymanagerareasatencion__default(),
            new Object[][] {
                new Object[] {
               H00872_A366AreasAtencionId, H00872_A367AreasAtencionDescripcion
               }
            }
         );
         WebComp_Tabstrip = new GeneXus.Http.GXNullWebComponent();
         WebComp_Componentwc_general = new GeneXus.Http.GXNullWebComponent();
         WebComp_Componentwc_listarequerimientos = new GeneXus.Http.GXNullWebComponent();
      ...
      private int divComponentcontainer_listarequerimientos_Visible ;
      ...
      private string divComponentcontainer_listarequerimientos_Internalname ;
      private string WebComp_Componentwc_listarequerimientos_Component ;
      private string OldComponentwc_listarequerimientos ;
      ...
      private bool bDynCreated_Componentwc_listarequerimientos ;
      ...
      private GXWebComponent WebComp_Componentwc_listarequerimientos ;
      ...
      private short[] H00872_A366AreasAtencionId ;
      private string[] H00872_A367AreasAtencionDescripcion ;
   ...
   public class entitymanagerareasatencion__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00872", "SELECT TOP 1 [AreasAtencionId], [AreasAtencionDescripcion] FROM [AreasAtencion] WHERE [AreasAtencionId] = @AV6AreasAtencionId ORDER BY [AreasAtencionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00872,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
