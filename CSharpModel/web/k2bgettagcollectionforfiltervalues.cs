...
namespace GeneXus.Programs {
   public class k2bgettagcollectionforfiltervalues : GXProcedure
   {
                           ...
                           out GXBaseCollection<SdtK2BValueDescriptionCollection_Item> aP3_K2BTagCollection )
      {
         ...
         this.AV16K2BTagCollection = new GXBaseCollection<SdtK2BValueDescriptionCollection_Item>( context, "Item", "kb_ticket") ;
         initialize();
         executePrivate();
                                 ...
                                 out GXBaseCollection<SdtK2BValueDescriptionCollection_Item> aP3_K2BTagCollection )
      {
         ...
         objk2bgettagcollectionforfiltervalues.AV16K2BTagCollection = new GXBaseCollection<SdtK2BValueDescriptionCollection_Item>( context, "Item", "kb_ticket") ;
         ...
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objk2bgettagcollectionforfiltervalues);
         aP3_K2BTagCollection=this.AV16K2BTagCollection;
      }
      ...
      void executePrivate( )
      {
         ...
         AV22GXV1 = 1;
         while ( AV22GXV1 <= AV8K2BFilterValuesSDT.Count )
         {
            AV9K2BFilterValuesSDTItem = ((SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem)AV8K2BFilterValuesSDT.Item(AV22GXV1));
      ...
      {
         AV16K2BTagCollection = new GXBaseCollection<SdtK2BValueDescriptionCollection_Item>( context, "Item", "kb_ticket");
