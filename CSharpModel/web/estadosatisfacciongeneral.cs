...
namespace GeneXus.Programs {
   public class estadosatisfacciongeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public estadosatisfacciongeneral( )
      {
      ...
      public estadosatisfacciongeneral( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "AV6EstadoSatisfaccionId", StringUtil.LTrimStr( (decimal)(AV6EstadoSatisfaccionId), 4, 0));
                  AV8TabCode = GetPar( "TabCode");
                  AssignAttri(sPrefix, false, "AV8TabCode", AV8TabCode);
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)Gx_mode,(short)AV6EstadoSatisfaccionId,(string)AV8TabCode});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188135052", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6EstadoSatisfaccionId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6EstadoSatisfaccionId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8TabCode", StringUtil.RTrim( wcpOAV8TabCode));
         GxWebStd.gx_hidden_field( context, sPrefix+"ESTADOSATISFACCIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A4EstadoSatisfaccionId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vESTADOSATISFACCIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6EstadoSatisfaccionId), 4, 0, ".", "")));
      ...
      {
         return "EstadoSatisfaccionGeneral" ;
      }
      ...
      protected void WB260( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "estadosatisfacciongeneral.aspx");
            }
            /* Div Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_15_262( true) ;
         }
         else
         {
            wb_table1_15_262( false) ;
         }
         return  ;
      }

      protected void wb_table1_15_262e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void STRUP260( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6EstadoSatisfaccionId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6EstadoSatisfaccionId"), ".", ","));
      ...
      protected void E12262( )
      {
         ...
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "EstadoSatisfaccion";
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "EstadoSatisfaccion";
         ...
         {
            A4EstadoSatisfaccionId = H00262_A4EstadoSatisfaccionId[0];
            AV16GXLvl26 = 1;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Transactioncomponent_Component), StringUtil.Lower( "EstadoSatisfaccion")) != 0 )
         {
            WebComp_Transactioncomponent = getWebComponent(GetType(), "GeneXus.Programs", "estadosatisfaccion", new Object[] {context} );
            WebComp_Transactioncomponent.ComponentInit();
            WebComp_Transactioncomponent.Name = "EstadoSatisfaccion";
            WebComp_Transactioncomponent_Component = "EstadoSatisfaccion";
         }
         if ( StringUtil.Len( WebComp_Transactioncomponent_Component) != 0 )
         {
            WebComp_Transactioncomponent.setjustcreated();
            WebComp_Transactioncomponent.componentprepare(new Object[] {(string)sPrefix+"W0029",(string)"",(string)Gx_mode,(short)AV6EstadoSatisfaccionId});
      ...
      protected void E13262( )
      {
         /* 'DoUpdate' Routine */
         returnInSub = false;
         new k2bgettrncontextbyname(context ).execute(  "EstadoSatisfaccion", out  AV10TrnContext) ;
         GXt_char1 = "";
         ...
         new k2bsettrncontextbyname(context ).execute(  "EstadoSatisfaccion",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerestadosatisfaccion.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(AV6EstadoSatisfaccionId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","EstadoSatisfaccionId","TabCode"}) );
      ...
      protected void E14262( )
      {
         ...
         AV10TrnContext.gxTpr_Returnmode = "Popup";
         new k2bsettrncontextbyname(context ).execute(  "EstadoSatisfaccion",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerestadosatisfaccion.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(AV6EstadoSatisfaccionId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","EstadoSatisfaccionId","TabCode"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void wb_table1_15_262( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_18_262( true) ;
         }
         else
         {
            wb_table2_18_262( false) ;
         }
         return  ;
      }

      protected void wb_table2_18_262e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_15_262e( true) ;
         }
         else
         {
            wb_table1_15_262e( false) ;
         }
      }

      protected void wb_table2_18_262( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_18_262e( true) ;
         }
         else
         {
            wb_table2_18_262e( false) ;
         }
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6EstadoSatisfaccionId = (string)((string)getParm(obj,1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "estadosatisfacciongeneral", GetJustCreated( ));
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "Gx_mode", Gx_mode);
            AV6EstadoSatisfaccionId = Convert.ToInt16(getParm(obj,3));
            AssignAttri(sPrefix, false, "AV6EstadoSatisfaccionId", StringUtil.LTrimStr( (decimal)(AV6EstadoSatisfaccionId), 4, 0));
         ...
         wcpOAV6EstadoSatisfaccionId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6EstadoSatisfaccionId"), ".", ","));
         wcpOAV8TabCode = cgiGet( sPrefix+"wcpOAV8TabCode");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(Gx_mode, wcpOGx_mode) != 0 ) || ( AV6EstadoSatisfaccionId != wcpOAV6EstadoSatisfaccionId ) || ( StringUtil.StrCmp(AV8TabCode, wcpOAV8TabCode) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOGx_mode = Gx_mode;
         wcpOAV6EstadoSatisfaccionId = AV6EstadoSatisfaccionId;
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV6EstadoSatisfaccionId = cgiGet( sPrefix+"AV6EstadoSatisfaccionId_CTRL");
         if ( StringUtil.Len( sCtrlAV6EstadoSatisfaccionId) > 0 )
         {
            AV6EstadoSatisfaccionId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6EstadoSatisfaccionId), ".", ","));
            AssignAttri(sPrefix, false, "AV6EstadoSatisfaccionId", StringUtil.LTrimStr( (decimal)(AV6EstadoSatisfaccionId), 4, 0));
         }
         else
         {
            AV6EstadoSatisfaccionId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6EstadoSatisfaccionId_PARM"), ".", ","));
         }
      ...
      protected void WCParametersSet( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6EstadoSatisfaccionId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6EstadoSatisfaccionId), 4, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6EstadoSatisfaccionId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6EstadoSatisfaccionId_CTRL", StringUtil.RTrim( sCtrlAV6EstadoSatisfaccionId));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188135095", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("estadosatisfacciongeneral.js", "?2024188135095", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A4EstadoSatisfaccionId',fld:'ESTADOSATISFACCIONID',pic:'ZZZ9'},{av:'AV6EstadoSatisfaccionId',fld:'vESTADOSATISFACCIONID',pic:'ZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E13262',iparms:[{av:'AV6EstadoSatisfaccionId',fld:'vESTADOSATISFACCIONID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E14262',iparms:[{av:'AV6EstadoSatisfaccionId',fld:'vESTADOSATISFACCIONID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV12ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         scmdbuf = "";
         H00262_A4EstadoSatisfaccionId = new short[1] ;
         ...
         sCtrlGx_mode = "";
         sCtrlAV6EstadoSatisfaccionId = "";
         sCtrlAV8TabCode = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.estadosatisfacciongeneral__default(),
            new Object[][] {
                new Object[] {
               H00262_A4EstadoSatisfaccionId
               }
            }
         );
      ...
      private string sCtrlAV6EstadoSatisfaccionId ;
      ...
      private short[] H00262_A4EstadoSatisfaccionId ;
   ...
   public class estadosatisfacciongeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00262", "SELECT [EstadoSatisfaccionId] FROM [EstadoSatisfaccion] WHERE [EstadoSatisfaccionId] = @AV6EstadoSatisfaccionId ORDER BY [EstadoSatisfaccionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00262,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
