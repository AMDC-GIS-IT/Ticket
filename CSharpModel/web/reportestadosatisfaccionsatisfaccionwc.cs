...
namespace GeneXus.Programs {
   public class reportestadosatisfaccionsatisfaccionwc : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
         ...
         try
         {
            ...
            else
            {
               ...
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV22SatisfaccionTecnicoProblemaNombre)) )
               {
                  ...
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV22SatisfaccionTecnicoProblemaNombre, "")), 92, Gx_line+7, 312, Gx_line+23, 0+256, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
               }
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV23SatisfaccionTecnicoCompetenteNombre)) )
               {
                  ...
                  getPrinter().GxDrawText("Respuesta:", 10, Gx_line+7, 84, Gx_line+22, 0+256, 0, 0, 0) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV23SatisfaccionTecnicoCompetenteNombre, "")), 92, Gx_line+7, 312, Gx_line+23, 0+256, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
               }
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV24SatisfaccionTecnicoProfesionalismoNombre)) )
               {
                  ...
                  getPrinter().GxDrawText("Respuesta:", 10, Gx_line+7, 84, Gx_line+22, 0+256, 0, 0, 0) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV24SatisfaccionTecnicoProfesionalismoNombre, "")), 92, Gx_line+7, 312, Gx_line+23, 0+256, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
               }
               ...
               while ( (pr_default.getStatus(0) != 101) )
               {
                  ...
                  n34SatisfaccionSugerencia = P00362_n34SatisfaccionSugerencia[0];
                  ...
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A36SatisfaccionTecnicoProblemaNombre, "")), 633, Gx_line+7, 762, Gx_line+23, 0, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
      ...
      public override void initialize( )
      {
         ...
         P00362_n34SatisfaccionSugerencia = new bool[] {false} ;
         P00362_A94UsuarioRequerimiento = new string[] {""} ;
         P00362_A93UsuarioNombre = new string[] {""} ;
         P00362_A15UsuarioId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportestadosatisfaccionsatisfaccionwc__default(),
            new Object[][] {
                new Object[] {
               P00362_A9SatisfaccionTecnicoProblemaId, P00362_A10SatisfaccionTecnicoCompetenteId, P00362_A11SatisfaccionTecnicoProfesionalismoId, P00362_A12SatisfaccionTiempoId, P00362_A13SatisfaccionAtencionId, P00362_A8SatisfaccionResueltoId, P00362_A34SatisfaccionSugerencia, P00362_n34SatisfaccionSugerencia, P00362_A94UsuarioRequerimiento, P00362_A93UsuarioNombre,
               P00362_A15UsuarioId, P00362_A14TicketId, P00362_A7SatisfaccionId, P00362_A31SatisfaccionAtencionNombre, P00362_A38SatisfaccionTiempoNombre, P00362_A37SatisfaccionTecnicoProfesionalismoNombre, P00362_A35SatisfaccionTecnicoCompetenteNombre, P00362_A36SatisfaccionTecnicoProblemaNombre, P00362_A90UsuarioFecha, P00362_A32SatisfaccionFecha
               }
            }
         );
   ...
   public class reportestadosatisfaccionsatisfaccionwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00362(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (long)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] , (short)dynConstraints[25] );
         }
