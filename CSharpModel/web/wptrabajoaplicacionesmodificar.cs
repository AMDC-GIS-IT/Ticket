...
namespace GeneXus.Programs {
   public class wptrabajoaplicacionesmodificar : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wptrabajoaplicacionesmodificar( )
      {
      ...
      public wptrabajoaplicacionesmodificar( IGxContext context )
      {
                           ...
                           string aP12_fecha_solicitud )
      {
         ...
         this.AV35nombre_emp1 = aP1_nombre_emp1;
         this.AV45cargo_emp1 = aP2_cargo_emp1;
         this.AV36nombre_usuario1 = aP3_nombre_usuario1;
         this.AV37fecha_registro1 = aP4_fecha_registro1;
         this.AV38depto_usuario1 = aP5_depto_usuario1;
         this.AV39correo_usuario1 = aP6_correo_usuario1;
         this.AV40observaciones1 = aP7_observaciones1;
         this.AV41detalle_infotecid_unidad1 = aP8_detalle_infotecid_unidad1;
         this.AV42id_categoria1 = aP9_id_categoria1;
         this.AV43id_actividad1 = aP10_id_actividad1;
         this.AV44prioridad1 = aP11_prioridad1;
         this.AV47fecha_solicitud = aP12_fecha_solicitud;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vEMPLEADO") == 0 )
            {
               ...
               GXDLVvEMPLEADO7Y2( AV33UsuarioConectado) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vCARGO") == 0 )
            {
               ...
               GXDLVvCARGO7Y2( AV33UsuarioConectado) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vDETALLE_INFOTECID_UNIDAD") == 0 )
            {
               ...
               GXDLVvDETALLE_INFOTECID_UNIDAD7Y2( AV7categoria_tareaid_tipo_categoria) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vCATEGORIA_TAREAID_TIPO_CATEGORIA") == 0 )
            {
               ...
               GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA7Y2( ) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vID_ACTIVIDAD_CATEGORIA") == 0 )
            {
               ...
               GXDLVvID_ACTIVIDAD_CATEGORIA7Y2( AV7categoria_tareaid_tipo_categoria) ;
               return  ;
            }
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               {
                  AV35nombre_emp1 = GetPar( "nombre_emp1");
                  AssignAttri("", false, "AV35nombre_emp1", AV35nombre_emp1);
                  AV45cargo_emp1 = GetPar( "cargo_emp1");
                  AssignAttri("", false, "AV45cargo_emp1", AV45cargo_emp1);
                  AV36nombre_usuario1 = GetPar( "nombre_usuario1");
                  AssignAttri("", false, "AV36nombre_usuario1", AV36nombre_usuario1);
                  GxWebStd.gx_hidden_field( context, "gxhash_vNOMBRE_USUARIO1", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV36nombre_usuario1, "")), context));
                  AV37fecha_registro1 = context.localUtil.ParseDateParm( GetPar( "fecha_registro1"));
                  AssignAttri("", false, "AV37fecha_registro1", context.localUtil.Format(AV37fecha_registro1, "99/99/99"));
                  AV38depto_usuario1 = GetPar( "depto_usuario1");
                  AssignAttri("", false, "AV38depto_usuario1", AV38depto_usuario1);
                  GxWebStd.gx_hidden_field( context, "gxhash_vDEPTO_USUARIO1", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV38depto_usuario1, "")), context));
                  AV39correo_usuario1 = GetPar( "correo_usuario1");
                  AssignAttri("", false, "AV39correo_usuario1", AV39correo_usuario1);
                  GxWebStd.gx_hidden_field( context, "gxhash_vCORREO_USUARIO1", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV39correo_usuario1, "")), context));
                  AV40observaciones1 = GetPar( "observaciones1");
                  AssignAttri("", false, "AV40observaciones1", AV40observaciones1);
                  GxWebStd.gx_hidden_field( context, "gxhash_vOBSERVACIONES1", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV40observaciones1, "")), context));
                  AV41detalle_infotecid_unidad1 = (int)(NumberUtil.Val( GetPar( "detalle_infotecid_unidad1"), "."));
                  AssignAttri("", false, "AV41detalle_infotecid_unidad1", StringUtil.LTrimStr( (decimal)(AV41detalle_infotecid_unidad1), 9, 0));
                  GxWebStd.gx_hidden_field( context, "gxhash_vDETALLE_INFOTECID_UNIDAD1", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV41detalle_infotecid_unidad1), "ZZZZZZZZ9"), context));
                  AV42id_categoria1 = (int)(NumberUtil.Val( GetPar( "id_categoria1"), "."));
                  AssignAttri("", false, "AV42id_categoria1", StringUtil.LTrimStr( (decimal)(AV42id_categoria1), 9, 0));
                  GxWebStd.gx_hidden_field( context, "gxhash_vID_CATEGORIA1", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV42id_categoria1), "ZZZZZZZZ9"), context));
                  AV43id_actividad1 = (int)(NumberUtil.Val( GetPar( "id_actividad1"), "."));
                  AssignAttri("", false, "AV43id_actividad1", StringUtil.LTrimStr( (decimal)(AV43id_actividad1), 9, 0));
                  GxWebStd.gx_hidden_field( context, "gxhash_vID_ACTIVIDAD1", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV43id_actividad1), "ZZZZZZZZ9"), context));
                  AV44prioridad1 = GetPar( "prioridad1");
                  AssignAttri("", false, "AV44prioridad1", AV44prioridad1);
                  GxWebStd.gx_hidden_field( context, "gxhash_vPRIORIDAD1", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV44prioridad1, "")), context));
                  AV47fecha_solicitud = GetPar( "fecha_solicitud");
                  AssignAttri("", false, "AV47fecha_solicitud", AV47fecha_solicitud);
                  GxWebStd.gx_hidden_field( context, "gxhash_vFECHA_SOLICITUD", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV47fecha_solicitud, "")), context));
               }
            }
            if ( toggleJsOutput )
            {
      ...
      {
         get {
            return "wptrabajoaplicacionesmodificar_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188221567", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wptrabajoaplicacionesmodificar.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV34correlativo,9,0)),UrlEncode(StringUtil.RTrim(AV35nombre_emp1)),UrlEncode(StringUtil.RTrim(AV45cargo_emp1)),UrlEncode(StringUtil.RTrim(AV36nombre_usuario1)),UrlEncode(DateTimeUtil.FormatDateParm(AV37fecha_registro1)),UrlEncode(StringUtil.RTrim(AV38depto_usuario1)),UrlEncode(StringUtil.RTrim(AV39correo_usuario1)),UrlEncode(StringUtil.RTrim(AV40observaciones1)),UrlEncode(StringUtil.LTrimStr(AV41detalle_infotecid_unidad1,9,0)),UrlEncode(StringUtil.LTrimStr(AV42id_categoria1,9,0)),UrlEncode(StringUtil.LTrimStr(AV43id_actividad1,9,0)),UrlEncode(StringUtil.RTrim(AV44prioridad1)),UrlEncode(StringUtil.RTrim(AV47fecha_solicitud))}, new string[] {"correlativo","nombre_emp1","cargo_emp1","nombre_usuario1","fecha_registro1","depto_usuario1","correo_usuario1","observaciones1","detalle_infotecid_unidad1","id_categoria1","id_actividad1","prioridad1","fecha_solicitud"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"WPTrabajoAplicacionesModificar");
         ...
         GXUtil.WriteLogInfo("wptrabajoaplicacionesmodificar:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vETAPADESARROLLOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV16EtapaDesarrolloId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vNOMBRE_EMP1", AV35nombre_emp1);
         GxWebStd.gx_hidden_field( context, "vCARGO_EMP1", AV45cargo_emp1);
         GxWebStd.gx_hidden_field( context, "vNOMBRE_USUARIO1", AV36nombre_usuario1);
         GxWebStd.gx_hidden_field( context, "gxhash_vNOMBRE_USUARIO1", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV36nombre_usuario1, "")), context));
         GxWebStd.gx_hidden_field( context, "vFECHA_REGISTRO1", context.localUtil.DToC( AV37fecha_registro1, 0, "/"));
         GxWebStd.gx_hidden_field( context, "vDEPTO_USUARIO1", AV38depto_usuario1);
         GxWebStd.gx_hidden_field( context, "gxhash_vDEPTO_USUARIO1", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV38depto_usuario1, "")), context));
         GxWebStd.gx_hidden_field( context, "vCORREO_USUARIO1", AV39correo_usuario1);
         GxWebStd.gx_hidden_field( context, "gxhash_vCORREO_USUARIO1", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV39correo_usuario1, "")), context));
         GxWebStd.gx_hidden_field( context, "vOBSERVACIONES1", AV40observaciones1);
         GxWebStd.gx_hidden_field( context, "gxhash_vOBSERVACIONES1", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV40observaciones1, "")), context));
         GxWebStd.gx_hidden_field( context, "vDETALLE_INFOTECID_UNIDAD1", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV41detalle_infotecid_unidad1), 9, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vDETALLE_INFOTECID_UNIDAD1", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV41detalle_infotecid_unidad1), "ZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vID_CATEGORIA1", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV42id_categoria1), 9, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vID_CATEGORIA1", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV42id_categoria1), "ZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vID_ACTIVIDAD1", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV43id_actividad1), 9, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vID_ACTIVIDAD1", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV43id_actividad1), "ZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vPRIORIDAD1", AV44prioridad1);
         GxWebStd.gx_hidden_field( context, "gxhash_vPRIORIDAD1", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV44prioridad1, "")), context));
         GxWebStd.gx_hidden_field( context, "vFECHA_SOLICITUD", AV47fecha_solicitud);
         GxWebStd.gx_hidden_field( context, "gxhash_vFECHA_SOLICITUD", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV47fecha_solicitud, "")), context));
      ...
      {
         return formatLink("wptrabajoaplicacionesmodificar.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV34correlativo,9,0)),UrlEncode(StringUtil.RTrim(AV35nombre_emp1)),UrlEncode(StringUtil.RTrim(AV45cargo_emp1)),UrlEncode(StringUtil.RTrim(AV36nombre_usuario1)),UrlEncode(DateTimeUtil.FormatDateParm(AV37fecha_registro1)),UrlEncode(StringUtil.RTrim(AV38depto_usuario1)),UrlEncode(StringUtil.RTrim(AV39correo_usuario1)),UrlEncode(StringUtil.RTrim(AV40observaciones1)),UrlEncode(StringUtil.LTrimStr(AV41detalle_infotecid_unidad1,9,0)),UrlEncode(StringUtil.LTrimStr(AV42id_categoria1,9,0)),UrlEncode(StringUtil.LTrimStr(AV43id_actividad1,9,0)),UrlEncode(StringUtil.RTrim(AV44prioridad1)),UrlEncode(StringUtil.RTrim(AV47fecha_solicitud))}, new string[] {"correlativo","nombre_emp1","cargo_emp1","nombre_usuario1","fecha_registro1","depto_usuario1","correo_usuario1","observaciones1","detalle_infotecid_unidad1","id_categoria1","id_actividad1","prioridad1","fecha_solicitud"})  ;
      }

      public override string GetPgmname( )
      {
         return "WPTrabajoAplicacionesModificar" ;
      }

      public override string GetPgmdesc( )
      {
         return "WPTrabajo Aplicaciones Modificar" ;
      }
      ...
      protected void WB7Y0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock2_Internalname, "Gerencia de Información y Sistemas", "", "", lblTextblock2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_LevelHeaderTitle1", 0, "", 1, 1, 0, 0, "HLP_WPTrabajoAplicacionesModificar.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "Middle", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock3_Internalname, "<<Modificar Trabajo Diario>>", "", "", lblTextblock3_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_LevelHeaderTitle", 0, "", 1, 1, 0, 0, "HLP_WPTrabajoAplicacionesModificar.htm");
            GxWebStd.gx_div_end( context, "Center", "Middle", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtavCorrelativo_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV34correlativo), 9, 0, ".", "")), StringUtil.LTrim( ((edtavCorrelativo_Enabled!=0) ? context.localUtil.Format( (decimal)(AV34correlativo), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(AV34correlativo), "ZZZZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCorrelativo_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCorrelativo_Enabled, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_WPTrabajoAplicacionesModificar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavCargo, dynavCargo_Internalname, StringUtil.RTrim( AV6Cargo), 1, dynavCargo_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavCargo.Enabled, 0, 0, 0, "em", 0, "", "color:"+context.BuildHTMLColor( dynavCargo.ForeColor)+";", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,46);\"", "", true, 1, "HLP_WPTrabajoAplicacionesModificar.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsuariofecha_Internalname, context.localUtil.Format(AV28UsuarioFecha, "99/99/9999"), context.localUtil.Format( AV28UsuarioFecha, "99/99/9999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsuariofecha_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavUsuariofecha_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_WPTrabajoAplicacionesModificar.htm");
            GxWebStd.gx_bitmap( context, edtavUsuariofecha_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavUsuariofecha_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_WPTrabajoAplicacionesModificar.htm");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavUsuariodepartamento, dynavUsuariodepartamento_Internalname, StringUtil.RTrim( AV26UsuarioDepartamento), 1, dynavUsuariodepartamento_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavUsuariodepartamento.Enabled, 0, 0, 0, "em", 0, "", "color:"+context.BuildHTMLColor( dynavUsuariodepartamento.ForeColor)+";", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,74);\"", "", true, 1, "HLP_WPTrabajoAplicacionesModificar.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsuarioemail_Internalname, AV27UsuarioEmail, StringUtil.RTrim( context.localUtil.Format( AV27UsuarioEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,81);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsuarioemail_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavUsuarioemail_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, 0, true, "", "left", true, "", "HLP_WPTrabajoAplicacionesModificar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavDetalle_infotecid_unidad, dynavDetalle_infotecid_unidad_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV9detalle_infotecid_unidad), 9, 0)), 1, dynavDetalle_infotecid_unidad_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", dynavDetalle_infotecid_unidad.Visible, dynavDetalle_infotecid_unidad.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,89);\"", "", true, 1, "HLP_WPTrabajoAplicacionesModificar.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "Observaciones: ", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "color:"+context.BuildHTMLColor( lblTextblock1_Forecolor)+";", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPTrabajoAplicacionesModificar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavCategoria_tareaid_tipo_categoria, dynavCategoria_tareaid_tipo_categoria_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV7categoria_tareaid_tipo_categoria), 9, 0)), 1, dynavCategoria_tareaid_tipo_categoria_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, dynavCategoria_tareaid_tipo_categoria.Enabled, 0, 0, 0, "em", 0, "", "color:"+context.BuildHTMLColor( dynavCategoria_tareaid_tipo_categoria.ForeColor)+";", "Attribute_Color", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,126);\"", "", true, 1, "HLP_WPTrabajoAplicacionesModificar.htm");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavPrioridad, cmbavPrioridad_Internalname, StringUtil.RTrim( AV19prioridad), 1, cmbavPrioridad_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbavPrioridad.Enabled, 0, 0, 0, "em", 0, "", "color:"+context.BuildHTMLColor( cmbavPrioridad.ForeColor)+";", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,142);\"", "", true, 1, "HLP_WPTrabajoAplicacionesModificar.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttGuardar_Internalname, "", "Guardar", bttGuardar_Jsonclick, 5, "Guardar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'GUARDAR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WPTrabajoAplicacionesModificar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttCancelar_Internalname, "", "Cancelar", bttCancelar_Jsonclick, 5, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CANCELAR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WPTrabajoAplicacionesModificar.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START7Y2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "WPTrabajo Aplicaciones Modificar", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void GXDLVvUSUARIODEPARTAMENTO7Y1( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvUSUARIODEPARTAMENTO_data7Y1( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXVvUSUARIODEPARTAMENTO_html7Y1( )
      {
      ...
      protected void GXDLVvUSUARIODEPARTAMENTO_data7Y1( )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(H007Y2_A361nombre_depto[0]);
            gxdynajaxctrldescr.Add(H007Y2_A361nombre_depto[0]);
            pr_datastore1.readNext(0);
         }
         pr_datastore1.close(0);
      }

      protected void GXDLVvEMPLEADO7Y2( string AV33UsuarioConectado )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvEMPLEADO_data7Y2( AV33UsuarioConectado) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvEMPLEADO_html7Y2( string AV33UsuarioConectado )
      {
         string gxdynajaxvalue;
         GXDLVvEMPLEADO_data7Y2( AV33UsuarioConectado) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvEMPLEADO_data7Y2( string AV33UsuarioConectado )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         /* Using cursor H007Y3 */
         ...
         {
            gxdynajaxctrlcodr.Add(H007Y3_A30ResponsableNombre[0]);
            gxdynajaxctrldescr.Add(H007Y3_A30ResponsableNombre[0]);
            pr_default.readNext(0);
         }
         pr_default.close(0);
      }

      protected void GXDLVvCARGO7Y2( string AV33UsuarioConectado )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvCARGO_data7Y2( AV33UsuarioConectado) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvCARGO_html7Y2( string AV33UsuarioConectado )
      {
         string gxdynajaxvalue;
         GXDLVvCARGO_data7Y2( AV33UsuarioConectado) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvCARGO_data7Y2( string AV33UsuarioConectado )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         /* Using cursor H007Y4 */
         ...
         {
            gxdynajaxctrlcodr.Add(H007Y4_A27ResponsableCargo[0]);
            gxdynajaxctrldescr.Add(H007Y4_A27ResponsableCargo[0]);
            pr_default.readNext(1);
         }
         pr_default.close(1);
      }

      protected void GXDLVvDETALLE_INFOTECID_UNIDAD7Y2( int AV7categoria_tareaid_tipo_categoria )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvDETALLE_INFOTECID_UNIDAD_data7Y2( AV7categoria_tareaid_tipo_categoria) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvDETALLE_INFOTECID_UNIDAD_html7Y2( int AV7categoria_tareaid_tipo_categoria )
      {
         int gxdynajaxvalue;
         GXDLVvDETALLE_INFOTECID_UNIDAD_data7Y2( AV7categoria_tareaid_tipo_categoria) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvDETALLE_INFOTECID_UNIDAD_data7Y2( int AV7categoria_tareaid_tipo_categoria )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H007Y5_A105id_unidad_gis[0]), 9, 0, ".", "")));
            gxdynajaxctrldescr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H007Y5_A105id_unidad_gis[0]), 9, 0, ".", "")));
            pr_datastore1.readNext(1);
         }
         pr_datastore1.close(1);
      }

      protected void GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA7Y2( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA_data7Y2( ) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvCATEGORIA_TAREAID_TIPO_CATEGORIA_html7Y2( )
      {
         int gxdynajaxvalue;
         GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA_data7Y2( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA_data7Y2( )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         gxdynajaxctrlcodr.Add(StringUtil.Str( (decimal)(0), 1, 0));
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H007Y6_A104categoria_tareaid_tipo_categoria[0]), 9, 0, ".", "")));
            gxdynajaxctrldescr.Add(H007Y6_A106nombre_categoria[0]);
            pr_datastore1.readNext(2);
         }
         pr_datastore1.close(2);
      }

      protected void GXDLVvID_ACTIVIDAD_CATEGORIA7Y2( int AV7categoria_tareaid_tipo_categoria )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvID_ACTIVIDAD_CATEGORIA_data7Y2( AV7categoria_tareaid_tipo_categoria) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvID_ACTIVIDAD_CATEGORIA_html7Y2( int AV7categoria_tareaid_tipo_categoria )
      {
         int gxdynajaxvalue;
         GXDLVvID_ACTIVIDAD_CATEGORIA_data7Y2( AV7categoria_tareaid_tipo_categoria) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvID_ACTIVIDAD_CATEGORIA_data7Y2( int AV7categoria_tareaid_tipo_categoria )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         gxdynajaxctrlcodr.Add(StringUtil.Str( (decimal)(0), 1, 0));
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H007Y7_A102id_actividad_categoria[0]), 9, 0, ".", "")));
            gxdynajaxctrldescr.Add(H007Y7_A123nombre_actividad[0]);
      ...
      protected void clear_multi_value_controls( )
      {
         if ( context.isAjaxRequest( ) )
         {
            GXVvCATEGORIA_TAREAID_TIPO_CATEGORIA_html7Y2( ) ;
            ...
            {
               dynavUsuariodepartamento.addItem(H007Y8_A361nombre_depto[0], H007Y8_A361nombre_depto[0], 0);
      ...
      protected void STRUP7Y0( )
      {
         ...
         GXVvEMPLEADO_html7Y2( AV33UsuarioConectado) ;
         GXVvCARGO_html7Y2( AV33UsuarioConectado) ;
         GXVvDETALLE_INFOTECID_UNIDAD_html7Y2( AV7categoria_tareaid_tipo_categoria) ;
         GXVvID_ACTIVIDAD_CATEGORIA_html7Y2( AV7categoria_tareaid_tipo_categoria) ;
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            ...
            {
               GXUtil.WriteLogError("wptrabajoaplicacionesmodificar:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E147Y2( )
      {
         ...
         AV30UsuarioNombre = AV36nombre_usuario1;
         AssignAttri("", false, "AV30UsuarioNombre", AV30UsuarioNombre);
         AV28UsuarioFecha = context.localUtil.CToD( AV47fecha_solicitud, 2);
         AssignAttri("", false, "AV28UsuarioFecha", context.localUtil.Format(AV28UsuarioFecha, "99/99/9999"));
         AV26UsuarioDepartamento = AV38depto_usuario1;
         AssignAttri("", false, "AV26UsuarioDepartamento", AV26UsuarioDepartamento);
         AV27UsuarioEmail = AV39correo_usuario1;
         AssignAttri("", false, "AV27UsuarioEmail", AV27UsuarioEmail);
         AV9detalle_infotecid_unidad = AV41detalle_infotecid_unidad1;
         AssignAttri("", false, "AV9detalle_infotecid_unidad", StringUtil.LTrimStr( (decimal)(AV9detalle_infotecid_unidad), 9, 0));
         AV24TicketResponsableObservacion = AV40observaciones1;
         AssignAttri("", false, "AV24TicketResponsableObservacion", AV24TicketResponsableObservacion);
         AV7categoria_tareaid_tipo_categoria = AV42id_categoria1;
         AssignAttri("", false, "AV7categoria_tareaid_tipo_categoria", StringUtil.LTrimStr( (decimal)(AV7categoria_tareaid_tipo_categoria), 9, 0));
         AV17id_actividad_categoria = AV43id_actividad1;
         AssignAttri("", false, "AV17id_actividad_categoria", StringUtil.LTrimStr( (decimal)(AV17id_actividad_categoria), 9, 0));
         AV19prioridad = AV44prioridad1;
         AssignAttri("", false, "AV19prioridad", AV19prioridad);
      }
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "AV34correlativo", StringUtil.LTrimStr( (decimal)(AV34correlativo), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCORRELATIVO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV34correlativo), "ZZZZZZZZ9"), context));
         AV35nombre_emp1 = (string)getParm(obj,1);
         AssignAttri("", false, "AV35nombre_emp1", AV35nombre_emp1);
         AV45cargo_emp1 = (string)getParm(obj,2);
         AssignAttri("", false, "AV45cargo_emp1", AV45cargo_emp1);
         AV36nombre_usuario1 = (string)getParm(obj,3);
         AssignAttri("", false, "AV36nombre_usuario1", AV36nombre_usuario1);
         GxWebStd.gx_hidden_field( context, "gxhash_vNOMBRE_USUARIO1", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV36nombre_usuario1, "")), context));
         AV37fecha_registro1 = (DateTime)getParm(obj,4);
         AssignAttri("", false, "AV37fecha_registro1", context.localUtil.Format(AV37fecha_registro1, "99/99/99"));
         AV38depto_usuario1 = (string)getParm(obj,5);
         AssignAttri("", false, "AV38depto_usuario1", AV38depto_usuario1);
         GxWebStd.gx_hidden_field( context, "gxhash_vDEPTO_USUARIO1", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV38depto_usuario1, "")), context));
         AV39correo_usuario1 = (string)getParm(obj,6);
         AssignAttri("", false, "AV39correo_usuario1", AV39correo_usuario1);
         GxWebStd.gx_hidden_field( context, "gxhash_vCORREO_USUARIO1", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV39correo_usuario1, "")), context));
         AV40observaciones1 = (string)getParm(obj,7);
         AssignAttri("", false, "AV40observaciones1", AV40observaciones1);
         GxWebStd.gx_hidden_field( context, "gxhash_vOBSERVACIONES1", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV40observaciones1, "")), context));
         AV41detalle_infotecid_unidad1 = Convert.ToInt32(getParm(obj,8));
         AssignAttri("", false, "AV41detalle_infotecid_unidad1", StringUtil.LTrimStr( (decimal)(AV41detalle_infotecid_unidad1), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vDETALLE_INFOTECID_UNIDAD1", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV41detalle_infotecid_unidad1), "ZZZZZZZZ9"), context));
         AV42id_categoria1 = Convert.ToInt32(getParm(obj,9));
         AssignAttri("", false, "AV42id_categoria1", StringUtil.LTrimStr( (decimal)(AV42id_categoria1), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vID_CATEGORIA1", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV42id_categoria1), "ZZZZZZZZ9"), context));
         AV43id_actividad1 = Convert.ToInt32(getParm(obj,10));
         AssignAttri("", false, "AV43id_actividad1", StringUtil.LTrimStr( (decimal)(AV43id_actividad1), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vID_ACTIVIDAD1", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV43id_actividad1), "ZZZZZZZZ9"), context));
         AV44prioridad1 = (string)getParm(obj,11);
         AssignAttri("", false, "AV44prioridad1", AV44prioridad1);
         GxWebStd.gx_hidden_field( context, "gxhash_vPRIORIDAD1", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV44prioridad1, "")), context));
         AV47fecha_solicitud = (string)getParm(obj,12);
         AssignAttri("", false, "AV47fecha_solicitud", AV47fecha_solicitud);
         GxWebStd.gx_hidden_field( context, "gxhash_vFECHA_SOLICITUD", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV47fecha_solicitud, "")), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188221877", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wptrabajoaplicacionesmodificar.js", "?2024188221878", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         {
            dynavUsuariodepartamento.addItem(H007Y9_A361nombre_depto[0], H007Y9_A361nombre_depto[0], 0);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "WPTrabajo Aplicaciones Modificar";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV15EstadoTicketTicketId',fld:'vESTADOTICKETTICKETID',pic:'ZZZ9',hsh:true},{av:'AV16EtapaDesarrolloId',fld:'vETAPADESARROLLOID',pic:'ZZZ9',hsh:true},{av:'AV36nombre_usuario1',fld:'vNOMBRE_USUARIO1',pic:'',hsh:true},{av:'AV38depto_usuario1',fld:'vDEPTO_USUARIO1',pic:'',hsh:true},{av:'AV39correo_usuario1',fld:'vCORREO_USUARIO1',pic:'',hsh:true},{av:'AV40observaciones1',fld:'vOBSERVACIONES1',pic:'',hsh:true},{av:'AV41detalle_infotecid_unidad1',fld:'vDETALLE_INFOTECID_UNIDAD1',pic:'ZZZZZZZZ9',hsh:true},{av:'AV42id_categoria1',fld:'vID_CATEGORIA1',pic:'ZZZZZZZZ9',hsh:true},{av:'AV43id_actividad1',fld:'vID_ACTIVIDAD1',pic:'ZZZZZZZZ9',hsh:true},{av:'AV44prioridad1',fld:'vPRIORIDAD1',pic:'',hsh:true},{av:'AV47fecha_solicitud',fld:'vFECHA_SOLICITUD',pic:'',hsh:true},{av:'AV34correlativo',fld:'vCORRELATIVO',pic:'ZZZZZZZZ9',hsh:true},{av:'dynavDetalle_infotecid_unidad'},{av:'AV9detalle_infotecid_unidad',fld:'vDETALLE_INFOTECID_UNIDAD',pic:'ZZZZZZZZ9'},{av:'dynavCategoria_tareaid_tipo_categoria'},{av:'AV7categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'dynavUsuariodepartamento'},{av:'AV26UsuarioDepartamento',fld:'vUSUARIODEPARTAMENTO',pic:''}]");
         ...
         setEventMetadata("'CANCELAR'","{handler:'E127Y2',iparms:[{av:'dynavCategoria_tareaid_tipo_categoria'},{av:'AV7categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'dynavUsuariodepartamento'},{av:'AV26UsuarioDepartamento',fld:'vUSUARIODEPARTAMENTO',pic:''}]");
         ...
         setEventMetadata("'PRUEBA'","{handler:'E137Y2',iparms:[{av:'dynavCategoria_tareaid_tipo_categoria'},{av:'AV7categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'dynavUsuariodepartamento'},{av:'AV26UsuarioDepartamento',fld:'vUSUARIODEPARTAMENTO',pic:''}]");
      ...
      public override void initialize( )
      {
         wcpOAV35nombre_emp1 = "";
         wcpOAV45cargo_emp1 = "";
         wcpOAV36nombre_usuario1 = "";
         wcpOAV37fecha_registro1 = DateTime.MinValue;
         wcpOAV38depto_usuario1 = "";
         wcpOAV39correo_usuario1 = "";
         wcpOAV40observaciones1 = "";
         wcpOAV44prioridad1 = "";
         wcpOAV47fecha_solicitud = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         ...
         gxwrpcisep = "";
         scmdbuf = "";
         H007Y2_A360codigo_depto = new int[1] ;
         H007Y2_A361nombre_depto = new string[] {""} ;
         H007Y2_n361nombre_depto = new bool[] {false} ;
         H007Y3_A6ResponsableId = new short[1] ;
         H007Y3_A30ResponsableNombre = new string[] {""} ;
         H007Y3_A96ResponsableUsuario = new string[] {""} ;
         H007Y4_A6ResponsableId = new short[1] ;
         H007Y4_A27ResponsableCargo = new string[] {""} ;
         H007Y4_A96ResponsableUsuario = new string[] {""} ;
         H007Y5_A105id_unidad_gis = new int[1] ;
         H007Y5_A104categoria_tareaid_tipo_categoria = new int[1] ;
         H007Y6_A104categoria_tareaid_tipo_categoria = new int[1] ;
         H007Y6_A106nombre_categoria = new string[] {""} ;
         H007Y6_n106nombre_categoria = new bool[] {false} ;
         H007Y7_A102id_actividad_categoria = new int[1] ;
         H007Y7_A123nombre_actividad = new string[] {""} ;
         H007Y7_n123nombre_actividad = new bool[] {false} ;
         H007Y7_A122actividades_categoriaid_tipo_categoria = new int[1] ;
         H007Y7_n122actividades_categoriaid_tipo_categoria = new bool[] {false} ;
         H007Y7_A125actividades_categoriaestado = new int[1] ;
         H007Y7_n125actividades_categoriaestado = new bool[] {false} ;
         H007Y8_A360codigo_depto = new int[1] ;
         H007Y8_A361nombre_depto = new string[] {""} ;
         H007Y8_n361nombre_depto = new bool[] {false} ;
         hsh = "";
         AV10detalle_tarea = "";
         AV5window = new GXWindow();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         H007Y9_A360codigo_depto = new int[1] ;
         H007Y9_A361nombre_depto = new string[] {""} ;
         H007Y9_n361nombre_depto = new bool[] {false} ;
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.wptrabajoaplicacionesmodificar__datastore1(),
            new Object[][] {
                new Object[] {
               H007Y2_A360codigo_depto, H007Y2_A361nombre_depto, H007Y2_n361nombre_depto
               }
               , new Object[] {
               H007Y5_A105id_unidad_gis, H007Y5_A104categoria_tareaid_tipo_categoria
               }
               , new Object[] {
               H007Y6_A104categoria_tareaid_tipo_categoria, H007Y6_A106nombre_categoria, H007Y6_n106nombre_categoria
               }
               , new Object[] {
               H007Y7_A102id_actividad_categoria, H007Y7_A123nombre_actividad, H007Y7_n123nombre_actividad, H007Y7_A122actividades_categoriaid_tipo_categoria, H007Y7_n122actividades_categoriaid_tipo_categoria, H007Y7_A125actividades_categoriaestado, H007Y7_n125actividades_categoriaestado
               }
               , new Object[] {
               H007Y8_A360codigo_depto, H007Y8_A361nombre_depto, H007Y8_n361nombre_depto
               }
               , new Object[] {
               H007Y9_A360codigo_depto, H007Y9_A361nombre_depto, H007Y9_n361nombre_depto
               }
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wptrabajoaplicacionesmodificar__default(),
            new Object[][] {
                new Object[] {
               H007Y3_A6ResponsableId, H007Y3_A30ResponsableNombre, H007Y3_A96ResponsableUsuario
               }
               , new Object[] {
               H007Y4_A6ResponsableId, H007Y4_A27ResponsableCargo, H007Y4_A96ResponsableUsuario
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int AV41detalle_infotecid_unidad1 ;
      private int AV42id_categoria1 ;
      private int AV43id_actividad1 ;
      private int wcpOAV34correlativo ;
      private int wcpOAV41detalle_infotecid_unidad1 ;
      private int wcpOAV42id_categoria1 ;
      private int wcpOAV43id_actividad1 ;
      ...
      private string hsh ;
      private DateTime AV37fecha_registro1 ;
      private DateTime wcpOAV37fecha_registro1 ;
      ...
      private string AV35nombre_emp1 ;
      private string AV45cargo_emp1 ;
      private string AV36nombre_usuario1 ;
      private string AV38depto_usuario1 ;
      private string AV39correo_usuario1 ;
      private string AV40observaciones1 ;
      private string AV44prioridad1 ;
      private string AV47fecha_solicitud ;
      private string wcpOAV35nombre_emp1 ;
      private string wcpOAV45cargo_emp1 ;
      private string wcpOAV36nombre_usuario1 ;
      private string wcpOAV38depto_usuario1 ;
      private string wcpOAV39correo_usuario1 ;
      private string wcpOAV40observaciones1 ;
      private string wcpOAV44prioridad1 ;
      private string wcpOAV47fecha_solicitud ;
      ...
      private int[] H007Y2_A360codigo_depto ;
      private string[] H007Y2_A361nombre_depto ;
      private bool[] H007Y2_n361nombre_depto ;
      private IDataStoreProvider pr_default ;
      private short[] H007Y3_A6ResponsableId ;
      private string[] H007Y3_A30ResponsableNombre ;
      private string[] H007Y3_A96ResponsableUsuario ;
      private short[] H007Y4_A6ResponsableId ;
      private string[] H007Y4_A27ResponsableCargo ;
      private string[] H007Y4_A96ResponsableUsuario ;
      private int[] H007Y5_A105id_unidad_gis ;
      private int[] H007Y5_A104categoria_tareaid_tipo_categoria ;
      private int[] H007Y6_A104categoria_tareaid_tipo_categoria ;
      private string[] H007Y6_A106nombre_categoria ;
      private bool[] H007Y6_n106nombre_categoria ;
      private int[] H007Y7_A102id_actividad_categoria ;
      private string[] H007Y7_A123nombre_actividad ;
      private bool[] H007Y7_n123nombre_actividad ;
      private int[] H007Y7_A122actividades_categoriaid_tipo_categoria ;
      private bool[] H007Y7_n122actividades_categoriaid_tipo_categoria ;
      private int[] H007Y7_A125actividades_categoriaestado ;
      private bool[] H007Y7_n125actividades_categoriaestado ;
      private int[] H007Y8_A360codigo_depto ;
      private string[] H007Y8_A361nombre_depto ;
      private bool[] H007Y8_n361nombre_depto ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private int[] H007Y9_A360codigo_depto ;
      private string[] H007Y9_A361nombre_depto ;
      private bool[] H007Y9_n361nombre_depto ;
      private GXWebForm Form ;
      private GXWindow AV5window ;
   }

   public class wptrabajoaplicacionesmodificar__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH007Y5;
          prmH007Y5 = new Object[] {
          new ParDef("@AV7categoria_tareaid_tipo_categoria",GXType.Int32,9,0)
          };
          Object[] prmH007Y6;
          prmH007Y6 = new Object[] {
          };
          Object[] prmH007Y7;
          prmH007Y7 = new Object[] {
          new ParDef("@AV7categoria_tareaid_tipo_categoria",GXType.Int32,9,0)
          };
          Object[] prmH007Y8;
          prmH007Y8 = new Object[] {
          };
          Object[] prmH007Y9;
          prmH007Y9 = new Object[] {
          };
          def= new CursorDef[] {
              new CursorDef("H007Y2", "SELECT [codigo_depto], [nombre_depto] FROM dbo.[deptos] ORDER BY [nombre_depto] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007Y2,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007Y5", "SELECT [id_unidad_gis], [id_tipo_categoria] AS categoria_tareaid_tipo_categoria FROM dbo.[categoria_tarea] WHERE [id_tipo_categoria] = @AV7categoria_tareaid_tipo_categoria ORDER BY [id_unidad_gis] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007Y5,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007Y6", "SELECT [id_tipo_categoria] AS categoria_tareaid_tipo_categoria, [nombre_categoria] FROM dbo.[categoria_tarea] WHERE [id_tipo_categoria] = 2 or [id_tipo_categoria] = 11 ORDER BY [nombre_categoria] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007Y6,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007Y7", "SELECT [id_actividad_categoria], [nombre_actividad], [id_tipo_categoria] AS actividades_categoriaid_tipo_categoria, [estado] AS actividades_categoriaestado FROM dbo.[actividades_categoria] WHERE ([id_tipo_categoria] = @AV7categoria_tareaid_tipo_categoria) AND ([estado] = 1) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007Y7,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007Y8", "SELECT [codigo_depto], [nombre_depto] FROM dbo.[deptos] ORDER BY [nombre_depto] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007Y8,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007Y9", "SELECT [codigo_depto], [nombre_depto] FROM dbo.[deptos] ORDER BY [nombre_depto] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007Y9,0, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
 ...
 public class wptrabajoaplicacionesmodificar__default : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        Object[] prmH007Y4;
        prmH007Y4 = new Object[] {
        new ParDef("@AV33UsuarioConectado",GXType.NVarChar,100,60)
        };
        def= new CursorDef[] {
            new CursorDef("H007Y3", "SELECT [ResponsableId], [ResponsableNombre], [ResponsableUsuario] FROM [Responsable] WHERE [ResponsableUsuario] = @AV33UsuarioConectado ORDER BY [ResponsableNombre] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007Y3,0, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("H007Y4", "SELECT [ResponsableId], [ResponsableCargo], [ResponsableUsuario] FROM [Responsable] WHERE [ResponsableUsuario] = @AV33UsuarioConectado ORDER BY [ResponsableCargo] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007Y4,0, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
