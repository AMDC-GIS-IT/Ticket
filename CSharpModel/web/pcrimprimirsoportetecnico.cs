...
namespace GeneXus.Programs {
   public class pcrimprimirsoportetecnico : GXProcedure
   {
      public pcrimprimirsoportetecnico( )
      {
      ...
      public pcrimprimirsoportetecnico( IGxContext context )
      {
      ...
      public void executeSubmit( long aP0_TicketId ,
                                 ...
                                 DateTime aP26_TicketHoraResponsable )
      {
         pcrimprimirsoportetecnico objpcrimprimirsoportetecnico;
         objpcrimprimirsoportetecnico = new pcrimprimirsoportetecnico();
         objpcrimprimirsoportetecnico.AV2TicketId = aP0_TicketId;
         objpcrimprimirsoportetecnico.AV3UsuarioId = aP1_UsuarioId;
         objpcrimprimirsoportetecnico.AV4TicketResponsableId = aP2_TicketResponsableId;
         objpcrimprimirsoportetecnico.AV5TicketTecnicoResponsableId = aP3_TicketTecnicoResponsableId;
         objpcrimprimirsoportetecnico.AV6TicketTecnicoResponsableNombre = aP4_TicketTecnicoResponsableNombre;
         objpcrimprimirsoportetecnico.AV7UsuarioEmail = aP5_UsuarioEmail;
         objpcrimprimirsoportetecnico.AV8UsuarioFecha = aP6_UsuarioFecha;
         objpcrimprimirsoportetecnico.AV9UsuarioNombre = aP7_UsuarioNombre;
         objpcrimprimirsoportetecnico.AV10UsuarioDepartamento = aP8_UsuarioDepartamento;
         objpcrimprimirsoportetecnico.AV11UsuarioRequerimiento = aP9_UsuarioRequerimiento;
         objpcrimprimirsoportetecnico.AV12TicketLaptop = aP10_TicketLaptop;
         objpcrimprimirsoportetecnico.AV13TicketDesktop = aP11_TicketDesktop;
         objpcrimprimirsoportetecnico.AV14TicketMonitor = aP12_TicketMonitor;
         objpcrimprimirsoportetecnico.AV15TicketImpresora = aP13_TicketImpresora;
         objpcrimprimirsoportetecnico.AV16TicketEscaner = aP14_TicketEscaner;
         objpcrimprimirsoportetecnico.AV17TicketRouter = aP15_TicketRouter;
         objpcrimprimirsoportetecnico.AV18TicketSistemaOperativo = aP16_TicketSistemaOperativo;
         objpcrimprimirsoportetecnico.AV19TicketOffice = aP17_TicketOffice;
         objpcrimprimirsoportetecnico.AV20TicketAntivirus = aP18_TicketAntivirus;
         objpcrimprimirsoportetecnico.AV21TicketDiscoDuroExterno = aP19_TicketDiscoDuroExterno;
         objpcrimprimirsoportetecnico.AV22TicketPerifericos = aP20_TicketPerifericos;
         objpcrimprimirsoportetecnico.AV23TicketUps = aP21_TicketUps;
         objpcrimprimirsoportetecnico.AV24TicketInstalarDataShow = aP22_TicketInstalarDataShow;
         objpcrimprimirsoportetecnico.AV25TicketOtros = aP23_TicketOtros;
         objpcrimprimirsoportetecnico.AV26UsuarioTelefono = aP24_UsuarioTelefono;
         objpcrimprimirsoportetecnico.AV27TicketFechaResponsable = aP25_TicketFechaResponsable;
         objpcrimprimirsoportetecnico.AV28TicketHoraResponsable = aP26_TicketHoraResponsable;
         objpcrimprimirsoportetecnico.context.SetSubmitInitialConfig(context);
         objpcrimprimirsoportetecnico.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objpcrimprimirsoportetecnico);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((pcrimprimirsoportetecnico)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
