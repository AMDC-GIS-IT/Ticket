...
namespace GeneXus.Programs {
   public class estadogeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "AV6EstadoId", StringUtil.LTrimStr( (decimal)(AV6EstadoId), 4, 0));
                  AV8TabCode = GetPar( "TabCode");
                  AssignAttri(sPrefix, false, "AV8TabCode", AV8TabCode);
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)Gx_mode,(short)AV6EstadoId,(string)AV8TabCode});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188135132", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6EstadoId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6EstadoId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8TabCode", StringUtil.RTrim( wcpOAV8TabCode));
         GxWebStd.gx_hidden_field( context, sPrefix+"ESTADOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A3EstadoId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vESTADOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6EstadoId), 4, 0, ".", "")));
      ...
      protected void WB230( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_15_232( true) ;
         }
         else
         {
            wb_table1_15_232( false) ;
         }
         return  ;
      }

      protected void wb_table1_15_232e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void STRUP230( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6EstadoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6EstadoId"), ".", ","));
      ...
      protected void E12232( )
      {
         ...
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Estado";
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Estado";
         ...
         {
            A3EstadoId = H00232_A3EstadoId[0];
            AV16GXLvl26 = 1;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Transactioncomponent_Component), StringUtil.Lower( "Estado")) != 0 )
         {
            WebComp_Transactioncomponent = getWebComponent(GetType(), "GeneXus.Programs", "estado", new Object[] {context} );
            WebComp_Transactioncomponent.ComponentInit();
            WebComp_Transactioncomponent.Name = "Estado";
            WebComp_Transactioncomponent_Component = "Estado";
         }
         if ( StringUtil.Len( WebComp_Transactioncomponent_Component) != 0 )
         {
            WebComp_Transactioncomponent.setjustcreated();
            WebComp_Transactioncomponent.componentprepare(new Object[] {(string)sPrefix+"W0029",(string)"",(string)Gx_mode,(short)AV6EstadoId});
      ...
      protected void E13232( )
      {
         /* 'DoUpdate' Routine */
         returnInSub = false;
         new k2bgettrncontextbyname(context ).execute(  "Estado", out  AV10TrnContext) ;
         GXt_char1 = "";
         ...
         new k2bsettrncontextbyname(context ).execute(  "Estado",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerestado.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(AV6EstadoId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","EstadoId","TabCode"}) );
      ...
      protected void E14232( )
      {
         ...
         AV10TrnContext.gxTpr_Returnmode = "Popup";
         new k2bsettrncontextbyname(context ).execute(  "Estado",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerestado.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(AV6EstadoId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","EstadoId","TabCode"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void wb_table1_15_232( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_18_232( true) ;
         }
         else
         {
            wb_table2_18_232( false) ;
         }
         return  ;
      }

      protected void wb_table2_18_232e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_15_232e( true) ;
         }
         else
         {
            wb_table1_15_232e( false) ;
         }
      }

      protected void wb_table2_18_232( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_18_232e( true) ;
         }
         else
         {
            wb_table2_18_232e( false) ;
         }
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6EstadoId = (string)((string)getParm(obj,1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "Gx_mode", Gx_mode);
            AV6EstadoId = Convert.ToInt16(getParm(obj,3));
            AssignAttri(sPrefix, false, "AV6EstadoId", StringUtil.LTrimStr( (decimal)(AV6EstadoId), 4, 0));
         ...
         wcpOAV6EstadoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6EstadoId"), ".", ","));
         wcpOAV8TabCode = cgiGet( sPrefix+"wcpOAV8TabCode");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(Gx_mode, wcpOGx_mode) != 0 ) || ( AV6EstadoId != wcpOAV6EstadoId ) || ( StringUtil.StrCmp(AV8TabCode, wcpOAV8TabCode) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOGx_mode = Gx_mode;
         wcpOAV6EstadoId = AV6EstadoId;
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV6EstadoId = cgiGet( sPrefix+"AV6EstadoId_CTRL");
         if ( StringUtil.Len( sCtrlAV6EstadoId) > 0 )
         {
            AV6EstadoId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6EstadoId), ".", ","));
            AssignAttri(sPrefix, false, "AV6EstadoId", StringUtil.LTrimStr( (decimal)(AV6EstadoId), 4, 0));
         }
         else
         {
            AV6EstadoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6EstadoId_PARM"), ".", ","));
         }
      ...
      protected void WCParametersSet( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6EstadoId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6EstadoId), 4, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6EstadoId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6EstadoId_CTRL", StringUtil.RTrim( sCtrlAV6EstadoId));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188135174", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("estadogeneral.js", "?2024188135174", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A3EstadoId',fld:'ESTADOID',pic:'ZZZ9'},{av:'AV6EstadoId',fld:'vESTADOID',pic:'ZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E13232',iparms:[{av:'AV6EstadoId',fld:'vESTADOID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E14232',iparms:[{av:'AV6EstadoId',fld:'vESTADOID',pic:'ZZZ9'}]");
      ...
      private string sCtrlAV6EstadoId ;
      ...
      private short[] H00232_A3EstadoId ;
   ...
   public class estadogeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00232", "SELECT [EstadoId] FROM [Estado] WHERE [EstadoId] = @AV6EstadoId ORDER BY [EstadoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00232,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
