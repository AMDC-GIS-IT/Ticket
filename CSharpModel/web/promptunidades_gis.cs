...
namespace GeneXus.Programs {
   public class promptunidades_gis : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188211155", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RF5C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV29K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV29K2BToolsGenericSearchField), 100, "%");
            /* Using cursor H005C2 */
            pr_datastore1.execute(0, new Object[] {lV18nombre_unidad, lV29K2BToolsGenericSearchField, lV29K2BToolsGenericSearchField, lV29K2BToolsGenericSearchField, lV29K2BToolsGenericSearchField, lV29K2BToolsGenericSearchField, GXPagingFrom2, GXPagingTo2, GXPagingFrom2, GXPagingTo2});
            nGXsfl_87_idx = 1;
            sGXsfl_87_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_87_idx), 4, 0), 4, "0");
            SubsflControlProps_872( ) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188211443", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("promptunidades_gis.js", "?2024188211445", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
