...
namespace GeneXus.Programs {
   public class estadosatisfaccionsatisfaccionwc4 : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public estadosatisfaccionsatisfaccionwc4( )
      {
      ...
      public estadosatisfaccionsatisfaccionwc4( IGxContext context )
      {
      ...
      public void execute( short aP0_SatisfaccionTiempoId )
      {
         this.AV6SatisfaccionTiempoId = aP0_SatisfaccionTiempoId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "SatisfaccionTiempoId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6SatisfaccionTiempoId = (short)(NumberUtil.Val( GetPar( "SatisfaccionTiempoId"), "."));
                  AssignAttri(sPrefix, false, "AV6SatisfaccionTiempoId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionTiempoId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV6SatisfaccionTiempoId});
                  componentstart();
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV67Pgmname = "EstadoSatisfaccionSatisfaccionWC4";
               context.Gx_err = 0;
               WS2B2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249512581", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("estadosatisfaccionsatisfaccionwc4.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6SatisfaccionTiempoId,4,0))}, new string[] {"SatisfaccionTiempoId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6SatisfaccionTiempoId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6SatisfaccionTiempoId), 4, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vSATISFACCIONTIEMPOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6SatisfaccionTiempoId), 4, 0, ",", "")));
      ...
      {
         return "EstadoSatisfaccionSatisfaccionWC4" ;
      }
      ...
      protected void WB2B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "estadosatisfaccionsatisfaccionwc4.aspx");
               context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
               context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
               context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
               context.AddJavascriptSource("K2BDateRangePicker/K2BDateRangePickerRender.js", "", false, true);
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocksatisfaccionfecha_Internalname, "Fecha Encuesta:", "", "", lblTextblocksatisfaccionfecha_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label K2BT_LabelTop", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC4.htm");
            /* User Defined Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockusuariofecha_Internalname, "Fecha", "", "", lblTextblockusuariofecha_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label K2BT_LabelTop", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC4.htm");
            /* User Defined Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;", "div");
            wb_table1_77_2B2( true) ;
         }
         else
         {
            wb_table1_77_2B2( false) ;
         }
         return  ;
      }

      protected void wb_table1_77_2B2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute_Grid"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
               context.SendWebValue( "Satisfaccion Atencion Id") ;
               context.WriteHtmlTextNl( "</th>") ;
               ...
               context.SendWebValue( "Satisfaccion Atencion Nombre") ;
               context.WriteHtmlTextNl( "</th>") ;
         ...
         if ( wbEnd == 223 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_246_2B2( true) ;
         }
         else
         {
            wb_table2_246_2B2( false) ;
         }
         return  ;
      }

      protected void wb_table2_246_2B2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagebuttontextblock_Internalname, "", "", "", lblPreviouspagebuttontextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOPREVIOUS\\'."+"'", "", lblPreviouspagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC4.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFirstpagetextblock_Internalname, lblFirstpagetextblock_Caption, "", "", lblFirstpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOFIRST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblFirstpagetextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC4.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacinglefttextblock_Internalname, "...", "", "", lblSpacinglefttextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacinglefttextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC4.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagetextblock_Internalname, lblPreviouspagetextblock_Caption, "", "", lblPreviouspagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOPREVIOUS\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPreviouspagetextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC4.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCurrentpagetextblock_Internalname, lblCurrentpagetextblock_Caption, "", "", lblCurrentpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC4.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagetextblock_Internalname, lblNextpagetextblock_Caption, "", "", lblNextpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DONEXT\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblNextpagetextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC4.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacingrighttextblock_Internalname, "...", "", "", lblSpacingrighttextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacingrighttextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC4.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLastpagetextblock_Internalname, lblLastpagetextblock_Caption, "", "", lblLastpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOLAST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblLastpagetextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC4.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagebuttontextblock_Internalname, "", "", "", lblNextpagebuttontextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DONEXT\\'."+"'", "", lblNextpagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC4.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF2B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV50K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV50K2BToolsGenericSearchField), 100, "%");
            /* Using cursor H002B2 */
            pr_default.execute(0, new Object[] {AV6SatisfaccionTiempoId, AV37SatisfaccionFecha_To, AV36SatisfaccionFecha_From, AV40UsuarioFecha_To, AV39UsuarioFecha_From, lV41SatisfaccionResueltoNombre, lV42SatisfaccionTecnicoProblemaNombre, lV43SatisfaccionTecnicoCompetenteNombre, lV44SatisfaccionTecnicoProfesionalismoNombre, lV45SatisfaccionAtencionNombre, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_223_idx = 1;
            sGXsfl_223_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_223_idx), 4, 0), 4, "0");
            SubsflControlProps_2232( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A12SatisfaccionTiempoId = H002B2_A12SatisfaccionTiempoId[0];
               A34SatisfaccionSugerencia = H002B2_A34SatisfaccionSugerencia[0];
               A31SatisfaccionAtencionNombre = H002B2_A31SatisfaccionAtencionNombre[0];
               A13SatisfaccionAtencionId = H002B2_A13SatisfaccionAtencionId[0];
               A37SatisfaccionTecnicoProfesionalismoNombre = H002B2_A37SatisfaccionTecnicoProfesionalismoNombre[0];
               A11SatisfaccionTecnicoProfesionalismoId = H002B2_A11SatisfaccionTecnicoProfesionalismoId[0];
               A35SatisfaccionTecnicoCompetenteNombre = H002B2_A35SatisfaccionTecnicoCompetenteNombre[0];
               A10SatisfaccionTecnicoCompetenteId = H002B2_A10SatisfaccionTecnicoCompetenteId[0];
               A36SatisfaccionTecnicoProblemaNombre = H002B2_A36SatisfaccionTecnicoProblemaNombre[0];
               A9SatisfaccionTecnicoProblemaId = H002B2_A9SatisfaccionTecnicoProblemaId[0];
               A33SatisfaccionResueltoNombre = H002B2_A33SatisfaccionResueltoNombre[0];
               A8SatisfaccionResueltoId = H002B2_A8SatisfaccionResueltoId[0];
               A94UsuarioRequerimiento = H002B2_A94UsuarioRequerimiento[0];
               A90UsuarioFecha = H002B2_A90UsuarioFecha[0];
               A93UsuarioNombre = H002B2_A93UsuarioNombre[0];
               A15UsuarioId = H002B2_A15UsuarioId[0];
               A14TicketId = H002B2_A14TicketId[0];
               A32SatisfaccionFecha = H002B2_A32SatisfaccionFecha[0];
               A7SatisfaccionId = H002B2_A7SatisfaccionId[0];
               A31SatisfaccionAtencionNombre = H002B2_A31SatisfaccionAtencionNombre[0];
               A37SatisfaccionTecnicoProfesionalismoNombre = H002B2_A37SatisfaccionTecnicoProfesionalismoNombre[0];
               A35SatisfaccionTecnicoCompetenteNombre = H002B2_A35SatisfaccionTecnicoCompetenteNombre[0];
               A36SatisfaccionTecnicoProblemaNombre = H002B2_A36SatisfaccionTecnicoProblemaNombre[0];
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV50K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV50K2BToolsGenericSearchField), 100, "%");
         /* Using cursor H002B3 */
         pr_default.execute(1, new Object[] {AV6SatisfaccionTiempoId, AV37SatisfaccionFecha_To, AV36SatisfaccionFecha_From, AV40UsuarioFecha_To, AV39UsuarioFecha_From, lV41SatisfaccionResueltoNombre, lV42SatisfaccionTecnicoProblemaNombre, lV43SatisfaccionTecnicoCompetenteNombre, lV44SatisfaccionTecnicoProfesionalismoNombre, lV45SatisfaccionAtencionNombre, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField});
      ...
      protected void STRUP2B0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6SatisfaccionTiempoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6SatisfaccionTiempoId"), ",", "."));
            AV51OrderedBy = (short)(context.localUtil.CToN( cgiGet( sPrefix+"vORDEREDBY"), ",", "."));
            AV6SatisfaccionTiempoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"vSATISFACCIONTIEMPOID"), ",", "."));
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV31GridStateKey = StringUtil.Str( (decimal)(AV6SatisfaccionTiempoId), 4, 0);
      ...
      protected void S192( )
      {
         ...
         AV58TrnContextAtt.gxTpr_Attributename = "SatisfaccionTiempoId";
         AV58TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6SatisfaccionTiempoId), 4, 0);
      ...
      protected void S182( )
      {
         ...
         AV14GridColumn.gxTpr_Columntitle = "Satisfaccion Atencion Nombre";
         AV14GridColumn.gxTpr_Showattribute = true;
         AV13GridColumns.Add(AV14GridColumn, 0);
         AV14GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
      ...
      protected void S212( )
      {
         ...
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Satisfaccion";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Satisfaccion";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = "ReportEstadoSatisfaccionSatisfaccionWC4";
         AV59ActivityList.Add(AV61ActivityListItem, 0);
         AV61ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Standardactivitytype = "List";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Useractivitytype = "";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Satisfaccion";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Satisfaccion";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = "ExportEstadoSatisfaccionSatisfaccionWC4";
         AV59ActivityList.Add(AV61ActivityListItem, 0);
         AV61ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
      ...
      protected void S122( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV45SatisfaccionAtencionNombre)) )
         {
            ...
            AV47K2BFilterValuesSDTItem.gxTpr_Description = "Satisfaccion Atencion Nombre";
            AV47K2BFilterValuesSDTItem.gxTpr_Type = "Standard";
      ...
      protected void wb_table2_246_2B2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoresultsfoundtextblock_Internalname, "No hay resultados", "", "", lblNoresultsfoundtextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC4.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_246_2B2e( true) ;
         }
         else
         {
            wb_table2_246_2B2e( false) ;
         }
      }

      protected void wb_table1_77_2B2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRuntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblRuntimecolumnselectiontb_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC4.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavAtt_satisfaccionatencionnombre_visible_Internalname, "Satisfaccion Atencion Nombre", "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            ...
            GxWebStd.gx_bitmap( context, imgImage1_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgImage1_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e272b1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_EstadoSatisfaccionSatisfaccionWC4.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table3_204_2B2( true) ;
         }
         else
         {
            wb_table3_204_2B2( false) ;
         }
         return  ;
      }

      protected void wb_table3_204_2B2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table4_211_2B2( true) ;
         }
         else
         {
            wb_table4_211_2B2( false) ;
         }
         return  ;
      }

      protected void wb_table4_211_2B2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_77_2B2e( true) ;
         }
         else
         {
            wb_table1_77_2B2e( false) ;
         }
      }

      protected void wb_table4_211_2B2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttInsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(223), 3, 0)+","+"null"+");", "Nuevo", bttInsert_Jsonclick, 5, bttInsert_Tooltiptext, "", StyleString, ClassString, bttInsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EstadoSatisfaccionSatisfaccionWC4.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_211_2B2e( true) ;
         }
         else
         {
            wb_table4_211_2B2e( false) ;
         }
      }

      protected void wb_table3_204_2B2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttReport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(223), 3, 0)+","+"null"+");", "Reporte", bttReport_Jsonclick, 7, bttReport_Tooltiptext, "", StyleString, ClassString, bttReport_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e282b1_client"+"'", TempTags, "", 2, "HLP_EstadoSatisfaccionSatisfaccionWC4.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='K2BToolsTableCell_ActionContainer'>") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 209,'" + sPrefix + "',false,'',0)\"";
            ClassString = "Button_Standard";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttExport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(223), 3, 0)+","+"null"+");", "Exportar", bttExport_Jsonclick, 5, bttExport_Tooltiptext, "", StyleString, ClassString, bttExport_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOEXPORT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EstadoSatisfaccionSatisfaccionWC4.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_204_2B2e( true) ;
         }
         else
         {
            wb_table3_204_2B2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6SatisfaccionTiempoId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6SatisfaccionTiempoId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionTiempoId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6SatisfaccionTiempoId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "estadosatisfaccionsatisfaccionwc4", GetJustCreated( ));
         ...
         {
            AV6SatisfaccionTiempoId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6SatisfaccionTiempoId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionTiempoId), 4, 0));
         }
         wcpOAV6SatisfaccionTiempoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6SatisfaccionTiempoId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV6SatisfaccionTiempoId != wcpOAV6SatisfaccionTiempoId ) ) )
         {
            setjustcreated();
         }
         wcpOAV6SatisfaccionTiempoId = AV6SatisfaccionTiempoId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6SatisfaccionTiempoId = cgiGet( sPrefix+"AV6SatisfaccionTiempoId_CTRL");
         if ( StringUtil.Len( sCtrlAV6SatisfaccionTiempoId) > 0 )
         {
            AV6SatisfaccionTiempoId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6SatisfaccionTiempoId), ",", "."));
            AssignAttri(sPrefix, false, "AV6SatisfaccionTiempoId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionTiempoId), 4, 0));
         }
         else
         {
            AV6SatisfaccionTiempoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6SatisfaccionTiempoId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6SatisfaccionTiempoId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6SatisfaccionTiempoId), 4, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6SatisfaccionTiempoId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6SatisfaccionTiempoId_CTRL", StringUtil.RTrim( sCtrlAV6SatisfaccionTiempoId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249513756", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("estadosatisfaccionsatisfaccionwc4.js", "?20231249513756", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/K2BDateRangePickerRender.js", "", false, true);
      ...
      protected void sendrow_2232( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_223_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute_Grid";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSatisfaccionAtencionId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A13SatisfaccionAtencionId), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A13SatisfaccionAtencionId), "ZZZ9"),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSatisfaccionAtencionId_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn InvisibleInExtraSmallColumn",(string)"",(short)0,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)223,(short)1,(short)-1,(short)0,(bool)true,(string)"NumMin",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      public override void initialize_properties( )
      {
         ...
         chkavAtt_satisfaccionatencionnombre_visible.Caption = "Satisfaccion Atencion Nombre";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOREPORT'","{handler:'E282B1',iparms:[{av:'AV6SatisfaccionTiempoId',fld:'vSATISFACCIONTIEMPOID',pic:'ZZZ9'},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV45SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'TOGGLEGRIDSETTINGSTABLE'","{handler:'E262B1',iparms:[{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E172B2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV45SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV6SatisfaccionTiempoId',fld:'vSATISFACCIONTIEMPOID',pic:'ZZZ9'},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV67Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV60AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E182B2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV45SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV6SatisfaccionTiempoId',fld:'vSATISFACCIONTIEMPOID',pic:'ZZZ9'},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV67Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV60AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E192B2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV45SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV6SatisfaccionTiempoId',fld:'vSATISFACCIONTIEMPOID',pic:'ZZZ9'},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV67Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV60AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'TOGGLEDOWNLOADACTIONS'","{handler:'E272B1',iparms:[{av:'divDownloadactionstable_Visible',ctrl:'DOWNLOADACTIONSTABLE',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERTOGGLE_COMBINED.CLICK","{handler:'E202B2',iparms:[{av:'divFiltercollapsiblesection_combined_Visible',ctrl:'FILTERCOLLAPSIBLESECTION_COMBINED',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERCLOSE_COMBINED.CLICK","{handler:'E212B2',iparms:[{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         lV50K2BToolsGenericSearchField = "";
         H002B2_A12SatisfaccionTiempoId = new short[1] ;
         H002B2_A34SatisfaccionSugerencia = new string[] {""} ;
         H002B2_A31SatisfaccionAtencionNombre = new string[] {""} ;
         H002B2_A13SatisfaccionAtencionId = new short[1] ;
         H002B2_A37SatisfaccionTecnicoProfesionalismoNombre = new string[] {""} ;
         H002B2_A11SatisfaccionTecnicoProfesionalismoId = new short[1] ;
         H002B2_A35SatisfaccionTecnicoCompetenteNombre = new string[] {""} ;
         H002B2_A10SatisfaccionTecnicoCompetenteId = new short[1] ;
         H002B2_A36SatisfaccionTecnicoProblemaNombre = new string[] {""} ;
         H002B2_A9SatisfaccionTecnicoProblemaId = new short[1] ;
         H002B2_A33SatisfaccionResueltoNombre = new string[] {""} ;
         H002B2_A8SatisfaccionResueltoId = new short[1] ;
         H002B2_A94UsuarioRequerimiento = new string[] {""} ;
         H002B2_A90UsuarioFecha = new DateTime[] {DateTime.MinValue} ;
         H002B2_A93UsuarioNombre = new string[] {""} ;
         H002B2_A15UsuarioId = new short[1] ;
         H002B2_A14TicketId = new long[1] ;
         H002B2_A32SatisfaccionFecha = new DateTime[] {DateTime.MinValue} ;
         H002B2_A7SatisfaccionId = new long[1] ;
         ...
         sCtrlAV6SatisfaccionTiempoId = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.estadosatisfaccionsatisfaccionwc4__default(),
            new Object[][] {
                new Object[] {
               H002B2_A12SatisfaccionTiempoId, H002B2_A34SatisfaccionSugerencia, H002B2_A31SatisfaccionAtencionNombre, H002B2_A13SatisfaccionAtencionId, H002B2_A37SatisfaccionTecnicoProfesionalismoNombre, H002B2_A11SatisfaccionTecnicoProfesionalismoId, H002B2_A35SatisfaccionTecnicoCompetenteNombre, H002B2_A10SatisfaccionTecnicoCompetenteId, H002B2_A36SatisfaccionTecnicoProblemaNombre, H002B2_A9SatisfaccionTecnicoProblemaId,
               H002B2_A33SatisfaccionResueltoNombre, H002B2_A8SatisfaccionResueltoId, H002B2_A94UsuarioRequerimiento, H002B2_A90UsuarioFecha, H002B2_A93UsuarioNombre, H002B2_A15UsuarioId, H002B2_A14TicketId, H002B2_A32SatisfaccionFecha, H002B2_A7SatisfaccionId
               }
               , new Object[] {
      ...
      private short AV6SatisfaccionTiempoId ;
      private short wcpOAV6SatisfaccionTiempoId ;
      ...
      private string sCtrlAV6SatisfaccionTiempoId ;
      ...
      private short[] H002B2_A12SatisfaccionTiempoId ;
      private string[] H002B2_A34SatisfaccionSugerencia ;
      private string[] H002B2_A31SatisfaccionAtencionNombre ;
      private short[] H002B2_A13SatisfaccionAtencionId ;
      private string[] H002B2_A37SatisfaccionTecnicoProfesionalismoNombre ;
      private short[] H002B2_A11SatisfaccionTecnicoProfesionalismoId ;
      private string[] H002B2_A35SatisfaccionTecnicoCompetenteNombre ;
      private short[] H002B2_A10SatisfaccionTecnicoCompetenteId ;
      private string[] H002B2_A36SatisfaccionTecnicoProblemaNombre ;
      private short[] H002B2_A9SatisfaccionTecnicoProblemaId ;
      private string[] H002B2_A33SatisfaccionResueltoNombre ;
      private short[] H002B2_A8SatisfaccionResueltoId ;
      private string[] H002B2_A94UsuarioRequerimiento ;
      private DateTime[] H002B2_A90UsuarioFecha ;
      private string[] H002B2_A93UsuarioNombre ;
      private short[] H002B2_A15UsuarioId ;
      private long[] H002B2_A14TicketId ;
      private DateTime[] H002B2_A32SatisfaccionFecha ;
      private long[] H002B2_A7SatisfaccionId ;
   ...
   public class estadosatisfaccionsatisfaccionwc4__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A12SatisfaccionTiempoId )
      {
         ...
         sOrderString = "";
         AddWhere(sWhereString, "(T1.[SatisfaccionTiempoId] = @AV6SatisfaccionTiempoId)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002B2(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (short)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] , (short)dynConstraints[25] );
               case 1 :
                     return conditional_H002B3(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (short)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] , (short)dynConstraints[25] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6SatisfaccionTiempoId",GXType.Int16,4,0) ,
