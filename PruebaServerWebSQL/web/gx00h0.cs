...
namespace GeneXus.Programs {
   public class gx00h0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV11cdetalle_infotecid_unidad = (int)(NumberUtil.Val( GetPar( "cdetalle_infotecid_unidad"), "."));
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6ccorrelativo, AV7ccargo_emp, AV8cfecha_registro, AV9chora_registro, AV10cestatus, AV11cdetalle_infotecid_unidad, AV12cid_categoria) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249572419", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCDETALLE_INFOTECID_UNIDAD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11cdetalle_infotecid_unidad), 9, 0, ",", "")));
      ...
      protected void WB5X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcorrelativo_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6ccorrelativo), 9, 0, ",", "")), ((edtavCcorrelativo_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6ccorrelativo), "ZZZZZZZZ9")) : context.localUtil.Format( (decimal)(AV6ccorrelativo), "ZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcorrelativo_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcorrelativo_Visible, edtavCcorrelativo_Enabled, 0, "number", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx00H0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCdetalle_infotecid_unidad_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11cdetalle_infotecid_unidad), 9, 0, ",", "")), ((edtavCdetalle_infotecid_unidad_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV11cdetalle_infotecid_unidad), "ZZZZZZZZ9")) : context.localUtil.Format( (decimal)(AV11cdetalle_infotecid_unidad), "ZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCdetalle_infotecid_unidad_Jsonclick, 0, "Attribute", "", "", "", "", edtavCdetalle_infotecid_unidad_Visible, edtavCdetalle_infotecid_unidad_Enabled, 0, "number", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx00H0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCid_categoria_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12cid_categoria), 9, 0, ",", "")), ((edtavCid_categoria_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV12cid_categoria), "ZZZZZZZZ9")) : context.localUtil.Format( (decimal)(AV12cid_categoria), "ZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,76);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCid_categoria_Jsonclick, 0, "Attribute", "", "", "", "", edtavCid_categoria_Visible, edtavCid_categoria_Enabled, 0, "number", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx00H0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCDETALLE_INFOTECID_UNIDAD"), ",", ".") != Convert.ToDecimal( AV11cdetalle_infotecid_unidad )) )
                                       {
                                          Rfr0gs = true;
                                       }
      ...
      protected void gxgrGrid1_refresh( int subGrid1_Rows ,
                                        ...
                                        string AV10cestatus ,
                                        int AV11cdetalle_infotecid_unidad ,
      ...
      protected void RF5X2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H005X2 */
            pr_datastore1.execute(0, new Object[] {AV6ccorrelativo, lV7ccargo_emp, AV8cfecha_registro, AV9chora_registro, lV10cestatus, AV11cdetalle_infotecid_unidad, AV12cid_categoria, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_84_idx = 1;
            sGXsfl_84_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_84_idx), 4, 0), 4, "0");
            SubsflControlProps_842( ) ;
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         lV10cestatus = StringUtil.Concat( StringUtil.RTrim( AV10cestatus), "%", "");
         /* Using cursor H005X3 */
         pr_datastore1.execute(1, new Object[] {AV6ccorrelativo, lV7ccargo_emp, AV8cfecha_registro, AV9chora_registro, lV10cestatus, AV11cdetalle_infotecid_unidad, AV12cid_categoria});
      ...
      protected void STRUP5X0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCdetalle_infotecid_unidad_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCdetalle_infotecid_unidad_Internalname), ",", ".") > Convert.ToDecimal( 999999999 )) ) )
            {
               ...
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV11cdetalle_infotecid_unidad = 0;
               AssignAttri("", false, "AV11cdetalle_infotecid_unidad", StringUtil.LTrimStr( (decimal)(AV11cdetalle_infotecid_unidad), 9, 0));
            }
            else
            {
               AV11cdetalle_infotecid_unidad = (int)(context.localUtil.CToN( cgiGet( edtavCdetalle_infotecid_unidad_Internalname), ",", "."));
               AssignAttri("", false, "AV11cdetalle_infotecid_unidad", StringUtil.LTrimStr( (decimal)(AV11cdetalle_infotecid_unidad), 9, 0));
            }
            ...
            if ( context.localUtil.CToD( cgiGet( "GXH_vCFECHA_REGISTRO"), 2) != AV8cfecha_registro )
            {
               GRID1_nFirstRecordOnPage = 0;
            }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249572482", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00h0.js", "?20231249572482", false, true);
      ...
      protected void sendrow_842( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_84_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtcorrelativo_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A238correlativo), 9, 0, ",", "")),context.localUtil.Format( (decimal)(A238correlativo), "ZZZZZZZZ9"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtcorrelativo_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)9,(short)0,(short)0,(short)84,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6ccorrelativo',fld:'vCCORRELATIVO',pic:'ZZZZZZZZ9'},{av:'AV7ccargo_emp',fld:'vCCARGO_EMP',pic:''},{av:'AV8cfecha_registro',fld:'vCFECHA_REGISTRO',pic:''},{av:'AV9chora_registro',fld:'vCHORA_REGISTRO',pic:'99/99/99 99:99'},{av:'AV10cestatus',fld:'vCESTATUS',pic:''},{av:'AV11cdetalle_infotecid_unidad',fld:'vCDETALLE_INFOTECID_UNIDAD',pic:'ZZZZZZZZ9'},{av:'AV12cid_categoria',fld:'vCID_CATEGORIA',pic:'ZZZZZZZZ9'}]");
      ...
      private int AV11cdetalle_infotecid_unidad ;
   ...
   public class gx00h0__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int AV6ccorrelativo )
      {
         ...
         if ( ! (0==AV11cdetalle_infotecid_unidad) )
         {
            AddWhere(sWhereString, "([id_unidad] >= @AV11cdetalle_infotecid_unidad)");
         }
         else
         {
            GXv_int1[5] = 1;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV11cdetalle_infotecid_unidad",GXType.Int32,9,0) ,
