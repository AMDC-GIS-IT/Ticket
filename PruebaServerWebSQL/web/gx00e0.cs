...
namespace GeneXus.Programs {
   public class gx00e0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249572468", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB5G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcategoria_tareaid_tipo_categoria_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6ccategoria_tareaid_tipo_categoria), 9, 0, ",", "")), ((edtavCcategoria_tareaid_tipo_categoria_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6ccategoria_tareaid_tipo_categoria), "ZZZZZZZZ9")) : context.localUtil.Format( (decimal)(AV6ccategoria_tareaid_tipo_categoria), "ZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcategoria_tareaid_tipo_categoria_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcategoria_tareaid_tipo_categoria_Visible, edtavCcategoria_tareaid_tipo_categoria_Enabled, 0, "number", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx00E0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCid_unidad_gis_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7cid_unidad_gis), 9, 0, ",", "")), ((edtavCid_unidad_gis_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV7cid_unidad_gis), "ZZZZZZZZ9")) : context.localUtil.Format( (decimal)(AV7cid_unidad_gis), "ZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCid_unidad_gis_Jsonclick, 0, "Attribute", "", "", "", "", edtavCid_unidad_gis_Visible, edtavCid_unidad_gis_Enabled, 0, "number", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx00E0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcategoria_tareaestado_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8ccategoria_tareaestado), 9, 0, ",", "")), ((edtavCcategoria_tareaestado_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV8ccategoria_tareaestado), "ZZZZZZZZ9")) : context.localUtil.Format( (decimal)(AV8ccategoria_tareaestado), "ZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcategoria_tareaestado_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcategoria_tareaestado_Visible, edtavCcategoria_tareaestado_Enabled, 0, "number", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx00E0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcategoria_tareahora_creacion_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10ccategoria_tareahora_creacion), 5, 0, ",", "")), ((edtavCcategoria_tareahora_creacion_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10ccategoria_tareahora_creacion), "ZZZZ9")) : context.localUtil.Format( (decimal)(AV10ccategoria_tareahora_creacion), "ZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcategoria_tareahora_creacion_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcategoria_tareahora_creacion_Visible, edtavCcategoria_tareahora_creacion_Enabled, 0, "number", "1", 5, "chr", 1, "row", 5, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx00E0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF5G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H005G2 */
            pr_datastore1.execute(0, new Object[] {AV6ccategoria_tareaid_tipo_categoria, AV7cid_unidad_gis, AV8ccategoria_tareaestado, AV9ccategoria_tareafecha_creacion, AV10ccategoria_tareahora_creacion, lV11ccategoria_tareacreado_por, AV12ccategoria_tareafecha_modificacion, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_84_idx = 1;
            sGXsfl_84_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_84_idx), 4, 0), 4, "0");
            SubsflControlProps_842( ) ;
      ...
      protected void STRUP5G0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.CToD( cgiGet( "GXH_vCCATEGORIA_TAREAFECHA_CREACION"), 2) != AV9ccategoria_tareafecha_creacion )
            {
               GRID1_nFirstRecordOnPage = 0;
            }
            if ( ( context.localUtil.CToN( cgiGet( "GXH_vCCATEGORIA_TAREAHORA_CREACION"), ",", ".") != Convert.ToDecimal( AV10ccategoria_tareahora_creacion )) )
            ...
            if ( context.localUtil.CToD( cgiGet( "GXH_vCCATEGORIA_TAREAFECHA_MODIFICACION"), 2) != AV12ccategoria_tareafecha_modificacion )
            {
               GRID1_nFirstRecordOnPage = 0;
            }
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249572529", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00e0.js", "?20231249572529", false, true);
      ...
      protected void sendrow_842( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_84_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtcategoria_tareaid_tipo_categoria_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A104categoria_tareaid_tipo_categoria), 9, 0, ",", "")),context.localUtil.Format( (decimal)(A104categoria_tareaid_tipo_categoria), "ZZZZZZZZ9"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtcategoria_tareaid_tipo_categoria_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)9,(short)0,(short)0,(short)84,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtid_unidad_gis_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A105id_unidad_gis), 9, 0, ",", "")),context.localUtil.Format( (decimal)(A105id_unidad_gis), "ZZZZZZZZ9"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtid_unidad_gis_Link,(string)"",(string)"",(string)"",(string)edtid_unidad_gis_Jsonclick,(short)0,(string)"DescriptionAttribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)9,(short)0,(short)0,(short)84,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtcategoria_tareaestado_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A107categoria_tareaestado), 9, 0, ",", "")),context.localUtil.Format( (decimal)(A107categoria_tareaestado), "ZZZZZZZZ9"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtcategoria_tareaestado_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn OptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)9,(short)0,(short)0,(short)84,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
