...
namespace GeneXus.Programs {
   public class estadoticketusuariowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV58Pgmname = "EstadoTicketUsuarioWC";
               context.Gx_err = 0;
               WS2G2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2023124950076", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void wb_table1_58_2G2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" width="+StringUtil.LTrimStr( (decimal)(62), 4, 0)+"px"+" class=\""+"Attribute_Grid"+"\" "+" style=\""+((edtUsuarioId_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV54Update)) ? AV60Update_GXI : context.convertURL( context.PathToRelativeUrl( AV54Update))), !bGXsfl_180_Refreshing);
                              ...
                              AssignProp(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV55Delete)) ? AV61Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV55Delete))), !bGXsfl_180_Refreshing);
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_USUARIOID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A15UsuarioId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"USUARIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A15UsuarioId), 4, 0, ".", "")));
      }
      ...
      protected void send_integrity_lvl_hashes2G2( )
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV58Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV58Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_USUARIOID"+"_"+sGXsfl_180_idx, GetSecureSignedToken( sPrefix+sGXsfl_180_idx, context.localUtil.Format( (decimal)(A15UsuarioId), "ZZZ9"), context));
      }
      ...
      protected void STRUP2G0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            if ( context.localUtil.CToD( cgiGet( sPrefix+"GXH_vUSUARIOFECHA_FROM"), 2) != AV33UsuarioFecha_From )
            {
               GRID_nFirstRecordOnPage = 0;
            }
      ...
      protected void E222G2( )
      {
         ...
         AssignAttri(sPrefix, false, "AV37UsuarioHora_To", context.localUtil.TToC( AV37UsuarioHora_To, 0, 5, 0, 3, "/", ":", " "));
         new k2bloadrowsperpage(context ).execute(  AV58Pgmname,  "Grid", out  AV25RowsPerPageVariable, out  AV26RowsPerPageLoaded) ;
      ...
      protected void E232G2( )
      {
         ...
         AV59GXV1 = 1;
         while ( AV59GXV1 <= AV47Messages.Count )
         {
            AV48Message = ((GeneXus.Utils.SdtMessages_Message)AV47Messages.Item(AV59GXV1));
         ...
         AV52ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV58Pgmname;
         ...
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV54Update)) ? AV60Update_GXI : context.convertURL( context.PathToRelativeUrl( AV54Update))), !bGXsfl_180_Refreshing);
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV54Update), true);
         AV60Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "788f9b72-f982-49f9-99e4-c0374e31a85a", "", context.GetTheme( )));
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV54Update)) ? AV60Update_GXI : context.convertURL( context.PathToRelativeUrl( AV54Update))), !bGXsfl_180_Refreshing);
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV54Update), true);
         ...
         AssignProp(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV55Delete)) ? AV61Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV55Delete))), !bGXsfl_180_Refreshing);
         AssignProp(sPrefix, false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV55Delete), true);
         AV61Delete_GXI = GXDbFile.PathToUrl( context.GetImagePath( "3e4a9f50-2c57-41b6-9da5-ebe49bca33c0", "", context.GetTheme( )));
         AssignProp(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV55Delete)) ? AV61Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV55Delete))), !bGXsfl_180_Refreshing);
         AssignProp(sPrefix, false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV55Delete), true);
      ...
      protected void S112( )
      {
         ...
         new k2bloadgridstate(context ).execute(  AV58Pgmname,  AV27GridStateKey, out  AV28GridState) ;
         ...
         AV62GXV2 = 1;
         while ( AV62GXV2 <= AV28GridState.gxTpr_Filtervalues.Count )
         {
            AV29GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV28GridState.gxTpr_Filtervalues.Item(AV62GXV2));
      ...
      protected void S132( )
      {
         ...
         AV28GridState.gxTpr_Filtervalues.Add(AV29GridStateFilterValue, 0);
         new k2bsavegridstate(context ).execute(  AV58Pgmname,  AV27GridStateKey,  AV28GridState) ;
      }
      ...
      protected void E142G2( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         CallWebObject(formatLink("exportestadoticketusuariowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6EstadoTicketId,4,0)),UrlEncode(StringUtil.RTrim(AV31UsuarioNombre)),UrlEncode(DateTimeUtil.FormatDateParm(AV33UsuarioFecha_From)),UrlEncode(DateTimeUtil.FormatDateParm(AV34UsuarioFecha_To)),UrlEncode(DateTimeUtil.FormatDateTimeParm(AV36UsuarioHora_From)),UrlEncode(DateTimeUtil.FormatDateTimeParm(AV37UsuarioHora_To)),UrlEncode(StringUtil.RTrim(AV42K2BToolsGenericSearchField)),UrlEncode(StringUtil.LTrimStr(AV43OrderedBy,4,0))}, new string[] {"EstadoTicketId","UsuarioNombre","UsuarioFecha_From","UsuarioFecha_To","UsuarioHora_From","UsuarioHora_To","K2BToolsGenericSearchField","OrderedBy"}) );
      ...
      protected void S202( )
      {
         ...
         AssignAttri(sPrefix, false, "AV23Att_UsuarioTelefono_Visible", AV23Att_UsuarioTelefono_Visible);
         new k2bsavegridconfiguration(context ).execute(  AV58Pgmname,  "Grid",  AV11GridConfiguration,  false) ;
         AV63GXV3 = 1;
         while ( AV63GXV3 <= AV11GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV14GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV11GridConfiguration.gxTpr_Gridcolumns.Item(AV63GXV3));
      ...
      private void E252G2( )
      {
         ...
         edtavUpdate_Link = formatLink("entitymanagerusuario.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A15UsuarioId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"Mode","UsuarioId","TabCode"}) ;
         edtavUpdate_Tooltiptext = "Actualizar";
         edtavDelete_Enabled = 1;
         edtavDelete_Link = formatLink("entitymanagerusuario.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A15UsuarioId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"Mode","UsuarioId","TabCode"}) ;
         edtavDelete_Tooltiptext = "Eliminar";
         /* Load Method */
         if ( wbStart != -1 )
         {
      ...
      protected void S122( )
      {
         ...
         if ( AV38K2BFilterValuesSDT.Count > 0 )
         {
            ...
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV58Pgmname,  "Grid",  AV38K2BFilterValuesSDT, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item4) ;
      ...
      protected void E152G2( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  AV58Pgmname,  "Grid", ref  AV11GridConfiguration) ;
         AV64GXV4 = 1;
         while ( AV64GXV4 <= AV11GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV14GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV11GridConfiguration.gxTpr_Gridcolumns.Item(AV64GXV4));
            if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "UsuarioId") == 0 )
            {
         ...
         new k2bsavegridconfiguration(context ).execute(  AV58Pgmname,  "Grid",  AV11GridConfiguration,  true) ;
         AV46UC_OrderedBy = AV43OrderedBy;
         AssignAttri(sPrefix, false, "AV46UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV46UC_OrderedBy), 4, 0));
         if ( AV25RowsPerPageVariable != AV24GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV25RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, sPrefix+"GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV58Pgmname,  "Grid",  AV25RowsPerPageVariable) ;
            AV9CurrentPage = 1;
            AssignAttri(sPrefix, false, "AV9CurrentPage", StringUtil.LTrimStr( (decimal)(AV9CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023124950791", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("estadoticketusuariowc.js", "?2023124950792", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/K2BDateRangePickerRender.js", "", false, true);
      ...
      protected void sendrow_1802( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_180_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV54Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV54Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV60Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV54Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV54Update)) ? AV60Update_GXI : context.PathToRelativeUrl( AV54Update));
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV55Delete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV55Delete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV61Delete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV55Delete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV55Delete)) ? AV61Delete_GXI : context.PathToRelativeUrl( AV55Delete));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E252G2',iparms:[{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZ9',hsh:true},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED","{handler:'E112G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'sPrefix'},{av:'AV41DeletedTag',fld:'vDELETEDTAG',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E122G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'sPrefix'},{av:'AV46UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E152G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'sPrefix'},{av:'AV25RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV24GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E162G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E172G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E182G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E192G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV33UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV36UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV37UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV53UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV16Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV19Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV23Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         H002G2_A15UsuarioId = new short[1] ;
      ...
      private string AV60Update_GXI ;
      private string AV61Delete_GXI ;
      ...
      private short[] H002G2_A15UsuarioId ;
   ...
   public class estadoticketusuariowc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002G2(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (DateTime)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (DateTime)dynConstraints[7] , (DateTime)dynConstraints[8] , (short)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (int)dynConstraints[14] , (short)dynConstraints[15] , (short)dynConstraints[16] , (short)dynConstraints[17] );
               case 1 :
