...
namespace GeneXus.Programs {
   public class exportwwusuariosistema : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      void executePrivate( )
      {
         ...
         if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "UsuarioSistema",  "UsuarioSistema",  "List",  "",  "WWUsuarioSistema") )
         {
            AV19Filename = "";
            ...
            AV20ErrorMessage += "PgmName:" + AV31Pgmname;
         ...
         AV19Filename = GxDirectory.TemporaryFilesPath + AV22File.Separator + "ExportWWUsuarioSistema-" + StringUtil.Trim( StringUtil.Str( (decimal)(AV17Random), 8, 0)) + ".xlsx";
         ...
         if ( ! context.isAjaxRequest( ) )
         {
            AV21HttpResponse.AppendHeader("Content-Disposition", "attachment;filename=ExportWWUsuarioSistema.xlsx");
         }
         if ( ! context.isAjaxRequest( ) )
         {
      ...
      public override void initialize( )
      {
         ...
         AV31Pgmname = "ExportWWUsuarioSistema";
         /* GeneXus formulas. */
         AV31Pgmname = "ExportWWUsuarioSistema";
         context.Gx_err = 0;
      }
