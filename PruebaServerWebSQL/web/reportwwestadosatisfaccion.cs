...
namespace GeneXus.Programs {
   public class reportwwestadosatisfaccion : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public reportwwestadosatisfaccion( )
      {
      ...
      public reportwwestadosatisfaccion( IGxContext context )
      {
      ...
      public void executeSubmit( string aP0_K2BToolsGenericSearchField ,
                                 short aP1_OrderedBy )
      {
         reportwwestadosatisfaccion objreportwwestadosatisfaccion;
         objreportwwestadosatisfaccion = new reportwwestadosatisfaccion();
         objreportwwestadosatisfaccion.AV9K2BToolsGenericSearchField = aP0_K2BToolsGenericSearchField;
         objreportwwestadosatisfaccion.AV10OrderedBy = aP1_OrderedBy;
         objreportwwestadosatisfaccion.context.SetSubmitInitialConfig(context);
         objreportwwestadosatisfaccion.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objreportwwestadosatisfaccion);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((reportwwestadosatisfaccion)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "EstadoSatisfaccion",  "EstadoSatisfaccion",  "List",  "",  AV20Pgmname) )
            {
               H350( false, 30) ;
            ...
            else
            {
               ...
               getPrinter().GxDrawText("Estado satisfaccion", 205, Gx_line+0, 622, Gx_line+42, 0+256, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
               ...
               getPrinter().GxDrawText("Satisfacción", 56, Gx_line+7, 276, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Estado", 284, Gx_line+7, 329, Gx_line+22, 0, 0, 0, 1) ;
               Gx_OldLine = Gx_line;
               Gx_line = (int)(Gx_line+30);
               GxHdr3 = true;
               ...
               lV9K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV9K2BToolsGenericSearchField), 200, "%");
               /* Using cursor P00352 */
               pr_default.execute(0, new Object[] {lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField});
               while ( (pr_default.getStatus(0) != 101) )
               {
                  A22EstadoSatisfaccionNombre = P00352_A22EstadoSatisfaccionNombre[0];
                  A4EstadoSatisfaccionId = P00352_A4EstadoSatisfaccionId[0];
                  A21EstadoSatisfaccionEstado = P00352_A21EstadoSatisfaccionEstado[0];
                  AV15Grid_EstadoSatisfaccionEstado = (A21EstadoSatisfaccionEstado ? "Si" : "No");
                  H350( false, 30) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(A4EstadoSatisfaccionId), "ZZZ9")), 18, Gx_line+7, 48, Gx_line+23, 2, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A22EstadoSatisfaccionNombre, "")), 56, Gx_line+7, 276, Gx_line+23, 0, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV15Grid_EstadoSatisfaccionEstado, "")), 284, Gx_line+7, 329, Gx_line+23, 0, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
      ...
      public override void initialize( )
      {
         ...
         A22EstadoSatisfaccionNombre = "";
         P00352_A22EstadoSatisfaccionNombre = new string[] {""} ;
         P00352_A4EstadoSatisfaccionId = new short[1] ;
         P00352_A21EstadoSatisfaccionEstado = new bool[] {false} ;
         AV15Grid_EstadoSatisfaccionEstado = "";
         Gx_date = DateTime.MinValue;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportwwestadosatisfaccion__default(),
            new Object[][] {
                new Object[] {
               P00352_A22EstadoSatisfaccionNombre, P00352_A4EstadoSatisfaccionId, P00352_A21EstadoSatisfaccionEstado
               }
            }
         );
         AV20Pgmname = "ReportWWEstadoSatisfaccion";
      ...
      private string AV15Grid_EstadoSatisfaccionEstado ;
      ...
      private string[] P00352_A22EstadoSatisfaccionNombre ;
      private short[] P00352_A4EstadoSatisfaccionId ;
      private bool[] P00352_A21EstadoSatisfaccionEstado ;
      private SdtK2BContext AV8Context ;
   }

   public class reportwwestadosatisfaccion__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV10OrderedBy )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(4), CAST([EstadoSatisfaccionId] AS decimal(4,0))) like '%' + @lV9K2BToolsGenericSearchField + '%' or [EstadoSatisfaccionNombre] like '%' + @lV9K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int1[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00352(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] );
         }
