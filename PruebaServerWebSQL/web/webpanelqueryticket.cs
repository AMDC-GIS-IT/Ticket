...
namespace GeneXus.Programs {
   public class webpanelqueryticket : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249571057", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.AddJavascriptSource("QueryViewer/Echarts/dist/echarts.min.js", "", false, true);
         context.AddJavascriptSource("QueryViewer/Echarts/dist/extension/bmap.js", "", false, true);
      ...
      protected void WB6W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavFechausuariodesde_Internalname, context.localUtil.Format(AV5FechaUsuarioDesde, "99/99/9999"), context.localUtil.Format( AV5FechaUsuarioDesde, "99/99/9999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,14);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFechausuariodesde_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFechausuariodesde_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_WebPanelQueryTicket.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavFechausuariohasta_Internalname, context.localUtil.Format(AV6FechaUsuarioHasta, "99/99/9999"), context.localUtil.Format( AV6FechaUsuarioHasta, "99/99/9999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,19);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFechausuariohasta_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFechausuariohasta_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_WebPanelQueryTicket.htm");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249571088", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("webpanelqueryticket.js", "?20231249571090", false, true);
         context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
         context.AddJavascriptSource("QueryViewer/highcharts/highcharts.js", "", false, true);
         context.AddJavascriptSource("QueryViewer/Echarts/dist/echarts.min.js", "", false, true);
         context.AddJavascriptSource("QueryViewer/Echarts/dist/extension/bmap.js", "", false, true);
