...
namespace GeneXus.Programs {
   public class etapasdesarrollogeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public etapasdesarrollogeneral( )
      {
      ...
      public etapasdesarrollogeneral( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)Gx_mode,(short)AV6EtapaDesarrolloId,(string)AV8TabCode});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249492128", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      {
         return "EtapasDesarrolloGeneral" ;
      }
      ...
      protected void WB780( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "etapasdesarrollogeneral.aspx");
            }
            /* Div Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_15_782( true) ;
         }
         else
         {
            wb_table1_15_782( false) ;
         }
         return  ;
      }

      protected void wb_table1_15_782e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void E12782( )
      {
         ...
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "EtapasDesarrollo";
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "EtapasDesarrollo";
         ...
         {
            A290EtapaDesarrolloId = H00782_A290EtapaDesarrolloId[0];
            AV16GXLvl26 = 1;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Transactioncomponent_Component), StringUtil.Lower( "EtapasDesarrollo")) != 0 )
         {
            WebComp_Transactioncomponent = getWebComponent(GetType(), "GeneXus.Programs", "etapasdesarrollo", new Object[] {context} );
            WebComp_Transactioncomponent.ComponentInit();
            WebComp_Transactioncomponent.Name = "EtapasDesarrollo";
            WebComp_Transactioncomponent_Component = "EtapasDesarrollo";
         }
         if ( StringUtil.Len( WebComp_Transactioncomponent_Component) != 0 )
         {
            WebComp_Transactioncomponent.setjustcreated();
            WebComp_Transactioncomponent.componentprepare(new Object[] {(string)sPrefix+"W0029",(string)"",(string)Gx_mode,(short)AV6EtapaDesarrolloId});
      ...
      protected void E13782( )
      {
         /* 'DoUpdate' Routine */
         returnInSub = false;
         new k2bgettrncontextbyname(context ).execute(  "EtapasDesarrollo", out  AV10TrnContext) ;
         GXt_char1 = "";
         ...
         new k2bsettrncontextbyname(context ).execute(  "EtapasDesarrollo",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanageretapasdesarrollo.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(AV6EtapaDesarrolloId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","EtapaDesarrolloId","TabCode"}) );
      ...
      protected void E14782( )
      {
         ...
         AV10TrnContext.gxTpr_Returnmode = "Popup";
         new k2bsettrncontextbyname(context ).execute(  "EtapasDesarrollo",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanageretapasdesarrollo.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(AV6EtapaDesarrolloId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","EtapaDesarrolloId","TabCode"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void wb_table1_15_782( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_18_782( true) ;
         }
         else
         {
            wb_table2_18_782( false) ;
         }
         return  ;
      }

      protected void wb_table2_18_782e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_15_782e( true) ;
         }
         else
         {
            wb_table1_15_782e( false) ;
         }
      }

      protected void wb_table2_18_782( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_18_782e( true) ;
         }
         else
         {
            wb_table2_18_782e( false) ;
         }
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6EtapaDesarrolloId = (string)((string)getParm(obj,1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "etapasdesarrollogeneral", GetJustCreated( ));
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "Gx_mode", Gx_mode);
            AV6EtapaDesarrolloId = Convert.ToInt16(getParm(obj,3));
            AssignAttri(sPrefix, false, "AV6EtapaDesarrolloId", StringUtil.LTrimStr( (decimal)(AV6EtapaDesarrolloId), 4, 0));
         ...
         wcpOAV6EtapaDesarrolloId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6EtapaDesarrolloId"), ",", "."));
         wcpOAV8TabCode = cgiGet( sPrefix+"wcpOAV8TabCode");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(Gx_mode, wcpOGx_mode) != 0 ) || ( AV6EtapaDesarrolloId != wcpOAV6EtapaDesarrolloId ) || ( StringUtil.StrCmp(AV8TabCode, wcpOAV8TabCode) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOGx_mode = Gx_mode;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249492165", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("etapasdesarrollogeneral.js", "?20231249492166", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A290EtapaDesarrolloId',fld:'ETAPADESARROLLOID',pic:'ZZZ9'},{av:'AV6EtapaDesarrolloId',fld:'vETAPADESARROLLOID',pic:'ZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E13782',iparms:[{av:'AV6EtapaDesarrolloId',fld:'vETAPADESARROLLOID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E14782',iparms:[{av:'AV6EtapaDesarrolloId',fld:'vETAPADESARROLLOID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV12ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         scmdbuf = "";
         H00782_A290EtapaDesarrolloId = new short[1] ;
         ...
         sCtrlAV8TabCode = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.etapasdesarrollogeneral__default(),
            new Object[][] {
                new Object[] {
               H00782_A290EtapaDesarrolloId
               }
            }
         );
      ...
      private short[] H00782_A290EtapaDesarrolloId ;
   ...
   public class etapasdesarrollogeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00782", "SELECT [EtapaDesarrolloId] FROM [EtapasDesarrollo] WHERE [EtapaDesarrolloId] = @AV6EtapaDesarrolloId ORDER BY [EtapaDesarrolloId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00782,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
