...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="K2BMultiLevelPersistedMenuItem" , Namespace="kb_ticket" )]
	[Serializable]
	public class SdtK2BMultiLevelPersistedMenu_K2BMultiLevelPersistedMenuItem : GxUserType
	{
		...
		public GXBaseCollection<GeneXus.Programs.SdtK2BMultiLevelPersistedMenu_K2BMultiLevelPersistedMenuItem> gxTpr_Items_GXBaseCollection
		{
			...
			set {
				...
				gxTv_SdtK2BMultiLevelPersistedMenu_K2BMultiLevelPersistedMenuItem_Items_N = 0;
		...
		{
			gxTv_SdtK2BMultiLevelPersistedMenu_K2BMultiLevelPersistedMenuItem_Items_N = 1;
		...
		{
			gxTv_SdtK2BMultiLevelPersistedMenu_K2BMultiLevelPersistedMenuItem_Activity_N = 1;
		...
		protected short gxTv_SdtK2BMultiLevelPersistedMenu_K2BMultiLevelPersistedMenuItem_Items_N;
		...
		protected short gxTv_SdtK2BMultiLevelPersistedMenu_K2BMultiLevelPersistedMenuItem_Activity_N;
	...
	[DataContract(Name=@"K2BMultiLevelPersistedMenuItem", Namespace="kb_ticket")]
