...
namespace GeneXus.Programs {
   public class wpasignarticketdesarrollo : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249571423", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      {
         return "WPAsignar Ticket Desarrollo" ;
      }
      ...
      protected void START7B2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "WPAsignar Ticket Desarrollo", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void S212( )
      {
         ...
         returnInSub = false;
         context.PopUp(formatLink("wpregistrarticketdesarrollo.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A15UsuarioId,4,0)),UrlEncode(StringUtil.RTrim(A93UsuarioNombre)),UrlEncode(StringUtil.RTrim(A91UsuarioGerencia)),UrlEncode(StringUtil.RTrim(A88UsuarioDepartamento)),UrlEncode(StringUtil.RTrim(A94UsuarioRequerimiento))}, new string[] {"UsuarioId","UsuarioNombre","UsuarioGerencia","UsuarioDepartamento","UsuarioRequerimiento"}) , new Object[] {});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249571662", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpasignarticketdesarrollo.js", "?20231249571662", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "WPAsignar Ticket Desarrollo";
      ...
      public override void initialize( )
      {
         ...
         H007B2_A15UsuarioId = new short[1] ;
      ...
      private short[] H007B2_A15UsuarioId ;
