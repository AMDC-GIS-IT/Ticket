...
namespace GeneXus.Programs {
   public class webpanelticketsasignados : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249571248", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249571526", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("webpanelticketsasignados.js", "?20231249571526", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         H006Z2_A15UsuarioId = new short[1] ;
      ...
      private short[] H006Z2_A15UsuarioId ;
   ...
   public class webpanelticketsasignados__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV21OrderedBy_Grid )
      {
         ...
         {
            AddWhere(sWhereString, "(CONVERT( char(4), CAST(T3.[UsuarioId] AS decimal(4,0))) like '%' + @lV28GenericFilter_Grid + '%' or T4.[UsuarioNombre] like '%' + @lV28GenericFilter_Grid + '%' or T4.[UsuarioGerencia] like '%' + @lV28GenericFilter_Grid + '%' or T4.[UsuarioDepartamento] like '%' + @lV28GenericFilter_Grid + '%' or T4.[UsuarioRequerimiento] like '%' + @lV28GenericFilter_Grid + '%' or CONVERT( char(9), CAST(T4.[UsuarioTelefono] AS decimal(9,0))) like '%' + @lV28GenericFilter_Grid + '%' or T5.[EstadoTicketNombre] like '%' + @lV28GenericFilter_Grid + '%' or T2.[ResponsableNombre] like '%' + @lV28GenericFilter_Grid + '%')");
         }
         else
         {
            GXv_int3[3] = 1;
                                             ...
                                             short AV21OrderedBy_Grid )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV28GenericFilter_Grid)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(4), CAST(T2.[UsuarioId] AS decimal(4,0))) like '%' + @lV28GenericFilter_Grid + '%' or T3.[UsuarioNombre] like '%' + @lV28GenericFilter_Grid + '%' or T3.[UsuarioGerencia] like '%' + @lV28GenericFilter_Grid + '%' or T3.[UsuarioDepartamento] like '%' + @lV28GenericFilter_Grid + '%' or T3.[UsuarioRequerimiento] like '%' + @lV28GenericFilter_Grid + '%' or CONVERT( char(9), CAST(T3.[UsuarioTelefono] AS decimal(9,0))) like '%' + @lV28GenericFilter_Grid + '%' or T4.[EstadoTicketNombre] like '%' + @lV28GenericFilter_Grid + '%' or T5.[ResponsableNombre] like '%' + @lV28GenericFilter_Grid + '%')");
         }
         else
         {
            GXv_int5[3] = 1;
