...
namespace GeneXus.Programs {
   public class estadoticketgeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public estadoticketgeneral( )
      {
      ...
      public estadoticketgeneral( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)Gx_mode,(short)AV6EstadoTicketId,(string)AV8TabCode});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2023124952190", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB2F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "estadoticketgeneral.aspx");
            }
            /* Div Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_15_2F2( true) ;
         }
         else
         {
            wb_table1_15_2F2( false) ;
         }
         return  ;
      }

      protected void wb_table1_15_2F2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void E122F2( )
      {
         ...
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "EstadoTicket";
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "EstadoTicket";
         ...
         {
            A5EstadoTicketId = H002F2_A5EstadoTicketId[0];
            AV16GXLvl26 = 1;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Transactioncomponent_Component), StringUtil.Lower( "EstadoTicket")) != 0 )
         {
            WebComp_Transactioncomponent = getWebComponent(GetType(), "GeneXus.Programs", "estadoticket", new Object[] {context} );
            WebComp_Transactioncomponent.ComponentInit();
            WebComp_Transactioncomponent.Name = "EstadoTicket";
            WebComp_Transactioncomponent_Component = "EstadoTicket";
         }
         if ( StringUtil.Len( WebComp_Transactioncomponent_Component) != 0 )
         {
            WebComp_Transactioncomponent.setjustcreated();
            WebComp_Transactioncomponent.componentprepare(new Object[] {(string)sPrefix+"W0029",(string)"",(string)Gx_mode,(short)AV6EstadoTicketId});
      ...
      protected void E132F2( )
      {
         /* 'DoUpdate' Routine */
         returnInSub = false;
         new k2bgettrncontextbyname(context ).execute(  "EstadoTicket", out  AV10TrnContext) ;
         GXt_char1 = "";
         ...
         new k2bsettrncontextbyname(context ).execute(  "EstadoTicket",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerestadoticket.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(AV6EstadoTicketId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","EstadoTicketId","TabCode"}) );
      ...
      protected void E142F2( )
      {
         ...
         AV10TrnContext.gxTpr_Returnmode = "Popup";
         new k2bsettrncontextbyname(context ).execute(  "EstadoTicket",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerestadoticket.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(AV6EstadoTicketId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","EstadoTicketId","TabCode"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void wb_table1_15_2F2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_18_2F2( true) ;
         }
         else
         {
            wb_table2_18_2F2( false) ;
         }
         return  ;
      }

      protected void wb_table2_18_2F2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_15_2F2e( true) ;
         }
         else
         {
            wb_table1_15_2F2e( false) ;
         }
      }

      protected void wb_table2_18_2F2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_18_2F2e( true) ;
         }
         else
         {
            wb_table2_18_2F2e( false) ;
         }
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6EstadoTicketId = (string)((string)getParm(obj,1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "estadoticketgeneral", GetJustCreated( ));
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "Gx_mode", Gx_mode);
            AV6EstadoTicketId = Convert.ToInt16(getParm(obj,3));
            AssignAttri(sPrefix, false, "AV6EstadoTicketId", StringUtil.LTrimStr( (decimal)(AV6EstadoTicketId), 4, 0));
         ...
         wcpOAV6EstadoTicketId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6EstadoTicketId"), ",", "."));
         wcpOAV8TabCode = cgiGet( sPrefix+"wcpOAV8TabCode");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(Gx_mode, wcpOGx_mode) != 0 ) || ( AV6EstadoTicketId != wcpOAV6EstadoTicketId ) || ( StringUtil.StrCmp(AV8TabCode, wcpOAV8TabCode) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOGx_mode = Gx_mode;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023124952214", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("estadoticketgeneral.js", "?2023124952214", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A5EstadoTicketId',fld:'ESTADOTICKETID',pic:'ZZZ9'},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E132F2',iparms:[{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E142F2',iparms:[{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV12ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         scmdbuf = "";
         H002F2_A5EstadoTicketId = new short[1] ;
         ...
         sCtrlAV8TabCode = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.estadoticketgeneral__default(),
            new Object[][] {
                new Object[] {
               H002F2_A5EstadoTicketId
               }
            }
         );
      ...
      private short[] H002F2_A5EstadoTicketId ;
   ...
   public class estadoticketgeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002F2", "SELECT [EstadoTicketId] FROM [EstadoTicket] WHERE [EstadoTicketId] = @AV6EstadoTicketId ORDER BY [EstadoTicketId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002F2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
