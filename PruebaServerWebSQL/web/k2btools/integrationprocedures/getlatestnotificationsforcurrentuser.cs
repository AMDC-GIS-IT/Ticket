...
namespace GeneXus.Programs.k2btools.integrationprocedures {
   public class getlatestnotificationsforcurrentuser : GXProcedure
   {
      ...
      {
         this.Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.k2btools.integrationprocedures.SdtWebNotificationSDT_Notification>( context, "Notification", "kb_ticket") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBaseCollection<GeneXus.Programs.k2btools.integrationprocedures.SdtWebNotificationSDT_Notification> aP0_Gxm2rootcol )
      {
         ...
         objgetlatestnotificationsforcurrentuser.Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.k2btools.integrationprocedures.SdtWebNotificationSDT_Notification>( context, "Notification", "kb_ticket") ;
