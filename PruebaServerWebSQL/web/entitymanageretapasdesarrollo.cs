...
namespace GeneXus.Programs {
   public class entitymanageretapasdesarrollo : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public entitymanageretapasdesarrollo( )
      {
      ...
      public entitymanageretapasdesarrollo( IGxContext context )
      {
                           ...
                           string aP2_TabCode )
      {
         ...
         this.AV6EtapaDesarrolloId = aP1_EtapaDesarrolloId;
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  ...
                  AssignAttri("", false, "AV6EtapaDesarrolloId", StringUtil.LTrimStr( (decimal)(AV6EtapaDesarrolloId), 4, 0));
                  GxWebStd.gx_hidden_field( context, "gxhash_vETAPADESARROLLOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6EtapaDesarrolloId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249571120", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("entitymanageretapasdesarrollo.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6EtapaDesarrolloId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Gx_mode","EtapaDesarrolloId","TabCode"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vMODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( Gx_mode, "@!")), context));
         GxWebStd.gx_hidden_field( context, "vETAPADESARROLLOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6EtapaDesarrolloId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vETAPADESARROLLOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6EtapaDesarrolloId), "ZZZ9"), context));
      ...
      {
         return formatLink("entitymanageretapasdesarrollo.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6EtapaDesarrolloId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Gx_mode","EtapaDesarrolloId","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "EntityManagerEtapasDesarrollo" ;
      }
      ...
      protected void WB760( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblK2bpgmdesc_Internalname, lblK2bpgmdesc_Caption, "", "", lblK2bpgmdesc_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_EntityManagerEtapasDesarrollo.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblBacktoworkwith_Internalname, lblBacktoworkwith_Caption, lblBacktoworkwith_Link, "", lblBacktoworkwith_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_BackToWorkWith", 0, "", 1, 1, 0, 0, "HLP_EntityManagerEtapasDesarrollo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0047"+"", StringUtil.RTrim( WebComp_Componentwc_responsable_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_53_762( true) ;
         }
         else
         {
            wb_table1_53_762( false) ;
         }
         return  ;
      }

      protected void wb_table1_53_762e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldComponentwc_responsable = cgiGet( "W0047");
                           ...
                           if ( StringUtil.Len( WebComp_Componentwc_responsable_Component) != 0 )
                           {
                              WebComp_Componentwc_responsable.componentprocess("W0047", "", sEvt);
                           }
                           WebComp_Componentwc_responsable_Component = OldComponentwc_responsable;
                        }
                        else if ( nCmpId == 73 )
      ...
      {
         /* GeneXus formulas. */
         AV27Pgmname = "EntityManagerEtapasDesarrollo";
         context.Gx_err = 0;
      }
      ...
      protected void E11762( )
      {
         /* Start Routine */
         returnInSub = false;
         lblBacktoworkwith_Caption = StringUtil.Format( "%1", "Etapas desarrollos", "", "", "", "", "", "", "", "");
         AssignProp("", false, lblBacktoworkwith_Internalname, "Caption", lblBacktoworkwith_Caption, true);
         lblBacktoworkwith_Link = formatLink("wwetapasdesarrollo.aspx") ;
         AssignProp("", false, lblBacktoworkwith_Internalname, "Link", lblBacktoworkwith_Link, true);
         AV26GXLvl7 = 0;
         /* Using cursor H00762 */
         pr_default.execute(0, new Object[] {AV6EtapaDesarrolloId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A290EtapaDesarrolloId = H00762_A290EtapaDesarrolloId[0];
            A291EtapaDesarrolloNombre = H00762_A291EtapaDesarrolloNombre[0];
            AV26GXLvl7 = 1;
            Form.Caption = A291EtapaDesarrolloNombre;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblK2bpgmdesc_Caption = StringUtil.Format( "%1 - %2", "Etapas Desarrollo", A291EtapaDesarrolloNombre, "", "", "", "", "", "", "");
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            lblK2bpgmdesc_Caption = "Etapas Desarrollo";
            AssignProp("", false, lblK2bpgmdesc_Internalname, "Caption", lblK2bpgmdesc_Caption, true);
         }
      ...
      protected void E12762( )
      {
         ...
         {
            AV20RelatedTransactionName = "EtapasDesarrollo";
         ...
         if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               lblComponenttitle_Caption = StringUtil.Format( "Actualizar %1", "Etapas Desarrollo", "", "", "", "", "", "", "", "");
               ...
               if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Popupcomponent_Component), StringUtil.Lower( "EtapasDesarrollo")) != 0 )
               {
                  WebComp_Popupcomponent = getWebComponent(GetType(), "GeneXus.Programs", "etapasdesarrollo", new Object[] {context} );
                  WebComp_Popupcomponent.ComponentInit();
                  WebComp_Popupcomponent.Name = "EtapasDesarrollo";
                  WebComp_Popupcomponent_Component = "EtapasDesarrollo";
               }
               if ( StringUtil.Len( WebComp_Popupcomponent_Component) != 0 )
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0073",(string)"",(string)"UPD",(short)AV6EtapaDesarrolloId});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
         {
            if ( ( StringUtil.StrCmp(AV8TabCode, "General") == 0 ) || String.IsNullOrEmpty(StringUtil.RTrim( AV8TabCode)) )
            {
               lblComponenttitle_Caption = StringUtil.Format( "Eliminar %1", "Etapas Desarrollo", "", "", "", "", "", "", "", "");
               AssignProp("", false, lblComponenttitle_Internalname, "Caption", lblComponenttitle_Caption, true);
               tblTablemodal_Visible = 1;
               AssignProp("", false, tblTablemodal_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(tblTablemodal_Visible), 5, 0), true);
               /* Object Property */
               ...
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0073",(string)"",(string)"DLT",(short)AV6EtapaDesarrolloId});
                  WebComp_Popupcomponent.componentbind(new Object[] {(string)"",(string)""});
               }
               if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Popupcomponent )
               {
      ...
      protected void S112( )
      {
         ...
         AV11Tab.gxTpr_Link = formatLink("entitymanageretapasdesarrollo.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6EtapaDesarrolloId,4,0)),UrlEncode(StringUtil.RTrim(AV11Tab.gxTpr_Code))}, new string[] {"Mode","EtapaDesarrolloId","TabCode"}) ;
         AV11Tab.gxTpr_Componenttype = 3;
         AV11Tab.gxTpr_Relatedtransaction = "EtapasDesarrollo";
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Componentwc_general_Component), StringUtil.Lower( "EtapasDesarrolloGeneral")) != 0 )
            {
               WebComp_Componentwc_general = getWebComponent(GetType(), "GeneXus.Programs", "etapasdesarrollogeneral", new Object[] {context} );
               WebComp_Componentwc_general.ComponentInit();
               WebComp_Componentwc_general.Name = "EtapasDesarrolloGeneral";
               WebComp_Componentwc_general_Component = "EtapasDesarrolloGeneral";
            }
            if ( StringUtil.Len( WebComp_Componentwc_general_Component) != 0 )
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0041",(string)"",(string)Gx_mode,(short)AV6EtapaDesarrolloId,(string)AV8TabCode});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0041",(string)"",(string)"DSP",(short)AV6EtapaDesarrolloId,(string)AV8TabCode});
               WebComp_Componentwc_general.componentbind(new Object[] {(string)"",(string)"",(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Componentwc_general )
            {
      ...
      protected void S132( )
      {
         ...
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "Ticket",  "Ticket",  "List",  "",  "EtapasDesarrolloTicketWC") )
         {
            if ( StringUtil.StrCmp(Gx_mode, "INS") != 0 )
            {
               ...
               if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Componentwc_responsable_Component), StringUtil.Lower( "EtapasDesarrolloTicketWC")) != 0 )
               {
                  WebComp_Componentwc_responsable = getWebComponent(GetType(), "GeneXus.Programs", "etapasdesarrolloticketwc", new Object[] {context} );
                  WebComp_Componentwc_responsable.ComponentInit();
                  WebComp_Componentwc_responsable.Name = "EtapasDesarrolloTicketWC";
                  WebComp_Componentwc_responsable_Component = "EtapasDesarrolloTicketWC";
               }
               if ( StringUtil.Len( WebComp_Componentwc_responsable_Component) != 0 )
               {
                  WebComp_Componentwc_responsable.setjustcreated();
                  WebComp_Componentwc_responsable.componentprepare(new Object[] {(string)"W0047",(string)"",(short)AV6EtapaDesarrolloId});
      ...
      protected void wb_table1_53_762( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_59_762( true) ;
         }
         else
         {
            wb_table2_59_762( false) ;
         }
         return  ;
      }

      protected void wb_table2_59_762e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            wb_table1_53_762e( true) ;
         }
         else
         {
            wb_table1_53_762e( false) ;
         }
      }

      protected void wb_table2_59_762( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblComponenttitle_Internalname, lblComponenttitle_Caption, "", "", lblComponenttitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "PopupTitle", 0, "", 1, 1, 0, 0, "HLP_EntityManagerEtapasDesarrollo.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table3_64_762( true) ;
         }
         else
         {
            wb_table3_64_762( false) ;
         }
         return  ;
      }

      protected void wb_table3_64_762e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_59_762e( true) ;
         }
         else
         {
            wb_table2_59_762e( false) ;
         }
      }

      protected void wb_table3_64_762( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'CLOSEMODAL\\'."+"'", "", "PopupHeaderButton", 5, "", 1, 1, 0, 0, "HLP_EntityManagerEtapasDesarrollo.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_64_762e( true) ;
         }
         else
         {
            wb_table3_64_762e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "Gx_mode", Gx_mode);
         AV6EtapaDesarrolloId = Convert.ToInt16(getParm(obj,1));
         AssignAttri("", false, "AV6EtapaDesarrolloId", StringUtil.LTrimStr( (decimal)(AV6EtapaDesarrolloId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vETAPADESARROLLOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6EtapaDesarrolloId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249571184", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("entitymanageretapasdesarrollo.js", "?20231249571184", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV18AvailableComponents',fld:'vAVAILABLECOMPONENTS',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'AV20RelatedTransactionName',fld:'vRELATEDTRANSACTIONNAME',pic:'',hsh:true},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV6EtapaDesarrolloId',fld:'vETAPADESARROLLOID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV20RelatedTransactionName',fld:'vRELATEDTRANSACTIONNAME',pic:'',hsh:true},{av:'tblTablemodal_Visible',ctrl:'TABLEMODAL',prop:'Visible'},{av:'lblComponenttitle_Caption',ctrl:'COMPONENTTITLE',prop:'Caption'},{ctrl:'POPUPCOMPONENT'},{av:'AV18AvailableComponents',fld:'vAVAILABLECOMPONENTS',pic:'',hsh:true},{ctrl:'TABSTRIP'},{av:'divComponentcontainer_general_Visible',ctrl:'COMPONENTCONTAINER_GENERAL',prop:'Visible'},{av:'divComponentcontainer_responsable_Visible',ctrl:'COMPONENTCONTAINER_RESPONSABLE',prop:'Visible'},{av:'divComponentscontainer_components_Visible',ctrl:'COMPONENTSCONTAINER_COMPONENTS',prop:'Visible'},{ctrl:'COMPONENTWC_GENERAL'},{ctrl:'COMPONENTWC_RESPONSABLE'}]}");
         setEventMetadata("GLOBALEVENTS.K2BT_REFRESHENTITYMANAGER","{handler:'E13762',iparms:[{av:'AV22GE_ComponentName',fld:'vGE_COMPONENTNAME',pic:''},{av:'AV21GE_EntityManagerName',fld:'vGE_ENTITYMANAGERNAME',pic:''},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV6EtapaDesarrolloId',fld:'vETAPADESARROLLOID',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("GLOBALEVENTS.K2BT_REFRESHENTITYMANAGER",",oparms:[{av:'divComponentcontainer_general_Visible',ctrl:'COMPONENTCONTAINER_GENERAL',prop:'Visible'},{ctrl:'COMPONENTWC_GENERAL'},{ctrl:'COMPONENTWC_RESPONSABLE'},{av:'divComponentcontainer_responsable_Visible',ctrl:'COMPONENTCONTAINER_RESPONSABLE',prop:'Visible'}]}");
         setEventMetadata("'CLOSEMODAL'","{handler:'E14762',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00762_A290EtapaDesarrolloId = new short[1] ;
         H00762_A291EtapaDesarrolloNombre = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.entitymanageretapasdesarrollo__default(),
            new Object[][] {
                new Object[] {
               H00762_A290EtapaDesarrolloId, H00762_A291EtapaDesarrolloNombre
               }
            }
         );
      ...
      private short[] H00762_A290EtapaDesarrolloId ;
      private string[] H00762_A291EtapaDesarrolloNombre ;
   ...
   public class entitymanageretapasdesarrollo__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00762", "SELECT TOP 1 [EtapaDesarrolloId], [EtapaDesarrolloNombre] FROM [EtapasDesarrollo] WHERE [EtapaDesarrolloId] = @AV6EtapaDesarrolloId ORDER BY [EtapaDesarrolloId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00762,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
