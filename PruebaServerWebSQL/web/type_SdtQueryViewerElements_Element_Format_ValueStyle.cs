...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerElements.Element.Format.ValueStyle" , Namespace="kb_ticket" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerElements.Element.Format.ValueStyle", Namespace="kb_ticket")]
