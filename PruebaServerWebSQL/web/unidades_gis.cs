...
namespace GeneXus.Programs {
   public class unidades_gis : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtid_unidad_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A103id_unidad), 9, 0, ",", "")), ((edtid_unidad_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A103id_unidad), "ZZZZZZZZ9")) : context.localUtil.Format( (decimal)(A103id_unidad), "ZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtid_unidad_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtid_unidad_Enabled, 0, "number", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_unidades_gis.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtunidades_gisestado_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A115unidades_gisestado), 9, 0, ",", "")), ((edtunidades_gisestado_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A115unidades_gisestado), "ZZZZZZZZ9")) : context.localUtil.Format( (decimal)(A115unidades_gisestado), "ZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,30);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtunidades_gisestado_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtunidades_gisestado_Enabled, 0, "number", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_unidades_gis.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtunidades_gishora_creacion_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A117unidades_gishora_creacion), 5, 0, ",", "")), ((edtunidades_gishora_creacion_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A117unidades_gishora_creacion), "ZZZZ9")) : context.localUtil.Format( (decimal)(A117unidades_gishora_creacion), "ZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,42);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtunidades_gishora_creacion_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtunidades_gishora_creacion_Enabled, 0, "number", "1", 5, "chr", 1, "row", 5, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_unidades_gis.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtunidades_gishora_modificacion_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A120unidades_gishora_modificacion), 5, 0, ",", "")), ((edtunidades_gishora_modificacion_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A120unidades_gishora_modificacion), "ZZZZ9")) : context.localUtil.Format( (decimal)(A120unidades_gishora_modificacion), "ZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,60);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtunidades_gishora_modificacion_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtunidades_gishora_modificacion_Enabled, 0, "number", "1", 5, "chr", 1, "row", 5, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_unidades_gis.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void CheckExtendedTable0B12( )
      {
         ...
         if ( ! ( (DateTime.MinValue==A116unidades_gisfecha_creacion) || ( A116unidades_gisfecha_creacion >= context.localUtil.YMDToD( 1753, 1, 1) ) ) )
         {
         ...
         if ( ! ( (DateTime.MinValue==A119unidades_gisfecha_modificacion) || ( A119unidades_gisfecha_modificacion >= context.localUtil.YMDToD( 1753, 1, 1) ) ) )
         {
      ...
      protected void CheckOptimisticConcurrency0B12( )
      {
         if ( ! IsIns( ) )
         {
            ...
            Gx_longc = false;
            if ( (pr_datastore1.getStatus(0) == 101) || ( StringUtil.StrCmp(Z114nombre_unidad, T000B2_A114nombre_unidad[0]) != 0 ) || ( Z115unidades_gisestado != T000B2_A115unidades_gisestado[0] ) || ( Z116unidades_gisfecha_creacion != T000B2_A116unidades_gisfecha_creacion[0] ) || ( Z117unidades_gishora_creacion != T000B2_A117unidades_gishora_creacion[0] ) || ( StringUtil.StrCmp(Z118unidades_giscreado_por, T000B2_A118unidades_giscreado_por[0]) != 0 ) )
            {
               Gx_longc = true;
            }
            if ( Gx_longc || ( Z119unidades_gisfecha_modificacion != T000B2_A119unidades_gisfecha_modificacion[0] ) || ( Z120unidades_gishora_modificacion != T000B2_A120unidades_gishora_modificacion[0] ) || ( StringUtil.StrCmp(Z121unidades_gismodificado_por, T000B2_A121unidades_gismodificado_por[0]) != 0 ) )
            {
               ...
               if ( Z116unidades_gisfecha_creacion != T000B2_A116unidades_gisfecha_creacion[0] )
               {
               ...
               if ( Z119unidades_gisfecha_modificacion != T000B2_A119unidades_gisfecha_modificacion[0] )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249492838", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249492858", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("unidades_gis.js", "?20231249492859", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
