...
namespace GeneXus.Programs {
   public class responsablegeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public responsablegeneral( )
      {
      ...
      public responsablegeneral( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)Gx_mode,(short)AV6ResponsableId,(string)AV8TabCode});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2023124952446", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB2O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "responsablegeneral.aspx");
            }
            /* Div Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_15_2O2( true) ;
         }
         else
         {
            wb_table1_15_2O2( false) ;
         }
         return  ;
      }

      protected void wb_table1_15_2O2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void E122O2( )
      {
         ...
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Responsable";
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Responsable";
         ...
         {
            A6ResponsableId = H002O2_A6ResponsableId[0];
            AV16GXLvl26 = 1;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Transactioncomponent_Component), StringUtil.Lower( "Responsable")) != 0 )
         {
            WebComp_Transactioncomponent = getWebComponent(GetType(), "GeneXus.Programs", "responsable", new Object[] {context} );
            WebComp_Transactioncomponent.ComponentInit();
            WebComp_Transactioncomponent.Name = "Responsable";
            WebComp_Transactioncomponent_Component = "Responsable";
         }
         if ( StringUtil.Len( WebComp_Transactioncomponent_Component) != 0 )
         {
            WebComp_Transactioncomponent.setjustcreated();
            WebComp_Transactioncomponent.componentprepare(new Object[] {(string)sPrefix+"W0029",(string)"",(string)Gx_mode,(short)AV6ResponsableId});
      ...
      protected void E132O2( )
      {
         /* 'DoUpdate' Routine */
         returnInSub = false;
         new k2bgettrncontextbyname(context ).execute(  "Responsable", out  AV10TrnContext) ;
         GXt_char1 = "";
         ...
         new k2bsettrncontextbyname(context ).execute(  "Responsable",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerresponsable.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(AV6ResponsableId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","ResponsableId","TabCode"}) );
      ...
      protected void E142O2( )
      {
         ...
         AV10TrnContext.gxTpr_Returnmode = "Popup";
         new k2bsettrncontextbyname(context ).execute(  "Responsable",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerresponsable.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(AV6ResponsableId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","ResponsableId","TabCode"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void wb_table1_15_2O2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_18_2O2( true) ;
         }
         else
         {
            wb_table2_18_2O2( false) ;
         }
         return  ;
      }

      protected void wb_table2_18_2O2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_15_2O2e( true) ;
         }
         else
         {
            wb_table1_15_2O2e( false) ;
         }
      }

      protected void wb_table2_18_2O2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_18_2O2e( true) ;
         }
         else
         {
            wb_table2_18_2O2e( false) ;
         }
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6ResponsableId = (string)((string)getParm(obj,1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "responsablegeneral", GetJustCreated( ));
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "Gx_mode", Gx_mode);
            AV6ResponsableId = Convert.ToInt16(getParm(obj,3));
            AssignAttri(sPrefix, false, "AV6ResponsableId", StringUtil.LTrimStr( (decimal)(AV6ResponsableId), 4, 0));
         ...
         wcpOAV6ResponsableId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6ResponsableId"), ",", "."));
         wcpOAV8TabCode = cgiGet( sPrefix+"wcpOAV8TabCode");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(Gx_mode, wcpOGx_mode) != 0 ) || ( AV6ResponsableId != wcpOAV6ResponsableId ) || ( StringUtil.StrCmp(AV8TabCode, wcpOAV8TabCode) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOGx_mode = Gx_mode;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023124952468", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("responsablegeneral.js", "?2023124952468", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A6ResponsableId',fld:'RESPONSABLEID',pic:'ZZZ9'},{av:'AV6ResponsableId',fld:'vRESPONSABLEID',pic:'ZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E132O2',iparms:[{av:'AV6ResponsableId',fld:'vRESPONSABLEID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E142O2',iparms:[{av:'AV6ResponsableId',fld:'vRESPONSABLEID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV12ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         scmdbuf = "";
         H002O2_A6ResponsableId = new short[1] ;
         ...
         sCtrlAV8TabCode = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.responsablegeneral__default(),
            new Object[][] {
                new Object[] {
               H002O2_A6ResponsableId
               }
            }
         );
      ...
      private short[] H002O2_A6ResponsableId ;
   ...
   public class responsablegeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002O2", "SELECT [ResponsableId] FROM [Responsable] WHERE [ResponsableId] = @AV6ResponsableId ORDER BY [ResponsableId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002O2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
