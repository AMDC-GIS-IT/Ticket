...
namespace GeneXus.Programs {
   public class estadosatisfaccionsatisfaccionwc3 : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public estadosatisfaccionsatisfaccionwc3( )
      {
      ...
      public estadosatisfaccionsatisfaccionwc3( IGxContext context )
      {
      ...
      {
         this.AV6SatisfaccionTecnicoProfesionalismoId = aP0_SatisfaccionTecnicoProfesionalismoId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6SatisfaccionTecnicoProfesionalismoId = (short)(NumberUtil.Val( GetPar( "SatisfaccionTecnicoProfesionalismoId"), "."));
                  AssignAttri(sPrefix, false, "AV6SatisfaccionTecnicoProfesionalismoId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionTecnicoProfesionalismoId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV6SatisfaccionTecnicoProfesionalismoId});
                  componentstart();
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV50K2BToolsGenericSearchField, AV36SatisfaccionFecha_From, AV39UsuarioFecha_From, AV41SatisfaccionResueltoNombre, AV42SatisfaccionTecnicoProblemaNombre, AV43SatisfaccionTecnicoCompetenteNombre, AV44SatisfaccionTiempoNombre, AV45SatisfaccionAtencionNombre, AV6SatisfaccionTecnicoProfesionalismoId, AV34ClassCollection, AV51OrderedBy, AV37SatisfaccionFecha_To, AV40UsuarioFecha_To, AV67Pgmname, AV9CurrentPage, AV11GridConfiguration, AV60AutoLinksActivityList, AV62SatisfaccionFecha_IsAuthorized, AV15Att_SatisfaccionId_Visible, AV16Att_SatisfaccionFecha_Visible, AV17Att_TicketId_Visible, AV18Att_UsuarioId_Visible, AV19Att_UsuarioNombre_Visible, AV20Att_UsuarioFecha_Visible, AV21Att_UsuarioRequerimiento_Visible, AV22Att_SatisfaccionResueltoNombre_Visible, AV23Att_SatisfaccionTecnicoProblemaNombre_Visible, AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible, AV25Att_SatisfaccionTiempoNombre_Visible, AV26Att_SatisfaccionAtencionNombre_Visible, AV27Att_SatisfaccionSugerencia_Visible, AV12FreezeColumnTitles, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV67Pgmname = "EstadoSatisfaccionSatisfaccionWC3";
               context.Gx_err = 0;
               WS2A2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2023124951428", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("estadosatisfaccionsatisfaccionwc3.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6SatisfaccionTecnicoProfesionalismoId,4,0))}, new string[] {"SatisfaccionTecnicoProfesionalismoId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6SatisfaccionTecnicoProfesionalismoId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6SatisfaccionTecnicoProfesionalismoId), 4, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vSATISFACCIONTECNICOPROFESIONALISMOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6SatisfaccionTecnicoProfesionalismoId), 4, 0, ",", "")));
      ...
      {
         return "EstadoSatisfaccionSatisfaccionWC3" ;
      }
      ...
      protected void WB2A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "estadosatisfaccionsatisfaccionwc3.aspx");
               context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
               context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
               context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
               context.AddJavascriptSource("K2BDateRangePicker/K2BDateRangePickerRender.js", "", false, true);
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocksatisfaccionfecha_Internalname, "Fecha Encuesta:", "", "", lblTextblocksatisfaccionfecha_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label K2BT_LabelTop", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC3.htm");
            /* User Defined Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockusuariofecha_Internalname, "Fecha", "", "", lblTextblockusuariofecha_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label K2BT_LabelTop", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC3.htm");
            /* User Defined Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;", "div");
            wb_table1_77_2A2( true) ;
         }
         else
         {
            wb_table1_77_2A2( false) ;
         }
         return  ;
      }

      protected void wb_table1_77_2A2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         if ( wbEnd == 223 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_246_2A2( true) ;
         }
         else
         {
            wb_table2_246_2A2( false) ;
         }
         return  ;
      }

      protected void wb_table2_246_2A2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagebuttontextblock_Internalname, "", "", "", lblPreviouspagebuttontextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOPREVIOUS\\'."+"'", "", lblPreviouspagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC3.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFirstpagetextblock_Internalname, lblFirstpagetextblock_Caption, "", "", lblFirstpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOFIRST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblFirstpagetextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC3.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacinglefttextblock_Internalname, "...", "", "", lblSpacinglefttextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacinglefttextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC3.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagetextblock_Internalname, lblPreviouspagetextblock_Caption, "", "", lblPreviouspagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOPREVIOUS\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPreviouspagetextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC3.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCurrentpagetextblock_Internalname, lblCurrentpagetextblock_Caption, "", "", lblCurrentpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC3.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagetextblock_Internalname, lblNextpagetextblock_Caption, "", "", lblNextpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DONEXT\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblNextpagetextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC3.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacingrighttextblock_Internalname, "...", "", "", lblSpacingrighttextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacingrighttextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC3.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLastpagetextblock_Internalname, lblLastpagetextblock_Caption, "", "", lblLastpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOLAST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblLastpagetextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC3.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagebuttontextblock_Internalname, "", "", "", lblNextpagebuttontextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DONEXT\\'."+"'", "", lblNextpagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC3.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       short AV6SatisfaccionTecnicoProfesionalismoId ,
      ...
      protected void RF2A2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV50K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV50K2BToolsGenericSearchField), 100, "%");
            /* Using cursor H002A2 */
            pr_default.execute(0, new Object[] {AV6SatisfaccionTecnicoProfesionalismoId, AV37SatisfaccionFecha_To, AV36SatisfaccionFecha_From, AV40UsuarioFecha_To, AV39UsuarioFecha_From, lV41SatisfaccionResueltoNombre, lV42SatisfaccionTecnicoProblemaNombre, lV43SatisfaccionTecnicoCompetenteNombre, lV44SatisfaccionTiempoNombre, lV45SatisfaccionAtencionNombre, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_223_idx = 1;
            sGXsfl_223_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_223_idx), 4, 0), 4, "0");
            SubsflControlProps_2232( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A11SatisfaccionTecnicoProfesionalismoId = H002A2_A11SatisfaccionTecnicoProfesionalismoId[0];
               A34SatisfaccionSugerencia = H002A2_A34SatisfaccionSugerencia[0];
               A31SatisfaccionAtencionNombre = H002A2_A31SatisfaccionAtencionNombre[0];
               A13SatisfaccionAtencionId = H002A2_A13SatisfaccionAtencionId[0];
               A38SatisfaccionTiempoNombre = H002A2_A38SatisfaccionTiempoNombre[0];
               A12SatisfaccionTiempoId = H002A2_A12SatisfaccionTiempoId[0];
               A35SatisfaccionTecnicoCompetenteNombre = H002A2_A35SatisfaccionTecnicoCompetenteNombre[0];
               A10SatisfaccionTecnicoCompetenteId = H002A2_A10SatisfaccionTecnicoCompetenteId[0];
               A36SatisfaccionTecnicoProblemaNombre = H002A2_A36SatisfaccionTecnicoProblemaNombre[0];
               A9SatisfaccionTecnicoProblemaId = H002A2_A9SatisfaccionTecnicoProblemaId[0];
               A33SatisfaccionResueltoNombre = H002A2_A33SatisfaccionResueltoNombre[0];
               A8SatisfaccionResueltoId = H002A2_A8SatisfaccionResueltoId[0];
               A94UsuarioRequerimiento = H002A2_A94UsuarioRequerimiento[0];
               A90UsuarioFecha = H002A2_A90UsuarioFecha[0];
               A93UsuarioNombre = H002A2_A93UsuarioNombre[0];
               A15UsuarioId = H002A2_A15UsuarioId[0];
               A14TicketId = H002A2_A14TicketId[0];
               A32SatisfaccionFecha = H002A2_A32SatisfaccionFecha[0];
               A7SatisfaccionId = H002A2_A7SatisfaccionId[0];
               A31SatisfaccionAtencionNombre = H002A2_A31SatisfaccionAtencionNombre[0];
               A38SatisfaccionTiempoNombre = H002A2_A38SatisfaccionTiempoNombre[0];
               A35SatisfaccionTecnicoCompetenteNombre = H002A2_A35SatisfaccionTecnicoCompetenteNombre[0];
               A36SatisfaccionTecnicoProblemaNombre = H002A2_A36SatisfaccionTecnicoProblemaNombre[0];
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV50K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV50K2BToolsGenericSearchField), 100, "%");
         /* Using cursor H002A3 */
         pr_default.execute(1, new Object[] {AV6SatisfaccionTecnicoProfesionalismoId, AV37SatisfaccionFecha_To, AV36SatisfaccionFecha_From, AV40UsuarioFecha_To, AV39UsuarioFecha_From, lV41SatisfaccionResueltoNombre, lV42SatisfaccionTecnicoProblemaNombre, lV43SatisfaccionTecnicoCompetenteNombre, lV44SatisfaccionTiempoNombre, lV45SatisfaccionAtencionNombre, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField});
      ...
      protected void STRUP2A0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6SatisfaccionTecnicoProfesionalismoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6SatisfaccionTecnicoProfesionalismoId"), ",", "."));
            AV51OrderedBy = (short)(context.localUtil.CToN( cgiGet( sPrefix+"vORDEREDBY"), ",", "."));
            AV6SatisfaccionTecnicoProfesionalismoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"vSATISFACCIONTECNICOPROFESIONALISMOID"), ",", "."));
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV31GridStateKey = StringUtil.Str( (decimal)(AV6SatisfaccionTecnicoProfesionalismoId), 4, 0);
      ...
      protected void S192( )
      {
         ...
         AV58TrnContextAtt.gxTpr_Attributename = "SatisfaccionTecnicoProfesionalismoId";
         AV58TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6SatisfaccionTecnicoProfesionalismoId), 4, 0);
      ...
      protected void E142A2( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         CallWebObject(formatLink("exportestadosatisfaccionsatisfaccionwc3.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6SatisfaccionTecnicoProfesionalismoId,4,0)),UrlEncode(DateTimeUtil.FormatDateParm(AV36SatisfaccionFecha_From)),UrlEncode(DateTimeUtil.FormatDateParm(AV37SatisfaccionFecha_To)),UrlEncode(DateTimeUtil.FormatDateParm(AV39UsuarioFecha_From)),UrlEncode(DateTimeUtil.FormatDateParm(AV40UsuarioFecha_To)),UrlEncode(StringUtil.RTrim(AV41SatisfaccionResueltoNombre)),UrlEncode(StringUtil.RTrim(AV42SatisfaccionTecnicoProblemaNombre)),UrlEncode(StringUtil.RTrim(AV43SatisfaccionTecnicoCompetenteNombre)),UrlEncode(StringUtil.RTrim(AV44SatisfaccionTiempoNombre)),UrlEncode(StringUtil.RTrim(AV45SatisfaccionAtencionNombre)),UrlEncode(StringUtil.RTrim(AV50K2BToolsGenericSearchField)),UrlEncode(StringUtil.LTrimStr(AV51OrderedBy,4,0))}, new string[] {"SatisfaccionTecnicoProfesionalismoId","SatisfaccionFecha_From","SatisfaccionFecha_To","UsuarioFecha_From","UsuarioFecha_To","SatisfaccionResueltoNombre","SatisfaccionTecnicoProblemaNombre","SatisfaccionTecnicoCompetenteNombre","SatisfaccionTiempoNombre","SatisfaccionAtencionNombre","K2BToolsGenericSearchField","OrderedBy"}) );
      ...
      protected void S212( )
      {
         ...
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Satisfaccion";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Satisfaccion";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = "ReportEstadoSatisfaccionSatisfaccionWC3";
         AV59ActivityList.Add(AV61ActivityListItem, 0);
         AV61ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Standardactivitytype = "List";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Useractivitytype = "";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Satisfaccion";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Satisfaccion";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = "ExportEstadoSatisfaccionSatisfaccionWC3";
         AV59ActivityList.Add(AV61ActivityListItem, 0);
         AV61ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
      ...
      protected void wb_table2_246_2A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoresultsfoundtextblock_Internalname, "No hay resultados", "", "", lblNoresultsfoundtextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC3.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_246_2A2e( true) ;
         }
         else
         {
            wb_table2_246_2A2e( false) ;
         }
      }

      protected void wb_table1_77_2A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRuntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblRuntimecolumnselectiontb_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC3.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_satisfacciontiemponombre_visible_Internalname, StringUtil.BoolToStr( AV25Att_SatisfaccionTiempoNombre_Visible), "", "Satisfaccion Tiempo Nombre", 1, chkavAtt_satisfacciontiemponombre_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(166, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,166);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgImage1_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgImage1_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e272a1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_EstadoSatisfaccionSatisfaccionWC3.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table3_204_2A2( true) ;
         }
         else
         {
            wb_table3_204_2A2( false) ;
         }
         return  ;
      }

      protected void wb_table3_204_2A2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table4_211_2A2( true) ;
         }
         else
         {
            wb_table4_211_2A2( false) ;
         }
         return  ;
      }

      protected void wb_table4_211_2A2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_77_2A2e( true) ;
         }
         else
         {
            wb_table1_77_2A2e( false) ;
         }
      }

      protected void wb_table4_211_2A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttInsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(223), 3, 0)+","+"null"+");", "Nuevo", bttInsert_Jsonclick, 5, bttInsert_Tooltiptext, "", StyleString, ClassString, bttInsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EstadoSatisfaccionSatisfaccionWC3.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_211_2A2e( true) ;
         }
         else
         {
            wb_table4_211_2A2e( false) ;
         }
      }

      protected void wb_table3_204_2A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttReport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(223), 3, 0)+","+"null"+");", "Reporte", bttReport_Jsonclick, 7, bttReport_Tooltiptext, "", StyleString, ClassString, bttReport_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e282a1_client"+"'", TempTags, "", 2, "HLP_EstadoSatisfaccionSatisfaccionWC3.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='K2BToolsTableCell_ActionContainer'>") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 209,'" + sPrefix + "',false,'',0)\"";
            ClassString = "Button_Standard";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttExport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(223), 3, 0)+","+"null"+");", "Exportar", bttExport_Jsonclick, 5, bttExport_Tooltiptext, "", StyleString, ClassString, bttExport_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOEXPORT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EstadoSatisfaccionSatisfaccionWC3.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_204_2A2e( true) ;
         }
         else
         {
            wb_table3_204_2A2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6SatisfaccionTecnicoProfesionalismoId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6SatisfaccionTecnicoProfesionalismoId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionTecnicoProfesionalismoId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6SatisfaccionTecnicoProfesionalismoId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "estadosatisfaccionsatisfaccionwc3", GetJustCreated( ));
         ...
         {
            AV6SatisfaccionTecnicoProfesionalismoId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6SatisfaccionTecnicoProfesionalismoId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionTecnicoProfesionalismoId), 4, 0));
         }
         wcpOAV6SatisfaccionTecnicoProfesionalismoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6SatisfaccionTecnicoProfesionalismoId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV6SatisfaccionTecnicoProfesionalismoId != wcpOAV6SatisfaccionTecnicoProfesionalismoId ) ) )
         {
            setjustcreated();
         }
         wcpOAV6SatisfaccionTecnicoProfesionalismoId = AV6SatisfaccionTecnicoProfesionalismoId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6SatisfaccionTecnicoProfesionalismoId = cgiGet( sPrefix+"AV6SatisfaccionTecnicoProfesionalismoId_CTRL");
         if ( StringUtil.Len( sCtrlAV6SatisfaccionTecnicoProfesionalismoId) > 0 )
         {
            AV6SatisfaccionTecnicoProfesionalismoId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6SatisfaccionTecnicoProfesionalismoId), ",", "."));
            AssignAttri(sPrefix, false, "AV6SatisfaccionTecnicoProfesionalismoId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionTecnicoProfesionalismoId), 4, 0));
         }
         else
         {
            AV6SatisfaccionTecnicoProfesionalismoId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6SatisfaccionTecnicoProfesionalismoId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6SatisfaccionTecnicoProfesionalismoId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6SatisfaccionTecnicoProfesionalismoId), 4, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6SatisfaccionTecnicoProfesionalismoId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6SatisfaccionTecnicoProfesionalismoId_CTRL", StringUtil.RTrim( sCtrlAV6SatisfaccionTecnicoProfesionalismoId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249515390", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("estadosatisfaccionsatisfaccionwc3.js", "?20231249515391", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/K2BDateRangePickerRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOREPORT'","{handler:'E282A1',iparms:[{av:'AV6SatisfaccionTecnicoProfesionalismoId',fld:'vSATISFACCIONTECNICOPROFESIONALISMOID',pic:'ZZZ9'},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV45SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'TOGGLEGRIDSETTINGSTABLE'","{handler:'E262A1',iparms:[{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E172A2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV45SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV6SatisfaccionTecnicoProfesionalismoId',fld:'vSATISFACCIONTECNICOPROFESIONALISMOID',pic:'ZZZ9'},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV67Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV60AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E182A2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV45SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV6SatisfaccionTecnicoProfesionalismoId',fld:'vSATISFACCIONTECNICOPROFESIONALISMOID',pic:'ZZZ9'},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV67Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV60AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E192A2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV45SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV6SatisfaccionTecnicoProfesionalismoId',fld:'vSATISFACCIONTECNICOPROFESIONALISMOID',pic:'ZZZ9'},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV67Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV60AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'TOGGLEDOWNLOADACTIONS'","{handler:'E272A1',iparms:[{av:'divDownloadactionstable_Visible',ctrl:'DOWNLOADACTIONSTABLE',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERTOGGLE_COMBINED.CLICK","{handler:'E202A2',iparms:[{av:'divFiltercollapsiblesection_combined_Visible',ctrl:'FILTERCOLLAPSIBLESECTION_COMBINED',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERCLOSE_COMBINED.CLICK","{handler:'E212A2',iparms:[{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         lV50K2BToolsGenericSearchField = "";
         H002A2_A11SatisfaccionTecnicoProfesionalismoId = new short[1] ;
         H002A2_A34SatisfaccionSugerencia = new string[] {""} ;
         H002A2_A31SatisfaccionAtencionNombre = new string[] {""} ;
         H002A2_A13SatisfaccionAtencionId = new short[1] ;
         H002A2_A38SatisfaccionTiempoNombre = new string[] {""} ;
         H002A2_A12SatisfaccionTiempoId = new short[1] ;
         H002A2_A35SatisfaccionTecnicoCompetenteNombre = new string[] {""} ;
         H002A2_A10SatisfaccionTecnicoCompetenteId = new short[1] ;
         H002A2_A36SatisfaccionTecnicoProblemaNombre = new string[] {""} ;
         H002A2_A9SatisfaccionTecnicoProblemaId = new short[1] ;
         H002A2_A33SatisfaccionResueltoNombre = new string[] {""} ;
         H002A2_A8SatisfaccionResueltoId = new short[1] ;
         H002A2_A94UsuarioRequerimiento = new string[] {""} ;
         H002A2_A90UsuarioFecha = new DateTime[] {DateTime.MinValue} ;
         H002A2_A93UsuarioNombre = new string[] {""} ;
         H002A2_A15UsuarioId = new short[1] ;
         H002A2_A14TicketId = new long[1] ;
         H002A2_A32SatisfaccionFecha = new DateTime[] {DateTime.MinValue} ;
         H002A2_A7SatisfaccionId = new long[1] ;
         ...
         sCtrlAV6SatisfaccionTecnicoProfesionalismoId = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.estadosatisfaccionsatisfaccionwc3__default(),
            new Object[][] {
                new Object[] {
               H002A2_A11SatisfaccionTecnicoProfesionalismoId, H002A2_A34SatisfaccionSugerencia, H002A2_A31SatisfaccionAtencionNombre, H002A2_A13SatisfaccionAtencionId, H002A2_A38SatisfaccionTiempoNombre, H002A2_A12SatisfaccionTiempoId, H002A2_A35SatisfaccionTecnicoCompetenteNombre, H002A2_A10SatisfaccionTecnicoCompetenteId, H002A2_A36SatisfaccionTecnicoProblemaNombre, H002A2_A9SatisfaccionTecnicoProblemaId,
               H002A2_A33SatisfaccionResueltoNombre, H002A2_A8SatisfaccionResueltoId, H002A2_A94UsuarioRequerimiento, H002A2_A90UsuarioFecha, H002A2_A93UsuarioNombre, H002A2_A15UsuarioId, H002A2_A14TicketId, H002A2_A32SatisfaccionFecha, H002A2_A7SatisfaccionId
               }
               , new Object[] {
      ...
      private short AV6SatisfaccionTecnicoProfesionalismoId ;
      private short wcpOAV6SatisfaccionTecnicoProfesionalismoId ;
      ...
      private string sCtrlAV6SatisfaccionTecnicoProfesionalismoId ;
      ...
      private short[] H002A2_A11SatisfaccionTecnicoProfesionalismoId ;
      private string[] H002A2_A34SatisfaccionSugerencia ;
      private string[] H002A2_A31SatisfaccionAtencionNombre ;
      private short[] H002A2_A13SatisfaccionAtencionId ;
      private string[] H002A2_A38SatisfaccionTiempoNombre ;
      private short[] H002A2_A12SatisfaccionTiempoId ;
      private string[] H002A2_A35SatisfaccionTecnicoCompetenteNombre ;
      private short[] H002A2_A10SatisfaccionTecnicoCompetenteId ;
      private string[] H002A2_A36SatisfaccionTecnicoProblemaNombre ;
      private short[] H002A2_A9SatisfaccionTecnicoProblemaId ;
      private string[] H002A2_A33SatisfaccionResueltoNombre ;
      private short[] H002A2_A8SatisfaccionResueltoId ;
      private string[] H002A2_A94UsuarioRequerimiento ;
      private DateTime[] H002A2_A90UsuarioFecha ;
      private string[] H002A2_A93UsuarioNombre ;
      private short[] H002A2_A15UsuarioId ;
      private long[] H002A2_A14TicketId ;
      private DateTime[] H002A2_A32SatisfaccionFecha ;
      private long[] H002A2_A7SatisfaccionId ;
   ...
   public class estadosatisfaccionsatisfaccionwc3__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A11SatisfaccionTecnicoProfesionalismoId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[SatisfaccionTecnicoProfesionalismoId], T1.[SatisfaccionSugerencia], T2.[EstadoSatisfaccionNombre] AS SatisfaccionAtencionNombre, T1.[SatisfaccionAtencionId] AS SatisfaccionAtencionId, T3.[EstadoSatisfaccionNombre] AS SatisfaccionTiempoNombre, T1.[SatisfaccionTiempoId] AS SatisfaccionTiempoId, T4.[EstadoSatisfaccionNombre] AS SatisfaccionTecnicoCompetenteNombre, T1.[SatisfaccionTecnicoCompetenteId] AS SatisfaccionTecnicoCompetenteId, T5.[EstadoSatisfaccionNombre] AS SatisfaccionTecnicoProblemaNombre, T1.[SatisfaccionTecnicoProblemaId] AS SatisfaccionTecnicoProblemaId, T6.[EstadoSatisfaccionNombre] AS SatisfaccionResueltoNombre, T1.[SatisfaccionResueltoId] AS SatisfaccionResueltoId, T8.[UsuarioRequerimiento], T8.[UsuarioFecha], T8.[UsuarioNombre], T7.[UsuarioId], T1.[TicketId], T1.[SatisfaccionFecha], T1.[SatisfaccionId]";
         sFromString = " FROM ((((((([Satisfaccion] T1 INNER JOIN [EstadoSatisfaccion] T2 ON T2.[EstadoSatisfaccionId] = T1.[SatisfaccionAtencionId]) INNER JOIN [EstadoSatisfaccion] T3 ON T3.[EstadoSatisfaccionId] = T1.[SatisfaccionTiempoId]) INNER JOIN [EstadoSatisfaccion] T4 ON T4.[EstadoSatisfaccionId] = T1.[SatisfaccionTecnicoCompetenteId]) INNER JOIN [EstadoSatisfaccion] T5 ON T5.[EstadoSatisfaccionId] = T1.[SatisfaccionTecnicoProblemaId]) INNER JOIN [EstadoSatisfaccion] T6 ON T6.[EstadoSatisfaccionId] = T1.[SatisfaccionResueltoId]) INNER JOIN [Ticket] T7 ON T7.[TicketId] = T1.[TicketId]) INNER JOIN [Usuario] T8 ON T8.[UsuarioId] = T7.[UsuarioId])";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.[SatisfaccionTecnicoProfesionalismoId] = @AV6SatisfaccionTecnicoProfesionalismoId)");
                                             ...
                                             short A11SatisfaccionTecnicoProfesionalismoId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((((((([Satisfaccion] T1 INNER JOIN [EstadoSatisfaccion] T8 ON T8.[EstadoSatisfaccionId] = T1.[SatisfaccionAtencionId]) INNER JOIN [EstadoSatisfaccion] T7 ON T7.[EstadoSatisfaccionId] = T1.[SatisfaccionTiempoId]) INNER JOIN [EstadoSatisfaccion] T6 ON T6.[EstadoSatisfaccionId] = T1.[SatisfaccionTecnicoCompetenteId]) INNER JOIN [EstadoSatisfaccion] T5 ON T5.[EstadoSatisfaccionId] = T1.[SatisfaccionTecnicoProblemaId]) INNER JOIN [EstadoSatisfaccion] T4 ON T4.[EstadoSatisfaccionId] = T1.[SatisfaccionResueltoId]) INNER JOIN [Ticket] T2 ON T2.[TicketId] = T1.[TicketId]) INNER JOIN [Usuario] T3 ON T3.[UsuarioId] = T2.[UsuarioId])";
         AddWhere(sWhereString, "(T1.[SatisfaccionTecnicoProfesionalismoId] = @AV6SatisfaccionTecnicoProfesionalismoId)");
         if ( ! (DateTime.MinValue==AV37SatisfaccionFecha_To) )
         {
            AddWhere(sWhereString, "(T1.[SatisfaccionFecha] <= @AV37SatisfaccionFecha_To)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002A2(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (short)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] , (short)dynConstraints[25] );
               case 1 :
                     return conditional_H002A3(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (short)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] , (short)dynConstraints[25] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6SatisfaccionTecnicoProfesionalismoId",GXType.Int16,4,0) ,
