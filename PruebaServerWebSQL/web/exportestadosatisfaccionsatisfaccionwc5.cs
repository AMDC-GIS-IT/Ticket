...
namespace GeneXus.Programs {
   public class exportestadosatisfaccionsatisfaccionwc5 : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV8SatisfaccionAtencionId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      public short executeUdp( short aP0_SatisfaccionAtencionId ,
                               DateTime aP1_SatisfaccionFecha_From ,
                               DateTime aP2_SatisfaccionFecha_To ,
                               DateTime aP3_UsuarioFecha_From ,
                               DateTime aP4_UsuarioFecha_To ,
      ...
      void executePrivate( )
      {
         ...
         AV27Filename = GxDirectory.TemporaryFilesPath + AV30File.Separator + "ExportEstadoSatisfaccionSatisfaccionWC5-" + StringUtil.Trim( StringUtil.Str( (decimal)(AV25Random), 8, 0)) + ".xlsx";
         ...
         if ( ! context.isAjaxRequest( ) )
         {
            AV29HttpResponse.AppendHeader("Content-Disposition", "attachment;filename=ExportEstadoSatisfaccionSatisfaccionWC5.xlsx");
         }
         if ( ! context.isAjaxRequest( ) )
         {
      ...
      public override void initialize( )
      {
         ...
         P00343_A15UsuarioId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.exportestadosatisfaccionsatisfaccionwc5__default(),
            new Object[][] {
               ...
               , new Object[] {
               P00343_A8SatisfaccionResueltoId, P00343_A9SatisfaccionTecnicoProblemaId, P00343_A10SatisfaccionTecnicoCompetenteId, P00343_A11SatisfaccionTecnicoProfesionalismoId, P00343_A12SatisfaccionTiempoId, P00343_A34SatisfaccionSugerencia, P00343_A94UsuarioRequerimiento, P00343_A93UsuarioNombre, P00343_A15UsuarioId, P00343_A14TicketId,
               P00343_A7SatisfaccionId, P00343_A38SatisfaccionTiempoNombre, P00343_A37SatisfaccionTecnicoProfesionalismoNombre, P00343_A35SatisfaccionTecnicoCompetenteNombre, P00343_A36SatisfaccionTecnicoProblemaNombre, P00343_A33SatisfaccionResueltoNombre, P00343_A90UsuarioFecha, P00343_A32SatisfaccionFecha, P00343_A13SatisfaccionAtencionId
               }
            }
         );
         AV52Pgmname = "ExportEstadoSatisfaccionSatisfaccionWC5";
         /* GeneXus formulas. */
         AV52Pgmname = "ExportEstadoSatisfaccionSatisfaccionWC5";
         context.Gx_err = 0;
      }
      ...
      private short[] P00343_A15UsuarioId ;
   ...
   public class exportestadosatisfaccionsatisfaccionwc5__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_P00343(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (short)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] , (short)dynConstraints[25] );
         }
