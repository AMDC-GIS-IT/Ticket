...
namespace GeneXus.Programs {
   public class gx00a0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV13pUsuarioId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV13pUsuarioId", StringUtil.LTrimStr( (decimal)(AV13pUsuarioId), 4, 0));
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249572121", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx00a0.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV13pUsuarioId,4,0))}, new string[] {"pUsuarioId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPUSUARIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13pUsuarioId), 4, 0, ",", "")));
      ...
      {
         return formatLink("gx00a0.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV13pUsuarioId,4,0))}, new string[] {"pUsuarioId"})  ;
      }
      ...
      protected void WB0F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavCusuariotelefono_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11cUsuarioTelefono), 9, 0, ",", "")), ((edtavCusuariotelefono_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV11cUsuarioTelefono), "ZZZZZZZZ9")) : context.localUtil.Format( (decimal)(AV11cUsuarioTelefono), "ZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCusuariotelefono_Jsonclick, 0, "Attribute", "", "", "", "", edtavCusuariotelefono_Visible, edtavCusuariotelefono_Enabled, 0, "number", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx00A0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCestadoticketusuarioid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV15cEstadoTicketUsuarioId), 4, 0, ",", "")), ((edtavCestadoticketusuarioid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV15cEstadoTicketUsuarioId), "ZZZ9")) : context.localUtil.Format( (decimal)(AV15cEstadoTicketUsuarioId), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,76);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCestadoticketusuarioid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCestadoticketusuarioid_Visible, edtavCestadoticketusuarioid_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx00A0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            else
            {
               ...
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A15UsuarioId), 4, 0, ".", "")));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void RF0F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV6cUsuarioId } ,
                                                 new int[]{
                                                 TypeConstants.DATE, TypeConstants.DATE, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.DATE, TypeConstants.DATE, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.SHORT
                                                 }
            });
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_USUARIOID"+"_"+sGXsfl_84_idx, GetSecureSignedToken( sGXsfl_84_idx, context.localUtil.Format( (decimal)(A15UsuarioId), "ZZZ9"), context));
      }
      ...
      protected void STRUP0F0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.CToD( cgiGet( "GXH_vCUSUARIOFECHA"), 2) != AV8cUsuarioFecha )
            {
               GRID1_nFirstRecordOnPage = 0;
            }
      ...
      protected void E210F2( )
      {
         ...
         AssignAttri("", false, "AV13pUsuarioId", StringUtil.LTrimStr( (decimal)(AV13pUsuarioId), 4, 0));
         context.setWebReturnParms(new Object[] {(short)AV13pUsuarioId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV13pUsuarioId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV13pUsuarioId", StringUtil.LTrimStr( (decimal)(AV13pUsuarioId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023124957223", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00a0.js", "?2023124957223", false, true);
      ...
      protected void sendrow_842( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_84_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A15UsuarioId), 4, 0, ",", "")))+"'"+"]);";
            ...
            edtUsuarioNombre_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A15UsuarioId), 4, 0, ",", "")))+"'"+"]);";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cUsuarioId',fld:'vCUSUARIOID',pic:'ZZZ9'},{av:'AV7cUsuarioNombre',fld:'vCUSUARIONOMBRE',pic:''},{av:'AV8cUsuarioFecha',fld:'vCUSUARIOFECHA',pic:''},{av:'AV9cUsuarioHora',fld:'vCUSUARIOHORA',pic:'99:99'},{av:'AV10cUsuarioEmail',fld:'vCUSUARIOEMAIL',pic:''},{av:'AV11cUsuarioTelefono',fld:'vCUSUARIOTELEFONO',pic:'ZZZZZZZZ9'},{av:'AV15cEstadoTicketUsuarioId',fld:'vCESTADOTICKETUSUARIOID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("ENTER","{handler:'E210F2',iparms:[{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV13pUsuarioId',fld:'vPUSUARIOID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cUsuarioId',fld:'vCUSUARIOID',pic:'ZZZ9'},{av:'AV7cUsuarioNombre',fld:'vCUSUARIONOMBRE',pic:''},{av:'AV8cUsuarioFecha',fld:'vCUSUARIOFECHA',pic:''},{av:'AV9cUsuarioHora',fld:'vCUSUARIOHORA',pic:'99:99'},{av:'AV10cUsuarioEmail',fld:'vCUSUARIOEMAIL',pic:''},{av:'AV11cUsuarioTelefono',fld:'vCUSUARIOTELEFONO',pic:'ZZZZZZZZ9'},{av:'AV15cEstadoTicketUsuarioId',fld:'vCESTADOTICKETUSUARIOID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cUsuarioId',fld:'vCUSUARIOID',pic:'ZZZ9'},{av:'AV7cUsuarioNombre',fld:'vCUSUARIONOMBRE',pic:''},{av:'AV8cUsuarioFecha',fld:'vCUSUARIOFECHA',pic:''},{av:'AV9cUsuarioHora',fld:'vCUSUARIOHORA',pic:'99:99'},{av:'AV10cUsuarioEmail',fld:'vCUSUARIOEMAIL',pic:''},{av:'AV11cUsuarioTelefono',fld:'vCUSUARIOTELEFONO',pic:'ZZZZZZZZ9'},{av:'AV15cEstadoTicketUsuarioId',fld:'vCESTADOTICKETUSUARIOID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cUsuarioId',fld:'vCUSUARIOID',pic:'ZZZ9'},{av:'AV7cUsuarioNombre',fld:'vCUSUARIONOMBRE',pic:''},{av:'AV8cUsuarioFecha',fld:'vCUSUARIOFECHA',pic:''},{av:'AV9cUsuarioHora',fld:'vCUSUARIOHORA',pic:'99:99'},{av:'AV10cUsuarioEmail',fld:'vCUSUARIOEMAIL',pic:''},{av:'AV11cUsuarioTelefono',fld:'vCUSUARIOTELEFONO',pic:'ZZZZZZZZ9'},{av:'AV15cEstadoTicketUsuarioId',fld:'vCESTADOTICKETUSUARIOID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cUsuarioId',fld:'vCUSUARIOID',pic:'ZZZ9'},{av:'AV7cUsuarioNombre',fld:'vCUSUARIONOMBRE',pic:''},{av:'AV8cUsuarioFecha',fld:'vCUSUARIOFECHA',pic:''},{av:'AV9cUsuarioHora',fld:'vCUSUARIOHORA',pic:'99:99'},{av:'AV10cUsuarioEmail',fld:'vCUSUARIOEMAIL',pic:''},{av:'AV11cUsuarioTelefono',fld:'vCUSUARIOTELEFONO',pic:'ZZZZZZZZ9'},{av:'AV15cEstadoTicketUsuarioId',fld:'vCESTADOTICKETUSUARIOID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         H000F2_A15UsuarioId = new short[1] ;
      ...
      private short[] H000F2_A15UsuarioId ;
   ...
   public class gx00a0__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000F2(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (string)dynConstraints[3] , (int)dynConstraints[4] , (short)dynConstraints[5] , (string)dynConstraints[6] , (DateTime)dynConstraints[7] , (DateTime)dynConstraints[8] , (string)dynConstraints[9] , (int)dynConstraints[10] , (short)dynConstraints[11] , (short)dynConstraints[12] );
               case 1 :
                     return conditional_H000F3(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (string)dynConstraints[3] , (int)dynConstraints[4] , (short)dynConstraints[5] , (string)dynConstraints[6] , (DateTime)dynConstraints[7] , (DateTime)dynConstraints[8] , (string)dynConstraints[9] , (int)dynConstraints[10] , (short)dynConstraints[11] , (short)dynConstraints[12] );
         }
