...
namespace GeneXus.Programs {
   public class promptunidades_gis : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public promptunidades_gis( )
      {
      ...
      public promptunidades_gis( IGxContext context )
      {
      ...
      {
         this.AV17pid_unidad = 0 ;
         executePrivate();
         aP0_pid_unidad=this.AV17pid_unidad;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV18nombre_unidad = GetPar( "nombre_unidad");
               ...
               AV17pid_unidad = (int)(NumberUtil.Val( GetPar( "pid_unidad"), "."));
               ...
               gxgrGrid_refresh( subGrid_Rows, AV29K2BToolsGenericSearchField, AV18nombre_unidad, AV15ClassCollection, AV30OrderedBy, AV40Pgmname, AV5CurrentPage, AV7GridConfiguration, AV17pid_unidad, AV8FreezeColumnTitles) ;
            ...
            {
               AV17pid_unidad = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV17pid_unidad", StringUtil.LTrimStr( (decimal)(AV17pid_unidad), 9, 0));
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2023124956418", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("promptunidades_gis.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV17pid_unidad,9,0))}, new string[] {"pid_unidad"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vNOMBRE_UNIDAD", AV18nombre_unidad);
         /* Send saved values. */
         ...
         GxWebStd.gx_hidden_field( context, "vPID_UNIDAD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV17pid_unidad), 9, 0, ",", "")));
      ...
      {
         return formatLink("promptunidades_gis.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV17pid_unidad,9,0))}, new string[] {"pid_unidad"})  ;
      }

      public override string GetPgmname( )
      {
         return "Promptunidades_gis" ;
      }
      ...
      protected void WB5C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_bitmap( context, imgFilterclose_combined_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 5, imgFilterclose_combined_Jsonclick, "'"+""+"'"+",false,"+"'"+"EFILTERCLOSE_COMBINED.CLICK."+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Promptunidades_gis.htm");
            /* Div Control */
            ...
            ClassString = "Attribute_Filter";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavNombre_unidad_Internalname, AV18nombre_unidad, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,41);\"", 0, 1, edtavNombre_unidad_Enabled, 0, 80, "chr", 3, "row", StyleString, ClassString, "", "", "200", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_Promptunidades_gis.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void wb_table1_43_5C2e( bool wbgen )
      {
         ...
         if ( wbEnd == 87 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_95_5C2( true) ;
         }
         else
         {
            wb_table2_95_5C2( false) ;
         }
         return  ;
      }

      protected void wb_table2_95_5C2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagebuttontextblock_Internalname, "", "", "", lblPreviouspagebuttontextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOPREVIOUS\\'."+"'", "", lblPreviouspagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_Promptunidades_gis.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFirstpagetextblock_Internalname, lblFirstpagetextblock_Caption, "", "", lblFirstpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOFIRST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblFirstpagetextblock_Visible, 1, 0, 0, "HLP_Promptunidades_gis.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacinglefttextblock_Internalname, "...", "", "", lblSpacinglefttextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacinglefttextblock_Visible, 1, 0, 0, "HLP_Promptunidades_gis.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagetextblock_Internalname, lblPreviouspagetextblock_Caption, "", "", lblPreviouspagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOPREVIOUS\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPreviouspagetextblock_Visible, 1, 0, 0, "HLP_Promptunidades_gis.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCurrentpagetextblock_Internalname, lblCurrentpagetextblock_Caption, "", "", lblCurrentpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_Promptunidades_gis.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagetextblock_Internalname, lblNextpagetextblock_Caption, "", "", lblNextpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DONEXT\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblNextpagetextblock_Visible, 1, 0, 0, "HLP_Promptunidades_gis.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacingrighttextblock_Internalname, "...", "", "", lblSpacingrighttextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacingrighttextblock_Visible, 1, 0, 0, "HLP_Promptunidades_gis.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLastpagetextblock_Internalname, lblLastpagetextblock_Caption, "", "", lblLastpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOLAST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblLastpagetextblock_Visible, 1, 0, 0, "HLP_Promptunidades_gis.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagebuttontextblock_Internalname, "", "", "", lblNextpagebuttontextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DONEXT\\'."+"'", "", lblNextpagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_Promptunidades_gis.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vNOMBRE_UNIDAD"), AV18nombre_unidad) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      {
         /* GeneXus formulas. */
         AV40Pgmname = "Promptunidades_gis";
         context.Gx_err = 0;
      }
      ...
      protected void RF5C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_datastore1.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV30OrderedBy } ,
                                                 new int[]{
                                                 TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.INT, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.SHORT
                                                 }
            });
            lV18nombre_unidad = StringUtil.Concat( StringUtil.RTrim( AV18nombre_unidad), "%", "");
            ...
            lV29K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV29K2BToolsGenericSearchField), 100, "%");
            /* Using cursor H005C2 */
            pr_datastore1.execute(0, new Object[] {lV18nombre_unidad, lV29K2BToolsGenericSearchField, lV29K2BToolsGenericSearchField, lV29K2BToolsGenericSearchField, lV29K2BToolsGenericSearchField, lV29K2BToolsGenericSearchField, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_87_idx = 1;
            sGXsfl_87_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_87_idx), 4, 0), 4, "0");
            SubsflControlProps_872( ) ;
            while ( ( (pr_datastore1.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A121unidades_gismodificado_por = H005C2_A121unidades_gismodificado_por[0];
               n121unidades_gismodificado_por = H005C2_n121unidades_gismodificado_por[0];
               A118unidades_giscreado_por = H005C2_A118unidades_giscreado_por[0];
               n118unidades_giscreado_por = H005C2_n118unidades_giscreado_por[0];
               A115unidades_gisestado = H005C2_A115unidades_gisestado[0];
               n115unidades_gisestado = H005C2_n115unidades_gisestado[0];
               A114nombre_unidad = H005C2_A114nombre_unidad[0];
               n114nombre_unidad = H005C2_n114nombre_unidad[0];
               A103id_unidad = H005C2_A103id_unidad[0];
               E245C2 ();
      ...
      protected void send_integrity_lvl_hashes5C2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV40Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV40Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_ID_UNIDAD"+"_"+sGXsfl_87_idx, GetSecureSignedToken( sGXsfl_87_idx, context.localUtil.Format( (decimal)(A103id_unidad), "ZZZZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV29K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV29K2BToolsGenericSearchField), 100, "%");
         /* Using cursor H005C3 */
         pr_datastore1.execute(1, new Object[] {lV18nombre_unidad, lV29K2BToolsGenericSearchField, lV29K2BToolsGenericSearchField, lV29K2BToolsGenericSearchField, lV29K2BToolsGenericSearchField, lV29K2BToolsGenericSearchField});
      ...
      protected void STRUP5C0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV18nombre_unidad = cgiGet( edtavNombre_unidad_Internalname);
            AssignAttri("", false, "AV18nombre_unidad", AV18nombre_unidad);
      ...
      protected void E205C2( )
      {
         ...
         AV37ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "unidades_gis";
         AV37ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "unidades_gis";
         ...
         GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
         Form.Caption = StringUtil.Format( "Seleccionar %1", "unidades_gis", "", "", "", "", "", "", "", "");
      ...
      protected void E225C2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV17pid_unidad = A103id_unidad;
         AssignAttri("", false, "AV17pid_unidad", StringUtil.LTrimStr( (decimal)(AV17pid_unidad), 9, 0));
         context.setWebReturnParms(new Object[] {(int)AV17pid_unidad});
         context.setWebReturnParmsMetadata(new Object[] {"AV17pid_unidad"});
         context.wjLocDisableFrm = 1;
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV12GridStateKey = StringUtil.Str( (decimal)(AV17pid_unidad), 9, 0);
         ...
         while ( AV41GXV1 <= AV13GridState.gxTpr_Filtervalues.Count )
         {
            ...
            if ( StringUtil.StrCmp(AV14GridStateFilterValue.gxTpr_Filtername, "nombre_unidad") == 0 )
            {
               AV18nombre_unidad = AV14GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV18nombre_unidad", AV18nombre_unidad);
            }
      ...
      protected void S122( )
      {
         ...
         AV14GridStateFilterValue.gxTpr_Value = AV18nombre_unidad;
      ...
      protected void S142( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV18nombre_unidad)) )
         {
            AV26K2BFilterValuesSDTItem = new SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem(context);
            AV26K2BFilterValuesSDTItem.gxTpr_Name = "nombre_unidad";
            AV26K2BFilterValuesSDTItem.gxTpr_Description = "nombre_unidad";
            AV26K2BFilterValuesSDTItem.gxTpr_Type = "Standard";
            AV26K2BFilterValuesSDTItem.gxTpr_Value = AV18nombre_unidad;
            AV26K2BFilterValuesSDTItem.gxTpr_Valuedescription = AV18nombre_unidad;
         ...
         if ( AV25K2BFilterValuesSDT.Count > 0 )
         {
            ...
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV40Pgmname,  "Grid",  AV25K2BFilterValuesSDT, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item2) ;
      ...
      protected void E115C2( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV28DeletedTag, "nombre_unidad") == 0 )
         {
            AV18nombre_unidad = "";
            AssignAttri("", false, "AV18nombre_unidad", AV18nombre_unidad);
         }
      ...
      protected void wb_table2_95_5C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoresultsfoundtextblock_Internalname, "No hay resultados", "", "", lblNoresultsfoundtextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_Promptunidades_gis.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_95_5C2e( true) ;
         }
         else
         {
            wb_table2_95_5C2e( false) ;
         }
      }
      ...
      protected void wb_table1_43_5C2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRuntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblRuntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_Promptunidades_gis.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttK2bgridsettingssave_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(87), 2, 0)+","+"null"+");", "Aplicar", bttK2bgridsettingssave_Jsonclick, 5, "Aplicar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'SAVEGRIDSETTINGS\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Promptunidades_gis.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV17pid_unidad = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV17pid_unidad", StringUtil.LTrimStr( (decimal)(AV17pid_unidad), 9, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249564279", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("promptunidades_gis.js", "?20231249564279", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
      ...
      {
         edtid_unidad_Internalname = "ID_UNIDAD_"+sGXsfl_87_idx;
         edtnombre_unidad_Internalname = "NOMBRE_UNIDAD_"+sGXsfl_87_idx;
         edtunidades_gisestado_Internalname = "UNIDADES_GISESTADO_"+sGXsfl_87_idx;
         edtunidades_giscreado_por_Internalname = "UNIDADES_GISCREADO_POR_"+sGXsfl_87_idx;
         edtunidades_gismodificado_por_Internalname = "UNIDADES_GISMODIFICADO_POR_"+sGXsfl_87_idx;
      }

      protected void SubsflControlProps_fel_872( )
      {
         edtid_unidad_Internalname = "ID_UNIDAD_"+sGXsfl_87_fel_idx;
         edtnombre_unidad_Internalname = "NOMBRE_UNIDAD_"+sGXsfl_87_fel_idx;
         edtunidades_gisestado_Internalname = "UNIDADES_GISESTADO_"+sGXsfl_87_fel_idx;
         edtunidades_giscreado_por_Internalname = "UNIDADES_GISCREADO_POR_"+sGXsfl_87_fel_idx;
         edtunidades_gismodificado_por_Internalname = "UNIDADES_GISMODIFICADO_POR_"+sGXsfl_87_fel_idx;
      }
      ...
      protected void sendrow_872( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_87_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute_Grid";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtunidades_gisestado_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A115unidades_gisestado), 9, 0, ",", "")),context.localUtil.Format( (decimal)(A115unidades_gisestado), "ZZZZZZZZ9"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtunidades_gisestado_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn InvisibleInExtraSmallColumn",(string)"",(short)-1,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)9,(short)0,(short)0,(short)87,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E225C2',iparms:[{av:'A103id_unidad',fld:'ID_UNIDAD',pic:'ZZZZZZZZ9',hsh:true},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV17pid_unidad',fld:'vPID_UNIDAD',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("GRID.REFRESH","{handler:'E235C2',iparms:[{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV18nombre_unidad',fld:'vNOMBRE_UNIDAD',pic:''},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pid_unidad',fld:'vPID_UNIDAD',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E245C2',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOSEARCH'","{handler:'E255C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18nombre_unidad',fld:'vNOMBRE_UNIDAD',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pid_unidad',fld:'vPID_UNIDAD',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E135C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18nombre_unidad',fld:'vNOMBRE_UNIDAD',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pid_unidad',fld:'vPID_UNIDAD',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E145C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18nombre_unidad',fld:'vNOMBRE_UNIDAD',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pid_unidad',fld:'vPID_UNIDAD',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E155C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18nombre_unidad',fld:'vNOMBRE_UNIDAD',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pid_unidad',fld:'vPID_UNIDAD',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E165C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18nombre_unidad',fld:'vNOMBRE_UNIDAD',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pid_unidad',fld:'vPID_UNIDAD',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'TOGGLEGRIDSETTINGSTABLE'","{handler:'E265C1',iparms:[{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED","{handler:'E115C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18nombre_unidad',fld:'vNOMBRE_UNIDAD',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pid_unidad',fld:'vPID_UNIDAD',pic:'ZZZZZZZZ9'},{av:'AV28DeletedTag',fld:'vDELETEDTAG',pic:''},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED",",oparms:[{av:'AV18nombre_unidad',fld:'vNOMBRE_UNIDAD',pic:''},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E125C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18nombre_unidad',fld:'vNOMBRE_UNIDAD',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pid_unidad',fld:'vPID_UNIDAD',pic:'ZZZZZZZZ9'},{av:'AV34UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERTOGGLE_COMBINED.CLICK","{handler:'E185C2',iparms:[{av:'divFiltercollapsiblesection_combined_Visible',ctrl:'FILTERCOLLAPSIBLESECTION_COMBINED',prop:'Visible'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERCLOSE_COMBINED.CLICK","{handler:'E195C2',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("NULL","{handler:'Valid_Unidades_gismodificado_por',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         H005C2_A121unidades_gismodificado_por = new string[] {""} ;
         H005C2_n121unidades_gismodificado_por = new bool[] {false} ;
         H005C2_A118unidades_giscreado_por = new string[] {""} ;
         H005C2_n118unidades_giscreado_por = new bool[] {false} ;
         H005C2_A115unidades_gisestado = new int[1] ;
         H005C2_n115unidades_gisestado = new bool[] {false} ;
         H005C2_A114nombre_unidad = new string[] {""} ;
         H005C2_n114nombre_unidad = new bool[] {false} ;
         H005C2_A103id_unidad = new int[1] ;
         ...
         ROClassString = "";
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.promptunidades_gis__datastore1(),
            new Object[][] {
                new Object[] {
               H005C2_A121unidades_gismodificado_por, H005C2_n121unidades_gismodificado_por, H005C2_A118unidades_giscreado_por, H005C2_n118unidades_giscreado_por, H005C2_A115unidades_gisestado, H005C2_n115unidades_gisestado, H005C2_A114nombre_unidad, H005C2_n114nombre_unidad, H005C2_A103id_unidad
               }
               , new Object[] {
      ...
      private string[] H005C2_A121unidades_gismodificado_por ;
      private bool[] H005C2_n121unidades_gismodificado_por ;
      private string[] H005C2_A118unidades_giscreado_por ;
      private bool[] H005C2_n118unidades_giscreado_por ;
      private int[] H005C2_A115unidades_gisestado ;
      private bool[] H005C2_n115unidades_gisestado ;
      private string[] H005C2_A114nombre_unidad ;
      private bool[] H005C2_n114nombre_unidad ;
      private int[] H005C2_A103id_unidad ;
   ...
   public class promptunidades_gis__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV30OrderedBy )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [modificado_por], [creado_por], [estado], [nombre_unidad], [id_unidad]";
         sFromString = " FROM dbo.[unidades_gis]";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV18nombre_unidad)) )
         {
            AddWhere(sWhereString, "([nombre_unidad] like @lV18nombre_unidad)");
         }
         else
         {
            GXv_int3[0] = 1;
         ...
         {
            AddWhere(sWhereString, "(CONVERT( char(9), CAST([id_unidad] AS decimal(9,0))) like '%' + @lV29K2BToolsGenericSearchField + '%' or [nombre_unidad] like '%' + @lV29K2BToolsGenericSearchField + '%' or CONVERT( char(9), CAST([estado] AS decimal(9,0))) like '%' + @lV29K2BToolsGenericSearchField + '%' or [creado_por] like '%' + @lV29K2BToolsGenericSearchField + '%' or [modificado_por] like '%' + @lV29K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int3[1] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H005C2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (int)dynConstraints[3] , (int)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (short)dynConstraints[7] );
               case 1 :
                     return conditional_H005C3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (int)dynConstraints[3] , (int)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (short)dynConstraints[7] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV18nombre_unidad",GXType.NVarChar,200,0) ,
