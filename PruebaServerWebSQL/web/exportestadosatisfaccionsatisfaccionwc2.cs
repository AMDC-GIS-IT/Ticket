...
namespace GeneXus.Programs {
   public class exportestadosatisfaccionsatisfaccionwc2 : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV8SatisfaccionTecnicoCompetenteId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      public short executeUdp( short aP0_SatisfaccionTecnicoCompetenteId ,
                               DateTime aP1_SatisfaccionFecha_From ,
                               DateTime aP2_SatisfaccionFecha_To ,
                               DateTime aP3_UsuarioFecha_From ,
                               DateTime aP4_UsuarioFecha_To ,
                               ...
                               string aP10_K2BToolsGenericSearchField )
      {
         execute(aP0_SatisfaccionTecnicoCompetenteId, aP1_SatisfaccionFecha_From, aP2_SatisfaccionFecha_To, aP3_UsuarioFecha_From, aP4_UsuarioFecha_To, aP5_SatisfaccionResueltoNombre, aP6_SatisfaccionTecnicoProblemaNombre, aP7_SatisfaccionTecnicoProfesionalismoNombre, aP8_SatisfaccionTiempoNombre, aP9_SatisfaccionAtencionNombre, aP10_K2BToolsGenericSearchField, ref aP11_OrderedBy);
      ...
      void executePrivate( )
      {
         ...
         AV27Filename = GxDirectory.TemporaryFilesPath + AV30File.Separator + "ExportEstadoSatisfaccionSatisfaccionWC2-" + StringUtil.Trim( StringUtil.Str( (decimal)(AV25Random), 8, 0)) + ".xlsx";
         ...
         if ( ! context.isAjaxRequest( ) )
         {
            AV29HttpResponse.AppendHeader("Content-Disposition", "attachment;filename=ExportEstadoSatisfaccionSatisfaccionWC2.xlsx");
         }
         if ( ! context.isAjaxRequest( ) )
         {
      ...
      public override void initialize( )
      {
         ...
         P00313_A15UsuarioId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.exportestadosatisfaccionsatisfaccionwc2__default(),
            new Object[][] {
               ...
               , new Object[] {
               P00313_A8SatisfaccionResueltoId, P00313_A9SatisfaccionTecnicoProblemaId, P00313_A11SatisfaccionTecnicoProfesionalismoId, P00313_A12SatisfaccionTiempoId, P00313_A13SatisfaccionAtencionId, P00313_A34SatisfaccionSugerencia, P00313_A94UsuarioRequerimiento, P00313_A93UsuarioNombre, P00313_A15UsuarioId, P00313_A14TicketId,
               P00313_A7SatisfaccionId, P00313_A31SatisfaccionAtencionNombre, P00313_A38SatisfaccionTiempoNombre, P00313_A37SatisfaccionTecnicoProfesionalismoNombre, P00313_A36SatisfaccionTecnicoProblemaNombre, P00313_A33SatisfaccionResueltoNombre, P00313_A90UsuarioFecha, P00313_A32SatisfaccionFecha, P00313_A10SatisfaccionTecnicoCompetenteId
               }
            }
         );
         AV52Pgmname = "ExportEstadoSatisfaccionSatisfaccionWC2";
         /* GeneXus formulas. */
         AV52Pgmname = "ExportEstadoSatisfaccionSatisfaccionWC2";
         context.Gx_err = 0;
      }
      ...
      private short[] P00313_A15UsuarioId ;
   ...
   public class exportestadosatisfaccionsatisfaccionwc2__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_P00313(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (short)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] );
         }
