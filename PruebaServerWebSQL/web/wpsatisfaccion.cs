...
namespace GeneXus.Programs {
   public class wpsatisfaccion : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249565826", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void wb_table2_107_5U2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table3_130_5U2( true) ;
         }
         else
         {
            wb_table3_130_5U2( false) ;
         }
         return  ;
      }

      protected void wb_table3_130_5U2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected int subGridclient_rec_count_fnc( )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              new int[]{
                                              TypeConstants.LONG, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT
                                              }
         });
      ...
      protected void S212( )
      {
         ...
         returnInSub = false;
         context.PopUp(formatLink("wpregistrarsatisfaccion.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A14TicketId,10,0)),UrlEncode(StringUtil.LTrimStr(A16TicketResponsableId,10,0)),UrlEncode(StringUtil.LTrimStr(A15UsuarioId,4,0)),UrlEncode(StringUtil.RTrim(A93UsuarioNombre)),UrlEncode(StringUtil.LTrimStr(A198TicketTecnicoResponsableId,4,0)),UrlEncode(StringUtil.RTrim(A199TicketTecnicoResponsableNombre))}, new string[] {"TicketId","TicketResponsableId","UsuarioId","UsuarioNombre","TicketTecnicoResponsableId","TicketTecnicoResponsableNombre"}) , new Object[] {});
      ...
      protected void wb_table3_130_5U2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_130_5U2e( true) ;
         }
         else
         {
            wb_table3_130_5U2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023124957124", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wpsatisfaccion.js", "?2023124957125", false, true);
            context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
            context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
            context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
            context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'E_ACTIONENCUESTA'","{handler:'E245U2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV64GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV66Variable_FilterUsuario',fld:'vVARIABLE_FILTERUSUARIO',pic:''},{av:'AV67Variable_FilterEstado',fld:'vVARIABLE_FILTERESTADO',pic:''},{av:'AV68Variable_FilterResponsable',fld:'vVARIABLE_FILTERRESPONSABLE',pic:''},{av:'AV55ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV69OrderedBy_Grid',fld:'vORDEREDBY_GRID',pic:'ZZZ9'},{av:'AV75Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV54CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'A14TicketId',fld:'TICKETID',pic:'ZZZZZZZZZ9',hsh:true},{av:'A16TicketResponsableId',fld:'TICKETRESPONSABLEID',pic:'ZZZZZZZZZ9',hsh:true},{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZ9'},{av:'A93UsuarioNombre',fld:'USUARIONOMBRE',pic:''},{av:'A198TicketTecnicoResponsableId',fld:'TICKETTECNICORESPONSABLEID',pic:'ZZZ9',hsh:true},{av:'A199TicketTecnicoResponsableNombre',fld:'TICKETTECNICORESPONSABLENOMBRE',pic:''},{av:'AV61FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         ...
         setEventMetadata("NULL","{handler:'Validv_Actionencuesta_action',iparms:[{av:'AV61FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("NULL",",oparms:[{av:'AV61FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         H005U2_A15UsuarioId = new short[1] ;
         ...
         H005U3_A15UsuarioId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpsatisfaccion__default(),
            new Object[][] {
                new Object[] {
               H005U2_A188EstadoTicketTicketNombre, H005U2_A187EstadoTicketTicketId, H005U2_A17EstadoTicketTecnicoId, H005U2_A191UsuarioSistema, H005U2_A190EstadoTicketUsuarioNombre, H005U2_A189EstadoTicketUsuarioId, H005U2_A199TicketTecnicoResponsableNombre, H005U2_A198TicketTecnicoResponsableId, H005U2_A90UsuarioFecha, H005U2_A88UsuarioDepartamento,
               H005U2_A91UsuarioGerencia, H005U2_A94UsuarioRequerimiento, H005U2_A93UsuarioNombre, H005U2_A15UsuarioId, H005U2_A48TicketHora, H005U2_A46TicketFecha, H005U2_A16TicketResponsableId, H005U2_A14TicketId
               }
               , new Object[] {
               H005U3_A188EstadoTicketTicketNombre, H005U3_A187EstadoTicketTicketId, H005U3_A17EstadoTicketTecnicoId, H005U3_A191UsuarioSistema, H005U3_A190EstadoTicketUsuarioNombre, H005U3_A189EstadoTicketUsuarioId, H005U3_A199TicketTecnicoResponsableNombre, H005U3_A198TicketTecnicoResponsableId, H005U3_A90UsuarioFecha, H005U3_A88UsuarioDepartamento,
               H005U3_A91UsuarioGerencia, H005U3_A94UsuarioRequerimiento, H005U3_A93UsuarioNombre, H005U3_A15UsuarioId, H005U3_A48TicketHora, H005U3_A46TicketFecha, H005U3_A16TicketResponsableId, H005U3_A14TicketId
               }
            }
         );
         AV75Pgmname = "WPSatisfaccion";
      ...
      private short[] H005U2_A15UsuarioId ;
      ...
      private short[] H005U3_A15UsuarioId ;
   ...
   public class wpsatisfaccion__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H005U2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (long)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (short)dynConstraints[12] , (string)dynConstraints[13] , (short)dynConstraints[14] , (short)dynConstraints[15] , (short)dynConstraints[16] );
               case 1 :
                     return conditional_H005U3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (long)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (short)dynConstraints[12] , (string)dynConstraints[13] , (short)dynConstraints[14] , (short)dynConstraints[15] , (short)dynConstraints[16] );
         }
