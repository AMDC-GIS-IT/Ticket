...
namespace GeneXus.Programs {
   public class wwunidades_gis : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV41K2BToolsGenericSearchField, AV30nombre_unidad, AV32unidades_gisfecha_creacion_From, AV35unidades_gisfecha_modificacion_From, AV29ClassCollection, AV42OrderedBy, AV33unidades_gisfecha_creacion_To, AV36unidades_gisfecha_modificacion_To, AV57Pgmname, AV8CurrentPage, AV10GridConfiguration, AV48nombre_unidad_IsAuthorized, AV14Att_id_unidad_Visible, AV15Att_nombre_unidad_Visible, AV16Att_unidades_gisestado_Visible, AV17Att_unidades_gisfecha_creacion_Visible, AV18Att_unidades_gishora_creacion_Visible, AV19Att_unidades_giscreado_por_Visible, AV20Att_unidades_gisfecha_modificacion_Visible, AV21Att_unidades_gishora_modificacion_Visible, AV22Att_unidades_gismodificado_por_Visible, AV11FreezeColumnTitles) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249565115", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RF5E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV41K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV41K2BToolsGenericSearchField), 100, "%");
            /* Using cursor H005E2 */
            pr_datastore1.execute(0, new Object[] {lV30nombre_unidad, AV33unidades_gisfecha_creacion_To, AV32unidades_gisfecha_creacion_From, AV36unidades_gisfecha_modificacion_To, AV35unidades_gisfecha_modificacion_From, lV41K2BToolsGenericSearchField, lV41K2BToolsGenericSearchField, lV41K2BToolsGenericSearchField, lV41K2BToolsGenericSearchField, lV41K2BToolsGenericSearchField, lV41K2BToolsGenericSearchField, lV41K2BToolsGenericSearchField, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_174_idx = 1;
            sGXsfl_174_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_174_idx), 4, 0), 4, "0");
            SubsflControlProps_1742( ) ;
      ...
      protected void STRUP5E0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.CToD( cgiGet( "GXH_vUNIDADES_GISFECHA_CREACION_FROM"), 2) != AV32unidades_gisfecha_creacion_From )
            {
               GRID_nFirstRecordOnPage = 0;
            }
            if ( context.localUtil.CToD( cgiGet( "GXH_vUNIDADES_GISFECHA_MODIFICACION_FROM"), 2) != AV35unidades_gisfecha_modificacion_From )
            {
               GRID_nFirstRecordOnPage = 0;
            }
         }
      ...
      protected void E215E2( )
      {
         ...
         new k2bloadrowsperpage(context ).execute(  AV57Pgmname,  "Grid", out  AV24RowsPerPageVariable, out  AV25RowsPerPageLoaded) ;
      ...
      protected void E225E2( )
      {
         ...
         AV58GXV1 = 1;
         while ( AV58GXV1 <= AV46Messages.Count )
         {
            AV47Message = ((GeneXus.Utils.SdtMessages_Message)AV46Messages.Item(AV58GXV1));
         ...
         AV54ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV57Pgmname;
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV26GridStateKey = "";
         new k2bloadgridstate(context ).execute(  AV57Pgmname,  AV26GridStateKey, out  AV27GridState) ;
         ...
         AV59GXV2 = 1;
         while ( AV59GXV2 <= AV27GridState.gxTpr_Filtervalues.Count )
         {
            AV28GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV27GridState.gxTpr_Filtervalues.Item(AV59GXV2));
      ...
      protected void S132( )
      {
         ...
         AV27GridState.gxTpr_Filtervalues.Add(AV28GridStateFilterValue, 0);
         new k2bsavegridstate(context ).execute(  AV57Pgmname,  AV26GridStateKey,  AV27GridState) ;
      }
      ...
      protected void E135E2( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         CallWebObject(formatLink("exportwwunidades_gis.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV30nombre_unidad)),UrlEncode(DateTimeUtil.FormatDateParm(AV32unidades_gisfecha_creacion_From)),UrlEncode(DateTimeUtil.FormatDateParm(AV33unidades_gisfecha_creacion_To)),UrlEncode(DateTimeUtil.FormatDateParm(AV35unidades_gisfecha_modificacion_From)),UrlEncode(DateTimeUtil.FormatDateParm(AV36unidades_gisfecha_modificacion_To)),UrlEncode(StringUtil.RTrim(AV41K2BToolsGenericSearchField)),UrlEncode(StringUtil.LTrimStr(AV42OrderedBy,4,0))}, new string[] {"nombre_unidad","unidades_gisfecha_creacion_From","unidades_gisfecha_creacion_To","unidades_gisfecha_modificacion_From","unidades_gisfecha_modificacion_To","K2BToolsGenericSearchField","OrderedBy"}) );
      ...
      protected void S202( )
      {
         ...
         AssignAttri("", false, "AV22Att_unidades_gismodificado_por_Visible", AV22Att_unidades_gismodificado_por_Visible);
         new k2bsavegridconfiguration(context ).execute(  AV57Pgmname,  "Grid",  AV10GridConfiguration,  false) ;
         AV60GXV3 = 1;
         while ( AV60GXV3 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV13GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV10GridConfiguration.gxTpr_Gridcolumns.Item(AV60GXV3));
      ...
      protected void S122( )
      {
         ...
         if ( AV37K2BFilterValuesSDT.Count > 0 )
         {
            ...
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV57Pgmname,  "Grid",  AV37K2BFilterValuesSDT, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item4) ;
      ...
      protected void E145E2( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  AV57Pgmname,  "Grid", ref  AV10GridConfiguration) ;
         AV61GXV4 = 1;
         while ( AV61GXV4 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV13GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV10GridConfiguration.gxTpr_Gridcolumns.Item(AV61GXV4));
            if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "id_unidad") == 0 )
            {
         ...
         new k2bsavegridconfiguration(context ).execute(  AV57Pgmname,  "Grid",  AV10GridConfiguration,  true) ;
         AV45UC_OrderedBy = AV42OrderedBy;
         AssignAttri("", false, "AV45UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV45UC_OrderedBy), 4, 0));
         if ( AV24RowsPerPageVariable != AV23GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV24RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV57Pgmname,  "Grid",  AV24RowsPerPageVariable) ;
            AV8CurrentPage = 1;
            AssignAttri("", false, "AV8CurrentPage", StringUtil.LTrimStr( (decimal)(AV8CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249565586", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwunidades_gis.js", "?20231249565587", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/K2BDateRangePickerRender.js", "", false, true);
      ...
      protected void sendrow_1742( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_174_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute_Grid";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtunidades_gishora_modificacion_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A120unidades_gishora_modificacion), 5, 0, ",", "")),context.localUtil.Format( (decimal)(A120unidades_gishora_modificacion), "ZZZZ9"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtunidades_gishora_modificacion_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn InvisibleInExtraSmallColumn",(string)"",(int)edtunidades_gishora_modificacion_Visible,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)5,(short)0,(short)0,(short)174,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOEXPORT'","{handler:'E135E2',iparms:[{av:'AV30nombre_unidad',fld:'vNOMBRE_UNIDAD',pic:''},{av:'AV32unidades_gisfecha_creacion_From',fld:'vUNIDADES_GISFECHA_CREACION_FROM',pic:''},{av:'AV33unidades_gisfecha_creacion_To',fld:'vUNIDADES_GISFECHA_CREACION_TO',pic:''},{av:'AV35unidades_gisfecha_modificacion_From',fld:'vUNIDADES_GISFECHA_MODIFICACION_FROM',pic:''},{av:'AV36unidades_gisfecha_modificacion_To',fld:'vUNIDADES_GISFECHA_MODIFICACION_TO',pic:''},{av:'AV41K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV42OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_id_unidad_Visible',fld:'vATT_ID_UNIDAD_VISIBLE',pic:''},{av:'AV15Att_nombre_unidad_Visible',fld:'vATT_NOMBRE_UNIDAD_VISIBLE',pic:''},{av:'AV16Att_unidades_gisestado_Visible',fld:'vATT_UNIDADES_GISESTADO_VISIBLE',pic:''},{av:'AV17Att_unidades_gisfecha_creacion_Visible',fld:'vATT_UNIDADES_GISFECHA_CREACION_VISIBLE',pic:''},{av:'AV18Att_unidades_gishora_creacion_Visible',fld:'vATT_UNIDADES_GISHORA_CREACION_VISIBLE',pic:''},{av:'AV19Att_unidades_giscreado_por_Visible',fld:'vATT_UNIDADES_GISCREADO_POR_VISIBLE',pic:''},{av:'AV20Att_unidades_gisfecha_modificacion_Visible',fld:'vATT_UNIDADES_GISFECHA_MODIFICACION_VISIBLE',pic:''},{av:'AV21Att_unidades_gishora_modificacion_Visible',fld:'vATT_UNIDADES_GISHORA_MODIFICACION_VISIBLE',pic:''},{av:'AV22Att_unidades_gismodificado_por_Visible',fld:'vATT_UNIDADES_GISMODIFICADO_POR_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOEXPORT'",",oparms:[{av:'AV42OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_id_unidad_Visible',fld:'vATT_ID_UNIDAD_VISIBLE',pic:''},{av:'AV15Att_nombre_unidad_Visible',fld:'vATT_NOMBRE_UNIDAD_VISIBLE',pic:''},{av:'AV16Att_unidades_gisestado_Visible',fld:'vATT_UNIDADES_GISESTADO_VISIBLE',pic:''},{av:'AV17Att_unidades_gisfecha_creacion_Visible',fld:'vATT_UNIDADES_GISFECHA_CREACION_VISIBLE',pic:''},{av:'AV18Att_unidades_gishora_creacion_Visible',fld:'vATT_UNIDADES_GISHORA_CREACION_VISIBLE',pic:''},{av:'AV19Att_unidades_giscreado_por_Visible',fld:'vATT_UNIDADES_GISCREADO_POR_VISIBLE',pic:''},{av:'AV20Att_unidades_gisfecha_modificacion_Visible',fld:'vATT_UNIDADES_GISFECHA_MODIFICACION_VISIBLE',pic:''},{av:'AV21Att_unidades_gishora_modificacion_Visible',fld:'vATT_UNIDADES_GISHORA_MODIFICACION_VISIBLE',pic:''},{av:'AV22Att_unidades_gismodificado_por_Visible',fld:'vATT_UNIDADES_GISMODIFICADO_POR_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         ...
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED","{handler:'E115E2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV41K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV30nombre_unidad',fld:'vNOMBRE_UNIDAD',pic:''},{av:'AV32unidades_gisfecha_creacion_From',fld:'vUNIDADES_GISFECHA_CREACION_FROM',pic:''},{av:'AV35unidades_gisfecha_modificacion_From',fld:'vUNIDADES_GISFECHA_MODIFICACION_FROM',pic:''},{av:'AV29ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV42OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV33unidades_gisfecha_creacion_To',fld:'vUNIDADES_GISFECHA_CREACION_TO',pic:''},{av:'AV36unidades_gisfecha_modificacion_To',fld:'vUNIDADES_GISFECHA_MODIFICACION_TO',pic:''},{av:'AV57Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV48nombre_unidad_IsAuthorized',fld:'vNOMBRE_UNIDAD_ISAUTHORIZED',pic:''},{av:'AV40DeletedTag',fld:'vDELETEDTAG',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_id_unidad_Visible',fld:'vATT_ID_UNIDAD_VISIBLE',pic:''},{av:'AV15Att_nombre_unidad_Visible',fld:'vATT_NOMBRE_UNIDAD_VISIBLE',pic:''},{av:'AV16Att_unidades_gisestado_Visible',fld:'vATT_UNIDADES_GISESTADO_VISIBLE',pic:''},{av:'AV17Att_unidades_gisfecha_creacion_Visible',fld:'vATT_UNIDADES_GISFECHA_CREACION_VISIBLE',pic:''},{av:'AV18Att_unidades_gishora_creacion_Visible',fld:'vATT_UNIDADES_GISHORA_CREACION_VISIBLE',pic:''},{av:'AV19Att_unidades_giscreado_por_Visible',fld:'vATT_UNIDADES_GISCREADO_POR_VISIBLE',pic:''},{av:'AV20Att_unidades_gisfecha_modificacion_Visible',fld:'vATT_UNIDADES_GISFECHA_MODIFICACION_VISIBLE',pic:''},{av:'AV21Att_unidades_gishora_modificacion_Visible',fld:'vATT_UNIDADES_GISHORA_MODIFICACION_VISIBLE',pic:''},{av:'AV22Att_unidades_gismodificado_por_Visible',fld:'vATT_UNIDADES_GISMODIFICADO_POR_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E125E2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV41K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV30nombre_unidad',fld:'vNOMBRE_UNIDAD',pic:''},{av:'AV32unidades_gisfecha_creacion_From',fld:'vUNIDADES_GISFECHA_CREACION_FROM',pic:''},{av:'AV35unidades_gisfecha_modificacion_From',fld:'vUNIDADES_GISFECHA_MODIFICACION_FROM',pic:''},{av:'AV29ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV42OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV33unidades_gisfecha_creacion_To',fld:'vUNIDADES_GISFECHA_CREACION_TO',pic:''},{av:'AV36unidades_gisfecha_modificacion_To',fld:'vUNIDADES_GISFECHA_MODIFICACION_TO',pic:''},{av:'AV57Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV48nombre_unidad_IsAuthorized',fld:'vNOMBRE_UNIDAD_ISAUTHORIZED',pic:''},{av:'AV45UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_id_unidad_Visible',fld:'vATT_ID_UNIDAD_VISIBLE',pic:''},{av:'AV15Att_nombre_unidad_Visible',fld:'vATT_NOMBRE_UNIDAD_VISIBLE',pic:''},{av:'AV16Att_unidades_gisestado_Visible',fld:'vATT_UNIDADES_GISESTADO_VISIBLE',pic:''},{av:'AV17Att_unidades_gisfecha_creacion_Visible',fld:'vATT_UNIDADES_GISFECHA_CREACION_VISIBLE',pic:''},{av:'AV18Att_unidades_gishora_creacion_Visible',fld:'vATT_UNIDADES_GISHORA_CREACION_VISIBLE',pic:''},{av:'AV19Att_unidades_giscreado_por_Visible',fld:'vATT_UNIDADES_GISCREADO_POR_VISIBLE',pic:''},{av:'AV20Att_unidades_gisfecha_modificacion_Visible',fld:'vATT_UNIDADES_GISFECHA_MODIFICACION_VISIBLE',pic:''},{av:'AV21Att_unidades_gishora_modificacion_Visible',fld:'vATT_UNIDADES_GISHORA_MODIFICACION_VISIBLE',pic:''},{av:'AV22Att_unidades_gismodificado_por_Visible',fld:'vATT_UNIDADES_GISMODIFICADO_POR_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E145E2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV41K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV30nombre_unidad',fld:'vNOMBRE_UNIDAD',pic:''},{av:'AV32unidades_gisfecha_creacion_From',fld:'vUNIDADES_GISFECHA_CREACION_FROM',pic:''},{av:'AV35unidades_gisfecha_modificacion_From',fld:'vUNIDADES_GISFECHA_MODIFICACION_FROM',pic:''},{av:'AV29ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV42OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV33unidades_gisfecha_creacion_To',fld:'vUNIDADES_GISFECHA_CREACION_TO',pic:''},{av:'AV36unidades_gisfecha_modificacion_To',fld:'vUNIDADES_GISFECHA_MODIFICACION_TO',pic:''},{av:'AV57Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV48nombre_unidad_IsAuthorized',fld:'vNOMBRE_UNIDAD_ISAUTHORIZED',pic:''},{av:'AV24RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV23GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_id_unidad_Visible',fld:'vATT_ID_UNIDAD_VISIBLE',pic:''},{av:'AV15Att_nombre_unidad_Visible',fld:'vATT_NOMBRE_UNIDAD_VISIBLE',pic:''},{av:'AV16Att_unidades_gisestado_Visible',fld:'vATT_UNIDADES_GISESTADO_VISIBLE',pic:''},{av:'AV17Att_unidades_gisfecha_creacion_Visible',fld:'vATT_UNIDADES_GISFECHA_CREACION_VISIBLE',pic:''},{av:'AV18Att_unidades_gishora_creacion_Visible',fld:'vATT_UNIDADES_GISHORA_CREACION_VISIBLE',pic:''},{av:'AV19Att_unidades_giscreado_por_Visible',fld:'vATT_UNIDADES_GISCREADO_POR_VISIBLE',pic:''},{av:'AV20Att_unidades_gisfecha_modificacion_Visible',fld:'vATT_UNIDADES_GISFECHA_MODIFICACION_VISIBLE',pic:''},{av:'AV21Att_unidades_gishora_modificacion_Visible',fld:'vATT_UNIDADES_GISHORA_MODIFICACION_VISIBLE',pic:''},{av:'AV22Att_unidades_gismodificado_por_Visible',fld:'vATT_UNIDADES_GISMODIFICADO_POR_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E155E2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV41K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV30nombre_unidad',fld:'vNOMBRE_UNIDAD',pic:''},{av:'AV32unidades_gisfecha_creacion_From',fld:'vUNIDADES_GISFECHA_CREACION_FROM',pic:''},{av:'AV35unidades_gisfecha_modificacion_From',fld:'vUNIDADES_GISFECHA_MODIFICACION_FROM',pic:''},{av:'AV29ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV42OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV33unidades_gisfecha_creacion_To',fld:'vUNIDADES_GISFECHA_CREACION_TO',pic:''},{av:'AV36unidades_gisfecha_modificacion_To',fld:'vUNIDADES_GISFECHA_MODIFICACION_TO',pic:''},{av:'AV57Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV48nombre_unidad_IsAuthorized',fld:'vNOMBRE_UNIDAD_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_id_unidad_Visible',fld:'vATT_ID_UNIDAD_VISIBLE',pic:''},{av:'AV15Att_nombre_unidad_Visible',fld:'vATT_NOMBRE_UNIDAD_VISIBLE',pic:''},{av:'AV16Att_unidades_gisestado_Visible',fld:'vATT_UNIDADES_GISESTADO_VISIBLE',pic:''},{av:'AV17Att_unidades_gisfecha_creacion_Visible',fld:'vATT_UNIDADES_GISFECHA_CREACION_VISIBLE',pic:''},{av:'AV18Att_unidades_gishora_creacion_Visible',fld:'vATT_UNIDADES_GISHORA_CREACION_VISIBLE',pic:''},{av:'AV19Att_unidades_giscreado_por_Visible',fld:'vATT_UNIDADES_GISCREADO_POR_VISIBLE',pic:''},{av:'AV20Att_unidades_gisfecha_modificacion_Visible',fld:'vATT_UNIDADES_GISFECHA_MODIFICACION_VISIBLE',pic:''},{av:'AV21Att_unidades_gishora_modificacion_Visible',fld:'vATT_UNIDADES_GISHORA_MODIFICACION_VISIBLE',pic:''},{av:'AV22Att_unidades_gismodificado_por_Visible',fld:'vATT_UNIDADES_GISMODIFICADO_POR_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E165E2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV41K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV30nombre_unidad',fld:'vNOMBRE_UNIDAD',pic:''},{av:'AV32unidades_gisfecha_creacion_From',fld:'vUNIDADES_GISFECHA_CREACION_FROM',pic:''},{av:'AV35unidades_gisfecha_modificacion_From',fld:'vUNIDADES_GISFECHA_MODIFICACION_FROM',pic:''},{av:'AV29ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV42OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV33unidades_gisfecha_creacion_To',fld:'vUNIDADES_GISFECHA_CREACION_TO',pic:''},{av:'AV36unidades_gisfecha_modificacion_To',fld:'vUNIDADES_GISFECHA_MODIFICACION_TO',pic:''},{av:'AV57Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV48nombre_unidad_IsAuthorized',fld:'vNOMBRE_UNIDAD_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_id_unidad_Visible',fld:'vATT_ID_UNIDAD_VISIBLE',pic:''},{av:'AV15Att_nombre_unidad_Visible',fld:'vATT_NOMBRE_UNIDAD_VISIBLE',pic:''},{av:'AV16Att_unidades_gisestado_Visible',fld:'vATT_UNIDADES_GISESTADO_VISIBLE',pic:''},{av:'AV17Att_unidades_gisfecha_creacion_Visible',fld:'vATT_UNIDADES_GISFECHA_CREACION_VISIBLE',pic:''},{av:'AV18Att_unidades_gishora_creacion_Visible',fld:'vATT_UNIDADES_GISHORA_CREACION_VISIBLE',pic:''},{av:'AV19Att_unidades_giscreado_por_Visible',fld:'vATT_UNIDADES_GISCREADO_POR_VISIBLE',pic:''},{av:'AV20Att_unidades_gisfecha_modificacion_Visible',fld:'vATT_UNIDADES_GISFECHA_MODIFICACION_VISIBLE',pic:''},{av:'AV21Att_unidades_gishora_modificacion_Visible',fld:'vATT_UNIDADES_GISHORA_MODIFICACION_VISIBLE',pic:''},{av:'AV22Att_unidades_gismodificado_por_Visible',fld:'vATT_UNIDADES_GISMODIFICADO_POR_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E175E2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV41K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV30nombre_unidad',fld:'vNOMBRE_UNIDAD',pic:''},{av:'AV32unidades_gisfecha_creacion_From',fld:'vUNIDADES_GISFECHA_CREACION_FROM',pic:''},{av:'AV35unidades_gisfecha_modificacion_From',fld:'vUNIDADES_GISFECHA_MODIFICACION_FROM',pic:''},{av:'AV29ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV42OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV33unidades_gisfecha_creacion_To',fld:'vUNIDADES_GISFECHA_CREACION_TO',pic:''},{av:'AV36unidades_gisfecha_modificacion_To',fld:'vUNIDADES_GISFECHA_MODIFICACION_TO',pic:''},{av:'AV57Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV48nombre_unidad_IsAuthorized',fld:'vNOMBRE_UNIDAD_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_id_unidad_Visible',fld:'vATT_ID_UNIDAD_VISIBLE',pic:''},{av:'AV15Att_nombre_unidad_Visible',fld:'vATT_NOMBRE_UNIDAD_VISIBLE',pic:''},{av:'AV16Att_unidades_gisestado_Visible',fld:'vATT_UNIDADES_GISESTADO_VISIBLE',pic:''},{av:'AV17Att_unidades_gisfecha_creacion_Visible',fld:'vATT_UNIDADES_GISFECHA_CREACION_VISIBLE',pic:''},{av:'AV18Att_unidades_gishora_creacion_Visible',fld:'vATT_UNIDADES_GISHORA_CREACION_VISIBLE',pic:''},{av:'AV19Att_unidades_giscreado_por_Visible',fld:'vATT_UNIDADES_GISCREADO_POR_VISIBLE',pic:''},{av:'AV20Att_unidades_gisfecha_modificacion_Visible',fld:'vATT_UNIDADES_GISFECHA_MODIFICACION_VISIBLE',pic:''},{av:'AV21Att_unidades_gishora_modificacion_Visible',fld:'vATT_UNIDADES_GISHORA_MODIFICACION_VISIBLE',pic:''},{av:'AV22Att_unidades_gismodificado_por_Visible',fld:'vATT_UNIDADES_GISMODIFICADO_POR_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E185E2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV41K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV30nombre_unidad',fld:'vNOMBRE_UNIDAD',pic:''},{av:'AV32unidades_gisfecha_creacion_From',fld:'vUNIDADES_GISFECHA_CREACION_FROM',pic:''},{av:'AV35unidades_gisfecha_modificacion_From',fld:'vUNIDADES_GISFECHA_MODIFICACION_FROM',pic:''},{av:'AV29ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV42OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV33unidades_gisfecha_creacion_To',fld:'vUNIDADES_GISFECHA_CREACION_TO',pic:''},{av:'AV36unidades_gisfecha_modificacion_To',fld:'vUNIDADES_GISFECHA_MODIFICACION_TO',pic:''},{av:'AV57Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV48nombre_unidad_IsAuthorized',fld:'vNOMBRE_UNIDAD_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_id_unidad_Visible',fld:'vATT_ID_UNIDAD_VISIBLE',pic:''},{av:'AV15Att_nombre_unidad_Visible',fld:'vATT_NOMBRE_UNIDAD_VISIBLE',pic:''},{av:'AV16Att_unidades_gisestado_Visible',fld:'vATT_UNIDADES_GISESTADO_VISIBLE',pic:''},{av:'AV17Att_unidades_gisfecha_creacion_Visible',fld:'vATT_UNIDADES_GISFECHA_CREACION_VISIBLE',pic:''},{av:'AV18Att_unidades_gishora_creacion_Visible',fld:'vATT_UNIDADES_GISHORA_CREACION_VISIBLE',pic:''},{av:'AV19Att_unidades_giscreado_por_Visible',fld:'vATT_UNIDADES_GISCREADO_POR_VISIBLE',pic:''},{av:'AV20Att_unidades_gisfecha_modificacion_Visible',fld:'vATT_UNIDADES_GISFECHA_MODIFICACION_VISIBLE',pic:''},{av:'AV21Att_unidades_gishora_modificacion_Visible',fld:'vATT_UNIDADES_GISHORA_MODIFICACION_VISIBLE',pic:''},{av:'AV22Att_unidades_gismodificado_por_Visible',fld:'vATT_UNIDADES_GISMODIFICADO_POR_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV44GridOrder = new SdtK2BGridOrders_K2BGridOrdersItem(context);
         AV46Messages = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
      ...
      private GXBaseCollection<SdtMessages_Message> AV46Messages ;
