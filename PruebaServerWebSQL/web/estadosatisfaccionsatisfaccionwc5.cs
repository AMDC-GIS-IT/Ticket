...
namespace GeneXus.Programs {
   public class estadosatisfaccionsatisfaccionwc5 : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public estadosatisfaccionsatisfaccionwc5( )
      {
      ...
      public estadosatisfaccionsatisfaccionwc5( IGxContext context )
      {
      ...
      {
         this.AV6SatisfaccionAtencionId = aP0_SatisfaccionAtencionId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6SatisfaccionAtencionId = (short)(NumberUtil.Val( GetPar( "SatisfaccionAtencionId"), "."));
                  AssignAttri(sPrefix, false, "AV6SatisfaccionAtencionId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionAtencionId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV6SatisfaccionAtencionId});
                  componentstart();
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  AV23Att_SatisfaccionTecnicoProblemaNombre_Visible = StringUtil.StrToBool( GetPar( "Att_SatisfaccionTecnicoProblemaNombre_Visible"));
                  AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible = StringUtil.StrToBool( GetPar( "Att_SatisfaccionTecnicoCompetenteNombre_Visible"));
                  AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible = StringUtil.StrToBool( GetPar( "Att_SatisfaccionTecnicoProfesionalismoNombre_Visible"));
                  AV26Att_SatisfaccionTiempoNombre_Visible = StringUtil.StrToBool( GetPar( "Att_SatisfaccionTiempoNombre_Visible"));
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV50K2BToolsGenericSearchField, AV36SatisfaccionFecha_From, AV39UsuarioFecha_From, AV41SatisfaccionResueltoNombre, AV42SatisfaccionTecnicoProblemaNombre, AV43SatisfaccionTecnicoCompetenteNombre, AV44SatisfaccionTecnicoProfesionalismoNombre, AV45SatisfaccionTiempoNombre, AV6SatisfaccionAtencionId, AV34ClassCollection, AV51OrderedBy, AV37SatisfaccionFecha_To, AV40UsuarioFecha_To, AV67Pgmname, AV9CurrentPage, AV11GridConfiguration, AV60AutoLinksActivityList, AV62SatisfaccionFecha_IsAuthorized, AV15Att_SatisfaccionId_Visible, AV16Att_SatisfaccionFecha_Visible, AV17Att_TicketId_Visible, AV18Att_UsuarioId_Visible, AV19Att_UsuarioNombre_Visible, AV20Att_UsuarioFecha_Visible, AV21Att_UsuarioRequerimiento_Visible, AV22Att_SatisfaccionResueltoNombre_Visible, AV23Att_SatisfaccionTecnicoProblemaNombre_Visible, AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible, AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible, AV26Att_SatisfaccionTiempoNombre_Visible, AV27Att_SatisfaccionSugerencia_Visible, AV12FreezeColumnTitles, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV67Pgmname = "EstadoSatisfaccionSatisfaccionWC5";
               context.Gx_err = 0;
               WS2C2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249514983", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("estadosatisfaccionsatisfaccionwc5.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6SatisfaccionAtencionId,4,0))}, new string[] {"SatisfaccionAtencionId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"GXH_vSATISFACCIONTECNICOPROBLEMANOMBRE", AV42SatisfaccionTecnicoProblemaNombre);
         GxWebStd.gx_hidden_field( context, sPrefix+"GXH_vSATISFACCIONTECNICOCOMPETENTENOMBRE", AV43SatisfaccionTecnicoCompetenteNombre);
         GxWebStd.gx_hidden_field( context, sPrefix+"GXH_vSATISFACCIONTECNICOPROFESIONALISMONOMBRE", AV44SatisfaccionTecnicoProfesionalismoNombre);
         GxWebStd.gx_hidden_field( context, sPrefix+"GXH_vSATISFACCIONTIEMPONOMBRE", AV45SatisfaccionTiempoNombre);
         /* Send saved values. */
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6SatisfaccionAtencionId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6SatisfaccionAtencionId), 4, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vSATISFACCIONATENCIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6SatisfaccionAtencionId), 4, 0, ",", "")));
      ...
      {
         return "EstadoSatisfaccionSatisfaccionWC5" ;
      }
      ...
      protected void WB2C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "estadosatisfaccionsatisfaccionwc5.aspx");
               context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
               context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
               context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
               context.AddJavascriptSource("K2BDateRangePicker/K2BDateRangePickerRender.js", "", false, true);
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocksatisfaccionfecha_Internalname, "Fecha Encuesta:", "", "", lblTextblocksatisfaccionfecha_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label K2BT_LabelTop", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            /* User Defined Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockusuariofecha_Internalname, "Fecha", "", "", lblTextblockusuariofecha_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label K2BT_LabelTop", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            /* User Defined Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavSatisfacciontecnicoproblemanombre_Internalname, "Satisfaccion Tecnico Problema Nombre", "gx-form-item Attribute_FilterLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 57,'" + sPrefix + "',false,'" + sGXsfl_223_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSatisfacciontecnicoproblemanombre_Internalname, AV42SatisfaccionTecnicoProblemaNombre, StringUtil.RTrim( context.localUtil.Format( AV42SatisfaccionTecnicoProblemaNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,57);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSatisfacciontecnicoproblemanombre_Jsonclick, 0, "Attribute_Filter", "", "", "", "", 1, edtavSatisfacciontecnicoproblemanombre_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavSatisfacciontecnicocompetentenombre_Internalname, "Satisfaccion Tecnico Competente Nombre", "gx-form-item Attribute_FilterLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 63,'" + sPrefix + "',false,'" + sGXsfl_223_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSatisfacciontecnicocompetentenombre_Internalname, AV43SatisfaccionTecnicoCompetenteNombre, StringUtil.RTrim( context.localUtil.Format( AV43SatisfaccionTecnicoCompetenteNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,63);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSatisfacciontecnicocompetentenombre_Jsonclick, 0, "Attribute_Filter", "", "", "", "", 1, edtavSatisfacciontecnicocompetentenombre_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavSatisfacciontecnicoprofesionalismonombre_Internalname, "Satisfaccion Tecnico Profesionalismo Nombre", "gx-form-item Attribute_FilterLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 69,'" + sPrefix + "',false,'" + sGXsfl_223_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSatisfacciontecnicoprofesionalismonombre_Internalname, AV44SatisfaccionTecnicoProfesionalismoNombre, StringUtil.RTrim( context.localUtil.Format( AV44SatisfaccionTecnicoProfesionalismoNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,69);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSatisfacciontecnicoprofesionalismonombre_Jsonclick, 0, "Attribute_Filter", "", "", "", "", 1, edtavSatisfacciontecnicoprofesionalismonombre_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavSatisfacciontiemponombre_Internalname, "Satisfaccion Tiempo Nombre", "gx-form-item Attribute_FilterLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 75,'" + sPrefix + "',false,'" + sGXsfl_223_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSatisfacciontiemponombre_Internalname, AV45SatisfaccionTiempoNombre, StringUtil.RTrim( context.localUtil.Format( AV45SatisfaccionTiempoNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,75);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSatisfacciontiemponombre_Jsonclick, 0, "Attribute_Filter", "", "", "", "", 1, edtavSatisfacciontiemponombre_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;", "div");
            wb_table1_77_2C2( true) ;
         }
         else
         {
            wb_table1_77_2C2( false) ;
         }
         return  ;
      }

      protected void wb_table1_77_2C2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.SendWebValue( "Satisfaccion Resuelto Id") ;
               context.WriteHtmlTextNl( "</th>") ;
               ...
               context.SendWebValue( "Satisfaccion Resuelto Nombre") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute_Grid"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
               context.SendWebValue( "Satisfaccion Tecnico Problema Id") ;
               context.WriteHtmlTextNl( "</th>") ;
               ...
               context.SendWebValue( "Satisfaccion Tecnico Problema Nombre") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute_Grid"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
               context.SendWebValue( "Satisfaccion Tecnico Competente Id") ;
               context.WriteHtmlTextNl( "</th>") ;
               ...
               context.SendWebValue( "Satisfaccion Tecnico Competente Nombre") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute_Grid"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
               context.SendWebValue( "Satisfaccion Tecnico Profesionalismo Id") ;
               context.WriteHtmlTextNl( "</th>") ;
               ...
               context.SendWebValue( "Satisfaccion Tecnico Profesionalismo Nombre") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute_Grid"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
               context.SendWebValue( "Satisfaccion Tiempo Id") ;
               context.WriteHtmlTextNl( "</th>") ;
               ...
               context.SendWebValue( "Satisfaccion Tiempo Nombre") ;
               context.WriteHtmlTextNl( "</th>") ;
         ...
         if ( wbEnd == 223 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_246_2C2( true) ;
         }
         else
         {
            wb_table2_246_2C2( false) ;
         }
         return  ;
      }

      protected void wb_table2_246_2C2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagebuttontextblock_Internalname, "", "", "", lblPreviouspagebuttontextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOPREVIOUS\\'."+"'", "", lblPreviouspagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFirstpagetextblock_Internalname, lblFirstpagetextblock_Caption, "", "", lblFirstpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOFIRST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblFirstpagetextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacinglefttextblock_Internalname, "...", "", "", lblSpacinglefttextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacinglefttextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagetextblock_Internalname, lblPreviouspagetextblock_Caption, "", "", lblPreviouspagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOPREVIOUS\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPreviouspagetextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCurrentpagetextblock_Internalname, lblCurrentpagetextblock_Caption, "", "", lblCurrentpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagetextblock_Internalname, lblNextpagetextblock_Caption, "", "", lblNextpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DONEXT\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblNextpagetextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacingrighttextblock_Internalname, "...", "", "", lblSpacingrighttextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacingrighttextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLastpagetextblock_Internalname, lblLastpagetextblock_Caption, "", "", lblLastpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOLAST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblLastpagetextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagebuttontextblock_Internalname, "", "", "", lblNextpagebuttontextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DONEXT\\'."+"'", "", lblNextpagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV63Update)) ? AV69Update_GXI : context.convertURL( context.PathToRelativeUrl( AV63Update))), !bGXsfl_223_Refreshing);
                              ...
                              AssignProp(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV64Delete)) ? AV70Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV64Delete))), !bGXsfl_223_Refreshing);
                                    ...
                                    if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                                    {
                                       ...
                                       if ( ! wbErr )
                                       {
                                          if ( ! wbErr )
                                          {
                                             ...
                                             if ( StringUtil.StrCmp(cgiGet( sPrefix+"GXH_vSATISFACCIONTECNICOPROBLEMANOMBRE"), AV42SatisfaccionTecnicoProblemaNombre) != 0 )
                                             {
                                                Rfr0gs = true;
                                             }
                                             /* Set Refresh If Satisfacciontecnicocompetentenombre Changed */
                                             if ( StringUtil.StrCmp(cgiGet( sPrefix+"GXH_vSATISFACCIONTECNICOCOMPETENTENOMBRE"), AV43SatisfaccionTecnicoCompetenteNombre) != 0 )
                                             {
                                                Rfr0gs = true;
                                             }
                                             /* Set Refresh If Satisfacciontecnicoprofesionalismonombre Changed */
                                             if ( StringUtil.StrCmp(cgiGet( sPrefix+"GXH_vSATISFACCIONTECNICOPROFESIONALISMONOMBRE"), AV44SatisfaccionTecnicoProfesionalismoNombre) != 0 )
                                             {
                                                Rfr0gs = true;
                                             }
                                             /* Set Refresh If Satisfacciontiemponombre Changed */
                                             if ( StringUtil.StrCmp(cgiGet( sPrefix+"GXH_vSATISFACCIONTIEMPONOMBRE"), AV45SatisfaccionTiempoNombre) != 0 )
                                             {
                                                Rfr0gs = true;
                                             }
                                             if ( ! Rfr0gs )
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       short AV6SatisfaccionAtencionId ,
                                       ...
                                       bool AV23Att_SatisfaccionTecnicoProblemaNombre_Visible ,
                                       bool AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible ,
                                       bool AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible ,
                                       bool AV26Att_SatisfaccionTiempoNombre_Visible ,
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         AV23Att_SatisfaccionTecnicoProblemaNombre_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV23Att_SatisfaccionTecnicoProblemaNombre_Visible));
         AssignAttri(sPrefix, false, "AV23Att_SatisfaccionTecnicoProblemaNombre_Visible", AV23Att_SatisfaccionTecnicoProblemaNombre_Visible);
         AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible));
         AssignAttri(sPrefix, false, "AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible", AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible);
         AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible));
         AssignAttri(sPrefix, false, "AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible", AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible);
         AV26Att_SatisfaccionTiempoNombre_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV26Att_SatisfaccionTiempoNombre_Visible));
         AssignAttri(sPrefix, false, "AV26Att_SatisfaccionTiempoNombre_Visible", AV26Att_SatisfaccionTiempoNombre_Visible);
      ...
      protected void RF2C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV50K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV50K2BToolsGenericSearchField), 100, "%");
            /* Using cursor H002C2 */
            pr_default.execute(0, new Object[] {AV6SatisfaccionAtencionId, AV37SatisfaccionFecha_To, AV36SatisfaccionFecha_From, AV40UsuarioFecha_To, AV39UsuarioFecha_From, lV41SatisfaccionResueltoNombre, lV42SatisfaccionTecnicoProblemaNombre, lV43SatisfaccionTecnicoCompetenteNombre, lV44SatisfaccionTecnicoProfesionalismoNombre, lV45SatisfaccionTiempoNombre, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_223_idx = 1;
            sGXsfl_223_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_223_idx), 4, 0), 4, "0");
            SubsflControlProps_2232( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A13SatisfaccionAtencionId = H002C2_A13SatisfaccionAtencionId[0];
               A34SatisfaccionSugerencia = H002C2_A34SatisfaccionSugerencia[0];
               A38SatisfaccionTiempoNombre = H002C2_A38SatisfaccionTiempoNombre[0];
               A12SatisfaccionTiempoId = H002C2_A12SatisfaccionTiempoId[0];
               A37SatisfaccionTecnicoProfesionalismoNombre = H002C2_A37SatisfaccionTecnicoProfesionalismoNombre[0];
               A11SatisfaccionTecnicoProfesionalismoId = H002C2_A11SatisfaccionTecnicoProfesionalismoId[0];
               A35SatisfaccionTecnicoCompetenteNombre = H002C2_A35SatisfaccionTecnicoCompetenteNombre[0];
               A10SatisfaccionTecnicoCompetenteId = H002C2_A10SatisfaccionTecnicoCompetenteId[0];
               A36SatisfaccionTecnicoProblemaNombre = H002C2_A36SatisfaccionTecnicoProblemaNombre[0];
               A9SatisfaccionTecnicoProblemaId = H002C2_A9SatisfaccionTecnicoProblemaId[0];
               A33SatisfaccionResueltoNombre = H002C2_A33SatisfaccionResueltoNombre[0];
               A8SatisfaccionResueltoId = H002C2_A8SatisfaccionResueltoId[0];
               A94UsuarioRequerimiento = H002C2_A94UsuarioRequerimiento[0];
               A90UsuarioFecha = H002C2_A90UsuarioFecha[0];
               A93UsuarioNombre = H002C2_A93UsuarioNombre[0];
               A15UsuarioId = H002C2_A15UsuarioId[0];
               A14TicketId = H002C2_A14TicketId[0];
               A32SatisfaccionFecha = H002C2_A32SatisfaccionFecha[0];
               A7SatisfaccionId = H002C2_A7SatisfaccionId[0];
               A38SatisfaccionTiempoNombre = H002C2_A38SatisfaccionTiempoNombre[0];
               A37SatisfaccionTecnicoProfesionalismoNombre = H002C2_A37SatisfaccionTecnicoProfesionalismoNombre[0];
               A35SatisfaccionTecnicoCompetenteNombre = H002C2_A35SatisfaccionTecnicoCompetenteNombre[0];
               A36SatisfaccionTecnicoProblemaNombre = H002C2_A36SatisfaccionTecnicoProblemaNombre[0];
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV50K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV50K2BToolsGenericSearchField), 100, "%");
         /* Using cursor H002C3 */
         pr_default.execute(1, new Object[] {AV6SatisfaccionAtencionId, AV37SatisfaccionFecha_To, AV36SatisfaccionFecha_From, AV40UsuarioFecha_To, AV39UsuarioFecha_From, lV41SatisfaccionResueltoNombre, lV42SatisfaccionTecnicoProblemaNombre, lV43SatisfaccionTecnicoCompetenteNombre, lV44SatisfaccionTecnicoProfesionalismoNombre, lV45SatisfaccionTiempoNombre, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField});
      ...
      protected void STRUP2C0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6SatisfaccionAtencionId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6SatisfaccionAtencionId"), ",", "."));
            AV51OrderedBy = (short)(context.localUtil.CToN( cgiGet( sPrefix+"vORDEREDBY"), ",", "."));
            AV6SatisfaccionAtencionId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"vSATISFACCIONATENCIONID"), ",", "."));
            ...
            AssignAttri(sPrefix, false, "AV42SatisfaccionTecnicoProblemaNombre", AV42SatisfaccionTecnicoProblemaNombre);
            AV43SatisfaccionTecnicoCompetenteNombre = cgiGet( edtavSatisfacciontecnicocompetentenombre_Internalname);
            AssignAttri(sPrefix, false, "AV43SatisfaccionTecnicoCompetenteNombre", AV43SatisfaccionTecnicoCompetenteNombre);
            AV44SatisfaccionTecnicoProfesionalismoNombre = cgiGet( edtavSatisfacciontecnicoprofesionalismonombre_Internalname);
            AssignAttri(sPrefix, false, "AV44SatisfaccionTecnicoProfesionalismoNombre", AV44SatisfaccionTecnicoProfesionalismoNombre);
            AV45SatisfaccionTiempoNombre = cgiGet( edtavSatisfacciontiemponombre_Internalname);
            AssignAttri(sPrefix, false, "AV45SatisfaccionTiempoNombre", AV45SatisfaccionTiempoNombre);
            ...
            AssignAttri(sPrefix, false, "AV22Att_SatisfaccionResueltoNombre_Visible", AV22Att_SatisfaccionResueltoNombre_Visible);
            AV23Att_SatisfaccionTecnicoProblemaNombre_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_satisfacciontecnicoproblemanombre_visible_Internalname));
            AssignAttri(sPrefix, false, "AV23Att_SatisfaccionTecnicoProblemaNombre_Visible", AV23Att_SatisfaccionTecnicoProblemaNombre_Visible);
            AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_satisfacciontecnicocompetentenombre_visible_Internalname));
            AssignAttri(sPrefix, false, "AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible", AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible);
            AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_satisfacciontecnicoprofesionalismonombre_visible_Internalname));
            AssignAttri(sPrefix, false, "AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible", AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible);
            AV26Att_SatisfaccionTiempoNombre_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_satisfacciontiemponombre_visible_Internalname));
            AssignAttri(sPrefix, false, "AV26Att_SatisfaccionTiempoNombre_Visible", AV26Att_SatisfaccionTiempoNombre_Visible);
            ...
            if ( context.localUtil.CToD( cgiGet( sPrefix+"GXH_vSATISFACCIONFECHA_FROM"), 2) != AV36SatisfaccionFecha_From )
            {
               GRID_nFirstRecordOnPage = 0;
            }
            if ( context.localUtil.CToD( cgiGet( sPrefix+"GXH_vUSUARIOFECHA_FROM"), 2) != AV39UsuarioFecha_From )
            {
               GRID_nFirstRecordOnPage = 0;
            }
            if ( StringUtil.StrCmp(cgiGet( sPrefix+"GXH_vSATISFACCIONRESUELTONOMBRE"), AV41SatisfaccionResueltoNombre) != 0 )
      ...
      protected void E222C2( )
      {
         ...
         new k2bloadrowsperpage(context ).execute(  AV67Pgmname,  "Grid", out  AV29RowsPerPageVariable, out  AV30RowsPerPageLoaded) ;
      ...
      protected void E232C2( )
      {
         ...
         AV68GXV1 = 1;
         while ( AV68GXV1 <= AV55Messages.Count )
         {
            AV56Message = ((GeneXus.Utils.SdtMessages_Message)AV55Messages.Item(AV68GXV1));
         ...
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV67Pgmname;
         ...
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV63Update)) ? AV69Update_GXI : context.convertURL( context.PathToRelativeUrl( AV63Update))), !bGXsfl_223_Refreshing);
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV63Update), true);
         AV69Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "788f9b72-f982-49f9-99e4-c0374e31a85a", "", context.GetTheme( )));
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV63Update)) ? AV69Update_GXI : context.convertURL( context.PathToRelativeUrl( AV63Update))), !bGXsfl_223_Refreshing);
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV63Update), true);
         ...
         AssignProp(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV64Delete)) ? AV70Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV64Delete))), !bGXsfl_223_Refreshing);
         AssignProp(sPrefix, false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV64Delete), true);
         AV70Delete_GXI = GXDbFile.PathToUrl( context.GetImagePath( "3e4a9f50-2c57-41b6-9da5-ebe49bca33c0", "", context.GetTheme( )));
         AssignProp(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV64Delete)) ? AV70Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV64Delete))), !bGXsfl_223_Refreshing);
         AssignProp(sPrefix, false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV64Delete), true);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV31GridStateKey = StringUtil.Str( (decimal)(AV6SatisfaccionAtencionId), 4, 0);
         new k2bloadgridstate(context ).execute(  AV67Pgmname,  AV31GridStateKey, out  AV32GridState) ;
         ...
         {
            AV33GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV32GridState.gxTpr_Filtervalues.Item(AV71GXV2));
            ...
            else if ( StringUtil.StrCmp(AV33GridStateFilterValue.gxTpr_Filtername, "SatisfaccionTecnicoProblemaNombre") == 0 )
            {
               AV42SatisfaccionTecnicoProblemaNombre = AV33GridStateFilterValue.gxTpr_Value;
               AssignAttri(sPrefix, false, "AV42SatisfaccionTecnicoProblemaNombre", AV42SatisfaccionTecnicoProblemaNombre);
            }
            else if ( StringUtil.StrCmp(AV33GridStateFilterValue.gxTpr_Filtername, "SatisfaccionTecnicoCompetenteNombre") == 0 )
            {
               AV43SatisfaccionTecnicoCompetenteNombre = AV33GridStateFilterValue.gxTpr_Value;
               AssignAttri(sPrefix, false, "AV43SatisfaccionTecnicoCompetenteNombre", AV43SatisfaccionTecnicoCompetenteNombre);
            }
            else if ( StringUtil.StrCmp(AV33GridStateFilterValue.gxTpr_Filtername, "SatisfaccionTecnicoProfesionalismoNombre") == 0 )
            {
               AV44SatisfaccionTecnicoProfesionalismoNombre = AV33GridStateFilterValue.gxTpr_Value;
               AssignAttri(sPrefix, false, "AV44SatisfaccionTecnicoProfesionalismoNombre", AV44SatisfaccionTecnicoProfesionalismoNombre);
            }
            else if ( StringUtil.StrCmp(AV33GridStateFilterValue.gxTpr_Filtername, "SatisfaccionTiempoNombre") == 0 )
            {
               AV45SatisfaccionTiempoNombre = AV33GridStateFilterValue.gxTpr_Value;
               AssignAttri(sPrefix, false, "AV45SatisfaccionTiempoNombre", AV45SatisfaccionTiempoNombre);
            }
      ...
      protected void S132( )
      {
         ...
         AV32GridState.gxTpr_Filtervalues.Add(AV33GridStateFilterValue, 0);
         AV33GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         AV33GridStateFilterValue.gxTpr_Filtername = "SatisfaccionTecnicoProblemaNombre";
         AV33GridStateFilterValue.gxTpr_Value = AV42SatisfaccionTecnicoProblemaNombre;
         AV32GridState.gxTpr_Filtervalues.Add(AV33GridStateFilterValue, 0);
         AV33GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         AV33GridStateFilterValue.gxTpr_Filtername = "SatisfaccionTecnicoCompetenteNombre";
         AV33GridStateFilterValue.gxTpr_Value = AV43SatisfaccionTecnicoCompetenteNombre;
         AV32GridState.gxTpr_Filtervalues.Add(AV33GridStateFilterValue, 0);
         AV33GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         AV33GridStateFilterValue.gxTpr_Filtername = "SatisfaccionTecnicoProfesionalismoNombre";
         AV33GridStateFilterValue.gxTpr_Value = AV44SatisfaccionTecnicoProfesionalismoNombre;
         AV32GridState.gxTpr_Filtervalues.Add(AV33GridStateFilterValue, 0);
         AV33GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         AV33GridStateFilterValue.gxTpr_Filtername = "SatisfaccionTiempoNombre";
         AV33GridStateFilterValue.gxTpr_Value = AV45SatisfaccionTiempoNombre;
         AV32GridState.gxTpr_Filtervalues.Add(AV33GridStateFilterValue, 0);
         AV33GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         ...
         AV32GridState.gxTpr_Filtervalues.Add(AV33GridStateFilterValue, 0);
         new k2bsavegridstate(context ).execute(  AV67Pgmname,  AV31GridStateKey,  AV32GridState) ;
      }
      ...
      protected void S192( )
      {
         ...
         AV58TrnContextAtt.gxTpr_Attributename = "SatisfaccionAtencionId";
         AV58TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6SatisfaccionAtencionId), 4, 0);
      ...
      protected void E142C2( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         CallWebObject(formatLink("exportestadosatisfaccionsatisfaccionwc5.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6SatisfaccionAtencionId,4,0)),UrlEncode(DateTimeUtil.FormatDateParm(AV36SatisfaccionFecha_From)),UrlEncode(DateTimeUtil.FormatDateParm(AV37SatisfaccionFecha_To)),UrlEncode(DateTimeUtil.FormatDateParm(AV39UsuarioFecha_From)),UrlEncode(DateTimeUtil.FormatDateParm(AV40UsuarioFecha_To)),UrlEncode(StringUtil.RTrim(AV41SatisfaccionResueltoNombre)),UrlEncode(StringUtil.RTrim(AV42SatisfaccionTecnicoProblemaNombre)),UrlEncode(StringUtil.RTrim(AV43SatisfaccionTecnicoCompetenteNombre)),UrlEncode(StringUtil.RTrim(AV44SatisfaccionTecnicoProfesionalismoNombre)),UrlEncode(StringUtil.RTrim(AV45SatisfaccionTiempoNombre)),UrlEncode(StringUtil.RTrim(AV50K2BToolsGenericSearchField)),UrlEncode(StringUtil.LTrimStr(AV51OrderedBy,4,0))}, new string[] {"SatisfaccionAtencionId","SatisfaccionFecha_From","SatisfaccionFecha_To","UsuarioFecha_From","UsuarioFecha_To","SatisfaccionResueltoNombre","SatisfaccionTecnicoProblemaNombre","SatisfaccionTecnicoCompetenteNombre","SatisfaccionTecnicoProfesionalismoNombre","SatisfaccionTiempoNombre","K2BToolsGenericSearchField","OrderedBy"}) );
      ...
      protected void S202( )
      {
         ...
         AssignProp(sPrefix, false, edtSatisfaccionTecnicoProblemaNombre_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtSatisfaccionTecnicoProblemaNombre_Visible), 5, 0), !bGXsfl_223_Refreshing);
         AV23Att_SatisfaccionTecnicoProblemaNombre_Visible = true;
         AssignAttri(sPrefix, false, "AV23Att_SatisfaccionTecnicoProblemaNombre_Visible", AV23Att_SatisfaccionTecnicoProblemaNombre_Visible);
         ...
         AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible = true;
         AssignAttri(sPrefix, false, "AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible", AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible);
         ...
         AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible = true;
         AssignAttri(sPrefix, false, "AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible", AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible);
         ...
         AV26Att_SatisfaccionTiempoNombre_Visible = true;
         AssignAttri(sPrefix, false, "AV26Att_SatisfaccionTiempoNombre_Visible", AV26Att_SatisfaccionTiempoNombre_Visible);
         ...
         AssignAttri(sPrefix, false, "AV27Att_SatisfaccionSugerencia_Visible", AV27Att_SatisfaccionSugerencia_Visible);
         new k2bsavegridconfiguration(context ).execute(  AV67Pgmname,  "Grid",  AV11GridConfiguration,  false) ;
         AV72GXV3 = 1;
         while ( AV72GXV3 <= AV11GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV14GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV11GridConfiguration.gxTpr_Gridcolumns.Item(AV72GXV3));
            if ( ! AV14GridColumn.gxTpr_Showattribute )
            {
               ...
               else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "SatisfaccionTecnicoProblemaNombre") == 0 )
               {
                  ...
                  AssignProp(sPrefix, false, edtSatisfaccionTecnicoProblemaNombre_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtSatisfaccionTecnicoProblemaNombre_Visible), 5, 0), !bGXsfl_223_Refreshing);
                  AV23Att_SatisfaccionTecnicoProblemaNombre_Visible = false;
                  AssignAttri(sPrefix, false, "AV23Att_SatisfaccionTecnicoProblemaNombre_Visible", AV23Att_SatisfaccionTecnicoProblemaNombre_Visible);
               }
               else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "SatisfaccionTecnicoCompetenteNombre") == 0 )
               {
                  ...
                  AssignProp(sPrefix, false, edtSatisfaccionTecnicoCompetenteNombre_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtSatisfaccionTecnicoCompetenteNombre_Visible), 5, 0), !bGXsfl_223_Refreshing);
                  AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible = false;
                  AssignAttri(sPrefix, false, "AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible", AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible);
               }
               else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "SatisfaccionTecnicoProfesionalismoNombre") == 0 )
               {
                  ...
                  AssignProp(sPrefix, false, edtSatisfaccionTecnicoProfesionalismoNombre_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtSatisfaccionTecnicoProfesionalismoNombre_Visible), 5, 0), !bGXsfl_223_Refreshing);
                  AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible = false;
                  AssignAttri(sPrefix, false, "AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible", AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible);
               }
               else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "SatisfaccionTiempoNombre") == 0 )
               {
                  ...
                  AssignProp(sPrefix, false, edtSatisfaccionTiempoNombre_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtSatisfaccionTiempoNombre_Visible), 5, 0), !bGXsfl_223_Refreshing);
                  AV26Att_SatisfaccionTiempoNombre_Visible = false;
                  AssignAttri(sPrefix, false, "AV26Att_SatisfaccionTiempoNombre_Visible", AV26Att_SatisfaccionTiempoNombre_Visible);
               }
      ...
      protected void S182( )
      {
         ...
         AV14GridColumn.gxTpr_Columntitle = "Satisfaccion Resuelto Nombre";
         AV14GridColumn.gxTpr_Showattribute = true;
         AV13GridColumns.Add(AV14GridColumn, 0);
         AV14GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV14GridColumn.gxTpr_Attributename = "SatisfaccionTecnicoProblemaNombre";
         AV14GridColumn.gxTpr_Columntitle = "Satisfaccion Tecnico Problema Nombre";
         AV14GridColumn.gxTpr_Showattribute = true;
         AV13GridColumns.Add(AV14GridColumn, 0);
         AV14GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV14GridColumn.gxTpr_Attributename = "SatisfaccionTecnicoCompetenteNombre";
         AV14GridColumn.gxTpr_Columntitle = "Satisfaccion Tecnico Competente Nombre";
         AV14GridColumn.gxTpr_Showattribute = true;
         AV13GridColumns.Add(AV14GridColumn, 0);
         AV14GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV14GridColumn.gxTpr_Attributename = "SatisfaccionTecnicoProfesionalismoNombre";
         AV14GridColumn.gxTpr_Columntitle = "Satisfaccion Tecnico Profesionalismo Nombre";
         AV14GridColumn.gxTpr_Showattribute = true;
         AV13GridColumns.Add(AV14GridColumn, 0);
         AV14GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV14GridColumn.gxTpr_Attributename = "SatisfaccionTiempoNombre";
         AV14GridColumn.gxTpr_Columntitle = "Satisfaccion Tiempo Nombre";
         AV14GridColumn.gxTpr_Showattribute = true;
         AV13GridColumns.Add(AV14GridColumn, 0);
         AV14GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
      ...
      protected void S212( )
      {
         ...
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Satisfaccion";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Satisfaccion";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = "ReportEstadoSatisfaccionSatisfaccionWC5";
         AV59ActivityList.Add(AV61ActivityListItem, 0);
         AV61ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Standardactivitytype = "List";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Useractivitytype = "";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Satisfaccion";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Satisfaccion";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = "ExportEstadoSatisfaccionSatisfaccionWC5";
         AV59ActivityList.Add(AV61ActivityListItem, 0);
         AV61ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
      ...
      protected void S122( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV41SatisfaccionResueltoNombre)) )
         {
            ...
            AV47K2BFilterValuesSDTItem.gxTpr_Description = "Satisfaccion Resuelto Nombre";
         ...
         {
            AV47K2BFilterValuesSDTItem = new SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem(context);
            AV47K2BFilterValuesSDTItem.gxTpr_Name = "SatisfaccionTecnicoProblemaNombre";
            AV47K2BFilterValuesSDTItem.gxTpr_Description = "Satisfaccion Tecnico Problema Nombre";
            AV47K2BFilterValuesSDTItem.gxTpr_Type = "Standard";
            AV47K2BFilterValuesSDTItem.gxTpr_Value = AV42SatisfaccionTecnicoProblemaNombre;
            AV47K2BFilterValuesSDTItem.gxTpr_Valuedescription = AV42SatisfaccionTecnicoProblemaNombre;
            AV46K2BFilterValuesSDT.Add(AV47K2BFilterValuesSDTItem, 0);
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV43SatisfaccionTecnicoCompetenteNombre)) )
         {
            ...
            AV47K2BFilterValuesSDTItem.gxTpr_Description = "Satisfaccion Tecnico Competente Nombre";
            AV47K2BFilterValuesSDTItem.gxTpr_Type = "Standard";
            AV47K2BFilterValuesSDTItem.gxTpr_Value = AV43SatisfaccionTecnicoCompetenteNombre;
            AV47K2BFilterValuesSDTItem.gxTpr_Valuedescription = AV43SatisfaccionTecnicoCompetenteNombre;
            AV46K2BFilterValuesSDT.Add(AV47K2BFilterValuesSDTItem, 0);
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV44SatisfaccionTecnicoProfesionalismoNombre)) )
         {
            ...
            AV47K2BFilterValuesSDTItem.gxTpr_Description = "Satisfaccion Tecnico Profesionalismo Nombre";
            AV47K2BFilterValuesSDTItem.gxTpr_Type = "Standard";
            AV47K2BFilterValuesSDTItem.gxTpr_Value = AV44SatisfaccionTecnicoProfesionalismoNombre;
            AV47K2BFilterValuesSDTItem.gxTpr_Valuedescription = AV44SatisfaccionTecnicoProfesionalismoNombre;
            AV46K2BFilterValuesSDT.Add(AV47K2BFilterValuesSDTItem, 0);
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV45SatisfaccionTiempoNombre)) )
         {
            ...
            AV47K2BFilterValuesSDTItem.gxTpr_Description = "Satisfaccion Tiempo Nombre";
            AV47K2BFilterValuesSDTItem.gxTpr_Type = "Standard";
            AV47K2BFilterValuesSDTItem.gxTpr_Value = AV45SatisfaccionTiempoNombre;
            AV47K2BFilterValuesSDTItem.gxTpr_Valuedescription = AV45SatisfaccionTiempoNombre;
            AV46K2BFilterValuesSDT.Add(AV47K2BFilterValuesSDTItem, 0);
         }
         ...
         if ( AV46K2BFilterValuesSDT.Count > 0 )
         {
            ...
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV67Pgmname,  "Grid",  AV46K2BFilterValuesSDT, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item4) ;
      ...
      protected void E112C2( )
      {
         ...
         else if ( StringUtil.StrCmp(AV49DeletedTag, "SatisfaccionTecnicoProblemaNombre") == 0 )
         {
            AV42SatisfaccionTecnicoProblemaNombre = "";
            AssignAttri(sPrefix, false, "AV42SatisfaccionTecnicoProblemaNombre", AV42SatisfaccionTecnicoProblemaNombre);
         }
      ...
      protected void E152C2( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  AV67Pgmname,  "Grid", ref  AV11GridConfiguration) ;
         AV73GXV4 = 1;
         while ( AV73GXV4 <= AV11GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV14GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV11GridConfiguration.gxTpr_Gridcolumns.Item(AV73GXV4));
            if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "SatisfaccionId") == 0 )
            {
            ...
            {
               AV14GridColumn.gxTpr_Showattribute = AV23Att_SatisfaccionTecnicoProblemaNombre_Visible;
            }
            else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "SatisfaccionTecnicoCompetenteNombre") == 0 )
            {
               AV14GridColumn.gxTpr_Showattribute = AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible;
            }
            else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "SatisfaccionTecnicoProfesionalismoNombre") == 0 )
            {
               AV14GridColumn.gxTpr_Showattribute = AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible;
            }
            else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "SatisfaccionTiempoNombre") == 0 )
            {
               AV14GridColumn.gxTpr_Showattribute = AV26Att_SatisfaccionTiempoNombre_Visible;
            }
            else if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "SatisfaccionSugerencia") == 0 )
            {
         ...
         new k2bsavegridconfiguration(context ).execute(  AV67Pgmname,  "Grid",  AV11GridConfiguration,  true) ;
         AV54UC_OrderedBy = AV51OrderedBy;
         AssignAttri(sPrefix, false, "AV54UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV54UC_OrderedBy), 4, 0));
         if ( AV29RowsPerPageVariable != AV28GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV29RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, sPrefix+"GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV67Pgmname,  "Grid",  AV29RowsPerPageVariable) ;
            AV9CurrentPage = 1;
            AssignAttri(sPrefix, false, "AV9CurrentPage", StringUtil.LTrimStr( (decimal)(AV9CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void wb_table2_246_2C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoresultsfoundtextblock_Internalname, "No hay resultados", "", "", lblNoresultsfoundtextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_246_2C2e( true) ;
         }
         else
         {
            wb_table2_246_2C2e( false) ;
         }
      }

      protected void wb_table1_77_2C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRuntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblRuntimecolumnselectiontb_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavAtt_satisfaccionresueltonombre_visible_Internalname, "Satisfaccion Resuelto Nombre", "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_satisfaccionresueltonombre_visible_Internalname, StringUtil.BoolToStr( AV22Att_SatisfaccionResueltoNombre_Visible), "", "Satisfaccion Resuelto Nombre", 1, chkavAtt_satisfaccionresueltonombre_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(148, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,148);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavAtt_satisfacciontecnicoproblemanombre_visible_Internalname, "Satisfaccion Tecnico Problema Nombre", "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_satisfacciontecnicoproblemanombre_visible_Internalname, StringUtil.BoolToStr( AV23Att_SatisfaccionTecnicoProblemaNombre_Visible), "", "Satisfaccion Tecnico Problema Nombre", 1, chkavAtt_satisfacciontecnicoproblemanombre_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(154, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,154);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavAtt_satisfacciontecnicocompetentenombre_visible_Internalname, "Satisfaccion Tecnico Competente Nombre", "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_satisfacciontecnicocompetentenombre_visible_Internalname, StringUtil.BoolToStr( AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible), "", "Satisfaccion Tecnico Competente Nombre", 1, chkavAtt_satisfacciontecnicocompetentenombre_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(160, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,160);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavAtt_satisfacciontecnicoprofesionalismonombre_visible_Internalname, "Satisfaccion Tecnico Profesionalismo Nombre", "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_satisfacciontecnicoprofesionalismonombre_visible_Internalname, StringUtil.BoolToStr( AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible), "", "Satisfaccion Tecnico Profesionalismo Nombre", 1, chkavAtt_satisfacciontecnicoprofesionalismonombre_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(166, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,166);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavAtt_satisfacciontiemponombre_visible_Internalname, "Satisfaccion Tiempo Nombre", "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_satisfacciontiemponombre_visible_Internalname, StringUtil.BoolToStr( AV26Att_SatisfaccionTiempoNombre_Visible), "", "Satisfaccion Tiempo Nombre", 1, chkavAtt_satisfacciontiemponombre_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(172, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,172);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgImage1_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgImage1_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e272c1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table3_204_2C2( true) ;
         }
         else
         {
            wb_table3_204_2C2( false) ;
         }
         return  ;
      }

      protected void wb_table3_204_2C2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table4_211_2C2( true) ;
         }
         else
         {
            wb_table4_211_2C2( false) ;
         }
         return  ;
      }

      protected void wb_table4_211_2C2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_77_2C2e( true) ;
         }
         else
         {
            wb_table1_77_2C2e( false) ;
         }
      }

      protected void wb_table4_211_2C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttInsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(223), 3, 0)+","+"null"+");", "Nuevo", bttInsert_Jsonclick, 5, bttInsert_Tooltiptext, "", StyleString, ClassString, bttInsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_211_2C2e( true) ;
         }
         else
         {
            wb_table4_211_2C2e( false) ;
         }
      }

      protected void wb_table3_204_2C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttReport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(223), 3, 0)+","+"null"+");", "Reporte", bttReport_Jsonclick, 7, bttReport_Tooltiptext, "", StyleString, ClassString, bttReport_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e282c1_client"+"'", TempTags, "", 2, "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='K2BToolsTableCell_ActionContainer'>") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 209,'" + sPrefix + "',false,'',0)\"";
            ClassString = "Button_Standard";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttExport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(223), 3, 0)+","+"null"+");", "Exportar", bttExport_Jsonclick, 5, bttExport_Tooltiptext, "", StyleString, ClassString, bttExport_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOEXPORT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EstadoSatisfaccionSatisfaccionWC5.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_204_2C2e( true) ;
         }
         else
         {
            wb_table3_204_2C2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6SatisfaccionAtencionId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6SatisfaccionAtencionId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionAtencionId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6SatisfaccionAtencionId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "estadosatisfaccionsatisfaccionwc5", GetJustCreated( ));
         ...
         {
            AV6SatisfaccionAtencionId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6SatisfaccionAtencionId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionAtencionId), 4, 0));
         }
         wcpOAV6SatisfaccionAtencionId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6SatisfaccionAtencionId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV6SatisfaccionAtencionId != wcpOAV6SatisfaccionAtencionId ) ) )
         {
            setjustcreated();
         }
         wcpOAV6SatisfaccionAtencionId = AV6SatisfaccionAtencionId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6SatisfaccionAtencionId = cgiGet( sPrefix+"AV6SatisfaccionAtencionId_CTRL");
         if ( StringUtil.Len( sCtrlAV6SatisfaccionAtencionId) > 0 )
         {
            AV6SatisfaccionAtencionId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6SatisfaccionAtencionId), ",", "."));
            AssignAttri(sPrefix, false, "AV6SatisfaccionAtencionId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionAtencionId), 4, 0));
         }
         else
         {
            AV6SatisfaccionAtencionId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6SatisfaccionAtencionId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6SatisfaccionAtencionId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6SatisfaccionAtencionId), 4, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6SatisfaccionAtencionId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6SatisfaccionAtencionId_CTRL", StringUtil.RTrim( sCtrlAV6SatisfaccionAtencionId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249515969", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("estadosatisfaccionsatisfaccionwc5.js", "?20231249515969", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/K2BDateRangePickerRender.js", "", false, true);
      ...
      protected void SubsflControlProps_2232( )
      {
         ...
         edtSatisfaccionTecnicoProblemaId_Internalname = sPrefix+"SATISFACCIONTECNICOPROBLEMAID_"+sGXsfl_223_idx;
         edtSatisfaccionTecnicoProblemaNombre_Internalname = sPrefix+"SATISFACCIONTECNICOPROBLEMANOMBRE_"+sGXsfl_223_idx;
      ...
      protected void SubsflControlProps_fel_2232( )
      {
         ...
         edtSatisfaccionTecnicoProblemaId_Internalname = sPrefix+"SATISFACCIONTECNICOPROBLEMAID_"+sGXsfl_223_fel_idx;
         edtSatisfaccionTecnicoProblemaNombre_Internalname = sPrefix+"SATISFACCIONTECNICOPROBLEMANOMBRE_"+sGXsfl_223_fel_idx;
      ...
      protected void sendrow_2232( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_223_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSatisfaccionId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A7SatisfaccionId), 10, 0, ",", "")),context.localUtil.Format( (decimal)(A7SatisfaccionId), "ZZZZZZZZZ9"),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSatisfaccionId_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn K2BToolsSortableColumn InvisibleInExtraSmallColumn",(string)"",(int)edtSatisfaccionId_Visible,(short)0,(short)0,(string)"number",(string)"1",(short)80,(string)"px",(short)17,(string)"px",(short)10,(short)0,(short)0,(short)223,(short)1,(short)-1,(short)0,(bool)true,(string)"NumMax",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute_Grid";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSatisfaccionTecnicoProfesionalismoId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A11SatisfaccionTecnicoProfesionalismoId), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A11SatisfaccionTecnicoProfesionalismoId), "ZZZ9"),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSatisfaccionTecnicoProfesionalismoId_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn InvisibleInExtraSmallColumn",(string)"",(short)0,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)223,(short)1,(short)-1,(short)0,(bool)true,(string)"NumMin",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute_Grid";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSatisfaccionTiempoId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A12SatisfaccionTiempoId), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A12SatisfaccionTiempoId), "ZZZ9"),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSatisfaccionTiempoId_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn InvisibleInExtraSmallColumn",(string)"",(short)0,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)223,(short)1,(short)-1,(short)0,(bool)true,(string)"NumMin",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV63Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV63Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV69Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV63Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV63Update)) ? AV69Update_GXI : context.PathToRelativeUrl( AV63Update));
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV64Delete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV64Delete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV70Delete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV64Delete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV64Delete)) ? AV70Delete_GXI : context.PathToRelativeUrl( AV64Delete));
      ...
      public override void initialize_properties( )
      {
         ...
         chkavAtt_satisfacciontiemponombre_visible.Caption = "Satisfaccion Tiempo Nombre";
         chkavAtt_satisfacciontecnicoprofesionalismonombre_visible.Caption = "Satisfaccion Tecnico Profesionalismo Nombre";
         chkavAtt_satisfacciontecnicocompetentenombre_visible.Caption = "Satisfaccion Tecnico Competente Nombre";
         chkavAtt_satisfacciontecnicoproblemanombre_visible.Caption = "Satisfaccion Tecnico Problema Nombre";
         chkavAtt_satisfaccionresueltonombre_visible.Caption = "Satisfaccion Resuelto Nombre";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.REFRESH","{handler:'E242C2',iparms:[{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV45SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV67Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV6SatisfaccionAtencionId',fld:'vSATISFACCIONATENCIONID',pic:'ZZZ9'},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV60AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E252C2',iparms:[{av:'AV60AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZ9'},{av:'A8SatisfaccionResueltoId',fld:'SATISFACCIONRESUELTOID',pic:'ZZZ9'},{av:'A9SatisfaccionTecnicoProblemaId',fld:'SATISFACCIONTECNICOPROBLEMAID',pic:'ZZZ9'},{av:'A10SatisfaccionTecnicoCompetenteId',fld:'SATISFACCIONTECNICOCOMPETENTEID',pic:'ZZZ9'},{av:'A11SatisfaccionTecnicoProfesionalismoId',fld:'SATISFACCIONTECNICOPROFESIONALISMOID',pic:'ZZZ9'},{av:'A12SatisfaccionTiempoId',fld:'SATISFACCIONTIEMPOID',pic:'ZZZ9'},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'A7SatisfaccionId',fld:'SATISFACCIONID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'tblNoresultsfoundtable_Visible',ctrl:'NORESULTSFOUNDTABLE',prop:'Visible'},{av:'edtUsuarioNombre_Link',ctrl:'USUARIONOMBRE',prop:'Link'},{av:'edtSatisfaccionResueltoNombre_Link',ctrl:'SATISFACCIONRESUELTONOMBRE',prop:'Link'},{av:'edtSatisfaccionTecnicoProblemaNombre_Link',ctrl:'SATISFACCIONTECNICOPROBLEMANOMBRE',prop:'Link'},{av:'edtSatisfaccionTecnicoCompetenteNombre_Link',ctrl:'SATISFACCIONTECNICOCOMPETENTENOMBRE',prop:'Link'},{av:'edtSatisfaccionTecnicoProfesionalismoNombre_Link',ctrl:'SATISFACCIONTECNICOPROFESIONALISMONOMBRE',prop:'Link'},{av:'edtSatisfaccionTiempoNombre_Link',ctrl:'SATISFACCIONTIEMPONOMBRE',prop:'Link'},{av:'edtSatisfaccionFecha_Link',ctrl:'SATISFACCIONFECHA',prop:'Link'},{av:'edtavUpdate_Enabled',ctrl:'vUPDATE',prop:'Enabled'},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'edtavDelete_Enabled',ctrl:'vDELETE',prop:'Enabled'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED","{handler:'E112C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV45SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV6SatisfaccionAtencionId',fld:'vSATISFACCIONATENCIONID',pic:'ZZZ9'},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV67Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV60AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{av:'AV49DeletedTag',fld:'vDELETEDTAG',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED",",oparms:[{av:'AV45SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{ctrl:'REPORT',prop:'Tooltiptext'},{ctrl:'EXPORT',prop:'Tooltiptext'},{ctrl:'INSERT',prop:'Tooltiptext'},{av:'AV63Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV64Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'divDownloadsactionssectioncontainer_Visible',ctrl:'DOWNLOADSACTIONSSECTIONCONTAINER',prop:'Visible'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{ctrl:'INSERT',prop:'Visible'},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'edtSatisfaccionId_Visible',ctrl:'SATISFACCIONID',prop:'Visible'},{av:'edtSatisfaccionFecha_Visible',ctrl:'SATISFACCIONFECHA',prop:'Visible'},{av:'edtTicketId_Visible',ctrl:'TICKETID',prop:'Visible'},{av:'edtUsuarioId_Visible',ctrl:'USUARIOID',prop:'Visible'},{av:'edtUsuarioNombre_Visible',ctrl:'USUARIONOMBRE',prop:'Visible'},{av:'edtUsuarioFecha_Visible',ctrl:'USUARIOFECHA',prop:'Visible'},{av:'edtUsuarioRequerimiento_Visible',ctrl:'USUARIOREQUERIMIENTO',prop:'Visible'},{av:'edtSatisfaccionResueltoNombre_Visible',ctrl:'SATISFACCIONRESUELTONOMBRE',prop:'Visible'},{av:'edtSatisfaccionTecnicoProblemaNombre_Visible',ctrl:'SATISFACCIONTECNICOPROBLEMANOMBRE',prop:'Visible'},{av:'edtSatisfaccionTecnicoCompetenteNombre_Visible',ctrl:'SATISFACCIONTECNICOCOMPETENTENOMBRE',prop:'Visible'},{av:'edtSatisfaccionTecnicoProfesionalismoNombre_Visible',ctrl:'SATISFACCIONTECNICOPROFESIONALISMONOMBRE',prop:'Visible'},{av:'edtSatisfaccionTiempoNombre_Visible',ctrl:'SATISFACCIONTIEMPONOMBRE',prop:'Visible'},{av:'edtSatisfaccionSugerencia_Visible',ctrl:'SATISFACCIONSUGERENCIA',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E122C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV45SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV6SatisfaccionAtencionId',fld:'vSATISFACCIONATENCIONID',pic:'ZZZ9'},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV67Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV60AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{av:'AV54UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'TOGGLEGRIDSETTINGSTABLE'","{handler:'E262C1',iparms:[{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E152C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV45SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV6SatisfaccionAtencionId',fld:'vSATISFACCIONATENCIONID',pic:'ZZZ9'},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV67Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV60AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{av:'AV29RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV28GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E162C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV45SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV6SatisfaccionAtencionId',fld:'vSATISFACCIONATENCIONID',pic:'ZZZ9'},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV67Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV60AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E172C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV45SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV6SatisfaccionAtencionId',fld:'vSATISFACCIONATENCIONID',pic:'ZZZ9'},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV67Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV60AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E182C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV45SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV6SatisfaccionAtencionId',fld:'vSATISFACCIONATENCIONID',pic:'ZZZ9'},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV67Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV60AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E192C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV45SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV6SatisfaccionAtencionId',fld:'vSATISFACCIONATENCIONID',pic:'ZZZ9'},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV67Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV60AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'TOGGLEDOWNLOADACTIONS'","{handler:'E272C1',iparms:[{av:'divDownloadactionstable_Visible',ctrl:'DOWNLOADACTIONSTABLE',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERTOGGLE_COMBINED.CLICK","{handler:'E202C2',iparms:[{av:'divFiltercollapsiblesection_combined_Visible',ctrl:'FILTERCOLLAPSIBLESECTION_COMBINED',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERCLOSE_COMBINED.CLICK","{handler:'E212C2',iparms:[{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         lV50K2BToolsGenericSearchField = "";
         H002C2_A13SatisfaccionAtencionId = new short[1] ;
         H002C2_A34SatisfaccionSugerencia = new string[] {""} ;
         H002C2_A38SatisfaccionTiempoNombre = new string[] {""} ;
         H002C2_A12SatisfaccionTiempoId = new short[1] ;
         H002C2_A37SatisfaccionTecnicoProfesionalismoNombre = new string[] {""} ;
         H002C2_A11SatisfaccionTecnicoProfesionalismoId = new short[1] ;
         H002C2_A35SatisfaccionTecnicoCompetenteNombre = new string[] {""} ;
         H002C2_A10SatisfaccionTecnicoCompetenteId = new short[1] ;
         H002C2_A36SatisfaccionTecnicoProblemaNombre = new string[] {""} ;
         H002C2_A9SatisfaccionTecnicoProblemaId = new short[1] ;
         H002C2_A33SatisfaccionResueltoNombre = new string[] {""} ;
         H002C2_A8SatisfaccionResueltoId = new short[1] ;
         H002C2_A94UsuarioRequerimiento = new string[] {""} ;
         H002C2_A90UsuarioFecha = new DateTime[] {DateTime.MinValue} ;
         H002C2_A93UsuarioNombre = new string[] {""} ;
         H002C2_A15UsuarioId = new short[1] ;
         H002C2_A14TicketId = new long[1] ;
         H002C2_A32SatisfaccionFecha = new DateTime[] {DateTime.MinValue} ;
         H002C2_A7SatisfaccionId = new long[1] ;
         H002C3_AGRID_nRecordCount = new long[1] ;
         AV5Context = new SdtK2BContext(context);
         AV53GridOrder = new SdtK2BGridOrders_K2BGridOrdersItem(context);
         AV55Messages = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
         ...
         sCtrlAV6SatisfaccionAtencionId = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.estadosatisfaccionsatisfaccionwc5__default(),
            new Object[][] {
                new Object[] {
               H002C2_A13SatisfaccionAtencionId, H002C2_A34SatisfaccionSugerencia, H002C2_A38SatisfaccionTiempoNombre, H002C2_A12SatisfaccionTiempoId, H002C2_A37SatisfaccionTecnicoProfesionalismoNombre, H002C2_A11SatisfaccionTecnicoProfesionalismoId, H002C2_A35SatisfaccionTecnicoCompetenteNombre, H002C2_A10SatisfaccionTecnicoCompetenteId, H002C2_A36SatisfaccionTecnicoProblemaNombre, H002C2_A9SatisfaccionTecnicoProblemaId,
               H002C2_A33SatisfaccionResueltoNombre, H002C2_A8SatisfaccionResueltoId, H002C2_A94UsuarioRequerimiento, H002C2_A90UsuarioFecha, H002C2_A93UsuarioNombre, H002C2_A15UsuarioId, H002C2_A14TicketId, H002C2_A32SatisfaccionFecha, H002C2_A7SatisfaccionId
               }
               , new Object[] {
      ...
      private short AV6SatisfaccionAtencionId ;
      private short wcpOAV6SatisfaccionAtencionId ;
      ...
      private string sCtrlAV6SatisfaccionAtencionId ;
      ...
      private bool AV23Att_SatisfaccionTecnicoProblemaNombre_Visible ;
      private bool AV24Att_SatisfaccionTecnicoCompetenteNombre_Visible ;
      private bool AV25Att_SatisfaccionTecnicoProfesionalismoNombre_Visible ;
      private bool AV26Att_SatisfaccionTiempoNombre_Visible ;
      ...
      private short[] H002C2_A13SatisfaccionAtencionId ;
      private string[] H002C2_A34SatisfaccionSugerencia ;
      private string[] H002C2_A38SatisfaccionTiempoNombre ;
      private short[] H002C2_A12SatisfaccionTiempoId ;
      private string[] H002C2_A37SatisfaccionTecnicoProfesionalismoNombre ;
      private short[] H002C2_A11SatisfaccionTecnicoProfesionalismoId ;
      private string[] H002C2_A35SatisfaccionTecnicoCompetenteNombre ;
      private short[] H002C2_A10SatisfaccionTecnicoCompetenteId ;
      private string[] H002C2_A36SatisfaccionTecnicoProblemaNombre ;
      private short[] H002C2_A9SatisfaccionTecnicoProblemaId ;
      private string[] H002C2_A33SatisfaccionResueltoNombre ;
      private short[] H002C2_A8SatisfaccionResueltoId ;
      private string[] H002C2_A94UsuarioRequerimiento ;
      private DateTime[] H002C2_A90UsuarioFecha ;
      private string[] H002C2_A93UsuarioNombre ;
      private short[] H002C2_A15UsuarioId ;
      private long[] H002C2_A14TicketId ;
      private DateTime[] H002C2_A32SatisfaccionFecha ;
      private long[] H002C2_A7SatisfaccionId ;
      ...
      private GXBaseCollection<SdtMessages_Message> AV55Messages ;
   ...
   public class estadosatisfaccionsatisfaccionwc5__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A13SatisfaccionAtencionId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[SatisfaccionAtencionId], T1.[SatisfaccionSugerencia], T2.[EstadoSatisfaccionNombre] AS SatisfaccionTiempoNombre, T1.[SatisfaccionTiempoId] AS SatisfaccionTiempoId, T3.[EstadoSatisfaccionNombre] AS SatisfaccionTecnicoProfesionalismoNombre, T1.[SatisfaccionTecnicoProfesionalismoId] AS SatisfaccionTecnicoProfesionalismoId, T4.[EstadoSatisfaccionNombre] AS SatisfaccionTecnicoCompetenteNombre, T1.[SatisfaccionTecnicoCompetenteId] AS SatisfaccionTecnicoCompetenteId, T5.[EstadoSatisfaccionNombre] AS SatisfaccionTecnicoProblemaNombre, T1.[SatisfaccionTecnicoProblemaId] AS SatisfaccionTecnicoProblemaId, T6.[EstadoSatisfaccionNombre] AS SatisfaccionResueltoNombre, T1.[SatisfaccionResueltoId] AS SatisfaccionResueltoId, T8.[UsuarioRequerimiento], T8.[UsuarioFecha], T8.[UsuarioNombre], T7.[UsuarioId], T1.[TicketId], T1.[SatisfaccionFecha], T1.[SatisfaccionId]";
         sFromString = " FROM ((((((([Satisfaccion] T1 INNER JOIN [EstadoSatisfaccion] T2 ON T2.[EstadoSatisfaccionId] = T1.[SatisfaccionTiempoId]) INNER JOIN [EstadoSatisfaccion] T3 ON T3.[EstadoSatisfaccionId] = T1.[SatisfaccionTecnicoProfesionalismoId]) INNER JOIN [EstadoSatisfaccion] T4 ON T4.[EstadoSatisfaccionId] = T1.[SatisfaccionTecnicoCompetenteId]) INNER JOIN [EstadoSatisfaccion] T5 ON T5.[EstadoSatisfaccionId] = T1.[SatisfaccionTecnicoProblemaId]) INNER JOIN [EstadoSatisfaccion] T6 ON T6.[EstadoSatisfaccionId] = T1.[SatisfaccionResueltoId]) INNER JOIN [Ticket] T7 ON T7.[TicketId] = T1.[TicketId]) INNER JOIN [Usuario] T8 ON T8.[UsuarioId] = T7.[UsuarioId])";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.[SatisfaccionAtencionId] = @AV6SatisfaccionAtencionId)");
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV42SatisfaccionTecnicoProblemaNombre)) )
         {
            AddWhere(sWhereString, "(T5.[EstadoSatisfaccionNombre] like @lV42SatisfaccionTecnicoProblemaNombre)");
         }
         else
         {
            GXv_int5[6] = 1;
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV43SatisfaccionTecnicoCompetenteNombre)) )
         {
            AddWhere(sWhereString, "(T4.[EstadoSatisfaccionNombre] like @lV43SatisfaccionTecnicoCompetenteNombre)");
         }
         else
         {
            GXv_int5[7] = 1;
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV44SatisfaccionTecnicoProfesionalismoNombre)) )
         {
            AddWhere(sWhereString, "(T3.[EstadoSatisfaccionNombre] like @lV44SatisfaccionTecnicoProfesionalismoNombre)");
         }
         else
         {
            GXv_int5[8] = 1;
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV45SatisfaccionTiempoNombre)) )
         {
            AddWhere(sWhereString, "(T2.[EstadoSatisfaccionNombre] like @lV45SatisfaccionTiempoNombre)");
         }
         else
         {
            GXv_int5[9] = 1;
         ...
         {
            AddWhere(sWhereString, "(CONVERT( char(10), CAST(T1.[SatisfaccionId] AS decimal(10,0))) like '%' + @lV50K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T1.[TicketId] AS decimal(10,0))) like '%' + @lV50K2BToolsGenericSearchField + '%' or CONVERT( char(4), CAST(T7.[UsuarioId] AS decimal(4,0))) like '%' + @lV50K2BToolsGenericSearchField + '%' or T8.[UsuarioNombre] like '%' + @lV50K2BToolsGenericSearchField + '%' or T8.[UsuarioRequerimiento] like '%' + @lV50K2BToolsGenericSearchField + '%' or T6.[EstadoSatisfaccionNombre] like '%' + @lV50K2BToolsGenericSearchField + '%' or T5.[EstadoSatisfaccionNombre] like '%' + @lV50K2BToolsGenericSearchField + '%' or T4.[EstadoSatisfaccionNombre] like '%' + @lV50K2BToolsGenericSearchField + '%' or T3.[EstadoSatisfaccionNombre] like '%' + @lV50K2BToolsGenericSearchField + '%' or T2.[EstadoSatisfaccionNombre] like '%' + @lV50K2BToolsGenericSearchField + '%' or T1.[SatisfaccionSugerencia] like '%' + @lV50K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int5[10] = 1;
                                             ...
                                             short A13SatisfaccionAtencionId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((((((([Satisfaccion] T1 INNER JOIN [EstadoSatisfaccion] T8 ON T8.[EstadoSatisfaccionId] = T1.[SatisfaccionTiempoId]) INNER JOIN [EstadoSatisfaccion] T7 ON T7.[EstadoSatisfaccionId] = T1.[SatisfaccionTecnicoProfesionalismoId]) INNER JOIN [EstadoSatisfaccion] T6 ON T6.[EstadoSatisfaccionId] = T1.[SatisfaccionTecnicoCompetenteId]) INNER JOIN [EstadoSatisfaccion] T5 ON T5.[EstadoSatisfaccionId] = T1.[SatisfaccionTecnicoProblemaId]) INNER JOIN [EstadoSatisfaccion] T4 ON T4.[EstadoSatisfaccionId] = T1.[SatisfaccionResueltoId]) INNER JOIN [Ticket] T2 ON T2.[TicketId] = T1.[TicketId]) INNER JOIN [Usuario] T3 ON T3.[UsuarioId] = T2.[UsuarioId])";
         AddWhere(sWhereString, "(T1.[SatisfaccionAtencionId] = @AV6SatisfaccionAtencionId)");
         if ( ! (DateTime.MinValue==AV37SatisfaccionFecha_To) )
         {
            AddWhere(sWhereString, "(T1.[SatisfaccionFecha] <= @AV37SatisfaccionFecha_To)");
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV43SatisfaccionTecnicoCompetenteNombre)) )
         {
            AddWhere(sWhereString, "(T6.[EstadoSatisfaccionNombre] like @lV43SatisfaccionTecnicoCompetenteNombre)");
         }
         else
         {
            GXv_int7[7] = 1;
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV44SatisfaccionTecnicoProfesionalismoNombre)) )
         {
            AddWhere(sWhereString, "(T7.[EstadoSatisfaccionNombre] like @lV44SatisfaccionTecnicoProfesionalismoNombre)");
         }
         else
         {
            GXv_int7[8] = 1;
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV45SatisfaccionTiempoNombre)) )
         {
            AddWhere(sWhereString, "(T8.[EstadoSatisfaccionNombre] like @lV45SatisfaccionTiempoNombre)");
         }
         else
         {
            GXv_int7[9] = 1;
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV50K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(10), CAST(T1.[SatisfaccionId] AS decimal(10,0))) like '%' + @lV50K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T1.[TicketId] AS decimal(10,0))) like '%' + @lV50K2BToolsGenericSearchField + '%' or CONVERT( char(4), CAST(T2.[UsuarioId] AS decimal(4,0))) like '%' + @lV50K2BToolsGenericSearchField + '%' or T3.[UsuarioNombre] like '%' + @lV50K2BToolsGenericSearchField + '%' or T3.[UsuarioRequerimiento] like '%' + @lV50K2BToolsGenericSearchField + '%' or T4.[EstadoSatisfaccionNombre] like '%' + @lV50K2BToolsGenericSearchField + '%' or T5.[EstadoSatisfaccionNombre] like '%' + @lV50K2BToolsGenericSearchField + '%' or T6.[EstadoSatisfaccionNombre] like '%' + @lV50K2BToolsGenericSearchField + '%' or T7.[EstadoSatisfaccionNombre] like '%' + @lV50K2BToolsGenericSearchField + '%' or T8.[EstadoSatisfaccionNombre] like '%' + @lV50K2BToolsGenericSearchField + '%' or T1.[SatisfaccionSugerencia] like '%' + @lV50K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int7[10] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002C2(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (short)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] , (short)dynConstraints[25] );
               case 1 :
                     return conditional_H002C3(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (short)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] , (short)dynConstraints[25] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6SatisfaccionAtencionId",GXType.Int16,4,0) ,
