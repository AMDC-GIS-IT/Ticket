...
namespace GeneXus.Programs {
   public class estadotecnicosgeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public estadotecnicosgeneral( )
      {
      ...
      public estadotecnicosgeneral( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "AV6EstadoTecnicosId", StringUtil.LTrimStr( (decimal)(AV6EstadoTecnicosId), 4, 0));
                  AV8TabCode = GetPar( "TabCode");
                  AssignAttri(sPrefix, false, "AV8TabCode", AV8TabCode);
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)Gx_mode,(short)AV6EstadoTecnicosId,(string)AV8TabCode});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249492391", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6EstadoTecnicosId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6EstadoTecnicosId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8TabCode", StringUtil.RTrim( wcpOAV8TabCode));
         GxWebStd.gx_hidden_field( context, sPrefix+"ESTADOTECNICOSID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A192EstadoTecnicosId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vESTADOTECNICOSID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6EstadoTecnicosId), 4, 0, ",", "")));
      ...
      protected void WB5S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "estadotecnicosgeneral.aspx");
            }
            /* Div Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_15_5S2( true) ;
         }
         else
         {
            wb_table1_15_5S2( false) ;
         }
         return  ;
      }

      protected void wb_table1_15_5S2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void STRUP5S0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6EstadoTecnicosId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6EstadoTecnicosId"), ",", "."));
      ...
      protected void E125S2( )
      {
         ...
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "EstadoTecnicos";
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "EstadoTecnicos";
         ...
         {
            A192EstadoTecnicosId = H005S2_A192EstadoTecnicosId[0];
            AV16GXLvl26 = 1;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Transactioncomponent_Component), StringUtil.Lower( "EstadoTecnicos")) != 0 )
         {
            WebComp_Transactioncomponent = getWebComponent(GetType(), "GeneXus.Programs", "estadotecnicos", new Object[] {context} );
            WebComp_Transactioncomponent.ComponentInit();
            WebComp_Transactioncomponent.Name = "EstadoTecnicos";
            WebComp_Transactioncomponent_Component = "EstadoTecnicos";
         }
         if ( StringUtil.Len( WebComp_Transactioncomponent_Component) != 0 )
         {
            WebComp_Transactioncomponent.setjustcreated();
            WebComp_Transactioncomponent.componentprepare(new Object[] {(string)sPrefix+"W0029",(string)"",(string)Gx_mode,(short)AV6EstadoTecnicosId});
      ...
      protected void E135S2( )
      {
         /* 'DoUpdate' Routine */
         returnInSub = false;
         new k2bgettrncontextbyname(context ).execute(  "EstadoTecnicos", out  AV10TrnContext) ;
         GXt_char1 = "";
         ...
         new k2bsettrncontextbyname(context ).execute(  "EstadoTecnicos",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerestadotecnicos.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(AV6EstadoTecnicosId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","EstadoTecnicosId","TabCode"}) );
      ...
      protected void E145S2( )
      {
         ...
         AV10TrnContext.gxTpr_Returnmode = "Popup";
         new k2bsettrncontextbyname(context ).execute(  "EstadoTecnicos",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerestadotecnicos.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(AV6EstadoTecnicosId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","EstadoTecnicosId","TabCode"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void wb_table1_15_5S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_18_5S2( true) ;
         }
         else
         {
            wb_table2_18_5S2( false) ;
         }
         return  ;
      }

      protected void wb_table2_18_5S2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_15_5S2e( true) ;
         }
         else
         {
            wb_table1_15_5S2e( false) ;
         }
      }

      protected void wb_table2_18_5S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_18_5S2e( true) ;
         }
         else
         {
            wb_table2_18_5S2e( false) ;
         }
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6EstadoTecnicosId = (string)((string)getParm(obj,1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "estadotecnicosgeneral", GetJustCreated( ));
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "Gx_mode", Gx_mode);
            AV6EstadoTecnicosId = Convert.ToInt16(getParm(obj,3));
            AssignAttri(sPrefix, false, "AV6EstadoTecnicosId", StringUtil.LTrimStr( (decimal)(AV6EstadoTecnicosId), 4, 0));
         ...
         wcpOAV6EstadoTecnicosId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6EstadoTecnicosId"), ",", "."));
         wcpOAV8TabCode = cgiGet( sPrefix+"wcpOAV8TabCode");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(Gx_mode, wcpOGx_mode) != 0 ) || ( AV6EstadoTecnicosId != wcpOAV6EstadoTecnicosId ) || ( StringUtil.StrCmp(AV8TabCode, wcpOAV8TabCode) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOGx_mode = Gx_mode;
         wcpOAV6EstadoTecnicosId = AV6EstadoTecnicosId;
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV6EstadoTecnicosId = cgiGet( sPrefix+"AV6EstadoTecnicosId_CTRL");
         if ( StringUtil.Len( sCtrlAV6EstadoTecnicosId) > 0 )
         {
            AV6EstadoTecnicosId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6EstadoTecnicosId), ",", "."));
            AssignAttri(sPrefix, false, "AV6EstadoTecnicosId", StringUtil.LTrimStr( (decimal)(AV6EstadoTecnicosId), 4, 0));
         }
         else
         {
            AV6EstadoTecnicosId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6EstadoTecnicosId_PARM"), ",", "."));
         }
      ...
      protected void WCParametersSet( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6EstadoTecnicosId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6EstadoTecnicosId), 4, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6EstadoTecnicosId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6EstadoTecnicosId_CTRL", StringUtil.RTrim( sCtrlAV6EstadoTecnicosId));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249492422", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("estadotecnicosgeneral.js", "?20231249492422", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A192EstadoTecnicosId',fld:'ESTADOTECNICOSID',pic:'ZZZ9'},{av:'AV6EstadoTecnicosId',fld:'vESTADOTECNICOSID',pic:'ZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E135S2',iparms:[{av:'AV6EstadoTecnicosId',fld:'vESTADOTECNICOSID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E145S2',iparms:[{av:'AV6EstadoTecnicosId',fld:'vESTADOTECNICOSID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV12ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         scmdbuf = "";
         H005S2_A192EstadoTecnicosId = new short[1] ;
         ...
         sCtrlGx_mode = "";
         sCtrlAV6EstadoTecnicosId = "";
         sCtrlAV8TabCode = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.estadotecnicosgeneral__default(),
            new Object[][] {
                new Object[] {
               H005S2_A192EstadoTecnicosId
               }
            }
         );
      ...
      private string sCtrlAV6EstadoTecnicosId ;
      ...
      private short[] H005S2_A192EstadoTecnicosId ;
   ...
   public class estadotecnicosgeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H005S2", "SELECT [EstadoTecnicosId] FROM [EstadoTecnicos] WHERE [EstadoTecnicosId] = @AV6EstadoTecnicosId ORDER BY [EstadoTecnicosId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005S2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
