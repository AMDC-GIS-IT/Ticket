...
namespace GeneXus.Programs {
   public class reportestadosatisfaccionsatisfaccionwc4 : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV9SatisfaccionTiempoId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      public reportestadosatisfaccionsatisfaccionwc4( )
      {
      ...
      public reportestadosatisfaccionsatisfaccionwc4( IGxContext context )
      {
      ...
      {
         this.AV9SatisfaccionTiempoId = aP0_SatisfaccionTiempoId;
      ...
      public void executeSubmit( short aP0_SatisfaccionTiempoId ,
                                 ...
                                 short aP11_OrderedBy )
      {
         reportestadosatisfaccionsatisfaccionwc4 objreportestadosatisfaccionsatisfaccionwc4;
         objreportestadosatisfaccionsatisfaccionwc4 = new reportestadosatisfaccionsatisfaccionwc4();
         objreportestadosatisfaccionsatisfaccionwc4.AV9SatisfaccionTiempoId = aP0_SatisfaccionTiempoId;
         objreportestadosatisfaccionsatisfaccionwc4.AV17SatisfaccionFecha_From = aP1_SatisfaccionFecha_From;
         objreportestadosatisfaccionsatisfaccionwc4.AV18SatisfaccionFecha_To = aP2_SatisfaccionFecha_To;
         objreportestadosatisfaccionsatisfaccionwc4.AV20UsuarioFecha_From = aP3_UsuarioFecha_From;
         objreportestadosatisfaccionsatisfaccionwc4.AV21UsuarioFecha_To = aP4_UsuarioFecha_To;
         objreportestadosatisfaccionsatisfaccionwc4.AV22SatisfaccionResueltoNombre = aP5_SatisfaccionResueltoNombre;
         objreportestadosatisfaccionsatisfaccionwc4.AV23SatisfaccionTecnicoProblemaNombre = aP6_SatisfaccionTecnicoProblemaNombre;
         objreportestadosatisfaccionsatisfaccionwc4.AV24SatisfaccionTecnicoCompetenteNombre = aP7_SatisfaccionTecnicoCompetenteNombre;
         objreportestadosatisfaccionsatisfaccionwc4.AV25SatisfaccionTecnicoProfesionalismoNombre = aP8_SatisfaccionTecnicoProfesionalismoNombre;
         objreportestadosatisfaccionsatisfaccionwc4.AV26SatisfaccionAtencionNombre = aP9_SatisfaccionAtencionNombre;
         objreportestadosatisfaccionsatisfaccionwc4.AV10K2BToolsGenericSearchField = aP10_K2BToolsGenericSearchField;
         objreportestadosatisfaccionsatisfaccionwc4.AV11OrderedBy = aP11_OrderedBy;
         objreportestadosatisfaccionsatisfaccionwc4.context.SetSubmitInitialConfig(context);
         objreportestadosatisfaccionsatisfaccionwc4.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objreportestadosatisfaccionsatisfaccionwc4);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((reportestadosatisfaccionsatisfaccionwc4)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            else
            {
               ...
               lV10K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV10K2BToolsGenericSearchField), 200, "%");
               /* Using cursor P003A2 */
               pr_default.execute(0, new Object[] {AV9SatisfaccionTiempoId, AV18SatisfaccionFecha_To, AV17SatisfaccionFecha_From, AV21UsuarioFecha_To, AV20UsuarioFecha_From, lV22SatisfaccionResueltoNombre, lV23SatisfaccionTecnicoProblemaNombre, lV24SatisfaccionTecnicoCompetenteNombre, lV25SatisfaccionTecnicoProfesionalismoNombre, lV26SatisfaccionAtencionNombre, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField});
               while ( (pr_default.getStatus(0) != 101) )
               {
                  A8SatisfaccionResueltoId = P003A2_A8SatisfaccionResueltoId[0];
                  A9SatisfaccionTecnicoProblemaId = P003A2_A9SatisfaccionTecnicoProblemaId[0];
                  A10SatisfaccionTecnicoCompetenteId = P003A2_A10SatisfaccionTecnicoCompetenteId[0];
                  A11SatisfaccionTecnicoProfesionalismoId = P003A2_A11SatisfaccionTecnicoProfesionalismoId[0];
                  A13SatisfaccionAtencionId = P003A2_A13SatisfaccionAtencionId[0];
                  A12SatisfaccionTiempoId = P003A2_A12SatisfaccionTiempoId[0];
                  A34SatisfaccionSugerencia = P003A2_A34SatisfaccionSugerencia[0];
                  A94UsuarioRequerimiento = P003A2_A94UsuarioRequerimiento[0];
                  A93UsuarioNombre = P003A2_A93UsuarioNombre[0];
                  A15UsuarioId = P003A2_A15UsuarioId[0];
                  A14TicketId = P003A2_A14TicketId[0];
                  A7SatisfaccionId = P003A2_A7SatisfaccionId[0];
                  A31SatisfaccionAtencionNombre = P003A2_A31SatisfaccionAtencionNombre[0];
                  A37SatisfaccionTecnicoProfesionalismoNombre = P003A2_A37SatisfaccionTecnicoProfesionalismoNombre[0];
                  A35SatisfaccionTecnicoCompetenteNombre = P003A2_A35SatisfaccionTecnicoCompetenteNombre[0];
                  A36SatisfaccionTecnicoProblemaNombre = P003A2_A36SatisfaccionTecnicoProblemaNombre[0];
                  A33SatisfaccionResueltoNombre = P003A2_A33SatisfaccionResueltoNombre[0];
                  A90UsuarioFecha = P003A2_A90UsuarioFecha[0];
                  A32SatisfaccionFecha = P003A2_A32SatisfaccionFecha[0];
                  A33SatisfaccionResueltoNombre = P003A2_A33SatisfaccionResueltoNombre[0];
                  A36SatisfaccionTecnicoProblemaNombre = P003A2_A36SatisfaccionTecnicoProblemaNombre[0];
                  A35SatisfaccionTecnicoCompetenteNombre = P003A2_A35SatisfaccionTecnicoCompetenteNombre[0];
                  A37SatisfaccionTecnicoProfesionalismoNombre = P003A2_A37SatisfaccionTecnicoProfesionalismoNombre[0];
      ...
      public override void initialize( )
      {
         ...
         A94UsuarioRequerimiento = "";
         A34SatisfaccionSugerencia = "";
         P003A2_A8SatisfaccionResueltoId = new short[1] ;
         P003A2_A9SatisfaccionTecnicoProblemaId = new short[1] ;
         P003A2_A10SatisfaccionTecnicoCompetenteId = new short[1] ;
         P003A2_A11SatisfaccionTecnicoProfesionalismoId = new short[1] ;
         P003A2_A13SatisfaccionAtencionId = new short[1] ;
         P003A2_A12SatisfaccionTiempoId = new short[1] ;
         P003A2_A34SatisfaccionSugerencia = new string[] {""} ;
         P003A2_A94UsuarioRequerimiento = new string[] {""} ;
         P003A2_A93UsuarioNombre = new string[] {""} ;
         P003A2_A15UsuarioId = new short[1] ;
         P003A2_A14TicketId = new long[1] ;
         P003A2_A7SatisfaccionId = new long[1] ;
         P003A2_A31SatisfaccionAtencionNombre = new string[] {""} ;
         P003A2_A37SatisfaccionTecnicoProfesionalismoNombre = new string[] {""} ;
         P003A2_A35SatisfaccionTecnicoCompetenteNombre = new string[] {""} ;
         P003A2_A36SatisfaccionTecnicoProblemaNombre = new string[] {""} ;
         P003A2_A33SatisfaccionResueltoNombre = new string[] {""} ;
         P003A2_A90UsuarioFecha = new DateTime[] {DateTime.MinValue} ;
         P003A2_A32SatisfaccionFecha = new DateTime[] {DateTime.MinValue} ;
         Gx_date = DateTime.MinValue;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportestadosatisfaccionsatisfaccionwc4__default(),
            new Object[][] {
                new Object[] {
               P003A2_A8SatisfaccionResueltoId, P003A2_A9SatisfaccionTecnicoProblemaId, P003A2_A10SatisfaccionTecnicoCompetenteId, P003A2_A11SatisfaccionTecnicoProfesionalismoId, P003A2_A13SatisfaccionAtencionId, P003A2_A12SatisfaccionTiempoId, P003A2_A34SatisfaccionSugerencia, P003A2_A94UsuarioRequerimiento, P003A2_A93UsuarioNombre, P003A2_A15UsuarioId,
               P003A2_A14TicketId, P003A2_A7SatisfaccionId, P003A2_A31SatisfaccionAtencionNombre, P003A2_A37SatisfaccionTecnicoProfesionalismoNombre, P003A2_A35SatisfaccionTecnicoCompetenteNombre, P003A2_A36SatisfaccionTecnicoProblemaNombre, P003A2_A33SatisfaccionResueltoNombre, P003A2_A90UsuarioFecha, P003A2_A32SatisfaccionFecha
               }
            }
         );
         AV37Pgmname = "ReportEstadoSatisfaccionSatisfaccionWC4";
      ...
      private short AV9SatisfaccionTiempoId ;
      ...
      private short[] P003A2_A8SatisfaccionResueltoId ;
      private short[] P003A2_A9SatisfaccionTecnicoProblemaId ;
      private short[] P003A2_A10SatisfaccionTecnicoCompetenteId ;
      private short[] P003A2_A11SatisfaccionTecnicoProfesionalismoId ;
      private short[] P003A2_A13SatisfaccionAtencionId ;
      private short[] P003A2_A12SatisfaccionTiempoId ;
      private string[] P003A2_A34SatisfaccionSugerencia ;
      private string[] P003A2_A94UsuarioRequerimiento ;
      private string[] P003A2_A93UsuarioNombre ;
      private short[] P003A2_A15UsuarioId ;
      private long[] P003A2_A14TicketId ;
      private long[] P003A2_A7SatisfaccionId ;
      private string[] P003A2_A31SatisfaccionAtencionNombre ;
      private string[] P003A2_A37SatisfaccionTecnicoProfesionalismoNombre ;
      private string[] P003A2_A35SatisfaccionTecnicoCompetenteNombre ;
      private string[] P003A2_A36SatisfaccionTecnicoProblemaNombre ;
      private string[] P003A2_A33SatisfaccionResueltoNombre ;
      private DateTime[] P003A2_A90UsuarioFecha ;
      private DateTime[] P003A2_A32SatisfaccionFecha ;
      private SdtK2BContext AV8Context ;
   }

   public class reportestadosatisfaccionsatisfaccionwc4__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A12SatisfaccionTiempoId )
      {
         ...
         AddWhere(sWhereString, "(T1.[SatisfaccionTiempoId] = @AV9SatisfaccionTiempoId)");
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV9SatisfaccionTiempoId",GXType.Int16,4,0) ,
