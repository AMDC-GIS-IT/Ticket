...
namespace GeneXus.Programs {
   public class wwusuariosistema : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV23K2BToolsGenericSearchField, AV22ClassCollection, AV24OrderedBy, AV8CurrentPage, AV43Pgmname, AV10GridConfiguration, AV38UsuarioSistemaIdentidad_IsAuthorized, AV14Att_UsuarioSistemaId_Visible, AV37Att_UsuarioSistemaIdentidad_Visible, AV15Att_UsuarioSistemaNombre_Visible, AV39Att_UsuarioSistemaGerencia_Visible, AV40Att_UsuarioSistemaDepartamento_Visible, AV11FreezeColumnTitles) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2023124956376", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV31Update)) ? AV45Update_GXI : context.convertURL( context.PathToRelativeUrl( AV31Update))), !bGXsfl_122_Refreshing);
                              ...
                              AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV32Delete)) ? AV46Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV32Delete))), !bGXsfl_122_Refreshing);
      ...
      protected void E19502( )
      {
         ...
         new k2bloadrowsperpage(context ).execute(  AV43Pgmname,  "Grid", out  AV17RowsPerPageVariable, out  AV18RowsPerPageLoaded) ;
      ...
      protected void E20502( )
      {
         ...
         AV44GXV1 = 1;
         while ( AV44GXV1 <= AV28Messages.Count )
         {
            AV29Message = ((GeneXus.Utils.SdtMessages_Message)AV28Messages.Item(AV44GXV1));
         ...
         AV36ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV43Pgmname;
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV19GridStateKey = "";
         new k2bloadgridstate(context ).execute(  AV43Pgmname,  AV19GridStateKey, out  AV20GridState) ;
         ...
         AV47GXV2 = 1;
         while ( AV47GXV2 <= AV20GridState.gxTpr_Filtervalues.Count )
         {
            AV21GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV20GridState.gxTpr_Filtervalues.Item(AV47GXV2));
      ...
      protected void S122( )
      {
         ...
         new k2bsavegridstate(context ).execute(  AV43Pgmname,  AV19GridStateKey,  AV20GridState) ;
      }
      ...
      protected void E13502( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         CallWebObject(formatLink("exportwwusuariosistema.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV23K2BToolsGenericSearchField)),UrlEncode(StringUtil.LTrimStr(AV24OrderedBy,4,0))}, new string[] {"K2BToolsGenericSearchField","OrderedBy"}) );
      ...
      protected void E14502( )
      {
         ...
         if ( AV17RowsPerPageVariable != AV16GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV17RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV43Pgmname,  "Grid",  AV17RowsPerPageVariable) ;
            AV8CurrentPage = 1;
            AssignAttri("", false, "AV8CurrentPage", StringUtil.LTrimStr( (decimal)(AV8CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249563970", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwusuariosistema.js", "?20231249563970", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      protected void sendrow_1222( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_122_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV31Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV31Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV45Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV31Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV31Update)) ? AV45Update_GXI : context.PathToRelativeUrl( AV31Update));
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV32Delete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV32Delete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV46Delete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV32Delete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV32Delete)) ? AV46Delete_GXI : context.PathToRelativeUrl( AV32Delete));
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV38UsuarioSistemaIdentidad_IsAuthorized',fld:'vUSUARIOSISTEMAIDENTIDAD_ISAUTHORIZED',pic:''},{av:'AV22ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV24OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV23K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV43Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14Att_UsuarioSistemaId_Visible',fld:'vATT_USUARIOSISTEMAID_VISIBLE',pic:''},{av:'AV37Att_UsuarioSistemaIdentidad_Visible',fld:'vATT_USUARIOSISTEMAIDENTIDAD_VISIBLE',pic:''},{av:'AV15Att_UsuarioSistemaNombre_Visible',fld:'vATT_USUARIOSISTEMANOMBRE_VISIBLE',pic:''},{av:'AV39Att_UsuarioSistemaGerencia_Visible',fld:'vATT_USUARIOSISTEMAGERENCIA_VISIBLE',pic:''},{av:'AV40Att_UsuarioSistemaDepartamento_Visible',fld:'vATT_USUARIOSISTEMADEPARTAMENTO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOEXPORT'","{handler:'E13502',iparms:[{av:'AV23K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV24OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_UsuarioSistemaId_Visible',fld:'vATT_USUARIOSISTEMAID_VISIBLE',pic:''},{av:'AV37Att_UsuarioSistemaIdentidad_Visible',fld:'vATT_USUARIOSISTEMAIDENTIDAD_VISIBLE',pic:''},{av:'AV15Att_UsuarioSistemaNombre_Visible',fld:'vATT_USUARIOSISTEMANOMBRE_VISIBLE',pic:''},{av:'AV39Att_UsuarioSistemaGerencia_Visible',fld:'vATT_USUARIOSISTEMAGERENCIA_VISIBLE',pic:''},{av:'AV40Att_UsuarioSistemaDepartamento_Visible',fld:'vATT_USUARIOSISTEMADEPARTAMENTO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOEXPORT'",",oparms:[{av:'AV24OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_UsuarioSistemaId_Visible',fld:'vATT_USUARIOSISTEMAID_VISIBLE',pic:''},{av:'AV37Att_UsuarioSistemaIdentidad_Visible',fld:'vATT_USUARIOSISTEMAIDENTIDAD_VISIBLE',pic:''},{av:'AV15Att_UsuarioSistemaNombre_Visible',fld:'vATT_USUARIOSISTEMANOMBRE_VISIBLE',pic:''},{av:'AV39Att_UsuarioSistemaGerencia_Visible',fld:'vATT_USUARIOSISTEMAGERENCIA_VISIBLE',pic:''},{av:'AV40Att_UsuarioSistemaDepartamento_Visible',fld:'vATT_USUARIOSISTEMADEPARTAMENTO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         ...
         setEventMetadata("GRID.REFRESH","{handler:'E21502',iparms:[{av:'AV22ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV24OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV23K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV43Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV38UsuarioSistemaIdentidad_IsAuthorized',fld:'vUSUARIOSISTEMAIDENTIDAD_ISAUTHORIZED',pic:''},{av:'AV14Att_UsuarioSistemaId_Visible',fld:'vATT_USUARIOSISTEMAID_VISIBLE',pic:''},{av:'AV37Att_UsuarioSistemaIdentidad_Visible',fld:'vATT_USUARIOSISTEMAIDENTIDAD_VISIBLE',pic:''},{av:'AV15Att_UsuarioSistemaNombre_Visible',fld:'vATT_USUARIOSISTEMANOMBRE_VISIBLE',pic:''},{av:'AV39Att_UsuarioSistemaGerencia_Visible',fld:'vATT_USUARIOSISTEMAGERENCIA_VISIBLE',pic:''},{av:'AV40Att_UsuarioSistemaDepartamento_Visible',fld:'vATT_USUARIOSISTEMADEPARTAMENTO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E15502',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV23K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV22ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV24OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV43Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV38UsuarioSistemaIdentidad_IsAuthorized',fld:'vUSUARIOSISTEMAIDENTIDAD_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_UsuarioSistemaId_Visible',fld:'vATT_USUARIOSISTEMAID_VISIBLE',pic:''},{av:'AV37Att_UsuarioSistemaIdentidad_Visible',fld:'vATT_USUARIOSISTEMAIDENTIDAD_VISIBLE',pic:''},{av:'AV15Att_UsuarioSistemaNombre_Visible',fld:'vATT_USUARIOSISTEMANOMBRE_VISIBLE',pic:''},{av:'AV39Att_UsuarioSistemaGerencia_Visible',fld:'vATT_USUARIOSISTEMAGERENCIA_VISIBLE',pic:''},{av:'AV40Att_UsuarioSistemaDepartamento_Visible',fld:'vATT_USUARIOSISTEMADEPARTAMENTO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E16502',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV23K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV22ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV24OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV43Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV38UsuarioSistemaIdentidad_IsAuthorized',fld:'vUSUARIOSISTEMAIDENTIDAD_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_UsuarioSistemaId_Visible',fld:'vATT_USUARIOSISTEMAID_VISIBLE',pic:''},{av:'AV37Att_UsuarioSistemaIdentidad_Visible',fld:'vATT_USUARIOSISTEMAIDENTIDAD_VISIBLE',pic:''},{av:'AV15Att_UsuarioSistemaNombre_Visible',fld:'vATT_USUARIOSISTEMANOMBRE_VISIBLE',pic:''},{av:'AV39Att_UsuarioSistemaGerencia_Visible',fld:'vATT_USUARIOSISTEMAGERENCIA_VISIBLE',pic:''},{av:'AV40Att_UsuarioSistemaDepartamento_Visible',fld:'vATT_USUARIOSISTEMADEPARTAMENTO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E17502',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV23K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV22ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV24OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV43Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV38UsuarioSistemaIdentidad_IsAuthorized',fld:'vUSUARIOSISTEMAIDENTIDAD_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_UsuarioSistemaId_Visible',fld:'vATT_USUARIOSISTEMAID_VISIBLE',pic:''},{av:'AV37Att_UsuarioSistemaIdentidad_Visible',fld:'vATT_USUARIOSISTEMAIDENTIDAD_VISIBLE',pic:''},{av:'AV15Att_UsuarioSistemaNombre_Visible',fld:'vATT_USUARIOSISTEMANOMBRE_VISIBLE',pic:''},{av:'AV39Att_UsuarioSistemaGerencia_Visible',fld:'vATT_USUARIOSISTEMAGERENCIA_VISIBLE',pic:''},{av:'AV40Att_UsuarioSistemaDepartamento_Visible',fld:'vATT_USUARIOSISTEMADEPARTAMENTO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E18502',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV23K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV22ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV24OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV43Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV38UsuarioSistemaIdentidad_IsAuthorized',fld:'vUSUARIOSISTEMAIDENTIDAD_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_UsuarioSistemaId_Visible',fld:'vATT_USUARIOSISTEMAID_VISIBLE',pic:''},{av:'AV37Att_UsuarioSistemaIdentidad_Visible',fld:'vATT_USUARIOSISTEMAIDENTIDAD_VISIBLE',pic:''},{av:'AV15Att_UsuarioSistemaNombre_Visible',fld:'vATT_USUARIOSISTEMANOMBRE_VISIBLE',pic:''},{av:'AV39Att_UsuarioSistemaGerencia_Visible',fld:'vATT_USUARIOSISTEMAGERENCIA_VISIBLE',pic:''},{av:'AV40Att_UsuarioSistemaDepartamento_Visible',fld:'vATT_USUARIOSISTEMADEPARTAMENTO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
