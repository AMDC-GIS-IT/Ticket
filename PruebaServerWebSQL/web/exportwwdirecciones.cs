...
namespace GeneXus.Programs {
   public class exportwwdirecciones : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      void executePrivate( )
      {
         ...
         if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "Direcciones",  "Direcciones",  "List",  "",  "WWDirecciones") )
         {
            AV19Filename = "";
            AV20ErrorMessage = "You are not authorized to do activity";
            AV20ErrorMessage += "EntityName:" + "Direcciones";
            AV20ErrorMessage += "TransactionName:" + "Direcciones";
         ...
         AV19Filename = GxDirectory.TemporaryFilesPath + AV22File.Separator + "ExportWWDirecciones-" + StringUtil.Trim( StringUtil.Str( (decimal)(AV17Random), 8, 0)) + ".xlsx";
         ...
         if ( ! context.isAjaxRequest( ) )
         {
            AV21HttpResponse.AppendHeader("Content-Disposition", "attachment;filename=ExportWWDirecciones.xlsx");
         }
         if ( ! context.isAjaxRequest( ) )
         {
      ...
      public override void initialize( )
      {
         ...
         AV28Pgmname = "ExportWWDirecciones";
         /* GeneXus formulas. */
         AV28Pgmname = "ExportWWDirecciones";
         context.Gx_err = 0;
      }
