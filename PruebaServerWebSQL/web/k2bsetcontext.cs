...
namespace GeneXus.Programs {
   public class k2bsetcontext : GXProcedure
   {
      ...
      public void executeSubmit( SdtK2BContext aP0_Context )
      {
         ...
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objk2bsetcontext);
      }
      ...
      void executePrivate( )
      {
         ...
         AV10Data = AV8Context.ToXml(false, true, "K2BContext", "kb_ticket");
