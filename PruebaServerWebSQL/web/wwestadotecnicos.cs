...
namespace GeneXus.Programs {
   public class wwestadotecnicos : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV23K2BToolsGenericSearchField, AV22ClassCollection, AV24OrderedBy, AV8CurrentPage, AV39Pgmname, AV10GridConfiguration, AV30EstadoTecnicosNombre_IsAuthorized, AV14Att_EstadoTecnicosId_Visible, AV15Att_EstadoTecnicosNombre_Visible, AV11FreezeColumnTitles) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249565180", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV31Update)) ? AV41Update_GXI : context.convertURL( context.PathToRelativeUrl( AV31Update))), !bGXsfl_104_Refreshing);
                              ...
                              AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV32Delete)) ? AV42Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV32Delete))), !bGXsfl_104_Refreshing);
      ...
      protected void E195R2( )
      {
         ...
         new k2bloadrowsperpage(context ).execute(  AV39Pgmname,  "Grid", out  AV17RowsPerPageVariable, out  AV18RowsPerPageLoaded) ;
      ...
      protected void E205R2( )
      {
         ...
         AV40GXV1 = 1;
         while ( AV40GXV1 <= AV28Messages.Count )
         {
            AV29Message = ((GeneXus.Utils.SdtMessages_Message)AV28Messages.Item(AV40GXV1));
         ...
         AV36ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV39Pgmname;
         ...
         AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV31Update)) ? AV41Update_GXI : context.convertURL( context.PathToRelativeUrl( AV31Update))), !bGXsfl_104_Refreshing);
         AssignProp("", false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV31Update), true);
         AV41Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "788f9b72-f982-49f9-99e4-c0374e31a85a", "", context.GetTheme( )));
         AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV31Update)) ? AV41Update_GXI : context.convertURL( context.PathToRelativeUrl( AV31Update))), !bGXsfl_104_Refreshing);
         AssignProp("", false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV31Update), true);
         ...
         AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV32Delete)) ? AV42Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV32Delete))), !bGXsfl_104_Refreshing);
         AssignProp("", false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV32Delete), true);
         AV42Delete_GXI = GXDbFile.PathToUrl( context.GetImagePath( "3e4a9f50-2c57-41b6-9da5-ebe49bca33c0", "", context.GetTheme( )));
         AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV32Delete)) ? AV42Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV32Delete))), !bGXsfl_104_Refreshing);
         AssignProp("", false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV32Delete), true);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV19GridStateKey = "";
         new k2bloadgridstate(context ).execute(  AV39Pgmname,  AV19GridStateKey, out  AV20GridState) ;
         ...
         AV43GXV2 = 1;
         while ( AV43GXV2 <= AV20GridState.gxTpr_Filtervalues.Count )
         {
            AV21GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV20GridState.gxTpr_Filtervalues.Item(AV43GXV2));
      ...
      protected void S122( )
      {
         ...
         new k2bsavegridstate(context ).execute(  AV39Pgmname,  AV19GridStateKey,  AV20GridState) ;
      }
      ...
      protected void E135R2( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         CallWebObject(formatLink("exportwwestadotecnicos.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV23K2BToolsGenericSearchField)),UrlEncode(StringUtil.LTrimStr(AV24OrderedBy,4,0))}, new string[] {"K2BToolsGenericSearchField","OrderedBy"}) );
      ...
      protected void S192( )
      {
         ...
         AssignAttri("", false, "AV15Att_EstadoTecnicosNombre_Visible", AV15Att_EstadoTecnicosNombre_Visible);
         new k2bsavegridconfiguration(context ).execute(  AV39Pgmname,  "Grid",  AV10GridConfiguration,  false) ;
         AV44GXV3 = 1;
      ...
      protected void E145R2( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  AV39Pgmname,  "Grid", ref  AV10GridConfiguration) ;
         AV45GXV4 = 1;
         ...
         new k2bsavegridconfiguration(context ).execute(  AV39Pgmname,  "Grid",  AV10GridConfiguration,  true) ;
         AV27UC_OrderedBy = AV24OrderedBy;
         AssignAttri("", false, "AV27UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV27UC_OrderedBy), 4, 0));
         if ( AV17RowsPerPageVariable != AV16GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV17RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV39Pgmname,  "Grid",  AV17RowsPerPageVariable) ;
            AV8CurrentPage = 1;
            AssignAttri("", false, "AV8CurrentPage", StringUtil.LTrimStr( (decimal)(AV8CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249565386", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwestadotecnicos.js", "?20231249565386", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      protected void sendrow_1042( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_104_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV31Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV31Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV41Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV31Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV31Update)) ? AV41Update_GXI : context.PathToRelativeUrl( AV31Update));
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV32Delete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV32Delete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV42Delete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV32Delete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV32Delete)) ? AV42Delete_GXI : context.PathToRelativeUrl( AV32Delete));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOEXPORT'","{handler:'E135R2',iparms:[{av:'AV23K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV24OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_EstadoTecnicosId_Visible',fld:'vATT_ESTADOTECNICOSID_VISIBLE',pic:''},{av:'AV15Att_EstadoTecnicosNombre_Visible',fld:'vATT_ESTADOTECNICOSNOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOEXPORT'",",oparms:[{av:'AV24OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_EstadoTecnicosId_Visible',fld:'vATT_ESTADOTECNICOSID_VISIBLE',pic:''},{av:'AV15Att_EstadoTecnicosNombre_Visible',fld:'vATT_ESTADOTECNICOSNOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E145R2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV23K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV22ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV24OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV30EstadoTecnicosNombre_IsAuthorized',fld:'vESTADOTECNICOSNOMBRE_ISAUTHORIZED',pic:''},{av:'AV17RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV16GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EstadoTecnicosId_Visible',fld:'vATT_ESTADOTECNICOSID_VISIBLE',pic:''},{av:'AV15Att_EstadoTecnicosNombre_Visible',fld:'vATT_ESTADOTECNICOSNOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E155R2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV23K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV22ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV24OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV30EstadoTecnicosNombre_IsAuthorized',fld:'vESTADOTECNICOSNOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EstadoTecnicosId_Visible',fld:'vATT_ESTADOTECNICOSID_VISIBLE',pic:''},{av:'AV15Att_EstadoTecnicosNombre_Visible',fld:'vATT_ESTADOTECNICOSNOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E165R2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV23K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV22ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV24OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV30EstadoTecnicosNombre_IsAuthorized',fld:'vESTADOTECNICOSNOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EstadoTecnicosId_Visible',fld:'vATT_ESTADOTECNICOSID_VISIBLE',pic:''},{av:'AV15Att_EstadoTecnicosNombre_Visible',fld:'vATT_ESTADOTECNICOSNOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E175R2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV23K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV22ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV24OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV30EstadoTecnicosNombre_IsAuthorized',fld:'vESTADOTECNICOSNOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EstadoTecnicosId_Visible',fld:'vATT_ESTADOTECNICOSID_VISIBLE',pic:''},{av:'AV15Att_EstadoTecnicosNombre_Visible',fld:'vATT_ESTADOTECNICOSNOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E185R2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV23K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV22ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV24OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV30EstadoTecnicosNombre_IsAuthorized',fld:'vESTADOTECNICOSNOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EstadoTecnicosId_Visible',fld:'vATT_ESTADOTECNICOSID_VISIBLE',pic:''},{av:'AV15Att_EstadoTecnicosNombre_Visible',fld:'vATT_ESTADOTECNICOSNOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
