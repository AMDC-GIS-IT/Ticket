...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="K2BPersistedMenuOutput" , Namespace="kb_ticket" )]
	[Serializable]
	public class SdtK2BPersistedMenuOutput : GxUserType
	{
		...
		public GXBaseCollection<GeneXus.Programs.SdtK2BMultiLevelPersistedMenu_K2BMultiLevelPersistedMenuItem> gxTpr_Persistedmenu_GXBaseCollection
		{
			...
			set {
				...
				gxTv_SdtK2BPersistedMenuOutput_Persistedmenu_N = 0;
		...
		{
			gxTv_SdtK2BPersistedMenuOutput_Persistedmenu_N = 1;
		...
		protected short gxTv_SdtK2BPersistedMenuOutput_Persistedmenu_N;
	...
	[GxUnWrappedJson()]
	[DataContract(Name=@"K2BPersistedMenuOutput", Namespace="kb_ticket")]
