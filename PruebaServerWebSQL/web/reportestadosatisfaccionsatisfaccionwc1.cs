...
namespace GeneXus.Programs {
   public class reportestadosatisfaccionsatisfaccionwc1 : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV9SatisfaccionTecnicoProblemaId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      public reportestadosatisfaccionsatisfaccionwc1( )
      {
      ...
      public reportestadosatisfaccionsatisfaccionwc1( IGxContext context )
      {
      ...
      {
         this.AV9SatisfaccionTecnicoProblemaId = aP0_SatisfaccionTecnicoProblemaId;
      ...
      public void executeSubmit( short aP0_SatisfaccionTecnicoProblemaId ,
                                 ...
                                 short aP11_OrderedBy )
      {
         reportestadosatisfaccionsatisfaccionwc1 objreportestadosatisfaccionsatisfaccionwc1;
         objreportestadosatisfaccionsatisfaccionwc1 = new reportestadosatisfaccionsatisfaccionwc1();
         objreportestadosatisfaccionsatisfaccionwc1.AV9SatisfaccionTecnicoProblemaId = aP0_SatisfaccionTecnicoProblemaId;
         objreportestadosatisfaccionsatisfaccionwc1.AV17SatisfaccionFecha_From = aP1_SatisfaccionFecha_From;
         objreportestadosatisfaccionsatisfaccionwc1.AV18SatisfaccionFecha_To = aP2_SatisfaccionFecha_To;
         objreportestadosatisfaccionsatisfaccionwc1.AV20UsuarioFecha_From = aP3_UsuarioFecha_From;
         objreportestadosatisfaccionsatisfaccionwc1.AV21UsuarioFecha_To = aP4_UsuarioFecha_To;
         objreportestadosatisfaccionsatisfaccionwc1.AV22SatisfaccionResueltoNombre = aP5_SatisfaccionResueltoNombre;
         objreportestadosatisfaccionsatisfaccionwc1.AV23SatisfaccionTecnicoCompetenteNombre = aP6_SatisfaccionTecnicoCompetenteNombre;
         objreportestadosatisfaccionsatisfaccionwc1.AV24SatisfaccionTecnicoProfesionalismoNombre = aP7_SatisfaccionTecnicoProfesionalismoNombre;
         objreportestadosatisfaccionsatisfaccionwc1.AV25SatisfaccionTiempoNombre = aP8_SatisfaccionTiempoNombre;
         objreportestadosatisfaccionsatisfaccionwc1.AV26SatisfaccionAtencionNombre = aP9_SatisfaccionAtencionNombre;
         objreportestadosatisfaccionsatisfaccionwc1.AV10K2BToolsGenericSearchField = aP10_K2BToolsGenericSearchField;
         objreportestadosatisfaccionsatisfaccionwc1.AV11OrderedBy = aP11_OrderedBy;
         objreportestadosatisfaccionsatisfaccionwc1.context.SetSubmitInitialConfig(context);
         objreportestadosatisfaccionsatisfaccionwc1.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objreportestadosatisfaccionsatisfaccionwc1);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((reportestadosatisfaccionsatisfaccionwc1)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
         ...
         try
         {
            ...
            else
            {
               ...
               pr_default.dynParam(0, new Object[]{ new Object[]{
                                                    ...
                                                    AV11OrderedBy ,
                                                    AV9SatisfaccionTecnicoProblemaId ,
               ...
               lV10K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV10K2BToolsGenericSearchField), 200, "%");
               /* Using cursor P00372 */
               pr_default.execute(0, new Object[] {AV9SatisfaccionTecnicoProblemaId, AV18SatisfaccionFecha_To, AV17SatisfaccionFecha_From, AV21UsuarioFecha_To, AV20UsuarioFecha_From, lV22SatisfaccionResueltoNombre, lV23SatisfaccionTecnicoCompetenteNombre, lV24SatisfaccionTecnicoProfesionalismoNombre, lV25SatisfaccionTiempoNombre, lV26SatisfaccionAtencionNombre, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField});
               while ( (pr_default.getStatus(0) != 101) )
               {
                  A8SatisfaccionResueltoId = P00372_A8SatisfaccionResueltoId[0];
                  A10SatisfaccionTecnicoCompetenteId = P00372_A10SatisfaccionTecnicoCompetenteId[0];
                  A11SatisfaccionTecnicoProfesionalismoId = P00372_A11SatisfaccionTecnicoProfesionalismoId[0];
                  A12SatisfaccionTiempoId = P00372_A12SatisfaccionTiempoId[0];
                  A13SatisfaccionAtencionId = P00372_A13SatisfaccionAtencionId[0];
                  A9SatisfaccionTecnicoProblemaId = P00372_A9SatisfaccionTecnicoProblemaId[0];
                  A34SatisfaccionSugerencia = P00372_A34SatisfaccionSugerencia[0];
                  A94UsuarioRequerimiento = P00372_A94UsuarioRequerimiento[0];
                  A93UsuarioNombre = P00372_A93UsuarioNombre[0];
                  A15UsuarioId = P00372_A15UsuarioId[0];
                  A14TicketId = P00372_A14TicketId[0];
                  A7SatisfaccionId = P00372_A7SatisfaccionId[0];
                  A31SatisfaccionAtencionNombre = P00372_A31SatisfaccionAtencionNombre[0];
                  A38SatisfaccionTiempoNombre = P00372_A38SatisfaccionTiempoNombre[0];
                  A37SatisfaccionTecnicoProfesionalismoNombre = P00372_A37SatisfaccionTecnicoProfesionalismoNombre[0];
                  A35SatisfaccionTecnicoCompetenteNombre = P00372_A35SatisfaccionTecnicoCompetenteNombre[0];
                  A33SatisfaccionResueltoNombre = P00372_A33SatisfaccionResueltoNombre[0];
                  A90UsuarioFecha = P00372_A90UsuarioFecha[0];
                  A32SatisfaccionFecha = P00372_A32SatisfaccionFecha[0];
                  A33SatisfaccionResueltoNombre = P00372_A33SatisfaccionResueltoNombre[0];
                  A35SatisfaccionTecnicoCompetenteNombre = P00372_A35SatisfaccionTecnicoCompetenteNombre[0];
                  A37SatisfaccionTecnicoProfesionalismoNombre = P00372_A37SatisfaccionTecnicoProfesionalismoNombre[0];
                  A38SatisfaccionTiempoNombre = P00372_A38SatisfaccionTiempoNombre[0];
      ...
      protected void H370( bool bFoot ,
                           int Inc )
      {
      ...
      public override void initialize( )
      {
         ...
         A94UsuarioRequerimiento = "";
         A34SatisfaccionSugerencia = "";
         P00372_A8SatisfaccionResueltoId = new short[1] ;
         P00372_A10SatisfaccionTecnicoCompetenteId = new short[1] ;
         P00372_A11SatisfaccionTecnicoProfesionalismoId = new short[1] ;
         P00372_A12SatisfaccionTiempoId = new short[1] ;
         P00372_A13SatisfaccionAtencionId = new short[1] ;
         P00372_A9SatisfaccionTecnicoProblemaId = new short[1] ;
         P00372_A34SatisfaccionSugerencia = new string[] {""} ;
         P00372_A94UsuarioRequerimiento = new string[] {""} ;
         P00372_A93UsuarioNombre = new string[] {""} ;
         P00372_A15UsuarioId = new short[1] ;
         P00372_A14TicketId = new long[1] ;
         P00372_A7SatisfaccionId = new long[1] ;
         P00372_A31SatisfaccionAtencionNombre = new string[] {""} ;
         P00372_A38SatisfaccionTiempoNombre = new string[] {""} ;
         P00372_A37SatisfaccionTecnicoProfesionalismoNombre = new string[] {""} ;
         P00372_A35SatisfaccionTecnicoCompetenteNombre = new string[] {""} ;
         P00372_A33SatisfaccionResueltoNombre = new string[] {""} ;
         P00372_A90UsuarioFecha = new DateTime[] {DateTime.MinValue} ;
         P00372_A32SatisfaccionFecha = new DateTime[] {DateTime.MinValue} ;
         Gx_date = DateTime.MinValue;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportestadosatisfaccionsatisfaccionwc1__default(),
            new Object[][] {
                new Object[] {
               P00372_A8SatisfaccionResueltoId, P00372_A10SatisfaccionTecnicoCompetenteId, P00372_A11SatisfaccionTecnicoProfesionalismoId, P00372_A12SatisfaccionTiempoId, P00372_A13SatisfaccionAtencionId, P00372_A9SatisfaccionTecnicoProblemaId, P00372_A34SatisfaccionSugerencia, P00372_A94UsuarioRequerimiento, P00372_A93UsuarioNombre, P00372_A15UsuarioId,
               P00372_A14TicketId, P00372_A7SatisfaccionId, P00372_A31SatisfaccionAtencionNombre, P00372_A38SatisfaccionTiempoNombre, P00372_A37SatisfaccionTecnicoProfesionalismoNombre, P00372_A35SatisfaccionTecnicoCompetenteNombre, P00372_A33SatisfaccionResueltoNombre, P00372_A90UsuarioFecha, P00372_A32SatisfaccionFecha
               }
            }
         );
         AV37Pgmname = "ReportEstadoSatisfaccionSatisfaccionWC1";
      ...
      private short AV9SatisfaccionTecnicoProblemaId ;
      ...
      private short[] P00372_A8SatisfaccionResueltoId ;
      private short[] P00372_A10SatisfaccionTecnicoCompetenteId ;
      private short[] P00372_A11SatisfaccionTecnicoProfesionalismoId ;
      private short[] P00372_A12SatisfaccionTiempoId ;
      private short[] P00372_A13SatisfaccionAtencionId ;
      private short[] P00372_A9SatisfaccionTecnicoProblemaId ;
      private string[] P00372_A34SatisfaccionSugerencia ;
      private string[] P00372_A94UsuarioRequerimiento ;
      private string[] P00372_A93UsuarioNombre ;
      private short[] P00372_A15UsuarioId ;
      private long[] P00372_A14TicketId ;
      private long[] P00372_A7SatisfaccionId ;
      private string[] P00372_A31SatisfaccionAtencionNombre ;
      private string[] P00372_A38SatisfaccionTiempoNombre ;
      private string[] P00372_A37SatisfaccionTecnicoProfesionalismoNombre ;
      private string[] P00372_A35SatisfaccionTecnicoCompetenteNombre ;
      private string[] P00372_A33SatisfaccionResueltoNombre ;
      private DateTime[] P00372_A90UsuarioFecha ;
      private DateTime[] P00372_A32SatisfaccionFecha ;
      private SdtK2BContext AV8Context ;
   }

   public class reportestadosatisfaccionsatisfaccionwc1__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P00372( IGxContext context ,
                                             ...
                                             short AV11OrderedBy ,
                                             short AV9SatisfaccionTecnicoProblemaId ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00372(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (short)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] , (short)dynConstraints[25] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV9SatisfaccionTecnicoProblemaId",GXType.Int16,4,0) ,
