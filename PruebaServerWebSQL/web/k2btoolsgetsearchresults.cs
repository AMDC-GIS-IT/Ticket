...
namespace GeneXus.Programs {
   public class k2btoolsgetsearchresults : GXProcedure
   {
                           ...
                           out GXBaseCollection<SdtK2BSearchResult_Item> aP6_K2BSearchResult )
      {
         ...
         this.AV16K2BSearchResult = new GXBaseCollection<SdtK2BSearchResult_Item>( context, "Item", "kb_ticket") ;
         initialize();
         executePrivate();
                                 ...
                                 out GXBaseCollection<SdtK2BSearchResult_Item> aP6_K2BSearchResult )
      {
         ...
         objk2btoolsgetsearchresults.AV16K2BSearchResult = new GXBaseCollection<SdtK2BSearchResult_Item>( context, "Item", "kb_ticket") ;
      ...
      {
         AV16K2BSearchResult = new GXBaseCollection<SdtK2BSearchResult_Item>( context, "Item", "kb_ticket");
         AV9SearchableTransactions = new GXBaseCollection<SdtSearchableTransactions_SearchableTransactionsItem>( context, "SearchableTransactionsItem", "kb_ticket");
