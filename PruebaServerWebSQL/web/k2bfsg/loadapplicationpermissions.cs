...
namespace GeneXus.Programs.k2bfsg {
   public class loadapplicationpermissions : GXProcedure
   {
                           ...
                           out GXBaseCollection<SdtMessages_Message> aP1_Messages )
      {
         ...
         this.AV9Messages = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus") ;
         initialize();
         executePrivate();
         aP1_Messages=this.AV9Messages;
      }

      public GXBaseCollection<SdtMessages_Message> executeUdp( long aP0_ApplicationId )
      {
                                 ...
                                 out GXBaseCollection<SdtMessages_Message> aP1_Messages )
      {
         ...
         objloadapplicationpermissions.AV9Messages = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus") ;
         objloadapplicationpermissions.context.SetSubmitInitialConfig(context);
         objloadapplicationpermissions.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objloadapplicationpermissions);
         aP1_Messages=this.AV9Messages;
      }
      ...
      void executePrivate( )
      {
         ...
         AV24GXV1 = 1;
         while ( AV24GXV1 <= AV11ActivityList.Count )
         {
            AV10Activity = ((SdtK2BActivityList_K2BActivityListItem)AV11ActivityList.Item(AV24GXV1));
            if ( StringUtil.StrCmp(AV10Activity.gxTpr_Activity.gxTpr_Standardactivitytype, "Maintenance") != 0 )
            {
               ...
               if ( ( AV15Errors.Count == 1 ) && ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV15Errors.Item(1)).gxTpr_Code == 153 ) )
               {
                  ...
                  if ( AV18isOK )
                  {
                     ...
                     AV16Message.gxTpr_Description = StringUtil.Format( "K2BT_GAM_PermissionAddedSuccessfully", AV17permissionName, "", "", "", "", "", "", "", "");
                  ...
                  else
                  {
                     ...
                     {
                        AV16Message = new GeneXus.Utils.SdtMessages_Message(context);
                        AV16Message.gxTpr_Description = StringUtil.Format( "K2BT_GAM_ErrorWhenAddingPermission", AV17permissionName, "", "", "", "", "", "", "", "");
                        AV9Messages.Add(AV16Message, 0);
         ...
         AV16Message = new GeneXus.Utils.SdtMessages_Message(context);
         AV16Message.gxTpr_Description = StringUtil.Format( "Ejecución finalizada: %3 permisos ya existían. %1 permisos creados. No fue posible crear %2 permisos", StringUtil.LTrimStr( (decimal)(AV19correctInserts), 4, 0), StringUtil.LTrimStr( (decimal)(AV20failedInserts), 4, 0), StringUtil.LTrimStr( (decimal)(AV21existingPermissions), 4, 0), "", "", "", "", "", "");
         AV9Messages.Add(AV16Message, 0);
      ...
      protected void S111( )
      {
         ...
         returnInSub = false;
         AV25GXV2 = 1;
         while ( AV25GXV2 <= AV15Errors.Count )
         {
            AV14Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV15Errors.Item(AV25GXV2));
            AV16Message = new GeneXus.Utils.SdtMessages_Message(context);
      ...
      public override void initialize( )
      {
         ...
         GXt_objcol_SdtK2BActivityList_K2BActivityListItem1 = new GXBaseCollection<SdtK2BActivityList_K2BActivityListItem>( context, "K2BActivityListItem", "kb_ticket");
         ...
         pr_datastore2 = new DataStoreProvider(context, new GeneXus.Programs.k2bfsg.loadapplicationpermissions__datastore2(),
            new Object[][] {
            }
         );
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.k2bfsg.loadapplicationpermissions__datastore1(),
            new Object[][] {
            }
         );
   ...
   public class loadapplicationpermissions__datastore2 : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class loadapplicationpermissions__datastore1 : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
