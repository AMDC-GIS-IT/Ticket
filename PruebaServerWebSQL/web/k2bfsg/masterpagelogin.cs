...
namespace GeneXus.Programs.k2bfsg {
   public class masterpagelogin : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      public masterpagelogin( )
      {
      ...
      public masterpagelogin( IGxContext context )
      {
      ...
      protected void RenderHtmlCloseForm3S2( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/masterpagelogin.js", "?20231249544653", false, true);
      ...
      {
         return "K2BFSG.MasterPageLogin" ;
      }

      public override string GetPgmdesc( )
      {
         return "Master Page Login" ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?20231249544656", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("k2bfsg/masterpagelogin.js", "?20231249544656", false, true);
         }
