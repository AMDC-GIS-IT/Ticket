...
namespace GeneXus.Programs.k2bfsg {
   public class k2btoolsaccessdenied : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.SendWebValue( "Acceso denegado") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2023124954376", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB3T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPgmdescriptortextblock_Internalname, "Access Denied", "", "", lblPgmdescriptortextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\K2BToolsAccessDenied.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divSection1_Internalname, 1, 0, "px", 0, "px", "K2BToolsSection_NotAuthorizedContent", "left", "top", "", "", "div");
            /* Static images/pictures */
            ClassString = "K2BToolsImage_NotAuthorizedIcon";
            StyleString = "";
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divSection2_Internalname, 1, 0, "px", 0, "px", "K2BToolsSection_NotAuthorizedContentInner", "left", "top", "", "", "div");
            /* Text block */
            ...
            GxWebStd.gx_single_line_edit( context, edtavLogin_againaction_Internalname, StringUtil.RTrim( AV5Login_AgainAction), StringUtil.RTrim( context.localUtil.Format( AV5Login_AgainAction, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+"e113t1_client"+"'", "", "", "", "", edtavLogin_againaction_Jsonclick, 7, "TextBlock_FloatRight", "", "", "", "", 1, edtavLogin_againaction_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, false, "", "left", true, "", "HLP_K2BFSG\\K2BToolsAccessDenied.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void E123T2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV5Login_AgainAction = "Ingresar como otro usuario";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249543713", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/k2btoolsaccessdenied.js", "?20231249543713", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'LOGINAGAIN'","{handler:'E113T1',iparms:[]");
