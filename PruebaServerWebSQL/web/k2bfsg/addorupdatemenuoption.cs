...
namespace GeneXus.Programs.k2bfsg {
   public class addorupdatemenuoption : GXProcedure
   {
      ...
      public void execute( long aP0_ApplicationId ,
                           ...
                           string aP4_MenuType ,
                           long aP5_SubMenuId ,
                           out GXBaseCollection<SdtMessages_Message> aP6_Errors ,
                           out bool aP7_Result )
      {
         ...
         this.AV11Errors = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus") ;
                                 ...
                                 out bool aP7_Result )
      {
         ...
         objaddorupdatemenuoption.AV11Errors = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus") ;
      ...
      {
         AV11Errors = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
      ...
      private GXBaseCollection<SdtMessages_Message> aP6_Errors ;
      ...
      private GXBaseCollection<SdtMessages_Message> AV11Errors ;
