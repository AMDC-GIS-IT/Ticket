...
namespace GeneXus.Programs.k2bfsg {
   public class getmenubyname : GXProcedure
   {
                                 ...
                                 out GeneXus.Programs.genexussecurity.SdtGAMApplicationMenu aP2_ApplicationMenu )
      {
         ...
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objgetmenubyname);
         aP2_ApplicationMenu=this.AV9ApplicationMenu;
      }
      ...
      void executePrivate( )
      {
         ...
         AV17GXV2 = 1;
         AV16GXV1 = AV8Application.getmenus(AV13MenuFilter, out  AV12GAMErrors);
         while ( AV17GXV2 <= AV16GXV1.Count )
         {
            AV10ApplicationMenuItem = ((GeneXus.Programs.genexussecurity.SdtGAMApplicationMenu)AV16GXV1.Item(AV17GXV2));
      ...
      public override void initialize( )
      {
         ...
         AV13MenuFilter = new GeneXus.Programs.genexussecurity.SdtGAMApplicationMenuFilter(context);
         AV16GXV1 = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplicationMenu>( context, "GeneXus.Programs.genexussecurity.SdtGAMApplicationMenu", "GeneXus.Programs");
      ...
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplicationMenu> AV16GXV1 ;
