...
namespace GeneXus.Programs.k2bfsg {
   public class login : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249545156", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "GRIDAUTHTYPES.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 26), "'SELECTAUTHENTICATIONTYPE'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 26), "'SELECTAUTHENTICATIONTYPE'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 26), "'SELECTAUTHENTICATIONTYPE'") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtavImageauthtype_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV67ImageAuthType)) ? AV89Imageauthtype_GXI : context.convertURL( context.PathToRelativeUrl( AV67ImageAuthType))), !bGXsfl_27_Refreshing);
      ...
      protected void S112( )
      {
         ...
         AV84GXV1 = 1;
         while ( AV84GXV1 <= AV12AuthenticationTypes.Count )
         {
            AV11AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV12AuthenticationTypes.Item(AV84GXV1));
      ...
      protected void S182( )
      {
         ...
         AV28ErrorCount = 0;
         AV85GXV2 = 1;
         while ( AV85GXV2 <= AV29Errors.Count )
         {
            AV27Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV29Errors.Item(AV85GXV2));
         ...
         {
            AV86GXV3 = 1;
            while ( AV86GXV3 <= AV29Errors.Count )
            {
               AV27Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV29Errors.Item(AV86GXV3));
      ...
      protected void S172( )
      {
         ...
         if ( StringUtil.StrCmp(AV20CaptchaRequiredText, "true") == 0 )
         {
            ...
            AssignProp("", false, imgavCaptchaimage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV17CaptchaImage)) ? AV87Captchaimage_GXI : context.convertURL( context.PathToRelativeUrl( AV17CaptchaImage))), true);
            AssignProp("", false, imgavCaptchaimage_Internalname, "SrcSet", context.GetImageSrcSet( AV17CaptchaImage), true);
            AV87Captchaimage_GXI = GXDbFile.PathToUrl( "data:image/jpeg;charset=utf-8;base64,"+AV14Base64String);
            AssignProp("", false, imgavCaptchaimage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV17CaptchaImage)) ? AV87Captchaimage_GXI : context.convertURL( context.PathToRelativeUrl( AV17CaptchaImage))), true);
            AssignProp("", false, imgavCaptchaimage_Internalname, "SrcSet", context.GetImageSrcSet( AV17CaptchaImage), true);
         }
         else
      ...
      private void E163R2( )
      {
         ...
         AV88GXV4 = 1;
         while ( AV88GXV4 <= AV12AuthenticationTypes.Count )
         {
            AV11AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV12AuthenticationTypes.Item(AV88GXV4));
            if ( ! AV11AuthenticationType.gxTpr_Needusername )
            {
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11AuthenticationType.gxTpr_Smallimagename)) )
               {
                  ...
                  AV89Imageauthtype_GXI = GXDbFile.PathToUrl( AV11AuthenticationType.gxTpr_Smallimagename);
               }
               else
               {
                  AV67ImageAuthType = context.GetImagePath( "6cdd3e18-cc5b-44e0-bd22-3efaf48a6c40", "", context.GetTheme( ));
                  AssignAttri("", false, edtavImageauthtype_Internalname, AV67ImageAuthType);
                  AV89Imageauthtype_GXI = GXDbFile.PathToUrl( context.GetImagePath( "6cdd3e18-cc5b-44e0-bd22-3efaf48a6c40", "", context.GetTheme( )));
               }
      ...
      protected void S202( )
      {
         ...
         new prcgettecnicoid(context ).execute(  AV59UserName, out  AV72ResponsableId, out  AV73ResponsableIdentidad, out  AV75ResponsableNombre, out  AV76ResponsableEmail, out  AV74ResponsableCargo) ;
      ...
      protected void wb_table2_92_3R2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            ClassString = "Image";
            StyleString = "";
            AV17CaptchaImage_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV17CaptchaImage))&&String.IsNullOrEmpty(StringUtil.RTrim( AV87Captchaimage_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV17CaptchaImage)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV17CaptchaImage)) ? AV87Captchaimage_GXI : context.PathToRelativeUrl( AV17CaptchaImage));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249551610", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/login.js", "?20231249551614", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      protected void sendrow_272( )
      {
         ...
         ClassString = "Fixed30";
         StyleString = "";
         AV67ImageAuthType_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV67ImageAuthType))&&String.IsNullOrEmpty(StringUtil.RTrim( AV89Imageauthtype_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV67ImageAuthType)));
         sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV67ImageAuthType)) ? AV89Imageauthtype_GXI : context.PathToRelativeUrl( AV67ImageAuthType));
      ...
      private string AV89Imageauthtype_GXI ;
      private string AV87Captchaimage_GXI ;
