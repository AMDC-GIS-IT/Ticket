...
namespace GeneXus.Programs.k2bfsg {
   public class persistmenusingam : GXProcedure
   {
                           ...
                           out bool aP2_Result )
      {
         ...
         this.AV19Messages = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus") ;
                                 ...
                                 out bool aP2_Result )
      {
         ...
         objpersistmenusingam.AV19Messages = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus") ;
      ...
      void executePrivate( )
      {
         ...
         while ( AV30GXV1 <= AV22PersistedMenuOutputCollection.Count )
         {
            ...
            if ( AV16MenuResult )
            {
               ...
               if ( AV20NewMenu )
               {
                  ...
                  AV18Message.gxTpr_Description = StringUtil.Format( "Menú %1 creado", AV21PersistedMenuOutput.gxTpr_Menucode, "", "", "", "", "", "", "", "");
               ...
               {
                  AV18Message = new GeneXus.Utils.SdtMessages_Message(context);
                  AV18Message.gxTpr_Description = StringUtil.Format( "Menú %1 actualizado", AV21PersistedMenuOutput.gxTpr_Menucode, "", "", "", "", "", "", "", "");
                  AV19Messages.Add(AV18Message, 0);
            ...
            else
            {
               ...
               {
                  AV18Message = new GeneXus.Utils.SdtMessages_Message(context);
                  AV18Message.gxTpr_Description = StringUtil.Format( "Menú %1 no pudo ser creado", AV21PersistedMenuOutput.gxTpr_Menucode, "", "", "", "", "", "", "", "");
                  AV19Messages.Add(AV18Message, 0);
               ...
               {
                  AV18Message = new GeneXus.Utils.SdtMessages_Message(context);
                  AV18Message.gxTpr_Description = StringUtil.Format( "Menú %1 no pudo ser actualizado", AV21PersistedMenuOutput.gxTpr_Menucode, "", "", "", "", "", "", "", "");
                  AV19Messages.Add(AV18Message, 0);
         ...
         {
            AV18Message = new GeneXus.Utils.SdtMessages_Message(context);
            AV18Message.gxTpr_Description = StringUtil.Format( "Ejecutado con éxito. Insertados: %1, Actualizados: %2", StringUtil.LTrimStr( (decimal)(AV15MenuInserted), 4, 0), StringUtil.LTrimStr( (decimal)(AV17MenuUpdated), 4, 0), "", "", "", "", "", "", "");
            AV19Messages.Add(AV18Message, 0);
         }
         else
         {
      ...
      {
         AV19Messages = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
         ...
         AV10Errors = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
         AV18Message = new GeneXus.Utils.SdtMessages_Message(context);
      ...
      private GXBaseCollection<SdtMessages_Message> AV10Errors ;
