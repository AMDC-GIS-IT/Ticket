...
namespace GeneXus.Programs.k2bfsg {
   public class entrymenuoption : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249554863", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB4O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavOptiondescription_Internalname, "Descripción", "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, cmbavMenusid_Internalname, "Sub-menú", "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavResourceparameters_Internalname, "Parámetros", "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavImageurl_Internalname, "URL de imágenes", "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpResponsive_Internalname, "Configuración Responsive Web Design", 1, 0, "px", 0, "px", "Group_Tabular", "", "HLP_K2BFSG\\EntryMenuOption.htm");
            /* Div Control */
      ...
      protected void START4O2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Opción de menú", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void E124O2( )
      {
         ...
         S122 ();
         if (returnInSub) return;
         imgOptionguid_var_contexthelpimage_Tooltiptext = "Si se deja vacío, será generado automáticamente.";
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            Form.Caption = "Agregar opción de menú";
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
         }
         if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            Form.Caption = "Actualizar opción de menú";
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
         }
         if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
         {
            Form.Caption = "Borrar opción de menú";
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
         }
         if ( StringUtil.StrCmp(Gx_mode, "DSP") == 0 )
         {
            Form.Caption = "Opción de menú";
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
         }
      }
      ...
      protected void S152( )
      {
         ...
         if ( AV18IsOk )
         {
            ...
            if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
            {
               AV27Message.gxTpr_Description = StringUtil.Format( "La opción de menú %1 fue creada", AV30OptionName, "", "", "", "", "", "", "", "");
            }
            if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
            {
               AV27Message.gxTpr_Description = StringUtil.Format( "La opción de menú %1 fue actualizada", AV30OptionName, "", "", "", "", "", "", "", "");
            }
            if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
            {
               AV27Message.gxTpr_Description = StringUtil.Format( "La opción de menú %1 fue borrada", AV30OptionName, "", "", "", "", "", "", "", "");
            }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249555789", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/entrymenuoption.js", "?20231249555790", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
