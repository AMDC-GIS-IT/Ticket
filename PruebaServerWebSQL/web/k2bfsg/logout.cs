...
namespace GeneXus.Programs.k2bfsg {
   public class logout : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249545316", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB4A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_6_4A2( true) ;
         }
         else
         {
            wb_table1_6_4A2( false) ;
         }
         return  ;
      }

      protected void wb_table1_6_4A2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START4A2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Cerrar sesión", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void E114A2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV9ConfirmMessage = "Está seguro que desea salir?";
         AssignAttri("", false, "AV9ConfirmMessage", AV9ConfirmMessage);
      }
      ...
      protected void wb_table1_6_4A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_9_4A2( true) ;
         }
         else
         {
            wb_table2_9_4A2( false) ;
         }
         return  ;
      }

      protected void wb_table2_9_4A2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            wb_table1_6_4A2e( true) ;
         }
         else
         {
            wb_table1_6_4A2e( false) ;
         }
      }

      protected void wb_table2_9_4A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table3_12_4A2( true) ;
         }
         else
         {
            wb_table3_12_4A2( false) ;
         }
         return  ;
      }

      protected void wb_table3_12_4A2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_9_4A2e( true) ;
         }
         else
         {
            wb_table2_9_4A2e( false) ;
         }
      }

      protected void wb_table3_12_4A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table4_19_4A2( true) ;
         }
         else
         {
            wb_table4_19_4A2( false) ;
         }
         return  ;
      }

      protected void wb_table4_19_4A2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_12_4A2e( true) ;
         }
         else
         {
            wb_table3_12_4A2e( false) ;
         }
      }

      protected void wb_table4_19_4A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttI_buttonconfirmyes_Internalname, "", "Aceptar", bttI_buttonconfirmyes_Jsonclick, 5, "Aceptar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CONFIRMYES\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\Logout.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 24,'',false,'',0)\"";
            ClassString = "Button_Standard";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttI_buttonconfirmno_Internalname, "", "Cancelar", bttI_buttonconfirmno_Jsonclick, 5, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CONFIRMNO\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\Logout.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_19_4A2e( true) ;
         }
         else
         {
            wb_table4_19_4A2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249545324", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/logout.js", "?20231249545324", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'CONFIRMYES'","{handler:'E124A2',iparms:[]");
         setEventMetadata("'CONFIRMYES'",",oparms:[]}");
         setEventMetadata("'CONFIRMNO'","{handler:'E134A2',iparms:[]");
