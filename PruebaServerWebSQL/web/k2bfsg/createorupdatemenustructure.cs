...
namespace GeneXus.Programs.k2bfsg {
   public class createorupdatemenustructure : GXProcedure
   {
      ...
      public void execute( long aP0_ApplicationId ,
                           ...
                           out GXBaseCollection<SdtMessages_Message> aP3_Errors ,
                           out long aP4_MenuId ,
                           ...
                           out bool aP6_Result )
      {
         ...
         this.AV13Errors = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus") ;
         this.AV18MenuId = 0 ;
                                 ...
                                 out bool aP6_Result )
      {
         ...
         objcreateorupdatemenustructure.AV13Errors = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus") ;
         ...
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objcreateorupdatemenustructure);
         aP3_Errors=this.AV13Errors;
         aP4_MenuId=this.AV18MenuId;
         aP5_newMenu=this.AV19newMenu;
         aP6_Result=this.AV20Result;
      ...
      {
         AV13Errors = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
         ...
         pr_datastore2 = new DataStoreProvider(context, new GeneXus.Programs.k2bfsg.createorupdatemenustructure__datastore2(),
            new Object[][] {
            }
         );
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.k2bfsg.createorupdatemenustructure__datastore1(),
            new Object[][] {
            }
         );
      ...
      private GXBaseCollection<SdtMessages_Message> aP3_Errors ;
      ...
      private GXBaseCollection<SdtMessages_Message> AV13Errors ;
   ...
   public class createorupdatemenustructure__datastore2 : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class createorupdatemenustructure__datastore1 : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
