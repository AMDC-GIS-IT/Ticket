...
namespace GeneXus.Programs.k2bfsg {
   public class emailsent : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.SendWebValue( "Correo electrónico enviado") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249553850", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB4K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_21_4K2( true) ;
         }
         else
         {
            wb_table1_21_4K2( false) ;
         }
         return  ;
      }

      protected void wb_table1_21_4K2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblMessage_Internalname, "Un correo electrónico ha sido enviado a su casilla", "", "", lblMessage_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\EmailSent.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_36_4K2( true) ;
         }
         else
         {
            wb_table2_36_4K2( false) ;
         }
         return  ;
      }

      protected void wb_table2_36_4K2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START4K2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Correo electrónico enviado", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void E124K2( )
      {
         ...
         S122 ();
         if (returnInSub) return;
         AV12GoToLogin_Action = "Ir a login";
         AssignAttri("", false, "AV12GoToLogin_Action", AV12GoToLogin_Action);
      ...
      protected void wb_table2_36_4K2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavGotologin_action_Internalname, StringUtil.RTrim( AV12GoToLogin_Action), StringUtil.RTrim( context.localUtil.Format( AV12GoToLogin_Action, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,40);\"", "'"+""+"'"+",false,"+"'"+"e144k1_client"+"'", "", "", "", "", edtavGotologin_action_Jsonclick, 7, "K2BT_TextAction", "", "", "", "", 1, edtavGotologin_action_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, false, "", "left", true, "", "HLP_K2BFSG\\EmailSent.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_36_4K2e( true) ;
         }
         else
         {
            wb_table2_36_4K2e( false) ;
         }
      }

      protected void wb_table1_21_4K2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock_attributes_attributes_Internalname, "Correo electrónico enviado", "", "", lblTextblock_attributes_attributes_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Subtitle", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\EmailSent.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_21_4K2e( true) ;
         }
         else
         {
            wb_table1_21_4K2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249553860", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2bfsg/emailsent.js", "?20231249553860", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH",",oparms:[{av:'AV12GoToLogin_Action',fld:'vGOTOLOGIN_ACTION',pic:''}]}");
         setEventMetadata("'E_GOTOLOGIN'","{handler:'E144K1',iparms:[]");
      ...
      private string AV12GoToLogin_Action ;
