...
namespace GeneXus.Programs.k2bfsg {
   public class converterrorstomessages : GXProcedure
   {
                                 ...
                                 out GXBaseCollection<SdtMessages_Message> aP1_Messages )
      {
         ...
         objconverterrorstomessages.AV11Messages = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus") ;
         objconverterrorstomessages.context.SetSubmitInitialConfig(context);
         objconverterrorstomessages.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objconverterrorstomessages);
         aP1_Messages=this.AV11Messages;
      }
