...
namespace GeneXus.Programs.k2bfsg {
   public class ssologin : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.SendWebValue( "Ingreso único") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249554760", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void START4P2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Ingreso único", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void S112( )
      {
         /* 'U_OPENPAGE' Routine */
         returnInSub = false;
         AV15ConnectionInfoCollection = new GeneXus.Programs.genexussecurity.SdtGAM(context).getconnections();
         if ( AV15ConnectionInfoCollection.Count > 0 )
         {
            AV5isOK = new GeneXus.Programs.genexussecurity.SdtGAM(context).setconnection(((GeneXus.Programs.genexussecurity.SdtGAMConnectionInfo)AV15ConnectionInfoCollection.Item(1)).gxTpr_Name, out  AV17Errors);
         }
         AV6isRedirect = false;
         AV17Errors = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getlasterrors();
         if ( ( AV17Errors.Count > 0 ) && ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV17Errors.Item(1)).gxTpr_Code != 104 ) )
         {
         ...
         {
            AV19SessionValid = new GeneXus.Programs.genexussecurity.SdtGAMSession(context).isvalid(out  AV18Session, out  AV17Errors);
            if ( AV19SessionValid && ! AV18Session.gxTpr_Isanonymous )
            {
      ...
      protected void S142( )
      {
         ...
         returnInSub = false;
         AV22GXV1 = 1;
         while ( AV22GXV1 <= AV17Errors.Count )
         {
            AV16Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV17Errors.Item(AV22GXV1));
            if ( AV16Error.gxTpr_Code != 13 )
            {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249555342", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("k2bfsg/ssologin.js", "?20231249555345", false, true);
            context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
            context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
            context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
         }
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         AV15ConnectionInfoCollection = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMConnectionInfo>( context, "GeneXus.Programs.genexussecurity.SdtGAMConnectionInfo", "GeneXus.Programs");
         ...
         AV18Session = new GeneXus.Programs.genexussecurity.SdtGAMSession(context);
         AV7URL = "";
      ...
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMConnectionInfo> AV15ConnectionInfoCollection ;
      ...
      private GeneXus.Programs.genexussecurity.SdtGAMSession AV18Session ;
   }
