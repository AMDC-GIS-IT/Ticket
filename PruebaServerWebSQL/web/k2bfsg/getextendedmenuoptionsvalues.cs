...
namespace GeneXus.Programs.k2bfsg {
   public class getextendedmenuoptionsvalues : GXProcedure
   {
                                 ...
                                 out bool aP6_ShowInLarge )
      {
         ...
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objgetextendedmenuoptionsvalues);
         aP1_ImageUrl=this.AV8ImageUrl;
         aP2_ImageClass=this.AV9ImageClass;
         aP3_ShowInExtraSmall=this.AV10ShowInExtraSmall;
         aP4_ShowInSmall=this.AV11ShowInSmall;
      ...
      void executePrivate( )
      {
         ...
         AV18GXV1 = 1;
         while ( AV18GXV1 <= AV14Properties.Count )
         {
            AV15Property = ((GeneXus.Programs.genexussecurity.SdtGAMProperty)AV14Properties.Item(AV18GXV1));
