...
namespace GeneXus.Programs.k2bfsg {
   public class checkuseractivationmethod : GXProcedure
   {
                                 ...
                                 out GXBaseCollection<SdtMessages_Message> aP1_Messages )
      {
         ...
         objcheckuseractivationmethod.AV12Messages = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus") ;
         objcheckuseractivationmethod.context.SetSubmitInitialConfig(context);
         objcheckuseractivationmethod.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objcheckuseractivationmethod);
         aP1_Messages=this.AV12Messages;
      }
      ...
      void executePrivate( )
      {
         ...
         if ( StringUtil.StrCmp(AV9Repository.gxTpr_Useractivationmethod, "U") == 0 )
         {
            ...
            else
            {
               ...
               new GeneXus.Programs.k2bfsg.converterrorstomessages(context ).execute(  AV13Errors, out  GXt_objcol_SdtMessages_Message1) ;
         ...
         else if ( StringUtil.StrCmp(AV9Repository.gxTpr_Useractivationmethod, "D") == 0 )
         {
            AV14Message = new GeneXus.Utils.SdtMessages_Message(context);
            AV14Message.gxTpr_Type = 0;
            AV14Message.gxTpr_Description = "K2BT_UserCreatedWaitAdmin";
            AV12Messages.Add(AV14Message, 0);
         }
         this.cleanup();
      }
