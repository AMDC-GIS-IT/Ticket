...
namespace GeneXus.Programs.k2bfsg {
   public class wwauthtype : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( AV34ClassCollection_Grid, AV39Pgmname, AV8CurrentPage_Grid, AV31GenericFilter_Grid, AV33GridConfiguration, AV15HasNextPage_Grid, AV26RowsPerPage_Grid, AV17I_LoadCount_Grid, AV23TypeId, AV35FreezeColumnTitles_Grid) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249535382", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB3K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, "Tipos de autenticación", "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWAuthType.htm");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;", "div");
            wb_table1_35_3K2( true) ;
         }
         else
         {
            wb_table1_35_3K2( false) ;
         }
         return  ;
      }

      protected void wb_table1_35_3K2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.SendWebValue( "") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"K2BT_TextAction"+"\" "+" style=\""+((edtavTestexternalauthenticationtype_action_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
               context.SendWebValue( "") ;
               context.WriteHtmlTextNl( "</th>") ;
            ...
            else
            {
               ...
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( AV23TypeId));
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( AV32TestExternalAuthenticationType_Action));
         ...
         if ( wbEnd == 84 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_92_3K2( true) ;
         }
         else
         {
            wb_table2_92_3K2( false) ;
         }
         return  ;
      }

      protected void wb_table2_92_3K2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_previouspagebuttontextblockgrid_Internalname, "", "", "", lblPaginationbar_previouspagebuttontextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"e113k1_client"+"'", "", lblPaginationbar_previouspagebuttontextblockgrid_Class, 7, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWAuthType.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_firstpagetextblockgrid_Internalname, lblPaginationbar_firstpagetextblockgrid_Caption, "", "", lblPaginationbar_firstpagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"e123k1_client"+"'", "", "K2BToolsTextBlock_PaginationNormal", 7, "", lblPaginationbar_firstpagetextblockgrid_Visible, 1, 0, 0, "HLP_K2BFSG\\WWAuthType.htm");
            /* Text block */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_nextpagetextblockgrid_Internalname, lblPaginationbar_nextpagetextblockgrid_Caption, "", "", lblPaginationbar_nextpagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"e133k1_client"+"'", "", "K2BToolsTextBlock_PaginationNormal", 7, "", lblPaginationbar_nextpagetextblockgrid_Visible, 1, 0, 0, "HLP_K2BFSG\\WWAuthType.htm");
            /* Text block */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_nextpagebuttontextblockgrid_Internalname, "", "", "", lblPaginationbar_nextpagebuttontextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"e133k1_client"+"'", "", lblPaginationbar_nextpagebuttontextblockgrid_Class, 7, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWAuthType.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START3K2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Tipos de autenticación", 0) ;
         }
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtavUpdate_action_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV29Update_Action)) ? AV40Update_action_GXI : context.convertURL( context.PathToRelativeUrl( AV29Update_Action))), !bGXsfl_84_Refreshing);
                              ...
                              AssignProp("", false, edtavDelete_action_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV30Delete_Action)) ? AV41Delete_action_GXI : context.convertURL( context.PathToRelativeUrl( AV30Delete_Action))), !bGXsfl_84_Refreshing);
      ...
      protected void gxgrGrid_refresh( GxSimpleCollection<string> AV34ClassCollection_Grid ,
                                       string AV39Pgmname ,
      ...
      protected void initialize_formulas( )
      {
         ...
         AssignProp("", false, cmbavTypeid_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(cmbavTypeid.Enabled), 5, 0), !bGXsfl_84_Refreshing);
         edtavTestexternalauthenticationtype_action_Enabled = 0;
         AssignProp("", false, edtavTestexternalauthenticationtype_action_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavTestexternalauthenticationtype_action_Enabled), 5, 0), !bGXsfl_84_Refreshing);
      }
      ...
      protected void STRUP3K0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV8CurrentPage_Grid = (short)(context.localUtil.CToN( cgiGet( "vCURRENTPAGE_GRID"), ",", "."));
      ...
      protected void S132( )
      {
         ...
         AV38GXV1 = 1;
         while ( AV38GXV1 <= AV25Messages.Count )
         {
            AV18Message = ((GeneXus.Utils.SdtMessages_Message)AV25Messages.Item(AV38GXV1));
      ...
      protected void E153K2( )
      {
         /* Start Routine */
         returnInSub = false;
         new k2bloadrowsperpage(context ).execute(  AV39Pgmname,  "Grid", out  AV26RowsPerPage_Grid, out  AV28RowsPerPageLoaded_Grid) ;
      ...
      private void E173K2( )
      {
         ...
         while ( true )
         {
            ...
            AV40Update_action_GXI = GXDbFile.PathToUrl( context.GetImagePath( "788f9b72-f982-49f9-99e4-c0374e31a85a", "", context.GetTheme( )));
            ...
            AV41Delete_action_GXI = GXDbFile.PathToUrl( context.GetImagePath( "3e4a9f50-2c57-41b6-9da5-ebe49bca33c0", "", context.GetTheme( )));
            edtavDelete_action_Tooltiptext = "Eliminar";
            AV32TestExternalAuthenticationType_Action = "Probar";
            AssignAttri("", false, edtavTestexternalauthenticationtype_action_Internalname, AV32TestExternalAuthenticationType_Action);
      ...
      protected void S232( )
      {
         ...
         new k2bloadgridstate(context ).execute(  AV39Pgmname,  AV14GridStateKey, out  AV12GridState) ;
         ...
         new k2bsavegridstate(context ).execute(  AV39Pgmname,  AV14GridStateKey,  AV12GridState) ;
      }
      ...
      protected void S122( )
      {
         ...
         new k2bloadgridstate(context ).execute(  AV39Pgmname,  AV14GridStateKey, out  AV12GridState) ;
         AV42GXV2 = 1;
         while ( AV42GXV2 <= AV12GridState.gxTpr_Filtervalues.Count )
         {
            AV13GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV12GridState.gxTpr_Filtervalues.Item(AV42GXV2));
      ...
      protected void E143K2( )
      {
         ...
         returnInSub = false;
         new k2bloadgridconfiguration(context ).execute(  AV39Pgmname,  "Grid", ref  AV33GridConfiguration) ;
         AV33GridConfiguration.gxTpr_Freezecolumntitles = AV35FreezeColumnTitles_Grid;
         new k2bsavegridconfiguration(context ).execute(  AV39Pgmname,  "Grid",  AV33GridConfiguration,  true) ;
         if ( AV26RowsPerPage_Grid != AV27GridSettingsRowsPerPage_Grid )
         {
            AV26RowsPerPage_Grid = AV27GridSettingsRowsPerPage_Grid;
            AssignAttri("", false, "AV26RowsPerPage_Grid", StringUtil.LTrimStr( (decimal)(AV26RowsPerPage_Grid), 4, 0));
            new k2bsaverowsperpage(context ).execute(  AV39Pgmname,  "Grid",  AV26RowsPerPage_Grid) ;
            AV8CurrentPage_Grid = 1;
            AssignAttri("", false, "AV8CurrentPage_Grid", StringUtil.LTrimStr( (decimal)(AV8CurrentPage_Grid), 4, 0));
         }
         gxgrGrid_refresh( AV34ClassCollection_Grid, AV39Pgmname, AV8CurrentPage_Grid, AV31GenericFilter_Grid, AV33GridConfiguration, AV15HasNextPage_Grid, AV26RowsPerPage_Grid, AV17I_LoadCount_Grid, AV23TypeId, AV35FreezeColumnTitles_Grid) ;
      ...
      protected void S212( )
      {
         ...
         if ( ( StringUtil.StrCmp(AV23TypeId, "ExternalWebService") == 0 ) || ( StringUtil.StrCmp(AV23TypeId, "Custom") == 0 ) || ( StringUtil.StrCmp(AV23TypeId, "GAMRemoteRest") == 0 ) )
         {
            ...
            AssignProp("", false, edtavTestexternalauthenticationtype_action_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavTestexternalauthenticationtype_action_Visible), 5, 0), !bGXsfl_84_Refreshing);
         }
         else
         {
      ...
      protected void wb_table2_92_3K2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_grid_Internalname, "No hay resultados", "", "", lblI_noresultsfoundtextblock_grid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWAuthType.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_92_3K2e( true) ;
         }
         else
         {
            wb_table2_92_3K2e( false) ;
         }
      }

      protected void wb_table1_35_3K2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGslayoutdefined_gridruntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblGslayoutdefined_gridruntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_K2BFSG\\WWAuthType.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavGridsettingsrowsperpage_grid, cmbavGridsettingsrowsperpage_grid_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV27GridSettingsRowsPerPage_Grid), 4, 0)), 1, cmbavGridsettingsrowsperpage_grid_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavGridsettingsrowsperpage_grid.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,61);\"", "", true, 1, "HLP_K2BFSG\\WWAuthType.htm");
            cmbavGridsettingsrowsperpage_grid.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV27GridSettingsRowsPerPage_Grid), 4, 0));
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttGridsettings_savegrid_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(84), 2, 0)+","+"null"+");", "Aplicar", bttGridsettings_savegrid_Jsonclick, 5, "Aplicar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'SAVEGRIDSETTINGS(GRID)\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_K2BFSG\\WWAuthType.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table3_72_3K2( true) ;
         }
         else
         {
            wb_table3_72_3K2( false) ;
         }
         return  ;
      }

      protected void wb_table3_72_3K2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_35_3K2e( true) ;
         }
         else
         {
            wb_table1_35_3K2e( false) ;
         }
      }

      protected void wb_table3_72_3K2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttNew_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(84), 2, 0)+","+"null"+");", "Nuevo", bttNew_Jsonclick, 7, "", "", StyleString, ClassString, bttNew_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"e203k1_client"+"'", TempTags, "", 2, "HLP_K2BFSG\\WWAuthType.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_72_3K2e( true) ;
         }
         else
         {
            wb_table3_72_3K2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249535868", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("k2bfsg/wwauthtype.js", "?20231249535872", false, true);
            context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
            context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
            context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
         }
      ...
      protected void SubsflControlProps_842( )
      {
         ...
         cmbavTypeid_Internalname = "vTYPEID_"+sGXsfl_84_idx;
         ...
         edtavTestexternalauthenticationtype_action_Internalname = "vTESTEXTERNALAUTHENTICATIONTYPE_ACTION_"+sGXsfl_84_idx;
      }

      protected void SubsflControlProps_fel_842( )
      {
         edtavName_Internalname = "vNAME_"+sGXsfl_84_fel_idx;
         cmbavTypeid_Internalname = "vTYPEID_"+sGXsfl_84_fel_idx;
         ...
         edtavTestexternalauthenticationtype_action_Internalname = "vTESTEXTERNALAUTHENTICATIONTYPE_ACTION_"+sGXsfl_84_fel_idx;
      }
      ...
      protected void sendrow_842( )
      {
         ...
         TempTags = " " + ((cmbavTypeid.Enabled!=0)&&(cmbavTypeid.Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 86,'',false,'"+sGXsfl_84_idx+"',84)\"" : " ");
         if ( ( cmbavTypeid.ItemCount == 0 ) && isAjaxCallMode( ) )
         {
            GXCCtl = "vTYPEID_" + sGXsfl_84_idx;
         ...
         ClassString = "Image_Action";
         StyleString = "";
         AV30Delete_Action_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV30Delete_Action))&&String.IsNullOrEmpty(StringUtil.RTrim( AV41Delete_action_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV30Delete_Action)));
         sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV30Delete_Action)) ? AV41Delete_action_GXI : context.PathToRelativeUrl( AV30Delete_Action));
         GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtavDelete_action_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)1,(string)"Delete",(string)edtavDelete_action_Tooltiptext,(short)0,(short)1,(short)20,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)7,(string)edtavDelete_action_Jsonclick,(string)"'"+""+"'"+",false,"+"'"+"e223k2_client"+"'",(string)StyleString,(string)ClassString,(string)"K2BToolsGridColumn ActionColumn ActionVisibleOnRowHover",(string)"",(string)"",(string)"",(string)""+TempTags,(string)"",(string)"",(short)1,(bool)AV30Delete_Action_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
         /* Subfile cell */
         if ( GridContainer.GetWrapped() == 1 )
         {
            context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+((edtavTestexternalauthenticationtype_action_Visible==0) ? "display:none;" : "")+"\">") ;
         }
         /* Single line edit */
         TempTags = " " + ((edtavTestexternalauthenticationtype_action_Enabled!=0)&&(edtavTestexternalauthenticationtype_action_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 89,'',false,'"+sGXsfl_84_idx+"',84)\"" : " ");
         ROClassString = "K2BT_TextAction";
         GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavTestexternalauthenticationtype_action_Internalname,StringUtil.RTrim( AV32TestExternalAuthenticationType_Action),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((edtavTestexternalauthenticationtype_action_Enabled!=0)&&(edtavTestexternalauthenticationtype_action_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,89);\"" : " "),(string)"'"+""+"'"+",false,"+"'"+"e233k2_client"+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavTestexternalauthenticationtype_action_Jsonclick,(short)7,(string)"K2BT_TextAction",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn ActionColumn ActionVisibleOnRowHover",(string)"",(int)edtavTestexternalauthenticationtype_action_Visible,(int)edtavTestexternalauthenticationtype_action_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)0,(short)84,(short)1,(short)-1,(short)-1,(bool)true,(string)"",(string)"left",(bool)true,(string)""});
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Tipos de autenticación";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV31GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV26RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'cmbavTypeid'},{av:'AV23TypeId',fld:'vTYPEID',pic:''},{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV34ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV33GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV15HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV17I_LoadCount_Grid',fld:'vI_LOADCOUNT_GRID',pic:'ZZZ9',hsh:true},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'AV33GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'NEW',prop:'Visible'},{av:'AV34ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("'PAGINGPREVIOUS(GRID)'","{handler:'E113K1',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV34ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV31GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV33GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV15HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV26RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV17I_LoadCount_Grid',fld:'vI_LOADCOUNT_GRID',pic:'ZZZ9',hsh:true},{av:'cmbavTypeid'},{av:'AV23TypeId',fld:'vTYPEID',pic:''},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'PAGINGPREVIOUS(GRID)'",",oparms:[{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'AV33GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'NEW',prop:'Visible'},{av:'AV34ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("'PAGINGNEXT(GRID)'","{handler:'E133K1',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV34ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV31GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV33GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV15HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV26RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV17I_LoadCount_Grid',fld:'vI_LOADCOUNT_GRID',pic:'ZZZ9',hsh:true},{av:'cmbavTypeid'},{av:'AV23TypeId',fld:'vTYPEID',pic:''},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'PAGINGNEXT(GRID)'",",oparms:[{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'AV33GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'NEW',prop:'Visible'},{av:'AV34ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("'E_UPDATE'","{handler:'E213K2',iparms:[{av:'AV19Name',fld:'vNAME',pic:''},{av:'cmbavTypeid'},{av:'AV23TypeId',fld:'vTYPEID',pic:''},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'E_UPDATE'",",oparms:[{av:'cmbavTypeid'},{av:'AV23TypeId',fld:'vTYPEID',pic:''},{av:'AV19Name',fld:'vNAME',pic:''},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("'E_DELETE'","{handler:'E223K2',iparms:[{av:'AV19Name',fld:'vNAME',pic:''},{av:'cmbavTypeid'},{av:'AV23TypeId',fld:'vTYPEID',pic:''},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'E_DELETE'",",oparms:[{av:'cmbavTypeid'},{av:'AV23TypeId',fld:'vTYPEID',pic:''},{av:'AV19Name',fld:'vNAME',pic:''},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("'E_NEW'","{handler:'E203K1',iparms:[{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'E_NEW'",",oparms:[{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("GRID.LOAD","{handler:'E173K2',iparms:[{av:'AV26RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV17I_LoadCount_Grid',fld:'vI_LOADCOUNT_GRID',pic:'ZZZ9',hsh:true},{av:'AV31GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'cmbavTypeid'},{av:'AV23TypeId',fld:'vTYPEID',pic:''},{av:'AV15HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'tblI_noresultsfoundtablename_grid_Visible',ctrl:'I_NORESULTSFOUNDTABLENAME_GRID',prop:'Visible'},{av:'AV17I_LoadCount_Grid',fld:'vI_LOADCOUNT_GRID',pic:'ZZZ9',hsh:true},{av:'AV15HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV29Update_Action',fld:'vUPDATE_ACTION',pic:''},{av:'edtavUpdate_action_Tooltiptext',ctrl:'vUPDATE_ACTION',prop:'Tooltiptext'},{av:'AV30Delete_Action',fld:'vDELETE_ACTION',pic:''},{av:'edtavDelete_action_Tooltiptext',ctrl:'vDELETE_ACTION',prop:'Tooltiptext'},{av:'AV32TestExternalAuthenticationType_Action',fld:'vTESTEXTERNALAUTHENTICATIONTYPE_ACTION',pic:''},{av:'AV19Name',fld:'vNAME',pic:''},{av:'cmbavTypeid'},{av:'AV23TypeId',fld:'vTYPEID',pic:''},{av:'edtavName_Link',ctrl:'vNAME',prop:'Link'},{av:'edtavTestexternalauthenticationtype_action_Visible',ctrl:'vTESTEXTERNALAUTHENTICATIONTYPE_ACTION',prop:'Visible'},{av:'lblPaginationbar_firstpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_previouspagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_currentpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_CURRENTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_nextpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_previouspagebuttontextblockgrid_Class',ctrl:'PAGINATIONBAR_PREVIOUSPAGEBUTTONTEXTBLOCKGRID',prop:'Class'},{av:'lblPaginationbar_nextpagebuttontextblockgrid_Class',ctrl:'PAGINATIONBAR_NEXTPAGEBUTTONTEXTBLOCKGRID',prop:'Class'},{av:'lblPaginationbar_firstpagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_spacinglefttextblockgrid_Visible',ctrl:'PAGINATIONBAR_SPACINGLEFTTEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_previouspagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_spacingrighttextblockgrid_Visible',ctrl:'PAGINATIONBAR_SPACINGRIGHTTEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_nextpagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRID',prop:'Visible'},{av:'divPaginationbar_pagingcontainertable_grid_Visible',ctrl:'PAGINATIONBAR_PAGINGCONTAINERTABLE_GRID',prop:'Visible'},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("'PAGINGFIRST(GRID)'","{handler:'E123K1',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV34ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV31GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV33GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV15HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV26RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV17I_LoadCount_Grid',fld:'vI_LOADCOUNT_GRID',pic:'ZZZ9',hsh:true},{av:'cmbavTypeid'},{av:'AV23TypeId',fld:'vTYPEID',pic:''},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'PAGINGFIRST(GRID)'",",oparms:[{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'AV33GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'NEW',prop:'Visible'},{av:'AV34ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("'TOGGLEGRIDSETTINGS(GRID)'","{handler:'E193K1',iparms:[{av:'divGridsettings_contentoutertablegrid_Visible',ctrl:'GRIDSETTINGS_CONTENTOUTERTABLEGRID',prop:'Visible'},{av:'AV26RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'TOGGLEGRIDSETTINGS(GRID)'",",oparms:[{av:'cmbavGridsettingsrowsperpage_grid'},{av:'AV27GridSettingsRowsPerPage_Grid',fld:'vGRIDSETTINGSROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'divGridsettings_contentoutertablegrid_Visible',ctrl:'GRIDSETTINGS_CONTENTOUTERTABLEGRID',prop:'Visible'},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("'SAVEGRIDSETTINGS(GRID)'","{handler:'E143K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV34ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV31GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV33GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV15HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV26RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV17I_LoadCount_Grid',fld:'vI_LOADCOUNT_GRID',pic:'ZZZ9',hsh:true},{av:'cmbavTypeid'},{av:'AV23TypeId',fld:'vTYPEID',pic:''},{av:'cmbavGridsettingsrowsperpage_grid'},{av:'AV27GridSettingsRowsPerPage_Grid',fld:'vGRIDSETTINGSROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'SAVEGRIDSETTINGS(GRID)'",",oparms:[{av:'AV33GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV26RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'divGridsettings_contentoutertablegrid_Visible',ctrl:'GRIDSETTINGS_CONTENTOUTERTABLEGRID',prop:'Visible'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{ctrl:'NEW',prop:'Visible'},{av:'AV34ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("GRID.REFRESH","{handler:'E183K2',iparms:[{av:'AV34ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV39Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV31GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV33GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV15HasNextPage_Grid',fld:'vHASNEXTPAGE_GRID',pic:'',hsh:true},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("GRID.REFRESH",",oparms:[{av:'AV34ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'AV33GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'lblPaginationbar_firstpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_previouspagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_currentpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_CURRENTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_nextpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_previouspagebuttontextblockgrid_Class',ctrl:'PAGINATIONBAR_PREVIOUSPAGEBUTTONTEXTBLOCKGRID',prop:'Class'},{av:'lblPaginationbar_nextpagebuttontextblockgrid_Class',ctrl:'PAGINATIONBAR_NEXTPAGEBUTTONTEXTBLOCKGRID',prop:'Class'},{av:'lblPaginationbar_firstpagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_spacinglefttextblockgrid_Visible',ctrl:'PAGINATIONBAR_SPACINGLEFTTEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_previouspagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_spacingrighttextblockgrid_Visible',ctrl:'PAGINATIONBAR_SPACINGRIGHTTEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_nextpagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRID',prop:'Visible'},{av:'divPaginationbar_pagingcontainertable_grid_Visible',ctrl:'PAGINATIONBAR_PAGINGCONTAINERTABLE_GRID',prop:'Visible'},{ctrl:'NEW',prop:'Visible'},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("'E_TESTEXTERNALAUTHENTICATIONTYPE'","{handler:'E233K2',iparms:[{av:'AV19Name',fld:'vNAME',pic:''},{av:'cmbavTypeid'},{av:'AV23TypeId',fld:'vTYPEID',pic:''},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'E_TESTEXTERNALAUTHENTICATIONTYPE'",",oparms:[{av:'cmbavTypeid'},{av:'AV23TypeId',fld:'vTYPEID',pic:''},{av:'AV19Name',fld:'vNAME',pic:''},{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("VALIDV_TYPEID","{handler:'Validv_Typeid',iparms:[{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("VALIDV_TYPEID",",oparms:[{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("NULL","{handler:'Validv_Testexternalauthenticationtype_action',iparms:[{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("NULL",",oparms:[{av:'AV35FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         AV40Update_action_GXI = "";
         AV41Delete_action_GXI = "";
      ...
      private string AV40Update_action_GXI ;
      private string AV41Delete_action_GXI ;
