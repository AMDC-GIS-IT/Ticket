...
namespace GeneXus.Programs {
   public class reportwwdirecciones : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public reportwwdirecciones( IGxContext context )
      {
      ...
      public void executeSubmit( string aP0_K2BToolsGenericSearchField ,
                                 short aP1_OrderedBy )
      {
         reportwwdirecciones objreportwwdirecciones;
         objreportwwdirecciones = new reportwwdirecciones();
         objreportwwdirecciones.AV9K2BToolsGenericSearchField = aP0_K2BToolsGenericSearchField;
         objreportwwdirecciones.AV10OrderedBy = aP1_OrderedBy;
         objreportwwdirecciones.context.SetSubmitInitialConfig(context);
         objreportwwdirecciones.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objreportwwdirecciones);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((reportwwdirecciones)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "Direcciones",  "Direcciones",  "List",  "",  AV19Pgmname) )
            {
               H620( false, 30) ;
            ...
            else
            {
               ...
               getPrinter().GxDrawText("Direccioneses", 271, Gx_line+0, 556, Gx_line+42, 0+256, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
               ...
               getPrinter().GxAttris("Courier New", 8, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText("Direccion Id", 18, Gx_line+7, 107, Gx_line+22, 2, 0, 0, 1) ;
               Gx_OldLine = Gx_line;
               Gx_line = (int)(Gx_line+30);
               GxHdr3 = true;
               ...
               lV9K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV9K2BToolsGenericSearchField), 200, "%");
               /* Using cursor P00622 */
               pr_datastore2.execute(0, new Object[] {lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField});
               while ( (pr_datastore2.getStatus(0) != 101) )
               {
                  A262DireccionDescripcion = P00622_A262DireccionDescripcion[0];
                  A258DireccionId = P00622_A258DireccionId[0];
                  H620( false, 30) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(A258DireccionId), "ZZZ9")), 18, Gx_line+7, 107, Gx_line+23, 2, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
      ...
      protected void H620( bool bFoot ,
                           int Inc )
      {
      ...
      public override void initialize( )
      {
         ...
         A262DireccionDescripcion = "";
         P00622_A262DireccionDescripcion = new string[] {""} ;
         P00622_A258DireccionId = new short[1] ;
         Gx_date = DateTime.MinValue;
         pr_datastore2 = new DataStoreProvider(context, new GeneXus.Programs.reportwwdirecciones__datastore2(),
            new Object[][] {
                new Object[] {
               P00622_A262DireccionDescripcion, P00622_A258DireccionId
               }
            }
         );
         AV19Pgmname = "ReportWWDirecciones";
      ...
      private string[] P00622_A262DireccionDescripcion ;
      private short[] P00622_A258DireccionId ;
      private SdtK2BContext AV8Context ;
   }

   public class reportwwdirecciones__datastore2 : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV10OrderedBy )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(4), CAST([DireccionId] AS decimal(4,0))) like '%' + @lV9K2BToolsGenericSearchField + '%' or [DireccionDescripcion] like '%' + @lV9K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int1[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00622(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] );
         }
