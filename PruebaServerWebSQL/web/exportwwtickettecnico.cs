...
namespace GeneXus.Programs {
   public class exportwwtickettecnico : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV14TicketTecnicoFecha_From = context.localUtil.ParseDateParm( gxfirstwebparm);
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV15TicketTecnicoFecha_To = context.localUtil.ParseDateParm( GetPar( "TicketTecnicoFecha_To"));
                  AV17TicketTecnicoHora_From = DateTimeUtil.ResetDate(context.localUtil.ParseDTimeParm( GetPar( "TicketTecnicoHora_From")));
                  AV18TicketTecnicoHora_To = DateTimeUtil.ResetDate(context.localUtil.ParseDTimeParm( GetPar( "TicketTecnicoHora_To")));
                           ...
                           ref short aP5_OrderedBy )
      {
         ...
         initialize();
         executePrivate();
         aP5_OrderedBy=this.AV19OrderedBy;
      }

      public short executeUdp( DateTime aP0_TicketTecnicoFecha_From ,
                               DateTime aP1_TicketTecnicoFecha_To ,
                               DateTime aP2_TicketTecnicoHora_From ,
                               DateTime aP3_TicketTecnicoHora_To ,
                               string aP4_K2BToolsGenericSearchField )
      {
         execute(aP0_TicketTecnicoFecha_From, aP1_TicketTecnicoFecha_To, aP2_TicketTecnicoHora_From, aP3_TicketTecnicoHora_To, aP4_K2BToolsGenericSearchField, ref aP5_OrderedBy);
         return AV19OrderedBy ;
      }
      ...
      void executePrivate( )
      {
         ...
         if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "TicketTecnico",  "TicketTecnico",  "List",  "",  "WWTicketTecnico") )
         {
            AV25Filename = "";
            AV26ErrorMessage = "You are not authorized to do activity";
            AV26ErrorMessage += "EntityName:" + "TicketTecnico";
            AV26ErrorMessage += "TransactionName:" + "TicketTecnico";
            AV26ErrorMessage += "ActivityType:" + "";
            AV26ErrorMessage += "PgmName:" + AV67Pgmname;
            AV27HttpResponse.AddString(AV26ErrorMessage);
            context.nUserReturn = 1;
            this.cleanup();
            if (true) return;
         }
         new k2bgetcontext(context ).execute( out  AV64Context) ;
         AV23Random = (int)(NumberUtil.Random( )*10000);
         AV25Filename = GxDirectory.TemporaryFilesPath + AV28File.Separator + "ExportWWTicketTecnico-" + StringUtil.Trim( StringUtil.Str( (decimal)(AV23Random), 8, 0)) + ".xlsx";
         ...
         AV20ExcelDocument.Open(AV25Filename);
         ...
         {
            AV20ExcelDocument.get_Cells(AV21CellRow, AV22FirstColumn+AV24ColumnIndex, 1, 1).Bold = 1;
            AV20ExcelDocument.get_Cells(AV21CellRow, AV22FirstColumn+AV24ColumnIndex, 1, 1).Text = "Id Ticket";
            AV24ColumnIndex = (short)(AV24ColumnIndex+1);
         }
         if ( AV33GridColumnVisible_TicketResponsableId )
         {
            AV20ExcelDocument.get_Cells(AV21CellRow, AV22FirstColumn+AV24ColumnIndex, 1, 1).Bold = 1;
            AV20ExcelDocument.get_Cells(AV21CellRow, AV22FirstColumn+AV24ColumnIndex, 1, 1).Text = "Ticket Responsable Id";
            AV24ColumnIndex = (short)(AV24ColumnIndex+1);
         }
         if ( AV35GridColumnVisible_ResponsableNombre )
         {
            AV20ExcelDocument.get_Cells(AV21CellRow, AV22FirstColumn+AV24ColumnIndex, 1, 1).Bold = 1;
            AV20ExcelDocument.get_Cells(AV21CellRow, AV22FirstColumn+AV24ColumnIndex, 1, 1).Text = "Responsable Nombre";
            AV24ColumnIndex = (short)(AV24ColumnIndex+1);
         }
         ...
         {
            AV27HttpResponse.AppendHeader("Content-Type", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
         }
         if ( ! context.isAjaxRequest( ) )
         {
            AV27HttpResponse.AppendHeader("Content-Disposition", "attachment;filename=ExportWWTicketTecnico.xlsx");
         }
         if ( ! context.isAjaxRequest( ) )
         {
            AV27HttpResponse.AppendHeader("X-Frame-Options", "sameOrigin");
         }
         if ( ! context.isAjaxRequest( ) )
         {
            AV27HttpResponse.AppendHeader("X-Content-Type-Options", "nosniff");
         }
         AV27HttpResponse.AddFile(AV25Filename);
         new k2bremoveexceldocument(context).executeSubmit(  AV25Filename) ;
      ...
      protected void S131( )
      {
         ...
         AV11GridColumn.gxTpr_Columntitle = "Id Ticket";
         AV11GridColumn.gxTpr_Showattribute = true;
         AV10GridColumns.Add(AV11GridColumn, 0);
         AV11GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV11GridColumn.gxTpr_Attributename = "TicketResponsableId";
         AV11GridColumn.gxTpr_Columntitle = "Ticket Responsable Id";
         AV11GridColumn.gxTpr_Showattribute = true;
         AV10GridColumns.Add(AV11GridColumn, 0);
         AV11GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV11GridColumn.gxTpr_Attributename = "ResponsableNombre";
         AV11GridColumn.gxTpr_Columntitle = "Responsable Nombre";
         AV11GridColumn.gxTpr_Showattribute = true;
         AV10GridColumns.Add(AV11GridColumn, 0);
         AV11GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
      ...
      public override void initialize( )
      {
         ...
         AV26ErrorMessage = "";
         AV67Pgmname = "";
         AV27HttpResponse = new GxHttpResponse( context);
         ...
         P003U2_A15UsuarioId = new short[1] ;
         ...
         AV67Pgmname = "ExportWWTicketTecnico";
         /* GeneXus formulas. */
         AV67Pgmname = "ExportWWTicketTecnico";
         context.Gx_err = 0;
      }
      ...
      private short[] P003U2_A15UsuarioId ;
      ...
      private GxHttpResponse AV27HttpResponse ;
   ...
   public class exportwwtickettecnico__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV19OrderedBy )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV12K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(10), CAST(T1.[TicketTecnicoId] AS decimal(10,0))) like '%' + @lV12K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T1.[TicketId] AS decimal(10,0))) like '%' + @lV12K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T1.[TicketResponsableId] AS decimal(10,0))) like '%' + @lV12K2BToolsGenericSearchField + '%' or T2.[ResponsableNombre] like '%' + @lV12K2BToolsGenericSearchField + '%' or CONVERT( char(4), CAST(T3.[UsuarioId] AS decimal(4,0))) like '%' + @lV12K2BToolsGenericSearchField + '%' or T4.[UsuarioNombre] like '%' + @lV12K2BToolsGenericSearchField + '%' or T4.[UsuarioRequerimiento] like '%' + @lV12K2BToolsGenericSearchField + '%' or T4.[UsuarioDepartamento] like '%' + @lV12K2BToolsGenericSearchField + '%' or T1.[TicketTecnicoInventarioSerie] like '%' + @lV12K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int2[4] = 1;
