         ...
         try
         {
            ...
            else
            {
               ...
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV15EstadoNombre)) )
               {
                  H2X0( false, 30) ;
                  getPrinter().GxAttris("Courier New", 8, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText("Nombre", 10, Gx_line+7, 55, Gx_line+22, 0+256, 0, 0, 0) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               ...
               getPrinter().GxDrawText("Nombre", 56, Gx_line+7, 276, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Activo", 284, Gx_line+7, 329, Gx_line+22, 0, 0, 0, 1) ;
               Gx_OldLine = Gx_line;
               Gx_line = (int)(Gx_line+30);
               GxHdr3 = true;
