   ...
   public class gx0060 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void WB0C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavCsatisfaccionid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cSatisfaccionId), 10, 0, ",", "")), ((edtavCsatisfaccionid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6cSatisfaccionId), "ZZZZZZZZZ9")) : context.localUtil.Format( (decimal)(AV6cSatisfaccionId), "ZZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCsatisfaccionid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCsatisfaccionid_Visible, edtavCsatisfaccionid_Enabled, 0, "number", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCsatisfaccionresueltoid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9cSatisfaccionResueltoId), 4, 0, ",", "")), ((edtavCsatisfaccionresueltoid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV9cSatisfaccionResueltoId), "ZZZ9")) : context.localUtil.Format( (decimal)(AV9cSatisfaccionResueltoId), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCsatisfaccionresueltoid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCsatisfaccionresueltoid_Visible, edtavCsatisfaccionresueltoid_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCsatisfacciontecnicoproblemaid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10cSatisfaccionTecnicoProblemaId), 4, 0, ",", "")), ((edtavCsatisfacciontecnicoproblemaid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10cSatisfaccionTecnicoProblemaId), "ZZZ9")) : context.localUtil.Format( (decimal)(AV10cSatisfaccionTecnicoProblemaId), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCsatisfacciontecnicoproblemaid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCsatisfacciontecnicoproblemaid_Visible, edtavCsatisfacciontecnicoproblemaid_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCsatisfacciontecnicocompetenteid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11cSatisfaccionTecnicoCompetenteId), 4, 0, ",", "")), ((edtavCsatisfacciontecnicocompetenteid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV11cSatisfaccionTecnicoCompetenteId), "ZZZ9")) : context.localUtil.Format( (decimal)(AV11cSatisfaccionTecnicoCompetenteId), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCsatisfacciontecnicocompetenteid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCsatisfacciontecnicocompetenteid_Visible, edtavCsatisfacciontecnicocompetenteid_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCsatisfacciontecnicoprofesionalismoid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12cSatisfaccionTecnicoProfesionalismoId), 4, 0, ",", "")), ((edtavCsatisfacciontecnicoprofesionalismoid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV12cSatisfaccionTecnicoProfesionalismoId), "ZZZ9")) : context.localUtil.Format( (decimal)(AV12cSatisfaccionTecnicoProfesionalismoId), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCsatisfacciontecnicoprofesionalismoid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCsatisfacciontecnicoprofesionalismoid_Visible, edtavCsatisfacciontecnicoprofesionalismoid_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCsatisfacciontiempoid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV15cSatisfaccionTiempoId), 4, 0, ",", "")), ((edtavCsatisfacciontiempoid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV15cSatisfaccionTiempoId), "ZZZ9")) : context.localUtil.Format( (decimal)(AV15cSatisfaccionTiempoId), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,76);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCsatisfacciontiempoid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCsatisfacciontiempoid_Visible, edtavCsatisfacciontiempoid_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0060.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void STRUP0C0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.CToD( cgiGet( "GXH_vCSATISFACCIONFECHA"), 2) != AV7cSatisfaccionFecha )
            {
               GRID1_nFirstRecordOnPage = 0;
            }
            if ( ( context.localUtil.CToN( cgiGet( "GXH_vCSATISFACCIONRESUELTOID"), ",", ".") != Convert.ToDecimal( AV9cSatisfaccionResueltoId )) )
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249572021", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0060.js", "?20231249572022", false, true);
      ...
      protected void sendrow_842( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_84_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSatisfaccionId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A7SatisfaccionId), 10, 0, ",", "")),context.localUtil.Format( (decimal)(A7SatisfaccionId), "ZZZZZZZZZ9"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSatisfaccionId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)10,(short)0,(short)0,(short)84,(short)1,(short)-1,(short)0,(bool)true,(string)"NumMax",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
