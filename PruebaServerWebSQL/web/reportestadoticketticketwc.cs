...
namespace GeneXus.Programs {
   public class reportestadoticketticketwc : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void initialize( )
      {
         ...
         P003H2_A15UsuarioId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportestadoticketticketwc__default(),
            new Object[][] {
                new Object[] {
               P003H2_A54TicketLastId, P003H2_A94UsuarioRequerimiento, P003H2_A15UsuarioId, P003H2_A14TicketId, P003H2_A93UsuarioNombre, P003H2_A48TicketHora, P003H2_A46TicketFecha, P003H2_A53TicketLaptop
               }
            }
         );
      ...
      private short[] P003H2_A15UsuarioId ;
   ...
   public class reportestadoticketticketwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P003H2(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (string)dynConstraints[8] , (long)dynConstraints[9] , (short)dynConstraints[10] , (string)dynConstraints[11] , (short)dynConstraints[12] , (string)dynConstraints[13] , (long)dynConstraints[14] , (short)dynConstraints[15] );
         }
