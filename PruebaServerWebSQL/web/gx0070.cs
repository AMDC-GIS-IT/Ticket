...
namespace GeneXus.Programs {
   public class gx0070 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV9cUsuarioId = (short)(NumberUtil.Val( GetPar( "cUsuarioId"), "."));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249571931", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCUSUARIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9cUsuarioId), 4, 0, ",", "")));
      ...
      protected void WB0D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavCticketid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cTicketId), 10, 0, ",", "")), ((edtavCticketid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6cTicketId), "ZZZZZZZZZ9")) : context.localUtil.Format( (decimal)(AV6cTicketId), "ZZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCticketid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCticketid_Visible, edtavCticketid_Enabled, 0, "number", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0070.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCusuarioid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9cUsuarioId), 4, 0, ",", "")), ((edtavCusuarioid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV9cUsuarioId), "ZZZ9")) : context.localUtil.Format( (decimal)(AV9cUsuarioId), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCusuarioid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCusuarioid_Visible, edtavCusuarioid_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0070.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCticketlastid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10cTicketLastId), 10, 0, ",", "")), ((edtavCticketlastid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10cTicketLastId), "ZZZZZZZZZ9")) : context.localUtil.Format( (decimal)(AV10cTicketLastId), "ZZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCticketlastid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCticketlastid_Visible, edtavCticketlastid_Enabled, 0, "number", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0070.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF0D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV6cTicketId } ,
                                                 new int[]{
                                                 TypeConstants.DATE, TypeConstants.DATE, TypeConstants.SHORT, TypeConstants.LONG, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.DATE, TypeConstants.DATE, TypeConstants.SHORT, TypeConstants.LONG,
      ...
      protected void STRUP0D0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCusuarioid_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCusuarioid_Internalname), ",", ".") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV9cUsuarioId = 0;
               AssignAttri("", false, "AV9cUsuarioId", StringUtil.LTrimStr( (decimal)(AV9cUsuarioId), 4, 0));
            }
            else
            {
               AV9cUsuarioId = (short)(context.localUtil.CToN( cgiGet( edtavCusuarioid_Internalname), ",", "."));
               AssignAttri("", false, "AV9cUsuarioId", StringUtil.LTrimStr( (decimal)(AV9cUsuarioId), 4, 0));
            }
            ...
            if ( context.localUtil.CToD( cgiGet( "GXH_vCTICKETFECHA"), 2) != AV7cTicketFecha )
            {
               GRID1_nFirstRecordOnPage = 0;
            }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249572020", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0070.js", "?20231249572020", false, true);
      ...
      protected void sendrow_842( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_84_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtTicketLastId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A54TicketLastId), 10, 0, ",", "")),context.localUtil.Format( (decimal)(A54TicketLastId), "ZZZZZZZZZ9"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtTicketLastId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn OptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)10,(short)0,(short)0,(short)84,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+""+"\">") ;
      ...
      public override void initialize( )
      {
         ...
         H000D2_A15UsuarioId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0070__default(),
            new Object[][] {
                new Object[] {
               H000D2_A87TicketUps, H000D2_A59TicketRouter, H000D2_A45TicketEscaner, H000D2_A50TicketImpresora, H000D2_A55TicketMonitor, H000D2_A42TicketDesktop, H000D2_A53TicketLaptop, H000D2_A54TicketLastId, H000D2_A15UsuarioId, H000D2_A48TicketHora,
               H000D2_A46TicketFecha, H000D2_A14TicketId
               }
               , new Object[] {
      ...
      private short[] H000D2_A15UsuarioId ;
   ...
   public class gx0070__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000D2(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (short)dynConstraints[2] , (long)dynConstraints[3] , (bool)dynConstraints[4] , (bool)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (short)dynConstraints[8] , (long)dynConstraints[9] , (bool)dynConstraints[10] , (bool)dynConstraints[11] , (long)dynConstraints[12] );
               case 1 :
                     return conditional_H000D3(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (short)dynConstraints[2] , (long)dynConstraints[3] , (bool)dynConstraints[4] , (bool)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (short)dynConstraints[8] , (long)dynConstraints[9] , (bool)dynConstraints[10] , (bool)dynConstraints[11] , (long)dynConstraints[12] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV9cUsuarioId",GXType.Int16,4,0) ,
