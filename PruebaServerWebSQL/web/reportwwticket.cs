...
namespace GeneXus.Programs {
   public class reportwwticket : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
         ...
         try
         {
            ...
            else
            {
               ...
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV29EstadoTicketTicketNombre)) )
               {
                  ...
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV29EstadoTicketTicketNombre, "")), 114, Gx_line+7, 334, Gx_line+23, 0+256, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
               }
               H3S0( false, 30) ;
               ...
               getPrinter().GxDrawText("Estado Ticket", 374, Gx_line+7, 503, Gx_line+22, 0, 0, 0, 1) ;
               Gx_OldLine = Gx_line;
               Gx_line = (int)(Gx_line+30);
               GxHdr3 = true;
      ...
      public override void initialize( )
      {
         ...
         A188EstadoTicketTicketNombre = "";
         A94UsuarioRequerimiento = "";
         P003S2_A15UsuarioId = new short[1] ;
      ...
      private short[] P003S2_A15UsuarioId ;
