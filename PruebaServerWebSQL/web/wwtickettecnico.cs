...
namespace GeneXus.Programs {
   public class wwtickettecnico : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV66K2BToolsGenericSearchField, AV57TicketTecnicoFecha_From, AV60TicketTecnicoHora_From, AV61TicketTecnicoHora_To, AV55ClassCollection, AV67OrderedBy, AV58TicketTecnicoFecha_To, AV83Pgmname, AV8CurrentPage, AV10GridConfiguration, AV79AutoLinksActivityList, AV73TicketTecnicoFecha_IsAuthorized, AV14Att_TicketTecnicoId_Visible, AV15Att_TicketTecnicoFecha_Visible, AV16Att_TicketTecnicoHora_Visible, AV17Att_TicketId_Visible, AV18Att_TicketResponsableId_Visible, AV20Att_ResponsableNombre_Visible, AV21Att_UsuarioId_Visible, AV22Att_UsuarioNombre_Visible, AV23Att_UsuarioRequerimiento_Visible, AV24Att_UsuarioDepartamento_Visible, AV25Att_TicketTecnicoInventarioSerie_Visible, AV11FreezeColumnTitles) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249525998", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV74Update)) ? AV85Update_GXI : context.convertURL( context.PathToRelativeUrl( AV74Update))), !bGXsfl_190_Refreshing);
                              ...
                              AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV75Delete)) ? AV86Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV75Delete))), !bGXsfl_190_Refreshing);
      ...
      protected void STRUP2V0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.CToD( cgiGet( "GXH_vTICKETTECNICOFECHA_FROM"), 2) != AV57TicketTecnicoFecha_From )
            {
               GRID_nFirstRecordOnPage = 0;
            }
      ...
      protected void E222V2( )
      {
         ...
         AssignAttri("", false, "AV61TicketTecnicoHora_To", context.localUtil.TToC( AV61TicketTecnicoHora_To, 0, 5, 0, 3, "/", ":", " "));
         new k2bloadrowsperpage(context ).execute(  AV83Pgmname,  "Grid", out  AV50RowsPerPageVariable, out  AV51RowsPerPageLoaded) ;
      ...
      protected void E232V2( )
      {
         ...
         AV84GXV1 = 1;
         while ( AV84GXV1 <= AV71Messages.Count )
         {
            AV72Message = ((GeneXus.Utils.SdtMessages_Message)AV71Messages.Item(AV84GXV1));
         ...
         AV80ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV83Pgmname;
         ...
         AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV74Update)) ? AV85Update_GXI : context.convertURL( context.PathToRelativeUrl( AV74Update))), !bGXsfl_190_Refreshing);
         AssignProp("", false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV74Update), true);
         AV85Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "788f9b72-f982-49f9-99e4-c0374e31a85a", "", context.GetTheme( )));
         AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV74Update)) ? AV85Update_GXI : context.convertURL( context.PathToRelativeUrl( AV74Update))), !bGXsfl_190_Refreshing);
         AssignProp("", false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV74Update), true);
         ...
         AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV75Delete)) ? AV86Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV75Delete))), !bGXsfl_190_Refreshing);
         AssignProp("", false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV75Delete), true);
         AV86Delete_GXI = GXDbFile.PathToUrl( context.GetImagePath( "3e4a9f50-2c57-41b6-9da5-ebe49bca33c0", "", context.GetTheme( )));
         AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV75Delete)) ? AV86Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV75Delete))), !bGXsfl_190_Refreshing);
         AssignProp("", false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV75Delete), true);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV52GridStateKey = "";
         new k2bloadgridstate(context ).execute(  AV83Pgmname,  AV52GridStateKey, out  AV53GridState) ;
         ...
         AV87GXV2 = 1;
         while ( AV87GXV2 <= AV53GridState.gxTpr_Filtervalues.Count )
         {
            AV54GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV53GridState.gxTpr_Filtervalues.Item(AV87GXV2));
      ...
      protected void S132( )
      {
         ...
         AV53GridState.gxTpr_Filtervalues.Add(AV54GridStateFilterValue, 0);
         new k2bsavegridstate(context ).execute(  AV83Pgmname,  AV52GridStateKey,  AV53GridState) ;
      }
      ...
      protected void E142V2( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         CallWebObject(formatLink("exportwwtickettecnico.aspx", new object[] {UrlEncode(DateTimeUtil.FormatDateParm(AV57TicketTecnicoFecha_From)),UrlEncode(DateTimeUtil.FormatDateParm(AV58TicketTecnicoFecha_To)),UrlEncode(DateTimeUtil.FormatDateTimeParm(AV60TicketTecnicoHora_From)),UrlEncode(DateTimeUtil.FormatDateTimeParm(AV61TicketTecnicoHora_To)),UrlEncode(StringUtil.RTrim(AV66K2BToolsGenericSearchField)),UrlEncode(StringUtil.LTrimStr(AV67OrderedBy,4,0))}, new string[] {"TicketTecnicoFecha_From","TicketTecnicoFecha_To","TicketTecnicoHora_From","TicketTecnicoHora_To","K2BToolsGenericSearchField","OrderedBy"}) );
      ...
      protected void S202( )
      {
         ...
         AssignAttri("", false, "AV25Att_TicketTecnicoInventarioSerie_Visible", AV25Att_TicketTecnicoInventarioSerie_Visible);
         new k2bsavegridconfiguration(context ).execute(  AV83Pgmname,  "Grid",  AV10GridConfiguration,  false) ;
         AV88GXV3 = 1;
         while ( AV88GXV3 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV13GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV10GridConfiguration.gxTpr_Gridcolumns.Item(AV88GXV3));
      ...
      protected void S182( )
      {
         ...
         AV13GridColumn.gxTpr_Columntitle = "Id Ticket";
         AV13GridColumn.gxTpr_Showattribute = true;
         AV12GridColumns.Add(AV13GridColumn, 0);
         AV13GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV13GridColumn.gxTpr_Attributename = "TicketResponsableId";
         AV13GridColumn.gxTpr_Columntitle = "Ticket Responsable Id";
         AV13GridColumn.gxTpr_Showattribute = true;
         AV12GridColumns.Add(AV13GridColumn, 0);
         AV13GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV13GridColumn.gxTpr_Attributename = "ResponsableNombre";
         AV13GridColumn.gxTpr_Columntitle = "Responsable Nombre";
         AV13GridColumn.gxTpr_Showattribute = true;
         AV12GridColumns.Add(AV13GridColumn, 0);
         AV13GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
      ...
      protected void S122( )
      {
         ...
         if ( AV62K2BFilterValuesSDT.Count > 0 )
         {
            ...
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV83Pgmname,  "Grid",  AV62K2BFilterValuesSDT, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item4) ;
      ...
      protected void E152V2( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  AV83Pgmname,  "Grid", ref  AV10GridConfiguration) ;
         AV89GXV4 = 1;
         while ( AV89GXV4 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV13GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV10GridConfiguration.gxTpr_Gridcolumns.Item(AV89GXV4));
            if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "TicketTecnicoId") == 0 )
            {
         ...
         new k2bsavegridconfiguration(context ).execute(  AV83Pgmname,  "Grid",  AV10GridConfiguration,  true) ;
         AV70UC_OrderedBy = AV67OrderedBy;
         AssignAttri("", false, "AV70UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV70UC_OrderedBy), 4, 0));
         if ( AV50RowsPerPageVariable != AV49GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV50RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV83Pgmname,  "Grid",  AV50RowsPerPageVariable) ;
            AV8CurrentPage = 1;
            AssignAttri("", false, "AV8CurrentPage", StringUtil.LTrimStr( (decimal)(AV8CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023124953795", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwtickettecnico.js", "?2023124953795", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/K2BDateRangePickerRender.js", "", false, true);
      ...
      protected void sendrow_1902( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_190_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV74Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV74Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV85Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV74Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV74Update)) ? AV85Update_GXI : context.PathToRelativeUrl( AV74Update));
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV75Delete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV75Delete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV86Delete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV75Delete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV75Delete)) ? AV86Delete_GXI : context.PathToRelativeUrl( AV75Delete));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOEXPORT'","{handler:'E142V2',iparms:[{av:'AV57TicketTecnicoFecha_From',fld:'vTICKETTECNICOFECHA_FROM',pic:''},{av:'AV58TicketTecnicoFecha_To',fld:'vTICKETTECNICOFECHA_TO',pic:''},{av:'AV60TicketTecnicoHora_From',fld:'vTICKETTECNICOHORA_FROM',pic:'99:99'},{av:'AV61TicketTecnicoHora_To',fld:'vTICKETTECNICOHORA_TO',pic:'99:99'},{av:'AV66K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV67OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_TicketTecnicoId_Visible',fld:'vATT_TICKETTECNICOID_VISIBLE',pic:''},{av:'AV15Att_TicketTecnicoFecha_Visible',fld:'vATT_TICKETTECNICOFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketTecnicoHora_Visible',fld:'vATT_TICKETTECNICOHORA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_TicketResponsableId_Visible',fld:'vATT_TICKETRESPONSABLEID_VISIBLE',pic:''},{av:'AV20Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV21Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV22Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV23Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV24Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV25Att_TicketTecnicoInventarioSerie_Visible',fld:'vATT_TICKETTECNICOINVENTARIOSERIE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOEXPORT'",",oparms:[{av:'AV67OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_TicketTecnicoId_Visible',fld:'vATT_TICKETTECNICOID_VISIBLE',pic:''},{av:'AV15Att_TicketTecnicoFecha_Visible',fld:'vATT_TICKETTECNICOFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketTecnicoHora_Visible',fld:'vATT_TICKETTECNICOHORA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_TicketResponsableId_Visible',fld:'vATT_TICKETRESPONSABLEID_VISIBLE',pic:''},{av:'AV20Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV21Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV22Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV23Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV24Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV25Att_TicketTecnicoInventarioSerie_Visible',fld:'vATT_TICKETTECNICOINVENTARIOSERIE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E252V2',iparms:[{av:'AV79AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZ9'},{av:'AV73TicketTecnicoFecha_IsAuthorized',fld:'vTICKETTECNICOFECHA_ISAUTHORIZED',pic:''},{av:'A18TicketTecnicoId',fld:'TICKETTECNICOID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV14Att_TicketTecnicoId_Visible',fld:'vATT_TICKETTECNICOID_VISIBLE',pic:''},{av:'AV15Att_TicketTecnicoFecha_Visible',fld:'vATT_TICKETTECNICOFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketTecnicoHora_Visible',fld:'vATT_TICKETTECNICOHORA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_TicketResponsableId_Visible',fld:'vATT_TICKETRESPONSABLEID_VISIBLE',pic:''},{av:'AV20Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV21Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV22Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV23Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV24Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV25Att_TicketTecnicoInventarioSerie_Visible',fld:'vATT_TICKETTECNICOINVENTARIOSERIE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED","{handler:'E112V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV66K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV57TicketTecnicoFecha_From',fld:'vTICKETTECNICOFECHA_FROM',pic:''},{av:'AV60TicketTecnicoHora_From',fld:'vTICKETTECNICOHORA_FROM',pic:'99:99'},{av:'AV61TicketTecnicoHora_To',fld:'vTICKETTECNICOHORA_TO',pic:'99:99'},{av:'AV55ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV67OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV58TicketTecnicoFecha_To',fld:'vTICKETTECNICOFECHA_TO',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV79AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV73TicketTecnicoFecha_IsAuthorized',fld:'vTICKETTECNICOFECHA_ISAUTHORIZED',pic:''},{av:'AV65DeletedTag',fld:'vDELETEDTAG',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_TicketTecnicoId_Visible',fld:'vATT_TICKETTECNICOID_VISIBLE',pic:''},{av:'AV15Att_TicketTecnicoFecha_Visible',fld:'vATT_TICKETTECNICOFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketTecnicoHora_Visible',fld:'vATT_TICKETTECNICOHORA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_TicketResponsableId_Visible',fld:'vATT_TICKETRESPONSABLEID_VISIBLE',pic:''},{av:'AV20Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV21Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV22Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV23Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV24Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV25Att_TicketTecnicoInventarioSerie_Visible',fld:'vATT_TICKETTECNICOINVENTARIOSERIE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E122V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV66K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV57TicketTecnicoFecha_From',fld:'vTICKETTECNICOFECHA_FROM',pic:''},{av:'AV60TicketTecnicoHora_From',fld:'vTICKETTECNICOHORA_FROM',pic:'99:99'},{av:'AV61TicketTecnicoHora_To',fld:'vTICKETTECNICOHORA_TO',pic:'99:99'},{av:'AV55ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV67OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV58TicketTecnicoFecha_To',fld:'vTICKETTECNICOFECHA_TO',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV79AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV73TicketTecnicoFecha_IsAuthorized',fld:'vTICKETTECNICOFECHA_ISAUTHORIZED',pic:''},{av:'AV70UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_TicketTecnicoId_Visible',fld:'vATT_TICKETTECNICOID_VISIBLE',pic:''},{av:'AV15Att_TicketTecnicoFecha_Visible',fld:'vATT_TICKETTECNICOFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketTecnicoHora_Visible',fld:'vATT_TICKETTECNICOHORA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_TicketResponsableId_Visible',fld:'vATT_TICKETRESPONSABLEID_VISIBLE',pic:''},{av:'AV20Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV21Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV22Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV23Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV24Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV25Att_TicketTecnicoInventarioSerie_Visible',fld:'vATT_TICKETTECNICOINVENTARIOSERIE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E152V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV66K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV57TicketTecnicoFecha_From',fld:'vTICKETTECNICOFECHA_FROM',pic:''},{av:'AV60TicketTecnicoHora_From',fld:'vTICKETTECNICOHORA_FROM',pic:'99:99'},{av:'AV61TicketTecnicoHora_To',fld:'vTICKETTECNICOHORA_TO',pic:'99:99'},{av:'AV55ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV67OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV58TicketTecnicoFecha_To',fld:'vTICKETTECNICOFECHA_TO',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV79AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV73TicketTecnicoFecha_IsAuthorized',fld:'vTICKETTECNICOFECHA_ISAUTHORIZED',pic:''},{av:'AV50RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV49GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_TicketTecnicoId_Visible',fld:'vATT_TICKETTECNICOID_VISIBLE',pic:''},{av:'AV15Att_TicketTecnicoFecha_Visible',fld:'vATT_TICKETTECNICOFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketTecnicoHora_Visible',fld:'vATT_TICKETTECNICOHORA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_TicketResponsableId_Visible',fld:'vATT_TICKETRESPONSABLEID_VISIBLE',pic:''},{av:'AV20Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV21Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV22Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV23Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV24Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV25Att_TicketTecnicoInventarioSerie_Visible',fld:'vATT_TICKETTECNICOINVENTARIOSERIE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E162V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV66K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV57TicketTecnicoFecha_From',fld:'vTICKETTECNICOFECHA_FROM',pic:''},{av:'AV60TicketTecnicoHora_From',fld:'vTICKETTECNICOHORA_FROM',pic:'99:99'},{av:'AV61TicketTecnicoHora_To',fld:'vTICKETTECNICOHORA_TO',pic:'99:99'},{av:'AV55ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV67OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV58TicketTecnicoFecha_To',fld:'vTICKETTECNICOFECHA_TO',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV79AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV73TicketTecnicoFecha_IsAuthorized',fld:'vTICKETTECNICOFECHA_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_TicketTecnicoId_Visible',fld:'vATT_TICKETTECNICOID_VISIBLE',pic:''},{av:'AV15Att_TicketTecnicoFecha_Visible',fld:'vATT_TICKETTECNICOFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketTecnicoHora_Visible',fld:'vATT_TICKETTECNICOHORA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_TicketResponsableId_Visible',fld:'vATT_TICKETRESPONSABLEID_VISIBLE',pic:''},{av:'AV20Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV21Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV22Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV23Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV24Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV25Att_TicketTecnicoInventarioSerie_Visible',fld:'vATT_TICKETTECNICOINVENTARIOSERIE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E172V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV66K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV57TicketTecnicoFecha_From',fld:'vTICKETTECNICOFECHA_FROM',pic:''},{av:'AV60TicketTecnicoHora_From',fld:'vTICKETTECNICOHORA_FROM',pic:'99:99'},{av:'AV61TicketTecnicoHora_To',fld:'vTICKETTECNICOHORA_TO',pic:'99:99'},{av:'AV55ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV67OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV58TicketTecnicoFecha_To',fld:'vTICKETTECNICOFECHA_TO',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV79AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV73TicketTecnicoFecha_IsAuthorized',fld:'vTICKETTECNICOFECHA_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_TicketTecnicoId_Visible',fld:'vATT_TICKETTECNICOID_VISIBLE',pic:''},{av:'AV15Att_TicketTecnicoFecha_Visible',fld:'vATT_TICKETTECNICOFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketTecnicoHora_Visible',fld:'vATT_TICKETTECNICOHORA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_TicketResponsableId_Visible',fld:'vATT_TICKETRESPONSABLEID_VISIBLE',pic:''},{av:'AV20Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV21Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV22Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV23Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV24Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV25Att_TicketTecnicoInventarioSerie_Visible',fld:'vATT_TICKETTECNICOINVENTARIOSERIE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E182V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV66K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV57TicketTecnicoFecha_From',fld:'vTICKETTECNICOFECHA_FROM',pic:''},{av:'AV60TicketTecnicoHora_From',fld:'vTICKETTECNICOHORA_FROM',pic:'99:99'},{av:'AV61TicketTecnicoHora_To',fld:'vTICKETTECNICOHORA_TO',pic:'99:99'},{av:'AV55ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV67OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV58TicketTecnicoFecha_To',fld:'vTICKETTECNICOFECHA_TO',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV79AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV73TicketTecnicoFecha_IsAuthorized',fld:'vTICKETTECNICOFECHA_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_TicketTecnicoId_Visible',fld:'vATT_TICKETTECNICOID_VISIBLE',pic:''},{av:'AV15Att_TicketTecnicoFecha_Visible',fld:'vATT_TICKETTECNICOFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketTecnicoHora_Visible',fld:'vATT_TICKETTECNICOHORA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_TicketResponsableId_Visible',fld:'vATT_TICKETRESPONSABLEID_VISIBLE',pic:''},{av:'AV20Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV21Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV22Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV23Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV24Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV25Att_TicketTecnicoInventarioSerie_Visible',fld:'vATT_TICKETTECNICOINVENTARIOSERIE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E192V2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV66K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV57TicketTecnicoFecha_From',fld:'vTICKETTECNICOFECHA_FROM',pic:''},{av:'AV60TicketTecnicoHora_From',fld:'vTICKETTECNICOHORA_FROM',pic:'99:99'},{av:'AV61TicketTecnicoHora_To',fld:'vTICKETTECNICOHORA_TO',pic:'99:99'},{av:'AV55ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV67OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV58TicketTecnicoFecha_To',fld:'vTICKETTECNICOFECHA_TO',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV79AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV73TicketTecnicoFecha_IsAuthorized',fld:'vTICKETTECNICOFECHA_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_TicketTecnicoId_Visible',fld:'vATT_TICKETTECNICOID_VISIBLE',pic:''},{av:'AV15Att_TicketTecnicoFecha_Visible',fld:'vATT_TICKETTECNICOFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketTecnicoHora_Visible',fld:'vATT_TICKETTECNICOHORA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_TicketResponsableId_Visible',fld:'vATT_TICKETRESPONSABLEID_VISIBLE',pic:''},{av:'AV20Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV21Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV22Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV23Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV24Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV25Att_TicketTecnicoInventarioSerie_Visible',fld:'vATT_TICKETTECNICOINVENTARIOSERIE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         H002V2_A15UsuarioId = new short[1] ;
         ...
         AV69GridOrder = new SdtK2BGridOrders_K2BGridOrdersItem(context);
         AV71Messages = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
      ...
      private short[] H002V2_A15UsuarioId ;
      ...
      private GXBaseCollection<SdtMessages_Message> AV71Messages ;
   ...
   public class wwtickettecnico__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV67OrderedBy )
      {
         ...
         {
            AddWhere(sWhereString, "(CONVERT( char(10), CAST(T1.[TicketTecnicoId] AS decimal(10,0))) like '%' + @lV66K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T1.[TicketId] AS decimal(10,0))) like '%' + @lV66K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T1.[TicketResponsableId] AS decimal(10,0))) like '%' + @lV66K2BToolsGenericSearchField + '%' or T2.[ResponsableNombre] like '%' + @lV66K2BToolsGenericSearchField + '%' or CONVERT( char(4), CAST(T3.[UsuarioId] AS decimal(4,0))) like '%' + @lV66K2BToolsGenericSearchField + '%' or T4.[UsuarioNombre] like '%' + @lV66K2BToolsGenericSearchField + '%' or T4.[UsuarioRequerimiento] like '%' + @lV66K2BToolsGenericSearchField + '%' or T4.[UsuarioDepartamento] like '%' + @lV66K2BToolsGenericSearchField + '%' or T1.[TicketTecnicoInventarioSerie] like '%' + @lV66K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int5[4] = 1;
                                             ...
                                             short AV67OrderedBy )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV66K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(10), CAST(T1.[TicketTecnicoId] AS decimal(10,0))) like '%' + @lV66K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T1.[TicketId] AS decimal(10,0))) like '%' + @lV66K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T1.[TicketResponsableId] AS decimal(10,0))) like '%' + @lV66K2BToolsGenericSearchField + '%' or T4.[ResponsableNombre] like '%' + @lV66K2BToolsGenericSearchField + '%' or CONVERT( char(4), CAST(T2.[UsuarioId] AS decimal(4,0))) like '%' + @lV66K2BToolsGenericSearchField + '%' or T3.[UsuarioNombre] like '%' + @lV66K2BToolsGenericSearchField + '%' or T3.[UsuarioRequerimiento] like '%' + @lV66K2BToolsGenericSearchField + '%' or T3.[UsuarioDepartamento] like '%' + @lV66K2BToolsGenericSearchField + '%' or T1.[TicketTecnicoInventarioSerie] like '%' + @lV66K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int7[4] = 1;
