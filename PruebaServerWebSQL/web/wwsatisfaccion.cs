...
namespace GeneXus.Programs {
   public class wwsatisfaccion : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV51K2BToolsGenericSearchField, AV36SatisfaccionFecha_From, AV39UsuarioFecha_From, AV41SatisfaccionResueltoNombre, AV42SatisfaccionTecnicoProblemaNombre, AV43SatisfaccionTecnicoCompetenteNombre, AV44SatisfaccionTecnicoProfesionalismoNombre, AV45SatisfaccionTiempoNombre, AV46SatisfaccionAtencionNombre, AV71UsuarioNombre, AV34ClassCollection, AV52OrderedBy, AV37SatisfaccionFecha_To, AV40UsuarioFecha_To, AV74Pgmname, AV8CurrentPage, AV10GridConfiguration, AV64AutoLinksActivityList, AV70Att_TicketId_Visible, AV68Att_TicketResponsableId_Visible, AV69Att_TicketTecnicoResponsableNombre_Visible, AV18Att_UsuarioNombre_Visible, AV19Att_UsuarioFecha_Visible, AV20Att_UsuarioRequerimiento_Visible, AV11FreezeColumnTitles) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249531266", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV59Update)) ? AV76Update_GXI : context.convertURL( context.PathToRelativeUrl( AV59Update))), !bGXsfl_197_Refreshing);
                              ...
                              AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV60Delete)) ? AV77Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV60Delete))), !bGXsfl_197_Refreshing);
      ...
      protected void STRUP2Y0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.CToD( cgiGet( "GXH_vSATISFACCIONFECHA_FROM"), 2) != AV36SatisfaccionFecha_From )
            {
               GRID_nFirstRecordOnPage = 0;
            }
            if ( context.localUtil.CToD( cgiGet( "GXH_vUSUARIOFECHA_FROM"), 2) != AV39UsuarioFecha_From )
            {
               GRID_nFirstRecordOnPage = 0;
            }
            if ( StringUtil.StrCmp(cgiGet( "GXH_vSATISFACCIONRESUELTONOMBRE"), AV41SatisfaccionResueltoNombre) != 0 )
      ...
      protected void E222Y2( )
      {
         ...
         new k2bloadrowsperpage(context ).execute(  AV74Pgmname,  "Grid", out  AV29RowsPerPageVariable, out  AV30RowsPerPageLoaded) ;
      ...
      protected void E232Y2( )
      {
         ...
         AV75GXV1 = 1;
         while ( AV75GXV1 <= AV56Messages.Count )
         {
            AV57Message = ((GeneXus.Utils.SdtMessages_Message)AV56Messages.Item(AV75GXV1));
         ...
         AV65ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV74Pgmname;
         ...
         AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV59Update)) ? AV76Update_GXI : context.convertURL( context.PathToRelativeUrl( AV59Update))), !bGXsfl_197_Refreshing);
         AssignProp("", false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV59Update), true);
         AV76Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "788f9b72-f982-49f9-99e4-c0374e31a85a", "", context.GetTheme( )));
         AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV59Update)) ? AV76Update_GXI : context.convertURL( context.PathToRelativeUrl( AV59Update))), !bGXsfl_197_Refreshing);
         AssignProp("", false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV59Update), true);
         ...
         AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV60Delete)) ? AV77Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV60Delete))), !bGXsfl_197_Refreshing);
         AssignProp("", false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV60Delete), true);
         AV77Delete_GXI = GXDbFile.PathToUrl( context.GetImagePath( "3e4a9f50-2c57-41b6-9da5-ebe49bca33c0", "", context.GetTheme( )));
         AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV60Delete)) ? AV77Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV60Delete))), !bGXsfl_197_Refreshing);
         AssignProp("", false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV60Delete), true);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV31GridStateKey = "";
         new k2bloadgridstate(context ).execute(  AV74Pgmname,  AV31GridStateKey, out  AV32GridState) ;
         ...
         {
            AV33GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV32GridState.gxTpr_Filtervalues.Item(AV78GXV2));
      ...
      protected void S132( )
      {
         ...
         AV32GridState.gxTpr_Filtervalues.Add(AV33GridStateFilterValue, 0);
         new k2bsavegridstate(context ).execute(  AV74Pgmname,  AV31GridStateKey,  AV32GridState) ;
      }
      ...
      protected void S202( )
      {
         ...
         AssignAttri("", false, "AV20Att_UsuarioRequerimiento_Visible", AV20Att_UsuarioRequerimiento_Visible);
         new k2bsavegridconfiguration(context ).execute(  AV74Pgmname,  "Grid",  AV10GridConfiguration,  false) ;
         AV79GXV3 = 1;
         while ( AV79GXV3 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV13GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV10GridConfiguration.gxTpr_Gridcolumns.Item(AV79GXV3));
      ...
      protected void S122( )
      {
         ...
         if ( AV47K2BFilterValuesSDT.Count > 0 )
         {
            ...
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV74Pgmname,  "Grid",  AV47K2BFilterValuesSDT, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item4) ;
      ...
      protected void E152Y2( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  AV74Pgmname,  "Grid", ref  AV10GridConfiguration) ;
         AV80GXV4 = 1;
         while ( AV80GXV4 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV13GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV10GridConfiguration.gxTpr_Gridcolumns.Item(AV80GXV4));
            if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "TicketId") == 0 )
            {
         ...
         new k2bsavegridconfiguration(context ).execute(  AV74Pgmname,  "Grid",  AV10GridConfiguration,  true) ;
         AV55UC_OrderedBy = AV52OrderedBy;
         AssignAttri("", false, "AV55UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV55UC_OrderedBy), 4, 0));
         if ( AV29RowsPerPageVariable != AV28GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV29RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV74Pgmname,  "Grid",  AV29RowsPerPageVariable) ;
            AV8CurrentPage = 1;
            AssignAttri("", false, "AV8CurrentPage", StringUtil.LTrimStr( (decimal)(AV8CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249531999", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwsatisfaccion.js", "?2023124953201", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/K2BDateRangePickerRender.js", "", false, true);
      ...
      protected void sendrow_1972( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_197_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute_Grid";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSatisfaccionAtencionId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A13SatisfaccionAtencionId), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A13SatisfaccionAtencionId), "ZZZ9"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSatisfaccionAtencionId_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn InvisibleInExtraSmallColumn",(string)"",(short)0,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)197,(short)1,(short)-1,(short)0,(bool)true,(string)"NumMin",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV59Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV59Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV76Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV59Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV59Update)) ? AV76Update_GXI : context.PathToRelativeUrl( AV59Update));
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV60Delete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV60Delete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV77Delete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV60Delete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV60Delete)) ? AV77Delete_GXI : context.PathToRelativeUrl( AV60Delete));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E252Y2',iparms:[{av:'AV64AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZ9'},{av:'A7SatisfaccionId',fld:'SATISFACCIONID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV70Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV68Att_TicketResponsableId_Visible',fld:'vATT_TICKETRESPONSABLEID_VISIBLE',pic:''},{av:'AV69Att_TicketTecnicoResponsableNombre_Visible',fld:'vATT_TICKETTECNICORESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV18Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV19Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E122Y2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV51K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV45SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV46SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV71UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV52OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV74Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV64AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV55UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV70Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV68Att_TicketResponsableId_Visible',fld:'vATT_TICKETRESPONSABLEID_VISIBLE',pic:''},{av:'AV69Att_TicketTecnicoResponsableNombre_Visible',fld:'vATT_TICKETTECNICORESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV18Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV19Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E152Y2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV51K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV45SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV46SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV71UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV52OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV74Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV64AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV29RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV28GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV70Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV68Att_TicketResponsableId_Visible',fld:'vATT_TICKETRESPONSABLEID_VISIBLE',pic:''},{av:'AV69Att_TicketTecnicoResponsableNombre_Visible',fld:'vATT_TICKETTECNICORESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV18Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV19Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E162Y2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV51K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV45SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV46SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV71UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV52OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV74Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV64AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV70Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV68Att_TicketResponsableId_Visible',fld:'vATT_TICKETRESPONSABLEID_VISIBLE',pic:''},{av:'AV69Att_TicketTecnicoResponsableNombre_Visible',fld:'vATT_TICKETTECNICORESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV18Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV19Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E172Y2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV51K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV45SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV46SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV71UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV52OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV74Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV64AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV70Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV68Att_TicketResponsableId_Visible',fld:'vATT_TICKETRESPONSABLEID_VISIBLE',pic:''},{av:'AV69Att_TicketTecnicoResponsableNombre_Visible',fld:'vATT_TICKETTECNICORESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV18Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV19Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E182Y2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV51K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV45SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV46SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV71UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV52OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV74Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV64AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV70Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV68Att_TicketResponsableId_Visible',fld:'vATT_TICKETRESPONSABLEID_VISIBLE',pic:''},{av:'AV69Att_TicketTecnicoResponsableNombre_Visible',fld:'vATT_TICKETTECNICORESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV18Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV19Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E192Y2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV51K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV44SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV45SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV46SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV71UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV52OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV74Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV64AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV70Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV68Att_TicketResponsableId_Visible',fld:'vATT_TICKETRESPONSABLEID_VISIBLE',pic:''},{av:'AV69Att_TicketTecnicoResponsableNombre_Visible',fld:'vATT_TICKETTECNICORESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV18Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV19Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         H002Y2_A15UsuarioId = new short[1] ;
         ...
         AV54GridOrder = new SdtK2BGridOrders_K2BGridOrdersItem(context);
         AV56Messages = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwsatisfaccion__default(),
            new Object[][] {
                new Object[] {
               H002Y2_A34SatisfaccionSugerencia, H002Y2_A31SatisfaccionAtencionNombre, H002Y2_A13SatisfaccionAtencionId, H002Y2_A38SatisfaccionTiempoNombre, H002Y2_A12SatisfaccionTiempoId, H002Y2_A37SatisfaccionTecnicoProfesionalismoNombre, H002Y2_A11SatisfaccionTecnicoProfesionalismoId, H002Y2_A35SatisfaccionTecnicoCompetenteNombre, H002Y2_A10SatisfaccionTecnicoCompetenteId, H002Y2_A36SatisfaccionTecnicoProblemaNombre,
               H002Y2_A9SatisfaccionTecnicoProblemaId, H002Y2_A33SatisfaccionResueltoNombre, H002Y2_A8SatisfaccionResueltoId, H002Y2_A94UsuarioRequerimiento, H002Y2_A90UsuarioFecha, H002Y2_A93UsuarioNombre, H002Y2_A15UsuarioId, H002Y2_A199TicketTecnicoResponsableNombre, H002Y2_A198TicketTecnicoResponsableId, H002Y2_A16TicketResponsableId,
               H002Y2_A14TicketId, H002Y2_A144SatisfaccionHora, H002Y2_A32SatisfaccionFecha, H002Y2_A7SatisfaccionId
               }
               , new Object[] {
      ...
      private short[] H002Y2_A15UsuarioId ;
      ...
      private GXBaseCollection<SdtMessages_Message> AV56Messages ;
