...
namespace GeneXus.Programs {
   public class entitymanageractividades_categoria : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public entitymanageractividades_categoria( )
      {
      ...
      public entitymanageractividades_categoria( IGxContext context )
      {
                           ...
                           string aP2_TabCode )
      {
         ...
         this.AV6id_actividad_categoria = aP1_id_actividad_categoria;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               {
                  AV6id_actividad_categoria = (int)(NumberUtil.Val( GetPar( "id_actividad_categoria"), "."));
                  AssignAttri("", false, "AV6id_actividad_categoria", StringUtil.LTrimStr( (decimal)(AV6id_actividad_categoria), 9, 0));
                  GxWebStd.gx_hidden_field( context, "gxhash_vID_ACTIVIDAD_CATEGORIA", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6id_actividad_categoria), "ZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2023124956367", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("entitymanageractividades_categoria.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6id_actividad_categoria,9,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Gx_mode","id_actividad_categoria","TabCode"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vMODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( Gx_mode, "@!")), context));
         GxWebStd.gx_hidden_field( context, "vID_ACTIVIDAD_CATEGORIA", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6id_actividad_categoria), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vID_ACTIVIDAD_CATEGORIA", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6id_actividad_categoria), "ZZZZZZZZ9"), context));
      ...
      {
         return formatLink("entitymanageractividades_categoria.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6id_actividad_categoria,9,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Gx_mode","id_actividad_categoria","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "EntityManageractividades_categoria" ;
      }
      ...
      protected void WB550( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblK2bpgmdesc_Internalname, lblK2bpgmdesc_Caption, "", "", lblK2bpgmdesc_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_EntityManageractividades_categoria.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblBacktoworkwith_Internalname, lblBacktoworkwith_Caption, lblBacktoworkwith_Link, "", lblBacktoworkwith_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_BackToWorkWith", 0, "", 1, 1, 0, 0, "HLP_EntityManageractividades_categoria.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_47_552( true) ;
         }
         else
         {
            wb_table1_47_552( false) ;
         }
         return  ;
      }

      protected void wb_table1_47_552e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      {
         /* GeneXus formulas. */
         AV27Pgmname = "EntityManageractividades_categoria";
         context.Gx_err = 0;
      }
      ...
      protected void E11552( )
      {
         /* Start Routine */
         returnInSub = false;
         lblBacktoworkwith_Caption = StringUtil.Format( "%1", "actividades_categorias", "", "", "", "", "", "", "", "");
         AssignProp("", false, lblBacktoworkwith_Internalname, "Caption", lblBacktoworkwith_Caption, true);
         lblBacktoworkwith_Link = formatLink("wwactividades_categoria.aspx") ;
         AssignProp("", false, lblBacktoworkwith_Internalname, "Link", lblBacktoworkwith_Link, true);
         AV26GXLvl7 = 0;
         /* Using cursor H00552 */
         pr_datastore1.execute(0, new Object[] {AV6id_actividad_categoria});
         while ( (pr_datastore1.getStatus(0) != 101) )
         {
            A102id_actividad_categoria = H00552_A102id_actividad_categoria[0];
            A122actividades_categoriaid_tipo_categoria = H00552_A122actividades_categoriaid_tipo_categoria[0];
            n122actividades_categoriaid_tipo_categoria = H00552_n122actividades_categoriaid_tipo_categoria[0];
            AV26GXLvl7 = 1;
            Form.Caption = StringUtil.Str( (decimal)(A122actividades_categoriaid_tipo_categoria), 9, 0);
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblK2bpgmdesc_Caption = StringUtil.Format( "%1 - %2", "actividades_categoria", context.localUtil.Format( (decimal)(A122actividades_categoriaid_tipo_categoria), "ZZZZZZZZ9"), "", "", "", "", "", "", "");
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            lblK2bpgmdesc_Caption = "actividades_categoria";
            AssignProp("", false, lblK2bpgmdesc_Internalname, "Caption", lblK2bpgmdesc_Caption, true);
         }
      ...
      protected void E12552( )
      {
         ...
         {
            AV20RelatedTransactionName = "actividades_categoria";
         ...
         if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               lblComponenttitle_Caption = StringUtil.Format( "Actualizar %1", "actividades_categoria", "", "", "", "", "", "", "", "");
               ...
               if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Popupcomponent_Component), StringUtil.Lower( "actividades_categoria")) != 0 )
               {
                  WebComp_Popupcomponent = getWebComponent(GetType(), "GeneXus.Programs", "actividades_categoria", new Object[] {context} );
                  WebComp_Popupcomponent.ComponentInit();
                  WebComp_Popupcomponent.Name = "actividades_categoria";
                  WebComp_Popupcomponent_Component = "actividades_categoria";
               }
               if ( StringUtil.Len( WebComp_Popupcomponent_Component) != 0 )
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0067",(string)"",(string)"UPD",(int)AV6id_actividad_categoria});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
         {
            if ( ( StringUtil.StrCmp(AV8TabCode, "General") == 0 ) || String.IsNullOrEmpty(StringUtil.RTrim( AV8TabCode)) )
            {
               lblComponenttitle_Caption = StringUtil.Format( "Eliminar %1", "actividades_categoria", "", "", "", "", "", "", "", "");
               AssignProp("", false, lblComponenttitle_Internalname, "Caption", lblComponenttitle_Caption, true);
               tblTablemodal_Visible = 1;
               AssignProp("", false, tblTablemodal_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(tblTablemodal_Visible), 5, 0), true);
               /* Object Property */
               ...
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0067",(string)"",(string)"DLT",(int)AV6id_actividad_categoria});
                  WebComp_Popupcomponent.componentbind(new Object[] {(string)"",(string)""});
               }
               if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Popupcomponent )
               {
      ...
      protected void S112( )
      {
         ...
         AV11Tab.gxTpr_Link = formatLink("entitymanageractividades_categoria.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6id_actividad_categoria,9,0)),UrlEncode(StringUtil.RTrim(AV11Tab.gxTpr_Code))}, new string[] {"Mode","id_actividad_categoria","TabCode"}) ;
         AV11Tab.gxTpr_Componenttype = 3;
         AV11Tab.gxTpr_Relatedtransaction = "actividades_categoria";
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Componentwc_general_Component), StringUtil.Lower( "actividades_categoriaGeneral")) != 0 )
            {
               WebComp_Componentwc_general = getWebComponent(GetType(), "GeneXus.Programs", "actividades_categoriageneral", new Object[] {context} );
               WebComp_Componentwc_general.ComponentInit();
               WebComp_Componentwc_general.Name = "actividades_categoriaGeneral";
               WebComp_Componentwc_general_Component = "actividades_categoriaGeneral";
            }
            if ( StringUtil.Len( WebComp_Componentwc_general_Component) != 0 )
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0041",(string)"",(string)Gx_mode,(int)AV6id_actividad_categoria,(string)AV8TabCode});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0041",(string)"",(string)"DSP",(int)AV6id_actividad_categoria,(string)AV8TabCode});
               WebComp_Componentwc_general.componentbind(new Object[] {(string)"",(string)"",(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Componentwc_general )
            {
      ...
      protected void wb_table1_47_552( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_53_552( true) ;
         }
         else
         {
            wb_table2_53_552( false) ;
         }
         return  ;
      }

      protected void wb_table2_53_552e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            wb_table1_47_552e( true) ;
         }
         else
         {
            wb_table1_47_552e( false) ;
         }
      }

      protected void wb_table2_53_552( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblComponenttitle_Internalname, lblComponenttitle_Caption, "", "", lblComponenttitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "PopupTitle", 0, "", 1, 1, 0, 0, "HLP_EntityManageractividades_categoria.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table3_58_552( true) ;
         }
         else
         {
            wb_table3_58_552( false) ;
         }
         return  ;
      }

      protected void wb_table3_58_552e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_53_552e( true) ;
         }
         else
         {
            wb_table2_53_552e( false) ;
         }
      }

      protected void wb_table3_58_552( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'CLOSEMODAL\\'."+"'", "", "PopupHeaderButton", 5, "", 1, 1, 0, 0, "HLP_EntityManageractividades_categoria.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_58_552e( true) ;
         }
         else
         {
            wb_table3_58_552e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "Gx_mode", Gx_mode);
         AV6id_actividad_categoria = Convert.ToInt32(getParm(obj,1));
         AssignAttri("", false, "AV6id_actividad_categoria", StringUtil.LTrimStr( (decimal)(AV6id_actividad_categoria), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vID_ACTIVIDAD_CATEGORIA", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6id_actividad_categoria), "ZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249563656", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("entitymanageractividades_categoria.js", "?20231249563656", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GLOBALEVENTS.K2BT_REFRESHENTITYMANAGER","{handler:'E13552',iparms:[{av:'AV22GE_ComponentName',fld:'vGE_COMPONENTNAME',pic:''},{av:'AV21GE_EntityManagerName',fld:'vGE_ENTITYMANAGERNAME',pic:''},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV6id_actividad_categoria',fld:'vID_ACTIVIDAD_CATEGORIA',pic:'ZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("'CLOSEMODAL'","{handler:'E14552',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00552_A102id_actividad_categoria = new int[1] ;
         H00552_A122actividades_categoriaid_tipo_categoria = new int[1] ;
         H00552_n122actividades_categoriaid_tipo_categoria = new bool[] {false} ;
         ...
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.entitymanageractividades_categoria__datastore1(),
            new Object[][] {
                new Object[] {
               H00552_A102id_actividad_categoria, H00552_A122actividades_categoriaid_tipo_categoria, H00552_n122actividades_categoriaid_tipo_categoria
               }
            }
         );
      ...
      private int AV6id_actividad_categoria ;
      private int wcpOAV6id_actividad_categoria ;
      ...
      private int[] H00552_A102id_actividad_categoria ;
      private int[] H00552_A122actividades_categoriaid_tipo_categoria ;
      private bool[] H00552_n122actividades_categoriaid_tipo_categoria ;
   ...
   public class entitymanageractividades_categoria__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6id_actividad_categoria",GXType.Int32,9,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00552", "SELECT TOP 1 [id_actividad_categoria], [id_tipo_categoria] FROM dbo.[actividades_categoria] WHERE [id_actividad_categoria] = @AV6id_actividad_categoria ORDER BY [id_actividad_categoria] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00552,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
