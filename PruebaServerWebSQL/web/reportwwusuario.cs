...
namespace GeneXus.Programs {
   public class reportwwusuario : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               ...
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  ...
                  AV27UsuarioId = (short)(NumberUtil.Val( GetPar( "UsuarioId"), "."));
         ...
         try
         {
            ...
            else
            {
               ...
               if ( ! (0==AV27UsuarioId) )
               {
                  ...
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(AV27UsuarioId), "ZZZ9")), 99, Gx_line+7, 129, Gx_line+23, 2+256, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
               }
               H3K0( false, 30) ;
      ...
      public override void initialize( )
      {
         ...
         P003K2_A15UsuarioId = new short[1] ;
      ...
      private short[] P003K2_A15UsuarioId ;
   ...
   public class reportwwusuario__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P003K2(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (DateTime)dynConstraints[6] , (short)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (int)dynConstraints[12] , (short)dynConstraints[13] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV27UsuarioId",GXType.Int16,4,0) ,
