...
namespace GeneXus.Programs {
   public class entitymanagercategoria_tarea : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public entitymanagercategoria_tarea( )
      {
      ...
      public entitymanagercategoria_tarea( IGxContext context )
      {
                           ...
                           string aP2_TabCode )
      {
         ...
         this.AV6categoria_tareaid_tipo_categoria = aP1_categoria_tareaid_tipo_categoria;
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  ...
                  GxWebStd.gx_hidden_field( context, "gxhash_vCATEGORIA_TAREAID_TIPO_CATEGORIA", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6categoria_tareaid_tipo_categoria), "ZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249563691", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("entitymanagercategoria_tarea.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6categoria_tareaid_tipo_categoria,9,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Gx_mode","categoria_tareaid_tipo_categoria","TabCode"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vMODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( Gx_mode, "@!")), context));
         GxWebStd.gx_hidden_field( context, "vCATEGORIA_TAREAID_TIPO_CATEGORIA", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6categoria_tareaid_tipo_categoria), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCATEGORIA_TAREAID_TIPO_CATEGORIA", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6categoria_tareaid_tipo_categoria), "ZZZZZZZZ9"), context));
      ...
      {
         return formatLink("entitymanagercategoria_tarea.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6categoria_tareaid_tipo_categoria,9,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Gx_mode","categoria_tareaid_tipo_categoria","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "EntityManagercategoria_tarea" ;
      }
      ...
      protected void WB590( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblK2bpgmdesc_Internalname, lblK2bpgmdesc_Caption, "", "", lblK2bpgmdesc_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_EntityManagercategoria_tarea.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblBacktoworkwith_Internalname, lblBacktoworkwith_Caption, lblBacktoworkwith_Link, "", lblBacktoworkwith_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_BackToWorkWith", 0, "", 1, 1, 0, 0, "HLP_EntityManagercategoria_tarea.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_47_592( true) ;
         }
         else
         {
            wb_table1_47_592( false) ;
         }
         return  ;
      }

      protected void wb_table1_47_592e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      {
         /* GeneXus formulas. */
         AV27Pgmname = "EntityManagercategoria_tarea";
         context.Gx_err = 0;
      }
      ...
      protected void E11592( )
      {
         /* Start Routine */
         returnInSub = false;
         lblBacktoworkwith_Caption = StringUtil.Format( "%1", "categoria_tareas", "", "", "", "", "", "", "", "");
         AssignProp("", false, lblBacktoworkwith_Internalname, "Caption", lblBacktoworkwith_Caption, true);
         lblBacktoworkwith_Link = formatLink("wwcategoria_tarea.aspx") ;
         AssignProp("", false, lblBacktoworkwith_Internalname, "Link", lblBacktoworkwith_Link, true);
         AV26GXLvl7 = 0;
         /* Using cursor H00592 */
         pr_datastore1.execute(0, new Object[] {AV6categoria_tareaid_tipo_categoria});
         while ( (pr_datastore1.getStatus(0) != 101) )
         {
            A104categoria_tareaid_tipo_categoria = H00592_A104categoria_tareaid_tipo_categoria[0];
            A105id_unidad_gis = H00592_A105id_unidad_gis[0];
            AV26GXLvl7 = 1;
            Form.Caption = StringUtil.Str( (decimal)(A105id_unidad_gis), 9, 0);
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblK2bpgmdesc_Caption = StringUtil.Format( "%1 - %2", "categoria_tarea", context.localUtil.Format( (decimal)(A105id_unidad_gis), "ZZZZZZZZ9"), "", "", "", "", "", "", "");
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            lblK2bpgmdesc_Caption = "categoria_tarea";
            AssignProp("", false, lblK2bpgmdesc_Internalname, "Caption", lblK2bpgmdesc_Caption, true);
         }
      ...
      protected void E12592( )
      {
         ...
         {
            AV20RelatedTransactionName = "categoria_tarea";
         ...
         if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               lblComponenttitle_Caption = StringUtil.Format( "Actualizar %1", "categoria_tarea", "", "", "", "", "", "", "", "");
               ...
               if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Popupcomponent_Component), StringUtil.Lower( "categoria_tarea")) != 0 )
               {
                  WebComp_Popupcomponent = getWebComponent(GetType(), "GeneXus.Programs", "categoria_tarea", new Object[] {context} );
                  WebComp_Popupcomponent.ComponentInit();
                  WebComp_Popupcomponent.Name = "categoria_tarea";
                  WebComp_Popupcomponent_Component = "categoria_tarea";
               }
               if ( StringUtil.Len( WebComp_Popupcomponent_Component) != 0 )
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0067",(string)"",(string)"UPD",(int)AV6categoria_tareaid_tipo_categoria});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
         {
            if ( ( StringUtil.StrCmp(AV8TabCode, "General") == 0 ) || String.IsNullOrEmpty(StringUtil.RTrim( AV8TabCode)) )
            {
               lblComponenttitle_Caption = StringUtil.Format( "Eliminar %1", "categoria_tarea", "", "", "", "", "", "", "", "");
               AssignProp("", false, lblComponenttitle_Internalname, "Caption", lblComponenttitle_Caption, true);
               tblTablemodal_Visible = 1;
               AssignProp("", false, tblTablemodal_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(tblTablemodal_Visible), 5, 0), true);
               /* Object Property */
               ...
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0067",(string)"",(string)"DLT",(int)AV6categoria_tareaid_tipo_categoria});
                  WebComp_Popupcomponent.componentbind(new Object[] {(string)"",(string)""});
               }
               if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Popupcomponent )
               {
      ...
      protected void S112( )
      {
         ...
         AV11Tab.gxTpr_Link = formatLink("entitymanagercategoria_tarea.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6categoria_tareaid_tipo_categoria,9,0)),UrlEncode(StringUtil.RTrim(AV11Tab.gxTpr_Code))}, new string[] {"Mode","categoria_tareaid_tipo_categoria","TabCode"}) ;
         AV11Tab.gxTpr_Componenttype = 3;
         AV11Tab.gxTpr_Relatedtransaction = "categoria_tarea";
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Componentwc_general_Component), StringUtil.Lower( "categoria_tareaGeneral")) != 0 )
            {
               WebComp_Componentwc_general = getWebComponent(GetType(), "GeneXus.Programs", "categoria_tareageneral", new Object[] {context} );
               WebComp_Componentwc_general.ComponentInit();
               WebComp_Componentwc_general.Name = "categoria_tareaGeneral";
               WebComp_Componentwc_general_Component = "categoria_tareaGeneral";
            }
            if ( StringUtil.Len( WebComp_Componentwc_general_Component) != 0 )
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0041",(string)"",(string)Gx_mode,(int)AV6categoria_tareaid_tipo_categoria,(string)AV8TabCode});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0041",(string)"",(string)"DSP",(int)AV6categoria_tareaid_tipo_categoria,(string)AV8TabCode});
               WebComp_Componentwc_general.componentbind(new Object[] {(string)"",(string)"",(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Componentwc_general )
            {
      ...
      protected void wb_table1_47_592( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_53_592( true) ;
         }
         else
         {
            wb_table2_53_592( false) ;
         }
         return  ;
      }

      protected void wb_table2_53_592e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            wb_table1_47_592e( true) ;
         }
         else
         {
            wb_table1_47_592e( false) ;
         }
      }

      protected void wb_table2_53_592( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblComponenttitle_Internalname, lblComponenttitle_Caption, "", "", lblComponenttitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "PopupTitle", 0, "", 1, 1, 0, 0, "HLP_EntityManagercategoria_tarea.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table3_58_592( true) ;
         }
         else
         {
            wb_table3_58_592( false) ;
         }
         return  ;
      }

      protected void wb_table3_58_592e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_53_592e( true) ;
         }
         else
         {
            wb_table2_53_592e( false) ;
         }
      }

      protected void wb_table3_58_592( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'CLOSEMODAL\\'."+"'", "", "PopupHeaderButton", 5, "", 1, 1, 0, 0, "HLP_EntityManagercategoria_tarea.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_58_592e( true) ;
         }
         else
         {
            wb_table3_58_592e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "Gx_mode", Gx_mode);
         AV6categoria_tareaid_tipo_categoria = Convert.ToInt32(getParm(obj,1));
         AssignAttri("", false, "AV6categoria_tareaid_tipo_categoria", StringUtil.LTrimStr( (decimal)(AV6categoria_tareaid_tipo_categoria), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCATEGORIA_TAREAID_TIPO_CATEGORIA", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6categoria_tareaid_tipo_categoria), "ZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249563741", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("entitymanagercategoria_tarea.js", "?20231249563742", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV18AvailableComponents',fld:'vAVAILABLECOMPONENTS',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'AV20RelatedTransactionName',fld:'vRELATEDTRANSACTIONNAME',pic:'',hsh:true},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV6categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9',hsh:true}]");
         ...
         setEventMetadata("GLOBALEVENTS.K2BT_REFRESHENTITYMANAGER","{handler:'E13592',iparms:[{av:'AV22GE_ComponentName',fld:'vGE_COMPONENTNAME',pic:''},{av:'AV21GE_EntityManagerName',fld:'vGE_ENTITYMANAGERNAME',pic:''},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV6categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("'CLOSEMODAL'","{handler:'E14592',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00592_A104categoria_tareaid_tipo_categoria = new int[1] ;
         H00592_A105id_unidad_gis = new int[1] ;
         ...
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.entitymanagercategoria_tarea__datastore1(),
            new Object[][] {
                new Object[] {
               H00592_A104categoria_tareaid_tipo_categoria, H00592_A105id_unidad_gis
               }
            }
         );
      ...
      private int wcpOAV6categoria_tareaid_tipo_categoria ;
      ...
      private int[] H00592_A104categoria_tareaid_tipo_categoria ;
      private int[] H00592_A105id_unidad_gis ;
   ...
   public class entitymanagercategoria_tarea__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00592", "SELECT TOP 1 [id_tipo_categoria], [id_unidad_gis] FROM dbo.[categoria_tarea] WHERE [id_tipo_categoria] = @AV6categoria_tareaid_tipo_categoria ORDER BY [id_tipo_categoria] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00592,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
