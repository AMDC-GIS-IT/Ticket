...
namespace GeneXus.Programs {
   public class satisfacciongeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public satisfacciongeneral( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "AV6SatisfaccionId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionId), 10, 0));
                  AV8TabCode = GetPar( "TabCode");
                  AssignAttri(sPrefix, false, "AV8TabCode", AV8TabCode);
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)Gx_mode,(long)AV6SatisfaccionId,(string)AV8TabCode});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249505869", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6SatisfaccionId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6SatisfaccionId), 10, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vSATISFACCIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6SatisfaccionId), 10, 0, ",", "")));
      ...
      protected void WB2Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "satisfacciongeneral.aspx");
            }
            /* Div Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_15_2Z2( true) ;
         }
         else
         {
            wb_table1_15_2Z2( false) ;
         }
         return  ;
      }

      protected void wb_table1_15_2Z2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void STRUP2Z0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6SatisfaccionId = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6SatisfaccionId"), ",", "."));
      ...
      protected void E122Z2( )
      {
         ...
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Satisfaccion";
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Satisfaccion";
         ...
         {
            A7SatisfaccionId = H002Z2_A7SatisfaccionId[0];
            AV16GXLvl26 = 1;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Transactioncomponent_Component), StringUtil.Lower( "Satisfaccion")) != 0 )
         {
            WebComp_Transactioncomponent = getWebComponent(GetType(), "GeneXus.Programs", "satisfaccion", new Object[] {context} );
            WebComp_Transactioncomponent.ComponentInit();
            WebComp_Transactioncomponent.Name = "Satisfaccion";
            WebComp_Transactioncomponent_Component = "Satisfaccion";
         }
         if ( StringUtil.Len( WebComp_Transactioncomponent_Component) != 0 )
         {
            WebComp_Transactioncomponent.setjustcreated();
            WebComp_Transactioncomponent.componentprepare(new Object[] {(string)sPrefix+"W0029",(string)"",(string)Gx_mode,(long)AV6SatisfaccionId});
      ...
      protected void E132Z2( )
      {
         /* 'DoUpdate' Routine */
         returnInSub = false;
         new k2bgettrncontextbyname(context ).execute(  "Satisfaccion", out  AV10TrnContext) ;
         GXt_char1 = "";
         ...
         new k2bsettrncontextbyname(context ).execute(  "Satisfaccion",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagersatisfaccion.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(AV6SatisfaccionId,10,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","SatisfaccionId","TabCode"}) );
      ...
      protected void E142Z2( )
      {
         ...
         AV10TrnContext.gxTpr_Returnmode = "Popup";
         new k2bsettrncontextbyname(context ).execute(  "Satisfaccion",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagersatisfaccion.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(AV6SatisfaccionId,10,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","SatisfaccionId","TabCode"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void wb_table1_15_2Z2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_18_2Z2( true) ;
         }
         else
         {
            wb_table2_18_2Z2( false) ;
         }
         return  ;
      }

      protected void wb_table2_18_2Z2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_15_2Z2e( true) ;
         }
         else
         {
            wb_table1_15_2Z2e( false) ;
         }
      }

      protected void wb_table2_18_2Z2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_18_2Z2e( true) ;
         }
         else
         {
            wb_table2_18_2Z2e( false) ;
         }
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6SatisfaccionId = (string)((string)getParm(obj,1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "satisfacciongeneral", GetJustCreated( ));
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "Gx_mode", Gx_mode);
            AV6SatisfaccionId = Convert.ToInt64(getParm(obj,3));
            AssignAttri(sPrefix, false, "AV6SatisfaccionId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionId), 10, 0));
         ...
         wcpOAV6SatisfaccionId = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6SatisfaccionId"), ",", "."));
         wcpOAV8TabCode = cgiGet( sPrefix+"wcpOAV8TabCode");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(Gx_mode, wcpOGx_mode) != 0 ) || ( AV6SatisfaccionId != wcpOAV6SatisfaccionId ) || ( StringUtil.StrCmp(AV8TabCode, wcpOAV8TabCode) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOGx_mode = Gx_mode;
         wcpOAV6SatisfaccionId = AV6SatisfaccionId;
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV6SatisfaccionId = cgiGet( sPrefix+"AV6SatisfaccionId_CTRL");
         if ( StringUtil.Len( sCtrlAV6SatisfaccionId) > 0 )
         {
            AV6SatisfaccionId = (long)(context.localUtil.CToN( cgiGet( sCtrlAV6SatisfaccionId), ",", "."));
            AssignAttri(sPrefix, false, "AV6SatisfaccionId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionId), 10, 0));
         }
         else
         {
            AV6SatisfaccionId = (long)(context.localUtil.CToN( cgiGet( sPrefix+"AV6SatisfaccionId_PARM"), ",", "."));
         }
      ...
      protected void WCParametersSet( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6SatisfaccionId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6SatisfaccionId), 10, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6SatisfaccionId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6SatisfaccionId_CTRL", StringUtil.RTrim( sCtrlAV6SatisfaccionId));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023124950591", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("satisfacciongeneral.js", "?2023124950592", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A7SatisfaccionId',fld:'SATISFACCIONID',pic:'ZZZZZZZZZ9'},{av:'AV6SatisfaccionId',fld:'vSATISFACCIONID',pic:'ZZZZZZZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E132Z2',iparms:[{av:'AV6SatisfaccionId',fld:'vSATISFACCIONID',pic:'ZZZZZZZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E142Z2',iparms:[{av:'AV6SatisfaccionId',fld:'vSATISFACCIONID',pic:'ZZZZZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV12ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         scmdbuf = "";
         H002Z2_A7SatisfaccionId = new long[1] ;
         ...
         sCtrlGx_mode = "";
         sCtrlAV6SatisfaccionId = "";
         sCtrlAV8TabCode = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.satisfacciongeneral__default(),
            new Object[][] {
                new Object[] {
               H002Z2_A7SatisfaccionId
               }
            }
         );
      ...
      private string sCtrlAV6SatisfaccionId ;
      ...
      private long[] H002Z2_A7SatisfaccionId ;
   ...
   public class satisfacciongeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002Z2", "SELECT [SatisfaccionId] FROM [Satisfaccion] WHERE [SatisfaccionId] = @AV6SatisfaccionId ORDER BY [SatisfaccionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002Z2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
