...
namespace GeneXus.Programs {
   public class estadosatisfaccionsatisfaccionwc2 : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public estadosatisfaccionsatisfaccionwc2( )
      {
      ...
      public estadosatisfaccionsatisfaccionwc2( IGxContext context )
      {
      ...
      {
         this.AV6SatisfaccionTecnicoCompetenteId = aP0_SatisfaccionTecnicoCompetenteId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "SatisfaccionTecnicoCompetenteId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6SatisfaccionTecnicoCompetenteId = (short)(NumberUtil.Val( GetPar( "SatisfaccionTecnicoCompetenteId"), "."));
                  AssignAttri(sPrefix, false, "AV6SatisfaccionTecnicoCompetenteId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionTecnicoCompetenteId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV6SatisfaccionTecnicoCompetenteId});
                  componentstart();
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV50K2BToolsGenericSearchField, AV36SatisfaccionFecha_From, AV39UsuarioFecha_From, AV41SatisfaccionResueltoNombre, AV42SatisfaccionTecnicoProblemaNombre, AV43SatisfaccionTecnicoProfesionalismoNombre, AV44SatisfaccionTiempoNombre, AV45SatisfaccionAtencionNombre, AV6SatisfaccionTecnicoCompetenteId, AV34ClassCollection, AV51OrderedBy, AV37SatisfaccionFecha_To, AV40UsuarioFecha_To, AV67Pgmname, AV9CurrentPage, AV11GridConfiguration, AV60AutoLinksActivityList, AV62SatisfaccionFecha_IsAuthorized, AV15Att_SatisfaccionId_Visible, AV16Att_SatisfaccionFecha_Visible, AV17Att_TicketId_Visible, AV18Att_UsuarioId_Visible, AV19Att_UsuarioNombre_Visible, AV20Att_UsuarioFecha_Visible, AV21Att_UsuarioRequerimiento_Visible, AV22Att_SatisfaccionResueltoNombre_Visible, AV23Att_SatisfaccionTecnicoProblemaNombre_Visible, AV24Att_SatisfaccionTecnicoProfesionalismoNombre_Visible, AV25Att_SatisfaccionTiempoNombre_Visible, AV26Att_SatisfaccionAtencionNombre_Visible, AV27Att_SatisfaccionSugerencia_Visible, AV12FreezeColumnTitles, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV67Pgmname = "EstadoSatisfaccionSatisfaccionWC2";
               context.Gx_err = 0;
               WS292( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249514225", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("estadosatisfaccionsatisfaccionwc2.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6SatisfaccionTecnicoCompetenteId,4,0))}, new string[] {"SatisfaccionTecnicoCompetenteId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6SatisfaccionTecnicoCompetenteId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6SatisfaccionTecnicoCompetenteId), 4, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vSATISFACCIONTECNICOCOMPETENTEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6SatisfaccionTecnicoCompetenteId), 4, 0, ",", "")));
      ...
      {
         return "EstadoSatisfaccionSatisfaccionWC2" ;
      }
      ...
      protected void WB290( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "estadosatisfaccionsatisfaccionwc2.aspx");
               context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
               context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
               context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
               context.AddJavascriptSource("K2BDateRangePicker/K2BDateRangePickerRender.js", "", false, true);
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocksatisfaccionfecha_Internalname, "Fecha Encuesta:", "", "", lblTextblocksatisfaccionfecha_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label K2BT_LabelTop", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC2.htm");
            /* User Defined Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockusuariofecha_Internalname, "Fecha", "", "", lblTextblockusuariofecha_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label K2BT_LabelTop", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC2.htm");
            /* User Defined Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;", "div");
            wb_table1_77_292( true) ;
         }
         else
         {
            wb_table1_77_292( false) ;
         }
         return  ;
      }

      protected void wb_table1_77_292e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         if ( wbEnd == 223 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_246_292( true) ;
         }
         else
         {
            wb_table2_246_292( false) ;
         }
         return  ;
      }

      protected void wb_table2_246_292e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagebuttontextblock_Internalname, "", "", "", lblPreviouspagebuttontextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOPREVIOUS\\'."+"'", "", lblPreviouspagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC2.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFirstpagetextblock_Internalname, lblFirstpagetextblock_Caption, "", "", lblFirstpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOFIRST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblFirstpagetextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC2.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacinglefttextblock_Internalname, "...", "", "", lblSpacinglefttextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacinglefttextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC2.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagetextblock_Internalname, lblPreviouspagetextblock_Caption, "", "", lblPreviouspagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOPREVIOUS\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPreviouspagetextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC2.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCurrentpagetextblock_Internalname, lblCurrentpagetextblock_Caption, "", "", lblCurrentpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC2.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagetextblock_Internalname, lblNextpagetextblock_Caption, "", "", lblNextpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DONEXT\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblNextpagetextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC2.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacingrighttextblock_Internalname, "...", "", "", lblSpacingrighttextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacingrighttextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC2.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLastpagetextblock_Internalname, lblLastpagetextblock_Caption, "", "", lblLastpagetextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOLAST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblLastpagetextblock_Visible, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC2.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagebuttontextblock_Internalname, "", "", "", lblNextpagebuttontextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DONEXT\\'."+"'", "", lblNextpagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       short AV6SatisfaccionTecnicoCompetenteId ,
      ...
      protected void RF292( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV51OrderedBy ,
                                                 AV6SatisfaccionTecnicoCompetenteId } ,
                                                 new int[]{
            ...
            lV50K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV50K2BToolsGenericSearchField), 100, "%");
            /* Using cursor H00292 */
            pr_default.execute(0, new Object[] {AV6SatisfaccionTecnicoCompetenteId, AV37SatisfaccionFecha_To, AV36SatisfaccionFecha_From, AV40UsuarioFecha_To, AV39UsuarioFecha_From, lV41SatisfaccionResueltoNombre, lV42SatisfaccionTecnicoProblemaNombre, lV43SatisfaccionTecnicoProfesionalismoNombre, lV44SatisfaccionTiempoNombre, lV45SatisfaccionAtencionNombre, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_223_idx = 1;
            sGXsfl_223_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_223_idx), 4, 0), 4, "0");
            SubsflControlProps_2232( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A10SatisfaccionTecnicoCompetenteId = H00292_A10SatisfaccionTecnicoCompetenteId[0];
               A34SatisfaccionSugerencia = H00292_A34SatisfaccionSugerencia[0];
               A31SatisfaccionAtencionNombre = H00292_A31SatisfaccionAtencionNombre[0];
               A13SatisfaccionAtencionId = H00292_A13SatisfaccionAtencionId[0];
               A38SatisfaccionTiempoNombre = H00292_A38SatisfaccionTiempoNombre[0];
               A12SatisfaccionTiempoId = H00292_A12SatisfaccionTiempoId[0];
               A37SatisfaccionTecnicoProfesionalismoNombre = H00292_A37SatisfaccionTecnicoProfesionalismoNombre[0];
               A11SatisfaccionTecnicoProfesionalismoId = H00292_A11SatisfaccionTecnicoProfesionalismoId[0];
               A36SatisfaccionTecnicoProblemaNombre = H00292_A36SatisfaccionTecnicoProblemaNombre[0];
               A9SatisfaccionTecnicoProblemaId = H00292_A9SatisfaccionTecnicoProblemaId[0];
               A33SatisfaccionResueltoNombre = H00292_A33SatisfaccionResueltoNombre[0];
               A8SatisfaccionResueltoId = H00292_A8SatisfaccionResueltoId[0];
               A94UsuarioRequerimiento = H00292_A94UsuarioRequerimiento[0];
               A90UsuarioFecha = H00292_A90UsuarioFecha[0];
               A93UsuarioNombre = H00292_A93UsuarioNombre[0];
               A15UsuarioId = H00292_A15UsuarioId[0];
               A14TicketId = H00292_A14TicketId[0];
               A32SatisfaccionFecha = H00292_A32SatisfaccionFecha[0];
               A7SatisfaccionId = H00292_A7SatisfaccionId[0];
               A31SatisfaccionAtencionNombre = H00292_A31SatisfaccionAtencionNombre[0];
               A38SatisfaccionTiempoNombre = H00292_A38SatisfaccionTiempoNombre[0];
               A37SatisfaccionTecnicoProfesionalismoNombre = H00292_A37SatisfaccionTecnicoProfesionalismoNombre[0];
               A36SatisfaccionTecnicoProblemaNombre = H00292_A36SatisfaccionTecnicoProblemaNombre[0];
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV50K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV50K2BToolsGenericSearchField), 100, "%");
         /* Using cursor H00293 */
         pr_default.execute(1, new Object[] {AV6SatisfaccionTecnicoCompetenteId, AV37SatisfaccionFecha_To, AV36SatisfaccionFecha_From, AV40UsuarioFecha_To, AV39UsuarioFecha_From, lV41SatisfaccionResueltoNombre, lV42SatisfaccionTecnicoProblemaNombre, lV43SatisfaccionTecnicoProfesionalismoNombre, lV44SatisfaccionTiempoNombre, lV45SatisfaccionAtencionNombre, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField, lV50K2BToolsGenericSearchField});
      ...
      protected void STRUP290( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6SatisfaccionTecnicoCompetenteId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6SatisfaccionTecnicoCompetenteId"), ",", "."));
            AV51OrderedBy = (short)(context.localUtil.CToN( cgiGet( sPrefix+"vORDEREDBY"), ",", "."));
            AV6SatisfaccionTecnicoCompetenteId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"vSATISFACCIONTECNICOCOMPETENTEID"), ",", "."));
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV31GridStateKey = StringUtil.Str( (decimal)(AV6SatisfaccionTecnicoCompetenteId), 4, 0);
      ...
      protected void S192( )
      {
         ...
         AV58TrnContextAtt.gxTpr_Attributename = "SatisfaccionTecnicoCompetenteId";
         AV58TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6SatisfaccionTecnicoCompetenteId), 4, 0);
      ...
      protected void E14292( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         CallWebObject(formatLink("exportestadosatisfaccionsatisfaccionwc2.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6SatisfaccionTecnicoCompetenteId,4,0)),UrlEncode(DateTimeUtil.FormatDateParm(AV36SatisfaccionFecha_From)),UrlEncode(DateTimeUtil.FormatDateParm(AV37SatisfaccionFecha_To)),UrlEncode(DateTimeUtil.FormatDateParm(AV39UsuarioFecha_From)),UrlEncode(DateTimeUtil.FormatDateParm(AV40UsuarioFecha_To)),UrlEncode(StringUtil.RTrim(AV41SatisfaccionResueltoNombre)),UrlEncode(StringUtil.RTrim(AV42SatisfaccionTecnicoProblemaNombre)),UrlEncode(StringUtil.RTrim(AV43SatisfaccionTecnicoProfesionalismoNombre)),UrlEncode(StringUtil.RTrim(AV44SatisfaccionTiempoNombre)),UrlEncode(StringUtil.RTrim(AV45SatisfaccionAtencionNombre)),UrlEncode(StringUtil.RTrim(AV50K2BToolsGenericSearchField)),UrlEncode(StringUtil.LTrimStr(AV51OrderedBy,4,0))}, new string[] {"SatisfaccionTecnicoCompetenteId","SatisfaccionFecha_From","SatisfaccionFecha_To","UsuarioFecha_From","UsuarioFecha_To","SatisfaccionResueltoNombre","SatisfaccionTecnicoProblemaNombre","SatisfaccionTecnicoProfesionalismoNombre","SatisfaccionTiempoNombre","SatisfaccionAtencionNombre","K2BToolsGenericSearchField","OrderedBy"}) );
      ...
      protected void S212( )
      {
         ...
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Satisfaccion";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Satisfaccion";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = "ReportEstadoSatisfaccionSatisfaccionWC2";
         AV59ActivityList.Add(AV61ActivityListItem, 0);
         AV61ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Standardactivitytype = "List";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Useractivitytype = "";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Satisfaccion";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Satisfaccion";
         AV61ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = "ExportEstadoSatisfaccionSatisfaccionWC2";
         AV59ActivityList.Add(AV61ActivityListItem, 0);
         AV61ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
      ...
      protected void wb_table2_246_292( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoresultsfoundtextblock_Internalname, "No hay resultados", "", "", lblNoresultsfoundtextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC2.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_246_292e( true) ;
         }
         else
         {
            wb_table2_246_292e( false) ;
         }
      }

      protected void wb_table1_77_292( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRuntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblRuntimecolumnselectiontb_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_EstadoSatisfaccionSatisfaccionWC2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_bitmap( context, imgImage1_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgImage1_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e27291_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_EstadoSatisfaccionSatisfaccionWC2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table3_204_292( true) ;
         }
         else
         {
            wb_table3_204_292( false) ;
         }
         return  ;
      }

      protected void wb_table3_204_292e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table4_211_292( true) ;
         }
         else
         {
            wb_table4_211_292( false) ;
         }
         return  ;
      }

      protected void wb_table4_211_292e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_77_292e( true) ;
         }
         else
         {
            wb_table1_77_292e( false) ;
         }
      }

      protected void wb_table4_211_292( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttInsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(223), 3, 0)+","+"null"+");", "Nuevo", bttInsert_Jsonclick, 5, bttInsert_Tooltiptext, "", StyleString, ClassString, bttInsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EstadoSatisfaccionSatisfaccionWC2.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_211_292e( true) ;
         }
         else
         {
            wb_table4_211_292e( false) ;
         }
      }

      protected void wb_table3_204_292( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttReport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(223), 3, 0)+","+"null"+");", "Reporte", bttReport_Jsonclick, 7, bttReport_Tooltiptext, "", StyleString, ClassString, bttReport_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e28291_client"+"'", TempTags, "", 2, "HLP_EstadoSatisfaccionSatisfaccionWC2.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='K2BToolsTableCell_ActionContainer'>") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 209,'" + sPrefix + "',false,'',0)\"";
            ClassString = "Button_Standard";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttExport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(223), 3, 0)+","+"null"+");", "Exportar", bttExport_Jsonclick, 5, bttExport_Tooltiptext, "", StyleString, ClassString, bttExport_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOEXPORT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EstadoSatisfaccionSatisfaccionWC2.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_204_292e( true) ;
         }
         else
         {
            wb_table3_204_292e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6SatisfaccionTecnicoCompetenteId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6SatisfaccionTecnicoCompetenteId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionTecnicoCompetenteId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6SatisfaccionTecnicoCompetenteId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "estadosatisfaccionsatisfaccionwc2", GetJustCreated( ));
         ...
         {
            AV6SatisfaccionTecnicoCompetenteId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6SatisfaccionTecnicoCompetenteId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionTecnicoCompetenteId), 4, 0));
         }
         wcpOAV6SatisfaccionTecnicoCompetenteId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6SatisfaccionTecnicoCompetenteId"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV6SatisfaccionTecnicoCompetenteId != wcpOAV6SatisfaccionTecnicoCompetenteId ) ) )
         {
            setjustcreated();
         }
         wcpOAV6SatisfaccionTecnicoCompetenteId = AV6SatisfaccionTecnicoCompetenteId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6SatisfaccionTecnicoCompetenteId = cgiGet( sPrefix+"AV6SatisfaccionTecnicoCompetenteId_CTRL");
         if ( StringUtil.Len( sCtrlAV6SatisfaccionTecnicoCompetenteId) > 0 )
         {
            AV6SatisfaccionTecnicoCompetenteId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6SatisfaccionTecnicoCompetenteId), ",", "."));
            AssignAttri(sPrefix, false, "AV6SatisfaccionTecnicoCompetenteId", StringUtil.LTrimStr( (decimal)(AV6SatisfaccionTecnicoCompetenteId), 4, 0));
         }
         else
         {
            AV6SatisfaccionTecnicoCompetenteId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6SatisfaccionTecnicoCompetenteId_PARM"), ",", "."));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6SatisfaccionTecnicoCompetenteId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6SatisfaccionTecnicoCompetenteId), 4, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6SatisfaccionTecnicoCompetenteId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6SatisfaccionTecnicoCompetenteId_CTRL", StringUtil.RTrim( sCtrlAV6SatisfaccionTecnicoCompetenteId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023124951545", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("estadosatisfaccionsatisfaccionwc2.js", "?2023124951546", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/K2BDateRangePickerRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOREPORT'","{handler:'E28291',iparms:[{av:'AV6SatisfaccionTecnicoCompetenteId',fld:'vSATISFACCIONTECNICOCOMPETENTEID',pic:'ZZZ9'},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV44SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV45SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'TOGGLEGRIDSETTINGSTABLE'","{handler:'E26291',iparms:[{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E17292',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV44SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV45SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV6SatisfaccionTecnicoCompetenteId',fld:'vSATISFACCIONTECNICOCOMPETENTEID',pic:'ZZZ9'},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV67Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV60AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E18292',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV44SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV45SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV6SatisfaccionTecnicoCompetenteId',fld:'vSATISFACCIONTECNICOCOMPETENTEID',pic:'ZZZ9'},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV67Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV60AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E19292',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV50K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV39UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV41SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV42SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV43SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV44SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV45SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV6SatisfaccionTecnicoCompetenteId',fld:'vSATISFACCIONTECNICOCOMPETENTEID',pic:'ZZZ9'},{av:'AV34ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV51OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV37SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV40UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV67Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV60AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV62SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'TOGGLEDOWNLOADACTIONS'","{handler:'E27291',iparms:[{av:'divDownloadactionstable_Visible',ctrl:'DOWNLOADACTIONSTABLE',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERTOGGLE_COMBINED.CLICK","{handler:'E20292',iparms:[{av:'divFiltercollapsiblesection_combined_Visible',ctrl:'FILTERCOLLAPSIBLESECTION_COMBINED',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERCLOSE_COMBINED.CLICK","{handler:'E21292',iparms:[{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV18Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV19Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV20Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV21Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV25Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV26Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV27Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         lV50K2BToolsGenericSearchField = "";
         H00292_A10SatisfaccionTecnicoCompetenteId = new short[1] ;
         H00292_A34SatisfaccionSugerencia = new string[] {""} ;
         H00292_A31SatisfaccionAtencionNombre = new string[] {""} ;
         H00292_A13SatisfaccionAtencionId = new short[1] ;
         H00292_A38SatisfaccionTiempoNombre = new string[] {""} ;
         H00292_A12SatisfaccionTiempoId = new short[1] ;
         H00292_A37SatisfaccionTecnicoProfesionalismoNombre = new string[] {""} ;
         H00292_A11SatisfaccionTecnicoProfesionalismoId = new short[1] ;
         H00292_A36SatisfaccionTecnicoProblemaNombre = new string[] {""} ;
         H00292_A9SatisfaccionTecnicoProblemaId = new short[1] ;
         H00292_A33SatisfaccionResueltoNombre = new string[] {""} ;
         H00292_A8SatisfaccionResueltoId = new short[1] ;
         H00292_A94UsuarioRequerimiento = new string[] {""} ;
         H00292_A90UsuarioFecha = new DateTime[] {DateTime.MinValue} ;
         H00292_A93UsuarioNombre = new string[] {""} ;
         H00292_A15UsuarioId = new short[1] ;
         H00292_A14TicketId = new long[1] ;
         H00292_A32SatisfaccionFecha = new DateTime[] {DateTime.MinValue} ;
         H00292_A7SatisfaccionId = new long[1] ;
         ...
         sCtrlAV6SatisfaccionTecnicoCompetenteId = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.estadosatisfaccionsatisfaccionwc2__default(),
            new Object[][] {
                new Object[] {
               H00292_A10SatisfaccionTecnicoCompetenteId, H00292_A34SatisfaccionSugerencia, H00292_A31SatisfaccionAtencionNombre, H00292_A13SatisfaccionAtencionId, H00292_A38SatisfaccionTiempoNombre, H00292_A12SatisfaccionTiempoId, H00292_A37SatisfaccionTecnicoProfesionalismoNombre, H00292_A11SatisfaccionTecnicoProfesionalismoId, H00292_A36SatisfaccionTecnicoProblemaNombre, H00292_A9SatisfaccionTecnicoProblemaId,
               H00292_A33SatisfaccionResueltoNombre, H00292_A8SatisfaccionResueltoId, H00292_A94UsuarioRequerimiento, H00292_A90UsuarioFecha, H00292_A93UsuarioNombre, H00292_A15UsuarioId, H00292_A14TicketId, H00292_A32SatisfaccionFecha, H00292_A7SatisfaccionId
               }
               , new Object[] {
      ...
      private short wcpOAV6SatisfaccionTecnicoCompetenteId ;
      ...
      private string sCtrlAV6SatisfaccionTecnicoCompetenteId ;
      ...
      private short[] H00292_A10SatisfaccionTecnicoCompetenteId ;
      private string[] H00292_A34SatisfaccionSugerencia ;
      private string[] H00292_A31SatisfaccionAtencionNombre ;
      private short[] H00292_A13SatisfaccionAtencionId ;
      private string[] H00292_A38SatisfaccionTiempoNombre ;
      private short[] H00292_A12SatisfaccionTiempoId ;
      private string[] H00292_A37SatisfaccionTecnicoProfesionalismoNombre ;
      private short[] H00292_A11SatisfaccionTecnicoProfesionalismoId ;
      private string[] H00292_A36SatisfaccionTecnicoProblemaNombre ;
      private short[] H00292_A9SatisfaccionTecnicoProblemaId ;
      private string[] H00292_A33SatisfaccionResueltoNombre ;
      private short[] H00292_A8SatisfaccionResueltoId ;
      private string[] H00292_A94UsuarioRequerimiento ;
      private DateTime[] H00292_A90UsuarioFecha ;
      private string[] H00292_A93UsuarioNombre ;
      private short[] H00292_A15UsuarioId ;
      private long[] H00292_A14TicketId ;
      private DateTime[] H00292_A32SatisfaccionFecha ;
      private long[] H00292_A7SatisfaccionId ;
   ...
   public class estadosatisfaccionsatisfaccionwc2__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV6SatisfaccionTecnicoCompetenteId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[SatisfaccionTecnicoCompetenteId], T1.[SatisfaccionSugerencia], T2.[EstadoSatisfaccionNombre] AS SatisfaccionAtencionNombre, T1.[SatisfaccionAtencionId] AS SatisfaccionAtencionId, T3.[EstadoSatisfaccionNombre] AS SatisfaccionTiempoNombre, T1.[SatisfaccionTiempoId] AS SatisfaccionTiempoId, T4.[EstadoSatisfaccionNombre] AS SatisfaccionTecnicoProfesionalismoNombre, T1.[SatisfaccionTecnicoProfesionalismoId] AS SatisfaccionTecnicoProfesionalismoId, T5.[EstadoSatisfaccionNombre] AS SatisfaccionTecnicoProblemaNombre, T1.[SatisfaccionTecnicoProblemaId] AS SatisfaccionTecnicoProblemaId, T6.[EstadoSatisfaccionNombre] AS SatisfaccionResueltoNombre, T1.[SatisfaccionResueltoId] AS SatisfaccionResueltoId, T8.[UsuarioRequerimiento], T8.[UsuarioFecha], T8.[UsuarioNombre], T7.[UsuarioId], T1.[TicketId], T1.[SatisfaccionFecha], T1.[SatisfaccionId]";
         sFromString = " FROM ((((((([Satisfaccion] T1 INNER JOIN [EstadoSatisfaccion] T2 ON T2.[EstadoSatisfaccionId] = T1.[SatisfaccionAtencionId]) INNER JOIN [EstadoSatisfaccion] T3 ON T3.[EstadoSatisfaccionId] = T1.[SatisfaccionTiempoId]) INNER JOIN [EstadoSatisfaccion] T4 ON T4.[EstadoSatisfaccionId] = T1.[SatisfaccionTecnicoProfesionalismoId]) INNER JOIN [EstadoSatisfaccion] T5 ON T5.[EstadoSatisfaccionId] = T1.[SatisfaccionTecnicoProblemaId]) INNER JOIN [EstadoSatisfaccion] T6 ON T6.[EstadoSatisfaccionId] = T1.[SatisfaccionResueltoId]) INNER JOIN [Ticket] T7 ON T7.[TicketId] = T1.[TicketId]) INNER JOIN [Usuario] T8 ON T8.[UsuarioId] = T7.[UsuarioId])";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.[SatisfaccionTecnicoCompetenteId] = @AV6SatisfaccionTecnicoCompetenteId)");
                                             ...
                                             short AV6SatisfaccionTecnicoCompetenteId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((((((([Satisfaccion] T1 INNER JOIN [EstadoSatisfaccion] T8 ON T8.[EstadoSatisfaccionId] = T1.[SatisfaccionAtencionId]) INNER JOIN [EstadoSatisfaccion] T7 ON T7.[EstadoSatisfaccionId] = T1.[SatisfaccionTiempoId]) INNER JOIN [EstadoSatisfaccion] T6 ON T6.[EstadoSatisfaccionId] = T1.[SatisfaccionTecnicoProfesionalismoId]) INNER JOIN [EstadoSatisfaccion] T5 ON T5.[EstadoSatisfaccionId] = T1.[SatisfaccionTecnicoProblemaId]) INNER JOIN [EstadoSatisfaccion] T4 ON T4.[EstadoSatisfaccionId] = T1.[SatisfaccionResueltoId]) INNER JOIN [Ticket] T2 ON T2.[TicketId] = T1.[TicketId]) INNER JOIN [Usuario] T3 ON T3.[UsuarioId] = T2.[UsuarioId])";
         AddWhere(sWhereString, "(T1.[SatisfaccionTecnicoCompetenteId] = @AV6SatisfaccionTecnicoCompetenteId)");
         if ( ! (DateTime.MinValue==AV37SatisfaccionFecha_To) )
         {
            AddWhere(sWhereString, "(T1.[SatisfaccionFecha] <= @AV37SatisfaccionFecha_To)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00292(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (short)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] );
               case 1 :
                     return conditional_H00293(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (short)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] );
         }
