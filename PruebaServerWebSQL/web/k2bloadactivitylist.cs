...
namespace GeneXus.Programs {
   public class k2bloadactivitylist : GXProcedure
   {
      ...
      {
         this.AV8ActivityList = new GXBaseCollection<SdtK2BActivityList_K2BActivityListItem>( context, "K2BActivityListItem", "kb_ticket") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBaseCollection<SdtK2BActivityList_K2BActivityListItem> aP0_ActivityList )
      {
         ...
         objk2bloadactivitylist.AV8ActivityList = new GXBaseCollection<SdtK2BActivityList_K2BActivityListItem>( context, "K2BActivityListItem", "kb_ticket") ;
         objk2bloadactivitylist.context.SetSubmitInitialConfig(context);
         objk2bloadactivitylist.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objk2bloadactivitylist);
         aP0_ActivityList=this.AV8ActivityList;
      }
