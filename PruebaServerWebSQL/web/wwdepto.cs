...
namespace GeneXus.Programs {
   public class wwdepto : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV24K2BToolsGenericSearchField, AV23ClassCollection, AV25OrderedBy, AV8CurrentPage, AV41Pgmname, AV10GridConfiguration, AV32DepartamentoNombre_IsAuthorized, AV14Att_CentrodecostoId_Visible, AV15Att_DepartamentoId_Visible, AV16Att_DepartamentoNombre_Visible, AV11FreezeColumnTitles) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249565948", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void E18612( )
      {
         ...
         new k2bloadrowsperpage(context ).execute(  AV41Pgmname,  "Grid", out  AV18RowsPerPageVariable, out  AV19RowsPerPageLoaded) ;
      ...
      protected void E19612( )
      {
         ...
         AV42GXV1 = 1;
         while ( AV42GXV1 <= AV30Messages.Count )
         {
            AV31Message = ((GeneXus.Utils.SdtMessages_Message)AV30Messages.Item(AV42GXV1));
         ...
         AV38ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV41Pgmname;
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV20GridStateKey = "";
         new k2bloadgridstate(context ).execute(  AV41Pgmname,  AV20GridStateKey, out  AV21GridState) ;
         ...
         AV43GXV2 = 1;
         while ( AV43GXV2 <= AV21GridState.gxTpr_Filtervalues.Count )
         {
            AV22GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV21GridState.gxTpr_Filtervalues.Item(AV43GXV2));
      ...
      protected void S122( )
      {
         ...
         new k2bsavegridstate(context ).execute(  AV41Pgmname,  AV20GridStateKey,  AV21GridState) ;
      }
      ...
      protected void E12612( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         CallWebObject(formatLink("exportwwdepto.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV24K2BToolsGenericSearchField)),UrlEncode(StringUtil.LTrimStr(AV25OrderedBy,4,0))}, new string[] {"K2BToolsGenericSearchField","OrderedBy"}) );
      ...
      protected void S192( )
      {
         ...
         AssignAttri("", false, "AV16Att_DepartamentoNombre_Visible", AV16Att_DepartamentoNombre_Visible);
         new k2bsavegridconfiguration(context ).execute(  AV41Pgmname,  "Grid",  AV10GridConfiguration,  false) ;
         AV44GXV3 = 1;
         while ( AV44GXV3 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV13GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV10GridConfiguration.gxTpr_Gridcolumns.Item(AV44GXV3));
      ...
      protected void E13612( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  AV41Pgmname,  "Grid", ref  AV10GridConfiguration) ;
         AV45GXV4 = 1;
         while ( AV45GXV4 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV13GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV10GridConfiguration.gxTpr_Gridcolumns.Item(AV45GXV4));
            if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "CentrodecostoId") == 0 )
            {
         ...
         new k2bsavegridconfiguration(context ).execute(  AV41Pgmname,  "Grid",  AV10GridConfiguration,  true) ;
         ...
         if ( AV18RowsPerPageVariable != AV17GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV18RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV41Pgmname,  "Grid",  AV18RowsPerPageVariable) ;
            AV8CurrentPage = 1;
            AssignAttri("", false, "AV8CurrentPage", StringUtil.LTrimStr( (decimal)(AV8CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023124957157", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwdepto.js", "?2023124957157", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOEXPORT'","{handler:'E12612',iparms:[{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOEXPORT'",",oparms:[{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         ...
         setEventMetadata("GRID.REFRESH","{handler:'E20612',iparms:[{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV32DepartamentoNombre_IsAuthorized',fld:'vDEPARTAMENTONOMBRE_ISAUTHORIZED',pic:''},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E11612',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV32DepartamentoNombre_IsAuthorized',fld:'vDEPARTAMENTONOMBRE_ISAUTHORIZED',pic:''},{av:'AV29UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E14612',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV32DepartamentoNombre_IsAuthorized',fld:'vDEPARTAMENTONOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E15612',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV32DepartamentoNombre_IsAuthorized',fld:'vDEPARTAMENTONOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E16612',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV32DepartamentoNombre_IsAuthorized',fld:'vDEPARTAMENTONOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E17612',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV41Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV32DepartamentoNombre_IsAuthorized',fld:'vDEPARTAMENTONOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_CentrodecostoId_Visible',fld:'vATT_CENTRODECOSTOID_VISIBLE',pic:''},{av:'AV15Att_DepartamentoId_Visible',fld:'vATT_DEPARTAMENTOID_VISIBLE',pic:''},{av:'AV16Att_DepartamentoNombre_Visible',fld:'vATT_DEPARTAMENTONOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV28GridOrder = new SdtK2BGridOrders_K2BGridOrdersItem(context);
         AV30Messages = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
