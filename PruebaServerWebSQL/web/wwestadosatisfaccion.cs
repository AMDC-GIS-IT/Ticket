...
namespace GeneXus.Programs {
   public class wwestadosatisfaccion : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV24K2BToolsGenericSearchField, AV23ClassCollection, AV25OrderedBy, AV8CurrentPage, AV40Pgmname, AV10GridConfiguration, AV31EstadoSatisfaccionNombre_IsAuthorized, AV14Att_EstadoSatisfaccionId_Visible, AV15Att_EstadoSatisfaccionNombre_Visible, AV16Att_EstadoSatisfaccionEstado_Visible, AV11FreezeColumnTitles) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249524915", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      {
         /* GeneXus formulas. */
         AV40Pgmname = "WWEstadoSatisfaccion";
         context.Gx_err = 0;
      }
      ...
      protected void E13252( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         CallWebObject(formatLink("exportwwestadosatisfaccion.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV24K2BToolsGenericSearchField)),UrlEncode(StringUtil.LTrimStr(AV25OrderedBy,4,0))}, new string[] {"K2BToolsGenericSearchField","OrderedBy"}) );
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249525145", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwestadosatisfaccion.js", "?20231249525147", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOEXPORT'","{handler:'E13252',iparms:[{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_EstadoSatisfaccionId_Visible',fld:'vATT_ESTADOSATISFACCIONID_VISIBLE',pic:''},{av:'AV15Att_EstadoSatisfaccionNombre_Visible',fld:'vATT_ESTADOSATISFACCIONNOMBRE_VISIBLE',pic:''},{av:'AV16Att_EstadoSatisfaccionEstado_Visible',fld:'vATT_ESTADOSATISFACCIONESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOEXPORT'",",oparms:[{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_EstadoSatisfaccionId_Visible',fld:'vATT_ESTADOSATISFACCIONID_VISIBLE',pic:''},{av:'AV15Att_EstadoSatisfaccionNombre_Visible',fld:'vATT_ESTADOSATISFACCIONNOMBRE_VISIBLE',pic:''},{av:'AV16Att_EstadoSatisfaccionEstado_Visible',fld:'vATT_ESTADOSATISFACCIONESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E15252',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV31EstadoSatisfaccionNombre_IsAuthorized',fld:'vESTADOSATISFACCIONNOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EstadoSatisfaccionId_Visible',fld:'vATT_ESTADOSATISFACCIONID_VISIBLE',pic:''},{av:'AV15Att_EstadoSatisfaccionNombre_Visible',fld:'vATT_ESTADOSATISFACCIONNOMBRE_VISIBLE',pic:''},{av:'AV16Att_EstadoSatisfaccionEstado_Visible',fld:'vATT_ESTADOSATISFACCIONESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E17252',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV31EstadoSatisfaccionNombre_IsAuthorized',fld:'vESTADOSATISFACCIONNOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EstadoSatisfaccionId_Visible',fld:'vATT_ESTADOSATISFACCIONID_VISIBLE',pic:''},{av:'AV15Att_EstadoSatisfaccionNombre_Visible',fld:'vATT_ESTADOSATISFACCIONNOMBRE_VISIBLE',pic:''},{av:'AV16Att_EstadoSatisfaccionEstado_Visible',fld:'vATT_ESTADOSATISFACCIONESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E18252',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV31EstadoSatisfaccionNombre_IsAuthorized',fld:'vESTADOSATISFACCIONNOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EstadoSatisfaccionId_Visible',fld:'vATT_ESTADOSATISFACCIONID_VISIBLE',pic:''},{av:'AV15Att_EstadoSatisfaccionNombre_Visible',fld:'vATT_ESTADOSATISFACCIONNOMBRE_VISIBLE',pic:''},{av:'AV16Att_EstadoSatisfaccionEstado_Visible',fld:'vATT_ESTADOSATISFACCIONESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
