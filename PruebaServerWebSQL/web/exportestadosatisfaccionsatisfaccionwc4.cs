...
namespace GeneXus.Programs {
   public class exportestadosatisfaccionsatisfaccionwc4 : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV8SatisfaccionTiempoId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      public exportestadosatisfaccionsatisfaccionwc4( )
      {
      ...
      public exportestadosatisfaccionsatisfaccionwc4( IGxContext context )
      {
      ...
      {
         this.AV8SatisfaccionTiempoId = aP0_SatisfaccionTiempoId;
      ...
      public short executeUdp( short aP0_SatisfaccionTiempoId ,
                               DateTime aP1_SatisfaccionFecha_From ,
                               DateTime aP2_SatisfaccionFecha_To ,
                               DateTime aP3_UsuarioFecha_From ,
                               DateTime aP4_UsuarioFecha_To ,
                               ...
                               string aP10_K2BToolsGenericSearchField )
      {
         execute(aP0_SatisfaccionTiempoId, aP1_SatisfaccionFecha_From, aP2_SatisfaccionFecha_To, aP3_UsuarioFecha_From, aP4_UsuarioFecha_To, aP5_SatisfaccionResueltoNombre, aP6_SatisfaccionTecnicoProblemaNombre, aP7_SatisfaccionTecnicoCompetenteNombre, aP8_SatisfaccionTecnicoProfesionalismoNombre, aP9_SatisfaccionAtencionNombre, aP10_K2BToolsGenericSearchField, ref aP11_OrderedBy);
         return AV21OrderedBy ;
      }

      public void executeSubmit( short aP0_SatisfaccionTiempoId ,
                                 DateTime aP1_SatisfaccionFecha_From ,
                                 DateTime aP2_SatisfaccionFecha_To ,
                                 DateTime aP3_UsuarioFecha_From ,
                                 DateTime aP4_UsuarioFecha_To ,
                                 ...
                                 ref short aP11_OrderedBy )
      {
         exportestadosatisfaccionsatisfaccionwc4 objexportestadosatisfaccionsatisfaccionwc4;
         objexportestadosatisfaccionsatisfaccionwc4 = new exportestadosatisfaccionsatisfaccionwc4();
         objexportestadosatisfaccionsatisfaccionwc4.AV8SatisfaccionTiempoId = aP0_SatisfaccionTiempoId;
         objexportestadosatisfaccionsatisfaccionwc4.AV11SatisfaccionFecha_From = aP1_SatisfaccionFecha_From;
         objexportestadosatisfaccionsatisfaccionwc4.AV12SatisfaccionFecha_To = aP2_SatisfaccionFecha_To;
         objexportestadosatisfaccionsatisfaccionwc4.AV14UsuarioFecha_From = aP3_UsuarioFecha_From;
         objexportestadosatisfaccionsatisfaccionwc4.AV15UsuarioFecha_To = aP4_UsuarioFecha_To;
         objexportestadosatisfaccionsatisfaccionwc4.AV16SatisfaccionResueltoNombre = aP5_SatisfaccionResueltoNombre;
         objexportestadosatisfaccionsatisfaccionwc4.AV17SatisfaccionTecnicoProblemaNombre = aP6_SatisfaccionTecnicoProblemaNombre;
         objexportestadosatisfaccionsatisfaccionwc4.AV18SatisfaccionTecnicoCompetenteNombre = aP7_SatisfaccionTecnicoCompetenteNombre;
         objexportestadosatisfaccionsatisfaccionwc4.AV19SatisfaccionTecnicoProfesionalismoNombre = aP8_SatisfaccionTecnicoProfesionalismoNombre;
         objexportestadosatisfaccionsatisfaccionwc4.AV20SatisfaccionAtencionNombre = aP9_SatisfaccionAtencionNombre;
         objexportestadosatisfaccionsatisfaccionwc4.AV9K2BToolsGenericSearchField = aP10_K2BToolsGenericSearchField;
         objexportestadosatisfaccionsatisfaccionwc4.AV21OrderedBy = aP11_OrderedBy;
         objexportestadosatisfaccionsatisfaccionwc4.context.SetSubmitInitialConfig(context);
         objexportestadosatisfaccionsatisfaccionwc4.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objexportestadosatisfaccionsatisfaccionwc4);
         aP11_OrderedBy=this.AV21OrderedBy;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((exportestadosatisfaccionsatisfaccionwc4)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         AV27Filename = GxDirectory.TemporaryFilesPath + AV30File.Separator + "ExportEstadoSatisfaccionSatisfaccionWC4-" + StringUtil.Trim( StringUtil.Str( (decimal)(AV25Random), 8, 0)) + ".xlsx";
         ...
         /* Using cursor P00332 */
         pr_default.execute(0, new Object[] {AV8SatisfaccionTiempoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A4EstadoSatisfaccionId = P00332_A4EstadoSatisfaccionId[0];
            A22EstadoSatisfaccionNombre = P00332_A22EstadoSatisfaccionNombre[0];
         ...
         lV9K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV9K2BToolsGenericSearchField), 200, "%");
         /* Using cursor P00333 */
         pr_default.execute(1, new Object[] {AV8SatisfaccionTiempoId, AV12SatisfaccionFecha_To, AV11SatisfaccionFecha_From, AV15UsuarioFecha_To, AV14UsuarioFecha_From, lV16SatisfaccionResueltoNombre, lV17SatisfaccionTecnicoProblemaNombre, lV18SatisfaccionTecnicoCompetenteNombre, lV19SatisfaccionTecnicoProfesionalismoNombre, lV20SatisfaccionAtencionNombre, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A8SatisfaccionResueltoId = P00333_A8SatisfaccionResueltoId[0];
            A9SatisfaccionTecnicoProblemaId = P00333_A9SatisfaccionTecnicoProblemaId[0];
            A10SatisfaccionTecnicoCompetenteId = P00333_A10SatisfaccionTecnicoCompetenteId[0];
            A11SatisfaccionTecnicoProfesionalismoId = P00333_A11SatisfaccionTecnicoProfesionalismoId[0];
            A13SatisfaccionAtencionId = P00333_A13SatisfaccionAtencionId[0];
            A34SatisfaccionSugerencia = P00333_A34SatisfaccionSugerencia[0];
            A94UsuarioRequerimiento = P00333_A94UsuarioRequerimiento[0];
            A93UsuarioNombre = P00333_A93UsuarioNombre[0];
            A15UsuarioId = P00333_A15UsuarioId[0];
            A14TicketId = P00333_A14TicketId[0];
            A7SatisfaccionId = P00333_A7SatisfaccionId[0];
            A31SatisfaccionAtencionNombre = P00333_A31SatisfaccionAtencionNombre[0];
            A37SatisfaccionTecnicoProfesionalismoNombre = P00333_A37SatisfaccionTecnicoProfesionalismoNombre[0];
            A35SatisfaccionTecnicoCompetenteNombre = P00333_A35SatisfaccionTecnicoCompetenteNombre[0];
            A36SatisfaccionTecnicoProblemaNombre = P00333_A36SatisfaccionTecnicoProblemaNombre[0];
            A33SatisfaccionResueltoNombre = P00333_A33SatisfaccionResueltoNombre[0];
            A90UsuarioFecha = P00333_A90UsuarioFecha[0];
            A32SatisfaccionFecha = P00333_A32SatisfaccionFecha[0];
            A12SatisfaccionTiempoId = P00333_A12SatisfaccionTiempoId[0];
            A33SatisfaccionResueltoNombre = P00333_A33SatisfaccionResueltoNombre[0];
            A36SatisfaccionTecnicoProblemaNombre = P00333_A36SatisfaccionTecnicoProblemaNombre[0];
            A35SatisfaccionTecnicoCompetenteNombre = P00333_A35SatisfaccionTecnicoCompetenteNombre[0];
            A37SatisfaccionTecnicoProfesionalismoNombre = P00333_A37SatisfaccionTecnicoProfesionalismoNombre[0];
         ...
         if ( ! context.isAjaxRequest( ) )
         {
            AV29HttpResponse.AppendHeader("Content-Disposition", "attachment;filename=ExportEstadoSatisfaccionSatisfaccionWC4.xlsx");
         }
         if ( ! context.isAjaxRequest( ) )
         {
      ...
      protected void S121( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  "EstadoSatisfaccionSatisfaccionWC4",  "Grid", ref  AV31GridConfiguration) ;
         ...
         new k2bsavegridconfiguration(context ).execute(  "EstadoSatisfaccionSatisfaccionWC4",  "Grid",  AV31GridConfiguration,  false) ;
         AV33GridColumns = AV31GridConfiguration.gxTpr_Gridcolumns;
         AV55GXV1 = 1;
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         P00332_A4EstadoSatisfaccionId = new short[1] ;
         P00332_A22EstadoSatisfaccionNombre = new string[] {""} ;
         ...
         A94UsuarioRequerimiento = "";
         A34SatisfaccionSugerencia = "";
         P00333_A8SatisfaccionResueltoId = new short[1] ;
         P00333_A9SatisfaccionTecnicoProblemaId = new short[1] ;
         P00333_A10SatisfaccionTecnicoCompetenteId = new short[1] ;
         P00333_A11SatisfaccionTecnicoProfesionalismoId = new short[1] ;
         P00333_A13SatisfaccionAtencionId = new short[1] ;
         P00333_A34SatisfaccionSugerencia = new string[] {""} ;
         P00333_A94UsuarioRequerimiento = new string[] {""} ;
         P00333_A93UsuarioNombre = new string[] {""} ;
         P00333_A15UsuarioId = new short[1] ;
         P00333_A14TicketId = new long[1] ;
         P00333_A7SatisfaccionId = new long[1] ;
         P00333_A31SatisfaccionAtencionNombre = new string[] {""} ;
         P00333_A37SatisfaccionTecnicoProfesionalismoNombre = new string[] {""} ;
         P00333_A35SatisfaccionTecnicoCompetenteNombre = new string[] {""} ;
         P00333_A36SatisfaccionTecnicoProblemaNombre = new string[] {""} ;
         P00333_A33SatisfaccionResueltoNombre = new string[] {""} ;
         P00333_A90UsuarioFecha = new DateTime[] {DateTime.MinValue} ;
         P00333_A32SatisfaccionFecha = new DateTime[] {DateTime.MinValue} ;
         P00333_A12SatisfaccionTiempoId = new short[1] ;
         GXt_dtime1 = (DateTime)(DateTime.MinValue);
         AV31GridConfiguration = new SdtK2BGridConfiguration(context);
         AV33GridColumns = new GXBaseCollection<SdtK2BGridColumns_K2BGridColumnsItem>( context, "K2BGridColumnsItem", "kb_ticket");
         AV34GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.exportestadosatisfaccionsatisfaccionwc4__default(),
            new Object[][] {
                new Object[] {
               P00332_A4EstadoSatisfaccionId, P00332_A22EstadoSatisfaccionNombre
               }
               , new Object[] {
               P00333_A8SatisfaccionResueltoId, P00333_A9SatisfaccionTecnicoProblemaId, P00333_A10SatisfaccionTecnicoCompetenteId, P00333_A11SatisfaccionTecnicoProfesionalismoId, P00333_A13SatisfaccionAtencionId, P00333_A34SatisfaccionSugerencia, P00333_A94UsuarioRequerimiento, P00333_A93UsuarioNombre, P00333_A15UsuarioId, P00333_A14TicketId,
               P00333_A7SatisfaccionId, P00333_A31SatisfaccionAtencionNombre, P00333_A37SatisfaccionTecnicoProfesionalismoNombre, P00333_A35SatisfaccionTecnicoCompetenteNombre, P00333_A36SatisfaccionTecnicoProblemaNombre, P00333_A33SatisfaccionResueltoNombre, P00333_A90UsuarioFecha, P00333_A32SatisfaccionFecha, P00333_A12SatisfaccionTiempoId
               }
            }
         );
         AV52Pgmname = "ExportEstadoSatisfaccionSatisfaccionWC4";
         /* GeneXus formulas. */
         AV52Pgmname = "ExportEstadoSatisfaccionSatisfaccionWC4";
         context.Gx_err = 0;
      }
      ...
      private short[] P00332_A4EstadoSatisfaccionId ;
      private string[] P00332_A22EstadoSatisfaccionNombre ;
      private short[] P00333_A8SatisfaccionResueltoId ;
      private short[] P00333_A9SatisfaccionTecnicoProblemaId ;
      private short[] P00333_A10SatisfaccionTecnicoCompetenteId ;
      private short[] P00333_A11SatisfaccionTecnicoProfesionalismoId ;
      private short[] P00333_A13SatisfaccionAtencionId ;
      private string[] P00333_A34SatisfaccionSugerencia ;
      private string[] P00333_A94UsuarioRequerimiento ;
      private string[] P00333_A93UsuarioNombre ;
      private short[] P00333_A15UsuarioId ;
      private long[] P00333_A14TicketId ;
      private long[] P00333_A7SatisfaccionId ;
      private string[] P00333_A31SatisfaccionAtencionNombre ;
      private string[] P00333_A37SatisfaccionTecnicoProfesionalismoNombre ;
      private string[] P00333_A35SatisfaccionTecnicoCompetenteNombre ;
      private string[] P00333_A36SatisfaccionTecnicoProblemaNombre ;
      private string[] P00333_A33SatisfaccionResueltoNombre ;
      private DateTime[] P00333_A90UsuarioFecha ;
      private DateTime[] P00333_A32SatisfaccionFecha ;
      private short[] P00333_A12SatisfaccionTiempoId ;
   ...
   public class exportestadosatisfaccionsatisfaccionwc4__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A12SatisfaccionTiempoId )
      {
         ...
         scmdbuf = "SELECT T1.[SatisfaccionResueltoId] AS SatisfaccionResueltoId, T1.[SatisfaccionTecnicoProblemaId] AS SatisfaccionTecnicoProblemaId, T1.[SatisfaccionTecnicoCompetenteId] AS SatisfaccionTecnicoCompetenteId, T1.[SatisfaccionTecnicoProfesionalismoId] AS SatisfaccionTecnicoProfesionalismoId, T1.[SatisfaccionAtencionId] AS SatisfaccionAtencionId, T1.[SatisfaccionSugerencia], T8.[UsuarioRequerimiento], T8.[UsuarioNombre], T7.[UsuarioId], T1.[TicketId], T1.[SatisfaccionId], T6.[EstadoSatisfaccionNombre] AS SatisfaccionAtencionNombre, T5.[EstadoSatisfaccionNombre] AS SatisfaccionTecnicoProfesionalismoNombre, T4.[EstadoSatisfaccionNombre] AS SatisfaccionTecnicoCompetenteNombre, T3.[EstadoSatisfaccionNombre] AS SatisfaccionTecnicoProblemaNombre, T2.[EstadoSatisfaccionNombre] AS SatisfaccionResueltoNombre, T8.[UsuarioFecha], T1.[SatisfaccionFecha], T1.[SatisfaccionTiempoId] FROM ((((((([Satisfaccion] T1 INNER JOIN [EstadoSatisfaccion] T2 ON T2.[EstadoSatisfaccionId] = T1.[SatisfaccionResueltoId]) INNER JOIN [EstadoSatisfaccion] T3 ON T3.[EstadoSatisfaccionId] = T1.[SatisfaccionTecnicoProblemaId]) INNER JOIN [EstadoSatisfaccion] T4 ON T4.[EstadoSatisfaccionId] = T1.[SatisfaccionTecnicoCompetenteId]) INNER JOIN [EstadoSatisfaccion] T5 ON T5.[EstadoSatisfaccionId] = T1.[SatisfaccionTecnicoProfesionalismoId]) INNER JOIN [EstadoSatisfaccion] T6 ON T6.[EstadoSatisfaccionId] = T1.[SatisfaccionAtencionId]) INNER JOIN [Ticket] T7 ON T7.[TicketId] = T1.[TicketId]) INNER JOIN [Usuario] T8 ON T8.[UsuarioId] = T7.[UsuarioId])";
         AddWhere(sWhereString, "(T1.[SatisfaccionTiempoId] = @AV8SatisfaccionTiempoId)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_P00333(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (short)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] , (short)dynConstraints[25] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00332", "SELECT TOP 1 [EstadoSatisfaccionId], [EstadoSatisfaccionNombre] FROM [EstadoSatisfaccion] WHERE [EstadoSatisfaccionId] = @AV8SatisfaccionTiempoId ORDER BY [EstadoSatisfaccionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00332,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00333", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00333,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
