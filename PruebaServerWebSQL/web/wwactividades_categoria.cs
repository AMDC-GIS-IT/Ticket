...
namespace GeneXus.Programs {
   public class wwactividades_categoria : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV55K2BToolsGenericSearchField, AV44actividades_categoriaid_tipo_categoria, AV69fltnombre, AV43ClassCollection, AV56OrderedBy, AV72Pgmname, AV8CurrentPage, AV10GridConfiguration, AV62actividades_categoriaid_tipo_categoria_IsAuthorized, AV14Att_id_actividad_categoria_Visible, AV15Att_actividades_categoriaid_tipo_categoria_Visible, AV16Att_nombre_actividad_Visible, AV17Att_unidad_medida_Visible, AV18Att_actividades_categoriaestado_Visible, AV11FreezeColumnTitles) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249564511", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB560( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavActividades_categoriaid_tipo_categoria_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV44actividades_categoriaid_tipo_categoria), 9, 0, ",", "")), ((edtavActividades_categoriaid_tipo_categoria_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV44actividades_categoriaid_tipo_categoria), "ZZZZZZZZ9")) : context.localUtil.Format( (decimal)(AV44actividades_categoriaid_tipo_categoria), "ZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,45);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavActividades_categoriaid_tipo_categoria_Jsonclick, 0, "Attribute_Filter", "", "", "", "", 1, edtavActividades_categoriaid_tipo_categoria_Enabled, 0, "number", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_WWactividades_categoria.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavFltnombre_Internalname, "nombre_actividad", "gx-form-item Attribute_FilterLabel", 1, true, "width: 100%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Multiple line edit */
      ...
      protected void wb_table1_53_562e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" width="+StringUtil.LTrimStr( (decimal)(129), 4, 0)+"px"+" class=\""+"Attribute_Grid"+"\" "+" style=\""+((edtid_actividad_categoria_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
      ...
      {
         /* GeneXus formulas. */
         AV72Pgmname = "WWactividades_categoria";
         context.Gx_err = 0;
      }
      ...
      protected void RF562( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV55K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV55K2BToolsGenericSearchField), 100, "%");
            /* Using cursor H00562 */
            pr_datastore1.execute(0, new Object[] {AV44actividades_categoriaid_tipo_categoria, lV69fltnombre, lV55K2BToolsGenericSearchField, lV55K2BToolsGenericSearchField, lV55K2BToolsGenericSearchField, lV55K2BToolsGenericSearchField, lV55K2BToolsGenericSearchField, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_146_idx = 1;
            sGXsfl_146_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_146_idx), 4, 0), 4, "0");
            SubsflControlProps_1462( ) ;
      ...
      protected void E21562( )
      {
         ...
         new k2bloadrowsperpage(context ).execute(  AV72Pgmname,  "Grid", out  AV38RowsPerPageVariable, out  AV39RowsPerPageLoaded) ;
      ...
      protected void E22562( )
      {
         ...
         AV68ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV72Pgmname;
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV40GridStateKey = "";
         new k2bloadgridstate(context ).execute(  AV72Pgmname,  AV40GridStateKey, out  AV41GridState) ;
         ...
         AV74GXV2 = 1;
         while ( AV74GXV2 <= AV41GridState.gxTpr_Filtervalues.Count )
         {
            AV42GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV41GridState.gxTpr_Filtervalues.Item(AV74GXV2));
      ...
      protected void S132( )
      {
         ...
         AV41GridState.gxTpr_Filtervalues.Add(AV42GridStateFilterValue, 0);
         new k2bsavegridstate(context ).execute(  AV72Pgmname,  AV40GridStateKey,  AV41GridState) ;
      }
      ...
      protected void E13562( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         CallWebObject(formatLink("exportwwactividades_categoria.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV44actividades_categoriaid_tipo_categoria,9,0)),UrlEncode(StringUtil.RTrim(AV69fltnombre)),UrlEncode(StringUtil.RTrim(AV55K2BToolsGenericSearchField)),UrlEncode(StringUtil.LTrimStr(AV56OrderedBy,4,0))}, new string[] {"actividades_categoriaid_tipo_categoria","fltnombre","K2BToolsGenericSearchField","OrderedBy"}) );
      ...
      protected void S202( )
      {
         ...
         AssignAttri("", false, "AV18Att_actividades_categoriaestado_Visible", AV18Att_actividades_categoriaestado_Visible);
         new k2bsavegridconfiguration(context ).execute(  AV72Pgmname,  "Grid",  AV10GridConfiguration,  false) ;
         AV75GXV3 = 1;
         while ( AV75GXV3 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV13GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV10GridConfiguration.gxTpr_Gridcolumns.Item(AV75GXV3));
      ...
      protected void S182( )
      {
         ...
         AV13GridColumn.gxTpr_Columntitle = "id_actividad_categoria";
         ...
         AV13GridColumn.gxTpr_Columntitle = "nombre_actividad";
         AV13GridColumn.gxTpr_Showattribute = true;
         AV12GridColumns.Add(AV13GridColumn, 0);
         AV13GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
      ...
      protected void S122( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV69fltnombre)) )
         {
            ...
            AV52K2BFilterValuesSDTItem.gxTpr_Description = "nombre_actividad";
            AV52K2BFilterValuesSDTItem.gxTpr_Type = "Standard";
         ...
         if ( AV51K2BFilterValuesSDT.Count > 0 )
         {
            ...
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV72Pgmname,  "Grid",  AV51K2BFilterValuesSDT, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item3) ;
      ...
      protected void E14562( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  AV72Pgmname,  "Grid", ref  AV10GridConfiguration) ;
         AV76GXV4 = 1;
         while ( AV76GXV4 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV13GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV10GridConfiguration.gxTpr_Gridcolumns.Item(AV76GXV4));
            if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "id_actividad_categoria") == 0 )
            {
         ...
         new k2bsavegridconfiguration(context ).execute(  AV72Pgmname,  "Grid",  AV10GridConfiguration,  true) ;
         AV59UC_OrderedBy = AV56OrderedBy;
         AssignAttri("", false, "AV59UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV59UC_OrderedBy), 4, 0));
         if ( AV38RowsPerPageVariable != AV37GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV38RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV72Pgmname,  "Grid",  AV38RowsPerPageVariable) ;
            AV8CurrentPage = 1;
            AssignAttri("", false, "AV8CurrentPage", StringUtil.LTrimStr( (decimal)(AV8CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void wb_table1_53_562( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavAtt_id_actividad_categoria_visible_Internalname, "id_actividad_categoria", "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavAtt_nombre_actividad_visible_Internalname, "nombre_actividad", "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249564853", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwactividades_categoria.js", "?20231249564853", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         chkavAtt_nombre_actividad_visible.Caption = "nombre_actividad";
         chkavAtt_actividades_categoriaid_tipo_categoria_visible.Caption = "id_tipo_categoria";
         chkavAtt_id_actividad_categoria_visible.Caption = "id_actividad_categoria";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOEXPORT'","{handler:'E13562',iparms:[{av:'AV44actividades_categoriaid_tipo_categoria',fld:'vACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV69fltnombre',fld:'vFLTNOMBRE',pic:''},{av:'AV55K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV56OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_id_actividad_categoria_Visible',fld:'vATT_ID_ACTIVIDAD_CATEGORIA_VISIBLE',pic:''},{av:'AV15Att_actividades_categoriaid_tipo_categoria_Visible',fld:'vATT_ACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA_VISIBLE',pic:''},{av:'AV16Att_nombre_actividad_Visible',fld:'vATT_NOMBRE_ACTIVIDAD_VISIBLE',pic:''},{av:'AV17Att_unidad_medida_Visible',fld:'vATT_UNIDAD_MEDIDA_VISIBLE',pic:''},{av:'AV18Att_actividades_categoriaestado_Visible',fld:'vATT_ACTIVIDADES_CATEGORIAESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOEXPORT'",",oparms:[{av:'AV56OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_id_actividad_categoria_Visible',fld:'vATT_ID_ACTIVIDAD_CATEGORIA_VISIBLE',pic:''},{av:'AV15Att_actividades_categoriaid_tipo_categoria_Visible',fld:'vATT_ACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA_VISIBLE',pic:''},{av:'AV16Att_nombre_actividad_Visible',fld:'vATT_NOMBRE_ACTIVIDAD_VISIBLE',pic:''},{av:'AV17Att_unidad_medida_Visible',fld:'vATT_UNIDAD_MEDIDA_VISIBLE',pic:''},{av:'AV18Att_actividades_categoriaestado_Visible',fld:'vATT_ACTIVIDADES_CATEGORIAESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E14562',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV55K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV44actividades_categoriaid_tipo_categoria',fld:'vACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV69fltnombre',fld:'vFLTNOMBRE',pic:''},{av:'AV43ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV56OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV72Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV62actividades_categoriaid_tipo_categoria_IsAuthorized',fld:'vACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA_ISAUTHORIZED',pic:''},{av:'AV38RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV37GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_id_actividad_categoria_Visible',fld:'vATT_ID_ACTIVIDAD_CATEGORIA_VISIBLE',pic:''},{av:'AV15Att_actividades_categoriaid_tipo_categoria_Visible',fld:'vATT_ACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA_VISIBLE',pic:''},{av:'AV16Att_nombre_actividad_Visible',fld:'vATT_NOMBRE_ACTIVIDAD_VISIBLE',pic:''},{av:'AV17Att_unidad_medida_Visible',fld:'vATT_UNIDAD_MEDIDA_VISIBLE',pic:''},{av:'AV18Att_actividades_categoriaestado_Visible',fld:'vATT_ACTIVIDADES_CATEGORIAESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E15562',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV55K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV44actividades_categoriaid_tipo_categoria',fld:'vACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV69fltnombre',fld:'vFLTNOMBRE',pic:''},{av:'AV43ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV56OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV72Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV62actividades_categoriaid_tipo_categoria_IsAuthorized',fld:'vACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_id_actividad_categoria_Visible',fld:'vATT_ID_ACTIVIDAD_CATEGORIA_VISIBLE',pic:''},{av:'AV15Att_actividades_categoriaid_tipo_categoria_Visible',fld:'vATT_ACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA_VISIBLE',pic:''},{av:'AV16Att_nombre_actividad_Visible',fld:'vATT_NOMBRE_ACTIVIDAD_VISIBLE',pic:''},{av:'AV17Att_unidad_medida_Visible',fld:'vATT_UNIDAD_MEDIDA_VISIBLE',pic:''},{av:'AV18Att_actividades_categoriaestado_Visible',fld:'vATT_ACTIVIDADES_CATEGORIAESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E16562',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV55K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV44actividades_categoriaid_tipo_categoria',fld:'vACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV69fltnombre',fld:'vFLTNOMBRE',pic:''},{av:'AV43ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV56OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV72Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV62actividades_categoriaid_tipo_categoria_IsAuthorized',fld:'vACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_id_actividad_categoria_Visible',fld:'vATT_ID_ACTIVIDAD_CATEGORIA_VISIBLE',pic:''},{av:'AV15Att_actividades_categoriaid_tipo_categoria_Visible',fld:'vATT_ACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA_VISIBLE',pic:''},{av:'AV16Att_nombre_actividad_Visible',fld:'vATT_NOMBRE_ACTIVIDAD_VISIBLE',pic:''},{av:'AV17Att_unidad_medida_Visible',fld:'vATT_UNIDAD_MEDIDA_VISIBLE',pic:''},{av:'AV18Att_actividades_categoriaestado_Visible',fld:'vATT_ACTIVIDADES_CATEGORIAESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E17562',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV55K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV44actividades_categoriaid_tipo_categoria',fld:'vACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV69fltnombre',fld:'vFLTNOMBRE',pic:''},{av:'AV43ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV56OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV72Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV62actividades_categoriaid_tipo_categoria_IsAuthorized',fld:'vACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_id_actividad_categoria_Visible',fld:'vATT_ID_ACTIVIDAD_CATEGORIA_VISIBLE',pic:''},{av:'AV15Att_actividades_categoriaid_tipo_categoria_Visible',fld:'vATT_ACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA_VISIBLE',pic:''},{av:'AV16Att_nombre_actividad_Visible',fld:'vATT_NOMBRE_ACTIVIDAD_VISIBLE',pic:''},{av:'AV17Att_unidad_medida_Visible',fld:'vATT_UNIDAD_MEDIDA_VISIBLE',pic:''},{av:'AV18Att_actividades_categoriaestado_Visible',fld:'vATT_ACTIVIDADES_CATEGORIAESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E18562',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV55K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV44actividades_categoriaid_tipo_categoria',fld:'vACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV69fltnombre',fld:'vFLTNOMBRE',pic:''},{av:'AV43ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV56OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV72Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV62actividades_categoriaid_tipo_categoria_IsAuthorized',fld:'vACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_id_actividad_categoria_Visible',fld:'vATT_ID_ACTIVIDAD_CATEGORIA_VISIBLE',pic:''},{av:'AV15Att_actividades_categoriaid_tipo_categoria_Visible',fld:'vATT_ACTIVIDADES_CATEGORIAID_TIPO_CATEGORIA_VISIBLE',pic:''},{av:'AV16Att_nombre_actividad_Visible',fld:'vATT_NOMBRE_ACTIVIDAD_VISIBLE',pic:''},{av:'AV17Att_unidad_medida_Visible',fld:'vATT_UNIDAD_MEDIDA_VISIBLE',pic:''},{av:'AV18Att_actividades_categoriaestado_Visible',fld:'vATT_ACTIVIDADES_CATEGORIAESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
