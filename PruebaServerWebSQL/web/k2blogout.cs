...
namespace GeneXus.Programs {
   public class k2blogout : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249524756", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB1Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_6_1Z2( true) ;
         }
         else
         {
            wb_table1_6_1Z2( false) ;
         }
         return  ;
      }

      protected void wb_table1_6_1Z2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void wb_table1_6_1Z2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void wb_table2_9_1Z2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_6_1Z2e( true) ;
         }
         else
         {
            wb_table1_6_1Z2e( false) ;
         }
      }
      ...
      protected void wb_table2_9_1Z2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table3_12_1Z2( true) ;
         }
         else
         {
            wb_table3_12_1Z2( false) ;
         }
         return  ;
      }

      protected void wb_table3_12_1Z2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table3_12_1Z2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table4_19_1Z2( true) ;
         }
         else
         {
            wb_table4_19_1Z2( false) ;
         }
         return  ;
      }

      protected void wb_table4_19_1Z2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_12_1Z2e( true) ;
         }
         else
         {
            wb_table3_12_1Z2e( false) ;
         }
      }

      protected void wb_table4_19_1Z2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_19_1Z2e( true) ;
         }
         else
         {
            wb_table4_19_1Z2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249524765", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("k2blogout.js", "?20231249524765", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'CONFIRMYES'","{handler:'E121Z2',iparms:[]");
         setEventMetadata("'CONFIRMYES'",",oparms:[]}");
         setEventMetadata("'CONFIRMNO'","{handler:'E131Z2',iparms:[]");
