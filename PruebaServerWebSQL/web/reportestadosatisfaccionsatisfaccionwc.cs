...
namespace GeneXus.Programs {
   public class reportestadosatisfaccionsatisfaccionwc : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV9SatisfaccionResueltoId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      public reportestadosatisfaccionsatisfaccionwc( )
      {
      ...
      public reportestadosatisfaccionsatisfaccionwc( IGxContext context )
      {
      ...
      {
         this.AV9SatisfaccionResueltoId = aP0_SatisfaccionResueltoId;
      ...
      public void executeSubmit( short aP0_SatisfaccionResueltoId ,
                                 ...
                                 short aP11_OrderedBy )
      {
         reportestadosatisfaccionsatisfaccionwc objreportestadosatisfaccionsatisfaccionwc;
         objreportestadosatisfaccionsatisfaccionwc = new reportestadosatisfaccionsatisfaccionwc();
         objreportestadosatisfaccionsatisfaccionwc.AV9SatisfaccionResueltoId = aP0_SatisfaccionResueltoId;
         objreportestadosatisfaccionsatisfaccionwc.AV17SatisfaccionFecha_From = aP1_SatisfaccionFecha_From;
         objreportestadosatisfaccionsatisfaccionwc.AV18SatisfaccionFecha_To = aP2_SatisfaccionFecha_To;
         objreportestadosatisfaccionsatisfaccionwc.AV20UsuarioFecha_From = aP3_UsuarioFecha_From;
         objreportestadosatisfaccionsatisfaccionwc.AV21UsuarioFecha_To = aP4_UsuarioFecha_To;
         objreportestadosatisfaccionsatisfaccionwc.AV22SatisfaccionTecnicoProblemaNombre = aP5_SatisfaccionTecnicoProblemaNombre;
         objreportestadosatisfaccionsatisfaccionwc.AV23SatisfaccionTecnicoCompetenteNombre = aP6_SatisfaccionTecnicoCompetenteNombre;
         objreportestadosatisfaccionsatisfaccionwc.AV24SatisfaccionTecnicoProfesionalismoNombre = aP7_SatisfaccionTecnicoProfesionalismoNombre;
         objreportestadosatisfaccionsatisfaccionwc.AV25SatisfaccionTiempoNombre = aP8_SatisfaccionTiempoNombre;
         objreportestadosatisfaccionsatisfaccionwc.AV26SatisfaccionAtencionNombre = aP9_SatisfaccionAtencionNombre;
         objreportestadosatisfaccionsatisfaccionwc.AV10K2BToolsGenericSearchField = aP10_K2BToolsGenericSearchField;
         objreportestadosatisfaccionsatisfaccionwc.AV11OrderedBy = aP11_OrderedBy;
         objreportestadosatisfaccionsatisfaccionwc.context.SetSubmitInitialConfig(context);
         objreportestadosatisfaccionsatisfaccionwc.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objreportestadosatisfaccionsatisfaccionwc);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((reportestadosatisfaccionsatisfaccionwc)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
         ...
         try
         {
            ...
            else
            {
               ...
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV22SatisfaccionTecnicoProblemaNombre)) )
               {
                  ...
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV22SatisfaccionTecnicoProblemaNombre, "")), 282, Gx_line+7, 502, Gx_line+23, 0+256, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
               }
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV23SatisfaccionTecnicoCompetenteNombre)) )
               {
                  ...
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV23SatisfaccionTecnicoCompetenteNombre, "")), 296, Gx_line+7, 516, Gx_line+23, 0+256, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
               }
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV24SatisfaccionTecnicoProfesionalismoNombre)) )
               {
                  ...
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV24SatisfaccionTecnicoProfesionalismoNombre, "")), 333, Gx_line+7, 553, Gx_line+23, 0+256, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
               }
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV25SatisfaccionTiempoNombre)) )
               {
                  ...
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV25SatisfaccionTiempoNombre, "")), 209, Gx_line+7, 429, Gx_line+23, 0+256, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
               }
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV26SatisfaccionAtencionNombre)) )
               {
                  H360( false, 30) ;
                  getPrinter().GxAttris("Courier New", 8, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText("Satisfaccion Atencion Nombre", 10, Gx_line+7, 215, Gx_line+22, 0+256, 0, 0, 0) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV26SatisfaccionAtencionNombre, "")), 223, Gx_line+7, 443, Gx_line+23, 0+256, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
               }
               H360( false, 30) ;
               ...
               getPrinter().GxDrawText("Satisfaccion Tecnico Problema Nombre", 589, Gx_line+7, 712, Gx_line+22, 0, 0, 0, 1) ;
               Gx_OldLine = Gx_line;
               Gx_line = (int)(Gx_line+30);
               GxHdr3 = true;
               ...
               lV10K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV10K2BToolsGenericSearchField), 200, "%");
               /* Using cursor P00362 */
               pr_default.execute(0, new Object[] {AV9SatisfaccionResueltoId, AV18SatisfaccionFecha_To, AV17SatisfaccionFecha_From, AV21UsuarioFecha_To, AV20UsuarioFecha_From, lV22SatisfaccionTecnicoProblemaNombre, lV23SatisfaccionTecnicoCompetenteNombre, lV24SatisfaccionTecnicoProfesionalismoNombre, lV25SatisfaccionTiempoNombre, lV26SatisfaccionAtencionNombre, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField});
               while ( (pr_default.getStatus(0) != 101) )
               {
                  A9SatisfaccionTecnicoProblemaId = P00362_A9SatisfaccionTecnicoProblemaId[0];
                  A10SatisfaccionTecnicoCompetenteId = P00362_A10SatisfaccionTecnicoCompetenteId[0];
                  A11SatisfaccionTecnicoProfesionalismoId = P00362_A11SatisfaccionTecnicoProfesionalismoId[0];
                  A12SatisfaccionTiempoId = P00362_A12SatisfaccionTiempoId[0];
                  A13SatisfaccionAtencionId = P00362_A13SatisfaccionAtencionId[0];
                  A8SatisfaccionResueltoId = P00362_A8SatisfaccionResueltoId[0];
                  A34SatisfaccionSugerencia = P00362_A34SatisfaccionSugerencia[0];
                  A94UsuarioRequerimiento = P00362_A94UsuarioRequerimiento[0];
                  A93UsuarioNombre = P00362_A93UsuarioNombre[0];
                  A15UsuarioId = P00362_A15UsuarioId[0];
                  A14TicketId = P00362_A14TicketId[0];
                  A7SatisfaccionId = P00362_A7SatisfaccionId[0];
                  A31SatisfaccionAtencionNombre = P00362_A31SatisfaccionAtencionNombre[0];
                  A38SatisfaccionTiempoNombre = P00362_A38SatisfaccionTiempoNombre[0];
                  A37SatisfaccionTecnicoProfesionalismoNombre = P00362_A37SatisfaccionTecnicoProfesionalismoNombre[0];
                  A35SatisfaccionTecnicoCompetenteNombre = P00362_A35SatisfaccionTecnicoCompetenteNombre[0];
                  A36SatisfaccionTecnicoProblemaNombre = P00362_A36SatisfaccionTecnicoProblemaNombre[0];
                  A90UsuarioFecha = P00362_A90UsuarioFecha[0];
                  A32SatisfaccionFecha = P00362_A32SatisfaccionFecha[0];
                  A36SatisfaccionTecnicoProblemaNombre = P00362_A36SatisfaccionTecnicoProblemaNombre[0];
                  A35SatisfaccionTecnicoCompetenteNombre = P00362_A35SatisfaccionTecnicoCompetenteNombre[0];
                  A37SatisfaccionTecnicoProfesionalismoNombre = P00362_A37SatisfaccionTecnicoProfesionalismoNombre[0];
                  A38SatisfaccionTiempoNombre = P00362_A38SatisfaccionTiempoNombre[0];
                  ...
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A36SatisfaccionTecnicoProblemaNombre, "")), 589, Gx_line+7, 712, Gx_line+23, 0, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
      ...
      public override void initialize( )
      {
         ...
         A94UsuarioRequerimiento = "";
         A34SatisfaccionSugerencia = "";
         P00362_A9SatisfaccionTecnicoProblemaId = new short[1] ;
         P00362_A10SatisfaccionTecnicoCompetenteId = new short[1] ;
         P00362_A11SatisfaccionTecnicoProfesionalismoId = new short[1] ;
         P00362_A12SatisfaccionTiempoId = new short[1] ;
         P00362_A13SatisfaccionAtencionId = new short[1] ;
         P00362_A8SatisfaccionResueltoId = new short[1] ;
         P00362_A34SatisfaccionSugerencia = new string[] {""} ;
         P00362_A94UsuarioRequerimiento = new string[] {""} ;
         P00362_A93UsuarioNombre = new string[] {""} ;
         P00362_A15UsuarioId = new short[1] ;
         P00362_A14TicketId = new long[1] ;
         P00362_A7SatisfaccionId = new long[1] ;
         P00362_A31SatisfaccionAtencionNombre = new string[] {""} ;
         P00362_A38SatisfaccionTiempoNombre = new string[] {""} ;
         P00362_A37SatisfaccionTecnicoProfesionalismoNombre = new string[] {""} ;
         P00362_A35SatisfaccionTecnicoCompetenteNombre = new string[] {""} ;
         P00362_A36SatisfaccionTecnicoProblemaNombre = new string[] {""} ;
         P00362_A90UsuarioFecha = new DateTime[] {DateTime.MinValue} ;
         P00362_A32SatisfaccionFecha = new DateTime[] {DateTime.MinValue} ;
         Gx_date = DateTime.MinValue;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportestadosatisfaccionsatisfaccionwc__default(),
            new Object[][] {
                new Object[] {
               P00362_A9SatisfaccionTecnicoProblemaId, P00362_A10SatisfaccionTecnicoCompetenteId, P00362_A11SatisfaccionTecnicoProfesionalismoId, P00362_A12SatisfaccionTiempoId, P00362_A13SatisfaccionAtencionId, P00362_A8SatisfaccionResueltoId, P00362_A34SatisfaccionSugerencia, P00362_A94UsuarioRequerimiento, P00362_A93UsuarioNombre, P00362_A15UsuarioId,
               P00362_A14TicketId, P00362_A7SatisfaccionId, P00362_A31SatisfaccionAtencionNombre, P00362_A38SatisfaccionTiempoNombre, P00362_A37SatisfaccionTecnicoProfesionalismoNombre, P00362_A35SatisfaccionTecnicoCompetenteNombre, P00362_A36SatisfaccionTecnicoProblemaNombre, P00362_A90UsuarioFecha, P00362_A32SatisfaccionFecha
               }
            }
         );
         AV37Pgmname = "ReportEstadoSatisfaccionSatisfaccionWC";
      ...
      private short AV9SatisfaccionResueltoId ;
      ...
      private short[] P00362_A9SatisfaccionTecnicoProblemaId ;
      private short[] P00362_A10SatisfaccionTecnicoCompetenteId ;
      private short[] P00362_A11SatisfaccionTecnicoProfesionalismoId ;
      private short[] P00362_A12SatisfaccionTiempoId ;
      private short[] P00362_A13SatisfaccionAtencionId ;
      private short[] P00362_A8SatisfaccionResueltoId ;
      private string[] P00362_A34SatisfaccionSugerencia ;
      private string[] P00362_A94UsuarioRequerimiento ;
      private string[] P00362_A93UsuarioNombre ;
      private short[] P00362_A15UsuarioId ;
      private long[] P00362_A14TicketId ;
      private long[] P00362_A7SatisfaccionId ;
      private string[] P00362_A31SatisfaccionAtencionNombre ;
      private string[] P00362_A38SatisfaccionTiempoNombre ;
      private string[] P00362_A37SatisfaccionTecnicoProfesionalismoNombre ;
      private string[] P00362_A35SatisfaccionTecnicoCompetenteNombre ;
      private string[] P00362_A36SatisfaccionTecnicoProblemaNombre ;
      private DateTime[] P00362_A90UsuarioFecha ;
      private DateTime[] P00362_A32SatisfaccionFecha ;
      private SdtK2BContext AV8Context ;
   }

   public class reportestadosatisfaccionsatisfaccionwc__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P00362( IGxContext context ,
                                             ...
                                             short AV11OrderedBy ,
                                             short AV9SatisfaccionResueltoId ,
                                             short A8SatisfaccionResueltoId )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV22SatisfaccionTecnicoProblemaNombre)) )
         {
            AddWhere(sWhereString, "(T2.[EstadoSatisfaccionNombre] like @lV22SatisfaccionTecnicoProblemaNombre)");
         }
         else
         {
            GXv_int1[5] = 1;
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV23SatisfaccionTecnicoCompetenteNombre)) )
         {
            AddWhere(sWhereString, "(T3.[EstadoSatisfaccionNombre] like @lV23SatisfaccionTecnicoCompetenteNombre)");
         }
         else
         {
            GXv_int1[6] = 1;
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV24SatisfaccionTecnicoProfesionalismoNombre)) )
         {
            AddWhere(sWhereString, "(T4.[EstadoSatisfaccionNombre] like @lV24SatisfaccionTecnicoProfesionalismoNombre)");
         }
         else
         {
            GXv_int1[7] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00362(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (short)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] , (short)dynConstraints[25] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV9SatisfaccionResueltoId",GXType.Int16,4,0) ,
