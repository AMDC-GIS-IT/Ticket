...
namespace GeneXus.Programs {
   public class estadotecnicos : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtEstadoTecnicosId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A192EstadoTecnicosId), 4, 0, ",", "")), ((edtEstadoTecnicosId_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A192EstadoTecnicosId), "ZZZ9")) : context.localUtil.Format( (decimal)(A192EstadoTecnicosId), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEstadoTecnicosId_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtEstadoTecnicosId_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "NumMin", "right", false, "", "HLP_EstadoTecnicos.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249492516", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249492530", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("estadotecnicos.js", "?20231249492530", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
