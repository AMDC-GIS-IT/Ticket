...
namespace GeneXus.Programs {
   public class reportestadosatisfaccionsatisfaccionwc2 : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV9SatisfaccionTecnicoCompetenteId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      public reportestadosatisfaccionsatisfaccionwc2( )
      {
      ...
      public reportestadosatisfaccionsatisfaccionwc2( IGxContext context )
      {
      ...
      {
         this.AV9SatisfaccionTecnicoCompetenteId = aP0_SatisfaccionTecnicoCompetenteId;
      ...
      public void executeSubmit( short aP0_SatisfaccionTecnicoCompetenteId ,
                                 ...
                                 short aP11_OrderedBy )
      {
         reportestadosatisfaccionsatisfaccionwc2 objreportestadosatisfaccionsatisfaccionwc2;
         objreportestadosatisfaccionsatisfaccionwc2 = new reportestadosatisfaccionsatisfaccionwc2();
         objreportestadosatisfaccionsatisfaccionwc2.AV9SatisfaccionTecnicoCompetenteId = aP0_SatisfaccionTecnicoCompetenteId;
         objreportestadosatisfaccionsatisfaccionwc2.AV17SatisfaccionFecha_From = aP1_SatisfaccionFecha_From;
         objreportestadosatisfaccionsatisfaccionwc2.AV18SatisfaccionFecha_To = aP2_SatisfaccionFecha_To;
         objreportestadosatisfaccionsatisfaccionwc2.AV20UsuarioFecha_From = aP3_UsuarioFecha_From;
         objreportestadosatisfaccionsatisfaccionwc2.AV21UsuarioFecha_To = aP4_UsuarioFecha_To;
         objreportestadosatisfaccionsatisfaccionwc2.AV22SatisfaccionResueltoNombre = aP5_SatisfaccionResueltoNombre;
         objreportestadosatisfaccionsatisfaccionwc2.AV23SatisfaccionTecnicoProblemaNombre = aP6_SatisfaccionTecnicoProblemaNombre;
         objreportestadosatisfaccionsatisfaccionwc2.AV24SatisfaccionTecnicoProfesionalismoNombre = aP7_SatisfaccionTecnicoProfesionalismoNombre;
         objreportestadosatisfaccionsatisfaccionwc2.AV25SatisfaccionTiempoNombre = aP8_SatisfaccionTiempoNombre;
         objreportestadosatisfaccionsatisfaccionwc2.AV26SatisfaccionAtencionNombre = aP9_SatisfaccionAtencionNombre;
         objreportestadosatisfaccionsatisfaccionwc2.AV10K2BToolsGenericSearchField = aP10_K2BToolsGenericSearchField;
         objreportestadosatisfaccionsatisfaccionwc2.AV11OrderedBy = aP11_OrderedBy;
         objreportestadosatisfaccionsatisfaccionwc2.context.SetSubmitInitialConfig(context);
         objreportestadosatisfaccionsatisfaccionwc2.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objreportestadosatisfaccionsatisfaccionwc2);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((reportestadosatisfaccionsatisfaccionwc2)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
         ...
         try
         {
            ...
            else
            {
               ...
               pr_default.dynParam(0, new Object[]{ new Object[]{
                                                    ...
                                                    AV11OrderedBy ,
                                                    AV9SatisfaccionTecnicoCompetenteId } ,
                                                    new int[]{
               ...
               lV10K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV10K2BToolsGenericSearchField), 200, "%");
               /* Using cursor P00382 */
               pr_default.execute(0, new Object[] {AV9SatisfaccionTecnicoCompetenteId, AV18SatisfaccionFecha_To, AV17SatisfaccionFecha_From, AV21UsuarioFecha_To, AV20UsuarioFecha_From, lV22SatisfaccionResueltoNombre, lV23SatisfaccionTecnicoProblemaNombre, lV24SatisfaccionTecnicoProfesionalismoNombre, lV25SatisfaccionTiempoNombre, lV26SatisfaccionAtencionNombre, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField, lV10K2BToolsGenericSearchField});
               while ( (pr_default.getStatus(0) != 101) )
               {
                  A8SatisfaccionResueltoId = P00382_A8SatisfaccionResueltoId[0];
                  A9SatisfaccionTecnicoProblemaId = P00382_A9SatisfaccionTecnicoProblemaId[0];
                  A11SatisfaccionTecnicoProfesionalismoId = P00382_A11SatisfaccionTecnicoProfesionalismoId[0];
                  A12SatisfaccionTiempoId = P00382_A12SatisfaccionTiempoId[0];
                  A13SatisfaccionAtencionId = P00382_A13SatisfaccionAtencionId[0];
                  A10SatisfaccionTecnicoCompetenteId = P00382_A10SatisfaccionTecnicoCompetenteId[0];
                  A34SatisfaccionSugerencia = P00382_A34SatisfaccionSugerencia[0];
                  A94UsuarioRequerimiento = P00382_A94UsuarioRequerimiento[0];
                  A93UsuarioNombre = P00382_A93UsuarioNombre[0];
                  A15UsuarioId = P00382_A15UsuarioId[0];
                  A14TicketId = P00382_A14TicketId[0];
                  A7SatisfaccionId = P00382_A7SatisfaccionId[0];
                  A31SatisfaccionAtencionNombre = P00382_A31SatisfaccionAtencionNombre[0];
                  A38SatisfaccionTiempoNombre = P00382_A38SatisfaccionTiempoNombre[0];
                  A37SatisfaccionTecnicoProfesionalismoNombre = P00382_A37SatisfaccionTecnicoProfesionalismoNombre[0];
                  A36SatisfaccionTecnicoProblemaNombre = P00382_A36SatisfaccionTecnicoProblemaNombre[0];
                  A33SatisfaccionResueltoNombre = P00382_A33SatisfaccionResueltoNombre[0];
                  A90UsuarioFecha = P00382_A90UsuarioFecha[0];
                  A32SatisfaccionFecha = P00382_A32SatisfaccionFecha[0];
                  A33SatisfaccionResueltoNombre = P00382_A33SatisfaccionResueltoNombre[0];
                  A36SatisfaccionTecnicoProblemaNombre = P00382_A36SatisfaccionTecnicoProblemaNombre[0];
                  A37SatisfaccionTecnicoProfesionalismoNombre = P00382_A37SatisfaccionTecnicoProfesionalismoNombre[0];
                  A38SatisfaccionTiempoNombre = P00382_A38SatisfaccionTiempoNombre[0];
      ...
      protected void H380( bool bFoot ,
                           int Inc )
      {
      ...
      public override void initialize( )
      {
         ...
         A94UsuarioRequerimiento = "";
         A34SatisfaccionSugerencia = "";
         P00382_A8SatisfaccionResueltoId = new short[1] ;
         P00382_A9SatisfaccionTecnicoProblemaId = new short[1] ;
         P00382_A11SatisfaccionTecnicoProfesionalismoId = new short[1] ;
         P00382_A12SatisfaccionTiempoId = new short[1] ;
         P00382_A13SatisfaccionAtencionId = new short[1] ;
         P00382_A10SatisfaccionTecnicoCompetenteId = new short[1] ;
         P00382_A34SatisfaccionSugerencia = new string[] {""} ;
         P00382_A94UsuarioRequerimiento = new string[] {""} ;
         P00382_A93UsuarioNombre = new string[] {""} ;
         P00382_A15UsuarioId = new short[1] ;
         P00382_A14TicketId = new long[1] ;
         P00382_A7SatisfaccionId = new long[1] ;
         P00382_A31SatisfaccionAtencionNombre = new string[] {""} ;
         P00382_A38SatisfaccionTiempoNombre = new string[] {""} ;
         P00382_A37SatisfaccionTecnicoProfesionalismoNombre = new string[] {""} ;
         P00382_A36SatisfaccionTecnicoProblemaNombre = new string[] {""} ;
         P00382_A33SatisfaccionResueltoNombre = new string[] {""} ;
         P00382_A90UsuarioFecha = new DateTime[] {DateTime.MinValue} ;
         P00382_A32SatisfaccionFecha = new DateTime[] {DateTime.MinValue} ;
         Gx_date = DateTime.MinValue;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportestadosatisfaccionsatisfaccionwc2__default(),
            new Object[][] {
                new Object[] {
               P00382_A8SatisfaccionResueltoId, P00382_A9SatisfaccionTecnicoProblemaId, P00382_A11SatisfaccionTecnicoProfesionalismoId, P00382_A12SatisfaccionTiempoId, P00382_A13SatisfaccionAtencionId, P00382_A10SatisfaccionTecnicoCompetenteId, P00382_A34SatisfaccionSugerencia, P00382_A94UsuarioRequerimiento, P00382_A93UsuarioNombre, P00382_A15UsuarioId,
               P00382_A14TicketId, P00382_A7SatisfaccionId, P00382_A31SatisfaccionAtencionNombre, P00382_A38SatisfaccionTiempoNombre, P00382_A37SatisfaccionTecnicoProfesionalismoNombre, P00382_A36SatisfaccionTecnicoProblemaNombre, P00382_A33SatisfaccionResueltoNombre, P00382_A90UsuarioFecha, P00382_A32SatisfaccionFecha
               }
            }
         );
         AV37Pgmname = "ReportEstadoSatisfaccionSatisfaccionWC2";
      ...
      private short AV9SatisfaccionTecnicoCompetenteId ;
      ...
      private short[] P00382_A8SatisfaccionResueltoId ;
      private short[] P00382_A9SatisfaccionTecnicoProblemaId ;
      private short[] P00382_A11SatisfaccionTecnicoProfesionalismoId ;
      private short[] P00382_A12SatisfaccionTiempoId ;
      private short[] P00382_A13SatisfaccionAtencionId ;
      private short[] P00382_A10SatisfaccionTecnicoCompetenteId ;
      private string[] P00382_A34SatisfaccionSugerencia ;
      private string[] P00382_A94UsuarioRequerimiento ;
      private string[] P00382_A93UsuarioNombre ;
      private short[] P00382_A15UsuarioId ;
      private long[] P00382_A14TicketId ;
      private long[] P00382_A7SatisfaccionId ;
      private string[] P00382_A31SatisfaccionAtencionNombre ;
      private string[] P00382_A38SatisfaccionTiempoNombre ;
      private string[] P00382_A37SatisfaccionTecnicoProfesionalismoNombre ;
      private string[] P00382_A36SatisfaccionTecnicoProblemaNombre ;
      private string[] P00382_A33SatisfaccionResueltoNombre ;
      private DateTime[] P00382_A90UsuarioFecha ;
      private DateTime[] P00382_A32SatisfaccionFecha ;
      private SdtK2BContext AV8Context ;
   }

   public class reportestadosatisfaccionsatisfaccionwc2__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00382(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (short)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV9SatisfaccionTecnicoCompetenteId",GXType.Int16,4,0) ,
