...
namespace GeneXus.Programs {
   public class exportwwetapasdesarrollo : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      void executePrivate( )
      {
         ...
         if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "EtapasDesarrollo",  "EtapasDesarrollo",  "List",  "",  "WWEtapasDesarrollo") )
         {
            AV19Filename = "";
            AV20ErrorMessage = "You are not authorized to do activity";
            AV20ErrorMessage += "EntityName:" + "EtapasDesarrollo";
            AV20ErrorMessage += "TransactionName:" + "EtapasDesarrollo";
         ...
         AV19Filename = GxDirectory.TemporaryFilesPath + AV22File.Separator + "ExportWWEtapasDesarrollo-" + StringUtil.Trim( StringUtil.Str( (decimal)(AV17Random), 8, 0)) + ".xlsx";
         ...
         if ( ! context.isAjaxRequest( ) )
         {
            AV21HttpResponse.AppendHeader("Content-Disposition", "attachment;filename=ExportWWEtapasDesarrollo.xlsx");
         }
         if ( ! context.isAjaxRequest( ) )
         {
      ...
      public override void initialize( )
      {
         ...
         AV29Pgmname = "ExportWWEtapasDesarrollo";
         /* GeneXus formulas. */
         AV29Pgmname = "ExportWWEtapasDesarrollo";
         context.Gx_err = 0;
      }
