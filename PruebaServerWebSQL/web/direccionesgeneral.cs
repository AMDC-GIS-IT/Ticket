...
namespace GeneXus.Programs {
   public class direccionesgeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public direccionesgeneral( )
      {
      ...
      public direccionesgeneral( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)Gx_mode,(short)AV6DireccionId,(string)AV8TabCode});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249492470", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"DIRECCIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A258DireccionId), 4, 0, ",", "")));
      ...
      protected void WB670( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "direccionesgeneral.aspx");
            }
            /* Div Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_15_672( true) ;
         }
         else
         {
            wb_table1_15_672( false) ;
         }
         return  ;
      }

      protected void wb_table1_15_672e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void E12672( )
      {
         ...
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Direcciones";
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Direcciones";
         ...
         {
            A258DireccionId = H00672_A258DireccionId[0];
            AV16GXLvl26 = 1;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Transactioncomponent_Component), StringUtil.Lower( "Direcciones")) != 0 )
         {
            WebComp_Transactioncomponent = getWebComponent(GetType(), "GeneXus.Programs", "direcciones", new Object[] {context} );
            WebComp_Transactioncomponent.ComponentInit();
            WebComp_Transactioncomponent.Name = "Direcciones";
            WebComp_Transactioncomponent_Component = "Direcciones";
         }
         if ( StringUtil.Len( WebComp_Transactioncomponent_Component) != 0 )
         {
            WebComp_Transactioncomponent.setjustcreated();
            WebComp_Transactioncomponent.componentprepare(new Object[] {(string)sPrefix+"W0029",(string)"",(string)Gx_mode,(short)AV6DireccionId});
      ...
      protected void E13672( )
      {
         /* 'DoUpdate' Routine */
         returnInSub = false;
         new k2bgettrncontextbyname(context ).execute(  "Direcciones", out  AV10TrnContext) ;
         GXt_char1 = "";
         ...
         new k2bsettrncontextbyname(context ).execute(  "Direcciones",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerdirecciones.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(AV6DireccionId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","DireccionId","TabCode"}) );
      ...
      protected void E14672( )
      {
         ...
         AV10TrnContext.gxTpr_Returnmode = "Popup";
         new k2bsettrncontextbyname(context ).execute(  "Direcciones",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerdirecciones.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(AV6DireccionId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","DireccionId","TabCode"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void wb_table1_15_672( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_18_672( true) ;
         }
         else
         {
            wb_table2_18_672( false) ;
         }
         return  ;
      }

      protected void wb_table2_18_672e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_15_672e( true) ;
         }
         else
         {
            wb_table1_15_672e( false) ;
         }
      }

      protected void wb_table2_18_672( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_18_672e( true) ;
         }
         else
         {
            wb_table2_18_672e( false) ;
         }
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6DireccionId = (string)((string)getParm(obj,1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "direccionesgeneral", GetJustCreated( ));
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "Gx_mode", Gx_mode);
            AV6DireccionId = Convert.ToInt16(getParm(obj,3));
            AssignAttri(sPrefix, false, "AV6DireccionId", StringUtil.LTrimStr( (decimal)(AV6DireccionId), 4, 0));
         ...
         wcpOAV6DireccionId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6DireccionId"), ",", "."));
         wcpOAV8TabCode = cgiGet( sPrefix+"wcpOAV8TabCode");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(Gx_mode, wcpOGx_mode) != 0 ) || ( AV6DireccionId != wcpOAV6DireccionId ) || ( StringUtil.StrCmp(AV8TabCode, wcpOAV8TabCode) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOGx_mode = Gx_mode;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249492498", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("direccionesgeneral.js", "?20231249492499", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A258DireccionId',fld:'DIRECCIONID',pic:'ZZZ9'},{av:'AV6DireccionId',fld:'vDIRECCIONID',pic:'ZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E13672',iparms:[{av:'AV6DireccionId',fld:'vDIRECCIONID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E14672',iparms:[{av:'AV6DireccionId',fld:'vDIRECCIONID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV12ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         scmdbuf = "";
         H00672_A258DireccionId = new short[1] ;
         ...
         sCtrlAV6DireccionId = "";
         sCtrlAV8TabCode = "";
         pr_datastore2 = new DataStoreProvider(context, new GeneXus.Programs.direccionesgeneral__datastore2(),
            new Object[][] {
                new Object[] {
               H00672_A258DireccionId
               }
            }
         );
      ...
      private short[] H00672_A258DireccionId ;
   ...
   public class direccionesgeneral__datastore2 : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00672", "SELECT [DireccionId] FROM dbo.[Direcciones] WHERE [DireccionId] = @AV6DireccionId ORDER BY [DireccionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00672,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
