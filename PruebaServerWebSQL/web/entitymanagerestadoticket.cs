...
namespace GeneXus.Programs {
   public class entitymanagerestadoticket : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public entitymanagerestadoticket( )
      {
      ...
      public entitymanagerestadoticket( IGxContext context )
      {
                           ...
                           string aP2_TabCode )
      {
         ...
         this.AV6EstadoTicketId = aP1_EstadoTicketId;
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  ...
                  AssignAttri("", false, "AV6EstadoTicketId", StringUtil.LTrimStr( (decimal)(AV6EstadoTicketId), 4, 0));
                  GxWebStd.gx_hidden_field( context, "gxhash_vESTADOTICKETID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6EstadoTicketId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249524955", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("entitymanagerestadoticket.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6EstadoTicketId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Gx_mode","EstadoTicketId","TabCode"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vMODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( Gx_mode, "@!")), context));
         GxWebStd.gx_hidden_field( context, "vESTADOTICKETID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6EstadoTicketId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vESTADOTICKETID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6EstadoTicketId), "ZZZ9"), context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Componentwc_usuario == null ) )
         {
            WebComp_Componentwc_usuario.componentjscripts();
         }
         if ( ! ( WebComp_Componentwc_responsable == null ) )
         {
            WebComp_Componentwc_responsable.componentjscripts();
         }
      ...
      {
         return formatLink("entitymanagerestadoticket.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6EstadoTicketId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Gx_mode","EstadoTicketId","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "EntityManagerEstadoTicket" ;
      }
      ...
      protected void WB2D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblK2bpgmdesc_Internalname, lblK2bpgmdesc_Caption, "", "", lblK2bpgmdesc_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_EntityManagerEstadoTicket.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblBacktoworkwith_Internalname, lblBacktoworkwith_Caption, lblBacktoworkwith_Link, "", lblBacktoworkwith_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_BackToWorkWith", 0, "", 1, 1, 0, 0, "HLP_EntityManagerEstadoTicket.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divComponentcontainer_usuario_Internalname, divComponentcontainer_usuario_Visible, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0047"+"", StringUtil.RTrim( WebComp_Componentwc_usuario_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0047"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Componentwc_usuario_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldComponentwc_usuario), StringUtil.Lower( WebComp_Componentwc_usuario_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0047"+"");
                  }
                  WebComp_Componentwc_usuario.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldComponentwc_usuario), StringUtil.Lower( WebComp_Componentwc_usuario_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divComponentcontainer_responsable_Internalname, divComponentcontainer_responsable_Visible, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0053"+"", StringUtil.RTrim( WebComp_Componentwc_responsable_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0053"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Componentwc_responsable_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldComponentwc_responsable), StringUtil.Lower( WebComp_Componentwc_responsable_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0053"+"");
                  }
                  WebComp_Componentwc_responsable.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldComponentwc_responsable), StringUtil.Lower( WebComp_Componentwc_responsable_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_59_2D2( true) ;
         }
         else
         {
            wb_table1_59_2D2( false) ;
         }
         return  ;
      }

      protected void wb_table1_59_2D2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldComponentwc_usuario = cgiGet( "W0047");
                           if ( ( StringUtil.Len( OldComponentwc_usuario) == 0 ) || ( StringUtil.StrCmp(OldComponentwc_usuario, WebComp_Componentwc_usuario_Component) != 0 ) )
                           {
                              WebComp_Componentwc_usuario = getWebComponent(GetType(), "GeneXus.Programs", OldComponentwc_usuario, new Object[] {context} );
                              WebComp_Componentwc_usuario.ComponentInit();
                              WebComp_Componentwc_usuario.Name = "OldComponentwc_usuario";
                              WebComp_Componentwc_usuario_Component = OldComponentwc_usuario;
                           }
                           if ( StringUtil.Len( WebComp_Componentwc_usuario_Component) != 0 )
                           {
                              WebComp_Componentwc_usuario.componentprocess("W0047", "", sEvt);
                           }
                           WebComp_Componentwc_usuario_Component = OldComponentwc_usuario;
                        }
                        else if ( nCmpId == 53 )
                        {
                           OldComponentwc_responsable = cgiGet( "W0053");
                           if ( ( StringUtil.Len( OldComponentwc_responsable) == 0 ) || ( StringUtil.StrCmp(OldComponentwc_responsable, WebComp_Componentwc_responsable_Component) != 0 ) )
                           {
                              WebComp_Componentwc_responsable = getWebComponent(GetType(), "GeneXus.Programs", OldComponentwc_responsable, new Object[] {context} );
                              WebComp_Componentwc_responsable.ComponentInit();
                              WebComp_Componentwc_responsable.Name = "OldComponentwc_responsable";
                              WebComp_Componentwc_responsable_Component = OldComponentwc_responsable;
                           }
                           if ( StringUtil.Len( WebComp_Componentwc_responsable_Component) != 0 )
                           {
                              WebComp_Componentwc_responsable.componentprocess("W0053", "", sEvt);
                           }
                           WebComp_Componentwc_responsable_Component = OldComponentwc_responsable;
                        }
                        else if ( nCmpId == 79 )
                        {
                           OldPopupcomponent = cgiGet( "W0079");
                           ...
                           {
                              WebComp_Popupcomponent.componentprocess("W0079", "", sEvt);
                           }
                           WebComp_Popupcomponent_Component = OldPopupcomponent;
                        }
                     }
      ...
      {
         /* GeneXus formulas. */
         AV27Pgmname = "EntityManagerEstadoTicket";
         context.Gx_err = 0;
      }
      ...
      protected void RF2D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Componentwc_usuario_Component) != 0 )
               {
                  WebComp_Componentwc_usuario.componentstart();
               }
            }
         }
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Componentwc_responsable_Component) != 0 )
               {
                  WebComp_Componentwc_responsable.componentstart();
               }
            }
         }
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
      ...
      protected void E112D2( )
      {
         /* Start Routine */
         returnInSub = false;
         lblBacktoworkwith_Caption = StringUtil.Format( "%1", "Estado tickets", "", "", "", "", "", "", "", "");
         AssignProp("", false, lblBacktoworkwith_Internalname, "Caption", lblBacktoworkwith_Caption, true);
         lblBacktoworkwith_Link = formatLink("wwestadoticket.aspx") ;
         AssignProp("", false, lblBacktoworkwith_Internalname, "Link", lblBacktoworkwith_Link, true);
         AV26GXLvl7 = 0;
         /* Using cursor H002D2 */
         pr_default.execute(0, new Object[] {AV6EstadoTicketId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A5EstadoTicketId = H002D2_A5EstadoTicketId[0];
            A24EstadoTicketNombre = H002D2_A24EstadoTicketNombre[0];
            AV26GXLvl7 = 1;
            Form.Caption = A24EstadoTicketNombre;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblK2bpgmdesc_Caption = StringUtil.Format( "%1 - %2", "Estado Ticket", A24EstadoTicketNombre, "", "", "", "", "", "", "");
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            lblK2bpgmdesc_Caption = "Estado Ticket";
            AssignProp("", false, lblK2bpgmdesc_Internalname, "Caption", lblK2bpgmdesc_Caption, true);
         }
      ...
      protected void E122D2( )
      {
         ...
         {
            AV20RelatedTransactionName = "EstadoTicket";
            AssignAttri("", false, "AV20RelatedTransactionName", AV20RelatedTransactionName);
            GxWebStd.gx_hidden_field( context, "gxhash_vRELATEDTRANSACTIONNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV20RelatedTransactionName, "")), context));
         }
         else if ( StringUtil.StrCmp(AV8TabCode, "Usuario") == 0 )
         {
            AV20RelatedTransactionName = "Usuario";
            AssignAttri("", false, "AV20RelatedTransactionName", AV20RelatedTransactionName);
            GxWebStd.gx_hidden_field( context, "gxhash_vRELATEDTRANSACTIONNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV20RelatedTransactionName, "")), context));
         }
         else if ( StringUtil.StrCmp(AV8TabCode, "Responsable") == 0 )
         {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               lblComponenttitle_Caption = StringUtil.Format( "Actualizar %1", "Estado Ticket", "", "", "", "", "", "", "", "");
               ...
               if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Popupcomponent_Component), StringUtil.Lower( "EstadoTicket")) != 0 )
               {
                  WebComp_Popupcomponent = getWebComponent(GetType(), "GeneXus.Programs", "estadoticket", new Object[] {context} );
                  WebComp_Popupcomponent.ComponentInit();
                  WebComp_Popupcomponent.Name = "EstadoTicket";
                  WebComp_Popupcomponent_Component = "EstadoTicket";
               }
               if ( StringUtil.Len( WebComp_Popupcomponent_Component) != 0 )
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0079",(string)"",(string)"UPD",(short)AV6EstadoTicketId});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
         {
            if ( ( StringUtil.StrCmp(AV8TabCode, "General") == 0 ) || String.IsNullOrEmpty(StringUtil.RTrim( AV8TabCode)) )
            {
               lblComponenttitle_Caption = StringUtil.Format( "Eliminar %1", "Estado Ticket", "", "", "", "", "", "", "", "");
               AssignProp("", false, lblComponenttitle_Internalname, "Caption", lblComponenttitle_Caption, true);
               tblTablemodal_Visible = 1;
               AssignProp("", false, tblTablemodal_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(tblTablemodal_Visible), 5, 0), true);
               /* Object Property */
               ...
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0079",(string)"",(string)"DLT",(short)AV6EstadoTicketId});
                  WebComp_Popupcomponent.componentbind(new Object[] {(string)"",(string)""});
               }
               if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Popupcomponent )
               {
      ...
      protected void S112( )
      {
         ...
         AV11Tab.gxTpr_Link = formatLink("entitymanagerestadoticket.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6EstadoTicketId,4,0)),UrlEncode(StringUtil.RTrim(AV11Tab.gxTpr_Code))}, new string[] {"Mode","EstadoTicketId","TabCode"}) ;
         AV11Tab.gxTpr_Componenttype = 3;
         AV11Tab.gxTpr_Relatedtransaction = "EstadoTicket";
         AV10Tabs.Add(AV11Tab, 0);
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "Usuario",  "Usuario",  "List",  "",  "EstadoTicketUsuarioWC") )
         {
            AV18AvailableComponents.Add("Usuario", 0);
            AV11Tab = new SdtK2BTabOptions_K2BTabOptionsItem(context);
            AV11Tab.gxTpr_Code = "Usuario";
            AV11Tab.gxTpr_Description = "Usuarios";
            AV11Tab.gxTpr_Link = formatLink("entitymanagerestadoticket.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6EstadoTicketId,4,0)),UrlEncode(StringUtil.RTrim(AV11Tab.gxTpr_Code))}, new string[] {"Mode","EstadoTicketId","TabCode"}) ;
            AV11Tab.gxTpr_Componenttype = 1;
            AV11Tab.gxTpr_Relatedtransaction = "Usuario";
            AV10Tabs.Add(AV11Tab, 0);
         }
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "Ticket",  "Ticket",  "List",  "",  "EstadoTicketTicketWC") )
         {
            AV18AvailableComponents.Add("Responsable", 0);
            AV11Tab = new SdtK2BTabOptions_K2BTabOptionsItem(context);
            AV11Tab.gxTpr_Code = "Responsable";
            AV11Tab.gxTpr_Description = "Ticketes";
            AV11Tab.gxTpr_Link = formatLink("entitymanagerestadoticket.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6EstadoTicketId,4,0)),UrlEncode(StringUtil.RTrim(AV11Tab.gxTpr_Code))}, new string[] {"Mode","EstadoTicketId","TabCode"}) ;
            AV11Tab.gxTpr_Componenttype = 1;
         ...
         if ( AV10Tabs.Count > 0 )
         {
            ...
            divComponentcontainer_usuario_Visible = 0;
            AssignProp("", false, divComponentcontainer_usuario_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(divComponentcontainer_usuario_Visible), 5, 0), true);
            divComponentcontainer_responsable_Visible = 0;
            AssignProp("", false, divComponentcontainer_responsable_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(divComponentcontainer_responsable_Visible), 5, 0), true);
            ...
            else if ( ( StringUtil.StrCmp(AV8TabCode, "Usuario") == 0 ) || ( String.IsNullOrEmpty(StringUtil.RTrim( AV8TabCode)) && ( StringUtil.StrCmp(((SdtK2BTabOptions_K2BTabOptionsItem)AV10Tabs.Item(1)).gxTpr_Code, "Usuario") == 0 ) ) )
            {
               /* Execute user subroutine: 'LOADCOMPONENT_USUARIO' */
               S132 ();
               if (returnInSub) return;
            }
            else if ( ( StringUtil.StrCmp(AV8TabCode, "Responsable") == 0 ) || ( String.IsNullOrEmpty(StringUtil.RTrim( AV8TabCode)) && ( StringUtil.StrCmp(((SdtK2BTabOptions_K2BTabOptionsItem)AV10Tabs.Item(1)).gxTpr_Code, "Responsable") == 0 ) ) )
            {
               /* Execute user subroutine: 'LOADCOMPONENT_RESPONSABLE' */
               S142 ();
               if (returnInSub) return;
            }
            else
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Componentwc_general_Component), StringUtil.Lower( "EstadoTicketGeneral")) != 0 )
            {
               WebComp_Componentwc_general = getWebComponent(GetType(), "GeneXus.Programs", "estadoticketgeneral", new Object[] {context} );
               WebComp_Componentwc_general.ComponentInit();
               WebComp_Componentwc_general.Name = "EstadoTicketGeneral";
               WebComp_Componentwc_general_Component = "EstadoTicketGeneral";
            }
            if ( StringUtil.Len( WebComp_Componentwc_general_Component) != 0 )
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0041",(string)"",(string)Gx_mode,(short)AV6EstadoTicketId,(string)AV8TabCode});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0041",(string)"",(string)"DSP",(short)AV6EstadoTicketId,(string)AV8TabCode});
               WebComp_Componentwc_general.componentbind(new Object[] {(string)"",(string)"",(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Componentwc_general )
            {
      ...
      protected void S132( )
      {
         /* 'LOADCOMPONENT_USUARIO' Routine */
         returnInSub = false;
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "Usuario",  "Usuario",  "List",  "",  "EstadoTicketUsuarioWC") )
         {
            if ( StringUtil.StrCmp(Gx_mode, "INS") != 0 )
            {
               divComponentcontainer_usuario_Visible = 1;
               AssignProp("", false, divComponentcontainer_usuario_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(divComponentcontainer_usuario_Visible), 5, 0), true);
               /* Object Property */
               if ( true )
               {
                  bDynCreated_Componentwc_usuario = true;
               }
               if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Componentwc_usuario_Component), StringUtil.Lower( "EstadoTicketUsuarioWC")) != 0 )
               {
                  WebComp_Componentwc_usuario = getWebComponent(GetType(), "GeneXus.Programs", "estadoticketusuariowc", new Object[] {context} );
                  WebComp_Componentwc_usuario.ComponentInit();
                  WebComp_Componentwc_usuario.Name = "EstadoTicketUsuarioWC";
                  WebComp_Componentwc_usuario_Component = "EstadoTicketUsuarioWC";
               }
               if ( StringUtil.Len( WebComp_Componentwc_usuario_Component) != 0 )
               {
                  WebComp_Componentwc_usuario.setjustcreated();
                  WebComp_Componentwc_usuario.componentprepare(new Object[] {(string)"W0047",(string)"",(short)AV6EstadoTicketId});
                  WebComp_Componentwc_usuario.componentbind(new Object[] {(string)""});
               }
               if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Componentwc_usuario )
               {
                  context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0047"+"");
                  WebComp_Componentwc_usuario.componentdraw();
                  context.httpAjaxContext.ajax_rspEndCmp();
      ...
      protected void S142( )
      {
         /* 'LOADCOMPONENT_RESPONSABLE' Routine */
         returnInSub = false;
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "Ticket",  "Ticket",  "List",  "",  "EstadoTicketTicketWC") )
         {
            if ( StringUtil.StrCmp(Gx_mode, "INS") != 0 )
            {
               divComponentcontainer_responsable_Visible = 1;
               AssignProp("", false, divComponentcontainer_responsable_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(divComponentcontainer_responsable_Visible), 5, 0), true);
               /* Object Property */
               if ( true )
               {
                  bDynCreated_Componentwc_responsable = true;
               }
               if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Componentwc_responsable_Component), StringUtil.Lower( "EstadoTicketTicketWC")) != 0 )
               {
                  WebComp_Componentwc_responsable = getWebComponent(GetType(), "GeneXus.Programs", "estadoticketticketwc", new Object[] {context} );
                  WebComp_Componentwc_responsable.ComponentInit();
                  WebComp_Componentwc_responsable.Name = "EstadoTicketTicketWC";
                  WebComp_Componentwc_responsable_Component = "EstadoTicketTicketWC";
               }
               if ( StringUtil.Len( WebComp_Componentwc_responsable_Component) != 0 )
               {
                  WebComp_Componentwc_responsable.setjustcreated();
                  WebComp_Componentwc_responsable.componentprepare(new Object[] {(string)"W0053",(string)"",(short)AV6EstadoTicketId});
                  WebComp_Componentwc_responsable.componentbind(new Object[] {(string)""});
               }
               if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Componentwc_responsable )
               {
                  context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0053"+"");
                  WebComp_Componentwc_responsable.componentdraw();
                  context.httpAjaxContext.ajax_rspEndCmp();
      ...
      protected void E132D2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV21GE_EntityManagerName)) || ( StringUtil.StrCmp(StringUtil.Lower( StringUtil.Trim( AV21GE_EntityManagerName)), StringUtil.Lower( StringUtil.Trim( AV27Pgmname))) == 0 ) )
         {
            ...
            else if ( StringUtil.StrCmp(AV22GE_ComponentName, "Usuario") == 0 )
            {
               /* Execute user subroutine: 'LOADCOMPONENT_USUARIO' */
               S132 ();
               if (returnInSub) return;
            }
            else if ( StringUtil.StrCmp(AV22GE_ComponentName, "Responsable") == 0 )
            {
               /* Execute user subroutine: 'LOADCOMPONENT_RESPONSABLE' */
               S142 ();
               if (returnInSub) return;
      ...
      protected void wb_table1_59_2D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_65_2D2( true) ;
         }
         else
         {
            wb_table2_65_2D2( false) ;
         }
         return  ;
      }

      protected void wb_table2_65_2D2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0079"+"", StringUtil.RTrim( WebComp_Popupcomponent_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            wb_table1_59_2D2e( true) ;
         }
         else
         {
            wb_table1_59_2D2e( false) ;
         }
      }

      protected void wb_table2_65_2D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblComponenttitle_Internalname, lblComponenttitle_Caption, "", "", lblComponenttitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "PopupTitle", 0, "", 1, 1, 0, 0, "HLP_EntityManagerEstadoTicket.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table3_70_2D2( true) ;
         }
         else
         {
            wb_table3_70_2D2( false) ;
         }
         return  ;
      }

      protected void wb_table3_70_2D2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_65_2D2e( true) ;
         }
         else
         {
            wb_table2_65_2D2e( false) ;
         }
      }

      protected void wb_table3_70_2D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'CLOSEMODAL\\'."+"'", "", "PopupHeaderButton", 5, "", 1, 1, 0, 0, "HLP_EntityManagerEstadoTicket.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_70_2D2e( true) ;
         }
         else
         {
            wb_table3_70_2D2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "Gx_mode", Gx_mode);
         AV6EstadoTicketId = Convert.ToInt16(getParm(obj,1));
         AssignAttri("", false, "AV6EstadoTicketId", StringUtil.LTrimStr( (decimal)(AV6EstadoTicketId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vESTADOTICKETID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6EstadoTicketId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Componentwc_usuario == null ) )
         {
            if ( StringUtil.Len( WebComp_Componentwc_usuario_Component) != 0 )
            {
               WebComp_Componentwc_usuario.componentthemes();
            }
         }
         if ( ! ( WebComp_Componentwc_responsable == null ) )
         {
            if ( StringUtil.Len( WebComp_Componentwc_responsable_Component) != 0 )
            {
               WebComp_Componentwc_responsable.componentthemes();
            }
         }
         if ( ! ( WebComp_Popupcomponent == null ) )
         {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249525026", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("entitymanagerestadoticket.js", "?20231249525028", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divComponentcontainer_usuario_Internalname = "COMPONENTCONTAINER_USUARIO";
         divComponentcontainer_responsable_Internalname = "COMPONENTCONTAINER_RESPONSABLE";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV18AvailableComponents',fld:'vAVAILABLECOMPONENTS',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'AV20RelatedTransactionName',fld:'vRELATEDTRANSACTIONNAME',pic:'',hsh:true},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV20RelatedTransactionName',fld:'vRELATEDTRANSACTIONNAME',pic:'',hsh:true},{av:'tblTablemodal_Visible',ctrl:'TABLEMODAL',prop:'Visible'},{av:'lblComponenttitle_Caption',ctrl:'COMPONENTTITLE',prop:'Caption'},{ctrl:'POPUPCOMPONENT'},{av:'AV18AvailableComponents',fld:'vAVAILABLECOMPONENTS',pic:'',hsh:true},{ctrl:'TABSTRIP'},{av:'divComponentcontainer_general_Visible',ctrl:'COMPONENTCONTAINER_GENERAL',prop:'Visible'},{av:'divComponentcontainer_usuario_Visible',ctrl:'COMPONENTCONTAINER_USUARIO',prop:'Visible'},{av:'divComponentcontainer_responsable_Visible',ctrl:'COMPONENTCONTAINER_RESPONSABLE',prop:'Visible'},{av:'divComponentscontainer_components_Visible',ctrl:'COMPONENTSCONTAINER_COMPONENTS',prop:'Visible'},{ctrl:'COMPONENTWC_GENERAL'},{ctrl:'COMPONENTWC_USUARIO'},{ctrl:'COMPONENTWC_RESPONSABLE'}]}");
         setEventMetadata("GLOBALEVENTS.K2BT_REFRESHENTITYMANAGER","{handler:'E132D2',iparms:[{av:'AV22GE_ComponentName',fld:'vGE_COMPONENTNAME',pic:''},{av:'AV21GE_EntityManagerName',fld:'vGE_ENTITYMANAGERNAME',pic:''},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV6EstadoTicketId',fld:'vESTADOTICKETID',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("GLOBALEVENTS.K2BT_REFRESHENTITYMANAGER",",oparms:[{av:'divComponentcontainer_general_Visible',ctrl:'COMPONENTCONTAINER_GENERAL',prop:'Visible'},{ctrl:'COMPONENTWC_GENERAL'},{ctrl:'COMPONENTWC_USUARIO'},{av:'divComponentcontainer_usuario_Visible',ctrl:'COMPONENTCONTAINER_USUARIO',prop:'Visible'},{ctrl:'COMPONENTWC_RESPONSABLE'},{av:'divComponentcontainer_responsable_Visible',ctrl:'COMPONENTCONTAINER_RESPONSABLE',prop:'Visible'}]}");
         setEventMetadata("'CLOSEMODAL'","{handler:'E142D2',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         WebComp_Componentwc_usuario_Component = "";
         OldComponentwc_usuario = "";
         WebComp_Componentwc_responsable_Component = "";
         OldComponentwc_responsable = "";
         ...
         scmdbuf = "";
         H002D2_A5EstadoTicketId = new short[1] ;
         H002D2_A24EstadoTicketNombre = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.entitymanagerestadoticket__default(),
            new Object[][] {
                new Object[] {
               H002D2_A5EstadoTicketId, H002D2_A24EstadoTicketNombre
               }
            }
         );
         WebComp_Tabstrip = new GeneXus.Http.GXNullWebComponent();
         WebComp_Componentwc_general = new GeneXus.Http.GXNullWebComponent();
         WebComp_Componentwc_usuario = new GeneXus.Http.GXNullWebComponent();
         WebComp_Componentwc_responsable = new GeneXus.Http.GXNullWebComponent();
      ...
      private int divComponentcontainer_usuario_Visible ;
      private int divComponentcontainer_responsable_Visible ;
      ...
      private string divComponentcontainer_usuario_Internalname ;
      private string WebComp_Componentwc_usuario_Component ;
      private string OldComponentwc_usuario ;
      private string divComponentcontainer_responsable_Internalname ;
      private string WebComp_Componentwc_responsable_Component ;
      private string OldComponentwc_responsable ;
      ...
      private bool bDynCreated_Componentwc_usuario ;
      private bool bDynCreated_Componentwc_responsable ;
      ...
      private GXWebComponent WebComp_Componentwc_usuario ;
      private GXWebComponent WebComp_Componentwc_responsable ;
      ...
      private short[] H002D2_A5EstadoTicketId ;
      private string[] H002D2_A24EstadoTicketNombre ;
   ...
   public class entitymanagerestadoticket__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002D2", "SELECT TOP 1 [EstadoTicketId], [EstadoTicketNombre] FROM [EstadoTicket] WHERE [EstadoTicketId] = @AV6EstadoTicketId ORDER BY [EstadoTicketId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002D2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
