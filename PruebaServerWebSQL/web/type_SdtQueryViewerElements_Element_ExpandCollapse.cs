...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerElements.Element.ExpandCollapse" , Namespace="kb_ticket" )]
	[Serializable]
	...
	[GxUnWrappedJson()]
	[DataContract(Name=@"QueryViewerElements.Element.ExpandCollapse", Namespace="kb_ticket")]
