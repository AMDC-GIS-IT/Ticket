...
namespace GeneXus.Programs {
   public class ticketgeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public ticketgeneral( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)Gx_mode,(long)AV6TicketId,(string)AV8TabCode});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2023124949593", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB2S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "ticketgeneral.aspx");
            }
            /* Div Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_15_2S2( true) ;
         }
         else
         {
            wb_table1_15_2S2( false) ;
         }
         return  ;
      }

      protected void wb_table1_15_2S2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void E122S2( )
      {
         ...
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Ticket";
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Ticket";
         ...
         {
            A14TicketId = H002S2_A14TicketId[0];
            AV16GXLvl26 = 1;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Transactioncomponent_Component), StringUtil.Lower( "Ticket")) != 0 )
         {
            WebComp_Transactioncomponent = getWebComponent(GetType(), "GeneXus.Programs", "ticket", new Object[] {context} );
            WebComp_Transactioncomponent.ComponentInit();
            WebComp_Transactioncomponent.Name = "Ticket";
            WebComp_Transactioncomponent_Component = "Ticket";
         }
         if ( StringUtil.Len( WebComp_Transactioncomponent_Component) != 0 )
         {
            WebComp_Transactioncomponent.setjustcreated();
            WebComp_Transactioncomponent.componentprepare(new Object[] {(string)sPrefix+"W0029",(string)"",(string)Gx_mode,(long)AV6TicketId});
      ...
      protected void E132S2( )
      {
         /* 'DoUpdate' Routine */
         returnInSub = false;
         new k2bgettrncontextbyname(context ).execute(  "Ticket", out  AV10TrnContext) ;
         GXt_char1 = "";
         ...
         new k2bsettrncontextbyname(context ).execute(  "Ticket",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerticket.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(AV6TicketId,10,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","TicketId","TabCode"}) );
      ...
      protected void E142S2( )
      {
         ...
         AV10TrnContext.gxTpr_Returnmode = "Popup";
         new k2bsettrncontextbyname(context ).execute(  "Ticket",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerticket.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(AV6TicketId,10,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","TicketId","TabCode"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void wb_table1_15_2S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_18_2S2( true) ;
         }
         else
         {
            wb_table2_18_2S2( false) ;
         }
         return  ;
      }

      protected void wb_table2_18_2S2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_15_2S2e( true) ;
         }
         else
         {
            wb_table1_15_2S2e( false) ;
         }
      }

      protected void wb_table2_18_2S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_18_2S2e( true) ;
         }
         else
         {
            wb_table2_18_2S2e( false) ;
         }
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6TicketId = (string)((string)getParm(obj,1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "ticketgeneral", GetJustCreated( ));
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "Gx_mode", Gx_mode);
            AV6TicketId = Convert.ToInt64(getParm(obj,3));
            AssignAttri(sPrefix, false, "AV6TicketId", StringUtil.LTrimStr( (decimal)(AV6TicketId), 10, 0));
         ...
         wcpOAV6TicketId = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6TicketId"), ",", "."));
         wcpOAV8TabCode = cgiGet( sPrefix+"wcpOAV8TabCode");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(Gx_mode, wcpOGx_mode) != 0 ) || ( AV6TicketId != wcpOAV6TicketId ) || ( StringUtil.StrCmp(AV8TabCode, wcpOAV8TabCode) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOGx_mode = Gx_mode;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249495935", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("ticketgeneral.js", "?20231249495935", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A14TicketId',fld:'TICKETID',pic:'ZZZZZZZZZ9'},{av:'AV6TicketId',fld:'vTICKETID',pic:'ZZZZZZZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E132S2',iparms:[{av:'AV6TicketId',fld:'vTICKETID',pic:'ZZZZZZZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E142S2',iparms:[{av:'AV6TicketId',fld:'vTICKETID',pic:'ZZZZZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sCtrlAV6TicketId = "";
         sCtrlAV8TabCode = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.ticketgeneral__default(),
            new Object[][] {
                new Object[] {
               H002S2_A14TicketId
               }
      ...
      private long[] H002S2_A14TicketId ;
   ...
   public class ticketgeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002S2", "SELECT [TicketId] FROM [Ticket] WHERE [TicketId] = @AV6TicketId ORDER BY [TicketId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002S2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
