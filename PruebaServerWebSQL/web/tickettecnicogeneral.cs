...
namespace GeneXus.Programs {
   public class tickettecnicogeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public tickettecnicogeneral( )
      {
      ...
      public tickettecnicogeneral( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "AV6TicketTecnicoId", StringUtil.LTrimStr( (decimal)(AV6TicketTecnicoId), 10, 0));
                  AV8TabCode = GetPar( "TabCode");
                  AssignAttri(sPrefix, false, "AV8TabCode", AV8TabCode);
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)Gx_mode,(long)AV6TicketTecnicoId,(string)AV8TabCode});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249495845", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6TicketTecnicoId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6TicketTecnicoId), 10, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8TabCode", StringUtil.RTrim( wcpOAV8TabCode));
         GxWebStd.gx_hidden_field( context, sPrefix+"TICKETTECNICOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A18TicketTecnicoId), 10, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTICKETTECNICOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6TicketTecnicoId), 10, 0, ",", "")));
      ...
      protected void WB2W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "tickettecnicogeneral.aspx");
            }
            /* Div Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_15_2W2( true) ;
         }
         else
         {
            wb_table1_15_2W2( false) ;
         }
         return  ;
      }

      protected void wb_table1_15_2W2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void STRUP2W0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6TicketTecnicoId = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6TicketTecnicoId"), ",", "."));
      ...
      protected void E122W2( )
      {
         ...
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "TicketTecnico";
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "TicketTecnico";
         ...
         {
            A18TicketTecnicoId = H002W2_A18TicketTecnicoId[0];
            AV16GXLvl26 = 1;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Transactioncomponent_Component), StringUtil.Lower( "TicketTecnico")) != 0 )
         {
            WebComp_Transactioncomponent = getWebComponent(GetType(), "GeneXus.Programs", "tickettecnico", new Object[] {context} );
            WebComp_Transactioncomponent.ComponentInit();
            WebComp_Transactioncomponent.Name = "TicketTecnico";
            WebComp_Transactioncomponent_Component = "TicketTecnico";
         }
         if ( StringUtil.Len( WebComp_Transactioncomponent_Component) != 0 )
         {
            WebComp_Transactioncomponent.setjustcreated();
            WebComp_Transactioncomponent.componentprepare(new Object[] {(string)sPrefix+"W0029",(string)"",(string)Gx_mode,(long)AV6TicketTecnicoId});
      ...
      protected void E132W2( )
      {
         /* 'DoUpdate' Routine */
         returnInSub = false;
         new k2bgettrncontextbyname(context ).execute(  "TicketTecnico", out  AV10TrnContext) ;
         GXt_char1 = "";
         ...
         new k2bsettrncontextbyname(context ).execute(  "TicketTecnico",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagertickettecnico.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(AV6TicketTecnicoId,10,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","TicketTecnicoId","TabCode"}) );
      ...
      protected void E142W2( )
      {
         ...
         AV10TrnContext.gxTpr_Returnmode = "Popup";
         new k2bsettrncontextbyname(context ).execute(  "TicketTecnico",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagertickettecnico.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(AV6TicketTecnicoId,10,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","TicketTecnicoId","TabCode"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void wb_table1_15_2W2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_18_2W2( true) ;
         }
         else
         {
            wb_table2_18_2W2( false) ;
         }
         return  ;
      }

      protected void wb_table2_18_2W2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_15_2W2e( true) ;
         }
         else
         {
            wb_table1_15_2W2e( false) ;
         }
      }

      protected void wb_table2_18_2W2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_18_2W2e( true) ;
         }
         else
         {
            wb_table2_18_2W2e( false) ;
         }
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6TicketTecnicoId = (string)((string)getParm(obj,1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "tickettecnicogeneral", GetJustCreated( ));
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "Gx_mode", Gx_mode);
            AV6TicketTecnicoId = Convert.ToInt64(getParm(obj,3));
            AssignAttri(sPrefix, false, "AV6TicketTecnicoId", StringUtil.LTrimStr( (decimal)(AV6TicketTecnicoId), 10, 0));
         ...
         wcpOAV6TicketTecnicoId = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6TicketTecnicoId"), ",", "."));
         wcpOAV8TabCode = cgiGet( sPrefix+"wcpOAV8TabCode");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(Gx_mode, wcpOGx_mode) != 0 ) || ( AV6TicketTecnicoId != wcpOAV6TicketTecnicoId ) || ( StringUtil.StrCmp(AV8TabCode, wcpOAV8TabCode) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOGx_mode = Gx_mode;
         wcpOAV6TicketTecnicoId = AV6TicketTecnicoId;
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV6TicketTecnicoId = cgiGet( sPrefix+"AV6TicketTecnicoId_CTRL");
         if ( StringUtil.Len( sCtrlAV6TicketTecnicoId) > 0 )
         {
            AV6TicketTecnicoId = (long)(context.localUtil.CToN( cgiGet( sCtrlAV6TicketTecnicoId), ",", "."));
            AssignAttri(sPrefix, false, "AV6TicketTecnicoId", StringUtil.LTrimStr( (decimal)(AV6TicketTecnicoId), 10, 0));
         }
         else
         {
            AV6TicketTecnicoId = (long)(context.localUtil.CToN( cgiGet( sPrefix+"AV6TicketTecnicoId_PARM"), ",", "."));
         }
      ...
      protected void WCParametersSet( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6TicketTecnicoId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6TicketTecnicoId), 10, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6TicketTecnicoId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6TicketTecnicoId_CTRL", StringUtil.RTrim( sCtrlAV6TicketTecnicoId));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249495877", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("tickettecnicogeneral.js", "?20231249495877", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A18TicketTecnicoId',fld:'TICKETTECNICOID',pic:'ZZZZZZZZZ9'},{av:'AV6TicketTecnicoId',fld:'vTICKETTECNICOID',pic:'ZZZZZZZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E132W2',iparms:[{av:'AV6TicketTecnicoId',fld:'vTICKETTECNICOID',pic:'ZZZZZZZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E142W2',iparms:[{av:'AV6TicketTecnicoId',fld:'vTICKETTECNICOID',pic:'ZZZZZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV12ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         scmdbuf = "";
         H002W2_A18TicketTecnicoId = new long[1] ;
         ...
         sCtrlGx_mode = "";
         sCtrlAV6TicketTecnicoId = "";
         sCtrlAV8TabCode = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tickettecnicogeneral__default(),
            new Object[][] {
                new Object[] {
               H002W2_A18TicketTecnicoId
               }
            }
         );
      ...
      private string sCtrlAV6TicketTecnicoId ;
      ...
      private long[] H002W2_A18TicketTecnicoId ;
   ...
   public class tickettecnicogeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002W2", "SELECT [TicketTecnicoId] FROM [TicketTecnico] WHERE [TicketTecnicoId] = @AV6TicketTecnicoId ORDER BY [TicketTecnicoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002W2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
