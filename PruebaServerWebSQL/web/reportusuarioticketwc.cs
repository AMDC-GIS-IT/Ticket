...
namespace GeneXus.Programs {
   public class reportusuarioticketwc : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV9UsuarioId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "Ticket",  "Ticket",  "List",  "",  AV41Pgmname) )
            {
               H3L0( false, 30) ;
            ...
            else
            {
               ...
               getPrinter().GxDrawText("Router", 609, Gx_line+7, 654, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Operativo", 662, Gx_line+7, 729, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Office", 737, Gx_line+7, 782, Gx_line+22, 0, 0, 0, 1) ;
               Gx_OldLine = Gx_line;
               Gx_line = (int)(Gx_line+30);
               GxHdr3 = true;
               ...
               while ( (pr_default.getStatus(0) != 101) )
               {
                  ...
                  A59TicketRouter = P003L2_A59TicketRouter[0];
                  ...
                  AV31Grid_TicketRouter = (A59TicketRouter ? "Si" : "No");
                  ...
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV31Grid_TicketRouter, "")), 609, Gx_line+7, 654, Gx_line+23, 0, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV35Grid_TicketSistemaOperativo, "")), 662, Gx_line+7, 729, Gx_line+23, 0, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV36Grid_TicketOffice, "")), 737, Gx_line+7, 782, Gx_line+23, 0, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
      ...
      public override void initialize( )
      {
         ...
         P003L2_A15UsuarioId = new short[1] ;
         ...
         P003L2_A59TicketRouter = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportusuarioticketwc__default(),
            new Object[][] {
                new Object[] {
               P003L2_A15UsuarioId, P003L2_A54TicketLastId, P003L2_A14TicketId, P003L2_A48TicketHora, P003L2_A46TicketFecha, P003L2_A53TicketLaptop, P003L2_A42TicketDesktop, P003L2_A55TicketMonitor, P003L2_A50TicketImpresora, P003L2_A45TicketEscaner,
               P003L2_A59TicketRouter, P003L2_A60TicketSistemaOperativo, P003L2_A56TicketOffice
               }
            }
         );
         AV41Pgmname = "ReportUsuarioTicketWC";
      ...
      private string AV31Grid_TicketRouter ;
      ...
      private short[] P003L2_A15UsuarioId ;
      ...
      private bool[] P003L2_A59TicketRouter ;
   ...
   public class reportusuarioticketwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A15UsuarioId )
      {
         ...
         scmdbuf = "SELECT [UsuarioId], [TicketLastId], [TicketId], [TicketHora], [TicketFecha], [TicketLaptop], [TicketDesktop], [TicketMonitor], [TicketImpresora], [TicketEscaner], [TicketRouter], [TicketSistemaOperativo], [TicketOffice] FROM [Ticket]";
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV9UsuarioId",GXType.Int16,4,0) ,
