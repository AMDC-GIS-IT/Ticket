...
namespace GeneXus.Programs {
   public class wwticket : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV58K2BToolsGenericSearchField, AV48TicketFecha_From, AV51TicketHora_From, AV52TicketHora_To, AV53UsuarioNombre, AV74EstadoTicketTicketNombre, AV46ClassCollection, AV59OrderedBy, AV49TicketFecha_To, AV78Pgmname, AV8CurrentPage, AV10GridConfiguration, AV71AutoLinksActivityList, AV65TicketFecha_IsAuthorized, AV14Att_TicketId_Visible, AV15Att_TicketFecha_Visible, AV16Att_TicketHora_Visible, AV17Att_UsuarioNombre_Visible, AV18Att_UsuarioRequerimiento_Visible, AV75Att_EstadoTicketTicketNombre_Visible, AV11FreezeColumnTitles) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249525940", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV73Update)) ? AV80Update_GXI : context.convertURL( context.PathToRelativeUrl( AV73Update))), !bGXsfl_172_Refreshing);
      ...
      protected void STRUP2R0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.CToD( cgiGet( "GXH_vTICKETFECHA_FROM"), 2) != AV48TicketFecha_From )
            {
               GRID_nFirstRecordOnPage = 0;
            }
      ...
      protected void E222R2( )
      {
         ...
         AssignAttri("", false, "AV52TicketHora_To", context.localUtil.TToC( AV52TicketHora_To, 0, 5, 0, 3, "/", ":", " "));
         new k2bloadrowsperpage(context ).execute(  AV78Pgmname,  "Grid", out  AV41RowsPerPageVariable, out  AV42RowsPerPageLoaded) ;
      ...
      protected void E232R2( )
      {
         ...
         AV79GXV1 = 1;
         while ( AV79GXV1 <= AV63Messages.Count )
         {
            AV64Message = ((GeneXus.Utils.SdtMessages_Message)AV63Messages.Item(AV79GXV1));
         ...
         AV72ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV78Pgmname;
         ...
         AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV73Update)) ? AV80Update_GXI : context.convertURL( context.PathToRelativeUrl( AV73Update))), !bGXsfl_172_Refreshing);
         AssignProp("", false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV73Update), true);
         AV80Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "788f9b72-f982-49f9-99e4-c0374e31a85a", "", context.GetTheme( )));
         AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV73Update)) ? AV80Update_GXI : context.convertURL( context.PathToRelativeUrl( AV73Update))), !bGXsfl_172_Refreshing);
         AssignProp("", false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV73Update), true);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV43GridStateKey = "";
         new k2bloadgridstate(context ).execute(  AV78Pgmname,  AV43GridStateKey, out  AV44GridState) ;
         ...
         AV81GXV2 = 1;
         while ( AV81GXV2 <= AV44GridState.gxTpr_Filtervalues.Count )
         {
            AV45GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV44GridState.gxTpr_Filtervalues.Item(AV81GXV2));
      ...
      protected void S132( )
      {
         ...
         AV44GridState.gxTpr_Filtervalues.Add(AV45GridStateFilterValue, 0);
         new k2bsavegridstate(context ).execute(  AV78Pgmname,  AV43GridStateKey,  AV44GridState) ;
      }
      ...
      protected void E142R2( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         CallWebObject(formatLink("exportwwticket.aspx", new object[] {UrlEncode(DateTimeUtil.FormatDateParm(AV48TicketFecha_From)),UrlEncode(DateTimeUtil.FormatDateParm(AV49TicketFecha_To)),UrlEncode(DateTimeUtil.FormatDateTimeParm(AV51TicketHora_From)),UrlEncode(DateTimeUtil.FormatDateTimeParm(AV52TicketHora_To)),UrlEncode(StringUtil.RTrim(AV53UsuarioNombre)),UrlEncode(StringUtil.RTrim(AV74EstadoTicketTicketNombre)),UrlEncode(StringUtil.RTrim(AV58K2BToolsGenericSearchField)),UrlEncode(StringUtil.LTrimStr(AV59OrderedBy,4,0))}, new string[] {"TicketFecha_From","TicketFecha_To","TicketHora_From","TicketHora_To","UsuarioNombre","EstadoTicketTicketNombre","K2BToolsGenericSearchField","OrderedBy"}) );
      ...
      protected void S202( )
      {
         ...
         AssignAttri("", false, "AV75Att_EstadoTicketTicketNombre_Visible", AV75Att_EstadoTicketTicketNombre_Visible);
         new k2bsavegridconfiguration(context ).execute(  AV78Pgmname,  "Grid",  AV10GridConfiguration,  false) ;
         AV82GXV3 = 1;
      ...
      protected void S122( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV74EstadoTicketTicketNombre)) )
         {
            ...
            AV55K2BFilterValuesSDTItem.gxTpr_Description = "Estado Ticket";
            AV55K2BFilterValuesSDTItem.gxTpr_Type = "Standard";
         ...
         if ( AV54K2BFilterValuesSDT.Count > 0 )
         {
            ...
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV78Pgmname,  "Grid",  AV54K2BFilterValuesSDT, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item4) ;
      ...
      protected void E152R2( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  AV78Pgmname,  "Grid", ref  AV10GridConfiguration) ;
         AV83GXV4 = 1;
         ...
         new k2bsavegridconfiguration(context ).execute(  AV78Pgmname,  "Grid",  AV10GridConfiguration,  true) ;
         AV62UC_OrderedBy = AV59OrderedBy;
         AssignAttri("", false, "AV62UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV62UC_OrderedBy), 4, 0));
         if ( AV41RowsPerPageVariable != AV40GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV41RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV78Pgmname,  "Grid",  AV41RowsPerPageVariable) ;
            AV8CurrentPage = 1;
            AssignAttri("", false, "AV8CurrentPage", StringUtil.LTrimStr( (decimal)(AV8CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023124953558", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwticket.js", "?2023124953558", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/K2BDateRangePickerRender.js", "", false, true);
      ...
      protected void sendrow_1722( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_172_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV73Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV73Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV80Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV73Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV73Update)) ? AV80Update_GXI : context.PathToRelativeUrl( AV73Update));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOEXPORT'","{handler:'E142R2',iparms:[{av:'AV48TicketFecha_From',fld:'vTICKETFECHA_FROM',pic:''},{av:'AV49TicketFecha_To',fld:'vTICKETFECHA_TO',pic:''},{av:'AV51TicketHora_From',fld:'vTICKETHORA_FROM',pic:'99:99'},{av:'AV52TicketHora_To',fld:'vTICKETHORA_TO',pic:'99:99'},{av:'AV53UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV74EstadoTicketTicketNombre',fld:'vESTADOTICKETTICKETNOMBRE',pic:''},{av:'AV58K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV59OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV15Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV17Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV18Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV75Att_EstadoTicketTicketNombre_Visible',fld:'vATT_ESTADOTICKETTICKETNOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOEXPORT'",",oparms:[{av:'AV59OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV15Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV17Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV18Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV75Att_EstadoTicketTicketNombre_Visible',fld:'vATT_ESTADOTICKETTICKETNOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E252R2',iparms:[{av:'AV71AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZ9'},{av:'A187EstadoTicketTicketId',fld:'ESTADOTICKETTICKETID',pic:'ZZZ9'},{av:'AV65TicketFecha_IsAuthorized',fld:'vTICKETFECHA_ISAUTHORIZED',pic:''},{av:'A14TicketId',fld:'TICKETID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV14Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV15Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV17Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV18Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV75Att_EstadoTicketTicketNombre_Visible',fld:'vATT_ESTADOTICKETTICKETNOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E122R2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV58K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV48TicketFecha_From',fld:'vTICKETFECHA_FROM',pic:''},{av:'AV51TicketHora_From',fld:'vTICKETHORA_FROM',pic:'99:99'},{av:'AV52TicketHora_To',fld:'vTICKETHORA_TO',pic:'99:99'},{av:'AV53UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV74EstadoTicketTicketNombre',fld:'vESTADOTICKETTICKETNOMBRE',pic:''},{av:'AV46ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV59OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV49TicketFecha_To',fld:'vTICKETFECHA_TO',pic:''},{av:'AV78Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV71AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV65TicketFecha_IsAuthorized',fld:'vTICKETFECHA_ISAUTHORIZED',pic:''},{av:'AV62UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV15Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV17Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV18Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV75Att_EstadoTicketTicketNombre_Visible',fld:'vATT_ESTADOTICKETTICKETNOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E152R2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV58K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV48TicketFecha_From',fld:'vTICKETFECHA_FROM',pic:''},{av:'AV51TicketHora_From',fld:'vTICKETHORA_FROM',pic:'99:99'},{av:'AV52TicketHora_To',fld:'vTICKETHORA_TO',pic:'99:99'},{av:'AV53UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV74EstadoTicketTicketNombre',fld:'vESTADOTICKETTICKETNOMBRE',pic:''},{av:'AV46ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV59OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV49TicketFecha_To',fld:'vTICKETFECHA_TO',pic:''},{av:'AV78Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV71AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV65TicketFecha_IsAuthorized',fld:'vTICKETFECHA_ISAUTHORIZED',pic:''},{av:'AV41RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV40GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV15Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV17Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV18Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV75Att_EstadoTicketTicketNombre_Visible',fld:'vATT_ESTADOTICKETTICKETNOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E162R2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV58K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV48TicketFecha_From',fld:'vTICKETFECHA_FROM',pic:''},{av:'AV51TicketHora_From',fld:'vTICKETHORA_FROM',pic:'99:99'},{av:'AV52TicketHora_To',fld:'vTICKETHORA_TO',pic:'99:99'},{av:'AV53UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV74EstadoTicketTicketNombre',fld:'vESTADOTICKETTICKETNOMBRE',pic:''},{av:'AV46ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV59OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV49TicketFecha_To',fld:'vTICKETFECHA_TO',pic:''},{av:'AV78Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV71AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV65TicketFecha_IsAuthorized',fld:'vTICKETFECHA_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV15Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV17Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV18Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV75Att_EstadoTicketTicketNombre_Visible',fld:'vATT_ESTADOTICKETTICKETNOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E172R2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV58K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV48TicketFecha_From',fld:'vTICKETFECHA_FROM',pic:''},{av:'AV51TicketHora_From',fld:'vTICKETHORA_FROM',pic:'99:99'},{av:'AV52TicketHora_To',fld:'vTICKETHORA_TO',pic:'99:99'},{av:'AV53UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV74EstadoTicketTicketNombre',fld:'vESTADOTICKETTICKETNOMBRE',pic:''},{av:'AV46ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV59OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV49TicketFecha_To',fld:'vTICKETFECHA_TO',pic:''},{av:'AV78Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV71AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV65TicketFecha_IsAuthorized',fld:'vTICKETFECHA_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV15Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV17Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV18Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV75Att_EstadoTicketTicketNombre_Visible',fld:'vATT_ESTADOTICKETTICKETNOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E182R2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV58K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV48TicketFecha_From',fld:'vTICKETFECHA_FROM',pic:''},{av:'AV51TicketHora_From',fld:'vTICKETHORA_FROM',pic:'99:99'},{av:'AV52TicketHora_To',fld:'vTICKETHORA_TO',pic:'99:99'},{av:'AV53UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV74EstadoTicketTicketNombre',fld:'vESTADOTICKETTICKETNOMBRE',pic:''},{av:'AV46ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV59OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV49TicketFecha_To',fld:'vTICKETFECHA_TO',pic:''},{av:'AV78Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV71AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV65TicketFecha_IsAuthorized',fld:'vTICKETFECHA_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV15Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV17Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV18Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV75Att_EstadoTicketTicketNombre_Visible',fld:'vATT_ESTADOTICKETTICKETNOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E192R2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV58K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV48TicketFecha_From',fld:'vTICKETFECHA_FROM',pic:''},{av:'AV51TicketHora_From',fld:'vTICKETHORA_FROM',pic:'99:99'},{av:'AV52TicketHora_To',fld:'vTICKETHORA_TO',pic:'99:99'},{av:'AV53UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV74EstadoTicketTicketNombre',fld:'vESTADOTICKETTICKETNOMBRE',pic:''},{av:'AV46ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV59OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV49TicketFecha_To',fld:'vTICKETFECHA_TO',pic:''},{av:'AV78Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV71AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV65TicketFecha_IsAuthorized',fld:'vTICKETFECHA_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_TicketId_Visible',fld:'vATT_TICKETID_VISIBLE',pic:''},{av:'AV15Att_TicketFecha_Visible',fld:'vATT_TICKETFECHA_VISIBLE',pic:''},{av:'AV16Att_TicketHora_Visible',fld:'vATT_TICKETHORA_VISIBLE',pic:''},{av:'AV17Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV18Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV75Att_EstadoTicketTicketNombre_Visible',fld:'vATT_ESTADOTICKETTICKETNOMBRE_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         H002R2_A15UsuarioId = new short[1] ;
         ...
         AV61GridOrder = new SdtK2BGridOrders_K2BGridOrdersItem(context);
         AV63Messages = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwticket__default(),
            new Object[][] {
                new Object[] {
               H002R2_A187EstadoTicketTicketId, H002R2_A57TicketOtros, H002R2_A52TicketInstalarDataShow, H002R2_A41TicketApoyoUsuario, H002R2_A87TicketUps, H002R2_A58TicketPerifericos, H002R2_A43TicketDiscoDuroExterno, H002R2_A51TicketIngenieria, H002R2_A44TicketDisenio, H002R2_A40TicketAplicacion,
               H002R2_A39TicketAntivirus, H002R2_A56TicketOffice, H002R2_A60TicketSistemaOperativo, H002R2_A59TicketRouter, H002R2_A45TicketEscaner, H002R2_A50TicketImpresora, H002R2_A55TicketMonitor, H002R2_A42TicketDesktop, H002R2_A53TicketLaptop, H002R2_A54TicketLastId,
               H002R2_A15UsuarioId, H002R2_A188EstadoTicketTicketNombre, H002R2_A94UsuarioRequerimiento, H002R2_A93UsuarioNombre, H002R2_A48TicketHora, H002R2_A46TicketFecha, H002R2_A14TicketId
               }
               , new Object[] {
      ...
      private short[] H002R2_A15UsuarioId ;
      ...
      private GXBaseCollection<SdtMessages_Message> AV63Messages ;
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((DateTime[]) buf[25])[0] = rslt.getGXDate(26);
