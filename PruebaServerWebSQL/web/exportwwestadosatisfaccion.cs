...
namespace GeneXus.Programs {
   public class exportwwestadosatisfaccion : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      void executePrivate( )
      {
         ...
         if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "EstadoSatisfaccion",  "EstadoSatisfaccion",  "List",  "",  "WWEstadoSatisfaccion") )
         {
            AV19Filename = "";
            AV20ErrorMessage = "You are not authorized to do activity";
            AV20ErrorMessage += "EntityName:" + "EstadoSatisfaccion";
            AV20ErrorMessage += "TransactionName:" + "EstadoSatisfaccion";
         ...
         AV19Filename = GxDirectory.TemporaryFilesPath + AV22File.Separator + "ExportWWEstadoSatisfaccion-" + StringUtil.Trim( StringUtil.Str( (decimal)(AV17Random), 8, 0)) + ".xlsx";
         ...
         if ( ! context.isAjaxRequest( ) )
         {
            AV21HttpResponse.AppendHeader("Content-Disposition", "attachment;filename=ExportWWEstadoSatisfaccion.xlsx");
         }
         if ( ! context.isAjaxRequest( ) )
         {
      ...
      public override void initialize( )
      {
         ...
         AV29Pgmname = "ExportWWEstadoSatisfaccion";
         /* GeneXus formulas. */
         AV29Pgmname = "ExportWWEstadoSatisfaccion";
         context.Gx_err = 0;
      }
