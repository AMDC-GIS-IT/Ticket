...
namespace GeneXus.Programs {
   public class entitymanagerusuario : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public entitymanagerusuario( )
      {
      ...
      public entitymanagerusuario( IGxContext context )
      {
                           ...
                           string aP2_TabCode )
      {
         ...
         this.AV6UsuarioId = aP1_UsuarioId;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249524786", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("entitymanagerusuario.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6UsuarioId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Gx_mode","UsuarioId","TabCode"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vMODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( Gx_mode, "@!")), context));
         GxWebStd.gx_hidden_field( context, "vUSUARIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6UsuarioId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6UsuarioId), "ZZZ9"), context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Componentwc_ticket == null ) )
         {
            WebComp_Componentwc_ticket.componentjscripts();
         }
      ...
      {
         return formatLink("entitymanagerusuario.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6UsuarioId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Gx_mode","UsuarioId","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "EntityManagerUsuario" ;
      }
      ...
      protected void WB2I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblK2bpgmdesc_Internalname, lblK2bpgmdesc_Caption, "", "", lblK2bpgmdesc_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_EntityManagerUsuario.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblBacktoworkwith_Internalname, lblBacktoworkwith_Caption, lblBacktoworkwith_Link, "", lblBacktoworkwith_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_BackToWorkWith", 0, "", 1, 1, 0, 0, "HLP_EntityManagerUsuario.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divComponentcontainer_ticket_Internalname, divComponentcontainer_ticket_Visible, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0047"+"", StringUtil.RTrim( WebComp_Componentwc_ticket_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0047"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Componentwc_ticket_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldComponentwc_ticket), StringUtil.Lower( WebComp_Componentwc_ticket_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0047"+"");
                  }
                  WebComp_Componentwc_ticket.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldComponentwc_ticket), StringUtil.Lower( WebComp_Componentwc_ticket_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_53_2I2( true) ;
         }
         else
         {
            wb_table1_53_2I2( false) ;
         }
         return  ;
      }

      protected void wb_table1_53_2I2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldComponentwc_ticket = cgiGet( "W0047");
                           if ( ( StringUtil.Len( OldComponentwc_ticket) == 0 ) || ( StringUtil.StrCmp(OldComponentwc_ticket, WebComp_Componentwc_ticket_Component) != 0 ) )
                           {
                              WebComp_Componentwc_ticket = getWebComponent(GetType(), "GeneXus.Programs", OldComponentwc_ticket, new Object[] {context} );
                              WebComp_Componentwc_ticket.ComponentInit();
                              WebComp_Componentwc_ticket.Name = "OldComponentwc_ticket";
                              WebComp_Componentwc_ticket_Component = OldComponentwc_ticket;
                           }
                           if ( StringUtil.Len( WebComp_Componentwc_ticket_Component) != 0 )
                           {
                              WebComp_Componentwc_ticket.componentprocess("W0047", "", sEvt);
                           }
                           WebComp_Componentwc_ticket_Component = OldComponentwc_ticket;
                        }
                        else if ( nCmpId == 73 )
      ...
      {
         /* GeneXus formulas. */
         AV27Pgmname = "EntityManagerUsuario";
         context.Gx_err = 0;
      }
      ...
      protected void RF2I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Componentwc_ticket_Component) != 0 )
               {
                  WebComp_Componentwc_ticket.componentstart();
               }
            }
         }
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
      ...
      protected void E112I2( )
      {
         /* Start Routine */
         returnInSub = false;
         lblBacktoworkwith_Caption = StringUtil.Format( "%1", "Usuarios", "", "", "", "", "", "", "", "");
         AssignProp("", false, lblBacktoworkwith_Internalname, "Caption", lblBacktoworkwith_Caption, true);
         lblBacktoworkwith_Link = formatLink("wwusuario.aspx") ;
         AssignProp("", false, lblBacktoworkwith_Internalname, "Link", lblBacktoworkwith_Link, true);
         AV26GXLvl7 = 0;
         /* Using cursor H002I2 */
         pr_default.execute(0, new Object[] {AV6UsuarioId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A15UsuarioId = H002I2_A15UsuarioId[0];
            A93UsuarioNombre = H002I2_A93UsuarioNombre[0];
            AV26GXLvl7 = 1;
            Form.Caption = A93UsuarioNombre;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblK2bpgmdesc_Caption = StringUtil.Format( "%1 - %2", "Usuario", A93UsuarioNombre, "", "", "", "", "", "", "");
      ...
      protected void E122I2( )
      {
         ...
         else if ( StringUtil.StrCmp(AV8TabCode, "Ticket") == 0 )
         {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               lblComponenttitle_Caption = StringUtil.Format( "Actualizar %1", "Usuario", "", "", "", "", "", "", "", "");
               ...
               if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Popupcomponent_Component), StringUtil.Lower( "Usuario")) != 0 )
               {
                  WebComp_Popupcomponent = getWebComponent(GetType(), "GeneXus.Programs", "usuario", new Object[] {context} );
                  WebComp_Popupcomponent.ComponentInit();
                  WebComp_Popupcomponent.Name = "Usuario";
                  WebComp_Popupcomponent_Component = "Usuario";
               }
               if ( StringUtil.Len( WebComp_Popupcomponent_Component) != 0 )
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0073",(string)"",(string)"UPD",(short)AV6UsuarioId});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
         {
            if ( ( StringUtil.StrCmp(AV8TabCode, "General") == 0 ) || String.IsNullOrEmpty(StringUtil.RTrim( AV8TabCode)) )
            {
               lblComponenttitle_Caption = StringUtil.Format( "Eliminar %1", "Usuario", "", "", "", "", "", "", "", "");
               AssignProp("", false, lblComponenttitle_Internalname, "Caption", lblComponenttitle_Caption, true);
               tblTablemodal_Visible = 1;
               AssignProp("", false, tblTablemodal_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(tblTablemodal_Visible), 5, 0), true);
               /* Object Property */
               ...
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0073",(string)"",(string)"DLT",(short)AV6UsuarioId});
                  WebComp_Popupcomponent.componentbind(new Object[] {(string)"",(string)""});
               }
               if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Popupcomponent )
               {
      ...
      protected void S112( )
      {
         ...
         AV11Tab.gxTpr_Link = formatLink("entitymanagerusuario.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6UsuarioId,4,0)),UrlEncode(StringUtil.RTrim(AV11Tab.gxTpr_Code))}, new string[] {"Mode","UsuarioId","TabCode"}) ;
         ...
         {
            AV18AvailableComponents.Add("Ticket", 0);
            AV11Tab = new SdtK2BTabOptions_K2BTabOptionsItem(context);
            AV11Tab.gxTpr_Code = "Ticket";
         ...
         if ( AV10Tabs.Count > 0 )
         {
            ...
            divComponentcontainer_ticket_Visible = 0;
            AssignProp("", false, divComponentcontainer_ticket_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(divComponentcontainer_ticket_Visible), 5, 0), true);
            ...
            else if ( ( StringUtil.StrCmp(AV8TabCode, "Ticket") == 0 ) || ( String.IsNullOrEmpty(StringUtil.RTrim( AV8TabCode)) && ( StringUtil.StrCmp(((SdtK2BTabOptions_K2BTabOptionsItem)AV10Tabs.Item(1)).gxTpr_Code, "Ticket") == 0 ) ) )
            {
               /* Execute user subroutine: 'LOADCOMPONENT_TICKET' */
               S132 ();
               if (returnInSub) return;
            }
            else
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Componentwc_general_Component), StringUtil.Lower( "UsuarioGeneral")) != 0 )
            {
               WebComp_Componentwc_general = getWebComponent(GetType(), "GeneXus.Programs", "usuariogeneral", new Object[] {context} );
               WebComp_Componentwc_general.ComponentInit();
               WebComp_Componentwc_general.Name = "UsuarioGeneral";
               WebComp_Componentwc_general_Component = "UsuarioGeneral";
            }
            if ( StringUtil.Len( WebComp_Componentwc_general_Component) != 0 )
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0041",(string)"",(string)Gx_mode,(short)AV6UsuarioId,(string)AV8TabCode});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0041",(string)"",(string)"DSP",(short)AV6UsuarioId,(string)AV8TabCode});
               WebComp_Componentwc_general.componentbind(new Object[] {(string)"",(string)"",(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Componentwc_general )
            {
      ...
      protected void S132( )
      {
         /* 'LOADCOMPONENT_TICKET' Routine */
         returnInSub = false;
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "Ticket",  "Ticket",  "List",  "",  "UsuarioTicketWC") )
         {
            if ( StringUtil.StrCmp(Gx_mode, "INS") != 0 )
            {
               divComponentcontainer_ticket_Visible = 1;
               AssignProp("", false, divComponentcontainer_ticket_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(divComponentcontainer_ticket_Visible), 5, 0), true);
               /* Object Property */
               if ( true )
               {
                  bDynCreated_Componentwc_ticket = true;
               }
               if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Componentwc_ticket_Component), StringUtil.Lower( "UsuarioTicketWC")) != 0 )
               {
                  WebComp_Componentwc_ticket = getWebComponent(GetType(), "GeneXus.Programs", "usuarioticketwc", new Object[] {context} );
                  WebComp_Componentwc_ticket.ComponentInit();
                  WebComp_Componentwc_ticket.Name = "UsuarioTicketWC";
                  WebComp_Componentwc_ticket_Component = "UsuarioTicketWC";
               }
               if ( StringUtil.Len( WebComp_Componentwc_ticket_Component) != 0 )
               {
                  WebComp_Componentwc_ticket.setjustcreated();
                  WebComp_Componentwc_ticket.componentprepare(new Object[] {(string)"W0047",(string)"",(short)AV6UsuarioId});
                  WebComp_Componentwc_ticket.componentbind(new Object[] {(string)""});
               }
               if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Componentwc_ticket )
               {
                  context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0047"+"");
                  WebComp_Componentwc_ticket.componentdraw();
                  context.httpAjaxContext.ajax_rspEndCmp();
      ...
      protected void E132I2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV21GE_EntityManagerName)) || ( StringUtil.StrCmp(StringUtil.Lower( StringUtil.Trim( AV21GE_EntityManagerName)), StringUtil.Lower( StringUtil.Trim( AV27Pgmname))) == 0 ) )
         {
            ...
            else if ( StringUtil.StrCmp(AV22GE_ComponentName, "Ticket") == 0 )
            {
               /* Execute user subroutine: 'LOADCOMPONENT_TICKET' */
               S132 ();
               if (returnInSub) return;
      ...
      protected void wb_table1_53_2I2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_59_2I2( true) ;
         }
         else
         {
            wb_table2_59_2I2( false) ;
         }
         return  ;
      }

      protected void wb_table2_59_2I2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            wb_table1_53_2I2e( true) ;
         }
         else
         {
            wb_table1_53_2I2e( false) ;
         }
      }

      protected void wb_table2_59_2I2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblComponenttitle_Internalname, lblComponenttitle_Caption, "", "", lblComponenttitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "PopupTitle", 0, "", 1, 1, 0, 0, "HLP_EntityManagerUsuario.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table3_64_2I2( true) ;
         }
         else
         {
            wb_table3_64_2I2( false) ;
         }
         return  ;
      }

      protected void wb_table3_64_2I2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_59_2I2e( true) ;
         }
         else
         {
            wb_table2_59_2I2e( false) ;
         }
      }

      protected void wb_table3_64_2I2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'CLOSEMODAL\\'."+"'", "", "PopupHeaderButton", 5, "", 1, 1, 0, 0, "HLP_EntityManagerUsuario.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_64_2I2e( true) ;
         }
         else
         {
            wb_table3_64_2I2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "Gx_mode", Gx_mode);
         AV6UsuarioId = Convert.ToInt16(getParm(obj,1));
         AssignAttri("", false, "AV6UsuarioId", StringUtil.LTrimStr( (decimal)(AV6UsuarioId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6UsuarioId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Componentwc_ticket == null ) )
         {
            if ( StringUtil.Len( WebComp_Componentwc_ticket_Component) != 0 )
            {
               WebComp_Componentwc_ticket.componentthemes();
            }
         }
         if ( ! ( WebComp_Popupcomponent == null ) )
         {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249524848", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("entitymanagerusuario.js", "?20231249524848", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divComponentcontainer_ticket_Internalname = "COMPONENTCONTAINER_TICKET";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV18AvailableComponents',fld:'vAVAILABLECOMPONENTS',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'AV20RelatedTransactionName',fld:'vRELATEDTRANSACTIONNAME',pic:'',hsh:true},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV6UsuarioId',fld:'vUSUARIOID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV20RelatedTransactionName',fld:'vRELATEDTRANSACTIONNAME',pic:'',hsh:true},{av:'tblTablemodal_Visible',ctrl:'TABLEMODAL',prop:'Visible'},{av:'lblComponenttitle_Caption',ctrl:'COMPONENTTITLE',prop:'Caption'},{ctrl:'POPUPCOMPONENT'},{av:'AV18AvailableComponents',fld:'vAVAILABLECOMPONENTS',pic:'',hsh:true},{ctrl:'TABSTRIP'},{av:'divComponentcontainer_general_Visible',ctrl:'COMPONENTCONTAINER_GENERAL',prop:'Visible'},{av:'divComponentcontainer_ticket_Visible',ctrl:'COMPONENTCONTAINER_TICKET',prop:'Visible'},{av:'divComponentscontainer_components_Visible',ctrl:'COMPONENTSCONTAINER_COMPONENTS',prop:'Visible'},{ctrl:'COMPONENTWC_GENERAL'},{ctrl:'COMPONENTWC_TICKET'}]}");
         setEventMetadata("GLOBALEVENTS.K2BT_REFRESHENTITYMANAGER","{handler:'E132I2',iparms:[{av:'AV22GE_ComponentName',fld:'vGE_COMPONENTNAME',pic:''},{av:'AV21GE_EntityManagerName',fld:'vGE_ENTITYMANAGERNAME',pic:''},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV6UsuarioId',fld:'vUSUARIOID',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("GLOBALEVENTS.K2BT_REFRESHENTITYMANAGER",",oparms:[{av:'divComponentcontainer_general_Visible',ctrl:'COMPONENTCONTAINER_GENERAL',prop:'Visible'},{ctrl:'COMPONENTWC_GENERAL'},{ctrl:'COMPONENTWC_TICKET'},{av:'divComponentcontainer_ticket_Visible',ctrl:'COMPONENTCONTAINER_TICKET',prop:'Visible'}]}");
         setEventMetadata("'CLOSEMODAL'","{handler:'E142I2',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         WebComp_Componentwc_ticket_Component = "";
         OldComponentwc_ticket = "";
         ...
         scmdbuf = "";
         H002I2_A15UsuarioId = new short[1] ;
         H002I2_A93UsuarioNombre = new string[] {""} ;
         A93UsuarioNombre = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.entitymanagerusuario__default(),
            new Object[][] {
                new Object[] {
               H002I2_A15UsuarioId, H002I2_A93UsuarioNombre
               }
            }
         );
         WebComp_Tabstrip = new GeneXus.Http.GXNullWebComponent();
         WebComp_Componentwc_general = new GeneXus.Http.GXNullWebComponent();
         WebComp_Componentwc_ticket = new GeneXus.Http.GXNullWebComponent();
      ...
      private int divComponentcontainer_ticket_Visible ;
      ...
      private string divComponentcontainer_ticket_Internalname ;
      private string WebComp_Componentwc_ticket_Component ;
      private string OldComponentwc_ticket ;
      ...
      private bool bDynCreated_Componentwc_ticket ;
      ...
      private GXWebComponent WebComp_Componentwc_ticket ;
      ...
      private short[] H002I2_A15UsuarioId ;
      private string[] H002I2_A93UsuarioNombre ;
   ...
   public class entitymanagerusuario__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002I2", "SELECT TOP 1 [UsuarioId], [UsuarioNombre] FROM [Usuario] WHERE [UsuarioId] = @AV6UsuarioId ORDER BY [UsuarioId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002I2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
