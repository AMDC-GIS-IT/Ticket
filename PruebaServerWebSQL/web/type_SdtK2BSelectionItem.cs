...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="K2BSelectionItem" , Namespace="kb_ticket" )]
	[Serializable]
	public class SdtK2BSelectionItem : GxUserType
	{
		...
		public GXBaseCollection<SdtK2BSelectionItem_FieldValuesItem> gxTpr_Fieldvalues
		{
			...
			set {
				...
				gxTv_SdtK2BSelectionItem_Fieldvalues_N = 0;
		...
		{
			gxTv_SdtK2BSelectionItem_Fieldvalues_N = 1;
		...
		protected short gxTv_SdtK2BSelectionItem_Fieldvalues_N;
	...
	[GxUnWrappedJson()]
	[DataContract(Name=@"K2BSelectionItem", Namespace="kb_ticket")]
