...
namespace GeneXus.Programs {
   public class entitymanagerusuariosistema : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public entitymanagerusuariosistema( )
      {
      ...
      public entitymanagerusuariosistema( IGxContext context )
      {
                           ...
                           string aP2_TabCode )
      {
         ...
         this.AV6UsuarioSistemaId = aP1_UsuarioSistemaId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               {
                  AV6UsuarioSistemaId = GetPar( "UsuarioSistemaId");
                  AssignAttri("", false, "AV6UsuarioSistemaId", AV6UsuarioSistemaId);
                  GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOSISTEMAID", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6UsuarioSistemaId, "")), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2023124956303", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("entitymanagerusuariosistema.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.RTrim(AV6UsuarioSistemaId)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Gx_mode","UsuarioSistemaId","TabCode"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vMODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( Gx_mode, "@!")), context));
         GxWebStd.gx_hidden_field( context, "vUSUARIOSISTEMAID", AV6UsuarioSistemaId);
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOSISTEMAID", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6UsuarioSistemaId, "")), context));
      ...
      {
         return formatLink("entitymanagerusuariosistema.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.RTrim(AV6UsuarioSistemaId)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Gx_mode","UsuarioSistemaId","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "EntityManagerUsuarioSistema" ;
      }
      ...
      protected void WB4Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblK2bpgmdesc_Internalname, lblK2bpgmdesc_Caption, "", "", lblK2bpgmdesc_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_EntityManagerUsuarioSistema.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblBacktoworkwith_Internalname, lblBacktoworkwith_Caption, lblBacktoworkwith_Link, "", lblBacktoworkwith_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_BackToWorkWith", 0, "", 1, 1, 0, 0, "HLP_EntityManagerUsuarioSistema.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_47_4Z2( true) ;
         }
         else
         {
            wb_table1_47_4Z2( false) ;
         }
         return  ;
      }

      protected void wb_table1_47_4Z2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      {
         /* GeneXus formulas. */
         AV27Pgmname = "EntityManagerUsuarioSistema";
         context.Gx_err = 0;
      }
      ...
      protected void E114Z2( )
      {
         /* Start Routine */
         returnInSub = false;
         lblBacktoworkwith_Caption = StringUtil.Format( "%1", "Usuario sistemas", "", "", "", "", "", "", "", "");
         AssignProp("", false, lblBacktoworkwith_Internalname, "Caption", lblBacktoworkwith_Caption, true);
         lblBacktoworkwith_Link = formatLink("wwusuariosistema.aspx") ;
         AssignProp("", false, lblBacktoworkwith_Internalname, "Link", lblBacktoworkwith_Link, true);
         AV26GXLvl7 = 0;
         /* Using cursor H004Z2 */
         pr_default.execute(0, new Object[] {AV6UsuarioSistemaId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A99UsuarioSistemaId = H004Z2_A99UsuarioSistemaId[0];
            A100UsuarioSistemaNombre = H004Z2_A100UsuarioSistemaNombre[0];
            AV26GXLvl7 = 1;
            Form.Caption = A100UsuarioSistemaNombre;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblK2bpgmdesc_Caption = StringUtil.Format( "%1 - %2", "Usuario Sistema", A100UsuarioSistemaNombre, "", "", "", "", "", "", "");
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            lblK2bpgmdesc_Caption = "Usuario Sistema";
            AssignProp("", false, lblK2bpgmdesc_Internalname, "Caption", lblK2bpgmdesc_Caption, true);
         }
      ...
      protected void E124Z2( )
      {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               lblComponenttitle_Caption = StringUtil.Format( "Actualizar %1", "Usuario Sistema", "", "", "", "", "", "", "", "");
               ...
               if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Popupcomponent_Component), StringUtil.Lower( "UsuarioSistema")) != 0 )
               {
                  WebComp_Popupcomponent = getWebComponent(GetType(), "GeneXus.Programs", "usuariosistema", new Object[] {context} );
                  WebComp_Popupcomponent.ComponentInit();
                  WebComp_Popupcomponent.Name = "UsuarioSistema";
                  WebComp_Popupcomponent_Component = "UsuarioSistema";
               }
               if ( StringUtil.Len( WebComp_Popupcomponent_Component) != 0 )
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0067",(string)"",(string)"UPD",(string)AV6UsuarioSistemaId});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
         {
            if ( ( StringUtil.StrCmp(AV8TabCode, "General") == 0 ) || String.IsNullOrEmpty(StringUtil.RTrim( AV8TabCode)) )
            {
               lblComponenttitle_Caption = StringUtil.Format( "Eliminar %1", "Usuario Sistema", "", "", "", "", "", "", "", "");
               AssignProp("", false, lblComponenttitle_Internalname, "Caption", lblComponenttitle_Caption, true);
               tblTablemodal_Visible = 1;
               AssignProp("", false, tblTablemodal_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(tblTablemodal_Visible), 5, 0), true);
               /* Object Property */
               ...
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0067",(string)"",(string)"DLT",(string)AV6UsuarioSistemaId});
                  WebComp_Popupcomponent.componentbind(new Object[] {(string)"",(string)""});
               }
               if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Popupcomponent )
               {
      ...
      protected void S112( )
      {
         ...
         AV11Tab.gxTpr_Link = formatLink("entitymanagerusuariosistema.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.RTrim(AV6UsuarioSistemaId)),UrlEncode(StringUtil.RTrim(AV11Tab.gxTpr_Code))}, new string[] {"Mode","UsuarioSistemaId","TabCode"}) ;
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Componentwc_general_Component), StringUtil.Lower( "UsuarioSistemaGeneral")) != 0 )
            {
               WebComp_Componentwc_general = getWebComponent(GetType(), "GeneXus.Programs", "usuariosistemageneral", new Object[] {context} );
               WebComp_Componentwc_general.ComponentInit();
               WebComp_Componentwc_general.Name = "UsuarioSistemaGeneral";
               WebComp_Componentwc_general_Component = "UsuarioSistemaGeneral";
            }
            if ( StringUtil.Len( WebComp_Componentwc_general_Component) != 0 )
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0041",(string)"",(string)Gx_mode,(string)AV6UsuarioSistemaId,(string)AV8TabCode});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0041",(string)"",(string)"DSP",(string)AV6UsuarioSistemaId,(string)AV8TabCode});
               WebComp_Componentwc_general.componentbind(new Object[] {(string)"",(string)"",(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Componentwc_general )
            {
      ...
      protected void wb_table1_47_4Z2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_53_4Z2( true) ;
         }
         else
         {
            wb_table2_53_4Z2( false) ;
         }
         return  ;
      }

      protected void wb_table2_53_4Z2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            wb_table1_47_4Z2e( true) ;
         }
         else
         {
            wb_table1_47_4Z2e( false) ;
         }
      }

      protected void wb_table2_53_4Z2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblComponenttitle_Internalname, lblComponenttitle_Caption, "", "", lblComponenttitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "PopupTitle", 0, "", 1, 1, 0, 0, "HLP_EntityManagerUsuarioSistema.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table3_58_4Z2( true) ;
         }
         else
         {
            wb_table3_58_4Z2( false) ;
         }
         return  ;
      }

      protected void wb_table3_58_4Z2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_53_4Z2e( true) ;
         }
         else
         {
            wb_table2_53_4Z2e( false) ;
         }
      }

      protected void wb_table3_58_4Z2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'CLOSEMODAL\\'."+"'", "", "PopupHeaderButton", 5, "", 1, 1, 0, 0, "HLP_EntityManagerUsuarioSistema.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_58_4Z2e( true) ;
         }
         else
         {
            wb_table3_58_4Z2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "Gx_mode", Gx_mode);
         AV6UsuarioSistemaId = (string)getParm(obj,1);
         AssignAttri("", false, "AV6UsuarioSistemaId", AV6UsuarioSistemaId);
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOSISTEMAID", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6UsuarioSistemaId, "")), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249563056", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("entitymanagerusuariosistema.js", "?20231249563056", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GLOBALEVENTS.K2BT_REFRESHENTITYMANAGER","{handler:'E134Z2',iparms:[{av:'AV22GE_ComponentName',fld:'vGE_COMPONENTNAME',pic:''},{av:'AV21GE_EntityManagerName',fld:'vGE_ENTITYMANAGERNAME',pic:''},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV6UsuarioSistemaId',fld:'vUSUARIOSISTEMAID',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("'CLOSEMODAL'","{handler:'E144Z2',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H004Z2_A99UsuarioSistemaId = new string[] {""} ;
         H004Z2_A100UsuarioSistemaNombre = new string[] {""} ;
         A99UsuarioSistemaId = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.entitymanagerusuariosistema__default(),
            new Object[][] {
                new Object[] {
               H004Z2_A99UsuarioSistemaId, H004Z2_A100UsuarioSistemaNombre
               }
            }
         );
      ...
      private string AV6UsuarioSistemaId ;
      private string wcpOAV6UsuarioSistemaId ;
      ...
      private string[] H004Z2_A99UsuarioSistemaId ;
      private string[] H004Z2_A100UsuarioSistemaNombre ;
   ...
   public class entitymanagerusuariosistema__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6UsuarioSistemaId",GXType.NVarChar,100,60)
          };
          def= new CursorDef[] {
              new CursorDef("H004Z2", "SELECT TOP 1 [UsuarioSistemaId], [UsuarioSistemaNombre] FROM [UsuarioSistema] WHERE [UsuarioSistemaId] = @AV6UsuarioSistemaId ORDER BY [UsuarioSistemaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004Z2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
