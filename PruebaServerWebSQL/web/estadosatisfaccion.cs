...
namespace GeneXus.Programs {
   public class estadosatisfaccion : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtEstadoSatisfaccionId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A4EstadoSatisfaccionId), 4, 0, ",", "")), ((edtEstadoSatisfaccionId_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A4EstadoSatisfaccionId), "ZZZ9")) : context.localUtil.Format( (decimal)(A4EstadoSatisfaccionId), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEstadoSatisfaccionId_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtEstadoSatisfaccionId_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "NumMin", "right", false, "", "HLP_EstadoSatisfaccion.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtEstadoSatisfaccionCalificacion_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A98EstadoSatisfaccionCalificacion), 4, 0, ",", "")), ((edtEstadoSatisfaccionCalificacion_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A98EstadoSatisfaccionCalificacion), "ZZZ9")) : context.localUtil.Format( (decimal)(A98EstadoSatisfaccionCalificacion), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,30);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEstadoSatisfaccionCalificacion_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtEstadoSatisfaccionCalificacion_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_EstadoSatisfaccion.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      public void ScanStart033( )
      {
         ...
         {
            RcdFound3 = 1;
            A4EstadoSatisfaccionId = T000317_A4EstadoSatisfaccionId[0];
            AssignAttri(sPrefix, false, "A4EstadoSatisfaccionId", StringUtil.LTrimStr( (decimal)(A4EstadoSatisfaccionId), 4, 0));
         }
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202312495252", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023124952514", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("estadosatisfaccion.js", "?2023124952514", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         T000317_A4EstadoSatisfaccionId = new short[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         sCtrlGx_mode = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.estadosatisfaccion__default(),
            new Object[][] {
               ...
               , new Object[] {
               T000317_A4EstadoSatisfaccionId
               }
            }
         );
         AV25Pgmname = "EstadoSatisfaccion";
      ...
      private short[] T000317_A4EstadoSatisfaccionId ;
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
          ...
          ,new CursorDef("T000311", "SELECT TOP 1 [SatisfaccionId] FROM [Satisfaccion] WHERE [SatisfaccionAtencionId] = @EstadoSatisfaccionId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000311,1, GxCacheFrequency.OFF ,true,true )
          ,new CursorDef("T000312", "SELECT TOP 1 [SatisfaccionId] FROM [Satisfaccion] WHERE [SatisfaccionTiempoId] = @EstadoSatisfaccionId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000312,1, GxCacheFrequency.OFF ,true,true )
          ,new CursorDef("T000313", "SELECT TOP 1 [SatisfaccionId] FROM [Satisfaccion] WHERE [SatisfaccionTecnicoProfesionalismoId] = @EstadoSatisfaccionId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000313,1, GxCacheFrequency.OFF ,true,true )
          ,new CursorDef("T000314", "SELECT TOP 1 [SatisfaccionId] FROM [Satisfaccion] WHERE [SatisfaccionTecnicoCompetenteId] = @EstadoSatisfaccionId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000314,1, GxCacheFrequency.OFF ,true,true )
          ,new CursorDef("T000315", "SELECT TOP 1 [SatisfaccionId] FROM [Satisfaccion] WHERE [SatisfaccionTecnicoProblemaId] = @EstadoSatisfaccionId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000315,1, GxCacheFrequency.OFF ,true,true )
          ,new CursorDef("T000316", "SELECT TOP 1 [SatisfaccionId] FROM [Satisfaccion] WHERE [SatisfaccionResueltoId] = @EstadoSatisfaccionId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000316,1, GxCacheFrequency.OFF ,true,true )
          ,new CursorDef("T000317", "SELECT [EstadoSatisfaccionId] FROM [EstadoSatisfaccion] ORDER BY [EstadoSatisfaccionId]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT000317,100, GxCacheFrequency.OFF ,true,false )
       };
    }
 }
