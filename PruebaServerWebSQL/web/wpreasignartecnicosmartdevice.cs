...
namespace GeneXus.Programs {
   public class wpreasignartecnicosmartdevice : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wpreasignartecnicosmartdevice( )
      {
      ...
      public wpreasignartecnicosmartdevice( IGxContext context )
      {
                           ...
                           ref bool aP9_TicketResponsablePasaTaller2 )
      {
         ...
         this.AV57UsuarioId = aP1_UsuarioId;
         this.AV30TicketResponsableId = aP2_TicketResponsableId;
         this.AV53TicketTecnicoResponsableId = aP3_TicketTecnicoResponsableId;
         this.AV55UsuarioEmail = aP4_UsuarioEmail;
         this.AV56UsuarioFecha = aP5_UsuarioFecha;
         this.AV58UsuarioNombre = aP6_UsuarioNombre;
         this.AV54UsuarioDepartamento = aP7_UsuarioDepartamento;
         this.AV59UsuarioRequerimiento = aP8_UsuarioRequerimiento;
         this.AV41TicketResponsablePasaTaller2 = aP9_TicketResponsablePasaTaller2;
         executePrivate();
         aP9_TicketResponsablePasaTaller2=this.AV41TicketResponsablePasaTaller2;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vDETALLE_INFOTECID_UNIDAD") == 0 )
            {
               ...
               GXDLVvDETALLE_INFOTECID_UNIDAD6L2( AV5categoria_tareaid_tipo_categoria) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vID_ACTIVIDAD_CATEGORIA") == 0 )
            {
               ...
               GXDLVvID_ACTIVIDAD_CATEGORIA6L2( AV5categoria_tareaid_tipo_categoria) ;
               return  ;
            }
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               {
                  AV57UsuarioId = (short)(NumberUtil.Val( GetPar( "UsuarioId"), "."));
                  AssignAttri("", false, "AV57UsuarioId", StringUtil.LTrimStr( (decimal)(AV57UsuarioId), 4, 0));
                  GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV57UsuarioId), "ZZZ9"), context));
                  ...
                  AV53TicketTecnicoResponsableId = (short)(NumberUtil.Val( GetPar( "TicketTecnicoResponsableId"), "."));
                  AssignAttri("", false, "AV53TicketTecnicoResponsableId", StringUtil.LTrimStr( (decimal)(AV53TicketTecnicoResponsableId), 4, 0));
                  GxWebStd.gx_hidden_field( context, "gxhash_vTICKETTECNICORESPONSABLEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV53TicketTecnicoResponsableId), "ZZZ9"), context));
                  AV55UsuarioEmail = GetPar( "UsuarioEmail");
                  AssignAttri("", false, "AV55UsuarioEmail", AV55UsuarioEmail);
                  GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOEMAIL", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV55UsuarioEmail, "")), context));
                  AV56UsuarioFecha = context.localUtil.ParseDateParm( GetPar( "UsuarioFecha"));
                  AssignAttri("", false, "AV56UsuarioFecha", context.localUtil.Format(AV56UsuarioFecha, "99/99/9999"));
                  GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOFECHA", GetSecureSignedToken( "", AV56UsuarioFecha, context));
                  AV58UsuarioNombre = GetPar( "UsuarioNombre");
                  AssignAttri("", false, "AV58UsuarioNombre", AV58UsuarioNombre);
                  GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIONOMBRE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV58UsuarioNombre, "")), context));
                  AV54UsuarioDepartamento = GetPar( "UsuarioDepartamento");
                  AssignAttri("", false, "AV54UsuarioDepartamento", AV54UsuarioDepartamento);
                  GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIODEPARTAMENTO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV54UsuarioDepartamento, "")), context));
                  AV59UsuarioRequerimiento = GetPar( "UsuarioRequerimiento");
                  AssignAttri("", false, "AV59UsuarioRequerimiento", AV59UsuarioRequerimiento);
                  AV41TicketResponsablePasaTaller2 = StringUtil.StrToBool( GetPar( "TicketResponsablePasaTaller2"));
                  AssignAttri("", false, "AV41TicketResponsablePasaTaller2", AV41TicketResponsablePasaTaller2);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2023124957679", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpreasignartecnicosmartdevice.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV16TicketId,10,0)),UrlEncode(StringUtil.LTrimStr(AV57UsuarioId,4,0)),UrlEncode(StringUtil.LTrimStr(AV30TicketResponsableId,10,0)),UrlEncode(StringUtil.LTrimStr(AV53TicketTecnicoResponsableId,4,0)),UrlEncode(StringUtil.RTrim(AV55UsuarioEmail)),UrlEncode(DateTimeUtil.FormatDateParm(AV56UsuarioFecha)),UrlEncode(StringUtil.RTrim(AV58UsuarioNombre)),UrlEncode(StringUtil.RTrim(AV54UsuarioDepartamento)),UrlEncode(StringUtil.RTrim(AV59UsuarioRequerimiento)),UrlEncode(StringUtil.BoolToStr(AV41TicketResponsablePasaTaller2))}, new string[] {"TicketId","UsuarioId","TicketResponsableId","TicketTecnicoResponsableId","UsuarioEmail","UsuarioFecha","UsuarioNombre","UsuarioDepartamento","UsuarioRequerimiento","TicketResponsablePasaTaller2"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vTICKETID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV16TicketId), "ZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vUSUARIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV57UsuarioId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV57UsuarioId), "ZZZ9"), context));
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vTICKETRESPONSABLEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV30TicketResponsableId), "ZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vTICKETTECNICORESPONSABLEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV53TicketTecnicoResponsableId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vTICKETTECNICORESPONSABLEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV53TicketTecnicoResponsableId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vUSUARIOEMAIL", AV55UsuarioEmail);
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOEMAIL", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV55UsuarioEmail, "")), context));
         GxWebStd.gx_hidden_field( context, "vUSUARIOFECHA", context.localUtil.DToC( AV56UsuarioFecha, 0, "/"));
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOFECHA", GetSecureSignedToken( "", AV56UsuarioFecha, context));
      ...
      {
         return formatLink("wpreasignartecnicosmartdevice.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV16TicketId,10,0)),UrlEncode(StringUtil.LTrimStr(AV57UsuarioId,4,0)),UrlEncode(StringUtil.LTrimStr(AV30TicketResponsableId,10,0)),UrlEncode(StringUtil.LTrimStr(AV53TicketTecnicoResponsableId,4,0)),UrlEncode(StringUtil.RTrim(AV55UsuarioEmail)),UrlEncode(DateTimeUtil.FormatDateParm(AV56UsuarioFecha)),UrlEncode(StringUtil.RTrim(AV58UsuarioNombre)),UrlEncode(StringUtil.RTrim(AV54UsuarioDepartamento)),UrlEncode(StringUtil.RTrim(AV59UsuarioRequerimiento)),UrlEncode(StringUtil.BoolToStr(AV41TicketResponsablePasaTaller2))}, new string[] {"TicketId","UsuarioId","TicketResponsableId","TicketTecnicoResponsableId","UsuarioEmail","UsuarioFecha","UsuarioNombre","UsuarioDepartamento","UsuarioRequerimiento","TicketResponsablePasaTaller2"})  ;
      }

      public override string GetPgmname( )
      {
         return "WPReasignarTecnicoSmartDevice" ;
      }

      public override string GetPgmdesc( )
      {
         return "WPReasignar Tecnico Smart Device" ;
      }
      ...
      protected void WB6L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTabpage1_title_Internalname, "Trabajo Realizado", "", "", lblTabpage1_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock32_Internalname, "Usuario:", "", "", lblTextblock32_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtavUsuarionombre_Internalname, AV58UsuarioNombre, StringUtil.RTrim( context.localUtil.Format( AV58UsuarioNombre, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsuarionombre_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavUsuarionombre_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock33_Internalname, "Departamento:", "", "", lblTextblock33_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavUsuariodepartamento_Internalname, AV54UsuarioDepartamento, "", "", 0, 1, edtavUsuariodepartamento_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock35_Internalname, "Requerimiento:", "", "", lblTextblock35_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavUsuariorequerimiento_Internalname, AV59UsuarioRequerimiento, "", "", 0, 1, edtavUsuariorequerimiento_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock34_Internalname, "Responsable:", "", "", lblTextblock34_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavResponsableid, dynavResponsableid_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV15ResponsableId), 4, 0)), 1, dynavResponsableid_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, dynavResponsableid.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,58);\"", "", true, 1, "HLP_WPReasignarTecnicoSmartDevice.htm");
            dynavResponsableid.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV15ResponsableId), 4, 0));
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock4_Internalname, "Inventario/Serie:", "", "", lblTextblock4_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock31_Internalname, "Estado Ticket:", "", "", lblTextblock31_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock2_Internalname, "ACCIONES REALIZADAS", "", "", lblTextblock2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock5_Internalname, "Instalación", "", "", lblTextblock5_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock6_Internalname, "Configuración", "", "", lblTextblock6_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock7_Internalname, "Internet/Router/Access Point", "", "", lblTextblock7_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock8_Internalname, "Formateo", "", "", lblTextblock8_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock9_Internalname, "Reparación", "", "", lblTextblock9_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock10_Internalname, "Limpieza", "", "", lblTextblock10_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock11_Internalname, "Punto Red", "", "", lblTextblock11_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock12_Internalname, "Cambios Hardware", "", "", lblTextblock12_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock13_Internalname, "Copias Respaldo", "", "", lblTextblock13_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "ESTADO DE ATENCIÓN DEL REQUERIMIENTO", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock14_Internalname, "Cerrado", "", "", lblTextblock14_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock15_Internalname, "Pendiente", "", "", lblTextblock15_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavTicketresponsablependiente_Internalname, StringUtil.BoolToStr( AV42TicketResponsablePendiente), "", "Pendiente", 1, chkavTicketresponsablependiente.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(177, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,177);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock16_Internalname, "Pasa Taller", "", "", lblTextblock16_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock17_Internalname, "Observación", "", "", lblTextblock17_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavTicketresponsableobservacion_Internalname, AV37TicketResponsableObservacion, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,192);\"", 0, 1, edtavTicketresponsableobservacion_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTabpage2_title_Internalname, "Taller Soporte Técnico", "", "", lblTabpage2_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock3_Internalname, "EN CASO DE LLEVAR AL TALLER DE SOPORTE TÉCNICO, CONFIRMAR LAS ESPECIFICACIONES DEL EQUIPO", "", "", lblTextblock3_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock18_Internalname, "RAM", "", "", lblTextblock18_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavTicketresponsableramtxt_Internalname, AV47TicketResponsableRamTxt, StringUtil.RTrim( context.localUtil.Format( AV47TicketResponsableRamTxt, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,212);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTicketresponsableramtxt_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTicketresponsableramtxt_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock19_Internalname, "Disco Duro", "", "", lblTextblock19_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavTicketresponsablediscodurotxt_Internalname, AV28TicketResponsableDiscoDuroTxt, StringUtil.RTrim( context.localUtil.Format( AV28TicketResponsableDiscoDuroTxt, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,220);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTicketresponsablediscodurotxt_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTicketresponsablediscodurotxt_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock20_Internalname, "Procesador", "", "", lblTextblock20_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavTicketresponsableprocesadortxt_Internalname, AV44TicketResponsableProcesadorTxt, StringUtil.RTrim( context.localUtil.Format( AV44TicketResponsableProcesadorTxt, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,228);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTicketresponsableprocesadortxt_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTicketresponsableprocesadortxt_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock21_Internalname, "Maletin", "", "", lblTextblock21_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavTicketresponsablemaletintxt_Internalname, AV36TicketResponsableMaletinTxt, StringUtil.RTrim( context.localUtil.Format( AV36TicketResponsableMaletinTxt, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,236);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTicketresponsablemaletintxt_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTicketresponsablemaletintxt_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock22_Internalname, "Toner Cinta", "", "", lblTextblock22_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavTicketresponsabletonercintatxt_Internalname, AV52TicketResponsableTonerCintaTxt, StringUtil.RTrim( context.localUtil.Format( AV52TicketResponsableTonerCintaTxt, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,244);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTicketresponsabletonercintatxt_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTicketresponsabletonercintatxt_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock23_Internalname, "Tarjeta de Video Extra", "", "", lblTextblock23_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavTicketresponsabletarjetavideoextratxt_Internalname, AV50TicketResponsableTarjetaVideoExtraTxt, StringUtil.RTrim( context.localUtil.Format( AV50TicketResponsableTarjetaVideoExtraTxt, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,252);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTicketresponsabletarjetavideoextratxt_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTicketresponsabletarjetavideoextratxt_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock24_Internalname, "Cargador Laptop", "", "", lblTextblock24_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavTicketresponsablecargadorlaptoptxt_Internalname, AV21TicketResponsableCargadorLaptopTxt, StringUtil.RTrim( context.localUtil.Format( AV21TicketResponsableCargadorLaptopTxt, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,260);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTicketresponsablecargadorlaptoptxt_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTicketresponsablecargadorlaptoptxt_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock25_Internalname, "CDs/DVDs", "", "", lblTextblock25_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavTicketresponsablecdsdvdstxt_Internalname, AV23TicketResponsableCDsDVDsTxt, StringUtil.RTrim( context.localUtil.Format( AV23TicketResponsableCDsDVDsTxt, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,268);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTicketresponsablecdsdvdstxt_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTicketresponsablecdsdvdstxt_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock26_Internalname, "Cable Especial", "", "", lblTextblock26_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavTicketresponsablecableespecialtxt_Internalname, AV18TicketResponsableCableEspecialTxt, StringUtil.RTrim( context.localUtil.Format( AV18TicketResponsableCableEspecialTxt, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,276);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTicketresponsablecableespecialtxt_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTicketresponsablecableespecialtxt_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock27_Internalname, "Otros", "", "", lblTextblock27_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavTicketresponsableotrostallertxt_Internalname, AV39TicketResponsableOtrosTallerTxt, StringUtil.RTrim( context.localUtil.Format( AV39TicketResponsableOtrosTallerTxt, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,284);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTicketresponsableotrostallertxt_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTicketresponsableotrostallertxt_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavTicketresponsablepasataller2_Internalname, StringUtil.BoolToStr( AV41TicketResponsablePasaTaller2), "", "Ticket Responsable Pasa Taller2", 1, chkavTicketresponsablepasataller2.Enabled, "true", "", StyleString, ClassString, "", "", "");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavDetalle_infotecid_unidad, dynavDetalle_infotecid_unidad_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV6detalle_infotecid_unidad), 9, 0)), 1, dynavDetalle_infotecid_unidad_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, dynavDetalle_infotecid_unidad.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,294);\"", "", true, 1, "HLP_WPReasignarTecnicoSmartDevice.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock28_Internalname, "Categoría de Tarea:", "", "", lblTextblock28_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavCategoria_tareaid_tipo_categoria, dynavCategoria_tareaid_tipo_categoria_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV5categoria_tareaid_tipo_categoria), 9, 0)), 1, dynavCategoria_tareaid_tipo_categoria_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, dynavCategoria_tareaid_tipo_categoria.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,313);\"", "", true, 1, "HLP_WPReasignarTecnicoSmartDevice.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock29_Internalname, "Detalle Tarea:", "", "", lblTextblock29_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavId_actividad_categoria, dynavId_actividad_categoria_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV12id_actividad_categoria), 9, 0)), 1, dynavId_actividad_categoria_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, dynavId_actividad_categoria.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,323);\"", "", true, 1, "HLP_WPReasignarTecnicoSmartDevice.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock30_Internalname, "Prioridad:", "", "", lblTextblock30_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavPrioridad, cmbavPrioridad_Internalname, StringUtil.RTrim( AV14prioridad), 1, cmbavPrioridad_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbavPrioridad.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,333);\"", "", true, 1, "HLP_WPReasignarTecnicoSmartDevice.htm");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttGuardar_Internalname, "", "Guardar", bttGuardar_Jsonclick, 5, "Guardar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'GUARDAR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttCancelar_Internalname, "", "Cancelar", bttCancelar_Jsonclick, 5, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CANCELAR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WPReasignarTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START6L2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "WPReasignar Tecnico Smart Device", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA6L2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = dynavResponsableid_Internalname;
      ...
      {
         GXVvDETALLE_INFOTECID_UNIDAD_html6L2( AV5categoria_tareaid_tipo_categoria) ;
         GXVvID_ACTIVIDAD_CATEGORIA_html6L2( AV5categoria_tareaid_tipo_categoria) ;
         /* End function dynload_actions */
      }

      protected void GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA6L1( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA_data6L1( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXVvCATEGORIA_TAREAID_TIPO_CATEGORIA_html6L1( )
      {
         int gxdynajaxvalue;
         GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA_data6L1( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvCATEGORIA_TAREAID_TIPO_CATEGORIA_data6L1( )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H006L2_A104categoria_tareaid_tipo_categoria[0]), 9, 0, ".", "")));
            gxdynajaxctrldescr.Add(H006L2_A106nombre_categoria[0]);
            pr_datastore1.readNext(0);
         }
         pr_datastore1.close(0);
      }

      protected void GXDLVvRESPONSABLEID6L1( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
      ...
      protected void GXVvRESPONSABLEID_html6L1( )
      {
      ...
      protected void GXDLVvRESPONSABLEID_data6L1( )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         /* Using cursor H006L3 */
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H006L3_A6ResponsableId[0]), 4, 0, ".", "")));
            gxdynajaxctrldescr.Add(H006L3_A30ResponsableNombre[0]);
            pr_default.readNext(0);
         }
         pr_default.close(0);
      }

      protected void GXDLVvESTADOTICKETTICKETID6L2( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvESTADOTICKETTICKETID_data6L2( ) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvESTADOTICKETTICKETID_html6L2( )
      {
         short gxdynajaxvalue;
         GXDLVvESTADOTICKETTICKETID_data6L2( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvESTADOTICKETTICKETID_data6L2( )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         /* Using cursor H006L4 */
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H006L4_A5EstadoTicketId[0]), 4, 0, ".", "")));
            gxdynajaxctrldescr.Add(H006L4_A24EstadoTicketNombre[0]);
            pr_default.readNext(1);
         }
         pr_default.close(1);
      }

      protected void GXDLVvDETALLE_INFOTECID_UNIDAD6L2( int AV5categoria_tareaid_tipo_categoria )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvDETALLE_INFOTECID_UNIDAD_data6L2( AV5categoria_tareaid_tipo_categoria) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvDETALLE_INFOTECID_UNIDAD_html6L2( int AV5categoria_tareaid_tipo_categoria )
      {
         int gxdynajaxvalue;
         GXDLVvDETALLE_INFOTECID_UNIDAD_data6L2( AV5categoria_tareaid_tipo_categoria) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvDETALLE_INFOTECID_UNIDAD_data6L2( int AV5categoria_tareaid_tipo_categoria )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         /* Using cursor H006L5 */
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H006L5_A105id_unidad_gis[0]), 9, 0, ".", "")));
            gxdynajaxctrldescr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H006L5_A105id_unidad_gis[0]), 9, 0, ".", "")));
            pr_datastore1.readNext(1);
         }
         pr_datastore1.close(1);
      }

      protected void GXDLVvID_ACTIVIDAD_CATEGORIA6L2( int AV5categoria_tareaid_tipo_categoria )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVvID_ACTIVIDAD_CATEGORIA_data6L2( AV5categoria_tareaid_tipo_categoria) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            AddString( gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((string)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}") ;
      ...
      protected void GXVvID_ACTIVIDAD_CATEGORIA_html6L2( int AV5categoria_tareaid_tipo_categoria )
      {
         int gxdynajaxvalue;
         GXDLVvID_ACTIVIDAD_CATEGORIA_data6L2( AV5categoria_tareaid_tipo_categoria) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvID_ACTIVIDAD_CATEGORIA_data6L2( int AV5categoria_tareaid_tipo_categoria )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         /* Using cursor H006L6 */
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H006L6_A102id_actividad_categoria[0]), 9, 0, ".", "")));
            gxdynajaxctrldescr.Add(H006L6_A123nombre_actividad[0]);
      ...
      protected void clear_multi_value_controls( )
      {
         if ( context.isAjaxRequest( ) )
         {
            GXVvESTADOTICKETTICKETID_html6L2( ) ;
            ...
            {
               dynavCategoria_tareaid_tipo_categoria.addItem(StringUtil.Trim( StringUtil.Str( (decimal)(H006L7_A104categoria_tareaid_tipo_categoria[0]), 9, 0)), H006L7_A106nombre_categoria[0], 0);
            ...
            {
               dynavResponsableid.addItem(StringUtil.Trim( StringUtil.Str( (decimal)(H006L8_A6ResponsableId[0]), 4, 0)), H006L8_A30ResponsableNombre[0], 0);
               pr_default.readNext(2);
            }
            pr_default.close(2);
            if ( dynavResponsableid.ItemCount > 0 )
            {
               AV15ResponsableId = (short)(NumberUtil.Val( dynavResponsableid.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(AV15ResponsableId), 4, 0))), "."));
               AssignAttri("", false, "AV15ResponsableId", StringUtil.LTrimStr( (decimal)(AV15ResponsableId), 4, 0));
            }
            dynload_actions( ) ;
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         AV48TicketResponsableReparacion = StringUtil.StrToBool( StringUtil.BoolToStr( AV48TicketResponsableReparacion));
         AssignAttri("", false, "AV48TicketResponsableReparacion", AV48TicketResponsableReparacion);
         ...
         AV45TicketResponsablePuntoRed = StringUtil.StrToBool( StringUtil.BoolToStr( AV45TicketResponsablePuntoRed));
         AssignAttri("", false, "AV45TicketResponsablePuntoRed", AV45TicketResponsablePuntoRed);
         ...
         AV42TicketResponsablePendiente = StringUtil.StrToBool( StringUtil.BoolToStr( AV42TicketResponsablePendiente));
         AssignAttri("", false, "AV42TicketResponsablePendiente", AV42TicketResponsablePendiente);
         ...
         AV41TicketResponsablePasaTaller2 = StringUtil.StrToBool( StringUtil.BoolToStr( AV41TicketResponsablePasaTaller2));
         AssignAttri("", false, "AV41TicketResponsablePasaTaller2", AV41TicketResponsablePasaTaller2);
      ...
      protected void STRUP6L0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV15ResponsableId = (short)(NumberUtil.Val( cgiGet( dynavResponsableid_Internalname), "."));
            AssignAttri("", false, "AV15ResponsableId", StringUtil.LTrimStr( (decimal)(AV15ResponsableId), 4, 0));
            ...
            AssignAttri("", false, "AV29TicketResponsableFormateo", AV29TicketResponsableFormateo);
            AV48TicketResponsableReparacion = StringUtil.StrToBool( cgiGet( chkavTicketresponsablereparacion_Internalname));
            AssignAttri("", false, "AV48TicketResponsableReparacion", AV48TicketResponsableReparacion);
            AV34TicketResponsableLimpieza = StringUtil.StrToBool( cgiGet( chkavTicketresponsablelimpieza_Internalname));
            AssignAttri("", false, "AV34TicketResponsableLimpieza", AV34TicketResponsableLimpieza);
            AV45TicketResponsablePuntoRed = StringUtil.StrToBool( cgiGet( chkavTicketresponsablepuntored_Internalname));
            AssignAttri("", false, "AV45TicketResponsablePuntoRed", AV45TicketResponsablePuntoRed);
            ...
            AssignAttri("", false, "AV24TicketResponsableCerrado", AV24TicketResponsableCerrado);
            AV42TicketResponsablePendiente = StringUtil.StrToBool( cgiGet( chkavTicketresponsablependiente_Internalname));
            AssignAttri("", false, "AV42TicketResponsablePendiente", AV42TicketResponsablePendiente);
            ...
            AV47TicketResponsableRamTxt = cgiGet( edtavTicketresponsableramtxt_Internalname);
            AssignAttri("", false, "AV47TicketResponsableRamTxt", AV47TicketResponsableRamTxt);
            ...
            AV44TicketResponsableProcesadorTxt = cgiGet( edtavTicketresponsableprocesadortxt_Internalname);
            AssignAttri("", false, "AV44TicketResponsableProcesadorTxt", AV44TicketResponsableProcesadorTxt);
            ...
            AV52TicketResponsableTonerCintaTxt = cgiGet( edtavTicketresponsabletonercintatxt_Internalname);
            AssignAttri("", false, "AV52TicketResponsableTonerCintaTxt", AV52TicketResponsableTonerCintaTxt);
            AV50TicketResponsableTarjetaVideoExtraTxt = cgiGet( edtavTicketresponsabletarjetavideoextratxt_Internalname);
            AssignAttri("", false, "AV50TicketResponsableTarjetaVideoExtraTxt", AV50TicketResponsableTarjetaVideoExtraTxt);
      ...
      protected void E116L2( )
      {
         /* 'Guardar' Routine */
         returnInSub = false;
         if ( ! AV41TicketResponsablePasaTaller2 )
         {
            ...
            else
            {
               ...
               new pcrreasignartecnico(context ).execute(  AV16TicketId,  AV57UsuarioId,  AV30TicketResponsableId,  AV53TicketTecnicoResponsableId,  AV15ResponsableId,  AV33TicketResponsableInventarioSerie,  AV31TicketResponsableInstalacion,  AV25TicketResponsableConfiguracion,  AV32TicketResponsableInternetRouter,  AV29TicketResponsableFormateo,  AV48TicketResponsableReparacion,  AV34TicketResponsableLimpieza,  AV45TicketResponsablePuntoRed,  AV19TicketResponsableCambiosHardware,  AV26TicketResponsableCopiasRespaldo,  AV47TicketResponsableRamTxt,  AV28TicketResponsableDiscoDuroTxt,  AV44TicketResponsableProcesadorTxt,  AV36TicketResponsableMaletinTxt,  AV52TicketResponsableTonerCintaTxt,  AV50TicketResponsableTarjetaVideoExtraTxt,  AV21TicketResponsableCargadorLaptopTxt,  AV23TicketResponsableCDsDVDsTxt,  AV18TicketResponsableCableEspecialTxt,  AV39TicketResponsableOtrosTallerTxt,  AV24TicketResponsableCerrado,  AV42TicketResponsablePendiente,  AV40TicketResponsablePasaTaller,  AV37TicketResponsableObservacion,  AV5categoria_tareaid_tipo_categoria,  AV12id_actividad_categoria,  AV58UsuarioNombre,  AV54UsuarioDepartamento,  AV55UsuarioEmail,  (int)(NumberUtil.Val( dynavDetalle_infotecid_unidad.Description, ".")),  AV7detalle_tarea,  cmbavPrioridad.Description,  AV56UsuarioFecha,  AV11EstadoTicketTicketId) ;
               context.setWebReturnParms(new Object[] {(bool)AV41TicketResponsablePasaTaller2});
               context.setWebReturnParmsMetadata(new Object[] {"AV41TicketResponsablePasaTaller2"});
      ...
      protected void E136L2( )
      {
         ...
         else
         {
            ...
            AssignProp("", false, chkavTicketresponsablependiente_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(chkavTicketresponsablependiente.Enabled), 5, 0), true);
            AV42TicketResponsablePendiente = false;
            AssignAttri("", false, "AV42TicketResponsablePendiente", AV42TicketResponsablePendiente);
         }
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "AV16TicketId", StringUtil.LTrimStr( (decimal)(AV16TicketId), 10, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vTICKETID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV16TicketId), "ZZZZZZZZZ9"), context));
         AV57UsuarioId = Convert.ToInt16(getParm(obj,1));
         AssignAttri("", false, "AV57UsuarioId", StringUtil.LTrimStr( (decimal)(AV57UsuarioId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV57UsuarioId), "ZZZ9"), context));
         AV30TicketResponsableId = Convert.ToInt64(getParm(obj,2));
         AssignAttri("", false, "AV30TicketResponsableId", StringUtil.LTrimStr( (decimal)(AV30TicketResponsableId), 10, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vTICKETRESPONSABLEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV30TicketResponsableId), "ZZZZZZZZZ9"), context));
         AV53TicketTecnicoResponsableId = Convert.ToInt16(getParm(obj,3));
         AssignAttri("", false, "AV53TicketTecnicoResponsableId", StringUtil.LTrimStr( (decimal)(AV53TicketTecnicoResponsableId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vTICKETTECNICORESPONSABLEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV53TicketTecnicoResponsableId), "ZZZ9"), context));
         AV55UsuarioEmail = (string)getParm(obj,4);
         AssignAttri("", false, "AV55UsuarioEmail", AV55UsuarioEmail);
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOEMAIL", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV55UsuarioEmail, "")), context));
         AV56UsuarioFecha = (DateTime)getParm(obj,5);
         AssignAttri("", false, "AV56UsuarioFecha", context.localUtil.Format(AV56UsuarioFecha, "99/99/9999"));
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIOFECHA", GetSecureSignedToken( "", AV56UsuarioFecha, context));
         AV58UsuarioNombre = (string)getParm(obj,6);
         AssignAttri("", false, "AV58UsuarioNombre", AV58UsuarioNombre);
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIONOMBRE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV58UsuarioNombre, "")), context));
         AV54UsuarioDepartamento = (string)getParm(obj,7);
         AssignAttri("", false, "AV54UsuarioDepartamento", AV54UsuarioDepartamento);
         GxWebStd.gx_hidden_field( context, "gxhash_vUSUARIODEPARTAMENTO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV54UsuarioDepartamento, "")), context));
         AV59UsuarioRequerimiento = (string)getParm(obj,8);
         AssignAttri("", false, "AV59UsuarioRequerimiento", AV59UsuarioRequerimiento);
         AV41TicketResponsablePasaTaller2 = (bool)getParm(obj,9);
         AssignAttri("", false, "AV41TicketResponsablePasaTaller2", AV41TicketResponsablePasaTaller2);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249571061", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpreasignartecnicosmartdevice.js", "?20231249571062", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         {
            dynavResponsableid.addItem(StringUtil.Trim( StringUtil.Str( (decimal)(H006L9_A6ResponsableId[0]), 4, 0)), H006L9_A30ResponsableNombre[0], 0);
         ...
         dynavCategoria_tareaid_tipo_categoria.WebTags = "";
         dynavCategoria_tareaid_tipo_categoria.removeAllItems();
         /* Using cursor H006L10 */
         pr_datastore1.execute(4);
         while ( (pr_datastore1.getStatus(4) != 101) )
         {
            dynavCategoria_tareaid_tipo_categoria.addItem(StringUtil.Trim( StringUtil.Str( (decimal)(H006L10_A104categoria_tareaid_tipo_categoria[0]), 9, 0)), H006L10_A106nombre_categoria[0], 0);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "WPReasignar Tecnico Smart Device";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public void Validv_Categoria_tareaid_tipo_categoria( )
      {
         ...
         AV15ResponsableId = (short)(NumberUtil.Val( dynavResponsableid.CurrentValue, "."));
         GXVvDETALLE_INFOTECID_UNIDAD_html6L2( AV5categoria_tareaid_tipo_categoria) ;
         GXVvID_ACTIVIDAD_CATEGORIA_html6L2( AV5categoria_tareaid_tipo_categoria) ;
         dynload_actions( ) ;
         if ( dynavDetalle_infotecid_unidad.ItemCount > 0 )
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV16TicketId',fld:'vTICKETID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV57UsuarioId',fld:'vUSUARIOID',pic:'ZZZ9',hsh:true},{av:'AV30TicketResponsableId',fld:'vTICKETRESPONSABLEID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV53TicketTecnicoResponsableId',fld:'vTICKETTECNICORESPONSABLEID',pic:'ZZZ9',hsh:true},{av:'AV55UsuarioEmail',fld:'vUSUARIOEMAIL',pic:'',hsh:true},{av:'AV56UsuarioFecha',fld:'vUSUARIOFECHA',pic:'',hsh:true},{av:'AV58UsuarioNombre',fld:'vUSUARIONOMBRE',pic:'',hsh:true},{av:'AV54UsuarioDepartamento',fld:'vUSUARIODEPARTAMENTO',pic:'',hsh:true},{av:'dynavEstadoticketticketid'},{av:'AV11EstadoTicketTicketId',fld:'vESTADOTICKETTICKETID',pic:'ZZZ9'},{av:'dynavCategoria_tareaid_tipo_categoria'},{av:'AV5categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'dynavResponsableid'},{av:'AV15ResponsableId',fld:'vRESPONSABLEID',pic:'ZZZ9'},{av:'AV31TicketResponsableInstalacion',fld:'vTICKETRESPONSABLEINSTALACION',pic:''},{av:'AV25TicketResponsableConfiguracion',fld:'vTICKETRESPONSABLECONFIGURACION',pic:''},{av:'AV32TicketResponsableInternetRouter',fld:'vTICKETRESPONSABLEINTERNETROUTER',pic:''},{av:'AV29TicketResponsableFormateo',fld:'vTICKETRESPONSABLEFORMATEO',pic:''},{av:'AV48TicketResponsableReparacion',fld:'vTICKETRESPONSABLEREPARACION',pic:''},{av:'AV34TicketResponsableLimpieza',fld:'vTICKETRESPONSABLELIMPIEZA',pic:''},{av:'AV45TicketResponsablePuntoRed',fld:'vTICKETRESPONSABLEPUNTORED',pic:''},{av:'AV19TicketResponsableCambiosHardware',fld:'vTICKETRESPONSABLECAMBIOSHARDWARE',pic:''},{av:'AV26TicketResponsableCopiasRespaldo',fld:'vTICKETRESPONSABLECOPIASRESPALDO',pic:''},{av:'AV24TicketResponsableCerrado',fld:'vTICKETRESPONSABLECERRADO',pic:''},{av:'AV42TicketResponsablePendiente',fld:'vTICKETRESPONSABLEPENDIENTE',pic:''},{av:'AV40TicketResponsablePasaTaller',fld:'vTICKETRESPONSABLEPASATALLER',pic:''},{av:'AV41TicketResponsablePasaTaller2',fld:'vTICKETRESPONSABLEPASATALLER2',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[{av:'dynavEstadoticketticketid'},{av:'AV11EstadoTicketTicketId',fld:'vESTADOTICKETTICKETID',pic:'ZZZ9'},{av:'dynavCategoria_tareaid_tipo_categoria'},{av:'AV5categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'dynavResponsableid'},{av:'AV15ResponsableId',fld:'vRESPONSABLEID',pic:'ZZZ9'},{av:'AV31TicketResponsableInstalacion',fld:'vTICKETRESPONSABLEINSTALACION',pic:''},{av:'AV25TicketResponsableConfiguracion',fld:'vTICKETRESPONSABLECONFIGURACION',pic:''},{av:'AV32TicketResponsableInternetRouter',fld:'vTICKETRESPONSABLEINTERNETROUTER',pic:''},{av:'AV29TicketResponsableFormateo',fld:'vTICKETRESPONSABLEFORMATEO',pic:''},{av:'AV48TicketResponsableReparacion',fld:'vTICKETRESPONSABLEREPARACION',pic:''},{av:'AV34TicketResponsableLimpieza',fld:'vTICKETRESPONSABLELIMPIEZA',pic:''},{av:'AV45TicketResponsablePuntoRed',fld:'vTICKETRESPONSABLEPUNTORED',pic:''},{av:'AV19TicketResponsableCambiosHardware',fld:'vTICKETRESPONSABLECAMBIOSHARDWARE',pic:''},{av:'AV26TicketResponsableCopiasRespaldo',fld:'vTICKETRESPONSABLECOPIASRESPALDO',pic:''},{av:'AV24TicketResponsableCerrado',fld:'vTICKETRESPONSABLECERRADO',pic:''},{av:'AV42TicketResponsablePendiente',fld:'vTICKETRESPONSABLEPENDIENTE',pic:''},{av:'AV40TicketResponsablePasaTaller',fld:'vTICKETRESPONSABLEPASATALLER',pic:''},{av:'AV41TicketResponsablePasaTaller2',fld:'vTICKETRESPONSABLEPASATALLER2',pic:''}]}");
         setEventMetadata("'GUARDAR'","{handler:'E116L2',iparms:[{av:'dynavId_actividad_categoria'},{av:'AV16TicketId',fld:'vTICKETID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV57UsuarioId',fld:'vUSUARIOID',pic:'ZZZ9',hsh:true},{av:'AV30TicketResponsableId',fld:'vTICKETRESPONSABLEID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV53TicketTecnicoResponsableId',fld:'vTICKETTECNICORESPONSABLEID',pic:'ZZZ9',hsh:true},{av:'AV33TicketResponsableInventarioSerie',fld:'vTICKETRESPONSABLEINVENTARIOSERIE',pic:''},{av:'AV47TicketResponsableRamTxt',fld:'vTICKETRESPONSABLERAMTXT',pic:''},{av:'AV28TicketResponsableDiscoDuroTxt',fld:'vTICKETRESPONSABLEDISCODUROTXT',pic:''},{av:'AV44TicketResponsableProcesadorTxt',fld:'vTICKETRESPONSABLEPROCESADORTXT',pic:''},{av:'AV36TicketResponsableMaletinTxt',fld:'vTICKETRESPONSABLEMALETINTXT',pic:''},{av:'AV52TicketResponsableTonerCintaTxt',fld:'vTICKETRESPONSABLETONERCINTATXT',pic:''},{av:'AV50TicketResponsableTarjetaVideoExtraTxt',fld:'vTICKETRESPONSABLETARJETAVIDEOEXTRATXT',pic:''},{av:'AV21TicketResponsableCargadorLaptopTxt',fld:'vTICKETRESPONSABLECARGADORLAPTOPTXT',pic:''},{av:'AV23TicketResponsableCDsDVDsTxt',fld:'vTICKETRESPONSABLECDSDVDSTXT',pic:''},{av:'AV18TicketResponsableCableEspecialTxt',fld:'vTICKETRESPONSABLECABLEESPECIALTXT',pic:''},{av:'AV39TicketResponsableOtrosTallerTxt',fld:'vTICKETRESPONSABLEOTROSTALLERTXT',pic:''},{av:'AV37TicketResponsableObservacion',fld:'vTICKETRESPONSABLEOBSERVACION',pic:''},{av:'AV12id_actividad_categoria',fld:'vID_ACTIVIDAD_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'AV58UsuarioNombre',fld:'vUSUARIONOMBRE',pic:'',hsh:true},{av:'AV54UsuarioDepartamento',fld:'vUSUARIODEPARTAMENTO',pic:'',hsh:true},{av:'AV55UsuarioEmail',fld:'vUSUARIOEMAIL',pic:'',hsh:true},{av:'dynavDetalle_infotecid_unidad'},{av:'cmbavPrioridad'},{av:'AV56UsuarioFecha',fld:'vUSUARIOFECHA',pic:'',hsh:true},{av:'dynavEstadoticketticketid'},{av:'AV11EstadoTicketTicketId',fld:'vESTADOTICKETTICKETID',pic:'ZZZ9'},{av:'dynavCategoria_tareaid_tipo_categoria'},{av:'AV5categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'dynavResponsableid'},{av:'AV15ResponsableId',fld:'vRESPONSABLEID',pic:'ZZZ9'},{av:'AV31TicketResponsableInstalacion',fld:'vTICKETRESPONSABLEINSTALACION',pic:''},{av:'AV25TicketResponsableConfiguracion',fld:'vTICKETRESPONSABLECONFIGURACION',pic:''},{av:'AV32TicketResponsableInternetRouter',fld:'vTICKETRESPONSABLEINTERNETROUTER',pic:''},{av:'AV29TicketResponsableFormateo',fld:'vTICKETRESPONSABLEFORMATEO',pic:''},{av:'AV48TicketResponsableReparacion',fld:'vTICKETRESPONSABLEREPARACION',pic:''},{av:'AV34TicketResponsableLimpieza',fld:'vTICKETRESPONSABLELIMPIEZA',pic:''},{av:'AV45TicketResponsablePuntoRed',fld:'vTICKETRESPONSABLEPUNTORED',pic:''},{av:'AV19TicketResponsableCambiosHardware',fld:'vTICKETRESPONSABLECAMBIOSHARDWARE',pic:''},{av:'AV26TicketResponsableCopiasRespaldo',fld:'vTICKETRESPONSABLECOPIASRESPALDO',pic:''},{av:'AV24TicketResponsableCerrado',fld:'vTICKETRESPONSABLECERRADO',pic:''},{av:'AV42TicketResponsablePendiente',fld:'vTICKETRESPONSABLEPENDIENTE',pic:''},{av:'AV40TicketResponsablePasaTaller',fld:'vTICKETRESPONSABLEPASATALLER',pic:''},{av:'AV41TicketResponsablePasaTaller2',fld:'vTICKETRESPONSABLEPASATALLER2',pic:''}]");
         setEventMetadata("'GUARDAR'",",oparms:[{av:'dynavEstadoticketticketid'},{av:'AV11EstadoTicketTicketId',fld:'vESTADOTICKETTICKETID',pic:'ZZZ9'},{av:'dynavCategoria_tareaid_tipo_categoria'},{av:'AV5categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'dynavResponsableid'},{av:'AV15ResponsableId',fld:'vRESPONSABLEID',pic:'ZZZ9'},{av:'AV31TicketResponsableInstalacion',fld:'vTICKETRESPONSABLEINSTALACION',pic:''},{av:'AV25TicketResponsableConfiguracion',fld:'vTICKETRESPONSABLECONFIGURACION',pic:''},{av:'AV32TicketResponsableInternetRouter',fld:'vTICKETRESPONSABLEINTERNETROUTER',pic:''},{av:'AV29TicketResponsableFormateo',fld:'vTICKETRESPONSABLEFORMATEO',pic:''},{av:'AV48TicketResponsableReparacion',fld:'vTICKETRESPONSABLEREPARACION',pic:''},{av:'AV34TicketResponsableLimpieza',fld:'vTICKETRESPONSABLELIMPIEZA',pic:''},{av:'AV45TicketResponsablePuntoRed',fld:'vTICKETRESPONSABLEPUNTORED',pic:''},{av:'AV19TicketResponsableCambiosHardware',fld:'vTICKETRESPONSABLECAMBIOSHARDWARE',pic:''},{av:'AV26TicketResponsableCopiasRespaldo',fld:'vTICKETRESPONSABLECOPIASRESPALDO',pic:''},{av:'AV24TicketResponsableCerrado',fld:'vTICKETRESPONSABLECERRADO',pic:''},{av:'AV42TicketResponsablePendiente',fld:'vTICKETRESPONSABLEPENDIENTE',pic:''},{av:'AV40TicketResponsablePasaTaller',fld:'vTICKETRESPONSABLEPASATALLER',pic:''},{av:'AV41TicketResponsablePasaTaller2',fld:'vTICKETRESPONSABLEPASATALLER2',pic:''}]}");
         setEventMetadata("'CANCELAR'","{handler:'E126L2',iparms:[{av:'dynavEstadoticketticketid'},{av:'AV11EstadoTicketTicketId',fld:'vESTADOTICKETTICKETID',pic:'ZZZ9'},{av:'dynavCategoria_tareaid_tipo_categoria'},{av:'AV5categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'dynavResponsableid'},{av:'AV15ResponsableId',fld:'vRESPONSABLEID',pic:'ZZZ9'},{av:'AV31TicketResponsableInstalacion',fld:'vTICKETRESPONSABLEINSTALACION',pic:''},{av:'AV25TicketResponsableConfiguracion',fld:'vTICKETRESPONSABLECONFIGURACION',pic:''},{av:'AV32TicketResponsableInternetRouter',fld:'vTICKETRESPONSABLEINTERNETROUTER',pic:''},{av:'AV29TicketResponsableFormateo',fld:'vTICKETRESPONSABLEFORMATEO',pic:''},{av:'AV48TicketResponsableReparacion',fld:'vTICKETRESPONSABLEREPARACION',pic:''},{av:'AV34TicketResponsableLimpieza',fld:'vTICKETRESPONSABLELIMPIEZA',pic:''},{av:'AV45TicketResponsablePuntoRed',fld:'vTICKETRESPONSABLEPUNTORED',pic:''},{av:'AV19TicketResponsableCambiosHardware',fld:'vTICKETRESPONSABLECAMBIOSHARDWARE',pic:''},{av:'AV26TicketResponsableCopiasRespaldo',fld:'vTICKETRESPONSABLECOPIASRESPALDO',pic:''},{av:'AV24TicketResponsableCerrado',fld:'vTICKETRESPONSABLECERRADO',pic:''},{av:'AV42TicketResponsablePendiente',fld:'vTICKETRESPONSABLEPENDIENTE',pic:''},{av:'AV40TicketResponsablePasaTaller',fld:'vTICKETRESPONSABLEPASATALLER',pic:''},{av:'AV41TicketResponsablePasaTaller2',fld:'vTICKETRESPONSABLEPASATALLER2',pic:''}]");
         setEventMetadata("'CANCELAR'",",oparms:[{av:'dynavEstadoticketticketid'},{av:'AV11EstadoTicketTicketId',fld:'vESTADOTICKETTICKETID',pic:'ZZZ9'},{av:'dynavCategoria_tareaid_tipo_categoria'},{av:'AV5categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'dynavResponsableid'},{av:'AV15ResponsableId',fld:'vRESPONSABLEID',pic:'ZZZ9'},{av:'AV31TicketResponsableInstalacion',fld:'vTICKETRESPONSABLEINSTALACION',pic:''},{av:'AV25TicketResponsableConfiguracion',fld:'vTICKETRESPONSABLECONFIGURACION',pic:''},{av:'AV32TicketResponsableInternetRouter',fld:'vTICKETRESPONSABLEINTERNETROUTER',pic:''},{av:'AV29TicketResponsableFormateo',fld:'vTICKETRESPONSABLEFORMATEO',pic:''},{av:'AV48TicketResponsableReparacion',fld:'vTICKETRESPONSABLEREPARACION',pic:''},{av:'AV34TicketResponsableLimpieza',fld:'vTICKETRESPONSABLELIMPIEZA',pic:''},{av:'AV45TicketResponsablePuntoRed',fld:'vTICKETRESPONSABLEPUNTORED',pic:''},{av:'AV19TicketResponsableCambiosHardware',fld:'vTICKETRESPONSABLECAMBIOSHARDWARE',pic:''},{av:'AV26TicketResponsableCopiasRespaldo',fld:'vTICKETRESPONSABLECOPIASRESPALDO',pic:''},{av:'AV24TicketResponsableCerrado',fld:'vTICKETRESPONSABLECERRADO',pic:''},{av:'AV42TicketResponsablePendiente',fld:'vTICKETRESPONSABLEPENDIENTE',pic:''},{av:'AV40TicketResponsablePasaTaller',fld:'vTICKETRESPONSABLEPASATALLER',pic:''},{av:'AV41TicketResponsablePasaTaller2',fld:'vTICKETRESPONSABLEPASATALLER2',pic:''}]}");
         setEventMetadata("VESTADOTICKETTICKETID.ISVALID","{handler:'E136L2',iparms:[{av:'dynavEstadoticketticketid'},{av:'AV11EstadoTicketTicketId',fld:'vESTADOTICKETTICKETID',pic:'ZZZ9'},{av:'dynavCategoria_tareaid_tipo_categoria'},{av:'AV5categoria_tareaid_tipo_categoria',fld:'vCATEGORIA_TAREAID_TIPO_CATEGORIA',pic:'ZZZZZZZZ9'},{av:'dynavResponsableid'},{av:'AV15ResponsableId',fld:'vRESPONSABLEID',pic:'ZZZ9'},{av:'AV31TicketResponsableInstalacion',fld:'vTICKETRESPONSABLEINSTALACION',pic:''},{av:'AV25TicketResponsableConfiguracion',fld:'vTICKETRESPONSABLECONFIGURACION',pic:''},{av:'AV32TicketResponsableInternetRouter',fld:'vTICKETRESPONSABLEINTERNETROUTER',pic:''},{av:'AV29TicketResponsableFormateo',fld:'vTICKETRESPONSABLEFORMATEO',pic:''},{av:'AV48TicketResponsableReparacion',fld:'vTICKETRESPONSABLEREPARACION',pic:''},{av:'AV34TicketResponsableLimpieza',fld:'vTICKETRESPONSABLELIMPIEZA',pic:''},{av:'AV45TicketResponsablePuntoRed',fld:'vTICKETRESPONSABLEPUNTORED',pic:''},{av:'AV19TicketResponsableCambiosHardware',fld:'vTICKETRESPONSABLECAMBIOSHARDWARE',pic:''},{av:'AV26TicketResponsableCopiasRespaldo',fld:'vTICKETRESPONSABLECOPIASRESPALDO',pic:''},{av:'AV24TicketResponsableCerrado',fld:'vTICKETRESPONSABLECERRADO',pic:''},{av:'AV42TicketResponsablePendiente',fld:'vTICKETRESPONSABLEPENDIENTE',pic:''},{av:'AV40TicketResponsablePasaTaller',fld:'vTICKETRESPONSABLEPASATALLER',pic:''},{av:'AV41TicketResponsablePasaTaller2',fld:'vTICKETRESPONSABLEPASATALLER2',pic:''}]");
      ...
      {
         wcpOAV55UsuarioEmail = "";
         wcpOAV56UsuarioFecha = DateTime.MinValue;
         wcpOAV58UsuarioNombre = "";
         wcpOAV54UsuarioDepartamento = "";
         wcpOAV59UsuarioRequerimiento = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sDynURL = "";
         FormProcess = "";
         ...
         AV52TicketResponsableTonerCintaTxt = "";
         lblTextblock23_Jsonclick = "";
         AV50TicketResponsableTarjetaVideoExtraTxt = "";
         ...
         gxwrpcisep = "";
         scmdbuf = "";
         H006L2_A104categoria_tareaid_tipo_categoria = new int[1] ;
         H006L2_A106nombre_categoria = new string[] {""} ;
         H006L2_n106nombre_categoria = new bool[] {false} ;
         H006L3_A6ResponsableId = new short[1] ;
         H006L3_A30ResponsableNombre = new string[] {""} ;
         H006L4_A5EstadoTicketId = new short[1] ;
         H006L4_A24EstadoTicketNombre = new string[] {""} ;
         H006L5_A105id_unidad_gis = new int[1] ;
         H006L5_A104categoria_tareaid_tipo_categoria = new int[1] ;
         H006L6_A102id_actividad_categoria = new int[1] ;
         H006L6_A123nombre_actividad = new string[] {""} ;
         H006L6_n123nombre_actividad = new bool[] {false} ;
         H006L6_A122actividades_categoriaid_tipo_categoria = new int[1] ;
         H006L6_n122actividades_categoriaid_tipo_categoria = new bool[] {false} ;
         H006L6_A125actividades_categoriaestado = new int[1] ;
         H006L6_n125actividades_categoriaestado = new bool[] {false} ;
         H006L7_A104categoria_tareaid_tipo_categoria = new int[1] ;
         H006L7_A106nombre_categoria = new string[] {""} ;
         H006L7_n106nombre_categoria = new bool[] {false} ;
         H006L8_A6ResponsableId = new short[1] ;
         H006L8_A30ResponsableNombre = new string[] {""} ;
         AV7detalle_tarea = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         H006L9_A6ResponsableId = new short[1] ;
         H006L9_A30ResponsableNombre = new string[] {""} ;
         H006L10_A104categoria_tareaid_tipo_categoria = new int[1] ;
         H006L10_A106nombre_categoria = new string[] {""} ;
         H006L10_n106nombre_categoria = new bool[] {false} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpreasignartecnicosmartdevice__default(),
            new Object[][] {
                new Object[] {
               H006L3_A6ResponsableId, H006L3_A30ResponsableNombre
               }
               , new Object[] {
               H006L4_A5EstadoTicketId, H006L4_A24EstadoTicketNombre
               }
               , new Object[] {
               H006L8_A6ResponsableId, H006L8_A30ResponsableNombre
               }
               , new Object[] {
               H006L9_A6ResponsableId, H006L9_A30ResponsableNombre
               }
            }
         );
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.wpreasignartecnicosmartdevice__datastore1(),
            new Object[][] {
                new Object[] {
               H006L2_A104categoria_tareaid_tipo_categoria, H006L2_A106nombre_categoria, H006L2_n106nombre_categoria
               }
               , new Object[] {
               H006L5_A105id_unidad_gis, H006L5_A104categoria_tareaid_tipo_categoria
               }
               , new Object[] {
               H006L6_A102id_actividad_categoria, H006L6_A123nombre_actividad, H006L6_n123nombre_actividad, H006L6_A122actividades_categoriaid_tipo_categoria, H006L6_n122actividades_categoriaid_tipo_categoria, H006L6_A125actividades_categoriaestado, H006L6_n125actividades_categoriaestado
               }
               , new Object[] {
               H006L7_A104categoria_tareaid_tipo_categoria, H006L7_A106nombre_categoria, H006L7_n106nombre_categoria
               }
               , new Object[] {
               H006L10_A104categoria_tareaid_tipo_categoria, H006L10_A106nombre_categoria, H006L10_n106nombre_categoria
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short AV57UsuarioId ;
      private short AV53TicketTecnicoResponsableId ;
      private short wcpOAV57UsuarioId ;
      private short wcpOAV53TicketTecnicoResponsableId ;
      ...
      private short AV15ResponsableId ;
      ...
      private DateTime wcpOAV56UsuarioFecha ;
      private bool AV41TicketResponsablePasaTaller2 ;
      private bool wcpOAV41TicketResponsablePasaTaller2 ;
      ...
      private bool AV48TicketResponsableReparacion ;
      private bool AV34TicketResponsableLimpieza ;
      private bool AV45TicketResponsablePuntoRed ;
      ...
      private bool AV42TicketResponsablePendiente ;
      private bool AV40TicketResponsablePasaTaller ;
      private bool Rfr0gs ;
      private bool wbErr ;
      private bool gxdyncontrolsrefreshing ;
      private bool returnInSub ;
      private string AV55UsuarioEmail ;
      private string AV58UsuarioNombre ;
      private string AV54UsuarioDepartamento ;
      private string AV59UsuarioRequerimiento ;
      private string wcpOAV55UsuarioEmail ;
      private string wcpOAV58UsuarioNombre ;
      private string wcpOAV54UsuarioDepartamento ;
      private string wcpOAV59UsuarioRequerimiento ;
      private string AV33TicketResponsableInventarioSerie ;
      private string AV37TicketResponsableObservacion ;
      private string AV47TicketResponsableRamTxt ;
      private string AV28TicketResponsableDiscoDuroTxt ;
      private string AV44TicketResponsableProcesadorTxt ;
      private string AV36TicketResponsableMaletinTxt ;
      private string AV52TicketResponsableTonerCintaTxt ;
      private string AV50TicketResponsableTarjetaVideoExtraTxt ;
      ...
      private int[] H006L2_A104categoria_tareaid_tipo_categoria ;
      private string[] H006L2_A106nombre_categoria ;
      private bool[] H006L2_n106nombre_categoria ;
      private IDataStoreProvider pr_default ;
      private short[] H006L3_A6ResponsableId ;
      private string[] H006L3_A30ResponsableNombre ;
      private short[] H006L4_A5EstadoTicketId ;
      private string[] H006L4_A24EstadoTicketNombre ;
      private int[] H006L5_A105id_unidad_gis ;
      private int[] H006L5_A104categoria_tareaid_tipo_categoria ;
      private int[] H006L6_A102id_actividad_categoria ;
      private string[] H006L6_A123nombre_actividad ;
      private bool[] H006L6_n123nombre_actividad ;
      private int[] H006L6_A122actividades_categoriaid_tipo_categoria ;
      private bool[] H006L6_n122actividades_categoriaid_tipo_categoria ;
      private int[] H006L6_A125actividades_categoriaestado ;
      private bool[] H006L6_n125actividades_categoriaestado ;
      private int[] H006L7_A104categoria_tareaid_tipo_categoria ;
      private string[] H006L7_A106nombre_categoria ;
      private bool[] H006L7_n106nombre_categoria ;
      private short[] H006L8_A6ResponsableId ;
      private string[] H006L8_A30ResponsableNombre ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private short[] H006L9_A6ResponsableId ;
      private string[] H006L9_A30ResponsableNombre ;
      private int[] H006L10_A104categoria_tareaid_tipo_categoria ;
      private string[] H006L10_A106nombre_categoria ;
      private bool[] H006L10_n106nombre_categoria ;
      private GXWebForm Form ;
   }

   public class wpreasignartecnicosmartdevice__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH006L8;
          prmH006L8 = new Object[] {
          };
          Object[] prmH006L9;
          prmH006L9 = new Object[] {
          };
          def= new CursorDef[] {
              new CursorDef("H006L3", "SELECT [ResponsableId], [ResponsableNombre] FROM [Responsable] ORDER BY [ResponsableNombre] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006L3,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H006L4", "SELECT [EstadoTicketId], [EstadoTicketNombre] FROM [EstadoTicket] WHERE [EstadoTicketId] = 4 ORDER BY [EstadoTicketNombre] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006L4,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H006L8", "SELECT [ResponsableId], [ResponsableNombre] FROM [Responsable] ORDER BY [ResponsableNombre] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006L8,0, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H006L9", "SELECT [ResponsableId], [ResponsableNombre] FROM [Responsable] ORDER BY [ResponsableNombre] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006L9,0, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
 ...
 public class wpreasignartecnicosmartdevice__datastore1 : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        Object[] prmH006L10;
        prmH006L10 = new Object[] {
        };
        def= new CursorDef[] {
            new CursorDef("H006L2", "SELECT [id_tipo_categoria] AS categoria_tareaid_tipo_categoria, [nombre_categoria] FROM dbo.[categoria_tarea] ORDER BY [nombre_categoria] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006L2,0, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("H006L5", "SELECT [id_unidad_gis], [id_tipo_categoria] AS categoria_tareaid_tipo_categoria FROM dbo.[categoria_tarea] WHERE [id_tipo_categoria] = @AV5categoria_tareaid_tipo_categoria ORDER BY [id_unidad_gis] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006L5,0, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("H006L6", "SELECT [id_actividad_categoria], [nombre_actividad], [id_tipo_categoria] AS actividades_categoriaid_tipo_categoria, [estado] AS actividades_categoriaestado FROM dbo.[actividades_categoria] WHERE ([id_tipo_categoria] = @AV5categoria_tareaid_tipo_categoria) AND ([estado] = 1) ORDER BY [nombre_actividad] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006L6,0, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("H006L7", "SELECT [id_tipo_categoria] AS categoria_tareaid_tipo_categoria, [nombre_categoria] FROM dbo.[categoria_tarea] ORDER BY [nombre_categoria] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006L7,0, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("H006L10", "SELECT [id_tipo_categoria] AS categoria_tareaid_tipo_categoria, [nombre_categoria] FROM dbo.[categoria_tarea] ORDER BY [nombre_categoria] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006L10,0, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
