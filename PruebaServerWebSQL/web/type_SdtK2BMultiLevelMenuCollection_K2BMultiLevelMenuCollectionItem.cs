...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="K2BMultiLevelMenuCollectionItem" , Namespace="kb_ticket" )]
	[Serializable]
	public class SdtK2BMultiLevelMenuCollection_K2BMultiLevelMenuCollectionItem : GxUserType
	{
		...
		public GXBaseCollection<GeneXus.Programs.SdtK2BMultiLevelMenu_K2BMultiLevelMenuItem> gxTpr_K2bmultilevelmenu_GXBaseCollection
		{
			...
			set {
				...
				gxTv_SdtK2BMultiLevelMenuCollection_K2BMultiLevelMenuCollectionItem_K2bmultilevelmenu_N = 0;
		...
		{
			gxTv_SdtK2BMultiLevelMenuCollection_K2BMultiLevelMenuCollectionItem_K2bmultilevelmenu_N = 1;
		...
		protected short gxTv_SdtK2BMultiLevelMenuCollection_K2BMultiLevelMenuCollectionItem_K2bmultilevelmenu_N;
	...
	[DataContract(Name=@"K2BMultiLevelMenuCollectionItem", Namespace="kb_ticket")]
