...
namespace GeneXus.Programs {
   public class exportdireccionesusuariosistemawc : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV8DireccionId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV10UsuarioSistemaIdentidad = GetPar( "UsuarioSistemaIdentidad");
                  AV11DepartamentoNombre = GetPar( "DepartamentoNombre");
                           ...
                           ref short aP4_OrderedBy )
      {
         ...
         initialize();
         executePrivate();
         aP4_OrderedBy=this.AV12OrderedBy;
      }

      public short executeUdp( short aP0_DireccionId ,
                               string aP1_UsuarioSistemaIdentidad ,
                               string aP2_DepartamentoNombre ,
                               string aP3_K2BToolsGenericSearchField )
      {
         execute(aP0_DireccionId, aP1_UsuarioSistemaIdentidad, aP2_DepartamentoNombre, aP3_K2BToolsGenericSearchField, ref aP4_OrderedBy);
         return AV12OrderedBy ;
      }
      ...
      void executePrivate( )
      {
         ...
         {
            AV18Filename = "";
            AV19ErrorMessage = "You are not authorized to do activity";
            AV19ErrorMessage += "EntityName:" + "UsuarioSistema";
            AV19ErrorMessage += "TransactionName:" + "UsuarioSistema";
            AV19ErrorMessage += "ActivityType:" + "";
            AV19ErrorMessage += "PgmName:" + AV35Pgmname;
            AV20HttpResponse.AddString(AV19ErrorMessage);
         ...
         AV18Filename = GxDirectory.TemporaryFilesPath + AV21File.Separator + "ExportDireccionesUsuarioSistemaWC-" + StringUtil.Trim( StringUtil.Str( (decimal)(AV16Random), 8, 0)) + ".xlsx";
         ...
         AV13ExcelDocument.Open(AV18Filename);
         ...
         {
            AV13ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+0, 1, 1).Bold = 1;
            AV13ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+0, 1, 1).Text = "Sistema Identidad";
         ...
         if ( AV26GridColumnVisible_UsuarioSistemaId )
         {
            ...
            AV13ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+AV17ColumnIndex, 1, 1).Text = "Sistema Id";
            AV17ColumnIndex = (short)(AV17ColumnIndex+1);
         }
         if ( AV27GridColumnVisible_UsuarioSistemaIdentidad )
         {
            AV13ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+AV17ColumnIndex, 1, 1).Bold = 1;
            AV13ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+AV17ColumnIndex, 1, 1).Text = "Sistema Identidad";
            AV17ColumnIndex = (short)(AV17ColumnIndex+1);
         }
         if ( AV28GridColumnVisible_UsuarioSistemaNombre )
         {
            AV13ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+AV17ColumnIndex, 1, 1).Bold = 1;
            AV13ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+AV17ColumnIndex, 1, 1).Text = "Sistema Nombre";
            AV17ColumnIndex = (short)(AV17ColumnIndex+1);
         }
         if ( AV29GridColumnVisible_UsuarioSistemaGerencia )
         {
            AV13ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+AV17ColumnIndex, 1, 1).Bold = 1;
            AV13ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+AV17ColumnIndex, 1, 1).Text = "Sistema Gerencia";
            AV17ColumnIndex = (short)(AV17ColumnIndex+1);
         }
         if ( AV30GridColumnVisible_UsuarioSistemaDepartamento )
         {
            AV13ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+AV17ColumnIndex, 1, 1).Bold = 1;
            AV13ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+AV17ColumnIndex, 1, 1).Text = "Sistema Departamento";
            AV17ColumnIndex = (short)(AV17ColumnIndex+1);
         }
         ...
         {
            AV20HttpResponse.AppendHeader("Content-Type", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
         }
         if ( ! context.isAjaxRequest( ) )
         {
            AV20HttpResponse.AppendHeader("Content-Disposition", "attachment;filename=ExportDireccionesUsuarioSistemaWC.xlsx");
         }
         if ( ! context.isAjaxRequest( ) )
         {
            AV20HttpResponse.AppendHeader("X-Frame-Options", "sameOrigin");
         }
         if ( ! context.isAjaxRequest( ) )
         {
            AV20HttpResponse.AppendHeader("X-Content-Type-Options", "nosniff");
         }
         AV20HttpResponse.AddFile(AV18Filename);
         new k2bremoveexceldocument(context).executeSubmit(  AV18Filename) ;
      ...
      protected void S131( )
      {
         ...
         AV25GridColumn.gxTpr_Columntitle = "Sistema Id";
         ...
         AV25GridColumn.gxTpr_Columntitle = "Sistema Identidad";
         AV25GridColumn.gxTpr_Showattribute = true;
         AV24GridColumns.Add(AV25GridColumn, 0);
         AV25GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV25GridColumn.gxTpr_Attributename = "UsuarioSistemaNombre";
         AV25GridColumn.gxTpr_Columntitle = "Sistema Nombre";
         AV25GridColumn.gxTpr_Showattribute = true;
         AV24GridColumns.Add(AV25GridColumn, 0);
         AV25GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV25GridColumn.gxTpr_Attributename = "UsuarioSistemaGerencia";
         AV25GridColumn.gxTpr_Columntitle = "Sistema Gerencia";
         AV25GridColumn.gxTpr_Showattribute = true;
         AV24GridColumns.Add(AV25GridColumn, 0);
         AV25GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV25GridColumn.gxTpr_Attributename = "UsuarioSistemaDepartamento";
         AV25GridColumn.gxTpr_Columntitle = "Sistema Departamento";
         AV25GridColumn.gxTpr_Showattribute = true;
         AV24GridColumns.Add(AV25GridColumn, 0);
         AV25GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
      ...
      public override void initialize( )
      {
         ...
         AV35Pgmname = "ExportDireccionesUsuarioSistemaWC";
         /* GeneXus formulas. */
         AV35Pgmname = "ExportDireccionesUsuarioSistemaWC";
         context.Gx_err = 0;
      }
