...
namespace GeneXus.Programs {
   public class exportdeptousuariosistemawc : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV8CentrodecostoId = gxfirstwebparm;
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9DepartamentoId = (short)(NumberUtil.Val( GetPar( "DepartamentoId"), "."));
                  AV11UsuarioSistemaIdentidad = GetPar( "UsuarioSistemaIdentidad");
                  AV12DireccionDescripcion = GetPar( "DireccionDescripcion");
                           ...
                           ref short aP5_OrderedBy )
      {
         ...
         initialize();
         executePrivate();
         aP5_OrderedBy=this.AV13OrderedBy;
      }

      public short executeUdp( string aP0_CentrodecostoId ,
                               short aP1_DepartamentoId ,
                               string aP2_UsuarioSistemaIdentidad ,
                               string aP3_DireccionDescripcion ,
                               string aP4_K2BToolsGenericSearchField )
      {
         execute(aP0_CentrodecostoId, aP1_DepartamentoId, aP2_UsuarioSistemaIdentidad, aP3_DireccionDescripcion, aP4_K2BToolsGenericSearchField, ref aP5_OrderedBy);
      ...
      void executePrivate( )
      {
         ...
         if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "UsuarioSistema",  "UsuarioSistema",  "List",  "",  "DeptoUsuarioSistemaWC") )
         {
            ...
            AV20ErrorMessage += "EntityName:" + "UsuarioSistema";
            AV20ErrorMessage += "TransactionName:" + "UsuarioSistema";
            AV20ErrorMessage += "ActivityType:" + "";
            AV20ErrorMessage += "PgmName:" + AV36Pgmname;
         ...
         AV19Filename = GxDirectory.TemporaryFilesPath + AV22File.Separator + "ExportDeptoUsuarioSistemaWC-" + StringUtil.Trim( StringUtil.Str( (decimal)(AV17Random), 8, 0)) + ".xlsx";
         ...
         {
            AV14ExcelDocument.get_Cells(AV15CellRow, AV16FirstColumn+0, 1, 1).Bold = 1;
            AV14ExcelDocument.get_Cells(AV15CellRow, AV16FirstColumn+0, 1, 1).Text = "Sistema Identidad";
         ...
         if ( AV27GridColumnVisible_UsuarioSistemaId )
         {
            ...
            AV14ExcelDocument.get_Cells(AV15CellRow, AV16FirstColumn+AV18ColumnIndex, 1, 1).Text = "Sistema Id";
            AV18ColumnIndex = (short)(AV18ColumnIndex+1);
         }
         if ( AV28GridColumnVisible_UsuarioSistemaIdentidad )
         {
            AV14ExcelDocument.get_Cells(AV15CellRow, AV16FirstColumn+AV18ColumnIndex, 1, 1).Bold = 1;
            AV14ExcelDocument.get_Cells(AV15CellRow, AV16FirstColumn+AV18ColumnIndex, 1, 1).Text = "Sistema Identidad";
            AV18ColumnIndex = (short)(AV18ColumnIndex+1);
         }
         if ( AV29GridColumnVisible_UsuarioSistemaNombre )
         {
            AV14ExcelDocument.get_Cells(AV15CellRow, AV16FirstColumn+AV18ColumnIndex, 1, 1).Bold = 1;
            AV14ExcelDocument.get_Cells(AV15CellRow, AV16FirstColumn+AV18ColumnIndex, 1, 1).Text = "Sistema Nombre";
            AV18ColumnIndex = (short)(AV18ColumnIndex+1);
         }
         if ( AV30GridColumnVisible_UsuarioSistemaGerencia )
         {
            AV14ExcelDocument.get_Cells(AV15CellRow, AV16FirstColumn+AV18ColumnIndex, 1, 1).Bold = 1;
            AV14ExcelDocument.get_Cells(AV15CellRow, AV16FirstColumn+AV18ColumnIndex, 1, 1).Text = "Sistema Gerencia";
            AV18ColumnIndex = (short)(AV18ColumnIndex+1);
         }
         if ( AV31GridColumnVisible_UsuarioSistemaDepartamento )
         {
            AV14ExcelDocument.get_Cells(AV15CellRow, AV16FirstColumn+AV18ColumnIndex, 1, 1).Bold = 1;
            AV14ExcelDocument.get_Cells(AV15CellRow, AV16FirstColumn+AV18ColumnIndex, 1, 1).Text = "Sistema Departamento";
            AV18ColumnIndex = (short)(AV18ColumnIndex+1);
         }
         ...
         if ( ! context.isAjaxRequest( ) )
         {
            AV21HttpResponse.AppendHeader("Content-Disposition", "attachment;filename=ExportDeptoUsuarioSistemaWC.xlsx");
         }
         if ( ! context.isAjaxRequest( ) )
         {
      ...
      protected void S131( )
      {
         ...
         AV26GridColumn.gxTpr_Columntitle = "Sistema Id";
         ...
         AV26GridColumn.gxTpr_Columntitle = "Sistema Identidad";
         AV26GridColumn.gxTpr_Showattribute = true;
         AV25GridColumns.Add(AV26GridColumn, 0);
         AV26GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV26GridColumn.gxTpr_Attributename = "UsuarioSistemaNombre";
         AV26GridColumn.gxTpr_Columntitle = "Sistema Nombre";
         AV26GridColumn.gxTpr_Showattribute = true;
         AV25GridColumns.Add(AV26GridColumn, 0);
         AV26GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV26GridColumn.gxTpr_Attributename = "UsuarioSistemaGerencia";
         AV26GridColumn.gxTpr_Columntitle = "Sistema Gerencia";
         AV26GridColumn.gxTpr_Showattribute = true;
         AV25GridColumns.Add(AV26GridColumn, 0);
         AV26GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV26GridColumn.gxTpr_Attributename = "UsuarioSistemaDepartamento";
         AV26GridColumn.gxTpr_Columntitle = "Sistema Departamento";
         AV26GridColumn.gxTpr_Showattribute = true;
         AV25GridColumns.Add(AV26GridColumn, 0);
         AV26GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
      ...
      public override void initialize( )
      {
         ...
         AV36Pgmname = "ExportDeptoUsuarioSistemaWC";
         /* GeneXus formulas. */
         AV36Pgmname = "ExportDeptoUsuarioSistemaWC";
         context.Gx_err = 0;
      }
