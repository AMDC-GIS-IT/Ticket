...
namespace GeneXus.Programs {
   public class responsable : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtResponsableId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A6ResponsableId), 4, 0, ",", "")), ((edtResponsableId_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A6ResponsableId), "ZZZ9")) : context.localUtil.Format( (decimal)(A6ResponsableId), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtResponsableId_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtResponsableId_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "NumMin", "right", false, "", "HLP_Responsable.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtEstadoResponsableId_Internalname, "Estado Responsable Id", "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         AssignAttri(sPrefix, false, "A194EstadoResponsableId", StringUtil.LTrimStr( (decimal)(A194EstadoResponsableId), 4, 0));
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 60,'" + sPrefix + "',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtEstadoResponsableId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A194EstadoResponsableId), 4, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A194EstadoResponsableId), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,60);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEstadoResponsableId_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtEstadoResponsableId_Enabled, 1, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "NumMin", "right", false, "", "HLP_Responsable.htm");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtEstadoResponsableNombre_Internalname, "Estado Responsable Nombre", "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         ...
         GxWebStd.gx_single_line_edit( context, edtid_unidad_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A103id_unidad), 9, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A103id_unidad), "ZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,72);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtid_unidad_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtid_unidad_Enabled, 1, "number", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Responsable.htm");
         /* Static images/pictures */
         ClassString = "gx-prompt Image";
         StyleString = "";
         sImgUrl = (string)(context.GetImagePath( "f5b04895-0024-488b-8e3b-b687ca4598ee", "", context.GetTheme( )));
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2023124952335", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023124952352", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("responsable.js", "?2023124952352", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
