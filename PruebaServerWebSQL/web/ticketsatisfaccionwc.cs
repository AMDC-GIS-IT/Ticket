   ...
   public class ticketsatisfaccionwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV65Pgmname = "TicketSatisfaccionWC";
               context.Gx_err = 0;
               WS2T2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249512026", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV61Update)) ? AV67Update_GXI : context.convertURL( context.PathToRelativeUrl( AV61Update))), !bGXsfl_211_Refreshing);
                              ...
                              AssignProp(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV62Delete)) ? AV68Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV62Delete))), !bGXsfl_211_Refreshing);
      ...
      protected void STRUP2T0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            if ( context.localUtil.CToD( cgiGet( sPrefix+"GXH_vSATISFACCIONFECHA_FROM"), 2) != AV33SatisfaccionFecha_From )
            {
               GRID_nFirstRecordOnPage = 0;
            }
            if ( context.localUtil.CToD( cgiGet( sPrefix+"GXH_vUSUARIOFECHA_FROM"), 2) != AV36UsuarioFecha_From )
            {
               GRID_nFirstRecordOnPage = 0;
            }
            if ( StringUtil.StrCmp(cgiGet( sPrefix+"GXH_vSATISFACCIONRESUELTONOMBRE"), AV38SatisfaccionResueltoNombre) != 0 )
      ...
      protected void E222T2( )
      {
         ...
         new k2bloadrowsperpage(context ).execute(  AV65Pgmname,  "Grid", out  AV26RowsPerPageVariable, out  AV27RowsPerPageLoaded) ;
      ...
      protected void E232T2( )
      {
         ...
         AV66GXV1 = 1;
         while ( AV66GXV1 <= AV53Messages.Count )
         {
            AV54Message = ((GeneXus.Utils.SdtMessages_Message)AV53Messages.Item(AV66GXV1));
         ...
         AV59ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV65Pgmname;
      ...
      protected void S112( )
      {
         ...
         new k2bloadgridstate(context ).execute(  AV65Pgmname,  AV28GridStateKey, out  AV29GridState) ;
         ...
         AV69GXV2 = 1;
         while ( AV69GXV2 <= AV29GridState.gxTpr_Filtervalues.Count )
         {
            AV30GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV29GridState.gxTpr_Filtervalues.Item(AV69GXV2));
      ...
      protected void S132( )
      {
         ...
         AV29GridState.gxTpr_Filtervalues.Add(AV30GridStateFilterValue, 0);
         new k2bsavegridstate(context ).execute(  AV65Pgmname,  AV28GridStateKey,  AV29GridState) ;
      }
      ...
      protected void E142T2( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         CallWebObject(formatLink("exportticketsatisfaccionwc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6TicketId,10,0)),UrlEncode(DateTimeUtil.FormatDateParm(AV33SatisfaccionFecha_From)),UrlEncode(DateTimeUtil.FormatDateParm(AV34SatisfaccionFecha_To)),UrlEncode(DateTimeUtil.FormatDateParm(AV36UsuarioFecha_From)),UrlEncode(DateTimeUtil.FormatDateParm(AV37UsuarioFecha_To)),UrlEncode(StringUtil.RTrim(AV38SatisfaccionResueltoNombre)),UrlEncode(StringUtil.RTrim(AV39SatisfaccionTecnicoProblemaNombre)),UrlEncode(StringUtil.RTrim(AV40SatisfaccionTecnicoCompetenteNombre)),UrlEncode(StringUtil.RTrim(AV41SatisfaccionTecnicoProfesionalismoNombre)),UrlEncode(StringUtil.RTrim(AV42SatisfaccionTiempoNombre)),UrlEncode(StringUtil.RTrim(AV43SatisfaccionAtencionNombre)),UrlEncode(StringUtil.RTrim(AV48K2BToolsGenericSearchField)),UrlEncode(StringUtil.LTrimStr(AV49OrderedBy,4,0))}, new string[] {"TicketId","SatisfaccionFecha_From","SatisfaccionFecha_To","UsuarioFecha_From","UsuarioFecha_To","SatisfaccionResueltoNombre","SatisfaccionTecnicoProblemaNombre","SatisfaccionTecnicoCompetenteNombre","SatisfaccionTecnicoProfesionalismoNombre","SatisfaccionTiempoNombre","SatisfaccionAtencionNombre","K2BToolsGenericSearchField","OrderedBy"}) );
      ...
      protected void S202( )
      {
         ...
         AssignAttri(sPrefix, false, "AV24Att_SatisfaccionSugerencia_Visible", AV24Att_SatisfaccionSugerencia_Visible);
         new k2bsavegridconfiguration(context ).execute(  AV65Pgmname,  "Grid",  AV11GridConfiguration,  false) ;
         AV70GXV3 = 1;
         while ( AV70GXV3 <= AV11GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV14GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV11GridConfiguration.gxTpr_Gridcolumns.Item(AV70GXV3));
      ...
      protected void S122( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV38SatisfaccionResueltoNombre)) )
         {
            ...
            AV45K2BFilterValuesSDTItem.gxTpr_Description = "Satisfaccion Resuelto Nombre";
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV39SatisfaccionTecnicoProblemaNombre)) )
         {
            ...
            AV45K2BFilterValuesSDTItem.gxTpr_Description = "Satisfaccion Tecnico Problema Nombre";
            AV45K2BFilterValuesSDTItem.gxTpr_Type = "Standard";
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV40SatisfaccionTecnicoCompetenteNombre)) )
         {
            ...
            AV45K2BFilterValuesSDTItem.gxTpr_Description = "Satisfaccion Tecnico Competente Nombre";
            AV45K2BFilterValuesSDTItem.gxTpr_Type = "Standard";
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV41SatisfaccionTecnicoProfesionalismoNombre)) )
         {
            ...
            AV45K2BFilterValuesSDTItem.gxTpr_Description = "Satisfaccion Tecnico Profesionalismo Nombre";
            AV45K2BFilterValuesSDTItem.gxTpr_Type = "Standard";
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV42SatisfaccionTiempoNombre)) )
         {
            ...
            AV45K2BFilterValuesSDTItem.gxTpr_Description = "Satisfaccion Tiempo Nombre";
            AV45K2BFilterValuesSDTItem.gxTpr_Type = "Standard";
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV43SatisfaccionAtencionNombre)) )
         {
            ...
            AV45K2BFilterValuesSDTItem.gxTpr_Description = "Satisfaccion Atencion Nombre";
            AV45K2BFilterValuesSDTItem.gxTpr_Type = "Standard";
         ...
         if ( AV44K2BFilterValuesSDT.Count > 0 )
         {
            ...
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV65Pgmname,  "Grid",  AV44K2BFilterValuesSDT, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item4) ;
      ...
      protected void E152T2( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  AV65Pgmname,  "Grid", ref  AV11GridConfiguration) ;
         AV71GXV4 = 1;
         while ( AV71GXV4 <= AV11GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV14GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV11GridConfiguration.gxTpr_Gridcolumns.Item(AV71GXV4));
            if ( StringUtil.StrCmp(AV14GridColumn.gxTpr_Attributename, "SatisfaccionId") == 0 )
            {
         ...
         new k2bsavegridconfiguration(context ).execute(  AV65Pgmname,  "Grid",  AV11GridConfiguration,  true) ;
         AV52UC_OrderedBy = AV49OrderedBy;
         AssignAttri(sPrefix, false, "AV52UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV52UC_OrderedBy), 4, 0));
         if ( AV26RowsPerPageVariable != AV25GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV26RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, sPrefix+"GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV65Pgmname,  "Grid",  AV26RowsPerPageVariable) ;
            AV9CurrentPage = 1;
            AssignAttri(sPrefix, false, "AV9CurrentPage", StringUtil.LTrimStr( (decimal)(AV9CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void wb_table1_83_2T2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_satisfaccionresueltonombre_visible_Internalname, StringUtil.BoolToStr( AV18Att_SatisfaccionResueltoNombre_Visible), "", "Satisfaccion Resuelto Nombre", 1, chkavAtt_satisfaccionresueltonombre_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(130, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,130);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_satisfacciontecnicocompetentenombre_visible_Internalname, StringUtil.BoolToStr( AV20Att_SatisfaccionTecnicoCompetenteNombre_Visible), "", "Satisfaccion Tecnico Competente Nombre", 1, chkavAtt_satisfacciontecnicocompetentenombre_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(142, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,142);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_satisfacciontecnicoprofesionalismonombre_visible_Internalname, StringUtil.BoolToStr( AV21Att_SatisfaccionTecnicoProfesionalismoNombre_Visible), "", "Satisfaccion Tecnico Profesionalismo Nombre", 1, chkavAtt_satisfacciontecnicoprofesionalismonombre_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(148, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,148);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_satisfacciontiemponombre_visible_Internalname, StringUtil.BoolToStr( AV22Att_SatisfaccionTiempoNombre_Visible), "", "Satisfaccion Tiempo Nombre", 1, chkavAtt_satisfacciontiemponombre_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(154, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,154);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_satisfaccionatencionnombre_visible_Internalname, StringUtil.BoolToStr( AV23Att_SatisfaccionAtencionNombre_Visible), "", "Satisfaccion Atencion Nombre", 1, chkavAtt_satisfaccionatencionnombre_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(160, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,160);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249513084", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("ticketsatisfaccionwc.js", "?20231249513085", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/K2BDateRangePickerRender.js", "", false, true);
      ...
      protected void sendrow_2112( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_211_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV61Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV61Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV67Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV61Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV61Update)) ? AV67Update_GXI : context.PathToRelativeUrl( AV61Update));
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV62Delete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV62Delete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV68Delete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV62Delete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV62Delete)) ? AV68Delete_GXI : context.PathToRelativeUrl( AV62Delete));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E122T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV48K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV33SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV36UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV38SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV39SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV40SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV41SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV42SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV43SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV6TicketId',fld:'vTICKETID',pic:'ZZZZZZZZZ9'},{av:'AV31ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV49OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV37UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV65Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV58AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV60SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{av:'AV52UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV19Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV20Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV21Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E152T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV48K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV33SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV36UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV38SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV39SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV40SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV41SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV42SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV43SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV6TicketId',fld:'vTICKETID',pic:'ZZZZZZZZZ9'},{av:'AV31ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV49OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV37UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV65Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV58AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV60SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{av:'AV26RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV25GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV19Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV20Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV21Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E162T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV48K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV33SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV36UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV38SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV39SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV40SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV41SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV42SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV43SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV6TicketId',fld:'vTICKETID',pic:'ZZZZZZZZZ9'},{av:'AV31ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV49OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV37UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV65Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV58AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV60SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV19Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV20Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV21Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E172T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV48K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV33SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV36UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV38SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV39SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV40SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV41SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV42SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV43SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV6TicketId',fld:'vTICKETID',pic:'ZZZZZZZZZ9'},{av:'AV31ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV49OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV37UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV65Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV58AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV60SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV19Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV20Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV21Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E182T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV48K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV33SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV36UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV38SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV39SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV40SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV41SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV42SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV43SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV6TicketId',fld:'vTICKETID',pic:'ZZZZZZZZZ9'},{av:'AV31ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV49OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV37UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV65Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV58AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV60SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV19Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV20Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV21Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E192T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV48K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV33SatisfaccionFecha_From',fld:'vSATISFACCIONFECHA_FROM',pic:''},{av:'AV36UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV38SatisfaccionResueltoNombre',fld:'vSATISFACCIONRESUELTONOMBRE',pic:''},{av:'AV39SatisfaccionTecnicoProblemaNombre',fld:'vSATISFACCIONTECNICOPROBLEMANOMBRE',pic:''},{av:'AV40SatisfaccionTecnicoCompetenteNombre',fld:'vSATISFACCIONTECNICOCOMPETENTENOMBRE',pic:''},{av:'AV41SatisfaccionTecnicoProfesionalismoNombre',fld:'vSATISFACCIONTECNICOPROFESIONALISMONOMBRE',pic:''},{av:'AV42SatisfaccionTiempoNombre',fld:'vSATISFACCIONTIEMPONOMBRE',pic:''},{av:'AV43SatisfaccionAtencionNombre',fld:'vSATISFACCIONATENCIONNOMBRE',pic:''},{av:'AV6TicketId',fld:'vTICKETID',pic:'ZZZZZZZZZ9'},{av:'AV31ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV49OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV34SatisfaccionFecha_To',fld:'vSATISFACCIONFECHA_TO',pic:''},{av:'AV37UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV65Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV9CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV11GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV58AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV60SatisfaccionFecha_IsAuthorized',fld:'vSATISFACCIONFECHA_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV15Att_SatisfaccionId_Visible',fld:'vATT_SATISFACCIONID_VISIBLE',pic:''},{av:'AV16Att_SatisfaccionFecha_Visible',fld:'vATT_SATISFACCIONFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV18Att_SatisfaccionResueltoNombre_Visible',fld:'vATT_SATISFACCIONRESUELTONOMBRE_VISIBLE',pic:''},{av:'AV19Att_SatisfaccionTecnicoProblemaNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROBLEMANOMBRE_VISIBLE',pic:''},{av:'AV20Att_SatisfaccionTecnicoCompetenteNombre_Visible',fld:'vATT_SATISFACCIONTECNICOCOMPETENTENOMBRE_VISIBLE',pic:''},{av:'AV21Att_SatisfaccionTecnicoProfesionalismoNombre_Visible',fld:'vATT_SATISFACCIONTECNICOPROFESIONALISMONOMBRE_VISIBLE',pic:''},{av:'AV22Att_SatisfaccionTiempoNombre_Visible',fld:'vATT_SATISFACCIONTIEMPONOMBRE_VISIBLE',pic:''},{av:'AV23Att_SatisfaccionAtencionNombre_Visible',fld:'vATT_SATISFACCIONATENCIONNOMBRE_VISIBLE',pic:''},{av:'AV24Att_SatisfaccionSugerencia_Visible',fld:'vATT_SATISFACCIONSUGERENCIA_VISIBLE',pic:''},{av:'AV12FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         lV43SatisfaccionAtencionNombre = "";
         lV48K2BToolsGenericSearchField = "";
         H002T2_A15UsuarioId = new short[1] ;
         ...
         AV51GridOrder = new SdtK2BGridOrders_K2BGridOrdersItem(context);
         AV53Messages = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.ticketsatisfaccionwc__default(),
            new Object[][] {
                new Object[] {
               H002T2_A15UsuarioId, H002T2_A14TicketId, H002T2_A34SatisfaccionSugerencia, H002T2_A31SatisfaccionAtencionNombre, H002T2_A13SatisfaccionAtencionId, H002T2_A38SatisfaccionTiempoNombre, H002T2_A12SatisfaccionTiempoId, H002T2_A37SatisfaccionTecnicoProfesionalismoNombre, H002T2_A11SatisfaccionTecnicoProfesionalismoId, H002T2_A35SatisfaccionTecnicoCompetenteNombre,
               H002T2_A10SatisfaccionTecnicoCompetenteId, H002T2_A36SatisfaccionTecnicoProblemaNombre, H002T2_A9SatisfaccionTecnicoProblemaId, H002T2_A33SatisfaccionResueltoNombre, H002T2_A8SatisfaccionResueltoId, H002T2_A90UsuarioFecha, H002T2_A32SatisfaccionFecha, H002T2_A7SatisfaccionId
               }
               , new Object[] {
      ...
      private short[] H002T2_A15UsuarioId ;
      ...
      private GXBaseCollection<SdtMessages_Message> AV53Messages ;
