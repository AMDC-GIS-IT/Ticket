...
namespace GeneXus.Programs {
   public class wwresponsable : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249525171", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV36Update)) ? AV49Update_GXI : context.convertURL( context.PathToRelativeUrl( AV36Update))), !bGXsfl_146_Refreshing);
                              ...
                              AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV37Delete)) ? AV50Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV37Delete))), !bGXsfl_146_Refreshing);
      ...
      protected void E192N2( )
      {
         ...
         new k2bloadrowsperpage(context ).execute(  AV47Pgmname,  "Grid", out  AV22RowsPerPageVariable, out  AV23RowsPerPageLoaded) ;
      ...
      protected void E202N2( )
      {
         ...
         AV48GXV1 = 1;
         while ( AV48GXV1 <= AV33Messages.Count )
         {
            AV34Message = ((GeneXus.Utils.SdtMessages_Message)AV33Messages.Item(AV48GXV1));
         ...
         AV41ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV47Pgmname;
         ...
         AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV36Update)) ? AV49Update_GXI : context.convertURL( context.PathToRelativeUrl( AV36Update))), !bGXsfl_146_Refreshing);
         AssignProp("", false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV36Update), true);
         AV49Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "788f9b72-f982-49f9-99e4-c0374e31a85a", "", context.GetTheme( )));
         AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV36Update)) ? AV49Update_GXI : context.convertURL( context.PathToRelativeUrl( AV36Update))), !bGXsfl_146_Refreshing);
         AssignProp("", false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV36Update), true);
         ...
         AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV37Delete)) ? AV50Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV37Delete))), !bGXsfl_146_Refreshing);
         AssignProp("", false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV37Delete), true);
         AV50Delete_GXI = GXDbFile.PathToUrl( context.GetImagePath( "3e4a9f50-2c57-41b6-9da5-ebe49bca33c0", "", context.GetTheme( )));
         AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV37Delete)) ? AV50Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV37Delete))), !bGXsfl_146_Refreshing);
         AssignProp("", false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV37Delete), true);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV24GridStateKey = "";
         new k2bloadgridstate(context ).execute(  AV47Pgmname,  AV24GridStateKey, out  AV25GridState) ;
         ...
         AV51GXV2 = 1;
         while ( AV51GXV2 <= AV25GridState.gxTpr_Filtervalues.Count )
         {
            AV26GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV25GridState.gxTpr_Filtervalues.Item(AV51GXV2));
      ...
      protected void S122( )
      {
         ...
         new k2bsavegridstate(context ).execute(  AV47Pgmname,  AV24GridStateKey,  AV25GridState) ;
      }
      ...
      protected void E132N2( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         CallWebObject(formatLink("exportwwresponsable.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV28K2BToolsGenericSearchField)),UrlEncode(StringUtil.LTrimStr(AV29OrderedBy,4,0))}, new string[] {"K2BToolsGenericSearchField","OrderedBy"}) );
      ...
      protected void S192( )
      {
         ...
         AssignAttri("", false, "AV43Att_nombre_unidad_Visible", AV43Att_nombre_unidad_Visible);
         new k2bsavegridconfiguration(context ).execute(  AV47Pgmname,  "Grid",  AV10GridConfiguration,  false) ;
         AV52GXV3 = 1;
         while ( AV52GXV3 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV13GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV10GridConfiguration.gxTpr_Gridcolumns.Item(AV52GXV3));
      ...
      protected void E142N2( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  AV47Pgmname,  "Grid", ref  AV10GridConfiguration) ;
         AV53GXV4 = 1;
         while ( AV53GXV4 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV13GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV10GridConfiguration.gxTpr_Gridcolumns.Item(AV53GXV4));
            if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "ResponsableId") == 0 )
            {
         ...
         new k2bsavegridconfiguration(context ).execute(  AV47Pgmname,  "Grid",  AV10GridConfiguration,  true) ;
         AV32UC_OrderedBy = AV29OrderedBy;
         AssignAttri("", false, "AV32UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV32UC_OrderedBy), 4, 0));
         if ( AV22RowsPerPageVariable != AV21GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV22RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV47Pgmname,  "Grid",  AV22RowsPerPageVariable) ;
            AV8CurrentPage = 1;
            AssignAttri("", false, "AV8CurrentPage", StringUtil.LTrimStr( (decimal)(AV8CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249525527", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwresponsable.js", "?20231249525528", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      protected void sendrow_1462( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_146_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV36Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV36Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV49Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV36Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV36Update)) ? AV49Update_GXI : context.PathToRelativeUrl( AV36Update));
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV37Delete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV37Delete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV50Delete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV37Delete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV37Delete)) ? AV50Delete_GXI : context.PathToRelativeUrl( AV37Delete));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOEXPORT'","{handler:'E132N2',iparms:[{av:'AV28K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV29OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_ResponsableId_Visible',fld:'vATT_RESPONSABLEID_VISIBLE',pic:''},{av:'AV15Att_ResponsableIdentidad_Visible',fld:'vATT_RESPONSABLEIDENTIDAD_VISIBLE',pic:''},{av:'AV16Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV17Att_ResponsableUsuario_Visible',fld:'vATT_RESPONSABLEUSUARIO_VISIBLE',pic:''},{av:'AV18Att_ResponsableCargo_Visible',fld:'vATT_RESPONSABLECARGO_VISIBLE',pic:''},{av:'AV19Att_ResponsableEmail_Visible',fld:'vATT_RESPONSABLEEMAIL_VISIBLE',pic:''},{av:'AV20Att_ResponsableActivo_Visible',fld:'vATT_RESPONSABLEACTIVO_VISIBLE',pic:''},{av:'AV42Att_id_unidad_Visible',fld:'vATT_ID_UNIDAD_VISIBLE',pic:''},{av:'AV43Att_nombre_unidad_Visible',fld:'vATT_NOMBRE_UNIDAD_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOEXPORT'",",oparms:[{av:'AV29OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_ResponsableId_Visible',fld:'vATT_RESPONSABLEID_VISIBLE',pic:''},{av:'AV15Att_ResponsableIdentidad_Visible',fld:'vATT_RESPONSABLEIDENTIDAD_VISIBLE',pic:''},{av:'AV16Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV17Att_ResponsableUsuario_Visible',fld:'vATT_RESPONSABLEUSUARIO_VISIBLE',pic:''},{av:'AV18Att_ResponsableCargo_Visible',fld:'vATT_RESPONSABLECARGO_VISIBLE',pic:''},{av:'AV19Att_ResponsableEmail_Visible',fld:'vATT_RESPONSABLEEMAIL_VISIBLE',pic:''},{av:'AV20Att_ResponsableActivo_Visible',fld:'vATT_RESPONSABLEACTIVO_VISIBLE',pic:''},{av:'AV42Att_id_unidad_Visible',fld:'vATT_ID_UNIDAD_VISIBLE',pic:''},{av:'AV43Att_nombre_unidad_Visible',fld:'vATT_NOMBRE_UNIDAD_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         ...
         setEventMetadata("GRID.REFRESH","{handler:'E212N2',iparms:[{av:'AV27ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV29OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV28K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV47Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV44AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV35ResponsableIdentidad_IsAuthorized',fld:'vRESPONSABLEIDENTIDAD_ISAUTHORIZED',pic:''},{av:'AV14Att_ResponsableId_Visible',fld:'vATT_RESPONSABLEID_VISIBLE',pic:''},{av:'AV15Att_ResponsableIdentidad_Visible',fld:'vATT_RESPONSABLEIDENTIDAD_VISIBLE',pic:''},{av:'AV16Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV17Att_ResponsableUsuario_Visible',fld:'vATT_RESPONSABLEUSUARIO_VISIBLE',pic:''},{av:'AV18Att_ResponsableCargo_Visible',fld:'vATT_RESPONSABLECARGO_VISIBLE',pic:''},{av:'AV19Att_ResponsableEmail_Visible',fld:'vATT_RESPONSABLEEMAIL_VISIBLE',pic:''},{av:'AV20Att_ResponsableActivo_Visible',fld:'vATT_RESPONSABLEACTIVO_VISIBLE',pic:''},{av:'AV42Att_id_unidad_Visible',fld:'vATT_ID_UNIDAD_VISIBLE',pic:''},{av:'AV43Att_nombre_unidad_Visible',fld:'vATT_NOMBRE_UNIDAD_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E112N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV28K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV27ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV29OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV47Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV44AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV35ResponsableIdentidad_IsAuthorized',fld:'vRESPONSABLEIDENTIDAD_ISAUTHORIZED',pic:''},{av:'AV32UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_ResponsableId_Visible',fld:'vATT_RESPONSABLEID_VISIBLE',pic:''},{av:'AV15Att_ResponsableIdentidad_Visible',fld:'vATT_RESPONSABLEIDENTIDAD_VISIBLE',pic:''},{av:'AV16Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV17Att_ResponsableUsuario_Visible',fld:'vATT_RESPONSABLEUSUARIO_VISIBLE',pic:''},{av:'AV18Att_ResponsableCargo_Visible',fld:'vATT_RESPONSABLECARGO_VISIBLE',pic:''},{av:'AV19Att_ResponsableEmail_Visible',fld:'vATT_RESPONSABLEEMAIL_VISIBLE',pic:''},{av:'AV20Att_ResponsableActivo_Visible',fld:'vATT_RESPONSABLEACTIVO_VISIBLE',pic:''},{av:'AV42Att_id_unidad_Visible',fld:'vATT_ID_UNIDAD_VISIBLE',pic:''},{av:'AV43Att_nombre_unidad_Visible',fld:'vATT_NOMBRE_UNIDAD_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E142N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV28K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV27ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV29OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV47Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV44AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV35ResponsableIdentidad_IsAuthorized',fld:'vRESPONSABLEIDENTIDAD_ISAUTHORIZED',pic:''},{av:'AV22RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV21GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_ResponsableId_Visible',fld:'vATT_RESPONSABLEID_VISIBLE',pic:''},{av:'AV15Att_ResponsableIdentidad_Visible',fld:'vATT_RESPONSABLEIDENTIDAD_VISIBLE',pic:''},{av:'AV16Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV17Att_ResponsableUsuario_Visible',fld:'vATT_RESPONSABLEUSUARIO_VISIBLE',pic:''},{av:'AV18Att_ResponsableCargo_Visible',fld:'vATT_RESPONSABLECARGO_VISIBLE',pic:''},{av:'AV19Att_ResponsableEmail_Visible',fld:'vATT_RESPONSABLEEMAIL_VISIBLE',pic:''},{av:'AV20Att_ResponsableActivo_Visible',fld:'vATT_RESPONSABLEACTIVO_VISIBLE',pic:''},{av:'AV42Att_id_unidad_Visible',fld:'vATT_ID_UNIDAD_VISIBLE',pic:''},{av:'AV43Att_nombre_unidad_Visible',fld:'vATT_NOMBRE_UNIDAD_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E152N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV28K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV27ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV29OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV47Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV44AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV35ResponsableIdentidad_IsAuthorized',fld:'vRESPONSABLEIDENTIDAD_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_ResponsableId_Visible',fld:'vATT_RESPONSABLEID_VISIBLE',pic:''},{av:'AV15Att_ResponsableIdentidad_Visible',fld:'vATT_RESPONSABLEIDENTIDAD_VISIBLE',pic:''},{av:'AV16Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV17Att_ResponsableUsuario_Visible',fld:'vATT_RESPONSABLEUSUARIO_VISIBLE',pic:''},{av:'AV18Att_ResponsableCargo_Visible',fld:'vATT_RESPONSABLECARGO_VISIBLE',pic:''},{av:'AV19Att_ResponsableEmail_Visible',fld:'vATT_RESPONSABLEEMAIL_VISIBLE',pic:''},{av:'AV20Att_ResponsableActivo_Visible',fld:'vATT_RESPONSABLEACTIVO_VISIBLE',pic:''},{av:'AV42Att_id_unidad_Visible',fld:'vATT_ID_UNIDAD_VISIBLE',pic:''},{av:'AV43Att_nombre_unidad_Visible',fld:'vATT_NOMBRE_UNIDAD_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E162N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV28K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV27ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV29OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV47Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV44AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV35ResponsableIdentidad_IsAuthorized',fld:'vRESPONSABLEIDENTIDAD_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_ResponsableId_Visible',fld:'vATT_RESPONSABLEID_VISIBLE',pic:''},{av:'AV15Att_ResponsableIdentidad_Visible',fld:'vATT_RESPONSABLEIDENTIDAD_VISIBLE',pic:''},{av:'AV16Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV17Att_ResponsableUsuario_Visible',fld:'vATT_RESPONSABLEUSUARIO_VISIBLE',pic:''},{av:'AV18Att_ResponsableCargo_Visible',fld:'vATT_RESPONSABLECARGO_VISIBLE',pic:''},{av:'AV19Att_ResponsableEmail_Visible',fld:'vATT_RESPONSABLEEMAIL_VISIBLE',pic:''},{av:'AV20Att_ResponsableActivo_Visible',fld:'vATT_RESPONSABLEACTIVO_VISIBLE',pic:''},{av:'AV42Att_id_unidad_Visible',fld:'vATT_ID_UNIDAD_VISIBLE',pic:''},{av:'AV43Att_nombre_unidad_Visible',fld:'vATT_NOMBRE_UNIDAD_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E172N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV28K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV27ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV29OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV47Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV44AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV35ResponsableIdentidad_IsAuthorized',fld:'vRESPONSABLEIDENTIDAD_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_ResponsableId_Visible',fld:'vATT_RESPONSABLEID_VISIBLE',pic:''},{av:'AV15Att_ResponsableIdentidad_Visible',fld:'vATT_RESPONSABLEIDENTIDAD_VISIBLE',pic:''},{av:'AV16Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV17Att_ResponsableUsuario_Visible',fld:'vATT_RESPONSABLEUSUARIO_VISIBLE',pic:''},{av:'AV18Att_ResponsableCargo_Visible',fld:'vATT_RESPONSABLECARGO_VISIBLE',pic:''},{av:'AV19Att_ResponsableEmail_Visible',fld:'vATT_RESPONSABLEEMAIL_VISIBLE',pic:''},{av:'AV20Att_ResponsableActivo_Visible',fld:'vATT_RESPONSABLEACTIVO_VISIBLE',pic:''},{av:'AV42Att_id_unidad_Visible',fld:'vATT_ID_UNIDAD_VISIBLE',pic:''},{av:'AV43Att_nombre_unidad_Visible',fld:'vATT_NOMBRE_UNIDAD_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E182N2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV28K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV27ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV29OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV47Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV44AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV35ResponsableIdentidad_IsAuthorized',fld:'vRESPONSABLEIDENTIDAD_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_ResponsableId_Visible',fld:'vATT_RESPONSABLEID_VISIBLE',pic:''},{av:'AV15Att_ResponsableIdentidad_Visible',fld:'vATT_RESPONSABLEIDENTIDAD_VISIBLE',pic:''},{av:'AV16Att_ResponsableNombre_Visible',fld:'vATT_RESPONSABLENOMBRE_VISIBLE',pic:''},{av:'AV17Att_ResponsableUsuario_Visible',fld:'vATT_RESPONSABLEUSUARIO_VISIBLE',pic:''},{av:'AV18Att_ResponsableCargo_Visible',fld:'vATT_RESPONSABLECARGO_VISIBLE',pic:''},{av:'AV19Att_ResponsableEmail_Visible',fld:'vATT_RESPONSABLEEMAIL_VISIBLE',pic:''},{av:'AV20Att_ResponsableActivo_Visible',fld:'vATT_RESPONSABLEACTIVO_VISIBLE',pic:''},{av:'AV42Att_id_unidad_Visible',fld:'vATT_ID_UNIDAD_VISIBLE',pic:''},{av:'AV43Att_nombre_unidad_Visible',fld:'vATT_NOMBRE_UNIDAD_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV31GridOrder = new SdtK2BGridOrders_K2BGridOrdersItem(context);
         AV33Messages = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
      ...
      private GXBaseCollection<SdtMessages_Message> AV33Messages ;
