...
namespace GeneXus.Programs {
   public class entitymanagerestadosatisfaccion : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249524791", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB240( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0047"+"", StringUtil.RTrim( WebComp_Componentwc_satisfaccion_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0053"+"", StringUtil.RTrim( WebComp_Componentwc_satisfaccion1_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0059"+"", StringUtil.RTrim( WebComp_Componentwc_satisfaccion2_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0065"+"", StringUtil.RTrim( WebComp_Componentwc_satisfaccion3_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0071"+"", StringUtil.RTrim( WebComp_Componentwc_satisfaccion4_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0077"+"", StringUtil.RTrim( WebComp_Componentwc_satisfaccion5_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_83_242( true) ;
         }
         else
         {
            wb_table1_83_242( false) ;
         }
         return  ;
      }

      protected void wb_table1_83_242e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldComponentwc_satisfaccion = cgiGet( "W0047");
                           ...
                           if ( StringUtil.Len( WebComp_Componentwc_satisfaccion_Component) != 0 )
                           {
                              WebComp_Componentwc_satisfaccion.componentprocess("W0047", "", sEvt);
                           }
                           WebComp_Componentwc_satisfaccion_Component = OldComponentwc_satisfaccion;
                        }
                        else if ( nCmpId == 53 )
                        {
                           OldComponentwc_satisfaccion1 = cgiGet( "W0053");
                           ...
                           if ( StringUtil.Len( WebComp_Componentwc_satisfaccion1_Component) != 0 )
                           {
                              WebComp_Componentwc_satisfaccion1.componentprocess("W0053", "", sEvt);
                           }
                           WebComp_Componentwc_satisfaccion1_Component = OldComponentwc_satisfaccion1;
                        }
                        else if ( nCmpId == 59 )
                        {
                           OldComponentwc_satisfaccion2 = cgiGet( "W0059");
                           ...
                           if ( StringUtil.Len( WebComp_Componentwc_satisfaccion2_Component) != 0 )
                           {
                              WebComp_Componentwc_satisfaccion2.componentprocess("W0059", "", sEvt);
                           }
                           WebComp_Componentwc_satisfaccion2_Component = OldComponentwc_satisfaccion2;
                        }
                        else if ( nCmpId == 65 )
                        {
                           OldComponentwc_satisfaccion3 = cgiGet( "W0065");
                           ...
                           if ( StringUtil.Len( WebComp_Componentwc_satisfaccion3_Component) != 0 )
                           {
                              WebComp_Componentwc_satisfaccion3.componentprocess("W0065", "", sEvt);
                           }
                           WebComp_Componentwc_satisfaccion3_Component = OldComponentwc_satisfaccion3;
                        }
                        else if ( nCmpId == 71 )
                        {
                           OldComponentwc_satisfaccion4 = cgiGet( "W0071");
                           ...
                           if ( StringUtil.Len( WebComp_Componentwc_satisfaccion4_Component) != 0 )
                           {
                              WebComp_Componentwc_satisfaccion4.componentprocess("W0071", "", sEvt);
                           }
                           WebComp_Componentwc_satisfaccion4_Component = OldComponentwc_satisfaccion4;
                        }
                        else if ( nCmpId == 77 )
                        {
                           OldComponentwc_satisfaccion5 = cgiGet( "W0077");
                           ...
                           if ( StringUtil.Len( WebComp_Componentwc_satisfaccion5_Component) != 0 )
                           {
                              WebComp_Componentwc_satisfaccion5.componentprocess("W0077", "", sEvt);
                           }
                           WebComp_Componentwc_satisfaccion5_Component = OldComponentwc_satisfaccion5;
                        }
                        else if ( nCmpId == 103 )
                        {
                           OldPopupcomponent = cgiGet( "W0103");
                           ...
                           {
                              WebComp_Popupcomponent.componentprocess("W0103", "", sEvt);
                           }
                           WebComp_Popupcomponent_Component = OldPopupcomponent;
                        }
                     }
      ...
      protected void E12242( )
      {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               lblComponenttitle_Caption = StringUtil.Format( "Actualizar %1", "Estado Satisfaccion", "", "", "", "", "", "", "", "");
               ...
               if ( StringUtil.Len( WebComp_Popupcomponent_Component) != 0 )
               {
                  ...
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0103",(string)"",(string)"UPD",(short)AV6EstadoSatisfaccionId});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
         {
            if ( ( StringUtil.StrCmp(AV8TabCode, "General") == 0 ) || String.IsNullOrEmpty(StringUtil.RTrim( AV8TabCode)) )
            {
               lblComponenttitle_Caption = StringUtil.Format( "Eliminar %1", "Estado Satisfaccion", "", "", "", "", "", "", "", "");
               AssignProp("", false, lblComponenttitle_Internalname, "Caption", lblComponenttitle_Caption, true);
               tblTablemodal_Visible = 1;
               AssignProp("", false, tblTablemodal_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(tblTablemodal_Visible), 5, 0), true);
               /* Object Property */
               ...
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0103",(string)"",(string)"DLT",(short)AV6EstadoSatisfaccionId});
                  WebComp_Popupcomponent.componentbind(new Object[] {(string)"",(string)""});
               }
               if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Popupcomponent )
               {
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            ...
            if ( StringUtil.Len( WebComp_Componentwc_general_Component) != 0 )
            {
               ...
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0041",(string)"",(string)Gx_mode,(short)AV6EstadoSatisfaccionId,(string)AV8TabCode});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0041",(string)"",(string)"DSP",(short)AV6EstadoSatisfaccionId,(string)AV8TabCode});
               WebComp_Componentwc_general.componentbind(new Object[] {(string)"",(string)"",(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Componentwc_general )
            {
         ...
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "Satisfaccion",  "Satisfaccion",  "List",  "",  "EstadoSatisfaccionSatisfaccionWC") )
         {
            if ( StringUtil.StrCmp(Gx_mode, "INS") != 0 )
            {
               ...
               if ( StringUtil.Len( WebComp_Componentwc_satisfaccion_Component) != 0 )
               {
                  ...
                  WebComp_Componentwc_satisfaccion.componentprepare(new Object[] {(string)"W0047",(string)"",(short)AV6EstadoSatisfaccionId});
         ...
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "Satisfaccion",  "Satisfaccion",  "List",  "",  "EstadoSatisfaccionSatisfaccionWC1") )
         {
            if ( StringUtil.StrCmp(Gx_mode, "INS") != 0 )
            {
               ...
               if ( StringUtil.Len( WebComp_Componentwc_satisfaccion1_Component) != 0 )
               {
                  ...
                  WebComp_Componentwc_satisfaccion1.componentprepare(new Object[] {(string)"W0053",(string)"",(short)AV6EstadoSatisfaccionId});
         ...
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "Satisfaccion",  "Satisfaccion",  "List",  "",  "EstadoSatisfaccionSatisfaccionWC2") )
         {
            if ( StringUtil.StrCmp(Gx_mode, "INS") != 0 )
            {
               ...
               if ( StringUtil.Len( WebComp_Componentwc_satisfaccion2_Component) != 0 )
               {
                  ...
                  WebComp_Componentwc_satisfaccion2.componentprepare(new Object[] {(string)"W0059",(string)"",(short)AV6EstadoSatisfaccionId});
         ...
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "Satisfaccion",  "Satisfaccion",  "List",  "",  "EstadoSatisfaccionSatisfaccionWC3") )
         {
            if ( StringUtil.StrCmp(Gx_mode, "INS") != 0 )
            {
               ...
               if ( StringUtil.Len( WebComp_Componentwc_satisfaccion3_Component) != 0 )
               {
                  ...
                  WebComp_Componentwc_satisfaccion3.componentprepare(new Object[] {(string)"W0065",(string)"",(short)AV6EstadoSatisfaccionId});
         ...
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "Satisfaccion",  "Satisfaccion",  "List",  "",  "EstadoSatisfaccionSatisfaccionWC4") )
         {
            if ( StringUtil.StrCmp(Gx_mode, "INS") != 0 )
            {
               ...
               if ( StringUtil.Len( WebComp_Componentwc_satisfaccion4_Component) != 0 )
               {
                  ...
                  WebComp_Componentwc_satisfaccion4.componentprepare(new Object[] {(string)"W0071",(string)"",(short)AV6EstadoSatisfaccionId});
         ...
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "Satisfaccion",  "Satisfaccion",  "List",  "",  "EstadoSatisfaccionSatisfaccionWC5") )
         {
            if ( StringUtil.StrCmp(Gx_mode, "INS") != 0 )
            {
               ...
               if ( StringUtil.Len( WebComp_Componentwc_satisfaccion5_Component) != 0 )
               {
                  ...
                  WebComp_Componentwc_satisfaccion5.componentprepare(new Object[] {(string)"W0077",(string)"",(short)AV6EstadoSatisfaccionId});
      ...
      protected void wb_table1_83_242( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_89_242( true) ;
         }
         else
         {
            wb_table2_89_242( false) ;
         }
         return  ;
      }

      protected void wb_table2_89_242e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0103"+"", StringUtil.RTrim( WebComp_Popupcomponent_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            wb_table1_83_242e( true) ;
         }
         else
         {
            wb_table1_83_242e( false) ;
         }
      }

      protected void wb_table2_89_242( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblComponenttitle_Internalname, lblComponenttitle_Caption, "", "", lblComponenttitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "PopupTitle", 0, "", 1, 1, 0, 0, "HLP_EntityManagerEstadoSatisfaccion.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table3_94_242( true) ;
         }
         else
         {
            wb_table3_94_242( false) ;
         }
         return  ;
      }

      protected void wb_table3_94_242e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_89_242e( true) ;
         }
         else
         {
            wb_table2_89_242e( false) ;
         }
      }

      protected void wb_table3_94_242( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'CLOSEMODAL\\'."+"'", "", "PopupHeaderButton", 5, "", 1, 1, 0, 0, "HLP_EntityManagerEstadoSatisfaccion.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_94_242e( true) ;
         }
         else
         {
            wb_table3_94_242e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023124952494", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("entitymanagerestadosatisfaccion.js", "?2023124952494", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH",",oparms:[{av:'AV20RelatedTransactionName',fld:'vRELATEDTRANSACTIONNAME',pic:'',hsh:true},{av:'tblTablemodal_Visible',ctrl:'TABLEMODAL',prop:'Visible'},{av:'lblComponenttitle_Caption',ctrl:'COMPONENTTITLE',prop:'Caption'},{ctrl:'POPUPCOMPONENT'},{av:'AV18AvailableComponents',fld:'vAVAILABLECOMPONENTS',pic:'',hsh:true},{ctrl:'TABSTRIP'},{av:'divComponentcontainer_general_Visible',ctrl:'COMPONENTCONTAINER_GENERAL',prop:'Visible'},{av:'divComponentcontainer_satisfaccion_Visible',ctrl:'COMPONENTCONTAINER_SATISFACCION',prop:'Visible'},{av:'divComponentcontainer_satisfaccion1_Visible',ctrl:'COMPONENTCONTAINER_SATISFACCION1',prop:'Visible'},{av:'divComponentcontainer_satisfaccion2_Visible',ctrl:'COMPONENTCONTAINER_SATISFACCION2',prop:'Visible'},{av:'divComponentcontainer_satisfaccion3_Visible',ctrl:'COMPONENTCONTAINER_SATISFACCION3',prop:'Visible'},{av:'divComponentcontainer_satisfaccion4_Visible',ctrl:'COMPONENTCONTAINER_SATISFACCION4',prop:'Visible'},{av:'divComponentcontainer_satisfaccion5_Visible',ctrl:'COMPONENTCONTAINER_SATISFACCION5',prop:'Visible'},{av:'divComponentscontainer_components_Visible',ctrl:'COMPONENTSCONTAINER_COMPONENTS',prop:'Visible'},{ctrl:'COMPONENTWC_GENERAL'},{ctrl:'COMPONENTWC_SATISFACCION'},{ctrl:'COMPONENTWC_SATISFACCION1'},{ctrl:'COMPONENTWC_SATISFACCION2'},{ctrl:'COMPONENTWC_SATISFACCION3'},{ctrl:'COMPONENTWC_SATISFACCION4'},{ctrl:'COMPONENTWC_SATISFACCION5'}]}");
         setEventMetadata("GLOBALEVENTS.K2BT_REFRESHENTITYMANAGER","{handler:'E13242',iparms:[{av:'AV22GE_ComponentName',fld:'vGE_COMPONENTNAME',pic:''},{av:'AV21GE_EntityManagerName',fld:'vGE_ENTITYMANAGERNAME',pic:''},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV6EstadoSatisfaccionId',fld:'vESTADOSATISFACCIONID',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("'CLOSEMODAL'","{handler:'E14242',iparms:[]");
