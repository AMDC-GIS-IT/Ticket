...
namespace GeneXus.Programs {
   public class exportestadosatisfaccionsatisfaccionwc : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV8SatisfaccionResueltoId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  ...
                  AV16SatisfaccionTecnicoProblemaNombre = GetPar( "SatisfaccionTecnicoProblemaNombre");
      ...
      public exportestadosatisfaccionsatisfaccionwc( )
      {
      ...
      public exportestadosatisfaccionsatisfaccionwc( IGxContext context )
      {
      ...
      {
         this.AV8SatisfaccionResueltoId = aP0_SatisfaccionResueltoId;
         ...
         this.AV16SatisfaccionTecnicoProblemaNombre = aP5_SatisfaccionTecnicoProblemaNombre;
      ...
      public short executeUdp( short aP0_SatisfaccionResueltoId ,
                               DateTime aP1_SatisfaccionFecha_From ,
                               DateTime aP2_SatisfaccionFecha_To ,
                               DateTime aP3_UsuarioFecha_From ,
                               DateTime aP4_UsuarioFecha_To ,
                               ...
                               string aP10_K2BToolsGenericSearchField )
      {
         execute(aP0_SatisfaccionResueltoId, aP1_SatisfaccionFecha_From, aP2_SatisfaccionFecha_To, aP3_UsuarioFecha_From, aP4_UsuarioFecha_To, aP5_SatisfaccionTecnicoProblemaNombre, aP6_SatisfaccionTecnicoCompetenteNombre, aP7_SatisfaccionTecnicoProfesionalismoNombre, aP8_SatisfaccionTiempoNombre, aP9_SatisfaccionAtencionNombre, aP10_K2BToolsGenericSearchField, ref aP11_OrderedBy);
         return AV21OrderedBy ;
      }

      public void executeSubmit( short aP0_SatisfaccionResueltoId ,
                                 DateTime aP1_SatisfaccionFecha_From ,
                                 DateTime aP2_SatisfaccionFecha_To ,
                                 DateTime aP3_UsuarioFecha_From ,
                                 DateTime aP4_UsuarioFecha_To ,
                                 ...
                                 ref short aP11_OrderedBy )
      {
         exportestadosatisfaccionsatisfaccionwc objexportestadosatisfaccionsatisfaccionwc;
         objexportestadosatisfaccionsatisfaccionwc = new exportestadosatisfaccionsatisfaccionwc();
         objexportestadosatisfaccionsatisfaccionwc.AV8SatisfaccionResueltoId = aP0_SatisfaccionResueltoId;
         objexportestadosatisfaccionsatisfaccionwc.AV11SatisfaccionFecha_From = aP1_SatisfaccionFecha_From;
         objexportestadosatisfaccionsatisfaccionwc.AV12SatisfaccionFecha_To = aP2_SatisfaccionFecha_To;
         objexportestadosatisfaccionsatisfaccionwc.AV14UsuarioFecha_From = aP3_UsuarioFecha_From;
         objexportestadosatisfaccionsatisfaccionwc.AV15UsuarioFecha_To = aP4_UsuarioFecha_To;
         objexportestadosatisfaccionsatisfaccionwc.AV16SatisfaccionTecnicoProblemaNombre = aP5_SatisfaccionTecnicoProblemaNombre;
         objexportestadosatisfaccionsatisfaccionwc.AV17SatisfaccionTecnicoCompetenteNombre = aP6_SatisfaccionTecnicoCompetenteNombre;
         objexportestadosatisfaccionsatisfaccionwc.AV18SatisfaccionTecnicoProfesionalismoNombre = aP7_SatisfaccionTecnicoProfesionalismoNombre;
         objexportestadosatisfaccionsatisfaccionwc.AV19SatisfaccionTiempoNombre = aP8_SatisfaccionTiempoNombre;
         objexportestadosatisfaccionsatisfaccionwc.AV20SatisfaccionAtencionNombre = aP9_SatisfaccionAtencionNombre;
         objexportestadosatisfaccionsatisfaccionwc.AV9K2BToolsGenericSearchField = aP10_K2BToolsGenericSearchField;
         objexportestadosatisfaccionsatisfaccionwc.AV21OrderedBy = aP11_OrderedBy;
         objexportestadosatisfaccionsatisfaccionwc.context.SetSubmitInitialConfig(context);
         objexportestadosatisfaccionsatisfaccionwc.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objexportestadosatisfaccionsatisfaccionwc);
         aP11_OrderedBy=this.AV21OrderedBy;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((exportestadosatisfaccionsatisfaccionwc)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         AV27Filename = GxDirectory.TemporaryFilesPath + AV30File.Separator + "ExportEstadoSatisfaccionSatisfaccionWC-" + StringUtil.Trim( StringUtil.Str( (decimal)(AV25Random), 8, 0)) + ".xlsx";
         ...
         /* Using cursor P002Z2 */
         pr_default.execute(0, new Object[] {AV8SatisfaccionResueltoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A4EstadoSatisfaccionId = P002Z2_A4EstadoSatisfaccionId[0];
            A22EstadoSatisfaccionNombre = P002Z2_A22EstadoSatisfaccionNombre[0];
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16SatisfaccionTecnicoProblemaNombre)) )
         {
            AV22ExcelDocument.get_Cells(AV23CellRow, AV24FirstColumn+0, 1, 1).Bold = 1;
            AV22ExcelDocument.get_Cells(AV23CellRow, AV24FirstColumn+0, 1, 1).Text = "Satisfaccion Tecnico Problema Nombre";
            AV22ExcelDocument.get_Cells(AV23CellRow, AV24FirstColumn+1, 1, 1).Text = StringUtil.RTrim( AV16SatisfaccionTecnicoProblemaNombre);
            AV23CellRow = (int)(AV23CellRow+1);
         }
         ...
         if ( AV42GridColumnVisible_SatisfaccionTecnicoProblemaNombre )
         {
            AV22ExcelDocument.get_Cells(AV23CellRow, AV24FirstColumn+AV26ColumnIndex, 1, 1).Bold = 1;
            AV22ExcelDocument.get_Cells(AV23CellRow, AV24FirstColumn+AV26ColumnIndex, 1, 1).Text = "Satisfaccion Tecnico Problema Nombre";
            AV26ColumnIndex = (short)(AV26ColumnIndex+1);
         }
         ...
         pr_default.dynParam(1, new Object[]{ new Object[]{
                                              ...
                                              AV16SatisfaccionTecnicoProblemaNombre ,
         ...
         lV16SatisfaccionTecnicoProblemaNombre = StringUtil.Concat( StringUtil.RTrim( AV16SatisfaccionTecnicoProblemaNombre), "%", "");
         ...
         lV9K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV9K2BToolsGenericSearchField), 200, "%");
         /* Using cursor P002Z3 */
         pr_default.execute(1, new Object[] {AV8SatisfaccionResueltoId, AV12SatisfaccionFecha_To, AV11SatisfaccionFecha_From, AV15UsuarioFecha_To, AV14UsuarioFecha_From, lV16SatisfaccionTecnicoProblemaNombre, lV17SatisfaccionTecnicoCompetenteNombre, lV18SatisfaccionTecnicoProfesionalismoNombre, lV19SatisfaccionTiempoNombre, lV20SatisfaccionAtencionNombre, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A9SatisfaccionTecnicoProblemaId = P002Z3_A9SatisfaccionTecnicoProblemaId[0];
            A10SatisfaccionTecnicoCompetenteId = P002Z3_A10SatisfaccionTecnicoCompetenteId[0];
            A11SatisfaccionTecnicoProfesionalismoId = P002Z3_A11SatisfaccionTecnicoProfesionalismoId[0];
            A12SatisfaccionTiempoId = P002Z3_A12SatisfaccionTiempoId[0];
            A13SatisfaccionAtencionId = P002Z3_A13SatisfaccionAtencionId[0];
            A34SatisfaccionSugerencia = P002Z3_A34SatisfaccionSugerencia[0];
            A94UsuarioRequerimiento = P002Z3_A94UsuarioRequerimiento[0];
            A93UsuarioNombre = P002Z3_A93UsuarioNombre[0];
            A15UsuarioId = P002Z3_A15UsuarioId[0];
            A14TicketId = P002Z3_A14TicketId[0];
            A7SatisfaccionId = P002Z3_A7SatisfaccionId[0];
            A31SatisfaccionAtencionNombre = P002Z3_A31SatisfaccionAtencionNombre[0];
            A38SatisfaccionTiempoNombre = P002Z3_A38SatisfaccionTiempoNombre[0];
            A37SatisfaccionTecnicoProfesionalismoNombre = P002Z3_A37SatisfaccionTecnicoProfesionalismoNombre[0];
            A35SatisfaccionTecnicoCompetenteNombre = P002Z3_A35SatisfaccionTecnicoCompetenteNombre[0];
            A36SatisfaccionTecnicoProblemaNombre = P002Z3_A36SatisfaccionTecnicoProblemaNombre[0];
            A90UsuarioFecha = P002Z3_A90UsuarioFecha[0];
            A32SatisfaccionFecha = P002Z3_A32SatisfaccionFecha[0];
            A8SatisfaccionResueltoId = P002Z3_A8SatisfaccionResueltoId[0];
            A36SatisfaccionTecnicoProblemaNombre = P002Z3_A36SatisfaccionTecnicoProblemaNombre[0];
            A35SatisfaccionTecnicoCompetenteNombre = P002Z3_A35SatisfaccionTecnicoCompetenteNombre[0];
            A37SatisfaccionTecnicoProfesionalismoNombre = P002Z3_A37SatisfaccionTecnicoProfesionalismoNombre[0];
            A38SatisfaccionTiempoNombre = P002Z3_A38SatisfaccionTiempoNombre[0];
         ...
         if ( ! context.isAjaxRequest( ) )
         {
            AV29HttpResponse.AppendHeader("Content-Disposition", "attachment;filename=ExportEstadoSatisfaccionSatisfaccionWC.xlsx");
         }
         if ( ! context.isAjaxRequest( ) )
         {
      ...
      protected void S121( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  "EstadoSatisfaccionSatisfaccionWC",  "Grid", ref  AV31GridConfiguration) ;
         ...
         AV42GridColumnVisible_SatisfaccionTecnicoProblemaNombre = true;
         ...
         new k2bsavegridconfiguration(context ).execute(  "EstadoSatisfaccionSatisfaccionWC",  "Grid",  AV31GridConfiguration,  false) ;
         AV33GridColumns = AV31GridConfiguration.gxTpr_Gridcolumns;
         AV55GXV1 = 1;
         while ( AV55GXV1 <= AV33GridColumns.Count )
         {
            ...
            if ( ! AV34GridColumn.gxTpr_Showattribute )
            {
               ...
               {
                  AV42GridColumnVisible_SatisfaccionTecnicoProblemaNombre = false;
               }
      ...
      protected void S131( )
      {
         ...
         AV34GridColumn.gxTpr_Columntitle = "Satisfaccion Tecnico Problema Nombre";
         AV34GridColumn.gxTpr_Showattribute = true;
         AV33GridColumns.Add(AV34GridColumn, 0);
         AV34GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         P002Z2_A4EstadoSatisfaccionId = new short[1] ;
         P002Z2_A22EstadoSatisfaccionNombre = new string[] {""} ;
         A22EstadoSatisfaccionNombre = "";
         lV16SatisfaccionTecnicoProblemaNombre = "";
         ...
         A94UsuarioRequerimiento = "";
         A34SatisfaccionSugerencia = "";
         P002Z3_A9SatisfaccionTecnicoProblemaId = new short[1] ;
         P002Z3_A10SatisfaccionTecnicoCompetenteId = new short[1] ;
         P002Z3_A11SatisfaccionTecnicoProfesionalismoId = new short[1] ;
         P002Z3_A12SatisfaccionTiempoId = new short[1] ;
         P002Z3_A13SatisfaccionAtencionId = new short[1] ;
         P002Z3_A34SatisfaccionSugerencia = new string[] {""} ;
         P002Z3_A94UsuarioRequerimiento = new string[] {""} ;
         P002Z3_A93UsuarioNombre = new string[] {""} ;
         P002Z3_A15UsuarioId = new short[1] ;
         P002Z3_A14TicketId = new long[1] ;
         P002Z3_A7SatisfaccionId = new long[1] ;
         P002Z3_A31SatisfaccionAtencionNombre = new string[] {""} ;
         P002Z3_A38SatisfaccionTiempoNombre = new string[] {""} ;
         P002Z3_A37SatisfaccionTecnicoProfesionalismoNombre = new string[] {""} ;
         P002Z3_A35SatisfaccionTecnicoCompetenteNombre = new string[] {""} ;
         P002Z3_A36SatisfaccionTecnicoProblemaNombre = new string[] {""} ;
         P002Z3_A90UsuarioFecha = new DateTime[] {DateTime.MinValue} ;
         P002Z3_A32SatisfaccionFecha = new DateTime[] {DateTime.MinValue} ;
         P002Z3_A8SatisfaccionResueltoId = new short[1] ;
         GXt_dtime1 = (DateTime)(DateTime.MinValue);
         AV31GridConfiguration = new SdtK2BGridConfiguration(context);
         AV33GridColumns = new GXBaseCollection<SdtK2BGridColumns_K2BGridColumnsItem>( context, "K2BGridColumnsItem", "kb_ticket");
         AV34GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.exportestadosatisfaccionsatisfaccionwc__default(),
            new Object[][] {
                new Object[] {
               P002Z2_A4EstadoSatisfaccionId, P002Z2_A22EstadoSatisfaccionNombre
               }
               , new Object[] {
               P002Z3_A9SatisfaccionTecnicoProblemaId, P002Z3_A10SatisfaccionTecnicoCompetenteId, P002Z3_A11SatisfaccionTecnicoProfesionalismoId, P002Z3_A12SatisfaccionTiempoId, P002Z3_A13SatisfaccionAtencionId, P002Z3_A34SatisfaccionSugerencia, P002Z3_A94UsuarioRequerimiento, P002Z3_A93UsuarioNombre, P002Z3_A15UsuarioId, P002Z3_A14TicketId,
               P002Z3_A7SatisfaccionId, P002Z3_A31SatisfaccionAtencionNombre, P002Z3_A38SatisfaccionTiempoNombre, P002Z3_A37SatisfaccionTecnicoProfesionalismoNombre, P002Z3_A35SatisfaccionTecnicoCompetenteNombre, P002Z3_A36SatisfaccionTecnicoProblemaNombre, P002Z3_A90UsuarioFecha, P002Z3_A32SatisfaccionFecha, P002Z3_A8SatisfaccionResueltoId
               }
            }
         );
         AV52Pgmname = "ExportEstadoSatisfaccionSatisfaccionWC";
         /* GeneXus formulas. */
         AV52Pgmname = "ExportEstadoSatisfaccionSatisfaccionWC";
         context.Gx_err = 0;
      }
      ...
      private short AV8SatisfaccionResueltoId ;
      ...
      private bool AV42GridColumnVisible_SatisfaccionTecnicoProblemaNombre ;
      ...
      private string AV16SatisfaccionTecnicoProblemaNombre ;
      ...
      private string lV16SatisfaccionTecnicoProblemaNombre ;
      ...
      private short[] P002Z2_A4EstadoSatisfaccionId ;
      private string[] P002Z2_A22EstadoSatisfaccionNombre ;
      private short[] P002Z3_A9SatisfaccionTecnicoProblemaId ;
      private short[] P002Z3_A10SatisfaccionTecnicoCompetenteId ;
      private short[] P002Z3_A11SatisfaccionTecnicoProfesionalismoId ;
      private short[] P002Z3_A12SatisfaccionTiempoId ;
      private short[] P002Z3_A13SatisfaccionAtencionId ;
      private string[] P002Z3_A34SatisfaccionSugerencia ;
      private string[] P002Z3_A94UsuarioRequerimiento ;
      private string[] P002Z3_A93UsuarioNombre ;
      private short[] P002Z3_A15UsuarioId ;
      private long[] P002Z3_A14TicketId ;
      private long[] P002Z3_A7SatisfaccionId ;
      private string[] P002Z3_A31SatisfaccionAtencionNombre ;
      private string[] P002Z3_A38SatisfaccionTiempoNombre ;
      private string[] P002Z3_A37SatisfaccionTecnicoProfesionalismoNombre ;
      private string[] P002Z3_A35SatisfaccionTecnicoCompetenteNombre ;
      private string[] P002Z3_A36SatisfaccionTecnicoProblemaNombre ;
      private DateTime[] P002Z3_A90UsuarioFecha ;
      private DateTime[] P002Z3_A32SatisfaccionFecha ;
      private short[] P002Z3_A8SatisfaccionResueltoId ;
   ...
   public class exportestadosatisfaccionsatisfaccionwc__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P002Z3( IGxContext context ,
                                             ...
                                             string AV16SatisfaccionTecnicoProblemaNombre ,
                                             ...
                                             short AV21OrderedBy ,
                                             short AV8SatisfaccionResueltoId ,
                                             short A8SatisfaccionResueltoId )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16SatisfaccionTecnicoProblemaNombre)) )
         {
            AddWhere(sWhereString, "(T2.[EstadoSatisfaccionNombre] like @lV16SatisfaccionTecnicoProblemaNombre)");
         }
         else
         {
            GXv_int2[5] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_P002Z3(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (short)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] , (short)dynConstraints[25] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8SatisfaccionResueltoId",GXType.Int16,4,0)
          };
          Object[] prmP002Z3;
          ...
          new ParDef("@lV16SatisfaccionTecnicoProblemaNombre",GXType.NVarChar,30,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("P002Z2", "SELECT TOP 1 [EstadoSatisfaccionId], [EstadoSatisfaccionNombre] FROM [EstadoSatisfaccion] WHERE [EstadoSatisfaccionId] = @AV8SatisfaccionResueltoId ORDER BY [EstadoSatisfaccionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP002Z2,1, GxCacheFrequency.OFF ,false,true )
