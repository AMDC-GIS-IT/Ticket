...
namespace GeneXus.Programs {
   public class exportestadosatisfaccionsatisfaccionwc3 : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV8SatisfaccionTecnicoProfesionalismoId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      public exportestadosatisfaccionsatisfaccionwc3( )
      {
      ...
      public exportestadosatisfaccionsatisfaccionwc3( IGxContext context )
      {
      ...
      {
         this.AV8SatisfaccionTecnicoProfesionalismoId = aP0_SatisfaccionTecnicoProfesionalismoId;
      ...
      public short executeUdp( short aP0_SatisfaccionTecnicoProfesionalismoId ,
                               DateTime aP1_SatisfaccionFecha_From ,
                               DateTime aP2_SatisfaccionFecha_To ,
                               DateTime aP3_UsuarioFecha_From ,
                               DateTime aP4_UsuarioFecha_To ,
                               ...
                               string aP10_K2BToolsGenericSearchField )
      {
         execute(aP0_SatisfaccionTecnicoProfesionalismoId, aP1_SatisfaccionFecha_From, aP2_SatisfaccionFecha_To, aP3_UsuarioFecha_From, aP4_UsuarioFecha_To, aP5_SatisfaccionResueltoNombre, aP6_SatisfaccionTecnicoProblemaNombre, aP7_SatisfaccionTecnicoCompetenteNombre, aP8_SatisfaccionTiempoNombre, aP9_SatisfaccionAtencionNombre, aP10_K2BToolsGenericSearchField, ref aP11_OrderedBy);
      ...
      public void executeSubmit( short aP0_SatisfaccionTecnicoProfesionalismoId ,
                                 ...
                                 ref short aP11_OrderedBy )
      {
         exportestadosatisfaccionsatisfaccionwc3 objexportestadosatisfaccionsatisfaccionwc3;
         objexportestadosatisfaccionsatisfaccionwc3 = new exportestadosatisfaccionsatisfaccionwc3();
         objexportestadosatisfaccionsatisfaccionwc3.AV8SatisfaccionTecnicoProfesionalismoId = aP0_SatisfaccionTecnicoProfesionalismoId;
         objexportestadosatisfaccionsatisfaccionwc3.AV11SatisfaccionFecha_From = aP1_SatisfaccionFecha_From;
         objexportestadosatisfaccionsatisfaccionwc3.AV12SatisfaccionFecha_To = aP2_SatisfaccionFecha_To;
         objexportestadosatisfaccionsatisfaccionwc3.AV14UsuarioFecha_From = aP3_UsuarioFecha_From;
         objexportestadosatisfaccionsatisfaccionwc3.AV15UsuarioFecha_To = aP4_UsuarioFecha_To;
         objexportestadosatisfaccionsatisfaccionwc3.AV16SatisfaccionResueltoNombre = aP5_SatisfaccionResueltoNombre;
         objexportestadosatisfaccionsatisfaccionwc3.AV17SatisfaccionTecnicoProblemaNombre = aP6_SatisfaccionTecnicoProblemaNombre;
         objexportestadosatisfaccionsatisfaccionwc3.AV18SatisfaccionTecnicoCompetenteNombre = aP7_SatisfaccionTecnicoCompetenteNombre;
         objexportestadosatisfaccionsatisfaccionwc3.AV19SatisfaccionTiempoNombre = aP8_SatisfaccionTiempoNombre;
         objexportestadosatisfaccionsatisfaccionwc3.AV20SatisfaccionAtencionNombre = aP9_SatisfaccionAtencionNombre;
         objexportestadosatisfaccionsatisfaccionwc3.AV9K2BToolsGenericSearchField = aP10_K2BToolsGenericSearchField;
         objexportestadosatisfaccionsatisfaccionwc3.AV21OrderedBy = aP11_OrderedBy;
         objexportestadosatisfaccionsatisfaccionwc3.context.SetSubmitInitialConfig(context);
         objexportestadosatisfaccionsatisfaccionwc3.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objexportestadosatisfaccionsatisfaccionwc3);
         aP11_OrderedBy=this.AV21OrderedBy;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((exportestadosatisfaccionsatisfaccionwc3)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         AV27Filename = GxDirectory.TemporaryFilesPath + AV30File.Separator + "ExportEstadoSatisfaccionSatisfaccionWC3-" + StringUtil.Trim( StringUtil.Str( (decimal)(AV25Random), 8, 0)) + ".xlsx";
         ...
         /* Using cursor P00322 */
         pr_default.execute(0, new Object[] {AV8SatisfaccionTecnicoProfesionalismoId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A4EstadoSatisfaccionId = P00322_A4EstadoSatisfaccionId[0];
            A22EstadoSatisfaccionNombre = P00322_A22EstadoSatisfaccionNombre[0];
         ...
         pr_default.dynParam(1, new Object[]{ new Object[]{
                                              ...
                                              AV21OrderedBy ,
                                              AV8SatisfaccionTecnicoProfesionalismoId ,
         ...
         lV9K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV9K2BToolsGenericSearchField), 200, "%");
         /* Using cursor P00323 */
         pr_default.execute(1, new Object[] {AV8SatisfaccionTecnicoProfesionalismoId, AV12SatisfaccionFecha_To, AV11SatisfaccionFecha_From, AV15UsuarioFecha_To, AV14UsuarioFecha_From, lV16SatisfaccionResueltoNombre, lV17SatisfaccionTecnicoProblemaNombre, lV18SatisfaccionTecnicoCompetenteNombre, lV19SatisfaccionTiempoNombre, lV20SatisfaccionAtencionNombre, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A8SatisfaccionResueltoId = P00323_A8SatisfaccionResueltoId[0];
            A9SatisfaccionTecnicoProblemaId = P00323_A9SatisfaccionTecnicoProblemaId[0];
            A10SatisfaccionTecnicoCompetenteId = P00323_A10SatisfaccionTecnicoCompetenteId[0];
            A12SatisfaccionTiempoId = P00323_A12SatisfaccionTiempoId[0];
            A13SatisfaccionAtencionId = P00323_A13SatisfaccionAtencionId[0];
            A34SatisfaccionSugerencia = P00323_A34SatisfaccionSugerencia[0];
            A94UsuarioRequerimiento = P00323_A94UsuarioRequerimiento[0];
            A93UsuarioNombre = P00323_A93UsuarioNombre[0];
            A15UsuarioId = P00323_A15UsuarioId[0];
            A14TicketId = P00323_A14TicketId[0];
            A7SatisfaccionId = P00323_A7SatisfaccionId[0];
            A31SatisfaccionAtencionNombre = P00323_A31SatisfaccionAtencionNombre[0];
            A38SatisfaccionTiempoNombre = P00323_A38SatisfaccionTiempoNombre[0];
            A35SatisfaccionTecnicoCompetenteNombre = P00323_A35SatisfaccionTecnicoCompetenteNombre[0];
            A36SatisfaccionTecnicoProblemaNombre = P00323_A36SatisfaccionTecnicoProblemaNombre[0];
            A33SatisfaccionResueltoNombre = P00323_A33SatisfaccionResueltoNombre[0];
            A90UsuarioFecha = P00323_A90UsuarioFecha[0];
            A32SatisfaccionFecha = P00323_A32SatisfaccionFecha[0];
            A11SatisfaccionTecnicoProfesionalismoId = P00323_A11SatisfaccionTecnicoProfesionalismoId[0];
            A33SatisfaccionResueltoNombre = P00323_A33SatisfaccionResueltoNombre[0];
            A36SatisfaccionTecnicoProblemaNombre = P00323_A36SatisfaccionTecnicoProblemaNombre[0];
            A35SatisfaccionTecnicoCompetenteNombre = P00323_A35SatisfaccionTecnicoCompetenteNombre[0];
            A38SatisfaccionTiempoNombre = P00323_A38SatisfaccionTiempoNombre[0];
         ...
         if ( ! context.isAjaxRequest( ) )
         {
            AV29HttpResponse.AppendHeader("Content-Disposition", "attachment;filename=ExportEstadoSatisfaccionSatisfaccionWC3.xlsx");
         }
         if ( ! context.isAjaxRequest( ) )
         {
      ...
      protected void S121( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  "EstadoSatisfaccionSatisfaccionWC3",  "Grid", ref  AV31GridConfiguration) ;
         ...
         new k2bsavegridconfiguration(context ).execute(  "EstadoSatisfaccionSatisfaccionWC3",  "Grid",  AV31GridConfiguration,  false) ;
         AV33GridColumns = AV31GridConfiguration.gxTpr_Gridcolumns;
         AV55GXV1 = 1;
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         P00322_A4EstadoSatisfaccionId = new short[1] ;
         P00322_A22EstadoSatisfaccionNombre = new string[] {""} ;
         ...
         A94UsuarioRequerimiento = "";
         A34SatisfaccionSugerencia = "";
         P00323_A8SatisfaccionResueltoId = new short[1] ;
         P00323_A9SatisfaccionTecnicoProblemaId = new short[1] ;
         P00323_A10SatisfaccionTecnicoCompetenteId = new short[1] ;
         P00323_A12SatisfaccionTiempoId = new short[1] ;
         P00323_A13SatisfaccionAtencionId = new short[1] ;
         P00323_A34SatisfaccionSugerencia = new string[] {""} ;
         P00323_A94UsuarioRequerimiento = new string[] {""} ;
         P00323_A93UsuarioNombre = new string[] {""} ;
         P00323_A15UsuarioId = new short[1] ;
         P00323_A14TicketId = new long[1] ;
         P00323_A7SatisfaccionId = new long[1] ;
         P00323_A31SatisfaccionAtencionNombre = new string[] {""} ;
         P00323_A38SatisfaccionTiempoNombre = new string[] {""} ;
         P00323_A35SatisfaccionTecnicoCompetenteNombre = new string[] {""} ;
         P00323_A36SatisfaccionTecnicoProblemaNombre = new string[] {""} ;
         P00323_A33SatisfaccionResueltoNombre = new string[] {""} ;
         P00323_A90UsuarioFecha = new DateTime[] {DateTime.MinValue} ;
         P00323_A32SatisfaccionFecha = new DateTime[] {DateTime.MinValue} ;
         P00323_A11SatisfaccionTecnicoProfesionalismoId = new short[1] ;
         GXt_dtime1 = (DateTime)(DateTime.MinValue);
         AV31GridConfiguration = new SdtK2BGridConfiguration(context);
         AV33GridColumns = new GXBaseCollection<SdtK2BGridColumns_K2BGridColumnsItem>( context, "K2BGridColumnsItem", "kb_ticket");
         AV34GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.exportestadosatisfaccionsatisfaccionwc3__default(),
            new Object[][] {
                new Object[] {
               P00322_A4EstadoSatisfaccionId, P00322_A22EstadoSatisfaccionNombre
               }
               , new Object[] {
               P00323_A8SatisfaccionResueltoId, P00323_A9SatisfaccionTecnicoProblemaId, P00323_A10SatisfaccionTecnicoCompetenteId, P00323_A12SatisfaccionTiempoId, P00323_A13SatisfaccionAtencionId, P00323_A34SatisfaccionSugerencia, P00323_A94UsuarioRequerimiento, P00323_A93UsuarioNombre, P00323_A15UsuarioId, P00323_A14TicketId,
               P00323_A7SatisfaccionId, P00323_A31SatisfaccionAtencionNombre, P00323_A38SatisfaccionTiempoNombre, P00323_A35SatisfaccionTecnicoCompetenteNombre, P00323_A36SatisfaccionTecnicoProblemaNombre, P00323_A33SatisfaccionResueltoNombre, P00323_A90UsuarioFecha, P00323_A32SatisfaccionFecha, P00323_A11SatisfaccionTecnicoProfesionalismoId
               }
            }
         );
         AV52Pgmname = "ExportEstadoSatisfaccionSatisfaccionWC3";
         /* GeneXus formulas. */
         AV52Pgmname = "ExportEstadoSatisfaccionSatisfaccionWC3";
         context.Gx_err = 0;
      }
      ...
      private short AV8SatisfaccionTecnicoProfesionalismoId ;
      ...
      private short[] P00322_A4EstadoSatisfaccionId ;
      private string[] P00322_A22EstadoSatisfaccionNombre ;
      private short[] P00323_A8SatisfaccionResueltoId ;
      private short[] P00323_A9SatisfaccionTecnicoProblemaId ;
      private short[] P00323_A10SatisfaccionTecnicoCompetenteId ;
      private short[] P00323_A12SatisfaccionTiempoId ;
      private short[] P00323_A13SatisfaccionAtencionId ;
      private string[] P00323_A34SatisfaccionSugerencia ;
      private string[] P00323_A94UsuarioRequerimiento ;
      private string[] P00323_A93UsuarioNombre ;
      private short[] P00323_A15UsuarioId ;
      private long[] P00323_A14TicketId ;
      private long[] P00323_A7SatisfaccionId ;
      private string[] P00323_A31SatisfaccionAtencionNombre ;
      private string[] P00323_A38SatisfaccionTiempoNombre ;
      private string[] P00323_A35SatisfaccionTecnicoCompetenteNombre ;
      private string[] P00323_A36SatisfaccionTecnicoProblemaNombre ;
      private string[] P00323_A33SatisfaccionResueltoNombre ;
      private DateTime[] P00323_A90UsuarioFecha ;
      private DateTime[] P00323_A32SatisfaccionFecha ;
      private short[] P00323_A11SatisfaccionTecnicoProfesionalismoId ;
   ...
   public class exportestadosatisfaccionsatisfaccionwc3__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P00323( IGxContext context ,
                                             ...
                                             short AV21OrderedBy ,
                                             short AV8SatisfaccionTecnicoProfesionalismoId ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_P00323(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (short)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] , (short)dynConstraints[25] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV8SatisfaccionTecnicoProfesionalismoId",GXType.Int16,4,0)
          };
          Object[] prmP00323;
          ...
          def= new CursorDef[] {
              new CursorDef("P00322", "SELECT TOP 1 [EstadoSatisfaccionId], [EstadoSatisfaccionNombre] FROM [EstadoSatisfaccion] WHERE [EstadoSatisfaccionId] = @AV8SatisfaccionTecnicoProfesionalismoId ORDER BY [EstadoSatisfaccionId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00322,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00323", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00323,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
