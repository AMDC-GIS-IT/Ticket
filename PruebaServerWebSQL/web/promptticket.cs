...
namespace GeneXus.Programs {
   public class promptticket : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249555793", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void STRUP4T0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.CToD( cgiGet( "GXH_vTICKETFECHA_FROM"), 2) != AV19TicketFecha_From )
            {
               GRID_nFirstRecordOnPage = 0;
            }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202312495616", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("promptticket.js", "?202312495616", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/K2BDateRangePickerRender.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         H004T2_A15UsuarioId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.promptticket__default(),
            new Object[][] {
                new Object[] {
               H004T2_A57TicketOtros, H004T2_A52TicketInstalarDataShow, H004T2_A41TicketApoyoUsuario, H004T2_A87TicketUps, H004T2_A58TicketPerifericos, H004T2_A43TicketDiscoDuroExterno, H004T2_A51TicketIngenieria, H004T2_A44TicketDisenio, H004T2_A40TicketAplicacion, H004T2_A39TicketAntivirus,
               H004T2_A56TicketOffice, H004T2_A60TicketSistemaOperativo, H004T2_A59TicketRouter, H004T2_A45TicketEscaner, H004T2_A50TicketImpresora, H004T2_A55TicketMonitor, H004T2_A42TicketDesktop, H004T2_A53TicketLaptop, H004T2_A54TicketLastId, H004T2_A94UsuarioRequerimiento,
               H004T2_A93UsuarioNombre, H004T2_A15UsuarioId, H004T2_A48TicketHora, H004T2_A46TicketFecha, H004T2_A14TicketId
               }
               , new Object[] {
      ...
      private short[] H004T2_A15UsuarioId ;
