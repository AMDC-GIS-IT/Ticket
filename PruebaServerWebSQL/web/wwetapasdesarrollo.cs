...
namespace GeneXus.Programs {
   public class wwetapasdesarrollo : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwetapasdesarrollo( )
      {
      ...
      public wwetapasdesarrollo( IGxContext context )
      {
      ...
      {
         chkavAtt_etapadesarrolloid_visible = new GXCheckbox();
         chkavAtt_etapadesarrollonombre_visible = new GXCheckbox();
         chkavAtt_etapadesarrollousuarioregistro_visible = new GXCheckbox();
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV31EtapaDesarrolloNombre_IsAuthorized = StringUtil.StrToBool( GetPar( "EtapaDesarrolloNombre_IsAuthorized"));
               AV14Att_EtapaDesarrolloId_Visible = StringUtil.StrToBool( GetPar( "Att_EtapaDesarrolloId_Visible"));
               AV15Att_EtapaDesarrolloNombre_Visible = StringUtil.StrToBool( GetPar( "Att_EtapaDesarrolloNombre_Visible"));
               AV16Att_EtapaDesarrolloUsuarioRegistro_Visible = StringUtil.StrToBool( GetPar( "Att_EtapaDesarrolloUsuarioRegistro_Visible"));
               ...
               gxgrGrid_refresh( subGrid_Rows, AV24K2BToolsGenericSearchField, AV23ClassCollection, AV25OrderedBy, AV8CurrentPage, AV40Pgmname, AV10GridConfiguration, AV31EtapaDesarrolloNombre_IsAuthorized, AV14Att_EtapaDesarrolloId_Visible, AV15Att_EtapaDesarrolloNombre_Visible, AV16Att_EtapaDesarrolloUsuarioRegistro_Visible, AV11FreezeColumnTitles) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249571316", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwetapasdesarrollo.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vETAPADESARROLLONOMBRE_ISAUTHORIZED", AV31EtapaDesarrolloNombre_IsAuthorized);
      ...
      {
         return formatLink("wwetapasdesarrollo.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WWEtapasDesarrollo" ;
      }

      public override string GetPgmdesc( )
      {
         return "Etapas desarrollos" ;
      }
      ...
      protected void WB770( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPgmdescriptortextblock_Internalname, "Etapas desarrollos", "", "", lblPgmdescriptortextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_WWEtapasDesarrollo.htm");
      ...
      protected void wb_table1_24_772e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" width="+StringUtil.LTrimStr( (decimal)(38), 4, 0)+"px"+" class=\""+"Attribute_Grid"+"\" "+" style=\""+((edtEtapaDesarrolloId_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
               context.SendWebValue( "Id") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute_Grid"+"\" "+" style=\""+((edtEtapaDesarrolloNombre_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
               context.SendWebValue( "Desarrollo Nombre") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute_Grid"+"\" "+" style=\""+((edtEtapaDesarrolloUsuarioRegistro_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtEtapaDesarrolloId_Visible), 5, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A291EtapaDesarrolloNombre);
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtEtapaDesarrolloNombre_Link));
               GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtEtapaDesarrolloNombre_Visible), 5, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A292EtapaDesarrolloUsuarioRegistro);
               GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtEtapaDesarrolloUsuarioRegistro_Visible), 5, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         if ( wbEnd == 110 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_118_772( true) ;
         }
         else
         {
            wb_table2_118_772( false) ;
         }
         return  ;
      }

      protected void wb_table2_118_772e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagebuttontextblock_Internalname, "", "", "", lblPreviouspagebuttontextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOPREVIOUS\\'."+"'", "", lblPreviouspagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_WWEtapasDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFirstpagetextblock_Internalname, lblFirstpagetextblock_Caption, "", "", lblFirstpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOFIRST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblFirstpagetextblock_Visible, 1, 0, 0, "HLP_WWEtapasDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacinglefttextblock_Internalname, "...", "", "", lblSpacinglefttextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacinglefttextblock_Visible, 1, 0, 0, "HLP_WWEtapasDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagetextblock_Internalname, lblPreviouspagetextblock_Caption, "", "", lblPreviouspagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOPREVIOUS\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPreviouspagetextblock_Visible, 1, 0, 0, "HLP_WWEtapasDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCurrentpagetextblock_Internalname, lblCurrentpagetextblock_Caption, "", "", lblCurrentpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_WWEtapasDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagetextblock_Internalname, lblNextpagetextblock_Caption, "", "", lblNextpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DONEXT\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblNextpagetextblock_Visible, 1, 0, 0, "HLP_WWEtapasDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacingrighttextblock_Internalname, "...", "", "", lblSpacingrighttextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacingrighttextblock_Visible, 1, 0, 0, "HLP_WWEtapasDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLastpagetextblock_Internalname, lblLastpagetextblock_Caption, "", "", lblLastpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOLAST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblLastpagetextblock_Visible, 1, 0, 0, "HLP_WWEtapasDesarrollo.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagebuttontextblock_Internalname, "", "", "", lblNextpagebuttontextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DONEXT\\'."+"'", "", lblNextpagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_WWEtapasDesarrollo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START772( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Etapas desarrollos", 0) ;
         }
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV32Update)) ? AV42Update_GXI : context.convertURL( context.PathToRelativeUrl( AV32Update))), !bGXsfl_110_Refreshing);
                              ...
                              AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV33Delete)) ? AV43Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV33Delete))), !bGXsfl_110_Refreshing);
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV31EtapaDesarrolloNombre_IsAuthorized ,
                                       bool AV14Att_EtapaDesarrolloId_Visible ,
                                       bool AV15Att_EtapaDesarrolloNombre_Visible ,
                                       bool AV16Att_EtapaDesarrolloUsuarioRegistro_Visible ,
      ...
      {
         AV14Att_EtapaDesarrolloId_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV14Att_EtapaDesarrolloId_Visible));
         AssignAttri("", false, "AV14Att_EtapaDesarrolloId_Visible", AV14Att_EtapaDesarrolloId_Visible);
         AV15Att_EtapaDesarrolloNombre_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV15Att_EtapaDesarrolloNombre_Visible));
         AssignAttri("", false, "AV15Att_EtapaDesarrolloNombre_Visible", AV15Att_EtapaDesarrolloNombre_Visible);
         AV16Att_EtapaDesarrolloUsuarioRegistro_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV16Att_EtapaDesarrolloUsuarioRegistro_Visible));
         AssignAttri("", false, "AV16Att_EtapaDesarrolloUsuarioRegistro_Visible", AV16Att_EtapaDesarrolloUsuarioRegistro_Visible);
      ...
      {
         /* GeneXus formulas. */
         AV40Pgmname = "WWEtapasDesarrollo";
         context.Gx_err = 0;
      }
      ...
      protected void RF772( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A292EtapaDesarrolloUsuarioRegistro = H00772_A292EtapaDesarrolloUsuarioRegistro[0];
               A291EtapaDesarrolloNombre = H00772_A291EtapaDesarrolloNombre[0];
               A290EtapaDesarrolloId = H00772_A290EtapaDesarrolloId[0];
               E22772 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         GRID_nRecordCount = H00773_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void STRUP770( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV14Att_EtapaDesarrolloId_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_etapadesarrolloid_visible_Internalname));
            AssignAttri("", false, "AV14Att_EtapaDesarrolloId_Visible", AV14Att_EtapaDesarrolloId_Visible);
            AV15Att_EtapaDesarrolloNombre_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_etapadesarrollonombre_visible_Internalname));
            AssignAttri("", false, "AV15Att_EtapaDesarrolloNombre_Visible", AV15Att_EtapaDesarrolloNombre_Visible);
            AV16Att_EtapaDesarrolloUsuarioRegistro_Visible = StringUtil.StrToBool( cgiGet( chkavAtt_etapadesarrollousuarioregistro_visible_Internalname));
            AssignAttri("", false, "AV16Att_EtapaDesarrolloUsuarioRegistro_Visible", AV16Att_EtapaDesarrolloUsuarioRegistro_Visible);
      ...
      protected void E19772( )
      {
         ...
         new k2bloadrowsperpage(context ).execute(  AV40Pgmname,  "Grid", out  AV18RowsPerPageVariable, out  AV19RowsPerPageLoaded) ;
         ...
         GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
         Form.Caption = "Etapas desarrollos";
      ...
      protected void E20772( )
      {
         ...
         AV41GXV1 = 1;
         while ( AV41GXV1 <= AV29Messages.Count )
         {
            AV30Message = ((GeneXus.Utils.SdtMessages_Message)AV29Messages.Item(AV41GXV1));
         ...
         AV37ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "EtapasDesarrollo";
         AV37ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "EtapasDesarrollo";
         ...
         AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV32Update)) ? AV42Update_GXI : context.convertURL( context.PathToRelativeUrl( AV32Update))), !bGXsfl_110_Refreshing);
         AssignProp("", false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV32Update), true);
         AV42Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "788f9b72-f982-49f9-99e4-c0374e31a85a", "", context.GetTheme( )));
         AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV32Update)) ? AV42Update_GXI : context.convertURL( context.PathToRelativeUrl( AV32Update))), !bGXsfl_110_Refreshing);
         AssignProp("", false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV32Update), true);
         ...
         AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV33Delete)) ? AV43Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV33Delete))), !bGXsfl_110_Refreshing);
         AssignProp("", false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV33Delete), true);
         AV43Delete_GXI = GXDbFile.PathToUrl( context.GetImagePath( "3e4a9f50-2c57-41b6-9da5-ebe49bca33c0", "", context.GetTheme( )));
         AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV33Delete)) ? AV43Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV33Delete))), !bGXsfl_110_Refreshing);
         AssignProp("", false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV33Delete), true);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV20GridStateKey = "";
         new k2bloadgridstate(context ).execute(  AV40Pgmname,  AV20GridStateKey, out  AV21GridState) ;
         ...
         AV44GXV2 = 1;
         while ( AV44GXV2 <= AV21GridState.gxTpr_Filtervalues.Count )
         {
            AV22GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV21GridState.gxTpr_Filtervalues.Item(AV44GXV2));
      ...
      protected void S122( )
      {
         ...
         new k2bsavegridstate(context ).execute(  AV40Pgmname,  AV20GridStateKey,  AV21GridState) ;
      }
      ...
      protected void S182( )
      {
         ...
         new k2bsettrncontextbyname(context ).execute(  "EtapasDesarrollo",  AV34TrnContext) ;
      }
      ...
      protected void E12772( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "EtapasDesarrollo",  "EtapasDesarrollo",  "Insert",  "",  "EntityManagerEtapasDesarrollo") )
         {
            CallWebObject(formatLink("entitymanageretapasdesarrollo.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"Mode","EtapaDesarrolloId","TabCode"}) );
            context.wjLocDisableFrm = 1;
         }
      }
      ...
      protected void E13772( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         CallWebObject(formatLink("exportwwetapasdesarrollo.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV24K2BToolsGenericSearchField)),UrlEncode(StringUtil.LTrimStr(AV25OrderedBy,4,0))}, new string[] {"K2BToolsGenericSearchField","OrderedBy"}) );
      ...
      protected void S192( )
      {
         ...
         returnInSub = false;
         edtEtapaDesarrolloId_Visible = 1;
         AssignProp("", false, edtEtapaDesarrolloId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtEtapaDesarrolloId_Visible), 5, 0), !bGXsfl_110_Refreshing);
         AV14Att_EtapaDesarrolloId_Visible = true;
         AssignAttri("", false, "AV14Att_EtapaDesarrolloId_Visible", AV14Att_EtapaDesarrolloId_Visible);
         edtEtapaDesarrolloNombre_Visible = 1;
         AssignProp("", false, edtEtapaDesarrolloNombre_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtEtapaDesarrolloNombre_Visible), 5, 0), !bGXsfl_110_Refreshing);
         AV15Att_EtapaDesarrolloNombre_Visible = true;
         AssignAttri("", false, "AV15Att_EtapaDesarrolloNombre_Visible", AV15Att_EtapaDesarrolloNombre_Visible);
         edtEtapaDesarrolloUsuarioRegistro_Visible = 1;
         AssignProp("", false, edtEtapaDesarrolloUsuarioRegistro_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtEtapaDesarrolloUsuarioRegistro_Visible), 5, 0), !bGXsfl_110_Refreshing);
         AV16Att_EtapaDesarrolloUsuarioRegistro_Visible = true;
         AssignAttri("", false, "AV16Att_EtapaDesarrolloUsuarioRegistro_Visible", AV16Att_EtapaDesarrolloUsuarioRegistro_Visible);
         new k2bsavegridconfiguration(context ).execute(  AV40Pgmname,  "Grid",  AV10GridConfiguration,  false) ;
         AV45GXV3 = 1;
         while ( AV45GXV3 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            ...
            {
               if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "EtapaDesarrolloId") == 0 )
               {
                  edtEtapaDesarrolloId_Visible = 0;
                  AssignProp("", false, edtEtapaDesarrolloId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtEtapaDesarrolloId_Visible), 5, 0), !bGXsfl_110_Refreshing);
                  AV14Att_EtapaDesarrolloId_Visible = false;
                  AssignAttri("", false, "AV14Att_EtapaDesarrolloId_Visible", AV14Att_EtapaDesarrolloId_Visible);
               }
               else if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "EtapaDesarrolloNombre") == 0 )
               {
                  edtEtapaDesarrolloNombre_Visible = 0;
                  AssignProp("", false, edtEtapaDesarrolloNombre_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtEtapaDesarrolloNombre_Visible), 5, 0), !bGXsfl_110_Refreshing);
                  AV15Att_EtapaDesarrolloNombre_Visible = false;
                  AssignAttri("", false, "AV15Att_EtapaDesarrolloNombre_Visible", AV15Att_EtapaDesarrolloNombre_Visible);
               }
               else if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "EtapaDesarrolloUsuarioRegistro") == 0 )
               {
                  edtEtapaDesarrolloUsuarioRegistro_Visible = 0;
                  AssignProp("", false, edtEtapaDesarrolloUsuarioRegistro_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtEtapaDesarrolloUsuarioRegistro_Visible), 5, 0), !bGXsfl_110_Refreshing);
                  AV16Att_EtapaDesarrolloUsuarioRegistro_Visible = false;
                  AssignAttri("", false, "AV16Att_EtapaDesarrolloUsuarioRegistro_Visible", AV16Att_EtapaDesarrolloUsuarioRegistro_Visible);
               }
            }
      ...
      protected void S172( )
      {
         ...
         AV13GridColumn.gxTpr_Attributename = "EtapaDesarrolloId";
         AV13GridColumn.gxTpr_Columntitle = "Id";
         AV13GridColumn.gxTpr_Showattribute = true;
         AV12GridColumns.Add(AV13GridColumn, 0);
         AV13GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV13GridColumn.gxTpr_Attributename = "EtapaDesarrolloNombre";
         AV13GridColumn.gxTpr_Columntitle = "Desarrollo Nombre";
         AV13GridColumn.gxTpr_Showattribute = true;
         AV12GridColumns.Add(AV13GridColumn, 0);
         AV13GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV13GridColumn.gxTpr_Attributename = "EtapaDesarrolloUsuarioRegistro";
      ...
      protected void S202( )
      {
         ...
         AV37ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "EtapasDesarrollo";
         AV37ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "EtapasDesarrollo";
         AV37ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = "ReportWWEtapasDesarrollo";
         AV36ActivityList.Add(AV37ActivityListItem, 0);
         AV37ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         AV37ActivityListItem.gxTpr_Activity.gxTpr_Standardactivitytype = "List";
         AV37ActivityListItem.gxTpr_Activity.gxTpr_Useractivitytype = "";
         AV37ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "EtapasDesarrollo";
         AV37ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "EtapasDesarrollo";
         AV37ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = "ExportWWEtapasDesarrollo";
         AV36ActivityList.Add(AV37ActivityListItem, 0);
         AV37ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         ...
         AV37ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "EtapasDesarrollo";
         AV37ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "EtapasDesarrollo";
         AV37ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = "EntityManagerEtapasDesarrollo";
         AV36ActivityList.Add(AV37ActivityListItem, 0);
         new k2bisauthorizedactivitylist(context ).execute( ref  AV36ActivityList) ;
         if ( ((SdtK2BActivityList_K2BActivityListItem)AV36ActivityList.Item(1)).gxTpr_Isauthorized )
         {
      ...
      protected void S212( )
      {
         ...
         AV36ActivityList.Add(AV37ActivityListItem, 0);
         new k2bisauthorizedactivitylist(context ).execute( ref  AV36ActivityList) ;
         AV31EtapaDesarrolloNombre_IsAuthorized = ((SdtK2BActivityList_K2BActivityListItem)AV36ActivityList.Item(1)).gxTpr_Isauthorized;
         AssignAttri("", false, "AV31EtapaDesarrolloNombre_IsAuthorized", AV31EtapaDesarrolloNombre_IsAuthorized);
         if ( ! ((SdtK2BActivityList_K2BActivityListItem)AV36ActivityList.Item(2)).gxTpr_Isauthorized )
         {
      ...
      private void E22772( )
      {
         ...
         AssignProp("", false, tblNoresultsfoundtable_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(tblNoresultsfoundtable_Visible), 5, 0), true);
         if ( AV31EtapaDesarrolloNombre_IsAuthorized )
         {
            edtEtapaDesarrolloNombre_Link = formatLink("entitymanageretapasdesarrollo.aspx", new object[] {UrlEncode(StringUtil.RTrim("DSP")),UrlEncode(StringUtil.LTrimStr(A290EtapaDesarrolloId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"Mode","EtapaDesarrolloId","TabCode"}) ;
         }
         else
         {
            edtEtapaDesarrolloNombre_Link = "";
         }
         edtavUpdate_Enabled = 1;
         edtavUpdate_Link = formatLink("entitymanageretapasdesarrollo.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A290EtapaDesarrolloId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"Mode","EtapaDesarrolloId","TabCode"}) ;
         edtavUpdate_Tooltiptext = "Actualizar";
         edtavDelete_Enabled = 1;
         edtavDelete_Link = formatLink("entitymanageretapasdesarrollo.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A290EtapaDesarrolloId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"Mode","EtapaDesarrolloId","TabCode"}) ;
         edtavDelete_Tooltiptext = "Eliminar";
         /* Load Method */
         if ( wbStart != -1 )
         {
      ...
      protected void E14772( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  AV40Pgmname,  "Grid", ref  AV10GridConfiguration) ;
         AV46GXV4 = 1;
         while ( AV46GXV4 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            ...
            if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "EtapaDesarrolloId") == 0 )
            {
               AV13GridColumn.gxTpr_Showattribute = AV14Att_EtapaDesarrolloId_Visible;
            }
            else if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "EtapaDesarrolloNombre") == 0 )
            {
               AV13GridColumn.gxTpr_Showattribute = AV15Att_EtapaDesarrolloNombre_Visible;
            }
            else if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "EtapaDesarrolloUsuarioRegistro") == 0 )
            {
               AV13GridColumn.gxTpr_Showattribute = AV16Att_EtapaDesarrolloUsuarioRegistro_Visible;
            }
            AV46GXV4 = (int)(AV46GXV4+1);
         }
         AV10GridConfiguration.gxTpr_Freezecolumntitles = AV11FreezeColumnTitles;
         new k2bsavegridconfiguration(context ).execute(  AV40Pgmname,  "Grid",  AV10GridConfiguration,  true) ;
         AV28UC_OrderedBy = AV25OrderedBy;
         AssignAttri("", false, "AV28UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV28UC_OrderedBy), 4, 0));
         if ( AV18RowsPerPageVariable != AV17GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV18RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV40Pgmname,  "Grid",  AV18RowsPerPageVariable) ;
            AV8CurrentPage = 1;
            AssignAttri("", false, "AV8CurrentPage", StringUtil.LTrimStr( (decimal)(AV8CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void wb_table2_118_772( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoresultsfoundtextblock_Internalname, "No hay resultados", "", "", lblNoresultsfoundtextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_WWEtapasDesarrollo.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_118_772e( true) ;
         }
         else
         {
            wb_table2_118_772e( false) ;
         }
      }

      protected void wb_table1_24_772( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, imgK2bgridsettingslabel_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "K2BT_GridSettingsLabel", "Config. tabla", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgK2bgridsettingslabel_Jsonclick, "'"+""+"'"+",false,"+"'"+"e23771_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_WWEtapasDesarrollo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRuntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblRuntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_WWEtapasDesarrollo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divEtapadesarrolloid_gridsettingscontainer_Internalname, 1, 0, "px", 0, "px", "K2BT_GridSettingsAttributeContainer", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group gx-default-form-group", "left", "top", ""+" data-gx-for=\""+chkavAtt_etapadesarrolloid_visible_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavAtt_etapadesarrolloid_visible_Internalname, "Id", "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_etapadesarrolloid_visible_Internalname, StringUtil.BoolToStr( AV14Att_EtapaDesarrolloId_Visible), "", "Id", 1, chkavAtt_etapadesarrolloid_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(53, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,53);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divEtapadesarrollonombre_gridsettingscontainer_Internalname, 1, 0, "px", 0, "px", "K2BT_GridSettingsAttributeContainer", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group gx-default-form-group", "left", "top", ""+" data-gx-for=\""+chkavAtt_etapadesarrollonombre_visible_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavAtt_etapadesarrollonombre_visible_Internalname, "Desarrollo Nombre", "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_etapadesarrollonombre_visible_Internalname, StringUtil.BoolToStr( AV15Att_EtapaDesarrolloNombre_Visible), "", "Desarrollo Nombre", 1, chkavAtt_etapadesarrollonombre_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(59, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,59);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divEtapadesarrollousuarioregistro_gridsettingscontainer_Internalname, 1, 0, "px", 0, "px", "K2BT_GridSettingsAttributeContainer", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group gx-default-form-group", "left", "top", ""+" data-gx-for=\""+chkavAtt_etapadesarrollousuarioregistro_visible_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavAtt_etapadesarrollousuarioregistro_visible_Internalname, "Usuario Registro", "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
            /* Check box */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAtt_etapadesarrollousuarioregistro_visible_Internalname, StringUtil.BoolToStr( AV16Att_EtapaDesarrolloUsuarioRegistro_Visible), "", "Usuario Registro", 1, chkavAtt_etapadesarrollousuarioregistro_visible.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(65, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,65);\"");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttK2bgridsettingssave_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(110), 3, 0)+","+"null"+");", "Aplicar", bttK2bgridsettingssave_Jsonclick, 5, "Aplicar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'SAVEGRIDSETTINGS\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWEtapasDesarrollo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgImage1_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgImage1_Jsonclick, "'"+""+"'"+",false,"+"'"+"e24771_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_WWEtapasDesarrollo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table3_91_772( true) ;
         }
         else
         {
            wb_table3_91_772( false) ;
         }
         return  ;
      }

      protected void wb_table3_91_772e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table4_98_772( true) ;
         }
         else
         {
            wb_table4_98_772( false) ;
         }
         return  ;
      }

      protected void wb_table4_98_772e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_24_772e( true) ;
         }
         else
         {
            wb_table1_24_772e( false) ;
         }
      }

      protected void wb_table4_98_772( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttInsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(110), 3, 0)+","+"null"+");", "Nuevo", bttInsert_Jsonclick, 5, bttInsert_Tooltiptext, "", StyleString, ClassString, bttInsert_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWEtapasDesarrollo.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_98_772e( true) ;
         }
         else
         {
            wb_table4_98_772e( false) ;
         }
      }

      protected void wb_table3_91_772( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttReport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(110), 3, 0)+","+"null"+");", "Reporte", bttReport_Jsonclick, 7, bttReport_Tooltiptext, "", StyleString, ClassString, bttReport_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"e25771_client"+"'", TempTags, "", 2, "HLP_WWEtapasDesarrollo.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='K2BToolsTableCell_ActionContainer'>") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 96,'',false,'',0)\"";
            ClassString = "Button_Standard";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttExport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(110), 3, 0)+","+"null"+");", "Exportar", bttExport_Jsonclick, 5, bttExport_Tooltiptext, "", StyleString, ClassString, bttExport_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOEXPORT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWEtapasDesarrollo.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_91_772e( true) ;
         }
         else
         {
            wb_table3_91_772e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249571539", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwetapasdesarrollo.js", "?20231249571540", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      protected void SubsflControlProps_1102( )
      {
         ...
         edtEtapaDesarrolloNombre_Internalname = "ETAPADESARROLLONOMBRE_"+sGXsfl_110_idx;
         edtEtapaDesarrolloUsuarioRegistro_Internalname = "ETAPADESARROLLOUSUARIOREGISTRO_"+sGXsfl_110_idx;
      ...
      protected void SubsflControlProps_fel_1102( )
      {
         ...
         edtEtapaDesarrolloNombre_Internalname = "ETAPADESARROLLONOMBRE_"+sGXsfl_110_fel_idx;
         edtEtapaDesarrolloUsuarioRegistro_Internalname = "ETAPADESARROLLOUSUARIOREGISTRO_"+sGXsfl_110_fel_idx;
      ...
      protected void sendrow_1102( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_110_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+((edtEtapaDesarrolloId_Visible==0) ? "display:none;" : "")+"\">") ;
            }
            /* Single line edit */
            ROClassString = "Attribute_Grid";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEtapaDesarrolloId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A290EtapaDesarrolloId), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A290EtapaDesarrolloId), "ZZZ9"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtEtapaDesarrolloId_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn K2BToolsSortableColumn InvisibleInExtraSmallColumn",(string)"",(int)edtEtapaDesarrolloId_Visible,(short)0,(short)0,(string)"number",(string)"1",(short)38,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)110,(short)1,(short)-1,(short)0,(bool)true,(string)"NumMin",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+((edtEtapaDesarrolloNombre_Visible==0) ? "display:none;" : "")+"\">") ;
            }
            /* Single line edit */
            ROClassString = "Attribute_Grid";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEtapaDesarrolloNombre_Internalname,(string)A291EtapaDesarrolloNombre,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtEtapaDesarrolloNombre_Link,(string)"",(string)"",(string)"",(string)edtEtapaDesarrolloNombre_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn K2BToolsSortableColumn",(string)"",(int)edtEtapaDesarrolloNombre_Visible,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)30,(short)0,(short)0,(short)110,(short)1,(short)-1,(short)-1,(bool)true,(string)"Descripcion",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+((edtEtapaDesarrolloUsuarioRegistro_Visible==0) ? "display:none;" : "")+"\">") ;
            }
            /* Single line edit */
            ROClassString = "Attribute_Grid";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEtapaDesarrolloUsuarioRegistro_Internalname,(string)A292EtapaDesarrolloUsuarioRegistro,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtEtapaDesarrolloUsuarioRegistro_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn InvisibleInExtraSmallColumn",(string)"",(int)edtEtapaDesarrolloUsuarioRegistro_Visible,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)110,(short)1,(short)0,(short)0,(bool)true,(string)"GeneXusSecurityCommon\\GAMUserIdentification",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            StyleString = "";
            AV32Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV32Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV42Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV32Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV32Update)) ? AV42Update_GXI : context.PathToRelativeUrl( AV32Update));
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV33Delete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV33Delete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV43Delete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV33Delete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV33Delete)) ? AV43Delete_GXI : context.PathToRelativeUrl( AV33Delete));
      ...
      {
         chkavAtt_etapadesarrolloid_visible.Name = "vATT_ETAPADESARROLLOID_VISIBLE";
         chkavAtt_etapadesarrolloid_visible.WebTags = "";
         chkavAtt_etapadesarrolloid_visible.Caption = "";
         AssignProp("", false, chkavAtt_etapadesarrolloid_visible_Internalname, "TitleCaption", chkavAtt_etapadesarrolloid_visible.Caption, true);
         chkavAtt_etapadesarrolloid_visible.CheckedValue = "false";
         AV14Att_EtapaDesarrolloId_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV14Att_EtapaDesarrolloId_Visible));
         AssignAttri("", false, "AV14Att_EtapaDesarrolloId_Visible", AV14Att_EtapaDesarrolloId_Visible);
         chkavAtt_etapadesarrollonombre_visible.Name = "vATT_ETAPADESARROLLONOMBRE_VISIBLE";
         chkavAtt_etapadesarrollonombre_visible.WebTags = "";
         chkavAtt_etapadesarrollonombre_visible.Caption = "";
         AssignProp("", false, chkavAtt_etapadesarrollonombre_visible_Internalname, "TitleCaption", chkavAtt_etapadesarrollonombre_visible.Caption, true);
         chkavAtt_etapadesarrollonombre_visible.CheckedValue = "false";
         AV15Att_EtapaDesarrolloNombre_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV15Att_EtapaDesarrolloNombre_Visible));
         AssignAttri("", false, "AV15Att_EtapaDesarrolloNombre_Visible", AV15Att_EtapaDesarrolloNombre_Visible);
         chkavAtt_etapadesarrollousuarioregistro_visible.Name = "vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE";
         chkavAtt_etapadesarrollousuarioregistro_visible.WebTags = "";
         chkavAtt_etapadesarrollousuarioregistro_visible.Caption = "";
         AssignProp("", false, chkavAtt_etapadesarrollousuarioregistro_visible_Internalname, "TitleCaption", chkavAtt_etapadesarrollousuarioregistro_visible.Caption, true);
         chkavAtt_etapadesarrollousuarioregistro_visible.CheckedValue = "false";
         AV16Att_EtapaDesarrolloUsuarioRegistro_Visible = StringUtil.StrToBool( StringUtil.BoolToStr( AV16Att_EtapaDesarrolloUsuarioRegistro_Visible));
         AssignAttri("", false, "AV16Att_EtapaDesarrolloUsuarioRegistro_Visible", AV16Att_EtapaDesarrolloUsuarioRegistro_Visible);
      ...
      protected void init_default_properties( )
      {
         ...
         chkavAtt_etapadesarrolloid_visible_Internalname = "vATT_ETAPADESARROLLOID_VISIBLE";
         divEtapadesarrolloid_gridsettingscontainer_Internalname = "ETAPADESARROLLOID_GRIDSETTINGSCONTAINER";
         chkavAtt_etapadesarrollonombre_visible_Internalname = "vATT_ETAPADESARROLLONOMBRE_VISIBLE";
         divEtapadesarrollonombre_gridsettingscontainer_Internalname = "ETAPADESARROLLONOMBRE_GRIDSETTINGSCONTAINER";
         chkavAtt_etapadesarrollousuarioregistro_visible_Internalname = "vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE";
         divEtapadesarrollousuarioregistro_gridsettingscontainer_Internalname = "ETAPADESARROLLOUSUARIOREGISTRO_GRIDSETTINGSCONTAINER";
         ...
         edtEtapaDesarrolloNombre_Internalname = "ETAPADESARROLLONOMBRE";
         edtEtapaDesarrolloUsuarioRegistro_Internalname = "ETAPADESARROLLOUSUARIOREGISTRO";
      ...
      public override void initialize_properties( )
      {
         ...
         chkavAtt_etapadesarrollousuarioregistro_visible.Caption = "Usuario Registro";
         chkavAtt_etapadesarrollonombre_visible.Caption = "Desarrollo Nombre";
         chkavAtt_etapadesarrolloid_visible.Caption = "Id";
         ...
         chkavAtt_etapadesarrollousuarioregistro_visible.Enabled = 1;
         chkavAtt_etapadesarrollonombre_visible.Enabled = 1;
         chkavAtt_etapadesarrolloid_visible.Enabled = 1;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'TOGGLEGRIDSETTINGSTABLE'","{handler:'E23771',iparms:[{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{av:'AV14Att_EtapaDesarrolloId_Visible',fld:'vATT_ETAPADESARROLLOID_VISIBLE',pic:''},{av:'AV15Att_EtapaDesarrolloNombre_Visible',fld:'vATT_ETAPADESARROLLONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EtapaDesarrolloUsuarioRegistro_Visible',fld:'vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'TOGGLEGRIDSETTINGSTABLE'",",oparms:[{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{av:'AV14Att_EtapaDesarrolloId_Visible',fld:'vATT_ETAPADESARROLLOID_VISIBLE',pic:''},{av:'AV15Att_EtapaDesarrolloNombre_Visible',fld:'vATT_ETAPADESARROLLONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EtapaDesarrolloUsuarioRegistro_Visible',fld:'vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E14772',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV31EtapaDesarrolloNombre_IsAuthorized',fld:'vETAPADESARROLLONOMBRE_ISAUTHORIZED',pic:''},{av:'AV18RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV17GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EtapaDesarrolloId_Visible',fld:'vATT_ETAPADESARROLLOID_VISIBLE',pic:''},{av:'AV15Att_EtapaDesarrolloNombre_Visible',fld:'vATT_ETAPADESARROLLONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EtapaDesarrolloUsuarioRegistro_Visible',fld:'vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'SAVEGRIDSETTINGS'",",oparms:[{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV28UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{av:'AV18RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{ctrl:'REPORT',prop:'Tooltiptext'},{ctrl:'EXPORT',prop:'Tooltiptext'},{ctrl:'INSERT',prop:'Tooltiptext'},{av:'AV32Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV33Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'divDownloadsactionssectioncontainer_Visible',ctrl:'DOWNLOADSACTIONSSECTIONCONTAINER',prop:'Visible'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{ctrl:'INSERT',prop:'Visible'},{av:'AV31EtapaDesarrolloNombre_IsAuthorized',fld:'vETAPADESARROLLONOMBRE_ISAUTHORIZED',pic:''},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'edtEtapaDesarrolloId_Visible',ctrl:'ETAPADESARROLLOID',prop:'Visible'},{av:'edtEtapaDesarrolloNombre_Visible',ctrl:'ETAPADESARROLLONOMBRE',prop:'Visible'},{av:'edtEtapaDesarrolloUsuarioRegistro_Visible',ctrl:'ETAPADESARROLLOUSUARIOREGISTRO',prop:'Visible'},{av:'AV14Att_EtapaDesarrolloId_Visible',fld:'vATT_ETAPADESARROLLOID_VISIBLE',pic:''},{av:'AV15Att_EtapaDesarrolloNombre_Visible',fld:'vATT_ETAPADESARROLLONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EtapaDesarrolloUsuarioRegistro_Visible',fld:'vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("'DOFIRST'","{handler:'E15772',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV31EtapaDesarrolloNombre_IsAuthorized',fld:'vETAPADESARROLLONOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EtapaDesarrolloId_Visible',fld:'vATT_ETAPADESARROLLOID_VISIBLE',pic:''},{av:'AV15Att_EtapaDesarrolloNombre_Visible',fld:'vATT_ETAPADESARROLLONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EtapaDesarrolloUsuarioRegistro_Visible',fld:'vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E16772',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV31EtapaDesarrolloNombre_IsAuthorized',fld:'vETAPADESARROLLONOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EtapaDesarrolloId_Visible',fld:'vATT_ETAPADESARROLLOID_VISIBLE',pic:''},{av:'AV15Att_EtapaDesarrolloNombre_Visible',fld:'vATT_ETAPADESARROLLONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EtapaDesarrolloUsuarioRegistro_Visible',fld:'vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E17772',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV31EtapaDesarrolloNombre_IsAuthorized',fld:'vETAPADESARROLLONOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EtapaDesarrolloId_Visible',fld:'vATT_ETAPADESARROLLOID_VISIBLE',pic:''},{av:'AV15Att_EtapaDesarrolloNombre_Visible',fld:'vATT_ETAPADESARROLLONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EtapaDesarrolloUsuarioRegistro_Visible',fld:'vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E18772',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV31EtapaDesarrolloNombre_IsAuthorized',fld:'vETAPADESARROLLONOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EtapaDesarrolloId_Visible',fld:'vATT_ETAPADESARROLLOID_VISIBLE',pic:''},{av:'AV15Att_EtapaDesarrolloNombre_Visible',fld:'vATT_ETAPADESARROLLONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EtapaDesarrolloUsuarioRegistro_Visible',fld:'vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'TOGGLEDOWNLOADACTIONS'","{handler:'E24771',iparms:[{av:'divDownloadactionstable_Visible',ctrl:'DOWNLOADACTIONSTABLE',prop:'Visible'},{av:'AV14Att_EtapaDesarrolloId_Visible',fld:'vATT_ETAPADESARROLLOID_VISIBLE',pic:''},{av:'AV15Att_EtapaDesarrolloNombre_Visible',fld:'vATT_ETAPADESARROLLONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EtapaDesarrolloUsuarioRegistro_Visible',fld:'vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'TOGGLEDOWNLOADACTIONS'",",oparms:[{av:'divDownloadactionstable_Visible',ctrl:'DOWNLOADACTIONSTABLE',prop:'Visible'},{av:'AV14Att_EtapaDesarrolloId_Visible',fld:'vATT_ETAPADESARROLLOID_VISIBLE',pic:''},{av:'AV15Att_EtapaDesarrolloNombre_Visible',fld:'vATT_ETAPADESARROLLONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EtapaDesarrolloUsuarioRegistro_Visible',fld:'vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("NULL","{handler:'Validv_Delete',iparms:[{av:'AV14Att_EtapaDesarrolloId_Visible',fld:'vATT_ETAPADESARROLLOID_VISIBLE',pic:''},{av:'AV15Att_EtapaDesarrolloNombre_Visible',fld:'vATT_ETAPADESARROLLONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EtapaDesarrolloUsuarioRegistro_Visible',fld:'vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("NULL",",oparms:[{av:'AV14Att_EtapaDesarrolloId_Visible',fld:'vATT_ETAPADESARROLLOID_VISIBLE',pic:''},{av:'AV15Att_EtapaDesarrolloNombre_Visible',fld:'vATT_ETAPADESARROLLONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EtapaDesarrolloUsuarioRegistro_Visible',fld:'vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         H00772_A292EtapaDesarrolloUsuarioRegistro = new string[] {""} ;
         H00772_A291EtapaDesarrolloNombre = new string[] {""} ;
         H00772_A290EtapaDesarrolloId = new short[1] ;
         H00773_AGRID_nRecordCount = new long[1] ;
         AV5Context = new SdtK2BContext(context);
         AV27GridOrder = new SdtK2BGridOrders_K2BGridOrdersItem(context);
         AV29Messages = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
         ...
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwetapasdesarrollo__default(),
            new Object[][] {
                new Object[] {
               H00772_A292EtapaDesarrolloUsuarioRegistro, H00772_A291EtapaDesarrolloNombre, H00772_A290EtapaDesarrolloId
               }
               , new Object[] {
               H00773_AGRID_nRecordCount
               }
            }
         );
         AV40Pgmname = "WWEtapasDesarrollo";
      ...
      private int edtEtapaDesarrolloId_Visible ;
      private int edtEtapaDesarrolloNombre_Visible ;
      private int edtEtapaDesarrolloUsuarioRegistro_Visible ;
      ...
      private string edtEtapaDesarrolloNombre_Link ;
      ...
      private string chkavAtt_etapadesarrolloid_visible_Internalname ;
      private string chkavAtt_etapadesarrollonombre_visible_Internalname ;
      private string chkavAtt_etapadesarrollousuarioregistro_visible_Internalname ;
      ...
      private string divEtapadesarrolloid_gridsettingscontainer_Internalname ;
      private string divEtapadesarrollonombre_gridsettingscontainer_Internalname ;
      private string divEtapadesarrollousuarioregistro_gridsettingscontainer_Internalname ;
      ...
      private bool AV31EtapaDesarrolloNombre_IsAuthorized ;
      private bool AV14Att_EtapaDesarrolloId_Visible ;
      private bool AV15Att_EtapaDesarrolloNombre_Visible ;
      private bool AV16Att_EtapaDesarrolloUsuarioRegistro_Visible ;
      ...
      private string AV42Update_GXI ;
      private string AV43Delete_GXI ;
      ...
      private GXCheckbox chkavAtt_etapadesarrolloid_visible ;
      private GXCheckbox chkavAtt_etapadesarrollonombre_visible ;
      private GXCheckbox chkavAtt_etapadesarrollousuarioregistro_visible ;
      private GXCombobox cmbavGridsettingsrowsperpagevariable ;
      private GXCheckbox chkavFreezecolumntitles ;
      private IDataStoreProvider pr_default ;
      private string[] H00772_A292EtapaDesarrolloUsuarioRegistro ;
      private string[] H00772_A291EtapaDesarrolloNombre ;
      private short[] H00772_A290EtapaDesarrolloId ;
      private long[] H00773_AGRID_nRecordCount ;
      ...
      private GXBaseCollection<SdtMessages_Message> AV29Messages ;
   ...
   public class wwetapasdesarrollo__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H00772( IGxContext context ,
                                             string AV24K2BToolsGenericSearchField ,
                                             ...
                                             short AV25OrderedBy )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [EtapaDesarrolloUsuarioRegistro], [EtapaDesarrolloNombre], [EtapaDesarrolloId]";
         sFromString = " FROM [EtapasDesarrollo]";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV24K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(4), CAST([EtapaDesarrolloId] AS decimal(4,0))) like '%' + @lV24K2BToolsGenericSearchField + '%' or [EtapaDesarrolloNombre] like '%' + @lV24K2BToolsGenericSearchField + '%' or [EtapaDesarrolloUsuarioRegistro] like '%' + @lV24K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int3[0] = 1;
         ...
         if ( AV25OrderedBy == 0 )
         {
            sOrderString += " ORDER BY [EtapaDesarrolloId]";
         }
         else if ( AV25OrderedBy == 1 )
         {
            sOrderString += " ORDER BY [EtapaDesarrolloId] DESC";
         }
         else if ( AV25OrderedBy == 2 )
         {
            sOrderString += " ORDER BY [EtapaDesarrolloNombre]";
         }
         else if ( AV25OrderedBy == 3 )
         {
            sOrderString += " ORDER BY [EtapaDesarrolloNombre] DESC";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY [EtapaDesarrolloId]";
                                             ...
                                             short AV25OrderedBy )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM [EtapasDesarrollo]";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV24K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(4), CAST([EtapaDesarrolloId] AS decimal(4,0))) like '%' + @lV24K2BToolsGenericSearchField + '%' or [EtapaDesarrolloNombre] like '%' + @lV24K2BToolsGenericSearchField + '%' or [EtapaDesarrolloUsuarioRegistro] like '%' + @lV24K2BToolsGenericSearchField + '%')");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00772(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] );
               case 1 :
                     return conditional_H00773(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00772", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00772,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00773", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00773,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
