...
namespace GeneXus.Programs {
   public class reportestadoticketusuariowc : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
         ...
         try
         {
            ...
            else
            {
               ...
               pr_default.dynParam(0, new Object[]{ new Object[]{
                                                    ...
                                                    AV11OrderedBy } ,
                                                    new int[]{
                                                    TypeConstants.DATE, TypeConstants.DATE, TypeConstants.DATE, TypeConstants.DATE, TypeConstants.DATE, TypeConstants.DATE, TypeConstants.SHORT, TypeConstants.INT, TypeConstants.SHORT
                                                    }
               });
               ...
               while ( (pr_default.getStatus(0) != 101) )
               {
                  ...
                  H3G0( false, 30) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(A15UsuarioId), "ZZZ9")), 18, Gx_line+7, 99, Gx_line+23, 2, 0, 0, 0) ;
      ...
      public override void initialize( )
      {
         ...
         P003G2_A15UsuarioId = new short[1] ;
      ...
      private short[] P003G2_A15UsuarioId ;
   ...
   public class reportestadoticketusuariowc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV11OrderedBy )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV10K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(4), CAST([UsuarioId] AS decimal(4,0))) like '%' + @lV10K2BToolsGenericSearchField + '%' or [UsuarioNombre] like '%' + @lV10K2BToolsGenericSearchField + '%' or [UsuarioGerencia] like '%' + @lV10K2BToolsGenericSearchField + '%' or [UsuarioDepartamento] like '%' + @lV10K2BToolsGenericSearchField + '%' or [UsuarioRequerimiento] like '%' + @lV10K2BToolsGenericSearchField + '%' or [UsuarioEmail] like '%' + @lV10K2BToolsGenericSearchField + '%' or CONVERT( char(9), CAST([UsuarioTelefono] AS decimal(9,0))) like '%' + @lV10K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int1[5] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P003G2(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (DateTime)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (DateTime)dynConstraints[7] , (DateTime)dynConstraints[8] , (short)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (int)dynConstraints[14] , (short)dynConstraints[15] );
         }
