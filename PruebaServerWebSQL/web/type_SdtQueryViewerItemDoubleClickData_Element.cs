...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerItemDoubleClickData.Element" , Namespace="kb_ticket" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerItemDoubleClickData.Element", Namespace="kb_ticket")]
