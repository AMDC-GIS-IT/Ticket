...
namespace GeneXus.Programs {
   public class promptestadosatisfaccion : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public promptestadosatisfaccion( )
      {
      ...
      public promptestadosatisfaccion( IGxContext context )
      {
      ...
      {
         this.AV17pEstadoSatisfaccionId = 0 ;
         executePrivate();
         aP0_pEstadoSatisfaccionId=this.AV17pEstadoSatisfaccionId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV17pEstadoSatisfaccionId = (short)(NumberUtil.Val( GetPar( "pEstadoSatisfaccionId"), "."));
               ...
               gxgrGrid_refresh( subGrid_Rows, AV18K2BToolsGenericSearchField, AV15ClassCollection, AV19OrderedBy, AV5CurrentPage, AV29Pgmname, AV7GridConfiguration, AV17pEstadoSatisfaccionId, AV8FreezeColumnTitles) ;
            ...
            {
               AV17pEstadoSatisfaccionId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV17pEstadoSatisfaccionId", StringUtil.LTrimStr( (decimal)(AV17pEstadoSatisfaccionId), 4, 0));
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2023124956481", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("promptestadosatisfaccion.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV17pEstadoSatisfaccionId,4,0))}, new string[] {"pEstadoSatisfaccionId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPESTADOSATISFACCIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV17pEstadoSatisfaccionId), 4, 0, ",", "")));
      ...
      {
         return formatLink("promptestadosatisfaccion.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV17pEstadoSatisfaccionId,4,0))}, new string[] {"pEstadoSatisfaccionId"})  ;
      }

      public override string GetPgmname( )
      {
         return "PromptEstadoSatisfaccion" ;
      }
      ...
      protected void wb_table1_20_4W2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A98EstadoSatisfaccionCalificacion), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         if ( wbEnd == 64 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_71_4W2( true) ;
         }
         else
         {
            wb_table2_71_4W2( false) ;
         }
         return  ;
      }

      protected void wb_table2_71_4W2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagebuttontextblock_Internalname, "", "", "", lblPreviouspagebuttontextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOPREVIOUS\\'."+"'", "", lblPreviouspagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_PromptEstadoSatisfaccion.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFirstpagetextblock_Internalname, lblFirstpagetextblock_Caption, "", "", lblFirstpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOFIRST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblFirstpagetextblock_Visible, 1, 0, 0, "HLP_PromptEstadoSatisfaccion.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacinglefttextblock_Internalname, "...", "", "", lblSpacinglefttextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacinglefttextblock_Visible, 1, 0, 0, "HLP_PromptEstadoSatisfaccion.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagetextblock_Internalname, lblPreviouspagetextblock_Caption, "", "", lblPreviouspagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOPREVIOUS\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPreviouspagetextblock_Visible, 1, 0, 0, "HLP_PromptEstadoSatisfaccion.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCurrentpagetextblock_Internalname, lblCurrentpagetextblock_Caption, "", "", lblCurrentpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_PromptEstadoSatisfaccion.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagetextblock_Internalname, lblNextpagetextblock_Caption, "", "", lblNextpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DONEXT\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblNextpagetextblock_Visible, 1, 0, 0, "HLP_PromptEstadoSatisfaccion.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacingrighttextblock_Internalname, "...", "", "", lblSpacingrighttextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacingrighttextblock_Visible, 1, 0, 0, "HLP_PromptEstadoSatisfaccion.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLastpagetextblock_Internalname, lblLastpagetextblock_Caption, "", "", lblLastpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOLAST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblLastpagetextblock_Visible, 1, 0, 0, "HLP_PromptEstadoSatisfaccion.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagebuttontextblock_Internalname, "", "", "", lblNextpagebuttontextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DONEXT\\'."+"'", "", lblNextpagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_PromptEstadoSatisfaccion.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       short AV17pEstadoSatisfaccionId ,
      ...
      {
         /* GeneXus formulas. */
         AV29Pgmname = "PromptEstadoSatisfaccion";
         context.Gx_err = 0;
      }
      ...
      protected void RF4W2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV18K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV18K2BToolsGenericSearchField), 100, "%");
            lV18K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV18K2BToolsGenericSearchField), 100, "%");
            lV18K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV18K2BToolsGenericSearchField), 100, "%");
            /* Using cursor H004W2 */
            pr_default.execute(0, new Object[] {lV18K2BToolsGenericSearchField, lV18K2BToolsGenericSearchField, lV18K2BToolsGenericSearchField, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_64_idx = 1;
            sGXsfl_64_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_64_idx), 4, 0), 4, "0");
            SubsflControlProps_642( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A21EstadoSatisfaccionEstado = H004W2_A21EstadoSatisfaccionEstado[0];
               A98EstadoSatisfaccionCalificacion = H004W2_A98EstadoSatisfaccionCalificacion[0];
               A22EstadoSatisfaccionNombre = H004W2_A22EstadoSatisfaccionNombre[0];
               A4EstadoSatisfaccionId = H004W2_A4EstadoSatisfaccionId[0];
               E214W2 ();
      ...
      protected void send_integrity_lvl_hashes4W2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV29Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV29Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_ESTADOSATISFACCIONID"+"_"+sGXsfl_64_idx, GetSecureSignedToken( sGXsfl_64_idx, context.localUtil.Format( (decimal)(A4EstadoSatisfaccionId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV18K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV18K2BToolsGenericSearchField), 100, "%");
         /* Using cursor H004W3 */
         pr_default.execute(1, new Object[] {lV18K2BToolsGenericSearchField, lV18K2BToolsGenericSearchField, lV18K2BToolsGenericSearchField});
      ...
      protected void E174W2( )
      {
         ...
         AV26ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "EstadoSatisfaccion";
         AV26ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "EstadoSatisfaccion";
         ...
         GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
         Form.Caption = StringUtil.Format( "Seleccionar %1", "Estado Satisfaccion", "", "", "", "", "", "", "", "");
      ...
      protected void E194W2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV17pEstadoSatisfaccionId = A4EstadoSatisfaccionId;
         AssignAttri("", false, "AV17pEstadoSatisfaccionId", StringUtil.LTrimStr( (decimal)(AV17pEstadoSatisfaccionId), 4, 0));
         context.setWebReturnParms(new Object[] {(short)AV17pEstadoSatisfaccionId});
         context.setWebReturnParmsMetadata(new Object[] {"AV17pEstadoSatisfaccionId"});
         context.wjLocDisableFrm = 1;
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV12GridStateKey = StringUtil.Str( (decimal)(AV17pEstadoSatisfaccionId), 4, 0);
      ...
      protected void wb_table2_71_4W2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoresultsfoundtextblock_Internalname, "No hay resultados", "", "", lblNoresultsfoundtextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_PromptEstadoSatisfaccion.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_71_4W2e( true) ;
         }
         else
         {
            wb_table2_71_4W2e( false) ;
         }
      }

      protected void wb_table1_20_4W2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, imgK2bgridsettingslabel_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "K2BT_GridSettingsLabel", "Config. tabla", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgK2bgridsettingslabel_Jsonclick, "'"+""+"'"+",false,"+"'"+"e234w1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_PromptEstadoSatisfaccion.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRuntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblRuntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_PromptEstadoSatisfaccion.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttK2bgridsettingssave_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(64), 2, 0)+","+"null"+");", "Aplicar", bttK2bgridsettingssave_Jsonclick, 5, "Aplicar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'SAVEGRIDSETTINGS\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_PromptEstadoSatisfaccion.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_20_4W2e( true) ;
         }
         else
         {
            wb_table1_20_4W2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV17pEstadoSatisfaccionId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV17pEstadoSatisfaccionId", StringUtil.LTrimStr( (decimal)(AV17pEstadoSatisfaccionId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023124956592", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("promptestadosatisfaccion.js", "?2023124956592", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      {
         edtEstadoSatisfaccionId_Internalname = "ESTADOSATISFACCIONID_"+sGXsfl_64_idx;
         edtEstadoSatisfaccionNombre_Internalname = "ESTADOSATISFACCIONNOMBRE_"+sGXsfl_64_idx;
         edtEstadoSatisfaccionCalificacion_Internalname = "ESTADOSATISFACCIONCALIFICACION_"+sGXsfl_64_idx;
         chkEstadoSatisfaccionEstado_Internalname = "ESTADOSATISFACCIONESTADO_"+sGXsfl_64_idx;
      }

      protected void SubsflControlProps_fel_642( )
      {
         edtEstadoSatisfaccionId_Internalname = "ESTADOSATISFACCIONID_"+sGXsfl_64_fel_idx;
         edtEstadoSatisfaccionNombre_Internalname = "ESTADOSATISFACCIONNOMBRE_"+sGXsfl_64_fel_idx;
         edtEstadoSatisfaccionCalificacion_Internalname = "ESTADOSATISFACCIONCALIFICACION_"+sGXsfl_64_fel_idx;
         chkEstadoSatisfaccionEstado_Internalname = "ESTADOSATISFACCIONESTADO_"+sGXsfl_64_fel_idx;
      }
      ...
      protected void sendrow_642( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_64_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            AssignProp("", false, edtEstadoSatisfaccionNombre_Internalname, "Link", edtEstadoSatisfaccionNombre_Link, !bGXsfl_64_Refreshing);
            ...
            StyleString = "";
            GXCCtl = "ESTADOSATISFACCIONESTADO_" + sGXsfl_64_idx;
            chkEstadoSatisfaccionEstado.Name = GXCCtl;
            chkEstadoSatisfaccionEstado.WebTags = "";
            chkEstadoSatisfaccionEstado.Caption = "";
            AssignProp("", false, chkEstadoSatisfaccionEstado_Internalname, "TitleCaption", chkEstadoSatisfaccionEstado.Caption, !bGXsfl_64_Refreshing);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV17pEstadoSatisfaccionId',fld:'vPESTADOSATISFACCIONID',pic:'ZZZ9'},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV19OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV18K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("ENTER","{handler:'E194W2',iparms:[{av:'A4EstadoSatisfaccionId',fld:'ESTADOSATISFACCIONID',pic:'ZZZ9',hsh:true},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV17pEstadoSatisfaccionId',fld:'vPESTADOSATISFACCIONID',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("GRID.REFRESH","{handler:'E204W2',iparms:[{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV19OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pEstadoSatisfaccionId',fld:'vPESTADOSATISFACCIONID',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E214W2',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E124W2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV19OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pEstadoSatisfaccionId',fld:'vPESTADOSATISFACCIONID',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E144W2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV19OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pEstadoSatisfaccionId',fld:'vPESTADOSATISFACCIONID',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E154W2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV19OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pEstadoSatisfaccionId',fld:'vPESTADOSATISFACCIONID',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'TOGGLEGRIDSETTINGSTABLE'","{handler:'E234W1',iparms:[{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E164W2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV19OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pEstadoSatisfaccionId',fld:'vPESTADOSATISFACCIONID',pic:'ZZZ9'},{av:'AV10RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV9GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E114W2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV19OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pEstadoSatisfaccionId',fld:'vPESTADOSATISFACCIONID',pic:'ZZZ9'},{av:'AV23UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("NULL","{handler:'Valid_Estadosatisfaccionestado',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         H004W2_A21EstadoSatisfaccionEstado = new bool[] {false} ;
         H004W2_A98EstadoSatisfaccionCalificacion = new short[1] ;
         H004W2_A22EstadoSatisfaccionNombre = new string[] {""} ;
         H004W2_A4EstadoSatisfaccionId = new short[1] ;
         ...
         ROClassString = "";
         GXCCtl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.promptestadosatisfaccion__default(),
            new Object[][] {
                new Object[] {
               H004W2_A21EstadoSatisfaccionEstado, H004W2_A98EstadoSatisfaccionCalificacion, H004W2_A22EstadoSatisfaccionNombre, H004W2_A4EstadoSatisfaccionId
               }
               , new Object[] {
      ...
      private short AV17pEstadoSatisfaccionId ;
      ...
      private bool[] H004W2_A21EstadoSatisfaccionEstado ;
      private short[] H004W2_A98EstadoSatisfaccionCalificacion ;
      private string[] H004W2_A22EstadoSatisfaccionNombre ;
      private short[] H004W2_A4EstadoSatisfaccionId ;
   ...
   public class promptestadosatisfaccion__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV19OrderedBy )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [EstadoSatisfaccionEstado], [EstadoSatisfaccionCalificacion], [EstadoSatisfaccionNombre], [EstadoSatisfaccionId]";
         sFromString = " FROM [EstadoSatisfaccion]";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV18K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(4), CAST([EstadoSatisfaccionId] AS decimal(4,0))) like '%' + @lV18K2BToolsGenericSearchField + '%' or [EstadoSatisfaccionNombre] like '%' + @lV18K2BToolsGenericSearchField + '%' or CONVERT( char(4), CAST([EstadoSatisfaccionCalificacion] AS decimal(4,0))) like '%' + @lV18K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int2[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004W2(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] );
               case 1 :
                     return conditional_H004W3(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV18K2BToolsGenericSearchField",GXType.Char,100,0) ,
          new ParDef("@lV18K2BToolsGenericSearchField",GXType.NChar,100,0) ,
          new ParDef("@lV18K2BToolsGenericSearchField",GXType.Char,100,0) ,
