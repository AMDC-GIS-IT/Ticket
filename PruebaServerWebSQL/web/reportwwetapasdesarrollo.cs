...
namespace GeneXus.Programs {
   public class reportwwetapasdesarrollo : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public reportwwetapasdesarrollo( )
      {
      ...
      public reportwwetapasdesarrollo( IGxContext context )
      {
      ...
      public void executeSubmit( string aP0_K2BToolsGenericSearchField ,
                                 short aP1_OrderedBy )
      {
         reportwwetapasdesarrollo objreportwwetapasdesarrollo;
         objreportwwetapasdesarrollo = new reportwwetapasdesarrollo();
         objreportwwetapasdesarrollo.AV9K2BToolsGenericSearchField = aP0_K2BToolsGenericSearchField;
         objreportwwetapasdesarrollo.AV10OrderedBy = aP1_OrderedBy;
         objreportwwetapasdesarrollo.context.SetSubmitInitialConfig(context);
         objreportwwetapasdesarrollo.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objreportwwetapasdesarrollo);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((reportwwetapasdesarrollo)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "EtapasDesarrollo",  "EtapasDesarrollo",  "List",  "",  AV19Pgmname) )
            {
               H720( false, 30) ;
            ...
            else
            {
               ...
               getPrinter().GxDrawText("Etapas desarrollos", 216, Gx_line+0, 611, Gx_line+42, 0+256, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
               ...
               getPrinter().GxDrawText("Desarrollo Nombre", 56, Gx_line+7, 122, Gx_line+22, 0, 0, 0, 1) ;
               Gx_OldLine = Gx_line;
               Gx_line = (int)(Gx_line+30);
               GxHdr3 = true;
               ...
               lV9K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV9K2BToolsGenericSearchField), 200, "%");
               /* Using cursor P00722 */
               pr_default.execute(0, new Object[] {lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField, lV9K2BToolsGenericSearchField});
               while ( (pr_default.getStatus(0) != 101) )
               {
                  A292EtapaDesarrolloUsuarioRegistro = P00722_A292EtapaDesarrolloUsuarioRegistro[0];
                  A291EtapaDesarrolloNombre = P00722_A291EtapaDesarrolloNombre[0];
                  A290EtapaDesarrolloId = P00722_A290EtapaDesarrolloId[0];
                  H720( false, 30) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(A290EtapaDesarrolloId), "ZZZ9")), 18, Gx_line+7, 48, Gx_line+23, 2, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A291EtapaDesarrolloNombre, "")), 56, Gx_line+7, 122, Gx_line+23, 0, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
      ...
      public override void initialize( )
      {
         ...
         A291EtapaDesarrolloNombre = "";
         A292EtapaDesarrolloUsuarioRegistro = "";
         P00722_A292EtapaDesarrolloUsuarioRegistro = new string[] {""} ;
         P00722_A291EtapaDesarrolloNombre = new string[] {""} ;
         P00722_A290EtapaDesarrolloId = new short[1] ;
         Gx_date = DateTime.MinValue;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportwwetapasdesarrollo__default(),
            new Object[][] {
                new Object[] {
               P00722_A292EtapaDesarrolloUsuarioRegistro, P00722_A291EtapaDesarrolloNombre, P00722_A290EtapaDesarrolloId
               }
            }
         );
         AV19Pgmname = "ReportWWEtapasDesarrollo";
      ...
      private string[] P00722_A292EtapaDesarrolloUsuarioRegistro ;
      private string[] P00722_A291EtapaDesarrolloNombre ;
      private short[] P00722_A290EtapaDesarrolloId ;
      private SdtK2BContext AV8Context ;
   }

   public class reportwwetapasdesarrollo__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV10OrderedBy )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(4), CAST([EtapaDesarrolloId] AS decimal(4,0))) like '%' + @lV9K2BToolsGenericSearchField + '%' or [EtapaDesarrolloNombre] like '%' + @lV9K2BToolsGenericSearchField + '%' or [EtapaDesarrolloUsuarioRegistro] like '%' + @lV9K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int1[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00722(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00722", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00722,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
