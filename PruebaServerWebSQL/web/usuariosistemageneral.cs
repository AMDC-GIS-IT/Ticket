...
namespace GeneXus.Programs {
   public class usuariosistemageneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public usuariosistemageneral( )
      {
      ...
      public usuariosistemageneral( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "AV6UsuarioSistemaId", AV6UsuarioSistemaId);
                  AV8TabCode = GetPar( "TabCode");
                  AssignAttri(sPrefix, false, "AV8TabCode", AV8TabCode);
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)Gx_mode,(string)AV6UsuarioSistemaId,(string)AV8TabCode});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249492947", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6UsuarioSistemaId", wcpOAV6UsuarioSistemaId);
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vUSUARIOSISTEMAID", AV6UsuarioSistemaId);
      ...
      protected void WB510( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "usuariosistemageneral.aspx");
            }
            /* Div Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_15_512( true) ;
         }
         else
         {
            wb_table1_15_512( false) ;
         }
         return  ;
      }

      protected void wb_table1_15_512e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void STRUP510( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6UsuarioSistemaId = cgiGet( sPrefix+"wcpOAV6UsuarioSistemaId");
      ...
      protected void E12512( )
      {
         ...
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "UsuarioSistema";
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "UsuarioSistema";
         ...
         {
            A99UsuarioSistemaId = H00512_A99UsuarioSistemaId[0];
            AV16GXLvl26 = 1;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Transactioncomponent_Component), StringUtil.Lower( "UsuarioSistema")) != 0 )
         {
            WebComp_Transactioncomponent = getWebComponent(GetType(), "GeneXus.Programs", "usuariosistema", new Object[] {context} );
            WebComp_Transactioncomponent.ComponentInit();
            WebComp_Transactioncomponent.Name = "UsuarioSistema";
            WebComp_Transactioncomponent_Component = "UsuarioSistema";
         }
         if ( StringUtil.Len( WebComp_Transactioncomponent_Component) != 0 )
         {
            WebComp_Transactioncomponent.setjustcreated();
            WebComp_Transactioncomponent.componentprepare(new Object[] {(string)sPrefix+"W0029",(string)"",(string)Gx_mode,(string)AV6UsuarioSistemaId});
      ...
      protected void E13512( )
      {
         /* 'DoUpdate' Routine */
         returnInSub = false;
         new k2bgettrncontextbyname(context ).execute(  "UsuarioSistema", out  AV10TrnContext) ;
         GXt_char1 = "";
         ...
         new k2bsettrncontextbyname(context ).execute(  "UsuarioSistema",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerusuariosistema.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.RTrim(AV6UsuarioSistemaId)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","UsuarioSistemaId","TabCode"}) );
      ...
      protected void E14512( )
      {
         ...
         AV10TrnContext.gxTpr_Returnmode = "Popup";
         new k2bsettrncontextbyname(context ).execute(  "UsuarioSistema",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerusuariosistema.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.RTrim(AV6UsuarioSistemaId)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","UsuarioSistemaId","TabCode"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void wb_table1_15_512( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_18_512( true) ;
         }
         else
         {
            wb_table2_18_512( false) ;
         }
         return  ;
      }

      protected void wb_table2_18_512e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_15_512e( true) ;
         }
         else
         {
            wb_table1_15_512e( false) ;
         }
      }

      protected void wb_table2_18_512( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_18_512e( true) ;
         }
         else
         {
            wb_table2_18_512e( false) ;
         }
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6UsuarioSistemaId = (string)((string)getParm(obj,1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "usuariosistemageneral", GetJustCreated( ));
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "Gx_mode", Gx_mode);
            AV6UsuarioSistemaId = (string)getParm(obj,3);
            AssignAttri(sPrefix, false, "AV6UsuarioSistemaId", AV6UsuarioSistemaId);
         ...
         wcpOAV6UsuarioSistemaId = cgiGet( sPrefix+"wcpOAV6UsuarioSistemaId");
         wcpOAV8TabCode = cgiGet( sPrefix+"wcpOAV8TabCode");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(Gx_mode, wcpOGx_mode) != 0 ) || ( StringUtil.StrCmp(AV6UsuarioSistemaId, wcpOAV6UsuarioSistemaId) != 0 ) || ( StringUtil.StrCmp(AV8TabCode, wcpOAV8TabCode) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOGx_mode = Gx_mode;
         wcpOAV6UsuarioSistemaId = AV6UsuarioSistemaId;
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV6UsuarioSistemaId = cgiGet( sPrefix+"AV6UsuarioSistemaId_CTRL");
         if ( StringUtil.Len( sCtrlAV6UsuarioSistemaId) > 0 )
         {
            AV6UsuarioSistemaId = cgiGet( sCtrlAV6UsuarioSistemaId);
            AssignAttri(sPrefix, false, "AV6UsuarioSistemaId", AV6UsuarioSistemaId);
         }
         else
         {
            AV6UsuarioSistemaId = cgiGet( sPrefix+"AV6UsuarioSistemaId_PARM");
         }
      ...
      protected void WCParametersSet( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6UsuarioSistemaId_PARM", AV6UsuarioSistemaId);
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6UsuarioSistemaId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6UsuarioSistemaId_CTRL", StringUtil.RTrim( sCtrlAV6UsuarioSistemaId));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249492979", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("usuariosistemageneral.js", "?20231249492979", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A99UsuarioSistemaId',fld:'USUARIOSISTEMAID',pic:''},{av:'AV6UsuarioSistemaId',fld:'vUSUARIOSISTEMAID',pic:''},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E13512',iparms:[{av:'AV6UsuarioSistemaId',fld:'vUSUARIOSISTEMAID',pic:''}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E14512',iparms:[{av:'AV6UsuarioSistemaId',fld:'vUSUARIOSISTEMAID',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV12ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         scmdbuf = "";
         H00512_A99UsuarioSistemaId = new string[] {""} ;
         ...
         sCtrlGx_mode = "";
         sCtrlAV6UsuarioSistemaId = "";
         sCtrlAV8TabCode = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.usuariosistemageneral__default(),
            new Object[][] {
                new Object[] {
               H00512_A99UsuarioSistemaId
               }
            }
         );
      ...
      private string sCtrlAV6UsuarioSistemaId ;
      ...
      private string[] H00512_A99UsuarioSistemaId ;
   ...
   public class usuariosistemageneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00512", "SELECT [UsuarioSistemaId] FROM [UsuarioSistema] WHERE [UsuarioSistemaId] = @AV6UsuarioSistemaId ORDER BY [UsuarioSistemaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00512,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
