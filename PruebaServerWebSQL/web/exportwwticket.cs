...
namespace GeneXus.Programs {
   public class exportwwticket : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV14TicketFecha_From = context.localUtil.ParseDateParm( gxfirstwebparm);
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV15TicketFecha_To = context.localUtil.ParseDateParm( GetPar( "TicketFecha_To"));
                  AV17TicketHora_From = DateTimeUtil.ResetDate(context.localUtil.ParseDTimeParm( GetPar( "TicketHora_From")));
                  AV18TicketHora_To = DateTimeUtil.ResetDate(context.localUtil.ParseDTimeParm( GetPar( "TicketHora_To")));
                  AV19UsuarioNombre = GetPar( "UsuarioNombre");
                  AV57EstadoTicketTicketNombre = GetPar( "EstadoTicketTicketNombre");
                           ...
                           ref short aP7_OrderedBy )
      {
         ...
         initialize();
         executePrivate();
         aP7_OrderedBy=this.AV20OrderedBy;
      }

      public short executeUdp( DateTime aP0_TicketFecha_From ,
                               DateTime aP1_TicketFecha_To ,
                               DateTime aP2_TicketHora_From ,
                               DateTime aP3_TicketHora_To ,
                               string aP4_UsuarioNombre ,
                               ...
                               string aP6_K2BToolsGenericSearchField )
      {
         execute(aP0_TicketFecha_From, aP1_TicketFecha_To, aP2_TicketHora_From, aP3_TicketHora_To, aP4_UsuarioNombre, aP5_EstadoTicketTicketNombre, aP6_K2BToolsGenericSearchField, ref aP7_OrderedBy);
      ...
      void executePrivate( )
      {
         ...
         if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "Ticket",  "Ticket",  "List",  "",  "WWTicket") )
         {
            AV26Filename = "";
            AV27ErrorMessage = "You are not authorized to do activity";
            AV27ErrorMessage += "EntityName:" + "Ticket";
            AV27ErrorMessage += "TransactionName:" + "Ticket";
            AV27ErrorMessage += "ActivityType:" + "";
            AV27ErrorMessage += "PgmName:" + AV61Pgmname;
         ...
         AV26Filename = GxDirectory.TemporaryFilesPath + AV29File.Separator + "ExportWWTicket-" + StringUtil.Trim( StringUtil.Str( (decimal)(AV24Random), 8, 0)) + ".xlsx";
         ...
         {
            AV21ExcelDocument.get_Cells(AV22CellRow, AV23FirstColumn+0, 1, 1).Bold = 1;
            AV21ExcelDocument.get_Cells(AV22CellRow, AV23FirstColumn+0, 1, 1).Text = "Estado Ticket";
         ...
         {
            AV21ExcelDocument.get_Cells(AV22CellRow, AV23FirstColumn+AV25ColumnIndex, 1, 1).Bold = 1;
            AV21ExcelDocument.get_Cells(AV22CellRow, AV23FirstColumn+AV25ColumnIndex, 1, 1).Text = "Estado Ticket";
            AV25ColumnIndex = (short)(AV25ColumnIndex+1);
         }
         ...
         if ( ! context.isAjaxRequest( ) )
         {
            AV28HttpResponse.AppendHeader("Content-Disposition", "attachment;filename=ExportWWTicket.xlsx");
         }
         if ( ! context.isAjaxRequest( ) )
         {
      ...
      public override void initialize( )
      {
         ...
         A188EstadoTicketTicketNombre = "";
         A94UsuarioRequerimiento = "";
         P003Q2_A15UsuarioId = new short[1] ;
      ...
      private short[] P003Q2_A15UsuarioId ;
