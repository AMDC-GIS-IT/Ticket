...
namespace GeneXus.Programs {
   public class wwusuario : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249525236", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vUSUARIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV57UsuarioId), 4, 0, ",", "")));
         /* Send saved values. */
      ...
      protected void WB2J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavUsuarioid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV57UsuarioId), 4, 0, ",", "")), ((edtavUsuarioid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV57UsuarioId), "ZZZ9")) : context.localUtil.Format( (decimal)(AV57UsuarioId), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUsuarioid_Jsonclick, 0, "Attribute_Filter", "", "", "", "", 1, edtavUsuarioid_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_WWUsuario.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV50Update)) ? AV64Update_GXI : context.convertURL( context.PathToRelativeUrl( AV50Update))), !bGXsfl_180_Refreshing);
                              ...
                              AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV51Delete)) ? AV65Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV51Delete))), !bGXsfl_180_Refreshing);
      ...
      protected void send_integrity_lvl_hashes2J2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV62Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV62Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_USUARIOID"+"_"+sGXsfl_180_idx, GetSecureSignedToken( sGXsfl_180_idx, context.localUtil.Format( (decimal)(A15UsuarioId), "ZZZ9"), context));
      }
      ...
      protected void STRUP2J0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            {
               AV57UsuarioId = (short)(context.localUtil.CToN( cgiGet( edtavUsuarioid_Internalname), ",", "."));
               AssignAttri("", false, "AV57UsuarioId", StringUtil.LTrimStr( (decimal)(AV57UsuarioId), 4, 0));
            }
            ...
            if ( context.localUtil.CToD( cgiGet( "GXH_vUSUARIOFECHA_FROM"), 2) != AV58UsuarioFecha_From )
            {
               GRID_nFirstRecordOnPage = 0;
            }
            if ( ( context.localUtil.CToN( cgiGet( "GXH_vUSUARIOID"), ",", ".") != Convert.ToDecimal( AV57UsuarioId )) )
      ...
      protected void E222J2( )
      {
         ...
         new k2bloadrowsperpage(context ).execute(  AV62Pgmname,  "Grid", out  AV25RowsPerPageVariable, out  AV26RowsPerPageLoaded) ;
      ...
      protected void E232J2( )
      {
         ...
         AV63GXV1 = 1;
         while ( AV63GXV1 <= AV47Messages.Count )
         {
            AV48Message = ((GeneXus.Utils.SdtMessages_Message)AV47Messages.Item(AV63GXV1));
         ...
         AV55ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV62Pgmname;
         ...
         AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV50Update)) ? AV64Update_GXI : context.convertURL( context.PathToRelativeUrl( AV50Update))), !bGXsfl_180_Refreshing);
         AssignProp("", false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV50Update), true);
         AV64Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "788f9b72-f982-49f9-99e4-c0374e31a85a", "", context.GetTheme( )));
         AssignProp("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV50Update)) ? AV64Update_GXI : context.convertURL( context.PathToRelativeUrl( AV50Update))), !bGXsfl_180_Refreshing);
         AssignProp("", false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV50Update), true);
         ...
         AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV51Delete)) ? AV65Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV51Delete))), !bGXsfl_180_Refreshing);
         AssignProp("", false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV51Delete), true);
         AV65Delete_GXI = GXDbFile.PathToUrl( context.GetImagePath( "3e4a9f50-2c57-41b6-9da5-ebe49bca33c0", "", context.GetTheme( )));
         AssignProp("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV51Delete)) ? AV65Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV51Delete))), !bGXsfl_180_Refreshing);
         AssignProp("", false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV51Delete), true);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV27GridStateKey = "";
         new k2bloadgridstate(context ).execute(  AV62Pgmname,  AV27GridStateKey, out  AV28GridState) ;
         ...
         AV66GXV2 = 1;
         while ( AV66GXV2 <= AV28GridState.gxTpr_Filtervalues.Count )
         {
            AV29GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV28GridState.gxTpr_Filtervalues.Item(AV66GXV2));
            ...
            {
               AV57UsuarioId = (short)(NumberUtil.Val( AV29GridStateFilterValue.gxTpr_Value, "."));
               AssignAttri("", false, "AV57UsuarioId", StringUtil.LTrimStr( (decimal)(AV57UsuarioId), 4, 0));
            }
      ...
      protected void S132( )
      {
         ...
         AV29GridStateFilterValue.gxTpr_Value = StringUtil.Str( (decimal)(AV57UsuarioId), 4, 0);
         AV28GridState.gxTpr_Filtervalues.Add(AV29GridStateFilterValue, 0);
         AV29GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         ...
         AV28GridState.gxTpr_Filtervalues.Add(AV29GridStateFilterValue, 0);
         new k2bsavegridstate(context ).execute(  AV62Pgmname,  AV27GridStateKey,  AV28GridState) ;
      }
      ...
      protected void E142J2( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         CallWebObject(formatLink("exportwwusuario.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV31UsuarioNombre)),UrlEncode(DateTimeUtil.FormatDateParm(AV58UsuarioFecha_From)),UrlEncode(DateTimeUtil.FormatDateParm(AV59UsuarioFecha_To)),UrlEncode(StringUtil.LTrimStr(AV57UsuarioId,4,0)),UrlEncode(StringUtil.RTrim(AV42K2BToolsGenericSearchField)),UrlEncode(StringUtil.LTrimStr(AV43OrderedBy,4,0))}, new string[] {"UsuarioNombre","UsuarioFecha_From","UsuarioFecha_To","UsuarioId","K2BToolsGenericSearchField","OrderedBy"}) );
      ...
      protected void S202( )
      {
         ...
         AssignAttri("", false, "AV22Att_UsuarioTelefono_Visible", AV22Att_UsuarioTelefono_Visible);
         new k2bsavegridconfiguration(context ).execute(  AV62Pgmname,  "Grid",  AV10GridConfiguration,  false) ;
         AV67GXV3 = 1;
         while ( AV67GXV3 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV13GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV10GridConfiguration.gxTpr_Gridcolumns.Item(AV67GXV3));
      ...
      protected void S122( )
      {
         ...
         if ( ! (0==AV57UsuarioId) )
         {
            ...
            AV39K2BFilterValuesSDTItem.gxTpr_Type = "Standard";
            AV39K2BFilterValuesSDTItem.gxTpr_Value = StringUtil.Str( (decimal)(AV57UsuarioId), 4, 0);
            AV39K2BFilterValuesSDTItem.gxTpr_Valuedescription = StringUtil.Str( (decimal)(AV57UsuarioId), 4, 0);
            AV38K2BFilterValuesSDT.Add(AV39K2BFilterValuesSDTItem, 0);
         }
         ...
         if ( AV38K2BFilterValuesSDT.Count > 0 )
         {
            ...
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV62Pgmname,  "Grid",  AV38K2BFilterValuesSDT, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item4) ;
      ...
      protected void E152J2( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  AV62Pgmname,  "Grid", ref  AV10GridConfiguration) ;
         AV68GXV4 = 1;
         while ( AV68GXV4 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV13GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV10GridConfiguration.gxTpr_Gridcolumns.Item(AV68GXV4));
            if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "UsuarioId") == 0 )
            {
         ...
         new k2bsavegridconfiguration(context ).execute(  AV62Pgmname,  "Grid",  AV10GridConfiguration,  true) ;
         AV46UC_OrderedBy = AV43OrderedBy;
         AssignAttri("", false, "AV46UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV46UC_OrderedBy), 4, 0));
         if ( AV25RowsPerPageVariable != AV24GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV25RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV62Pgmname,  "Grid",  AV25RowsPerPageVariable) ;
            AV8CurrentPage = 1;
            AssignAttri("", false, "AV8CurrentPage", StringUtil.LTrimStr( (decimal)(AV8CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023124952584", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwusuario.js", "?2023124952584", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/K2BDateRangePickerRender.js", "", false, true);
      ...
      protected void sendrow_1802( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_180_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV50Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV50Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV64Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV50Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV50Update)) ? AV64Update_GXI : context.PathToRelativeUrl( AV50Update));
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV51Delete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV51Delete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV65Delete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV51Delete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV51Delete)) ? AV65Delete_GXI : context.PathToRelativeUrl( AV51Delete));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOINSERT'","{handler:'E132J2',iparms:[{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZ9',hsh:true},{av:'AV14Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV15Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV16Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV19Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV22Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOINSERT'",",oparms:[{av:'AV14Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV15Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV16Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV19Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV22Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("'DOEXPORT'","{handler:'E142J2',iparms:[{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV58UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV59UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV57UsuarioId',fld:'vUSUARIOID',pic:'ZZZ9'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV15Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV16Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV19Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV22Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOEXPORT'",",oparms:[{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV15Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV16Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV19Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV22Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E252J2',iparms:[{av:'AV49UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZ9',hsh:true},{av:'AV14Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV15Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV16Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV19Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV22Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED","{handler:'E112J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV58UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV57UsuarioId',fld:'vUSUARIOID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV59UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV62Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'AV41DeletedTag',fld:'vDELETEDTAG',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV15Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV16Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV19Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV22Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED",",oparms:[{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV58UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV59UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV57UsuarioId',fld:'vUSUARIOID',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Tooltiptext'},{ctrl:'EXPORT',prop:'Tooltiptext'},{ctrl:'INSERT',prop:'Tooltiptext'},{av:'AV50Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV51Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'divDownloadsactionssectioncontainer_Visible',ctrl:'DOWNLOADSACTIONSSECTIONCONTAINER',prop:'Visible'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{ctrl:'INSERT',prop:'Visible'},{av:'AV49UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'edtUsuarioId_Visible',ctrl:'USUARIOID',prop:'Visible'},{av:'edtUsuarioNombre_Visible',ctrl:'USUARIONOMBRE',prop:'Visible'},{av:'edtUsuarioFecha_Visible',ctrl:'USUARIOFECHA',prop:'Visible'},{av:'edtUsuarioHora_Visible',ctrl:'USUARIOHORA',prop:'Visible'},{av:'edtUsuarioGerencia_Visible',ctrl:'USUARIOGERENCIA',prop:'Visible'},{av:'edtUsuarioDepartamento_Visible',ctrl:'USUARIODEPARTAMENTO',prop:'Visible'},{av:'edtUsuarioRequerimiento_Visible',ctrl:'USUARIOREQUERIMIENTO',prop:'Visible'},{av:'edtUsuarioEmail_Visible',ctrl:'USUARIOEMAIL',prop:'Visible'},{av:'edtUsuarioTelefono_Visible',ctrl:'USUARIOTELEFONO',prop:'Visible'},{av:'AV14Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV15Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV16Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV19Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV22Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E122J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV58UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV57UsuarioId',fld:'vUSUARIOID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV59UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV62Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'AV46UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV15Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV16Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV19Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV22Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E152J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV58UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV57UsuarioId',fld:'vUSUARIOID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV59UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV62Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{av:'AV25RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV24GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV15Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV16Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV19Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV22Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E162J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV58UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV57UsuarioId',fld:'vUSUARIOID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV59UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV62Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV15Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV16Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV19Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV22Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E172J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV58UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV57UsuarioId',fld:'vUSUARIOID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV59UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV62Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV15Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV16Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV19Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV22Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E182J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV58UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV57UsuarioId',fld:'vUSUARIOID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV59UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV62Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV15Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV16Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV19Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV22Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E192J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV58UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV57UsuarioId',fld:'vUSUARIOID',pic:'ZZZ9'},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV59UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV62Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49UsuarioNombre_IsAuthorized',fld:'vUSUARIONOMBRE_ISAUTHORIZED',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_UsuarioId_Visible',fld:'vATT_USUARIOID_VISIBLE',pic:''},{av:'AV15Att_UsuarioNombre_Visible',fld:'vATT_USUARIONOMBRE_VISIBLE',pic:''},{av:'AV16Att_UsuarioFecha_Visible',fld:'vATT_USUARIOFECHA_VISIBLE',pic:''},{av:'AV17Att_UsuarioHora_Visible',fld:'vATT_USUARIOHORA_VISIBLE',pic:''},{av:'AV18Att_UsuarioGerencia_Visible',fld:'vATT_USUARIOGERENCIA_VISIBLE',pic:''},{av:'AV19Att_UsuarioDepartamento_Visible',fld:'vATT_USUARIODEPARTAMENTO_VISIBLE',pic:''},{av:'AV20Att_UsuarioRequerimiento_Visible',fld:'vATT_USUARIOREQUERIMIENTO_VISIBLE',pic:''},{av:'AV21Att_UsuarioEmail_Visible',fld:'vATT_USUARIOEMAIL_VISIBLE',pic:''},{av:'AV22Att_UsuarioTelefono_Visible',fld:'vATT_USUARIOTELEFONO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         H002J2_A15UsuarioId = new short[1] ;
      ...
      private short[] H002J2_A15UsuarioId ;
   ...
   public class wwusuario__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002J2(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (DateTime)dynConstraints[6] , (short)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (int)dynConstraints[12] , (short)dynConstraints[13] );
               case 1 :
                     return conditional_H002J3(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (DateTime)dynConstraints[6] , (short)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (int)dynConstraints[12] , (short)dynConstraints[13] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV57UsuarioId",GXType.Int16,4,0) ,
