...
namespace GeneXus.Programs {
   public class usuariogeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)Gx_mode,(short)AV6UsuarioId,(string)AV8TabCode});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249495427", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB2K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_15_2K2( true) ;
         }
         else
         {
            wb_table1_15_2K2( false) ;
         }
         return  ;
      }

      protected void wb_table1_15_2K2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void E122K2( )
      {
         ...
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "Usuario";
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "Usuario";
         ...
         {
            A15UsuarioId = H002K2_A15UsuarioId[0];
            AV16GXLvl26 = 1;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Transactioncomponent_Component), StringUtil.Lower( "Usuario")) != 0 )
         {
            WebComp_Transactioncomponent = getWebComponent(GetType(), "GeneXus.Programs", "usuario", new Object[] {context} );
            WebComp_Transactioncomponent.ComponentInit();
            WebComp_Transactioncomponent.Name = "Usuario";
            WebComp_Transactioncomponent_Component = "Usuario";
         }
         if ( StringUtil.Len( WebComp_Transactioncomponent_Component) != 0 )
         {
            WebComp_Transactioncomponent.setjustcreated();
            WebComp_Transactioncomponent.componentprepare(new Object[] {(string)sPrefix+"W0029",(string)"",(string)Gx_mode,(short)AV6UsuarioId});
      ...
      protected void E132K2( )
      {
         /* 'DoUpdate' Routine */
         returnInSub = false;
         new k2bgettrncontextbyname(context ).execute(  "Usuario", out  AV10TrnContext) ;
         GXt_char1 = "";
         ...
         new k2bsettrncontextbyname(context ).execute(  "Usuario",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerusuario.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(AV6UsuarioId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","UsuarioId","TabCode"}) );
      ...
      protected void E142K2( )
      {
         ...
         AV10TrnContext.gxTpr_Returnmode = "Popup";
         new k2bsettrncontextbyname(context ).execute(  "Usuario",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerusuario.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(AV6UsuarioId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","UsuarioId","TabCode"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void wb_table1_15_2K2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_18_2K2( true) ;
         }
         else
         {
            wb_table2_18_2K2( false) ;
         }
         return  ;
      }

      protected void wb_table2_18_2K2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_15_2K2e( true) ;
         }
         else
         {
            wb_table1_15_2K2e( false) ;
         }
      }

      protected void wb_table2_18_2K2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_18_2K2e( true) ;
         }
         else
         {
            wb_table2_18_2K2e( false) ;
         }
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6UsuarioId = (string)((string)getParm(obj,1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "Gx_mode", Gx_mode);
            AV6UsuarioId = Convert.ToInt16(getParm(obj,3));
            AssignAttri(sPrefix, false, "AV6UsuarioId", StringUtil.LTrimStr( (decimal)(AV6UsuarioId), 4, 0));
         ...
         wcpOAV6UsuarioId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6UsuarioId"), ",", "."));
         wcpOAV8TabCode = cgiGet( sPrefix+"wcpOAV8TabCode");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(Gx_mode, wcpOGx_mode) != 0 ) || ( AV6UsuarioId != wcpOAV6UsuarioId ) || ( StringUtil.StrCmp(AV8TabCode, wcpOAV8TabCode) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOGx_mode = Gx_mode;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249495462", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("usuariogeneral.js", "?20231249495462", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZ9'},{av:'AV6UsuarioId',fld:'vUSUARIOID',pic:'ZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E132K2',iparms:[{av:'AV6UsuarioId',fld:'vUSUARIOID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E142K2',iparms:[{av:'AV6UsuarioId',fld:'vUSUARIOID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV12ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         scmdbuf = "";
         H002K2_A15UsuarioId = new short[1] ;
      ...
      private short[] H002K2_A15UsuarioId ;
   ...
   public class usuariogeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002K2", "SELECT [UsuarioId] FROM [Usuario] WHERE [UsuarioId] = @AV6UsuarioId ORDER BY [UsuarioId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002K2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
