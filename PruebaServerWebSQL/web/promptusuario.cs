...
namespace GeneXus.Programs {
   public class promptusuario : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV17pUsuarioId = (short)(NumberUtil.Val( GetPar( "pUsuarioId"), "."));
            ...
            {
               AV17pUsuarioId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV17pUsuarioId", StringUtil.LTrimStr( (decimal)(AV17pUsuarioId), 4, 0));
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249525910", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("promptusuario.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV17pUsuarioId,4,0))}, new string[] {"pUsuarioId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPUSUARIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV17pUsuarioId), 4, 0, ",", "")));
      ...
      {
         return formatLink("promptusuario.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV17pUsuarioId,4,0))}, new string[] {"pUsuarioId"})  ;
      }
      ...
      protected void wb_table1_58_302e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" width="+StringUtil.LTrimStr( (decimal)(62), 4, 0)+"px"+" class=\""+"Attribute_Grid"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
      ...
      protected void send_integrity_lvl_hashes302( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV40Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV40Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_USUARIOID"+"_"+sGXsfl_102_idx, GetSecureSignedToken( sGXsfl_102_idx, context.localUtil.Format( (decimal)(A15UsuarioId), "ZZZ9"), context));
      }
      ...
      protected void STRUP300( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.CToD( cgiGet( "GXH_vUSUARIOFECHA_FROM"), 2) != AV20UsuarioFecha_From )
            {
               GRID_nFirstRecordOnPage = 0;
            }
      ...
      protected void E22302( )
      {
         ...
         AssignAttri("", false, "AV17pUsuarioId", StringUtil.LTrimStr( (decimal)(AV17pUsuarioId), 4, 0));
         context.setWebReturnParms(new Object[] {(short)AV17pUsuarioId});
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV12GridStateKey = StringUtil.Str( (decimal)(AV17pUsuarioId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV17pUsuarioId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV17pUsuarioId", StringUtil.LTrimStr( (decimal)(AV17pUsuarioId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023124953156", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("promptusuario.js", "?2023124953156", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/K2BDateRangePickerRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E22302',iparms:[{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZ9',hsh:true},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV17pUsuarioId',fld:'vPUSUARIOID',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         ...
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED","{handler:'E11302',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV20UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV23UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV24UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV21UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pUsuarioId',fld:'vPUSUARIOID',pic:'ZZZ9'},{av:'AV28DeletedTag',fld:'vDELETEDTAG',pic:''},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E12302',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV29K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18UsuarioNombre',fld:'vUSUARIONOMBRE',pic:''},{av:'AV20UsuarioFecha_From',fld:'vUSUARIOFECHA_FROM',pic:''},{av:'AV23UsuarioHora_From',fld:'vUSUARIOHORA_FROM',pic:'99:99'},{av:'AV24UsuarioHora_To',fld:'vUSUARIOHORA_TO',pic:'99:99'},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV30OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV21UsuarioFecha_To',fld:'vUSUARIOFECHA_TO',pic:''},{av:'AV40Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pUsuarioId',fld:'vPUSUARIOID',pic:'ZZZ9'},{av:'AV34UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         H00302_A15UsuarioId = new short[1] ;
      ...
      private short[] H00302_A15UsuarioId ;
