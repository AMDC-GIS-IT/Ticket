...
namespace GeneXus.Programs {
   public class exportestadoticketticketwc : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV8EstadoTicketTecnicoId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      public short executeUdp( short aP0_EstadoTicketTecnicoId ,
                               DateTime aP1_TicketFecha_From ,
                               DateTime aP2_TicketFecha_To ,
                               DateTime aP3_TicketHora_From ,
                               DateTime aP4_TicketHora_To ,
                               ...
                               string aP6_K2BToolsGenericSearchField )
      {
         execute(aP0_EstadoTicketTecnicoId, aP1_TicketFecha_From, aP2_TicketFecha_To, aP3_TicketHora_From, aP4_TicketHora_To, aP5_UsuarioNombre, aP6_K2BToolsGenericSearchField, ref aP7_OrderedBy);
      ...
      void executePrivate( )
      {
         ...
         if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "Ticket",  "Ticket",  "List",  "",  "EstadoTicketTicketWC") )
         {
            ...
            AV24ErrorMessage += "PgmName:" + AV62Pgmname;
         ...
         AV23Filename = GxDirectory.TemporaryFilesPath + AV26File.Separator + "ExportEstadoTicketTicketWC-" + StringUtil.Trim( StringUtil.Str( (decimal)(AV21Random), 8, 0)) + ".xlsx";
         ...
         {
            AV18ExcelDocument.get_Cells(AV19CellRow, AV20FirstColumn+AV22ColumnIndex, 1, 1).Bold = 1;
            AV18ExcelDocument.get_Cells(AV19CellRow, AV20FirstColumn+AV22ColumnIndex, 1, 1).Text = "Router";
            AV22ColumnIndex = (short)(AV22ColumnIndex+1);
         }
         ...
         if ( ! context.isAjaxRequest( ) )
         {
            AV25HttpResponse.AppendHeader("Content-Disposition", "attachment;filename=ExportEstadoTicketTicketWC.xlsx");
         }
         if ( ! context.isAjaxRequest( ) )
         {
      ...
      protected void S131( )
      {
         ...
         AV30GridColumn.gxTpr_Columntitle = "Router";
         AV30GridColumn.gxTpr_Showattribute = true;
         AV29GridColumns.Add(AV30GridColumn, 0);
         AV30GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
      ...
      public override void initialize( )
      {
         ...
         P003E3_A15UsuarioId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.exportestadoticketticketwc__default(),
            new Object[][] {
               ...
               , new Object[] {
               P003E3_A54TicketLastId, P003E3_A94UsuarioRequerimiento, P003E3_A15UsuarioId, P003E3_A14TicketId, P003E3_A93UsuarioNombre, P003E3_A48TicketHora, P003E3_A46TicketFecha, P003E3_A53TicketLaptop, P003E3_A42TicketDesktop, P003E3_A55TicketMonitor,
               P003E3_A50TicketImpresora, P003E3_A45TicketEscaner, P003E3_A59TicketRouter, P003E3_A60TicketSistemaOperativo, P003E3_A56TicketOffice, P003E3_A39TicketAntivirus, P003E3_A40TicketAplicacion, P003E3_A44TicketDisenio, P003E3_A51TicketIngenieria, P003E3_A43TicketDiscoDuroExterno,
               P003E3_A58TicketPerifericos, P003E3_A87TicketUps, P003E3_A41TicketApoyoUsuario, P003E3_A52TicketInstalarDataShow, P003E3_A57TicketOtros
               }
            }
         );
         AV62Pgmname = "ExportEstadoTicketTicketWC";
         /* GeneXus formulas. */
         AV62Pgmname = "ExportEstadoTicketTicketWC";
         context.Gx_err = 0;
      }
      ...
      private short[] P003E3_A15UsuarioId ;
   ...
   public class exportestadoticketticketwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_P003E3(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (string)dynConstraints[8] , (long)dynConstraints[9] , (short)dynConstraints[10] , (string)dynConstraints[11] , (short)dynConstraints[12] , (string)dynConstraints[13] , (long)dynConstraints[14] , (short)dynConstraints[15] , (short)dynConstraints[17] );
         }
