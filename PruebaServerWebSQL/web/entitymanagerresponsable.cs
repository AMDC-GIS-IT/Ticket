...
namespace GeneXus.Programs {
   public class entitymanagerresponsable : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public entitymanagerresponsable( )
      {
      ...
      public entitymanagerresponsable( IGxContext context )
      {
                           ...
                           string aP2_TabCode )
      {
         ...
         this.AV6ResponsableId = aP1_ResponsableId;
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  ...
                  GxWebStd.gx_hidden_field( context, "gxhash_vRESPONSABLEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6ResponsableId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2023124952494", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("entitymanagerresponsable.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6ResponsableId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Gx_mode","ResponsableId","TabCode"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vMODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( Gx_mode, "@!")), context));
         GxWebStd.gx_hidden_field( context, "vRESPONSABLEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6ResponsableId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vRESPONSABLEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6ResponsableId), "ZZZ9"), context));
      ...
      {
         return formatLink("entitymanagerresponsable.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6ResponsableId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Gx_mode","ResponsableId","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "EntityManagerResponsable" ;
      }
      ...
      protected void WB2M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblK2bpgmdesc_Internalname, lblK2bpgmdesc_Caption, "", "", lblK2bpgmdesc_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_EntityManagerResponsable.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblBacktoworkwith_Internalname, lblBacktoworkwith_Caption, lblBacktoworkwith_Link, "", lblBacktoworkwith_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_BackToWorkWith", 0, "", 1, 1, 0, 0, "HLP_EntityManagerResponsable.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_53_2M2( true) ;
         }
         else
         {
            wb_table1_53_2M2( false) ;
         }
         return  ;
      }

      protected void wb_table1_53_2M2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      {
         /* GeneXus formulas. */
         AV27Pgmname = "EntityManagerResponsable";
         context.Gx_err = 0;
      }
      ...
      protected void E112M2( )
      {
         /* Start Routine */
         returnInSub = false;
         lblBacktoworkwith_Caption = StringUtil.Format( "%1", "Responsables", "", "", "", "", "", "", "", "");
         AssignProp("", false, lblBacktoworkwith_Internalname, "Caption", lblBacktoworkwith_Caption, true);
         lblBacktoworkwith_Link = formatLink("wwresponsable.aspx") ;
         AssignProp("", false, lblBacktoworkwith_Internalname, "Link", lblBacktoworkwith_Link, true);
         AV26GXLvl7 = 0;
         /* Using cursor H002M2 */
         pr_default.execute(0, new Object[] {AV6ResponsableId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A6ResponsableId = H002M2_A6ResponsableId[0];
            A29ResponsableIdentidad = H002M2_A29ResponsableIdentidad[0];
            AV26GXLvl7 = 1;
            Form.Caption = A29ResponsableIdentidad;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblK2bpgmdesc_Caption = StringUtil.Format( "%1 - %2", "Responsable", A29ResponsableIdentidad, "", "", "", "", "", "", "");
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            lblK2bpgmdesc_Caption = "Responsable";
            AssignProp("", false, lblK2bpgmdesc_Internalname, "Caption", lblK2bpgmdesc_Caption, true);
         }
      ...
      protected void E122M2( )
      {
         ...
         {
            AV20RelatedTransactionName = "Responsable";
         ...
         if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               lblComponenttitle_Caption = StringUtil.Format( "Actualizar %1", "Responsable", "", "", "", "", "", "", "", "");
               ...
               if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Popupcomponent_Component), StringUtil.Lower( "Responsable")) != 0 )
               {
                  WebComp_Popupcomponent = getWebComponent(GetType(), "GeneXus.Programs", "responsable", new Object[] {context} );
                  WebComp_Popupcomponent.ComponentInit();
                  WebComp_Popupcomponent.Name = "Responsable";
                  WebComp_Popupcomponent_Component = "Responsable";
               }
               if ( StringUtil.Len( WebComp_Popupcomponent_Component) != 0 )
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0073",(string)"",(string)"UPD",(short)AV6ResponsableId});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
         {
            if ( ( StringUtil.StrCmp(AV8TabCode, "General") == 0 ) || String.IsNullOrEmpty(StringUtil.RTrim( AV8TabCode)) )
            {
               lblComponenttitle_Caption = StringUtil.Format( "Eliminar %1", "Responsable", "", "", "", "", "", "", "", "");
               AssignProp("", false, lblComponenttitle_Internalname, "Caption", lblComponenttitle_Caption, true);
               tblTablemodal_Visible = 1;
               AssignProp("", false, tblTablemodal_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(tblTablemodal_Visible), 5, 0), true);
               /* Object Property */
               ...
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0073",(string)"",(string)"DLT",(short)AV6ResponsableId});
                  WebComp_Popupcomponent.componentbind(new Object[] {(string)"",(string)""});
               }
               if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Popupcomponent )
               {
      ...
      protected void S112( )
      {
         ...
         AV11Tab.gxTpr_Link = formatLink("entitymanagerresponsable.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6ResponsableId,4,0)),UrlEncode(StringUtil.RTrim(AV11Tab.gxTpr_Code))}, new string[] {"Mode","ResponsableId","TabCode"}) ;
         AV11Tab.gxTpr_Componenttype = 3;
         AV11Tab.gxTpr_Relatedtransaction = "Responsable";
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Componentwc_general_Component), StringUtil.Lower( "ResponsableGeneral")) != 0 )
            {
               WebComp_Componentwc_general = getWebComponent(GetType(), "GeneXus.Programs", "responsablegeneral", new Object[] {context} );
               WebComp_Componentwc_general.ComponentInit();
               WebComp_Componentwc_general.Name = "ResponsableGeneral";
               WebComp_Componentwc_general_Component = "ResponsableGeneral";
            }
            if ( StringUtil.Len( WebComp_Componentwc_general_Component) != 0 )
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0041",(string)"",(string)Gx_mode,(short)AV6ResponsableId,(string)AV8TabCode});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0041",(string)"",(string)"DSP",(short)AV6ResponsableId,(string)AV8TabCode});
               WebComp_Componentwc_general.componentbind(new Object[] {(string)"",(string)"",(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Componentwc_general )
            {
      ...
      protected void S132( )
      {
         ...
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "Ticket",  "Ticket",  "List",  "",  "ResponsableTicketWC") )
         {
            if ( StringUtil.StrCmp(Gx_mode, "INS") != 0 )
            {
               ...
               if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Componentwc_responsable_Component), StringUtil.Lower( "ResponsableTicketWC")) != 0 )
               {
                  WebComp_Componentwc_responsable = getWebComponent(GetType(), "GeneXus.Programs", "responsableticketwc", new Object[] {context} );
                  WebComp_Componentwc_responsable.ComponentInit();
                  WebComp_Componentwc_responsable.Name = "ResponsableTicketWC";
                  WebComp_Componentwc_responsable_Component = "ResponsableTicketWC";
               }
               if ( StringUtil.Len( WebComp_Componentwc_responsable_Component) != 0 )
               {
                  WebComp_Componentwc_responsable.setjustcreated();
                  WebComp_Componentwc_responsable.componentprepare(new Object[] {(string)"W0047",(string)"",(short)AV6ResponsableId});
      ...
      protected void wb_table1_53_2M2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_59_2M2( true) ;
         }
         else
         {
            wb_table2_59_2M2( false) ;
         }
         return  ;
      }

      protected void wb_table2_59_2M2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            wb_table1_53_2M2e( true) ;
         }
         else
         {
            wb_table1_53_2M2e( false) ;
         }
      }

      protected void wb_table2_59_2M2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblComponenttitle_Internalname, lblComponenttitle_Caption, "", "", lblComponenttitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "PopupTitle", 0, "", 1, 1, 0, 0, "HLP_EntityManagerResponsable.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table3_64_2M2( true) ;
         }
         else
         {
            wb_table3_64_2M2( false) ;
         }
         return  ;
      }

      protected void wb_table3_64_2M2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_59_2M2e( true) ;
         }
         else
         {
            wb_table2_59_2M2e( false) ;
         }
      }

      protected void wb_table3_64_2M2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'CLOSEMODAL\\'."+"'", "", "PopupHeaderButton", 5, "", 1, 1, 0, 0, "HLP_EntityManagerResponsable.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_64_2M2e( true) ;
         }
         else
         {
            wb_table3_64_2M2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "Gx_mode", Gx_mode);
         AV6ResponsableId = Convert.ToInt16(getParm(obj,1));
         AssignAttri("", false, "AV6ResponsableId", StringUtil.LTrimStr( (decimal)(AV6ResponsableId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vRESPONSABLEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6ResponsableId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249524968", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("entitymanagerresponsable.js", "?20231249524968", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GLOBALEVENTS.K2BT_REFRESHENTITYMANAGER","{handler:'E132M2',iparms:[{av:'AV22GE_ComponentName',fld:'vGE_COMPONENTNAME',pic:''},{av:'AV21GE_EntityManagerName',fld:'vGE_ENTITYMANAGERNAME',pic:''},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV6ResponsableId',fld:'vRESPONSABLEID',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("'CLOSEMODAL'","{handler:'E142M2',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H002M2_A6ResponsableId = new short[1] ;
         H002M2_A29ResponsableIdentidad = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.entitymanagerresponsable__default(),
            new Object[][] {
                new Object[] {
               H002M2_A6ResponsableId, H002M2_A29ResponsableIdentidad
               }
            }
         );
      ...
      private short[] H002M2_A6ResponsableId ;
      private string[] H002M2_A29ResponsableIdentidad ;
   ...
   public class entitymanagerresponsable__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002M2", "SELECT TOP 1 [ResponsableId], [ResponsableIdentidad] FROM [Responsable] WHERE [ResponsableId] = @AV6ResponsableId ORDER BY [ResponsableId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002M2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
