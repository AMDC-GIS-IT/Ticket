...
namespace GeneXus.Programs {
   public class reportticketsatisfaccionwc : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
         ...
         try
         {
            ...
            else
            {
               ...
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV27SatisfaccionAtencionNombre)) )
               {
                  ...
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV27SatisfaccionAtencionNombre, "")), 223, Gx_line+7, 443, Gx_line+23, 0+256, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
               }
               H3T0( false, 30) ;
               ...
               getPrinter().GxDrawText("Fecha Encuesta:", 56, Gx_line+7, 145, Gx_line+22, 2, 0, 0, 1) ;
               getPrinter().GxDrawText("Fecha Inicio:", 153, Gx_line+7, 239, Gx_line+22, 2, 0, 0, 1) ;
               getPrinter().GxDrawText("Satisfaccion Resuelto Nombre", 247, Gx_line+7, 340, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Satisfaccion Tecnico Problema Nombre", 348, Gx_line+7, 437, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Satisfaccion Tecnico Competente Nombre", 445, Gx_line+7, 539, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Satisfaccion Tecnico Profesionalismo Nombre", 547, Gx_line+7, 641, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Satisfaccion Tiempo Nombre", 649, Gx_line+7, 742, Gx_line+22, 0, 0, 0, 1) ;
               Gx_OldLine = Gx_line;
               Gx_line = (int)(Gx_line+30);
               GxHdr3 = true;
               ...
               while ( (pr_default.getStatus(0) != 101) )
               {
                  ...
                  getPrinter().GxDrawText(context.localUtil.Format( A32SatisfaccionFecha, "99/99/9999"), 56, Gx_line+7, 145, Gx_line+23, 2, 0, 0, 0) ;
                  getPrinter().GxDrawText(context.localUtil.Format( A90UsuarioFecha, "99/99/9999"), 153, Gx_line+7, 239, Gx_line+23, 2, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A33SatisfaccionResueltoNombre, "")), 247, Gx_line+7, 340, Gx_line+23, 0, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A36SatisfaccionTecnicoProblemaNombre, "")), 348, Gx_line+7, 437, Gx_line+23, 0, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A35SatisfaccionTecnicoCompetenteNombre, "")), 445, Gx_line+7, 539, Gx_line+23, 0, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A37SatisfaccionTecnicoProfesionalismoNombre, "")), 547, Gx_line+7, 641, Gx_line+23, 0, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A38SatisfaccionTiempoNombre, "")), 649, Gx_line+7, 742, Gx_line+23, 0, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
      ...
      public override void initialize( )
      {
         ...
         A31SatisfaccionAtencionNombre = "";
         A34SatisfaccionSugerencia = "";
         P003T2_A15UsuarioId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportticketsatisfaccionwc__default(),
            new Object[][] {
                new Object[] {
               P003T2_A15UsuarioId, P003T2_A8SatisfaccionResueltoId, P003T2_A9SatisfaccionTecnicoProblemaId, P003T2_A10SatisfaccionTecnicoCompetenteId, P003T2_A11SatisfaccionTecnicoProfesionalismoId, P003T2_A12SatisfaccionTiempoId, P003T2_A13SatisfaccionAtencionId, P003T2_A14TicketId, P003T2_A34SatisfaccionSugerencia, P003T2_A7SatisfaccionId,
               P003T2_A31SatisfaccionAtencionNombre, P003T2_A38SatisfaccionTiempoNombre, P003T2_A37SatisfaccionTecnicoProfesionalismoNombre, P003T2_A35SatisfaccionTecnicoCompetenteNombre, P003T2_A36SatisfaccionTecnicoProblemaNombre, P003T2_A33SatisfaccionResueltoNombre, P003T2_A90UsuarioFecha, P003T2_A32SatisfaccionFecha
               }
            }
         );
      ...
      private short[] P003T2_A15UsuarioId ;
