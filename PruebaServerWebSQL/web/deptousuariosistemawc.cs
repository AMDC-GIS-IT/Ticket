   ...
   public class deptousuariosistemawc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV52Pgmname = "DeptoUsuarioSistemaWC";
               context.Gx_err = 0;
               WS632( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231249494387", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV43Update)) ? AV54Update_GXI : context.convertURL( context.PathToRelativeUrl( AV43Update))), !bGXsfl_153_Refreshing);
                              ...
                              AssignProp(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV44Delete)) ? AV55Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV44Delete))), !bGXsfl_153_Refreshing);
      ...
      protected void E22632( )
      {
         ...
         new k2bloadrowsperpage(context ).execute(  AV52Pgmname,  "Grid", out  AV23RowsPerPageVariable, out  AV24RowsPerPageLoaded) ;
      ...
      protected void E23632( )
      {
         ...
         AV53GXV1 = 1;
         while ( AV53GXV1 <= AV40Messages.Count )
         {
            AV41Message = ((GeneXus.Utils.SdtMessages_Message)AV40Messages.Item(AV53GXV1));
         ...
         AV48ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV52Pgmname;
         ...
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV43Update)) ? AV54Update_GXI : context.convertURL( context.PathToRelativeUrl( AV43Update))), !bGXsfl_153_Refreshing);
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV43Update), true);
         AV54Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "788f9b72-f982-49f9-99e4-c0374e31a85a", "", context.GetTheme( )));
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV43Update)) ? AV54Update_GXI : context.convertURL( context.PathToRelativeUrl( AV43Update))), !bGXsfl_153_Refreshing);
         AssignProp(sPrefix, false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV43Update), true);
         ...
         AssignProp(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV44Delete)) ? AV55Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV44Delete))), !bGXsfl_153_Refreshing);
         AssignProp(sPrefix, false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV44Delete), true);
         AV55Delete_GXI = GXDbFile.PathToUrl( context.GetImagePath( "3e4a9f50-2c57-41b6-9da5-ebe49bca33c0", "", context.GetTheme( )));
         AssignProp(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV44Delete)) ? AV55Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV44Delete))), !bGXsfl_153_Refreshing);
         AssignProp(sPrefix, false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV44Delete), true);
      ...
      protected void S112( )
      {
         ...
         new k2bloadgridstate(context ).execute(  AV52Pgmname,  AV25GridStateKey, out  AV26GridState) ;
         ...
         AV56GXV2 = 1;
         while ( AV56GXV2 <= AV26GridState.gxTpr_Filtervalues.Count )
         {
            AV27GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV26GridState.gxTpr_Filtervalues.Item(AV56GXV2));
      ...
      protected void S132( )
      {
         ...
         AV26GridState.gxTpr_Filtervalues.Add(AV27GridStateFilterValue, 0);
         new k2bsavegridstate(context ).execute(  AV52Pgmname,  AV25GridStateKey,  AV26GridState) ;
      }
      ...
      protected void E14632( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         CallWebObject(formatLink("exportdeptousuariosistemawc.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV6CentrodecostoId)),UrlEncode(StringUtil.LTrimStr(AV7DepartamentoId,4,0)),UrlEncode(StringUtil.RTrim(AV29UsuarioSistemaIdentidad)),UrlEncode(StringUtil.RTrim(AV30DireccionDescripcion)),UrlEncode(StringUtil.RTrim(AV35K2BToolsGenericSearchField)),UrlEncode(StringUtil.LTrimStr(AV36OrderedBy,4,0))}, new string[] {"CentrodecostoId","DepartamentoId","UsuarioSistemaIdentidad","DireccionDescripcion","K2BToolsGenericSearchField","OrderedBy"}) );
      ...
      protected void S202( )
      {
         ...
         AssignAttri(sPrefix, false, "AV21Att_DireccionDescripcion_Visible", AV21Att_DireccionDescripcion_Visible);
         new k2bsavegridconfiguration(context ).execute(  AV52Pgmname,  "Grid",  AV12GridConfiguration,  false) ;
         AV57GXV3 = 1;
         while ( AV57GXV3 <= AV12GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV15GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV12GridConfiguration.gxTpr_Gridcolumns.Item(AV57GXV3));
      ...
      protected void S182( )
      {
         ...
         AV15GridColumn.gxTpr_Columntitle = "Sistema Id";
         ...
         AV15GridColumn.gxTpr_Columntitle = "Sistema Identidad";
         AV15GridColumn.gxTpr_Showattribute = true;
         AV14GridColumns.Add(AV15GridColumn, 0);
         AV15GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV15GridColumn.gxTpr_Attributename = "UsuarioSistemaNombre";
         AV15GridColumn.gxTpr_Columntitle = "Sistema Nombre";
         AV15GridColumn.gxTpr_Showattribute = true;
         AV14GridColumns.Add(AV15GridColumn, 0);
         AV15GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV15GridColumn.gxTpr_Attributename = "UsuarioSistemaGerencia";
         AV15GridColumn.gxTpr_Columntitle = "Sistema Gerencia";
         AV15GridColumn.gxTpr_Showattribute = true;
         AV14GridColumns.Add(AV15GridColumn, 0);
         AV15GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
         AV15GridColumn.gxTpr_Attributename = "UsuarioSistemaDepartamento";
         AV15GridColumn.gxTpr_Columntitle = "Sistema Departamento";
         AV15GridColumn.gxTpr_Showattribute = true;
         AV14GridColumns.Add(AV15GridColumn, 0);
         AV15GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
      ...
      protected void S122( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV29UsuarioSistemaIdentidad)) )
         {
            ...
            AV32K2BFilterValuesSDTItem.gxTpr_Description = "Sistema Identidad";
         ...
         if ( AV31K2BFilterValuesSDT.Count > 0 )
         {
            ...
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV52Pgmname,  "Grid",  AV31K2BFilterValuesSDT, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item3) ;
      ...
      protected void E15632( )
      {
         ...
         new k2bloadgridconfiguration(context ).execute(  AV52Pgmname,  "Grid", ref  AV12GridConfiguration) ;
         AV58GXV4 = 1;
         while ( AV58GXV4 <= AV12GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV15GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV12GridConfiguration.gxTpr_Gridcolumns.Item(AV58GXV4));
            if ( StringUtil.StrCmp(AV15GridColumn.gxTpr_Attributename, "UsuarioSistemaId") == 0 )
            {
         ...
         new k2bsavegridconfiguration(context ).execute(  AV52Pgmname,  "Grid",  AV12GridConfiguration,  true) ;
         AV39UC_OrderedBy = AV36OrderedBy;
         AssignAttri(sPrefix, false, "AV39UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV39UC_OrderedBy), 4, 0));
         if ( AV23RowsPerPageVariable != AV22GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV23RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, sPrefix+"GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV52Pgmname,  "Grid",  AV23RowsPerPageVariable) ;
            AV10CurrentPage = 1;
            AssignAttri(sPrefix, false, "AV10CurrentPage", StringUtil.LTrimStr( (decimal)(AV10CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20231249494952", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("deptousuariosistemawc.js", "?20231249494952", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/silviomoreto-bootstrap-select/dist/js/bootstrap-select.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
      ...
      protected void sendrow_1532( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_153_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV43Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV43Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV54Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV43Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV43Update)) ? AV54Update_GXI : context.PathToRelativeUrl( AV43Update));
            ...
            ClassString = "Image_Action";
            StyleString = "";
            AV44Delete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV44Delete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV55Delete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV44Delete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV44Delete)) ? AV55Delete_GXI : context.PathToRelativeUrl( AV44Delete));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOEXPORT'","{handler:'E14632',iparms:[{av:'AV6CentrodecostoId',fld:'vCENTRODECOSTOID',pic:''},{av:'AV7DepartamentoId',fld:'vDEPARTAMENTOID',pic:'ZZZ9'},{av:'AV29UsuarioSistemaIdentidad',fld:'vUSUARIOSISTEMAIDENTIDAD',pic:''},{av:'AV30DireccionDescripcion',fld:'vDIRECCIONDESCRIPCION',pic:''},{av:'AV35K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV36OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV16Att_UsuarioSistemaId_Visible',fld:'vATT_USUARIOSISTEMAID_VISIBLE',pic:''},{av:'AV17Att_UsuarioSistemaIdentidad_Visible',fld:'vATT_USUARIOSISTEMAIDENTIDAD_VISIBLE',pic:''},{av:'AV18Att_UsuarioSistemaNombre_Visible',fld:'vATT_USUARIOSISTEMANOMBRE_VISIBLE',pic:''},{av:'AV19Att_UsuarioSistemaGerencia_Visible',fld:'vATT_USUARIOSISTEMAGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioSistemaDepartamento_Visible',fld:'vATT_USUARIOSISTEMADEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_DireccionDescripcion_Visible',fld:'vATT_DIRECCIONDESCRIPCION_VISIBLE',pic:''},{av:'AV13FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOEXPORT'",",oparms:[{av:'AV36OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV16Att_UsuarioSistemaId_Visible',fld:'vATT_USUARIOSISTEMAID_VISIBLE',pic:''},{av:'AV17Att_UsuarioSistemaIdentidad_Visible',fld:'vATT_USUARIOSISTEMAIDENTIDAD_VISIBLE',pic:''},{av:'AV18Att_UsuarioSistemaNombre_Visible',fld:'vATT_USUARIOSISTEMANOMBRE_VISIBLE',pic:''},{av:'AV19Att_UsuarioSistemaGerencia_Visible',fld:'vATT_USUARIOSISTEMAGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioSistemaDepartamento_Visible',fld:'vATT_USUARIOSISTEMADEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_DireccionDescripcion_Visible',fld:'vATT_DIRECCIONDESCRIPCION_VISIBLE',pic:''},{av:'AV13FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         ...
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E12632',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV35K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV29UsuarioSistemaIdentidad',fld:'vUSUARIOSISTEMAIDENTIDAD',pic:''},{av:'AV30DireccionDescripcion',fld:'vDIRECCIONDESCRIPCION',pic:''},{av:'AV6CentrodecostoId',fld:'vCENTRODECOSTOID',pic:''},{av:'AV7DepartamentoId',fld:'vDEPARTAMENTOID',pic:'ZZZ9'},{av:'AV28ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV36OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV52Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV12GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV42UsuarioSistemaIdentidad_IsAuthorized',fld:'vUSUARIOSISTEMAIDENTIDAD_ISAUTHORIZED',pic:''},{av:'sPrefix'},{av:'AV39UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV16Att_UsuarioSistemaId_Visible',fld:'vATT_USUARIOSISTEMAID_VISIBLE',pic:''},{av:'AV17Att_UsuarioSistemaIdentidad_Visible',fld:'vATT_USUARIOSISTEMAIDENTIDAD_VISIBLE',pic:''},{av:'AV18Att_UsuarioSistemaNombre_Visible',fld:'vATT_USUARIOSISTEMANOMBRE_VISIBLE',pic:''},{av:'AV19Att_UsuarioSistemaGerencia_Visible',fld:'vATT_USUARIOSISTEMAGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioSistemaDepartamento_Visible',fld:'vATT_USUARIOSISTEMADEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_DireccionDescripcion_Visible',fld:'vATT_DIRECCIONDESCRIPCION_VISIBLE',pic:''},{av:'AV13FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E15632',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV35K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV29UsuarioSistemaIdentidad',fld:'vUSUARIOSISTEMAIDENTIDAD',pic:''},{av:'AV30DireccionDescripcion',fld:'vDIRECCIONDESCRIPCION',pic:''},{av:'AV6CentrodecostoId',fld:'vCENTRODECOSTOID',pic:''},{av:'AV7DepartamentoId',fld:'vDEPARTAMENTOID',pic:'ZZZ9'},{av:'AV28ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV36OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV52Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV12GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV42UsuarioSistemaIdentidad_IsAuthorized',fld:'vUSUARIOSISTEMAIDENTIDAD_ISAUTHORIZED',pic:''},{av:'sPrefix'},{av:'AV23RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV22GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV16Att_UsuarioSistemaId_Visible',fld:'vATT_USUARIOSISTEMAID_VISIBLE',pic:''},{av:'AV17Att_UsuarioSistemaIdentidad_Visible',fld:'vATT_USUARIOSISTEMAIDENTIDAD_VISIBLE',pic:''},{av:'AV18Att_UsuarioSistemaNombre_Visible',fld:'vATT_USUARIOSISTEMANOMBRE_VISIBLE',pic:''},{av:'AV19Att_UsuarioSistemaGerencia_Visible',fld:'vATT_USUARIOSISTEMAGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioSistemaDepartamento_Visible',fld:'vATT_USUARIOSISTEMADEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_DireccionDescripcion_Visible',fld:'vATT_DIRECCIONDESCRIPCION_VISIBLE',pic:''},{av:'AV13FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E17632',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV35K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV29UsuarioSistemaIdentidad',fld:'vUSUARIOSISTEMAIDENTIDAD',pic:''},{av:'AV30DireccionDescripcion',fld:'vDIRECCIONDESCRIPCION',pic:''},{av:'AV6CentrodecostoId',fld:'vCENTRODECOSTOID',pic:''},{av:'AV7DepartamentoId',fld:'vDEPARTAMENTOID',pic:'ZZZ9'},{av:'AV28ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV36OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV52Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV12GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV42UsuarioSistemaIdentidad_IsAuthorized',fld:'vUSUARIOSISTEMAIDENTIDAD_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV16Att_UsuarioSistemaId_Visible',fld:'vATT_USUARIOSISTEMAID_VISIBLE',pic:''},{av:'AV17Att_UsuarioSistemaIdentidad_Visible',fld:'vATT_USUARIOSISTEMAIDENTIDAD_VISIBLE',pic:''},{av:'AV18Att_UsuarioSistemaNombre_Visible',fld:'vATT_USUARIOSISTEMANOMBRE_VISIBLE',pic:''},{av:'AV19Att_UsuarioSistemaGerencia_Visible',fld:'vATT_USUARIOSISTEMAGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioSistemaDepartamento_Visible',fld:'vATT_USUARIOSISTEMADEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_DireccionDescripcion_Visible',fld:'vATT_DIRECCIONDESCRIPCION_VISIBLE',pic:''},{av:'AV13FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E18632',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV35K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV29UsuarioSistemaIdentidad',fld:'vUSUARIOSISTEMAIDENTIDAD',pic:''},{av:'AV30DireccionDescripcion',fld:'vDIRECCIONDESCRIPCION',pic:''},{av:'AV6CentrodecostoId',fld:'vCENTRODECOSTOID',pic:''},{av:'AV7DepartamentoId',fld:'vDEPARTAMENTOID',pic:'ZZZ9'},{av:'AV28ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV36OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV52Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV12GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV42UsuarioSistemaIdentidad_IsAuthorized',fld:'vUSUARIOSISTEMAIDENTIDAD_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV16Att_UsuarioSistemaId_Visible',fld:'vATT_USUARIOSISTEMAID_VISIBLE',pic:''},{av:'AV17Att_UsuarioSistemaIdentidad_Visible',fld:'vATT_USUARIOSISTEMAIDENTIDAD_VISIBLE',pic:''},{av:'AV18Att_UsuarioSistemaNombre_Visible',fld:'vATT_USUARIOSISTEMANOMBRE_VISIBLE',pic:''},{av:'AV19Att_UsuarioSistemaGerencia_Visible',fld:'vATT_USUARIOSISTEMAGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioSistemaDepartamento_Visible',fld:'vATT_USUARIOSISTEMADEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_DireccionDescripcion_Visible',fld:'vATT_DIRECCIONDESCRIPCION_VISIBLE',pic:''},{av:'AV13FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E19632',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV35K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV29UsuarioSistemaIdentidad',fld:'vUSUARIOSISTEMAIDENTIDAD',pic:''},{av:'AV30DireccionDescripcion',fld:'vDIRECCIONDESCRIPCION',pic:''},{av:'AV6CentrodecostoId',fld:'vCENTRODECOSTOID',pic:''},{av:'AV7DepartamentoId',fld:'vDEPARTAMENTOID',pic:'ZZZ9'},{av:'AV28ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV36OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV52Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV12GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49AutoLinksActivityList',fld:'vAUTOLINKSACTIVITYLIST',pic:''},{av:'AV42UsuarioSistemaIdentidad_IsAuthorized',fld:'vUSUARIOSISTEMAIDENTIDAD_ISAUTHORIZED',pic:''},{av:'sPrefix'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV16Att_UsuarioSistemaId_Visible',fld:'vATT_USUARIOSISTEMAID_VISIBLE',pic:''},{av:'AV17Att_UsuarioSistemaIdentidad_Visible',fld:'vATT_USUARIOSISTEMAIDENTIDAD_VISIBLE',pic:''},{av:'AV18Att_UsuarioSistemaNombre_Visible',fld:'vATT_USUARIOSISTEMANOMBRE_VISIBLE',pic:''},{av:'AV19Att_UsuarioSistemaGerencia_Visible',fld:'vATT_USUARIOSISTEMAGERENCIA_VISIBLE',pic:''},{av:'AV20Att_UsuarioSistemaDepartamento_Visible',fld:'vATT_USUARIOSISTEMADEPARTAMENTO_VISIBLE',pic:''},{av:'AV21Att_DireccionDescripcion_Visible',fld:'vATT_DIRECCIONDESCRIPCION_VISIBLE',pic:''},{av:'AV13FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV38GridOrder = new SdtK2BGridOrders_K2BGridOrdersItem(context);
         AV40Messages = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
      ...
      private GXBaseCollection<SdtMessages_Message> AV40Messages ;
