...
namespace GeneXus.Programs {
   public class k2btoolssearchresultentitywcorion : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2023124949888", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023124949925", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("k2btoolssearchresultentitywcorion.js", "?2023124949925", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTITIESRESULTSGRIDLARGE.LOAD","{handler:'E14112',iparms:[{av:'AV24ResultsEntities',fld:'vRESULTSENTITIES',grid:12,pic:''},{av:'ENTITIESRESULTSGRIDLARGE_nFirstRecordOnPage'},{av:'nRC_GXsfl_12',ctrl:'ENTITIESRESULTSGRIDLARGE',prop:'GridRC',grid:12}]");
