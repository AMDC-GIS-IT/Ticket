...
namespace GeneXus.Programs {
   public class exportresponsableticketwc : GXProcedure
   {
      ...
      public string executeUdp( short aP0_ResponsableId ,
                                DateTime aP1_TicketFecha_From ,
                                DateTime aP2_TicketFecha_To ,
                                DateTime aP3_TicketHora_From ,
                                DateTime aP4_TicketHora_To ,
                                ...
                                short aP7_OrderedBy )
      {
         execute(aP0_ResponsableId, aP1_TicketFecha_From, aP2_TicketFecha_To, aP3_TicketHora_From, aP4_TicketHora_To, aP5_UsuarioNombre, aP6_K2BToolsGenericSearchField, aP7_OrderedBy, out aP8_OutFile);
         return AV59OutFile ;
      }
                                 ...
                                 out string aP8_OutFile )
      {
         ...
         objexportresponsableticketwc.AV59OutFile = "" ;
      ...
      void executePrivate( )
      {
         ...
         AV59OutFile = GxDirectory.TemporaryFilesPath + AV26File.Separator + "ExportResponsableTicketWC-" + Guid.NewGuid( ).ToString() + ".xlsx";
         AV18ExcelDocument.Open(AV59OutFile);
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            n53TicketLaptop = P003N3_n53TicketLaptop[0];
            A42TicketDesktop = P003N3_A42TicketDesktop[0];
            n42TicketDesktop = P003N3_n42TicketDesktop[0];
            A55TicketMonitor = P003N3_A55TicketMonitor[0];
            n55TicketMonitor = P003N3_n55TicketMonitor[0];
            A50TicketImpresora = P003N3_A50TicketImpresora[0];
            n50TicketImpresora = P003N3_n50TicketImpresora[0];
            A45TicketEscaner = P003N3_A45TicketEscaner[0];
            n45TicketEscaner = P003N3_n45TicketEscaner[0];
            A59TicketRouter = P003N3_A59TicketRouter[0];
            n59TicketRouter = P003N3_n59TicketRouter[0];
            A60TicketSistemaOperativo = P003N3_A60TicketSistemaOperativo[0];
            n60TicketSistemaOperativo = P003N3_n60TicketSistemaOperativo[0];
            A56TicketOffice = P003N3_A56TicketOffice[0];
            n56TicketOffice = P003N3_n56TicketOffice[0];
            A39TicketAntivirus = P003N3_A39TicketAntivirus[0];
            n39TicketAntivirus = P003N3_n39TicketAntivirus[0];
            A40TicketAplicacion = P003N3_A40TicketAplicacion[0];
            n40TicketAplicacion = P003N3_n40TicketAplicacion[0];
            A44TicketDisenio = P003N3_A44TicketDisenio[0];
            n44TicketDisenio = P003N3_n44TicketDisenio[0];
            A51TicketIngenieria = P003N3_A51TicketIngenieria[0];
            n51TicketIngenieria = P003N3_n51TicketIngenieria[0];
            A43TicketDiscoDuroExterno = P003N3_A43TicketDiscoDuroExterno[0];
            n43TicketDiscoDuroExterno = P003N3_n43TicketDiscoDuroExterno[0];
            A58TicketPerifericos = P003N3_A58TicketPerifericos[0];
            n58TicketPerifericos = P003N3_n58TicketPerifericos[0];
            A87TicketUps = P003N3_A87TicketUps[0];
            n87TicketUps = P003N3_n87TicketUps[0];
            A41TicketApoyoUsuario = P003N3_A41TicketApoyoUsuario[0];
            n41TicketApoyoUsuario = P003N3_n41TicketApoyoUsuario[0];
            A52TicketInstalarDataShow = P003N3_A52TicketInstalarDataShow[0];
            n52TicketInstalarDataShow = P003N3_n52TicketInstalarDataShow[0];
            A57TicketOtros = P003N3_A57TicketOtros[0];
            n57TicketOtros = P003N3_n57TicketOtros[0];
            A94UsuarioRequerimiento = P003N3_A94UsuarioRequerimiento[0];
            A93UsuarioNombre = P003N3_A93UsuarioNombre[0];
            AV19CellRow = (int)(AV19CellRow+1);
            AV22ColumnIndex = 0;
      ...
      public override void initialize( )
      {
         ...
         P003N3_A15UsuarioId = new long[1] ;
         ...
         P003N3_n53TicketLaptop = new bool[] {false} ;
         P003N3_A42TicketDesktop = new bool[] {false} ;
         P003N3_n42TicketDesktop = new bool[] {false} ;
         P003N3_A55TicketMonitor = new bool[] {false} ;
         P003N3_n55TicketMonitor = new bool[] {false} ;
         P003N3_A50TicketImpresora = new bool[] {false} ;
         P003N3_n50TicketImpresora = new bool[] {false} ;
         P003N3_A45TicketEscaner = new bool[] {false} ;
         P003N3_n45TicketEscaner = new bool[] {false} ;
         P003N3_A59TicketRouter = new bool[] {false} ;
         P003N3_n59TicketRouter = new bool[] {false} ;
         P003N3_A60TicketSistemaOperativo = new bool[] {false} ;
         P003N3_n60TicketSistemaOperativo = new bool[] {false} ;
         P003N3_A56TicketOffice = new bool[] {false} ;
         P003N3_n56TicketOffice = new bool[] {false} ;
         P003N3_A39TicketAntivirus = new bool[] {false} ;
         P003N3_n39TicketAntivirus = new bool[] {false} ;
         P003N3_A40TicketAplicacion = new bool[] {false} ;
         P003N3_n40TicketAplicacion = new bool[] {false} ;
         P003N3_A44TicketDisenio = new bool[] {false} ;
         P003N3_n44TicketDisenio = new bool[] {false} ;
         P003N3_A51TicketIngenieria = new bool[] {false} ;
         P003N3_n51TicketIngenieria = new bool[] {false} ;
         P003N3_A43TicketDiscoDuroExterno = new bool[] {false} ;
         P003N3_n43TicketDiscoDuroExterno = new bool[] {false} ;
         P003N3_A58TicketPerifericos = new bool[] {false} ;
         P003N3_n58TicketPerifericos = new bool[] {false} ;
         P003N3_A87TicketUps = new bool[] {false} ;
         P003N3_n87TicketUps = new bool[] {false} ;
         P003N3_A41TicketApoyoUsuario = new bool[] {false} ;
         P003N3_n41TicketApoyoUsuario = new bool[] {false} ;
         P003N3_A52TicketInstalarDataShow = new bool[] {false} ;
         P003N3_n52TicketInstalarDataShow = new bool[] {false} ;
         P003N3_A57TicketOtros = new bool[] {false} ;
         P003N3_n57TicketOtros = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.exportresponsableticketwc__default(),
            new Object[][] {
               ...
               , new Object[] {
               P003N3_A54TicketLastId, P003N3_A94UsuarioRequerimiento, P003N3_A15UsuarioId, P003N3_A14TicketId, P003N3_A93UsuarioNombre, P003N3_A48TicketHora, P003N3_A46TicketFecha, P003N3_A53TicketLaptop, P003N3_n53TicketLaptop, P003N3_A42TicketDesktop,
               P003N3_n42TicketDesktop, P003N3_A55TicketMonitor, P003N3_n55TicketMonitor, P003N3_A50TicketImpresora, P003N3_n50TicketImpresora, P003N3_A45TicketEscaner, P003N3_n45TicketEscaner, P003N3_A59TicketRouter, P003N3_n59TicketRouter, P003N3_A60TicketSistemaOperativo,
               P003N3_n60TicketSistemaOperativo, P003N3_A56TicketOffice, P003N3_n56TicketOffice, P003N3_A39TicketAntivirus, P003N3_n39TicketAntivirus, P003N3_A40TicketAplicacion, P003N3_n40TicketAplicacion, P003N3_A44TicketDisenio, P003N3_n44TicketDisenio, P003N3_A51TicketIngenieria,
               P003N3_n51TicketIngenieria, P003N3_A43TicketDiscoDuroExterno, P003N3_n43TicketDiscoDuroExterno, P003N3_A58TicketPerifericos, P003N3_n58TicketPerifericos, P003N3_A87TicketUps, P003N3_n87TicketUps, P003N3_A41TicketApoyoUsuario, P003N3_n41TicketApoyoUsuario, P003N3_A52TicketInstalarDataShow,
               P003N3_n52TicketInstalarDataShow, P003N3_A57TicketOtros, P003N3_n57TicketOtros
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private long[] P003N3_A15UsuarioId ;
      ...
      private bool[] P003N3_n53TicketLaptop ;
      private bool[] P003N3_A42TicketDesktop ;
      private bool[] P003N3_n42TicketDesktop ;
      private bool[] P003N3_A55TicketMonitor ;
      private bool[] P003N3_n55TicketMonitor ;
      private bool[] P003N3_A50TicketImpresora ;
      private bool[] P003N3_n50TicketImpresora ;
      private bool[] P003N3_A45TicketEscaner ;
      private bool[] P003N3_n45TicketEscaner ;
      private bool[] P003N3_A59TicketRouter ;
      private bool[] P003N3_n59TicketRouter ;
      private bool[] P003N3_A60TicketSistemaOperativo ;
      private bool[] P003N3_n60TicketSistemaOperativo ;
      private bool[] P003N3_A56TicketOffice ;
      private bool[] P003N3_n56TicketOffice ;
      private bool[] P003N3_A39TicketAntivirus ;
      private bool[] P003N3_n39TicketAntivirus ;
      private bool[] P003N3_A40TicketAplicacion ;
      private bool[] P003N3_n40TicketAplicacion ;
      private bool[] P003N3_A44TicketDisenio ;
      private bool[] P003N3_n44TicketDisenio ;
      private bool[] P003N3_A51TicketIngenieria ;
      private bool[] P003N3_n51TicketIngenieria ;
      private bool[] P003N3_A43TicketDiscoDuroExterno ;
      private bool[] P003N3_n43TicketDiscoDuroExterno ;
      private bool[] P003N3_A58TicketPerifericos ;
      private bool[] P003N3_n58TicketPerifericos ;
      private bool[] P003N3_A87TicketUps ;
      private bool[] P003N3_n87TicketUps ;
      private bool[] P003N3_A41TicketApoyoUsuario ;
      private bool[] P003N3_n41TicketApoyoUsuario ;
      private bool[] P003N3_A52TicketInstalarDataShow ;
      private bool[] P003N3_n52TicketInstalarDataShow ;
      private bool[] P003N3_A57TicketOtros ;
      private bool[] P003N3_n57TicketOtros ;
   ...
   public class exportresponsableticketwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_P003N3(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (string)dynConstraints[8] , (long)dynConstraints[9] , (long)dynConstraints[10] , (string)dynConstraints[11] , (short)dynConstraints[12] , (string)dynConstraints[13] , (long)dynConstraints[14] , (short)dynConstraints[15] , (short)dynConstraints[16] , (short)dynConstraints[17] );
         }
