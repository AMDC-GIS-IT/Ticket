...
namespace GeneXus.Programs {
   public class reportresponsableticketwc : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV9ResponsableId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      public reportresponsableticketwc( )
      {
      ...
      public reportresponsableticketwc( IGxContext context )
      {
      ...
      public void execute( short aP0_ResponsableId ,
                           ...
                           short aP7_OrderedBy )
      {
         this.AV9ResponsableId = aP0_ResponsableId;
      ...
      public void executeSubmit( short aP0_ResponsableId ,
                                 ...
                                 short aP7_OrderedBy )
      {
         reportresponsableticketwc objreportresponsableticketwc;
         objreportresponsableticketwc = new reportresponsableticketwc();
         objreportresponsableticketwc.AV9ResponsableId = aP0_ResponsableId;
         objreportresponsableticketwc.AV17TicketFecha_From = aP1_TicketFecha_From;
         objreportresponsableticketwc.AV18TicketFecha_To = aP2_TicketFecha_To;
         objreportresponsableticketwc.AV20TicketHora_From = aP3_TicketHora_From;
         objreportresponsableticketwc.AV21TicketHora_To = aP4_TicketHora_To;
         objreportresponsableticketwc.AV22UsuarioNombre = aP5_UsuarioNombre;
         objreportresponsableticketwc.AV10K2BToolsGenericSearchField = aP6_K2BToolsGenericSearchField;
         objreportresponsableticketwc.AV11OrderedBy = aP7_OrderedBy;
         objreportresponsableticketwc.context.SetSubmitInitialConfig(context);
         objreportresponsableticketwc.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objreportresponsableticketwc);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((reportresponsableticketwc)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            else
            {
               ...
               {
                  A54TicketLastId = P003P2_A54TicketLastId[0];
                  A94UsuarioRequerimiento = P003P2_A94UsuarioRequerimiento[0];
                  A15UsuarioId = P003P2_A15UsuarioId[0];
                  A14TicketId = P003P2_A14TicketId[0];
                  A93UsuarioNombre = P003P2_A93UsuarioNombre[0];
                  A48TicketHora = P003P2_A48TicketHora[0];
                  A46TicketFecha = P003P2_A46TicketFecha[0];
                  A53TicketLaptop = P003P2_A53TicketLaptop[0];
                  n53TicketLaptop = P003P2_n53TicketLaptop[0];
                  A94UsuarioRequerimiento = P003P2_A94UsuarioRequerimiento[0];
                  A93UsuarioNombre = P003P2_A93UsuarioNombre[0];
      ...
      public override void initialize( )
      {
         ...
         A94UsuarioRequerimiento = "";
         A24EstadoTicketNombre = "";
         P003P2_A54TicketLastId = new long[1] ;
         P003P2_A94UsuarioRequerimiento = new string[] {""} ;
         P003P2_A15UsuarioId = new long[1] ;
         P003P2_A14TicketId = new long[1] ;
         P003P2_A93UsuarioNombre = new string[] {""} ;
         P003P2_A48TicketHora = new DateTime[] {DateTime.MinValue} ;
         P003P2_A46TicketFecha = new DateTime[] {DateTime.MinValue} ;
         P003P2_A53TicketLaptop = new bool[] {false} ;
         P003P2_n53TicketLaptop = new bool[] {false} ;
         AV29Grid_TicketLaptop = "";
         Gx_date = DateTime.MinValue;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportresponsableticketwc__default(),
            new Object[][] {
                new Object[] {
               P003P2_A54TicketLastId, P003P2_A94UsuarioRequerimiento, P003P2_A15UsuarioId, P003P2_A14TicketId, P003P2_A93UsuarioNombre, P003P2_A48TicketHora, P003P2_A46TicketFecha, P003P2_A53TicketLaptop, P003P2_n53TicketLaptop
               }
            }
         );
         AV34Pgmname = "ReportResponsableTicketWC";
      ...
      private long[] P003P2_A54TicketLastId ;
      private string[] P003P2_A94UsuarioRequerimiento ;
      private long[] P003P2_A15UsuarioId ;
      private long[] P003P2_A14TicketId ;
      private string[] P003P2_A93UsuarioNombre ;
      private DateTime[] P003P2_A48TicketHora ;
      private DateTime[] P003P2_A46TicketFecha ;
      private bool[] P003P2_A53TicketLaptop ;
      private bool[] P003P2_n53TicketLaptop ;
      private SdtK2BContext AV8Context ;
   }

   public class reportresponsableticketwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P003P2(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (string)dynConstraints[8] , (long)dynConstraints[9] , (long)dynConstraints[10] , (string)dynConstraints[11] , (short)dynConstraints[12] , (string)dynConstraints[13] , (long)dynConstraints[14] , (short)dynConstraints[15] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P003P2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP003P2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
