...
namespace GeneXus.Programs {
   public class k2bloadgridconfiguration : GXProcedure
   {
                                 ...
                                 ref SdtK2BGridConfiguration aP2_GridConfiguration )
      {
         ...
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objk2bloadgridconfiguration);
         aP2_GridConfiguration=this.AV19GridConfiguration;
      }
      ...
      void executePrivate( )
      {
         ...
         else
         {
            ...
            AV23GXV1 = 1;
            while ( AV23GXV1 <= AV19GridConfiguration.gxTpr_Gridcolumns.Count )
            {
               AV10GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV19GridConfiguration.gxTpr_Gridcolumns.Item(AV23GXV1));
      ...
      protected void S111( )
      {
         ...
         AV9Found = false;
         AV24GXV2 = 1;
         while ( AV24GXV2 <= AV20GridConfigurationDB.gxTpr_Gridcolumns.Count )
         {
            AV11GridColumnDB = ((SdtK2BGridColumns_K2BGridColumnsItem)AV20GridConfigurationDB.gxTpr_Gridcolumns.Item(AV24GXV2));
