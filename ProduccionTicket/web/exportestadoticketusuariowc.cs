...
namespace GeneXus.Programs {
   public class exportestadoticketusuariowc : GXProcedure
   {
                           ...
                           out string aP8_OutFile )
      {
         ...
         initialize();
         executePrivate();
         aP8_OutFile=this.AV41OutFile;
      }

      public string executeUdp( short aP0_EstadoTicketId ,
                                string aP1_UsuarioNombre ,
                                DateTime aP2_UsuarioFecha_From ,
                                DateTime aP3_UsuarioFecha_To ,
                                DateTime aP4_UsuarioHora_From ,
                                ...
                                short aP7_OrderedBy )
      {
         execute(aP0_EstadoTicketId, aP1_UsuarioNombre, aP2_UsuarioFecha_From, aP3_UsuarioFecha_To, aP4_UsuarioHora_From, aP5_UsuarioHora_To, aP6_K2BToolsGenericSearchField, aP7_OrderedBy, out aP8_OutFile);
         return AV41OutFile ;
      }
                                 ...
                                 out string aP8_OutFile )
      {
         ...
         objexportestadoticketusuariowc.AV41OutFile = "" ;
      ...
      void executePrivate( )
      {
         ...
         AV41OutFile = GxDirectory.TemporaryFilesPath + AV26File.Separator + "ExportEstadoTicketUsuarioWC-" + Guid.NewGuid( ).ToString() + ".xlsx";
         AV18ExcelDocument.Open(AV41OutFile);
      ...
      public override void initialize( )
      {
         ...
         P003D3_A15UsuarioId = new long[1] ;
      ...
      private long[] P003D3_A15UsuarioId ;
   ...
   public class exportestadoticketusuariowc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_P003D3(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (DateTime)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (DateTime)dynConstraints[7] , (DateTime)dynConstraints[8] , (long)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (int)dynConstraints[14] , (short)dynConstraints[15] , (short)dynConstraints[16] , (short)dynConstraints[17] );
         }
