...
namespace GeneXus.Programs {
   public class reportetapasdesarrolloticketwc : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "Ticket",  "Ticket",  "List",  "",  AV39Pgmname) )
            {
               H730( false, 30) ;
            ...
            else
            {
               ...
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV23EstadoTicketTicketNombre)) )
               {
                  ...
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV23EstadoTicketTicketNombre, "")), 63, Gx_line+7, 283, Gx_line+23, 0+256, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
               }
               ...
               getPrinter().GxDrawText("Id", 472, Gx_line+7, 502, Gx_line+22, 2, 0, 0, 1) ;
               getPrinter().GxDrawText("Ticket", 510, Gx_line+7, 639, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Last Id", 647, Gx_line+7, 721, Gx_line+22, 2, 0, 0, 1) ;
               getPrinter().GxDrawText("aptop", 737, Gx_line+7, 774, Gx_line+22, 0, 0, 0, 1) ;
               Gx_OldLine = Gx_line;
               Gx_line = (int)(Gx_line+30);
               GxHdr3 = true;
               pr_default.dynParam(0, new Object[]{ new Object[]{
                                                    ...
                                                    TypeConstants.LONG, TypeConstants.LONG, TypeConstants.SHORT, TypeConstants.LONG, TypeConstants.BOOLEAN, TypeConstants.SHORT
                                                    }
               });
               ...
               while ( (pr_default.getStatus(0) != 101) )
               {
                  ...
                  n278TicketUsuarioAsigno = P00732_n278TicketUsuarioAsigno[0];
                  ...
                  A53TicketLaptop = P00732_A53TicketLaptop[0];
                  n53TicketLaptop = P00732_n53TicketLaptop[0];
                  A188EstadoTicketTicketNombre = P00732_A188EstadoTicketTicketNombre[0];
                  A88UsuarioDepartamento = P00732_A88UsuarioDepartamento[0];
                  A91UsuarioGerencia = P00732_A91UsuarioGerencia[0];
                  A94UsuarioRequerimiento = P00732_A94UsuarioRequerimiento[0];
                  A93UsuarioNombre = P00732_A93UsuarioNombre[0];
                  AV34Grid_TicketLaptop = (A53TicketLaptop ? "Si" : "No");
                  H730( false, 30) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  ...
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(A187EstadoTicketTicketId), "ZZZ9")), 472, Gx_line+7, 502, Gx_line+23, 2, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A188EstadoTicketTicketNombre, "")), 510, Gx_line+7, 639, Gx_line+23, 0, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(A54TicketLastId), "ZZZZZZZZZ9")), 647, Gx_line+7, 721, Gx_line+23, 2, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV34Grid_TicketLaptop, "")), 737, Gx_line+7, 774, Gx_line+23, 0, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
      ...
      public override void initialize( )
      {
         ...
         P00732_n278TicketUsuarioAsigno = new bool[] {false} ;
         ...
         P00732_A15UsuarioId = new long[1] ;
         ...
         P00732_A53TicketLaptop = new bool[] {false} ;
         P00732_n53TicketLaptop = new bool[] {false} ;
         AV34Grid_TicketLaptop = "";
         Gx_date = DateTime.MinValue;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportetapasdesarrolloticketwc__default(),
            new Object[][] {
                new Object[] {
               P00732_A278TicketUsuarioAsigno, P00732_n278TicketUsuarioAsigno, P00732_A285TicketHoraCaracter, P00732_A54TicketLastId, P00732_A187EstadoTicketTicketId, P00732_A88UsuarioDepartamento, P00732_A91UsuarioGerencia, P00732_A94UsuarioRequerimiento, P00732_A15UsuarioId, P00732_A14TicketId,
               P00732_A289TicketFechaHora, P00732_n289TicketFechaHora, P00732_A188EstadoTicketTicketNombre, P00732_A93UsuarioNombre, P00732_A48TicketHora, P00732_A46TicketFecha, P00732_A53TicketLaptop, P00732_n53TicketLaptop
               }
            }
         );
         AV39Pgmname = "ReportEtapasDesarrolloTicketWC";
      ...
      private string AV34Grid_TicketLaptop ;
      ...
      private bool[] P00732_n278TicketUsuarioAsigno ;
      ...
      private long[] P00732_A15UsuarioId ;
      ...
      private bool[] P00732_A53TicketLaptop ;
      private bool[] P00732_n53TicketLaptop ;
   ...
   public class reportetapasdesarrolloticketwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV11OrderedBy )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV10K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(10), CAST(T1.[TicketId] AS decimal(10,0))) like '%' + @lV10K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T1.[UsuarioId] AS decimal(10,0))) like '%' + @lV10K2BToolsGenericSearchField + '%' or T3.[UsuarioNombre] like '%' + @lV10K2BToolsGenericSearchField + '%' or T3.[UsuarioRequerimiento] like '%' + @lV10K2BToolsGenericSearchField + '%' or T3.[UsuarioGerencia] like '%' + @lV10K2BToolsGenericSearchField + '%' or T3.[UsuarioDepartamento] like '%' + @lV10K2BToolsGenericSearchField + '%' or CONVERT( char(4), CAST(T1.[EstadoTicketTicketId] AS decimal(4,0))) like '%' + @lV10K2BToolsGenericSearchField + '%' or T2.[EstadoTicketNombre] like '%' + @lV10K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T1.[TicketLastId] AS decimal(10,0))) like '%' + @lV10K2BToolsGenericSearchField + '%' or T1.[TicketHoraCaracter] like '%' + @lV10K2BToolsGenericSearchField + '%' or T1.[TicketUsuarioAsigno] like '%' + @lV10K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int1[8] = 1;
