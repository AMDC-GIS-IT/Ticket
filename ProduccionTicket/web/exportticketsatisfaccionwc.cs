...
namespace GeneXus.Programs {
   public class exportticketsatisfaccionwc : GXProcedure
   {
                           ...
                           out string aP13_OutFile )
      {
         ...
         initialize();
         executePrivate();
         aP13_OutFile=this.AV47OutFile;
      }

      public string executeUdp( long aP0_TicketId ,
                                DateTime aP1_SatisfaccionFecha_From ,
                                DateTime aP2_SatisfaccionFecha_To ,
                                DateTime aP3_UsuarioFecha_From ,
                                DateTime aP4_UsuarioFecha_To ,
                                 ...
                                 out string aP13_OutFile )
      {
         ...
         objexportticketsatisfaccionwc.AV47OutFile = "" ;
      ...
      void executePrivate( )
      {
         ...
         AV47OutFile = GxDirectory.TemporaryFilesPath + AV31File.Separator + "ExportTicketSatisfaccionWC-" + Guid.NewGuid( ).ToString() + ".xlsx";
         AV23ExcelDocument.Open(AV47OutFile);
         ...
         {
            AV23ExcelDocument.get_Cells(AV24CellRow, AV25FirstColumn+0, 1, 1).Bold = 1;
            AV23ExcelDocument.get_Cells(AV24CellRow, AV25FirstColumn+0, 1, 1).Text = "Respuesta:";
         ...
         {
            AV23ExcelDocument.get_Cells(AV24CellRow, AV25FirstColumn+AV27ColumnIndex, 1, 1).Bold = 1;
            AV23ExcelDocument.get_Cells(AV24CellRow, AV25FirstColumn+AV27ColumnIndex, 1, 1).Text = "Respuesta:";
            AV27ColumnIndex = (short)(AV27ColumnIndex+1);
         }
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            n34SatisfaccionSugerencia = P003R3_n34SatisfaccionSugerencia[0];
      ...
      protected void S131( )
      {
         ...
         AV35GridColumn.gxTpr_Columntitle = "Respuesta:";
         AV35GridColumn.gxTpr_Showattribute = true;
         AV34GridColumns.Add(AV35GridColumn, 0);
         AV35GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
      ...
      public override void initialize( )
      {
         ...
         A31SatisfaccionAtencionNombre = "";
         A34SatisfaccionSugerencia = "";
         P003R3_A15UsuarioId = new long[1] ;
         ...
         P003R3_n34SatisfaccionSugerencia = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.exportticketsatisfaccionwc__default(),
            new Object[][] {
               ...
               , new Object[] {
               P003R3_A15UsuarioId, P003R3_A8SatisfaccionResueltoId, P003R3_A9SatisfaccionTecnicoProblemaId, P003R3_A10SatisfaccionTecnicoCompetenteId, P003R3_A11SatisfaccionTecnicoProfesionalismoId, P003R3_A12SatisfaccionTiempoId, P003R3_A13SatisfaccionAtencionId, P003R3_A34SatisfaccionSugerencia, P003R3_n34SatisfaccionSugerencia, P003R3_A7SatisfaccionId,
               P003R3_A31SatisfaccionAtencionNombre, P003R3_A38SatisfaccionTiempoNombre, P003R3_A37SatisfaccionTecnicoProfesionalismoNombre, P003R3_A35SatisfaccionTecnicoCompetenteNombre, P003R3_A36SatisfaccionTecnicoProblemaNombre, P003R3_A33SatisfaccionResueltoNombre, P003R3_A90UsuarioFecha, P003R3_A32SatisfaccionFecha, P003R3_A14TicketId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private long[] P003R3_A15UsuarioId ;
      ...
      private bool[] P003R3_n34SatisfaccionSugerencia ;
