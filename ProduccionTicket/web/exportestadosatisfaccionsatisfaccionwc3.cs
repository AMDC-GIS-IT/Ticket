...
namespace GeneXus.Programs {
   public class exportestadosatisfaccionsatisfaccionwc3 : GXProcedure
   {
      ...
      public string executeUdp( short aP0_SatisfaccionTecnicoProfesionalismoId ,
                                DateTime aP1_SatisfaccionFecha_From ,
                                DateTime aP2_SatisfaccionFecha_To ,
                                DateTime aP3_UsuarioFecha_From ,
                                DateTime aP4_UsuarioFecha_To ,
                                ...
                                short aP11_OrderedBy )
      {
         execute(aP0_SatisfaccionTecnicoProfesionalismoId, aP1_SatisfaccionFecha_From, aP2_SatisfaccionFecha_To, aP3_UsuarioFecha_From, aP4_UsuarioFecha_To, aP5_SatisfaccionResueltoNombre, aP6_SatisfaccionTecnicoProblemaNombre, aP7_SatisfaccionTecnicoCompetenteNombre, aP8_SatisfaccionTiempoNombre, aP9_SatisfaccionAtencionNombre, aP10_K2BToolsGenericSearchField, aP11_OrderedBy, out aP12_OutFile);
         return AV50OutFile ;
      }
                                 ...
                                 out string aP12_OutFile )
      {
         ...
         objexportestadosatisfaccionsatisfaccionwc3.AV50OutFile = "" ;
      ...
      void executePrivate( )
      {
         ...
         AV50OutFile = GxDirectory.TemporaryFilesPath + AV30File.Separator + "ExportEstadoSatisfaccionSatisfaccionWC3-" + Guid.NewGuid( ).ToString() + ".xlsx";
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            n34SatisfaccionSugerencia = P00323_n34SatisfaccionSugerencia[0];
      ...
      public override void initialize( )
      {
         ...
         P00323_n34SatisfaccionSugerencia = new bool[] {false} ;
         P00323_A94UsuarioRequerimiento = new string[] {""} ;
         P00323_A93UsuarioNombre = new string[] {""} ;
         P00323_A15UsuarioId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.exportestadosatisfaccionsatisfaccionwc3__default(),
            new Object[][] {
               ...
               , new Object[] {
               P00323_A8SatisfaccionResueltoId, P00323_A9SatisfaccionTecnicoProblemaId, P00323_A10SatisfaccionTecnicoCompetenteId, P00323_A12SatisfaccionTiempoId, P00323_A13SatisfaccionAtencionId, P00323_A34SatisfaccionSugerencia, P00323_n34SatisfaccionSugerencia, P00323_A94UsuarioRequerimiento, P00323_A93UsuarioNombre, P00323_A15UsuarioId,
               P00323_A14TicketId, P00323_A7SatisfaccionId, P00323_A31SatisfaccionAtencionNombre, P00323_A38SatisfaccionTiempoNombre, P00323_A35SatisfaccionTecnicoCompetenteNombre, P00323_A36SatisfaccionTecnicoProblemaNombre, P00323_A33SatisfaccionResueltoNombre, P00323_A90UsuarioFecha, P00323_A32SatisfaccionFecha, P00323_A11SatisfaccionTecnicoProfesionalismoId
               }
            }
         );
         /* GeneXus formulas. */
   ...
   public class exportestadosatisfaccionsatisfaccionwc3__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_P00323(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (long)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] , (short)dynConstraints[25] );
         }
