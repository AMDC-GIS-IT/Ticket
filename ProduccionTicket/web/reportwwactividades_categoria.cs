         ...
         try
         {
            ...
            else
            {
               ...
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV28fltnombre)) )
               {
                  H5J0( false, 30) ;
                  getPrinter().GxAttris("Courier New", 8, true, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText("Actividad Categoría", 10, Gx_line+7, 150, Gx_line+22, 0+256, 0, 0, 0) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV28fltnombre, "")), 158, Gx_line+7, 1617, Gx_line+23, 0+256, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
               }
               H5J0( false, 30) ;
               ...
               getPrinter().GxDrawText("id_tipo_categoria", 93, Gx_line+7, 218, Gx_line+22, 2, 0, 0, 1) ;
               getPrinter().GxDrawText("unidad_medida", 234, Gx_line+7, 409, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("estado", 417, Gx_line+7, 484, Gx_line+22, 2, 0, 0, 1) ;
               Gx_OldLine = Gx_line;
               Gx_line = (int)(Gx_line+30);
               GxHdr3 = true;
               ...
               while ( (pr_datastore1.getStatus(0) != 101) )
               {
                  ...
                  H5J0( false, 30) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(A102id_actividad_categoria), "ZZZZZZZZ9")), 18, Gx_line+7, 85, Gx_line+23, 2, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(A122actividades_categoriaid_tipo_categoria), "ZZZZZZZZ9")), 93, Gx_line+7, 218, Gx_line+23, 2, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A124unidad_medida, "")), 234, Gx_line+7, 409, Gx_line+23, 0, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(A125actividades_categoriaestado), "ZZZZZZZZ9")), 417, Gx_line+7, 484, Gx_line+23, 2, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
