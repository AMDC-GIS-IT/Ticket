...
namespace GeneXus.Programs {
   public class wwcategoria_tarea : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV42K2BToolsGenericSearchField, AV31id_unidad_gis, AV56flnombre, AV30ClassCollection, AV43OrderedBy, AV62Pgmname, AV8CurrentPage, AV10GridConfiguration, AV49id_unidad_gis_IsAuthorized, AV14Att_categoria_tareaid_tipo_categoria_Visible, AV15Att_id_unidad_gis_Visible, AV16Att_nombre_categoria_Visible, AV17Att_categoria_tareaestado_Visible, AV11FreezeColumnTitles, AV59Uri) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202418842765", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vURI", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV59Uri, "")), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vURI", AV59Uri);
         GxWebStd.gx_hidden_field( context, "gxhash_vURI", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV59Uri, "")), context));
      ...
      protected void WB5A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavId_unidad_gis_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV31id_unidad_gis), 9, 0, ".", "")), StringUtil.LTrim( ((edtavId_unidad_gis_Enabled!=0) ? context.localUtil.Format( (decimal)(AV31id_unidad_gis), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(AV31id_unidad_gis), "ZZZZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,45);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavId_unidad_gis_Jsonclick, 0, "Attribute_Filter", "", "", "", "", 1, edtavId_unidad_gis_Enabled, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_WWcategoria_tarea.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF5A2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV42K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV42K2BToolsGenericSearchField), 100, "%");
            /* Using cursor H005A2 */
            pr_datastore1.execute(0, new Object[] {AV31id_unidad_gis, lV56flnombre, lV42K2BToolsGenericSearchField, lV42K2BToolsGenericSearchField, lV42K2BToolsGenericSearchField, lV42K2BToolsGenericSearchField, GXPagingFrom2, GXPagingTo2, GXPagingFrom2, GXPagingTo2});
            nGXsfl_140_idx = 1;
            sGXsfl_140_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_140_idx), 4, 0), 4, "0");
            SubsflControlProps_1402( ) ;
      ...
      protected void S112( )
      {
         ...
         AV64GXV2 = 1;
         while ( AV64GXV2 <= AV28GridState.gxTpr_Filtervalues.Count )
         {
            AV29GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV28GridState.gxTpr_Filtervalues.Item(AV64GXV2));
      ...
      protected void S202( )
      {
         ...
         AV65GXV3 = 1;
         while ( AV65GXV3 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV13GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV10GridConfiguration.gxTpr_Gridcolumns.Item(AV65GXV3));
      ...
      protected void S122( )
      {
         ...
         if ( AV38K2BFilterValuesSDT.Count > 0 )
         {
            ...
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV62Pgmname,  "Grid",  AV38K2BFilterValuesSDT, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item3) ;
      ...
      protected void E135A2( )
      {
         ...
         AV66GXV4 = 1;
         while ( AV66GXV4 <= AV10GridConfiguration.gxTpr_Gridcolumns.Count )
         {
            AV13GridColumn = ((SdtK2BGridColumns_K2BGridColumnsItem)AV10GridConfiguration.gxTpr_Gridcolumns.Item(AV66GXV4));
            if ( StringUtil.StrCmp(AV13GridColumn.gxTpr_Attributename, "categoria_tareaid_tipo_categoria") == 0 )
            {
      ...
      protected void E185A2( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "categoria_tarea",  "categoria_tarea",  "List",  "",  "ExportWWcategoria_tarea") )
         {
            new exportwwcategoria_tarea(context ).execute(  AV31id_unidad_gis,  AV56flnombre,  AV42K2BToolsGenericSearchField,  AV43OrderedBy, out  AV57OutFile) ;
            if ( new k2bt_isinexternalstorage(context).executeUdp(  AV57OutFile, out  AV59Uri) )
            {
               CallWebObject(formatLink(AV59Uri) );
               context.wjLocDisableFrm = 0;
            }
            else
            {
               AV58Guid = (Guid)(Guid.NewGuid( ));
               new k2bsessionset(context ).execute(  AV58Guid.ToString(),  AV57OutFile) ;
               CallWebObject(formatLink("k2bt_returnfileinhttpresponse.aspx", new object[] {UrlEncode(AV58Guid.ToString())}, new string[] {"Guid"}) );
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188421292", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwcategoria_tarea.js", "?2024188421292", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
      ...
      protected void sendrow_1402( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_140_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtcategoria_tareaid_tipo_categoria_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A104categoria_tareaid_tipo_categoria), 9, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A104categoria_tareaid_tipo_categoria), "ZZZZZZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtcategoria_tareaid_tipo_categoria_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn K2BToolsSortableColumn InvisibleInExtraSmallColumn",(string)"",(int)edtcategoria_tareaid_tipo_categoria_Visible,(short)0,(short)0,(string)"text",(string)"1",(short)98,(string)"px",(short)17,(string)"px",(short)9,(short)0,(short)0,(short)140,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute_Grid";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtcategoria_tareaestado_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A107categoria_tareaestado), 9, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A107categoria_tareaestado), "ZZZZZZZZ9")),(string)" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtcategoria_tareaestado_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn InvisibleInExtraSmallColumn",(string)"",(int)edtcategoria_tareaestado_Visible,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)9,(short)0,(short)0,(short)140,(short)1,(short)-1,(short)0,(bool)true,(string)"",(string)"right",(bool)false,(string)""});
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.REFRESH","{handler:'E235A2',iparms:[{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV31id_unidad_gis',fld:'vID_UNIDAD_GIS',pic:'ZZZZZZZZ9'},{av:'AV56flnombre',fld:'vFLNOMBRE',pic:''},{av:'AV62Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49id_unidad_gis_IsAuthorized',fld:'vID_UNIDAD_GIS_ISAUTHORIZED',pic:''},{av:'AV59Uri',fld:'vURI',pic:'',hsh:true},{av:'AV14Att_categoria_tareaid_tipo_categoria_Visible',fld:'vATT_CATEGORIA_TAREAID_TIPO_CATEGORIA_VISIBLE',pic:''},{av:'AV15Att_id_unidad_gis_Visible',fld:'vATT_ID_UNIDAD_GIS_VISIBLE',pic:''},{av:'AV16Att_nombre_categoria_Visible',fld:'vATT_NOMBRE_CATEGORIA_VISIBLE',pic:''},{av:'AV17Att_categoria_tareaestado_Visible',fld:'vATT_CATEGORIA_TAREAESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED","{handler:'E115A2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31id_unidad_gis',fld:'vID_UNIDAD_GIS',pic:'ZZZZZZZZ9'},{av:'AV56flnombre',fld:'vFLNOMBRE',pic:''},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV62Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49id_unidad_gis_IsAuthorized',fld:'vID_UNIDAD_GIS_ISAUTHORIZED',pic:''},{av:'AV59Uri',fld:'vURI',pic:'',hsh:true},{av:'AV41DeletedTag',fld:'vDELETEDTAG',pic:''},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_categoria_tareaid_tipo_categoria_Visible',fld:'vATT_CATEGORIA_TAREAID_TIPO_CATEGORIA_VISIBLE',pic:''},{av:'AV15Att_id_unidad_gis_Visible',fld:'vATT_ID_UNIDAD_GIS_VISIBLE',pic:''},{av:'AV16Att_nombre_categoria_Visible',fld:'vATT_NOMBRE_CATEGORIA_VISIBLE',pic:''},{av:'AV17Att_categoria_tareaestado_Visible',fld:'vATT_CATEGORIA_TAREAESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E125A2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31id_unidad_gis',fld:'vID_UNIDAD_GIS',pic:'ZZZZZZZZ9'},{av:'AV56flnombre',fld:'vFLNOMBRE',pic:''},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV62Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49id_unidad_gis_IsAuthorized',fld:'vID_UNIDAD_GIS_ISAUTHORIZED',pic:''},{av:'AV59Uri',fld:'vURI',pic:'',hsh:true},{av:'AV46UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_categoria_tareaid_tipo_categoria_Visible',fld:'vATT_CATEGORIA_TAREAID_TIPO_CATEGORIA_VISIBLE',pic:''},{av:'AV15Att_id_unidad_gis_Visible',fld:'vATT_ID_UNIDAD_GIS_VISIBLE',pic:''},{av:'AV16Att_nombre_categoria_Visible',fld:'vATT_NOMBRE_CATEGORIA_VISIBLE',pic:''},{av:'AV17Att_categoria_tareaestado_Visible',fld:'vATT_CATEGORIA_TAREAESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E135A2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31id_unidad_gis',fld:'vID_UNIDAD_GIS',pic:'ZZZZZZZZ9'},{av:'AV56flnombre',fld:'vFLNOMBRE',pic:''},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV62Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49id_unidad_gis_IsAuthorized',fld:'vID_UNIDAD_GIS_ISAUTHORIZED',pic:''},{av:'AV59Uri',fld:'vURI',pic:'',hsh:true},{av:'AV25RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV24GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_categoria_tareaid_tipo_categoria_Visible',fld:'vATT_CATEGORIA_TAREAID_TIPO_CATEGORIA_VISIBLE',pic:''},{av:'AV15Att_id_unidad_gis_Visible',fld:'vATT_ID_UNIDAD_GIS_VISIBLE',pic:''},{av:'AV16Att_nombre_categoria_Visible',fld:'vATT_NOMBRE_CATEGORIA_VISIBLE',pic:''},{av:'AV17Att_categoria_tareaestado_Visible',fld:'vATT_CATEGORIA_TAREAESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E145A2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31id_unidad_gis',fld:'vID_UNIDAD_GIS',pic:'ZZZZZZZZ9'},{av:'AV56flnombre',fld:'vFLNOMBRE',pic:''},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV62Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49id_unidad_gis_IsAuthorized',fld:'vID_UNIDAD_GIS_ISAUTHORIZED',pic:''},{av:'AV59Uri',fld:'vURI',pic:'',hsh:true},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_categoria_tareaid_tipo_categoria_Visible',fld:'vATT_CATEGORIA_TAREAID_TIPO_CATEGORIA_VISIBLE',pic:''},{av:'AV15Att_id_unidad_gis_Visible',fld:'vATT_ID_UNIDAD_GIS_VISIBLE',pic:''},{av:'AV16Att_nombre_categoria_Visible',fld:'vATT_NOMBRE_CATEGORIA_VISIBLE',pic:''},{av:'AV17Att_categoria_tareaestado_Visible',fld:'vATT_CATEGORIA_TAREAESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E165A2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31id_unidad_gis',fld:'vID_UNIDAD_GIS',pic:'ZZZZZZZZ9'},{av:'AV56flnombre',fld:'vFLNOMBRE',pic:''},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV62Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49id_unidad_gis_IsAuthorized',fld:'vID_UNIDAD_GIS_ISAUTHORIZED',pic:''},{av:'AV59Uri',fld:'vURI',pic:'',hsh:true},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_categoria_tareaid_tipo_categoria_Visible',fld:'vATT_CATEGORIA_TAREAID_TIPO_CATEGORIA_VISIBLE',pic:''},{av:'AV15Att_id_unidad_gis_Visible',fld:'vATT_ID_UNIDAD_GIS_VISIBLE',pic:''},{av:'AV16Att_nombre_categoria_Visible',fld:'vATT_NOMBRE_CATEGORIA_VISIBLE',pic:''},{av:'AV17Att_categoria_tareaestado_Visible',fld:'vATT_CATEGORIA_TAREAESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E175A2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV31id_unidad_gis',fld:'vID_UNIDAD_GIS',pic:'ZZZZZZZZ9'},{av:'AV56flnombre',fld:'vFLNOMBRE',pic:''},{av:'AV30ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV62Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV49id_unidad_gis_IsAuthorized',fld:'vID_UNIDAD_GIS_ISAUTHORIZED',pic:''},{av:'AV59Uri',fld:'vURI',pic:'',hsh:true},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_categoria_tareaid_tipo_categoria_Visible',fld:'vATT_CATEGORIA_TAREAID_TIPO_CATEGORIA_VISIBLE',pic:''},{av:'AV15Att_id_unidad_gis_Visible',fld:'vATT_ID_UNIDAD_GIS_VISIBLE',pic:''},{av:'AV16Att_nombre_categoria_Visible',fld:'vATT_NOMBRE_CATEGORIA_VISIBLE',pic:''},{av:'AV17Att_categoria_tareaestado_Visible',fld:'vATT_CATEGORIA_TAREAESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOEXPORT'","{handler:'E185A2',iparms:[{av:'AV31id_unidad_gis',fld:'vID_UNIDAD_GIS',pic:'ZZZZZZZZ9'},{av:'AV56flnombre',fld:'vFLNOMBRE',pic:''},{av:'AV42K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV43OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV59Uri',fld:'vURI',pic:'',hsh:true},{av:'AV14Att_categoria_tareaid_tipo_categoria_Visible',fld:'vATT_CATEGORIA_TAREAID_TIPO_CATEGORIA_VISIBLE',pic:''},{av:'AV15Att_id_unidad_gis_Visible',fld:'vATT_ID_UNIDAD_GIS_VISIBLE',pic:''},{av:'AV16Att_nombre_categoria_Visible',fld:'vATT_NOMBRE_CATEGORIA_VISIBLE',pic:''},{av:'AV17Att_categoria_tareaestado_Visible',fld:'vATT_CATEGORIA_TAREAESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'DOEXPORT'",",oparms:[{av:'AV14Att_categoria_tareaid_tipo_categoria_Visible',fld:'vATT_CATEGORIA_TAREAID_TIPO_CATEGORIA_VISIBLE',pic:''},{av:'AV15Att_id_unidad_gis_Visible',fld:'vATT_ID_UNIDAD_GIS_VISIBLE',pic:''},{av:'AV16Att_nombre_categoria_Visible',fld:'vATT_NOMBRE_CATEGORIA_VISIBLE',pic:''},{av:'AV17Att_categoria_tareaestado_Visible',fld:'vATT_CATEGORIA_TAREAESTADO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
