...
namespace GeneXus.Programs {
   public class prcgettecnicoid : GXProcedure
   {
                           ...
                           out int aP6_id_unidad_tecnico )
      {
         ...
         aP6_id_unidad_tecnico=this.AV14id_unidad_tecnico;
      }

      public int executeUdp( string aP0_ResponsableUsuario ,
                             out short aP1_ResponsableId ,
                             out string aP2_ResponsableIdentidad ,
                             out string aP3_ResponsableNombre ,
                             out string aP4_ResponsableEmail ,
                             out string aP5_ResponsableCargo )
      {
         execute(aP0_ResponsableUsuario, out aP1_ResponsableId, out aP2_ResponsableIdentidad, out aP3_ResponsableNombre, out aP4_ResponsableEmail, out aP5_ResponsableCargo, out aP6_id_unidad_tecnico);
         return AV14id_unidad_tecnico ;
      }
                                 ...
                                 out int aP6_id_unidad_tecnico )
      {
         ...
         objprcgettecnicoid.AV14id_unidad_tecnico = 0 ;
      ...
      void executePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A103id_unidad = P005H2_A103id_unidad[0];
            ...
            AV14id_unidad_tecnico = A103id_unidad;
      ...
      public override void initialize( )
      {
         ...
         P005H2_A103id_unidad = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prcgettecnicoid__default(),
            new Object[][] {
                new Object[] {
               P005H2_A96ResponsableUsuario, P005H2_A6ResponsableId, P005H2_A29ResponsableIdentidad, P005H2_A30ResponsableNombre, P005H2_A28ResponsableEmail, P005H2_A27ResponsableCargo, P005H2_A103id_unidad
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int AV14id_unidad_tecnico ;
      ...
      private int[] P005H2_A103id_unidad ;
      ...
      private int aP6_id_unidad_tecnico ;
   }
