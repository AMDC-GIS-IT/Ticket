...
namespace GeneXus.Programs {
   public class wpbuscartdaplicaciones : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wpbuscartdaplicaciones( )
      {
      ...
      public wpbuscartdaplicaciones( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV30GenericFilter_Grid, AV31Filter_Fecha_From, AV17ClassCollection_Grid, AV32Filter_Fecha_To, AV35Pgmname, AV15GridConfiguration, AV16CurrentPage_Grid, AV23FreezeColumnTitles_Grid) ;
      ...
      {
         get {
            return "wpbuscartdaplicaciones_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202418843995", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpbuscartdaplicaciones.aspx") +"\">") ;
      ...
      {
         return formatLink("wpbuscartdaplicaciones.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WpBuscarTdAplicaciones" ;
      }

      public override string GetPgmdesc( )
      {
         return "Web Panel Buscar Trabajo Diario Aplicaciones" ;
      }
      ...
      protected void WB7X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock_var_filter_fecha_Internalname, "fecha_registro", "", "", lblTextblock_var_filter_fecha_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BT_LabelTop", 0, "", 1, 1, 0, 0, "HLP_WpBuscarTdAplicaciones.htm");
            /* User Defined Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;", "div");
            wb_table1_46_7X2( true) ;
         }
         else
         {
            wb_table1_46_7X2( false) ;
         }
         return  ;
      }

      protected void wb_table1_46_7X2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            wb_table2_90_7X2( true) ;
         }
         else
         {
            wb_table2_90_7X2( false) ;
         }
         return  ;
      }

      protected void wb_table2_90_7X2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", context.convertURL( AV24ActionModificar_Action));
         ...
         if ( wbEnd == 99 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table3_116_7X2( true) ;
         }
         else
         {
            wb_table3_116_7X2( false) ;
         }
         return  ;
      }

      protected void wb_table3_116_7X2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_previouspagebuttontextblockgrid_Internalname, "", "", "", lblPaginationbar_previouspagebuttontextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGPREVIOUS(GRID)\\'."+"'", "", lblPaginationbar_previouspagebuttontextblockgrid_Class, 5, "", 1, 1, 0, 0, "HLP_WpBuscarTdAplicaciones.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_firstpagetextblockgrid_Internalname, lblPaginationbar_firstpagetextblockgrid_Caption, "", "", lblPaginationbar_firstpagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGFIRST(GRID)\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPaginationbar_firstpagetextblockgrid_Visible, 1, 0, 0, "HLP_WpBuscarTdAplicaciones.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_spacinglefttextblockgrid_Internalname, "...", "", "", lblPaginationbar_spacinglefttextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblPaginationbar_spacinglefttextblockgrid_Visible, 1, 0, 0, "HLP_WpBuscarTdAplicaciones.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_previouspagetextblockgrid_Internalname, lblPaginationbar_previouspagetextblockgrid_Caption, "", "", lblPaginationbar_previouspagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGPREVIOUS(GRID)\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPaginationbar_previouspagetextblockgrid_Visible, 1, 0, 0, "HLP_WpBuscarTdAplicaciones.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_currentpagetextblockgrid_Internalname, lblPaginationbar_currentpagetextblockgrid_Caption, "", "", lblPaginationbar_currentpagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_WpBuscarTdAplicaciones.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_nextpagetextblockgrid_Internalname, lblPaginationbar_nextpagetextblockgrid_Caption, "", "", lblPaginationbar_nextpagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGNEXT(GRID)\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPaginationbar_nextpagetextblockgrid_Visible, 1, 0, 0, "HLP_WpBuscarTdAplicaciones.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_spacingrighttextblockgrid_Internalname, "...", "", "", lblPaginationbar_spacingrighttextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblPaginationbar_spacingrighttextblockgrid_Visible, 1, 0, 0, "HLP_WpBuscarTdAplicaciones.htm");
            /* Text block */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_nextpagebuttontextblockgrid_Internalname, "", "", "", lblPaginationbar_nextpagebuttontextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGNEXT(GRID)\\'."+"'", "", lblPaginationbar_nextpagebuttontextblockgrid_Class, 5, "", 1, 1, 0, 0, "HLP_WpBuscarTdAplicaciones.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START7X2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Web Panel Buscar Trabajo Diario Aplicaciones", 0) ;
         }
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 19), "'E_ACTIONMODIFICAR'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 19), "'E_ACTIONMODIFICAR'") == 0 ) )
                           {
                              ...
                              AV24ActionModificar_Action = cgiGet( edtavActionmodificar_action_Internalname);
                              AssignProp("", false, edtavActionmodificar_action_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV24ActionModificar_Action)) ? AV36Actionmodificar_action_GXI : context.convertURL( context.PathToRelativeUrl( AV24ActionModificar_Action))), !bGXsfl_99_Refreshing);
                              AssignProp("", false, edtavActionmodificar_action_Internalname, "SrcSet", context.GetImageSrcSet( AV24ActionModificar_Action), true);
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
      ...
      {
         /* GeneXus formulas. */
         AV35Pgmname = "WpBuscarTdAplicaciones";
         context.Gx_err = 0;
      }
      ...
      protected int subGridclient_rec_count_fnc( )
      {
         ...
         {
            A254fecha_solicitud = H007X2_A254fecha_solicitud[0];
            n254fecha_solicitud = H007X2_n254fecha_solicitud[0];
            A252prioridad = H007X2_A252prioridad[0];
            n252prioridad = H007X2_n252prioridad[0];
            A250id_actividad = H007X2_A250id_actividad[0];
            n250id_actividad = H007X2_n250id_actividad[0];
            A249id_categoria = H007X2_A249id_categoria[0];
            n249id_categoria = H007X2_n249id_categoria[0];
            A248detalle_infotecid_unidad = H007X2_A248detalle_infotecid_unidad[0];
            n248detalle_infotecid_unidad = H007X2_n248detalle_infotecid_unidad[0];
            A253observaciones = H007X2_A253observaciones[0];
            n253observaciones = H007X2_n253observaciones[0];
            A247correo_usuario = H007X2_A247correo_usuario[0];
            n247correo_usuario = H007X2_n247correo_usuario[0];
            A246depto_usuario = H007X2_A246depto_usuario[0];
            n246depto_usuario = H007X2_n246depto_usuario[0];
            A241fecha_registro = H007X2_A241fecha_registro[0];
            n241fecha_registro = H007X2_n241fecha_registro[0];
            A245nombre_usuario = H007X2_A245nombre_usuario[0];
            n245nombre_usuario = H007X2_n245nombre_usuario[0];
            A240cargo_emp = H007X2_A240cargo_emp[0];
            n240cargo_emp = H007X2_n240cargo_emp[0];
            A239nombre_emp = H007X2_A239nombre_emp[0];
            n239nombre_emp = H007X2_n239nombre_emp[0];
            A238correlativo = H007X2_A238correlativo[0];
      ...
      protected void RF7X2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A254fecha_solicitud = H007X3_A254fecha_solicitud[0];
               n254fecha_solicitud = H007X3_n254fecha_solicitud[0];
               A252prioridad = H007X3_A252prioridad[0];
               n252prioridad = H007X3_n252prioridad[0];
               A250id_actividad = H007X3_A250id_actividad[0];
               n250id_actividad = H007X3_n250id_actividad[0];
               A249id_categoria = H007X3_A249id_categoria[0];
               n249id_categoria = H007X3_n249id_categoria[0];
               A248detalle_infotecid_unidad = H007X3_A248detalle_infotecid_unidad[0];
               n248detalle_infotecid_unidad = H007X3_n248detalle_infotecid_unidad[0];
               A253observaciones = H007X3_A253observaciones[0];
               n253observaciones = H007X3_n253observaciones[0];
               A247correo_usuario = H007X3_A247correo_usuario[0];
               n247correo_usuario = H007X3_n247correo_usuario[0];
               A246depto_usuario = H007X3_A246depto_usuario[0];
               n246depto_usuario = H007X3_n246depto_usuario[0];
               A241fecha_registro = H007X3_A241fecha_registro[0];
               n241fecha_registro = H007X3_n241fecha_registro[0];
               A245nombre_usuario = H007X3_A245nombre_usuario[0];
               n245nombre_usuario = H007X3_n245nombre_usuario[0];
               A240cargo_emp = H007X3_A240cargo_emp[0];
               n240cargo_emp = H007X3_n240cargo_emp[0];
               A239nombre_emp = H007X3_A239nombre_emp[0];
               n239nombre_emp = H007X3_n239nombre_emp[0];
               A238correlativo = H007X3_A238correlativo[0];
               if ( StringUtil.StrCmp(A239nombre_emp, AV25WebSession.Get("NombreResponsable")) == 0 )
               {
                  E227X2 ();
               }
      ...
      protected void E217X2( )
      {
         ...
         new k2bloadrowsperpage(context ).execute(  AV35Pgmname,  "Grid", out  AV19RowsPerPage_Grid, out  AV20RowsPerPageLoaded_Grid) ;
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         new k2bloadgridconfiguration(context ).execute(  AV35Pgmname,  "Grid", ref  AV15GridConfiguration) ;
      ...
      private void E227X2( )
      {
         if ( ( subGrid_Islastpage == 1 ) || ( subGrid_Rows == 0 ) || ( ( GRID_nCurrentRecord >= GRID_nFirstRecordOnPage ) && ( GRID_nCurrentRecord < GRID_nFirstRecordOnPage + subGrid_fnc_Recordsperpage( ) ) ) )
         {
            ...
            AV24ActionModificar_Action = context.GetImagePath( "7c63c2b9-483e-4035-b512-febf9186a274", "", context.GetTheme( ));
            AssignAttri("", false, edtavActionmodificar_action_Internalname, AV24ActionModificar_Action);
      ...
      protected void S162( )
      {
         ...
         if ( ( AV13GridState.gxTpr_Currentpage > 0 ) && ( AV13GridState.gxTpr_Currentpage <= AV22PageCount_Grid ) )
         {
            AV16CurrentPage_Grid = AV13GridState.gxTpr_Currentpage;
            AssignAttri("", false, "AV16CurrentPage_Grid", StringUtil.LTrimStr( (decimal)(AV16CurrentPage_Grid), 4, 0));
      ...
      protected void E167X2( )
      {
         ...
         new k2bsavegridconfiguration(context ).execute(  AV35Pgmname,  "Grid",  AV15GridConfiguration,  true) ;
         ...
         if ( AV19RowsPerPage_Grid != AV21GridSettingsRowsPerPage_Grid )
         {
            ...
            AssignAttri("", false, "AV19RowsPerPage_Grid", StringUtil.LTrimStr( (decimal)(AV19RowsPerPage_Grid), 4, 0));
            new k2bsaverowsperpage(context ).execute(  AV35Pgmname,  "Grid",  AV19RowsPerPage_Grid) ;
            AV16CurrentPage_Grid = 1;
            AssignAttri("", false, "AV16CurrentPage_Grid", StringUtil.LTrimStr( (decimal)(AV16CurrentPage_Grid), 4, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void S232( )
      {
         ...
         returnInSub = false;
         context.PopUp(formatLink("wptrabajoaplicaciones.aspx") , new Object[] {});
         context.DoAjaxRefresh();
      }

      protected void wb_table3_116_7X2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_grid_Internalname, "No hay resultados", "", "", lblI_noresultsfoundtextblock_grid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_WpBuscarTdAplicaciones.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_116_7X2e( true) ;
         }
         else
         {
            wb_table3_116_7X2e( false) ;
         }
      }

      protected void wb_table2_90_7X2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttActionnuevatarea_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(99), 2, 0)+","+"null"+");", "Registrar Trabajo", bttActionnuevatarea_Jsonclick, 5, "", "", StyleString, ClassString, bttActionnuevatarea_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'E_ACTIONNUEVATAREA\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WpBuscarTdAplicaciones.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_90_7X2e( true) ;
         }
         else
         {
            wb_table2_90_7X2e( false) ;
         }
      }

      protected void wb_table1_46_7X2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGslayoutdefined_gridruntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblGslayoutdefined_gridruntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_WpBuscarTdAplicaciones.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavGridsettingsrowsperpage_grid, cmbavGridsettingsrowsperpage_grid_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV21GridSettingsRowsPerPage_Grid), 4, 0)), 1, cmbavGridsettingsrowsperpage_grid_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavGridsettingsrowsperpage_grid.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,72);\"", "", true, 1, "HLP_WpBuscarTdAplicaciones.htm");
            cmbavGridsettingsrowsperpage_grid.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV21GridSettingsRowsPerPage_Grid), 4, 0));
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttGridsettings_savegrid_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(99), 2, 0)+","+"null"+");", "Aplicar", bttGridsettings_savegrid_Jsonclick, 5, "Aplicar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'SAVEGRIDSETTINGS(GRID)\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WpBuscarTdAplicaciones.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_46_7X2e( true) ;
         }
         else
         {
            wb_table1_46_7X2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188431319", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wpbuscartdaplicaciones.js", "?2024188431320", false, true);
            context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
            context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
            context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
            context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Web Panel Buscar Trabajo Diario Aplicaciones";
         subGrid_Rows = 20;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'SAVEGRIDSETTINGS(GRID)'","{handler:'E167X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV30GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV31Filter_Fecha_From',fld:'vFILTER_FECHA_FROM',pic:''},{av:'AV17ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV32Filter_Fecha_To',fld:'vFILTER_FECHA_TO',pic:''},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV15GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV16CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpage_grid'},{av:'AV21GridSettingsRowsPerPage_Grid',fld:'vGRIDSETTINGSROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV19RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV23FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'SAVEGRIDSETTINGS(GRID)'",",oparms:[{av:'AV15GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV19RowsPerPage_Grid',fld:'vROWSPERPAGE_GRID',pic:'ZZZ9'},{av:'AV16CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'divGridsettings_contentoutertablegrid_Visible',ctrl:'GRIDSETTINGS_CONTENTOUTERTABLEGRID',prop:'Visible'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{ctrl:'ACTIONNUEVATAREA',prop:'Visible'},{av:'AV17ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV23FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("'E_ACTIONMODIFICAR'","{handler:'E247X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV30GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV31Filter_Fecha_From',fld:'vFILTER_FECHA_FROM',pic:''},{av:'AV17ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV32Filter_Fecha_To',fld:'vFILTER_FECHA_TO',pic:''},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV15GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV16CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'A238correlativo',fld:'CORRELATIVO',pic:'ZZZZZZZZ9',hsh:true},{av:'A239nombre_emp',fld:'NOMBRE_EMP',pic:'',hsh:true},{av:'A240cargo_emp',fld:'CARGO_EMP',pic:'',hsh:true},{av:'A245nombre_usuario',fld:'NOMBRE_USUARIO',pic:'',hsh:true},{av:'A241fecha_registro',fld:'FECHA_REGISTRO',pic:'',hsh:true},{av:'A246depto_usuario',fld:'DEPTO_USUARIO',pic:'',hsh:true},{av:'A247correo_usuario',fld:'CORREO_USUARIO',pic:'',hsh:true},{av:'A253observaciones',fld:'OBSERVACIONES',pic:'',hsh:true},{av:'A248detalle_infotecid_unidad',fld:'DETALLE_INFOTECID_UNIDAD',pic:'ZZZZZZZZ9',hsh:true},{av:'A249id_categoria',fld:'ID_CATEGORIA',pic:'ZZZZZZZZ9',hsh:true},{av:'A250id_actividad',fld:'ID_ACTIVIDAD',pic:'ZZZZZZZZ9',hsh:true},{av:'A252prioridad',fld:'PRIORIDAD',pic:'',hsh:true},{av:'A254fecha_solicitud',fld:'FECHA_SOLICITUD',pic:'',hsh:true},{av:'AV23FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'E_ACTIONMODIFICAR'",",oparms:[{av:'AV16CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'AV15GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'ACTIONNUEVATAREA',prop:'Visible'},{av:'AV17ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV23FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("FILTERTAGSUSERCONTROL_GRID.TAGDELETED","{handler:'E117X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV30GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV31Filter_Fecha_From',fld:'vFILTER_FECHA_FROM',pic:''},{av:'AV17ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV32Filter_Fecha_To',fld:'vFILTER_FECHA_TO',pic:''},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV15GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV16CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV29DeletedTag_Grid',fld:'vDELETEDTAG_GRID',pic:''},{av:'AV23FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("FILTERTAGSUSERCONTROL_GRID.TAGDELETED",",oparms:[{av:'AV31Filter_Fecha_From',fld:'vFILTER_FECHA_FROM',pic:''},{av:'AV32Filter_Fecha_To',fld:'vFILTER_FECHA_TO',pic:''},{av:'AV16CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'AV15GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'ACTIONNUEVATAREA',prop:'Visible'},{av:'AV17ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV23FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("LAYOUTDEFINED_FILTERTOGGLE_COMBINED_GRID.CLICK","{handler:'E177X2',iparms:[{av:'divLayoutdefined_filtercollapsiblesection_combined_grid_Visible',ctrl:'LAYOUTDEFINED_FILTERCOLLAPSIBLESECTION_COMBINED_GRID',prop:'Visible'},{av:'AV23FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         ...
         setEventMetadata("LAYOUTDEFINED_FILTERCLOSE_COMBINED_GRID.CLICK","{handler:'E187X2',iparms:[{av:'AV23FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         ...
         setEventMetadata("'E_ACTIONNUEVATAREA'","{handler:'E197X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV30GenericFilter_Grid',fld:'vGENERICFILTER_GRID',pic:''},{av:'AV31Filter_Fecha_From',fld:'vFILTER_FECHA_FROM',pic:''},{av:'AV17ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV32Filter_Fecha_To',fld:'vFILTER_FECHA_TO',pic:''},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV15GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV16CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV23FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'E_ACTIONNUEVATAREA'",",oparms:[{av:'AV16CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'AV15GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{ctrl:'ACTIONNUEVATAREA',prop:'Visible'},{av:'AV17ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV23FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         ...
         setEventMetadata("NULL","{handler:'Validv_Actionmodificar_action',iparms:[{av:'AV23FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         H007X2_A254fecha_solicitud = new string[] {""} ;
         H007X2_n254fecha_solicitud = new bool[] {false} ;
         H007X2_A252prioridad = new string[] {""} ;
         H007X2_n252prioridad = new bool[] {false} ;
         H007X2_A250id_actividad = new int[1] ;
         H007X2_n250id_actividad = new bool[] {false} ;
         H007X2_A249id_categoria = new int[1] ;
         H007X2_n249id_categoria = new bool[] {false} ;
         H007X2_A248detalle_infotecid_unidad = new int[1] ;
         H007X2_n248detalle_infotecid_unidad = new bool[] {false} ;
         H007X2_A253observaciones = new string[] {""} ;
         H007X2_n253observaciones = new bool[] {false} ;
         H007X2_A247correo_usuario = new string[] {""} ;
         H007X2_n247correo_usuario = new bool[] {false} ;
         H007X2_A246depto_usuario = new string[] {""} ;
         H007X2_n246depto_usuario = new bool[] {false} ;
         H007X2_A241fecha_registro = new DateTime[] {DateTime.MinValue} ;
         H007X2_n241fecha_registro = new bool[] {false} ;
         H007X2_A245nombre_usuario = new string[] {""} ;
         H007X2_n245nombre_usuario = new bool[] {false} ;
         H007X2_A240cargo_emp = new string[] {""} ;
         H007X2_n240cargo_emp = new bool[] {false} ;
         H007X2_A239nombre_emp = new string[] {""} ;
         H007X2_n239nombre_emp = new bool[] {false} ;
         H007X2_A238correlativo = new int[1] ;
         AV25WebSession = context.GetSession();
         H007X3_A254fecha_solicitud = new string[] {""} ;
         H007X3_n254fecha_solicitud = new bool[] {false} ;
         H007X3_A252prioridad = new string[] {""} ;
         H007X3_n252prioridad = new bool[] {false} ;
         H007X3_A250id_actividad = new int[1] ;
         H007X3_n250id_actividad = new bool[] {false} ;
         H007X3_A249id_categoria = new int[1] ;
         H007X3_n249id_categoria = new bool[] {false} ;
         H007X3_A248detalle_infotecid_unidad = new int[1] ;
         H007X3_n248detalle_infotecid_unidad = new bool[] {false} ;
         H007X3_A253observaciones = new string[] {""} ;
         H007X3_n253observaciones = new bool[] {false} ;
         H007X3_A247correo_usuario = new string[] {""} ;
         H007X3_n247correo_usuario = new bool[] {false} ;
         H007X3_A246depto_usuario = new string[] {""} ;
         H007X3_n246depto_usuario = new bool[] {false} ;
         H007X3_A241fecha_registro = new DateTime[] {DateTime.MinValue} ;
         H007X3_n241fecha_registro = new bool[] {false} ;
         H007X3_A245nombre_usuario = new string[] {""} ;
         H007X3_n245nombre_usuario = new bool[] {false} ;
         H007X3_A240cargo_emp = new string[] {""} ;
         H007X3_n240cargo_emp = new bool[] {false} ;
         H007X3_A239nombre_emp = new string[] {""} ;
         H007X3_n239nombre_emp = new bool[] {false} ;
         H007X3_A238correlativo = new int[1] ;
         ...
         ROClassString = "";
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.wpbuscartdaplicaciones__datastore1(),
            new Object[][] {
                new Object[] {
               H007X2_A254fecha_solicitud, H007X2_n254fecha_solicitud, H007X2_A252prioridad, H007X2_n252prioridad, H007X2_A250id_actividad, H007X2_n250id_actividad, H007X2_A249id_categoria, H007X2_n249id_categoria, H007X2_A248detalle_infotecid_unidad, H007X2_n248detalle_infotecid_unidad,
               H007X2_A253observaciones, H007X2_n253observaciones, H007X2_A247correo_usuario, H007X2_n247correo_usuario, H007X2_A246depto_usuario, H007X2_n246depto_usuario, H007X2_A241fecha_registro, H007X2_n241fecha_registro, H007X2_A245nombre_usuario, H007X2_n245nombre_usuario,
               H007X2_A240cargo_emp, H007X2_n240cargo_emp, H007X2_A239nombre_emp, H007X2_n239nombre_emp, H007X2_A238correlativo
               }
               , new Object[] {
               H007X3_A254fecha_solicitud, H007X3_n254fecha_solicitud, H007X3_A252prioridad, H007X3_n252prioridad, H007X3_A250id_actividad, H007X3_n250id_actividad, H007X3_A249id_categoria, H007X3_n249id_categoria, H007X3_A248detalle_infotecid_unidad, H007X3_n248detalle_infotecid_unidad,
               H007X3_A253observaciones, H007X3_n253observaciones, H007X3_A247correo_usuario, H007X3_n247correo_usuario, H007X3_A246depto_usuario, H007X3_n246depto_usuario, H007X3_A241fecha_registro, H007X3_n241fecha_registro, H007X3_A245nombre_usuario, H007X3_n245nombre_usuario,
               H007X3_A240cargo_emp, H007X3_n240cargo_emp, H007X3_A239nombre_emp, H007X3_n239nombre_emp, H007X3_A238correlativo
               }
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpbuscartdaplicaciones__default(),
            new Object[][] {
            }
         );
         AV35Pgmname = "WpBuscarTdAplicaciones";
      ...
      private bool AV24ActionModificar_Action_IsBlob ;
      ...
      private string AV24ActionModificar_Action ;
      ...
      private string[] H007X2_A254fecha_solicitud ;
      private bool[] H007X2_n254fecha_solicitud ;
      private string[] H007X2_A252prioridad ;
      private bool[] H007X2_n252prioridad ;
      private int[] H007X2_A250id_actividad ;
      private bool[] H007X2_n250id_actividad ;
      private int[] H007X2_A249id_categoria ;
      private bool[] H007X2_n249id_categoria ;
      private int[] H007X2_A248detalle_infotecid_unidad ;
      private bool[] H007X2_n248detalle_infotecid_unidad ;
      private string[] H007X2_A253observaciones ;
      private bool[] H007X2_n253observaciones ;
      private string[] H007X2_A247correo_usuario ;
      private bool[] H007X2_n247correo_usuario ;
      private string[] H007X2_A246depto_usuario ;
      private bool[] H007X2_n246depto_usuario ;
      private DateTime[] H007X2_A241fecha_registro ;
      private bool[] H007X2_n241fecha_registro ;
      private string[] H007X2_A245nombre_usuario ;
      private bool[] H007X2_n245nombre_usuario ;
      private string[] H007X2_A240cargo_emp ;
      private bool[] H007X2_n240cargo_emp ;
      private string[] H007X2_A239nombre_emp ;
      private bool[] H007X2_n239nombre_emp ;
      private int[] H007X2_A238correlativo ;
      private string[] H007X3_A254fecha_solicitud ;
      private bool[] H007X3_n254fecha_solicitud ;
      private string[] H007X3_A252prioridad ;
      private bool[] H007X3_n252prioridad ;
      private int[] H007X3_A250id_actividad ;
      private bool[] H007X3_n250id_actividad ;
      private int[] H007X3_A249id_categoria ;
      private bool[] H007X3_n249id_categoria ;
      private int[] H007X3_A248detalle_infotecid_unidad ;
      private bool[] H007X3_n248detalle_infotecid_unidad ;
      private string[] H007X3_A253observaciones ;
      private bool[] H007X3_n253observaciones ;
      private string[] H007X3_A247correo_usuario ;
      private bool[] H007X3_n247correo_usuario ;
      private string[] H007X3_A246depto_usuario ;
      private bool[] H007X3_n246depto_usuario ;
      private DateTime[] H007X3_A241fecha_registro ;
      private bool[] H007X3_n241fecha_registro ;
      private string[] H007X3_A245nombre_usuario ;
      private bool[] H007X3_n245nombre_usuario ;
      private string[] H007X3_A240cargo_emp ;
      private bool[] H007X3_n240cargo_emp ;
      private string[] H007X3_A239nombre_emp ;
      private bool[] H007X3_n239nombre_emp ;
      private int[] H007X3_A238correlativo ;
   ...
   public class wpbuscartdaplicaciones__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int A249id_categoria )
      {
         ...
         AddWhere(sWhereString, "([id_categoria] = 2 or [id_categoria] = 11)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H007X2(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (string)dynConstraints[2] , (DateTime)dynConstraints[3] , (int)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (int)dynConstraints[12] );
               case 1 :
                     return conditional_H007X3(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (string)dynConstraints[2] , (DateTime)dynConstraints[3] , (int)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (int)dynConstraints[12] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H007X2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007X2,21, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007X3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007X3,21, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
 ...
 public class wpbuscartdaplicaciones__default : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
