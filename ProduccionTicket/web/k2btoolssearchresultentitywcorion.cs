...
namespace GeneXus.Programs {
   public class k2btoolssearchresultentitywcorion : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188311750", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("k2btoolssearchresultentitywcorion.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV26SearchCriteriaIn)),UrlEncode(StringUtil.RTrim(AV11EntityName))}, new string[] {"SearchCriteriaIn","EntityName"}) +"\">") ;
      ...
      protected void S112( )
      {
         ...
         AV24ResultsEntities = new GXBaseCollection<SdtK2BSearchResult_Item>( context, "Item", "kb_ticket");
         gx_BV12 = true;
      ...
      {
         AV31GXV1 = nGXsfl_12_idx;
         if ( ( AV31GXV1 > 0 ) && ( AV24ResultsEntities.Count >= AV31GXV1 ) )
         {
            AV24ResultsEntities.CurrentItem = ((SdtK2BSearchResult_Item)AV24ResultsEntities.Item(AV31GXV1));
         }
         /* 'E_NextPage' Routine */
      ...
      protected void wb_table1_6_112( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoresultsfoundtextblock_Internalname, "No results found", "", "", lblNoresultsfoundtextblock_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_K2BToolsSearchResultEntityWCOrion.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188311787", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("k2btoolssearchresultentitywcorion.js", "?2024188311787", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTITIESRESULTSGRIDLARGE.LOAD","{handler:'E14112',iparms:[{av:'AV24ResultsEntities',fld:'vRESULTSENTITIES',grid:12,pic:''},{av:'nGXsfl_12_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:12},{av:'ENTITIESRESULTSGRIDLARGE_nFirstRecordOnPage'},{av:'nRC_GXsfl_12',ctrl:'ENTITIESRESULTSGRIDLARGE',prop:'GridRC',grid:12}]");
