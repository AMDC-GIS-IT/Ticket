...
namespace GeneXus.Programs {
   public class exportetapasdesarrolloticketwc : GXProcedure
   {
                           ...
                           out string aP11_OutFile )
      {
         ...
         initialize();
         executePrivate();
         aP11_OutFile=this.AV68OutFile;
      }

      public string executeUdp( short aP0_EtapaDesarrolloId ,
                                DateTime aP1_TicketFecha_From ,
                                DateTime aP2_TicketFecha_To ,
                                DateTime aP3_TicketHora_From ,
                                DateTime aP4_TicketHora_To ,
                                ...
                                short aP10_OrderedBy )
      {
         execute(aP0_EtapaDesarrolloId, aP1_TicketFecha_From, aP2_TicketFecha_To, aP3_TicketHora_From, aP4_TicketHora_To, aP5_UsuarioNombre, aP6_EstadoTicketTicketNombre, aP7_TicketFechaHora_From, aP8_TicketFechaHora_To, aP9_K2BToolsGenericSearchField, aP10_OrderedBy, out aP11_OutFile);
         return AV68OutFile ;
      }
                                 ...
                                 out string aP11_OutFile )
      {
         ...
         objexportetapasdesarrolloticketwc.AV68OutFile = "" ;
      ...
      void executePrivate( )
      {
         ...
         AV68OutFile = GxDirectory.TemporaryFilesPath + AV30File.Separator + "ExportEtapasDesarrolloTicketWC-" + Guid.NewGuid( ).ToString() + ".xlsx";
         AV22ExcelDocument.Open(AV68OutFile);
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            n278TicketUsuarioAsigno = P00713_n278TicketUsuarioAsigno[0];
            ...
            n53TicketLaptop = P00713_n53TicketLaptop[0];
            A42TicketDesktop = P00713_A42TicketDesktop[0];
            n42TicketDesktop = P00713_n42TicketDesktop[0];
            A55TicketMonitor = P00713_A55TicketMonitor[0];
            n55TicketMonitor = P00713_n55TicketMonitor[0];
            A50TicketImpresora = P00713_A50TicketImpresora[0];
            n50TicketImpresora = P00713_n50TicketImpresora[0];
            A45TicketEscaner = P00713_A45TicketEscaner[0];
            n45TicketEscaner = P00713_n45TicketEscaner[0];
            A59TicketRouter = P00713_A59TicketRouter[0];
            n59TicketRouter = P00713_n59TicketRouter[0];
            A60TicketSistemaOperativo = P00713_A60TicketSistemaOperativo[0];
            n60TicketSistemaOperativo = P00713_n60TicketSistemaOperativo[0];
            A56TicketOffice = P00713_A56TicketOffice[0];
            n56TicketOffice = P00713_n56TicketOffice[0];
            A39TicketAntivirus = P00713_A39TicketAntivirus[0];
            n39TicketAntivirus = P00713_n39TicketAntivirus[0];
            A40TicketAplicacion = P00713_A40TicketAplicacion[0];
            n40TicketAplicacion = P00713_n40TicketAplicacion[0];
            A44TicketDisenio = P00713_A44TicketDisenio[0];
            n44TicketDisenio = P00713_n44TicketDisenio[0];
            A51TicketIngenieria = P00713_A51TicketIngenieria[0];
            n51TicketIngenieria = P00713_n51TicketIngenieria[0];
            A43TicketDiscoDuroExterno = P00713_A43TicketDiscoDuroExterno[0];
            n43TicketDiscoDuroExterno = P00713_n43TicketDiscoDuroExterno[0];
            A58TicketPerifericos = P00713_A58TicketPerifericos[0];
            n58TicketPerifericos = P00713_n58TicketPerifericos[0];
            A87TicketUps = P00713_A87TicketUps[0];
            n87TicketUps = P00713_n87TicketUps[0];
            A41TicketApoyoUsuario = P00713_A41TicketApoyoUsuario[0];
            n41TicketApoyoUsuario = P00713_n41TicketApoyoUsuario[0];
            A52TicketInstalarDataShow = P00713_A52TicketInstalarDataShow[0];
            n52TicketInstalarDataShow = P00713_n52TicketInstalarDataShow[0];
            A57TicketOtros = P00713_A57TicketOtros[0];
            n57TicketOtros = P00713_n57TicketOtros[0];
            A188EstadoTicketTicketNombre = P00713_A188EstadoTicketTicketNombre[0];
            A88UsuarioDepartamento = P00713_A88UsuarioDepartamento[0];
            A91UsuarioGerencia = P00713_A91UsuarioGerencia[0];
            A94UsuarioRequerimiento = P00713_A94UsuarioRequerimiento[0];
      ...
      public override void initialize( )
      {
         ...
         P00713_n278TicketUsuarioAsigno = new bool[] {false} ;
         ...
         P00713_A15UsuarioId = new long[1] ;
         ...
         P00713_n53TicketLaptop = new bool[] {false} ;
         P00713_A42TicketDesktop = new bool[] {false} ;
         P00713_n42TicketDesktop = new bool[] {false} ;
         P00713_A55TicketMonitor = new bool[] {false} ;
         P00713_n55TicketMonitor = new bool[] {false} ;
         P00713_A50TicketImpresora = new bool[] {false} ;
         P00713_n50TicketImpresora = new bool[] {false} ;
         P00713_A45TicketEscaner = new bool[] {false} ;
         P00713_n45TicketEscaner = new bool[] {false} ;
         P00713_A59TicketRouter = new bool[] {false} ;
         P00713_n59TicketRouter = new bool[] {false} ;
         P00713_A60TicketSistemaOperativo = new bool[] {false} ;
         P00713_n60TicketSistemaOperativo = new bool[] {false} ;
         P00713_A56TicketOffice = new bool[] {false} ;
         P00713_n56TicketOffice = new bool[] {false} ;
         P00713_A39TicketAntivirus = new bool[] {false} ;
         P00713_n39TicketAntivirus = new bool[] {false} ;
         P00713_A40TicketAplicacion = new bool[] {false} ;
         P00713_n40TicketAplicacion = new bool[] {false} ;
         P00713_A44TicketDisenio = new bool[] {false} ;
         P00713_n44TicketDisenio = new bool[] {false} ;
         P00713_A51TicketIngenieria = new bool[] {false} ;
         P00713_n51TicketIngenieria = new bool[] {false} ;
         P00713_A43TicketDiscoDuroExterno = new bool[] {false} ;
         P00713_n43TicketDiscoDuroExterno = new bool[] {false} ;
         P00713_A58TicketPerifericos = new bool[] {false} ;
         P00713_n58TicketPerifericos = new bool[] {false} ;
         P00713_A87TicketUps = new bool[] {false} ;
         P00713_n87TicketUps = new bool[] {false} ;
         P00713_A41TicketApoyoUsuario = new bool[] {false} ;
         P00713_n41TicketApoyoUsuario = new bool[] {false} ;
         P00713_A52TicketInstalarDataShow = new bool[] {false} ;
         P00713_n52TicketInstalarDataShow = new bool[] {false} ;
         P00713_A57TicketOtros = new bool[] {false} ;
         P00713_n57TicketOtros = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.exportetapasdesarrolloticketwc__default(),
            new Object[][] {
               ...
               , new Object[] {
               P00713_A278TicketUsuarioAsigno, P00713_n278TicketUsuarioAsigno, P00713_A285TicketHoraCaracter, P00713_A54TicketLastId, P00713_A187EstadoTicketTicketId, P00713_A88UsuarioDepartamento, P00713_A91UsuarioGerencia, P00713_A94UsuarioRequerimiento, P00713_A15UsuarioId, P00713_A14TicketId,
               P00713_A289TicketFechaHora, P00713_n289TicketFechaHora, P00713_A188EstadoTicketTicketNombre, P00713_A93UsuarioNombre, P00713_A48TicketHora, P00713_A46TicketFecha, P00713_A53TicketLaptop, P00713_n53TicketLaptop, P00713_A42TicketDesktop, P00713_n42TicketDesktop,
               P00713_A55TicketMonitor, P00713_n55TicketMonitor, P00713_A50TicketImpresora, P00713_n50TicketImpresora, P00713_A45TicketEscaner, P00713_n45TicketEscaner, P00713_A59TicketRouter, P00713_n59TicketRouter, P00713_A60TicketSistemaOperativo, P00713_n60TicketSistemaOperativo,
               P00713_A56TicketOffice, P00713_n56TicketOffice, P00713_A39TicketAntivirus, P00713_n39TicketAntivirus, P00713_A40TicketAplicacion, P00713_n40TicketAplicacion, P00713_A44TicketDisenio, P00713_n44TicketDisenio, P00713_A51TicketIngenieria, P00713_n51TicketIngenieria,
               P00713_A43TicketDiscoDuroExterno, P00713_n43TicketDiscoDuroExterno, P00713_A58TicketPerifericos, P00713_n58TicketPerifericos, P00713_A87TicketUps, P00713_n87TicketUps, P00713_A41TicketApoyoUsuario, P00713_n41TicketApoyoUsuario, P00713_A52TicketInstalarDataShow, P00713_n52TicketInstalarDataShow,
               P00713_A57TicketOtros, P00713_n57TicketOtros
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private bool[] P00713_n278TicketUsuarioAsigno ;
      ...
      private long[] P00713_A15UsuarioId ;
      ...
      private bool[] P00713_n53TicketLaptop ;
      private bool[] P00713_A42TicketDesktop ;
      private bool[] P00713_n42TicketDesktop ;
      private bool[] P00713_A55TicketMonitor ;
      private bool[] P00713_n55TicketMonitor ;
      private bool[] P00713_A50TicketImpresora ;
      private bool[] P00713_n50TicketImpresora ;
      private bool[] P00713_A45TicketEscaner ;
      private bool[] P00713_n45TicketEscaner ;
      private bool[] P00713_A59TicketRouter ;
      private bool[] P00713_n59TicketRouter ;
      private bool[] P00713_A60TicketSistemaOperativo ;
      private bool[] P00713_n60TicketSistemaOperativo ;
      private bool[] P00713_A56TicketOffice ;
      private bool[] P00713_n56TicketOffice ;
      private bool[] P00713_A39TicketAntivirus ;
      private bool[] P00713_n39TicketAntivirus ;
      private bool[] P00713_A40TicketAplicacion ;
      private bool[] P00713_n40TicketAplicacion ;
      private bool[] P00713_A44TicketDisenio ;
      private bool[] P00713_n44TicketDisenio ;
      private bool[] P00713_A51TicketIngenieria ;
      private bool[] P00713_n51TicketIngenieria ;
      private bool[] P00713_A43TicketDiscoDuroExterno ;
      private bool[] P00713_n43TicketDiscoDuroExterno ;
      private bool[] P00713_A58TicketPerifericos ;
      private bool[] P00713_n58TicketPerifericos ;
      private bool[] P00713_A87TicketUps ;
      private bool[] P00713_n87TicketUps ;
      private bool[] P00713_A41TicketApoyoUsuario ;
      private bool[] P00713_n41TicketApoyoUsuario ;
      private bool[] P00713_A52TicketInstalarDataShow ;
      private bool[] P00713_n52TicketInstalarDataShow ;
      private bool[] P00713_A57TicketOtros ;
      private bool[] P00713_n57TicketOtros ;
      private string aP11_OutFile ;
   ...
   public class exportetapasdesarrolloticketwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV8EtapaDesarrolloId )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(10), CAST(T1.[TicketId] AS decimal(10,0))) like '%' + @lV9K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T1.[UsuarioId] AS decimal(10,0))) like '%' + @lV9K2BToolsGenericSearchField + '%' or T3.[UsuarioNombre] like '%' + @lV9K2BToolsGenericSearchField + '%' or T3.[UsuarioRequerimiento] like '%' + @lV9K2BToolsGenericSearchField + '%' or T3.[UsuarioGerencia] like '%' + @lV9K2BToolsGenericSearchField + '%' or T3.[UsuarioDepartamento] like '%' + @lV9K2BToolsGenericSearchField + '%' or CONVERT( char(4), CAST(T1.[EstadoTicketTicketId] AS decimal(4,0))) like '%' + @lV9K2BToolsGenericSearchField + '%' or T2.[EstadoTicketNombre] like '%' + @lV9K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T1.[TicketLastId] AS decimal(10,0))) like '%' + @lV9K2BToolsGenericSearchField + '%' or T1.[TicketHoraCaracter] like '%' + @lV9K2BToolsGenericSearchField + '%' or T1.[TicketUsuarioAsigno] like '%' + @lV9K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int2[10] = 1;
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             ...
             case 1 :
                ...
                ((bool[]) buf[34])[0] = rslt.getBool(24);
                ((bool[]) buf[35])[0] = rslt.wasNull(24);
                ((bool[]) buf[36])[0] = rslt.getBool(25);
                ((bool[]) buf[37])[0] = rslt.wasNull(25);
                ((bool[]) buf[38])[0] = rslt.getBool(26);
                ((bool[]) buf[39])[0] = rslt.wasNull(26);
                ((bool[]) buf[40])[0] = rslt.getBool(27);
                ((bool[]) buf[41])[0] = rslt.wasNull(27);
                ((bool[]) buf[42])[0] = rslt.getBool(28);
                ((bool[]) buf[43])[0] = rslt.wasNull(28);
                ((bool[]) buf[44])[0] = rslt.getBool(29);
                ((bool[]) buf[45])[0] = rslt.wasNull(29);
                ((bool[]) buf[46])[0] = rslt.getBool(30);
                ((bool[]) buf[47])[0] = rslt.wasNull(30);
                ((bool[]) buf[48])[0] = rslt.getBool(31);
                ((bool[]) buf[49])[0] = rslt.wasNull(31);
                ((bool[]) buf[50])[0] = rslt.getBool(32);
