...
namespace GeneXus.Programs {
   public class usuario : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITTRN( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
            {
               ...
               AV7UsuarioId = (long)(NumberUtil.Val( GetPar( "UsuarioId"), "."));
               AssignAttri(sPrefix, false, "AV7UsuarioId", StringUtil.LTrimStr( (decimal)(AV7UsuarioId), 10, 0));
               setjustcreated();
               componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)Gx_mode,(long)AV7UsuarioId});
               componentstart();
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtUsuarioTelefono_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A95UsuarioTelefono), 9, 0, ".", "")), StringUtil.LTrim( ((edtUsuarioTelefono_Enabled!=0) ? context.localUtil.Format( (decimal)(A95UsuarioTelefono), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(A95UsuarioTelefono), "ZZZZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,64);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtUsuarioTelefono_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtUsuarioTelefono_Enabled, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 1, -1, 0, true, "Telefono", "right", false, "", "HLP_Usuario.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtEstadoTicketUsuarioId_Internalname, "Id", "gx-form-item Attribute_TrnLabel", 1, true, "width: 100%;");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 100, "%", 0, "px", "gx-form-item gx-attribute", "left", "top", "", "", "div");
         /* Single line edit */
         AssignAttri(sPrefix, false, "A189EstadoTicketUsuarioId", StringUtil.LTrimStr( (decimal)(A189EstadoTicketUsuarioId), 4, 0));
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 102,'" + sPrefix + "',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtEstadoTicketUsuarioId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A189EstadoTicketUsuarioId), 4, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A189EstadoTicketUsuarioId), "ZZZ9")), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,102);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtEstadoTicketUsuarioId_Jsonclick, 0, "Attribute_Trn", "", "", "", "", 1, edtEstadoTicketUsuarioId_Enabled, 1, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "NumMin", "right", false, "", "HLP_Usuario.htm");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( ( ( ( StringUtil.Len( sPrefix) == 0 ) ) || ( StringUtil.StringSearch( sXEvt, sPrefix, 1) > 0 ) ) && ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
            {
               ...
               Z375UsuarioFechaSistema = context.localUtil.CToT( cgiGet( sPrefix+"Z375UsuarioFechaSistema"), 0);
               n375UsuarioFechaSistema = ((DateTime.MinValue==A375UsuarioFechaSistema) ? true : false);
               Z189EstadoTicketUsuarioId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"Z189EstadoTicketUsuarioId"), ".", ","));
               wcpOGx_mode = cgiGet( sPrefix+"wcpOGx_mode");
               wcpOAV7UsuarioId = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV7UsuarioId"), ".", ","));
               ...
               n286UsuarioFechaHora = ((DateTime.MinValue==A286UsuarioFechaHora) ? true : false);
               A375UsuarioFechaSistema = context.localUtil.CToT( cgiGet( sPrefix+"Z375UsuarioFechaSistema"), 0);
               ...
               AV7UsuarioId = (long)(context.localUtil.CToN( cgiGet( sPrefix+"vUSUARIOID"), ".", ","));
               ...
               n286UsuarioFechaHora = ((DateTime.MinValue==A286UsuarioFechaHora) ? true : false);
               A375UsuarioFechaSistema = context.localUtil.CToT( cgiGet( sPrefix+"USUARIOFECHASISTEMA"), 0);
               n375UsuarioFechaSistema = ((DateTime.MinValue==A375UsuarioFechaSistema) ? true : false);
               ...
               forbiddenHiddens.Add("UsuarioFechaSistema", context.localUtil.Format( A375UsuarioFechaSistema, "99/99/9999 99:99:99"));
      ...
      protected void E12092( )
      {
         ...
         if ( AV8TrnContext.gxTpr_Savepk || ( StringUtil.StrCmp(AV8TrnContext.gxTpr_Returnmode, "Modal") == 0 ) )
         {
            ...
            AV22AttributeValueItem.gxTpr_Attributevalue = StringUtil.Str( (decimal)(A15UsuarioId), 10, 0);
      ...
      protected void S112( )
      {
         ...
         if ( AV10Navigation.gxTpr_Aftertrn == 2 )
         {
            ...
            else
            {
               ...
               {
                  try {
                     args = new Object[] {(string)"_site_encryption",AV8TrnContext.gxTpr_Entitymanagernexttaskmode,(long)A15UsuarioId,AV8TrnContext.gxTpr_Entitymanagernexttaskcode} ;
                     ...
                     if ( AV11DinamicObjToLink .Trim().Length < 6 || AV11DinamicObjToLink .Substring( AV11DinamicObjToLink .Trim().Length - 5, 5) != ".aspx")
                     {
                        ...
                        GXEncryptionTmp = StringUtil.Trim( StringUtil.Lower( AV11DinamicObjToLink))+".aspx"+UrlEncode(StringUtil.RTrim(AV8TrnContext.gxTpr_Entitymanagernexttaskmode)) + "," + UrlEncode(StringUtil.LTrimStr(A15UsuarioId,10,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TrnContext.gxTpr_Entitymanagernexttaskcode));
                     ...
                     {
                        GXKey = Crypto.GetSiteKey( );
                        GXEncryptionTmp = StringUtil.Trim( StringUtil.Lower( AV11DinamicObjToLink))+UrlEncode(StringUtil.RTrim(AV8TrnContext.gxTpr_Entitymanagernexttaskmode)) + "," + UrlEncode(StringUtil.LTrimStr(A15UsuarioId,10,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TrnContext.gxTpr_Entitymanagernexttaskcode));
               ...
               else
               {
                  ...
                  {
                     try {
                        args = new Object[] {(string)"_session_encryption",AV8TrnContext.gxTpr_Entitymanagernexttaskmode,(long)A15UsuarioId,AV8TrnContext.gxTpr_Entitymanagernexttaskcode} ;
                        ClassLoader.WebExecute(AV11DinamicObjToLink,"GeneXus.Programs",AV11DinamicObjToLink.ToLower().Trim(), new Object[] {context }, "execute", args);
                        if ( ( args != null ) && ( args.Length == 4 ) )
                        {
                           AV8TrnContext.gxTpr_Entitymanagernexttaskmode = (string)(args[1]) ;
                  ...
                  {
                     try {
                        args = new Object[] {AV8TrnContext.gxTpr_Entitymanagernexttaskmode,(long)A15UsuarioId,AV8TrnContext.gxTpr_Entitymanagernexttaskcode} ;
                        ClassLoader.WebExecute(AV11DinamicObjToLink,"GeneXus.Programs",AV11DinamicObjToLink.ToLower().Trim(), new Object[] {context }, "execute", args);
                        if ( ( args != null ) && ( args.Length == 3 ) )
                        {
                           AV8TrnContext.gxTpr_Entitymanagernexttaskmode = (string)(args[0]) ;
                           A15UsuarioId = (long)(args[1]) ;
                        ...
                        if ( AV11DinamicObjToLink .Trim().Length < 6 || AV11DinamicObjToLink .Substring( AV11DinamicObjToLink .Trim().Length - 5, 5) != ".aspx")
                        {
                           context.wjLoc = formatLink(AV11DinamicObjToLink+".aspx", new object[] {UrlEncode(StringUtil.RTrim(AV8TrnContext.gxTpr_Entitymanagernexttaskmode)),UrlEncode(StringUtil.LTrimStr(A15UsuarioId,10,0)),UrlEncode(StringUtil.RTrim(AV8TrnContext.gxTpr_Entitymanagernexttaskcode))}, new string[] {}) ;
                        }
                        else
                        {
                           context.wjLoc = formatLink(AV11DinamicObjToLink, new object[] {UrlEncode(StringUtil.RTrim(AV8TrnContext.gxTpr_Entitymanagernexttaskmode)),UrlEncode(StringUtil.LTrimStr(A15UsuarioId,10,0)),UrlEncode(StringUtil.RTrim(AV8TrnContext.gxTpr_Entitymanagernexttaskcode))}, new string[] {}) ;
                        }
                     }
                  }
               }
         ...
         else
         {
            if ( AV10Navigation.gxTpr_Aftertrn == 3 )
            {
               ...
               {
                  try {
                     args = new Object[] {(string)"_site_encryption",AV10Navigation.gxTpr_Mode,(long)A15UsuarioId,AV10Navigation.gxTpr_Extraparameter} ;
                     ClassLoader.WebExecute(AV11DinamicObjToLink,"GeneXus.Programs",AV11DinamicObjToLink.ToLower().Trim(), new Object[] {context }, "execute", args);
                     if ( ( args != null ) && ( args.Length == 4 ) )
                     {
                     ...
                     {
                        GXKey = Crypto.GetSiteKey( );
                        GXEncryptionTmp = StringUtil.Trim( StringUtil.Lower( AV11DinamicObjToLink))+".aspx"+UrlEncode(StringUtil.RTrim(AV10Navigation.gxTpr_Mode)) + "," + UrlEncode(StringUtil.LTrimStr(A15UsuarioId,10,0)) + "," + UrlEncode(StringUtil.RTrim(AV10Navigation.gxTpr_Extraparameter));
                        context.wjLoc = StringUtil.Trim( StringUtil.Lower( AV11DinamicObjToLink))+".aspx"+ "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
                     }
                     else
                     {
                        GXKey = Crypto.GetSiteKey( );
                        GXEncryptionTmp = StringUtil.Trim( StringUtil.Lower( AV11DinamicObjToLink))+UrlEncode(StringUtil.RTrim(AV10Navigation.gxTpr_Mode)) + "," + UrlEncode(StringUtil.LTrimStr(A15UsuarioId,10,0)) + "," + UrlEncode(StringUtil.RTrim(AV10Navigation.gxTpr_Extraparameter));
                        context.wjLoc = StringUtil.Trim( StringUtil.Lower( AV11DinamicObjToLink))+ "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
                     }
                  }
               }
               else
               {
                  ...
                  {
                     try {
                        args = new Object[] {(string)"_session_encryption",AV10Navigation.gxTpr_Mode,(long)A15UsuarioId,AV10Navigation.gxTpr_Extraparameter} ;
                        ClassLoader.WebExecute(AV11DinamicObjToLink,"GeneXus.Programs",AV11DinamicObjToLink.ToLower().Trim(), new Object[] {context }, "execute", args);
                        if ( ( args != null ) && ( args.Length == 4 ) )
                        {
                           AV10Navigation.gxTpr_Mode = (string)(args[1]) ;
                  ...
                  {
                     try {
                        args = new Object[] {AV10Navigation.gxTpr_Mode,(long)A15UsuarioId,AV10Navigation.gxTpr_Extraparameter} ;
                        ClassLoader.WebExecute(AV11DinamicObjToLink,"GeneXus.Programs",AV11DinamicObjToLink.ToLower().Trim(), new Object[] {context }, "execute", args);
                        if ( ( args != null ) && ( args.Length == 3 ) )
                        {
                        ...
                        if ( AV11DinamicObjToLink .Trim().Length < 6 || AV11DinamicObjToLink .Substring( AV11DinamicObjToLink .Trim().Length - 5, 5) != ".aspx")
                        {
                           context.wjLoc = formatLink(AV11DinamicObjToLink+".aspx", new object[] {UrlEncode(StringUtil.RTrim(AV10Navigation.gxTpr_Mode)),UrlEncode(StringUtil.LTrimStr(A15UsuarioId,10,0)),UrlEncode(StringUtil.RTrim(AV10Navigation.gxTpr_Extraparameter))}, new string[] {}) ;
                        }
                        else
                        {
                           context.wjLoc = formatLink(AV11DinamicObjToLink, new object[] {UrlEncode(StringUtil.RTrim(AV10Navigation.gxTpr_Mode)),UrlEncode(StringUtil.LTrimStr(A15UsuarioId,10,0)),UrlEncode(StringUtil.RTrim(AV10Navigation.gxTpr_Extraparameter))}, new string[] {}) ;
                        }
                     }
                  }
               }
      ...
      protected void ZM0910( short GX_JID )
      {
         if ( ( GX_JID == 15 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               ...
               Z375UsuarioFechaSistema = T00093_A375UsuarioFechaSistema[0];
            ...
            else
            {
               ...
               Z375UsuarioFechaSistema = A375UsuarioFechaSistema;
      ...
      protected void Load0910( )
      {
         ...
         if ( (pr_default.getStatus(3) != 101) )
         {
            ...
            A375UsuarioFechaSistema = T00095_A375UsuarioFechaSistema[0];
            n375UsuarioFechaSistema = T00095_n375UsuarioFechaSistema[0];
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            A375UsuarioFechaSistema = T00093_A375UsuarioFechaSistema[0];
            n375UsuarioFechaSistema = T00093_n375UsuarioFechaSistema[0];
      ...
      protected void CheckOptimisticConcurrency0910( )
      {
         if ( ! IsIns( ) )
         {
            ...
            Gx_longc = false;
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z93UsuarioNombre, T00092_A93UsuarioNombre[0]) != 0 ) || ( DateTimeUtil.ResetTime ( Z90UsuarioFecha ) != DateTimeUtil.ResetTime ( T00092_A90UsuarioFecha[0] ) ) || ( Z92UsuarioHora != T00092_A92UsuarioHora[0] ) || ( StringUtil.StrCmp(Z91UsuarioGerencia, T00092_A91UsuarioGerencia[0]) != 0 ) || ( StringUtil.StrCmp(Z88UsuarioDepartamento, T00092_A88UsuarioDepartamento[0]) != 0 ) )
            {
               Gx_longc = true;
            }
            ...
            if ( Gx_longc || ( Z375UsuarioFechaSistema != T00092_A375UsuarioFechaSistema[0] ) || ( Z189EstadoTicketUsuarioId != T00092_A189EstadoTicketUsuarioId[0] ) )
            {
               ...
               if ( DateTimeUtil.ResetTime ( Z90UsuarioFecha ) != DateTimeUtil.ResetTime ( T00092_A90UsuarioFecha[0] ) )
               {
               ...
               if ( Z375UsuarioFechaSistema != T00092_A375UsuarioFechaSistema[0] )
               {
                  GXUtil.WriteLog("usuario:[seudo value changed for attri]"+"UsuarioFechaSistema");
                  GXUtil.WriteLogRaw("Old: ",Z375UsuarioFechaSistema);
                  GXUtil.WriteLogRaw("Current: ",T00092_A375UsuarioFechaSistema[0]);
               }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(8, new Object[] {A15UsuarioId, A93UsuarioNombre, A90UsuarioFecha, A92UsuarioHora, A91UsuarioGerencia, A88UsuarioDepartamento, A94UsuarioRequerimiento, A89UsuarioEmail, A95UsuarioTelefono, A191UsuarioSistema, n286UsuarioFechaHora, A286UsuarioFechaHora, n375UsuarioFechaSistema, A375UsuarioFechaSistema, A189EstadoTicketUsuarioId});
                     pr_default.close(8);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(9, new Object[] {A93UsuarioNombre, A90UsuarioFecha, A92UsuarioHora, A91UsuarioGerencia, A88UsuarioDepartamento, A94UsuarioRequerimiento, A89UsuarioEmail, A95UsuarioTelefono, A191UsuarioSistema, n286UsuarioFechaHora, A286UsuarioFechaHora, n375UsuarioFechaSistema, A375UsuarioFechaSistema, A189EstadoTicketUsuarioId, A15UsuarioId});
                     pr_default.close(9);
                     dsDefault.SmartCacheProvider.SetUpdated("Usuario");
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188324631", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"Z375UsuarioFechaSistema", context.localUtil.TToC( Z375UsuarioFechaSistema, 10, 8, 0, 0, "/", ":", " "));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV7UsuarioId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV7UsuarioId), 10, 0, ".", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vUSUARIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7UsuarioId), 10, 0, ".", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"USUARIOFECHASISTEMA", context.localUtil.TToC( A375UsuarioFechaSistema, 10, 8, 0, 0, "/", ":", " "));
      ...
      protected void InitializeNonKey0910( )
      {
         ...
         n375UsuarioFechaSistema = false;
         AssignAttri(sPrefix, false, "A375UsuarioFechaSistema", context.localUtil.TToC( A375UsuarioFechaSistema, 10, 8, 0, 3, "/", ":", " "));
         A189EstadoTicketUsuarioId = 1;
         AssignAttri(sPrefix, false, "A189EstadoTicketUsuarioId", StringUtil.LTrimStr( (decimal)(A189EstadoTicketUsuarioId), 4, 0));
         A90UsuarioFecha = DateTimeUtil.Today( context);
         AssignAttri(sPrefix, false, "A90UsuarioFecha", context.localUtil.Format(A90UsuarioFecha, "99/99/9999"));
         ...
         Z375UsuarioFechaSistema = (DateTime)(DateTime.MinValue);
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "Gx_mode", Gx_mode);
            AV7UsuarioId = Convert.ToInt64(getParm(obj,3));
            AssignAttri(sPrefix, false, "AV7UsuarioId", StringUtil.LTrimStr( (decimal)(AV7UsuarioId), 10, 0));
         }
         wcpOGx_mode = cgiGet( sPrefix+"wcpOGx_mode");
         wcpOAV7UsuarioId = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV7UsuarioId"), ".", ","));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV7UsuarioId = (long)(context.localUtil.CToN( cgiGet( sCtrlAV7UsuarioId), ".", ","));
            AssignAttri(sPrefix, false, "AV7UsuarioId", StringUtil.LTrimStr( (decimal)(AV7UsuarioId), 10, 0));
         }
         else
         {
            AV7UsuarioId = (long)(context.localUtil.CToN( cgiGet( sPrefix+"AV7UsuarioId_PARM"), ".", ","));
         }
      }
      ...
      protected void WCParametersSet( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"AV7UsuarioId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7UsuarioId), 10, 0, ".", "")));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188324656", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("usuario.js", "?2024188324656", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      {
         setEventMetadata("ENTER","{handler:'componentprocess',iparms:[{postForm:true},{sPrefix:true},{sSFPrefix:true},{sCompEvt:true},{av:'Gx_mode',fld:'vMODE',pic:'@!'},{av:'AV7UsuarioId',fld:'vUSUARIOID',pic:'ZZZZZZZZZ9'}]");
         setEventMetadata("ENTER",",oparms:[]}");
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV8TrnContext',fld:'vTRNCONTEXT',pic:'',hsh:true},{av:'AV21AttributeValue',fld:'vATTRIBUTEVALUE',pic:'',hsh:true},{av:'AV10Navigation',fld:'vNAVIGATION',pic:'',hsh:true},{av:'Gx_mode',fld:'vMODE',pic:'@!'},{av:'A286UsuarioFechaHora',fld:'USUARIOFECHAHORA',pic:'99/99/9999 99:99:99'},{av:'A375UsuarioFechaSistema',fld:'USUARIOFECHASISTEMA',pic:'99/99/9999 99:99:99'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("AFTER TRN","{handler:'E12092',iparms:[{av:'AV8TrnContext',fld:'vTRNCONTEXT',pic:'',hsh:true},{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZZZZZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'},{av:'A93UsuarioNombre',fld:'USUARIONOMBRE',pic:''},{av:'AV21AttributeValue',fld:'vATTRIBUTEVALUE',pic:'',hsh:true},{av:'AV10Navigation',fld:'vNAVIGATION',pic:'',hsh:true}]");
         setEventMetadata("AFTER TRN",",oparms:[{av:'AV21AttributeValue',fld:'vATTRIBUTEVALUE',pic:'',hsh:true},{av:'AV10Navigation',fld:'vNAVIGATION',pic:'',hsh:true},{av:'AV8TrnContext',fld:'vTRNCONTEXT',pic:'',hsh:true},{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZZZZZZZ9'}]}");
      ...
      public override void initialize( )
      {
         ...
         T00095_A15UsuarioId = new long[1] ;
         ...
         T00095_A375UsuarioFechaSistema = new DateTime[] {DateTime.MinValue} ;
         T00095_n375UsuarioFechaSistema = new bool[] {false} ;
         T00095_A189EstadoTicketUsuarioId = new short[1] ;
         T00096_A190EstadoTicketUsuarioNombre = new string[] {""} ;
         T00097_A15UsuarioId = new long[1] ;
         T00093_A15UsuarioId = new long[1] ;
         ...
         T00093_A375UsuarioFechaSistema = new DateTime[] {DateTime.MinValue} ;
         T00093_n375UsuarioFechaSistema = new bool[] {false} ;
         T00093_A189EstadoTicketUsuarioId = new short[1] ;
         T00098_A15UsuarioId = new long[1] ;
         T00099_A15UsuarioId = new long[1] ;
         T00092_A15UsuarioId = new long[1] ;
         ...
         T00092_A375UsuarioFechaSistema = new DateTime[] {DateTime.MinValue} ;
         T00092_n375UsuarioFechaSistema = new bool[] {false} ;
         ...
         T000915_A15UsuarioId = new long[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.usuario__default(),
            new Object[][] {
               ...
               T00092_A286UsuarioFechaHora, T00092_n286UsuarioFechaHora, T00092_A375UsuarioFechaSistema, T00092_n375UsuarioFechaSistema, T00092_A189EstadoTicketUsuarioId
               }
               , new Object[] {
               ...
               T00093_A286UsuarioFechaHora, T00093_n286UsuarioFechaHora, T00093_A375UsuarioFechaSistema, T00093_n375UsuarioFechaSistema, T00093_A189EstadoTicketUsuarioId
               }
               , new Object[] {
               ...
               T00095_A191UsuarioSistema, T00095_A286UsuarioFechaHora, T00095_n286UsuarioFechaHora, T00095_A375UsuarioFechaSistema, T00095_n375UsuarioFechaSistema, T00095_A189EstadoTicketUsuarioId
               }
               , new Object[] {
      ...
      private DateTime Z375UsuarioFechaSistema ;
      ...
      private long[] T00095_A15UsuarioId ;
      ...
      private DateTime[] T00095_A375UsuarioFechaSistema ;
      private bool[] T00095_n375UsuarioFechaSistema ;
      private short[] T00095_A189EstadoTicketUsuarioId ;
      private string[] T00096_A190EstadoTicketUsuarioNombre ;
      private long[] T00097_A15UsuarioId ;
      private long[] T00093_A15UsuarioId ;
      ...
      private DateTime[] T00093_A375UsuarioFechaSistema ;
      private bool[] T00093_n375UsuarioFechaSistema ;
      private short[] T00093_A189EstadoTicketUsuarioId ;
      private long[] T00098_A15UsuarioId ;
      private long[] T00099_A15UsuarioId ;
      private long[] T00092_A15UsuarioId ;
      ...
      private DateTime[] T00092_A375UsuarioFechaSistema ;
      private bool[] T00092_n375UsuarioFechaSistema ;
      ...
      private long[] T000915_A15UsuarioId ;
...
public class usuario__default : DataStoreHelperBase, IDataStoreHelper
{
 ...
 private void cursorDefinitions( )
 {
    if ( def == null )
    {
       ...
       def= new CursorDef[] {
           new CursorDef("T00092", "SELECT [UsuarioId], [UsuarioNombre], [UsuarioFecha], [UsuarioHora], [UsuarioGerencia], [UsuarioDepartamento], [UsuarioRequerimiento], [UsuarioEmail], [UsuarioTelefono], [UsuarioSistema], [UsuarioFechaHora], [UsuarioFechaSistema], [EstadoTicketUsuarioId] AS EstadoTicketUsuarioId FROM [Usuario] WITH (UPDLOCK) WHERE [UsuarioId] = @UsuarioId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00092,1, GxCacheFrequency.OFF ,true,false )
          ,new CursorDef("T00093", "SELECT [UsuarioId], [UsuarioNombre], [UsuarioFecha], [UsuarioHora], [UsuarioGerencia], [UsuarioDepartamento], [UsuarioRequerimiento], [UsuarioEmail], [UsuarioTelefono], [UsuarioSistema], [UsuarioFechaHora], [UsuarioFechaSistema], [EstadoTicketUsuarioId] AS EstadoTicketUsuarioId FROM [Usuario] WHERE [UsuarioId] = @UsuarioId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00093,1, GxCacheFrequency.OFF ,true,false )
          ...
          ,new CursorDef("T000910", "INSERT INTO [Usuario]([UsuarioId], [UsuarioNombre], [UsuarioFecha], [UsuarioHora], [UsuarioGerencia], [UsuarioDepartamento], [UsuarioRequerimiento], [UsuarioEmail], [UsuarioTelefono], [UsuarioSistema], [UsuarioFechaHora], [UsuarioFechaSistema], [EstadoTicketUsuarioId]) VALUES(@UsuarioId, @UsuarioNombre, @UsuarioFecha, @UsuarioHora, @UsuarioGerencia, @UsuarioDepartamento, @UsuarioRequerimiento, @UsuarioEmail, @UsuarioTelefono, @UsuarioSistema, @UsuarioFechaHora, @UsuarioFechaSistema, @EstadoTicketUsuarioId)", GxErrorMask.GX_NOMASK,prmT000910)
          ,new CursorDef("T000911", "UPDATE [Usuario] SET [UsuarioNombre]=@UsuarioNombre, [UsuarioFecha]=@UsuarioFecha, [UsuarioHora]=@UsuarioHora, [UsuarioGerencia]=@UsuarioGerencia, [UsuarioDepartamento]=@UsuarioDepartamento, [UsuarioRequerimiento]=@UsuarioRequerimiento, [UsuarioEmail]=@UsuarioEmail, [UsuarioTelefono]=@UsuarioTelefono, [UsuarioSistema]=@UsuarioSistema, [UsuarioFechaHora]=@UsuarioFechaHora, [UsuarioFechaSistema]=@UsuarioFechaSistema, [EstadoTicketUsuarioId]=@EstadoTicketUsuarioId  WHERE [UsuarioId] = @UsuarioId", GxErrorMask.GX_NOMASK,prmT000911)
