...
namespace GeneXus.Programs {
   public class k2blistprograms : GXProcedure
   {
      ...
      {
         this.AV8ProgramNames = new GXBaseCollection<SdtK2BProgramNames_ProgramName>( context, "ProgramName", "kb_ticket") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBaseCollection<SdtK2BProgramNames_ProgramName> aP0_ProgramNames )
      {
         ...
         objk2blistprograms.AV8ProgramNames = new GXBaseCollection<SdtK2BProgramNames_ProgramName>( context, "ProgramName", "kb_ticket") ;
      ...
      {
         AV8ProgramNames = new GXBaseCollection<SdtK2BProgramNames_ProgramName>( context, "ProgramName", "kb_ticket");
         /* GeneXus formulas. */
         context.Gx_err = 0;
      }
