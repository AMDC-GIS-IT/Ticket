...
namespace GeneXus.Programs {
   public class usuariogeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)Gx_mode,(long)AV6UsuarioId,(string)AV8TabCode});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188321579", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void E122K2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Transactioncomponent_Component) != 0 )
         {
            ...
            WebComp_Transactioncomponent.componentprepare(new Object[] {(string)sPrefix+"W0029",(string)"",(string)Gx_mode,(long)AV6UsuarioId});
      ...
      protected void E132K2( )
      {
         ...
         CallWebObject(formatLink("entitymanagerusuario.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(AV6UsuarioId,10,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","UsuarioId","TabCode"}) );
      ...
      protected void E142K2( )
      {
         ...
         AV10TrnContext.gxTpr_Returnmode = "Popup";
         new k2bsettrncontextbyname(context ).execute(  "Usuario",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerusuario.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(AV6UsuarioId,10,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","UsuarioId","TabCode"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "Gx_mode", Gx_mode);
            AV6UsuarioId = Convert.ToInt64(getParm(obj,3));
            AssignAttri(sPrefix, false, "AV6UsuarioId", StringUtil.LTrimStr( (decimal)(AV6UsuarioId), 10, 0));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188321614", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("usuariogeneral.js", "?2024188321614", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZZZZZZZ9'},{av:'AV6UsuarioId',fld:'vUSUARIOID',pic:'ZZZZZZZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E132K2',iparms:[{av:'AV6UsuarioId',fld:'vUSUARIOID',pic:'ZZZZZZZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E142K2',iparms:[{av:'AV6UsuarioId',fld:'vUSUARIOID',pic:'ZZZZZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV12ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         scmdbuf = "";
         H002K2_A15UsuarioId = new long[1] ;
      ...
      private long[] H002K2_A15UsuarioId ;
