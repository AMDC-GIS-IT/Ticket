...
namespace GeneXus.Programs {
   public class exportwwusuario : GXProcedure
   {
                           ...
                           out string aP6_OutFile )
      {
         ...
         initialize();
         executePrivate();
         aP6_OutFile=this.AV45OutFile;
      }

      public string executeUdp( string aP0_UsuarioNombre ,
                                DateTime aP1_UsuarioFecha_From ,
                                DateTime aP2_UsuarioFecha_To ,
                                long aP3_UsuarioId ,
                                string aP4_K2BToolsGenericSearchField ,
                                short aP5_OrderedBy )
      {
         execute(aP0_UsuarioNombre, aP1_UsuarioFecha_From, aP2_UsuarioFecha_To, aP3_UsuarioId, aP4_K2BToolsGenericSearchField, aP5_OrderedBy, out aP6_OutFile);
         return AV45OutFile ;
      }
                                 ...
                                 out string aP6_OutFile )
      {
         ...
         objexportwwusuario.AV45OutFile = "" ;
      ...
      void executePrivate( )
      {
         ...
         AV45OutFile = GxDirectory.TemporaryFilesPath + AV29File.Separator + "ExportWWUsuario-" + Guid.NewGuid( ).ToString() + ".xlsx";
         AV21ExcelDocument.Open(AV45OutFile);
      ...
      public override void initialize( )
      {
         ...
         P003I2_A15UsuarioId = new long[1] ;
      ...
      private long[] P003I2_A15UsuarioId ;
   ...
   public class exportwwusuario__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV20OrderedBy )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV12K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(10), CAST([UsuarioId] AS decimal(10,0))) like '%' + @lV12K2BToolsGenericSearchField + '%' or [UsuarioNombre] like '%' + @lV12K2BToolsGenericSearchField + '%' or [UsuarioGerencia] like '%' + @lV12K2BToolsGenericSearchField + '%' or [UsuarioDepartamento] like '%' + @lV12K2BToolsGenericSearchField + '%' or [UsuarioRequerimiento] like '%' + @lV12K2BToolsGenericSearchField + '%' or [UsuarioEmail] like '%' + @lV12K2BToolsGenericSearchField + '%' or CONVERT( char(9), CAST([UsuarioTelefono] AS decimal(9,0))) like '%' + @lV12K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int2[4] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P003I2(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (long)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (DateTime)dynConstraints[6] , (long)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (int)dynConstraints[12] , (short)dynConstraints[13] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV42UsuarioId",GXType.Decimal,10,0) ,
