...
namespace GeneXus.Programs {
   public class promptlistarequerimientos : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public promptlistarequerimientos( )
      {
      ...
      public promptlistarequerimientos( IGxContext context )
      {
      ...
      public void execute( out short aP0_pListaRequerimientosId )
      {
         this.AV17pListaRequerimientosId = 0 ;
         executePrivate();
         aP0_pListaRequerimientosId=this.AV17pListaRequerimientosId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "pListaRequerimientosId");
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV18ListaRequerimientosDescripcion = GetPar( "ListaRequerimientosDescripcion");
               AV19AreasAtencionDescripcion = GetPar( "AreasAtencionDescripcion");
               ...
               AV17pListaRequerimientosId = (short)(NumberUtil.Val( GetPar( "pListaRequerimientosId"), "."));
               ...
               gxgrGrid_refresh( subGrid_Rows, AV24K2BToolsGenericSearchField, AV18ListaRequerimientosDescripcion, AV19AreasAtencionDescripcion, AV15ClassCollection, AV25OrderedBy, AV35Pgmname, AV5CurrentPage, AV7GridConfiguration, AV17pListaRequerimientosId, AV8FreezeColumnTitles) ;
            ...
            {
               AV17pListaRequerimientosId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV17pListaRequerimientosId", StringUtil.LTrimStr( (decimal)(AV17pListaRequerimientosId), 4, 0));
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188433515", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("promptlistarequerimientos.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV17pListaRequerimientosId,4,0))}, new string[] {"pListaRequerimientosId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vLISTAREQUERIMIENTOSDESCRIPCION", AV18ListaRequerimientosDescripcion);
         GxWebStd.gx_hidden_field( context, "GXH_vAREASATENCIONDESCRIPCION", AV19AreasAtencionDescripcion);
         /* Send saved values. */
         send_integrity_footer_hashes( ) ;
         GxWebStd.gx_hidden_field( context, "nRC_GXsfl_93", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_93), 8, 0, ".", "")));
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vFILTERTAGS", AV22FilterTags);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vFILTERTAGS", AV22FilterTags);
         }
         GxWebStd.gx_hidden_field( context, "vDELETEDTAG", StringUtil.RTrim( AV23DeletedTag));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, "vPLISTAREQUERIMIENTOSID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV17pListaRequerimientosId), 4, 0, ".", "")));
      ...
      {
         return formatLink("promptlistarequerimientos.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV17pListaRequerimientosId,4,0))}, new string[] {"pListaRequerimientosId"})  ;
      }

      public override string GetPgmname( )
      {
         return "PromptListaRequerimientos" ;
      }
      ...
      protected void WB8F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavK2btoolsgenericsearchfield_Internalname, StringUtil.RTrim( AV24K2BToolsGenericSearchField), StringUtil.RTrim( context.localUtil.Format( AV24K2BToolsGenericSearchField, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,25);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Buscar...", edtavK2btoolsgenericsearchfield_Jsonclick, 0, "K2BTools_SearchCriteria", "", "", "", "", 1, edtavK2btoolsgenericsearchfield_Enabled, 0, "text", "", 40, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_PromptListaRequerimientos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, imgFiltertoggle_combined_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 5, imgFiltertoggle_combined_Jsonclick, "'"+""+"'"+",false,"+"'"+"EFILTERTOGGLE_COMBINED.CLICK."+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_PromptListaRequerimientos.htm");
            /* User Defined Control */
            ucFiltersummarytagsuc.SetProperty("TagValues", AV22FilterTags);
            ucFiltersummarytagsuc.SetProperty("DeletedTag", AV23DeletedTag);
            ...
            GxWebStd.gx_single_line_edit( context, edtavListarequerimientosdescripcion_Internalname, AV18ListaRequerimientosDescripcion, StringUtil.RTrim( context.localUtil.Format( AV18ListaRequerimientosDescripcion, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,41);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavListarequerimientosdescripcion_Jsonclick, 0, "Attribute_Filter", "", "", "", "", 1, edtavListarequerimientosdescripcion_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_PromptListaRequerimientos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavAreasatenciondescripcion_Internalname, AV19AreasAtencionDescripcion, StringUtil.RTrim( context.localUtil.Format( AV19AreasAtencionDescripcion, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,47);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavAreasatenciondescripcion_Jsonclick, 0, "Attribute_Filter", "", "", "", "", 1, edtavAreasatenciondescripcion_Enabled, 0, "text", "", 30, "chr", 1, "row", 30, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_PromptListaRequerimientos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;", "div");
            wb_table1_49_8F2( true) ;
         }
         else
         {
            wb_table1_49_8F2( false) ;
         }
         return  ;
      }

      protected void wb_table1_49_8F2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         if ( wbEnd == 93 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_101_8F2( true) ;
         }
         else
         {
            wb_table2_101_8F2( false) ;
         }
         return  ;
      }

      protected void wb_table2_101_8F2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagebuttontextblock_Internalname, "", "", "", lblPreviouspagebuttontextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOPREVIOUS\\'."+"'", "", lblPreviouspagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_PromptListaRequerimientos.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFirstpagetextblock_Internalname, lblFirstpagetextblock_Caption, "", "", lblFirstpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOFIRST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblFirstpagetextblock_Visible, 1, 0, 0, "HLP_PromptListaRequerimientos.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacinglefttextblock_Internalname, "...", "", "", lblSpacinglefttextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacinglefttextblock_Visible, 1, 0, 0, "HLP_PromptListaRequerimientos.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagetextblock_Internalname, lblPreviouspagetextblock_Caption, "", "", lblPreviouspagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOPREVIOUS\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPreviouspagetextblock_Visible, 1, 0, 0, "HLP_PromptListaRequerimientos.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCurrentpagetextblock_Internalname, lblCurrentpagetextblock_Caption, "", "", lblCurrentpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_PromptListaRequerimientos.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagetextblock_Internalname, lblNextpagetextblock_Caption, "", "", lblNextpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DONEXT\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblNextpagetextblock_Visible, 1, 0, 0, "HLP_PromptListaRequerimientos.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacingrighttextblock_Internalname, "...", "", "", lblSpacingrighttextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacingrighttextblock_Visible, 1, 0, 0, "HLP_PromptListaRequerimientos.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLastpagetextblock_Internalname, lblLastpagetextblock_Caption, "", "", lblLastpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOLAST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblLastpagetextblock_Visible, 1, 0, 0, "HLP_PromptListaRequerimientos.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagebuttontextblock_Internalname, "", "", "", lblNextpagebuttontextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DONEXT\\'."+"'", "", lblNextpagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_PromptListaRequerimientos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vLISTAREQUERIMIENTOSDESCRIPCION"), AV18ListaRequerimientosDescripcion) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Areasatenciondescripcion Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vAREASATENCIONDESCRIPCION"), AV19AreasAtencionDescripcion) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       string AV18ListaRequerimientosDescripcion ,
                                       string AV19AreasAtencionDescripcion ,
                                       GxSimpleCollection<string> AV15ClassCollection ,
                                       short AV25OrderedBy ,
                                       string AV35Pgmname ,
                                       int AV5CurrentPage ,
                                       SdtK2BGridConfiguration AV7GridConfiguration ,
                                       short AV17pListaRequerimientosId ,
      ...
      {
         /* GeneXus formulas. */
         AV35Pgmname = "PromptListaRequerimientos";
         context.Gx_err = 0;
      }
      ...
      protected void RF8F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV18ListaRequerimientosDescripcion ,
                                                 AV19AreasAtencionDescripcion ,
            ...
            lV18ListaRequerimientosDescripcion = StringUtil.Concat( StringUtil.RTrim( AV18ListaRequerimientosDescripcion), "%", "");
            lV19AreasAtencionDescripcion = StringUtil.Concat( StringUtil.RTrim( AV19AreasAtencionDescripcion), "%", "");
            lV24K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV24K2BToolsGenericSearchField), 100, "%");
            lV24K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV24K2BToolsGenericSearchField), 100, "%");
            lV24K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV24K2BToolsGenericSearchField), 100, "%");
            lV24K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV24K2BToolsGenericSearchField), 100, "%");
            /* Using cursor H008F2 */
            pr_default.execute(0, new Object[] {lV18ListaRequerimientosDescripcion, lV19AreasAtencionDescripcion, lV24K2BToolsGenericSearchField, lV24K2BToolsGenericSearchField, lV24K2BToolsGenericSearchField, lV24K2BToolsGenericSearchField, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_93_idx = 1;
            sGXsfl_93_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_93_idx), 4, 0), 4, "0");
            SubsflControlProps_932( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A371ListaRequerimientosUsuarioSistema = H008F2_A371ListaRequerimientosUsuarioSistema[0];
               A367AreasAtencionDescripcion = H008F2_A367AreasAtencionDescripcion[0];
               A366AreasAtencionId = H008F2_A366AreasAtencionId[0];
               A370ListaRequerimientosDescripcion = H008F2_A370ListaRequerimientosDescripcion[0];
               A369ListaRequerimientosId = H008F2_A369ListaRequerimientosId[0];
               A367AreasAtencionDescripcion = H008F2_A367AreasAtencionDescripcion[0];
               E248F2 ();
      ...
      protected void send_integrity_lvl_hashes8F2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV35Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV35Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_LISTAREQUERIMIENTOSID"+"_"+sGXsfl_93_idx, GetSecureSignedToken( sGXsfl_93_idx, context.localUtil.Format( (decimal)(A369ListaRequerimientosId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV24K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV24K2BToolsGenericSearchField), 100, "%");
         /* Using cursor H008F3 */
         pr_default.execute(1, new Object[] {lV18ListaRequerimientosDescripcion, lV19AreasAtencionDescripcion, lV24K2BToolsGenericSearchField, lV24K2BToolsGenericSearchField, lV24K2BToolsGenericSearchField, lV24K2BToolsGenericSearchField});
      ...
      protected void STRUP8F0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV18ListaRequerimientosDescripcion = cgiGet( edtavListarequerimientosdescripcion_Internalname);
            AssignAttri("", false, "AV18ListaRequerimientosDescripcion", AV18ListaRequerimientosDescripcion);
            AV19AreasAtencionDescripcion = cgiGet( edtavAreasatenciondescripcion_Internalname);
            AssignAttri("", false, "AV19AreasAtencionDescripcion", AV19AreasAtencionDescripcion);
      ...
      protected void E208F2( )
      {
         ...
         AV31ActivityList = new GXBaseCollection<SdtK2BActivityList_K2BActivityListItem>( context, "K2BActivityListItem", "kb_ticket");
         AV32ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         AV32ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "ListaRequerimientos";
         AV32ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "ListaRequerimientos";
         AV32ActivityListItem.gxTpr_Activity.gxTpr_Standardactivitytype = "List";
         AV32ActivityListItem.gxTpr_Activity.gxTpr_Useractivitytype = "";
         AV32ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV35Pgmname;
         AV31ActivityList.Add(AV32ActivityListItem, 0);
         new k2bisauthorizedactivitylist(context ).execute( ref  AV31ActivityList) ;
         if ( ! ((SdtK2BActivityList_K2BActivityListItem)AV31ActivityList.Item(1)).gxTpr_Isauthorized )
         {
            CallWebObject(formatLink("k2bnotauthorized.aspx", new object[] {UrlEncode(StringUtil.RTrim(((SdtK2BActivityList_K2BActivityListItem)AV31ActivityList.Item(1)).gxTpr_Activity.gxTpr_Entityname)),UrlEncode(StringUtil.RTrim(((SdtK2BActivityList_K2BActivityListItem)AV31ActivityList.Item(1)).gxTpr_Activity.gxTpr_Transactionname)),UrlEncode(StringUtil.RTrim(((SdtK2BActivityList_K2BActivityListItem)AV31ActivityList.Item(1)).gxTpr_Activity.gxTpr_Standardactivitytype)),UrlEncode(StringUtil.RTrim(((SdtK2BActivityList_K2BActivityListItem)AV31ActivityList.Item(1)).gxTpr_Activity.gxTpr_Useractivitytype)),UrlEncode(StringUtil.RTrim(((SdtK2BActivityList_K2BActivityListItem)AV31ActivityList.Item(1)).gxTpr_Activity.gxTpr_Pgmname))}, new string[] {"EntityName","TransactionName","StandardActivityType","UserActivityType","ProgramName"}) );
         ...
         AV19AreasAtencionDescripcion = "";
         AssignAttri("", false, "AV19AreasAtencionDescripcion", AV19AreasAtencionDescripcion);
         new k2bloadrowsperpage(context ).execute(  AV35Pgmname,  "Grid", out  AV10RowsPerPageVariable, out  AV11RowsPerPageLoaded) ;
         ...
         GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
         Form.Caption = StringUtil.Format( "Seleccionar %1", "Lista requerimientos", "", "", "", "", "", "", "", "");
      ...
      protected void E228F2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV17pListaRequerimientosId = A369ListaRequerimientosId;
         AssignAttri("", false, "AV17pListaRequerimientosId", StringUtil.LTrimStr( (decimal)(AV17pListaRequerimientosId), 4, 0));
         context.setWebReturnParms(new Object[] {(short)AV17pListaRequerimientosId});
         context.setWebReturnParmsMetadata(new Object[] {"AV17pListaRequerimientosId"});
         context.wjLocDisableFrm = 1;
      ...
      protected void E238F2( )
      {
         ...
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV15ClassCollection", AV15ClassCollection);
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV22FilterTags", AV22FilterTags);
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV7GridConfiguration", AV7GridConfiguration);
      }
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV12GridStateKey = StringUtil.Str( (decimal)(AV17pListaRequerimientosId), 4, 0);
         new k2bloadgridstate(context ).execute(  AV35Pgmname,  AV12GridStateKey, out  AV13GridState) ;
         AV25OrderedBy = AV13GridState.gxTpr_Orderedby;
         AssignAttri("", false, "AV25OrderedBy", StringUtil.LTrimStr( (decimal)(AV25OrderedBy), 4, 0));
         AV29UC_OrderedBy = AV13GridState.gxTpr_Orderedby;
         AssignAttri("", false, "AV29UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV29UC_OrderedBy), 4, 0));
         AV36GXV1 = 1;
         while ( AV36GXV1 <= AV13GridState.gxTpr_Filtervalues.Count )
         {
            AV14GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV13GridState.gxTpr_Filtervalues.Item(AV36GXV1));
            if ( StringUtil.StrCmp(AV14GridStateFilterValue.gxTpr_Filtername, "ListaRequerimientosDescripcion") == 0 )
            {
               AV18ListaRequerimientosDescripcion = AV14GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV18ListaRequerimientosDescripcion", AV18ListaRequerimientosDescripcion);
            }
            else if ( StringUtil.StrCmp(AV14GridStateFilterValue.gxTpr_Filtername, "AreasAtencionDescripcion") == 0 )
            {
               AV19AreasAtencionDescripcion = AV14GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV19AreasAtencionDescripcion", AV19AreasAtencionDescripcion);
            }
            else if ( StringUtil.StrCmp(AV14GridStateFilterValue.gxTpr_Filtername, "K2BToolsGenericSearchField") == 0 )
            {
               AV24K2BToolsGenericSearchField = AV14GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV24K2BToolsGenericSearchField", AV24K2BToolsGenericSearchField);
            }
      ...
      protected void S122( )
      {
         ...
         AV13GridState.gxTpr_Orderedby = AV25OrderedBy;
         AV13GridState.gxTpr_Filtervalues.Clear();
         AV14GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         AV14GridStateFilterValue.gxTpr_Filtername = "ListaRequerimientosDescripcion";
         AV14GridStateFilterValue.gxTpr_Value = AV18ListaRequerimientosDescripcion;
         AV13GridState.gxTpr_Filtervalues.Add(AV14GridStateFilterValue, 0);
         AV14GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         AV14GridStateFilterValue.gxTpr_Filtername = "AreasAtencionDescripcion";
         AV14GridStateFilterValue.gxTpr_Value = AV19AreasAtencionDescripcion;
         AV13GridState.gxTpr_Filtervalues.Add(AV14GridStateFilterValue, 0);
         AV14GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         AV14GridStateFilterValue.gxTpr_Filtername = "K2BToolsGenericSearchField";
         AV14GridStateFilterValue.gxTpr_Value = AV24K2BToolsGenericSearchField;
         AV13GridState.gxTpr_Filtervalues.Add(AV14GridStateFilterValue, 0);
         new k2bsavegridstate(context ).execute(  AV35Pgmname,  AV12GridStateKey,  AV13GridState) ;
      }
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         new k2bloadgridconfiguration(context ).execute(  AV35Pgmname,  "Grid", ref  AV7GridConfiguration) ;
      ...
      protected void E178F2( )
      {
         ...
         new k2bsavegridconfiguration(context ).execute(  AV35Pgmname,  "Grid",  AV7GridConfiguration,  true) ;
         AV29UC_OrderedBy = AV25OrderedBy;
         AssignAttri("", false, "AV29UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV29UC_OrderedBy), 4, 0));
         if ( AV10RowsPerPageVariable != AV9GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV10RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV35Pgmname,  "Grid",  AV10RowsPerPageVariable) ;
            AV5CurrentPage = 1;
            AssignAttri("", false, "AV5CurrentPage", StringUtil.LTrimStr( (decimal)(AV5CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void S142( )
      {
         ...
         returnInSub = false;
         AV20K2BFilterValuesSDT = new GXBaseCollection<SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem>( context, "K2BFilterValuesSDTItem", "kb_ticket");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV18ListaRequerimientosDescripcion)) )
         {
            AV21K2BFilterValuesSDTItem = new SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem(context);
            AV21K2BFilterValuesSDTItem.gxTpr_Name = "ListaRequerimientosDescripcion";
            AV21K2BFilterValuesSDTItem.gxTpr_Description = "Descripción:";
            AV21K2BFilterValuesSDTItem.gxTpr_Canbedeleted = true;
            AV21K2BFilterValuesSDTItem.gxTpr_Type = "Standard";
            AV21K2BFilterValuesSDTItem.gxTpr_Value = AV18ListaRequerimientosDescripcion;
            AV21K2BFilterValuesSDTItem.gxTpr_Valuedescription = AV18ListaRequerimientosDescripcion;
            AV20K2BFilterValuesSDT.Add(AV21K2BFilterValuesSDTItem, 0);
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV19AreasAtencionDescripcion)) )
         {
            AV21K2BFilterValuesSDTItem = new SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem(context);
            AV21K2BFilterValuesSDTItem.gxTpr_Name = "AreasAtencionDescripcion";
            AV21K2BFilterValuesSDTItem.gxTpr_Description = "Descripción: ";
            AV21K2BFilterValuesSDTItem.gxTpr_Canbedeleted = true;
            AV21K2BFilterValuesSDTItem.gxTpr_Type = "Standard";
            AV21K2BFilterValuesSDTItem.gxTpr_Value = AV19AreasAtencionDescripcion;
            AV21K2BFilterValuesSDTItem.gxTpr_Valuedescription = AV19AreasAtencionDescripcion;
            AV20K2BFilterValuesSDT.Add(AV21K2BFilterValuesSDTItem, 0);
         }
         ...
         if ( AV20K2BFilterValuesSDT.Count > 0 )
         {
            GXt_objcol_SdtK2BValueDescriptionCollection_Item2 = AV22FilterTags;
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV35Pgmname,  "Grid",  AV20K2BFilterValuesSDT, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item2) ;
            AV22FilterTags = GXt_objcol_SdtK2BValueDescriptionCollection_Item2;
         }
      }
      ...
      protected void E118F2( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV23DeletedTag, "ListaRequerimientosDescripcion") == 0 )
         {
            AV18ListaRequerimientosDescripcion = "";
            AssignAttri("", false, "AV18ListaRequerimientosDescripcion", AV18ListaRequerimientosDescripcion);
         }
         else if ( StringUtil.StrCmp(AV23DeletedTag, "AreasAtencionDescripcion") == 0 )
         {
            AV19AreasAtencionDescripcion = "";
            AssignAttri("", false, "AV19AreasAtencionDescripcion", AV19AreasAtencionDescripcion);
         }
      ...
      protected void wb_table2_101_8F2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoresultsfoundtextblock_Internalname, "No hay resultados", "", "", lblNoresultsfoundtextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_PromptListaRequerimientos.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_101_8F2e( true) ;
         }
         else
         {
            wb_table2_101_8F2e( false) ;
         }
      }

      protected void wb_table1_49_8F2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRuntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblRuntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_PromptListaRequerimientos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttK2bgridsettingssave_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(93), 2, 0)+","+"null"+");", "Aplicar", bttK2bgridsettingssave_Jsonclick, 5, "Aplicar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'SAVEGRIDSETTINGS\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_PromptListaRequerimientos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_49_8F2e( true) ;
         }
         else
         {
            wb_table1_49_8F2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV17pListaRequerimientosId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV17pListaRequerimientosId", StringUtil.LTrimStr( (decimal)(AV17pListaRequerimientosId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188433776", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("promptlistarequerimientos.js", "?2024188433776", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
      ...
      {
         edtListaRequerimientosId_Internalname = "LISTAREQUERIMIENTOSID_"+sGXsfl_93_idx;
         edtListaRequerimientosDescripcion_Internalname = "LISTAREQUERIMIENTOSDESCRIPCION_"+sGXsfl_93_idx;
         edtAreasAtencionId_Internalname = "AREASATENCIONID_"+sGXsfl_93_idx;
         edtAreasAtencionDescripcion_Internalname = "AREASATENCIONDESCRIPCION_"+sGXsfl_93_idx;
         edtListaRequerimientosUsuarioSistema_Internalname = "LISTAREQUERIMIENTOSUSUARIOSISTEMA_"+sGXsfl_93_idx;
      }

      protected void SubsflControlProps_fel_932( )
      {
         edtListaRequerimientosId_Internalname = "LISTAREQUERIMIENTOSID_"+sGXsfl_93_fel_idx;
         edtListaRequerimientosDescripcion_Internalname = "LISTAREQUERIMIENTOSDESCRIPCION_"+sGXsfl_93_fel_idx;
         edtAreasAtencionId_Internalname = "AREASATENCIONID_"+sGXsfl_93_fel_idx;
         edtAreasAtencionDescripcion_Internalname = "AREASATENCIONDESCRIPCION_"+sGXsfl_93_fel_idx;
         edtListaRequerimientosUsuarioSistema_Internalname = "LISTAREQUERIMIENTOSUSUARIOSISTEMA_"+sGXsfl_93_fel_idx;
      }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV17pListaRequerimientosId',fld:'vPLISTAREQUERIMIENTOSID',pic:'ZZZ9'},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV18ListaRequerimientosDescripcion',fld:'vLISTAREQUERIMIENTOSDESCRIPCION',pic:''},{av:'AV19AreasAtencionDescripcion',fld:'vAREASATENCIONDESCRIPCION',pic:''},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("ENTER","{handler:'E228F2',iparms:[{av:'A369ListaRequerimientosId',fld:'LISTAREQUERIMIENTOSID',pic:'ZZZ9',hsh:true},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV17pListaRequerimientosId',fld:'vPLISTAREQUERIMIENTOSID',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("GRID.REFRESH","{handler:'E238F2',iparms:[{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV18ListaRequerimientosDescripcion',fld:'vLISTAREQUERIMIENTOSDESCRIPCION',pic:''},{av:'AV19AreasAtencionDescripcion',fld:'vAREASATENCIONDESCRIPCION',pic:''},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pListaRequerimientosId',fld:'vPLISTAREQUERIMIENTOSID',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("GRID.REFRESH",",oparms:[{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'tblNoresultsfoundtable_Visible',ctrl:'NORESULTSFOUNDTABLE',prop:'Visible'},{av:'AV29UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'Filtersummarytagsuc_Emptystatemessage',ctrl:'FILTERSUMMARYTAGSUC',prop:'EmptyStateMessage'},{av:'AV22FilterTags',fld:'vFILTERTAGS',pic:''},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'lblFirstpagetextblock_Caption',ctrl:'FIRSTPAGETEXTBLOCK',prop:'Caption'},{av:'lblPreviouspagetextblock_Caption',ctrl:'PREVIOUSPAGETEXTBLOCK',prop:'Caption'},{av:'lblCurrentpagetextblock_Caption',ctrl:'CURRENTPAGETEXTBLOCK',prop:'Caption'},{av:'lblNextpagetextblock_Caption',ctrl:'NEXTPAGETEXTBLOCK',prop:'Caption'},{av:'lblLastpagetextblock_Caption',ctrl:'LASTPAGETEXTBLOCK',prop:'Caption'},{av:'lblPreviouspagebuttontextblock_Class',ctrl:'PREVIOUSPAGEBUTTONTEXTBLOCK',prop:'Class'},{av:'lblNextpagebuttontextblock_Class',ctrl:'NEXTPAGEBUTTONTEXTBLOCK',prop:'Class'},{av:'lblFirstpagetextblock_Visible',ctrl:'FIRSTPAGETEXTBLOCK',prop:'Visible'},{av:'lblSpacinglefttextblock_Visible',ctrl:'SPACINGLEFTTEXTBLOCK',prop:'Visible'},{av:'lblPreviouspagetextblock_Visible',ctrl:'PREVIOUSPAGETEXTBLOCK',prop:'Visible'},{av:'lblLastpagetextblock_Visible',ctrl:'LASTPAGETEXTBLOCK',prop:'Visible'},{av:'lblSpacingrighttextblock_Visible',ctrl:'SPACINGRIGHTTEXTBLOCK',prop:'Visible'},{av:'lblNextpagetextblock_Visible',ctrl:'NEXTPAGETEXTBLOCK',prop:'Visible'},{av:'divK2btoolspagingcontainertable_Visible',ctrl:'K2BTOOLSPAGINGCONTAINERTABLE',prop:'Visible'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("GRID.LOAD","{handler:'E248F2',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOSEARCH'","{handler:'E258F2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18ListaRequerimientosDescripcion',fld:'vLISTAREQUERIMIENTOSDESCRIPCION',pic:''},{av:'AV19AreasAtencionDescripcion',fld:'vAREASATENCIONDESCRIPCION',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pListaRequerimientosId',fld:'vPLISTAREQUERIMIENTOSID',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E138F2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18ListaRequerimientosDescripcion',fld:'vLISTAREQUERIMIENTOSDESCRIPCION',pic:''},{av:'AV19AreasAtencionDescripcion',fld:'vAREASATENCIONDESCRIPCION',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pListaRequerimientosId',fld:'vPLISTAREQUERIMIENTOSID',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E158F2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18ListaRequerimientosDescripcion',fld:'vLISTAREQUERIMIENTOSDESCRIPCION',pic:''},{av:'AV19AreasAtencionDescripcion',fld:'vAREASATENCIONDESCRIPCION',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pListaRequerimientosId',fld:'vPLISTAREQUERIMIENTOSID',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E168F2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18ListaRequerimientosDescripcion',fld:'vLISTAREQUERIMIENTOSDESCRIPCION',pic:''},{av:'AV19AreasAtencionDescripcion',fld:'vAREASATENCIONDESCRIPCION',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pListaRequerimientosId',fld:'vPLISTAREQUERIMIENTOSID',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'TOGGLEGRIDSETTINGSTABLE'","{handler:'E268F1',iparms:[{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E178F2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18ListaRequerimientosDescripcion',fld:'vLISTAREQUERIMIENTOSDESCRIPCION',pic:''},{av:'AV19AreasAtencionDescripcion',fld:'vAREASATENCIONDESCRIPCION',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pListaRequerimientosId',fld:'vPLISTAREQUERIMIENTOSID',pic:'ZZZ9'},{av:'AV10RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV9GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'SAVEGRIDSETTINGS'",",oparms:[{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV29UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{av:'AV10RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED","{handler:'E118F2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18ListaRequerimientosDescripcion',fld:'vLISTAREQUERIMIENTOSDESCRIPCION',pic:''},{av:'AV19AreasAtencionDescripcion',fld:'vAREASATENCIONDESCRIPCION',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pListaRequerimientosId',fld:'vPLISTAREQUERIMIENTOSID',pic:'ZZZ9'},{av:'AV23DeletedTag',fld:'vDELETEDTAG',pic:''},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED",",oparms:[{av:'AV18ListaRequerimientosDescripcion',fld:'vLISTAREQUERIMIENTOSDESCRIPCION',pic:''},{av:'AV19AreasAtencionDescripcion',fld:'vAREASATENCIONDESCRIPCION',pic:''},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E128F2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18ListaRequerimientosDescripcion',fld:'vLISTAREQUERIMIENTOSDESCRIPCION',pic:''},{av:'AV19AreasAtencionDescripcion',fld:'vAREASATENCIONDESCRIPCION',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV35Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pListaRequerimientosId',fld:'vPLISTAREQUERIMIENTOSID',pic:'ZZZ9'},{av:'AV29UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED",",oparms:[{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("FILTERTOGGLE_COMBINED.CLICK","{handler:'E188F2',iparms:[{av:'divFiltercollapsiblesection_combined_Visible',ctrl:'FILTERCOLLAPSIBLESECTION_COMBINED',prop:'Visible'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERCLOSE_COMBINED.CLICK","{handler:'E198F2',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("VALID_AREASATENCIONID","{handler:'Valid_Areasatencionid',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("VALID_AREASATENCIONID",",oparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("NULL","{handler:'Valid_Listarequerimientosusuariosistema',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         bodyStyle = "";
         GXKey = "";
         AV22FilterTags = new GXBaseCollection<SdtK2BValueDescriptionCollection_Item>( context, "Item", "kb_ticket");
         AV23DeletedTag = "";
         AV27GridOrders = new GXBaseCollection<SdtK2BGridOrders_K2BGridOrdersItem>( context, "K2BGridOrdersItem", "kb_ticket");
         ...
         sEvtType = "";
         scmdbuf = "";
         lV18ListaRequerimientosDescripcion = "";
         lV19AreasAtencionDescripcion = "";
         lV24K2BToolsGenericSearchField = "";
         H008F2_A371ListaRequerimientosUsuarioSistema = new string[] {""} ;
         H008F2_A367AreasAtencionDescripcion = new string[] {""} ;
         H008F2_A366AreasAtencionId = new short[1] ;
         H008F2_A370ListaRequerimientosDescripcion = new string[] {""} ;
         H008F2_A369ListaRequerimientosId = new short[1] ;
         ...
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.promptlistarequerimientos__default(),
            new Object[][] {
                new Object[] {
               H008F2_A371ListaRequerimientosUsuarioSistema, H008F2_A367AreasAtencionDescripcion, H008F2_A366AreasAtencionId, H008F2_A370ListaRequerimientosDescripcion, H008F2_A369ListaRequerimientosId
               }
               , new Object[] {
      ...
      private short AV17pListaRequerimientosId ;
      ...
      private string AV18ListaRequerimientosDescripcion ;
      private string AV19AreasAtencionDescripcion ;
      ...
      private string lV18ListaRequerimientosDescripcion ;
      private string lV19AreasAtencionDescripcion ;
      ...
      private string[] H008F2_A371ListaRequerimientosUsuarioSistema ;
      private string[] H008F2_A367AreasAtencionDescripcion ;
      private short[] H008F2_A366AreasAtencionId ;
      private string[] H008F2_A370ListaRequerimientosDescripcion ;
      private short[] H008F2_A369ListaRequerimientosId ;
      private long[] H008F3_AGRID_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private short aP0_pListaRequerimientosId ;
      private GxSimpleCollection<string> AV15ClassCollection ;
      private GXBaseCollection<SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem> AV20K2BFilterValuesSDT ;
      private GXBaseCollection<SdtK2BValueDescriptionCollection_Item> AV22FilterTags ;
      ...
      private GXBaseCollection<SdtK2BActivityList_K2BActivityListItem> AV31ActivityList ;
      ...
      private SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem AV21K2BFilterValuesSDTItem ;
      private SdtK2BGridOrders_K2BGridOrdersItem AV28GridOrder ;
      private SdtK2BActivityList_K2BActivityListItem AV32ActivityListItem ;
   }

   public class promptlistarequerimientos__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV25OrderedBy )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV18ListaRequerimientosDescripcion)) )
         {
            AddWhere(sWhereString, "(T1.[ListaRequerimientosDescripcion] like @lV18ListaRequerimientosDescripcion)");
         }
         else
         {
            GXv_int3[0] = 1;
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV19AreasAtencionDescripcion)) )
         {
            AddWhere(sWhereString, "(T2.[AreasAtencionDescripcion] like @lV19AreasAtencionDescripcion)");
         }
         else
         {
            GXv_int3[1] = 1;
         ...
         {
            AddWhere(sWhereString, "(CONVERT( char(4), CAST(T1.[ListaRequerimientosId] AS decimal(4,0))) like '%' + @lV24K2BToolsGenericSearchField + '%' or T1.[ListaRequerimientosDescripcion] like '%' + @lV24K2BToolsGenericSearchField + '%' or T2.[AreasAtencionDescripcion] like '%' + @lV24K2BToolsGenericSearchField + '%' or T1.[ListaRequerimientosUsuarioSistema] like '%' + @lV24K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int3[2] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H008F2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (short)dynConstraints[5] , (string)dynConstraints[6] , (short)dynConstraints[7] );
               case 1 :
                     return conditional_H008F3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (short)dynConstraints[5] , (string)dynConstraints[6] , (short)dynConstraints[7] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV18ListaRequerimientosDescripcion",GXType.NVarChar,100,0) ,
          new ParDef("@lV19AreasAtencionDescripcion",GXType.NVarChar,30,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H008F2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008F2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H008F3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008F3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
