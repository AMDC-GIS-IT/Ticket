...
namespace GeneXus.Programs {
   public class pcrregistrartecnico : GXProcedure
   {
      ...
      public void execute( long aP0_TicketId ,
                           ...
                           DateTime aP38_TicketResponsableFechaHoraAtiende ,
                           DateTime aP39_TicketResponsableFechaHoraResuelve )
      {
         ...
         this.AV65TicketResponsableFechaHoraAtiende = aP38_TicketResponsableFechaHoraAtiende;
         this.AV66TicketResponsableFechaHoraResuelve = aP39_TicketResponsableFechaHoraResuelve;
         initialize();
         executePrivate();
      }
                                 ...
                                 DateTime aP39_TicketResponsableFechaHoraResuelve )
      {
         ...
         objpcrregistrartecnico.AV65TicketResponsableFechaHoraAtiende = aP38_TicketResponsableFechaHoraAtiende;
         objpcrregistrartecnico.AV66TicketResponsableFechaHoraResuelve = aP39_TicketResponsableFechaHoraResuelve;
      ...
      void executePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A363TicketResponsableFechaHoraAtiende = P005P2_A363TicketResponsableFechaHoraAtiende[0];
            A288TicketResponsableFechaHoraResuelve = P005P2_A288TicketResponsableFechaHoraResuelve[0];
            n288TicketResponsableFechaHoraResuelve = P005P2_n288TicketResponsableFechaHoraResuelve[0];
         ...
         if ( AV63EstadoTicketTicketId == 5 )
         {
            ...
            */
            ...
            A248detalle_infotecid_unidad = (int)(NumberUtil.Val( AV57WebSession.Get("id_unidad_tecnico"), "."));
            ...
            n252prioridad = false;
            A253observaciones = AV34TicketResponsableObservacion + " de Ticket" + StringUtil.Str( (decimal)(AV36UsuarioId), 10, 0);
         ...
         if ( AV63EstadoTicketTicketId == 4 )
         {
            ...
            */
            ...
            pr_default.close(5);
            AV73Ticketresponsablesig = (long)(A40000GXC1+1);
            A14TicketId = AV37TicketId;
            A16TicketResponsableId = AV73Ticketresponsablesig;
            ...
            pr_default.execute(7, new Object[] {AV73Ticketresponsablesig, AV37TicketId, AV36UsuarioId});
            pr_default.close(7);
            dsDefault.SmartCacheProvider.SetUpdated("Ticket");
            /* End optimized UPDATE. */
            /* Optimized UPDATE. */
      ...
      public override void initialize( )
      {
         ...
         P005P2_A363TicketResponsableFechaHoraAtiende = new DateTime[] {DateTime.MinValue} ;
         P005P2_A288TicketResponsableFechaHoraResuelve = new DateTime[] {DateTime.MinValue} ;
         P005P2_n288TicketResponsableFechaHoraResuelve = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.pcrregistrartecnico__default(),
            new Object[][] {
               ...
               P005P2_n168TicketResponsableObservacion, P005P2_A175TicketResponsableFechaResuelve, P005P2_n175TicketResponsableFechaResuelve, P005P2_A176TicketResponsableHoraResuelve, P005P2_n176TicketResponsableHoraResuelve, P005P2_A363TicketResponsableFechaHoraAtiende, P005P2_A288TicketResponsableFechaHoraResuelve, P005P2_n288TicketResponsableFechaHoraResuelve, P005P2_A14TicketId
               }
               , new Object[] {
               }
               , new Object[] {
      ...
      private long AV36UsuarioId ;
      private long AV8TicketResponsableId ;
      private long A16TicketResponsableId ;
      private long A14TicketId ;
      private long A40000GXC1 ;
      private long AV73Ticketresponsablesig ;
      private long A54TicketLastId ;
      private string scmdbuf ;
      private string Gx_emsg ;
      private DateTime AV65TicketResponsableFechaHoraAtiende ;
      private DateTime AV66TicketResponsableFechaHoraResuelve ;
      ...
      private DateTime[] P005P2_A363TicketResponsableFechaHoraAtiende ;
      private DateTime[] P005P2_A288TicketResponsableFechaHoraResuelve ;
      private bool[] P005P2_n288TicketResponsableFechaHoraResuelve ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P005P10", cmdBufferP005P10, GxErrorMask.GX_NOMASK,prmP005P10)
             ,new CursorDef("P005P11", "UPDATE [Ticket] SET [TicketLastId]=@TicketLastId, [EstadoTicketTicketId]=3  WHERE ([TicketId] = @AV37TicketId) AND ([UsuarioId] = @AV36UsuarioId)", GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP005P11)
