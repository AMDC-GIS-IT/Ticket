...
namespace GeneXus.Programs {
   public class reportwwtickettecnico : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            else
            {
               ...
               getPrinter().GxDrawText("RST No.", 256, Gx_line+7, 330, Gx_line+22, 2, 0, 0, 1) ;
               getPrinter().GxDrawText("Id TR:", 338, Gx_line+7, 412, Gx_line+22, 2, 0, 0, 1) ;
               getPrinter().GxDrawText("Técnico", 420, Gx_line+7, 551, Gx_line+22, 0, 0, 0, 1) ;
               getPrinter().GxDrawText("Id Usuario", 559, Gx_line+7, 633, Gx_line+22, 2, 0, 0, 1) ;
               getPrinter().GxDrawText("Usuario", 641, Gx_line+7, 776, Gx_line+22, 0, 0, 0, 1) ;
               Gx_OldLine = Gx_line;
               Gx_line = (int)(Gx_line+30);
               GxHdr3 = true;
               ...
               while ( (pr_default.getStatus(0) != 101) )
               {
                  ...
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(A16TicketResponsableId), "ZZZZZZZZZ9")), 338, Gx_line+7, 412, Gx_line+23, 2, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A30ResponsableNombre, "")), 420, Gx_line+7, 551, Gx_line+23, 0, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(A15UsuarioId), "ZZZZZZZZZ9")), 559, Gx_line+7, 633, Gx_line+23, 2, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A93UsuarioNombre, "")), 641, Gx_line+7, 776, Gx_line+23, 0, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
      ...
      public override void initialize( )
      {
         ...
         P003V2_A15UsuarioId = new long[1] ;
      ...
      private long[] P003V2_A15UsuarioId ;
   ...
   public class reportwwtickettecnico__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV10OrderedBy )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(10), CAST(T1.[TicketTecnicoId] AS decimal(10,0))) like '%' + @lV9K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T1.[TicketId] AS decimal(10,0))) like '%' + @lV9K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T1.[TicketResponsableId] AS decimal(10,0))) like '%' + @lV9K2BToolsGenericSearchField + '%' or T2.[ResponsableNombre] like '%' + @lV9K2BToolsGenericSearchField + '%' or CONVERT( char(10), CAST(T3.[UsuarioId] AS decimal(10,0))) like '%' + @lV9K2BToolsGenericSearchField + '%' or T4.[UsuarioNombre] like '%' + @lV9K2BToolsGenericSearchField + '%' or T4.[UsuarioRequerimiento] like '%' + @lV9K2BToolsGenericSearchField + '%' or T4.[UsuarioDepartamento] like '%' + @lV9K2BToolsGenericSearchField + '%' or T1.[TicketTecnicoInventarioSerie] like '%' + @lV9K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int1[4] = 1;
