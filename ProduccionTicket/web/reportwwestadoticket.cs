...
namespace GeneXus.Programs {
   public class reportwwestadoticket : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public reportwwestadoticket( IGxContext context )
      {
      ...
      public void executeSubmit( string aP0_K2BToolsGenericSearchField ,
                                 short aP1_OrderedBy )
      {
         reportwwestadoticket objreportwwestadoticket;
         objreportwwestadoticket = new reportwwestadoticket();
         objreportwwestadoticket.AV9K2BToolsGenericSearchField = aP0_K2BToolsGenericSearchField;
         objreportwwestadoticket.AV10OrderedBy = aP1_OrderedBy;
         objreportwwestadoticket.context.SetSubmitInitialConfig(context);
         objreportwwestadoticket.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objreportwwestadoticket);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((reportwwestadoticket)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "EstadoTicket",  "EstadoTicket",  "List",  "",  AV20Pgmname) )
            {
               H3F0( false, 30) ;
            ...
            else
            {
               ...
               getPrinter().GxDrawText("Estado tickets", 260, Gx_line+0, 567, Gx_line+42, 0+256, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
               ...
               getPrinter().GxDrawText("Estado Ticket:", 56, Gx_line+7, 276, Gx_line+22, 0, 0, 0, 1) ;
               ...
               {
                  A24EstadoTicketNombre = P003F2_A24EstadoTicketNombre[0];
                  A5EstadoTicketId = P003F2_A5EstadoTicketId[0];
                  A23EstadoTicketEstado = P003F2_A23EstadoTicketEstado[0];
                  AV15Grid_EstadoTicketEstado = (A23EstadoTicketEstado ? "Si" : "No");
                  H3F0( false, 30) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(A5EstadoTicketId), "ZZZ9")), 18, Gx_line+7, 48, Gx_line+23, 2, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A24EstadoTicketNombre, "")), 56, Gx_line+7, 276, Gx_line+23, 0, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( AV15Grid_EstadoTicketEstado, "")), 284, Gx_line+7, 329, Gx_line+23, 0, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
      ...
      public override void initialize( )
      {
         ...
         A24EstadoTicketNombre = "";
         P003F2_A24EstadoTicketNombre = new string[] {""} ;
         P003F2_A5EstadoTicketId = new short[1] ;
         P003F2_A23EstadoTicketEstado = new bool[] {false} ;
         AV15Grid_EstadoTicketEstado = "";
         Gx_date = DateTime.MinValue;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportwwestadoticket__default(),
            new Object[][] {
                new Object[] {
               P003F2_A24EstadoTicketNombre, P003F2_A5EstadoTicketId, P003F2_A23EstadoTicketEstado
               }
            }
         );
         AV20Pgmname = "ReportWWEstadoTicket";
      ...
      private string AV15Grid_EstadoTicketEstado ;
      ...
      private string[] P003F2_A24EstadoTicketNombre ;
      private short[] P003F2_A5EstadoTicketId ;
      private bool[] P003F2_A23EstadoTicketEstado ;
      private SdtK2BContext AV8Context ;
   }

   public class reportwwestadoticket__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV10OrderedBy )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(4), CAST([EstadoTicketId] AS decimal(4,0))) like '%' + @lV9K2BToolsGenericSearchField + '%' or [EstadoTicketNombre] like '%' + @lV9K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int1[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P003F2(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] );
         }
