...
namespace GeneXus.Programs {
   public class reportwwestadotecnicos : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public reportwwestadotecnicos( IGxContext context )
      {
      ...
      public void executeSubmit( string aP0_K2BToolsGenericSearchField ,
                                 short aP1_OrderedBy )
      {
         reportwwestadotecnicos objreportwwestadotecnicos;
         objreportwwestadotecnicos = new reportwwestadotecnicos();
         objreportwwestadotecnicos.AV9K2BToolsGenericSearchField = aP0_K2BToolsGenericSearchField;
         objreportwwestadotecnicos.AV10OrderedBy = aP1_OrderedBy;
         objreportwwestadotecnicos.context.SetSubmitInitialConfig(context);
         objreportwwestadotecnicos.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objreportwwestadotecnicos);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((reportwwestadotecnicos)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "EstadoTecnicos",  "EstadoTecnicos",  "List",  "",  AV19Pgmname) )
            {
               H5T0( false, 30) ;
            ...
            else
            {
               ...
               getPrinter().GxDrawText("Estado técnicos", 249, Gx_line+0, 578, Gx_line+42, 0+256, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
               ...
               getPrinter().GxDrawText("Técnicos", 56, Gx_line+7, 276, Gx_line+22, 0, 0, 0, 1) ;
               Gx_OldLine = Gx_line;
               Gx_line = (int)(Gx_line+30);
               GxHdr3 = true;
               ...
               {
                  A193EstadoTecnicosNombre = P005T2_A193EstadoTecnicosNombre[0];
                  A192EstadoTecnicosId = P005T2_A192EstadoTecnicosId[0];
                  H5T0( false, 30) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(A192EstadoTecnicosId), "ZZZ9")), 18, Gx_line+7, 48, Gx_line+23, 2, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A193EstadoTecnicosNombre, "")), 56, Gx_line+7, 276, Gx_line+23, 0, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
      ...
      protected void H5T0( bool bFoot ,
                           int Inc )
      {
      ...
      public override void initialize( )
      {
         ...
         A193EstadoTecnicosNombre = "";
         P005T2_A193EstadoTecnicosNombre = new string[] {""} ;
         P005T2_A192EstadoTecnicosId = new short[1] ;
         Gx_date = DateTime.MinValue;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportwwestadotecnicos__default(),
            new Object[][] {
                new Object[] {
               P005T2_A193EstadoTecnicosNombre, P005T2_A192EstadoTecnicosId
               }
            }
         );
         AV19Pgmname = "ReportWWEstadoTecnicos";
      ...
      private string[] P005T2_A193EstadoTecnicosNombre ;
      private short[] P005T2_A192EstadoTecnicosId ;
      private SdtK2BContext AV8Context ;
   }

   public class reportwwestadotecnicos__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV10OrderedBy )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(4), CAST([EstadoTecnicosId] AS decimal(4,0))) like '%' + @lV9K2BToolsGenericSearchField + '%' or [EstadoTecnicosNombre] like '%' + @lV9K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int1[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P005T2(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P005T2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP005T2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
