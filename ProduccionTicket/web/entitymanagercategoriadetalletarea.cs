...
namespace GeneXus.Programs {
   public class entitymanagercategoriadetalletarea : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public entitymanagercategoriadetalletarea( )
      {
      ...
      public entitymanagercategoriadetalletarea( IGxContext context )
      {
                           ...
                           string aP2_TabCode )
      {
         ...
         this.AV6CategoriaDetalleTareaId = aP1_CategoriaDetalleTareaId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               {
                  AV6CategoriaDetalleTareaId = (short)(NumberUtil.Val( GetPar( "CategoriaDetalleTareaId"), "."));
                  AssignAttri("", false, "AV6CategoriaDetalleTareaId", StringUtil.LTrimStr( (decimal)(AV6CategoriaDetalleTareaId), 4, 0));
                  GxWebStd.gx_hidden_field( context, "gxhash_vCATEGORIADETALLETAREAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6CategoriaDetalleTareaId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188425210", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("entitymanagercategoriadetalletarea.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6CategoriaDetalleTareaId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Gx_mode","CategoriaDetalleTareaId","TabCode"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vMODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( Gx_mode, "@!")), context));
         GxWebStd.gx_hidden_field( context, "vCATEGORIADETALLETAREAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6CategoriaDetalleTareaId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCATEGORIADETALLETAREAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6CategoriaDetalleTareaId), "ZZZ9"), context));
      ...
      {
         return formatLink("entitymanagercategoriadetalletarea.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6CategoriaDetalleTareaId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Gx_mode","CategoriaDetalleTareaId","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "EntityManagerCategoriaDetalleTarea" ;
      }
      ...
      protected void WB7G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblK2bpgmdesc_Internalname, lblK2bpgmdesc_Caption, "", "", lblK2bpgmdesc_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_EntityManagerCategoriaDetalleTarea.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblBacktoworkwith_Internalname, lblBacktoworkwith_Caption, lblBacktoworkwith_Link, "", lblBacktoworkwith_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_BackToWorkWith", 0, "", 1, 1, 0, 0, "HLP_EntityManagerCategoriaDetalleTarea.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      {
         /* GeneXus formulas. */
         AV27Pgmname = "EntityManagerCategoriaDetalleTarea";
         context.Gx_err = 0;
      }
      ...
      protected void E127G2( )
      {
         /* Start Routine */
         returnInSub = false;
         lblBacktoworkwith_Caption = StringUtil.Format( "%1", "Categoria detalle tareas", "", "", "", "", "", "", "", "");
         AssignProp("", false, lblBacktoworkwith_Internalname, "Caption", lblBacktoworkwith_Caption, true);
         lblBacktoworkwith_Link = formatLink("wwcategoriadetalletarea.aspx") ;
         AssignProp("", false, lblBacktoworkwith_Internalname, "Link", lblBacktoworkwith_Link, true);
         AV26GXLvl7 = 0;
         /* Using cursor H007G2 */
         pr_default.execute(0, new Object[] {AV6CategoriaDetalleTareaId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A294CategoriaDetalleTareaId = H007G2_A294CategoriaDetalleTareaId[0];
            A295CategoriaDetalleTareaNombre = H007G2_A295CategoriaDetalleTareaNombre[0];
            AV26GXLvl7 = 1;
            Form.Caption = A295CategoriaDetalleTareaNombre;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblK2bpgmdesc_Caption = StringUtil.Format( "%1 - %2", "Categoria Detalle Tarea", A295CategoriaDetalleTareaNombre, "", "", "", "", "", "", "");
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            lblK2bpgmdesc_Caption = "Categoria Detalle Tarea";
            AssignProp("", false, lblK2bpgmdesc_Internalname, "Caption", lblK2bpgmdesc_Caption, true);
         }
      ...
      protected void E137G2( )
      {
         ...
         {
            AV20RelatedTransactionName = "CategoriaDetalleTarea";
         ...
         if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               Tablemodal_Modaltitle = StringUtil.Format( "Actualizar %1", "Categoria Detalle Tarea", "", "", "", "", "", "", "", "");
               ...
               if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Popupcomponent_Component), StringUtil.Lower( "CategoriaDetalleTarea")) != 0 )
               {
                  WebComp_Popupcomponent = getWebComponent(GetType(), "GeneXus.Programs", "categoriadetalletarea", new Object[] {context} );
                  WebComp_Popupcomponent.ComponentInit();
                  WebComp_Popupcomponent.Name = "CategoriaDetalleTarea";
                  WebComp_Popupcomponent_Component = "CategoriaDetalleTarea";
               }
               if ( StringUtil.Len( WebComp_Popupcomponent_Component) != 0 )
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0054",(string)"",(string)"UPD",(short)AV6CategoriaDetalleTareaId});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
         {
            if ( ( StringUtil.StrCmp(AV8TabCode, "General") == 0 ) || String.IsNullOrEmpty(StringUtil.RTrim( AV8TabCode)) )
            {
               Tablemodal_Modaltitle = StringUtil.Format( "Eliminar %1", "Categoria Detalle Tarea", "", "", "", "", "", "", "", "");
               ucTablemodal.SendProperty(context, "", false, Tablemodal_Internalname, "ModalTitle", Tablemodal_Modaltitle);
               Tablemodal_Visible = true;
               ucTablemodal.SendProperty(context, "", false, Tablemodal_Internalname, "Visible", StringUtil.BoolToStr( Tablemodal_Visible));
               /* Object Property */
               ...
               {
                  WebComp_Popupcomponent.setjustcreated();
                  WebComp_Popupcomponent.componentprepare(new Object[] {(string)"W0054",(string)"",(string)"DLT",(short)AV6CategoriaDetalleTareaId});
                  WebComp_Popupcomponent.componentbind(new Object[] {(string)"",(string)""});
               }
               if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Popupcomponent )
               {
      ...
      protected void S112( )
      {
         ...
         AV11Tab.gxTpr_Link = formatLink("entitymanagercategoriadetalletarea.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV6CategoriaDetalleTareaId,4,0)),UrlEncode(StringUtil.RTrim(AV11Tab.gxTpr_Code))}, new string[] {"Mode","CategoriaDetalleTareaId","TabCode"}) ;
         AV11Tab.gxTpr_Componenttype = 3;
         AV11Tab.gxTpr_Relatedtransaction = "CategoriaDetalleTarea";
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Componentwc_general_Component), StringUtil.Lower( "CategoriaDetalleTareaGeneral")) != 0 )
            {
               WebComp_Componentwc_general = getWebComponent(GetType(), "GeneXus.Programs", "categoriadetalletareageneral", new Object[] {context} );
               WebComp_Componentwc_general.ComponentInit();
               WebComp_Componentwc_general.Name = "CategoriaDetalleTareaGeneral";
               WebComp_Componentwc_general_Component = "CategoriaDetalleTareaGeneral";
            }
            if ( StringUtil.Len( WebComp_Componentwc_general_Component) != 0 )
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0043",(string)"",(string)Gx_mode,(short)AV6CategoriaDetalleTareaId,(string)AV8TabCode});
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            {
               WebComp_Componentwc_general.setjustcreated();
               WebComp_Componentwc_general.componentprepare(new Object[] {(string)"W0043",(string)"",(string)"DSP",(short)AV6CategoriaDetalleTareaId,(string)AV8TabCode});
               WebComp_Componentwc_general.componentbind(new Object[] {(string)"",(string)"",(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Componentwc_general )
            {
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "Gx_mode", Gx_mode);
         AV6CategoriaDetalleTareaId = Convert.ToInt16(getParm(obj,1));
         AssignAttri("", false, "AV6CategoriaDetalleTareaId", StringUtil.LTrimStr( (decimal)(AV6CategoriaDetalleTareaId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCATEGORIADETALLETAREAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV6CategoriaDetalleTareaId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188425283", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("entitymanagercategoriadetalletarea.js", "?2024188425283", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("UserControls/K2BT_ComponentRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GLOBALEVENTS.K2BT_REFRESHENTITYMANAGER","{handler:'E147G2',iparms:[{av:'AV22GE_ComponentName',fld:'vGE_COMPONENTNAME',pic:''},{av:'AV21GE_EntityManagerName',fld:'vGE_ENTITYMANAGERNAME',pic:''},{av:'AV27Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV6CategoriaDetalleTareaId',fld:'vCATEGORIADETALLETAREAID',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("TABLEMODAL.ONCLOSE","{handler:'E117G2',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H007G2_A294CategoriaDetalleTareaId = new short[1] ;
         H007G2_A295CategoriaDetalleTareaNombre = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.entitymanagercategoriadetalletarea__default(),
            new Object[][] {
                new Object[] {
               H007G2_A294CategoriaDetalleTareaId, H007G2_A295CategoriaDetalleTareaNombre
               }
            }
         );
      ...
      private short AV6CategoriaDetalleTareaId ;
      private short wcpOAV6CategoriaDetalleTareaId ;
      ...
      private short[] H007G2_A294CategoriaDetalleTareaId ;
      private string[] H007G2_A295CategoriaDetalleTareaNombre ;
   ...
   public class entitymanagercategoriadetalletarea__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6CategoriaDetalleTareaId",GXType.Int16,4,0)
          };
          def= new CursorDef[] {
              new CursorDef("H007G2", "SELECT TOP 1 [CategoriaDetalleTareaId], [CategoriaDetalleTareaNombre] FROM [CategoriaDetalleTarea] WHERE [CategoriaDetalleTareaId] = @AV6CategoriaDetalleTareaId ORDER BY [CategoriaDetalleTareaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007G2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
