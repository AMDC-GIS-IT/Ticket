...
namespace GeneXus.Programs {
   public class wptecnicosmartdevice : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wptecnicosmartdevice( )
      {
      ...
      public wptecnicosmartdevice( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188424466", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wptecnicosmartdevice.aspx") +"\">") ;
      ...
      {
         return formatLink("wptecnicosmartdevice.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WPTecnicoSmartDevice" ;
      }

      public override string GetPgmdesc( )
      {
         return "WPTecnico Smart Device" ;
      }
      ...
      protected void WB6J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, "Solicitud Soporte Técnico", "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_Title", 0, "", 1, 1, 0, 0, "HLP_WPTecnicoSmartDevice.htm");
            ...
            wb_table1_24_6J2( true) ;
         }
         else
         {
            wb_table1_24_6J2( false) ;
         }
         return  ;
      }

      protected void wb_table1_24_6J2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", context.convertURL( AV5ActionReasignar_Action));
         ...
         if ( wbEnd == 68 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_86_6J2( true) ;
         }
         else
         {
            wb_table2_86_6J2( false) ;
         }
         return  ;
      }

      protected void wb_table2_86_6J2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_previouspagebuttontextblockgrid_Internalname, "", "", "", lblPaginationbar_previouspagebuttontextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGPREVIOUS(GRID)\\'."+"'", "", lblPaginationbar_previouspagebuttontextblockgrid_Class, 5, "", 1, 1, 0, 0, "HLP_WPTecnicoSmartDevice.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_firstpagetextblockgrid_Internalname, lblPaginationbar_firstpagetextblockgrid_Caption, "", "", lblPaginationbar_firstpagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGFIRST(GRID)\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPaginationbar_firstpagetextblockgrid_Visible, 1, 0, 0, "HLP_WPTecnicoSmartDevice.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_spacinglefttextblockgrid_Internalname, "...", "", "", lblPaginationbar_spacinglefttextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblPaginationbar_spacinglefttextblockgrid_Visible, 1, 0, 0, "HLP_WPTecnicoSmartDevice.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_previouspagetextblockgrid_Internalname, lblPaginationbar_previouspagetextblockgrid_Caption, "", "", lblPaginationbar_previouspagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGPREVIOUS(GRID)\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPaginationbar_previouspagetextblockgrid_Visible, 1, 0, 0, "HLP_WPTecnicoSmartDevice.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_currentpagetextblockgrid_Internalname, lblPaginationbar_currentpagetextblockgrid_Caption, "", "", lblPaginationbar_currentpagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_WPTecnicoSmartDevice.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_nextpagetextblockgrid_Internalname, lblPaginationbar_nextpagetextblockgrid_Caption, "", "", lblPaginationbar_nextpagetextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGNEXT(GRID)\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPaginationbar_nextpagetextblockgrid_Visible, 1, 0, 0, "HLP_WPTecnicoSmartDevice.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_spacingrighttextblockgrid_Internalname, "...", "", "", lblPaginationbar_spacingrighttextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblPaginationbar_spacingrighttextblockgrid_Visible, 1, 0, 0, "HLP_WPTecnicoSmartDevice.htm");
            /* Text block */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_nextpagebuttontextblockgrid_Internalname, "", "", "", lblPaginationbar_nextpagebuttontextblockgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGNEXT(GRID)\\'."+"'", "", lblPaginationbar_nextpagebuttontextblockgrid_Class, 5, "", 1, 1, 0, 0, "HLP_WPTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START6J2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "WPTecnico Smart Device", 0) ;
         }
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "GRID.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 19), "'E_ACTIONREGISTRAR'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 19), "'E_ACTIONREASIGNAR'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 19), "'E_ACTIONREGISTRAR'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 19), "'E_ACTIONREASIGNAR'") == 0 ) )
                           {
                              ...
                              AV5ActionReasignar_Action = cgiGet( edtavActionreasignar_action_Internalname);
                              AssignProp("", false, edtavActionreasignar_action_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV5ActionReasignar_Action)) ? AV31Actionreasignar_action_GXI : context.convertURL( context.PathToRelativeUrl( AV5ActionReasignar_Action))), !bGXsfl_68_Refreshing);
                              AssignProp("", false, edtavActionreasignar_action_Internalname, "SrcSet", context.GetImageSrcSet( AV5ActionReasignar_Action), true);
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
      ...
      {
         /* GeneXus formulas. */
         AV29Pgmname = "WPTecnicoSmartDevice";
         context.Gx_err = 0;
      }
      ...
      protected int subGridclient_rec_count_fnc( )
      {
         ...
         {
            A17EstadoTicketTecnicoId = H006J2_A17EstadoTicketTecnicoId[0];
            A167TicketResponsablePasaTaller = H006J2_A167TicketResponsablePasaTaller[0];
            n167TicketResponsablePasaTaller = H006J2_n167TicketResponsablePasaTaller[0];
            A199TicketTecnicoResponsableNombre = H006J2_A199TicketTecnicoResponsableNombre[0];
            A198TicketTecnicoResponsableId = H006J2_A198TicketTecnicoResponsableId[0];
            A48TicketHora = H006J2_A48TicketHora[0];
            A46TicketFecha = H006J2_A46TicketFecha[0];
            A16TicketResponsableId = H006J2_A16TicketResponsableId[0];
            A14TicketId = H006J2_A14TicketId[0];
            A90UsuarioFecha = H006J2_A90UsuarioFecha[0];
            A89UsuarioEmail = H006J2_A89UsuarioEmail[0];
            A88UsuarioDepartamento = H006J2_A88UsuarioDepartamento[0];
            A94UsuarioRequerimiento = H006J2_A94UsuarioRequerimiento[0];
            A15UsuarioId = H006J2_A15UsuarioId[0];
            A93UsuarioNombre = H006J2_A93UsuarioNombre[0];
            A199TicketTecnicoResponsableNombre = H006J2_A199TicketTecnicoResponsableNombre[0];
            A48TicketHora = H006J2_A48TicketHora[0];
            A46TicketFecha = H006J2_A46TicketFecha[0];
            A15UsuarioId = H006J2_A15UsuarioId[0];
      ...
      protected void RF6J2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A17EstadoTicketTecnicoId = H006J3_A17EstadoTicketTecnicoId[0];
               A167TicketResponsablePasaTaller = H006J3_A167TicketResponsablePasaTaller[0];
               n167TicketResponsablePasaTaller = H006J3_n167TicketResponsablePasaTaller[0];
               A199TicketTecnicoResponsableNombre = H006J3_A199TicketTecnicoResponsableNombre[0];
               A198TicketTecnicoResponsableId = H006J3_A198TicketTecnicoResponsableId[0];
               A48TicketHora = H006J3_A48TicketHora[0];
               A46TicketFecha = H006J3_A46TicketFecha[0];
               A16TicketResponsableId = H006J3_A16TicketResponsableId[0];
               A14TicketId = H006J3_A14TicketId[0];
               A90UsuarioFecha = H006J3_A90UsuarioFecha[0];
               A89UsuarioEmail = H006J3_A89UsuarioEmail[0];
               A88UsuarioDepartamento = H006J3_A88UsuarioDepartamento[0];
               A94UsuarioRequerimiento = H006J3_A94UsuarioRequerimiento[0];
               A15UsuarioId = H006J3_A15UsuarioId[0];
               A93UsuarioNombre = H006J3_A93UsuarioNombre[0];
               A199TicketTecnicoResponsableNombre = H006J3_A199TicketTecnicoResponsableNombre[0];
               A48TicketHora = H006J3_A48TicketHora[0];
               A46TicketFecha = H006J3_A46TicketFecha[0];
               A15UsuarioId = H006J3_A15UsuarioId[0];
      ...
      private void E186J2( )
      {
         if ( ( subGrid_Islastpage == 1 ) || ( subGrid_Rows == 0 ) || ( ( GRID_nCurrentRecord >= GRID_nFirstRecordOnPage ) && ( GRID_nCurrentRecord < GRID_nFirstRecordOnPage + subGrid_fnc_Recordsperpage( ) ) ) )
         {
            ...
            AV5ActionReasignar_Action = context.GetImagePath( "49aab9cd-117e-44e0-a44a-469a4c44e38d", "", context.GetTheme( ));
            AssignAttri("", false, edtavActionreasignar_action_Internalname, AV5ActionReasignar_Action);
            AV31Actionreasignar_action_GXI = GXDbFile.PathToUrl( context.GetImagePath( "49aab9cd-117e-44e0-a44a-469a4c44e38d", "", context.GetTheme( )));
      ...
      protected void wb_table2_86_6J2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_grid_Internalname, "No hay resultados", "", "", lblI_noresultsfoundtextblock_grid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_WPTecnicoSmartDevice.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_86_6J2e( true) ;
         }
         else
         {
            wb_table2_86_6J2e( false) ;
         }
      }

      protected void wb_table1_24_6J2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_bitmap( context, imgGridsettings_labelgrid_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "K2BT_GridSettingsLabel", "Config. tabla", 0, 0, 0, "px", 0, "px", 0, 0, 7, imgGridsettings_labelgrid_Jsonclick, "'"+""+"'"+",false,"+"'"+"e226j1_client"+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_WPTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGslayoutdefined_gridruntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblGslayoutdefined_gridruntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_WPTecnicoSmartDevice.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavGridsettingsrowsperpage_grid, cmbavGridsettingsrowsperpage_grid_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV13GridSettingsRowsPerPage_Grid), 4, 0)), 1, cmbavGridsettingsrowsperpage_grid_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavGridsettingsrowsperpage_grid.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,50);\"", "", true, 1, "HLP_WPTecnicoSmartDevice.htm");
            cmbavGridsettingsrowsperpage_grid.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV13GridSettingsRowsPerPage_Grid), 4, 0));
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_24_6J2e( true) ;
         }
         else
         {
            wb_table1_24_6J2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188424655", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wptecnicosmartdevice.js", "?2024188424655", false, true);
            context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
            context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
            context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
         }
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "WPTecnico Smart Device";
         subGrid_Rows = 20;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'PAGINGFIRST(GRID)'","{handler:'E116J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV9ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV12GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV10CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV11FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'PAGINGFIRST(GRID)'",",oparms:[{av:'AV10CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'lblPaginationbar_firstpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_previouspagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_currentpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_CURRENTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_nextpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_lastpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_previouspagebuttontextblockgrid_Class',ctrl:'PAGINATIONBAR_PREVIOUSPAGEBUTTONTEXTBLOCKGRID',prop:'Class'},{av:'lblPaginationbar_nextpagebuttontextblockgrid_Class',ctrl:'PAGINATIONBAR_NEXTPAGEBUTTONTEXTBLOCKGRID',prop:'Class'},{av:'lblPaginationbar_firstpagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_spacinglefttextblockgrid_Visible',ctrl:'PAGINATIONBAR_SPACINGLEFTTEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_previouspagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_lastpagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_spacingrighttextblockgrid_Visible',ctrl:'PAGINATIONBAR_SPACINGRIGHTTEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_nextpagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRID',prop:'Visible'},{av:'divPaginationbar_pagingcontainertable_grid_Visible',ctrl:'PAGINATIONBAR_PAGINGCONTAINERTABLE_GRID',prop:'Visible'},{av:'AV11FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("'PAGINGPREVIOUS(GRID)'","{handler:'E126J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV9ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV12GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV10CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV11FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'PAGINGPREVIOUS(GRID)'",",oparms:[{av:'AV10CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'lblPaginationbar_firstpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_previouspagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_currentpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_CURRENTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_nextpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_lastpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_previouspagebuttontextblockgrid_Class',ctrl:'PAGINATIONBAR_PREVIOUSPAGEBUTTONTEXTBLOCKGRID',prop:'Class'},{av:'lblPaginationbar_nextpagebuttontextblockgrid_Class',ctrl:'PAGINATIONBAR_NEXTPAGEBUTTONTEXTBLOCKGRID',prop:'Class'},{av:'lblPaginationbar_firstpagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_spacinglefttextblockgrid_Visible',ctrl:'PAGINATIONBAR_SPACINGLEFTTEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_previouspagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_lastpagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_spacingrighttextblockgrid_Visible',ctrl:'PAGINATIONBAR_SPACINGRIGHTTEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_nextpagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRID',prop:'Visible'},{av:'divPaginationbar_pagingcontainertable_grid_Visible',ctrl:'PAGINATIONBAR_PAGINGCONTAINERTABLE_GRID',prop:'Visible'},{av:'AV11FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("'PAGINGNEXT(GRID)'","{handler:'E136J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV9ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV12GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV10CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV11FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'PAGINGNEXT(GRID)'",",oparms:[{av:'AV10CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'lblPaginationbar_firstpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_previouspagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_currentpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_CURRENTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_nextpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_lastpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_previouspagebuttontextblockgrid_Class',ctrl:'PAGINATIONBAR_PREVIOUSPAGEBUTTONTEXTBLOCKGRID',prop:'Class'},{av:'lblPaginationbar_nextpagebuttontextblockgrid_Class',ctrl:'PAGINATIONBAR_NEXTPAGEBUTTONTEXTBLOCKGRID',prop:'Class'},{av:'lblPaginationbar_firstpagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_spacinglefttextblockgrid_Visible',ctrl:'PAGINATIONBAR_SPACINGLEFTTEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_previouspagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_lastpagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_spacingrighttextblockgrid_Visible',ctrl:'PAGINATIONBAR_SPACINGRIGHTTEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_nextpagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRID',prop:'Visible'},{av:'divPaginationbar_pagingcontainertable_grid_Visible',ctrl:'PAGINATIONBAR_PAGINGCONTAINERTABLE_GRID',prop:'Visible'},{av:'AV11FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("'PAGINGLAST(GRID)'","{handler:'E146J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV9ClassCollection_Grid',fld:'vCLASSCOLLECTION_GRID',pic:''},{av:'AV29Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV12GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV10CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'AV11FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         setEventMetadata("'PAGINGLAST(GRID)'",",oparms:[{av:'AV10CurrentPage_Grid',fld:'vCURRENTPAGE_GRID',pic:'ZZZ9'},{av:'lblPaginationbar_firstpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_previouspagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_currentpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_CURRENTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_nextpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_lastpagetextblockgrid_Caption',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRID',prop:'Caption'},{av:'lblPaginationbar_previouspagebuttontextblockgrid_Class',ctrl:'PAGINATIONBAR_PREVIOUSPAGEBUTTONTEXTBLOCKGRID',prop:'Class'},{av:'lblPaginationbar_nextpagebuttontextblockgrid_Class',ctrl:'PAGINATIONBAR_NEXTPAGEBUTTONTEXTBLOCKGRID',prop:'Class'},{av:'lblPaginationbar_firstpagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_spacinglefttextblockgrid_Visible',ctrl:'PAGINATIONBAR_SPACINGLEFTTEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_previouspagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_lastpagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_spacingrighttextblockgrid_Visible',ctrl:'PAGINATIONBAR_SPACINGRIGHTTEXTBLOCKGRID',prop:'Visible'},{av:'lblPaginationbar_nextpagetextblockgrid_Visible',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRID',prop:'Visible'},{av:'divPaginationbar_pagingcontainertable_grid_Visible',ctrl:'PAGINATIONBAR_PAGINGCONTAINERTABLE_GRID',prop:'Visible'},{av:'AV11FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]}");
         setEventMetadata("'TOGGLEGRIDSETTINGS(GRID)'","{handler:'E226J1',iparms:[{av:'divGridsettings_contentoutertablegrid_Visible',ctrl:'GRIDSETTINGS_CONTENTOUTERTABLEGRID',prop:'Visible'},{av:'AV11FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
         ...
         setEventMetadata("NULL","{handler:'Validv_Actionreasignar_action',iparms:[{av:'AV11FreezeColumnTitles_Grid',fld:'vFREEZECOLUMNTITLES_GRID',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV31Actionreasignar_action_GXI = "";
         scmdbuf = "";
         H006J2_A17EstadoTicketTecnicoId = new short[1] ;
         H006J2_A167TicketResponsablePasaTaller = new bool[] {false} ;
         H006J2_n167TicketResponsablePasaTaller = new bool[] {false} ;
         H006J2_A199TicketTecnicoResponsableNombre = new string[] {""} ;
         H006J2_A198TicketTecnicoResponsableId = new short[1] ;
         H006J2_A48TicketHora = new DateTime[] {DateTime.MinValue} ;
         H006J2_A46TicketFecha = new DateTime[] {DateTime.MinValue} ;
         H006J2_A16TicketResponsableId = new long[1] ;
         H006J2_A14TicketId = new long[1] ;
         H006J2_A90UsuarioFecha = new DateTime[] {DateTime.MinValue} ;
         H006J2_A89UsuarioEmail = new string[] {""} ;
         H006J2_A88UsuarioDepartamento = new string[] {""} ;
         H006J2_A94UsuarioRequerimiento = new string[] {""} ;
         H006J2_A15UsuarioId = new long[1] ;
         H006J2_A93UsuarioNombre = new string[] {""} ;
         AV26WebSession = context.GetSession();
         H006J3_A17EstadoTicketTecnicoId = new short[1] ;
         H006J3_A167TicketResponsablePasaTaller = new bool[] {false} ;
         H006J3_n167TicketResponsablePasaTaller = new bool[] {false} ;
         H006J3_A199TicketTecnicoResponsableNombre = new string[] {""} ;
         H006J3_A198TicketTecnicoResponsableId = new short[1] ;
         H006J3_A48TicketHora = new DateTime[] {DateTime.MinValue} ;
         H006J3_A46TicketFecha = new DateTime[] {DateTime.MinValue} ;
         H006J3_A16TicketResponsableId = new long[1] ;
         H006J3_A14TicketId = new long[1] ;
         H006J3_A90UsuarioFecha = new DateTime[] {DateTime.MinValue} ;
         H006J3_A89UsuarioEmail = new string[] {""} ;
         H006J3_A88UsuarioDepartamento = new string[] {""} ;
         H006J3_A94UsuarioRequerimiento = new string[] {""} ;
         H006J3_A15UsuarioId = new long[1] ;
         H006J3_A93UsuarioNombre = new string[] {""} ;
         ...
         ROClassString = "";
         GXCCtl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wptecnicosmartdevice__default(),
            new Object[][] {
                new Object[] {
               H006J2_A17EstadoTicketTecnicoId, H006J2_A167TicketResponsablePasaTaller, H006J2_n167TicketResponsablePasaTaller, H006J2_A199TicketTecnicoResponsableNombre, H006J2_A198TicketTecnicoResponsableId, H006J2_A48TicketHora, H006J2_A46TicketFecha, H006J2_A16TicketResponsableId, H006J2_A14TicketId, H006J2_A90UsuarioFecha,
               H006J2_A89UsuarioEmail, H006J2_A88UsuarioDepartamento, H006J2_A94UsuarioRequerimiento, H006J2_A15UsuarioId, H006J2_A93UsuarioNombre
               }
               , new Object[] {
               H006J3_A17EstadoTicketTecnicoId, H006J3_A167TicketResponsablePasaTaller, H006J3_n167TicketResponsablePasaTaller, H006J3_A199TicketTecnicoResponsableNombre, H006J3_A198TicketTecnicoResponsableId, H006J3_A48TicketHora, H006J3_A46TicketFecha, H006J3_A16TicketResponsableId, H006J3_A14TicketId, H006J3_A90UsuarioFecha,
               H006J3_A89UsuarioEmail, H006J3_A88UsuarioDepartamento, H006J3_A94UsuarioRequerimiento, H006J3_A15UsuarioId, H006J3_A93UsuarioNombre
               }
            }
         );
         AV29Pgmname = "WPTecnicoSmartDevice";
      ...
      private bool AV5ActionReasignar_Action_IsBlob ;
      ...
      private string AV31Actionreasignar_action_GXI ;
      private string AV16GridStateKey ;
      private string AV6ActionRegistrar_Action ;
      private string AV5ActionReasignar_Action ;
      ...
      private short[] H006J2_A17EstadoTicketTecnicoId ;
      private bool[] H006J2_A167TicketResponsablePasaTaller ;
      private bool[] H006J2_n167TicketResponsablePasaTaller ;
      private string[] H006J2_A199TicketTecnicoResponsableNombre ;
      private short[] H006J2_A198TicketTecnicoResponsableId ;
      private DateTime[] H006J2_A48TicketHora ;
      private DateTime[] H006J2_A46TicketFecha ;
      private long[] H006J2_A16TicketResponsableId ;
      private long[] H006J2_A14TicketId ;
      private DateTime[] H006J2_A90UsuarioFecha ;
      private string[] H006J2_A89UsuarioEmail ;
      private string[] H006J2_A88UsuarioDepartamento ;
      private string[] H006J2_A94UsuarioRequerimiento ;
      private long[] H006J2_A15UsuarioId ;
      private string[] H006J2_A93UsuarioNombre ;
      private short[] H006J3_A17EstadoTicketTecnicoId ;
      private bool[] H006J3_A167TicketResponsablePasaTaller ;
      private bool[] H006J3_n167TicketResponsablePasaTaller ;
      private string[] H006J3_A199TicketTecnicoResponsableNombre ;
      private short[] H006J3_A198TicketTecnicoResponsableId ;
      private DateTime[] H006J3_A48TicketHora ;
      private DateTime[] H006J3_A46TicketFecha ;
      private long[] H006J3_A16TicketResponsableId ;
      private long[] H006J3_A14TicketId ;
      private DateTime[] H006J3_A90UsuarioFecha ;
      private string[] H006J3_A89UsuarioEmail ;
      private string[] H006J3_A88UsuarioDepartamento ;
      private string[] H006J3_A94UsuarioRequerimiento ;
      private long[] H006J3_A15UsuarioId ;
      private string[] H006J3_A93UsuarioNombre ;
   ...
   public class wptecnicosmartdevice__default : DataStoreHelperBase, IDataStoreHelper
   {
