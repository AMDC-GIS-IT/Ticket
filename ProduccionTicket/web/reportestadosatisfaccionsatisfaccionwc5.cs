...
namespace GeneXus.Programs {
   public class reportestadosatisfaccionsatisfaccionwc5 : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
         ...
         try
         {
            ...
            else
            {
               ...
               while ( (pr_default.getStatus(0) != 101) )
               {
                  ...
                  n34SatisfaccionSugerencia = P003B2_n34SatisfaccionSugerencia[0];
      ...
      public override void initialize( )
      {
         ...
         P003B2_n34SatisfaccionSugerencia = new bool[] {false} ;
         P003B2_A94UsuarioRequerimiento = new string[] {""} ;
         P003B2_A93UsuarioNombre = new string[] {""} ;
         P003B2_A15UsuarioId = new long[1] ;
   ...
   public class reportestadosatisfaccionsatisfaccionwc5__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P003B2(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (long)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] , (short)dynConstraints[25] );
         }
