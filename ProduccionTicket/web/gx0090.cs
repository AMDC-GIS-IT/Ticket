...
namespace GeneXus.Programs {
   public class gx0090 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188434431", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB0G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavCtickettecnicoid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cTicketTecnicoId), 10, 0, ".", "")), StringUtil.LTrim( ((edtavCtickettecnicoid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV6cTicketTecnicoId), "ZZZZZZZZZ9") : context.localUtil.Format( (decimal)(AV6cTicketTecnicoId), "ZZZZZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCtickettecnicoid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCtickettecnicoid_Visible, edtavCtickettecnicoid_Enabled, 0, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0090.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCticketid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9cTicketId), 10, 0, ".", "")), StringUtil.LTrim( ((edtavCticketid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV9cTicketId), "ZZZZZZZZZ9") : context.localUtil.Format( (decimal)(AV9cTicketId), "ZZZZZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCticketid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCticketid_Visible, edtavCticketid_Enabled, 0, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0090.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCticketresponsableid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10cTicketResponsableId), 10, 0, ".", "")), StringUtil.LTrim( ((edtavCticketresponsableid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV10cTicketResponsableId), "ZZZZZZZZZ9") : context.localUtil.Format( (decimal)(AV10cTicketResponsableId), "ZZZZZZZZZ9"))), " inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCticketresponsableid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCticketresponsableid_Visible, edtavCticketresponsableid_Enabled, 0, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Gx0090.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void STRUP0G0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( DateTimeUtil.ResetTime ( context.localUtil.CToD( cgiGet( "GXH_vCTICKETTECNICOFECHA"), 2) ) != DateTimeUtil.ResetTime ( AV7cTicketTecnicoFecha ) )
            {
               GRID1_nFirstRecordOnPage = 0;
            }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188434546", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0090.js", "?2024188434548", false, true);
