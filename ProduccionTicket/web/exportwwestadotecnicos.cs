...
namespace GeneXus.Programs {
   public class exportwwestadotecnicos : GXProcedure
   {
                                 ...
                                 out string aP2_OutFile )
      {
         ...
         objexportwwestadotecnicos.AV26OutFile = "" ;
      ...
      void executePrivate( )
      {
         ...
         AV26OutFile = GxDirectory.TemporaryFilesPath + AV22File.Separator + "ExportWWEstadoTecnicos-" + Guid.NewGuid( ).ToString() + ".xlsx";
         ...
         AV14ExcelDocument.get_Cells(AV15CellRow, AV16FirstColumn, 1, 1).Text = "Estado técnicos";
         ...
         {
            AV14ExcelDocument.get_Cells(AV15CellRow, AV16FirstColumn+AV18ColumnIndex, 1, 1).Bold = 1;
            AV14ExcelDocument.get_Cells(AV15CellRow, AV16FirstColumn+AV18ColumnIndex, 1, 1).Text = "Técnicos";
            AV18ColumnIndex = (short)(AV18ColumnIndex+1);
         }
      ...
      protected void S131( )
      {
         ...
         AV11GridColumn.gxTpr_Columntitle = "Técnicos";
         AV11GridColumn.gxTpr_Showattribute = true;
         AV10GridColumns.Add(AV11GridColumn, 0);
