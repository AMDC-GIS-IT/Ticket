...
namespace GeneXus.Programs {
   public class wwetapasdesarrollo : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV24K2BToolsGenericSearchField, AV23ClassCollection, AV25OrderedBy, AV8CurrentPage, AV43Pgmname, AV10GridConfiguration, AV31EtapaDesarrolloNombre_IsAuthorized, AV14Att_EtapaDesarrolloId_Visible, AV15Att_EtapaDesarrolloNombre_Visible, AV16Att_EtapaDesarrolloUsuarioRegistro_Visible, AV11FreezeColumnTitles, AV40Uri) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188425063", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      {
         /* GeneXus formulas. */
         AV43Pgmname = "WWEtapasDesarrollo";
         context.Gx_err = 0;
      }
      ...
      protected void E18772( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         if ( new k2bisauthorizedactivityname(context).executeUdp(  "EtapasDesarrollo",  "EtapasDesarrollo",  "List",  "",  "ExportWWEtapasDesarrollo") )
         {
            new exportwwetapasdesarrollo(context ).execute(  AV24K2BToolsGenericSearchField,  AV25OrderedBy, out  AV38OutFile) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188425393", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwetapasdesarrollo.js", "?2024188425394", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/K2BControlBeautifyRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOFIRST'","{handler:'E14772',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV43Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV31EtapaDesarrolloNombre_IsAuthorized',fld:'vETAPADESARROLLONOMBRE_ISAUTHORIZED',pic:''},{av:'AV40Uri',fld:'vURI',pic:'',hsh:true},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EtapaDesarrolloId_Visible',fld:'vATT_ETAPADESARROLLOID_VISIBLE',pic:''},{av:'AV15Att_EtapaDesarrolloNombre_Visible',fld:'vATT_ETAPADESARROLLONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EtapaDesarrolloUsuarioRegistro_Visible',fld:'vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E15772',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV43Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV31EtapaDesarrolloNombre_IsAuthorized',fld:'vETAPADESARROLLONOMBRE_ISAUTHORIZED',pic:''},{av:'AV40Uri',fld:'vURI',pic:'',hsh:true},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EtapaDesarrolloId_Visible',fld:'vATT_ETAPADESARROLLOID_VISIBLE',pic:''},{av:'AV15Att_EtapaDesarrolloNombre_Visible',fld:'vATT_ETAPADESARROLLONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EtapaDesarrolloUsuarioRegistro_Visible',fld:'vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E16772',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV43Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV31EtapaDesarrolloNombre_IsAuthorized',fld:'vETAPADESARROLLONOMBRE_ISAUTHORIZED',pic:''},{av:'AV40Uri',fld:'vURI',pic:'',hsh:true},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EtapaDesarrolloId_Visible',fld:'vATT_ETAPADESARROLLOID_VISIBLE',pic:''},{av:'AV15Att_EtapaDesarrolloNombre_Visible',fld:'vATT_ETAPADESARROLLONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EtapaDesarrolloUsuarioRegistro_Visible',fld:'vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E17772',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV23ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV8CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV43Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV31EtapaDesarrolloNombre_IsAuthorized',fld:'vETAPADESARROLLONOMBRE_ISAUTHORIZED',pic:''},{av:'AV40Uri',fld:'vURI',pic:'',hsh:true},{ctrl:'REPORT',prop:'Visible'},{ctrl:'EXPORT',prop:'Visible'},{av:'AV14Att_EtapaDesarrolloId_Visible',fld:'vATT_ETAPADESARROLLOID_VISIBLE',pic:''},{av:'AV15Att_EtapaDesarrolloNombre_Visible',fld:'vATT_ETAPADESARROLLONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EtapaDesarrolloUsuarioRegistro_Visible',fld:'vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOEXPORT'","{handler:'E18772',iparms:[{av:'AV24K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV25OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV40Uri',fld:'vURI',pic:'',hsh:true},{av:'AV14Att_EtapaDesarrolloId_Visible',fld:'vATT_ETAPADESARROLLOID_VISIBLE',pic:''},{av:'AV15Att_EtapaDesarrolloNombre_Visible',fld:'vATT_ETAPADESARROLLONOMBRE_VISIBLE',pic:''},{av:'AV16Att_EtapaDesarrolloUsuarioRegistro_Visible',fld:'vATT_ETAPADESARROLLOUSUARIOREGISTRO_VISIBLE',pic:''},{av:'AV11FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
