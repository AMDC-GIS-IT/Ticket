...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="DashboardViewerFiltersChangedData" , Namespace="kb_ticket" )]
	[Serializable]
	public class SdtDashboardViewerFiltersChangedData : GxUserType
	{
		...
		public GXBaseCollection<SdtDashboardViewerFiltersChangedData_ChangedFilter> gxTpr_Changedfilters
		{
			...
			set {
				gxTv_SdtDashboardViewerFiltersChangedData_Changedfilters_N = false;
		...
		{
			gxTv_SdtDashboardViewerFiltersChangedData_Changedfilters_N = true;
		...
		{
			return gxTv_SdtDashboardViewerFiltersChangedData_Changedfilters == null;
		}
		...
		public GXBaseCollection<SdtDashboardViewerFiltersChangedData_Filter> gxTpr_Allfilters
		{
			...
			set {
				gxTv_SdtDashboardViewerFiltersChangedData_Allfilters_N = false;
		...
		{
			gxTv_SdtDashboardViewerFiltersChangedData_Allfilters_N = true;
		...
		{
			return gxTv_SdtDashboardViewerFiltersChangedData_Allfilters == null;
		}
		...
		{
			return (
				ShouldSerializegxTpr_Changedfilters_GxSimpleCollection_Json() ||
		...
		protected bool gxTv_SdtDashboardViewerFiltersChangedData_Changedfilters_N;
		...
		protected bool gxTv_SdtDashboardViewerFiltersChangedData_Allfilters_N;
	...
	[GxUnWrappedJson()]
	[DataContract(Name=@"DashboardViewerFiltersChangedData", Namespace="kb_ticket")]
