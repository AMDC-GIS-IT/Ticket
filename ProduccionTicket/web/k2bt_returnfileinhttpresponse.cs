   ...
   public class k2bt_returnfileinhttpresponse : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      public override void webExecute( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV15Guid = (Guid)(StringUtil.StrToGuid( gxfirstwebparm));
            }
            if ( toggleJsOutput )
            {
            }
      ...
      public void executeSubmit( Guid aP0_Guid )
      {
         ...
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objk2bt_returnfileinhttpresponse);
      }
      ...
      void executePrivate( )
      {
         ...
         AV11FileName = AV16Session.Get(AV15Guid.ToString());
         AV16Session.Set(AV15Guid.ToString(), "");
