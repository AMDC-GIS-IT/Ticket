...
namespace GeneXus.Programs {
   public class wpregistrarticket : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wpregistrarticket( )
      {
      ...
      public wpregistrarticket( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Gridusuario") == 0 )
            {
               ...
               gxgrGridusuario_refresh( subGridusuario_Rows, AV28GenericFilter_GridUsuario, AV33UsuarioNombre_Filter, AV38EstadoTicketUsuarioNombre_Filter, AV22ClassCollection_GridUsuario, AV21OrderedBy_GridUsuario, AV42Pgmname, AV17GridConfiguration, AV18CurrentPage_GridUsuario, AV32FreezeColumnTitles_GridUsuario) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202418842863", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpregistrarticket.aspx") +"\">") ;
      ...
      {
         return formatLink("wpregistrarticket.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WPRegistrarTicket" ;
      }
      ...
      protected void WB5M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;", "div");
            wb_table1_53_5M2( true) ;
         }
         else
         {
            wb_table1_53_5M2( false) ;
         }
         return  ;
      }

      protected void wb_table1_53_5M2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_97_5M2( true) ;
         }
         else
         {
            wb_table2_97_5M2( false) ;
         }
         return  ;
      }

      protected void wb_table2_97_5M2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table3_117_5M2( true) ;
         }
         else
         {
            wb_table3_117_5M2( false) ;
         }
         return  ;
      }

      protected void wb_table3_117_5M2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_previouspagebuttontextblockgridusuario_Internalname, "", "", "", lblPaginationbar_previouspagebuttontextblockgridusuario_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGPREVIOUS(GRIDUSUARIO)\\'."+"'", "", lblPaginationbar_previouspagebuttontextblockgridusuario_Class, 5, "", 1, 1, 0, 0, "HLP_WPRegistrarTicket.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_firstpagetextblockgridusuario_Internalname, lblPaginationbar_firstpagetextblockgridusuario_Caption, "", "", lblPaginationbar_firstpagetextblockgridusuario_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGFIRST(GRIDUSUARIO)\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPaginationbar_firstpagetextblockgridusuario_Visible, 1, 0, 0, "HLP_WPRegistrarTicket.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_spacinglefttextblockgridusuario_Internalname, "...", "", "", lblPaginationbar_spacinglefttextblockgridusuario_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblPaginationbar_spacinglefttextblockgridusuario_Visible, 1, 0, 0, "HLP_WPRegistrarTicket.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_previouspagetextblockgridusuario_Internalname, lblPaginationbar_previouspagetextblockgridusuario_Caption, "", "", lblPaginationbar_previouspagetextblockgridusuario_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGPREVIOUS(GRIDUSUARIO)\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPaginationbar_previouspagetextblockgridusuario_Visible, 1, 0, 0, "HLP_WPRegistrarTicket.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_currentpagetextblockgridusuario_Internalname, lblPaginationbar_currentpagetextblockgridusuario_Caption, "", "", lblPaginationbar_currentpagetextblockgridusuario_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_WPRegistrarTicket.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_nextpagetextblockgridusuario_Internalname, lblPaginationbar_nextpagetextblockgridusuario_Caption, "", "", lblPaginationbar_nextpagetextblockgridusuario_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGNEXT(GRIDUSUARIO)\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPaginationbar_nextpagetextblockgridusuario_Visible, 1, 0, 0, "HLP_WPRegistrarTicket.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_spacingrighttextblockgridusuario_Internalname, "...", "", "", lblPaginationbar_spacingrighttextblockgridusuario_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblPaginationbar_spacingrighttextblockgridusuario_Visible, 1, 0, 0, "HLP_WPRegistrarTicket.htm");
            /* Text block */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPaginationbar_nextpagebuttontextblockgridusuario_Internalname, "", "", "", lblPaginationbar_nextpagebuttontextblockgridusuario_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'PAGINGNEXT(GRIDUSUARIO)\\'."+"'", "", lblPaginationbar_nextpagebuttontextblockgridusuario_Class, 5, "", 1, 1, 0, 0, "HLP_WPRegistrarTicket.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START5M2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Asignar Ticket", 0) ;
         }
         context.wjLoc = "";
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 16), "GRIDUSUARIO.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 19), "GRIDUSUARIO.REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 17), "'E_ASIGNARTICKET'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 17), "'E_ASIGNARTICKET'") == 0 ) )
                           {
                              ...
                              AV39AsignarTicket_Action = cgiGet( edtavAsignarticket_action_Internalname);
                              AssignProp("", false, edtavAsignarticket_action_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV39AsignarTicket_Action)) ? AV43Asignarticket_action_GXI : context.convertURL( context.PathToRelativeUrl( AV39AsignarTicket_Action))), !bGXsfl_100_Refreshing);
                              AssignProp("", false, edtavAsignarticket_action_Internalname, "SrcSet", context.GetImageSrcSet( AV39AsignarTicket_Action), true);
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "'E_ASIGNARTICKET'") == 0 )
                                 {
                                    context.wbHandled = 1;
                                    dynload_actions( ) ;
                                    /* Execute user event: 'E_AsignarTicket' */
                                    E245M2 ();
                                 }
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_USUARIONOMBRE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A93UsuarioNombre, "")), context));
         GxWebStd.gx_hidden_field( context, "USUARIONOMBRE", A93UsuarioNombre);
         GxWebStd.gx_hidden_field( context, "gxhash_USUARIOGERENCIA", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A91UsuarioGerencia, "")), context));
         GxWebStd.gx_hidden_field( context, "USUARIOGERENCIA", A91UsuarioGerencia);
         GxWebStd.gx_hidden_field( context, "gxhash_USUARIODEPARTAMENTO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A88UsuarioDepartamento, "")), context));
         GxWebStd.gx_hidden_field( context, "USUARIODEPARTAMENTO", A88UsuarioDepartamento);
         GxWebStd.gx_hidden_field( context, "gxhash_USUARIOREQUERIMIENTO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A94UsuarioRequerimiento, "")), context));
         GxWebStd.gx_hidden_field( context, "USUARIOREQUERIMIENTO", A94UsuarioRequerimiento);
      }
      ...
      protected void RF5M2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV28GenericFilter_GridUsuario = StringUtil.PadR( StringUtil.RTrim( AV28GenericFilter_GridUsuario), 100, "%");
            /* Using cursor H005M2 */
            pr_default.execute(0, new Object[] {lV33UsuarioNombre_Filter, lV38EstadoTicketUsuarioNombre_Filter, lV28GenericFilter_GridUsuario, lV28GenericFilter_GridUsuario, lV28GenericFilter_GridUsuario, lV28GenericFilter_GridUsuario, lV28GenericFilter_GridUsuario, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_100_idx = 1;
            sGXsfl_100_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_100_idx), 4, 0), 4, "0");
            SubsflControlProps_1002( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGridusuario_Rows == 0 ) || ( GRIDUSUARIO_nCurrentRecord < subGridusuario_fnc_Recordsperpage( ) ) ) ) )
            {
               A190EstadoTicketUsuarioNombre = H005M2_A190EstadoTicketUsuarioNombre[0];
               A189EstadoTicketUsuarioId = H005M2_A189EstadoTicketUsuarioId[0];
               A95UsuarioTelefono = H005M2_A95UsuarioTelefono[0];
               A89UsuarioEmail = H005M2_A89UsuarioEmail[0];
               A94UsuarioRequerimiento = H005M2_A94UsuarioRequerimiento[0];
               A88UsuarioDepartamento = H005M2_A88UsuarioDepartamento[0];
               A91UsuarioGerencia = H005M2_A91UsuarioGerencia[0];
               A92UsuarioHora = H005M2_A92UsuarioHora[0];
               A90UsuarioFecha = H005M2_A90UsuarioFecha[0];
               A15UsuarioId = H005M2_A15UsuarioId[0];
               A93UsuarioNombre = H005M2_A93UsuarioNombre[0];
               A190EstadoTicketUsuarioNombre = H005M2_A190EstadoTicketUsuarioNombre[0];
               E225M2 ();
      ...
      protected void send_integrity_lvl_hashes5M2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV42Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV42Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_USUARIOID"+"_"+sGXsfl_100_idx, GetSecureSignedToken( sGXsfl_100_idx, context.localUtil.Format( (decimal)(A15UsuarioId), "ZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_USUARIONOMBRE"+"_"+sGXsfl_100_idx, GetSecureSignedToken( sGXsfl_100_idx, StringUtil.RTrim( context.localUtil.Format( A93UsuarioNombre, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_USUARIOGERENCIA"+"_"+sGXsfl_100_idx, GetSecureSignedToken( sGXsfl_100_idx, StringUtil.RTrim( context.localUtil.Format( A91UsuarioGerencia, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_USUARIODEPARTAMENTO"+"_"+sGXsfl_100_idx, GetSecureSignedToken( sGXsfl_100_idx, StringUtil.RTrim( context.localUtil.Format( A88UsuarioDepartamento, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_USUARIOREQUERIMIENTO"+"_"+sGXsfl_100_idx, GetSecureSignedToken( sGXsfl_100_idx, StringUtil.RTrim( context.localUtil.Format( A94UsuarioRequerimiento, "")), context));
      }
      ...
      protected int subGridusuario_fnc_Recordcount( )
      {
         ...
         lV28GenericFilter_GridUsuario = StringUtil.PadR( StringUtil.RTrim( AV28GenericFilter_GridUsuario), 100, "%");
         /* Using cursor H005M3 */
         pr_default.execute(1, new Object[] {lV33UsuarioNombre_Filter, lV38EstadoTicketUsuarioNombre_Filter, lV28GenericFilter_GridUsuario, lV28GenericFilter_GridUsuario, lV28GenericFilter_GridUsuario, lV28GenericFilter_GridUsuario, lV28GenericFilter_GridUsuario});
         GRIDUSUARIO_nRecordCount = H005M3_AGRIDUSUARIO_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void E215M2( )
      {
         ...
         new k2bloadrowsperpage(context ).execute(  AV42Pgmname,  "GridUsuario", out  AV24RowsPerPage_GridUsuario, out  AV25RowsPerPageLoaded_GridUsuario) ;
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         new k2bloadgridconfiguration(context ).execute(  AV42Pgmname,  "GridUsuario", ref  AV17GridConfiguration) ;
      ...
      private void E225M2( )
      {
         ...
         AV39AsignarTicket_Action = context.GetImagePath( "5649fbb8-8ce0-4810-a5ce-bd649ea83c3a", "", context.GetTheme( ));
         AssignAttri("", false, edtavAsignarticket_action_Internalname, AV39AsignarTicket_Action);
         AV43Asignarticket_action_GXI = GXDbFile.PathToUrl( context.GetImagePath( "5649fbb8-8ce0-4810-a5ce-bd649ea83c3a", "", context.GetTheme( )));
         edtavAsignarticket_action_Tooltiptext = "Asignar Ticket";
      ...
      protected void S172( )
      {
         ...
         AssignProp("", false, edtUsuarioNombre_Internalname, "Forecolor", StringUtil.LTrimStr( (decimal)(edtUsuarioNombre_Forecolor), 9, 0), !bGXsfl_100_Refreshing);
         edtUsuarioFecha_Forecolor = GXUtil.RGB( 0, 0, 0);
         AssignProp("", false, edtUsuarioFecha_Internalname, "Forecolor", StringUtil.LTrimStr( (decimal)(edtUsuarioFecha_Forecolor), 9, 0), !bGXsfl_100_Refreshing);
         edtUsuarioHora_Forecolor = GXUtil.RGB( 0, 0, 0);
         AssignProp("", false, edtUsuarioHora_Internalname, "Forecolor", StringUtil.LTrimStr( (decimal)(edtUsuarioHora_Forecolor), 9, 0), !bGXsfl_100_Refreshing);
         edtUsuarioGerencia_Forecolor = GXUtil.RGB( 0, 0, 0);
         AssignProp("", false, edtUsuarioGerencia_Internalname, "Forecolor", StringUtil.LTrimStr( (decimal)(edtUsuarioGerencia_Forecolor), 9, 0), !bGXsfl_100_Refreshing);
         edtUsuarioDepartamento_Forecolor = GXUtil.RGB( 0, 0, 0);
         AssignProp("", false, edtUsuarioDepartamento_Internalname, "Forecolor", StringUtil.LTrimStr( (decimal)(edtUsuarioDepartamento_Forecolor), 9, 0), !bGXsfl_100_Refreshing);
         edtUsuarioRequerimiento_Forecolor = GXUtil.RGB( 0, 0, 0);
         AssignProp("", false, edtUsuarioRequerimiento_Internalname, "Forecolor", StringUtil.LTrimStr( (decimal)(edtUsuarioRequerimiento_Forecolor), 9, 0), !bGXsfl_100_Refreshing);
         edtEstadoTicketUsuarioNombre_Forecolor = GXUtil.RGB( 0, 0, 0);
         AssignProp("", false, edtEstadoTicketUsuarioNombre_Internalname, "Forecolor", StringUtil.LTrimStr( (decimal)(edtEstadoTicketUsuarioNombre_Forecolor), 9, 0), !bGXsfl_100_Refreshing);
      }
      ...
      protected void S182( )
      {
         ...
         AV14GridStateFilterValue.gxTpr_Value = AV38EstadoTicketUsuarioNombre_Filter;
         AV13GridState.gxTpr_Filtervalues.Add(AV14GridStateFilterValue, 0);
         AV14GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
      ...
      protected void S152( )
      {
         ...
         AssignAttri("", false, "AV21OrderedBy_GridUsuario", StringUtil.LTrimStr( (decimal)(AV21OrderedBy_GridUsuario), 4, 0));
         AV44GXV1 = 1;
         while ( AV44GXV1 <= AV13GridState.gxTpr_Filtervalues.Count )
         {
            AV14GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV13GridState.gxTpr_Filtervalues.Item(AV44GXV1));
            ...
            {
               AV38EstadoTicketUsuarioNombre_Filter = AV14GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV38EstadoTicketUsuarioNombre_Filter", AV38EstadoTicketUsuarioNombre_Filter);
            }
      ...
      protected void E175M2( )
      {
         ...
         new k2bsavegridconfiguration(context ).execute(  AV42Pgmname,  "GridUsuario",  AV17GridConfiguration,  true) ;
         ...
         if ( AV24RowsPerPage_GridUsuario != AV26GridSettingsRowsPerPage_GridUsuario )
         {
            ...
            AssignAttri("", false, "AV24RowsPerPage_GridUsuario", StringUtil.LTrimStr( (decimal)(AV24RowsPerPage_GridUsuario), 4, 0));
            new k2bsaverowsperpage(context ).execute(  AV42Pgmname,  "GridUsuario",  AV24RowsPerPage_GridUsuario) ;
            AV18CurrentPage_GridUsuario = 1;
            AssignAttri("", false, "AV18CurrentPage_GridUsuario", StringUtil.LTrimStr( (decimal)(AV18CurrentPage_GridUsuario), 4, 0));
            subgridusuario_firstpage( ) ;
         }
      ...
      protected void S162( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV38EstadoTicketUsuarioNombre_Filter)) )
         {
            ...
            AV16K2BFilterValuesSDTItem_WebForm.gxTpr_Type = "Standard";
            AV16K2BFilterValuesSDTItem_WebForm.gxTpr_Value = AV38EstadoTicketUsuarioNombre_Filter;
            AV16K2BFilterValuesSDTItem_WebForm.gxTpr_Valuedescription = AV38EstadoTicketUsuarioNombre_Filter;
            AV15K2BFilterValuesSDT_WebForm.Add(AV16K2BFilterValuesSDTItem_WebForm, 0);
         }
         ...
         if ( AV15K2BFilterValuesSDT_WebForm.Count > 0 )
         {
            ...
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV42Pgmname,  "GridUsuario",  AV15K2BFilterValuesSDT_WebForm, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item2) ;
      ...
      {
         /* 'E_AsignarTicket' Routine */
         returnInSub = false;
         /* Execute user subroutine: 'U_ASIGNARTICKET' */
         S212 ();
         if ( returnInSub )
         {
            returnInSub = true;
      ...
      protected void S212( )
      {
         /* 'U_ASIGNARTICKET' Routine */
         returnInSub = false;
         context.PopUp(formatLink("wpcolaticket.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A15UsuarioId,10,0)),UrlEncode(StringUtil.RTrim(A93UsuarioNombre)),UrlEncode(StringUtil.RTrim(A91UsuarioGerencia)),UrlEncode(StringUtil.RTrim(A88UsuarioDepartamento)),UrlEncode(StringUtil.RTrim(A94UsuarioRequerimiento))}, new string[] {"UsuarioId","UsuarioNombre","UsuarioGerencia","UsuarioDepartamento","UsuarioRequerimiento"}) , new Object[] {});
         context.DoAjaxRefresh();
      }

      protected void wb_table3_117_5M2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblI_noresultsfoundtextblock_gridusuario_Internalname, "No hay resultados", "", "", lblI_noresultsfoundtextblock_gridusuario_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_WPRegistrarTicket.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_117_5M2e( true) ;
         }
         else
         {
            wb_table3_117_5M2e( false) ;
         }
      }

      protected void wb_table2_97_5M2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            else
            {
               ...
               GridusuarioContainer.AddColumnProperties(GridusuarioColumn);
               GridusuarioColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridusuarioColumn.AddObjectProperty("Value", context.convertURL( AV39AsignarTicket_Action));
               GridusuarioColumn.AddObjectProperty("Tooltiptext", StringUtil.RTrim( edtavAsignarticket_action_Tooltiptext));
               GridusuarioContainer.AddColumnProperties(GridusuarioColumn);
         ...
         if ( wbEnd == 100 )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_97_5M2e( true) ;
         }
         else
         {
            wb_table2_97_5M2e( false) ;
         }
      }

      protected void wb_table1_53_5M2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGslayoutdefined_gridusuarioruntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblGslayoutdefined_gridusuarioruntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_WPRegistrarTicket.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_53_5M2e( true) ;
         }
         else
         {
            wb_table1_53_5M2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188421236", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpregistrarticket.js", "?2024188421238", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BOrderBy/K2BOrderByRender.js", "", false, true);
         context.AddJavascriptSource("K2BControlBeautify/toastr-master/toastr.min.js", "", false, true);
      ...
      protected void SubsflControlProps_1002( )
      {
         ...
         edtavAsignarticket_action_Internalname = "vASIGNARTICKET_ACTION_"+sGXsfl_100_idx;
      }
      ...
      protected void SubsflControlProps_fel_1002( )
      {
         ...
         edtavAsignarticket_action_Internalname = "vASIGNARTICKET_ACTION_"+sGXsfl_100_fel_idx;
      }
      ...
      protected void sendrow_1002( )
      {
         ...
         if ( ( subGridusuario_Rows * 1 == 0 ) || ( nGXsfl_100_idx <= subGridusuario_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            TempTags = " " + ((edtavAsignarticket_action_Enabled!=0)&&(edtavAsignarticket_action_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 112,'',false,'',100)\"" : " ");
            ClassString = "Image_Action";
            StyleString = "";
            AV39AsignarTicket_Action_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV39AsignarTicket_Action))&&String.IsNullOrEmpty(StringUtil.RTrim( AV43Asignarticket_action_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV39AsignarTicket_Action)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV39AsignarTicket_Action)) ? AV43Asignarticket_action_GXI : context.PathToRelativeUrl( AV39AsignarTicket_Action));
            GridusuarioRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtavAsignarticket_action_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)1,(string)"Asignar Ticket",(string)edtavAsignarticket_action_Tooltiptext,(short)0,(short)1,(short)20,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)5,(string)edtavAsignarticket_action_Jsonclick,"'"+""+"'"+",false,"+"'"+"E\\'E_ASIGNARTICKET\\'."+sGXsfl_100_idx+"'",(string)StyleString,(string)ClassString,(string)"K2BToolsGridColumn ActionColumn ActionVisibleOnRowHover",(string)"",(string)"",(string)"",(string)""+TempTags,(string)"",(string)"",(short)1,(bool)AV39AsignarTicket_Action_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
      ...
      protected void init_default_properties( )
      {
         ...
         edtavAsignarticket_action_Internalname = "vASIGNARTICKET_ACTION";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavAsignarticket_action_Jsonclick = "";
         edtavAsignarticket_action_Visible = -1;
         edtavAsignarticket_action_Enabled = 1;
         ...
         edtavAsignarticket_action_Tooltiptext = "";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ORDERBYUC_GRIDUSUARIO.ORDERBYCHANGED","{handler:'E125M2',iparms:[{av:'GRIDUSUARIO_nFirstRecordOnPage'},{av:'GRIDUSUARIO_nEOF'},{av:'subGridusuario_Rows',ctrl:'GRIDUSUARIO',prop:'Rows'},{av:'AV28GenericFilter_GridUsuario',fld:'vGENERICFILTER_GRIDUSUARIO',pic:''},{av:'AV33UsuarioNombre_Filter',fld:'vUSUARIONOMBRE_FILTER',pic:''},{av:'AV38EstadoTicketUsuarioNombre_Filter',fld:'vESTADOTICKETUSUARIONOMBRE_FILTER',pic:''},{av:'AV22ClassCollection_GridUsuario',fld:'vCLASSCOLLECTION_GRIDUSUARIO',pic:''},{av:'AV21OrderedBy_GridUsuario',fld:'vORDEREDBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV29SelectedOrderBy_GridUsuario',fld:'vSELECTEDORDERBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         setEventMetadata("ORDERBYUC_GRIDUSUARIO.ORDERBYCHANGED",",oparms:[{av:'AV21OrderedBy_GridUsuario',fld:'vORDEREDBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'divMaingrid_responsivetable_gridusuario_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRIDUSUARIO',prop:'Class'},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV22ClassCollection_GridUsuario',fld:'vCLASSCOLLECTION_GRIDUSUARIO',pic:''},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]}");
         setEventMetadata("GRIDUSUARIO.LOAD","{handler:'E225M2',iparms:[{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         setEventMetadata("GRIDUSUARIO.LOAD",",oparms:[{av:'tblI_noresultsfoundtablename_gridusuario_Visible',ctrl:'I_NORESULTSFOUNDTABLENAME_GRIDUSUARIO',prop:'Visible'},{av:'AV39AsignarTicket_Action',fld:'vASIGNARTICKET_ACTION',pic:''},{av:'edtavAsignarticket_action_Tooltiptext',ctrl:'vASIGNARTICKET_ACTION',prop:'Tooltiptext'},{av:'edtUsuarioNombre_Forecolor',ctrl:'USUARIONOMBRE',prop:'Forecolor'},{av:'edtUsuarioFecha_Forecolor',ctrl:'USUARIOFECHA',prop:'Forecolor'},{av:'edtUsuarioHora_Forecolor',ctrl:'USUARIOHORA',prop:'Forecolor'},{av:'edtUsuarioGerencia_Forecolor',ctrl:'USUARIOGERENCIA',prop:'Forecolor'},{av:'edtUsuarioDepartamento_Forecolor',ctrl:'USUARIODEPARTAMENTO',prop:'Forecolor'},{av:'edtUsuarioRequerimiento_Forecolor',ctrl:'USUARIOREQUERIMIENTO',prop:'Forecolor'},{av:'edtEstadoTicketUsuarioNombre_Forecolor',ctrl:'ESTADOTICKETUSUARIONOMBRE',prop:'Forecolor'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]}");
         setEventMetadata("GRIDUSUARIO.REFRESH","{handler:'E235M2',iparms:[{av:'AV22ClassCollection_GridUsuario',fld:'vCLASSCOLLECTION_GRIDUSUARIO',pic:''},{av:'AV21OrderedBy_GridUsuario',fld:'vORDEREDBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV33UsuarioNombre_Filter',fld:'vUSUARIONOMBRE_FILTER',pic:''},{av:'AV38EstadoTicketUsuarioNombre_Filter',fld:'vESTADOTICKETUSUARIONOMBRE_FILTER',pic:''},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'GRIDUSUARIO_nFirstRecordOnPage'},{av:'GRIDUSUARIO_nEOF'},{av:'subGridusuario_Rows',ctrl:'GRIDUSUARIO',prop:'Rows'},{av:'AV28GenericFilter_GridUsuario',fld:'vGENERICFILTER_GRIDUSUARIO',pic:''},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         ...
         setEventMetadata("'PAGINGFIRST(GRIDUSUARIO)'","{handler:'E135M2',iparms:[{av:'GRIDUSUARIO_nFirstRecordOnPage'},{av:'GRIDUSUARIO_nEOF'},{av:'subGridusuario_Rows',ctrl:'GRIDUSUARIO',prop:'Rows'},{av:'AV28GenericFilter_GridUsuario',fld:'vGENERICFILTER_GRIDUSUARIO',pic:''},{av:'AV33UsuarioNombre_Filter',fld:'vUSUARIONOMBRE_FILTER',pic:''},{av:'AV38EstadoTicketUsuarioNombre_Filter',fld:'vESTADOTICKETUSUARIONOMBRE_FILTER',pic:''},{av:'AV22ClassCollection_GridUsuario',fld:'vCLASSCOLLECTION_GRIDUSUARIO',pic:''},{av:'AV21OrderedBy_GridUsuario',fld:'vORDEREDBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         setEventMetadata("'PAGINGFIRST(GRIDUSUARIO)'",",oparms:[{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'lblPaginationbar_firstpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_previouspagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_currentpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_CURRENTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_nextpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_lastpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_previouspagebuttontextblockgridusuario_Class',ctrl:'PAGINATIONBAR_PREVIOUSPAGEBUTTONTEXTBLOCKGRIDUSUARIO',prop:'Class'},{av:'lblPaginationbar_nextpagebuttontextblockgridusuario_Class',ctrl:'PAGINATIONBAR_NEXTPAGEBUTTONTEXTBLOCKGRIDUSUARIO',prop:'Class'},{av:'lblPaginationbar_firstpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_spacinglefttextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_SPACINGLEFTTEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_previouspagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_lastpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_spacingrighttextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_SPACINGRIGHTTEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_nextpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'divPaginationbar_pagingcontainertable_gridusuario_Visible',ctrl:'PAGINATIONBAR_PAGINGCONTAINERTABLE_GRIDUSUARIO',prop:'Visible'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]}");
         setEventMetadata("'PAGINGPREVIOUS(GRIDUSUARIO)'","{handler:'E145M2',iparms:[{av:'GRIDUSUARIO_nFirstRecordOnPage'},{av:'GRIDUSUARIO_nEOF'},{av:'subGridusuario_Rows',ctrl:'GRIDUSUARIO',prop:'Rows'},{av:'AV28GenericFilter_GridUsuario',fld:'vGENERICFILTER_GRIDUSUARIO',pic:''},{av:'AV33UsuarioNombre_Filter',fld:'vUSUARIONOMBRE_FILTER',pic:''},{av:'AV38EstadoTicketUsuarioNombre_Filter',fld:'vESTADOTICKETUSUARIONOMBRE_FILTER',pic:''},{av:'AV22ClassCollection_GridUsuario',fld:'vCLASSCOLLECTION_GRIDUSUARIO',pic:''},{av:'AV21OrderedBy_GridUsuario',fld:'vORDEREDBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         setEventMetadata("'PAGINGPREVIOUS(GRIDUSUARIO)'",",oparms:[{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'lblPaginationbar_firstpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_previouspagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_currentpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_CURRENTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_nextpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_lastpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_previouspagebuttontextblockgridusuario_Class',ctrl:'PAGINATIONBAR_PREVIOUSPAGEBUTTONTEXTBLOCKGRIDUSUARIO',prop:'Class'},{av:'lblPaginationbar_nextpagebuttontextblockgridusuario_Class',ctrl:'PAGINATIONBAR_NEXTPAGEBUTTONTEXTBLOCKGRIDUSUARIO',prop:'Class'},{av:'lblPaginationbar_firstpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_spacinglefttextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_SPACINGLEFTTEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_previouspagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_lastpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_spacingrighttextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_SPACINGRIGHTTEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_nextpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'divPaginationbar_pagingcontainertable_gridusuario_Visible',ctrl:'PAGINATIONBAR_PAGINGCONTAINERTABLE_GRIDUSUARIO',prop:'Visible'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]}");
         setEventMetadata("'PAGINGNEXT(GRIDUSUARIO)'","{handler:'E155M2',iparms:[{av:'GRIDUSUARIO_nFirstRecordOnPage'},{av:'GRIDUSUARIO_nEOF'},{av:'subGridusuario_Rows',ctrl:'GRIDUSUARIO',prop:'Rows'},{av:'AV28GenericFilter_GridUsuario',fld:'vGENERICFILTER_GRIDUSUARIO',pic:''},{av:'AV33UsuarioNombre_Filter',fld:'vUSUARIONOMBRE_FILTER',pic:''},{av:'AV38EstadoTicketUsuarioNombre_Filter',fld:'vESTADOTICKETUSUARIONOMBRE_FILTER',pic:''},{av:'AV22ClassCollection_GridUsuario',fld:'vCLASSCOLLECTION_GRIDUSUARIO',pic:''},{av:'AV21OrderedBy_GridUsuario',fld:'vORDEREDBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         setEventMetadata("'PAGINGNEXT(GRIDUSUARIO)'",",oparms:[{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'lblPaginationbar_firstpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_previouspagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_currentpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_CURRENTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_nextpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_lastpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_previouspagebuttontextblockgridusuario_Class',ctrl:'PAGINATIONBAR_PREVIOUSPAGEBUTTONTEXTBLOCKGRIDUSUARIO',prop:'Class'},{av:'lblPaginationbar_nextpagebuttontextblockgridusuario_Class',ctrl:'PAGINATIONBAR_NEXTPAGEBUTTONTEXTBLOCKGRIDUSUARIO',prop:'Class'},{av:'lblPaginationbar_firstpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_spacinglefttextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_SPACINGLEFTTEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_previouspagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_lastpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_spacingrighttextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_SPACINGRIGHTTEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_nextpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'divPaginationbar_pagingcontainertable_gridusuario_Visible',ctrl:'PAGINATIONBAR_PAGINGCONTAINERTABLE_GRIDUSUARIO',prop:'Visible'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]}");
         setEventMetadata("'PAGINGLAST(GRIDUSUARIO)'","{handler:'E165M2',iparms:[{av:'GRIDUSUARIO_nFirstRecordOnPage'},{av:'GRIDUSUARIO_nEOF'},{av:'subGridusuario_Rows',ctrl:'GRIDUSUARIO',prop:'Rows'},{av:'AV28GenericFilter_GridUsuario',fld:'vGENERICFILTER_GRIDUSUARIO',pic:''},{av:'AV33UsuarioNombre_Filter',fld:'vUSUARIONOMBRE_FILTER',pic:''},{av:'AV38EstadoTicketUsuarioNombre_Filter',fld:'vESTADOTICKETUSUARIONOMBRE_FILTER',pic:''},{av:'AV22ClassCollection_GridUsuario',fld:'vCLASSCOLLECTION_GRIDUSUARIO',pic:''},{av:'AV21OrderedBy_GridUsuario',fld:'vORDEREDBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         setEventMetadata("'PAGINGLAST(GRIDUSUARIO)'",",oparms:[{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'lblPaginationbar_firstpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_previouspagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_currentpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_CURRENTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_nextpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_lastpagetextblockgridusuario_Caption',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRIDUSUARIO',prop:'Caption'},{av:'lblPaginationbar_previouspagebuttontextblockgridusuario_Class',ctrl:'PAGINATIONBAR_PREVIOUSPAGEBUTTONTEXTBLOCKGRIDUSUARIO',prop:'Class'},{av:'lblPaginationbar_nextpagebuttontextblockgridusuario_Class',ctrl:'PAGINATIONBAR_NEXTPAGEBUTTONTEXTBLOCKGRIDUSUARIO',prop:'Class'},{av:'lblPaginationbar_firstpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_FIRSTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_spacinglefttextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_SPACINGLEFTTEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_previouspagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_PREVIOUSPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_lastpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_LASTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_spacingrighttextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_SPACINGRIGHTTEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'lblPaginationbar_nextpagetextblockgridusuario_Visible',ctrl:'PAGINATIONBAR_NEXTPAGETEXTBLOCKGRIDUSUARIO',prop:'Visible'},{av:'divPaginationbar_pagingcontainertable_gridusuario_Visible',ctrl:'PAGINATIONBAR_PAGINGCONTAINERTABLE_GRIDUSUARIO',prop:'Visible'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]}");
         setEventMetadata("'TOGGLEGRIDSETTINGS(GRIDUSUARIO)'","{handler:'E255M1',iparms:[{av:'divGridsettings_contentoutertablegridusuario_Visible',ctrl:'GRIDSETTINGS_CONTENTOUTERTABLEGRIDUSUARIO',prop:'Visible'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         ...
         setEventMetadata("FILTERTAGSUSERCONTROL_GRIDUSUARIO.TAGDELETED","{handler:'E115M2',iparms:[{av:'GRIDUSUARIO_nFirstRecordOnPage'},{av:'GRIDUSUARIO_nEOF'},{av:'subGridusuario_Rows',ctrl:'GRIDUSUARIO',prop:'Rows'},{av:'AV28GenericFilter_GridUsuario',fld:'vGENERICFILTER_GRIDUSUARIO',pic:''},{av:'AV33UsuarioNombre_Filter',fld:'vUSUARIONOMBRE_FILTER',pic:''},{av:'AV38EstadoTicketUsuarioNombre_Filter',fld:'vESTADOTICKETUSUARIONOMBRE_FILTER',pic:''},{av:'AV22ClassCollection_GridUsuario',fld:'vCLASSCOLLECTION_GRIDUSUARIO',pic:''},{av:'AV21OrderedBy_GridUsuario',fld:'vORDEREDBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV20DeletedTag_GridUsuario',fld:'vDELETEDTAG_GRIDUSUARIO',pic:''},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         ...
         setEventMetadata("LAYOUTDEFINED_FILTERTOGGLE_COMBINED_GRIDUSUARIO.CLICK","{handler:'E185M2',iparms:[{av:'divLayoutdefined_filtercollapsiblesection_combined_gridusuario_Visible',ctrl:'LAYOUTDEFINED_FILTERCOLLAPSIBLESECTION_COMBINED_GRIDUSUARIO',prop:'Visible'},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         ...
         setEventMetadata("LAYOUTDEFINED_FILTERCLOSE_COMBINED_GRIDUSUARIO.CLICK","{handler:'E195M2',iparms:[{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         ...
         setEventMetadata("'E_ASIGNARTICKET'","{handler:'E245M2',iparms:[{av:'GRIDUSUARIO_nFirstRecordOnPage'},{av:'GRIDUSUARIO_nEOF'},{av:'subGridusuario_Rows',ctrl:'GRIDUSUARIO',prop:'Rows'},{av:'AV28GenericFilter_GridUsuario',fld:'vGENERICFILTER_GRIDUSUARIO',pic:''},{av:'AV33UsuarioNombre_Filter',fld:'vUSUARIONOMBRE_FILTER',pic:''},{av:'AV38EstadoTicketUsuarioNombre_Filter',fld:'vESTADOTICKETUSUARIONOMBRE_FILTER',pic:''},{av:'AV22ClassCollection_GridUsuario',fld:'vCLASSCOLLECTION_GRIDUSUARIO',pic:''},{av:'AV21OrderedBy_GridUsuario',fld:'vORDEREDBY_GRIDUSUARIO',pic:'ZZZ9'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'A15UsuarioId',fld:'USUARIOID',pic:'ZZZZZZZZZ9',hsh:true},{av:'A93UsuarioNombre',fld:'USUARIONOMBRE',pic:'',hsh:true},{av:'A91UsuarioGerencia',fld:'USUARIOGERENCIA',pic:'',hsh:true},{av:'A88UsuarioDepartamento',fld:'USUARIODEPARTAMENTO',pic:'',hsh:true},{av:'A94UsuarioRequerimiento',fld:'USUARIOREQUERIMIENTO',pic:'',hsh:true},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
         setEventMetadata("'E_ASIGNARTICKET'",",oparms:[{av:'AV18CurrentPage_GridUsuario',fld:'vCURRENTPAGE_GRIDUSUARIO',pic:'ZZZ9'},{av:'divMaingrid_responsivetable_gridusuario_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRIDUSUARIO',prop:'Class'},{av:'AV17GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV22ClassCollection_GridUsuario',fld:'vCLASSCOLLECTION_GRIDUSUARIO',pic:''},{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]}");
         ...
         setEventMetadata("NULL","{handler:'Validv_Asignarticket_action',iparms:[{av:'AV32FreezeColumnTitles_GridUsuario',fld:'vFREEZECOLUMNTITLES_GRIDUSUARIO',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         A89UsuarioEmail = "";
         A190EstadoTicketUsuarioNombre = "";
         AV39AsignarTicket_Action = "";
         AV43Asignarticket_action_GXI = "";
         scmdbuf = "";
         lV33UsuarioNombre_Filter = "";
         lV38EstadoTicketUsuarioNombre_Filter = "";
         lV28GenericFilter_GridUsuario = "";
         H005M2_A190EstadoTicketUsuarioNombre = new string[] {""} ;
         H005M2_A189EstadoTicketUsuarioId = new short[1] ;
         H005M2_A95UsuarioTelefono = new int[1] ;
         H005M2_A89UsuarioEmail = new string[] {""} ;
         H005M2_A94UsuarioRequerimiento = new string[] {""} ;
         H005M2_A88UsuarioDepartamento = new string[] {""} ;
         H005M2_A91UsuarioGerencia = new string[] {""} ;
         H005M2_A92UsuarioHora = new DateTime[] {DateTime.MinValue} ;
         H005M2_A90UsuarioFecha = new DateTime[] {DateTime.MinValue} ;
         H005M2_A15UsuarioId = new long[1] ;
         H005M2_A93UsuarioNombre = new string[] {""} ;
         H005M3_AGRIDUSUARIO_nRecordCount = new long[1] ;
         ...
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpregistrarticket__default(),
            new Object[][] {
                new Object[] {
               H005M2_A190EstadoTicketUsuarioNombre, H005M2_A189EstadoTicketUsuarioId, H005M2_A95UsuarioTelefono, H005M2_A89UsuarioEmail, H005M2_A94UsuarioRequerimiento, H005M2_A88UsuarioDepartamento, H005M2_A91UsuarioGerencia, H005M2_A92UsuarioHora, H005M2_A90UsuarioFecha, H005M2_A15UsuarioId,
               H005M2_A93UsuarioNombre
               }
               , new Object[] {
               H005M3_AGRIDUSUARIO_nRecordCount
               }
            }
         );
         AV42Pgmname = "WPRegistrarTicket";
      ...
      private int edtavAsignarticket_action_Enabled ;
      private int edtavAsignarticket_action_Visible ;
      ...
      private string edtavAsignarticket_action_Internalname ;
      ...
      private string edtavAsignarticket_action_Tooltiptext ;
      ...
      private string edtavAsignarticket_action_Jsonclick ;
      ...
      private bool AV39AsignarTicket_Action_IsBlob ;
      ...
      private string AV43Asignarticket_action_GXI ;
      ...
      private string AV39AsignarTicket_Action ;
      ...
      private string[] H005M2_A190EstadoTicketUsuarioNombre ;
      private short[] H005M2_A189EstadoTicketUsuarioId ;
      private int[] H005M2_A95UsuarioTelefono ;
      private string[] H005M2_A89UsuarioEmail ;
      private string[] H005M2_A94UsuarioRequerimiento ;
      private string[] H005M2_A88UsuarioDepartamento ;
      private string[] H005M2_A91UsuarioGerencia ;
      private DateTime[] H005M2_A92UsuarioHora ;
      private DateTime[] H005M2_A90UsuarioFecha ;
      private long[] H005M2_A15UsuarioId ;
      private string[] H005M2_A93UsuarioNombre ;
      private long[] H005M3_AGRIDUSUARIO_nRecordCount ;
   ...
   public class wpregistrarticket__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A189EstadoTicketUsuarioId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T2.[EstadoTicketNombre] AS EstadoTicketUsuarioNombre, T1.[EstadoTicketUsuarioId] AS EstadoTicketUsuarioId, T1.[UsuarioTelefono], T1.[UsuarioEmail], T1.[UsuarioRequerimiento], T1.[UsuarioDepartamento], T1.[UsuarioGerencia], T1.[UsuarioHora], T1.[UsuarioFecha], T1.[UsuarioId], T1.[UsuarioNombre]";
         sFromString = " FROM ([Usuario] T1 INNER JOIN [EstadoTicket] T2 ON T2.[EstadoTicketId] = T1.[EstadoTicketUsuarioId])";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.[EstadoTicketUsuarioId] = 1)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV33UsuarioNombre_Filter)) )
         {
         ...
         {
            AddWhere(sWhereString, "(T1.[UsuarioNombre] like '%' + @lV28GenericFilter_GridUsuario + '%' or T1.[UsuarioGerencia] like '%' + @lV28GenericFilter_GridUsuario + '%' or T1.[UsuarioDepartamento] like '%' + @lV28GenericFilter_GridUsuario + '%' or T1.[UsuarioRequerimiento] like '%' + @lV28GenericFilter_GridUsuario + '%' or T2.[EstadoTicketNombre] like '%' + @lV28GenericFilter_GridUsuario + '%')");
         }
         else
         {
            GXv_int3[2] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H005M2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] );
               case 1 :
                     return conditional_H005M3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H005M2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005M2,21, GxCacheFrequency.OFF ,true,false )
