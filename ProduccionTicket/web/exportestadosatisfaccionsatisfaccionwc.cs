...
namespace GeneXus.Programs {
   public class exportestadosatisfaccionsatisfaccionwc : GXProcedure
   {
      ...
      public string executeUdp( short aP0_SatisfaccionResueltoId ,
                                DateTime aP1_SatisfaccionFecha_From ,
                                DateTime aP2_SatisfaccionFecha_To ,
                                DateTime aP3_UsuarioFecha_From ,
                                DateTime aP4_UsuarioFecha_To ,
                                 ...
                                 out string aP12_OutFile )
      {
         ...
         objexportestadosatisfaccionsatisfaccionwc.AV50OutFile = "" ;
      ...
      void executePrivate( )
      {
         ...
         AV50OutFile = GxDirectory.TemporaryFilesPath + AV30File.Separator + "ExportEstadoSatisfaccionSatisfaccionWC-" + Guid.NewGuid( ).ToString() + ".xlsx";
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            n34SatisfaccionSugerencia = P002Z3_n34SatisfaccionSugerencia[0];
      ...
      public override void initialize( )
      {
         ...
         P002Z3_n34SatisfaccionSugerencia = new bool[] {false} ;
         P002Z3_A94UsuarioRequerimiento = new string[] {""} ;
         P002Z3_A93UsuarioNombre = new string[] {""} ;
         P002Z3_A15UsuarioId = new long[1] ;
   ...
   public class exportestadosatisfaccionsatisfaccionwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_P002Z3(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (long)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] , (short)dynConstraints[25] );
         }
