...
namespace GeneXus.Programs {
   public class exportusuarioticketwc : GXProcedure
   {
      ...
      public string executeUdp( long aP0_UsuarioId ,
                                ...
                                short aP6_OrderedBy )
      {
         execute(aP0_UsuarioId, aP1_TicketFecha_From, aP2_TicketFecha_To, aP3_TicketHora_From, aP4_TicketHora_To, aP5_K2BToolsGenericSearchField, aP6_OrderedBy, out aP7_OutFile);
         return AV54OutFile ;
      }
                                 ...
                                 out string aP7_OutFile )
      {
         ...
         objexportusuarioticketwc.AV54OutFile = "" ;
      ...
      void executePrivate( )
      {
         ...
         AV54OutFile = GxDirectory.TemporaryFilesPath + AV25File.Separator + "ExportUsuarioTicketWC-" + Guid.NewGuid( ).ToString() + ".xlsx";
         AV17ExcelDocument.Open(AV54OutFile);
         ...
         {
            AV17ExcelDocument.get_Cells(AV18CellRow, AV19FirstColumn+AV21ColumnIndex, 1, 1).Bold = 1;
            AV17ExcelDocument.get_Cells(AV18CellRow, AV19FirstColumn+AV21ColumnIndex, 1, 1).Text = "Internet/Router/Access Point";
            AV21ColumnIndex = (short)(AV21ColumnIndex+1);
         }
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            n53TicketLaptop = P003J3_n53TicketLaptop[0];
            A42TicketDesktop = P003J3_A42TicketDesktop[0];
            n42TicketDesktop = P003J3_n42TicketDesktop[0];
            A55TicketMonitor = P003J3_A55TicketMonitor[0];
            n55TicketMonitor = P003J3_n55TicketMonitor[0];
            A50TicketImpresora = P003J3_A50TicketImpresora[0];
            n50TicketImpresora = P003J3_n50TicketImpresora[0];
            A45TicketEscaner = P003J3_A45TicketEscaner[0];
            n45TicketEscaner = P003J3_n45TicketEscaner[0];
            A59TicketRouter = P003J3_A59TicketRouter[0];
            n59TicketRouter = P003J3_n59TicketRouter[0];
            A60TicketSistemaOperativo = P003J3_A60TicketSistemaOperativo[0];
            n60TicketSistemaOperativo = P003J3_n60TicketSistemaOperativo[0];
            A56TicketOffice = P003J3_A56TicketOffice[0];
            n56TicketOffice = P003J3_n56TicketOffice[0];
            A39TicketAntivirus = P003J3_A39TicketAntivirus[0];
            n39TicketAntivirus = P003J3_n39TicketAntivirus[0];
            A40TicketAplicacion = P003J3_A40TicketAplicacion[0];
            n40TicketAplicacion = P003J3_n40TicketAplicacion[0];
            A44TicketDisenio = P003J3_A44TicketDisenio[0];
            n44TicketDisenio = P003J3_n44TicketDisenio[0];
            A51TicketIngenieria = P003J3_A51TicketIngenieria[0];
            n51TicketIngenieria = P003J3_n51TicketIngenieria[0];
            A43TicketDiscoDuroExterno = P003J3_A43TicketDiscoDuroExterno[0];
            n43TicketDiscoDuroExterno = P003J3_n43TicketDiscoDuroExterno[0];
            A58TicketPerifericos = P003J3_A58TicketPerifericos[0];
            n58TicketPerifericos = P003J3_n58TicketPerifericos[0];
            A87TicketUps = P003J3_A87TicketUps[0];
            n87TicketUps = P003J3_n87TicketUps[0];
            A41TicketApoyoUsuario = P003J3_A41TicketApoyoUsuario[0];
            n41TicketApoyoUsuario = P003J3_n41TicketApoyoUsuario[0];
            A52TicketInstalarDataShow = P003J3_A52TicketInstalarDataShow[0];
            n52TicketInstalarDataShow = P003J3_n52TicketInstalarDataShow[0];
            A57TicketOtros = P003J3_A57TicketOtros[0];
            n57TicketOtros = P003J3_n57TicketOtros[0];
            AV18CellRow = (int)(AV18CellRow+1);
            AV21ColumnIndex = 0;
            if ( AV30GridColumnVisible_TicketId )
            {
      ...
      protected void S131( )
      {
         ...
         AV29GridColumn.gxTpr_Columntitle = "Internet/Router/Access Point";
         AV29GridColumn.gxTpr_Showattribute = true;
         AV28GridColumns.Add(AV29GridColumn, 0);
         AV29GridColumn = new SdtK2BGridColumns_K2BGridColumnsItem(context);
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         P003J2_A15UsuarioId = new long[1] ;
         ...
         P003J3_A15UsuarioId = new long[1] ;
         P003J3_A53TicketLaptop = new bool[] {false} ;
         P003J3_n53TicketLaptop = new bool[] {false} ;
         P003J3_A42TicketDesktop = new bool[] {false} ;
         P003J3_n42TicketDesktop = new bool[] {false} ;
         P003J3_A55TicketMonitor = new bool[] {false} ;
         P003J3_n55TicketMonitor = new bool[] {false} ;
         P003J3_A50TicketImpresora = new bool[] {false} ;
         P003J3_n50TicketImpresora = new bool[] {false} ;
         P003J3_A45TicketEscaner = new bool[] {false} ;
         P003J3_n45TicketEscaner = new bool[] {false} ;
         P003J3_A59TicketRouter = new bool[] {false} ;
         P003J3_n59TicketRouter = new bool[] {false} ;
         P003J3_A60TicketSistemaOperativo = new bool[] {false} ;
         P003J3_n60TicketSistemaOperativo = new bool[] {false} ;
         P003J3_A56TicketOffice = new bool[] {false} ;
         P003J3_n56TicketOffice = new bool[] {false} ;
         P003J3_A39TicketAntivirus = new bool[] {false} ;
         P003J3_n39TicketAntivirus = new bool[] {false} ;
         P003J3_A40TicketAplicacion = new bool[] {false} ;
         P003J3_n40TicketAplicacion = new bool[] {false} ;
         P003J3_A44TicketDisenio = new bool[] {false} ;
         P003J3_n44TicketDisenio = new bool[] {false} ;
         P003J3_A51TicketIngenieria = new bool[] {false} ;
         P003J3_n51TicketIngenieria = new bool[] {false} ;
         P003J3_A43TicketDiscoDuroExterno = new bool[] {false} ;
         P003J3_n43TicketDiscoDuroExterno = new bool[] {false} ;
         P003J3_A58TicketPerifericos = new bool[] {false} ;
         P003J3_n58TicketPerifericos = new bool[] {false} ;
         P003J3_A87TicketUps = new bool[] {false} ;
         P003J3_n87TicketUps = new bool[] {false} ;
         P003J3_A41TicketApoyoUsuario = new bool[] {false} ;
         P003J3_n41TicketApoyoUsuario = new bool[] {false} ;
         P003J3_A52TicketInstalarDataShow = new bool[] {false} ;
         P003J3_n52TicketInstalarDataShow = new bool[] {false} ;
         P003J3_A57TicketOtros = new bool[] {false} ;
         P003J3_n57TicketOtros = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.exportusuarioticketwc__default(),
            new Object[][] {
               ...
               , new Object[] {
               P003J3_A54TicketLastId, P003J3_A14TicketId, P003J3_A48TicketHora, P003J3_A46TicketFecha, P003J3_A15UsuarioId, P003J3_A53TicketLaptop, P003J3_n53TicketLaptop, P003J3_A42TicketDesktop, P003J3_n42TicketDesktop, P003J3_A55TicketMonitor,
               P003J3_n55TicketMonitor, P003J3_A50TicketImpresora, P003J3_n50TicketImpresora, P003J3_A45TicketEscaner, P003J3_n45TicketEscaner, P003J3_A59TicketRouter, P003J3_n59TicketRouter, P003J3_A60TicketSistemaOperativo, P003J3_n60TicketSistemaOperativo, P003J3_A56TicketOffice,
               P003J3_n56TicketOffice, P003J3_A39TicketAntivirus, P003J3_n39TicketAntivirus, P003J3_A40TicketAplicacion, P003J3_n40TicketAplicacion, P003J3_A44TicketDisenio, P003J3_n44TicketDisenio, P003J3_A51TicketIngenieria, P003J3_n51TicketIngenieria, P003J3_A43TicketDiscoDuroExterno,
               P003J3_n43TicketDiscoDuroExterno, P003J3_A58TicketPerifericos, P003J3_n58TicketPerifericos, P003J3_A87TicketUps, P003J3_n87TicketUps, P003J3_A41TicketApoyoUsuario, P003J3_n41TicketApoyoUsuario, P003J3_A52TicketInstalarDataShow, P003J3_n52TicketInstalarDataShow, P003J3_A57TicketOtros,
               P003J3_n57TicketOtros
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private long[] P003J2_A15UsuarioId ;
      ...
      private long[] P003J3_A15UsuarioId ;
      private bool[] P003J3_A53TicketLaptop ;
      private bool[] P003J3_n53TicketLaptop ;
      private bool[] P003J3_A42TicketDesktop ;
      private bool[] P003J3_n42TicketDesktop ;
      private bool[] P003J3_A55TicketMonitor ;
      private bool[] P003J3_n55TicketMonitor ;
      private bool[] P003J3_A50TicketImpresora ;
      private bool[] P003J3_n50TicketImpresora ;
      private bool[] P003J3_A45TicketEscaner ;
      private bool[] P003J3_n45TicketEscaner ;
      private bool[] P003J3_A59TicketRouter ;
      private bool[] P003J3_n59TicketRouter ;
      private bool[] P003J3_A60TicketSistemaOperativo ;
      private bool[] P003J3_n60TicketSistemaOperativo ;
      private bool[] P003J3_A56TicketOffice ;
      private bool[] P003J3_n56TicketOffice ;
      private bool[] P003J3_A39TicketAntivirus ;
      private bool[] P003J3_n39TicketAntivirus ;
      private bool[] P003J3_A40TicketAplicacion ;
      private bool[] P003J3_n40TicketAplicacion ;
      private bool[] P003J3_A44TicketDisenio ;
      private bool[] P003J3_n44TicketDisenio ;
      private bool[] P003J3_A51TicketIngenieria ;
      private bool[] P003J3_n51TicketIngenieria ;
      private bool[] P003J3_A43TicketDiscoDuroExterno ;
      private bool[] P003J3_n43TicketDiscoDuroExterno ;
      private bool[] P003J3_A58TicketPerifericos ;
      private bool[] P003J3_n58TicketPerifericos ;
      private bool[] P003J3_A87TicketUps ;
      private bool[] P003J3_n87TicketUps ;
      private bool[] P003J3_A41TicketApoyoUsuario ;
      private bool[] P003J3_n41TicketApoyoUsuario ;
      private bool[] P003J3_A52TicketInstalarDataShow ;
      private bool[] P003J3_n52TicketInstalarDataShow ;
      private bool[] P003J3_A57TicketOtros ;
      private bool[] P003J3_n57TicketOtros ;
      private string aP7_OutFile ;
