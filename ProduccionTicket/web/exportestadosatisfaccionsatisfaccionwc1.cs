...
namespace GeneXus.Programs {
   public class exportestadosatisfaccionsatisfaccionwc1 : GXProcedure
   {
      ...
      public string executeUdp( short aP0_SatisfaccionTecnicoProblemaId ,
                                DateTime aP1_SatisfaccionFecha_From ,
                                DateTime aP2_SatisfaccionFecha_To ,
                                DateTime aP3_UsuarioFecha_From ,
                                DateTime aP4_UsuarioFecha_To ,
                                 ...
                                 out string aP12_OutFile )
      {
         ...
         objexportestadosatisfaccionsatisfaccionwc1.AV50OutFile = "" ;
      ...
      void executePrivate( )
      {
         ...
         AV50OutFile = GxDirectory.TemporaryFilesPath + AV30File.Separator + "ExportEstadoSatisfaccionSatisfaccionWC1-" + Guid.NewGuid( ).ToString() + ".xlsx";
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            n34SatisfaccionSugerencia = P00303_n34SatisfaccionSugerencia[0];
      ...
      public override void initialize( )
      {
         ...
         P00303_n34SatisfaccionSugerencia = new bool[] {false} ;
         P00303_A94UsuarioRequerimiento = new string[] {""} ;
         P00303_A93UsuarioNombre = new string[] {""} ;
         P00303_A15UsuarioId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.exportestadosatisfaccionsatisfaccionwc1__default(),
            new Object[][] {
               ...
               , new Object[] {
               P00303_A8SatisfaccionResueltoId, P00303_A10SatisfaccionTecnicoCompetenteId, P00303_A11SatisfaccionTecnicoProfesionalismoId, P00303_A12SatisfaccionTiempoId, P00303_A13SatisfaccionAtencionId, P00303_A34SatisfaccionSugerencia, P00303_n34SatisfaccionSugerencia, P00303_A94UsuarioRequerimiento, P00303_A93UsuarioNombre, P00303_A15UsuarioId,
   ...
   public class exportestadosatisfaccionsatisfaccionwc1__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_P00303(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (long)dynConstraints[17] , (long)dynConstraints[18] , (long)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (string)dynConstraints[22] , (short)dynConstraints[23] , (short)dynConstraints[24] , (short)dynConstraints[25] );
         }
