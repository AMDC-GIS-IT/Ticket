...
namespace GeneXus.Programs {
   public class promptdetalle_infotec : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public promptdetalle_infotec( )
      {
      ...
      public promptdetalle_infotec( IGxContext context )
      {
      ...
      {
         this.AV17pcorrelativo = 0 ;
         executePrivate();
         aP0_pcorrelativo=this.AV17pcorrelativo;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV18nombre_emp = GetPar( "nombre_emp");
               AV45fecha_registro_From = context.localUtil.ParseDateParm( GetPar( "fecha_registro_From"));
               ajax_req_read_hidden_sdt(GetNextPar( ), AV15ClassCollection);
               AV36OrderedBy = (short)(NumberUtil.Val( GetPar( "OrderedBy"), "."));
               AV46fecha_registro_To = context.localUtil.ParseDateParm( GetPar( "fecha_registro_To"));
               ...
               AV17pcorrelativo = (int)(NumberUtil.Val( GetPar( "pcorrelativo"), "."));
               ...
               gxgrGrid_refresh( subGrid_Rows, AV35K2BToolsGenericSearchField, AV18nombre_emp, AV45fecha_registro_From, AV15ClassCollection, AV36OrderedBy, AV46fecha_registro_To, AV49Pgmname, AV5CurrentPage, AV7GridConfiguration, AV17pcorrelativo, AV8FreezeColumnTitles) ;
            ...
            {
               AV17pcorrelativo = (int)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV17pcorrelativo", StringUtil.LTrimStr( (decimal)(AV17pcorrelativo), 9, 0));
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202418843482", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("promptdetalle_infotec.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV17pcorrelativo,9,0))}, new string[] {"pcorrelativo"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vK2BTOOLSGENERICSEARCHFIELD", StringUtil.RTrim( AV35K2BToolsGenericSearchField));
         GxWebStd.gx_hidden_field( context, "GXH_vNOMBRE_EMP", AV18nombre_emp);
         GxWebStd.gx_hidden_field( context, "GXH_vFECHA_REGISTRO_FROM", context.localUtil.Format(AV45fecha_registro_From, "99/99/99"));
         /* Send saved values. */
         send_integrity_footer_hashes( ) ;
         GxWebStd.gx_hidden_field( context, "nRC_GXsfl_92", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_92), 8, 0, ".", "")));
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vFILTERTAGS", AV33FilterTags);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vFILTERTAGS", AV33FilterTags);
         }
         GxWebStd.gx_hidden_field( context, "vDELETEDTAG", StringUtil.RTrim( AV34DeletedTag));
         GxWebStd.gx_hidden_field( context, "vFECHA_REGISTRO_TO", context.localUtil.DToC( AV46fecha_registro_To, 0, "/"));
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vGRIDORDERS", AV38GridOrders);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vGRIDORDERS", AV38GridOrders);
         }
         GxWebStd.gx_hidden_field( context, "vUC_ORDEREDBY", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV40UC_OrderedBy), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vPCORRELATIVO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV17pcorrelativo), 9, 0, ".", "")));
         ...
         GxWebStd.gx_hidden_field( context, "vORDEREDBY", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV36OrderedBy), 4, 0, ".", "")));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, "vFECHA_REGISTRO_FROM", context.localUtil.DToC( AV45fecha_registro_From, 0, "/"));
      ...
      {
         return formatLink("promptdetalle_infotec.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV17pcorrelativo,9,0))}, new string[] {"pcorrelativo"})  ;
      }

      public override string GetPgmname( )
      {
         return "Promptdetalle_infotec" ;
      }
      ...
      protected void WB7T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 25,'',false,'" + sGXsfl_92_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavK2btoolsgenericsearchfield_Internalname, StringUtil.RTrim( AV35K2BToolsGenericSearchField), StringUtil.RTrim( context.localUtil.Format( AV35K2BToolsGenericSearchField, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,25);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Buscar...", edtavK2btoolsgenericsearchfield_Jsonclick, 0, "K2BTools_SearchCriteria", "", "", "", "", 1, edtavK2btoolsgenericsearchfield_Enabled, 0, "text", "", 40, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Promptdetalle_infotec.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Multiple line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 41,'',false,'" + sGXsfl_92_idx + "',0)\"";
            ClassString = "Attribute_Filter";
            StyleString = "";
            ClassString = "Attribute_Filter";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavNombre_emp_Internalname, AV18nombre_emp, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,41);\"", 0, 1, edtavNombre_emp_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_Promptdetalle_infotec.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockfecha_registro_Internalname, "fecha_registro", "", "", lblTextblockfecha_registro_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock_FilterDesc K2BT_LabelTop", 0, "", 1, 1, 0, 0, "HLP_Promptdetalle_infotec.htm");
            /* User Defined Control */
            ucFecha_registro_daterangepicker.SetProperty("ValueFrom", AV45fecha_registro_From);
            ucFecha_registro_daterangepicker.SetProperty("ValueTo", AV46fecha_registro_To);
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "left", "top", "", "flex-grow:1;", "div");
            wb_table1_48_7T2( true) ;
         }
         else
         {
            wb_table1_48_7T2( false) ;
         }
         return  ;
      }

      protected void wb_table1_48_7T2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" width="+StringUtil.LTrimStr( (decimal)(73), 4, 0)+"px"+" class=\""+"Attribute_Grid"+"\" "+" style=\""+""+""+"\" "+">") ;
         ...
         if ( wbEnd == 92 )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table2_110_7T2( true) ;
         }
         else
         {
            wb_table2_110_7T2( false) ;
         }
         return  ;
      }

      protected void wb_table2_110_7T2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagebuttontextblock_Internalname, "", "", "", lblPreviouspagebuttontextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOPREVIOUS\\'."+"'", "", lblPreviouspagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_Promptdetalle_infotec.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFirstpagetextblock_Internalname, lblFirstpagetextblock_Caption, "", "", lblFirstpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOFIRST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblFirstpagetextblock_Visible, 1, 0, 0, "HLP_Promptdetalle_infotec.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacinglefttextblock_Internalname, "...", "", "", lblSpacinglefttextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacinglefttextblock_Visible, 1, 0, 0, "HLP_Promptdetalle_infotec.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPreviouspagetextblock_Internalname, lblPreviouspagetextblock_Caption, "", "", lblPreviouspagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOPREVIOUS\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblPreviouspagetextblock_Visible, 1, 0, 0, "HLP_Promptdetalle_infotec.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCurrentpagetextblock_Internalname, lblCurrentpagetextblock_Caption, "", "", lblCurrentpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationCurrent", 0, "", 1, 1, 0, 0, "HLP_Promptdetalle_infotec.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagetextblock_Internalname, lblNextpagetextblock_Caption, "", "", lblNextpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DONEXT\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblNextpagetextblock_Visible, 1, 0, 0, "HLP_Promptdetalle_infotec.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpacingrighttextblock_Internalname, "...", "", "", lblSpacingrighttextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_PaginationDisabled", 0, "", lblSpacingrighttextblock_Visible, 1, 0, 0, "HLP_Promptdetalle_infotec.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLastpagetextblock_Internalname, lblLastpagetextblock_Caption, "", "", lblLastpagetextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOLAST\\'."+"'", "", "K2BToolsTextBlock_PaginationNormal", 5, "", lblLastpagetextblock_Visible, 1, 0, 0, "HLP_Promptdetalle_infotec.htm");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNextpagebuttontextblock_Internalname, "", "", "", lblNextpagebuttontextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DONEXT\\'."+"'", "", lblNextpagebuttontextblock_Class, 5, "", 1, 1, 0, 0, "HLP_Promptdetalle_infotec.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* User Defined Control */
            ucK2borderbyusercontrol.SetProperty("GridOrders", AV38GridOrders);
            ucK2borderbyusercontrol.SetProperty("SelectedOrderBy", AV40UC_OrderedBy);
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vK2BTOOLSGENERICSEARCHFIELD"), AV35K2BToolsGenericSearchField) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Nombre_emp Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vNOMBRE_EMP"), AV18nombre_emp) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Fecha_registro_from Changed */
                                       if ( context.localUtil.CToT( cgiGet( "GXH_vFECHA_REGISTRO_FROM"), 0) != AV45fecha_registro_From )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       string AV18nombre_emp ,
                                       DateTime AV45fecha_registro_From ,
                                       GxSimpleCollection<string> AV15ClassCollection ,
                                       short AV36OrderedBy ,
                                       DateTime AV46fecha_registro_To ,
                                       string AV49Pgmname ,
                                       int AV5CurrentPage ,
                                       SdtK2BGridConfiguration AV7GridConfiguration ,
                                       int AV17pcorrelativo ,
      ...
      {
         /* GeneXus formulas. */
         AV49Pgmname = "Promptdetalle_infotec";
         context.Gx_err = 0;
      }
      ...
      protected void RF7T2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_datastore1.dynParam(0, new Object[]{ new Object[]{
                                                 AV18nombre_emp ,
                                                 AV46fecha_registro_To ,
                                                 AV45fecha_registro_From ,
            ...
            lV18nombre_emp = StringUtil.Concat( StringUtil.RTrim( AV18nombre_emp), "%", "");
            lV35K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV35K2BToolsGenericSearchField), 100, "%");
            lV35K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV35K2BToolsGenericSearchField), 100, "%");
            lV35K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV35K2BToolsGenericSearchField), 100, "%");
            lV35K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV35K2BToolsGenericSearchField), 100, "%");
            lV35K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV35K2BToolsGenericSearchField), 100, "%");
            ...
            lV35K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV35K2BToolsGenericSearchField), 100, "%");
            /* Using cursor H007T2 */
            pr_datastore1.execute(0, new Object[] {lV18nombre_emp, AV46fecha_registro_To, AV45fecha_registro_From, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, GXPagingFrom2, GXPagingTo2, GXPagingFrom2, GXPagingTo2});
            nGXsfl_92_idx = 1;
            sGXsfl_92_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_92_idx), 4, 0), 4, "0");
            SubsflControlProps_922( ) ;
            while ( ( (pr_datastore1.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A253observaciones = H007T2_A253observaciones[0];
               n253observaciones = H007T2_n253observaciones[0];
               A252prioridad = H007T2_A252prioridad[0];
               n252prioridad = H007T2_n252prioridad[0];
               A251detalle_tarea = H007T2_A251detalle_tarea[0];
               n251detalle_tarea = H007T2_n251detalle_tarea[0];
               A250id_actividad = H007T2_A250id_actividad[0];
               n250id_actividad = H007T2_n250id_actividad[0];
               A249id_categoria = H007T2_A249id_categoria[0];
               n249id_categoria = H007T2_n249id_categoria[0];
               A248detalle_infotecid_unidad = H007T2_A248detalle_infotecid_unidad[0];
               n248detalle_infotecid_unidad = H007T2_n248detalle_infotecid_unidad[0];
               A247correo_usuario = H007T2_A247correo_usuario[0];
               n247correo_usuario = H007T2_n247correo_usuario[0];
               A246depto_usuario = H007T2_A246depto_usuario[0];
               n246depto_usuario = H007T2_n246depto_usuario[0];
               A245nombre_usuario = H007T2_A245nombre_usuario[0];
               n245nombre_usuario = H007T2_n245nombre_usuario[0];
               A244trabajo = H007T2_A244trabajo[0];
               n244trabajo = H007T2_n244trabajo[0];
               A243estatus = H007T2_A243estatus[0];
               n243estatus = H007T2_n243estatus[0];
               A241fecha_registro = H007T2_A241fecha_registro[0];
               n241fecha_registro = H007T2_n241fecha_registro[0];
               A240cargo_emp = H007T2_A240cargo_emp[0];
               n240cargo_emp = H007T2_n240cargo_emp[0];
               A239nombre_emp = H007T2_A239nombre_emp[0];
               n239nombre_emp = H007T2_n239nombre_emp[0];
               A238correlativo = H007T2_A238correlativo[0];
               E247T2 ();
      ...
      protected void send_integrity_lvl_hashes7T2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV49Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV49Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_CORRELATIVO"+"_"+sGXsfl_92_idx, GetSecureSignedToken( sGXsfl_92_idx, context.localUtil.Format( (decimal)(A238correlativo), "ZZZZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV35K2BToolsGenericSearchField = StringUtil.PadR( StringUtil.RTrim( AV35K2BToolsGenericSearchField), 100, "%");
         /* Using cursor H007T3 */
         pr_datastore1.execute(1, new Object[] {lV18nombre_emp, AV46fecha_registro_To, AV45fecha_registro_From, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField, lV35K2BToolsGenericSearchField});
      ...
      protected void STRUP7T0( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( "vFILTERTAGS"), AV33FilterTags);
            ajax_req_read_hidden_sdt(cgiGet( "vGRIDORDERS"), AV38GridOrders);
            /* Read saved values. */
            nRC_GXsfl_92 = (int)(context.localUtil.CToN( cgiGet( "nRC_GXsfl_92"), ".", ","));
            AV34DeletedTag = cgiGet( "vDELETEDTAG");
            AV45fecha_registro_From = context.localUtil.CToD( cgiGet( "vFECHA_REGISTRO_FROM"), 0);
            AV46fecha_registro_To = context.localUtil.CToD( cgiGet( "vFECHA_REGISTRO_TO"), 0);
            AV40UC_OrderedBy = (short)(context.localUtil.CToN( cgiGet( "vUC_ORDEREDBY"), ".", ","));
            ...
            AssignAttri("", false, "AV35K2BToolsGenericSearchField", AV35K2BToolsGenericSearchField);
            AV18nombre_emp = cgiGet( edtavNombre_emp_Internalname);
            AssignAttri("", false, "AV18nombre_emp", AV18nombre_emp);
            ...
            if ( DateTimeUtil.ResetTime ( context.localUtil.CToD( cgiGet( "GXH_vFECHA_REGISTRO_FROM"), 2) ) != DateTimeUtil.ResetTime ( AV45fecha_registro_From ) )
            {
               GRID_nFirstRecordOnPage = 0;
            }
         }
      ...
      protected void E207T2( )
      {
         ...
         AV42ActivityList = new GXBaseCollection<SdtK2BActivityList_K2BActivityListItem>( context, "K2BActivityListItem", "kb_ticket");
         AV43ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         AV43ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "detalle_infotec";
         AV43ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "detalle_infotec";
         AV43ActivityListItem.gxTpr_Activity.gxTpr_Standardactivitytype = "List";
         AV43ActivityListItem.gxTpr_Activity.gxTpr_Useractivitytype = "";
         AV43ActivityListItem.gxTpr_Activity.gxTpr_Pgmname = AV49Pgmname;
         AV42ActivityList.Add(AV43ActivityListItem, 0);
         new k2bisauthorizedactivitylist(context ).execute( ref  AV42ActivityList) ;
         if ( ! ((SdtK2BActivityList_K2BActivityListItem)AV42ActivityList.Item(1)).gxTpr_Isauthorized )
         {
            CallWebObject(formatLink("k2bnotauthorized.aspx", new object[] {UrlEncode(StringUtil.RTrim(((SdtK2BActivityList_K2BActivityListItem)AV42ActivityList.Item(1)).gxTpr_Activity.gxTpr_Entityname)),UrlEncode(StringUtil.RTrim(((SdtK2BActivityList_K2BActivityListItem)AV42ActivityList.Item(1)).gxTpr_Activity.gxTpr_Transactionname)),UrlEncode(StringUtil.RTrim(((SdtK2BActivityList_K2BActivityListItem)AV42ActivityList.Item(1)).gxTpr_Activity.gxTpr_Standardactivitytype)),UrlEncode(StringUtil.RTrim(((SdtK2BActivityList_K2BActivityListItem)AV42ActivityList.Item(1)).gxTpr_Activity.gxTpr_Useractivitytype)),UrlEncode(StringUtil.RTrim(((SdtK2BActivityList_K2BActivityListItem)AV42ActivityList.Item(1)).gxTpr_Activity.gxTpr_Pgmname))}, new string[] {"EntityName","TransactionName","StandardActivityType","UserActivityType","ProgramName"}) );
            context.wjLocDisableFrm = 1;
         }
         new k2bgetcontext(context ).execute( out  AV16Context) ;
         AV18nombre_emp = "";
         AssignAttri("", false, "AV18nombre_emp", AV18nombre_emp);
         AV44fecha_registro = DateTime.MinValue;
         AV45fecha_registro_From = DateTimeUtil.DAdd(DateTimeUtil.ServerDate( context, pr_default),-((int)(30)));
         AssignAttri("", false, "AV45fecha_registro_From", context.localUtil.Format(AV45fecha_registro_From, "99/99/99"));
         AV46fecha_registro_To = DateTimeUtil.ResetTime(DateTimeUtil.ServerNow( context, pr_default));
         AssignAttri("", false, "AV46fecha_registro_To", context.localUtil.Format(AV46fecha_registro_To, "99/99/99"));
         new k2bloadrowsperpage(context ).execute(  AV49Pgmname,  "Grid", out  AV10RowsPerPageVariable, out  AV11RowsPerPageLoaded) ;
         ...
         GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
         Form.Caption = StringUtil.Format( "Seleccionar %1", "detalle_infotec", "", "", "", "", "", "", "", "");
         ...
         AV38GridOrders = new GXBaseCollection<SdtK2BGridOrders_K2BGridOrdersItem>( context, "K2BGridOrdersItem", "kb_ticket");
         AV39GridOrder = new SdtK2BGridOrders_K2BGridOrdersItem(context);
         AV39GridOrder.gxTpr_Ascendingorder = 0;
         AV39GridOrder.gxTpr_Descendingorder = 1;
         AV39GridOrder.gxTpr_Gridcolumnindex = 1;
         AV38GridOrders.Add(AV39GridOrder, 0);
         AV39GridOrder = new SdtK2BGridOrders_K2BGridOrdersItem(context);
         AV39GridOrder.gxTpr_Ascendingorder = 2;
         AV39GridOrder.gxTpr_Descendingorder = 3;
         AV39GridOrder.gxTpr_Gridcolumnindex = 2;
         AV38GridOrders.Add(AV39GridOrder, 0);
      ...
      protected void E227T2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV17pcorrelativo = A238correlativo;
         AssignAttri("", false, "AV17pcorrelativo", StringUtil.LTrimStr( (decimal)(AV17pcorrelativo), 9, 0));
         context.setWebReturnParms(new Object[] {(int)AV17pcorrelativo});
         context.setWebReturnParmsMetadata(new Object[] {"AV17pcorrelativo"});
         context.wjLocDisableFrm = 1;
      ...
      protected void E237T2( )
      {
         ...
         AV40UC_OrderedBy = AV36OrderedBy;
         ...
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV15ClassCollection", AV15ClassCollection);
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV33FilterTags", AV33FilterTags);
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV7GridConfiguration", AV7GridConfiguration);
      }
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV12GridStateKey = StringUtil.Str( (decimal)(AV17pcorrelativo), 9, 0);
         new k2bloadgridstate(context ).execute(  AV49Pgmname,  AV12GridStateKey, out  AV13GridState) ;
         AV36OrderedBy = AV13GridState.gxTpr_Orderedby;
         AssignAttri("", false, "AV36OrderedBy", StringUtil.LTrimStr( (decimal)(AV36OrderedBy), 4, 0));
         AV40UC_OrderedBy = AV13GridState.gxTpr_Orderedby;
         AssignAttri("", false, "AV40UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV40UC_OrderedBy), 4, 0));
         AV50GXV1 = 1;
         while ( AV50GXV1 <= AV13GridState.gxTpr_Filtervalues.Count )
         {
            AV14GridStateFilterValue = ((SdtK2BGridState_FilterValue)AV13GridState.gxTpr_Filtervalues.Item(AV50GXV1));
            if ( StringUtil.StrCmp(AV14GridStateFilterValue.gxTpr_Filtername, "nombre_emp") == 0 )
            {
               AV18nombre_emp = AV14GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV18nombre_emp", AV18nombre_emp);
            }
            else if ( StringUtil.StrCmp(AV14GridStateFilterValue.gxTpr_Filtername, "fecha_registro:From") == 0 )
            {
               AV45fecha_registro_From = context.localUtil.CToD( AV14GridStateFilterValue.gxTpr_Value, 2);
               AssignAttri("", false, "AV45fecha_registro_From", context.localUtil.Format(AV45fecha_registro_From, "99/99/99"));
            }
            else if ( StringUtil.StrCmp(AV14GridStateFilterValue.gxTpr_Filtername, "fecha_registro:To") == 0 )
            {
               AV46fecha_registro_To = context.localUtil.CToD( AV14GridStateFilterValue.gxTpr_Value, 2);
               AssignAttri("", false, "AV46fecha_registro_To", context.localUtil.Format(AV46fecha_registro_To, "99/99/99"));
            }
            else if ( StringUtil.StrCmp(AV14GridStateFilterValue.gxTpr_Filtername, "K2BToolsGenericSearchField") == 0 )
            {
               AV35K2BToolsGenericSearchField = AV14GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV35K2BToolsGenericSearchField", AV35K2BToolsGenericSearchField);
            }
      ...
      protected void S122( )
      {
         ...
         AV13GridState.gxTpr_Orderedby = AV36OrderedBy;
         AV13GridState.gxTpr_Filtervalues.Clear();
         AV14GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         AV14GridStateFilterValue.gxTpr_Filtername = "nombre_emp";
         AV14GridStateFilterValue.gxTpr_Value = AV18nombre_emp;
         AV13GridState.gxTpr_Filtervalues.Add(AV14GridStateFilterValue, 0);
         AV14GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         AV14GridStateFilterValue.gxTpr_Filtername = "fecha_registro:From";
         AV14GridStateFilterValue.gxTpr_Value = context.localUtil.Format( AV45fecha_registro_From, "99/99/99");
         AV13GridState.gxTpr_Filtervalues.Add(AV14GridStateFilterValue, 0);
         AV14GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         AV14GridStateFilterValue.gxTpr_Filtername = "fecha_registro:To";
         AV14GridStateFilterValue.gxTpr_Value = context.localUtil.Format( AV46fecha_registro_To, "99/99/99");
         AV13GridState.gxTpr_Filtervalues.Add(AV14GridStateFilterValue, 0);
         AV14GridStateFilterValue = new SdtK2BGridState_FilterValue(context);
         AV14GridStateFilterValue.gxTpr_Filtername = "K2BToolsGenericSearchField";
         AV14GridStateFilterValue.gxTpr_Value = AV35K2BToolsGenericSearchField;
         AV13GridState.gxTpr_Filtervalues.Add(AV14GridStateFilterValue, 0);
         new k2bsavegridstate(context ).execute(  AV49Pgmname,  AV12GridStateKey,  AV13GridState) ;
      }
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         new k2bloadgridconfiguration(context ).execute(  AV49Pgmname,  "Grid", ref  AV7GridConfiguration) ;
      ...
      protected void E177T2( )
      {
         ...
         new k2bsavegridconfiguration(context ).execute(  AV49Pgmname,  "Grid",  AV7GridConfiguration,  true) ;
         AV40UC_OrderedBy = AV36OrderedBy;
         AssignAttri("", false, "AV40UC_OrderedBy", StringUtil.LTrimStr( (decimal)(AV40UC_OrderedBy), 4, 0));
         if ( AV10RowsPerPageVariable != AV9GridSettingsRowsPerPageVariable )
         {
            ...
            subGrid_Rows = AV10RowsPerPageVariable;
            GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            new k2bsaverowsperpage(context ).execute(  AV49Pgmname,  "Grid",  AV10RowsPerPageVariable) ;
            AV5CurrentPage = 1;
            AssignAttri("", false, "AV5CurrentPage", StringUtil.LTrimStr( (decimal)(AV5CurrentPage), 5, 0));
            subgrid_firstpage( ) ;
         }
      ...
      protected void S142( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV18nombre_emp)) )
         {
            AV32K2BFilterValuesSDTItem = new SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem(context);
            AV32K2BFilterValuesSDTItem.gxTpr_Name = "nombre_emp";
            AV32K2BFilterValuesSDTItem.gxTpr_Description = "nombre_emp";
            AV32K2BFilterValuesSDTItem.gxTpr_Canbedeleted = true;
            AV32K2BFilterValuesSDTItem.gxTpr_Type = "Standard";
            AV32K2BFilterValuesSDTItem.gxTpr_Value = AV18nombre_emp;
            AV32K2BFilterValuesSDTItem.gxTpr_Valuedescription = AV18nombre_emp;
            AV31K2BFilterValuesSDT.Add(AV32K2BFilterValuesSDTItem, 0);
         }
         if ( ! (DateTime.MinValue==AV45fecha_registro_From) || ! (DateTime.MinValue==AV46fecha_registro_To) )
         {
            AV32K2BFilterValuesSDTItem = new SdtK2BFilterValuesSDT_K2BFilterValuesSDTItem(context);
            AV32K2BFilterValuesSDTItem.gxTpr_Name = "fecha_registro";
            AV32K2BFilterValuesSDTItem.gxTpr_Description = "fecha_registro";
            AV32K2BFilterValuesSDTItem.gxTpr_Canbedeleted = true;
            AV32K2BFilterValuesSDTItem.gxTpr_Type = "DateRange";
            AV32K2BFilterValuesSDTItem.gxTpr_Semanticdaterangevalue = "K2BToolsDateRangeManual";
            GXt_dtime2 = DateTimeUtil.ResetTime( AV45fecha_registro_From ) ;
            AV32K2BFilterValuesSDTItem.gxTpr_Daterangefromvalue = GXt_dtime2;
            GXt_dtime2 = DateTimeUtil.ResetTime( AV46fecha_registro_To ) ;
            AV32K2BFilterValuesSDTItem.gxTpr_Daterangetovalue = GXt_dtime2;
            AV31K2BFilterValuesSDT.Add(AV32K2BFilterValuesSDTItem, 0);
         }
         ...
         if ( AV31K2BFilterValuesSDT.Count > 0 )
         {
            ...
            new k2bgettagcollectionforfiltervalues(context ).execute(  AV49Pgmname,  "Grid",  AV31K2BFilterValuesSDT, out  GXt_objcol_SdtK2BValueDescriptionCollection_Item3) ;
      ...
      protected void E117T2( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV34DeletedTag, "nombre_emp") == 0 )
         {
            AV18nombre_emp = "";
            AssignAttri("", false, "AV18nombre_emp", AV18nombre_emp);
         }
         else if ( StringUtil.StrCmp(AV34DeletedTag, "fecha_registro") == 0 )
         {
            AV45fecha_registro_From = DateTime.MinValue;
            AssignAttri("", false, "AV45fecha_registro_From", context.localUtil.Format(AV45fecha_registro_From, "99/99/99"));
            AV46fecha_registro_To = DateTime.MinValue;
            AssignAttri("", false, "AV46fecha_registro_To", context.localUtil.Format(AV46fecha_registro_To, "99/99/99"));
         }
         gxgrGrid_refresh( subGrid_Rows, AV35K2BToolsGenericSearchField, AV18nombre_emp, AV45fecha_registro_From, AV15ClassCollection, AV36OrderedBy, AV46fecha_registro_To, AV49Pgmname, AV5CurrentPage, AV7GridConfiguration, AV17pcorrelativo, AV8FreezeColumnTitles) ;
         /*  Sending Event outputs  */
      ...
      protected void E127T2( )
      {
         ...
         returnInSub = false;
         AV36OrderedBy = AV40UC_OrderedBy;
         AssignAttri("", false, "AV36OrderedBy", StringUtil.LTrimStr( (decimal)(AV36OrderedBy), 4, 0));
         gxgrGrid_refresh( subGrid_Rows, AV35K2BToolsGenericSearchField, AV18nombre_emp, AV45fecha_registro_From, AV15ClassCollection, AV36OrderedBy, AV46fecha_registro_To, AV49Pgmname, AV5CurrentPage, AV7GridConfiguration, AV17pcorrelativo, AV8FreezeColumnTitles) ;
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV7GridConfiguration", AV7GridConfiguration);
      ...
      protected void wb_table2_110_7T2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoresultsfoundtextblock_Internalname, "No hay resultados", "", "", lblNoresultsfoundtextblock_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "K2BToolsTextBlock_NoResultsFound", 0, "", 1, 1, 0, 0, "HLP_Promptdetalle_infotec.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_110_7T2e( true) ;
         }
         else
         {
            wb_table2_110_7T2e( false) ;
         }
      }

      protected void wb_table1_48_7T2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRuntimecolumnselectiontb_Internalname, "Config. tabla", "", "", lblRuntimecolumnselectiontb_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Section_Invisible", 0, "", 1, 1, 0, 0, "HLP_Promptdetalle_infotec.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 74,'',false,'" + sGXsfl_92_idx + "',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavGridsettingsrowsperpagevariable, cmbavGridsettingsrowsperpagevariable_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV9GridSettingsRowsPerPageVariable), 4, 0)), 1, cmbavGridsettingsrowsperpagevariable_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavGridsettingsrowsperpagevariable.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,74);\"", "", true, 1, "HLP_Promptdetalle_infotec.htm");
            cmbavGridsettingsrowsperpagevariable.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV9GridSettingsRowsPerPageVariable), 4, 0));
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttK2bgridsettingssave_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(92), 2, 0)+","+"null"+");", "Aplicar", bttK2bgridsettingssave_Jsonclick, 5, "Aplicar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'SAVEGRIDSETTINGS\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Promptdetalle_infotec.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_48_7T2e( true) ;
         }
         else
         {
            wb_table1_48_7T2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV17pcorrelativo = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV17pcorrelativo", StringUtil.LTrimStr( (decimal)(AV17pcorrelativo), 9, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202418843835", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("promptdetalle_infotec.js", "?202418843836", false, true);
         context.AddJavascriptSource("Shared/K2BToolsComponents/dist/k2btools-components/k2btools-components.js", "", false, true);
         context.AddJavascriptSource("K2BTagsViewer/K2BTagsViewerRender.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/moment.min.js", "", false, true);
         context.AddJavascriptSource("K2BDateRangePicker/bootstrap-daterangepicker/daterangepicker.js", "", false, true);
      ...
      {
         edtcorrelativo_Internalname = "CORRELATIVO_"+sGXsfl_92_idx;
         edtnombre_emp_Internalname = "NOMBRE_EMP_"+sGXsfl_92_idx;
         edtcargo_emp_Internalname = "CARGO_EMP_"+sGXsfl_92_idx;
         edtfecha_registro_Internalname = "FECHA_REGISTRO_"+sGXsfl_92_idx;
         edtestatus_Internalname = "ESTATUS_"+sGXsfl_92_idx;
         edttrabajo_Internalname = "TRABAJO_"+sGXsfl_92_idx;
         edtnombre_usuario_Internalname = "NOMBRE_USUARIO_"+sGXsfl_92_idx;
         edtdepto_usuario_Internalname = "DEPTO_USUARIO_"+sGXsfl_92_idx;
         edtcorreo_usuario_Internalname = "CORREO_USUARIO_"+sGXsfl_92_idx;
         edtdetalle_infotecid_unidad_Internalname = "DETALLE_INFOTECID_UNIDAD_"+sGXsfl_92_idx;
         edtid_categoria_Internalname = "ID_CATEGORIA_"+sGXsfl_92_idx;
         edtid_actividad_Internalname = "ID_ACTIVIDAD_"+sGXsfl_92_idx;
         edtdetalle_tarea_Internalname = "DETALLE_TAREA_"+sGXsfl_92_idx;
         edtprioridad_Internalname = "PRIORIDAD_"+sGXsfl_92_idx;
         edtobservaciones_Internalname = "OBSERVACIONES_"+sGXsfl_92_idx;
      }

      protected void SubsflControlProps_fel_922( )
      {
         edtcorrelativo_Internalname = "CORRELATIVO_"+sGXsfl_92_fel_idx;
         edtnombre_emp_Internalname = "NOMBRE_EMP_"+sGXsfl_92_fel_idx;
         edtcargo_emp_Internalname = "CARGO_EMP_"+sGXsfl_92_fel_idx;
         edtfecha_registro_Internalname = "FECHA_REGISTRO_"+sGXsfl_92_fel_idx;
         edtestatus_Internalname = "ESTATUS_"+sGXsfl_92_fel_idx;
         edttrabajo_Internalname = "TRABAJO_"+sGXsfl_92_fel_idx;
         edtnombre_usuario_Internalname = "NOMBRE_USUARIO_"+sGXsfl_92_fel_idx;
         edtdepto_usuario_Internalname = "DEPTO_USUARIO_"+sGXsfl_92_fel_idx;
         edtcorreo_usuario_Internalname = "CORREO_USUARIO_"+sGXsfl_92_fel_idx;
         edtdetalle_infotecid_unidad_Internalname = "DETALLE_INFOTECID_UNIDAD_"+sGXsfl_92_fel_idx;
         edtid_categoria_Internalname = "ID_CATEGORIA_"+sGXsfl_92_fel_idx;
         edtid_actividad_Internalname = "ID_ACTIVIDAD_"+sGXsfl_92_fel_idx;
         edtdetalle_tarea_Internalname = "DETALLE_TAREA_"+sGXsfl_92_fel_idx;
         edtprioridad_Internalname = "PRIORIDAD_"+sGXsfl_92_fel_idx;
         edtobservaciones_Internalname = "OBSERVACIONES_"+sGXsfl_92_fel_idx;
      }
      ...
      protected void sendrow_922( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_92_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute_Grid";
            edtnombre_emp_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A238correlativo), 9, 0, ".", "")))+"'"+"]);";
            AssignProp("", false, edtnombre_emp_Internalname, "Link", edtnombre_emp_Link, !bGXsfl_92_Refreshing);
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtnombre_emp_Internalname,(string)A239nombre_emp,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtnombre_emp_Link,(string)"",(string)"",(string)"",(string)edtnombre_emp_Jsonclick,(short)0,(string)"Attribute_Grid",(string)"",(string)ROClassString,(string)"K2BToolsGridColumn K2BToolsSortableColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)300,(short)0,(short)0,(short)92,(short)1,(short)-1,(short)-1,(bool)true,(string)"",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV17pcorrelativo',fld:'vPCORRELATIVO',pic:'ZZZZZZZZ9'},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV36OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV18nombre_emp',fld:'vNOMBRE_EMP',pic:''},{av:'AV45fecha_registro_From',fld:'vFECHA_REGISTRO_FROM',pic:''},{av:'AV46fecha_registro_To',fld:'vFECHA_REGISTRO_TO',pic:''},{av:'AV35K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV49Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("ENTER","{handler:'E227T2',iparms:[{av:'A238correlativo',fld:'CORRELATIVO',pic:'ZZZZZZZZ9',hsh:true},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV17pcorrelativo',fld:'vPCORRELATIVO',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("GRID.REFRESH","{handler:'E237T2',iparms:[{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV36OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV18nombre_emp',fld:'vNOMBRE_EMP',pic:''},{av:'AV45fecha_registro_From',fld:'vFECHA_REGISTRO_FROM',pic:''},{av:'AV46fecha_registro_To',fld:'vFECHA_REGISTRO_TO',pic:''},{av:'AV49Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV35K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pcorrelativo',fld:'vPCORRELATIVO',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("GRID.REFRESH",",oparms:[{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'tblNoresultsfoundtable_Visible',ctrl:'NORESULTSFOUNDTABLE',prop:'Visible'},{av:'AV40UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'divMaingrid_responsivetable_grid_Class',ctrl:'MAINGRID_RESPONSIVETABLE_GRID',prop:'Class'},{av:'Filtersummarytagsuc_Emptystatemessage',ctrl:'FILTERSUMMARYTAGSUC',prop:'EmptyStateMessage'},{av:'AV33FilterTags',fld:'vFILTERTAGS',pic:''},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'lblFirstpagetextblock_Caption',ctrl:'FIRSTPAGETEXTBLOCK',prop:'Caption'},{av:'lblPreviouspagetextblock_Caption',ctrl:'PREVIOUSPAGETEXTBLOCK',prop:'Caption'},{av:'lblCurrentpagetextblock_Caption',ctrl:'CURRENTPAGETEXTBLOCK',prop:'Caption'},{av:'lblNextpagetextblock_Caption',ctrl:'NEXTPAGETEXTBLOCK',prop:'Caption'},{av:'lblLastpagetextblock_Caption',ctrl:'LASTPAGETEXTBLOCK',prop:'Caption'},{av:'lblPreviouspagebuttontextblock_Class',ctrl:'PREVIOUSPAGEBUTTONTEXTBLOCK',prop:'Class'},{av:'lblNextpagebuttontextblock_Class',ctrl:'NEXTPAGEBUTTONTEXTBLOCK',prop:'Class'},{av:'lblFirstpagetextblock_Visible',ctrl:'FIRSTPAGETEXTBLOCK',prop:'Visible'},{av:'lblSpacinglefttextblock_Visible',ctrl:'SPACINGLEFTTEXTBLOCK',prop:'Visible'},{av:'lblPreviouspagetextblock_Visible',ctrl:'PREVIOUSPAGETEXTBLOCK',prop:'Visible'},{av:'lblLastpagetextblock_Visible',ctrl:'LASTPAGETEXTBLOCK',prop:'Visible'},{av:'lblSpacingrighttextblock_Visible',ctrl:'SPACINGRIGHTTEXTBLOCK',prop:'Visible'},{av:'lblNextpagetextblock_Visible',ctrl:'NEXTPAGETEXTBLOCK',prop:'Visible'},{av:'divK2btoolspagingcontainertable_Visible',ctrl:'K2BTOOLSPAGINGCONTAINERTABLE',prop:'Visible'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("GRID.LOAD","{handler:'E247T2',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOSEARCH'","{handler:'E257T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV35K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18nombre_emp',fld:'vNOMBRE_EMP',pic:''},{av:'AV45fecha_registro_From',fld:'vFECHA_REGISTRO_FROM',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV36OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV46fecha_registro_To',fld:'vFECHA_REGISTRO_TO',pic:''},{av:'AV49Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pcorrelativo',fld:'vPCORRELATIVO',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOFIRST'","{handler:'E137T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV35K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18nombre_emp',fld:'vNOMBRE_EMP',pic:''},{av:'AV45fecha_registro_From',fld:'vFECHA_REGISTRO_FROM',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV36OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV46fecha_registro_To',fld:'vFECHA_REGISTRO_TO',pic:''},{av:'AV49Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pcorrelativo',fld:'vPCORRELATIVO',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOPREVIOUS'","{handler:'E147T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV35K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18nombre_emp',fld:'vNOMBRE_EMP',pic:''},{av:'AV45fecha_registro_From',fld:'vFECHA_REGISTRO_FROM',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV36OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV46fecha_registro_To',fld:'vFECHA_REGISTRO_TO',pic:''},{av:'AV49Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pcorrelativo',fld:'vPCORRELATIVO',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E157T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV35K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18nombre_emp',fld:'vNOMBRE_EMP',pic:''},{av:'AV45fecha_registro_From',fld:'vFECHA_REGISTRO_FROM',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV36OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV46fecha_registro_To',fld:'vFECHA_REGISTRO_TO',pic:''},{av:'AV49Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pcorrelativo',fld:'vPCORRELATIVO',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'DOLAST'","{handler:'E167T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV35K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18nombre_emp',fld:'vNOMBRE_EMP',pic:''},{av:'AV45fecha_registro_From',fld:'vFECHA_REGISTRO_FROM',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV36OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV46fecha_registro_To',fld:'vFECHA_REGISTRO_TO',pic:''},{av:'AV49Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pcorrelativo',fld:'vPCORRELATIVO',pic:'ZZZZZZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'TOGGLEGRIDSETTINGSTABLE'","{handler:'E267T1',iparms:[{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("'SAVEGRIDSETTINGS'","{handler:'E177T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV35K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18nombre_emp',fld:'vNOMBRE_EMP',pic:''},{av:'AV45fecha_registro_From',fld:'vFECHA_REGISTRO_FROM',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV36OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV46fecha_registro_To',fld:'vFECHA_REGISTRO_TO',pic:''},{av:'AV49Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pcorrelativo',fld:'vPCORRELATIVO',pic:'ZZZZZZZZ9'},{av:'AV10RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'cmbavGridsettingsrowsperpagevariable'},{av:'AV9GridSettingsRowsPerPageVariable',fld:'vGRIDSETTINGSROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("'SAVEGRIDSETTINGS'",",oparms:[{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV40UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{av:'AV10RowsPerPageVariable',fld:'vROWSPERPAGEVARIABLE',pic:'ZZZ9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'divK2bgridsettingscontentoutertable_Visible',ctrl:'K2BGRIDSETTINGSCONTENTOUTERTABLE',prop:'Visible'},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED","{handler:'E117T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV35K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18nombre_emp',fld:'vNOMBRE_EMP',pic:''},{av:'AV45fecha_registro_From',fld:'vFECHA_REGISTRO_FROM',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV36OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV46fecha_registro_To',fld:'vFECHA_REGISTRO_TO',pic:''},{av:'AV49Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pcorrelativo',fld:'vPCORRELATIVO',pic:'ZZZZZZZZ9'},{av:'AV34DeletedTag',fld:'vDELETEDTAG',pic:''},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("FILTERSUMMARYTAGSUC.TAGDELETED",",oparms:[{av:'AV18nombre_emp',fld:'vNOMBRE_EMP',pic:''},{av:'AV45fecha_registro_From',fld:'vFECHA_REGISTRO_FROM',pic:''},{av:'AV46fecha_registro_To',fld:'vFECHA_REGISTRO_TO',pic:''},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED","{handler:'E127T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV35K2BToolsGenericSearchField',fld:'vK2BTOOLSGENERICSEARCHFIELD',pic:''},{av:'AV18nombre_emp',fld:'vNOMBRE_EMP',pic:''},{av:'AV45fecha_registro_From',fld:'vFECHA_REGISTRO_FROM',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV36OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV46fecha_registro_To',fld:'vFECHA_REGISTRO_TO',pic:''},{av:'AV49Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV5CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZZ9'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV17pcorrelativo',fld:'vPCORRELATIVO',pic:'ZZZZZZZZ9'},{av:'AV40UC_OrderedBy',fld:'vUC_ORDEREDBY',pic:'ZZZ9'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         setEventMetadata("K2BORDERBYUSERCONTROL.ORDERBYCHANGED",",oparms:[{av:'AV36OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'subGrid_Backcolorstyle',ctrl:'GRID',prop:'Backcolorstyle'},{av:'AV7GridConfiguration',fld:'vGRIDCONFIGURATION',pic:''},{av:'AV15ClassCollection',fld:'vCLASSCOLLECTION',pic:''},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]}");
         setEventMetadata("FILTERTOGGLE_COMBINED.CLICK","{handler:'E187T2',iparms:[{av:'divFiltercollapsiblesection_combined_Visible',ctrl:'FILTERCOLLAPSIBLESECTION_COMBINED',prop:'Visible'},{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("FILTERCLOSE_COMBINED.CLICK","{handler:'E197T2',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
         ...
         setEventMetadata("NULL","{handler:'Valid_Observaciones',iparms:[{av:'AV8FreezeColumnTitles',fld:'vFREEZECOLUMNTITLES',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV18nombre_emp = "";
         lV35K2BToolsGenericSearchField = "";
         H007T2_A253observaciones = new string[] {""} ;
         H007T2_n253observaciones = new bool[] {false} ;
         H007T2_A252prioridad = new string[] {""} ;
         H007T2_n252prioridad = new bool[] {false} ;
         H007T2_A251detalle_tarea = new string[] {""} ;
         H007T2_n251detalle_tarea = new bool[] {false} ;
         H007T2_A250id_actividad = new int[1] ;
         H007T2_n250id_actividad = new bool[] {false} ;
         H007T2_A249id_categoria = new int[1] ;
         H007T2_n249id_categoria = new bool[] {false} ;
         H007T2_A248detalle_infotecid_unidad = new int[1] ;
         H007T2_n248detalle_infotecid_unidad = new bool[] {false} ;
         H007T2_A247correo_usuario = new string[] {""} ;
         H007T2_n247correo_usuario = new bool[] {false} ;
         H007T2_A246depto_usuario = new string[] {""} ;
         H007T2_n246depto_usuario = new bool[] {false} ;
         H007T2_A245nombre_usuario = new string[] {""} ;
         H007T2_n245nombre_usuario = new bool[] {false} ;
         H007T2_A244trabajo = new string[] {""} ;
         H007T2_n244trabajo = new bool[] {false} ;
         H007T2_A243estatus = new string[] {""} ;
         H007T2_n243estatus = new bool[] {false} ;
         H007T2_A241fecha_registro = new DateTime[] {DateTime.MinValue} ;
         H007T2_n241fecha_registro = new bool[] {false} ;
         H007T2_A240cargo_emp = new string[] {""} ;
         H007T2_n240cargo_emp = new bool[] {false} ;
         H007T2_A239nombre_emp = new string[] {""} ;
         H007T2_n239nombre_emp = new bool[] {false} ;
         H007T2_A238correlativo = new int[1] ;
         ...
         ROClassString = "";
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.promptdetalle_infotec__datastore1(),
            new Object[][] {
                new Object[] {
               H007T2_A253observaciones, H007T2_n253observaciones, H007T2_A252prioridad, H007T2_n252prioridad, H007T2_A251detalle_tarea, H007T2_n251detalle_tarea, H007T2_A250id_actividad, H007T2_n250id_actividad, H007T2_A249id_categoria, H007T2_n249id_categoria,
               H007T2_A248detalle_infotecid_unidad, H007T2_n248detalle_infotecid_unidad, H007T2_A247correo_usuario, H007T2_n247correo_usuario, H007T2_A246depto_usuario, H007T2_n246depto_usuario, H007T2_A245nombre_usuario, H007T2_n245nombre_usuario, H007T2_A244trabajo, H007T2_n244trabajo,
               H007T2_A243estatus, H007T2_n243estatus, H007T2_A241fecha_registro, H007T2_n241fecha_registro, H007T2_A240cargo_emp, H007T2_n240cargo_emp, H007T2_A239nombre_emp, H007T2_n239nombre_emp, H007T2_A238correlativo
               }
               , new Object[] {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.promptdetalle_infotec__default(),
            new Object[][] {
            }
         );
         AV49Pgmname = "Promptdetalle_infotec";
      ...
      private string lV35K2BToolsGenericSearchField ;
      ...
      private DateTime AV45fecha_registro_From ;
      private DateTime AV46fecha_registro_To ;
      private DateTime A241fecha_registro ;
      private DateTime AV44fecha_registro ;
      ...
      private string[] H007T2_A253observaciones ;
      private bool[] H007T2_n253observaciones ;
      private string[] H007T2_A252prioridad ;
      private bool[] H007T2_n252prioridad ;
      private string[] H007T2_A251detalle_tarea ;
      private bool[] H007T2_n251detalle_tarea ;
      private int[] H007T2_A250id_actividad ;
      private bool[] H007T2_n250id_actividad ;
      private int[] H007T2_A249id_categoria ;
      private bool[] H007T2_n249id_categoria ;
      private int[] H007T2_A248detalle_infotecid_unidad ;
      private bool[] H007T2_n248detalle_infotecid_unidad ;
      private string[] H007T2_A247correo_usuario ;
      private bool[] H007T2_n247correo_usuario ;
      private string[] H007T2_A246depto_usuario ;
      private bool[] H007T2_n246depto_usuario ;
      private string[] H007T2_A245nombre_usuario ;
      private bool[] H007T2_n245nombre_usuario ;
      private string[] H007T2_A244trabajo ;
      private bool[] H007T2_n244trabajo ;
      private string[] H007T2_A243estatus ;
      private bool[] H007T2_n243estatus ;
      private DateTime[] H007T2_A241fecha_registro ;
      private bool[] H007T2_n241fecha_registro ;
      private string[] H007T2_A240cargo_emp ;
      private bool[] H007T2_n240cargo_emp ;
      private string[] H007T2_A239nombre_emp ;
      private bool[] H007T2_n239nombre_emp ;
      private int[] H007T2_A238correlativo ;
      ...
      private GXBaseCollection<SdtK2BGridOrders_K2BGridOrdersItem> AV38GridOrders ;
      private GXBaseCollection<SdtK2BActivityList_K2BActivityListItem> AV42ActivityList ;
      ...
      private SdtK2BGridOrders_K2BGridOrdersItem AV39GridOrder ;
      private SdtK2BActivityList_K2BActivityListItem AV43ActivityListItem ;
   }

   public class promptdetalle_infotec__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV36OrderedBy )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [observaciones], [prioridad], [detalle_tarea], [id_actividad], [id_categoria], [id_unidad], [correo_usuario], [depto_usuario], [nombre_usuario], [trabajo], [estatus], [fecha_registro], [cargo_emp], [nombre_emp], [correlativo]";
         sFromString = " FROM dbo.[detalle_infotec]";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV18nombre_emp)) )
         {
            AddWhere(sWhereString, "([nombre_emp] like @lV18nombre_emp)");
         }
         else
         {
            GXv_int4[0] = 1;
         }
         if ( ! (DateTime.MinValue==AV46fecha_registro_To) )
         {
            AddWhere(sWhereString, "([fecha_registro] <= @AV46fecha_registro_To)");
         }
         else
         {
            GXv_int4[1] = 1;
         }
         if ( ! (DateTime.MinValue==AV45fecha_registro_From) )
         {
            AddWhere(sWhereString, "([fecha_registro] >= @AV45fecha_registro_From)");
         }
         else
         {
            GXv_int4[2] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV35K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(9), CAST([correlativo] AS decimal(9,0))) like '%' + @lV35K2BToolsGenericSearchField + '%' or [nombre_emp] like '%' + @lV35K2BToolsGenericSearchField + '%' or [cargo_emp] like '%' + @lV35K2BToolsGenericSearchField + '%' or [estatus] like '%' + @lV35K2BToolsGenericSearchField + '%' or [trabajo] like '%' + @lV35K2BToolsGenericSearchField + '%' or [nombre_usuario] like '%' + @lV35K2BToolsGenericSearchField + '%' or [depto_usuario] like '%' + @lV35K2BToolsGenericSearchField + '%' or [correo_usuario] like '%' + @lV35K2BToolsGenericSearchField + '%' or CONVERT( char(9), CAST([id_unidad] AS decimal(9,0))) like '%' + @lV35K2BToolsGenericSearchField + '%' or CONVERT( char(9), CAST([id_categoria] AS decimal(9,0))) like '%' + @lV35K2BToolsGenericSearchField + '%' or CONVERT( char(9), CAST([id_actividad] AS decimal(9,0))) like '%' + @lV35K2BToolsGenericSearchField + '%' or [detalle_tarea] like '%' + @lV35K2BToolsGenericSearchField + '%' or [prioridad] like '%' + @lV35K2BToolsGenericSearchField + '%' or [observaciones] like '%' + @lV35K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int4[3] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H007T2(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (DateTime)dynConstraints[5] , (int)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (int)dynConstraints[13] , (int)dynConstraints[14] , (int)dynConstraints[15] , (string)dynConstraints[16] , (string)dynConstraints[17] , (string)dynConstraints[18] , (short)dynConstraints[19] );
               case 1 :
                     return conditional_H007T3(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (DateTime)dynConstraints[5] , (int)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (int)dynConstraints[13] , (int)dynConstraints[14] , (int)dynConstraints[15] , (string)dynConstraints[16] , (string)dynConstraints[17] , (string)dynConstraints[18] , (short)dynConstraints[19] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV18nombre_emp",GXType.NVarChar,300,0) ,
          new ParDef("@AV46fecha_registro_To",GXType.Date,8,0) ,
          new ParDef("@AV45fecha_registro_From",GXType.Date,8,0) ,
          new ParDef("@lV35K2BToolsGenericSearchField",GXType.Char,100,0) ,
          new ParDef("@lV35K2BToolsGenericSearchField",GXType.NChar,100,0) ,
          new ParDef("@lV35K2BToolsGenericSearchField",GXType.NChar,100,0) ,
          new ParDef("@lV35K2BToolsGenericSearchField",GXType.NChar,100,0) ,
          new ParDef("@lV35K2BToolsGenericSearchField",GXType.NChar,100,0) ,
          new ParDef("@lV35K2BToolsGenericSearchField",GXType.NChar,100,0) ,
 ...
 public class promptdetalle_infotec__default : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
