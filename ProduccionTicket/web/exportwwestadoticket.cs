...
namespace GeneXus.Programs {
   public class exportwwestadoticket : GXProcedure
   {
                                 ...
                                 out string aP2_OutFile )
      {
         ...
         objexportwwestadoticket.AV27OutFile = "" ;
      ...
      void executePrivate( )
      {
         ...
         AV27OutFile = GxDirectory.TemporaryFilesPath + AV22File.Separator + "ExportWWEstadoTicket-" + Guid.NewGuid( ).ToString() + ".xlsx";
