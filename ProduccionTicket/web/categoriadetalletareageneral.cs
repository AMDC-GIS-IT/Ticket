...
namespace GeneXus.Programs {
   public class categoriadetalletareageneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public categoriadetalletareageneral( )
      {
      ...
      public categoriadetalletareageneral( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "AV6CategoriaDetalleTareaId", StringUtil.LTrimStr( (decimal)(AV6CategoriaDetalleTareaId), 4, 0));
                  AV8TabCode = GetPar( "TabCode");
                  AssignAttri(sPrefix, false, "AV8TabCode", AV8TabCode);
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)Gx_mode,(short)AV6CategoriaDetalleTareaId,(string)AV8TabCode});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188313426", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6CategoriaDetalleTareaId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6CategoriaDetalleTareaId), 4, 0, ".", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vCATEGORIADETALLETAREAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6CategoriaDetalleTareaId), 4, 0, ".", "")));
      ...
      {
         return "CategoriaDetalleTareaGeneral" ;
      }
      ...
      protected void WB7I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "categoriadetalletareageneral.aspx");
            }
            /* Div Control */
      ...
      protected void STRUP7I0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6CategoriaDetalleTareaId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6CategoriaDetalleTareaId"), ".", ","));
      ...
      protected void E127I2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         AV10ActivityList = new GXBaseCollection<SdtK2BActivityList_K2BActivityListItem>( context, "K2BActivityListItem", "kb_ticket");
         ...
         AV11ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "CategoriaDetalleTarea";
         AV11ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "CategoriaDetalleTarea";
         ...
         {
            A294CategoriaDetalleTareaId = H007I2_A294CategoriaDetalleTareaId[0];
            AV16GXLvl26 = 1;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Transactioncomponent_Component), StringUtil.Lower( "CategoriaDetalleTarea")) != 0 )
         {
            WebComp_Transactioncomponent = getWebComponent(GetType(), "GeneXus.Programs", "categoriadetalletarea", new Object[] {context} );
            WebComp_Transactioncomponent.ComponentInit();
            WebComp_Transactioncomponent.Name = "CategoriaDetalleTarea";
            WebComp_Transactioncomponent_Component = "CategoriaDetalleTarea";
         }
         if ( StringUtil.Len( WebComp_Transactioncomponent_Component) != 0 )
         {
            WebComp_Transactioncomponent.setjustcreated();
            WebComp_Transactioncomponent.componentprepare(new Object[] {(string)sPrefix+"W0029",(string)"",(string)Gx_mode,(short)AV6CategoriaDetalleTareaId});
      ...
      protected void E137I2( )
      {
         ...
         new k2bsettrncontextbyname(context ).execute(  "CategoriaDetalleTarea",  AV9TrnContext) ;
         CallWebObject(formatLink("entitymanagercategoriadetalletarea.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(AV6CategoriaDetalleTareaId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","CategoriaDetalleTareaId","TabCode"}) );
      ...
      protected void E147I2( )
      {
         ...
         AV9TrnContext.gxTpr_Returnmode = "Popup";
         new k2bsettrncontextbyname(context ).execute(  "CategoriaDetalleTarea",  AV9TrnContext) ;
         CallWebObject(formatLink("entitymanagercategoriadetalletarea.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(AV6CategoriaDetalleTareaId,4,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","CategoriaDetalleTareaId","TabCode"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void wb_table1_15_7I2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_18_7I2( true) ;
         }
         else
         {
            wb_table2_18_7I2( false) ;
         }
         return  ;
      }

      protected void wb_table2_18_7I2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void wb_table2_18_7I2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_18_7I2e( true) ;
         }
         else
         {
            wb_table2_18_7I2e( false) ;
         }
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6CategoriaDetalleTareaId = (string)((string)getParm(obj,1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "categoriadetalletareageneral", GetJustCreated( ));
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "Gx_mode", Gx_mode);
            AV6CategoriaDetalleTareaId = Convert.ToInt16(getParm(obj,3));
            AssignAttri(sPrefix, false, "AV6CategoriaDetalleTareaId", StringUtil.LTrimStr( (decimal)(AV6CategoriaDetalleTareaId), 4, 0));
         ...
         wcpOAV6CategoriaDetalleTareaId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6CategoriaDetalleTareaId"), ".", ","));
         wcpOAV8TabCode = cgiGet( sPrefix+"wcpOAV8TabCode");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(Gx_mode, wcpOGx_mode) != 0 ) || ( AV6CategoriaDetalleTareaId != wcpOAV6CategoriaDetalleTareaId ) || ( StringUtil.StrCmp(AV8TabCode, wcpOAV8TabCode) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOGx_mode = Gx_mode;
         wcpOAV6CategoriaDetalleTareaId = AV6CategoriaDetalleTareaId;
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV6CategoriaDetalleTareaId = cgiGet( sPrefix+"AV6CategoriaDetalleTareaId_CTRL");
         if ( StringUtil.Len( sCtrlAV6CategoriaDetalleTareaId) > 0 )
         {
            AV6CategoriaDetalleTareaId = (short)(context.localUtil.CToN( cgiGet( sCtrlAV6CategoriaDetalleTareaId), ".", ","));
            AssignAttri(sPrefix, false, "AV6CategoriaDetalleTareaId", StringUtil.LTrimStr( (decimal)(AV6CategoriaDetalleTareaId), 4, 0));
         }
         else
         {
            AV6CategoriaDetalleTareaId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV6CategoriaDetalleTareaId_PARM"), ".", ","));
         }
      ...
      protected void WCParametersSet( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6CategoriaDetalleTareaId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6CategoriaDetalleTareaId), 4, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6CategoriaDetalleTareaId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6CategoriaDetalleTareaId_CTRL", StringUtil.RTrim( sCtrlAV6CategoriaDetalleTareaId));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188313473", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("categoriadetalletareageneral.js", "?2024188313473", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A294CategoriaDetalleTareaId',fld:'CATEGORIADETALLETAREAID',pic:'ZZZ9'},{av:'AV6CategoriaDetalleTareaId',fld:'vCATEGORIADETALLETAREAID',pic:'ZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E137I2',iparms:[{av:'AV6CategoriaDetalleTareaId',fld:'vCATEGORIADETALLETAREAID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E147I2',iparms:[{av:'AV6CategoriaDetalleTareaId',fld:'vCATEGORIADETALLETAREAID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV11ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         scmdbuf = "";
         H007I2_A294CategoriaDetalleTareaId = new short[1] ;
         ...
         sCtrlGx_mode = "";
         sCtrlAV6CategoriaDetalleTareaId = "";
         sCtrlAV8TabCode = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.categoriadetalletareageneral__default(),
            new Object[][] {
                new Object[] {
               H007I2_A294CategoriaDetalleTareaId
               }
            }
         );
      ...
      private string sCtrlAV6CategoriaDetalleTareaId ;
      ...
      private short[] H007I2_A294CategoriaDetalleTareaId ;
   ...
   public class categoriadetalletareageneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H007I2", "SELECT [CategoriaDetalleTareaId] FROM [CategoriaDetalleTarea] WHERE [CategoriaDetalleTareaId] = @AV6CategoriaDetalleTareaId ORDER BY [CategoriaDetalleTareaId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007I2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
