...
namespace GeneXus.Programs.k2bfsg {
   public class findgamproperty : GXProcedure
   {
                                 ...
                                 out GeneXus.Programs.genexussecurity.SdtGAMProperty aP3_Property )
      {
         ...
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objfindgamproperty);
         aP2_Found=this.AV10Found;
         aP3_Property=this.AV11Property;
      }
      ...
      void executePrivate( )
      {
         ...
         AV10Found = false;
         AV15GXV1 = 1;
         while ( AV15GXV1 <= AV8Properties.Count )
         {
            AV12PropertyIterator = ((GeneXus.Programs.genexussecurity.SdtGAMProperty)AV8Properties.Item(AV15GXV1));
