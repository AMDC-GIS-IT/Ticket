...
namespace GeneXus.Programs.k2bfsg {
   public class addandgetpermissionresource : GXProcedure
   {
                                 ...
                                 out string aP2_PermissionResourceGUID )
      {
         ...
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objaddandgetpermissionresource);
         aP2_PermissionResourceGUID=this.AV13PermissionResourceGUID;
      }
      ...
      public override void initialize( )
      {
         ...
         pr_datastore2 = new DataStoreProvider(context, new GeneXus.Programs.k2bfsg.addandgetpermissionresource__datastore2(),
            new Object[][] {
            }
         );
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.k2bfsg.addandgetpermissionresource__datastore1(),
            new Object[][] {
            }
         );
   ...
   public class addandgetpermissionresource__datastore2 : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class addandgetpermissionresource__datastore1 : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
