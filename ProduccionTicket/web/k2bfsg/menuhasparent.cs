...
namespace GeneXus.Programs.k2bfsg {
   public class menuhasparent : GXProcedure
   {
                                 ...
                                 out bool aP2_hasParent )
      {
         ...
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objmenuhasparent);
         aP2_hasParent=this.AV12hasParent;
      }
      ...
      void executePrivate( )
      {
         ...
         AV12hasParent = false;
         AV23GXV1 = 1;
         while ( AV23GXV1 <= AV19Menus.Count )
         {
            AV13Menu = ((GeneXus.Programs.genexussecurity.SdtGAMApplicationMenu)AV19Menus.Item(AV23GXV1));
            if ( AV13Menu.gxTpr_Id != AV15MenuId )
            {
               ...
               AV24GXV2 = 1;
               while ( AV24GXV2 <= AV18MenuOptions.Count )
               {
                  AV16MenuOption = ((GeneXus.Programs.genexussecurity.SdtGAMApplicationMenuOption)AV18MenuOptions.Item(AV24GXV2));
