...
namespace GeneXus.Programs.k2bfsg {
   public class getmenuoptionbyname : GXProcedure
   {
                                 ...
                                 out GeneXus.Programs.genexussecurity.SdtGAMApplicationMenuOption aP3_ApplicationMenuOption )
      {
         ...
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objgetmenuoptionbyname);
         aP3_ApplicationMenuOption=this.AV10ApplicationMenuOption;
      }
      ...
      void executePrivate( )
      {
         ...
         AV19GXV2 = 1;
         AV18GXV1 = AV9ApplicationMenu.getmenuoptions(AV8ApplicationId, AV14MenuOptionFilter, out  AV12Errors);
         while ( AV19GXV2 <= AV18GXV1.Count )
         {
            AV11ApplicationMenuOptionInCollection = ((GeneXus.Programs.genexussecurity.SdtGAMApplicationMenuOption)AV18GXV1.Item(AV19GXV2));
      ...
      public override void initialize( )
      {
         AV10ApplicationMenuOption = new GeneXus.Programs.genexussecurity.SdtGAMApplicationMenuOption(context);
         AV14MenuOptionFilter = new GeneXus.Programs.genexussecurity.SdtGAMApplicationMenuOptionFilter(context);
         AV18GXV1 = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplicationMenuOption>( context, "GeneXus.Programs.genexussecurity.SdtGAMApplicationMenuOption", "GeneXus.Programs");
      ...
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplicationMenuOption> AV18GXV1 ;
