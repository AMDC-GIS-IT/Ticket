...
namespace GeneXus.Programs {
   public class detalle_infotecgeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public detalle_infotecgeneral( )
      {
      ...
      public detalle_infotecgeneral( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "AV6correlativo", StringUtil.LTrimStr( (decimal)(AV6correlativo), 9, 0));
                  AV8TabCode = GetPar( "TabCode");
                  AssignAttri(sPrefix, false, "AV8TabCode", AV8TabCode);
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)Gx_mode,(int)AV6correlativo,(string)AV8TabCode});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2024188315242", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6correlativo", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6correlativo), 9, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8TabCode", StringUtil.RTrim( wcpOAV8TabCode));
         GxWebStd.gx_hidden_field( context, sPrefix+"CORRELATIVO", StringUtil.LTrim( StringUtil.NToC( (decimal)(A238correlativo), 9, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vCORRELATIVO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6correlativo), 9, 0, ".", "")));
      ...
      protected void WB7W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "detalle_infotecgeneral.aspx");
            }
            /* Div Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            wb_table1_15_7W2( true) ;
         }
         else
         {
            wb_table1_15_7W2( false) ;
         }
         return  ;
      }

      protected void wb_table1_15_7W2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void STRUP7W0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6correlativo = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6correlativo"), ".", ","));
      ...
      protected void E127W2( )
      {
         ...
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Entityname = "detalle_infotec";
         AV12ActivityListItem.gxTpr_Activity.gxTpr_Transactionname = "detalle_infotec";
         ...
         {
            A238correlativo = H007W2_A238correlativo[0];
            AV16GXLvl26 = 1;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Transactioncomponent_Component), StringUtil.Lower( "detalle_infotec")) != 0 )
         {
            WebComp_Transactioncomponent = getWebComponent(GetType(), "GeneXus.Programs", "detalle_infotec", new Object[] {context} );
            WebComp_Transactioncomponent.ComponentInit();
            WebComp_Transactioncomponent.Name = "detalle_infotec";
            WebComp_Transactioncomponent_Component = "detalle_infotec";
         }
         if ( StringUtil.Len( WebComp_Transactioncomponent_Component) != 0 )
         {
            WebComp_Transactioncomponent.setjustcreated();
            WebComp_Transactioncomponent.componentprepare(new Object[] {(string)sPrefix+"W0029",(string)"",(string)Gx_mode,(int)AV6correlativo});
      ...
      protected void E137W2( )
      {
         /* 'DoUpdate' Routine */
         returnInSub = false;
         new k2bgettrncontextbyname(context ).execute(  "detalle_infotec", out  AV10TrnContext) ;
         GXt_char1 = "";
         ...
         new k2bsettrncontextbyname(context ).execute(  "detalle_infotec",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerdetalle_infotec.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(AV6correlativo,9,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","correlativo","TabCode"}) );
      ...
      protected void E147W2( )
      {
         ...
         AV10TrnContext.gxTpr_Returnmode = "Popup";
         new k2bsettrncontextbyname(context ).execute(  "detalle_infotec",  AV10TrnContext) ;
         CallWebObject(formatLink("entitymanagerdetalle_infotec.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(AV6correlativo,9,0)),UrlEncode(StringUtil.RTrim("General"))}, new string[] {"Mode","correlativo","TabCode"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void wb_table1_15_7W2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_18_7W2( true) ;
         }
         else
         {
            wb_table2_18_7W2( false) ;
         }
         return  ;
      }

      protected void wb_table2_18_7W2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_15_7W2e( true) ;
         }
         else
         {
            wb_table1_15_7W2e( false) ;
         }
      }

      protected void wb_table2_18_7W2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_18_7W2e( true) ;
         }
         else
         {
            wb_table2_18_7W2e( false) ;
         }
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6correlativo = (string)((string)getParm(obj,1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "detalle_infotecgeneral", GetJustCreated( ));
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "Gx_mode", Gx_mode);
            AV6correlativo = Convert.ToInt32(getParm(obj,3));
            AssignAttri(sPrefix, false, "AV6correlativo", StringUtil.LTrimStr( (decimal)(AV6correlativo), 9, 0));
         ...
         wcpOAV6correlativo = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6correlativo"), ".", ","));
         wcpOAV8TabCode = cgiGet( sPrefix+"wcpOAV8TabCode");
         if ( ! GetJustCreated( ) && ( ( StringUtil.StrCmp(Gx_mode, wcpOGx_mode) != 0 ) || ( AV6correlativo != wcpOAV6correlativo ) || ( StringUtil.StrCmp(AV8TabCode, wcpOAV8TabCode) != 0 ) ) )
         {
            setjustcreated();
         }
         wcpOGx_mode = Gx_mode;
         wcpOAV6correlativo = AV6correlativo;
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV6correlativo = cgiGet( sPrefix+"AV6correlativo_CTRL");
         if ( StringUtil.Len( sCtrlAV6correlativo) > 0 )
         {
            AV6correlativo = (int)(context.localUtil.CToN( cgiGet( sCtrlAV6correlativo), ".", ","));
            AssignAttri(sPrefix, false, "AV6correlativo", StringUtil.LTrimStr( (decimal)(AV6correlativo), 9, 0));
         }
         else
         {
            AV6correlativo = (int)(context.localUtil.CToN( cgiGet( sPrefix+"AV6correlativo_PARM"), ".", ","));
         }
      ...
      protected void WCParametersSet( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6correlativo_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6correlativo), 9, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6correlativo)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6correlativo_CTRL", StringUtil.RTrim( sCtrlAV6correlativo));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024188315291", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("detalle_infotecgeneral.js", "?2024188315291", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A238correlativo',fld:'CORRELATIVO',pic:'ZZZZZZZZ9'},{av:'AV6correlativo',fld:'vCORRELATIVO',pic:'ZZZZZZZZ9'},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E137W2',iparms:[{av:'AV6correlativo',fld:'vCORRELATIVO',pic:'ZZZZZZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E147W2',iparms:[{av:'AV6correlativo',fld:'vCORRELATIVO',pic:'ZZZZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV12ActivityListItem = new SdtK2BActivityList_K2BActivityListItem(context);
         scmdbuf = "";
         H007W2_A238correlativo = new int[1] ;
         ...
         sCtrlAV6correlativo = "";
         sCtrlAV8TabCode = "";
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.detalle_infotecgeneral__datastore1(),
            new Object[][] {
                new Object[] {
               H007W2_A238correlativo
               }
            }
         );
      ...
      private string sCtrlAV6correlativo ;
      ...
      private int[] H007W2_A238correlativo ;
   ...
   public class detalle_infotecgeneral__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H007W2", "SELECT [correlativo] FROM dbo.[detalle_infotec] WHERE [correlativo] = @AV6correlativo ORDER BY [correlativo] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007W2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
