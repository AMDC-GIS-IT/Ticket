...
namespace GeneXus.Programs {
   public class reportwwareasatencion : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public reportwwareasatencion( IGxContext context )
      {
      ...
      public void executeSubmit( string aP0_K2BToolsGenericSearchField ,
                                 short aP1_OrderedBy )
      {
         reportwwareasatencion objreportwwareasatencion;
         objreportwwareasatencion = new reportwwareasatencion();
         objreportwwareasatencion.AV9K2BToolsGenericSearchField = aP0_K2BToolsGenericSearchField;
         objreportwwareasatencion.AV10OrderedBy = aP1_OrderedBy;
         objreportwwareasatencion.context.SetSubmitInitialConfig(context);
         objreportwwareasatencion.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objreportwwareasatencion);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((reportwwareasatencion)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            if ( ! new k2bisauthorizedactivityname(context).executeUdp(  "AreasAtencion",  "AreasAtencion",  "List",  "",  AV19Pgmname) )
            {
               H7L0( false, 30) ;
            ...
            else
            {
               ...
               getPrinter().GxDrawText("Áreas de atenciones", 205, Gx_line+0, 622, Gx_line+42, 0+256, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
               ...
               getPrinter().GxDrawText("", 126, Gx_line+6, 192, Gx_line+23, 0, 0, 0, 1) ;
               Gx_OldLine = Gx_line;
               Gx_line = (int)(Gx_line+30);
               GxHdr3 = true;
               ...
               {
                  A368AreasAtencionUsuarioSistema = P007L2_A368AreasAtencionUsuarioSistema[0];
                  A367AreasAtencionDescripcion = P007L2_A367AreasAtencionDescripcion[0];
                  A366AreasAtencionId = P007L2_A366AreasAtencionId[0];
                  H7L0( false, 30) ;
                  getPrinter().GxAttris("Courier New", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(A366AreasAtencionId), "ZZZ9")), 18, Gx_line+7, 118, Gx_line+23, 2, 0, 0, 0) ;
                  getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A367AreasAtencionDescripcion, "")), 126, Gx_line+7, 192, Gx_line+23, 0, 0, 0, 0) ;
                  Gx_OldLine = Gx_line;
                  Gx_line = (int)(Gx_line+30);
      ...
      protected void H7L0( bool bFoot ,
                           int Inc )
      {
      ...
      public override void initialize( )
      {
         ...
         A367AreasAtencionDescripcion = "";
         A368AreasAtencionUsuarioSistema = "";
         P007L2_A368AreasAtencionUsuarioSistema = new string[] {""} ;
         P007L2_A367AreasAtencionDescripcion = new string[] {""} ;
         P007L2_A366AreasAtencionId = new short[1] ;
         Gx_date = DateTime.MinValue;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportwwareasatencion__default(),
            new Object[][] {
                new Object[] {
               P007L2_A368AreasAtencionUsuarioSistema, P007L2_A367AreasAtencionDescripcion, P007L2_A366AreasAtencionId
               }
            }
         );
         AV19Pgmname = "ReportWWAreasAtencion";
      ...
      private string[] P007L2_A368AreasAtencionUsuarioSistema ;
      private string[] P007L2_A367AreasAtencionDescripcion ;
      private short[] P007L2_A366AreasAtencionId ;
      private SdtK2BContext AV8Context ;
   }

   public class reportwwareasatencion__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV10OrderedBy )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9K2BToolsGenericSearchField)) )
         {
            AddWhere(sWhereString, "(CONVERT( char(4), CAST([AreasAtencionId] AS decimal(4,0))) like '%' + @lV9K2BToolsGenericSearchField + '%' or [AreasAtencionDescripcion] like '%' + @lV9K2BToolsGenericSearchField + '%' or [AreasAtencionUsuarioSistema] like '%' + @lV9K2BToolsGenericSearchField + '%')");
         }
         else
         {
            GXv_int1[0] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P007L2(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P007L2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007L2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
