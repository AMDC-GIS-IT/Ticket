...
namespace GeneXus.Programs {
   public class k2bwwmasterpageorionhorizmenu : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm1I2( )
      {
         ...
         context.AddJavascriptSource("k2bwwmasterpageorionhorizmenu.js", "?2024188355934", false, true);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?2024188355978", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("k2bwwmasterpageorionhorizmenu.js", "?2024188355978", false, true);
         context.AddJavascriptSource("K2BHorizontalMenu/K2BHorizontalMenuRender.js", "", false, true);
         context.AddJavascriptSource("K2BAccordionMenu/metisMenu-master/dist/metisMenu.min.js", "", false, true);
         context.AddJavascriptSource("K2BAccordionMenu/K2BAccordionMenuRender.js", "", false, true);
